...
- Take a look at the functional tests in this repo? They may have an example for you. See the [functional tests](https://github.com/microsoftgraph/msgraph-beta-sdk-java/tree/master/src/test/java/com/microsoft/graph/functional)
