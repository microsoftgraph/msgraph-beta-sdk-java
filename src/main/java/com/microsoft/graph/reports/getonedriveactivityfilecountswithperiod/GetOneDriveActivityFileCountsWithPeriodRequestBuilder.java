...
public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
    ...
    /**
     * Invoke function getOneDriveActivityFileCounts
     * @return a CompletableFuture of getOneDriveActivityFileCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityFileCountsWithPeriodResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetOneDriveActivityFileCountsWithPeriodResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getOneDriveActivityFileCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityFileCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getOneDriveActivityFileCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityFileCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetOneDriveActivityFileCountsWithPeriodResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
