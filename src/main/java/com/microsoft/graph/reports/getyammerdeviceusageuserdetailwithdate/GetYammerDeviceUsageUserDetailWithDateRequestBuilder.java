...
public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
    ...
    /**
     * Invoke function getYammerDeviceUsageUserDetail
     * @return a CompletableFuture of getYammerDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerDeviceUsageUserDetailWithDateResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetYammerDeviceUsageUserDetailWithDateResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getYammerDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerDeviceUsageUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getYammerDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerDeviceUsageUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetYammerDeviceUsageUserDetailWithDateResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
