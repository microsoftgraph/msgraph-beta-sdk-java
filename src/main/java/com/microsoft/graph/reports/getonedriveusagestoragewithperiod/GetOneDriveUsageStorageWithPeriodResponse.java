...
public class GetOneDriveUsageStorageWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getOneDriveUsageStorageWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetOneDriveUsageStorageWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetOneDriveUsageStorageWithPeriodResponse currentObject = this;
