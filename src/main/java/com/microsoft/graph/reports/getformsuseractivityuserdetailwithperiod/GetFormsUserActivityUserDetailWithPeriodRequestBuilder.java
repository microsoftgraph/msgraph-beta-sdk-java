package com.microsoft.graph.reports.getformsuseractivityuserdetailwithperiod;
...
public class GetFormsUserActivityUserDetailWithPeriodRequestBuilder {
    ...
    public GetFormsUserActivityUserDetailWithPeriodRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String period) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/reports/getFormsUserActivityUserDetail(period='{period}')";
     ...
     */
    @javax.annotation.Nullable
    public GetFormsUserActivityUserDetailWithPeriodRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/reports/getFormsUserActivityUserDetail(period='{period}')";
