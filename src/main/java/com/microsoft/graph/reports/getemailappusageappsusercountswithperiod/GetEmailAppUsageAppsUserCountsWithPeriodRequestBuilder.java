...
public class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder {
    ...
    public GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String period) {
     ...
     */
    @javax.annotation.Nullable
    public GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getEmailAppUsageAppsUserCounts(period='{period}')";
