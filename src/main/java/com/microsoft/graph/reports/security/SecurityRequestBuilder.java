...
public class SecurityRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SecurityReportsRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SecurityReportsRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SecurityReportsRoot> executionException = new java.util.concurrent.CompletableFuture<SecurityReportsRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
