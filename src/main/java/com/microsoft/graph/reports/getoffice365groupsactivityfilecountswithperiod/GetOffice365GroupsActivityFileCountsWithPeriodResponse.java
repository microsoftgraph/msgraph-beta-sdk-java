...
public class GetOffice365GroupsActivityFileCountsWithPeriodResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<Office365GroupsActivityFileCounts> _value;
    /**
    ...
    public static GetOffice365GroupsActivityFileCountsWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetOffice365GroupsActivityFileCountsWithPeriodResponse currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Office365GroupsActivityFileCounts::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<Office365GroupsActivityFileCounts> value) {
        this._value = value;
    }
}
