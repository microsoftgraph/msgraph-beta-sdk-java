...
public class GetYammerActivityCountsWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getYammerActivityCountsWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetYammerActivityCountsWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetYammerActivityCountsWithPeriodResponse currentObject = this;
