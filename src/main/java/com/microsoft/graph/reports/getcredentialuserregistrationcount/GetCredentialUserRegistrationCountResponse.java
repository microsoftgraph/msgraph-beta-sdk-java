package com.microsoft.graph.reports.getcredentialuserregistrationcount;
...
public class GetCredentialUserRegistrationCountResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static GetCredentialUserRegistrationCountResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<CredentialUserRegistrationCount>
     */
