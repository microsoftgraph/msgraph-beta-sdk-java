...
public class GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder {
    ...
    /**
     * Invoke function getSkypeForBusinessParticipantActivityMinuteCounts
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
