package microsoft.graph.reports.getbrowseruserdetailwithperiod;
...
public class GetBrowserUserDetailWithPeriodResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getBrowserUserDetailWithPeriodResponse
     */
    @javax.annotation.Nonnull
    public static GetBrowserUserDetailWithPeriodResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetBrowserUserDetailWithPeriodResponse currentObject = this;
