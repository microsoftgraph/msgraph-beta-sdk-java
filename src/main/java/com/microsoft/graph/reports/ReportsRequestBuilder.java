...
import microsoft.graph.reports.applicationsignindetailedsummary.ApplicationSignInDetailedSummaryRequestBuilder;
import microsoft.graph.reports.applicationsignindetailedsummary.item.ApplicationSignInDetailedSummaryItemRequestBuilder;
import microsoft.graph.reports.authenticationmethods.AuthenticationMethodsRequestBuilder;
import microsoft.graph.reports.credentialuserregistrationdetails.CredentialUserRegistrationDetailsRequestBuilder;
import microsoft.graph.reports.credentialuserregistrationdetails.item.CredentialUserRegistrationDetailsItemRequestBuilder;
...
import microsoft.graph.reports.dailyprintusagesummariesbyprinter.DailyPrintUsageSummariesByPrinterRequestBuilder;
import microsoft.graph.reports.dailyprintusagesummariesbyuser.DailyPrintUsageSummariesByUserRequestBuilder;
...
import microsoft.graph.reports.getattacksimulationrepeatoffenders.GetAttackSimulationRepeatOffendersRequestBuilder;
import microsoft.graph.reports.getattacksimulationsimulationusercoverage.GetAttackSimulationSimulationUserCoverageRequestBuilder;
import microsoft.graph.reports.getattacksimulationtrainingusercoverage.GetAttackSimulationTrainingUserCoverageRequestBuilder;
import microsoft.graph.reports.getazureadapplicationsigninsummarywithperiod.GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder;
import microsoft.graph.reports.getazureadfeatureusagewithperiod.GetAzureADFeatureUsageWithPeriodRequestBuilder;
import microsoft.graph.reports.getazureadlicenseusagewithperiod.GetAzureADLicenseUsageWithPeriodRequestBuilder;
import microsoft.graph.reports.getazureaduserfeatureusage.GetAzureADUserFeatureUsageRequestBuilder;
import microsoft.graph.reports.getbrowserdistributionusercountswithperiod.GetBrowserDistributionUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getbrowserusercountswithperiod.GetBrowserUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getbrowseruserdetailwithperiod.GetBrowserUserDetailWithPeriodRequestBuilder;
import microsoft.graph.reports.getcredentialusagesummarywithperiod.GetCredentialUsageSummaryWithPeriodRequestBuilder;
import microsoft.graph.reports.getcredentialuserregistrationcount.GetCredentialUserRegistrationCountRequestBuilder;
...
import microsoft.graph.reports.getm365appplatformusercountswithperiod.GetM365AppPlatformUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getm365appusercountswithperiod.GetM365AppUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getm365appuserdetailwithdate.GetM365AppUserDetailWithDateRequestBuilder;
import microsoft.graph.reports.getm365appuserdetailwithperiod.GetM365AppUserDetailWithPeriodRequestBuilder;
...
import microsoft.graph.reports.getrelyingpartydetailedsummarywithperiod.GetRelyingPartyDetailedSummaryWithPeriodRequestBuilder;
...
import microsoft.graph.reports.getteamsdeviceusagedistributiontotalusercountswithperiod.GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilder;
...
import microsoft.graph.reports.getteamsdeviceusagetotalusercountswithperiod.GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder;
...
import microsoft.graph.reports.getteamsteamactivitycountswithperiod.GetTeamsTeamActivityCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsteamactivitydetailwithdate.GetTeamsTeamActivityDetailWithDateRequestBuilder;
import microsoft.graph.reports.getteamsteamactivitydetailwithperiod.GetTeamsTeamActivityDetailWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsteamactivitydistributioncountswithperiod.GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitycountswithperiod.GetTeamsUserActivityCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitydistributiontotalusercountswithperiod.GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitydistributionusercountswithperiod.GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitytotalcountswithperiod.GetTeamsUserActivityTotalCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitytotaldistributioncountswithperiod.GetTeamsUserActivityTotalDistributionCountsWithPeriodRequestBuilder;
import microsoft.graph.reports.getteamsuseractivitytotalusercountswithperiod.GetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilder;
...
import microsoft.graph.reports.manageddeviceenrollmentabandonmentdetailswithskipwithtopwithfilterwithskiptoken.ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder;
import microsoft.graph.reports.manageddeviceenrollmentabandonmentsummarywithskipwithtopwithfilterwithskiptoken.ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilder;
...
import microsoft.graph.reports.manageddeviceenrollmentfailuretrends.ManagedDeviceEnrollmentFailureTrendsRequestBuilder;
...
public class ReportsRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.reports.applicationSignInDetailedSummary.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.reports.credentialUserRegistrationDetails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.reports.dailyPrintUsageSummariesByPrinter.item collection
     * @param id Unique identifier of the item
     * @return a printUsageByPrinterItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.reports.dailyprintusagesummariesbyprinter.item.PrintUsageByPrinterItemRequestBuilder dailyPrintUsageSummariesByPrinter(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printUsageByPrinter%2Did", id);
        return new microsoft.graph.reports.dailyprintusagesummariesbyprinter.item.PrintUsageByPrinterItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.reports.dailyPrintUsageSummariesByUser.item collection
     * @param id Unique identifier of the item
     * @return a printUsageByUserItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.reports.dailyprintusagesummariesbyuser.item.PrintUsageByUserItemRequestBuilder dailyPrintUsageSummariesByUser(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printUsageByUser%2Did", id);
        return new microsoft.graph.reports.dailyprintusagesummariesbyuser.item.PrintUsageByUserItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    /**
     * Gets an item from the Microsoft.Graph.reports.monthlyPrintUsageSummariesByPrinter.item collection
     * @param id Unique identifier of the item
     * @return a printUsageByPrinterItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.reports.monthlyprintusagesummariesbyprinter.item.PrintUsageByPrinterItemRequestBuilder monthlyPrintUsageSummariesByPrinter(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printUsageByPrinter%2Did", id);
        return new microsoft.graph.reports.monthlyprintusagesummariesbyprinter.item.PrintUsageByPrinterItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.reports.monthlyPrintUsageSummariesByUser.item collection
     * @param id Unique identifier of the item
     * @return a printUsageByUserItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.reports.monthlyprintusagesummariesbyuser.item.PrintUsageByUserItemRequestBuilder monthlyPrintUsageSummariesByUser(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printUsageByUser%2Did", id);
        return new microsoft.graph.reports.monthlyprintusagesummariesbyuser.item.PrintUsageByUserItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update reports
     * @param body 
    ...
    /**
     * Gets an item from the Microsoft.Graph.reports.userCredentialUsageDetails.item collection
     * @param id Unique identifier of the item
