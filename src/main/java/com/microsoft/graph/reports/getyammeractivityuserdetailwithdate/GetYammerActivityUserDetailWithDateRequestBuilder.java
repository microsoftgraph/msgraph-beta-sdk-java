...
public class GetYammerActivityUserDetailWithDateRequestBuilder {
    ...
    /**
     * Invoke function getYammerActivityUserDetail
     * @return a CompletableFuture of getYammerActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerActivityUserDetailWithDateResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetYammerActivityUserDetailWithDateResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getYammerActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getYammerActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetYammerActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetYammerActivityUserDetailWithDateResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
