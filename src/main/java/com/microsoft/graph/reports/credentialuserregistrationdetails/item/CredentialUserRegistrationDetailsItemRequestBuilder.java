...
public class CredentialUserRegistrationDetailsItemRequestBuilder extends BaseRequestBuilder {
    ...
    @Deprecated
    public CredentialUserRegistrationDetails get() {
        return get(null);
    }
    /**
     * Details of the usage of self-service password reset and multi-factor authentication (MFA) for all registered users.
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CredentialUserRegistrationDetails get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CredentialUserRegistrationDetails::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CredentialUserRegistrationDetails patch(@jakarta.annotation.Nonnull final CredentialUserRegistrationDetails body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CredentialUserRegistrationDetails patch(@jakarta.annotation.Nonnull final CredentialUserRegistrationDetails body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public CredentialUserRegistrationDetailsItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
