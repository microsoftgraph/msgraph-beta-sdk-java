package com.microsoft.graph.reports.userinsights.monthly.activeusersbreakdown.item;
...
public class ActiveUsersBreakdownMetricItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ActiveUsersBreakdownMetric
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ActiveUsersBreakdownMetric> get() {
        return get(null);
    }
    /**
     * Get activeUsersBreakdown from reports
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ActiveUsersBreakdownMetric> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ActiveUsersBreakdownMetric::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get activeUsersBreakdown from reports
