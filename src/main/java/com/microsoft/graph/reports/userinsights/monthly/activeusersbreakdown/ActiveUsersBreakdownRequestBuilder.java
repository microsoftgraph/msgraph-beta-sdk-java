package com.microsoft.graph.reports.userinsights.monthly.activeusersbreakdown;

import com.microsoft.graph.models.ActiveUsersBreakdownMetricCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.reports.userinsights.monthly.activeusersbreakdown.count.CountRequestBuilder;
import com.microsoft.graph.reports.userinsights.monthly.activeusersbreakdown.item.ActiveUsersBreakdownMetricItemRequestBuilder;
...
public class ActiveUsersBreakdownRequestBuilder extends BaseRequestBuilder {
    ...
    public ActiveUsersBreakdownRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ActiveUsersBreakdownRequestBuilder and sets the default values.
    ...
    public ActiveUsersBreakdownRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get activeUsersBreakdown from reports
     * @return a CompletableFuture of ActiveUsersBreakdownMetricCollectionResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ActiveUsersBreakdownMetricCollectionResponse> get() {
        return get(null);
    }
    /**
     * Get activeUsersBreakdown from reports
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ActiveUsersBreakdownMetricCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ActiveUsersBreakdownMetricCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get activeUsersBreakdown from reports
