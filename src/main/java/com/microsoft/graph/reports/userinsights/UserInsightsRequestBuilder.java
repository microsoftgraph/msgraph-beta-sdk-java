...
public class UserInsightsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of UserInsightsRoot
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserInsightsRoot> get() {
        return get(null);
    }
    /**
     * Get userInsights from reports
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserInsightsRoot> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, UserInsightsRoot::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserInsightsRoot> patch(@jakarta.annotation.Nonnull final UserInsightsRoot body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserInsightsRoot> patch(@jakarta.annotation.Nonnull final UserInsightsRoot body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
