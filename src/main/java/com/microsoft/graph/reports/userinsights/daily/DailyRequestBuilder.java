...
public class DailyRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of DailyUserInsightMetricsRoot
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DailyUserInsightMetricsRoot> get() {
        return get(null);
    }
    /**
     * Get daily from reports
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DailyUserInsightMetricsRoot> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, DailyUserInsightMetricsRoot::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DailyUserInsightMetricsRoot> patch(@jakarta.annotation.Nonnull final DailyUserInsightMetricsRoot body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DailyUserInsightMetricsRoot> patch(@jakarta.annotation.Nonnull final DailyUserInsightMetricsRoot body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
