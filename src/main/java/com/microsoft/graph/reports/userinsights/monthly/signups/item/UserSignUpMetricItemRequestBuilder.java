package com.microsoft.graph.reports.userinsights.monthly.signups.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserSignUpMetric;
...
public class UserSignUpMetricItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of UserSignUpMetric
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserSignUpMetric> get() {
        return get(null);
    }
    /**
     * Get signUps from reports
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserSignUpMetric> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, UserSignUpMetric::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get signUps from reports
