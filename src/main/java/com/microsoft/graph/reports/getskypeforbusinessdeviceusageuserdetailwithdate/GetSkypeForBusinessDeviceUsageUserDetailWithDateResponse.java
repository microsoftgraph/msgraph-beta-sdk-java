...
public class GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getSkypeForBusinessDeviceUsageUserDetailWithDateResponse
     */
    @javax.annotation.Nonnull
    public static GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse currentObject = this;
