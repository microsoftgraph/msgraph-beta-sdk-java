...
public class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder {
    ...
    /**
     * Invoke function getSkypeForBusinessDeviceUsageUserDetail
     * @return a CompletableFuture of getSkypeForBusinessDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getSkypeForBusinessDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getSkypeForBusinessDeviceUsageUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessDeviceUsageUserDetailWithDateResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
