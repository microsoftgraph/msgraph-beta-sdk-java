...
public class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder {
    ...
    public GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final LocalDate date) {
     ...
     */
    @javax.annotation.Nullable
    public GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getTeamsDeviceUsageUserDetail(date={date})";
