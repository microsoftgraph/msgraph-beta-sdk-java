...
public class ServiceActivityRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ServiceActivity
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceActivity> get() {
        return get(null);
    }
    /**
     * A placeholder to the Microsoft Entra service activity.
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceActivity> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ServiceActivity::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceActivity> patch(@jakarta.annotation.Nonnull final ServiceActivity body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceActivity> patch(@jakarta.annotation.Nonnull final ServiceActivity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
