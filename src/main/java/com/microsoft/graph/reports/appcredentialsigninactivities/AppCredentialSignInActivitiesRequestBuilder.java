...
public class AppCredentialSignInActivitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public AppCredentialSignInActivityCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, AppCredentialSignInActivityCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public AppCredentialSignInActivity post(@jakarta.annotation.Nonnull final AppCredentialSignInActivity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, AppCredentialSignInActivity::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of appCredentialSignInActivity objects that contains recent activity of application credentials. This API is available in the following national cloud deployments.
