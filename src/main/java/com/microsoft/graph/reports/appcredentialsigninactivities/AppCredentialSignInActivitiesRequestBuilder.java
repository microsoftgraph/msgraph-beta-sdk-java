...
public class AppCredentialSignInActivitiesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the appCredentialSignInActivities property of the microsoft.graph.reportRoot entity.
     * @param appCredentialSignInActivityId Unique identifier of the item
     * @return a AppCredentialSignInActivityItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public AppCredentialSignInActivityItemRequestBuilder byAppCredentialSignInActivityId(@javax.annotation.Nonnull final String appCredentialSignInActivityId) {
    ...
    public AppCredentialSignInActivitiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public AppCredentialSignInActivitiesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<AppCredentialSignInActivityCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AppCredentialSignInActivityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AppCredentialSignInActivityCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AppCredentialSignInActivity> post(@javax.annotation.Nonnull final AppCredentialSignInActivity body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AppCredentialSignInActivity> post(@javax.annotation.Nonnull final AppCredentialSignInActivity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AppCredentialSignInActivity body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AppCredentialSignInActivity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
