...
public class GetOneDriveActivityUserDetailWithDateRequestBuilder {
    ...
    /**
     * Invoke function getOneDriveActivityUserDetail
     * @return a CompletableFuture of getOneDriveActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityUserDetailWithDateResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetOneDriveActivityUserDetailWithDateResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getOneDriveActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getOneDriveActivityUserDetailWithDateResponse
     */
    public java.util.concurrent.CompletableFuture<GetOneDriveActivityUserDetailWithDateResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetOneDriveActivityUserDetailWithDateResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
