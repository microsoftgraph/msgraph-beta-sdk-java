...
public class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder {
    ...
    /**
     * Invoke function getSkypeForBusinessParticipantActivityCounts
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityCountsWithPeriodResponse> get() {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessParticipantActivityCountsWithPeriodResponse::createFromDiscriminatorValue, null, null);
     ...
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of getSkypeForBusinessParticipantActivityCountsWithPeriodResponse
     */
    public java.util.concurrent.CompletableFuture<GetSkypeForBusinessParticipantActivityCountsWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            return this.requestAdapter.sendAsync(requestInfo, GetSkypeForBusinessParticipantActivityCountsWithPeriodResponse::createFromDiscriminatorValue, responseHandler, null);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
