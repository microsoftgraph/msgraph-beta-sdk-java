...
public class MessageTracesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MessageTrace body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MessageTraceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MessageTraceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MessageTraceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MessageTrace> post(@javax.annotation.Nonnull final MessageTrace body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MessageTrace> executionException = new java.util.concurrent.CompletableFuture<MessageTrace>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
