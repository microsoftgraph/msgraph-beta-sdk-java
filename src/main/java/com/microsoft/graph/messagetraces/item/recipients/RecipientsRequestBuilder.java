...
public class RecipientsRequestBuilder {
     ...
     * @return a CompletableFuture of MessageRecipientCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<MessageRecipientCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<RecipientsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of messageRecipient
     */
    public java.util.concurrent.CompletableFuture<MessageRecipient> post(@javax.annotation.Nonnull final MessageRecipient body, @javax.annotation.Nullable final java.util.function.Consumer<RecipientsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
