...
import microsoft.graph.teams.item.owners.item.UserItemRequestBuilder;
import microsoft.graph.teams.item.owners.OwnersRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.PermissionGrantsRequestBuilder;
...
import microsoft.graph.teams.item.tags.item.TeamworkTagItemRequestBuilder;
import microsoft.graph.teams.item.tags.TagsRequestBuilder;
...
public class TeamItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teams.item.owners.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teams.item.permissionGrants.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teams.item.tags.item collection
     * @param id Unique identifier of the item
