package microsoft.graph.teams.item.permissiongrants.item;
...
import microsoft.graph.teams.item.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.teams.item.permissiongrants.item.restore.RestoreRequestBuilder;
