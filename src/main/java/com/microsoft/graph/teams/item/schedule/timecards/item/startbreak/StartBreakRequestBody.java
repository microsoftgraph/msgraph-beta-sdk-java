...
public class StartBreakRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a startBreakRequestBody
     */
    @javax.annotation.Nonnull
    public static StartBreakRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StartBreakRequestBody currentObject = this;
