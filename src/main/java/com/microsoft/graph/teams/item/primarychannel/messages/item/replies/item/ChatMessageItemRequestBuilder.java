...
import microsoft.graph.teams.item.primarychannel.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.teams.item.primarychannel.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
