...
import microsoft.graph.teams.item.channels.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.teams.item.channels.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
