package com.microsoft.graph.teams.item.channels.item.messages.item.hostedcontents;
...
import com.microsoft.graph.teams.item.channels.item.messages.item.hostedcontents.count.CountRequestBuilder;
