...
import microsoft.graph.teams.item.channels.item.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.teams.item.channels.item.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
