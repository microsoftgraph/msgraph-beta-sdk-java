...
public class InboundSharedUserProfileUserItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<InboundSharedUserProfile> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<InboundSharedUserProfile> executionException = new java.util.concurrent.CompletableFuture<InboundSharedUserProfile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
