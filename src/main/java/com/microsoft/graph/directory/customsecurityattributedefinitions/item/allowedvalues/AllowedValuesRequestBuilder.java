...
public class AllowedValuesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public AllowedValueItemRequestBuilder byAllowedValueId(@javax.annotation.Nonnull final String allowedValueId) {
    ...
    public java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AllowedValue body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AllowedValue body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
