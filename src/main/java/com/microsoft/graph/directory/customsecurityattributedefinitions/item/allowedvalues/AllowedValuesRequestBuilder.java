...
public class AllowedValuesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AllowedValue body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AllowedValueCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AllowedValue> post(@javax.annotation.Nonnull final AllowedValue body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AllowedValue> executionException = new java.util.concurrent.CompletableFuture<AllowedValue>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
