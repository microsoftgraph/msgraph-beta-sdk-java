package com.microsoft.graph.directory.featurerolloutpolicies.item.appliesto.item;

import com.microsoft.graph.directory.featurerolloutpolicies.item.appliesto.item.ref.RefRequestBuilder;
