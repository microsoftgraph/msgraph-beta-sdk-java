package com.microsoft.graph.directory.impactedresources.item.reactivate;
...
public class ReactivateRequestBuilder {
    ...
    public ReactivateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/directory/impactedResources/{recommendationResource%2Did}/microsoft.graph.reactivate";
     ...
     * @return a CompletableFuture of recommendationResource
     */
    public java.util.concurrent.CompletableFuture<RecommendationResource> post(@javax.annotation.Nullable final java.util.function.Consumer<ReactivateRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of recommendationResource
     */
    public java.util.concurrent.CompletableFuture<RecommendationResource> post(@javax.annotation.Nullable final java.util.function.Consumer<ReactivateRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
