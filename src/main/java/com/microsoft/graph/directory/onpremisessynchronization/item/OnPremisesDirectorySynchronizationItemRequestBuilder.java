...
public class OnPremisesDirectorySynchronizationItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final OnPremisesDirectorySynchronization body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronization> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronization> executionException = new java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronization>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
