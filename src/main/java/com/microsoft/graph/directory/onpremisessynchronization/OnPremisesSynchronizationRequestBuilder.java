...
public class OnPremisesSynchronizationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnPremisesDirectorySynchronization body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse>();
