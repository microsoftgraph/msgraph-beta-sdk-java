...
public class OnPremisesSynchronizationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<OnPremisesSynchronizationRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final OnPremisesSynchronizationRequestBuilderGetRequestConfiguration requestConfig = new OnPremisesSynchronizationRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnPremisesDirectorySynchronization body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnPremisesDirectorySynchronization body, @javax.annotation.Nullable final java.util.function.Consumer<OnPremisesSynchronizationRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final OnPremisesSynchronizationRequestBuilderPostRequestConfiguration requestConfig = new OnPremisesSynchronizationRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse>() {{
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronizationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<OnPremisesSynchronizationRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesDirectorySynchronization> post(@javax.annotation.Nonnull final OnPremisesDirectorySynchronization body, @javax.annotation.Nullable final java.util.function.Consumer<OnPremisesSynchronizationRequestBuilderPostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
    ...
    public class OnPremisesSynchronizationRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public OnPremisesSynchronizationRequestBuilderGetQueryParameters queryParameters = new OnPremisesSynchronizationRequestBuilderGetQueryParameters();
        /**
