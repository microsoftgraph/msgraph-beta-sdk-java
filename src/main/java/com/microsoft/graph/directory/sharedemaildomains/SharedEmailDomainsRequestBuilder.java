...
public class SharedEmailDomainsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SharedEmailDomainCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SharedEmailDomainCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SharedEmailDomainCollectionResponse>();
