...
public class CompanySubscriptionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CompanySubscription get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CompanySubscription::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public CompanySubscription patch(@jakarta.annotation.Nonnull final CompanySubscription body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CompanySubscription patch(@jakarta.annotation.Nonnull final CompanySubscription body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CompanySubscription body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CompanySubscription body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
        if (requestConfiguration != null) {
     ...
     */
    @jakarta.annotation.Nonnull
    public CompanySubscriptionItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
