...
public class ImpactedResourceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ImpactedResourceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{impactedResource%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ImpactedResourceItemRequestBuilder and sets the default values.
    ...
    public ImpactedResourceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{impactedResource%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
