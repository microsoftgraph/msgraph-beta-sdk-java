...
public class DismissRequestBuilder extends BaseRequestBuilder {
    ...
    public DismissRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/dismiss", pathParameters);
    }
    /**
     * Instantiates a new DismissRequestBuilder and sets the default values.
    ...
    /**
     * Dismiss a recommendation object that you consider to be inapplicable to your tenant and update its status to dismissed . This API is supported in the following national cloud deployments.
    ...
    public java.util.concurrent.CompletableFuture<Recommendation> post(@jakarta.annotation.Nonnull final DismissPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Recommendation> post(@jakarta.annotation.Nonnull final DismissPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
