package microsoft.graph.directory.recommendations.item.reactivate;
...
public class ReactivateRequestBuilder {
     ...
     * @return a CompletableFuture of recommendation
     */
    public java.util.concurrent.CompletableFuture<Recommendation> post(@javax.annotation.Nullable final java.util.function.Consumer<ReactivateRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
