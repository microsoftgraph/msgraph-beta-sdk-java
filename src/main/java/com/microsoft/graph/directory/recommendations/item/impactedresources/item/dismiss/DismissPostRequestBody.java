...
public class DismissPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public String getDismissReason() {
        return this.backingStore.get("dismissReason");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dismissReason", (n) -> { this.setDismissReason(n.getStringValue()); });
     ...
     */
    public void setDismissReason(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("dismissReason", value);
    }
}
