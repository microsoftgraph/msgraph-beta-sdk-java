...
public class PostponeRequestBuilder {
     ...
     * @return a CompletableFuture of recommendation
     */
    public java.util.concurrent.CompletableFuture<Recommendation> post(@javax.annotation.Nonnull final PostponePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostponeRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
