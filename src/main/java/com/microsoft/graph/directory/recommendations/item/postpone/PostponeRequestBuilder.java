...
public class PostponeRequestBuilder {
     ...
     */
    public java.util.concurrent.CompletableFuture<Recommendation> post(@javax.annotation.Nonnull final PostponeRequestBody body) {
        try {
     ...
     * @return a CompletableFuture of recommendation
     */
    public java.util.concurrent.CompletableFuture<Recommendation> post(@javax.annotation.Nonnull final PostponeRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostponeRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
