package com.microsoft.graph.governanceroledefinitions.item.rolesetting;
...
public class RoleSettingRequestBuilder {
    ...
    public RoleSettingRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}/roleSetting{?%24select,%24expand}";
