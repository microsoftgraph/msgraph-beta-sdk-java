package com.microsoft.graph.privilegedaccess.item.resources.item.rolesettings.item.roledefinition.resource;
...
public class ResourceRequestBuilder {
    ...
    public ResourceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleSettings/{governanceRoleSetting%2Did}/roleDefinition/resource{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of governanceResource
     */
    public java.util.concurrent.CompletableFuture<GovernanceResource> get(@javax.annotation.Nullable final java.util.function.Consumer<ResourceRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of governanceResource
     */
    public java.util.concurrent.CompletableFuture<GovernanceResource> get(@javax.annotation.Nullable final java.util.function.Consumer<ResourceRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
