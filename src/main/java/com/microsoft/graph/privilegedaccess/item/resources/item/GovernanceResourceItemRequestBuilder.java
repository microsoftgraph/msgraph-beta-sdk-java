...
public class GovernanceResourceItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final GovernanceResource body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GovernanceResource> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GovernanceResource> executionException = new java.util.concurrent.CompletableFuture<GovernanceResource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
