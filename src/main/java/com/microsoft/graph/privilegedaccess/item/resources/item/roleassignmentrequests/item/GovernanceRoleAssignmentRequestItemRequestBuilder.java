package microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item;
...
import microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item.cancel.CancelRequestBuilder;
import microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item.resource.ResourceRequestBuilder;
import microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item.roledefinition.RoleDefinitionRequestBuilder;
import microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item.subject.SubjectRequestBuilder;
import microsoft.graph.privilegedaccess.item.resources.item.roleassignmentrequests.item.updaterequest.UpdateRequestRequestBuilder;
...
public class GovernanceRoleAssignmentRequestItemRequestBuilder {
    ...
    public GovernanceRoleAssignmentRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<GovernanceRoleAssignmentRequestItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of governanceRoleAssignmentRequest
     */
    public java.util.concurrent.CompletableFuture<GovernanceRoleAssignmentRequest> get(@javax.annotation.Nullable final java.util.function.Consumer<GovernanceRoleAssignmentRequestItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final GovernanceRoleAssignmentRequest body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final GovernanceRoleAssignmentRequest body, @javax.annotation.Nullable final java.util.function.Consumer<GovernanceRoleAssignmentRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final GovernanceRoleAssignmentRequest body, @javax.annotation.Nullable final java.util.function.Consumer<GovernanceRoleAssignmentRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
