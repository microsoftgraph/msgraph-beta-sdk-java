package microsoft.graph.privilegedaccess.item;
...
import microsoft.graph.models.PrivilegedAccess;
import microsoft.graph.privilegedaccess.item.resources.item.GovernanceResourceItemRequestBuilder;
import microsoft.graph.privilegedaccess.item.resources.ResourcesRequestBuilder;
import microsoft.graph.privilegedaccess.item.roleassignmentrequests.item.GovernanceRoleAssignmentRequestItemRequestBuilder;
import microsoft.graph.privilegedaccess.item.roleassignmentrequests.RoleAssignmentRequestsRequestBuilder;
import microsoft.graph.privilegedaccess.item.roleassignments.item.GovernanceRoleAssignmentItemRequestBuilder;
import microsoft.graph.privilegedaccess.item.roleassignments.RoleAssignmentsRequestBuilder;
import microsoft.graph.privilegedaccess.item.roledefinitions.item.GovernanceRoleDefinitionItemRequestBuilder;
import microsoft.graph.privilegedaccess.item.roledefinitions.RoleDefinitionsRequestBuilder;
import microsoft.graph.privilegedaccess.item.rolesettings.item.GovernanceRoleSettingItemRequestBuilder;
import microsoft.graph.privilegedaccess.item.rolesettings.RoleSettingsRequestBuilder;
...
public class PrivilegedAccessItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration requestConfig = new PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        final RequestInformation requestInfo = new RequestInformation() {{
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PrivilegedAccess body, @javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final PrivilegedAccessItemRequestBuilderPatchRequestConfiguration requestConfig = new PrivilegedAccessItemRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedAccess> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedAccess::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of privilegedAccess
     */
    public java.util.concurrent.CompletableFuture<PrivilegedAccess> get(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of privilegedAccess
     */
    public java.util.concurrent.CompletableFuture<PrivilegedAccess> get(@javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedAccess::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PrivilegedAccess body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PrivilegedAccess body, @javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PrivilegedAccess body, @javax.annotation.Nullable final java.util.function.Consumer<PrivilegedAccessItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
    ...
    public class PrivilegedAccessItemRequestBuilderDeleteRequestConfiguration {
        /** Request headers */
    ...
    /** Configuration for the request such as headers, query parameters, and middleware options. */
    public class PrivilegedAccessItemRequestBuilderGetRequestConfiguration {
        /** Request headers */
        @javax.annotation.Nullable
        public HashMap<String, String> headers = new HashMap<>();
        /** Request options */
    ...
    /** Configuration for the request such as headers, query parameters, and middleware options. */
    public class PrivilegedAccessItemRequestBuilderPatchRequestConfiguration {
        /** Request headers */
        @javax.annotation.Nullable
        public HashMap<String, String> headers = new HashMap<>();
        /** Request options */
