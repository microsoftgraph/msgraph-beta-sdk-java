package com.microsoft.graph.privilegedaccess.item.rolesettings.item.resource;
...
public class ResourceRequestBuilder {
    ...
    public ResourceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleSettings/{governanceRoleSetting%2Did}/resource{?%24select,%24expand}";
