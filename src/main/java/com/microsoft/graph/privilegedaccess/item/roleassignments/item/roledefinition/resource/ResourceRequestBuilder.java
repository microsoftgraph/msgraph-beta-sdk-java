package com.microsoft.graph.privilegedaccess.item.roleassignments.item.roledefinition.resource;
...
public class ResourceRequestBuilder {
    ...
    public ResourceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/resource{?%24select,%24expand}";
