...
public class PreviewRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a previewRequestBody
     */
    @javax.annotation.Nonnull
    public static PreviewRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PreviewRequestBody currentObject = this;
