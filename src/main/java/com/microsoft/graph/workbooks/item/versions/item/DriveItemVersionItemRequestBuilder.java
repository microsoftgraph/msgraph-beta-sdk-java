package com.microsoft.graph.workbooks.item.versions.item;

import com.microsoft.graph.models.DriveItemVersion;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.workbooks.item.versions.item.content.ContentRequestBuilder;
import com.microsoft.graph.workbooks.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
