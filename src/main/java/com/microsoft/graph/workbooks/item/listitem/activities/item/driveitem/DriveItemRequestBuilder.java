package microsoft.graph.workbooks.item.listitem.activities.item.driveitem;
...
import microsoft.graph.workbooks.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
