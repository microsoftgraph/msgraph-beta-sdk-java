...
import microsoft.graph.workbooks.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.workbooks.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.workbooks.item.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.workbooks.item.activities.item collection
