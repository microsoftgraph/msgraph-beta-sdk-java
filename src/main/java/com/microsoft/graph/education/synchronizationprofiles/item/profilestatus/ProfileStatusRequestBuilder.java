...
public class ProfileStatusRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EducationSynchronizationProfileStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationSynchronizationProfileStatus> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationSynchronizationProfileStatus> executionException = new java.util.concurrent.CompletableFuture<EducationSynchronizationProfileStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
