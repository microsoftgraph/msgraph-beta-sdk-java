...
public class StartRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<StartResponse> post() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, StartResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of startResponse
     */
    public java.util.concurrent.CompletableFuture<StartResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<StartRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of startResponse
     */
    public java.util.concurrent.CompletableFuture<StartResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<StartRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, StartResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
