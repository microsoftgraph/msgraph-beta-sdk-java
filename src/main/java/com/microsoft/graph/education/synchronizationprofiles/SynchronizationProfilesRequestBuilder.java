...
public class SynchronizationProfilesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EducationSynchronizationProfile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationSynchronizationProfileCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationSynchronizationProfileCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EducationSynchronizationProfileCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EducationSynchronizationProfile> post(@javax.annotation.Nonnull final EducationSynchronizationProfile body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationSynchronizationProfile> executionException = new java.util.concurrent.CompletableFuture<EducationSynchronizationProfile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
