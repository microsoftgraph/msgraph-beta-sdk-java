...
public class SynchronizationProfilesRequestBuilder extends BaseRequestBuilder {
    ...
    public EducationSynchronizationProfileCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, EducationSynchronizationProfileCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public EducationSynchronizationProfile post(@jakarta.annotation.Nonnull final EducationSynchronizationProfile body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, EducationSynchronizationProfile::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve the collection of school data synchronization profiles in the tenant. This API is available in the following national cloud deployments.
