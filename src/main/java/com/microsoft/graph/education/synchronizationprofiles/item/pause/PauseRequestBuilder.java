...
public class PauseRequestBuilder {
    ...
    public PauseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/education/synchronizationProfiles/{educationSynchronizationProfile%2Did}/pause";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/educationsynchronizationprofile-pause?view=graph-rest-1.0">Find more info here</a>
     */
