...
public class AssignmentSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EducationAssignmentSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EducationAssignmentSettings> executionException = new java.util.concurrent.CompletableFuture<EducationAssignmentSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
