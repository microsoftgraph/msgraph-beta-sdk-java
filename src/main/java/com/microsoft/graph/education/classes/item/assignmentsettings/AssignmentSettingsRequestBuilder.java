...
public class AssignmentSettingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EducationAssignmentSettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EducationAssignmentSettings> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<EducationAssignmentSettings> executionException = new java.util.concurrent.CompletableFuture<EducationAssignmentSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
