...
public class EducationAssignmentItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.education.me.assignments.item.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.education.me.assignments.item.submissions.item collection
     * @param id Unique identifier of the item
