package com.microsoft.graph.education.me.assignments.item.deactivate;
...
public class DeactivateRequestBuilder extends BaseRequestBuilder {
    ...
    public DeactivateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/deactivate", pathParameters);
    }
    /**
     * Instantiates a new DeactivateRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public DeactivateRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
