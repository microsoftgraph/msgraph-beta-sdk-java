package com.microsoft.graph.education.users.item.assignments;

import com.microsoft.graph.education.users.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.education.users.item.assignments.delta.DeltaRequestBuilder;
