package com.microsoft.graph.education.users.item.assignments.item.resources.item.dependentresources;

import com.microsoft.graph.education.users.item.assignments.item.resources.item.dependentresources.count.CountRequestBuilder;
import com.microsoft.graph.education.users.item.assignments.item.resources.item.dependentresources.item.EducationAssignmentResourceItemRequestBuilder;
