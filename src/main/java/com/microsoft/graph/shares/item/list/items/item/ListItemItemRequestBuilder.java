...
import com.microsoft.graph.shares.item.list.items.item.activities.ActivitiesRequestBuilder;
...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.items.item.activities.item collection
