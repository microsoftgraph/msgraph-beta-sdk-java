...
import microsoft.graph.shares.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.shares.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.shares.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.shares.item.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.shares.item.listItem.activities.item collection
