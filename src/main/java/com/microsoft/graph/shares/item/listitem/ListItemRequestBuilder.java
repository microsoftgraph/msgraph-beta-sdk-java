...
import com.microsoft.graph.shares.item.listitem.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.shares.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.shares.item.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.shares.item.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.listItem.activities.item collection
