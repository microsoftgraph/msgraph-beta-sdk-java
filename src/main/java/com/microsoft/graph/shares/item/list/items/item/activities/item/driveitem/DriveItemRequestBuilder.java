package microsoft.graph.shares.item.list.items.item.activities.item.driveitem;
...
import microsoft.graph.shares.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
