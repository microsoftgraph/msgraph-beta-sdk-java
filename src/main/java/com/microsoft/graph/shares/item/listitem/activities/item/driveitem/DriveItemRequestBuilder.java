package microsoft.graph.shares.item.listitem.activities.item.driveitem;
...
import microsoft.graph.shares.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
