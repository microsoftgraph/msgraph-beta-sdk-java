...
import com.microsoft.graph.shares.item.list.activities.ActivitiesRequestBuilder;
...
public class ListRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.columns.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.shares.item.list.subscriptions.item collection
     * @param id Unique identifier of the item
