package com.microsoft.graph.beta.sites.item.lists.item.contenttypes;
...
import com.microsoft.graph.beta.sites.item.lists.item.contenttypes.addcopy.AddCopyRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.contenttypes.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.contenttypes.item.ContentTypeItemRequestBuilder;
...
public class ContentTypesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/list-list-contenttypes?view=graph-rest-beta">Find more info here</a>
     */
