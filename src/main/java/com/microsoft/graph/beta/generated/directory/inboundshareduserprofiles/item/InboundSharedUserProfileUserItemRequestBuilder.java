package com.microsoft.graph.beta.directory.inboundshareduserprofiles.item;

import com.microsoft.graph.beta.directory.inboundshareduserprofiles.item.exportpersonaldata.ExportPersonalDataRequestBuilder;
import com.microsoft.graph.beta.directory.inboundshareduserprofiles.item.removepersonaldata.RemovePersonalDataRequestBuilder;
import com.microsoft.graph.beta.models.InboundSharedUserProfile;
...
public class InboundSharedUserProfileUserItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link InboundSharedUserProfileUserItemRequestBuilder} and sets the default values.
    ...
    public InboundSharedUserProfileUserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link InboundSharedUserProfileUserItemRequestBuilder} and sets the default values.
    ...
    public InboundSharedUserProfileUserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final InboundSharedUserProfile body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link InboundSharedUserProfileUserItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
