package com.microsoft.graph.beta.devicemanagement.configurationpolicytemplates.item.settingtemplates;

import com.microsoft.graph.beta.devicemanagement.configurationpolicytemplates.item.settingtemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.configurationpolicytemplates.item.settingtemplates.item.DeviceManagementConfigurationSettingTemplateItemRequestBuilder;
...
public class SettingTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SettingTemplatesRequestBuilder} and sets the default values.
    ...
    public SettingTemplatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}/settingTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SettingTemplatesRequestBuilder} and sets the default values.
    ...
    public SettingTemplatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}/settingTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Setting templates
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementConfigurationSettingTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}/settingTemplates", pathParameters);
