...
public class ApproverDelegate implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ApproverDelegate} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ApproverDelegate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
