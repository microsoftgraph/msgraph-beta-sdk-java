package com.microsoft.graph.beta.users.item.messages;
...
import com.microsoft.graph.beta.users.item.messages.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.MessageItemRequestBuilder;
...
public class MessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,includeHiddenMessages*}", pathParameters);
