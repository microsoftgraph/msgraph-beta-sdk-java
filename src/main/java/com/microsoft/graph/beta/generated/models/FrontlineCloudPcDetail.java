...
public class FrontlineCloudPcDetail implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FrontlineCloudPcDetail} and sets the default values.
     */
    public FrontlineCloudPcDetail() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static FrontlineCloudPcDetail createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new FrontlineCloudPcDetail();
    }
    /**
