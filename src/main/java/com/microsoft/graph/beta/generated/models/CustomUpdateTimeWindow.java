...
public class CustomUpdateTimeWindow implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endDay", (n) -> { this.setEndDay(n.getEnumValue(DayOfWeek::forValue)); });
        deserializerMap.put("endTime", (n) -> { this.setEndTime(n.getLocalTimeValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("startDay", (n) -> { this.setStartDay(n.getEnumValue(DayOfWeek::forValue)); });
