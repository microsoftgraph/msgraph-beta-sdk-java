...
public class InferenceData implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link InferenceData} and sets the default values.
     */
     ...
     * @return a {@link InferenceDataConfidenceScore}
     */
    @jakarta.annotation.Nullable
    public InferenceDataConfidenceScore getConfidenceScore() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("confidenceScore", (n) -> { this.setConfidenceScore(n.getObjectValue(InferenceDataConfidenceScore::createFromDiscriminatorValue)); });
     ...
     */
    public void setConfidenceScore(@jakarta.annotation.Nullable final InferenceDataConfidenceScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class InferenceDataConfidenceScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link InferenceDataConfidenceScore} and sets the default values.
         */
        public InferenceDataConfidenceScore() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static InferenceDataConfidenceScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final InferenceDataConfidenceScore result = new InferenceDataConfidenceScore();
