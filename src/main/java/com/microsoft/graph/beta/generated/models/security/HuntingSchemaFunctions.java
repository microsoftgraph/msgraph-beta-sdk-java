...
public class HuntingSchemaFunctions implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Gets the builtInFunctions property value. Prebuilt functions included with Microsoft Defender XDR advanced hunting.
    ...
    /**
     * Gets the savedFunctions property value. Custom functions created by users, including shared functions accessible to all tenant users and personal functions visible only to their creator.
    ...
    /**
     * Sets the builtInFunctions property value. Prebuilt functions included with Microsoft Defender XDR advanced hunting.
    ...
    /**
     * Sets the savedFunctions property value. Custom functions created by users, including shared functions accessible to all tenant users and personal functions visible only to their creator.
