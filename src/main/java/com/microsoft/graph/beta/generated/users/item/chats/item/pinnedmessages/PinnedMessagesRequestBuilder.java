package com.microsoft.graph.beta.users.item.chats.item.pinnedmessages;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PinnedChatMessageInfo;
import com.microsoft.graph.beta.models.PinnedChatMessageInfoCollectionResponse;
import com.microsoft.graph.beta.users.item.chats.item.pinnedmessages.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.pinnedmessages.item.PinnedChatMessageInfoItemRequestBuilder;
...
public class PinnedMessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public PinnedMessagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PinnedMessagesRequestBuilder} and sets the default values.
    ...
    public PinnedMessagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PinnedChatMessageInfo body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages", pathParameters);
