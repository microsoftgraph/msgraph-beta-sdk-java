package com.microsoft.graph.beta.groups.item.sites.item.pages.item.graphsitepage.canvaslayout.verticalsection.webparts.item.getpositionofwebpart;
...
public class GetPositionOfWebPartRequestBuilder extends BaseRequestBuilder {
    ...
    public GetPositionOfWebPartRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart%2Did}/getPositionOfWebPart", pathParameters);
    }
    /**
     * Instantiates a new GetPositionOfWebPartRequestBuilder and sets the default values.
    ...
    public GetPositionOfWebPartRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart%2Did}/getPositionOfWebPart", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a GetPositionOfWebPartRequestBuilder
     */
    @jakarta.annotation.Nonnull
