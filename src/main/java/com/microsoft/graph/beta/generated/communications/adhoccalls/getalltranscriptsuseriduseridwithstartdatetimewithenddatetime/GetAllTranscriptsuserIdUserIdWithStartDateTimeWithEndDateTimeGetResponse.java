...
public class GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDateTimeGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDateTimeGetResponse} and sets the default values.
     */
    ...
    public static GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDateTimeGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetAllTranscriptsuserIdUserIdWithStartDateTimeWithEndDateTimeGetResponse();
    }
    /**
