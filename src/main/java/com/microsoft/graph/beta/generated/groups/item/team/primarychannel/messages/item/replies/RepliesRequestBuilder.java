package com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies;

import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.forwardtochat.ForwardToChatRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.replywithquote.ReplyWithQuoteRequestBuilder;
