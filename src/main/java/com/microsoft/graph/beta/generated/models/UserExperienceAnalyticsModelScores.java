...
public class UserExperienceAnalyticsModelScores extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("meanResourceSpikeTimeScore", (n) -> { this.setMeanResourceSpikeTimeScore(n.getObjectValue(UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore::createFromDiscriminatorValue)); });
     ...
     * @return a {@link UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore}
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore getMeanResourceSpikeTimeScore() {
     ...
     */
    public void setMeanResourceSpikeTimeScore(@jakarta.annotation.Nullable final UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore} and sets the default values.
         */
        public UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore result = new UserExperienceAnalyticsModelScoresMeanResourceSpikeTimeScore();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
