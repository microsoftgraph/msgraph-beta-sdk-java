package com.microsoft.graph.beta.devices.item.transitivememberof;

import com.microsoft.graph.beta.devices.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.devices.item.transitivememberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.devices.item.transitivememberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.devices.item.transitivememberof.item.DirectoryObjectItemRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/device-list-transitivememberof?view=graph-rest-beta">Find more info here</a>
     */
