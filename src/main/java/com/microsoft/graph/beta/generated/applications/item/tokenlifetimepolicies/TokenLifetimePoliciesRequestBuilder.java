package com.microsoft.graph.beta.applications.item.tokenlifetimepolicies;

import com.microsoft.graph.beta.applications.item.tokenlifetimepolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.applications.item.tokenlifetimepolicies.item.TokenLifetimePolicyItemRequestBuilder;
import com.microsoft.graph.beta.applications.item.tokenlifetimepolicies.ref.RefRequestBuilder;
...
public class TokenLifetimePoliciesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/application-list-tokenlifetimepolicies?view=graph-rest-beta">Find more info here</a>
     */
