package com.microsoft.graph.beta.groups.item.transitivememberof;

import com.microsoft.graph.beta.groups.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivememberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivememberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivememberof.item.DirectoryObjectItemRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder extends BaseRequestBuilder {
    ...
    public TransitiveMemberOfRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMemberOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TransitiveMemberOfRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-transitivememberof?view=graph-rest-beta">Find more info here</a>
     */
