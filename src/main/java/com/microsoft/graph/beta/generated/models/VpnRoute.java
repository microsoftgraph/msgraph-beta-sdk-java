...
public class VpnRoute implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link VpnRoute} and sets the default values.
     */
    public VpnRoute() {
    ...
    public String getDestinationPrefix() {
        return this.backingStore.get("destinationPrefix");
    }
    /**
    ...
    public Integer getPrefixSize() {
        return this.backingStore.get("prefixSize");
    }
    /**
    ...
    public void setDestinationPrefix(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("destinationPrefix", value);
    }
    /**
    ...
    public void setPrefixSize(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("prefixSize", value);
    }
}
