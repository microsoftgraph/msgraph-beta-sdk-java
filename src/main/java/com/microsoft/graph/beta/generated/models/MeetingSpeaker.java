...
public class MeetingSpeaker implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MeetingSpeaker} and sets the default values.
     */
     ...
     * @return a {@link MeetingSpeaker}
     */
    @jakarta.annotation.Nonnull
    public static MeetingSpeaker createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("bio", (n) -> { this.setBio(n.getStringValue()); });
     ...
     */
    public void setBio(@jakarta.annotation.Nullable final String value) {
