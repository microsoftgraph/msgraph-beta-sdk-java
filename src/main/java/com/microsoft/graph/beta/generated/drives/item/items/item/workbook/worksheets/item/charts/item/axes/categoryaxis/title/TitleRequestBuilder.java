package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.categoryaxis.title;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.categoryaxis.title.format.FormatRequestBuilder;
