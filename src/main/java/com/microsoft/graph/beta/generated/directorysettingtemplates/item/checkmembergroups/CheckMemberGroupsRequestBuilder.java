package com.microsoft.graph.beta.directorysettingtemplates.item.checkmembergroups;
...
public class CheckMemberGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public CheckMemberGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}/checkMemberGroups", pathParameters);
    }
    /**
     * Instantiates a new {@link CheckMemberGroupsRequestBuilder} and sets the default values.
    ...
    public CheckMemberGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}/checkMemberGroups", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directoryobject-checkmembergroups?view=graph-rest-beta">Find more info here</a>
     */
