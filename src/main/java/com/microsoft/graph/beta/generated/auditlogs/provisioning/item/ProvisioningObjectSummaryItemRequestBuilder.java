package com.microsoft.graph.beta.auditlogs.provisioning.item;
...
public class ProvisioningObjectSummaryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ProvisioningObjectSummaryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ProvisioningObjectSummaryItemRequestBuilder} and sets the default values.
    ...
    public ProvisioningObjectSummaryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}", pathParameters);
