package com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item;

import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item.microsoftgraphwindowsupdatesaddmembers.MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item.microsoftgraphwindowsupdatesaddmembersbyid.MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item.microsoftgraphwindowsupdatesremovemembers.MicrosoftGraphWindowsUpdatesRemoveMembersRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item.microsoftgraphwindowsupdatesremovemembersbyid.MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder;
...
public class UpdatableAssetItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UpdatableAssetItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link UpdatableAssetItemRequestBuilder} and sets the default values.
    ...
    public UpdatableAssetItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}{?%24expand,%24select}", pathParameters);
