...
public class DeviceComplianceScriptError implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DeviceComplianceScriptError} and sets the default values.
     */
     ...
     * @return a {@link DeviceComplianceScriptError}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link DeviceComplianceScriptRulesValidationError}
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceComplianceScriptRulesValidationError", (n) -> { this.setDeviceComplianceScriptRulesValidationError(n.getEnumValue(DeviceComplianceScriptRulesValidationError::forValue)); });
