package com.microsoft.graph.beta.chats.item.messages.item;

import com.microsoft.graph.beta.chats.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.chats.item.messages.item.replies.RepliesRequestBuilder;
import com.microsoft.graph.beta.chats.item.messages.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.chats.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.chats.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.chats.item.messages.item.unsetreaction.UnsetReactionRequestBuilder;
