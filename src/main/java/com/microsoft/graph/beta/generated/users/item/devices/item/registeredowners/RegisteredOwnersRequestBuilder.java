package com.microsoft.graph.beta.users.item.devices.item.registeredowners;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.ref.RefRequestBuilder;
...
public class RegisteredOwnersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.users.item.devices.item.registeredOwners.item collection
    ...
    public RegisteredOwnersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RegisteredOwnersRequestBuilder} and sets the default values.
    ...
    public RegisteredOwnersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
