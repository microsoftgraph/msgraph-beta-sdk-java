package com.microsoft.graph.beta.directory.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities;

import com.microsoft.graph.beta.directory.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities.item.CertificateAuthorityAsEntityItemRequestBuilder;
import com.microsoft.graph.beta.models.CertificateAuthorityAsEntity;
import com.microsoft.graph.beta.models.CertificateAuthorityAsEntityCollectionResponse;
...
public class TrustedCertificateAuthoritiesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link TrustedCertificateAuthoritiesRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/certificatebasedapplicationconfiguration-list-trustedcertificateauthorities?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/certificatebasedapplicationconfiguration-post-trustedcertificateauthorities?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directory/certificateAuthorities/certificateBasedApplicationConfigurations/{certificateBasedApplicationConfiguration%2Did}/trustedCertificateAuthorities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CertificateAuthorityAsEntity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directory/certificateAuthorities/certificateBasedApplicationConfigurations/{certificateBasedApplicationConfiguration%2Did}/trustedCertificateAuthorities", pathParameters);
