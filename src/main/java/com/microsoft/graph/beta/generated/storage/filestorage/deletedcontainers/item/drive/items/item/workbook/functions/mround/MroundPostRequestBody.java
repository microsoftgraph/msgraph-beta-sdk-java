package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.mround;
...
public class MroundPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MroundPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link MroundPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static MroundPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
