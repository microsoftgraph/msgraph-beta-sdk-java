...
public class ExternalItemInformationProtectionLabel implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ExternalItemInformationProtectionLabel} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ExternalItemInformationProtectionLabel createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ExternalItemInformationProtectionLabel();
    }
    /**
