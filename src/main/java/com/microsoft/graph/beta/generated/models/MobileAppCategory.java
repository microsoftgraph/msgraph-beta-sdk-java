...
public class MobileAppCategory extends Entity implements Parsable {
    /**
     * Instantiates a new {@link MobileAppCategory} and sets the default values.
     */
    ...
    public static MobileAppCategory createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
