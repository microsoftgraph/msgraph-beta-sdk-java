package com.microsoft.graph.beta.admin.exchange.tracing.messagetraces;

import com.microsoft.graph.beta.admin.exchange.tracing.messagetraces.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.exchange.tracing.messagetraces.item.ExchangeMessageTraceItemRequestBuilder;
import com.microsoft.graph.beta.models.ExchangeMessageTrace;
import com.microsoft.graph.beta.models.ExchangeMessageTraceCollectionResponse;
...
public class MessageTracesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExchangeMessageTraceItemRequestBuilder byExchangeMessageTraceId(@jakarta.annotation.Nonnull final String exchangeMessageTraceId) {
        ...
        urlTplParams.put("exchangeMessageTrace%2Did", exchangeMessageTraceId);
        return new ExchangeMessageTraceItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    public MessageTracesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MessageTracesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public ExchangeMessageTraceCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ExchangeMessageTraceCollectionResponse::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/exchange/tracing/messageTraces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ExchangeMessageTrace body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/admin/exchange/tracing/messageTraces", pathParameters);
