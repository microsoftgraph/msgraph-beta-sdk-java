package com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.instances;

import com.microsoft.graph.beta.models.EventCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.instances.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.instances.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.instances.item.EventItemRequestBuilder;
