...
public class ManagedDeviceMobileAppConfigurationSettingState implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ManagedDeviceMobileAppConfigurationSettingState} and sets the default values.
     */
     ...
     * @return a {@link ManagedDeviceMobileAppConfigurationSettingState}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("settingInstanceId", (n) -> { this.setSettingInstanceId(n.getStringValue()); });
    ...
    public String getSettingInstanceId() {
        return this.backingStore.get("settingInstanceId");
    }
    /**
    ...
    public void setSettingInstanceId(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("settingInstanceId", value);
    }
    /**
