package com.microsoft.graph.beta.solutions.backuprestore.mailboxexclusionunits;
...
import com.microsoft.graph.beta.solutions.backuprestore.mailboxexclusionunits.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.backuprestore.mailboxexclusionunits.item.MailboxExclusionUnitItemRequestBuilder;
...
public class MailboxExclusionUnitsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxExclusionUnit post(@jakarta.annotation.Nonnull final MailboxExclusionUnit body) {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxExclusionUnit post(@jakarta.annotation.Nonnull final MailboxExclusionUnit body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/mailboxExclusionUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxExclusionUnit body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxExclusionUnit body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/mailboxExclusionUnits", pathParameters);
