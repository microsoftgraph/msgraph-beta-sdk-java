package com.microsoft.graph.beta.devicemanagement.devicehealthscripts;

import com.microsoft.graph.beta.devicemanagement.devicehealthscripts.areglobalscriptsavailable.AreGlobalScriptsAvailableRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicehealthscripts.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicehealthscripts.enableglobalscripts.EnableGlobalScriptsRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicehealthscripts.getremediationsummary.GetRemediationSummaryRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicehealthscripts.item.DeviceHealthScriptItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceHealthScript;
import com.microsoft.graph.beta.models.DeviceHealthScriptCollectionResponse;
...
public class DeviceHealthScriptsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link AreGlobalScriptsAvailableRequestBuilder}
     */
     ...
     * @return a {@link EnableGlobalScriptsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link DeviceHealthScriptsRequestBuilder} and sets the default values.
    ...
    public DeviceHealthScriptsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceHealthScripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceHealthScriptsRequestBuilder} and sets the default values.
    ...
    public DeviceHealthScriptsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceHealthScripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceHealthScript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/deviceHealthScripts", pathParameters);
