package com.microsoft.graph.beta.accessreviews.item.reviewers;

import com.microsoft.graph.beta.accessreviews.item.reviewers.count.CountRequestBuilder;
import com.microsoft.graph.beta.accessreviews.item.reviewers.item.AccessReviewReviewerItemRequestBuilder;
...
public class ReviewersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/accessReviews/{accessReview%2Did}/reviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
