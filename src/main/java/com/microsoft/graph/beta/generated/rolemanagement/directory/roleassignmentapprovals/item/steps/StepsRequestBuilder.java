package com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.item.steps;
...
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.item.steps.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.item.steps.item.ApprovalStepItemRequestBuilder;
...
public class StepsRequestBuilder extends BaseRequestBuilder {
    ...
    public StepsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals/{approval%2Did}/steps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link StepsRequestBuilder} and sets the default values.
    ...
    public StepsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals/{approval%2Did}/steps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ApprovalStep body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals/{approval%2Did}/steps", pathParameters);
