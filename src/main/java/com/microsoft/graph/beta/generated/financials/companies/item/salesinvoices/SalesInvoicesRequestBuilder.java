package com.microsoft.graph.beta.financials.companies.item.salesinvoices;

import com.microsoft.graph.beta.financials.companies.item.salesinvoices.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salesinvoices.item.SalesInvoiceItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SalesInvoiceCollectionResponse;
...
public class SalesInvoicesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SalesInvoicesRequestBuilder} and sets the default values.
    ...
    public SalesInvoicesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SalesInvoicesRequestBuilder} and sets the default values.
    ...
    public SalesInvoicesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get salesInvoices from financials
     * @return a {@link SalesInvoiceCollectionResponse}
    ...
    public SalesInvoiceCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, SalesInvoiceCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     * Get salesInvoices from financials
