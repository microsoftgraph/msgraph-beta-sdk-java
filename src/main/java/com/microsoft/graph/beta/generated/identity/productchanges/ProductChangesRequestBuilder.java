package com.microsoft.graph.beta.identity.productchanges;

import com.microsoft.graph.beta.identity.productchanges.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.productchanges.item.ChangeItemBaseItemRequestBuilder;
import com.microsoft.graph.beta.models.ChangeItemBase;
import com.microsoft.graph.beta.models.ChangeItemBaseCollectionResponse;
...
public class ProductChangesRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ChangeItemBaseItemRequestBuilder byChangeItemBaseId(@jakarta.annotation.Nonnull final String changeItemBaseId) {
        ...
        urlTplParams.put("changeItemBase%2Did", changeItemBaseId);
        return new ChangeItemBaseItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Instantiates a new {@link ProductChangesRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ProductChangesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/productChanges{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ProductChangesRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ProductChangesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public ChangeItemBaseCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ChangeItemBaseCollectionResponse::createFromDiscriminatorValue);
    }
    /**
