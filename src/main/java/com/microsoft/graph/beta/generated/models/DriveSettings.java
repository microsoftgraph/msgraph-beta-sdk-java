...
public class DriveSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DriveSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static DriveSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
