package com.microsoft.graph.beta.security.cases.ediscoverycases.item.legalholds;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.EdiscoveryHoldPolicy;
import com.microsoft.graph.beta.models.security.EdiscoveryHoldPolicyCollectionResponse;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.legalholds.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.legalholds.item.EdiscoveryHoldPolicyItemRequestBuilder;
...
public class LegalHoldsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link EdiscoveryHoldPolicyItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link LegalHoldsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-ediscoverycase-list-legalholds?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EdiscoveryHoldPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-ediscoverycase-post-legalholds?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds", pathParameters);
