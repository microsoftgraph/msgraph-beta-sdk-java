package com.microsoft.graph.beta.users.item.registereddevices;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.registereddevices.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.registereddevices.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.users.item.registereddevices.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.users.item.registereddevices.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.beta.users.item.registereddevices.item.DirectoryObjectItemRequestBuilder;
...
public class RegisteredDevicesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link RegisteredDevicesRequestBuilder} and sets the default values.
    ...
    public RegisteredDevicesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/registeredDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RegisteredDevicesRequestBuilder} and sets the default values.
    ...
    public RegisteredDevicesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/registeredDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
