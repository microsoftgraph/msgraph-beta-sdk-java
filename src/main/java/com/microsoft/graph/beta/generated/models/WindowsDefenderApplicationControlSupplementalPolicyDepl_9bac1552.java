...
public class WindowsDefenderApplicationControlSupplementalPolicyDepl_9bac1552 extends Entity implements Parsable {
    /**
     * Instantiates a new {@link WindowsDefenderApplicationControlSupplementalPolicyDepl_9bac1552} and sets the default values.
     */
    public WindowsDefenderApplicationControlSupplementalPolicyDepl_9bac1552() {
        super();
    }
    /**
    ...
    public static WindowsDefenderApplicationControlSupplementalPolicyDepl_9bac1552 createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WindowsDefenderApplicationControlSupplementalPolicyDepl_9bac1552();
    }
    /**
