package com.microsoft.graph.beta.users.item.manageddevices.item.setcloudpcreviewstatus;
...
public class SetCloudPcReviewStatusPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SetCloudPcReviewStatusPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SetCloudPcReviewStatusPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static SetCloudPcReviewStatusPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
