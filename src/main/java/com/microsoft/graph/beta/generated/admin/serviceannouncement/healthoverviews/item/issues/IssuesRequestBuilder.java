package com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews.item.issues;

import com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews.item.issues.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews.item.issues.item.ServiceHealthIssueItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ServiceHealthIssue;
import com.microsoft.graph.beta.models.ServiceHealthIssueCollectionResponse;
...
public class IssuesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/serviceAnnouncement/healthOverviews/{serviceHealth%2Did}/issues{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
