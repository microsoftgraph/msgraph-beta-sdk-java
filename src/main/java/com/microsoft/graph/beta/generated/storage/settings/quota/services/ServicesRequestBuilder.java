package com.microsoft.graph.beta.storage.settings.quota.services;
...
import com.microsoft.graph.beta.storage.settings.quota.services.count.CountRequestBuilder;
import com.microsoft.graph.beta.storage.settings.quota.services.item.ServiceStorageQuotaBreakdownItemRequestBuilder;
...
public class ServicesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/storage/settings/quota/services{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ServiceStorageQuotaBreakdown body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/storage/settings/quota/services", pathParameters);
