package com.microsoft.graph.beta.security.threatintelligence.hostcomponents;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.HostComponent;
import com.microsoft.graph.beta.models.security.HostComponentCollectionResponse;
import com.microsoft.graph.beta.security.threatintelligence.hostcomponents.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostcomponents.item.HostComponentItemRequestBuilder;
...
public class HostComponentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link HostComponentsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatIntelligence/hostComponents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final HostComponent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/threatIntelligence/hostComponents", pathParameters);
