...
public class RedirectUriWildcardConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RedirectUriWildcardConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RedirectUriWildcardConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriWildcardExcludeFormats getExcludeFormats() {
        return this.backingStore.get("excludeFormats");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("excludeFormats", (n) -> { this.setExcludeFormats(n.getObjectValue(RedirectUriWildcardExcludeFormats::createFromDiscriminatorValue)); });
