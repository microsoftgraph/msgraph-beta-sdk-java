package com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.previousversiondefinition;

import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.previousversiondefinition.category.CategoryRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.previousversiondefinition.definitionfile.DefinitionFileRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.previousversiondefinition.presentations.PresentationsRequestBuilder;
...
public class PreviousVersionDefinitionRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link PreviousVersionDefinitionRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PreviousVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PreviousVersionDefinitionRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PreviousVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GroupPolicyDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public PreviousVersionDefinitionRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
