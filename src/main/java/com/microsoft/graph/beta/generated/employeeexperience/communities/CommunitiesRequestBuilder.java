package com.microsoft.graph.beta.employeeexperience.communities;

import com.microsoft.graph.beta.employeeexperience.communities.count.CountRequestBuilder;
import com.microsoft.graph.beta.employeeexperience.communities.item.CommunityItemRequestBuilder;
import com.microsoft.graph.beta.models.Community;
import com.microsoft.graph.beta.models.CommunityCollectionResponse;
...
public class CommunitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public CommunitiesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CommunitiesRequestBuilder and sets the default values.
    ...
    public CommunitiesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a CommunitiesRequestBuilder
     */
    @jakarta.annotation.Nonnull
