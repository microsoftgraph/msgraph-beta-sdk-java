package com.microsoft.graph.beta.devicemanagement.manageddevices.item.devicehealthscriptstates;

import com.microsoft.graph.beta.devicemanagement.manageddevices.item.devicehealthscriptstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.manageddevices.item.devicehealthscriptstates.withidwithpolicyidwithdeviceid.WithIdWithPolicyIdWithDeviceIdRequestBuilder;
...
public class DeviceHealthScriptStatesRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceHealthScriptStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceHealthScriptStatesRequestBuilder} and sets the default values.
    ...
    public DeviceHealthScriptStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceHealthScriptPolicyState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates", pathParameters);
