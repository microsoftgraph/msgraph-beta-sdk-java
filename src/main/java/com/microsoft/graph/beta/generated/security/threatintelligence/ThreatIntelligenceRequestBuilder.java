package com.microsoft.graph.beta.security.threatintelligence;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.ThreatIntelligence;
import com.microsoft.graph.beta.security.threatintelligence.articleindicators.ArticleIndicatorsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.articles.ArticlesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostcomponents.HostComponentsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostcookies.HostCookiesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostpairs.HostPairsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostports.HostPortsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.HostsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostsslcertificates.HostSslCertificatesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosttrackers.HostTrackersRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.intelligenceprofileindicators.IntelligenceProfileIndicatorsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.intelprofiles.IntelProfilesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.passivednsrecords.PassiveDnsRecordsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.sslcertificates.SslCertificatesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.subdomains.SubdomainsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.vulnerabilities.VulnerabilitiesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.whoishistoryrecords.WhoisHistoryRecordsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.whoisrecords.WhoisRecordsRequestBuilder;
...
public class ThreatIntelligenceRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/security/threatIntelligence", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ThreatIntelligence body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/security/threatIntelligence", pathParameters);
