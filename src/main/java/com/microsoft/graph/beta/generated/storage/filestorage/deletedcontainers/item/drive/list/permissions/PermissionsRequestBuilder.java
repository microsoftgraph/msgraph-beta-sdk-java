package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.permissions;
...
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.permissions.count.CountRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.permissions.item.PermissionItemRequestBuilder;
...
public class PermissionsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/permissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionsRequestBuilder} and sets the default values.
    ...
    public PermissionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/permissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
