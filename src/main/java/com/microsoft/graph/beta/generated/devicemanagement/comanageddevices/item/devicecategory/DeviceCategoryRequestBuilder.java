...
import com.microsoft.graph.beta.devicemanagement.comanageddevices.item.devicecategory.ref.RefRequestBuilder;
...
public class DeviceCategoryRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceCategoryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceCategory", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceCategoryRequestBuilder} and sets the default values.
    ...
    public DeviceCategoryRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceCategory", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceCategory{?%24expand,%24select}", pathParameters);
