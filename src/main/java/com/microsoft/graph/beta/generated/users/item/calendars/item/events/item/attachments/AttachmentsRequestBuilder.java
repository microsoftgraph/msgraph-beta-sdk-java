package com.microsoft.graph.beta.users.item.calendars.item.events.item.attachments;
...
import com.microsoft.graph.beta.users.item.calendars.item.events.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.attachments.item.AttachmentItemRequestBuilder;
