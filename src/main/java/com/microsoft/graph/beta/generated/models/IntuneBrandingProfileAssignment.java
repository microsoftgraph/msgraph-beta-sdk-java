...
public class IntuneBrandingProfileAssignment extends Entity implements Parsable {
    /**
     * Instantiates a new {@link IntuneBrandingProfileAssignment} and sets the default values.
     */
    ...
    public static IntuneBrandingProfileAssignment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
