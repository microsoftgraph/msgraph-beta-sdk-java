...
public class DeviceEnrollmentConfiguration extends Entity implements Parsable {
     ...
     * @return a {@link DeviceEnrollmentConfigurationType}
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceEnrollmentConfigurationType", (n) -> { this.setDeviceEnrollmentConfigurationType(n.getEnumValue(DeviceEnrollmentConfigurationType::forValue)); });
