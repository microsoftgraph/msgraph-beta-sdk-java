package com.microsoft.graph.beta.reports.serviceprincipalsigninactivities;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ServicePrincipalSignInActivity;
import com.microsoft.graph.beta.models.ServicePrincipalSignInActivityCollectionResponse;
import com.microsoft.graph.beta.reports.serviceprincipalsigninactivities.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.serviceprincipalsigninactivities.item.ServicePrincipalSignInActivityItemRequestBuilder;
...
public class ServicePrincipalSignInActivitiesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ServicePrincipalSignInActivitiesRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/servicePrincipalSignInActivities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ServicePrincipalSignInActivity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/servicePrincipalSignInActivities", pathParameters);
