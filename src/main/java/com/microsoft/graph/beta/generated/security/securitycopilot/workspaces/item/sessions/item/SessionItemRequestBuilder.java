package com.microsoft.graph.beta.security.securitycopilot.workspaces.item.sessions.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.securitycopilot.Session;
import com.microsoft.graph.beta.security.securitycopilot.workspaces.item.sessions.item.prompts.PromptsRequestBuilder;
...
public class SessionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PromptsRequestBuilder prompts() {
        return new PromptsRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public SessionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions/{session%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SessionItemRequestBuilder} and sets the default values.
    ...
    public SessionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions/{session%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions/{session%2Did}{?%24expand,%24select}", pathParameters);
