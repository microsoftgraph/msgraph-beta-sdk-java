package com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.installedapps.item.upgrade;
...
public class UpgradeRequestBuilder extends BaseRequestBuilder {
    ...
    public UpgradeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/installedApps/{teamsAppInstallation%2Did}/upgrade", pathParameters);
    }
    /**
     * Instantiates a new {@link UpgradeRequestBuilder} and sets the default values.
    ...
    public UpgradeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/installedApps/{teamsAppInstallation%2Did}/upgrade", rawUrl);
    }
    /**
     * Upgrade an app installation within a chat.
     * @param body The request body
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/chat-teamsappinstallation-upgrade?view=graph-rest-beta">Find more info here</a>
     */
