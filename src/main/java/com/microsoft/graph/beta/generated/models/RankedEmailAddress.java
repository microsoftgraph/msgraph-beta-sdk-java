...
public class RankedEmailAddress implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("rank", (n) -> { this.setRank(n.getObjectValue(RankedEmailAddressRank::createFromDiscriminatorValue)); });
     ...
     * @return a {@link RankedEmailAddressRank}
     */
    @jakarta.annotation.Nullable
    public RankedEmailAddressRank getRank() {
     ...
     */
    public void setRank(@jakarta.annotation.Nullable final RankedEmailAddressRank value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class RankedEmailAddressRank implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link RankedEmailAddressRank} and sets the default values.
         */
        public RankedEmailAddressRank() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static RankedEmailAddressRank createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final RankedEmailAddressRank result = new RankedEmailAddressRank();
