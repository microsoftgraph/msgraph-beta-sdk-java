package com.microsoft.graph.beta.sites.item.informationprotection.bitlocker.recoverykeys;

import com.microsoft.graph.beta.models.BitlockerRecoveryKeyCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.informationprotection.bitlocker.recoverykeys.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.informationprotection.bitlocker.recoverykeys.item.BitlockerRecoveryKeyItemRequestBuilder;
...
public class RecoveryKeysRequestBuilder extends BaseRequestBuilder {
    ...
    public RecoveryKeysRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new RecoveryKeysRequestBuilder and sets the default values.
    ...
    public RecoveryKeysRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
