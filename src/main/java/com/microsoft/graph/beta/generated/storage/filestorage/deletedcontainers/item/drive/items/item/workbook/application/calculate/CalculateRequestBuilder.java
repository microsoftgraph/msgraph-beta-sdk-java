package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.application.calculate;
...
public class CalculateRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CalculateRequestBuilder} and sets the default values.
    ...
    public CalculateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/application/calculate", pathParameters);
    }
    /**
     * Instantiates a new {@link CalculateRequestBuilder} and sets the default values.
    ...
    public CalculateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/application/calculate", rawUrl);
    }
    /**
     * Recalculate all currently opened workbooks in Excel.
     * @param body The request body
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/workbookapplication-calculate?view=graph-rest-beta">Find more info here</a>
     */
