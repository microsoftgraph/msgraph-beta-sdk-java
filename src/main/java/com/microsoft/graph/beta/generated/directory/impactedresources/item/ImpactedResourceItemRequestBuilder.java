package com.microsoft.graph.beta.directory.impactedresources.item;

import com.microsoft.graph.beta.directory.impactedresources.item.acceptrisk.AcceptRiskRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.addtag.AddTagRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.applyalternatemitigation.ApplyAlternateMitigationRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.complete.CompleteRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.dismiss.DismissRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.markplanned.MarkPlannedRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.postpone.PostponeRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.reactivate.ReactivateRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.removetag.RemoveTagRequestBuilder;
import com.microsoft.graph.beta.directory.impactedresources.item.tags.TagsRequestBuilder;
...
public class ImpactedResourceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ImpactedResourceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/impactedResources/{impactedResource%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
