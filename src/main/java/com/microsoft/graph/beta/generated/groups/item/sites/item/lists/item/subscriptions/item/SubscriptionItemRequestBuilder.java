package com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions.item;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
...
public class SubscriptionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SubscriptionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SubscriptionItemRequestBuilder} and sets the default values.
    ...
    public SubscriptionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}{?%24expand,%24select}", pathParameters);
