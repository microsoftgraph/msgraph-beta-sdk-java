...
public class CloudPcConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CloudPcConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("osLocale", (n) -> { this.setOsLocale(n.getStringValue()); });
    ...
    public String getOsLocale() {
        return this.backingStore.get("osLocale");
    }
    /**
    ...
    public void setOsLocale(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("osLocale", value);
    }
}
