package com.microsoft.graph.beta.places.item.graphbuilding.children;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlaceCollectionResponse;
import com.microsoft.graph.beta.places.item.graphbuilding.children.count.CountRequestBuilder;
import com.microsoft.graph.beta.places.item.graphbuilding.children.item.PlaceItemRequestBuilder;
...
public class ChildrenRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public PlaceItemRequestBuilder byPlaceId1(@jakarta.annotation.Nonnull final String placeId1) {
        Objects.requireNonNull(placeId1);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("place%2Did1", placeId1);
    ...
    public ChildrenRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChildrenRequestBuilder} and sets the default values.
    ...
    public ChildrenRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public PlaceCollectionResponse get() {
        return get(null);
    }
    /**
     * A collection of children places that is only used in the Upsert places API.
     ...
     */
    @jakarta.annotation.Nullable
    public PlaceCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
