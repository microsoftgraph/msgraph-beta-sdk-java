package com.microsoft.graph.beta.teamwork.teamtemplates.item.definitions.item.teamdefinition.installedapps.item.teamsapp;
...
public class TeamsAppRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsAppRequestBuilder} and sets the default values.
    ...
    public TeamsAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", rawUrl);
    }
    /**
