...
public class OperationApprovalRequestsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a OperationApprovalRequestItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    ...
    public OperationApprovalRequestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OperationApprovalRequestsRequestBuilder and sets the default values.
    ...
    public OperationApprovalRequestsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * The Operation Approval Requests
     * @return a OperationApprovalRequestCollectionResponse
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a OperationApprovalRequestsRequestBuilder
     */
    @jakarta.annotation.Nonnull
