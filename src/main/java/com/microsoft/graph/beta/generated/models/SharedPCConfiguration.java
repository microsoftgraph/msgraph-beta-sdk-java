...
public class SharedPCConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("fastFirstSignIn", (n) -> { this.setFastFirstSignIn(n.getEnumValue(Enablement::forValue)); });
        ...
        deserializerMap.put("localStorage", (n) -> { this.setLocalStorage(n.getEnumValue(Enablement::forValue)); });
        deserializerMap.put("maintenanceStartTime", (n) -> { this.setMaintenanceStartTime(n.getLocalTimeValue()); });
        deserializerMap.put("setAccountManager", (n) -> { this.setSetAccountManager(n.getEnumValue(Enablement::forValue)); });
        deserializerMap.put("setEduPolicies", (n) -> { this.setSetEduPolicies(n.getEnumValue(Enablement::forValue)); });
        deserializerMap.put("setPowerPolicies", (n) -> { this.setSetPowerPolicies(n.getEnumValue(Enablement::forValue)); });
        deserializerMap.put("signInOnResume", (n) -> { this.setSignInOnResume(n.getEnumValue(Enablement::forValue)); });
