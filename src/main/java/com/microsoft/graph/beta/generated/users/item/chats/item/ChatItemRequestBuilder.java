package com.microsoft.graph.beta.users.item.chats.item;

import com.microsoft.graph.beta.models.Chat;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.chats.item.completemigration.CompleteMigrationRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.hideforuser.HideForUserRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.installedapps.InstalledAppsRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.lastmessagepreview.LastMessagePreviewRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.markchatreadforuser.MarkChatReadForUserRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.markchatunreadforuser.MarkChatUnreadForUserRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.members.MembersRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.MessagesRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.permissiongrants.PermissionGrantsRequestBuilder;
...
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.TargetedMessagesRequestBuilder;
