package com.microsoft.graph.beta.planner.plans.item.goals;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerGoalCollectionResponse;
import com.microsoft.graph.beta.planner.plans.item.goals.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.goals.item.PlannerGoalItemRequestBuilder;
...
public class GoalsRequestBuilder extends BaseRequestBuilder {
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GoalsRequestBuilder} and sets the default values.
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @deprecated
     * private preview elements are required to be marked as deprecated as of 2025-03/Tasks_And_Plans on 2025-03-26 and will be removed 2026-03-26
     * @see <a href="https://learn.microsoft.com/graph/api/plannerplan-list-goals?view=graph-rest-beta">Find more info here</a>
     */
