package com.microsoft.graph.beta.external.connections.item.items.item;

import com.microsoft.graph.beta.external.connections.item.items.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.items.item.microsoftgraphexternalconnectorsaddactivities.MicrosoftGraphExternalConnectorsAddActivitiesRequestBuilder;
...
public class ExternalItemItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalitem-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
