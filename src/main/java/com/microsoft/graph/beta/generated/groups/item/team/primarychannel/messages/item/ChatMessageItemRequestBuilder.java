package com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item;

import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.RepliesRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.unsetreaction.UnsetReactionRequestBuilder;
