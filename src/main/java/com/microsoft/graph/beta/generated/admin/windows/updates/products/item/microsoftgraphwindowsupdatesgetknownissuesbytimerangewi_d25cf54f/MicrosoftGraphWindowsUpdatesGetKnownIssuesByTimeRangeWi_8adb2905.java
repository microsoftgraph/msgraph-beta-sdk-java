...
public class MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905 extends BaseRequestBuilder {
     ...
     */
    public MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final Integer daysInPast) {
     ...
     */
    @jakarta.annotation.Nullable
    public GetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllAc_1ad18fab get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
