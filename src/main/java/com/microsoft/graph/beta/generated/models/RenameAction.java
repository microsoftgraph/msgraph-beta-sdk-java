...
public class RenameAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RenameAction} and sets the default values.
     */
    public RenameAction() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static RenameAction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getNewName() {
        return this.backingStore.get("newName");
    }
    /**
    ...
    public String getOldName() {
        return this.backingStore.get("oldName");
    }
    /**
    ...
    public void setNewName(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("newName", value);
    }
    /**
     ...
     */
    public void setOldName(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("oldName", value);
    }
}
