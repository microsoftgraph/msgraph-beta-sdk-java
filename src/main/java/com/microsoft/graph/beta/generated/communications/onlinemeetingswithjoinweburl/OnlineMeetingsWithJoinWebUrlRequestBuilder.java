package com.microsoft.graph.beta.communications.onlinemeetingswithjoinweburl;

import com.microsoft.graph.beta.communications.onlinemeetingswithjoinweburl.getvirtualappointmentjoinweburl.GetVirtualAppointmentJoinWebUrlRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingswithjoinweburl.sendvirtualappointmentremindersms.SendVirtualAppointmentReminderSmsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingswithjoinweburl.sendvirtualappointmentsms.SendVirtualAppointmentSmsRequestBuilder;
...
public class OnlineMeetingsWithJoinWebUrlRequestBuilder extends BaseRequestBuilder {
    ...
    public OnlineMeetingsWithJoinWebUrlRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String joinWebUrl) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')", pathParameters);
    ...
    public OnlineMeetingsWithJoinWebUrlRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}'){?%24expand,%24select}", pathParameters);
