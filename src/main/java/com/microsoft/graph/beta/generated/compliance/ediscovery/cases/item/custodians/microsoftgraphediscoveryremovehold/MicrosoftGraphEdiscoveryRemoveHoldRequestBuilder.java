package com.microsoft.graph.beta.compliance.ediscovery.cases.item.custodians.microsoftgraphediscoveryremovehold;
...
public class MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/microsoft.graph.ediscovery.removeHold", pathParameters);
    }
    /**
     * Instantiates a new {@link MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder} and sets the default values.
    ...
    public MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/microsoft.graph.ediscovery.removeHold", rawUrl);
    }
    /**
