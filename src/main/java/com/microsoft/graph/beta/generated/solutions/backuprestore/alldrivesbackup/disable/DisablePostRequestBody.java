package com.microsoft.graph.beta.solutions.backuprestore.alldrivesbackup.disable;

import com.microsoft.graph.beta.models.FullServiceBackupDisableMode;
...
public class DisablePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DisablePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DisablePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DisablePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
