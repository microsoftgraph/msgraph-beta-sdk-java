package com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.send;
...
public class SendRequestBuilder extends BaseRequestBuilder {
    ...
    public SendRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/send", pathParameters);
    }
    /**
     * Instantiates a new {@link SendRequestBuilder} and sets the default values.
    ...
    public SendRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/send", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/message-send?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void post() {
        post(null);
