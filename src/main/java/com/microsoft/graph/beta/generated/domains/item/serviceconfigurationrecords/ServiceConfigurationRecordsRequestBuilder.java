package com.microsoft.graph.beta.domains.item.serviceconfigurationrecords;

import com.microsoft.graph.beta.domains.item.serviceconfigurationrecords.count.CountRequestBuilder;
import com.microsoft.graph.beta.domains.item.serviceconfigurationrecords.item.DomainDnsRecordItemRequestBuilder;
import com.microsoft.graph.beta.models.DomainDnsRecord;
import com.microsoft.graph.beta.models.DomainDnsRecordCollectionResponse;
...
public class ServiceConfigurationRecordsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/domain-list-serviceconfigurationrecords?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/domains/{domain%2Did}/serviceConfigurationRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
