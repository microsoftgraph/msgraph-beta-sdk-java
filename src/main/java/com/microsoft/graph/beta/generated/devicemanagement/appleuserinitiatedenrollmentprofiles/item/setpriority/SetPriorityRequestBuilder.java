package com.microsoft.graph.beta.devicemanagement.appleuserinitiatedenrollmentprofiles.item.setpriority;
...
public class SetPriorityRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link SetPriorityRequestBuilder} and sets the default values.
    ...
    public SetPriorityRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/appleUserInitiatedEnrollmentProfiles/{appleUserInitiatedEnrollmentProfile%2Did}/setPriority", pathParameters);
    }
    /**
     * Instantiates a new {@link SetPriorityRequestBuilder} and sets the default values.
    ...
    public SetPriorityRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/appleUserInitiatedEnrollmentProfiles/{appleUserInitiatedEnrollmentProfile%2Did}/setPriority", rawUrl);
    }
    /**
