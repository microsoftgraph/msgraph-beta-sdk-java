package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.userprocessingresults.item.taskprocessingresults.item.subject.mailboxsettings;
