package com.microsoft.graph.beta.groups.item.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections;

import com.microsoft.graph.beta.groups.item.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections.item.HorizontalSectionItemRequestBuilder;
import com.microsoft.graph.beta.models.HorizontalSection;
import com.microsoft.graph.beta.models.HorizontalSectionCollectionResponse;
...
public class HorizontalSectionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a HorizontalSectionItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    ...
    public HorizontalSectionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/horizontalSections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new HorizontalSectionsRequestBuilder and sets the default values.
    ...
    public HorizontalSectionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/horizontalSections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Collection of horizontal sections on the SharePoint page.
     * @return a HorizontalSectionCollectionResponse
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a HorizontalSectionsRequestBuilder
     */
    @jakarta.annotation.Nonnull
