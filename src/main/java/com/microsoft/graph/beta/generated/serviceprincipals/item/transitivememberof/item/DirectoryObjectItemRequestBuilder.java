package com.microsoft.graph.beta.serviceprincipals.item.transitivememberof.item;

import com.microsoft.graph.beta.models.DirectoryObject;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.serviceprincipals.item.transitivememberof.item.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.transitivememberof.item.graphdirectoryrole.GraphDirectoryRoleRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.transitivememberof.item.graphgroup.GraphGroupRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
