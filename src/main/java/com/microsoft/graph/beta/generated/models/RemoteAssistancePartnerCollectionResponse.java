...
public class RemoteAssistancePartnerCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link RemoteAssistancePartnerCollectionResponse} and sets the default values.
     */
     ...
     * @return a {@link RemoteAssistancePartnerCollectionResponse}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(RemoteAssistancePartner::createFromDiscriminatorValue)); });
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<RemoteAssistancePartner> value) {
