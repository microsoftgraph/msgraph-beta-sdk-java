package com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item;

import com.microsoft.graph.beta.models.ChatMessage;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.messages.item.replies.item.unsetreaction.UnsetReactionRequestBuilder;
