package com.microsoft.graph.beta.privilegedroleassignments;
...
import com.microsoft.graph.beta.privilegedroleassignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.item.PrivilegedRoleAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.my.MyRequestBuilder;
...
public class PrivilegedRoleAssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PrivilegedRoleAssignmentsRequestBuilder} and sets the default values.
    ...
    public PrivilegedRoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedRoleAssignmentsRequestBuilder} and sets the default values.
    ...
    public PrivilegedRoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegedRoleAssignment post(@jakarta.annotation.Nonnull final PrivilegedRoleAssignment body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegedRoleAssignment post(@jakarta.annotation.Nonnull final PrivilegedRoleAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrivilegedRoleAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/privilegedRoleAssignments", pathParameters);
