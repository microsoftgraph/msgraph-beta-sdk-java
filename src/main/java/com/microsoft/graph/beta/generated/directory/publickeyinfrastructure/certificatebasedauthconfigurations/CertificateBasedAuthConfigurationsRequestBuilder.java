package com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations;

import com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations.item.CertificateBasedAuthPkiItemRequestBuilder;
import com.microsoft.graph.beta.models.CertificateBasedAuthPki;
import com.microsoft.graph.beta.models.CertificateBasedAuthPkiCollectionResponse;
...
public class CertificateBasedAuthConfigurationsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public CertificateBasedAuthConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/publickeyinfrastructureroot-list-certificatebasedauthconfigurations?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/publickeyinfrastructureroot-post-certificatebasedauthconfigurations?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CertificateBasedAuthPki body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations", pathParameters);
