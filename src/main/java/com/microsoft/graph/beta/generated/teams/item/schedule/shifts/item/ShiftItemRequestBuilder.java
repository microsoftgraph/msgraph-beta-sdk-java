package com.microsoft.graph.beta.teams.item.schedule.shifts.item;
...
public class ShiftItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ShiftItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/shifts/{shift%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ShiftItemRequestBuilder} and sets the default values.
    ...
    public ShiftItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/shifts/{shift%2Did}", rawUrl);
    }
    /**
     * Delete a shift from the schedule.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/shift-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link Shift}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/shift-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Shift}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/shift-put?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teams/{team%2Did}/schedule/shifts/{shift%2Did}{?%24expand,%24select}", pathParameters);
