package com.microsoft.graph.beta.users.item.calendar;

import com.microsoft.graph.beta.models.Calendar;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendar.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.calendarpermissions.CalendarPermissionsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.calendarview.CalendarViewRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.EventsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.getschedule.GetScheduleRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.permanentdelete.PermanentDeleteRequestBuilder;
