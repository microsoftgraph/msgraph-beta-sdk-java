package com.microsoft.graph.beta.users.item.onlinemeetings.getalltranscripts;
...
public class GetAllTranscriptsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetAllTranscriptsRequestBuilder} and sets the default values.
    ...
    public GetAllTranscriptsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/getAllTranscripts(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllTranscriptsRequestBuilder} and sets the default values.
    ...
    public GetAllTranscriptsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/getAllTranscripts(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @return a {@link GetAllTranscriptsGetResponse}
