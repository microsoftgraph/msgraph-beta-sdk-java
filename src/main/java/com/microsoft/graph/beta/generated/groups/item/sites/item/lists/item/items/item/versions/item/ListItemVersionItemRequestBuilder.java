package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions.item;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
