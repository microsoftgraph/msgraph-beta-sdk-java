package com.microsoft.graph.beta.groups.item.team.owners.item;

import com.microsoft.graph.beta.groups.item.team.owners.item.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.owners.item.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/owners/{user%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UserItemRequestBuilder and sets the default values.
    ...
    public UserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/owners/{user%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
