package com.microsoft.graph.beta.users.item.security.informationprotection.sensitivitylabels.microsoftgraphsecurityevaluateclassificationresults;
...
/**
 * Provides operations to call the evaluateClassificationResults method. Original name: MicrosoftGraphSecurityEvaluateClassificationResultsRequestBuilder
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec(rawUrl, requestAdapter);
    }
    /**
