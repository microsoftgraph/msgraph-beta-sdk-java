package com.microsoft.graph.beta.users.item.oauth2permissiongrants;

import com.microsoft.graph.beta.models.OAuth2PermissionGrantCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.oauth2permissiongrants.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.oauth2permissiongrants.item.OAuth2PermissionGrantItemRequestBuilder;
...
public class Oauth2PermissionGrantsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/user-list-oauth2permissiongrants?view=graph-rest-beta">Find more info here</a>
     */
