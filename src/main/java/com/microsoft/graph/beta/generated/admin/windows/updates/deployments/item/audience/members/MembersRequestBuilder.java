package com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members;

import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.item.UpdatableAssetItemRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.microsoftgraphwindowsupdatesenrollassets.MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.microsoftgraphwindowsupdatesenrollassetsbyid.MicrosoftGraphWindowsUpdatesEnrollAssetsByIdRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.microsoftgraphwindowsupdatesunenrollassets.MicrosoftGraphWindowsUpdatesUnenrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.microsoftgraphwindowsupdatesunenrollassetsbyid.MicrosoftGraphWindowsUpdatesUnenrollAssetsByIdRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
    ...
    public MembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link MembersRequestBuilder} and sets the default values.
    ...
    public MembersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
