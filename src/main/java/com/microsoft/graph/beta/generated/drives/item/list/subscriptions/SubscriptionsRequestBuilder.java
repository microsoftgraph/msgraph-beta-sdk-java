package com.microsoft.graph.beta.drives.item.list.subscriptions;

import com.microsoft.graph.beta.drives.item.list.subscriptions.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.subscriptions.getvapidpublickey.GetVapidPublicKeyRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.subscriptions.item.SubscriptionItemRequestBuilder;
