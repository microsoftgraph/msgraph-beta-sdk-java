package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.tables.item.sort.apply;

import com.microsoft.graph.beta.models.WorkbookSortField;
