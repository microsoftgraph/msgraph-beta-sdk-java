package com.microsoft.graph.beta.security.threatintelligence.hosts.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.Host;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.childhostpairs.ChildHostPairsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.components.ComponentsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.cookies.CookiesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.hostpairs.HostPairsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.parenthostpairs.ParentHostPairsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.passivedns.PassiveDnsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.passivednsreverse.PassiveDnsReverseRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.ports.PortsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.reputation.ReputationRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.sslcertificates.SslCertificatesRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.subdomains.SubdomainsRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.trackers.TrackersRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosts.item.whois.WhoisRequestBuilder;
...
public class HostItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link Host}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-host-get?view=graph-rest-beta">Find more info here</a>
     */
