package com.microsoft.graph.beta.solutions.backuprestore.mailboxinclusionrules;

import com.microsoft.graph.beta.models.MailboxProtectionRule;
import com.microsoft.graph.beta.models.MailboxProtectionRuleCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.backuprestore.mailboxinclusionrules.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.backuprestore.mailboxinclusionrules.item.MailboxProtectionRuleItemRequestBuilder;
...
public class MailboxInclusionRulesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxProtectionRule post(@jakarta.annotation.Nonnull final MailboxProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxProtectionRule post(@jakarta.annotation.Nonnull final MailboxProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/mailboxInclusionRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/mailboxInclusionRules", pathParameters);
