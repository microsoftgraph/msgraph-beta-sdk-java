...
public class ScheduleSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ScheduleSettings} and sets the default values.
     */
    ...
    public GradualRolloutSettings getGradualRollout() {
        return this.backingStore.get("gradualRollout");
    }
    /**
    ...
    public void setGradualRollout(@jakarta.annotation.Nullable final GradualRolloutSettings value) {
        this.backingStore.set("gradualRollout", value);
    }
    /**
