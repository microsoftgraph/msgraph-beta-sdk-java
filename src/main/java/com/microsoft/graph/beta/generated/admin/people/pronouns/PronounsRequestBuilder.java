package com.microsoft.graph.beta.admin.people.pronouns;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PronounsSettings;
...
public class PronounsRequestBuilder extends BaseRequestBuilder {
    ...
    public PronounsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/people/pronouns", pathParameters);
    }
    /**
     * Instantiates a new {@link PronounsRequestBuilder} and sets the default values.
    ...
    public PronounsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/people/pronouns", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/peopleadminsettings-list-pronouns?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link PronounsSettings}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/pronounssettings-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
