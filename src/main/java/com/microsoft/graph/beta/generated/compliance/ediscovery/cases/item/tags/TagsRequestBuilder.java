package com.microsoft.graph.beta.compliance.ediscovery.cases.item.tags;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.tags.count.CountRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.tags.item.TagItemRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.tags.microsoftgraphediscoveryashierarchy.MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder;
...
public class TagsRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder microsoftGraphEdiscoveryAsHierarchy() {
        return new MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the tags property of the microsoft.graph.ediscovery.case entity.
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public TagItemRequestBuilder byTagId(@jakarta.annotation.Nonnull final String tagId) {
        Objects.requireNonNull(tagId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("tag%2Did", tagId);
     ...
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-case-list-tags?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-case-post-tags?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    @Deprecated
    public Tag post(@jakarta.annotation.Nonnull final Tag body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public Tag post(@jakarta.annotation.Nonnull final Tag body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Tag body) {
