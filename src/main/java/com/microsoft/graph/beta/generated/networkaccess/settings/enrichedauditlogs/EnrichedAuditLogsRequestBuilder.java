package com.microsoft.graph.beta.networkaccess.settings.enrichedauditlogs;
...
public class EnrichedAuditLogsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link EnrichedAuditLogsRequestBuilder} and sets the default values.
    ...
    public EnrichedAuditLogsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/settings/enrichedAuditLogs{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EnrichedAuditLogsRequestBuilder} and sets the default values.
    ...
    public EnrichedAuditLogsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/settings/enrichedAuditLogs{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/networkAccess/settings/enrichedAuditLogs", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final EnrichedAuditLogs body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/networkAccess/settings/enrichedAuditLogs", pathParameters);
