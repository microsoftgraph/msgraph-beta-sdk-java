package com.microsoft.graph.beta.compliance.ediscovery.cases.item.sourcecollections.item.custodiansources;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.sourcecollections.item.custodiansources.count.CountRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.sourcecollections.item.custodiansources.item.DataSourceItemRequestBuilder;
...
public class CustodianSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public CustodianSourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/custodianSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link CustodianSourcesRequestBuilder} and sets the default values.
