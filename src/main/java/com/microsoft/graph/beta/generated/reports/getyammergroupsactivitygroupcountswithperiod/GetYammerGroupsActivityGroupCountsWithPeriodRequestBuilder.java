package com.microsoft.graph.beta.reports.getyammergroupsactivitygroupcountswithperiod;
...
public class GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
