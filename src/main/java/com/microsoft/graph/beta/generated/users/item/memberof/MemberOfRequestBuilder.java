package com.microsoft.graph.beta.users.item.memberof;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.memberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.users.item.memberof.graphdirectoryrole.GraphDirectoryRoleRequestBuilder;
import com.microsoft.graph.beta.users.item.memberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.users.item.memberof.item.DirectoryObjectItemRequestBuilder;
...
public class MemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-memberof?view=graph-rest-beta">Find more info here</a>
     */
