package com.microsoft.graph.beta.users.item.adhoccalls.item.transcripts.item;

import com.microsoft.graph.beta.models.CallTranscript;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.adhoccalls.item.transcripts.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.users.item.adhoccalls.item.transcripts.item.metadatacontent.MetadataContentRequestBuilder;
...
public class CallTranscriptItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/calltranscript-get?view=graph-rest-beta">Find more info here</a>
     */
