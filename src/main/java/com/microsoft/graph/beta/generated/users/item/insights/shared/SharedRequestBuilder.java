package com.microsoft.graph.beta.users.item.insights.shared;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SharedInsight;
import com.microsoft.graph.beta.models.SharedInsightCollectionResponse;
import com.microsoft.graph.beta.users.item.insights.shared.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.insights.shared.item.SharedInsightItemRequestBuilder;
...
public class SharedRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SharedRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/insights/shared{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SharedInsight body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/insights/shared", pathParameters);
