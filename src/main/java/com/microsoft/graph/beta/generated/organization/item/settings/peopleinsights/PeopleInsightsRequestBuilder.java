package com.microsoft.graph.beta.organization.item.settings.peopleinsights;

import com.microsoft.graph.beta.models.InsightsSettings;
...
public class PeopleInsightsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link PeopleInsightsRequestBuilder} and sets the default values.
    ...
    public PeopleInsightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings/peopleInsights", pathParameters);
    }
    /**
     * Instantiates a new {@link PeopleInsightsRequestBuilder} and sets the default values.
    ...
    public PeopleInsightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings/peopleInsights", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/organizationsettings-list-peopleinsights?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link InsightsSettings}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/insightssettings-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/organization/{organization%2Did}/settings/peopleInsights{?%24expand,%24select}", pathParameters);
