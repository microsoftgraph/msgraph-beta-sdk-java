package com.microsoft.graph.beta.organization.item.branding.localizations.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OrganizationalBrandingLocalization;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.backgroundimage.BackgroundImageRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.bannerlogo.BannerLogoRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.customcss.CustomCSSRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.favicon.FaviconRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.headerlogo.HeaderLogoRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.squarelogo.SquareLogoRequestBuilder;
import com.microsoft.graph.beta.organization.item.branding.localizations.item.squarelogodark.SquareLogoDarkRequestBuilder;
...
public class OrganizationalBrandingLocalizationItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link OrganizationalBrandingLocalization}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
