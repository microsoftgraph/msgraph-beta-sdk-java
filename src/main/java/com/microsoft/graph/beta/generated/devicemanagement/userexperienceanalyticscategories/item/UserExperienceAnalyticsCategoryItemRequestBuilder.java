package com.microsoft.graph.beta.devicemanagement.userexperienceanalyticscategories.item;

import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticscategories.item.metricvalues.MetricValuesRequestBuilder;
...
public class UserExperienceAnalyticsCategoryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UserExperienceAnalyticsCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserExperienceAnalyticsCategoryItemRequestBuilder} and sets the default values.
    ...
    public UserExperienceAnalyticsCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory%2Did}{?%24expand,%24select}", pathParameters);
