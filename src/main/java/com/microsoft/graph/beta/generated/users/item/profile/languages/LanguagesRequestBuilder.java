package com.microsoft.graph.beta.users.item.profile.languages;

import com.microsoft.graph.beta.models.LanguageProficiency;
import com.microsoft.graph.beta.models.LanguageProficiencyCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.profile.languages.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.profile.languages.item.LanguageProficiencyItemRequestBuilder;
...
public class LanguagesRequestBuilder extends BaseRequestBuilder {
    ...
    public LanguagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/languages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link LanguagesRequestBuilder} and sets the default values.
    ...
    public LanguagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/languages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Retrieve a list of languageProficiency objects from a user's profile.
     * @return a {@link LanguageProficiencyCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final LanguageProficiency body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/profile/languages", pathParameters);
