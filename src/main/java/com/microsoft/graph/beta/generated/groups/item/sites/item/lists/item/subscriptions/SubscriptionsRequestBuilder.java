package com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions.getvapidpublickey.GetVapidPublicKeyRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.subscriptions.item.SubscriptionItemRequestBuilder;
