package com.microsoft.graph.beta.drives.item.items.item.preview;
...
public class PreviewPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link PreviewPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PreviewPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("zoom", (n) -> { this.setZoom(n.getObjectValue(PreviewPostRequestBodyZoom::createFromDiscriminatorValue)); });
     ...
     * @return a {@link PreviewPostRequestBodyZoom}
     */
    @jakarta.annotation.Nullable
    public PreviewPostRequestBodyZoom getZoom() {
     ...
     */
    public void setZoom(@jakarta.annotation.Nullable final PreviewPostRequestBodyZoom value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class PreviewPostRequestBodyZoom implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link PreviewPostRequestBodyZoom} and sets the default values.
         */
        public PreviewPostRequestBodyZoom() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static PreviewPostRequestBodyZoom createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final PreviewPostRequestBodyZoom result = new PreviewPostRequestBodyZoom();
