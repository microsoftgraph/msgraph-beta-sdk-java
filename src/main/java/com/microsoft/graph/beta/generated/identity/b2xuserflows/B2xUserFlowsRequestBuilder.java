package com.microsoft.graph.beta.identity.b2xuserflows;

import com.microsoft.graph.beta.identity.b2xuserflows.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.b2xuserflows.item.B2xIdentityUserFlowItemRequestBuilder;
import com.microsoft.graph.beta.models.B2xIdentityUserFlow;
import com.microsoft.graph.beta.models.B2xIdentityUserFlowCollectionResponse;
...
public class B2xUserFlowsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identitycontainer-list-b2xuserflows?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/identitycontainer-post-b2xuserflows?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/b2xUserFlows{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
