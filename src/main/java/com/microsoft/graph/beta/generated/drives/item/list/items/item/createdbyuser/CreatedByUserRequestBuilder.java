package com.microsoft.graph.beta.drives.item.list.items.item.createdbyuser;

import com.microsoft.graph.beta.drives.item.list.items.item.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.items.item.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
