package com.microsoft.graph.beta.users.item.sponsors;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.sponsors.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.sponsors.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.users.item.sponsors.ref.RefRequestBuilder;
...
public class SponsorsRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.users.item.sponsors.item collection
    ...
    /**
     * Instantiates a new {@link SponsorsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SponsorsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/sponsors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SponsorsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SponsorsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-sponsors?view=graph-rest-beta">Find more info here</a>
     */
