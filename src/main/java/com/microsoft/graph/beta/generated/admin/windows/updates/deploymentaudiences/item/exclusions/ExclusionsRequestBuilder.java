package com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions;

import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.item.UpdatableAssetItemRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.microsoftgraphwindowsupdatesenrollassets.MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.microsoftgraphwindowsupdatesenrollassetsbyid.MicrosoftGraphWindowsUpdatesEnrollAssetsByIdRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.microsoftgraphwindowsupdatesunenrollassets.MicrosoftGraphWindowsUpdatesUnenrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.exclusions.microsoftgraphwindowsupdatesunenrollassetsbyid.MicrosoftGraphWindowsUpdatesUnenrollAssetsByIdRequestBuilder;
...
public class ExclusionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ExclusionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExclusionsRequestBuilder} and sets the default values.
    ...
    public ExclusionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/windowsupdates-deploymentaudience-list-exclusions?view=graph-rest-beta">Find more info here</a>
     */
