...
public class GetWindowsUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetWindowsUpdateAlertSummaryReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetWindowsUpdateAlertSummaryReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetWindowsUpdateAlertSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
