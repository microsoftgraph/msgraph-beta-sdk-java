package com.microsoft.graph.beta.alloweddatalocations;

import com.microsoft.graph.beta.alloweddatalocations.count.CountRequestBuilder;
import com.microsoft.graph.beta.alloweddatalocations.item.AllowedDataLocationItemRequestBuilder;
import com.microsoft.graph.beta.models.AllowedDataLocation;
import com.microsoft.graph.beta.models.AllowedDataLocationCollectionResponse;
...
public class AllowedDataLocationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/allowedDataLocations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
