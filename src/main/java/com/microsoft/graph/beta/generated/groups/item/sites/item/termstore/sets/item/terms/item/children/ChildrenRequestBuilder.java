package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.terms.item.children;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.terms.item.children.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.terms.item.children.item.TermItemRequestBuilder;
