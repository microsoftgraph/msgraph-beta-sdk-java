package com.microsoft.graph.beta.education.me.assignments.item.submissions.item;

import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.excuse.ExcuseRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.outcomes.OutcomesRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.reassign.ReassignRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.resources.ResourcesRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.returnescaped.ReturnRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.setupresourcesfolder.SetUpResourcesFolderRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.submit.SubmitRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.submittedresources.SubmittedResourcesRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.submissions.item.unsubmit.UnsubmitRequestBuilder;
