package com.microsoft.graph.beta.agreements.item.files;

import com.microsoft.graph.beta.agreements.item.files.count.CountRequestBuilder;
import com.microsoft.graph.beta.agreements.item.files.item.AgreementFileLocalizationItemRequestBuilder;
