package com.microsoft.graph.beta.chats;

import com.microsoft.graph.beta.chats.allmessages.AllMessagesRequestBuilder;
import com.microsoft.graph.beta.chats.count.CountRequestBuilder;
import com.microsoft.graph.beta.chats.getallmessages.GetAllMessagesRequestBuilder;
import com.microsoft.graph.beta.chats.getallretainedmessages.GetAllRetainedMessagesRequestBuilder;
import com.microsoft.graph.beta.chats.item.ChatItemRequestBuilder;
...
public class ChatsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/chats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
