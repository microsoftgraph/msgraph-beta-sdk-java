...
public class SpecifiedCaptiveNetworkPlugins implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public java.util.List<String> getAllowedBundleIdentifiers() {
        return this.backingStore.get("allowedBundleIdentifiers");
    }
    /**
    ...
    public void setAllowedBundleIdentifiers(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("allowedBundleIdentifiers", value);
    }
    /**
