...
import com.microsoft.graph.beta.app.calls.item.participants.muteall.MuteAllRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Participant;
import com.microsoft.graph.beta.models.ParticipantCollectionResponse;
...
public class ParticipantsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link MuteAllRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public ParticipantsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/participants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ParticipantsRequestBuilder} and sets the default values.
    ...
    public ParticipantsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/participants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
