package com.microsoft.graph.beta.security.casemanagement.cases.item.relations;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.casemanagement.Relation;
import com.microsoft.graph.beta.models.security.casemanagement.RelationCollectionResponse;
import com.microsoft.graph.beta.security.casemanagement.cases.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.casemanagement.cases.item.relations.item.RelationItemRequestBuilder;
...
public class RelationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RelationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}/relations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RelationsRequestBuilder} and sets the default values.
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-case-post-relations?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
