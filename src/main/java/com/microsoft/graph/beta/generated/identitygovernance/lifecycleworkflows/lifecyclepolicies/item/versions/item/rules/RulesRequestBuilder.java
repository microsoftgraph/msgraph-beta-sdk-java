package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.rules;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.rules.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.rules.item.LifecyclePolicyRuleItemRequestBuilder;
...
public class RulesRequestBuilder extends BaseRequestBuilder {
    ...
    public RulesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/lifecyclePolicies/{lifecyclePolicy%2Did}/versions/{lifecyclePolicy%2Did1}/rules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RulesRequestBuilder} and sets the default values.
    ...
    public RulesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/lifecyclePolicies/{lifecyclePolicy%2Did}/versions/{lifecyclePolicy%2Did1}/rules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
