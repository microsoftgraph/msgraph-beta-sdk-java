package com.microsoft.graph.beta.serviceprincipals.item.licensedetails.getteamslicensingdetails;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamsLicensingDetails;
...
public class GetTeamsLicensingDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetTeamsLicensingDetailsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails/getTeamsLicensingDetails()", pathParameters);
    }
    /**
     * Instantiates a new {@link GetTeamsLicensingDetailsRequestBuilder} and sets the default values.
    ...
    public GetTeamsLicensingDetailsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails/getTeamsLicensingDetails()", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/licensedetails-getteamslicensingdetails?view=graph-rest-beta">Find more info here</a>
     */
