...
public class UserManagementOptions implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UserManagementOptions} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static UserManagementOptions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public AdditionalUserOptions getAdditionalOptions() {
     ...
     */
    public void setAdditionalOptions(@jakarta.annotation.Nullable final AdditionalUserOptions value) {
