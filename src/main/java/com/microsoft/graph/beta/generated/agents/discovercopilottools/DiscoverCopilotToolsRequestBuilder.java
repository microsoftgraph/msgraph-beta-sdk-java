...
public class DiscoverCopilotToolsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public DiscoverCopilotToolsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public DiscoverCopilotToolsGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
