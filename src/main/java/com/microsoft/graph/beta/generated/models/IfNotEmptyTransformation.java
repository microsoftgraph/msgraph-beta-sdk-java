...
public class IfNotEmptyTransformation extends CustomClaimTransformation implements Parsable {
    /**
     * Instantiates a new {@link IfNotEmptyTransformation} and sets the default values.
     */
    public IfNotEmptyTransformation() {
        super();
     ...
     * @return a {@link IfNotEmptyTransformation}
     */
    @jakarta.annotation.Nonnull
    public static IfNotEmptyTransformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
