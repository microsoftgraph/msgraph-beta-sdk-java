...
public class AnalyzedEmailRecipientDetail implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AnalyzedEmailRecipientDetail} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AnalyzedEmailRecipientDetail createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AnalyzedEmailRecipientDetail();
    }
    /**
