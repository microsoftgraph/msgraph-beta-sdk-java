package com.microsoft.graph.beta.users.item.cloudpcs.validatebulkresize;
...
public class ValidateBulkResizeRequestBuilder extends BaseRequestBuilder {
    ...
    public ValidateBulkResizeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/cloudPCs/validateBulkResize", pathParameters);
    }
    /**
     * Instantiates a new {@link ValidateBulkResizeRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/cloudpc-validatebulkresize?view=graph-rest-beta">Find more info here</a>
     */
