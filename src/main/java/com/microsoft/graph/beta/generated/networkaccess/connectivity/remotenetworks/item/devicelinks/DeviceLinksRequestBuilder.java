package com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.devicelinks;

import com.microsoft.graph.beta.models.networkaccess.DeviceLink;
import com.microsoft.graph.beta.models.networkaccess.DeviceLinkCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.devicelinks.count.CountRequestBuilder;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.devicelinks.item.DeviceLinkItemRequestBuilder;
...
public class DeviceLinksRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link DeviceLinksRequestBuilder} and sets the default values.
    ...
    public DeviceLinkCollectionResponse get() {
        return get(null);
    }
    /**
     * Retrieves a specific device link associated with a remote network.
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceLinkCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceLink post(@jakarta.annotation.Nonnull final DeviceLink body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceLink post(@jakarta.annotation.Nonnull final DeviceLink body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/deviceLinks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceLink body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/deviceLinks", pathParameters);
