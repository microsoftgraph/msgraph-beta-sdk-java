...
public class MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequ_71c2adef(rawUrl, requestAdapter);
    }
    /**
