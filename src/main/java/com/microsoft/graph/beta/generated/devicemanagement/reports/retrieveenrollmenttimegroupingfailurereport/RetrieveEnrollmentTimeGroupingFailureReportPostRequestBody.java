...
public class RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody();
    }
    /**
