package com.microsoft.graph.beta.admin.edge;

import com.microsoft.graph.beta.admin.edge.internetexplorermode.InternetExplorerModeRequestBuilder;
import com.microsoft.graph.beta.models.Edge;
...
public class EdgeRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link EdgeRequestBuilder} and sets the default values.
    ...
    public EdgeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/edge", pathParameters);
    }
    /**
     * Instantiates a new {@link EdgeRequestBuilder} and sets the default values.
    ...
    public EdgeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/edge", rawUrl);
    }
    /**
    ...
    public Edge get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, Edge::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/edge{?%24expand,%24select}", pathParameters);
