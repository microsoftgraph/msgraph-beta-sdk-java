package com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SynchronizationJob;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.bulkupload.BulkUploadRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.pause.PauseRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.provisionondemand.ProvisionOnDemandRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.restart.RestartRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.SchemaRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.validatecredentials.ValidateCredentialsRequestBuilder;
...
public class SynchronizationJobItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-get?view=graph-rest-beta">Find more info here</a>
     */
