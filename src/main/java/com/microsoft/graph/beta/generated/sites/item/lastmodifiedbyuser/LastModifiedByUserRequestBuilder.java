package com.microsoft.graph.beta.sites.item.lastmodifiedbyuser;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.sites.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.sites.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lastModifiedByUser{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new LastModifiedByUserRequestBuilder and sets the default values.
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lastModifiedByUser{?%24select,%24expand}", rawUrl);
    }
    /**
