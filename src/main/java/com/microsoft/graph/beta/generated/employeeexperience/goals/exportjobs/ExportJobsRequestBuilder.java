...
public class ExportJobsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a GoalsExportJobItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    ...
    public ExportJobsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/goals/exportJobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ExportJobsRequestBuilder and sets the default values.
    ...
    public ExportJobsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/goals/exportJobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of goalsExportJob objects and their properties in a Viva Goals organization.
     * @return a GoalsExportJobCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/goals-list-exportjobs?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/goals-post-exportjobs?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
