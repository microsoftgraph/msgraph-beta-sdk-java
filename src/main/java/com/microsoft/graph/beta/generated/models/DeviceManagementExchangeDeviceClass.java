...
public class DeviceManagementExchangeDeviceClass implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeviceManagementExchangeDeviceClass} and sets the default values.
     */
     ...
     * @return a {@link DeviceManagementExchangeDeviceClass}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(DeviceManagementExchangeAccessRuleType::forValue)); });
     ...
     * @return a {@link DeviceManagementExchangeAccessRuleType}
     */
    @jakarta.annotation.Nullable
