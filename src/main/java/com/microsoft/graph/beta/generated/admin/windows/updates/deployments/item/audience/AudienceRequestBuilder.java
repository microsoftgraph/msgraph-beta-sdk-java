package com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience;

import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.applicablecontent.ApplicableContentRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.exclusions.ExclusionsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.members.MembersRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.microsoftgraphwindowsupdatesupdateaudience.MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.microsoftgraphwindowsupdatesupdateaudiencebyid.MicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder;
...
public class AudienceRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience{?%24expand,%24select}", pathParameters);
