package com.microsoft.graph.beta.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.item.decisions.item.insights;

import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.item.decisions.item.insights.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.item.decisions.item.insights.item.GovernanceInsightItemRequestBuilder;
