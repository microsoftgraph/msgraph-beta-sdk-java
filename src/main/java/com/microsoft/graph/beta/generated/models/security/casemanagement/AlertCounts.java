...
public class AlertCounts implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AlertCounts} and sets the default values.
     */
    public AlertCounts() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static AlertCounts createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public IncidentSeverityCounts getBySeverity() {
        return this.backingStore.get("bySeverity");
    }
    /**
     * Gets the byStatus property value. The alert counts grouped by alert status.
     * @return a {@link AlertStatusCounts}
     */
    @jakarta.annotation.Nullable
    public AlertStatusCounts getByStatus() {
        return this.backingStore.get("byStatus");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("bySeverity", (n) -> { this.setBySeverity(n.getObjectValue(IncidentSeverityCounts::createFromDiscriminatorValue)); });
        deserializerMap.put("byStatus", (n) -> { this.setByStatus(n.getObjectValue(AlertStatusCounts::createFromDiscriminatorValue)); });
     ...
     * @param value Value to set for the bySeverity property.
     */
    public void setBySeverity(@jakarta.annotation.Nullable final IncidentSeverityCounts value) {
        this.backingStore.set("bySeverity", value);
    }
    /**
     * Sets the byStatus property value. The alert counts grouped by alert status.
     * @param value Value to set for the byStatus property.
     */
    public void setByStatus(@jakarta.annotation.Nullable final AlertStatusCounts value) {
        this.backingStore.set("byStatus", value);
    }
    /**
