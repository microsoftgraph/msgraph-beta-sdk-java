package com.microsoft.graph.beta.app.onlinemeetings.item;

import com.microsoft.graph.beta.app.onlinemeetings.item.aiinsights.AiInsightsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.alternativerecording.AlternativeRecordingRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.AttendanceReportsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.attendeereport.AttendeeReportRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.broadcastrecording.BroadcastRecordingRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.getvirtualappointmentjoinweburl.GetVirtualAppointmentJoinWebUrlRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.meetingattendancereport.MeetingAttendanceReportRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.recording.RecordingRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.recordings.RecordingsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.registration.RegistrationRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.sendvirtualappointmentremindersms.SendVirtualAppointmentReminderSmsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.sendvirtualappointmentsms.SendVirtualAppointmentSmsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.transcripts.TranscriptsRequestBuilder;
...
public class OnlineMeetingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}", pathParameters);
