package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.insights.microsoftgraphidentitygovernanceworkflowsprocessedbycat_458cb5f3;

import com.microsoft.graph.beta.models.identitygovernance.WorkflowsInsightsByCategory;
...
public class MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c} and sets the default values.
     * @param endDateTime Usage: endDateTime={endDateTime}
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @param startDateTime Usage: startDateTime={startDateTime}
     */
    public MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final OffsetDateTime endDateTime, @jakarta.annotation.Nullable final OffsetDateTime startDateTime) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identitygovernance-insights-workflowsprocessedbycategory?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c(rawUrl, requestAdapter);
    }
    /**
