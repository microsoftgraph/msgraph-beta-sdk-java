...
public class LanguageMetric implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link LanguageMetric} and sets the default values.
     */
     ...
     * @return a {@link LanguageMetric}
     */
    @jakarta.annotation.Nonnull
    public static LanguageMetric createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
