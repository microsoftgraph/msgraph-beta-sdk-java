package com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Site;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.columns.ColumnsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.contenttypes.ContentTypesRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.drive.DriveRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.drives.DrivesRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.externalcolumns.ExternalColumnsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.informationprotection.InformationProtectionRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.items.ItemsRequestBuilder;
...
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.lists.ListsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.onenote.OnenoteRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.recyclebin.RecycleBinRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.sites.SitesRequestBuilder;
import com.microsoft.graph.beta.sites.item.getbypathwithpath.getbypathwithpath1.termstore.TermStoreRequestBuilder;
...
public class GetByPathWithPath1RequestBuilder extends BaseRequestBuilder {
    ...
    public GetByPathWithPath1RequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String path1) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')", pathParameters);
    ...
    public GetByPathWithPath1RequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')", rawUrl);
    }
    /**
