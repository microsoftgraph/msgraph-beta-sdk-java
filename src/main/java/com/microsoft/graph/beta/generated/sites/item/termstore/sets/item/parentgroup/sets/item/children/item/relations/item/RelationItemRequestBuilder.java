package com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.termstore.Relation;
import com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.toterm.ToTermRequestBuilder;
