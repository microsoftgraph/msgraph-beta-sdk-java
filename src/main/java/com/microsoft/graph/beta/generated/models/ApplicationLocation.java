...
public class ApplicationLocation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ApplicationLocation} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ApplicationLocation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
