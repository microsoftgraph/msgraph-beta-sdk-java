...
public class CaseExportOperation extends CaseOperation implements Parsable {
     ...
     * @return a CaseExportOperationExportOptions
     */
    @jakarta.annotation.Nullable
    public CaseExportOperationExportOptions getExportOptions() {
     ...
     * @return a CaseExportOperationExportStructure
     */
    @jakarta.annotation.Nullable
    public CaseExportOperationExportStructure getExportStructure() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exportOptions", (n) -> { this.setExportOptions(n.getEnumValue(CaseExportOperationExportOptions::forValue)); });
        deserializerMap.put("exportStructure", (n) -> { this.setExportStructure(n.getEnumValue(CaseExportOperationExportStructure::forValue)); });
     ...
     */
    public void setExportOptions(@jakarta.annotation.Nullable final CaseExportOperationExportOptions value) {
     ...
     */
    public void setExportStructure(@jakarta.annotation.Nullable final CaseExportOperationExportStructure value) {
