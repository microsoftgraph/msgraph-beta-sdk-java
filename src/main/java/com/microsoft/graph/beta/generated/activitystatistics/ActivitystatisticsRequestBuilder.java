package com.microsoft.graph.beta.activitystatistics;

import com.microsoft.graph.beta.activitystatistics.count.CountRequestBuilder;
import com.microsoft.graph.beta.activitystatistics.item.ActivityStatisticsItemRequestBuilder;
...
public class ActivitystatisticsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ActivityStatisticsItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ActivitystatisticsRequestBuilder} and sets the default values.
    ...
    public ActivitystatisticsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/activitystatistics{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ActivitystatisticsRequestBuilder} and sets the default values.
    ...
    public ActivitystatisticsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/activitystatistics{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
