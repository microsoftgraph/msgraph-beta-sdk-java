package com.microsoft.graph.beta.privacy;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Privacy;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.SubjectRightsRequestsRequestBuilder;
...
public class PrivacyRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/privacy{?%24expand,%24select}", pathParameters);
