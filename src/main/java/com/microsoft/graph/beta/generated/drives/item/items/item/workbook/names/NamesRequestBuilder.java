package com.microsoft.graph.beta.drives.item.items.item.workbook.names;

import com.microsoft.graph.beta.drives.item.items.item.workbook.names.add.AddRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.names.addformulalocal.AddFormulaLocalRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.names.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.names.item.WorkbookNamedItemItemRequestBuilder;
