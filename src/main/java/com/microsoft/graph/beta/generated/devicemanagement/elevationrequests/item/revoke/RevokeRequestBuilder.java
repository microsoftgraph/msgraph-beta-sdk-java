package com.microsoft.graph.beta.devicemanagement.elevationrequests.item.revoke;
...
public class RevokeRequestBuilder extends BaseRequestBuilder {
    ...
    public RevokeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/elevationRequests/{privilegeManagementElevationRequest%2Did}/revoke", pathParameters);
    }
    /**
     * Instantiates a new {@link RevokeRequestBuilder} and sets the default values.
    ...
    public RevokeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/elevationRequests/{privilegeManagementElevationRequest%2Did}/revoke", rawUrl);
    }
    /**
    ...
    public PrivilegeManagementElevationRequest post(@jakarta.annotation.Nonnull final RevokePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegeManagementElevationRequest post(@jakarta.annotation.Nonnull final RevokePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
