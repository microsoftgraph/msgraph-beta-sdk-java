package com.microsoft.graph.beta.solutions.approval.approvalitems.item.requests.item;
...
public class ApprovalItemRequestItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ApprovalItemRequestItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ApprovalItemRequestItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/approval/approvalItems/{approvalItem%2Did}/requests/{approvalItemRequest%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApprovalItemRequestItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ApprovalItemRequestItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/approval/approvalItems/{approvalItem%2Did}/requests/{approvalItemRequest%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/approval/approvalItems/{approvalItem%2Did}/requests/{approvalItemRequest%2Did}{?%24expand,%24select}", pathParameters);
