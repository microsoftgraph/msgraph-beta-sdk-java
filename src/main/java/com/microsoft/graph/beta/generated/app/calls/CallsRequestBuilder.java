package com.microsoft.graph.beta.app.calls;

import com.microsoft.graph.beta.app.calls.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.calls.item.CallItemRequestBuilder;
import com.microsoft.graph.beta.app.calls.logteleconferencedevicequality.LogTeleconferenceDeviceQualityRequestBuilder;
...
public class CallsRequestBuilder extends BaseRequestBuilder {
    ...
    public CallsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link CallsRequestBuilder} and sets the default values.
    ...
    public CallsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get calls from app
