package com.microsoft.graph.beta.sites.item.onenote.notebooks.item;

import com.microsoft.graph.beta.models.Notebook;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.SectionsRequestBuilder;
...
public class NotebookItemRequestBuilder extends BaseRequestBuilder {
    ...
    public NotebookItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link NotebookItemRequestBuilder} and sets the default values.
    ...
    public NotebookItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Notebook body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}", pathParameters);
