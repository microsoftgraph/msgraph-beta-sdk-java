package com.microsoft.graph.beta.places.item.graphbuilding.mapescaped.levels.item.fixtures.item;
...
public class FixtureMapItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/fixturemap-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link FixtureMap}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/fixturemap-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
