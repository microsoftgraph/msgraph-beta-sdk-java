...
public class DeploymentState implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DeploymentState} and sets the default values.
     */
     ...
     * @return a {@link DeploymentStateValue}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("effectiveValue", (n) -> { this.setEffectiveValue(n.getEnumValue(DeploymentStateValue::forValue)); });
        ...
        deserializerMap.put("requestedValue", (n) -> { this.setRequestedValue(n.getEnumValue(RequestedDeploymentStateValue::forValue)); });
     ...
     * @return a {@link java.util.List<DeploymentStateReason>}
     */
    @jakarta.annotation.Nullable
     ...
     * @return a {@link RequestedDeploymentStateValue}
     */
    @jakarta.annotation.Nullable
