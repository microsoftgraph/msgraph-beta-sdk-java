package com.microsoft.graph.beta.identitygovernance.accessreviews.definitions.item.instances.item.decisions.item.instance.stages.item.decisions.recordalldecisions;
