package com.microsoft.graph.beta.employeeexperience.learningproviders.item.learningcourseactivities;

import com.microsoft.graph.beta.employeeexperience.learningproviders.item.learningcourseactivities.count.CountRequestBuilder;
import com.microsoft.graph.beta.employeeexperience.learningproviders.item.learningcourseactivities.item.LearningCourseActivityItemRequestBuilder;
...
public class LearningCourseActivitiesRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/employeeexperienceuser-post-learningcourseactivities?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
