package com.microsoft.graph.beta.drives.item.items.item.versions.item.restoreversion;
...
public class RestoreVersionRequestBuilder extends BaseRequestBuilder {
    ...
    public RestoreVersionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/restoreVersion", pathParameters);
    }
    /**
     * Instantiates a new {@link RestoreVersionRequestBuilder} and sets the default values.
    ...
    public RestoreVersionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/restoreVersion", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/driveitemversion-restoreversion?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
