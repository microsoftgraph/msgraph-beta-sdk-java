package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.items.item.permissions.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Permission;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.items.item.permissions.item.grant.GrantRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.items.item.permissions.item.revokegrants.RevokeGrantsRequestBuilder;
...
public class PermissionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/permissions/{permission%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionItemRequestBuilder} and sets the default values.
    ...
    public PermissionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/permissions/{permission%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
