package com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.stages.item.decisions.item.instance.contactedreviewers;

import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.stages.item.decisions.item.instance.contactedreviewers.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.stages.item.decisions.item.instance.contactedreviewers.item.AccessReviewReviewerItemRequestBuilder;
...
public class ContactedReviewersRequestBuilder extends BaseRequestBuilder {
    ...
    public ContactedReviewersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/contactedReviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ContactedReviewersRequestBuilder} and sets the default values.
    ...
    public ContactedReviewersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/contactedReviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
