package com.microsoft.graph.beta.reports.userinsights.daily.mfacompletions.item;

import com.microsoft.graph.beta.models.MfaCompletionMetric;
...
public class MfaCompletionMetricItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MfaCompletionMetricItemRequestBuilder} and sets the default values.
    ...
    public MfaCompletionMetricItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/daily/mfaCompletions/{mfaCompletionMetric%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link MfaCompletionMetricItemRequestBuilder} and sets the default values.
    ...
    public MfaCompletionMetricItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/daily/mfaCompletions/{mfaCompletionMetric%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
