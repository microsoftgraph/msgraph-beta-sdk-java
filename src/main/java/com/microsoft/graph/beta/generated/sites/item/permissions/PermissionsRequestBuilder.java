package com.microsoft.graph.beta.sites.item.permissions;
...
import com.microsoft.graph.beta.sites.item.permissions.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.permissions.item.PermissionItemRequestBuilder;
...
public class PermissionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/site-list-permissions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/site-post-permissions?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
