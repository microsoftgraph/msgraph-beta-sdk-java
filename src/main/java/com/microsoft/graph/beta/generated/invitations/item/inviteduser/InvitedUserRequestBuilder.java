package com.microsoft.graph.beta.invitations.item.inviteduser;

import com.microsoft.graph.beta.invitations.item.inviteduser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.invitations.item.inviteduser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class InvitedUserRequestBuilder extends BaseRequestBuilder {
    ...
    public InvitedUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/invitations/{invitation%2Did}/invitedUser{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new InvitedUserRequestBuilder and sets the default values.
    ...
    public InvitedUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/invitations/{invitation%2Did}/invitedUser{?%24select,%24expand}", rawUrl);
    }
    /**
