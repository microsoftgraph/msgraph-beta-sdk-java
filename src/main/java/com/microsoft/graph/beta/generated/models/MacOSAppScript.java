...
public class MacOSAppScript implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MacOSAppScript} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MacOSAppScript createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the scriptContent property value. The base64 encoded shell script (.sh) that assists managing macOS apps.
     * @return a {@link String}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the scriptContent property value. The base64 encoded shell script (.sh) that assists managing macOS apps.
