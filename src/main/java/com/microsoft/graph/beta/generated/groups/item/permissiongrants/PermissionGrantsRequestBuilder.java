package com.microsoft.graph.beta.groups.item.permissiongrants;

import com.microsoft.graph.beta.groups.item.permissiongrants.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
...
public class PermissionGrantsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-permissiongrants?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
