...
public class CrossTenantGroupSyncInbound implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CrossTenantGroupSyncInbound} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CrossTenantGroupSyncInbound createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CrossTenantGroupSyncInbound();
    }
    /**
