package com.microsoft.graph.beta.drives.item.items.item.workbook.names.item;

import com.microsoft.graph.beta.drives.item.items.item.workbook.names.item.range.RangeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.names.item.worksheet.WorksheetRequestBuilder;
...
public class WorkbookNamedItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkbookNamedItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkbookNamedItemItemRequestBuilder} and sets the default values.
    ...
    public WorkbookNamedItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}{?%24expand,%24select}", pathParameters);
