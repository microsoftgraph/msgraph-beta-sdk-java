package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackageswithuniquename.movetocatalog;
...
public class MoveToCatalogRequestBuilder extends BaseRequestBuilder {
    ...
    public MoveToCatalogRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/moveToCatalog", pathParameters);
    }
    /**
     * Instantiates a new {@link MoveToCatalogRequestBuilder} and sets the default values.
    ...
    public MoveToCatalogRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/moveToCatalog", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/accesspackage-movetocatalog?view=graph-rest-beta">Find more info here</a>
     */
