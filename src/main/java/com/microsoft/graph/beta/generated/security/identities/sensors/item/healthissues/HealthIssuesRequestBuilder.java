package com.microsoft.graph.beta.security.identities.sensors.item.healthissues;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.HealthIssueCollectionResponse;
import com.microsoft.graph.beta.security.identities.sensors.item.healthissues.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.identities.sensors.item.healthissues.item.HealthIssueItemRequestBuilder;
...
public class HealthIssuesRequestBuilder extends BaseRequestBuilder {
    ...
    public HealthIssuesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/sensors/{sensor%2Did}/healthIssues{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link HealthIssuesRequestBuilder} and sets the default values.
    ...
    public HealthIssuesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/identities/sensors/{sensor%2Did}/healthIssues{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
