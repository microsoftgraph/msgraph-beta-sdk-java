package com.microsoft.graph.beta.identityprotection.riskyusers.item.history;

import com.microsoft.graph.beta.identityprotection.riskyusers.item.history.count.CountRequestBuilder;
import com.microsoft.graph.beta.identityprotection.riskyusers.item.history.item.RiskyUserHistoryItemItemRequestBuilder;
...
public class HistoryRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
