...
public class ManagementTemplateStepTenantSummaryCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link ManagementTemplateStepTenantSummaryCollectionResponse} and sets the default values.
     */
     ...
     * @return a {@link ManagementTemplateStepTenantSummaryCollectionResponse}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(ManagementTemplateStepTenantSummary::createFromDiscriminatorValue)); });
