package com.microsoft.graph.beta.shares.item.list.items.item.versions;
...
import com.microsoft.graph.beta.shares.item.list.items.item.versions.count.CountRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.items.item.versions.item.ListItemVersionItemRequestBuilder;
