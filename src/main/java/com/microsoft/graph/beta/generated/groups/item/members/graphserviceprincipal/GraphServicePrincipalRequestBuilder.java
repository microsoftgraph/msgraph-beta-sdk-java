package com.microsoft.graph.beta.groups.item.members.graphserviceprincipal;

import com.microsoft.graph.beta.groups.item.members.graphserviceprincipal.count.CountRequestBuilder;
...
public class GraphServicePrincipalRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphServicePrincipalRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/members/graph.servicePrincipal{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphServicePrincipalRequestBuilder} and sets the default values.
