...
public class RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca} and sets the default values.
     * @param ids Usage: ids={ids}
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String ids) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsRe_d92dd7ca(rawUrl, requestAdapter);
    }
    /**
     * Invoke function retrieveWindowsQualityUpdateCatalogItemDetails
     */
