package com.microsoft.graph.beta.devicemanagement.cloudcertificationauthority.item.activate;
...
public class ActivateRequestBuilder extends BaseRequestBuilder {
    ...
    public ActivateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}/activate", pathParameters);
    }
    /**
     * Instantiates a new {@link ActivateRequestBuilder} and sets the default values.
    ...
    public ActivateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}/activate", rawUrl);
    }
    /**
    ...
    public CloudCertificationAuthority post(@jakarta.annotation.Nonnull final ActivatePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CloudCertificationAuthority post(@jakarta.annotation.Nonnull final ActivatePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
