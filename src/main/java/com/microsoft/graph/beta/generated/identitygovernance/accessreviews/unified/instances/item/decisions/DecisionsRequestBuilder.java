package com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions;

import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.AccessReviewInstanceDecisionItemItemRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.recordalldecisions.RecordAllDecisionsRequestBuilder;
