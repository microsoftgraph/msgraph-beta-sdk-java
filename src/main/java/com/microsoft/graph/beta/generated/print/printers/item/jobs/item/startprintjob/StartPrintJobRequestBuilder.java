package com.microsoft.graph.beta.print.printers.item.jobs.item.startprintjob;
...
public class StartPrintJobRequestBuilder extends BaseRequestBuilder {
     ...
     * @deprecated
     * The startPrintJob API is deprecated and will stop returning data on July 31, 2023. Please use the start API instead of this. as of 2023-06/Tasks_And_Plans
     */
