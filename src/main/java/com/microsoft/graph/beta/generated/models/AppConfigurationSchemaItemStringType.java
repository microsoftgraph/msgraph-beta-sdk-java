...
public class AppConfigurationSchemaItemStringType extends AppConfigurationSchemaItemType implements Parsable {
    /**
     * Instantiates a new {@link AppConfigurationSchemaItemStringType} and sets the default values.
     */
    public AppConfigurationSchemaItemStringType() {
        super();
    ...
    public static AppConfigurationSchemaItemStringType createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
