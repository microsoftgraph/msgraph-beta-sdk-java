package com.microsoft.graph.beta.reports.monthlyprintusagesummariesbyuser;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrintUsageByUser;
import com.microsoft.graph.beta.models.PrintUsageByUserCollectionResponse;
import com.microsoft.graph.beta.reports.monthlyprintusagesummariesbyuser.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.monthlyprintusagesummariesbyuser.item.PrintUsageByUserItemRequestBuilder;
...
public class MonthlyPrintUsageSummariesByUserRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link MonthlyPrintUsageSummariesByUserRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MonthlyPrintUsageSummariesByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByUser{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link MonthlyPrintUsageSummariesByUserRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MonthlyPrintUsageSummariesByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByUser{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrintUsageByUser body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/monthlyPrintUsageSummariesByUser", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public MonthlyPrintUsageSummariesByUserRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MonthlyPrintUsageSummariesByUserRequestBuilder(rawUrl, requestAdapter);
    }
    /**
     * Get monthlyPrintUsageSummariesByUser from reports
     */
