package com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences;

import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder;
...
public class ExceptionOccurrencesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new ExceptionOccurrencesRequestBuilder and sets the default values.
    ...
    public ExceptionOccurrencesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
