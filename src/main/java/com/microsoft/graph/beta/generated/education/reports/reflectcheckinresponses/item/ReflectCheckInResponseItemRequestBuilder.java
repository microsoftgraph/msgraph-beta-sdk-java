package com.microsoft.graph.beta.education.reports.reflectcheckinresponses.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ReflectCheckInResponse;
...
public class ReflectCheckInResponseItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ReflectCheckInResponseItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/reports/reflectCheckInResponses/{reflectCheckInResponse%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ReflectCheckInResponseItemRequestBuilder} and sets the default values.
    ...
    public ReflectCheckInResponseItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/reports/reflectCheckInResponses/{reflectCheckInResponse%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/reports/reflectCheckInResponses/{reflectCheckInResponse%2Did}{?%24expand,%24select}", pathParameters);
