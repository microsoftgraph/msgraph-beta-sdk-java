...
public class ExclusionUnitBase extends Entity implements Parsable {
    /**
     * Instantiates a new {@link ExclusionUnitBase} and sets the default values.
     */
    public ExclusionUnitBase() {
        super();
    }
    /**
    ...
    public static ExclusionUnitBase createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
