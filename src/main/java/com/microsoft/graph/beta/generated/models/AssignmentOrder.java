...
public class AssignmentOrder implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AssignmentOrder} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AssignmentOrder createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
