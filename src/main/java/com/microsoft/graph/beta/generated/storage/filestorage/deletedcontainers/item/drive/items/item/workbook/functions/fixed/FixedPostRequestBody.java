package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.fixed;
...
public class FixedPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link FixedPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link FixedPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("noCommas", (n) -> { this.setNoCommas(n.getObjectValue(UntypedNode::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public UntypedNode getNoCommas() {
     ...
     */
    public void setNoCommas(@jakarta.annotation.Nullable final UntypedNode value) {
