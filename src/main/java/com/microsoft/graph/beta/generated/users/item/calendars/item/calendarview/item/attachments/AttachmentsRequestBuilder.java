package com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.attachments;
...
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
