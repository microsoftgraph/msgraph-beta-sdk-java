package com.microsoft.graph.beta.devicemanagement.configurationpolicies;

import com.microsoft.graph.beta.devicemanagement.configurationpolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.configurationpolicies.item.DeviceManagementConfigurationPolicyItemRequestBuilder;
...
public class ConfigurationPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ConfigurationPoliciesRequestBuilder} and sets the default values.
    ...
    public ConfigurationPoliciesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ConfigurationPoliciesRequestBuilder} and sets the default values.
    ...
    public ConfigurationPoliciesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementConfigurationPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/configurationPolicies", pathParameters);
