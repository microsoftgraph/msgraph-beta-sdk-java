...
public class DriveItemSource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DriveItemSource} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static DriveItemSource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link DriveItemSourceApplication}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("application", (n) -> { this.setApplication(n.getEnumValue(DriveItemSourceApplication::forValue)); });
     ...
     */
    public void setApplication(@jakarta.annotation.Nullable final DriveItemSourceApplication value) {
