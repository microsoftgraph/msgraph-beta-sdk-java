package com.microsoft.graph.beta.identitygovernance.accessreviews.unified.definitions.item.instances.item.stages.item.decisions.item.instance.decisions.recordalldecisions;
...
public class RecordAllDecisionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RecordAllDecisionsRequestBuilder} and sets the default values.
    ...
    public RecordAllDecisionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/recordAllDecisions", pathParameters);
    }
    /**
     * Instantiates a new {@link RecordAllDecisionsRequestBuilder} and sets the default values.
    ...
    public RecordAllDecisionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/recordAllDecisions", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/accessreviewinstancedecisionitem-recordalldecisions?view=graph-rest-beta">Find more info here</a>
     */
