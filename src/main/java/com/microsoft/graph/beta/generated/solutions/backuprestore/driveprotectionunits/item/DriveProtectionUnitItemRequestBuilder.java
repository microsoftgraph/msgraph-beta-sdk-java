package com.microsoft.graph.beta.solutions.backuprestore.driveprotectionunits.item;
...
public class DriveProtectionUnitItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveProtectionUnitItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/driveProtectionUnits/{driveProtectionUnit%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveProtectionUnitItemRequestBuilder} and sets the default values.
    ...
    public DriveProtectionUnitItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/driveProtectionUnits/{driveProtectionUnit%2Did}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionUnit patch(@jakarta.annotation.Nonnull final DriveProtectionUnit body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionUnit patch(@jakarta.annotation.Nonnull final DriveProtectionUnit body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/driveProtectionUnits/{driveProtectionUnit%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionUnit body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionUnit body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
