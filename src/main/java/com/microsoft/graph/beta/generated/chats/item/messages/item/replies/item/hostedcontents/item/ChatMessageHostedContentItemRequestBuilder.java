package com.microsoft.graph.beta.chats.item.messages.item.replies.item.hostedcontents.item;

import com.microsoft.graph.beta.chats.item.messages.item.replies.item.hostedcontents.item.value.ContentRequestBuilder;
