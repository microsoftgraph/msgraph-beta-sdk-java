...
public class GetSummarizedNonInteractiveSignInsWithAggregationWindow_0c89c0fa extends BaseRequestBuilder {
     ...
     */
    public GetSummarizedNonInteractiveSignInsWithAggregationWindow_0c89c0fa(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String aggregationWindow) {
     ...
     */
    @jakarta.annotation.Nullable
    public GetSummarizedNonInteractiveSignInsWithAggregationWindow_f8e5dd0d get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetSummarizedNonInteractiveSignInsWithAggregationWindow_0c89c0fa withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetSummarizedNonInteractiveSignInsWithAggregationWindow_0c89c0fa(rawUrl, requestAdapter);
    }
    /**
     * Returns aggregated non-interactive sign-in event counts grouped by user, application, IP address, and time window, with drill-down capability using individual requestIds via the /signIns endpoint. This includes autonomous agent sign-in events.
     */
