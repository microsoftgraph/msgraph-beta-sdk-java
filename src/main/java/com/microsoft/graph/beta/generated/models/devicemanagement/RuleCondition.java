...
public class RuleCondition implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a RuleConditionAggregation
     */
    @jakarta.annotation.Nullable
    public RuleConditionAggregation getAggregation() {
     ...
     * @return a RuleConditionConditionCategory
     */
    @jakarta.annotation.Nullable
    public RuleConditionConditionCategory getConditionCategory() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("aggregation", (n) -> { this.setAggregation(n.getEnumValue(RuleConditionAggregation::forValue)); });
        deserializerMap.put("conditionCategory", (n) -> { this.setConditionCategory(n.getEnumValue(RuleConditionConditionCategory::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("operator", (n) -> { this.setOperator(n.getEnumValue(RuleConditionOperator::forValue)); });
        deserializerMap.put("relationshipType", (n) -> { this.setRelationshipType(n.getEnumValue(RuleConditionRelationshipType::forValue)); });
     ...
     * @return a RuleConditionOperator
     */
    @jakarta.annotation.Nullable
    public RuleConditionOperator getOperator() {
     ...
     * @return a RuleConditionRelationshipType
     */
    @jakarta.annotation.Nullable
    public RuleConditionRelationshipType getRelationshipType() {
     ...
     */
    public void setAggregation(@jakarta.annotation.Nullable final RuleConditionAggregation value) {
     ...
     */
    public void setConditionCategory(@jakarta.annotation.Nullable final RuleConditionConditionCategory value) {
     ...
     */
    public void setOperator(@jakarta.annotation.Nullable final RuleConditionOperator value) {
     ...
     */
    public void setRelationshipType(@jakarta.annotation.Nullable final RuleConditionRelationshipType value) {
