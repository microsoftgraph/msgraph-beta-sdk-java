package com.microsoft.graph.beta.places.item.graphdesk.children;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlaceCollectionResponse;
import com.microsoft.graph.beta.places.item.graphdesk.children.count.CountRequestBuilder;
import com.microsoft.graph.beta.places.item.graphdesk.children.item.PlaceItemRequestBuilder;
...
public class ChildrenRequestBuilder extends BaseRequestBuilder {
    ...
    public ChildrenRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.desk/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChildrenRequestBuilder} and sets the default values.
