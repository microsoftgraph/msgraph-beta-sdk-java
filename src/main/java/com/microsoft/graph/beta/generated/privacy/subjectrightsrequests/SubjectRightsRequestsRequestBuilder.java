package com.microsoft.graph.beta.privacy.subjectrightsrequests;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SubjectRightsRequest;
import com.microsoft.graph.beta.models.SubjectRightsRequestCollectionResponse;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.count.CountRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.SubjectRightsRequestItemRequestBuilder;
...
public class SubjectRightsRequestsRequestBuilder extends BaseRequestBuilder {
     ...
     * @deprecated
     * The subject rights request API under Privacy is deprecated and will stop working on  March 22, 2025. Please use the new API under Security. as of 2022-02/PrivacyDeprecate on 2022-03-22 and will be removed 2025-03-20
     * @see <a href="https://learn.microsoft.com/graph/api/subjectrightsrequest-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @deprecated
     * The subject rights request API under Privacy is deprecated and will stop working on  March 22, 2025. Please use the new API under Security. as of 2022-02/PrivacyDeprecate on 2022-03-22 and will be removed 2025-03-20
     * @see <a href="https://learn.microsoft.com/graph/api/subjectrightsrequest-post?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    @Deprecated
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/privacy/subjectRightsRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
