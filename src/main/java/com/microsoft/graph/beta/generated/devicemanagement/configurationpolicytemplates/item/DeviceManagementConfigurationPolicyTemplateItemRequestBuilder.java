package com.microsoft.graph.beta.devicemanagement.configurationpolicytemplates.item;

import com.microsoft.graph.beta.devicemanagement.configurationpolicytemplates.item.settingtemplates.SettingTemplatesRequestBuilder;
...
public class DeviceManagementConfigurationPolicyTemplateItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementConfigurationPolicyTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceManagementConfigurationPolicyTemplateItemRequestBuilder} and sets the default values.
    ...
    public DeviceManagementConfigurationPolicyTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate%2Did}{?%24expand,%24select}", pathParameters);
