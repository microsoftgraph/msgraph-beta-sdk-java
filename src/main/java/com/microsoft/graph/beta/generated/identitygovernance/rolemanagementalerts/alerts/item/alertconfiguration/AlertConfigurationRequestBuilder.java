...
public class AlertConfigurationRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AlertConfigurationRequestBuilder} and sets the default values.
    ...
    public AlertConfigurationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertConfiguration{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AlertConfigurationRequestBuilder} and sets the default values.
    ...
    public AlertConfigurationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertConfiguration{?%24expand,%24select}", rawUrl);
    }
    /**
