...
public class ContainerFilter implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ContainerFilter} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ContainerFilter createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("includedContainers", (n) -> { this.setIncludedContainers(n.getCollectionOfPrimitiveValues(String.class)); });
    ...
    public java.util.List<String> getIncludedContainers() {
        return this.backingStore.get("includedContainers");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfPrimitiveValues("includedContainers", this.getIncludedContainers());
    ...
    public void setIncludedContainers(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("includedContainers", value);
    }
    /**
