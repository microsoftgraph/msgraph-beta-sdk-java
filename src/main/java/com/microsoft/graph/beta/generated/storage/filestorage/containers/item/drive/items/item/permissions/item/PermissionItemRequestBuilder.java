package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.permissions.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Permission;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.permissions.item.grant.GrantRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.permissions.item.revokegrants.RevokeGrantsRequestBuilder;
