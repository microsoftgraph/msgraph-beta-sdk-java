...
public class MonitoringSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MonitoringSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MonitoringSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<MonitoringRule> getMonitoringRules() {
        return this.backingStore.get("monitoringRules");
    }
    /**
    ...
    public void setMonitoringRules(@jakarta.annotation.Nullable final java.util.List<MonitoringRule> value) {
        this.backingStore.set("monitoringRules", value);
    }
    /**
