package com.microsoft.graph.beta.devicemanagement.devicecompliancepolicies.validatecompliancescript;

import com.microsoft.graph.beta.models.DeviceComplianceScriptValidationResult;
...
public class ValidateComplianceScriptRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ValidateComplianceScriptRequestBuilder} and sets the default values.
     ...
     * @return a {@link DeviceComplianceScriptValidationResult}
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ValidateComplianceScriptRequestBuilder}
     */
    @jakarta.annotation.Nonnull
