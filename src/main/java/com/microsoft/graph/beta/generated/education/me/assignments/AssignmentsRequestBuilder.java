package com.microsoft.graph.beta.education.me.assignments;

import com.microsoft.graph.beta.education.me.assignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.education.me.assignments.item.EducationAssignmentItemRequestBuilder;
...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/me/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
