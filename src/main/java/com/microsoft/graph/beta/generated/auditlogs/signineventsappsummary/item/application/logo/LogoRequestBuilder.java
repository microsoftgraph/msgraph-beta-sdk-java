package com.microsoft.graph.beta.auditlogs.signineventsappsummary.item.application.logo;
...
public class LogoRequestBuilder extends BaseRequestBuilder {
    ...
    public LogoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/signInEventsAppSummary/{signInEventsAppActivity%2DappId}/application/logo", pathParameters);
    }
    /**
     * Instantiates a new {@link LogoRequestBuilder} and sets the default values.
    ...
    public LogoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/signInEventsAppSummary/{signInEventsAppActivity%2DappId}/application/logo", rawUrl);
    }
    /**
