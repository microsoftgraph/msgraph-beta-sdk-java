package com.microsoft.graph.beta.compliance.ediscovery.cases.item;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.custodians.CustodiansRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.LegalHoldsRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.microsoftgraphediscoveryclose.MicrosoftGraphEdiscoveryCloseRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.microsoftgraphediscoveryreopen.MicrosoftGraphEdiscoveryReopenRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.noncustodialdatasources.NoncustodialDataSourcesRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.reviewsets.ReviewSetsRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.settings.SettingsRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.sourcecollections.SourceCollectionsRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.tags.TagsRequestBuilder;
...
public class CaseItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public CaseItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link CaseItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public CaseItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}", rawUrl);
    }
    /**
     ...
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-case-delete?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void delete() {
        delete(null);
     ...
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-case-get?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseEscaped get() {
        return get(null);
    }
    /**
     * Retrieve the properties and relationships of a case object.
     ...
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-case-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseEscaped patch(@jakarta.annotation.Nonnull final CaseEscaped body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseEscaped patch(@jakarta.annotation.Nonnull final CaseEscaped body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}{?%24expand,%24select}", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CaseEscaped body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public CaseItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
