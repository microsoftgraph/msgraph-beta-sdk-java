package com.microsoft.graph.beta.drives.item;

import com.microsoft.graph.beta.drives.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.drives.item.bundles.BundlesRequestBuilder;
import com.microsoft.graph.beta.drives.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.drives.item.following.FollowingRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.ItemsRequestBuilder;
import com.microsoft.graph.beta.drives.item.lastmodifiedbyuser.LastModifiedByUserRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.ListRequestBuilder;
import com.microsoft.graph.beta.drives.item.recent.RecentRequestBuilder;
import com.microsoft.graph.beta.drives.item.root.RootRequestBuilder;
import com.microsoft.graph.beta.drives.item.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.beta.drives.item.sharedwithme.SharedWithMeRequestBuilder;
import com.microsoft.graph.beta.drives.item.special.SpecialRequestBuilder;
...
public class DriveItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemRequestBuilder} and sets the default values.
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/drives/{drive%2Did}{?%24expand,%24select}", pathParameters);
