package com.microsoft.graph.beta.financials.companies.item.salescreditmemos;

import com.microsoft.graph.beta.financials.companies.item.salescreditmemos.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salescreditmemos.item.SalesCreditMemoItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SalesCreditMemoCollectionResponse;
...
public class SalesCreditMemosRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SalesCreditMemosRequestBuilder} and sets the default values.
    ...
    public SalesCreditMemosRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SalesCreditMemosRequestBuilder} and sets the default values.
    ...
    public SalesCreditMemosRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get salesCreditMemos from financials
     * @return a {@link SalesCreditMemoCollectionResponse}
