...
public class ComplianceSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ComplianceSettings} and sets the default values.
     */
    ...
    public java.util.List<DisplayTemplate> getEDiscoveryResultTemplates() {
        return this.backingStore.get("eDiscoveryResultTemplates");
    }
    /**
    ...
    public void setEDiscoveryResultTemplates(@jakarta.annotation.Nullable final java.util.List<DisplayTemplate> value) {
        this.backingStore.set("eDiscoveryResultTemplates", value);
    }
    /**
