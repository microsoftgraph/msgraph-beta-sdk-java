package com.microsoft.graph.beta.devicemanagement.reports.getencryptionreportfordevices;
...
public class GetEncryptionReportForDevicesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetEncryptionReportForDevicesPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetEncryptionReportForDevicesPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetEncryptionReportForDevicesPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
