package com.microsoft.graph.beta.print.printers.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Printer;
import com.microsoft.graph.beta.print.printers.item.connectors.ConnectorsRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.getcapabilities.GetCapabilitiesRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.JobsRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.resetdefaults.ResetDefaultsRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.restorefactorydefaults.RestoreFactoryDefaultsRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.share.ShareRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.shares.SharesRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.tasktriggers.TaskTriggersRequestBuilder;
...
public class PrinterItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ResetDefaultsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/printer-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printer-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Printer}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printer-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
