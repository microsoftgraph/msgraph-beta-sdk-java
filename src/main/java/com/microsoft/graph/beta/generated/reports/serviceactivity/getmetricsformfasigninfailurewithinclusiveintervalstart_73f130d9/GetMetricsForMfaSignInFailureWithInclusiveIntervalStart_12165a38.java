...
public class GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152 get() {
        return get(null);
    }
    /**
     * Get the number of times users fail to complete interactive MFA sign-ins using the Microsoft Entra MFA cloud service during a specified time period. Sign-in failures happen, for example, when users abandon or cancel MFA requests, or refresh MFA sessions without doing interactive MFA.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152::createFromDiscriminatorValue);
    }
    /**
     * Get the number of times users fail to complete interactive MFA sign-ins using the Microsoft Entra MFA cloud service during a specified time period. Sign-in failures happen, for example, when users abandon or cancel MFA requests, or refresh MFA sessions without doing interactive MFA.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38(rawUrl, requestAdapter);
    }
    /**
     * Get the number of times users fail to complete interactive MFA sign-ins using the Microsoft Entra MFA cloud service during a specified time period. Sign-in failures happen, for example, when users abandon or cancel MFA requests, or refresh MFA sessions without doing interactive MFA.
     */
