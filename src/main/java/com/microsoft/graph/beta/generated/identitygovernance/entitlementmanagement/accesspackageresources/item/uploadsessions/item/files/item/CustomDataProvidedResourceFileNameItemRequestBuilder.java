package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackageresources.item.uploadsessions.item.files.item;

import com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackageresources.item.uploadsessions.item.files.item.value.ContentRequestBuilder;
...
public class CustomDataProvidedResourceFileNameItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomDataProvidedResourceFileNameItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files/{customDataProvidedResourceFile%2Dname}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link CustomDataProvidedResourceFileNameItemRequestBuilder} and sets the default values.
    ...
    public CustomDataProvidedResourceFileNameItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files/{customDataProvidedResourceFile%2Dname}{?%24expand,%24select}", rawUrl);
    }
    /**
