package com.microsoft.graph.beta.contacts.item.directreports;

import com.microsoft.graph.beta.contacts.item.directreports.count.CountRequestBuilder;
import com.microsoft.graph.beta.contacts.item.directreports.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.contacts.item.directreports.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.contacts.item.directreports.item.DirectoryObjectItemRequestBuilder;
...
public class DirectReportsRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectReportsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/directReports{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DirectReportsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/orgcontact-list-directreports?view=graph-rest-beta">Find more info here</a>
     */
