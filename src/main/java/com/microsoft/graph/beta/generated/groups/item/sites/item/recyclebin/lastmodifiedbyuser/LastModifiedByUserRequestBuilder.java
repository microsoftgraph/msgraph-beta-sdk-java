package com.microsoft.graph.beta.groups.item.sites.item.recyclebin.lastmodifiedbyuser;

import com.microsoft.graph.beta.groups.item.sites.item.recyclebin.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.recyclebin.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new LastModifiedByUserRequestBuilder and sets the default values.
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser{?%24select,%24expand}", rawUrl);
    }
    /**
