...
public class UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522 extends Entity implements Parsable {
    /**
     * Instantiates a new {@link UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522} and sets the default values.
     */
    public UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522() {
        super();
    }
    /**
    ...
    public static UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522 createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522();
    }
    /**
