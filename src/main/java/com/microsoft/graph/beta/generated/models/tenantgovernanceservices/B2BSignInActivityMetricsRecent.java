...
public class B2BSignInActivityMetricsRecent extends B2BSignInActivityMetricsBase implements Parsable {
    /**
     * Instantiates a new {@link B2BSignInActivityMetricsRecent} and sets the default values.
     */
    public B2BSignInActivityMetricsRecent() {
        super();
        this.setOdataType("#microsoft.graph.tenantGovernanceServices.b2BSignInActivityMetricsRecent");
    }
    /**
    ...
    public static B2BSignInActivityMetricsRecent createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new B2BSignInActivityMetricsRecent();
    }
    /**
