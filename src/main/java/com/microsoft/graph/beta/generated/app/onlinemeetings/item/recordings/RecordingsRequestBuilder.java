package com.microsoft.graph.beta.app.onlinemeetings.item.recordings;

import com.microsoft.graph.beta.app.onlinemeetings.item.recordings.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.recordings.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.recordings.item.CallRecordingItemRequestBuilder;
...
public class RecordingsRequestBuilder extends BaseRequestBuilder {
    ...
    public RecordingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RecordingsRequestBuilder and sets the default values.
    ...
    public RecordingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recordings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
