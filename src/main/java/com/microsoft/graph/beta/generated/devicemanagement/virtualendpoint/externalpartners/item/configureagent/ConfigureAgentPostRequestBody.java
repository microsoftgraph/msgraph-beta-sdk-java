...
import com.microsoft.graph.beta.models.CloudPcExternalPartnerAgentSetting;
...
public class ConfigureAgentPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ConfigureAgentPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ConfigureAgentPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ConfigureAgentPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ConfigureAgentPostRequestBody();
    }
    /**
    ...
    /**
     * Gets the agentSetting property value. The agentSetting property
    ...
    /**
     * Sets the agentSetting property value. The agentSetting property
