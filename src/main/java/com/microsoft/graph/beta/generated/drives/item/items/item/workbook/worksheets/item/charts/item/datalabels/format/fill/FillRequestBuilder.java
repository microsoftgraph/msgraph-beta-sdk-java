package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.datalabels.format.fill;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.datalabels.format.fill.clear.ClearRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.datalabels.format.fill.setsolidcolor.SetSolidColorRequestBuilder;
