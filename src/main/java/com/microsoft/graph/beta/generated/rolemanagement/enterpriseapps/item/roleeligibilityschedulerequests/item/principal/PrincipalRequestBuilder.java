package com.microsoft.graph.beta.rolemanagement.enterpriseapps.item.roleeligibilityschedulerequests.item.principal;
...
public class PrincipalRequestBuilder extends BaseRequestBuilder {
    ...
    public PrincipalRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/principal{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrincipalRequestBuilder} and sets the default values.
    ...
    public PrincipalRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/principal{?%24expand,%24select}", rawUrl);
    }
    /**
