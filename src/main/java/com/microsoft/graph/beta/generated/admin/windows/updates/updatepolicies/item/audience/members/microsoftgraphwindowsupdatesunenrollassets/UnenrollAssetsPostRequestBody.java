package com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.members.microsoftgraphwindowsupdatesunenrollassets;
...
public class UnenrollAssetsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UnenrollAssetsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link UnenrollAssetsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static UnenrollAssetsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<UpdatableAsset> getAssets() {
        return this.backingStore.get("assets");
    }
    /**
    ...
    public void setAssets(@jakarta.annotation.Nullable final java.util.List<UpdatableAsset> value) {
        this.backingStore.set("assets", value);
    }
    /**
