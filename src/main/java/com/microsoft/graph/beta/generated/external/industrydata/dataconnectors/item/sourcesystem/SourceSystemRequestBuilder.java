package com.microsoft.graph.beta.external.industrydata.dataconnectors.item.sourcesystem;
...
public class SourceSystemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link SourceSystemRequestBuilder} and sets the default values.
    ...
    public SourceSystemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}/sourceSystem{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SourceSystemRequestBuilder} and sets the default values.
    ...
    public SourceSystemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}/sourceSystem{?%24expand,%24select}", rawUrl);
    }
    /**
