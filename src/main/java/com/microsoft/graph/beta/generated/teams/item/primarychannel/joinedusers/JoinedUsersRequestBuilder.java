package com.microsoft.graph.beta.teams.item.primarychannel.joinedusers;
...
import com.microsoft.graph.beta.teams.item.primarychannel.joinedusers.add.AddRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.joinedusers.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.joinedusers.item.ConversationMemberItemRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.joinedusers.remove.RemoveRequestBuilder;
...
public class JoinedUsersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teams/{team%2Did}/primaryChannel/joinedUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConversationMember body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/teams/{team%2Did}/primaryChannel/joinedUsers", pathParameters);
