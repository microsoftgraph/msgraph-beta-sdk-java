package com.microsoft.graph.beta.solutions.businessscenarios.item.planner;

import com.microsoft.graph.beta.models.BusinessScenarioPlanner;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.businessscenarios.item.planner.getplan.GetPlanRequestBuilder;
import com.microsoft.graph.beta.solutions.businessscenarios.item.planner.planconfiguration.PlanConfigurationRequestBuilder;
import com.microsoft.graph.beta.solutions.businessscenarios.item.planner.taskconfiguration.TaskConfigurationRequestBuilder;
import com.microsoft.graph.beta.solutions.businessscenarios.item.planner.tasks.TasksRequestBuilder;
...
public class PlannerRequestBuilder extends BaseRequestBuilder {
    ...
    public PlannerRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PlannerRequestBuilder} and sets the default values.
    ...
    public PlannerRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public BusinessScenarioPlanner get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, BusinessScenarioPlanner::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final BusinessScenarioPlanner body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner", pathParameters);
