package com.microsoft.graph.beta.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.planner.plans.item.unarchive;
...
public class UnarchivePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UnarchivePostRequestBody} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static UnarchivePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
