package com.microsoft.graph.beta.admin.serviceannouncement.messages.item;

import com.microsoft.graph.beta.admin.serviceannouncement.messages.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.admin.serviceannouncement.messages.item.attachmentsarchive.AttachmentsArchiveRequestBuilder;
...
public class ServiceUpdateMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ServiceUpdateMessageItemRequestBuilder} and sets the default values.
    ...
    public ServiceUpdateMessageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ServiceUpdateMessageItemRequestBuilder} and sets the default values.
    ...
    public ServiceUpdateMessageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/serviceupdatemessage-get?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}{?%24expand,%24select}", pathParameters);
