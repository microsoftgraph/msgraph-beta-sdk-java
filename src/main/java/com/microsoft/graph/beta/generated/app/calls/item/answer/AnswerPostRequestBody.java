package com.microsoft.graph.beta.app.calls.item.answer;

import com.microsoft.graph.beta.models.IncomingCallOptions;
import com.microsoft.graph.beta.models.MediaConfig;
...
public class AnswerPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acceptedModalities", (n) -> { this.setAcceptedModalities(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setAcceptedModalities(@jakarta.annotation.Nullable final java.util.List<String> value) {
