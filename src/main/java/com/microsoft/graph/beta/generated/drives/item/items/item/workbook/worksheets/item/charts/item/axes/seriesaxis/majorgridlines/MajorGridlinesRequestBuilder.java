package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.majorgridlines;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.majorgridlines.format.FormatRequestBuilder;
