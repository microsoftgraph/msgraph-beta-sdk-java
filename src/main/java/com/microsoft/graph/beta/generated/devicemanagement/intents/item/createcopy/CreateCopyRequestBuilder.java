...
public class CreateCopyRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementIntent post(@jakarta.annotation.Nonnull final CreateCopyPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntent post(@jakarta.annotation.Nonnull final CreateCopyPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
