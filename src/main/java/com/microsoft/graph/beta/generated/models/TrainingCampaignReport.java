...
public class TrainingCampaignReport implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TrainingCampaignReport} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TrainingCampaignReport createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<UserSimulationDetails> getCampaignUsers() {
        return this.backingStore.get("campaignUsers");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("campaignUsers", (n) -> { this.setCampaignUsers(n.getCollectionOfObjectValues(UserSimulationDetails::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("overview", (n) -> { this.setOverview(n.getObjectValue(TrainingCampaignReportOverview::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public TrainingCampaignReportOverview getOverview() {
    ...
    public void setCampaignUsers(@jakarta.annotation.Nullable final java.util.List<UserSimulationDetails> value) {
        this.backingStore.set("campaignUsers", value);
    }
    /**
     ...
     */
    public void setOverview(@jakarta.annotation.Nullable final TrainingCampaignReportOverview value) {
