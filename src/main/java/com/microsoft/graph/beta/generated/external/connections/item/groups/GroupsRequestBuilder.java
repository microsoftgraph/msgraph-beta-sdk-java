package com.microsoft.graph.beta.external.connections.item.groups;

import com.microsoft.graph.beta.external.connections.item.groups.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.groups.item.ExternalGroupItemRequestBuilder;
import com.microsoft.graph.beta.models.externalconnectors.ExternalGroup;
import com.microsoft.graph.beta.models.externalconnectors.ExternalGroupCollectionResponse;
...
public class GroupsRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalconnection-post-groups?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
