package com.microsoft.graph.beta.groups.item.sites.item.informationprotection.policy.labels.extractlabel;

import com.microsoft.graph.beta.models.InformationProtectionContentLabel;
...
public class ExtractLabelRequestBuilder extends BaseRequestBuilder {
    ...
    public ExtractLabelRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/extractLabel", pathParameters);
    }
    /**
     * Instantiates a new {@link ExtractLabelRequestBuilder} and sets the default values.
    ...
    public ExtractLabelRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/extractLabel", rawUrl);
    }
    /**
