package com.microsoft.graph.beta.identity.conditionalaccess.policies.item.restore;
...
public class RestoreRequestBuilder extends BaseRequestBuilder {
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/policies/{conditionalAccessPolicy%2Did}/restore", pathParameters);
    }
    /**
     * Instantiates a new {@link RestoreRequestBuilder} and sets the default values.
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/policies/{conditionalAccessPolicy%2Did}/restore", rawUrl);
    }
    /**
     * Restore a deleted conditionalAccessPolicy object.
     * @return a {@link ConditionalAccessPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/conditionalaccesspolicy-restore?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public ConditionalAccessPolicy post() {
        return post(null);
    }
    /**
     * Restore a deleted conditionalAccessPolicy object.
     ...
     */
    @jakarta.annotation.Nullable
    public ConditionalAccessPolicy post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
