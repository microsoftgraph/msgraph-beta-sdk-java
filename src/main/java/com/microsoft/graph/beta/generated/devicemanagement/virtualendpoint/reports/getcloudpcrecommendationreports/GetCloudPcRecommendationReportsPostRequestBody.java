...
public class GetCloudPcRecommendationReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a GetCloudPcRecommendationReportsPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetCloudPcRecommendationReportsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reportName", (n) -> { this.setReportName(n.getEnumValue(GetCloudPcRecommendationReportsPostRequestBodyReportName::forValue)); });
     ...
     * @return a GetCloudPcRecommendationReportsPostRequestBodyReportName
     */
    @jakarta.annotation.Nullable
    public GetCloudPcRecommendationReportsPostRequestBodyReportName getReportName() {
     ...
     */
    public void setReportName(@jakarta.annotation.Nullable final GetCloudPcRecommendationReportsPostRequestBodyReportName value) {
