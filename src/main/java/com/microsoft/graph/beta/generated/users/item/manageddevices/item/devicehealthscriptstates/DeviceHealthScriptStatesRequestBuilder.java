package com.microsoft.graph.beta.users.item.manageddevices.item.devicehealthscriptstates;
...
import com.microsoft.graph.beta.users.item.manageddevices.item.devicehealthscriptstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.manageddevices.item.devicehealthscriptstates.withidwithpolicyidwithdeviceid.WithIdWithPolicyIdWithDeviceIdRequestBuilder;
...
public class DeviceHealthScriptStatesRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceHealthScriptStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DeviceHealthScriptStatesRequestBuilder and sets the default values.
    ...
    public DeviceHealthScriptStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
