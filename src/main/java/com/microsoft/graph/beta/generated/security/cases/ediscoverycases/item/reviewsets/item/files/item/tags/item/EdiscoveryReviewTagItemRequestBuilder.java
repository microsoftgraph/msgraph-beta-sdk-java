package com.microsoft.graph.beta.security.cases.ediscoverycases.item.reviewsets.item.files.item.tags.item;
...
public class EdiscoveryReviewTagItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link EdiscoveryReviewTagItemRequestBuilder} and sets the default values.
    ...
    public EdiscoveryReviewTagItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/files/{ediscoveryFile%2Did}/tags/{ediscoveryReviewTag%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EdiscoveryReviewTagItemRequestBuilder} and sets the default values.
    ...
    public EdiscoveryReviewTagItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/files/{ediscoveryFile%2Did}/tags/{ediscoveryReviewTag%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
