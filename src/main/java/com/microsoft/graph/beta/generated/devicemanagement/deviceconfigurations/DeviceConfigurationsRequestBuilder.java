package com.microsoft.graph.beta.devicemanagement.deviceconfigurations;

import com.microsoft.graph.beta.devicemanagement.deviceconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceconfigurations.getiosavailableupdateversions.GetIosAvailableUpdateVersionsRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceconfigurations.gettargetedusersanddevices.GetTargetedUsersAndDevicesRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceconfigurations.haspayloadlinks.HasPayloadLinksRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceconfigurations.item.DeviceConfigurationItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceConfiguration;
import com.microsoft.graph.beta.models.DeviceConfigurationCollectionResponse;
...
public class DeviceConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetTargetedUsersAndDevicesRequestBuilder getTargetedUsersAndDevices() {
        return new GetTargetedUsersAndDevicesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
