package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.workbook.functions.floor_precise;

import com.microsoft.graph.beta.models.Json;
...
public class FloorPrecisePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FloorPrecisePostRequestBody} and sets the default values.
     */
    public FloorPrecisePostRequestBody() {
     ...
     * @return a {@link FloorPrecisePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static FloorPrecisePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new FloorPrecisePostRequestBody();
    }
    /**
