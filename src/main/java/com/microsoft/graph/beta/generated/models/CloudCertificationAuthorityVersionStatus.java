...
public enum CloudCertificationAuthorityVersionStatus implements ValuedEnum {
    ...
    CloudCertificationAuthorityVersionStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static CloudCertificationAuthorityVersionStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
