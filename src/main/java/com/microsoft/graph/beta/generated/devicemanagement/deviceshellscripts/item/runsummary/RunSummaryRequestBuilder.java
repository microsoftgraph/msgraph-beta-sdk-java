package com.microsoft.graph.beta.devicemanagement.deviceshellscripts.item.runsummary;
...
public class RunSummaryRequestBuilder extends BaseRequestBuilder {
    ...
    public RunSummaryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/runSummary{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new RunSummaryRequestBuilder and sets the default values.
    ...
    public RunSummaryRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/runSummary{?%24expand,%24select}", rawUrl);
    }
    /**
