package com.microsoft.graph.beta.financials.companies.item.unitsofmeasure;

import com.microsoft.graph.beta.financials.companies.item.unitsofmeasure.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.unitsofmeasure.item.UnitOfMeasureItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnitOfMeasure;
import com.microsoft.graph.beta.models.UnitOfMeasureCollectionResponse;
...
public class UnitsOfMeasureRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/financials/companies/{company%2Did}/unitsOfMeasure{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
