package com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.hostedcontents.item;

import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.hostedcontents.item.value.ContentRequestBuilder;
