...
public class AcceptedForRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AcceptedForRequestBuilder} and sets the default values.
    ...
    public AcceptedForRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion%2Did}/acceptedFor{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptedForRequestBuilder} and sets the default values.
    ...
    public AcceptedForRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion%2Did}/acceptedFor{?%24expand,%24select}", rawUrl);
    }
    /**
