package com.microsoft.graph.beta.users.item.owneddevices;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.owneddevices.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.owneddevices.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.users.item.owneddevices.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.users.item.owneddevices.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.beta.users.item.owneddevices.item.DirectoryObjectItemRequestBuilder;
...
public class OwnedDevicesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link OwnedDevicesRequestBuilder} and sets the default values.
    ...
    public OwnedDevicesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OwnedDevicesRequestBuilder} and sets the default values.
    ...
    public OwnedDevicesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
