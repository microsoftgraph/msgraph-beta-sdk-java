package com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item;

import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.acceptrecommendations.AcceptRecommendationsRequestBuilder;
...
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.batchapplycustomdataprovidedresourcedecisions.BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.batchrecorddecisions.BatchRecordDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.contactedreviewers.ContactedReviewersRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.decisions.DecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.definition.DefinitionRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.resetdecisions.ResetDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.sendreminder.SendReminderRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stages.StagesRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stop.StopRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stopapplydecisions.StopApplyDecisionsRequestBuilder;
...
public class AccessReviewInstanceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewInstanceItemRequestBuilder} and sets the default values.
    ...
    public AccessReviewInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}{?%24expand,%24select}", pathParameters);
