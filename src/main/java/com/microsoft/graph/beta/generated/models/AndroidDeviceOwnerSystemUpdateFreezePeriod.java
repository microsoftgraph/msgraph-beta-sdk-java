...
public class AndroidDeviceOwnerSystemUpdateFreezePeriod implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AndroidDeviceOwnerSystemUpdateFreezePeriod} and sets the default values.
     */
     ...
     * @return a {@link AndroidDeviceOwnerSystemUpdateFreezePeriod}
     */
    @jakarta.annotation.Nonnull
    ...
    public Integer getEndMonth() {
        return this.backingStore.get("endMonth");
    }
    /**
    ...
    public Integer getStartMonth() {
        return this.backingStore.get("startMonth");
    }
    /**
    ...
    public void setEndMonth(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("endMonth", value);
    }
    /**
    ...
    public void setStartMonth(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("startMonth", value);
    }
}
