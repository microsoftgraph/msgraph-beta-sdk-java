...
public class MonitoringRule implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link MonitoringRule} and sets the default values.
     */
     ...
     * @return a {@link MonitoringAction}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { this.setAction(n.getEnumValue(MonitoringAction::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("signal", (n) -> { this.setSignal(n.getEnumValue(MonitoringSignal::forValue)); });
     ...
     * @return a {@link MonitoringSignal}
     */
    @jakarta.annotation.Nullable
