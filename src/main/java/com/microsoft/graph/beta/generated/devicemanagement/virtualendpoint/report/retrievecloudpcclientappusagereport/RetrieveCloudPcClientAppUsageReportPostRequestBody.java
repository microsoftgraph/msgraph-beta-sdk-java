...
import com.microsoft.graph.beta.models.CloudPcClientAppUsageReportType;
...
public class RetrieveCloudPcClientAppUsageReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetrieveCloudPcClientAppUsageReportPostRequestBody} and sets the default values.
     */
    public RetrieveCloudPcClientAppUsageReportPostRequestBody() {
     ...
     * @return a {@link RetrieveCloudPcClientAppUsageReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RetrieveCloudPcClientAppUsageReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RetrieveCloudPcClientAppUsageReportPostRequestBody();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reportType", (n) -> { this.setReportType(n.getEnumValue(CloudPcClientAppUsageReportType::forValue)); });
     ...
     * @return a {@link CloudPcClientAppUsageReportType}
     */
    @jakarta.annotation.Nullable
    public CloudPcClientAppUsageReportType getReportType() {
     ...
     */
    public void setReportType(@jakarta.annotation.Nullable final CloudPcClientAppUsageReportType value) {
