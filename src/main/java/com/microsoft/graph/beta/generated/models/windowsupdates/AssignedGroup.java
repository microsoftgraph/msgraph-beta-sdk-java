...
public class AssignedGroup implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AssignedGroup} and sets the default values.
     */
     ...
     * @return a {@link AssignedGroup}
     */
    @jakarta.annotation.Nonnull
    public static AssignedGroup createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
