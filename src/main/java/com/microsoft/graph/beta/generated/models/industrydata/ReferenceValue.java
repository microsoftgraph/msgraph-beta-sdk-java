...
public class ReferenceValue implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ReferenceValue} and sets the default values.
     */
     ...
     * @return a {@link ReferenceValue}
     */
    @jakarta.annotation.Nonnull
    public static ReferenceValue createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final ReferenceDefinition value) {
