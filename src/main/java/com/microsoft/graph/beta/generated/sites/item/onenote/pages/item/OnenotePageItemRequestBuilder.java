package com.microsoft.graph.beta.sites.item.onenote.pages.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OnenotePage;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.copytosection.CopyToSectionRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.onenotepatchcontent.OnenotePatchContentRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.parentsection.ParentSectionRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.pages.item.preview.PreviewRequestBuilder;
