package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.bitor;
...
public class BitorRequestBuilder extends BaseRequestBuilder {
    ...
    public BitorRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/bitor", rawUrl);
    }
    /**
     * Invoke action bitor
