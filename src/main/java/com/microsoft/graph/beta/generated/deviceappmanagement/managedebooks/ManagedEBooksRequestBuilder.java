package com.microsoft.graph.beta.deviceappmanagement.managedebooks;

import com.microsoft.graph.beta.deviceappmanagement.managedebooks.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.ManagedEBookItemRequestBuilder;
import com.microsoft.graph.beta.models.ManagedEBook;
import com.microsoft.graph.beta.models.ManagedEBookCollectionResponse;
...
public class ManagedEBooksRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ManagedEBooksRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/managedEBooks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ManagedEBook body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceAppManagement/managedEBooks", pathParameters);
