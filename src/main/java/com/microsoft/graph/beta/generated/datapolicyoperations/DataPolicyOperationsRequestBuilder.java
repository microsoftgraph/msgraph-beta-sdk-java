package com.microsoft.graph.beta.datapolicyoperations;

import com.microsoft.graph.beta.datapolicyoperations.count.CountRequestBuilder;
import com.microsoft.graph.beta.datapolicyoperations.item.DataPolicyOperationItemRequestBuilder;
import com.microsoft.graph.beta.models.DataPolicyOperation;
import com.microsoft.graph.beta.models.DataPolicyOperationCollectionResponse;
...
public class DataPolicyOperationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/dataPolicyOperations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
