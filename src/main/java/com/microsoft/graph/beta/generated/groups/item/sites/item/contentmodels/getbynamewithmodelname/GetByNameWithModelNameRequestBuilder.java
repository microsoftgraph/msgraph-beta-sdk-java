package com.microsoft.graph.beta.groups.item.sites.item.contentmodels.getbynamewithmodelname;

import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.getbynamewithmodelname.addtodrive.AddToDriveRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.getbynamewithmodelname.getapplieddrives.GetAppliedDrivesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.getbynamewithmodelname.removefromdrive.RemoveFromDriveRequestBuilder;
...
public class GetByNameWithModelNameRequestBuilder extends BaseRequestBuilder {
    ...
    public GetByNameWithModelNameRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String modelName) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')", pathParameters);
    ...
    public GetByNameWithModelNameRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')", rawUrl);
    }
    /**
