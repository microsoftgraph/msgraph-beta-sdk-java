...
import com.microsoft.graph.beta.communications.onlinemeetings.item.broadcastrecording.BroadcastRecordingRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.getvirtualappointmentjoinweburl.GetVirtualAppointmentJoinWebUrlRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.meetingattendancereport.MeetingAttendanceReportRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.recording.RecordingRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.recordings.RecordingsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.registration.RegistrationRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.sendvirtualappointmentremindersms.SendVirtualAppointmentReminderSmsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.sendvirtualappointmentsms.SendVirtualAppointmentSmsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.transcripts.TranscriptsRequestBuilder;
...
public class OnlineMeetingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public OnlineMeetingItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link OnlineMeetingItemRequestBuilder} and sets the default values.
    ...
    public OnlineMeetingItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}", pathParameters);
