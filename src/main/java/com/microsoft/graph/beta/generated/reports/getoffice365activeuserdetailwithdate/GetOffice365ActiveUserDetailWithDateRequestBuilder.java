package com.microsoft.graph.beta.reports.getoffice365activeuserdetailwithdate;
...
public class GetOffice365ActiveUserDetailWithDateRequestBuilder extends BaseRequestBuilder {
    ...
    public GetOffice365ActiveUserDetailWithDateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final LocalDate date) {
        super(requestAdapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(date={date}){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public GetOffice365ActiveUserDetailWithDateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(date={date}){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Invoke function getOffice365ActiveUserDetail
     * @return a {@link GetOffice365ActiveUserDetailWithDateGetResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public GetOffice365ActiveUserDetailWithDateGetResponse get() {
        return get(null);
    }
    /**
     * Invoke function getOffice365ActiveUserDetail
     ...
     */
    @jakarta.annotation.Nullable
    public GetOffice365ActiveUserDetailWithDateGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetOffice365ActiveUserDetailWithDateGetResponse::createFromDiscriminatorValue);
    }
    /**
     * Invoke function getOffice365ActiveUserDetail
