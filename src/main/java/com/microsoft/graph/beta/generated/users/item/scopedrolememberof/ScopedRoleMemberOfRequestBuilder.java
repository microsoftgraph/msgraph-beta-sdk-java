package com.microsoft.graph.beta.users.item.scopedrolememberof;
...
import com.microsoft.graph.beta.users.item.scopedrolememberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.scopedrolememberof.item.ScopedRoleMembershipItemRequestBuilder;
...
public class ScopedRoleMemberOfRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ScopedRoleMemberOfRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ScopedRoleMemberOfRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/scopedRoleMemberOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ScopedRoleMemberOfRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ScopedRoleMemberOfRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/scopedRoleMemberOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Retrieve a list of scopedRoleMembership for the user.
     * @return a {@link ScopedRoleMembershipCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/user-list-scopedrolememberof?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ScopedRoleMembership body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/scopedRoleMemberOf", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public ScopedRoleMemberOfRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
