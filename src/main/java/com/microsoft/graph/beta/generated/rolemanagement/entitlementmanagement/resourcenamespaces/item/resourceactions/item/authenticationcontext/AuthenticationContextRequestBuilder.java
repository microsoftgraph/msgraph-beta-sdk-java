package com.microsoft.graph.beta.rolemanagement.entitlementmanagement.resourcenamespaces.item.resourceactions.item.authenticationcontext;
...
public class AuthenticationContextRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AuthenticationContextRequestBuilder} and sets the default values.
    ...
    public AuthenticationContextRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/authenticationContext{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthenticationContextRequestBuilder} and sets the default values.
    ...
    public AuthenticationContextRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/authenticationContext{?%24expand,%24select}", rawUrl);
    }
    /**
