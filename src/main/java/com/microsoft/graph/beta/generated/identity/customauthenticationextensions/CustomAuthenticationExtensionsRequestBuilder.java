package com.microsoft.graph.beta.identity.customauthenticationextensions;

import com.microsoft.graph.beta.identity.customauthenticationextensions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.customauthenticationextensions.item.CustomAuthenticationExtensionItemRequestBuilder;
import com.microsoft.graph.beta.identity.customauthenticationextensions.validateauthenticationconfiguration.ValidateAuthenticationConfigurationRequestBuilder;
import com.microsoft.graph.beta.models.CustomAuthenticationExtension;
import com.microsoft.graph.beta.models.CustomAuthenticationExtensionCollectionResponse;
...
public class CustomAuthenticationExtensionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identitycontainer-list-customauthenticationextensions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/identitycontainer-post-customauthenticationextensions?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/customAuthenticationExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
