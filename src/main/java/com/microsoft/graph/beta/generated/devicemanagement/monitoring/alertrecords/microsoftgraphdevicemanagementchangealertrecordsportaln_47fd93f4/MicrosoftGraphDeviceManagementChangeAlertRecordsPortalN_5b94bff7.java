package com.microsoft.graph.beta.devicemanagement.monitoring.alertrecords.microsoftgraphdevicemanagementchangealertrecordsportaln_47fd93f4;
...
public class MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphDeviceManagementChangeAlertRecordsPortalN_5b94bff7(rawUrl, requestAdapter);
    }
    /**
