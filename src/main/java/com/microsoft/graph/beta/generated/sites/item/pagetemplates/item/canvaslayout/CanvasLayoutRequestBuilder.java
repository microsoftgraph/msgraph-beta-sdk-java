package com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout;

import com.microsoft.graph.beta.models.CanvasLayout;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout.horizontalsections.HorizontalSectionsRequestBuilder;
import com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout.verticalsection.VerticalSectionRequestBuilder;
...
public class CanvasLayoutRequestBuilder extends BaseRequestBuilder {
    ...
    public CanvasLayoutRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout", pathParameters);
    }
    /**
     * Instantiates a new {@link CanvasLayoutRequestBuilder} and sets the default values.
    ...
    public CanvasLayoutRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout{?%24expand,%24select}", pathParameters);
