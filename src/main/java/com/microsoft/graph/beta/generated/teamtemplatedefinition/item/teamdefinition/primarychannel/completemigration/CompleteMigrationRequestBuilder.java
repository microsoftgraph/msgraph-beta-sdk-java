package com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.primarychannel.completemigration;
...
public class CompleteMigrationRequestBuilder extends BaseRequestBuilder {
    ...
    public CompleteMigrationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/completeMigration", pathParameters);
    }
    /**
     * Instantiates a new {@link CompleteMigrationRequestBuilder} and sets the default values.
    ...
    public CompleteMigrationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/completeMigration", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/channel-completemigration?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
