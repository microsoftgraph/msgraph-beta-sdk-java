package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.sheets;
...
public class SheetsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SheetsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SheetsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static SheetsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
