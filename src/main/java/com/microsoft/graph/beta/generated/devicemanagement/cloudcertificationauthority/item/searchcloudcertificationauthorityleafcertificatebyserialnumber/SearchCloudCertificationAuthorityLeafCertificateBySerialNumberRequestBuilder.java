...
public class SearchCloudCertificationAuthorityLeafCertificateBySerialNumberRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SearchCloudCertificationAuthorityLeafCertificateBySerialNumberRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public CloudCertificationAuthorityLeafCertificate post(@jakarta.annotation.Nonnull final SearchCloudCertificationAuthorityLeafCertificateBySerialNumberPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SearchCloudCertificationAuthorityLeafCertificateBySerialNumberPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
