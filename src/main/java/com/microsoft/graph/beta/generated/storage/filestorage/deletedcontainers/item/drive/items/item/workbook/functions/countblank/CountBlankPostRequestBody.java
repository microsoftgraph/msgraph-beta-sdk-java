package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.countblank;
...
public class CountBlankPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link CountBlankPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CountBlankPostRequestBody}
     */
    @jakarta.annotation.Nonnull
