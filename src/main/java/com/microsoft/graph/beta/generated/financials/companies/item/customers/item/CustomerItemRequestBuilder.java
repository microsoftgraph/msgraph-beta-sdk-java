package com.microsoft.graph.beta.financials.companies.item.customers.item;

import com.microsoft.graph.beta.financials.companies.item.customers.item.currency.CurrencyRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.customers.item.paymentmethod.PaymentMethodRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.customers.item.paymentterm.PaymentTermRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.customers.item.picture.PictureRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.customers.item.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Customer body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public CustomerItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
