...
public class StartsWithTransformation extends CustomClaimTransformation implements Parsable {
    /**
     * Instantiates a new {@link StartsWithTransformation} and sets the default values.
     */
    public StartsWithTransformation() {
        super();
        this.setOdataType("#microsoft.graph.startsWithTransformation");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link StartsWithTransformation}
     */
    @jakarta.annotation.Nonnull
    public static StartsWithTransformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
