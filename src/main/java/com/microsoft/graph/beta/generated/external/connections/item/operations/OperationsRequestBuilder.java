package com.microsoft.graph.beta.external.connections.item.operations;

import com.microsoft.graph.beta.external.connections.item.operations.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.operations.item.ConnectionOperationItemRequestBuilder;
import com.microsoft.graph.beta.models.externalconnectors.ConnectionOperation;
import com.microsoft.graph.beta.models.externalconnectors.ConnectionOperationCollectionResponse;
...
public class OperationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/external/connections/{externalConnection%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConnectionOperation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/external/connections/{externalConnection%2Did}/operations", pathParameters);
