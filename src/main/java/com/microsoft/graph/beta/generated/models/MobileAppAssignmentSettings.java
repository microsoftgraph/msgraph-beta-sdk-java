...
public class MobileAppAssignmentSettings implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link MobileAppAssignmentSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MobileAppAssignmentSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
