package com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.extensions;

import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.extensions.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.extensions.item.ExtensionItemRequestBuilder;
