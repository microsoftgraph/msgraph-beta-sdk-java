package com.microsoft.graph.beta.devicemanagement.rolescopetags.hascustomrolescopetag;
...
public class HasCustomRoleScopeTagRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public HasCustomRoleScopeTagRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public HasCustomRoleScopeTagRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/roleScopeTags/hasCustomRoleScopeTag()", rawUrl);
    }
    /**
