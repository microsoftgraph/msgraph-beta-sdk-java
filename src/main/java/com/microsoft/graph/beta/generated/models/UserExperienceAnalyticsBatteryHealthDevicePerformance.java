...
public class UserExperienceAnalyticsBatteryHealthDevicePerformance extends Entity implements Parsable {
    /**
     * Instantiates a new {@link UserExperienceAnalyticsBatteryHealthDevicePerformance} and sets the default values.
     */
     ...
     * @return a {@link java.util.List<UserExperienceAnalyticsDeviceBatteryDetail>}
     */
    @jakarta.annotation.Nullable
