package com.microsoft.graph.beta.governancerolesettings.item.roledefinition.rolesetting;
...
public class RoleSettingRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleSettingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleSettingRequestBuilder} and sets the default values.
    ...
    public RoleSettingRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24expand,%24select}", rawUrl);
    }
    /**
