package com.microsoft.graph.beta.external.industrydata.runs.item.activities.item.activity;
...
public class ActivityRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ActivityRequestBuilder} and sets the default values.
    ...
    public ActivityRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}/activity{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ActivityRequestBuilder} and sets the default values.
    ...
    public ActivityRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}/activity{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public IndustryDataActivity get() {
        return get(null);
    }
    /**
     * The flow that was run by this activity.
     ...
     */
    @jakarta.annotation.Nullable
    public IndustryDataActivity get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, IndustryDataActivity::createFromDiscriminatorValue);
    }
    /**
     * The flow that was run by this activity.
