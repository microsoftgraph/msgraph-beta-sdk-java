package com.microsoft.graph.beta.app.calls.item.operations.item;
...
public class CommsOperationItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CommsOperationItemRequestBuilder} and sets the default values.
    ...
    public CommsOperationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/operations/{commsOperation%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link CommsOperationItemRequestBuilder} and sets the default values.
    ...
    public CommsOperationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/operations/{commsOperation%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/app/calls/{call%2Did}/operations/{commsOperation%2Did}{?%24expand,%24select}", pathParameters);
