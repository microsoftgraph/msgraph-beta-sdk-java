package com.microsoft.graph.beta.financials.companies.item.taxgroups;

import com.microsoft.graph.beta.financials.companies.item.taxgroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.taxgroups.item.TaxGroupItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TaxGroup;
import com.microsoft.graph.beta.models.TaxGroupCollectionResponse;
...
public class TaxGroupsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link TaxGroupItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link TaxGroupsRequestBuilder} and sets the default values.
    ...
    public TaxGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/taxGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TaxGroupsRequestBuilder} and sets the default values.
    ...
    public TaxGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/taxGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get taxGroups from financials
     * @return a {@link TaxGroupCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TaxGroup body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/financials/companies/{company%2Did}/taxGroups", pathParameters);
