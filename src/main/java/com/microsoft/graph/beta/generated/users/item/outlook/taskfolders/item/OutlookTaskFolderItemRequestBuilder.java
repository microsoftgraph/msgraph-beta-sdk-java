...
public class OutlookTaskFolderItemRequestBuilder extends BaseRequestBuilder {
    ...
    public OutlookTaskFolderItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link OutlookTaskFolderItemRequestBuilder} and sets the default values.
    ...
    public OutlookTaskFolderItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
