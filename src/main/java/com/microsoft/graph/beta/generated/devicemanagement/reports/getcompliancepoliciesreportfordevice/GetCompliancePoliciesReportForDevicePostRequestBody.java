package com.microsoft.graph.beta.devicemanagement.reports.getcompliancepoliciesreportfordevice;
...
public class GetCompliancePoliciesReportForDevicePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetCompliancePoliciesReportForDevicePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetCompliancePoliciesReportForDevicePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetCompliancePoliciesReportForDevicePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
