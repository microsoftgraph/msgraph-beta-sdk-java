package com.microsoft.graph.beta.devicemanagement.manageddevices.item.securitybaselinestates.item.settingstates;

import com.microsoft.graph.beta.devicemanagement.manageddevices.item.securitybaselinestates.item.settingstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.manageddevices.item.securitybaselinestates.item.settingstates.item.SecurityBaselineSettingStateItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SecurityBaselineSettingState;
import com.microsoft.graph.beta.models.SecurityBaselineSettingStateCollectionResponse;
...
public class SettingStatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SettingStatesRequestBuilder} and sets the default values.
    ...
    public SettingStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SettingStatesRequestBuilder} and sets the default values.
    ...
    public SettingStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * The security baseline state for different settings for a device
     * @return a {@link SecurityBaselineSettingStateCollectionResponse}
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link SettingStatesRequestBuilder}
     * @deprecated
     * This API is deprecated and will stop returning data on July 7, 2026. Use POST /deviceManagement/reports/getConfigurationSettingsReport instead. as of 2026-04/Rv1MigrationDeprecation on 2026-04-03 and will be removed 2026-07-07
     */
    @jakarta.annotation.Nonnull
