package com.microsoft.graph.beta.applicationtemplates.item;

import com.microsoft.graph.beta.applicationtemplates.item.instantiate.InstantiateRequestBuilder;
import com.microsoft.graph.beta.models.ApplicationTemplate;
...
public class ApplicationTemplateItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ApplicationTemplateItemRequestBuilder} and sets the default values.
    ...
    public ApplicationTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applicationTemplates/{applicationTemplate%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApplicationTemplateItemRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/applicationtemplate-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ApplicationTemplateItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
