...
public class MediaConfig implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MediaConfig} and sets the default values.
     */
    public MediaConfig() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static MediaConfig createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("removeFromDefaultAudioGroup", (n) -> { this.setRemoveFromDefaultAudioGroup(n.getBooleanValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public Boolean getRemoveFromDefaultAudioGroup() {
        return this.backingStore.get("removeFromDefaultAudioGroup");
    }
    /**
    ...
    public void setRemoveFromDefaultAudioGroup(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("removeFromDefaultAudioGroup", value);
    }
}
