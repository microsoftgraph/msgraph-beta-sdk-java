package com.microsoft.graph.beta.devices.item.devicetemplate;

import com.microsoft.graph.beta.devices.item.devicetemplate.count.CountRequestBuilder;
import com.microsoft.graph.beta.devices.item.devicetemplate.item.DeviceTemplateItemRequestBuilder;
...
public class DeviceTemplateRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceTemplateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/deviceTemplate{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceTemplateRequestBuilder} and sets the default values.
    ...
    public DeviceTemplateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/deviceTemplate{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
