package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.createdbyuser;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class CreatedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/createdByUser{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link CreatedByUserRequestBuilder} and sets the default values.
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/createdByUser{?%24expand,%24select}", rawUrl);
    }
    /**
