package com.microsoft.graph.beta.devicemanagement.deponboardingsettings.item.enrollmentprofiles.item.exportmobileconfig;
...
public class ExportMobileConfigRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ExportMobileConfigRequestBuilder} and sets the default values.
     ...
     * @return a {@link ExportMobileConfigGetResponse}
    ...
    public ExportMobileConfigGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ExportMobileConfigGetResponse::createFromDiscriminatorValue);
    }
    /**
     * Exports the mobile configuration
