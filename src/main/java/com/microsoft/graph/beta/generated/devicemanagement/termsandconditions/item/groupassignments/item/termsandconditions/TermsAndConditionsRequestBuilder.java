package com.microsoft.graph.beta.devicemanagement.termsandconditions.item.groupassignments.item.termsandconditions;
...
public class TermsAndConditionsRequestBuilder extends BaseRequestBuilder {
    ...
    public TermsAndConditionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments/{termsAndConditionsGroupAssignment%2Did}/termsAndConditions{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TermsAndConditionsRequestBuilder and sets the default values.
    ...
    public TermsAndConditionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments/{termsAndConditionsGroupAssignment%2Did}/termsAndConditions{?%24select,%24expand}", rawUrl);
    }
    /**
