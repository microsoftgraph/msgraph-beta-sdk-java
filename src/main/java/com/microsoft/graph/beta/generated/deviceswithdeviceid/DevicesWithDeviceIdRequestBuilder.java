package com.microsoft.graph.beta.deviceswithdeviceid;
...
public class DevicesWithDeviceIdRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DevicesWithDeviceIdRequestBuilder} and sets the default values.
    ...
    public DevicesWithDeviceIdRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String deviceId) {
        super(requestAdapter, "{+baseurl}/devices(deviceId='{deviceId}')", pathParameters);
    ...
    public DevicesWithDeviceIdRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices(deviceId='{deviceId}')", rawUrl);
    }
    /**
     * Delete a registered device.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/device-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/device-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Device}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/device-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/devices(deviceId='{deviceId}'){?%24expand,%24select}", pathParameters);
