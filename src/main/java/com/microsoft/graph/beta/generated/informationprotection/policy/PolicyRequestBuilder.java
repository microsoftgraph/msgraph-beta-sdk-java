package com.microsoft.graph.beta.informationprotection.policy;

import com.microsoft.graph.beta.informationprotection.policy.labels.LabelsRequestBuilder;
import com.microsoft.graph.beta.models.InformationProtectionPolicy;
...
public class PolicyRequestBuilder extends BaseRequestBuilder {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public InformationProtectionPolicy get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, InformationProtectionPolicy::createFromDiscriminatorValue);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public InformationProtectionPolicy patch(@jakarta.annotation.Nonnull final InformationProtectionPolicy body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public InformationProtectionPolicy patch(@jakarta.annotation.Nonnull final InformationProtectionPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/informationProtection/policy", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final InformationProtectionPolicy body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final InformationProtectionPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/informationProtection/policy", pathParameters);
