package com.microsoft.graph.beta.users.item.profile.patents;

import com.microsoft.graph.beta.models.ItemPatent;
import com.microsoft.graph.beta.models.ItemPatentCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.profile.patents.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.profile.patents.item.ItemPatentItemRequestBuilder;
...
public class PatentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PatentsRequestBuilder} and sets the default values.
    ...
    public PatentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/patents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PatentsRequestBuilder} and sets the default values.
    ...
    public PatentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/patents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ItemPatent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/profile/patents", pathParameters);
