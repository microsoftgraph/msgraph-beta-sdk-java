package com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.item.authorizationsystem;
...
public class AuthorizationSystemRequestBuilder extends BaseRequestBuilder {
    ...
    public AuthorizationSystemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}/authorizationSystem{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthorizationSystemRequestBuilder} and sets the default values.
    ...
    public AuthorizationSystemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}/authorizationSystem{?%24expand,%24select}", rawUrl);
    }
    /**
