package com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.registrationswithuserid;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventRegistration;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.registrationswithuserid.cancel.CancelRequestBuilder;
...
public class RegistrationsWithUserIdRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrationsWithUserIdRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String userId) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(userId='{userId}')", pathParameters);
    ...
    public RegistrationsWithUserIdRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(userId='{userId}')", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(userId='{userId}'){?%24expand,%24select}", pathParameters);
