package com.microsoft.graph.beta.devicemanagement.devicecompliancepolicies.item.devicestatuses;

import com.microsoft.graph.beta.devicemanagement.devicecompliancepolicies.item.devicestatuses.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicecompliancepolicies.item.devicestatuses.item.DeviceComplianceDeviceStatusItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceComplianceDeviceStatus;
import com.microsoft.graph.beta.models.DeviceComplianceDeviceStatusCollectionResponse;
...
public class DeviceStatusesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link DeviceComplianceDeviceStatusItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceStatuses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceComplianceDeviceStatus body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceStatuses", pathParameters);
