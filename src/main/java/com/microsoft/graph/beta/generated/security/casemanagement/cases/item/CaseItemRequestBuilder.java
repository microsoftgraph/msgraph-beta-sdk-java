package com.microsoft.graph.beta.security.casemanagement.cases.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.casemanagement.CaseEscaped;
import com.microsoft.graph.beta.security.casemanagement.cases.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.security.casemanagement.cases.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.security.casemanagement.cases.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.security.casemanagement.cases.item.tasks.TasksRequestBuilder;
...
public class CaseItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CaseItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link CaseItemRequestBuilder} and sets the default values.
    ...
    public CaseItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * Delete a case object from case management.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagementroot-delete-cases?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-case-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link CaseEscaped}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-case-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
