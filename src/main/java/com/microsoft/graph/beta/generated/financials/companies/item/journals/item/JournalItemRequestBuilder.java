package com.microsoft.graph.beta.financials.companies.item.journals.item;

import com.microsoft.graph.beta.financials.companies.item.journals.item.account.AccountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.journals.item.journallines.JournalLinesRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.journals.item.post.PostRequestBuilder;
...
public class JournalItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Journal body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}", pathParameters);
