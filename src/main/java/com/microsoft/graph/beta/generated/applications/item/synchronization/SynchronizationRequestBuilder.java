package com.microsoft.graph.beta.applications.item.synchronization;

import com.microsoft.graph.beta.applications.item.synchronization.acquireaccesstoken.AcquireAccessTokenRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.JobsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.ping.PingRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.secrets.SecretsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.templates.TemplatesRequestBuilder;
