package com.microsoft.graph.beta.devicemanagement.windowsinformationprotectionapplearningsummaries;

import com.microsoft.graph.beta.devicemanagement.windowsinformationprotectionapplearningsummaries.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.windowsinformationprotectionapplearningsummaries.item.WindowsInformationProtectionAppLearningSummaryItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WindowsInformationProtectionAppLearningSummary;
import com.microsoft.graph.beta.models.WindowsInformationProtectionAppLearningSummaryCollectionResponse;
...
public class WindowsInformationProtectionAppLearningSummariesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/windowsInformationProtectionAppLearningSummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WindowsInformationProtectionAppLearningSummary body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/windowsInformationProtectionAppLearningSummaries", pathParameters);
