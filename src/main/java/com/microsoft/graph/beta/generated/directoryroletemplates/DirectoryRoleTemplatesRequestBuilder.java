package com.microsoft.graph.beta.directoryroletemplates;

import com.microsoft.graph.beta.directoryroletemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.item.DirectoryRoleTemplateItemRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.validateproperties.ValidatePropertiesRequestBuilder;
import com.microsoft.graph.beta.models.DirectoryRoleTemplate;
import com.microsoft.graph.beta.models.DirectoryRoleTemplateCollectionResponse;
...
public class DirectoryRoleTemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directoryroletemplate-list?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directoryRoleTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DirectoryRoleTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directoryRoleTemplates", pathParameters);
