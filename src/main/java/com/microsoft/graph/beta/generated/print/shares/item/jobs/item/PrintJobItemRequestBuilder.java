package com.microsoft.graph.beta.print.shares.item.jobs.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrintJob;
import com.microsoft.graph.beta.print.shares.item.jobs.item.abort.AbortRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.cancelprintjob.CancelPrintJobRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.documents.DocumentsRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.redirect.RedirectRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.startprintjob.StartPrintJobRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.tasks.TasksRequestBuilder;
