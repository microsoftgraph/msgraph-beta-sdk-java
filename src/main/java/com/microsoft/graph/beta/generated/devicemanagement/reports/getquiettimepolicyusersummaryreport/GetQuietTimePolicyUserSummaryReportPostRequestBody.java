...
public class GetQuietTimePolicyUserSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetQuietTimePolicyUserSummaryReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetQuietTimePolicyUserSummaryReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetQuietTimePolicyUserSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
