package com.microsoft.graph.beta.domains.item;

import com.microsoft.graph.beta.domains.item.domainnamereferences.DomainNameReferencesRequestBuilder;
import com.microsoft.graph.beta.domains.item.federationconfiguration.FederationConfigurationRequestBuilder;
...
import com.microsoft.graph.beta.domains.item.verify.VerifyRequestBuilder;
import com.microsoft.graph.beta.models.Domain;
...
public class DomainItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link PromoteToInitialRequestBuilder}
     */
    @jakarta.annotation.Nonnull
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/domain-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/domain-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Domain}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/domain-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/domains/{domain%2Did}{?%24expand,%24select}", pathParameters);
