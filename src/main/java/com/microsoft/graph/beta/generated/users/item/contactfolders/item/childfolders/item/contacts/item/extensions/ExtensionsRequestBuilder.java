package com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.extensions;
...
import com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.extensions.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.extensions.item.ExtensionItemRequestBuilder;
