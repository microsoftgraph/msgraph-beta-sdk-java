package com.microsoft.graph.beta.users.item.contactfolders.item.contacts;
...
import com.microsoft.graph.beta.users.item.contactfolders.item.contacts.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.contactfolders.item.contacts.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.contactfolders.item.contacts.item.ContactItemRequestBuilder;
...
public class ContactsRequestBuilder extends BaseRequestBuilder {
    ...
    public ContactsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ContactsRequestBuilder} and sets the default values.
    ...
    public ContactsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Contact body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts", pathParameters);
