package com.microsoft.graph.beta.users.item.onenote.notebooks.item.sectiongroups.item.sectiongroups;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SectionGroupCollectionResponse;
import com.microsoft.graph.beta.users.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.item.SectionGroupItemRequestBuilder;
