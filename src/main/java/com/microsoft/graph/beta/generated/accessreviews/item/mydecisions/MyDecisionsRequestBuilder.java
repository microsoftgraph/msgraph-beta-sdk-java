package com.microsoft.graph.beta.accessreviews.item.mydecisions;

import com.microsoft.graph.beta.accessreviews.item.mydecisions.count.CountRequestBuilder;
import com.microsoft.graph.beta.accessreviews.item.mydecisions.item.AccessReviewDecisionItemRequestBuilder;
...
public class MyDecisionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
