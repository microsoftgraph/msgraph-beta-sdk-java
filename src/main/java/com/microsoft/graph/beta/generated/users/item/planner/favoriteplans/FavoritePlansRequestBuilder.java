package com.microsoft.graph.beta.users.item.planner.favoriteplans;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerPlanCollectionResponse;
import com.microsoft.graph.beta.users.item.planner.favoriteplans.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.planner.favoriteplans.item.PlannerPlanItemRequestBuilder;
...
public class FavoritePlansRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link FavoritePlansRequestBuilder} and sets the default values.
    ...
    public FavoritePlansRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/planner/favoritePlans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link FavoritePlansRequestBuilder} and sets the default values.
