package com.microsoft.graph.beta.devicemanagement.grouppolicycategories.item.children.item;
...
public class GroupPolicyCategoryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupPolicyCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/children/{groupPolicyCategory%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new GroupPolicyCategoryItemRequestBuilder and sets the default values.
    ...
    public GroupPolicyCategoryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/children/{groupPolicyCategory%2Did1}{?%24expand,%24select}", rawUrl);
    }
    /**
