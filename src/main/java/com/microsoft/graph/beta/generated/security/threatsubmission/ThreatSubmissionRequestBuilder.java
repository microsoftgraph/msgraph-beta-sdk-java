package com.microsoft.graph.beta.security.threatsubmission;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.ThreatSubmissionRoot;
import com.microsoft.graph.beta.security.threatsubmission.emailthreats.EmailThreatsRequestBuilder;
import com.microsoft.graph.beta.security.threatsubmission.emailthreatsubmissionpolicies.EmailThreatSubmissionPoliciesRequestBuilder;
import com.microsoft.graph.beta.security.threatsubmission.filethreats.FileThreatsRequestBuilder;
import com.microsoft.graph.beta.security.threatsubmission.urlthreats.UrlThreatsRequestBuilder;
...
public class ThreatSubmissionRequestBuilder extends BaseRequestBuilder {
    ...
    public ThreatSubmissionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatSubmission", pathParameters);
    }
    /**
     * Instantiates a new {@link ThreatSubmissionRequestBuilder} and sets the default values.
    ...
    public ThreatSubmissionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatSubmission", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatSubmission{?%24expand,%24select}", pathParameters);
