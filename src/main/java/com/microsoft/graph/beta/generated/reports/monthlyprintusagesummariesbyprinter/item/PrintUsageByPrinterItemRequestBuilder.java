package com.microsoft.graph.beta.reports.monthlyprintusagesummariesbyprinter.item;
...
public class PrintUsageByPrinterItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrintUsageByPrinterItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrintUsageByPrinterItemRequestBuilder} and sets the default values.
    ...
    public PrintUsageByPrinterItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinter%2Did}{?%24expand,%24select}", pathParameters);
