package com.microsoft.graph.beta.deviceappmanagement.iosmanagedappprotections.item;

import com.microsoft.graph.beta.deviceappmanagement.iosmanagedappprotections.item.apps.AppsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.iosmanagedappprotections.item.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.iosmanagedappprotections.item.deploymentsummary.DeploymentSummaryRequestBuilder;
...
public class IosManagedAppProtectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public IosManagedAppProtectionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link IosManagedAppProtectionItemRequestBuilder} and sets the default values.
    ...
    public IosManagedAppProtectionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}{?%24expand,%24select}", pathParameters);
