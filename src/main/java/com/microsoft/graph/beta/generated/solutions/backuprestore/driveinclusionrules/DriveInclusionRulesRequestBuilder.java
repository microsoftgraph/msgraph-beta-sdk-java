package com.microsoft.graph.beta.solutions.backuprestore.driveinclusionrules;

import com.microsoft.graph.beta.models.DriveProtectionRule;
import com.microsoft.graph.beta.models.DriveProtectionRuleCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.backuprestore.driveinclusionrules.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.backuprestore.driveinclusionrules.item.DriveProtectionRuleItemRequestBuilder;
...
public class DriveInclusionRulesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionRule post(@jakarta.annotation.Nonnull final DriveProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveProtectionRule post(@jakarta.annotation.Nonnull final DriveProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/driveInclusionRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionRule body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DriveProtectionRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/driveInclusionRules", pathParameters);
