package com.microsoft.graph.beta.users.item.authentication.passwordmethods;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PasswordAuthenticationMethod;
import com.microsoft.graph.beta.models.PasswordAuthenticationMethodCollectionResponse;
import com.microsoft.graph.beta.users.item.authentication.passwordmethods.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.authentication.passwordmethods.item.PasswordAuthenticationMethodItemRequestBuilder;
...
public class PasswordMethodsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PasswordMethodsRequestBuilder} and sets the default values.
    ...
    public PasswordMethodsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/passwordMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PasswordMethodsRequestBuilder} and sets the default values.
    ...
    public PasswordMethodsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/passwordMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @return a {@link PasswordAuthenticationMethodCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PasswordAuthenticationMethod body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/authentication/passwordMethods", pathParameters);
