package com.microsoft.graph.beta.security.threatsubmission.emailthreatsubmissionpolicies;
...
import com.microsoft.graph.beta.security.threatsubmission.emailthreatsubmissionpolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatsubmission.emailthreatsubmissionpolicies.item.EmailThreatSubmissionPolicyItemRequestBuilder;
...
public class EmailThreatSubmissionPoliciesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-emailthreatsubmissionpolicy-list?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatSubmission/emailThreatSubmissionPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
