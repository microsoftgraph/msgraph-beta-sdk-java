package com.microsoft.graph.beta.organization.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Organization;
import com.microsoft.graph.beta.organization.item.branding.BrandingRequestBuilder;
import com.microsoft.graph.beta.organization.item.certificatebasedauthconfiguration.CertificateBasedAuthConfigurationRequestBuilder;
import com.microsoft.graph.beta.organization.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.organization.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.organization.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.organization.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.organization.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.organization.item.partnerinformation.PartnerInformationRequestBuilder;
import com.microsoft.graph.beta.organization.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.beta.organization.item.setmobiledevicemanagementauthority.SetMobileDeviceManagementAuthorityRequestBuilder;
import com.microsoft.graph.beta.organization.item.settings.SettingsRequestBuilder;
...
public class OrganizationItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/organization-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Organization}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/organization-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
