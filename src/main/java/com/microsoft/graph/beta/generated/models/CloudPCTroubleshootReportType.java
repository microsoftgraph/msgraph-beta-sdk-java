...
public enum CloudPCTroubleshootReportType implements ValuedEnum {
    ...
    CloudPCTroubleshootReportType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static CloudPCTroubleshootReportType forValue(@jakarta.annotation.Nonnull final String searchValue) {
