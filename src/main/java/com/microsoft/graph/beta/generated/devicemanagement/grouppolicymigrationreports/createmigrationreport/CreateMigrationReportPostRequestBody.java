...
import com.microsoft.graph.beta.models.GroupPolicyObjectFile;
...
public class CreateMigrationReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public GroupPolicyObjectFile getGroupPolicyObjectFile() {
        return this.backingStore.get("groupPolicyObjectFile");
    }
    /**
    ...
    public void setGroupPolicyObjectFile(@jakarta.annotation.Nullable final GroupPolicyObjectFile value) {
        this.backingStore.set("groupPolicyObjectFile", value);
    }
}
