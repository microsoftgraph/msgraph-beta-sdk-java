package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.SetsRequestBuilder;
