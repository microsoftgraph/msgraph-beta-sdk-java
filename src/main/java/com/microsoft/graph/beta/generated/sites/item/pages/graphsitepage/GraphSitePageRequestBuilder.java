package com.microsoft.graph.beta.sites.item.pages.graphsitepage;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SitePageCollectionResponse;
import com.microsoft.graph.beta.sites.item.pages.graphsitepage.count.CountRequestBuilder;
...
public class GraphSitePageRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphSitePageRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/graph.sitePage{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphSitePageRequestBuilder and sets the default values.
    ...
    public GraphSitePageRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/graph.sitePage{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get the items of type microsoft.graph.sitePage in the microsoft.graph.baseSitePage collection
     * @return a SitePageCollectionResponse
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a GraphSitePageRequestBuilder
     */
    @jakarta.annotation.Nonnull
