package com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.file.localizations.item.versions;

import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.file.localizations.item.versions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.file.localizations.item.versions.item.AgreementFileVersionItemRequestBuilder;
import com.microsoft.graph.beta.models.AgreementFileVersion;
import com.microsoft.graph.beta.models.AgreementFileVersionCollectionResponse;
