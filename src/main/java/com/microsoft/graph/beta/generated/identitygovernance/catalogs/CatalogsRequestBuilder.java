package com.microsoft.graph.beta.identitygovernance.catalogs;

import com.microsoft.graph.beta.identitygovernance.catalogs.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.catalogs.item.AccessPackageCatalogItemRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.catalogs.search.SearchRequestBuilder;
...
public class CatalogsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link CatalogsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/catalogs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AccessPackageCatalog body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/catalogs", pathParameters);
