...
public enum IncidentClassification implements ValuedEnum {
    Unknown("unknown"),
    ...
    IncidentClassification(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static IncidentClassification forValue(@jakarta.annotation.Nonnull final String searchValue) {
