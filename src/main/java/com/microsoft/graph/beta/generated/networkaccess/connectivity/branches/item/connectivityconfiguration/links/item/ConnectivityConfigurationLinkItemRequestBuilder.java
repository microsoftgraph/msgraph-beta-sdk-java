...
public class ConnectivityConfigurationLinkItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ConnectivityConfigurationLinkItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/connectivityConfiguration/links/{connectivityConfigurationLink%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ConnectivityConfigurationLinkItemRequestBuilder and sets the default values.
    ...
    public ConnectivityConfigurationLinkItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/connectivityConfiguration/links/{connectivityConfigurationLink%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
