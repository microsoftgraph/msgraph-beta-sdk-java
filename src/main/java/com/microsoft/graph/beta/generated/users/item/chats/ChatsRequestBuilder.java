package com.microsoft.graph.beta.users.item.chats;

import com.microsoft.graph.beta.models.Chat;
import com.microsoft.graph.beta.models.ChatCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.chats.allmessages.AllMessagesRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.getallmessages.GetAllMessagesRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.getallretainedmessages.GetAllRetainedMessagesRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.ChatItemRequestBuilder;
...
public class ChatsRequestBuilder extends BaseRequestBuilder {
    ...
    public ChatsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChatsRequestBuilder} and sets the default values.
    ...
    public ChatsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Chat body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/chats", pathParameters);
