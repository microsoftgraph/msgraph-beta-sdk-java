package com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats;

import com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats.item.ItemActivityStatItemRequestBuilder;
import com.microsoft.graph.beta.models.ItemActivityStat;
import com.microsoft.graph.beta.models.ItemActivityStatCollectionResponse;
...
public class ItemActivityStatsRequestBuilder extends BaseRequestBuilder {
    ...
    public ItemActivityStatsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ItemActivityStatsRequestBuilder} and sets the default values.
    ...
    public ItemActivityStatsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ItemActivityStat body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats", pathParameters);
