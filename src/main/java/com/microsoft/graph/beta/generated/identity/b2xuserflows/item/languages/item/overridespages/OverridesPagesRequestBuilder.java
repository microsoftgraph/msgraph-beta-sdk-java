package com.microsoft.graph.beta.identity.b2xuserflows.item.languages.item.overridespages;

import com.microsoft.graph.beta.identity.b2xuserflows.item.languages.item.overridespages.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.b2xuserflows.item.languages.item.overridespages.item.UserFlowLanguagePageItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserFlowLanguagePage;
import com.microsoft.graph.beta.models.UserFlowLanguagePageCollectionResponse;
...
public class OverridesPagesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
