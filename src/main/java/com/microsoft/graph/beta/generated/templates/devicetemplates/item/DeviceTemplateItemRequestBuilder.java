package com.microsoft.graph.beta.templates.devicetemplates.item;

import com.microsoft.graph.beta.models.DeviceTemplate;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.templates.devicetemplates.item.createdevicefromtemplate.CreateDeviceFromTemplateRequestBuilder;
import com.microsoft.graph.beta.templates.devicetemplates.item.deviceinstances.DeviceInstancesRequestBuilder;
import com.microsoft.graph.beta.templates.devicetemplates.item.deviceinstanceswithdeviceid.DeviceInstancesWithDeviceIdRequestBuilder;
import com.microsoft.graph.beta.templates.devicetemplates.item.owners.OwnersRequestBuilder;
...
public class DeviceTemplateItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceTemplateItemRequestBuilder} and sets the default values.
    ...
    public DeviceTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}{?%24expand,%24select}", pathParameters);
