...
public class AdminTodo extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("settings", (n) -> { this.setSettings(n.getObjectValue(TodoSettings::createFromDiscriminatorValue)); });
     ...
     */
    public void setSettings(@jakarta.annotation.Nullable final TodoSettings value) {
