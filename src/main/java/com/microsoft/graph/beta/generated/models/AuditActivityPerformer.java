...
public class AuditActivityPerformer implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AuditActivityPerformer} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AuditActivityPerformer createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AuditActivityPerformer();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("identityType", (n) -> { this.setIdentityType(n.getEnumValue(AuditIdentityType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the identityType property value. The identityType property
     * @return a {@link AuditIdentityType}
     */
    @jakarta.annotation.Nullable
    public AuditIdentityType getIdentityType() {
     ...
     */
    public void setIdentityType(@jakarta.annotation.Nullable final AuditIdentityType value) {
