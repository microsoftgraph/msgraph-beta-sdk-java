...
public class RedirectUriBlockedDomainConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RedirectUriBlockedDomainConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RedirectUriBlockedDomainConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RedirectUriBlockedDomainConfiguration();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("publicClient", (n) -> { this.setPublicClient(n.getObjectValue(RedirectUriPlatformBlockedDomainConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("spa", (n) -> { this.setSpa(n.getObjectValue(RedirectUriPlatformBlockedDomainConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AppManagementRestrictionState::forValue)); });
        deserializerMap.put("web", (n) -> { this.setWeb(n.getObjectValue(RedirectUriPlatformBlockedDomainConfiguration::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedDomainConfiguration getPublicClient() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedDomainConfiguration getSpa() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedDomainConfiguration getWeb() {
