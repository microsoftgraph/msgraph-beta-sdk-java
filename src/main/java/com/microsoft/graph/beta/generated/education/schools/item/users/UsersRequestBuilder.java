package com.microsoft.graph.beta.education.schools.item.users;

import com.microsoft.graph.beta.education.schools.item.users.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.schools.item.users.item.EducationUserItemRequestBuilder;
import com.microsoft.graph.beta.education.schools.item.users.ref.RefRequestBuilder;
import com.microsoft.graph.beta.models.EducationUserCollectionResponse;
...
public class UsersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.education.schools.item.users.item collection
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationschool-list-users?view=graph-rest-beta">Find more info here</a>
     */
