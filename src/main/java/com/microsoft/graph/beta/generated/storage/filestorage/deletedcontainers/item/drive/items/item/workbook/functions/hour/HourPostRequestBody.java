package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.hour;
...
public class HourPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link HourPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link HourPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static HourPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
