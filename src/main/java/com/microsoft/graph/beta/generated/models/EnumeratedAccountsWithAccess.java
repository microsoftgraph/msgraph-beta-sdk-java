...
public class EnumeratedAccountsWithAccess extends AccountsWithAccess implements Parsable {
    /**
     * Instantiates a new {@link EnumeratedAccountsWithAccess} and sets the default values.
     */
    public EnumeratedAccountsWithAccess() {
        super();
        this.setOdataType("#microsoft.graph.enumeratedAccountsWithAccess");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link EnumeratedAccountsWithAccess}
     */
    @jakarta.annotation.Nonnull
    public static EnumeratedAccountsWithAccess createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accounts", (n) -> { this.setAccounts(n.getCollectionOfObjectValues(AuthorizationSystem::createFromDiscriminatorValue)); });
     ...
     */
    public void setAccounts(@jakarta.annotation.Nullable final java.util.List<AuthorizationSystem> value) {
