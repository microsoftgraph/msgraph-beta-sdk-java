package com.microsoft.graph.beta.users.item.chats.item.messages.item.replies.item.hostedcontents;
...
import com.microsoft.graph.beta.users.item.chats.item.messages.item.replies.item.hostedcontents.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
