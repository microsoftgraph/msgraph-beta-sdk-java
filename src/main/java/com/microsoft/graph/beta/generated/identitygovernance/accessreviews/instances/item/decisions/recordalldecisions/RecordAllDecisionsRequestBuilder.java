package com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.decisions.recordalldecisions;
...
public class RecordAllDecisionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RecordAllDecisionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/decisions/recordAllDecisions", pathParameters);
    }
    /**
     * Instantiates a new {@link RecordAllDecisionsRequestBuilder} and sets the default values.
    ...
    public RecordAllDecisionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/decisions/recordAllDecisions", rawUrl);
    }
    /**
