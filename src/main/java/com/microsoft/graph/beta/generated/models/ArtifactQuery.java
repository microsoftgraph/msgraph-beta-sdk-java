...
public class ArtifactQuery implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ArtifactQuery} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ArtifactQuery createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link RestorableArtifact}
     */
    @jakarta.annotation.Nullable
    public RestorableArtifact getArtifactType() {
        return this.backingStore.get("artifactType");
    }
    /**
     ...
     */
    public void setArtifactType(@jakarta.annotation.Nullable final RestorableArtifact value) {
        this.backingStore.set("artifactType", value);
    }
    /**
