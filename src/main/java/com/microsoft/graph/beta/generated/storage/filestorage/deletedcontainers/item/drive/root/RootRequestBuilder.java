package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.root;

import com.microsoft.graph.beta.models.DriveItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.root.content.ContentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.root.contentstream.ContentStreamRequestBuilder;
...
public class RootRequestBuilder extends BaseRequestBuilder {
    ...
    public RootRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/root{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RootRequestBuilder} and sets the default values.
    ...
    public RootRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/root{?%24expand,%24select}", rawUrl);
    }
    /**
