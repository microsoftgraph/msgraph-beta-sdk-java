package com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item.renew;

import com.microsoft.graph.beta.models.ExactMatchSession;
...
public class RenewRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RenewRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public ExactMatchSession post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, ExactMatchSession::createFromDiscriminatorValue);
    }
    /**
     * Invoke action renew
