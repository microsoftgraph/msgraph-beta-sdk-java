package com.microsoft.graph.beta.solutions.backuprestore.sharepointprotectionpolicies.item.siteexclusionunitsbulkadditionjobs.item;
...
public class SiteExclusionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SiteExclusionUnitsBulkAdditionJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy%2Did}/siteExclusionUnitsBulkAdditionJobs/{siteExclusionUnitsBulkAdditionJob%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SiteExclusionUnitsBulkAdditionJobItemRequestBuilder} and sets the default values.
