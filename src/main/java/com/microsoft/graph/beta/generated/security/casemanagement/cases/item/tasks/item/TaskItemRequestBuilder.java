package com.microsoft.graph.beta.security.casemanagement.cases.item.tasks.item;
...
public class TaskItemRequestBuilder extends BaseRequestBuilder {
    ...
    public TaskItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}/tasks/{task%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TaskItemRequestBuilder} and sets the default values.
    ...
    public TaskItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}/tasks/{task%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * Delete a task from a case.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-task-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link Task}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-task-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Task}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-casemanagement-task-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
