...
public class ConfigurationManagerAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ConfigurationManagerAction} and sets the default values.
     */
     ...
     * @return a {@link ConfigurationManagerActionType}
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { this.setAction(n.getEnumValue(ConfigurationManagerActionType::forValue)); });
