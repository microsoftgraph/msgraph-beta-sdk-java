package com.microsoft.graph.beta.directory.deleteditems.item;

import com.microsoft.graph.beta.directory.deleteditems.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.restore.RestoreRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directory-deleteditems-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/directory-deleteditems-get?view=graph-rest-beta">Find more info here</a>
     */
