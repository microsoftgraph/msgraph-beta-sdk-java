...
public class QualityUpdateCveSeverityInformation implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maxBaseScore", (n) -> { this.setMaxBaseScore(n.getObjectValue(QualityUpdateCveSeverityInformationMaxBaseScore::createFromDiscriminatorValue)); });
     ...
     * @return a {@link QualityUpdateCveSeverityInformationMaxBaseScore}
     */
    @jakarta.annotation.Nullable
    public QualityUpdateCveSeverityInformationMaxBaseScore getMaxBaseScore() {
     ...
     */
    public void setMaxBaseScore(@jakarta.annotation.Nullable final QualityUpdateCveSeverityInformationMaxBaseScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class QualityUpdateCveSeverityInformationMaxBaseScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link QualityUpdateCveSeverityInformationMaxBaseScore} and sets the default values.
         */
        public QualityUpdateCveSeverityInformationMaxBaseScore() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static QualityUpdateCveSeverityInformationMaxBaseScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final QualityUpdateCveSeverityInformationMaxBaseScore result = new QualityUpdateCveSeverityInformationMaxBaseScore();
