package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.dsum;
...
public class DsumPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DsumPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DsumPostRequestBody}
     */
    @jakarta.annotation.Nonnull
