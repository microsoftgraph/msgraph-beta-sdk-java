package com.microsoft.graph.beta.devicemanagement.reports.getwindowsdriverupdatealertsperpolicyperdevicereport;
...
/**
 * Original name: GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3 implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3} and sets the default values.
     */
    public GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3() {
     ...
     * @return a {@link GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3}
     */
    @jakarta.annotation.Nonnull
    public static GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3 createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPos_8e8a0be3();
    }
    /**
