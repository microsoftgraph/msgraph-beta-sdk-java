package com.microsoft.graph.beta.groups.item.onenote;

import com.microsoft.graph.beta.groups.item.onenote.notebooks.NotebooksRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.resources.ResourcesRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sections.SectionsRequestBuilder;
...
public class OnenoteRequestBuilder extends BaseRequestBuilder {
    ...
    public OnenoteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link OnenoteRequestBuilder} and sets the default values.
    ...
    public OnenoteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/groups/{group%2Did}/onenote", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Onenote body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/groups/{group%2Did}/onenote", pathParameters);
