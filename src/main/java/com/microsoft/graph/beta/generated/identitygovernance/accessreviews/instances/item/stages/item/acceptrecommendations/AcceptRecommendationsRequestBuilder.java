package com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stages.item.acceptrecommendations;
...
public class AcceptRecommendationsRequestBuilder extends BaseRequestBuilder {
    ...
    public AcceptRecommendationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/acceptRecommendations", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptRecommendationsRequestBuilder} and sets the default values.
    ...
    public AcceptRecommendationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/acceptRecommendations", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/accessreviewstage-acceptrecommendations?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
