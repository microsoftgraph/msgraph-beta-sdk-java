package com.microsoft.graph.beta.communications.callrecords.item.sessions;

import com.microsoft.graph.beta.communications.callrecords.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.beta.communications.callrecords.item.sessions.item.SessionItemRequestBuilder;
import com.microsoft.graph.beta.models.callrecords.Session;
import com.microsoft.graph.beta.models.callrecords.SessionCollectionResponse;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/callrecords-callrecord-list-sessions?view=graph-rest-beta">Find more info here</a>
     */
