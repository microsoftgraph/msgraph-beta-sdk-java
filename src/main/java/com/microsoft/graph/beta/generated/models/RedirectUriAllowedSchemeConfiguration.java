...
public class RedirectUriAllowedSchemeConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RedirectUriAllowedSchemeConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RedirectUriAllowedSchemeConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RedirectUriAllowedSchemeConfiguration();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("publicClient", (n) -> { this.setPublicClient(n.getObjectValue(RedirectUriPlatformAllowedSchemeConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("spa", (n) -> { this.setSpa(n.getObjectValue(RedirectUriPlatformAllowedSchemeConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AppManagementRestrictionState::forValue)); });
        deserializerMap.put("web", (n) -> { this.setWeb(n.getObjectValue(RedirectUriPlatformAllowedSchemeConfiguration::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformAllowedSchemeConfiguration getPublicClient() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformAllowedSchemeConfiguration getSpa() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformAllowedSchemeConfiguration getWeb() {
