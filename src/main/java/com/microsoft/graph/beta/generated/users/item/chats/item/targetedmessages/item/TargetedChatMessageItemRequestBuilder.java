package com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TargetedChatMessage;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.RepliesRequestBuilder;
...
public class TargetedChatMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public TargetedChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link TargetedChatMessageItemRequestBuilder} and sets the default values.
    ...
    public TargetedChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/targetedMessages/{targetedChatMessage%2Did}{?%24expand,%24select}", pathParameters);
