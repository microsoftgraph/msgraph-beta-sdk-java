package com.microsoft.graph.beta.devicemanagement.rolescopetags.getrolescopetagsbyid;
...
public class GetRoleScopeTagsByIdRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetRoleScopeTagsByIdRequestBuilder} and sets the default values.
     ...
     * @return a {@link GetRoleScopeTagsByIdPostResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public GetRoleScopeTagsByIdPostResponse post(@jakarta.annotation.Nonnull final GetRoleScopeTagsByIdPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GetRoleScopeTagsByIdPostResponse post(@jakarta.annotation.Nonnull final GetRoleScopeTagsByIdPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetRoleScopeTagsByIdPostResponse::createFromDiscriminatorValue);
    }
    /**
     * Invoke action getRoleScopeTagsById
     * @param body The request body
