package com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions;

import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.item.UpdatableAssetItemRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.microsoftgraphwindowsupdatesenrollassets.MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.microsoftgraphwindowsupdatesenrollassetsbyid.MicrosoftGraphWindowsUpdatesEnrollAssetsByIdRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.microsoftgraphwindowsupdatesunenrollassets.MicrosoftGraphWindowsUpdatesUnenrollAssetsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.updatepolicies.item.audience.exclusions.microsoftgraphwindowsupdatesunenrollassetsbyid.MicrosoftGraphWindowsUpdatesUnenrollAssetsByIdRequestBuilder;
...
public class ExclusionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
