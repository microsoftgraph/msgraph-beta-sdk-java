package com.microsoft.graph.beta.users.item.employeeexperience.assignedroles.item.members.item.user;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.users.item.employeeexperience.assignedroles.item.members.item.user.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.users.item.employeeexperience.assignedroles.item.members.item.user.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
