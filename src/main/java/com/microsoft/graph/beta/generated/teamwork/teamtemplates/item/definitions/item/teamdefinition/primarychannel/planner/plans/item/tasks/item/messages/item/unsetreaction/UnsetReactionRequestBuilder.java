...
public class UnsetReactionRequestBuilder extends BaseRequestBuilder {
    ...
    public UnsetReactionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/messages/{plannerTaskChatMessage%2Did}/unsetReaction", pathParameters);
    }
    /**
     * Instantiates a new {@link UnsetReactionRequestBuilder} and sets the default values.
    ...
    public UnsetReactionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/messages/{plannerTaskChatMessage%2Did}/unsetReaction", rawUrl);
    }
    /**
