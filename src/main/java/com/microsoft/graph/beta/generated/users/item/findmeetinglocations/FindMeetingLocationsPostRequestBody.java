...
public class FindMeetingLocationsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FindMeetingLocationsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link FindMeetingLocationsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static FindMeetingLocationsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Boolean getAllowFreeOnly() {
        return this.backingStore.get("allowFreeOnly");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowFreeOnly", (n) -> { this.setAllowFreeOnly(n.getBooleanValue()); });
     ...
     * @param value Value to set for the allowFreeOnly property.
     */
    public void setAllowFreeOnly(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("allowFreeOnly", value);
    }
    /**
