package com.microsoft.graph.beta.workplace.sensordevices.item;
...
public class WorkplaceSensorDeviceItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/workplace/sensorDevices/{workplaceSensorDevice%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public WorkplaceSensorDeviceItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
