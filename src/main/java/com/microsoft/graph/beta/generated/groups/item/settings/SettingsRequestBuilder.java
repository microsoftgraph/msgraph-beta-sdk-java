package com.microsoft.graph.beta.groups.item.settings;

import com.microsoft.graph.beta.groups.item.settings.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.settings.item.DirectorySettingItemRequestBuilder;
