...
public class ServiceInformation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ServiceInformation} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ServiceInformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
