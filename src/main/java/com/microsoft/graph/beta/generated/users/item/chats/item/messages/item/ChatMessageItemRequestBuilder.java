package com.microsoft.graph.beta.users.item.chats.item.messages.item;

import com.microsoft.graph.beta.models.ChatMessage;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.replies.RepliesRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.unsetreaction.UnsetReactionRequestBuilder;
