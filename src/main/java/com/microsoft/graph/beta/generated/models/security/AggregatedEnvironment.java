...
public class AggregatedEnvironment implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link AggregatedEnvironment} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AggregatedEnvironment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AggregatedEnvironment();
    }
    /**
    ...
    /**
     * Gets the count property value. Number of environments of this type.
    ...
    /**
     * Gets the kind property value. Environment type.
    ...
    /**
     * Sets the count property value. Number of environments of this type.
    ...
    /**
     * Sets the kind property value. Environment type.
