package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.pduration;
...
public class PdurationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link PdurationPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PdurationPostRequestBody}
     */
    @jakarta.annotation.Nonnull
