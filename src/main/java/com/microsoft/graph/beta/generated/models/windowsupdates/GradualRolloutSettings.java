...
public class GradualRolloutSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GradualRolloutSettings} and sets the default values.
     */
     ...
     * @return a {@link GradualRolloutSettings}
     */
    @jakarta.annotation.Nonnull
    public static GradualRolloutSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public PeriodAndDuration getDurationBetweenOffers() {
        return this.backingStore.get("durationBetweenOffers");
    }
    /**
    ...
    public void setDurationBetweenOffers(@jakarta.annotation.Nullable final PeriodAndDuration value) {
        this.backingStore.set("durationBetweenOffers", value);
    }
    /**
