package com.microsoft.graph.beta.education.classes.item.assignmentsettings;

import com.microsoft.graph.beta.education.classes.item.assignmentsettings.defaultgradingscheme.DefaultGradingSchemeRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignmentsettings.gradingcategories.GradingCategoriesRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignmentsettings.gradingschemes.GradingSchemesRequestBuilder;
import com.microsoft.graph.beta.models.EducationAssignmentSettings;
...
public class AssignmentSettingsRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationassignmentsettings-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationAssignmentSettings}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationassignmentsettings-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
