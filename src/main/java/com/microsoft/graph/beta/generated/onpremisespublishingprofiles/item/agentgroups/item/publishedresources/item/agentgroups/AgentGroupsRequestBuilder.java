package com.microsoft.graph.beta.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups;
...
import com.microsoft.graph.beta.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.OnPremisesAgentGroupItemRequestBuilder;
import com.microsoft.graph.beta.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.ref.RefRequestBuilder;
...
public class AgentGroupsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public OnPremisesAgentGroupItemRequestBuilder byOnPremisesAgentGroupId1(@jakarta.annotation.Nonnull final String onPremisesAgentGroupId1) {
        Objects.requireNonNull(onPremisesAgentGroupId1);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("onPremisesAgentGroup%2Did1", onPremisesAgentGroupId1);
    ...
    public AgentGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AgentGroupsRequestBuilder} and sets the default values.
    ...
    public AgentGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final OnPremisesAgentGroup body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups", pathParameters);
