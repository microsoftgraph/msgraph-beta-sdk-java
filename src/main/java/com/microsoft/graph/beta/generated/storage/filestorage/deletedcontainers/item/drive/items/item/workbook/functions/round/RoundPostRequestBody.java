package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.round;
...
public class RoundPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RoundPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RoundPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RoundPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
