package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.getnotebookfromweburl;

import com.microsoft.graph.beta.models.CopyNotebookModel;
...
public class GetNotebookFromWebUrlRequestBuilder extends BaseRequestBuilder {
    ...
    public GetNotebookFromWebUrlRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl", pathParameters);
    }
    /**
     * Instantiates a new {@link GetNotebookFromWebUrlRequestBuilder} and sets the default values.
    ...
    public GetNotebookFromWebUrlRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/notebook-getnotebookfromweburl?view=graph-rest-beta">Find more info here</a>
     */
