...
public class ServiceTagNamedLocation extends NamedLocation implements Parsable {
    /**
     * Instantiates a new {@link ServiceTagNamedLocation} and sets the default values.
     */
    public ServiceTagNamedLocation() {
        super();
    ...
    public static ServiceTagNamedLocation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("serviceTags", (n) -> { this.setServiceTags(n.getCollectionOfPrimitiveValues(String.class)); });
    ...
    public java.util.List<String> getServiceTags() {
        return this.backingStore.get("serviceTags");
    }
    /**
     ...
     */
    public void setServiceTags(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("serviceTags", value);
    }
}
