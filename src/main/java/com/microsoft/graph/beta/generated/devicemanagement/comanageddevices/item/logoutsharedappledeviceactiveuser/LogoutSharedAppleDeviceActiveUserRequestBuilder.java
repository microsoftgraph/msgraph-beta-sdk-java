package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.logoutsharedappledeviceactiveuser;
...
public class LogoutSharedAppleDeviceActiveUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LogoutSharedAppleDeviceActiveUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/logoutSharedAppleDeviceActiveUser", pathParameters);
    }
    /**
     * Instantiates a new {@link LogoutSharedAppleDeviceActiveUserRequestBuilder} and sets the default values.
    ...
    public LogoutSharedAppleDeviceActiveUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/logoutSharedAppleDeviceActiveUser", rawUrl);
    }
    /**
