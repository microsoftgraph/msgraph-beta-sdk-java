package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.TaskItemRequestBuilder;
...
public class TasksRequestBuilder extends BaseRequestBuilder {
    ...
    public TasksRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates/{workflowTemplate%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
