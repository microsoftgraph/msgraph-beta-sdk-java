...
import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsbatteryhealthdeviceappimpact.item.UserExperienceAnalyticsBatteryHealthDeviceAppImpactItem_27b4d433;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsBatteryHealthDeviceAppImpact;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsBatteryHealthDeviceAppImpactColl_cf5e24ce;
...
public class UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418 extends BaseRequestBuilder {
    /**
     ...
     * @return a {@link UserExperienceAnalyticsBatteryHealthDeviceAppImpactItem_27b4d433}
     */
    @jakarta.annotation.Nonnull
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactItem_27b4d433 byUserExperienceAnalyticsBatteryHealthDeviceAppImpactId(@jakarta.annotation.Nonnull final String userExperienceAnalyticsBatteryHealthDeviceAppImpactId) {
        ...
        return new UserExperienceAnalyticsBatteryHealthDeviceAppImpactItem_27b4d433(urlTplParams, requestAdapter);
    }
    /**
     * Instantiates a new {@link UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactColl_cf5e24ce get() {
        return get(null);
    }
    /**
     * User Experience Analytics Battery Health Device App Impact
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactColl_cf5e24ce get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, UserExperienceAnalyticsBatteryHealthDeviceAppImpactColl_cf5e24ce::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/userExperienceAnalyticsBatteryHealthDeviceAppImpact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418}
     */
    @jakarta.annotation.Nonnull
    public UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new UserExperienceAnalyticsBatteryHealthDeviceAppImpactRequ_fbd82418(rawUrl, requestAdapter);
    }
    /**
     * User Experience Analytics Battery Health Device App Impact
     */
