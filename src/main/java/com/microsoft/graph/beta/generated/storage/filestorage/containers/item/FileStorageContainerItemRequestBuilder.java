package com.microsoft.graph.beta.storage.filestorage.containers.item;
...
import com.microsoft.graph.beta.storage.filestorage.containers.item.migrationjobs.MigrationJobsRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.containers.item.provisionmigrationcontainers.ProvisionMigrationContainersRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.containers.item.transferprincipalownership.TransferPrincipalOwnershipRequestBuilder;
...
public class FileStorageContainerItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/filestoragecontainer-get?view=graph-rest-beta">Find more info here</a>
     */
