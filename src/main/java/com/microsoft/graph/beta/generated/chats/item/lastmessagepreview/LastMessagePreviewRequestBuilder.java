package com.microsoft.graph.beta.chats.item.lastmessagepreview;

import com.microsoft.graph.beta.models.ChatMessageInfo;
...
public class LastMessagePreviewRequestBuilder extends BaseRequestBuilder {
    ...
    public LastMessagePreviewRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/chats/{chat%2Did}/lastMessagePreview", pathParameters);
    }
    /**
     * Instantiates a new {@link LastMessagePreviewRequestBuilder} and sets the default values.
    ...
    public LastMessagePreviewRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/chats/{chat%2Did}/lastMessagePreview", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/chats/{chat%2Did}/lastMessagePreview{?%24expand,%24select}", pathParameters);
