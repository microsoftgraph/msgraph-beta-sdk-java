package com.microsoft.graph.beta.groups.item.sites.item.contenttypes.item.columns.item;

import com.microsoft.graph.beta.groups.item.sites.item.contenttypes.item.columns.item.sourcecolumn.SourceColumnRequestBuilder;
