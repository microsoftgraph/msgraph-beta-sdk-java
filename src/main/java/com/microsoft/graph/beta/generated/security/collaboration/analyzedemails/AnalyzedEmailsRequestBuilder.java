package com.microsoft.graph.beta.security.collaboration.analyzedemails;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.AnalyzedEmail;
import com.microsoft.graph.beta.models.security.AnalyzedEmailCollectionResponse;
import com.microsoft.graph.beta.security.collaboration.analyzedemails.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.collaboration.analyzedemails.item.AnalyzedEmailItemRequestBuilder;
import com.microsoft.graph.beta.security.collaboration.analyzedemails.microsoftgraphsecurityremediate.MicrosoftGraphSecurityRemediateRequestBuilder;
...
public class AnalyzedEmailsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a AnalyzedEmailItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    ...
    public AnalyzedEmailsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AnalyzedEmailsRequestBuilder and sets the default values.
    ...
    public AnalyzedEmailsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a AnalyzedEmailsRequestBuilder
     */
    @jakarta.annotation.Nonnull
