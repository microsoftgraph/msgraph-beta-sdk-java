package com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replies.item;

import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replies.item.conversation.ConversationRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replies.item.reactions.ReactionsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replies.item.replyto.ReplyToRequestBuilder;
