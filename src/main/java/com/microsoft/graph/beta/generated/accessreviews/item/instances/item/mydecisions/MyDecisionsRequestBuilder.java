package com.microsoft.graph.beta.accessreviews.item.instances.item.mydecisions;

import com.microsoft.graph.beta.accessreviews.item.instances.item.mydecisions.count.CountRequestBuilder;
import com.microsoft.graph.beta.accessreviews.item.instances.item.mydecisions.item.AccessReviewDecisionItemRequestBuilder;
...
public class MyDecisionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MyDecisionsRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public MyDecisionsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
