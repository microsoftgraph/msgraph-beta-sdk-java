package com.microsoft.graph.beta.teamwork.teamtemplates.item.definitions.item.teamdefinition.sendactivitynotification;
...
public class SendActivityNotificationRequestBuilder extends BaseRequestBuilder {
    ...
    public SendActivityNotificationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/sendActivityNotification", pathParameters);
    }
    /**
     * Instantiates a new {@link SendActivityNotificationRequestBuilder} and sets the default values.
    ...
    public SendActivityNotificationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/sendActivityNotification", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/team-sendactivitynotification?view=graph-rest-beta">Find more info here</a>
     */
