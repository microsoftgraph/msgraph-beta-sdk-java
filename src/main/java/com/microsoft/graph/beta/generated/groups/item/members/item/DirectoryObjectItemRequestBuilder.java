package com.microsoft.graph.beta.groups.item.members.item;

import com.microsoft.graph.beta.groups.item.members.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.members.item.ref.RefRequestBuilder;
