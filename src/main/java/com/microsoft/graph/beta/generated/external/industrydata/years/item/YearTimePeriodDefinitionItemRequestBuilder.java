...
public class YearTimePeriodDefinitionItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link YearTimePeriodDefinitionItemRequestBuilder} and sets the default values.
    ...
    public YearTimePeriodDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link YearTimePeriodDefinitionItemRequestBuilder} and sets the default values.
    ...
    public YearTimePeriodDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}", rawUrl);
    }
    /**
     * Delete a yearTimePeriodDefinition object.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-yeartimeperioddefinition-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-yeartimeperioddefinition-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link YearTimePeriodDefinition}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-yeartimeperioddefinition-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}{?%24expand,%24select}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link YearTimePeriodDefinitionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
