...
public class CloudPcBulkTroubleshoot extends CloudPcBulkAction implements Parsable {
    /**
     * Instantiates a new {@link CloudPcBulkTroubleshoot} and sets the default values.
     */
    public CloudPcBulkTroubleshoot() {
        super();
        this.setOdataType("#microsoft.graph.cloudPcBulkTroubleshoot");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link CloudPcBulkTroubleshoot}
     */
