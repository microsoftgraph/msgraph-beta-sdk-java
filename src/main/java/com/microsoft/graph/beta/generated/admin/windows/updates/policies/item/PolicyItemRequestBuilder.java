package com.microsoft.graph.beta.admin.windows.updates.policies.item;

import com.microsoft.graph.beta.admin.windows.updates.policies.item.applicablecontent.ApplicableContentRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.policies.item.approvals.ApprovalsRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.policies.item.rings.RingsRequestBuilder;
...
public class PolicyItemRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RingsRequestBuilder rings() {
        return new RingsRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/windowsupdates-policy-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/windowsupdates-policy-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Policy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/windowsupdates-policy-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public Policy patch(@jakarta.annotation.Nonnull final Policy body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Policy patch(@jakarta.annotation.Nonnull final Policy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/policies/{policy%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Policy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Policy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public PolicyItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new PolicyItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
