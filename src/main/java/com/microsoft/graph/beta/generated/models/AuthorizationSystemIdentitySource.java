...
public class AuthorizationSystemIdentitySource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AuthorizationSystemIdentitySource} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AuthorizationSystemIdentitySource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        final ParseNode mappingValueNode = parseNode.getChildNode("@odata.type");
        if (mappingValueNode != null) {
            final String mappingValue = mappingValueNode.getStringValue();
            switch (mappingValue) {
                case "#microsoft.graph.aadSource": return new AadSource();
                case "#microsoft.graph.awsSource": return new AwsSource();
                case "#microsoft.graph.azureSource": return new AzureSource();
                case "#microsoft.graph.gsuiteSource": return new GsuiteSource();
                case "#microsoft.graph.unknownSource": return new UnknownSource();
            }
        }
        return new AuthorizationSystemIdentitySource();
    }
    /**
