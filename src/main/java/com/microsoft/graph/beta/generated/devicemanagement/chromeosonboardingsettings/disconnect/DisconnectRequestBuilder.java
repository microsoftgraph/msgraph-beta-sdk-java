package com.microsoft.graph.beta.devicemanagement.chromeosonboardingsettings.disconnect;
...
public class DisconnectRequestBuilder extends BaseRequestBuilder {
    ...
    public ChromeOSOnboardingStatus post() {
        return post(null);
    }
    /**
     * Invoke action disconnect
     ...
     */
    @jakarta.annotation.Nullable
    public ChromeOSOnboardingStatus post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
