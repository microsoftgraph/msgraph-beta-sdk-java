...
public class GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6 get() {
        return get(null);
    }
    /**
     * Retrieve the number of users&apos; private application access attempts that were allowed using Global Secure Access client.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6::createFromDiscriminatorValue);
    }
    /**
     * Retrieve the number of users&apos; private application access attempts that were allowed using Global Secure Access client.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138(rawUrl, requestAdapter);
    }
    /**
     * Retrieve the number of users&apos; private application access attempts that were allowed using Global Secure Access client.
     */
