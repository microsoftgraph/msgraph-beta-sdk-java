package com.microsoft.graph.beta.groups.item.events.item;

import com.microsoft.graph.beta.groups.item.events.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.dismissreminder.DismissReminderRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EventItemRequestBuilder} and sets the default values.
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}", rawUrl);
    }
    /**
     * Delete an event object.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/group-delete-event?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link Event}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/group-get-event?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Event}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/group-update-event?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}{?%24expand,%24select}", pathParameters);
