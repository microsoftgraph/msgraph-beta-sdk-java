package com.microsoft.graph.beta.devicemanagement.reports.getdevicesstatusbysettingreport;
...
public class GetDevicesStatusBySettingReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDevicesStatusBySettingReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDevicesStatusBySettingReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDevicesStatusBySettingReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
