...
public class CreateMigrationReportRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CreateMigrationReportRequestBuilder} and sets the default values.
    ...
    public CreateMigrationReportPostResponse post(@jakarta.annotation.Nonnull final CreateMigrationReportPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CreateMigrationReportPostResponse post(@jakarta.annotation.Nonnull final CreateMigrationReportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, CreateMigrationReportPostResponse::createFromDiscriminatorValue);
    }
    /**
     * Invoke action createMigrationReport
     * @param body The request body
