package com.microsoft.graph.beta.admin.windows.updates.policies.item.applicablecontent;

import com.microsoft.graph.beta.admin.windows.updates.policies.item.applicablecontent.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.policies.item.applicablecontent.item.ApplicableContentCatalogEntryItemRequestBuilder;
...
public class ApplicableContentRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/windowsupdates-policy-list-applicablecontent?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ApplicableContent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent", pathParameters);
