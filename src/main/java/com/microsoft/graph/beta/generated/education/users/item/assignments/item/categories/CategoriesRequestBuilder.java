package com.microsoft.graph.beta.education.users.item.assignments.item.categories;

import com.microsoft.graph.beta.education.users.item.assignments.item.categories.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.categories.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.categories.item.EducationCategoryItemRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.categories.ref.RefRequestBuilder;
...
public class CategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.education.users.item.assignments.item.categories.item collection
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationCategory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories", pathParameters);
