package com.microsoft.graph.beta.sites.item.onenote.sectiongroups;
...
import com.microsoft.graph.beta.sites.item.onenote.sectiongroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.sectiongroups.item.SectionGroupItemRequestBuilder;
...
public class SectionGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/sectionGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SectionGroupsRequestBuilder} and sets the default values.
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/sectionGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SectionGroup body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/sites/{site%2Did}/onenote/sectionGroups", pathParameters);
