package com.microsoft.graph.beta.groups.item.team.channels;

import com.microsoft.graph.beta.groups.item.team.channels.allmessages.AllMessagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.getallmessages.GetAllMessagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.getallretainedmessages.GetAllRetainedMessagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.ChannelItemRequestBuilder;
...
public class ChannelsRequestBuilder extends BaseRequestBuilder {
    ...
    public ChannelsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChannelsRequestBuilder} and sets the default values.
    ...
    public ChannelsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Channel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/groups/{group%2Did}/team/channels", pathParameters);
