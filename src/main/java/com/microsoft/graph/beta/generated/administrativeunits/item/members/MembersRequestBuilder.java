package com.microsoft.graph.beta.administrativeunits.item.members;

import com.microsoft.graph.beta.administrativeunits.item.members.count.CountRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.members.ref.RefRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
    ...
    public MembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MembersRequestBuilder and sets the default values.
    ...
    public MembersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
