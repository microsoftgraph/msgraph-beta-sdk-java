package com.microsoft.graph.beta.print.printers.item.share;
...
public class ShareRequestBuilder extends BaseRequestBuilder {
    ...
    public ShareRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/share{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ShareRequestBuilder and sets the default values.
    ...
    public ShareRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/share{?%24select,%24expand}", rawUrl);
    }
    /**
