package com.microsoft.graph.beta.planner.tasks;
...
import com.microsoft.graph.beta.planner.tasks.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.item.PlannerTaskItemRequestBuilder;
...
public class TasksRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/planner-list-tasks?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/planner-post-tasks?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
