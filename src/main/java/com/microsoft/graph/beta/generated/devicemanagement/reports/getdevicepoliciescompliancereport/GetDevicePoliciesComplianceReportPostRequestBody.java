package com.microsoft.graph.beta.devicemanagement.reports.getdevicepoliciescompliancereport;
...
public class GetDevicePoliciesComplianceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDevicePoliciesComplianceReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDevicePoliciesComplianceReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDevicePoliciesComplianceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
