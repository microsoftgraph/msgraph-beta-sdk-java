package com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.checklistitems;

import com.microsoft.graph.beta.models.ChecklistItem;
import com.microsoft.graph.beta.models.ChecklistItemCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.checklistitems.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.checklistitems.item.ChecklistItemItemRequestBuilder;
...
public class ChecklistItemsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ChecklistItemItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ChecklistItemsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/checklistItems{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ChecklistItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/checklistItems", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ChecklistItemsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
