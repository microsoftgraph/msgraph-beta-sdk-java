package com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.sharedwithteams.item.allowedmembers;

import com.microsoft.graph.beta.models.ConversationMemberCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.sharedwithteams.item.allowedmembers.count.CountRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.sharedwithteams.item.allowedmembers.item.ConversationMemberItemRequestBuilder;
