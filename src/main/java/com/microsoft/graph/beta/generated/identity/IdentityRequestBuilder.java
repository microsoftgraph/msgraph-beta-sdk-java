package com.microsoft.graph.beta.identity;

import com.microsoft.graph.beta.identity.apiconnectors.ApiConnectorsRequestBuilder;
import com.microsoft.graph.beta.identity.authenticationeventlisteners.AuthenticationEventListenersRequestBuilder;
import com.microsoft.graph.beta.identity.authenticationeventsflows.AuthenticationEventsFlowsRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.B2cUserFlowsRequestBuilder;
import com.microsoft.graph.beta.identity.b2xuserflows.B2xUserFlowsRequestBuilder;
import com.microsoft.graph.beta.identity.conditionalaccess.ConditionalAccessRequestBuilder;
...
import com.microsoft.graph.beta.identity.productchanges.ProductChangesRequestBuilder;
...
public class IdentityRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public ProductChangesRequestBuilder productChanges() {
        return new ProductChangesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
