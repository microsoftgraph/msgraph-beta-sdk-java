package com.microsoft.graph.beta.privacy.subjectrightsrequests.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SubjectRightsRequest;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.approvers.ApproversRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.approverswithuserprincipalname.ApproversWithUserPrincipalNameRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.collaborators.CollaboratorsRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.collaboratorswithuserprincipalname.CollaboratorsWithUserPrincipalNameRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.getfinalattachment.GetFinalAttachmentRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.getfinalreport.GetFinalReportRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.notes.NotesRequestBuilder;
import com.microsoft.graph.beta.privacy.subjectrightsrequests.item.team.TeamRequestBuilder;
...
public class SubjectRightsRequestItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @deprecated
     * The subject rights request API under Privacy is deprecated and will stop working on  March 22, 2025. Please use the new API under Security. as of 2022-02/PrivacyDeprecate
     * @see <a href="https://learn.microsoft.com/graph/api/subjectrightsrequest-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @deprecated
     * The subject rights request API under Privacy is deprecated and will stop working on  March 22, 2025. Please use the new API under Security. as of 2022-02/PrivacyDeprecate
     * @see <a href="https://learn.microsoft.com/graph/api/subjectrightsrequest-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    @Deprecated
