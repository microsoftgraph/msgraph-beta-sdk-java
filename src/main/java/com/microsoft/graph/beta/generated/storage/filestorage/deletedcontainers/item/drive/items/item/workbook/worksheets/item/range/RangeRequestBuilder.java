package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.worksheets.item.range;
...
public class RangeRequestBuilder extends BaseRequestBuilder {
    ...
    public RangeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range()", pathParameters);
    }
    /**
     * Instantiates a new {@link RangeRequestBuilder} and sets the default values.
    ...
    public RangeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range()", rawUrl);
    }
    /**
