package com.microsoft.graph.beta.users.item.deviceenrollmentconfigurations;

import com.microsoft.graph.beta.models.DeviceEnrollmentConfiguration;
import com.microsoft.graph.beta.models.DeviceEnrollmentConfigurationCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.deviceenrollmentconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.deviceenrollmentconfigurations.createenrollmentnotificationconfiguration.CreateEnrollmentNotificationConfigurationRequestBuilder;
import com.microsoft.graph.beta.users.item.deviceenrollmentconfigurations.haspayloadlinks.HasPayloadLinksRequestBuilder;
import com.microsoft.graph.beta.users.item.deviceenrollmentconfigurations.item.DeviceEnrollmentConfigurationItemRequestBuilder;
...
public class DeviceEnrollmentConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceEnrollmentConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceEnrollmentConfigurationsRequestBuilder} and sets the default values.
    ...
    public DeviceEnrollmentConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceEnrollmentConfiguration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations", pathParameters);
