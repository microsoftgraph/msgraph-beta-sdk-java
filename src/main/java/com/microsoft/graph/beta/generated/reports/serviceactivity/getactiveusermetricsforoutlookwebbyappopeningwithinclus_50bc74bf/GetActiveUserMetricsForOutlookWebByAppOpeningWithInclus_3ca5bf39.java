package com.microsoft.graph.beta.reports.serviceactivity.getactiveusermetricsforoutlookwebbyappopeningwithinclus_50bc74bf;
...
public class GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a {@link GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9}
    ...
    public GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9 get() {
        return get(null);
    }
    /**
     * Get all the active usage based on the number of active users that signed in and started Outlook for the web.
     ...
     */
    @jakarta.annotation.Nullable
    public GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9::createFromDiscriminatorValue);
    }
    /**
     * Get all the active usage based on the number of active users that signed in and started Outlook for the web.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39(rawUrl, requestAdapter);
    }
    /**
     * Get all the active usage based on the number of active users that signed in and started Outlook for the web.
     */
