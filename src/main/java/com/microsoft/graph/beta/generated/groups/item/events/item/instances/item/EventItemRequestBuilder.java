package com.microsoft.graph.beta.groups.item.events.item.instances.item;

import com.microsoft.graph.beta.groups.item.events.item.instances.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
