package com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments;

import com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.getorder.GetOrderRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.item.IdentityUserFlowAttributeAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.setorder.SetOrderRequestBuilder;
import com.microsoft.graph.beta.models.IdentityUserFlowAttributeAssignment;
import com.microsoft.graph.beta.models.IdentityUserFlowAttributeAssignmentCollectionResponse;
...
public class UserAttributeAssignmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/b2cidentityuserflow-list-userattributeassignments?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/b2cidentityuserflow-post-userattributeassignments?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final IdentityUserFlowAttributeAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments", pathParameters);
