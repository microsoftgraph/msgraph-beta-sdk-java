package com.microsoft.graph.beta.teamwork.deletedchats.item;

import com.microsoft.graph.beta.models.DeletedChat;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teamwork.deletedchats.item.undodelete.UndoDeleteRequestBuilder;
...
public class DeletedChatItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DeletedChatItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/deletedChats/{deletedChat%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeletedChatItemRequestBuilder} and sets the default values.
    ...
    public DeletedChatItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/deletedChats/{deletedChat%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/deletedchat-get?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teamwork/deletedChats/{deletedChat%2Did}{?%24expand,%24select}", pathParameters);
