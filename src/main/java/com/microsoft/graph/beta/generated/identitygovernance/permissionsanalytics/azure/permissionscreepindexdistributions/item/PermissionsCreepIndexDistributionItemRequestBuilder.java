package com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.item;

import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.item.authorizationsystem.AuthorizationSystemRequestBuilder;
...
public class PermissionsCreepIndexDistributionItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link AuthorizationSystemRequestBuilder}
     */
    ...
    /**
     * Instantiates a new {@link PermissionsCreepIndexDistributionItemRequestBuilder} and sets the default values.
    ...
    public PermissionsCreepIndexDistributionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionsCreepIndexDistributionItemRequestBuilder} and sets the default values.
    ...
    public PermissionsCreepIndexDistributionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public PermissionsCreepIndexDistribution get() {
        return get(null);
    }
    /**
     * Represents the Permissions Creep Index (PCI) for the authorization system. PCI distribution chart shows the classification of human and nonhuman identities based on the PCI score in three buckets (low, medium, high).
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionsCreepIndexDistribution get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionsCreepIndexDistribution patch(@jakarta.annotation.Nonnull final PermissionsCreepIndexDistribution body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PermissionsCreepIndexDistribution patch(@jakarta.annotation.Nonnull final PermissionsCreepIndexDistribution body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PermissionsCreepIndexDistribution body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution%2Did}", pathParameters);
