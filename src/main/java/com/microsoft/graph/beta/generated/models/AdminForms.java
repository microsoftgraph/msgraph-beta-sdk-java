...
public class AdminForms extends Entity implements Parsable {
    /**
     * Instantiates a new {@link AdminForms} and sets the default values.
     */
    public AdminForms() {
        super();
    }
    ...
    public static AdminForms createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setSettings(@jakarta.annotation.Nullable final FormsSettings value) {
