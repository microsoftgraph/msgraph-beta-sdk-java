...
public class OnPremisesWritebackConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link OnPremisesWritebackConfiguration} and sets the default values.
     */
    ...
    public String getUnifiedGroupContainer() {
        return this.backingStore.get("unifiedGroupContainer");
    }
    /**
    ...
    public String getUserContainer() {
        return this.backingStore.get("userContainer");
    }
    /**
    ...
    public void setUnifiedGroupContainer(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("unifiedGroupContainer", value);
    }
    /**
    ...
    public void setUserContainer(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("userContainer", value);
    }
}
