package com.microsoft.graph.beta.users.item.devices.item.registeredowners.item;

import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.users.item.devices.item.registeredowners.item.ref.RefRequestBuilder;
