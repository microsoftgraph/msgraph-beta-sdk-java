package com.microsoft.graph.beta.users.item.ownedobjects;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.ownedobjects.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.item.DirectoryObjectItemRequestBuilder;
...
public class OwnedObjectsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-ownedobjects?view=graph-rest-beta">Find more info here</a>
     */
