package com.microsoft.graph.beta.devicemanagement.deviceconfigurations.item.assign;

import com.microsoft.graph.beta.models.DeviceConfigurationAssignment;
...
public class AssignPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public java.util.List<DeviceConfigurationGroupAssignment> getDeviceConfigurationGroupAssignments() {
        return this.backingStore.get("deviceConfigurationGroupAssignments");
    }
    /**
     ...
     */
    public void setDeviceConfigurationGroupAssignments(@jakarta.annotation.Nullable final java.util.List<DeviceConfigurationGroupAssignment> value) {
        this.backingStore.set("deviceConfigurationGroupAssignments", value);
    }
}
