package com.microsoft.graph.beta.users.item.retryserviceprovisioning;
...
public class RetryServiceProvisioningRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/user-retryserviceprovisioning?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
