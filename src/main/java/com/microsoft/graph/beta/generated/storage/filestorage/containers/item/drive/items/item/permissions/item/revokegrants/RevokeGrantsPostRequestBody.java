package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.permissions.item.revokegrants;

import com.microsoft.graph.beta.models.DriveRecipient;
...
public class RevokeGrantsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RevokeGrantsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RevokeGrantsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public java.util.List<DriveRecipient> getGrantees() {
        return this.backingStore.get("grantees");
    }
    /**
    ...
    public void setGrantees(@jakarta.annotation.Nullable final java.util.List<DriveRecipient> value) {
        this.backingStore.set("grantees", value);
    }
}
