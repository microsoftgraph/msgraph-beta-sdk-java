package com.microsoft.graph.beta.teamwork.devices.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamworkDevice;
import com.microsoft.graph.beta.teamwork.devices.item.activity.ActivityRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.configuration.ConfigurationRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.health.HealthRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.restart.RestartRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.rundiagnostics.RunDiagnosticsRequestBuilder;
import com.microsoft.graph.beta.teamwork.devices.item.updatesoftware.UpdateSoftwareRequestBuilder;
...
public class TeamworkDeviceItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public TeamworkDeviceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamworkDeviceItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public TeamworkDeviceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}{?%24expand,%24select}", pathParameters);
