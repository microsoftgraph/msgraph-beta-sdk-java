package com.microsoft.graph.beta.devicemanagement.virtualendpoint.serviceplans;

import com.microsoft.graph.beta.devicemanagement.virtualendpoint.serviceplans.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.virtualendpoint.serviceplans.item.CloudPcServicePlanItemRequestBuilder;
import com.microsoft.graph.beta.models.CloudPcServicePlan;
import com.microsoft.graph.beta.models.CloudPcServicePlanCollectionResponse;
...
public class ServicePlansRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link CloudPcServicePlanItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ServicePlansRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/virtualEndpoint/servicePlans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CloudPcServicePlan body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/virtualEndpoint/servicePlans", pathParameters);
