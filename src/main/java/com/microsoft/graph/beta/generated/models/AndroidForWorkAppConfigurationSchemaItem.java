...
public class AndroidForWorkAppConfigurationSchemaItem implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link AndroidForWorkAppConfigurationSchemaItem} and sets the default values.
     */
     ...
     * @return a {@link AndroidForWorkAppConfigurationSchemaItem}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dataType", (n) -> { this.setDataType(n.getEnumValue(AndroidForWorkAppConfigurationSchemaItemDataType::forValue)); });
