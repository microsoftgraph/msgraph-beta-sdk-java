package com.microsoft.graph.beta.users.item.messages.item;

import com.microsoft.graph.beta.models.Message;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.messages.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.copy.CopyRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.createforward.CreateForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.createreply.CreateReplyRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.createreplyall.CreateReplyAllRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.markasjunk.MarkAsJunkRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.markasnotjunk.MarkAsNotJunkRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.mentions.MentionsRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.move.MoveRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.reply.ReplyRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.replyall.ReplyAllRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.reportmessage.ReportMessageRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.send.SendRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
import com.microsoft.graph.beta.users.item.messages.item.value.ContentRequestBuilder;
