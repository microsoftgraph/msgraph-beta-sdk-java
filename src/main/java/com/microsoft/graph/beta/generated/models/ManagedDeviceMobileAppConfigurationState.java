...
public class ManagedDeviceMobileAppConfigurationState extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("settingStates", (n) -> { this.setSettingStates(n.getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationSettingState::createFromDiscriminatorValue)); });
