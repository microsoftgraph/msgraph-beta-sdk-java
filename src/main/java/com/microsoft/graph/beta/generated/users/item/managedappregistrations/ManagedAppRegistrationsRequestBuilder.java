package com.microsoft.graph.beta.users.item.managedappregistrations;

import com.microsoft.graph.beta.models.ManagedAppRegistrationCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.managedappregistrations.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.managedappregistrations.item.ManagedAppRegistrationItemRequestBuilder;
...
public class ManagedAppRegistrationsRequestBuilder extends BaseRequestBuilder {
    ...
    public ManagedAppRegistrationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedAppRegistrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ManagedAppRegistrationsRequestBuilder} and sets the default values.
    ...
    public ManagedAppRegistrationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedAppRegistrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
