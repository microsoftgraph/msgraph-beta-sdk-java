package com.microsoft.graph.beta.security.threatintelligence.hostsslcertificates;
...
import com.microsoft.graph.beta.security.threatintelligence.hostsslcertificates.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostsslcertificates.item.HostSslCertificateItemRequestBuilder;
...
public class HostSslCertificatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link HostSslCertificatesRequestBuilder} and sets the default values.
    ...
    public HostSslCertificatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostSslCertificates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link HostSslCertificatesRequestBuilder} and sets the default values.
    ...
    public HostSslCertificatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostSslCertificates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final HostSslCertificate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/threatIntelligence/hostSslCertificates", pathParameters);
