...
public class AppConfigurationSchemaItemBooleanType extends AppConfigurationSchemaItemType implements Parsable {
    /**
     * Instantiates a new {@link AppConfigurationSchemaItemBooleanType} and sets the default values.
     */
    public AppConfigurationSchemaItemBooleanType() {
        super();
    ...
    public static AppConfigurationSchemaItemBooleanType createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
