package com.microsoft.graph.beta.admin.windows.updates.resourceconnections;

import com.microsoft.graph.beta.admin.windows.updates.resourceconnections.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.resourceconnections.item.ResourceConnectionItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.windowsupdates.ResourceConnection;
import com.microsoft.graph.beta.models.windowsupdates.ResourceConnectionCollectionResponse;
...
public class ResourceConnectionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ResourceConnectionsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/resourceConnections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
