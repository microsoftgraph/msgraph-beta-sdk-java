package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.databodyrange.offsetrangewithrowoffsetwithcolumnoffset;
...
public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder extends BaseRequestBuilder {
    ...
    public OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final Integer columnOffset, @jakarta.annotation.Nullable final Integer rowOffset) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/dataBodyRange()/offsetRange(rowOffset={rowOffset},columnOffset={columnOffset})", pathParameters);
    ...
    public OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/dataBodyRange()/offsetRange(rowOffset={rowOffset},columnOffset={columnOffset})", rawUrl);
    }
    /**
