...
public class CeilingPreciseRequestBuilder extends BaseRequestBuilder {
    ...
    public CeilingPreciseRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ceiling_Precise", pathParameters);
    }
    /**
     * Instantiates a new {@link CeilingPreciseRequestBuilder} and sets the default values.
    ...
    public CeilingPreciseRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/ceiling_Precise", rawUrl);
    }
    /**
