package com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.decisions.item.instance.stages.item.decisions.item;

import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.decisions.item.instance.stages.item.decisions.item.insights.InsightsRequestBuilder;
...
public class AccessReviewInstanceDecisionItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewInstanceDecisionItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewInstanceDecisionItemItemRequestBuilder} and sets the default values.
    ...
    public AccessReviewInstanceDecisionItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/instances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did1}{?%24expand,%24select}", rawUrl);
    }
    /**
