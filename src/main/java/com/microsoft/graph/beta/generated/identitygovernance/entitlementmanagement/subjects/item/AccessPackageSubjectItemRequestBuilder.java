package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.subjects.item;

import com.microsoft.graph.beta.identitygovernance.entitlementmanagement.subjects.item.connectedorganization.ConnectedOrganizationRequestBuilder;
...
public class AccessPackageSubjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AccessPackageSubject body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}", pathParameters);
