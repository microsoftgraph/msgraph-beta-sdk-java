package com.microsoft.graph.beta.print.printers.item.jobs.item.documents;
...
import com.microsoft.graph.beta.print.printers.item.jobs.item.documents.count.CountRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.documents.item.PrintDocumentItemRequestBuilder;
...
public class DocumentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/printdocument-get-file?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/documents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
