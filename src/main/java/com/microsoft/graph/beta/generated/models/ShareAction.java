...
public class ShareAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static ShareAction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("recipients", (n) -> { this.setRecipients(n.getCollectionOfObjectValues(IdentitySet::createFromDiscriminatorValue)); });
     ...
     */
    public void setRecipients(@jakarta.annotation.Nullable final java.util.List<IdentitySet> value) {
