package com.microsoft.graph.beta.devicemanagement.importedwindowsautopilotdeviceidentities;

import com.microsoft.graph.beta.devicemanagement.importedwindowsautopilotdeviceidentities.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.importedwindowsautopilotdeviceidentities.importescaped.ImportRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.importedwindowsautopilotdeviceidentities.item.ImportedWindowsAutopilotDeviceIdentityItemRequestBuilder;
import com.microsoft.graph.beta.models.ImportedWindowsAutopilotDeviceIdentity;
import com.microsoft.graph.beta.models.ImportedWindowsAutopilotDeviceIdentityCollectionResponse;
...
public class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/importedWindowsAutopilotDeviceIdentities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
