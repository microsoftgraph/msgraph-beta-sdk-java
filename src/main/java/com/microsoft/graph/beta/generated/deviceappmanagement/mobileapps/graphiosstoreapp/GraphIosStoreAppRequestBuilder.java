package com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphiosstoreapp;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphiosstoreapp.count.CountRequestBuilder;
import com.microsoft.graph.beta.models.IosStoreAppCollectionResponse;
...
public class GraphIosStoreAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphIosStoreAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosStoreApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new GraphIosStoreAppRequestBuilder and sets the default values.
    ...
    public GraphIosStoreAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.iosStoreApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
