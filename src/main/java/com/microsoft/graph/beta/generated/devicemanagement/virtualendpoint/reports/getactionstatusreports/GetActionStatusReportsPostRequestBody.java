package com.microsoft.graph.beta.devicemanagement.virtualendpoint.reports.getactionstatusreports;
...
public class GetActionStatusReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetActionStatusReportsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetActionStatusReportsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetActionStatusReportsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
