...
public class ResponseTimeSecurityRequirement extends SecurityRequirement implements Parsable {
     ...
     * @return a {@link ResponseTimeSecurityRequirementAverageResponseTimeInHours}
     */
    @jakarta.annotation.Nullable
    public ResponseTimeSecurityRequirementAverageResponseTimeInHours getAverageResponseTimeInHours() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("averageResponseTimeInHours", (n) -> { this.setAverageResponseTimeInHours(n.getObjectValue(ResponseTimeSecurityRequirementAverageResponseTimeInHours::createFromDiscriminatorValue)); });
     ...
     */
    public void setAverageResponseTimeInHours(@jakarta.annotation.Nullable final ResponseTimeSecurityRequirementAverageResponseTimeInHours value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class ResponseTimeSecurityRequirementAverageResponseTimeInHours implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link ResponseTimeSecurityRequirementAverageResponseTimeInHours} and sets the default values.
         */
        public ResponseTimeSecurityRequirementAverageResponseTimeInHours() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static ResponseTimeSecurityRequirementAverageResponseTimeInHours createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final ResponseTimeSecurityRequirementAverageResponseTimeInHours result = new ResponseTimeSecurityRequirementAverageResponseTimeInHours();
