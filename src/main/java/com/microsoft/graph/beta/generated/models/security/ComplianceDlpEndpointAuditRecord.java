...
public class ComplianceDlpEndpointAuditRecord extends AuditData implements Parsable {
    /**
    ...
    public ComplianceDlpEndpointAuditRecord() {
        super();
        this.setOdataType("#microsoft.graph.security.complianceDlpEndpointAuditRecord");
    }
    /**
