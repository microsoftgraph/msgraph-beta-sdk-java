package com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.userstatesummary.item.devicestates;

import com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.userstatesummary.item.devicestates.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.userstatesummary.item.devicestates.item.DeviceInstallStateItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceInstallState;
import com.microsoft.graph.beta.models.DeviceInstallStateCollectionResponse;
...
public class DeviceStatesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary/{userInstallStateSummary%2Did}/deviceStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceInstallState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary/{userInstallStateSummary%2Did}/deviceStates", pathParameters);
