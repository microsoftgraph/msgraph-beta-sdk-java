package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sectiongroups;

import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SectionGroupCollectionResponse;
...
public class SectionGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SectionGroupsRequestBuilder} and sets the default values.
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
