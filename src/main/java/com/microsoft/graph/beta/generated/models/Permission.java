...
public class Permission extends Entity implements Parsable {
    ...
    /**
     * Gets the roles property value. The type of permission, for example, read. See the Roles property values section for the full list of roles. Read-only.
    ...
    /**
     * Sets the roles property value. The type of permission, for example, read. See the Roles property values section for the full list of roles. Read-only.
