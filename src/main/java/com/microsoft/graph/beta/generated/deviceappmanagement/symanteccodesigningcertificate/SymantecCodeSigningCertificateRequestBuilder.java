...
public class SymantecCodeSigningCertificateRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link SymantecCodeSigningCertificateRequestBuilder} and sets the default values.
    ...
    public SymantecCodeSigningCertificateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/symantecCodeSigningCertificate", pathParameters);
    }
    /**
     * Instantiates a new {@link SymantecCodeSigningCertificateRequestBuilder} and sets the default values.
    ...
    public SymantecCodeSigningCertificateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/symantecCodeSigningCertificate", rawUrl);
    }
    /**
     ...
     * @return a {@link SymantecCodeSigningCertificate}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/symantecCodeSigningCertificate{?%24expand,%24select}", pathParameters);
