package com.microsoft.graph.beta.approvalworkflowproviders.item;

import com.microsoft.graph.beta.approvalworkflowproviders.item.businessflows.BusinessFlowsRequestBuilder;
import com.microsoft.graph.beta.approvalworkflowproviders.item.businessflowswithrequestsawaitingmydecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder;
import com.microsoft.graph.beta.approvalworkflowproviders.item.policytemplates.PolicyTemplatesRequestBuilder;
import com.microsoft.graph.beta.models.ApprovalWorkflowProvider;
...
public class ApprovalWorkflowProviderItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ApprovalWorkflowProviderItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApprovalWorkflowProviderItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ApprovalWorkflowProviderItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}{?%24expand,%24select}", pathParameters);
    ...
    public ApprovalWorkflowProviderItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        ...
        return new ApprovalWorkflowProviderItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
