package com.microsoft.graph.beta.organization.item.branding.themes.item.localizations.item.headerlogo;
...
public class HeaderLogoRequestBuilder extends BaseRequestBuilder {
    ...
    public HeaderLogoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/branding/themes/{organizationalBrandingTheme%2Did}/localizations/{organizationalBrandingThemeLocalization%2Dlocale}/headerLogo", pathParameters);
    }
    /**
     * Instantiates a new {@link HeaderLogoRequestBuilder} and sets the default values.
    ...
    public HeaderLogoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/branding/themes/{organizationalBrandingTheme%2Did}/localizations/{organizationalBrandingThemeLocalization%2Dlocale}/headerLogo", rawUrl);
    }
    /**
