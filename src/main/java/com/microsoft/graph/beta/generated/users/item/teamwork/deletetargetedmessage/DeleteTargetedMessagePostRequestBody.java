...
public class DeleteTargetedMessagePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeleteTargetedMessagePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link DeleteTargetedMessagePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static DeleteTargetedMessagePostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
