package com.microsoft.graph.beta.security.threatintelligence.intelligenceprofileindicators;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.IntelligenceProfileIndicator;
import com.microsoft.graph.beta.models.security.IntelligenceProfileIndicatorCollectionResponse;
import com.microsoft.graph.beta.security.threatintelligence.intelligenceprofileindicators.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.intelligenceprofileindicators.item.IntelligenceProfileIndicatorItemRequestBuilder;
...
public class IntelligenceProfileIndicatorsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link IntelligenceProfileIndicatorsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final IntelligenceProfileIndicator body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators", pathParameters);
