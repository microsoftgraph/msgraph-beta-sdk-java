package com.microsoft.graph.beta.drives.item.list;

import com.microsoft.graph.beta.drives.item.list.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.columns.ColumnsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.contenttypes.ContentTypesRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.drive.DriveRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.items.ItemsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.lastmodifiedbyuser.LastModifiedByUserRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.subscriptions.SubscriptionsRequestBuilder;
...
public class ListRequestBuilder extends BaseRequestBuilder {
    ...
    public ListRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list", pathParameters);
    }
    /**
     * Instantiates a new {@link ListRequestBuilder} and sets the default values.
    ...
    public ListRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/drives/{drive%2Did}/list{?%24expand,%24select}", pathParameters);
