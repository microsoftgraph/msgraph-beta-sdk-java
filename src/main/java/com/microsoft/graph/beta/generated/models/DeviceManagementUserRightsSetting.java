...
public class DeviceManagementUserRightsSetting implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DeviceManagementUserRightsSetting} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(StateManagementSetting::forValue)); });
     ...
     * @return a {@link java.util.List<DeviceManagementUserRightsLocalUserOrGroup>}
     */
