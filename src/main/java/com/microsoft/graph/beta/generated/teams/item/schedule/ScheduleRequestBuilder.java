package com.microsoft.graph.beta.teams.item.schedule;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Schedule;
import com.microsoft.graph.beta.teams.item.schedule.daynotes.DayNotesRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.openshifts.OpenShiftsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.share.ShareRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.shifts.ShiftsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.shiftsroledefinitions.ShiftsRoleDefinitionsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.timecards.TimeCardsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.timesoff.TimesOffRequestBuilder;
...
public class ScheduleRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/teams/{team%2Did}/schedule", pathParameters);
    ...
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final Schedule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PUT, "{+baseurl}/teams/{team%2Did}/schedule", pathParameters);
