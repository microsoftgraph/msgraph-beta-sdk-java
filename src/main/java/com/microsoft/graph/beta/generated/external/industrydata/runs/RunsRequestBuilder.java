package com.microsoft.graph.beta.external.industrydata.runs;
...
public class RunsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link IndustryDataRunItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public IndustryDataRunItemRequestBuilder byIndustryDataRunId(@jakarta.annotation.Nonnull final String industryDataRunId) {
        Objects.requireNonNull(industryDataRunId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("industryDataRun%2Did", industryDataRunId);
    ...
    public RunsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RunsRequestBuilder} and sets the default values.
    ...
    public RunsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get a list of the industryDataRun objects and their properties.
     * @return a {@link IndustryDataRunCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-industrydatarun-list?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public IndustryDataRunCollectionResponse get() {
        return get(null);
    }
    /**
     * Get a list of the industryDataRun objects and their properties.
     ...
     */
    @jakarta.annotation.Nullable
    public IndustryDataRunCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
