package com.microsoft.graph.beta.reports.manageddeviceenrollmentfailuredetailswithskipwithtopwit_49904c71;
...
public class ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280} and sets the default values.
     ...
     */
    public ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String filter, @jakarta.annotation.Nullable final Integer skip, @jakarta.annotation.Nullable final String skipToken, @jakarta.annotation.Nullable final Integer top) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWit_20e92280(rawUrl, requestAdapter);
    }
    /**
