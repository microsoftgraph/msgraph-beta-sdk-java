package com.microsoft.graph.beta.app.onlinemeetings;
...
import com.microsoft.graph.beta.app.onlinemeetings.getallrecordings.GetAllRecordingsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.getalltranscripts.GetAllTranscriptsRequestBuilder;
...
public class OnlineMeetingsRequestBuilder extends BaseRequestBuilder {
    ...
    public OnlineMeetingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new OnlineMeetingsRequestBuilder and sets the default values.
    ...
    public OnlineMeetingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
