package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.deltawithtoken.DeltaWithTokenRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.ListItemItemRequestBuilder;
