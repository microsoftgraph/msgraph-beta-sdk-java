package com.microsoft.graph.beta.devicemanagement.compliancemanagementpartners;

import com.microsoft.graph.beta.devicemanagement.compliancemanagementpartners.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.compliancemanagementpartners.item.ComplianceManagementPartnerItemRequestBuilder;
import com.microsoft.graph.beta.models.ComplianceManagementPartner;
import com.microsoft.graph.beta.models.ComplianceManagementPartnerCollectionResponse;
...
public class ComplianceManagementPartnersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ComplianceManagementPartnersRequestBuilder} and sets the default values.
    ...
    public ComplianceManagementPartnersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/complianceManagementPartners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ComplianceManagementPartnersRequestBuilder} and sets the default values.
    ...
    public ComplianceManagementPartnersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/complianceManagementPartners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * The list of Compliance Management Partners configured by the tenant.
     * @return a {@link ComplianceManagementPartnerCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ComplianceManagementPartner body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/complianceManagementPartners", pathParameters);
