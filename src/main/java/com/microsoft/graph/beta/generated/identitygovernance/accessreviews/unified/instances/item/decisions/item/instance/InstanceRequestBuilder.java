package com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance;

import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.acceptrecommendations.AcceptRecommendationsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.applydecisions.ApplyDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.batchapplycustomdataprovidedresourcedecisions.BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.batchrecorddecisions.BatchRecordDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.contactedreviewers.ContactedReviewersRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.definition.DefinitionRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.resetdecisions.ResetDecisionsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.sendreminder.SendReminderRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.stages.StagesRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.stop.StopRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.unified.instances.item.decisions.item.instance.stopapplydecisions.StopApplyDecisionsRequestBuilder;
...
public class InstanceRequestBuilder extends BaseRequestBuilder {
    ...
    public InstanceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link InstanceRequestBuilder} and sets the default values.
    ...
    public InstanceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/unified/instances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24expand,%24select}", rawUrl);
    }
    /**
