package com.microsoft.graph.beta.devicemanagement.reports.getwindowsqualityupdatealertsummaryreport;
...
public class GetWindowsQualityUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetWindowsQualityUpdateAlertSummaryReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetWindowsQualityUpdateAlertSummaryReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
