package com.microsoft.graph.beta.reports.azureadpremiumlicenseinsight;

import com.microsoft.graph.beta.models.AzureADPremiumLicenseInsight;
...
public class AzureADPremiumLicenseInsightRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public AzureADPremiumLicenseInsight get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AzureADPremiumLicenseInsight::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AzureADPremiumLicenseInsight patch(@jakarta.annotation.Nonnull final AzureADPremiumLicenseInsight body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AzureADPremiumLicenseInsight patch(@jakarta.annotation.Nonnull final AzureADPremiumLicenseInsight body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/azureADPremiumLicenseInsight{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AzureADPremiumLicenseInsight body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final AzureADPremiumLicenseInsight body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public AzureADPremiumLicenseInsightRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new AzureADPremiumLicenseInsightRequestBuilder(rawUrl, requestAdapter);
    }
    /**
