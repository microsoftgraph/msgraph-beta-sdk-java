...
public class QualityUpdateApprovalRule extends ApprovalRule implements Parsable {
    /**
     * Instantiates a new {@link QualityUpdateApprovalRule} and sets the default values.
     */
    public QualityUpdateApprovalRule() {
        super();
        this.setOdataType("#microsoft.graph.windowsUpdates.qualityUpdateApprovalRule");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link QualityUpdateApprovalRule}
     */
    @jakarta.annotation.Nonnull
    public static QualityUpdateApprovalRule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new QualityUpdateApprovalRule();
    }
    /**
