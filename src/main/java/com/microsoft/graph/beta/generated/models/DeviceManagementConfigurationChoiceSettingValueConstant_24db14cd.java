...
public class DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd extends DeviceManagementConfigurationChoiceSettingValueDefaultTemplate implements Parsable {
    /**
     * Instantiates a new {@link DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd} and sets the default values.
     */
    public DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd() {
        super();
     ...
     * @return a {@link DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd}
     */
    @jakarta.annotation.Nonnull
    public static DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd();
    }
    /**
     * Gets the children property value. Option Children
     * @return a {@link java.util.List<DeviceManagementConfigurationSettingInstanceTemplate>}
     */
