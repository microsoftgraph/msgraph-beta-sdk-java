...
public class UpdatePasswordSingleSignOnCredentialsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdatePasswordSingleSignOnCredentialsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link UpdatePasswordSingleSignOnCredentialsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static UpdatePasswordSingleSignOnCredentialsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
