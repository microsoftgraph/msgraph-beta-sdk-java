...
public class MicrosoftGraphIdentityGovernanceActivateWithScopeRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphIdentityGovernanceActivateWithScopeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/microsoft.graph.identityGovernance.activateWithScope", pathParameters);
    }
    /**
     * Instantiates a new {@link MicrosoftGraphIdentityGovernanceActivateWithScopeRequestBuilder} and sets the default values.
    ...
    public MicrosoftGraphIdentityGovernanceActivateWithScopeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/microsoft.graph.identityGovernance.activateWithScope", rawUrl);
    }
    /**
