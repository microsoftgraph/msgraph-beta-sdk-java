package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.lastmodifiedbyuser;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
