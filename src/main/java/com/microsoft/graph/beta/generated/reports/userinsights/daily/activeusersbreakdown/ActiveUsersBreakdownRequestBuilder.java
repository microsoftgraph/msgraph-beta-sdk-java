package com.microsoft.graph.beta.reports.userinsights.daily.activeusersbreakdown;

import com.microsoft.graph.beta.models.ActiveUsersBreakdownMetricCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.reports.userinsights.daily.activeusersbreakdown.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.userinsights.daily.activeusersbreakdown.item.ActiveUsersBreakdownMetricItemRequestBuilder;
...
public class ActiveUsersBreakdownRequestBuilder extends BaseRequestBuilder {
    ...
    public ActiveUsersBreakdownRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/daily/activeUsersBreakdown{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ActiveUsersBreakdownRequestBuilder and sets the default values.
    ...
    public ActiveUsersBreakdownRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights/daily/activeUsersBreakdown{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
