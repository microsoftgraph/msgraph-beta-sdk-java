package com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.hostedcontents;
...
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.hostedcontents.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
