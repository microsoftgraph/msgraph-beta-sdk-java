...
public class EducationGradingSchemeGrade implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EducationGradingSchemeGrade} and sets the default values.
     */
     ...
     * @return a {@link EducationGradingSchemeGrade}
     */
    @jakarta.annotation.Nonnull
    public static EducationGradingSchemeGrade createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
