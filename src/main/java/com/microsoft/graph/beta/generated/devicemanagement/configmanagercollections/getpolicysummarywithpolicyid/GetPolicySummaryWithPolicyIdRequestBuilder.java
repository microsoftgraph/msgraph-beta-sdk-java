package com.microsoft.graph.beta.devicemanagement.configmanagercollections.getpolicysummarywithpolicyid;

import com.microsoft.graph.beta.models.ConfigManagerPolicySummary;
...
public class GetPolicySummaryWithPolicyIdRequestBuilder extends BaseRequestBuilder {
    ...
    public ConfigManagerPolicySummary get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ConfigManagerPolicySummary::createFromDiscriminatorValue);
    }
    /**
     * Invoke function getPolicySummary
