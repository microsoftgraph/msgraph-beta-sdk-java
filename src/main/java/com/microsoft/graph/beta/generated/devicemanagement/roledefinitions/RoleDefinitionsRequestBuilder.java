package com.microsoft.graph.beta.devicemanagement.roledefinitions;

import com.microsoft.graph.beta.devicemanagement.roledefinitions.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.roledefinitions.item.RoleDefinitionItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RoleDefinition;
import com.microsoft.graph.beta.models.RoleDefinitionCollectionResponse;
...
public class RoleDefinitionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link RoleDefinitionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RoleDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/roleDefinitions", pathParameters);
