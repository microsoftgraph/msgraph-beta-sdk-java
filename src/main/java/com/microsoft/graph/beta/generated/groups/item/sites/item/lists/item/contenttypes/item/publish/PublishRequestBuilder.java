package com.microsoft.graph.beta.groups.item.sites.item.lists.item.contenttypes.item.publish;
...
public class PublishRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/contenttype-publish?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
