package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.f_inv_rt;
...
public class FInvRTPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link FInvRTPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link FInvRTPostRequestBody}
     */
    @jakarta.annotation.Nonnull
