package com.microsoft.graph.beta.groups.item.sites.item.lists.item;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.columns.ColumnsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.contenttypes.ContentTypesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.drive.DriveRequestBuilder;
...
public class ListItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ListItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ListItemRequestBuilder} and sets the default values.
    ...
    public ListItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}{?%24expand,%24select}", pathParameters);
