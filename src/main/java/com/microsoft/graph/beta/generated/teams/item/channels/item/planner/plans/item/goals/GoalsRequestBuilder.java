package com.microsoft.graph.beta.teams.item.channels.item.planner.plans.item.goals;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerGoalCollectionResponse;
import com.microsoft.graph.beta.teams.item.channels.item.planner.plans.item.goals.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.planner.plans.item.goals.item.PlannerGoalItemRequestBuilder;
...
public class GoalsRequestBuilder extends BaseRequestBuilder {
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GoalsRequestBuilder} and sets the default values.
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
