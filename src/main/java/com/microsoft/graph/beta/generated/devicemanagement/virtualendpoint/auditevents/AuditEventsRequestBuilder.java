package com.microsoft.graph.beta.devicemanagement.virtualendpoint.auditevents;

import com.microsoft.graph.beta.devicemanagement.virtualendpoint.auditevents.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.virtualendpoint.auditevents.getauditactivitytypes.GetAuditActivityTypesRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.virtualendpoint.auditevents.item.CloudPcAuditEventItemRequestBuilder;
import com.microsoft.graph.beta.models.CloudPcAuditEvent;
import com.microsoft.graph.beta.models.CloudPcAuditEventCollectionResponse;
...
public class AuditEventsRequestBuilder extends BaseRequestBuilder {
    ...
    public AuditEventsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AuditEventsRequestBuilder and sets the default values.
