...
public class GetTargetedUsersAndDevicesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetTargetedUsersAndDevicesPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetTargetedUsersAndDevicesPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetTargetedUsersAndDevicesPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<String> getDeviceConfigurationIds() {
        return this.backingStore.get("deviceConfigurationIds");
    }
    /**
     ...
     */
    public void setDeviceConfigurationIds(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("deviceConfigurationIds", value);
    }
}
