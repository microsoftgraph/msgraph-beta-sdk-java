package com.microsoft.graph.beta.shares.item.list.items;
...
import com.microsoft.graph.beta.shares.item.list.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.items.deltawithtoken.DeltaWithTokenRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.items.item.ListItemItemRequestBuilder;
