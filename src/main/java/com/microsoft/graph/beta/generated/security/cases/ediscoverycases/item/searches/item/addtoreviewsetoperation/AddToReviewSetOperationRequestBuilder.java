package com.microsoft.graph.beta.security.cases.ediscoverycases.item.searches.item.addtoreviewsetoperation;
...
public class AddToReviewSetOperationRequestBuilder extends BaseRequestBuilder {
    ...
    public AddToReviewSetOperationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/addToReviewSetOperation{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new AddToReviewSetOperationRequestBuilder and sets the default values.
    ...
    public AddToReviewSetOperationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/addToReviewSetOperation{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public EdiscoveryAddToReviewSetOperation get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, EdiscoveryAddToReviewSetOperation::createFromDiscriminatorValue);
    }
    /**
     * Adds the results of the eDiscovery search to the specified reviewSet.
