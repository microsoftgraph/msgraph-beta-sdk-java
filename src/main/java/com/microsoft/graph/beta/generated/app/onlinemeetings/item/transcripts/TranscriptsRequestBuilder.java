package com.microsoft.graph.beta.app.onlinemeetings.item.transcripts;

import com.microsoft.graph.beta.app.onlinemeetings.item.transcripts.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.transcripts.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.transcripts.item.CallTranscriptItemRequestBuilder;
...
public class TranscriptsRequestBuilder extends BaseRequestBuilder {
    ...
    public TranscriptsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TranscriptsRequestBuilder} and sets the default values.
    ...
    public TranscriptsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CallTranscript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts", pathParameters);
