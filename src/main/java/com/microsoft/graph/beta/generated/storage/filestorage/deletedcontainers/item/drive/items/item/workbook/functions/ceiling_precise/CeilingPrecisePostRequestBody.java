package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.ceiling_precise;
...
public class CeilingPrecisePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link CeilingPrecisePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CeilingPrecisePostRequestBody}
     */
    @jakarta.annotation.Nonnull
