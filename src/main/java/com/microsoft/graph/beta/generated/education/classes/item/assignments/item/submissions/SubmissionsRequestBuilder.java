package com.microsoft.graph.beta.education.classes.item.assignments.item.submissions;

import com.microsoft.graph.beta.education.classes.item.assignments.item.submissions.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignments.item.submissions.item.EducationSubmissionItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationSubmission;
import com.microsoft.graph.beta.models.EducationSubmissionCollectionResponse;
...
public class SubmissionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationassignment-list-submissions?view=graph-rest-beta">Find more info here</a>
     */
