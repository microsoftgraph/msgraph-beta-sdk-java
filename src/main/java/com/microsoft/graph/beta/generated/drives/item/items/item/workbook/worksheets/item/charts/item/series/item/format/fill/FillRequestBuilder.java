package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.series.item.format.fill;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.series.item.format.fill.clear.ClearRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.series.item.format.fill.setsolidcolor.SetSolidColorRequestBuilder;
