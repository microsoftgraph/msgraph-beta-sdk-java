...
public class EntityDefinition implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EntityDefinition} and sets the default values.
     */
     ...
     * @return a {@link EntityDefinition}
     */
    @jakarta.annotation.Nonnull
    public static EntityDefinition createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
