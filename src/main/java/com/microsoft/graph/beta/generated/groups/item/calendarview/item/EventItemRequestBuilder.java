package com.microsoft.graph.beta.groups.item.calendarview.item;

import com.microsoft.graph.beta.groups.item.calendarview.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
