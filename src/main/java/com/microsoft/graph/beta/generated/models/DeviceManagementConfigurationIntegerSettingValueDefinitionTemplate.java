...
public class DeviceManagementConfigurationIntegerSettingValueDefinitionTemplate implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeviceManagementConfigurationIntegerSettingValueDefinitionTemplate} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("minValue", (n) -> { this.setMinValue(n.getIntegerValue()); });
