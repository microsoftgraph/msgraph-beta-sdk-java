package com.microsoft.graph.beta.drives.item.items.item;
...
import com.microsoft.graph.beta.drives.item.items.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.contentstream.ContentStreamRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.copy.CopyRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.createlink.CreateLinkRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.createuploadsession.CreateUploadSessionRequestBuilder;
...
import com.microsoft.graph.beta.drives.item.items.item.getactivitiesbyintervalwithstartdatetimewithenddatetime_3adc0b7b.GetActivitiesByIntervalWithStartDateTimeWithEndDateTime_41999afb;
...
import com.microsoft.graph.beta.drives.item.items.item.workbook.WorkbookRequestBuilder;
