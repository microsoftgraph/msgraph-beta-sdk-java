package com.microsoft.graph.beta.solutions.migrations.crosstenantmigrationjobs.item;
...
public class CrossTenantMigrationJobItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/migrations/crossTenantMigrationJobs/{crossTenantMigrationJob%2Did}{?%24expand,%24select}", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public CrossTenantMigrationJobItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new CrossTenantMigrationJobItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
