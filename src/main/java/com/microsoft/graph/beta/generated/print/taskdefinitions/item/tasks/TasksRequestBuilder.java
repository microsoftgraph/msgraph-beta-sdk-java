package com.microsoft.graph.beta.print.taskdefinitions.item.tasks;
...
import com.microsoft.graph.beta.print.taskdefinitions.item.tasks.count.CountRequestBuilder;
import com.microsoft.graph.beta.print.taskdefinitions.item.tasks.item.PrintTaskItemRequestBuilder;
...
public class TasksRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/printtaskdefinition-list-tasks?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrintTask body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks", pathParameters);
