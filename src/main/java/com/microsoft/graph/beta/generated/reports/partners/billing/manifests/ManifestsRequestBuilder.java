package com.microsoft.graph.beta.reports.partners.billing.manifests;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.partners.billing.Manifest;
import com.microsoft.graph.beta.models.partners.billing.ManifestCollectionResponse;
import com.microsoft.graph.beta.reports.partners.billing.manifests.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.partners.billing.manifests.item.ManifestItemRequestBuilder;
...
public class ManifestsRequestBuilder extends BaseRequestBuilder {
    ...
    public ManifestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/partners/billing/manifests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ManifestsRequestBuilder and sets the default values.
    ...
    public ManifestsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/partners/billing/manifests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
