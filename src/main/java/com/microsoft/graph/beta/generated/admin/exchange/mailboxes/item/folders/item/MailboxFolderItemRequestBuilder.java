package com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item;

import com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.childfolders.ChildFoldersRequestBuilder;
import com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.items.ItemsRequestBuilder;
...
public class MailboxFolderItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @deprecated
     * Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport
     * @see <a href="https://learn.microsoft.com/graph/api/mailboxfolder-get?view=graph-rest-beta">Find more info here</a>
     */
