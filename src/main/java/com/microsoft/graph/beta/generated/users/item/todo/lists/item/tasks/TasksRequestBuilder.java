package com.microsoft.graph.beta.users.item.todo.lists.item.tasks;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TodoTask;
import com.microsoft.graph.beta.models.TodoTaskCollectionResponse;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.TodoTaskItemRequestBuilder;
