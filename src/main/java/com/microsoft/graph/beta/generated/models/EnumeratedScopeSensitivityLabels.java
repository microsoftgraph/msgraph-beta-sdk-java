...
public class EnumeratedScopeSensitivityLabels extends ScopeSensitivityLabels implements Parsable {
    /**
     * Instantiates a new {@link EnumeratedScopeSensitivityLabels} and sets the default values.
     */
     ...
     * @return a {@link EnumeratedScopeSensitivityLabels}
     */
    @jakarta.annotation.Nonnull
    public static EnumeratedScopeSensitivityLabels createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sensitivityLabels", (n) -> { this.setSensitivityLabels(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setSensitivityLabels(@jakarta.annotation.Nullable final java.util.List<String> value) {
