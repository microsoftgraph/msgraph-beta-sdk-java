...
public class NumberRange implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Integer getLowerNumber() {
        return this.backingStore.get("lowerNumber");
    }
    /**
    ...
    public Integer getUpperNumber() {
        return this.backingStore.get("upperNumber");
    }
    /**
    ...
    public void setLowerNumber(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("lowerNumber", value);
    }
    /**
    ...
    public void setUpperNumber(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("upperNumber", value);
    }
}
