package com.microsoft.graph.beta.users.item.cloudpcs.item.start;
...
public class StartRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/cloudpc-start?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void post() {
        post(null);
