package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.set.SetRequestBuilder;
