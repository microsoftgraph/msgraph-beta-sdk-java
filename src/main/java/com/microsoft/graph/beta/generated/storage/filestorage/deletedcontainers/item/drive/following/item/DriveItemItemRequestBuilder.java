package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.following.item;

import com.microsoft.graph.beta.models.DriveItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.following.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.following.item.contentstream.ContentStreamRequestBuilder;
...
public class DriveItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/following/{driveItem%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemItemRequestBuilder} and sets the default values.
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/following/{driveItem%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
