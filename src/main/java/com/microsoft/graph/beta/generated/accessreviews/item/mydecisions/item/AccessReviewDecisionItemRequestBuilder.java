package com.microsoft.graph.beta.accessreviews.item.mydecisions.item;
...
public class AccessReviewDecisionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewDecisionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions/{accessReviewDecision%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewDecisionItemRequestBuilder} and sets the default values.
    ...
    public AccessReviewDecisionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions/{accessReviewDecision%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions/{accessReviewDecision%2Did}{?%24expand,%24select}", pathParameters);
