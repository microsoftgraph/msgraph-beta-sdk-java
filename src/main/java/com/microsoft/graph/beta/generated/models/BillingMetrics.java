...
public class BillingMetrics extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("investigationHints", (n) -> { this.setInvestigationHints(n.getCollectionOfObjectValues(InvestigationActionStep::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<InvestigationActionStep> getInvestigationHints() {
