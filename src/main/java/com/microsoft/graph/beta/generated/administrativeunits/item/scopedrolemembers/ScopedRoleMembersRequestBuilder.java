package com.microsoft.graph.beta.administrativeunits.item.scopedrolemembers;

import com.microsoft.graph.beta.administrativeunits.item.scopedrolemembers.count.CountRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.scopedrolemembers.item.ScopedRoleMembershipItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ScopedRoleMembership;
import com.microsoft.graph.beta.models.ScopedRoleMembershipCollectionResponse;
...
public class ScopedRoleMembersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ScopedRoleMembersRequestBuilder} and sets the default values.
    ...
    public ScopedRoleMembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ScopedRoleMembersRequestBuilder} and sets the default values.
    ...
    public ScopedRoleMembersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/administrativeunit-list-scopedrolemembers?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/administrativeunit-post-scopedrolemembers?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
