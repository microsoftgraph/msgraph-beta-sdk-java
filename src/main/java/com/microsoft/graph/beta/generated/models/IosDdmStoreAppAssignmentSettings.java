...
public class IosDdmStoreAppAssignmentSettings extends MobileAppAssignmentSettings implements Parsable {
    /**
     * Instantiates a new {@link IosDdmStoreAppAssignmentSettings} and sets the default values.
     */
    public IosDdmStoreAppAssignmentSettings() {
        super();
     ...
     * @return a {@link IosDdmStoreAppAssignmentSettings}
     */
    @jakarta.annotation.Nonnull
    public static IosDdmStoreAppAssignmentSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
