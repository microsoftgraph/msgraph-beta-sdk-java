package com.microsoft.graph.beta.termstore.groups.item.sets.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.termstore.Set;
import com.microsoft.graph.beta.termstore.groups.item.sets.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.beta.termstore.groups.item.sets.item.parentgroup.ParentGroupRequestBuilder;
import com.microsoft.graph.beta.termstore.groups.item.sets.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.termstore.groups.item.sets.item.terms.TermsRequestBuilder;
...
public class SetItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SetItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SetItemRequestBuilder} and sets the default values.
    ...
    public SetItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Set body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}", pathParameters);
