package com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnifiedRoleAssignmentScheduleRequest;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.activatedusing.ActivatedUsingRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.roledefinition.RoleDefinitionRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.targetschedule.TargetScheduleRequestBuilder;
...
public class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/unifiedroleassignmentschedulerequest-get?view=graph-rest-beta">Find more info here</a>
     */
