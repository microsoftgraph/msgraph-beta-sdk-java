package com.microsoft.graph.beta.print.printers.item.jobs;
...
import com.microsoft.graph.beta.print.printers.item.jobs.count.CountRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.PrintJobItemRequestBuilder;
...
public class JobsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/printer-list-jobs?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printer-post-jobs?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
