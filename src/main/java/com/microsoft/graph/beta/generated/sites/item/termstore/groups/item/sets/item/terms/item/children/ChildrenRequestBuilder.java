package com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children;
...
import com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children.item.TermItemRequestBuilder;
