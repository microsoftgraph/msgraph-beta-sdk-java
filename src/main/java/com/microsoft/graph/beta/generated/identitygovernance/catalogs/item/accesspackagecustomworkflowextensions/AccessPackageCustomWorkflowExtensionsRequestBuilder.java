package com.microsoft.graph.beta.identitygovernance.catalogs.item.accesspackagecustomworkflowextensions;

import com.microsoft.graph.beta.identitygovernance.catalogs.item.accesspackagecustomworkflowextensions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.catalogs.item.accesspackagecustomworkflowextensions.item.CustomCalloutExtensionItemRequestBuilder;
import com.microsoft.graph.beta.models.CustomCalloutExtension;
import com.microsoft.graph.beta.models.CustomCalloutExtensionCollectionResponse;
...
public class AccessPackageCustomWorkflowExtensionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AccessPackageCustomWorkflowExtensionsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageCustomWorkflowExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CustomCalloutExtension body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageCustomWorkflowExtensions", pathParameters);
