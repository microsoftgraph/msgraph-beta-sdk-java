...
public class SharePointGroupIdentityMappingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SharePointGroupIdentityMappingItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/sharePoint/migrations/crossOrganizationGroupMappings/{sharePointGroupIdentityMapping%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SharePointGroupIdentityMappingItemRequestBuilder} and sets the default values.
    ...
    public SharePointGroupIdentityMappingItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/sharePoint/migrations/crossOrganizationGroupMappings/{sharePointGroupIdentityMapping%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
