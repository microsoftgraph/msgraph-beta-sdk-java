...
public class DeleteAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeleteAction} and sets the default values.
     */
    public DeleteAction() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static DeleteAction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
