package com.microsoft.graph.beta.financials.companies.item.companyinformation.item.picture;
...
public class PictureRequestBuilder extends BaseRequestBuilder {
    ...
    public PictureRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/companyInformation/{companyInformation%2Did}/picture", rawUrl);
    }
    /**
