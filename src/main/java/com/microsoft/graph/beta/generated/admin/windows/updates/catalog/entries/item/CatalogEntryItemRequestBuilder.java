...
public class CatalogEntryItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CatalogEntryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/catalog/entries/{catalogEntry%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CatalogEntryItemRequestBuilder and sets the default values.
    ...
    public CatalogEntryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/catalog/entries/{catalogEntry%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
