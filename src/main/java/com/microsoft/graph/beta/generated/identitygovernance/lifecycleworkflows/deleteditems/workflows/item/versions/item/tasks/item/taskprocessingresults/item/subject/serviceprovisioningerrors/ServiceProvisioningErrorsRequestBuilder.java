package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.versions.item.tasks.item.taskprocessingresults.item.subject.serviceprovisioningerrors;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.versions.item.tasks.item.taskprocessingresults.item.subject.serviceprovisioningerrors.count.CountRequestBuilder;
