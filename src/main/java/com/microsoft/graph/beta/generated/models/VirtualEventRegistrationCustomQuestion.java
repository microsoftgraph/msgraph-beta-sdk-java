...
public class VirtualEventRegistrationCustomQuestion extends VirtualEventRegistrationQuestionBase implements Parsable {
     ...
     * @return a VirtualEventRegistrationCustomQuestionAnswerInputType
     */
    @jakarta.annotation.Nullable
    public VirtualEventRegistrationCustomQuestionAnswerInputType getAnswerInputType() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("answerInputType", (n) -> { this.setAnswerInputType(n.getEnumValue(VirtualEventRegistrationCustomQuestionAnswerInputType::forValue)); });
     ...
     */
    public void setAnswerInputType(@jakarta.annotation.Nullable final VirtualEventRegistrationCustomQuestionAnswerInputType value) {
