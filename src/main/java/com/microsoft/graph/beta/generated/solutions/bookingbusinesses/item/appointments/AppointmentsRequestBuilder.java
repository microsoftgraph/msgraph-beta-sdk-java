package com.microsoft.graph.beta.solutions.bookingbusinesses.item.appointments;
...
import com.microsoft.graph.beta.solutions.bookingbusinesses.item.appointments.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.bookingbusinesses.item.appointments.item.BookingAppointmentItemRequestBuilder;
...
public class AppointmentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AppointmentsRequestBuilder} and sets the default values.
    ...
    public AppointmentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AppointmentsRequestBuilder} and sets the default values.
    ...
    public AppointmentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final BookingAppointment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments", pathParameters);
