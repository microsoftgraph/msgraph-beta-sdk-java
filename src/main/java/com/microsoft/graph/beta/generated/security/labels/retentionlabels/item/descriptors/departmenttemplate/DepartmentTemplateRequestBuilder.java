package com.microsoft.graph.beta.security.labels.retentionlabels.item.descriptors.departmenttemplate;
...
public class DepartmentTemplateRequestBuilder extends BaseRequestBuilder {
    ...
    public DepartmentTemplateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/descriptors/departmentTemplate{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DepartmentTemplateRequestBuilder and sets the default values.
    ...
    public DepartmentTemplateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/descriptors/departmentTemplate{?%24select,%24expand}", rawUrl);
    }
    /**
