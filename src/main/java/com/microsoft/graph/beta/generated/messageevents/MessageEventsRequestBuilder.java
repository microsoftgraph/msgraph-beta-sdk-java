package com.microsoft.graph.beta.messageevents;

import com.microsoft.graph.beta.messageevents.count.CountRequestBuilder;
import com.microsoft.graph.beta.messageevents.item.MessageEventItemRequestBuilder;
...
public class MessageEventsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link MessageEventsRequestBuilder} and sets the default values.
    ...
    public MessageEventsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/messageEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link MessageEventsRequestBuilder} and sets the default values.
    ...
    public MessageEventsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/messageEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MessageEvent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/messageEvents", pathParameters);
