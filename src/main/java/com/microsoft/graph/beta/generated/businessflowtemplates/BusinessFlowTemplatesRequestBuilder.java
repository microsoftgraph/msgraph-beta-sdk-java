package com.microsoft.graph.beta.businessflowtemplates;

import com.microsoft.graph.beta.businessflowtemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.businessflowtemplates.item.BusinessFlowTemplateItemRequestBuilder;
import com.microsoft.graph.beta.models.BusinessFlowTemplate;
import com.microsoft.graph.beta.models.BusinessFlowTemplateCollectionResponse;
...
public class BusinessFlowTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/businessFlowTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
