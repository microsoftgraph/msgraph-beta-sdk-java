package com.microsoft.graph.beta.groups.item.memberswithlicenseerrors;

import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberswithlicenseerrors.item.DirectoryObjectItemRequestBuilder;
