package com.microsoft.graph.beta.users.item.chats.item.messages;
...
import com.microsoft.graph.beta.users.item.chats.item.messages.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.forwardtochat.ForwardToChatRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.messages.replywithquote.ReplyWithQuoteRequestBuilder;
