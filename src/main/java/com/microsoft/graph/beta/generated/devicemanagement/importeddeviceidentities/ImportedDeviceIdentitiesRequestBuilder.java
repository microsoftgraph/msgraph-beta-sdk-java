package com.microsoft.graph.beta.devicemanagement.importeddeviceidentities;

import com.microsoft.graph.beta.devicemanagement.importeddeviceidentities.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.importeddeviceidentities.importdeviceidentitylist.ImportDeviceIdentityListRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.importeddeviceidentities.item.ImportedDeviceIdentityItemRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.importeddeviceidentities.searchexistingidentities.SearchExistingIdentitiesRequestBuilder;
import com.microsoft.graph.beta.models.ImportedDeviceIdentity;
import com.microsoft.graph.beta.models.ImportedDeviceIdentityCollectionResponse;
...
public class ImportedDeviceIdentitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/importedDeviceIdentities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
