package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.createdbyuser.serviceprovisioningerrors;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.createdbyuser.serviceprovisioningerrors.count.CountRequestBuilder;
