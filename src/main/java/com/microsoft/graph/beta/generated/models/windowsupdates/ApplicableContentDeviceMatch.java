...
public class ApplicableContentDeviceMatch implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ApplicableContentDeviceMatch} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ApplicableContentDeviceMatch createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<String> getRecommendedBy() {
        return this.backingStore.get("recommendedBy");
    }
    /**
     ...
     */
    public void setRecommendedBy(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("recommendedBy", value);
    }
}
