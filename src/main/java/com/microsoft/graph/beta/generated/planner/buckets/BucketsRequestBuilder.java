package com.microsoft.graph.beta.planner.buckets;
...
import com.microsoft.graph.beta.planner.buckets.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.buckets.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.planner.buckets.item.PlannerBucketItemRequestBuilder;
...
public class BucketsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/planner/buckets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PlannerBucket body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/planner/buckets", pathParameters);
