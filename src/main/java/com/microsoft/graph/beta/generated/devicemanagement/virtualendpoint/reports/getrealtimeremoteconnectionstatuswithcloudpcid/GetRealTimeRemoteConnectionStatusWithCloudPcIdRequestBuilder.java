package com.microsoft.graph.beta.devicemanagement.virtualendpoint.reports.getrealtimeremoteconnectionstatuswithcloudpcid;
...
public class GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String cloudPcId) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/getRealTimeRemoteConnectionStatus(cloudPcId='{cloudPcId}')", pathParameters);
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
