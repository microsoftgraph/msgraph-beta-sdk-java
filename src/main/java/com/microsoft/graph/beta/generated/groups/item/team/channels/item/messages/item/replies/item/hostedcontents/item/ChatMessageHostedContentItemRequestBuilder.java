package com.microsoft.graph.beta.groups.item.team.channels.item.messages.item.replies.item.hostedcontents.item;

import com.microsoft.graph.beta.groups.item.team.channels.item.messages.item.replies.item.hostedcontents.item.value.ContentRequestBuilder;
