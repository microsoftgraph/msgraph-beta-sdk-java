package com.microsoft.graph.beta.privilegedapproval.item.roleinfo.assignments.item;
...
public class PrivilegedRoleAssignmentItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrivilegedRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedRoleAssignmentItemRequestBuilder} and sets the default values.
    ...
    public PrivilegedRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
