package com.microsoft.graph.beta.devices.item.registeredusers;

import com.microsoft.graph.beta.devices.item.registeredusers.count.CountRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.graphapproleassignment.GraphAppRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.devices.item.registeredusers.ref.RefRequestBuilder;
...
public class RegisteredUsersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.devices.item.registeredUsers.item collection
    ...
    /**
     * Instantiates a new {@link RegisteredUsersRequestBuilder} and sets the default values.
    ...
    public RegisteredUsersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RegisteredUsersRequestBuilder} and sets the default values.
    ...
    public RegisteredUsersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/device-list-registeredusers?view=graph-rest-beta">Find more info here</a>
     */
