...
public class GetComplianceSettingsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetComplianceSettingsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetComplianceSettingsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetComplianceSettingsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
