package com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerTask;
import com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item.details.DetailsRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item.messages.MessagesRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.planner.plans.item.buckets.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
...
public class PlannerTaskItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PlannerTaskItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PlannerTaskItemRequestBuilder} and sets the default values.
    ...
    public PlannerTaskItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24expand,%24select}", pathParameters);
