package com.microsoft.graph.beta.devicemanagement.templates.item;

import com.microsoft.graph.beta.devicemanagement.templates.item.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.item.comparewithtemplateid.CompareWithTemplateIdRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.item.createinstance.CreateInstanceRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.item.migratableto.MigratableToRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.item.settings.SettingsRequestBuilder;
...
public class DeviceManagementTemplateItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceManagementTemplateItemRequestBuilder} and sets the default values.
    ...
    public DeviceManagementTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}", pathParameters);
