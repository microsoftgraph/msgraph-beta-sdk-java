...
public class AppleOwnerTypeEnrollmentType implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AppleOwnerTypeEnrollmentType} and sets the default values.
     */
     ...
     * @return a {@link AppleOwnerTypeEnrollmentType}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enrollmentType", (n) -> { this.setEnrollmentType(n.getEnumValue(AppleUserInitiatedEnrollmentType::forValue)); });
     ...
     */
    public void setEnrollmentType(@jakarta.annotation.Nullable final AppleUserInitiatedEnrollmentType value) {
