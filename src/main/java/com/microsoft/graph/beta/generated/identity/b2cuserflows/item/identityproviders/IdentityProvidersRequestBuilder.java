package com.microsoft.graph.beta.identity.b2cuserflows.item.identityproviders;

import com.microsoft.graph.beta.identity.b2cuserflows.item.identityproviders.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.item.identityproviders.item.IdentityProviderItemRequestBuilder;
import com.microsoft.graph.beta.identity.b2cuserflows.item.identityproviders.ref.RefRequestBuilder;
...
public class IdentityProvidersRequestBuilder extends BaseRequestBuilder {
    ...
    public IdentityProvidersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/identityProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link IdentityProvidersRequestBuilder} and sets the default values.
    ...
    public IdentityProvidersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/identityProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
