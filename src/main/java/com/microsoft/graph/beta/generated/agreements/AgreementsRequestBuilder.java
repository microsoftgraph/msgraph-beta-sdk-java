package com.microsoft.graph.beta.agreements;

import com.microsoft.graph.beta.agreements.item.AgreementItemRequestBuilder;
import com.microsoft.graph.beta.models.Agreement;
import com.microsoft.graph.beta.models.AgreementCollectionResponse;
...
public class AgreementsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/agreements{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
