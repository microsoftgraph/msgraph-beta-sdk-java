package com.microsoft.graph.beta.policies.permissiongrantpolicies.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PermissionGrantPolicy;
import com.microsoft.graph.beta.policies.permissiongrantpolicies.item.excludes.ExcludesRequestBuilder;
import com.microsoft.graph.beta.policies.permissiongrantpolicies.item.includes.IncludesRequestBuilder;
...
public class PermissionGrantPolicyItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionGrantPolicyItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionGrantPolicyItemRequestBuilder} and sets the default values.
    ...
    public PermissionGrantPolicyItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}", rawUrl);
    }
    /**
     * Delete a permissionGrantPolicy object.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link PermissionGrantPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}{?%24expand,%24select}", pathParameters);
