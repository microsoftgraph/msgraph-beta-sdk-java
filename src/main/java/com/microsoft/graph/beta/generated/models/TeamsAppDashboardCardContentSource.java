...
public class TeamsAppDashboardCardContentSource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TeamsAppDashboardCardContentSource} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static TeamsAppDashboardCardContentSource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public TeamsAppDashboardCardBotConfiguration getBotConfiguration() {
        return this.backingStore.get("botConfiguration");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("botConfiguration", (n) -> { this.setBotConfiguration(n.getObjectValue(TeamsAppDashboardCardBotConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("sourceType", (n) -> { this.setSourceType(n.getEnumValue(TeamsAppDashboardCardSourceType::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public TeamsAppDashboardCardSourceType getSourceType() {
    ...
    public void setBotConfiguration(@jakarta.annotation.Nullable final TeamsAppDashboardCardBotConfiguration value) {
        this.backingStore.set("botConfiguration", value);
    }
    /**
