package com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.directories;

import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.directories.count.CountRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
...
public class DirectoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoriesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new DirectoriesRequestBuilder and sets the default values.
    ...
    public DirectoriesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
