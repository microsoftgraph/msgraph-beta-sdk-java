package com.microsoft.graph.beta.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.replywithquote;
...
public class ReplyWithQuoteRequestBuilder extends BaseRequestBuilder {
    ...
    public ReplyWithQuoteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/replyWithQuote", pathParameters);
    }
    /**
     * Instantiates a new {@link ReplyWithQuoteRequestBuilder} and sets the default values.
    ...
    public ReplyWithQuoteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/replyWithQuote", rawUrl);
    }
    /**
