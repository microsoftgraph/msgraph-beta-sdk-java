...
public class HardwareOathAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable {
    /**
     * Instantiates a new {@link HardwareOathAuthenticationMethodConfiguration} and sets the default values.
     */
    public HardwareOathAuthenticationMethodConfiguration() {
        super();
        this.setOdataType("#microsoft.graph.hardwareOathAuthenticationMethodConfiguration");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link HardwareOathAuthenticationMethodConfiguration}
     */
