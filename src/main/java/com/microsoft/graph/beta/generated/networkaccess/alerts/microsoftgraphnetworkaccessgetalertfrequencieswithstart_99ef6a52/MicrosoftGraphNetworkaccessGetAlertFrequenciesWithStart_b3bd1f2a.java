...
public class MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a extends BaseRequestBuilder {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a}
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a(rawUrl, requestAdapter);
    }
    /**
     * Invoke function getAlertFrequencies
     */
