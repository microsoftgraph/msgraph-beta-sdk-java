package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwindowsmobilemsi;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwindowsmobilemsi.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwindowsmobilemsi.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwindowsmobilemsi.contentversions.ContentVersionsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwindowsmobilemsi.relationships.RelationshipsRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WindowsMobileMSI;
...
public class GraphWindowsMobileMSIRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphWindowsMobileMSIRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI{?%24expand,%24select}", rawUrl);
    }
    /**
