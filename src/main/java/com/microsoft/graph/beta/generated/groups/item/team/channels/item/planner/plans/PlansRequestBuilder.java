package com.microsoft.graph.beta.groups.item.team.channels.item.planner.plans;

import com.microsoft.graph.beta.groups.item.team.channels.item.planner.plans.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.planner.plans.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.planner.plans.item.PlannerPlanItemRequestBuilder;
...
public class PlansRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/planner/plans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PlannerPlan body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/planner/plans", pathParameters);
