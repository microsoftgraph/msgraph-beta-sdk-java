...
public class SynchronizationJobRestartCriteria implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("resetScope", (n) -> { this.setResetScope(n.getEnumValue(SynchronizationJobRestartCriteriaResetScope::forValue)); });
     ...
     * @return a SynchronizationJobRestartCriteriaResetScope
     */
    @jakarta.annotation.Nullable
    public SynchronizationJobRestartCriteriaResetScope getResetScope() {
     ...
     */
    public void setResetScope(@jakarta.annotation.Nullable final SynchronizationJobRestartCriteriaResetScope value) {
