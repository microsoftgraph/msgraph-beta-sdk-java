package com.microsoft.graph.beta.admin.windows;

import com.microsoft.graph.beta.admin.windows.updates.UpdatesRequestBuilder;
import com.microsoft.graph.beta.models.AdminWindows;
...
public class WindowsRequestBuilder extends BaseRequestBuilder {
    ...
    public WindowsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows", pathParameters);
    }
    /**
     * Instantiates a new {@link WindowsRequestBuilder} and sets the default values.
    ...
    public WindowsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AdminWindows get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AdminWindows::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AdminWindows patch(@jakarta.annotation.Nonnull final AdminWindows body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AdminWindows patch(@jakarta.annotation.Nonnull final AdminWindows body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows{?%24expand,%24select}", pathParameters);
