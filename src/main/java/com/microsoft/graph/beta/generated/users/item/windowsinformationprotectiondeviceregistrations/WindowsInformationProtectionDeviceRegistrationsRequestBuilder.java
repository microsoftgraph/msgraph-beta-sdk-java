package com.microsoft.graph.beta.users.item.windowsinformationprotectiondeviceregistrations;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WindowsInformationProtectionDeviceRegistrationCollectionResponse;
import com.microsoft.graph.beta.users.item.windowsinformationprotectiondeviceregistrations.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.windowsinformationprotectiondeviceregistrations.item.WindowsInformationProtectionDeviceRegistrationItemRequestBuilder;
