...
public class TokenIssuancePolicy extends StsPolicy implements Parsable {
    /**
     * Instantiates a new {@link TokenIssuancePolicy} and sets the default values.
     */
    ...
    public static TokenIssuancePolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
