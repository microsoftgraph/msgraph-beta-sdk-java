package com.microsoft.graph.beta.users.item.onlinemeetings.item.meetingattendancereport.attendancerecords;
...
import com.microsoft.graph.beta.users.item.onlinemeetings.item.meetingattendancereport.attendancerecords.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.onlinemeetings.item.meetingattendancereport.attendancerecords.item.AttendanceRecordItemRequestBuilder;
...
public class AttendanceRecordsRequestBuilder extends BaseRequestBuilder {
    ...
    public AttendanceRecordsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AttendanceRecordsRequestBuilder} and sets the default values.
    ...
    public AttendanceRecordsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AttendanceRecord body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords", pathParameters);
