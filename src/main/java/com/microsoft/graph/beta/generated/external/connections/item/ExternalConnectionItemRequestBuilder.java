package com.microsoft.graph.beta.external.connections.item;

import com.microsoft.graph.beta.external.connections.item.groups.GroupsRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.items.ItemsRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.quota.QuotaRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.schema.SchemaRequestBuilder;
...
public class ExternalConnectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ExternalConnectionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExternalConnectionItemRequestBuilder} and sets the default values.
    ...
    public ExternalConnectionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}", rawUrl);
    }
    /**
     * Delete an externalConnection.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalconnection-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalconnection-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link ExternalConnection}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalconnection-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/external/connections/{externalConnection%2Did}{?%24expand,%24select}", pathParameters);
