package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmacosdmgapp;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmacosdmgapp.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmacosdmgapp.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmacosdmgapp.contentversions.ContentVersionsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmacosdmgapp.relationships.RelationshipsRequestBuilder;
import com.microsoft.graph.beta.models.MacOSDmgApp;
...
public class GraphMacOSDmgAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphMacOSDmgAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSDmgApp{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphMacOSDmgAppRequestBuilder and sets the default values.
    ...
    public GraphMacOSDmgAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSDmgApp{?%24select,%24expand}", rawUrl);
    }
    /**
