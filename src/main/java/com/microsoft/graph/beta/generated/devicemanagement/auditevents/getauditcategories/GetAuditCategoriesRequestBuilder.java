package com.microsoft.graph.beta.devicemanagement.auditevents.getauditcategories;
...
public class GetAuditCategoriesRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetAuditCategoriesRequestBuilder} and sets the default values.
    ...
    public GetAuditCategoriesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/auditEvents/getAuditCategories(){?%24count,%24filter,%24search,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAuditCategoriesRequestBuilder} and sets the default values.
