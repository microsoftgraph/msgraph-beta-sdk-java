package com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews;

import com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.serviceannouncement.healthoverviews.item.ServiceHealthItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ServiceHealth;
import com.microsoft.graph.beta.models.ServiceHealthCollectionResponse;
...
public class HealthOverviewsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ServiceHealthItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link HealthOverviewsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/serviceannouncement-list-healthoverviews?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/serviceAnnouncement/healthOverviews{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link HealthOverviewsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
