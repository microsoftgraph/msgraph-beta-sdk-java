package com.microsoft.graph.beta.app.calls.item.operations;

import com.microsoft.graph.beta.app.calls.item.operations.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.calls.item.operations.item.CommsOperationItemRequestBuilder;
import com.microsoft.graph.beta.models.CommsOperation;
import com.microsoft.graph.beta.models.CommsOperationCollectionResponse;
...
public class OperationsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link CommsOperationItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public CommsOperationItemRequestBuilder byCommsOperationId(@jakarta.annotation.Nonnull final String commsOperationId) {
    ...
    public OperationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OperationsRequestBuilder} and sets the default values.
    ...
    public OperationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public CommsOperationCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, CommsOperationCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CommsOperation body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CommsOperation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
