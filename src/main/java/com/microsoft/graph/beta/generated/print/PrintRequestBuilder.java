package com.microsoft.graph.beta.print;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Print;
import com.microsoft.graph.beta.print.connectors.ConnectorsRequestBuilder;
import com.microsoft.graph.beta.print.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.print.printers.PrintersRequestBuilder;
import com.microsoft.graph.beta.print.printershares.PrinterSharesRequestBuilder;
import com.microsoft.graph.beta.print.services.ServicesRequestBuilder;
import com.microsoft.graph.beta.print.shares.SharesRequestBuilder;
import com.microsoft.graph.beta.print.taskdefinitions.TaskDefinitionsRequestBuilder;
...
public class PrintRequestBuilder extends BaseRequestBuilder {
    ...
    public PrinterSharesRequestBuilder printerShares() {
        return new PrinterSharesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/print{?%24expand,%24select}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Print body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/print", pathParameters);
