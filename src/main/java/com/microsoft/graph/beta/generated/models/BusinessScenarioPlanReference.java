...
public class BusinessScenarioPlanReference extends Entity implements Parsable {
    /**
     * Instantiates a new {@link BusinessScenarioPlanReference} and sets the default values.
     */
    ...
    public static BusinessScenarioPlanReference createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
