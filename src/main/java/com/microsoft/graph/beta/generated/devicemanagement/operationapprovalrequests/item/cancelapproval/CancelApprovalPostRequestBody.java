package com.microsoft.graph.beta.devicemanagement.operationapprovalrequests.item.cancelapproval;
...
public class CancelApprovalPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CancelApprovalPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CancelApprovalPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CancelApprovalPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link OperationApprovalSource}
     */
