package com.microsoft.graph.beta.security.cases.ediscoverycases.item.tags.item.childtags;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.EdiscoveryReviewTagCollectionResponse;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.tags.item.childtags.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.tags.item.childtags.item.EdiscoveryReviewTagItemRequestBuilder;
...
public class ChildTagsRequestBuilder extends BaseRequestBuilder {
    ...
    public ChildTagsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/childTags{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChildTagsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-ediscoveryreviewtag-ashierarchy?view=graph-rest-beta">Find more info here</a>
     */
