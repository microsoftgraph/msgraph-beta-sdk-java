...
public class AssignResourceAccountToDevicePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AssignResourceAccountToDevicePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AssignResourceAccountToDevicePostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public String getResourceAccountName() {
        return this.backingStore.get("resourceAccountName");
    }
    /**
    ...
    public void setResourceAccountName(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("resourceAccountName", value);
    }
    /**
