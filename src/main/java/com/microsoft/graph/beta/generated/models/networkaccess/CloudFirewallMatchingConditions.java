...
public class CloudFirewallMatchingConditions implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudFirewallMatchingConditions} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CloudFirewallMatchingConditions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public CloudFirewallDestinationMatching getDestinations() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("destinations", (n) -> { this.setDestinations(n.getObjectValue(CloudFirewallDestinationMatching::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("sources", (n) -> { this.setSources(n.getObjectValue(CloudFirewallSourceMatching::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public CloudFirewallSourceMatching getSources() {
     ...
     */
    public void setDestinations(@jakarta.annotation.Nullable final CloudFirewallDestinationMatching value) {
     ...
     */
    public void setSources(@jakarta.annotation.Nullable final CloudFirewallSourceMatching value) {
