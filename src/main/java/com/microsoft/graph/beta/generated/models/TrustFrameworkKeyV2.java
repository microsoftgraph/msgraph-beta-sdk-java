...
public class TrustFrameworkKeyV2 implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link TrustFrameworkKeyV2} and sets the default values.
     */
     ...
     * @return a {@link TrustFrameworkKeyV2}
     */
    @jakarta.annotation.Nonnull
    public static TrustFrameworkKeyV2 createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
