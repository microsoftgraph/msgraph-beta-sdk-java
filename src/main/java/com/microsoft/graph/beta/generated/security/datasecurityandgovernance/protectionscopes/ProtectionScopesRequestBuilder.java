package com.microsoft.graph.beta.security.datasecurityandgovernance.protectionscopes;
...
public class ProtectionScopesRequestBuilder extends BaseRequestBuilder {
    ...
    public TenantProtectionScopeContainer get() {
        return get(null);
    }
    /**
     * Container for actions related to computing tenant-wide data protection scopes.
     ...
     */
    @jakarta.annotation.Nullable
    public TenantProtectionScopeContainer get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, TenantProtectionScopeContainer::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public TenantProtectionScopeContainer patch(@jakarta.annotation.Nonnull final TenantProtectionScopeContainer body) {
     ...
     */
    @jakarta.annotation.Nullable
    public TenantProtectionScopeContainer patch(@jakarta.annotation.Nonnull final TenantProtectionScopeContainer body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/dataSecurityAndGovernance/protectionScopes{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TenantProtectionScopeContainer body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TenantProtectionScopeContainer body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
