package com.microsoft.graph.beta.places.item.graphbuilding;
...
public class GraphBuildingRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public MapRequestBuilder mapEscaped() {
        return new MapRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public GraphBuildingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphBuildingRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public Building get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
