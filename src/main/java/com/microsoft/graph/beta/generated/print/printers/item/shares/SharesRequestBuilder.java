package com.microsoft.graph.beta.print.printers.item.shares;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrinterShareCollectionResponse;
import com.microsoft.graph.beta.print.printers.item.shares.count.CountRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.shares.item.PrinterShareItemRequestBuilder;
...
public class SharesRequestBuilder extends BaseRequestBuilder {
    ...
    public SharesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/shares{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SharesRequestBuilder} and sets the default values.
    ...
    public SharesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/shares{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
