package com.microsoft.graph.beta.users.item.transitivememberof;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.transitivememberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.users.item.transitivememberof.graphdirectoryrole.GraphDirectoryRoleRequestBuilder;
import com.microsoft.graph.beta.users.item.transitivememberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.users.item.transitivememberof.item.DirectoryObjectItemRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-transitivememberof?view=graph-rest-beta">Find more info here</a>
     */
