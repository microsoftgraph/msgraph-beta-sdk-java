...
public class RetrieveAssignedApplicationsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetrieveAssignedApplicationsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RetrieveAssignedApplicationsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RetrieveAssignedApplicationsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("groupby", (n) -> { this.setGroupby(n.getStringValue()); });
        deserializerMap.put("orderby", (n) -> { this.setOrderby(n.getStringValue()); });
        deserializerMap.put("search", (n) -> { this.setSearch(n.getStringValue()); });
        deserializerMap.put("select", (n) -> { this.setSelect(n.getStringValue()); });
     ...
     */
    public void setGroupby(@jakarta.annotation.Nullable final String value) {
     ...
     */
    public void setSelect(@jakarta.annotation.Nullable final String value) {
