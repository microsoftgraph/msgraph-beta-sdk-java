package com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages;
...
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.MessageItemRequestBuilder;
