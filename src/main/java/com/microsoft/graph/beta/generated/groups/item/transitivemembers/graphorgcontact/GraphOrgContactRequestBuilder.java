package com.microsoft.graph.beta.groups.item.transitivemembers.graphorgcontact;

import com.microsoft.graph.beta.groups.item.transitivemembers.graphorgcontact.count.CountRequestBuilder;
...
public class GraphOrgContactRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphOrgContactRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphOrgContactRequestBuilder} and sets the default values.
    ...
    public GraphOrgContactRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
