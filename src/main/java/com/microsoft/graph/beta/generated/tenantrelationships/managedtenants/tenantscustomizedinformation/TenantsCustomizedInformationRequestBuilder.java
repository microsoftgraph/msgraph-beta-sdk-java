package com.microsoft.graph.beta.tenantrelationships.managedtenants.tenantscustomizedinformation;

import com.microsoft.graph.beta.models.managedtenants.TenantCustomizedInformation;
import com.microsoft.graph.beta.models.managedtenants.TenantCustomizedInformationCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.tenantscustomizedinformation.count.CountRequestBuilder;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.tenantscustomizedinformation.item.TenantCustomizedInformationItemRequestBuilder;
...
public class TenantsCustomizedInformationRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-tenantscustomizedinformation?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/tenantRelationships/managedTenants/tenantsCustomizedInformation{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
