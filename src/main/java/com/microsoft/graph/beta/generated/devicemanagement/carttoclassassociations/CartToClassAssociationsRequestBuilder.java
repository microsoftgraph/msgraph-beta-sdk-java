package com.microsoft.graph.beta.devicemanagement.carttoclassassociations;

import com.microsoft.graph.beta.devicemanagement.carttoclassassociations.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.carttoclassassociations.item.CartToClassAssociationItemRequestBuilder;
import com.microsoft.graph.beta.models.CartToClassAssociation;
import com.microsoft.graph.beta.models.CartToClassAssociationCollectionResponse;
...
public class CartToClassAssociationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/cartToClassAssociations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
