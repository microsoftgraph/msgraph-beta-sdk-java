package com.microsoft.graph.beta.networkaccess.logs.traffic.item.user;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.networkaccess.logs.traffic.item.user.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.networkaccess.logs.traffic.item.user.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserRequestBuilder extends BaseRequestBuilder {
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}/user{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserRequestBuilder} and sets the default values.
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}/user{?%24expand,%24select}", rawUrl);
    }
    /**
