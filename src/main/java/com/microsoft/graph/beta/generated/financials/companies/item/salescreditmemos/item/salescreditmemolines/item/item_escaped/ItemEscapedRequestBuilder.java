package com.microsoft.graph.beta.financials.companies.item.salescreditmemos.item.salescreditmemolines.item.item_escaped;

import com.microsoft.graph.beta.financials.companies.item.salescreditmemos.item.salescreditmemolines.item.item_escaped.itemcategory.ItemCategoryRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salescreditmemos.item.salescreditmemolines.item.item_escaped.picture.PictureRequestBuilder;
...
public class ItemEscapedRequestBuilder extends BaseRequestBuilder {
    ...
    public ItemEscapedRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item", pathParameters);
    }
    /**
     * Instantiates a new {@link ItemEscapedRequestBuilder} and sets the default values.
    ...
    public ItemEscapedRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item{?%24expand,%24select}", pathParameters);
