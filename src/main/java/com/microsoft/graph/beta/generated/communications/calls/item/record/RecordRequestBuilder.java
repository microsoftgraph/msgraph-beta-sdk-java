package com.microsoft.graph.beta.communications.calls.item.record;
...
public class RecordRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RecordRequestBuilder} and sets the default values.
    ...
    public RecordOperation post(@jakarta.annotation.Nonnull final RecordPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public RecordOperation post(@jakarta.annotation.Nonnull final RecordPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
