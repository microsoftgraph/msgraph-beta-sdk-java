...
public class MetaDataKeyStringPair implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MetaDataKeyStringPair} and sets the default values.
     */
     ...
     * @return a {@link MetaDataKeyStringPair}
     */
    @jakarta.annotation.Nonnull
    public static MetaDataKeyStringPair createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
