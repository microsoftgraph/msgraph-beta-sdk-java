package com.microsoft.graph.beta.groups.item.sites.item.analytics;

import com.microsoft.graph.beta.groups.item.sites.item.analytics.alltime.AllTimeRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.analytics.itemactivitystats.ItemActivityStatsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.analytics.lastsevendays.LastSevenDaysRequestBuilder;
import com.microsoft.graph.beta.models.ItemAnalytics;
...
public class AnalyticsRequestBuilder extends BaseRequestBuilder {
    ...
    public AnalyticsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AnalyticsRequestBuilder} and sets the default values.
    ...
    public AnalyticsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ItemAnalytics body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics", pathParameters);
