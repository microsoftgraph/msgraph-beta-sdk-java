package com.microsoft.graph.beta.teamwork.teamsappsettings;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamsAppSettings;
...
public class TeamsAppSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsAppSettingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamsAppSettings", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsAppSettingsRequestBuilder} and sets the default values.
    ...
    public TeamsAppSettingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamsAppSettings", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/teamsappsettings-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link TeamsAppSettings}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/teamsappsettings-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teamwork/teamsAppSettings{?%24expand,%24select}", pathParameters);
