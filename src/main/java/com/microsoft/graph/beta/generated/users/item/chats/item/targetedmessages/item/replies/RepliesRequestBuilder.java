package com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies;
...
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.forwardtochat.ForwardToChatRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.replywithquote.ReplyWithQuoteRequestBuilder;
