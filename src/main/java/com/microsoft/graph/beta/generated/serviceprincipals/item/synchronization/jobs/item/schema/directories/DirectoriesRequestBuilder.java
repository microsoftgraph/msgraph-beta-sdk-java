package com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.directories;

import com.microsoft.graph.beta.models.DirectoryDefinition;
import com.microsoft.graph.beta.models.DirectoryDefinitionCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.directories.count.CountRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
...
public class DirectoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DirectoryDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories", pathParameters);
