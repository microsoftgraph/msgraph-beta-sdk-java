package com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item;

import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.exceptionoccurrences.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EventItemRequestBuilder} and sets the default values.
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", rawUrl);
    }
    /**
