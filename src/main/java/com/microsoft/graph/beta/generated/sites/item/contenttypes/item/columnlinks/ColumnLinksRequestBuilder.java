package com.microsoft.graph.beta.sites.item.contenttypes.item.columnlinks;
...
import com.microsoft.graph.beta.sites.item.contenttypes.item.columnlinks.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
...
public class ColumnLinksRequestBuilder extends BaseRequestBuilder {
    ...
    public ColumnLinksRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnLinks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ColumnLinksRequestBuilder} and sets the default values.
    ...
    public ColumnLinksRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnLinks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ColumnLink body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnLinks", pathParameters);
