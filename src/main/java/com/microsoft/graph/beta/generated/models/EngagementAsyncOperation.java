...
public class EngagementAsyncOperation extends LongRunningOperation implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("operationType", (n) -> { this.setOperationType(n.getEnumValue(EngagementAsyncOperationOperationType::forValue)); });
     ...
     * @return a EngagementAsyncOperationOperationType
     */
    @jakarta.annotation.Nullable
    public EngagementAsyncOperationOperationType getOperationType() {
     ...
     */
    public void setOperationType(@jakarta.annotation.Nullable final EngagementAsyncOperationOperationType value) {
