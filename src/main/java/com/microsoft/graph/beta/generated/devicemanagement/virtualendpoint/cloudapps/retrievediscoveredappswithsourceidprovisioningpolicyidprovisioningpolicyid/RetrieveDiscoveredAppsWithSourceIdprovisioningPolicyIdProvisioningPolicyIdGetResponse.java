...
public class RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdProvisioningPolicyIdGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * @return a {@link java.util.List<CloudPcDiscoveredApp>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<CloudPcDiscoveredApp> getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<CloudPcDiscoveredApp> value) {
