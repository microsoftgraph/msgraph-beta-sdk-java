...
public class DriveExclusionUnit extends ExclusionUnitBase implements Parsable {
    /**
     * Instantiates a new {@link DriveExclusionUnit} and sets the default values.
     */
    public DriveExclusionUnit() {
        super();
    ...
    public static DriveExclusionUnit createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
