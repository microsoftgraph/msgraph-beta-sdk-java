...
public class MultiTenantApplicationsToProvisionSnapshot implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("requiredResourceAccesses", (n) -> { this.setRequiredResourceAccesses(n.getCollectionOfObjectValues(RequiredResourceAccess::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<RequiredResourceAccess> getRequiredResourceAccesses() {
     ...
     */
    public void setRequiredResourceAccesses(@jakarta.annotation.Nullable final java.util.List<RequiredResourceAccess> value) {
