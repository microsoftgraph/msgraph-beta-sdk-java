package com.microsoft.graph.beta.identity.authenticationeventlisteners.item;

import com.microsoft.graph.beta.models.AuthenticationEventListener;
...
public class AuthenticationEventListenerItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public AuthenticationEventListenerItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/authenticationEventListeners/{authenticationEventListener%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthenticationEventListenerItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public AuthenticationEventListenerItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/authenticationEventListeners/{authenticationEventListener%2Did}", rawUrl);
    }
    /**
     * Delete an authenticationEventListener object. The following derived types are currently supported.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/authenticationeventlistener-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link AuthenticationEventListener}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/authenticationeventlistener-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public AuthenticationEventListener patch(@jakarta.annotation.Nonnull final AuthenticationEventListener body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AuthenticationEventListener patch(@jakarta.annotation.Nonnull final AuthenticationEventListener body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/authenticationEventListeners/{authenticationEventListener%2Did}{?%24expand,%24select}", pathParameters);
