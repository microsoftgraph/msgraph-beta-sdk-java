package com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.registrationswithemail;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventRegistration;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.registrationswithemail.cancel.CancelRequestBuilder;
...
public class RegistrationsWithEmailRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String email) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email='{email}')", pathParameters);
    ...
    public RegistrationsWithEmailRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email='{email}')", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrations(email='{email}'){?%24expand,%24select}", pathParameters);
