...
public class PasswordProfile implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Gets the forceChangePasswordNextSignIn property value. true if the user must change their password on the next sign-in; otherwise false. If not set, default is false.
    ...
    /**
     * Sets the forceChangePasswordNextSignIn property value. true if the user must change their password on the next sign-in; otherwise false. If not set, default is false.
