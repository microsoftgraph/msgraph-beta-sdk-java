package com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item;

import com.microsoft.graph.beta.models.Event;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link EventItemRequestBuilder} and sets the default values.
    ...
    public EventItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24expand,%24select}", rawUrl);
    }
    /**
