package com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OnenoteSection;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
