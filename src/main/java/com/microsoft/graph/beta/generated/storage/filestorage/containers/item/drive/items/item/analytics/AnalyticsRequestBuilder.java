package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.analytics;

import com.microsoft.graph.beta.models.ItemAnalytics;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.analytics.alltime.AllTimeRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.analytics.itemactivitystats.ItemActivityStatsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.analytics.lastsevendays.LastSevenDaysRequestBuilder;
