...
public class TimePeriod implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TimePeriod} and sets the default values.
     */
    public TimePeriod() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static TimePeriod createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
