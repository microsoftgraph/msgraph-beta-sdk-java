...
public class DeviceHealthStatus extends Entity implements Parsable {
     ...
     * @return a {@link DeviceHealthStatusBootTotalDurationInSeconds}
     */
    @jakarta.annotation.Nullable
    public DeviceHealthStatusBootTotalDurationInSeconds getBootTotalDurationInSeconds() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("bootTotalDurationInSeconds", (n) -> { this.setBootTotalDurationInSeconds(n.getObjectValue(DeviceHealthStatusBootTotalDurationInSeconds::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("startupPerformanceScore", (n) -> { this.setStartupPerformanceScore(n.getObjectValue(DeviceHealthStatusStartupPerformanceScore::createFromDiscriminatorValue)); });
     ...
     * @return a {@link DeviceHealthStatusStartupPerformanceScore}
     */
    @jakarta.annotation.Nullable
    public DeviceHealthStatusStartupPerformanceScore getStartupPerformanceScore() {
     ...
     */
    public void setBootTotalDurationInSeconds(@jakarta.annotation.Nullable final DeviceHealthStatusBootTotalDurationInSeconds value) {
     ...
     */
    public void setStartupPerformanceScore(@jakarta.annotation.Nullable final DeviceHealthStatusStartupPerformanceScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class DeviceHealthStatusBootTotalDurationInSeconds implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link DeviceHealthStatusBootTotalDurationInSeconds} and sets the default values.
         */
        public DeviceHealthStatusBootTotalDurationInSeconds() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static DeviceHealthStatusBootTotalDurationInSeconds createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final DeviceHealthStatusBootTotalDurationInSeconds result = new DeviceHealthStatusBootTotalDurationInSeconds();
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class DeviceHealthStatusStartupPerformanceScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link DeviceHealthStatusStartupPerformanceScore} and sets the default values.
         */
        public DeviceHealthStatusStartupPerformanceScore() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static DeviceHealthStatusStartupPerformanceScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final DeviceHealthStatusStartupPerformanceScore result = new DeviceHealthStatusStartupPerformanceScore();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
