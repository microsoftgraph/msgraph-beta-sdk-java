package com.microsoft.graph.beta.domains;

import com.microsoft.graph.beta.domains.count.CountRequestBuilder;
import com.microsoft.graph.beta.domains.item.DomainItemRequestBuilder;
import com.microsoft.graph.beta.models.Domain;
import com.microsoft.graph.beta.models.DomainCollectionResponse;
...
public class DomainsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link DomainsRequestBuilder} and sets the default values.
     ...
     * @return a {@link DomainCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/domain-list?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public DomainCollectionResponse get() {
        return get(null);
    }
    /**
     * Retrieve a list of domain objects.
     ...
     */
    @jakarta.annotation.Nullable
    public DomainCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, DomainCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/domain-post-domains?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public Domain post(@jakarta.annotation.Nonnull final Domain body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Domain post(@jakarta.annotation.Nonnull final Domain body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/domains{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Domain body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/domains", pathParameters);
