package com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.presenters.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventPresenter;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.presenters.item.profilephoto.ProfilePhotoRequestBuilder;
...
public class VirtualEventPresenterItemRequestBuilder extends BaseRequestBuilder {
    ...
    public VirtualEventPresenterItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new VirtualEventPresenterItemRequestBuilder and sets the default values.
    ...
    public VirtualEventPresenterItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
