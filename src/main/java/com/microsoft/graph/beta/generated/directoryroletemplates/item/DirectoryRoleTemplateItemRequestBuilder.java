package com.microsoft.graph.beta.directoryroletemplates.item;

import com.microsoft.graph.beta.directoryroletemplates.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroletemplates.item.restore.RestoreRequestBuilder;
...
public class DirectoryRoleTemplateItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/directoryroletemplate-get?view=graph-rest-beta">Find more info here</a>
     */
