package com.microsoft.graph.beta.rolemanagement.cloudpc.roleassignments.item.directoryscopes;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.rolemanagement.cloudpc.roleassignments.item.directoryscopes.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.cloudpc.roleassignments.item.directoryscopes.item.DirectoryObjectItemRequestBuilder;
...
public class DirectoryScopesRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryScopesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/directoryScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryScopesRequestBuilder and sets the default values.
    ...
    public DirectoryScopesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/directoryScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
