package com.microsoft.graph.beta.users.item.outlook.taskfolders;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OutlookTaskFolder;
import com.microsoft.graph.beta.models.OutlookTaskFolderCollectionResponse;
import com.microsoft.graph.beta.users.item.outlook.taskfolders.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.taskfolders.item.OutlookTaskFolderItemRequestBuilder;
...
public class TaskFoldersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link TaskFoldersRequestBuilder} and sets the default values.
    ...
    public TaskFoldersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TaskFoldersRequestBuilder} and sets the default values.
    ...
    public TaskFoldersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get all the Outlook task folders in the user's mailbox.
     * @return a {@link OutlookTaskFolderCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final OutlookTaskFolder body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/outlook/taskFolders", pathParameters);
