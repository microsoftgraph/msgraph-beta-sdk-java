package com.microsoft.graph.beta.external.connections.item.groups.item.members;

import com.microsoft.graph.beta.external.connections.item.groups.item.members.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.groups.item.members.item.IdentityItemRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/externalconnectors-externalgroup-post-members?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
