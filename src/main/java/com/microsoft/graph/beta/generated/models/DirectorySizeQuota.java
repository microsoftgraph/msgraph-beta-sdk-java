...
public class DirectorySizeQuota implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DirectorySizeQuota} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static DirectorySizeQuota createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("used", (n) -> { this.setUsed(n.getIntegerValue()); });
     ...
     */
    public void setUsed(@jakarta.annotation.Nullable final Integer value) {
