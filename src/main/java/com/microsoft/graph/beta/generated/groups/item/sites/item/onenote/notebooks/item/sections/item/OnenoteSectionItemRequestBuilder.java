package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item;

import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
