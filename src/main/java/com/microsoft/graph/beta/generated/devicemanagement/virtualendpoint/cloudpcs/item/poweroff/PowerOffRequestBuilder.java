package com.microsoft.graph.beta.devicemanagement.virtualendpoint.cloudpcs.item.poweroff;
...
public class PowerOffRequestBuilder extends BaseRequestBuilder {
    ...
    public PowerOffRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/powerOff", pathParameters);
    }
    /**
     * Instantiates a new PowerOffRequestBuilder and sets the default values.
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a PowerOffRequestBuilder
     */
    @jakarta.annotation.Nonnull
