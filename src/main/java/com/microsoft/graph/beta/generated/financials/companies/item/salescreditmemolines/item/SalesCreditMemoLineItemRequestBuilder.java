package com.microsoft.graph.beta.financials.companies.item.salescreditmemolines.item;

import com.microsoft.graph.beta.financials.companies.item.salescreditmemolines.item.account.AccountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salescreditmemolines.item.item.ItemRequestBuilder;
...
public class SalesCreditMemoLineItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SalesCreditMemoLineItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SalesCreditMemoLineItemRequestBuilder} and sets the default values.
    ...
    public SalesCreditMemoLineItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SalesCreditMemoLine body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}", pathParameters);
