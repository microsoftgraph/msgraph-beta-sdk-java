package com.microsoft.graph.beta.print.printershares.item.jobs.item.documents.item.createuploadsession;

import com.microsoft.graph.beta.models.PrintDocumentUploadProperties;
...
public class CreateUploadSessionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a {@link PrintDocumentUploadProperties}
     */
