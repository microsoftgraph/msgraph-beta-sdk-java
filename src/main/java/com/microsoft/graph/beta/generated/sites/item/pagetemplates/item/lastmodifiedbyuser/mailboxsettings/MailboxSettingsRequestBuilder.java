package com.microsoft.graph.beta.sites.item.pagetemplates.item.lastmodifiedbyuser.mailboxsettings;
...
public class MailboxSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/lastModifiedByUser/mailboxSettings{?%24expand,%24select}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final MailboxSettings body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/lastModifiedByUser/mailboxSettings", pathParameters);
