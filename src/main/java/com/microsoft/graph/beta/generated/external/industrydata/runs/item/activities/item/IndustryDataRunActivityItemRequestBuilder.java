package com.microsoft.graph.beta.external.industrydata.runs.item.activities.item;

import com.microsoft.graph.beta.external.industrydata.runs.item.activities.item.activity.ActivityRequestBuilder;
...
public class IndustryDataRunActivityItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link IndustryDataRunActivityItemRequestBuilder} and sets the default values.
    ...
    public IndustryDataRunActivityItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link IndustryDataRunActivityItemRequestBuilder} and sets the default values.
    ...
    public IndustryDataRunActivityItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * The set of activities performed during the run.
     * @return a {@link IndustryDataRunActivity}
    ...
    public IndustryDataRunActivity get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, IndustryDataRunActivity::createFromDiscriminatorValue);
    }
    /**
     * The set of activities performed during the run.
