package com.microsoft.graph.beta.directory.recommendations.item.postpone;
...
public class PostponeRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link PostponeRequestBuilder} and sets the default values.
    ...
    public PostponeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/postpone", pathParameters);
    }
    /**
     * Instantiates a new {@link PostponeRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/recommendation-postpone?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public Recommendation post(@jakarta.annotation.Nonnull final PostponePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Recommendation post(@jakarta.annotation.Nonnull final PostponePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
