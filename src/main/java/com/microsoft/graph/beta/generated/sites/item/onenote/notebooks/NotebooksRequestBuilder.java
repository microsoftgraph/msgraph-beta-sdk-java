package com.microsoft.graph.beta.sites.item.onenote.notebooks;
...
import com.microsoft.graph.beta.sites.item.onenote.notebooks.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.getnotebookfromweburl.GetNotebookFromWebUrlRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.getrecentnotebookswithincludepersonalnotebooks.GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.NotebookItemRequestBuilder;
