package com.microsoft.graph.beta.groups.item.sites.item.lists.item.columns.item;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.columns.item.sourcecolumn.SourceColumnRequestBuilder;
