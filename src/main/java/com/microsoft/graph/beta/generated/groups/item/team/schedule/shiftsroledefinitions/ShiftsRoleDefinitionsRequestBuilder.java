package com.microsoft.graph.beta.groups.item.team.schedule.shiftsroledefinitions;

import com.microsoft.graph.beta.groups.item.team.schedule.shiftsroledefinitions.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.shiftsroledefinitions.item.ShiftsRoleDefinitionItemRequestBuilder;
...
public class ShiftsRoleDefinitionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ShiftsRoleDefinitionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/shiftsRoleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ShiftsRoleDefinitionsRequestBuilder} and sets the default values.
    ...
    public ShiftsRoleDefinitionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/shiftsRoleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ShiftsRoleDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/groups/{group%2Did}/team/schedule/shiftsRoleDefinitions", pathParameters);
