...
public class DeviceManagementConstraint implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DeviceManagementConstraint} and sets the default values.
     */
     ...
     * @return a {@link DeviceManagementConstraint}
     */
    @jakarta.annotation.Nonnull
    public static DeviceManagementConstraint createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
