package com.microsoft.graph.beta.devicemanagement.rolescopetags.item;

import com.microsoft.graph.beta.devicemanagement.rolescopetags.item.assign.AssignRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.rolescopetags.item.assignments.AssignmentsRequestBuilder;
...
public class RoleScopeTagItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleScopeTagItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleScopeTagItemRequestBuilder} and sets the default values.
    ...
    public RoleScopeTagItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public RoleScopeTag patch(@jakarta.annotation.Nonnull final RoleScopeTag body) {
     ...
     */
    @jakarta.annotation.Nullable
    public RoleScopeTag patch(@jakarta.annotation.Nonnull final RoleScopeTag body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final RoleScopeTag body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final RoleScopeTag body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}", pathParameters);
