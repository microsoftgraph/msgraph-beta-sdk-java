package com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsapphealthoverview;

import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsapphealthoverview.metricvalues.MetricValuesRequestBuilder;
...
public class UserExperienceAnalyticsAppHealthOverviewRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserExperienceAnalyticsAppHealthOverviewRequestBuilder} and sets the default values.
    ...
    public UserExperienceAnalyticsAppHealthOverviewRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserExperienceAnalyticsAppHealthOverviewRequestBuilder} and sets the default values.
    ...
    public UserExperienceAnalyticsAppHealthOverviewRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final UserExperienceAnalyticsCategory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview", pathParameters);
