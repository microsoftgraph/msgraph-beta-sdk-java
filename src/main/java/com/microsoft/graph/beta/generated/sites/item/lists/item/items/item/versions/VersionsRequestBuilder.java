package com.microsoft.graph.beta.sites.item.lists.item.items.item.versions;
...
import com.microsoft.graph.beta.sites.item.lists.item.items.item.versions.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.versions.item.ListItemVersionItemRequestBuilder;
