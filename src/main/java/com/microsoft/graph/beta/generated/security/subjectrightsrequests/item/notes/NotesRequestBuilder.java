package com.microsoft.graph.beta.security.subjectrightsrequests.item.notes;

import com.microsoft.graph.beta.models.AuthoredNote;
import com.microsoft.graph.beta.models.AuthoredNoteCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.notes.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.notes.item.AuthoredNoteItemRequestBuilder;
...
public class NotesRequestBuilder extends BaseRequestBuilder {
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link NotesRequestBuilder} and sets the default values.
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AuthoredNote body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes", pathParameters);
