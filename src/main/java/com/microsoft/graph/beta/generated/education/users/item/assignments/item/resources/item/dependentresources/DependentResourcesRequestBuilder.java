package com.microsoft.graph.beta.education.users.item.assignments.item.resources.item.dependentresources;

import com.microsoft.graph.beta.education.users.item.assignments.item.resources.item.dependentresources.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.resources.item.dependentresources.item.EducationAssignmentResourceItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationAssignmentResource;
import com.microsoft.graph.beta.models.EducationAssignmentResourceCollectionResponse;
...
public class DependentResourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DependentResourcesRequestBuilder} and sets the default values.
    ...
    public DependentResourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationAssignmentResource body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources", pathParameters);
