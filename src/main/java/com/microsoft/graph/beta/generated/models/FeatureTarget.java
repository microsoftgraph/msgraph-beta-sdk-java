...
public class FeatureTarget implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link FeatureTarget} and sets the default values.
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("targetType", (n) -> { this.setTargetType(n.getEnumValue(FeatureTargetType::forValue)); });
