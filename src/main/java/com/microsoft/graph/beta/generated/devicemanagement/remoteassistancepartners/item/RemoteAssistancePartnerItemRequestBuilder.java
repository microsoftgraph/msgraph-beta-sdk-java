package com.microsoft.graph.beta.devicemanagement.remoteassistancepartners.item;

import com.microsoft.graph.beta.devicemanagement.remoteassistancepartners.item.beginonboarding.BeginOnboardingRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.remoteassistancepartners.item.disconnect.DisconnectRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RemoteAssistancePartner;
...
public class RemoteAssistancePartnerItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link RemoteAssistancePartnerItemRequestBuilder} and sets the default values.
    ...
    public RemoteAssistancePartnerItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RemoteAssistancePartnerItemRequestBuilder} and sets the default values.
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final RemoteAssistancePartner body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link RemoteAssistancePartnerItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public RemoteAssistancePartnerItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
