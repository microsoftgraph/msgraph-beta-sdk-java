package com.microsoft.graph.beta.identitygovernance.catalogswithuniquename;
...
public class CatalogsWithUniqueNameRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link CatalogsWithUniqueNameRequestBuilder} and sets the default values.
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public CatalogsWithUniqueNameRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new CatalogsWithUniqueNameRequestBuilder(rawUrl, requestAdapter);
    }
    /**
