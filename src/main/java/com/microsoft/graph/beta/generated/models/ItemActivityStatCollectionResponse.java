...
public class ItemActivityStatCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link ItemActivityStatCollectionResponse} and sets the default values.
     */
    public ItemActivityStatCollectionResponse() {
        super();
    }
    /**
    ...
    public static ItemActivityStatCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
