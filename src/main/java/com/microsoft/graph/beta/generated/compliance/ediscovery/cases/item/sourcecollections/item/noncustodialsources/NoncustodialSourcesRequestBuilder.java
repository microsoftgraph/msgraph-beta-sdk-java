...
public class NoncustodialSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link NoncustodialSourcesRequestBuilder} and sets the default values.
    ...
    public NoncustodialSourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/noncustodialSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link NoncustodialSourcesRequestBuilder} and sets the default values.
