...
public class UserRegistrationActivitySummary extends Entity implements Parsable {
    /**
     * Instantiates a new {@link UserRegistrationActivitySummary} and sets the default values.
     */
    public UserRegistrationActivitySummary() {
        super();
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link UserRegistrationActivitySummary}
     */
    @jakarta.annotation.Nonnull
    public static UserRegistrationActivitySummary createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
