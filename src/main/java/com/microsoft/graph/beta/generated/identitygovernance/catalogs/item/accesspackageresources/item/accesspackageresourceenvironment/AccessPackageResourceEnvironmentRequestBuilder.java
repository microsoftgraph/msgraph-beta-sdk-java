package com.microsoft.graph.beta.identitygovernance.catalogs.item.accesspackageresources.item.accesspackageresourceenvironment;
...
public class AccessPackageResourceEnvironmentRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessPackageResourceEnvironmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceEnvironment{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessPackageResourceEnvironmentRequestBuilder} and sets the default values.
    ...
    public AccessPackageResourceEnvironmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceEnvironment{?%24expand,%24select}", rawUrl);
    }
    /**
