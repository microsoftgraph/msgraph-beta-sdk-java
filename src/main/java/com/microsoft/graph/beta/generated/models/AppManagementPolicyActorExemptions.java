...
public class AppManagementPolicyActorExemptions implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AppManagementPolicyActorExemptions} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AppManagementPolicyActorExemptions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<CustomSecurityAttributeExemption> getCustomSecurityAttributes() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customSecurityAttributes", (n) -> { this.setCustomSecurityAttributes(n.getCollectionOfObjectValues(CustomSecurityAttributeExemption::createFromDiscriminatorValue)); });
