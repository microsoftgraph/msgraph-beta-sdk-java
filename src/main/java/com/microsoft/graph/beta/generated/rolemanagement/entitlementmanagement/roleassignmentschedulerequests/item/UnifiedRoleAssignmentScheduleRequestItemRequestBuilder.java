package com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnifiedRoleAssignmentScheduleRequest;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.activatedusing.ActivatedUsingRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.roledefinition.RoleDefinitionRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.entitlementmanagement.roleassignmentschedulerequests.item.targetschedule.TargetScheduleRequestBuilder;
