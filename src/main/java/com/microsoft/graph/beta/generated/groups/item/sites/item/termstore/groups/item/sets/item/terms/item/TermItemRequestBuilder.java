package com.microsoft.graph.beta.groups.item.sites.item.termstore.groups.item.sets.item.terms.item;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.groups.item.sets.item.terms.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.groups.item.sets.item.terms.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.groups.item.sets.item.terms.item.set.SetRequestBuilder;
