package com.microsoft.graph.beta.print.printershares.item.allowedgroups;

import com.microsoft.graph.beta.models.GroupCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.print.printershares.item.allowedgroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.print.printershares.item.allowedgroups.item.GroupItemRequestBuilder;
import com.microsoft.graph.beta.print.printershares.item.allowedgroups.ref.RefRequestBuilder;
...
public class AllowedGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.print.printerShares.item.allowedGroups.item collection
    ...
    public AllowedGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new AllowedGroupsRequestBuilder and sets the default values.
