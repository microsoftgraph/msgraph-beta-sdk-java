package com.microsoft.graph.beta.external.connections.item.items.item.activities;

import com.microsoft.graph.beta.external.connections.item.items.item.activities.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.connections.item.items.item.activities.item.ExternalActivityItemRequestBuilder;
