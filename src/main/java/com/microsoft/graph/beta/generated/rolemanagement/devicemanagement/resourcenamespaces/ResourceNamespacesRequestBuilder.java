package com.microsoft.graph.beta.rolemanagement.devicemanagement.resourcenamespaces;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnifiedRbacResourceNamespace;
import com.microsoft.graph.beta.models.UnifiedRbacResourceNamespaceCollectionResponse;
import com.microsoft.graph.beta.rolemanagement.devicemanagement.resourcenamespaces.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.devicemanagement.resourcenamespaces.item.UnifiedRbacResourceNamespaceItemRequestBuilder;
...
public class ResourceNamespacesRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourceNamespacesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResourceNamespacesRequestBuilder} and sets the default values.
    ...
    public ResourceNamespacesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UnifiedRbacResourceNamespace body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces", pathParameters);
