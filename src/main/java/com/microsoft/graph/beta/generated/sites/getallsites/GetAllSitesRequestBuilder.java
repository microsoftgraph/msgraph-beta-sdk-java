package com.microsoft.graph.beta.sites.getallsites;
...
public class GetAllSitesRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetAllSitesRequestBuilder} and sets the default values.
    ...
    public GetAllSitesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/getAllSites(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllSitesRequestBuilder} and sets the default values.
    ...
    public GetAllSitesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/getAllSites(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @return a {@link GetAllSitesGetResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/site-getallsites?view=graph-rest-beta">Find more info here</a>
     */
