...
public class CopilotConversationMessage extends Entity implements Parsable {
    /**
     * Instantiates a new {@link CopilotConversationMessage} and sets the default values.
     */
    public CopilotConversationMessage() {
        super();
    }
    /**
    ...
    public static CopilotConversationMessage createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
