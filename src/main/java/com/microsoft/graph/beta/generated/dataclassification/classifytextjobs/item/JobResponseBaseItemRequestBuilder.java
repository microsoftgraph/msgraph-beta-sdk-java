package com.microsoft.graph.beta.dataclassification.classifytextjobs.item;
...
public class JobResponseBaseItemRequestBuilder extends BaseRequestBuilder {
    ...
    public JobResponseBaseItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/classifyTextJobs/{jobResponseBase%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link JobResponseBaseItemRequestBuilder} and sets the default values.
    ...
    public JobResponseBaseItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/classifyTextJobs/{jobResponseBase%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/dataClassification/classifyTextJobs/{jobResponseBase%2Did}{?%24expand,%24select}", pathParameters);
