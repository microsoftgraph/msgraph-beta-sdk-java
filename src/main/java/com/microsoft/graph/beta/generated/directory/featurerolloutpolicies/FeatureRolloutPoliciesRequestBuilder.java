package com.microsoft.graph.beta.directory.featurerolloutpolicies;

import com.microsoft.graph.beta.directory.featurerolloutpolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.featurerolloutpolicies.item.FeatureRolloutPolicyItemRequestBuilder;
...
public class FeatureRolloutPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public FeatureRolloutPoliciesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/featureRolloutPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link FeatureRolloutPoliciesRequestBuilder} and sets the default values.
    ...
    public FeatureRolloutPoliciesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/featureRolloutPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final FeatureRolloutPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directory/featureRolloutPolicies", pathParameters);
