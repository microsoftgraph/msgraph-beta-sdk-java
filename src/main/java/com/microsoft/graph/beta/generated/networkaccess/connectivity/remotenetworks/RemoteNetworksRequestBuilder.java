...
public class RemoteNetworksRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a RemoteNetworkItemRequestBuilder
     */
    @jakarta.annotation.Nonnull
    ...
    public RemoteNetworksRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RemoteNetworksRequestBuilder and sets the default values.
    ...
    public RemoteNetworksRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get remoteNetworks from networkAccess
     * @return a RemoteNetworkCollectionResponse
     */
