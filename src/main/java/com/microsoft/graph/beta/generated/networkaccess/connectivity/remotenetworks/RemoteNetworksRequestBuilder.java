package com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks;

import com.microsoft.graph.beta.models.networkaccess.RemoteNetwork;
import com.microsoft.graph.beta.models.networkaccess.RemoteNetworkCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.count.CountRequestBuilder;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.RemoteNetworkItemRequestBuilder;
...
public class RemoteNetworksRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link RemoteNetworkItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public RemoteNetworkItemRequestBuilder byRemoteNetworkId(@jakarta.annotation.Nonnull final String remoteNetworkId) {
        Objects.requireNonNull(remoteNetworkId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("remoteNetwork%2Did", remoteNetworkId);
    ...
    public RemoteNetworkCollectionResponse get() {
        return get(null);
    }
    /**
     * The locations, such as branches, that are connected to Global Secure Access services through an IPsec tunnel.
     ...
     */
    @jakarta.annotation.Nullable
    public RemoteNetworkCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/networkaccess-connectivity-post-remotenetworks?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/connectivity/remoteNetworks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RemoteNetwork body) {
