...
public class ExternalItemContent implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ExternalItemContent} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ExternalItemContent createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link ExternalItemContentType}
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ExternalItemContentType value) {
