package com.microsoft.graph.beta.planner.tasks.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerTask;
import com.microsoft.graph.beta.planner.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.item.details.DetailsRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.item.messages.MessagesRequestBuilder;
import com.microsoft.graph.beta.planner.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
...
public class PlannerTaskItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PlannerTaskItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/tasks/{plannerTask%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PlannerTaskItemRequestBuilder} and sets the default values.
    ...
    public PlannerTaskItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/tasks/{plannerTask%2Did}", rawUrl);
    }
    /**
     * Delete a plannerTask object.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannertask-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannertask-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link PlannerTask}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannertask-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/planner/tasks/{plannerTask%2Did}{?%24expand,%24select}", pathParameters);
