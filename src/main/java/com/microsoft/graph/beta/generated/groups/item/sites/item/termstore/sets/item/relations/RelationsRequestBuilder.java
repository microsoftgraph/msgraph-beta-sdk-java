package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.relations;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.relations.item.RelationItemRequestBuilder;
