package com.microsoft.graph.beta.devicemanagement.configurationpolicies.item.reorder;
...
public class ReorderRequestBuilder extends BaseRequestBuilder {
    ...
    public ReorderRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/reorder", pathParameters);
    }
    /**
     * Instantiates a new ReorderRequestBuilder and sets the default values.
    ...
    public ReorderRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/reorder", rawUrl);
    }
    /**
