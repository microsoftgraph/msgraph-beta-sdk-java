package com.microsoft.graph.beta.devicemanagement.reports.getuserinstallstatusreport;
...
public class GetUserInstallStatusReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetUserInstallStatusReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetUserInstallStatusReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetUserInstallStatusReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
