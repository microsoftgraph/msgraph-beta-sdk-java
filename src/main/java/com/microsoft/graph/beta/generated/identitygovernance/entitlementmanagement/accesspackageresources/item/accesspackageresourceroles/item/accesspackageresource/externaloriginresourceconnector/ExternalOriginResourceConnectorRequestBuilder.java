package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackageresources.item.accesspackageresourceroles.item.accesspackageresource.externaloriginresourceconnector;
...
public class ExternalOriginResourceConnectorRequestBuilder extends BaseRequestBuilder {
    ...
    public ExternalOriginResourceConnectorRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceRoles/{accessPackageResourceRole%2Did}/accessPackageResource/externalOriginResourceConnector{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExternalOriginResourceConnectorRequestBuilder} and sets the default values.
    ...
    public ExternalOriginResourceConnectorRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceRoles/{accessPackageResourceRole%2Did}/accessPackageResource/externalOriginResourceConnector{?%24expand,%24select}", rawUrl);
    }
    /**
