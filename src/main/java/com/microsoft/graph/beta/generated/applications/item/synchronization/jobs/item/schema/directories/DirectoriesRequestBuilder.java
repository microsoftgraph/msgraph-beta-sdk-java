package com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.directories;

import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.directories.count.CountRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
...
public class DirectoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoriesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DirectoriesRequestBuilder and sets the default values.
    ...
    public DirectoriesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
