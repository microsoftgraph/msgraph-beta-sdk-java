package com.microsoft.graph.beta.education.classes.item.assignments.item.categories;

import com.microsoft.graph.beta.education.classes.item.assignments.item.categories.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignments.item.categories.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignments.item.categories.item.EducationCategoryItemRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignments.item.categories.ref.RefRequestBuilder;
import com.microsoft.graph.beta.models.EducationCategory;
import com.microsoft.graph.beta.models.EducationCategoryCollectionResponse;
...
public class CategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.education.classes.item.assignments.item.categories.item collection
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationassignment-list-categories?view=graph-rest-beta">Find more info here</a>
     */
