package com.microsoft.graph.beta.networkaccess.settings.customblockpage;

import com.microsoft.graph.beta.models.networkaccess.CustomBlockPage;
...
public class CustomBlockPageRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CustomBlockPage body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CustomBlockPage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public CustomBlockPageRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new CustomBlockPageRequestBuilder(rawUrl, requestAdapter);
    }
    /**
