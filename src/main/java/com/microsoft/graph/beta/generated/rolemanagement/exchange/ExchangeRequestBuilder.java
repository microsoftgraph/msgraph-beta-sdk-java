package com.microsoft.graph.beta.rolemanagement.exchange;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnifiedRbacApplication;
import com.microsoft.graph.beta.rolemanagement.exchange.customappscopes.CustomAppScopesRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.exchange.resourcenamespaces.ResourceNamespacesRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.exchange.roleassignments.RoleAssignmentsRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.exchange.roledefinitions.RoleDefinitionsRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.exchange.transitiveroleassignments.TransitiveRoleAssignmentsRequestBuilder;
...
public class ExchangeRequestBuilder extends BaseRequestBuilder {
    ...
    public ExchangeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange", pathParameters);
    }
    /**
     * Instantiates a new {@link ExchangeRequestBuilder} and sets the default values.
    ...
    public ExchangeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/roleManagement/exchange{?%24expand,%24select}", pathParameters);
