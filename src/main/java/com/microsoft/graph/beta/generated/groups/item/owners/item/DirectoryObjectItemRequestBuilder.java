package com.microsoft.graph.beta.groups.item.owners.item;

import com.microsoft.graph.beta.groups.item.owners.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.ref.RefRequestBuilder;
