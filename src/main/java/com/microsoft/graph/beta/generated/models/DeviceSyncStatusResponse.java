...
public class DeviceSyncStatusResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeviceSyncStatusResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static DeviceSyncStatusResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link java.util.List<SyncComponent>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<SyncComponent> getComponents() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("components", (n) -> { this.setComponents(n.getCollectionOfObjectValues(SyncComponent::createFromDiscriminatorValue)); });
     ...
     */
    public void setComponents(@jakarta.annotation.Nullable final java.util.List<SyncComponent> value) {
