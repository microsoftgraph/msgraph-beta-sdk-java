package com.microsoft.graph.beta.places.graphroomlist;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RoomListCollectionResponse;
import com.microsoft.graph.beta.places.graphroomlist.count.CountRequestBuilder;
...
public class GraphRoomListRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphRoomListRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/graph.roomList{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphRoomListRequestBuilder} and sets the default values.
    ...
    public GraphRoomListRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/graph.roomList{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/place-get?view=graph-rest-beta">Find more info here</a>
     */
