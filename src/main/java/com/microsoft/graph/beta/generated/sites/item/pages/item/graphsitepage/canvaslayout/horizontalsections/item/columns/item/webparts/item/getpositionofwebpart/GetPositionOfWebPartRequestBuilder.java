package com.microsoft.graph.beta.sites.item.pages.item.graphsitepage.canvaslayout.horizontalsections.item.columns.item.webparts.item.getpositionofwebpart;
