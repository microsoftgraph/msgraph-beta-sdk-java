package com.microsoft.graph.beta.education.classes.item.modules;

import com.microsoft.graph.beta.education.classes.item.modules.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.item.EducationModuleItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationModule;
import com.microsoft.graph.beta.models.EducationModuleCollectionResponse;
...
public class ModulesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ModulesRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-list-modules?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public EducationModuleCollectionResponse get() {
        return get(null);
    }
    /**
     * Retrieve a list of module objects. Only teachers, students, and applications with application permissions can perform this operation. A teacher or an application with application permissions can see all module objects for the class. Students can only see published modules.
     ...
     */
    @jakarta.annotation.Nullable
    public EducationModuleCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-post-module?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public EducationModule post(@jakarta.annotation.Nonnull final EducationModule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public EducationModule post(@jakarta.annotation.Nonnull final EducationModule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/classes/{educationClass%2Did}/modules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationModule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/classes/{educationClass%2Did}/modules", pathParameters);
