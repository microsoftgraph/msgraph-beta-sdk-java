...
public class MacOSFirewallApplication implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MacOSFirewallApplication} and sets the default values.
     */
     ...
     * @return a {@link MacOSFirewallApplication}
     */
    @jakarta.annotation.Nonnull
    public static MacOSFirewallApplication createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Boolean getAllowsIncomingConnections() {
        return this.backingStore.get("allowsIncomingConnections");
    }
    /**
     ...
     */
    public void setAllowsIncomingConnections(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("allowsIncomingConnections", value);
    }
    /**
