package com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.joinedusers;
...
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.joinedusers.add.AddRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.joinedusers.count.CountRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.joinedusers.item.ConversationMemberItemRequestBuilder;
import com.microsoft.graph.beta.teamwork.deletedteams.item.channels.item.joinedusers.remove.RemoveRequestBuilder;
...
public class JoinedUsersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/joinedUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConversationMember body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/joinedUsers", pathParameters);
