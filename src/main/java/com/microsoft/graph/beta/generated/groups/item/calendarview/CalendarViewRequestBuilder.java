package com.microsoft.graph.beta.groups.item.calendarview;

import com.microsoft.graph.beta.groups.item.calendarview.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendarview.item.EventItemRequestBuilder;
...
public class CalendarViewRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-calendarview?view=graph-rest-beta">Find more info here</a>
     */
