package com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item;

import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.assign.AssignRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.devicestatuses.DeviceStatusesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.devicestatussummary.DeviceStatusSummaryRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.userstatuses.UserStatusesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileappconfigurations.item.userstatussummary.UserStatusSummaryRequestBuilder;
...
public class ManagedDeviceMobileAppConfigurationItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link UserStatusSummaryRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ManagedDeviceMobileAppConfigurationItemRequestBuilder} and sets the default values.
    ...
    public ManagedDeviceMobileAppConfigurationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ManagedDeviceMobileAppConfigurationItemRequestBuilder} and sets the default values.
    ...
    public ManagedDeviceMobileAppConfigurationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}{?%24expand,%24select}", pathParameters);
