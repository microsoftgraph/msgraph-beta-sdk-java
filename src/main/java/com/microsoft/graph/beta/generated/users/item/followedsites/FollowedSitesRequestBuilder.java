package com.microsoft.graph.beta.users.item.followedsites;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SiteCollectionResponse;
import com.microsoft.graph.beta.users.item.followedsites.add.AddRequestBuilder;
import com.microsoft.graph.beta.users.item.followedsites.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.followedsites.item.SiteItemRequestBuilder;
import com.microsoft.graph.beta.users.item.followedsites.remove.RemoveRequestBuilder;
...
public class FollowedSitesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link FollowedSitesRequestBuilder} and sets the default values.
    ...
    public FollowedSitesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/followedSites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link FollowedSitesRequestBuilder} and sets the default values.
