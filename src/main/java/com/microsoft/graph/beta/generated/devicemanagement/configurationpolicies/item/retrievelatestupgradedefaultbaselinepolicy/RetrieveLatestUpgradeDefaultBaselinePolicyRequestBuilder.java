package com.microsoft.graph.beta.devicemanagement.configurationpolicies.item.retrievelatestupgradedefaultbaselinepolicy;
...
public class RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder} and sets the default values.
    ...
    public RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/retrieveLatestUpgradeDefaultBaselinePolicy()", pathParameters);
    }
    /**
     * Instantiates a new {@link RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder} and sets the default values.
    ...
    public RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/retrieveLatestUpgradeDefaultBaselinePolicy()", rawUrl);
    }
    /**
