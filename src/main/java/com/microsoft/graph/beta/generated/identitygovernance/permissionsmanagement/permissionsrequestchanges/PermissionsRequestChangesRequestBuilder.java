package com.microsoft.graph.beta.identitygovernance.permissionsmanagement.permissionsrequestchanges;

import com.microsoft.graph.beta.identitygovernance.permissionsmanagement.permissionsrequestchanges.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.permissionsmanagement.permissionsrequestchanges.item.PermissionsRequestChangeItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PermissionsRequestChange;
import com.microsoft.graph.beta.models.PermissionsRequestChangeCollectionResponse;
...
public class PermissionsRequestChangesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PermissionsRequestChangesRequestBuilder} and sets the default values.
    ...
    public PermissionsRequestChangesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionsRequestChangesRequestBuilder} and sets the default values.
    ...
    public PermissionsRequestChangesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * List the permissionsRequestChange objects and their properties.
     * @return a {@link PermissionsRequestChangeCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/permissionsmanagement-list-permissionsrequestchanges?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public PermissionsRequestChangeCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, PermissionsRequestChangeCollectionResponse::createFromDiscriminatorValue);
    }
    /**
    ...
    public PermissionsRequestChange post(@jakarta.annotation.Nonnull final PermissionsRequestChange body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, PermissionsRequestChange::createFromDiscriminatorValue);
    }
    /**
     * List the permissionsRequestChange objects and their properties.
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PermissionsRequestChange body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges", pathParameters);
