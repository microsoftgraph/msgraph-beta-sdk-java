package com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item;

import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.conversation.ConversationRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.reactions.ReactionsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replies.RepliesRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetingconversations.item.messages.item.replyto.ReplyToRequestBuilder;
...
public class EngagementConversationMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EngagementConversationMessageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EngagementConversationMessageItemRequestBuilder} and sets the default values.
    ...
    public EngagementConversationMessageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}{?%24expand,%24select}", pathParameters);
