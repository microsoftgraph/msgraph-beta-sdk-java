package com.microsoft.graph.beta.groups.item.team.owners;

import com.microsoft.graph.beta.groups.item.team.owners.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.owners.item.UserItemRequestBuilder;
...
public class OwnersRequestBuilder extends BaseRequestBuilder {
    ...
    public OwnersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OwnersRequestBuilder} and sets the default values.
