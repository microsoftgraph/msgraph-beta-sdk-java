package com.microsoft.graph.beta.drives.item.items.item.workbook.comments.item.replies.item.task.changes;

import com.microsoft.graph.beta.drives.item.items.item.workbook.comments.item.replies.item.task.changes.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.comments.item.replies.item.task.changes.item.WorkbookDocumentTaskChangeItemRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.comments.item.replies.item.task.changes.itematwithindex.ItemAtWithIndexRequestBuilder;
...
public class ChangesRequestBuilder extends BaseRequestBuilder {
    ...
    public ChangesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/changes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChangesRequestBuilder} and sets the default values.
    ...
    public ChangesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/changes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WorkbookDocumentTaskChange body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/changes", pathParameters);
