...
public class PhotoUpdateSettings extends Entity implements Parsable {
    /**
     * Instantiates a new {@link PhotoUpdateSettings} and sets the default values.
     */
    ...
    public static PhotoUpdateSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
