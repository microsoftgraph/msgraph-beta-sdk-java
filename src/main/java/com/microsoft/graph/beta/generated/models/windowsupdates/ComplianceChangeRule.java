...
public class ComplianceChangeRule implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static ComplianceChangeRule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        final ParseNode mappingValueNode = parseNode.getChildNode("@odata.type");
        if (mappingValueNode != null) {
            final String mappingValue = mappingValueNode.getStringValue();
            switch (mappingValue) {
                case "#microsoft.graph.windowsUpdates.contentApprovalRule": return new ContentApprovalRule();
            }
        }
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastEvaluatedDateTime", (n) -> { this.setLastEvaluatedDateTime(n.getOffsetDateTimeValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public OffsetDateTime getLastEvaluatedDateTime() {
        return this.backingStore.get("lastEvaluatedDateTime");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeOffsetDateTimeValue("lastEvaluatedDateTime", this.getLastEvaluatedDateTime());
     ...
     */
    public void setLastEvaluatedDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("lastEvaluatedDateTime", value);
    }
    /**
