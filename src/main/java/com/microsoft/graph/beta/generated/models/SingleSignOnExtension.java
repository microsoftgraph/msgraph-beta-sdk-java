...
public class SingleSignOnExtension implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link SingleSignOnExtension} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static SingleSignOnExtension createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
