package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackageswithuniquename.getapplicablepolicyrequirements;
...
public class GetApplicablePolicyRequirementsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetApplicablePolicyRequirementsRequestBuilder} and sets the default values.
    ...
    public GetApplicablePolicyRequirementsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/getApplicablePolicyRequirements", pathParameters);
    }
    /**
     * Instantiates a new {@link GetApplicablePolicyRequirementsRequestBuilder} and sets the default values.
    ...
    public GetApplicablePolicyRequirementsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/getApplicablePolicyRequirements", rawUrl);
    }
    /**
