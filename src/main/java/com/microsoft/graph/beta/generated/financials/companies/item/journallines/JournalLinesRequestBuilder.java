package com.microsoft.graph.beta.financials.companies.item.journallines;

import com.microsoft.graph.beta.financials.companies.item.journallines.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.journallines.item.JournalLineItemRequestBuilder;
...
public class JournalLinesRequestBuilder extends BaseRequestBuilder {
    ...
    public JournalLinesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journalLines{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new JournalLinesRequestBuilder and sets the default values.
    ...
    public JournalLinesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journalLines{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
