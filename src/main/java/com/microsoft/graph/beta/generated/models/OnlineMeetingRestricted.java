...
public class OnlineMeetingRestricted implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Gets the contentSharingDisabled property value. Specifies the reason why shared content from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
    ...
    /**
     * Gets the videoDisabled property value. Specifies the reason why video from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
    ...
    /**
     * Sets the contentSharingDisabled property value. Specifies the reason why shared content from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
    ...
    /**
     * Sets the videoDisabled property value. Specifies the reason why video from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
