package com.microsoft.graph.beta.organization.item.settings;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OrganizationSettings;
import com.microsoft.graph.beta.organization.item.settings.contactinsights.ContactInsightsRequestBuilder;
import com.microsoft.graph.beta.organization.item.settings.iteminsights.ItemInsightsRequestBuilder;
import com.microsoft.graph.beta.organization.item.settings.microsoftapplicationdataaccess.MicrosoftApplicationDataAccessRequestBuilder;
import com.microsoft.graph.beta.organization.item.settings.peopleinsights.PeopleInsightsRequestBuilder;
...
public class SettingsRequestBuilder extends BaseRequestBuilder {
    ...
    public SettingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings", pathParameters);
    }
    /**
     * Instantiates a new {@link SettingsRequestBuilder} and sets the default values.
    ...
    public SettingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/organization/{organization%2Did}/settings{?%24expand,%24select}", pathParameters);
