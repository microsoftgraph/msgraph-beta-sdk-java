package com.microsoft.graph.beta.education.classes.item.assignmentsettings.gradingschemes;

import com.microsoft.graph.beta.education.classes.item.assignmentsettings.gradingschemes.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignmentsettings.gradingschemes.item.EducationGradingSchemeItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationGradingScheme;
import com.microsoft.graph.beta.models.EducationGradingSchemeCollectionResponse;
...
public class GradingSchemesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public GradingSchemesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public EducationGradingSchemeCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/classes/{educationClass%2Did}/assignmentSettings/gradingSchemes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationGradingScheme body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/classes/{educationClass%2Did}/assignmentSettings/gradingSchemes", pathParameters);
