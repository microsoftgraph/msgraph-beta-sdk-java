...
public class StatusBase implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link StatusBase} and sets the default values.
     */
    public StatusBase() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static StatusBase createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
