package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.replace;
...
public class ReplacePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ReplacePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ReplacePostRequestBody}
     */
    @jakarta.annotation.Nonnull
