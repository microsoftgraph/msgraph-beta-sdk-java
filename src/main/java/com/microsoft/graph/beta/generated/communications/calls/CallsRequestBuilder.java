package com.microsoft.graph.beta.communications.calls;

import com.microsoft.graph.beta.communications.calls.count.CountRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.CallItemRequestBuilder;
import com.microsoft.graph.beta.communications.calls.logteleconferencedevicequality.LogTeleconferenceDeviceQualityRequestBuilder;
import com.microsoft.graph.beta.models.Call;
import com.microsoft.graph.beta.models.CallCollectionResponse;
...
public class CallsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link Call}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/application-post-calls?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
