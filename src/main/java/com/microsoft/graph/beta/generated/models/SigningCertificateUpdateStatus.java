...
public class SigningCertificateUpdateStatus implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link SigningCertificateUpdateStatus} and sets the default values.
     */
    ...
    public String getCertificateUpdateResult() {
        return this.backingStore.get("certificateUpdateResult");
    }
    /**
    ...
    public void setCertificateUpdateResult(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("certificateUpdateResult", value);
    }
    /**
