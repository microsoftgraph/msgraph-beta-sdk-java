package com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto;

import com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto.mentions.MentionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.inreplyto.reply.ReplyRequestBuilder;
...
public class InReplyToRequestBuilder extends BaseRequestBuilder {
    ...
    public InReplyToRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo{?%24expand,%24select}", rawUrl);
    }
    /**
