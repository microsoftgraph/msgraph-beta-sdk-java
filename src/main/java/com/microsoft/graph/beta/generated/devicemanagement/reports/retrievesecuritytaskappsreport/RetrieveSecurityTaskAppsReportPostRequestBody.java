package com.microsoft.graph.beta.devicemanagement.reports.retrievesecuritytaskappsreport;
...
public class RetrieveSecurityTaskAppsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetrieveSecurityTaskAppsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RetrieveSecurityTaskAppsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RetrieveSecurityTaskAppsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
