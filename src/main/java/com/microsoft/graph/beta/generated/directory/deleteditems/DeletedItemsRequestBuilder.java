package com.microsoft.graph.beta.directory.deleteditems;

import com.microsoft.graph.beta.directory.deleteditems.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.directory.deleteditems.validateproperties.ValidatePropertiesRequestBuilder;
