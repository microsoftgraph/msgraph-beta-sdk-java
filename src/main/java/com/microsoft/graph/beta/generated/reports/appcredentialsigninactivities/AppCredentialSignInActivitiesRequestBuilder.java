package com.microsoft.graph.beta.reports.appcredentialsigninactivities;

import com.microsoft.graph.beta.models.AppCredentialSignInActivity;
import com.microsoft.graph.beta.models.AppCredentialSignInActivityCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.reports.appcredentialsigninactivities.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.appcredentialsigninactivities.item.AppCredentialSignInActivityItemRequestBuilder;
...
public class AppCredentialSignInActivitiesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link AppCredentialSignInActivityItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link AppCredentialSignInActivitiesRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/reportroot-list-appcredentialsigninactivities?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public AppCredentialSignInActivityCollectionResponse get() {
        return get(null);
    }
    /**
     * Get a list of appCredentialSignInActivity objects that contains recent activity of application credentials.
     ...
     */
    @jakarta.annotation.Nullable
    public AppCredentialSignInActivityCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AppCredentialSignInActivityCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public AppCredentialSignInActivity post(@jakarta.annotation.Nonnull final AppCredentialSignInActivity body) {
     ...
     */
    @jakarta.annotation.Nullable
    public AppCredentialSignInActivity post(@jakarta.annotation.Nonnull final AppCredentialSignInActivity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AppCredentialSignInActivity::createFromDiscriminatorValue);
    }
    /**
     * Get a list of appCredentialSignInActivity objects that contains recent activity of application credentials.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/appCredentialSignInActivities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AppCredentialSignInActivity body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/appCredentialSignInActivities", pathParameters);
