package com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrivilegedRole;
import com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo.selfactivate.SelfActivateRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo.selfdeactivate.SelfDeactivateRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo.settings.SettingsRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignments.item.roleinfo.summary.SummaryRequestBuilder;
...
public class RoleInfoRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleInfoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleInfoRequestBuilder} and sets the default values.
    ...
    public RoleInfoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PrivilegedRole body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo", pathParameters);
