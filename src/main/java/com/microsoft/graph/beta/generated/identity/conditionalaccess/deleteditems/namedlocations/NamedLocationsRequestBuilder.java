package com.microsoft.graph.beta.identity.conditionalaccess.deleteditems.namedlocations;

import com.microsoft.graph.beta.identity.conditionalaccess.deleteditems.namedlocations.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.conditionalaccess.deleteditems.namedlocations.item.NamedLocationItemRequestBuilder;
import com.microsoft.graph.beta.models.NamedLocation;
import com.microsoft.graph.beta.models.NamedLocationCollectionResponse;
...
public class NamedLocationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final NamedLocation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations", pathParameters);
