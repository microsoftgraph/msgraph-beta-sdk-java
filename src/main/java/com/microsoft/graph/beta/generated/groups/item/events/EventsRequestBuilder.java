package com.microsoft.graph.beta.groups.item.events;

import com.microsoft.graph.beta.groups.item.events.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.events.item.EventItemRequestBuilder;
...
public class EventsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-events?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Event}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/group-post-events?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
