package com.microsoft.graph.beta.directoryroles.item.members.item;

import com.microsoft.graph.beta.directoryroles.item.members.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.ref.RefRequestBuilder;
