package com.microsoft.graph.beta.solutions.virtualevents.webinars.item.presenters.item.sessions;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventSessionCollectionResponse;
import com.microsoft.graph.beta.solutions.virtualevents.webinars.item.presenters.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.webinars.item.presenters.item.sessions.item.VirtualEventSessionItemRequestBuilder;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/presenters/{virtualEventPresenter%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new SessionsRequestBuilder and sets the default values.
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/presenters/{virtualEventPresenter%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
