...
public class ConditionalAccessAuthenticationFlows implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    @jakarta.annotation.Nullable
    public EnumSet<ConditionalAccessTransferMethods> getTransferMethods() {
     ...
     */
    public void setTransferMethods(@jakarta.annotation.Nullable final EnumSet<ConditionalAccessTransferMethods> value) {
