package com.microsoft.graph.beta.users.item.chats.item.installedapps.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamsAppInstallation;
import com.microsoft.graph.beta.users.item.chats.item.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
import com.microsoft.graph.beta.users.item.chats.item.installedapps.item.upgrade.UpgradeRequestBuilder;
