package com.microsoft.graph.beta.users.item.owneddevices.graphapproleassignment;

import com.microsoft.graph.beta.models.AppRoleAssignmentCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.owneddevices.graphapproleassignment.count.CountRequestBuilder;
...
public class GraphAppRoleAssignmentRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedDevices/graph.appRoleAssignment{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphAppRoleAssignmentRequestBuilder} and sets the default values.
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedDevices/graph.appRoleAssignment{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
