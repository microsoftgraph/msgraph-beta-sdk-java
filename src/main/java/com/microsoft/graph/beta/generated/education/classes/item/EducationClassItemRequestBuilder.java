package com.microsoft.graph.beta.education.classes.item;

import com.microsoft.graph.beta.education.classes.item.assignmentcategories.AssignmentCategoriesRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignmentdefaults.AssignmentDefaultsRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.assignmentsettings.AssignmentSettingsRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.getrecentlymodifiedsubmissions.GetRecentlyModifiedSubmissionsRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.group.GroupRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.members.MembersRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.ModulesRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.schools.SchoolsRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.teachers.TeachersRequestBuilder;
...
public class EducationClassItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EducationClassItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EducationClassItemRequestBuilder} and sets the default values.
    ...
    public EducationClassItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}", rawUrl);
    }
    /**
     * Delete an educationClass. Because a class is also a universal group, deleting a class deletes the group.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationClass}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/classes/{educationClass%2Did}{?%24expand,%24select}", pathParameters);
