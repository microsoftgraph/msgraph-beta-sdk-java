package com.microsoft.graph.beta.users.item.mailfolders;
...
import com.microsoft.graph.beta.users.item.mailfolders.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.MailFolderItemRequestBuilder;
...
public class MailFoldersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/mailFolders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,includeHiddenFolders*}", pathParameters);
