package com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item;

import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.inreplyto.InReplyToRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.mentions.MentionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.posts.item.reply.ReplyRequestBuilder;
...
public class PostItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}{?%24expand,%24select}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Post body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}", pathParameters);
