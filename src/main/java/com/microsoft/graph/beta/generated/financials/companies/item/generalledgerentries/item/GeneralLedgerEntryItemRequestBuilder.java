package com.microsoft.graph.beta.financials.companies.item.generalledgerentries.item;

import com.microsoft.graph.beta.financials.companies.item.generalledgerentries.item.account.AccountRequestBuilder;
import com.microsoft.graph.beta.models.GeneralLedgerEntry;
...
public class GeneralLedgerEntryItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link GeneralLedgerEntryItemRequestBuilder} and sets the default values.
    ...
    public GeneralLedgerEntryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/generalLedgerEntries/{generalLedgerEntry%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GeneralLedgerEntryItemRequestBuilder} and sets the default values.
    ...
    public GeneralLedgerEntryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/generalLedgerEntries/{generalLedgerEntry%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public GeneralLedgerEntry get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GeneralLedgerEntry::createFromDiscriminatorValue);
    }
    /**
     * Get generalLedgerEntries from financials
