package com.microsoft.graph.beta.administrativeunits.item;
...
import com.microsoft.graph.beta.administrativeunits.item.members.MembersRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.scopedrolemembers.ScopedRoleMembersRequestBuilder;
...
public class AdministrativeUnitItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AdministrativeUnitItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AdministrativeUnitItemRequestBuilder} and sets the default values.
    ...
    public AdministrativeUnitItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}", rawUrl);
    }
    /**
     * Delete an administrativeUnit.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/administrativeunit-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/administrativeunit-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link AdministrativeUnit}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/administrativeunit-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}{?%24expand,%24select}", pathParameters);
