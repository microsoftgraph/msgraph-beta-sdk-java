package com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children.item.relations;
...
import com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.termstore.groups.item.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
