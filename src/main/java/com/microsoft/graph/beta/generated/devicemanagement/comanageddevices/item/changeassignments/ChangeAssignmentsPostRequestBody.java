package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.changeassignments;

import com.microsoft.graph.beta.models.DeviceAssignmentItem;
...
public class ChangeAssignmentsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ChangeAssignmentsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ChangeAssignmentsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ChangeAssignmentsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
