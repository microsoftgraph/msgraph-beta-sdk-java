package com.microsoft.graph.beta.drives.item.list.items.item.activities.item.listitem;
...
public class ListItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ListItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ListItemRequestBuilder and sets the default values.
    ...
    public ListItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}", rawUrl);
    }
    /**
