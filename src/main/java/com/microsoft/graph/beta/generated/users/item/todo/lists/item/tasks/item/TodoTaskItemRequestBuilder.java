package com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TodoTask;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.attachmentsessions.AttachmentSessionsRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.checklistitems.ChecklistItemsRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.todo.lists.item.tasks.item.linkedresources.LinkedResourcesRequestBuilder;
