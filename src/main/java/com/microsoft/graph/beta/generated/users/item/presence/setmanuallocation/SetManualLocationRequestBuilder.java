...
public class SetManualLocationRequestBuilder extends BaseRequestBuilder {
    ...
    public SetManualLocationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/presence/setManualLocation", pathParameters);
    }
    /**
     * Instantiates a new {@link SetManualLocationRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/presence-setmanuallocation?view=graph-rest-beta">Find more info here</a>
     */
