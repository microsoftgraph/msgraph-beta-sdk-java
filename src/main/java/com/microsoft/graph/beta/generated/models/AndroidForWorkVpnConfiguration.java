...
public class AndroidForWorkVpnConfiguration extends DeviceConfiguration implements Parsable {
    /**
     * Instantiates a new {@link AndroidForWorkVpnConfiguration} and sets the default values.
     */
     ...
     * @return a {@link AndroidForWorkVpnConfiguration}
     */
     ...
     * @return a {@link AndroidForWorkVpnConnectionType}
     */
    @jakarta.annotation.Nullable
