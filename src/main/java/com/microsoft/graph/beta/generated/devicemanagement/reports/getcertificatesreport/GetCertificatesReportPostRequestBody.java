...
public class GetCertificatesReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetCertificatesReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetCertificatesReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetCertificatesReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
