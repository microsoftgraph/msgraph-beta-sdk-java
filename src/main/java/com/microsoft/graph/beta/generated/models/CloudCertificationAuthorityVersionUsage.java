...
public class CloudCertificationAuthorityVersionUsage implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudCertificationAuthorityVersionUsage} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CloudCertificationAuthorityVersionUsage createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("issuedStagedLeafCertificateCount", (n) -> { this.setIssuedStagedLeafCertificateCount(n.getIntegerValue()); });
    ...
    public Integer getIssuedStagedLeafCertificateCount() {
        return this.backingStore.get("issuedStagedLeafCertificateCount");
    }
    /**
     ...
     * @param value Value to set for the issuedStagedLeafCertificateCount property.
     */
    public void setIssuedStagedLeafCertificateCount(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("issuedStagedLeafCertificateCount", value);
    }
    /**
