package com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsresourceperformance;

import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsresourceperformance.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsresourceperformance.item.UserExperienceAnalyticsResourcePerformanceItemRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsresourceperformance.summarizedeviceresourceperformancewithsummarizeby.SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsResourcePerformance;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsResourcePerformanceCollectionResponse;
...
public class UserExperienceAnalyticsResourcePerformanceRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link UserExperienceAnalyticsResourcePerformanceCollectionResponse}
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/userExperienceAnalyticsResourcePerformance{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserExperienceAnalyticsResourcePerformance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/userExperienceAnalyticsResourcePerformance", pathParameters);
