package com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item;

import com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.account.AccountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item.ItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PurchaseInvoiceLine;
...
public class PurchaseInvoiceLineItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PurchaseInvoiceLineItemRequestBuilder} and sets the default values.
    ...
    public PurchaseInvoiceLineItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PurchaseInvoiceLineItemRequestBuilder} and sets the default values.
    ...
    public PurchaseInvoiceLineItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * Get purchaseInvoiceLines from financials
     * @return a {@link PurchaseInvoiceLine}
    ...
    public PurchaseInvoiceLine get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, PurchaseInvoiceLine::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PurchaseInvoiceLine body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link PurchaseInvoiceLineItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
