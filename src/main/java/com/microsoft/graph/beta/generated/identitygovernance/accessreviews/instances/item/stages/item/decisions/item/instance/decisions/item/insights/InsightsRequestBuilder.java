package com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stages.item.decisions.item.instance.decisions.item.insights;

import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stages.item.decisions.item.instance.decisions.item.insights.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.instances.item.stages.item.decisions.item.instance.decisions.item.insights.item.GovernanceInsightItemRequestBuilder;
