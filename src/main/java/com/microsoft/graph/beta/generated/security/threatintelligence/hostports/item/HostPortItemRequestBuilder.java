package com.microsoft.graph.beta.security.threatintelligence.hostports.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.HostPort;
import com.microsoft.graph.beta.security.threatintelligence.hostports.item.host.HostRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hostports.item.mostrecentsslcertificate.MostRecentSslCertificateRequestBuilder;
...
public class HostPortItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link MostRecentSslCertificateRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    public HostPortItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link HostPortItemRequestBuilder} and sets the default values.
    ...
    public HostPortItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final HostPort body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}", pathParameters);
