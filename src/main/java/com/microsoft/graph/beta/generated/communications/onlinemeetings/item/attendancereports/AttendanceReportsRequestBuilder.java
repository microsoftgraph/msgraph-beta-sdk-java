package com.microsoft.graph.beta.communications.onlinemeetings.item.attendancereports;

import com.microsoft.graph.beta.communications.onlinemeetings.item.attendancereports.count.CountRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.attendancereports.item.MeetingAttendanceReportItemRequestBuilder;
...
public class AttendanceReportsRequestBuilder extends BaseRequestBuilder {
    ...
    public AttendanceReportsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AttendanceReportsRequestBuilder} and sets the default values.
    ...
    public AttendanceReportsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
