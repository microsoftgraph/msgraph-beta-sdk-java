package com.microsoft.graph.beta.shares.item.list.contenttypes;
...
import com.microsoft.graph.beta.shares.item.list.contenttypes.addcopy.AddCopyRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.contenttypes.count.CountRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.contenttypes.item.ContentTypeItemRequestBuilder;
