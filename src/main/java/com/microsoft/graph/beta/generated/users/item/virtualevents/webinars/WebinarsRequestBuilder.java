package com.microsoft.graph.beta.users.item.virtualevents.webinars;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventWebinarCollectionResponse;
import com.microsoft.graph.beta.users.item.virtualevents.webinars.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.virtualevents.webinars.item.VirtualEventWebinarItemRequestBuilder;
...
public class WebinarsRequestBuilder extends BaseRequestBuilder {
    ...
    public WebinarsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/virtualEvents/webinars{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new WebinarsRequestBuilder and sets the default values.
    ...
    public WebinarsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/virtualEvents/webinars{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
