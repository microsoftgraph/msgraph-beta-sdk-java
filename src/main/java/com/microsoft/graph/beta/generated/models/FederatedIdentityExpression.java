...
public class FederatedIdentityExpression implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link FederatedIdentityExpression} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static FederatedIdentityExpression createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("languageVersion", (n) -> { this.setLanguageVersion(n.getIntegerValue()); });
    ...
    public Integer getLanguageVersion() {
        return this.backingStore.get("languageVersion");
    }
    /**
     ...
     */
    public void setLanguageVersion(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("languageVersion", value);
    }
    /**
