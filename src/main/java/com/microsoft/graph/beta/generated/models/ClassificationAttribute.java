...
public class ClassificationAttribute implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ClassificationAttribute} and sets the default values.
     */
     ...
     * @return a {@link ClassificationAttribute}
     */
    @jakarta.annotation.Nonnull
    public static ClassificationAttribute createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
