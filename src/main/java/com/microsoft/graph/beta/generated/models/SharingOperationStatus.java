...
public class SharingOperationStatus implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SharingOperationStatus} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static SharingOperationStatus createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getDisabledReason() {
        return this.backingStore.get("disabledReason");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("disabledReason", (n) -> { this.setDisabledReason(n.getStringValue()); });
     ...
     */
    public void setDisabledReason(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("disabledReason", value);
    }
    /**
