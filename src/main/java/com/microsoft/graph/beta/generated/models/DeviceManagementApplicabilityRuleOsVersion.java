...
public class DeviceManagementApplicabilityRuleOsVersion implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link DeviceManagementApplicabilityRuleOsVersion} and sets the default values.
     */
     ...
     * @return a {@link DeviceManagementApplicabilityRuleOsVersion}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("minOSVersion", (n) -> { this.setMinOSVersion(n.getStringValue()); });
