package com.microsoft.graph.beta.governanceroleassignments.item;

import com.microsoft.graph.beta.governanceroleassignments.item.linkedeligibleroleassignment.LinkedEligibleRoleAssignmentRequestBuilder;
import com.microsoft.graph.beta.governanceroleassignments.item.resource.ResourceRequestBuilder;
import com.microsoft.graph.beta.governanceroleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
import com.microsoft.graph.beta.governanceroleassignments.item.subject.SubjectRequestBuilder;
...
public class GovernanceRoleAssignmentItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link GovernanceRoleAssignmentItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GovernanceRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GovernanceRoleAssignmentItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GovernanceRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GovernanceRoleAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}", pathParameters);
