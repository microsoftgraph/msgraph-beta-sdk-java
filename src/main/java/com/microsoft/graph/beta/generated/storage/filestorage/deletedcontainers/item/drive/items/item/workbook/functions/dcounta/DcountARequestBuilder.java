package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.dcounta;
...
public class DcountARequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DcountARequestBuilder} and sets the default values.
    ...
    public DcountARequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/dcountA", pathParameters);
    }
    /**
     * Instantiates a new {@link DcountARequestBuilder} and sets the default values.
    ...
    public DcountARequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/dcountA", rawUrl);
    }
    /**
