package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.taskprocessingresults.item;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.taskprocessingresults.item.microsoftgraphidentitygovernanceresume.MicrosoftGraphIdentityGovernanceResumeRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.taskprocessingresults.item.subject.SubjectRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.taskprocessingresults.item.task.TaskRequestBuilder;
