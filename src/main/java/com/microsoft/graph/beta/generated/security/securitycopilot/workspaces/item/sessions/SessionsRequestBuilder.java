package com.microsoft.graph.beta.security.securitycopilot.workspaces.item.sessions;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.securitycopilot.Session;
import com.microsoft.graph.beta.models.security.securitycopilot.SessionCollectionResponse;
import com.microsoft.graph.beta.security.securitycopilot.workspaces.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.securitycopilot.workspaces.item.sessions.item.SessionItemRequestBuilder;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Session body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions", pathParameters);
