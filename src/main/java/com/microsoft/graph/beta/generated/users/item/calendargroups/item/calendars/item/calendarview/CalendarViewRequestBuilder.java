package com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.calendarview;

import com.microsoft.graph.beta.models.EventCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.calendarview.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.calendarview.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.calendarview.item.EventItemRequestBuilder;
...
public class CalendarViewRequestBuilder extends BaseRequestBuilder {
    ...
    public CalendarViewRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link CalendarViewRequestBuilder} and sets the default values.
    ...
    public CalendarViewRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
