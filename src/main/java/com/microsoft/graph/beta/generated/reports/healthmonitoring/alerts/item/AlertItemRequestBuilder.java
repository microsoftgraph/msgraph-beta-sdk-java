package com.microsoft.graph.beta.reports.healthmonitoring.alerts.item;
...
public class AlertItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AlertItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/healthMonitoring/alerts/{alert%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AlertItemRequestBuilder} and sets the default values.
    ...
    public AlertItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/healthMonitoring/alerts/{alert%2Did}", rawUrl);
    }
    /**
     ...
     * @return a {@link Alert}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/healthmonitoring-alert-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Alert}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/healthmonitoring-alert-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/healthMonitoring/alerts/{alert%2Did}{?%24expand,%24select}", pathParameters);
