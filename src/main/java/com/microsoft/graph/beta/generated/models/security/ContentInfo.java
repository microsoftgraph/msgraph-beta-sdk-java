...
public class ContentInfo implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public String getContentFormat() {
        return this.backingStore.get("contentFormat");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ContentState::forValue)); });
    ...
    public void setContentFormat(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("contentFormat", value);
    }
    /**
