package com.microsoft.graph.beta.users.item.calendars.item;

import com.microsoft.graph.beta.models.Calendar;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendars.item.allowedcalendarsharingroleswithuser.AllowedCalendarSharingRolesWithUserRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarpermissions.CalendarPermissionsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.calendarview.CalendarViewRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.EventsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.getschedule.GetScheduleRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.permanentdelete.PermanentDeleteRequestBuilder;
