...
public class AndroidWorkProfileScepCertificateProfile extends AndroidWorkProfileCertificateProfileBase implements Parsable {
     ...
     * @return a AndroidWorkProfileScepCertificateProfileCertificateStore
     */
    @jakarta.annotation.Nullable
    public AndroidWorkProfileScepCertificateProfileCertificateStore getCertificateStore() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("certificateStore", (n) -> { this.setCertificateStore(n.getEnumValue(AndroidWorkProfileScepCertificateProfileCertificateStore::forValue)); });
     ...
     */
    public void setCertificateStore(@jakarta.annotation.Nullable final AndroidWorkProfileScepCertificateProfileCertificateStore value) {
