package com.microsoft.graph.beta.applications.item.synchronization.jobs.item;

import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.bulkupload.BulkUploadRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.pause.PauseRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.provisionondemand.ProvisionOnDemandRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.restart.RestartRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.SchemaRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.validatecredentials.ValidateCredentialsRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SynchronizationJob;
...
public class SynchronizationJobItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SynchronizationJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SynchronizationJobItemRequestBuilder} and sets the default values.
    ...
    public SynchronizationJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}{?%24expand,%24select}", pathParameters);
