...
public class CloudPcRegionGroupConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcRegionGroupConfiguration} and sets the default values.
     */
     ...
     * @return a {@link CloudPcRegionGroupConfiguration}
     */
    @jakarta.annotation.Nonnull
    public static CloudPcRegionGroupConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CloudPcRegionGroupConfiguration();
    }
    /**
    ...
    public java.util.List<String> getRegions() {
        return this.backingStore.get("regions");
    }
    /**
    ...
    public void setRegions(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("regions", value);
    }
}
