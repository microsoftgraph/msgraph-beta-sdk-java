package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Workbook;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.application.ApplicationRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.closesession.CloseSessionRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.comments.CommentsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.createsession.CreateSessionRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.FunctionsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.names.NamesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.refreshsession.RefreshSessionRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.tables.TablesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.worksheets.WorksheetsRequestBuilder;
...
public class WorkbookRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkbookRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkbookRequestBuilder} and sets the default values.
    ...
    public WorkbookRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook{?%24expand,%24select}", rawUrl);
    }
    /**
