package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.initiateondemandproactiveremediation;
...
public class InitiateOnDemandProactiveRemediationRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link InitiateOnDemandProactiveRemediationRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public InitiateOnDemandProactiveRemediationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", pathParameters);
    }
    /**
     * Instantiates a new {@link InitiateOnDemandProactiveRemediationRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public InitiateOnDemandProactiveRemediationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateOnDemandProactiveRemediation", rawUrl);
    }
    /**
