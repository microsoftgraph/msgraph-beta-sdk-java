package com.microsoft.graph.beta.education.users.item.assignments;

import com.microsoft.graph.beta.education.users.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.EducationAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationAssignment;
import com.microsoft.graph.beta.models.EducationAssignmentCollectionResponse;
...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationuser-list-assignments?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/users/{educationUser%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EducationAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/education/users/{educationUser%2Did}/assignments", pathParameters);
