...
import com.microsoft.graph.beta.models.VerificationResult;
...
public class VerifySignatureRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link VerifySignatureRequestBuilder} and sets the default values.
    ...
    public VerifySignatureRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/verifySignature", pathParameters);
    }
    /**
     * Instantiates a new {@link VerifySignatureRequestBuilder} and sets the default values.
    ...
    public VerifySignatureRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/verifySignature", rawUrl);
    }
    /**
    ...
    @Deprecated
    public VerificationResult post(@jakarta.annotation.Nonnull final VerifySignaturePostRequestBody body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public VerificationResult post(@jakarta.annotation.Nonnull final VerifySignaturePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, VerificationResult::createFromDiscriminatorValue);
    }
    /**
     * Invoke action verifySignature
     * @param body The request body
