package com.microsoft.graph.beta.identitygovernance.rolemanagementalerts.alerts.item.alertdefinition;
...
public class AlertDefinitionRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AlertDefinitionRequestBuilder} and sets the default values.
    ...
    public AlertDefinitionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertDefinition{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AlertDefinitionRequestBuilder} and sets the default values.
    ...
    public AlertDefinitionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertDefinition{?%24expand,%24select}", rawUrl);
    }
    /**
