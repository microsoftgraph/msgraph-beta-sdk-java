package com.microsoft.graph.beta.groups.item.calendar.events.item.attachments;

import com.microsoft.graph.beta.groups.item.calendar.events.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.attachments.item.AttachmentItemRequestBuilder;
...
public class AttachmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public AttachmentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AttachmentsRequestBuilder} and sets the default values.
    ...
    public AttachmentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Attachment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/attachments", pathParameters);
