package com.microsoft.graph.beta.riskyusers.item.history;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RiskyUserHistoryItem;
import com.microsoft.graph.beta.models.RiskyUserHistoryItemCollectionResponse;
import com.microsoft.graph.beta.riskyusers.item.history.count.CountRequestBuilder;
import com.microsoft.graph.beta.riskyusers.item.history.item.RiskyUserHistoryItemItemRequestBuilder;
...
public class HistoryRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/riskyuser-list-history?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/riskyUsers/{riskyUser%2Did}/history{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RiskyUserHistoryItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/riskyUsers/{riskyUser%2Did}/history", pathParameters);
