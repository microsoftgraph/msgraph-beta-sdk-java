package com.microsoft.graph.beta.rolemanagement.directory.roleassignmentschedulerequests.item.targetschedule;
...
public class TargetScheduleRequestBuilder extends BaseRequestBuilder {
    ...
    public TargetScheduleRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TargetScheduleRequestBuilder} and sets the default values.
    ...
    public TargetScheduleRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}", rawUrl);
    }
    /**
