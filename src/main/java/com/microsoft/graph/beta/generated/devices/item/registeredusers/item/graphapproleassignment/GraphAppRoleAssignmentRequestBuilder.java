package com.microsoft.graph.beta.devices.item.registeredusers.item.graphapproleassignment;
...
public class GraphAppRoleAssignmentRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphAppRoleAssignmentRequestBuilder} and sets the default values.
    ...
    public GraphAppRoleAssignmentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}", rawUrl);
    }
    /**
