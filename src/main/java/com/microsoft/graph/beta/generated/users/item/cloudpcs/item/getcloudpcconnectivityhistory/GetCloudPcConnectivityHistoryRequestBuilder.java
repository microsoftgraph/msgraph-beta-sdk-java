...
public class GetCloudPcConnectivityHistoryRequestBuilder extends BaseRequestBuilder {
    ...
    public GetCloudPcConnectivityHistoryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/getCloudPcConnectivityHistory(){?%24count,%24filter,%24search,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetCloudPcConnectivityHistoryRequestBuilder} and sets the default values.
