package com.microsoft.graph.beta.directoryroles;

import com.microsoft.graph.beta.directoryroles.count.CountRequestBuilder;
import com.microsoft.graph.beta.directoryroles.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.directoryroles.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.DirectoryRoleItemRequestBuilder;
import com.microsoft.graph.beta.directoryroles.validateproperties.ValidatePropertiesRequestBuilder;
...
public class DirectoryRolesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directoryrole-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/directoryrole-post-directoryroles?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
