package com.microsoft.graph.beta.certificateauthorities.mutualtlsoauthconfigurations;

import com.microsoft.graph.beta.certificateauthorities.mutualtlsoauthconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.beta.certificateauthorities.mutualtlsoauthconfigurations.item.MutualTlsOauthConfigurationItemRequestBuilder;
...
public class MutualTlsOauthConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/certificateAuthorities/mutualTlsOauthConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MutualTlsOauthConfiguration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/certificateAuthorities/mutualTlsOauthConfigurations", pathParameters);
