package com.microsoft.graph.beta.solutions.backuprestore.exchangerestoresessions.item.mailboxrestoreartifacts.item.restorepoint;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RestorePoint;
...
public class RestorePointRequestBuilder extends BaseRequestBuilder {
    ...
    public RestorePointRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/mailboxRestoreArtifacts/{mailboxRestoreArtifact%2Did}/restorePoint{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RestorePointRequestBuilder} and sets the default values.
    ...
    public RestorePointRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/mailboxRestoreArtifacts/{mailboxRestoreArtifact%2Did}/restorePoint{?%24expand,%24select}", rawUrl);
    }
    /**
