package com.microsoft.graph.beta.security.labels.retentionlabels;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.RetentionLabel;
import com.microsoft.graph.beta.models.security.RetentionLabelCollectionResponse;
import com.microsoft.graph.beta.security.labels.retentionlabels.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.labels.retentionlabels.item.RetentionLabelItemRequestBuilder;
...
public class RetentionLabelsRequestBuilder extends BaseRequestBuilder {
    ...
    public RetentionLabelsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RetentionLabelsRequestBuilder and sets the default values.
    ...
    public RetentionLabelsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
