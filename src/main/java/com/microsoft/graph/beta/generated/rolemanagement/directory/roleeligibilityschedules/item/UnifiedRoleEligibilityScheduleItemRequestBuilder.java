package com.microsoft.graph.beta.rolemanagement.directory.roleeligibilityschedules.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UnifiedRoleEligibilitySchedule;
import com.microsoft.graph.beta.rolemanagement.directory.roleeligibilityschedules.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleeligibilityschedules.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleeligibilityschedules.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleeligibilityschedules.item.roledefinition.RoleDefinitionRequestBuilder;
...
public class UnifiedRoleEligibilityScheduleItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/unifiedroleeligibilityschedule-get?view=graph-rest-beta">Find more info here</a>
     */
