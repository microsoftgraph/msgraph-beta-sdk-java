package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.versions.item.ListItemVersionItemRequestBuilder;
