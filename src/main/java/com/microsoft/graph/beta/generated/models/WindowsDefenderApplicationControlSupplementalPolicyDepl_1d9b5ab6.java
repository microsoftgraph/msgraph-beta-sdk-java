...
public class WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6 extends Entity implements Parsable {
    /**
     * Instantiates a new {@link WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6} and sets the default values.
     */
    public WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6() {
        super();
    }
    /**
    ...
    public static WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6 createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6();
    }
    /**
