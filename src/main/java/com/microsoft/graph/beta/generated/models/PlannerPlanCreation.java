...
public class PlannerPlanCreation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PlannerPlanCreation} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static PlannerPlanCreation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        final ParseNode mappingValueNode = parseNode.getChildNode("@odata.type");
        if (mappingValueNode != null) {
            final String mappingValue = mappingValueNode.getStringValue();
            switch (mappingValue) {
                case "#microsoft.graph.plannerExternalPlanSource": return new PlannerExternalPlanSource();
            }
        }
     ...
     * @return a {@link PlannerCreationSourceKind}
     */
