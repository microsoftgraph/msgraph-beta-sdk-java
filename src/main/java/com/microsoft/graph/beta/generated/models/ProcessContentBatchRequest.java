...
public class ProcessContentBatchRequest implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ProcessContentBatchRequest} and sets the default values.
     */
     ...
     * @return a {@link ProcessContentBatchRequest}
     */
    @jakarta.annotation.Nonnull
    public static ProcessContentBatchRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public ProcessContentRequest getContentToProcess() {
        return this.backingStore.get("contentToProcess");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("contentToProcess", (n) -> { this.setContentToProcess(n.getObjectValue(ProcessContentRequest::createFromDiscriminatorValue)); });
     ...
     */
    public void setContentToProcess(@jakarta.annotation.Nullable final ProcessContentRequest value) {
        this.backingStore.set("contentToProcess", value);
    }
    /**
