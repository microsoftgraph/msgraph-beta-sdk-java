...
public class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942 get() {
        return get(null);
    }
    /**
     * Retrieve the number of remote networks which are disconnected due to BGP being down. A remote network represents a location such as a branch office where customer premises equipment (CPE) is connected to the nearest deployment of Global Secure Access service through IPsec tunnels.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942::createFromDiscriminatorValue);
    }
    /**
     * Retrieve the number of remote networks which are disconnected due to BGP being down. A remote network represents a location such as a branch office where customer premises equipment (CPE) is connected to the nearest deployment of Global Secure Access service through IPsec tunnels.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a(rawUrl, requestAdapter);
    }
    /**
     * Retrieve the number of remote networks which are disconnected due to BGP being down. A remote network represents a location such as a branch office where customer premises equipment (CPE) is connected to the nearest deployment of Global Secure Access service through IPsec tunnels.
     */
