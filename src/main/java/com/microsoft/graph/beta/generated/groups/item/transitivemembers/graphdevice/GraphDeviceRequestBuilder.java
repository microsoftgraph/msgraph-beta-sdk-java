package com.microsoft.graph.beta.groups.item.transitivemembers.graphdevice;

import com.microsoft.graph.beta.groups.item.transitivemembers.graphdevice.count.CountRequestBuilder;
...
public class GraphDeviceRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphDeviceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.device{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new GraphDeviceRequestBuilder and sets the default values.
    ...
    public GraphDeviceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.device{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
