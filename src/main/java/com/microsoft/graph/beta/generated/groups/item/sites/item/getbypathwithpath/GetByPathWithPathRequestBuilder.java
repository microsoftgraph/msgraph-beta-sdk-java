package com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath;

import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.archive.ArchiveRequestBuilder;
...
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.externalcolumns.ExternalColumnsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.getactivitiesbyintervalwithstartdatetimewithenddatetime_3adc0b7b.GetActivitiesByIntervalWithStartDateTimeWithEndDateTime_41999afb;
...
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.lists.ListsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.onenote.OnenoteRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.pagetemplates.PageTemplatesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.recyclebin.RecycleBinRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.sites.SitesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.termstore.TermStoreRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.getbypathwithpath.unarchive.UnarchiveRequestBuilder;
