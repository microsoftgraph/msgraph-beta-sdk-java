package com.microsoft.graph.beta.sites.item.lists.item.columns;
...
import com.microsoft.graph.beta.sites.item.lists.item.columns.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.columns.item.ColumnDefinitionItemRequestBuilder;
...
public class ColumnsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/list-list-columns?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/list-post-columns?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
