package com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.databodyrange.boundingrectwithanotherrange;
...
public class BoundingRectWithAnotherRangeRequestBuilder extends BaseRequestBuilder {
    ...
    public BoundingRectWithAnotherRangeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String anotherRange) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/dataBodyRange()/boundingRect(anotherRange='{anotherRange}')", pathParameters);
    ...
    public BoundingRectWithAnotherRangeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/dataBodyRange()/boundingRect(anotherRange='{anotherRange}')", rawUrl);
    }
    /**
