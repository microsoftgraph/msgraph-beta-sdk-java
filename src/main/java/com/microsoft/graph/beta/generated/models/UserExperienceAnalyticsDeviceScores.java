...
public class UserExperienceAnalyticsDeviceScores extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("meanResourceSpikeTimeScore", (n) -> { this.setMeanResourceSpikeTimeScore(n.getObjectValue(UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore::createFromDiscriminatorValue)); });
     ...
     * @return a {@link UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore}
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore getMeanResourceSpikeTimeScore() {
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("meanResourceSpikeTimeScore", this.getMeanResourceSpikeTimeScore());
     ...
     */
    public void setMeanResourceSpikeTimeScore(@jakarta.annotation.Nullable final UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
         * Stores model information.
         */
        @jakarta.annotation.Nonnull
        protected BackingStore backingStore;
        /**
         * Instantiates a new {@link UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore} and sets the default values.
         */
        public UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore() {
            this.backingStore = BackingStoreFactorySingleton.instance.createBackingStore();
        }
        /**
         * Creates a new instance of the appropriate class based on discriminator value
         ...
         */
        @jakarta.annotation.Nonnull
        public static UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore result = new UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore();
            final ParseNode mappingValueNode = parseNode.getChildNode("");
            if (mappingValueNode != null) {
                final String mappingValue = mappingValueNode.getStringValue();
            }
