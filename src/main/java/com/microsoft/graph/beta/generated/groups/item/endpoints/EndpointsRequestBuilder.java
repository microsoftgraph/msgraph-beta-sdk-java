package com.microsoft.graph.beta.groups.item.endpoints;

import com.microsoft.graph.beta.groups.item.endpoints.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.endpoints.item.EndpointItemRequestBuilder;
import com.microsoft.graph.beta.models.Endpoint;
import com.microsoft.graph.beta.models.EndpointCollectionResponse;
...
public class EndpointsRequestBuilder extends BaseRequestBuilder {
    ...
    public EndpointsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/endpoints{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new EndpointsRequestBuilder and sets the default values.
    ...
    public EndpointsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/endpoints{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Retrieve a list of endpoint objects.
     * @return a EndpointCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-endpoints?view=graph-rest-1.0">Find more info here</a>
     */
