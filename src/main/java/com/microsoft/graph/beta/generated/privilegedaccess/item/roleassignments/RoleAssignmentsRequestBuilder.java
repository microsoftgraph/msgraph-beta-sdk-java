package com.microsoft.graph.beta.privilegedaccess.item.roleassignments;
...
import com.microsoft.graph.beta.privilegedaccess.item.roleassignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.privilegedaccess.item.roleassignments.export.ExportRequestBuilder;
import com.microsoft.graph.beta.privilegedaccess.item.roleassignments.item.GovernanceRoleAssignmentItemRequestBuilder;
...
public class RoleAssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleAssignmentsRequestBuilder} and sets the default values.
    ...
    public RoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GovernanceRoleAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments", pathParameters);
