package com.microsoft.graph.beta.education.users.item.assignments.item;

import com.microsoft.graph.beta.education.users.item.assignments.item.activate.ActivateRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.deactivate.DeactivateRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.gradingcategory.GradingCategoryRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.gradingscheme.GradingSchemeRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.publish.PublishRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.resources.ResourcesRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.rubric.RubricRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.setupfeedbackresourcesfolder.SetUpFeedbackResourcesFolderRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.setupresourcesfolder.SetUpResourcesFolderRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.submissions.SubmissionsRequestBuilder;
import com.microsoft.graph.beta.models.EducationAssignment;
...
public class EducationAssignmentItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EducationAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EducationAssignmentItemRequestBuilder} and sets the default values.
    ...
    public EducationAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}{?%24expand,%24select}", pathParameters);
