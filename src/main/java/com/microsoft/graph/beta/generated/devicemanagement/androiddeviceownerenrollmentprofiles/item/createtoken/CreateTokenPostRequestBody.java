...
public class CreateTokenPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CreateTokenPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CreateTokenPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Integer getTokenValidityInSeconds() {
        return this.backingStore.get("tokenValidityInSeconds");
    }
    /**
    ...
    public void setTokenValidityInSeconds(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("tokenValidityInSeconds", value);
    }
}
