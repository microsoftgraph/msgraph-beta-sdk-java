...
public class GcpScope implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GcpScope} and sets the default values.
     */
    public GcpScope() {
     ...
     * @return a {@link GcpScope}
     */
    @jakarta.annotation.Nonnull
    public static GcpScope createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
