package com.microsoft.graph.beta.policies.permissiongrantpolicies.item.includes;
...
import com.microsoft.graph.beta.policies.permissiongrantpolicies.item.includes.count.CountRequestBuilder;
import com.microsoft.graph.beta.policies.permissiongrantpolicies.item.includes.item.PermissionGrantConditionSetItemRequestBuilder;
...
public class IncludesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-list-includes?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-post-includes?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
