package com.microsoft.graph.beta.directory.attributesets;

import com.microsoft.graph.beta.directory.attributesets.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.attributesets.item.AttributeSetItemRequestBuilder;
import com.microsoft.graph.beta.models.AttributeSet;
import com.microsoft.graph.beta.models.AttributeSetCollectionResponse;
...
public class AttributeSetsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AttributeSetsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directory-list-attributesets?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/directory-post-attributesets?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directory/attributeSets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AttributeSet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directory/attributeSets", pathParameters);
