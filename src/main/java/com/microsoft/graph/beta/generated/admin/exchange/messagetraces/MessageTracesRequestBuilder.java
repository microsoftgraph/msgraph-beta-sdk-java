package com.microsoft.graph.beta.admin.exchange.messagetraces;

import com.microsoft.graph.beta.admin.exchange.messagetraces.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.exchange.messagetraces.item.MessageTraceItemRequestBuilder;
import com.microsoft.graph.beta.models.MessageTrace;
import com.microsoft.graph.beta.models.MessageTraceCollectionResponse;
...
public class MessageTracesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/exchange/messageTraces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MessageTrace body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/admin/exchange/messageTraces", pathParameters);
