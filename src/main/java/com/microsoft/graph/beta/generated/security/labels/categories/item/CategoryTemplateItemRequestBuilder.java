package com.microsoft.graph.beta.security.labels.categories.item;
...
public class CategoryTemplateItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public CategoryTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link CategoryTemplateItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public CategoryTemplateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-categorytemplate-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nullable
    public CategoryTemplate patch(@jakarta.annotation.Nonnull final CategoryTemplate body) {
     ...
     */
    @jakarta.annotation.Nullable
    public CategoryTemplate patch(@jakarta.annotation.Nonnull final CategoryTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CategoryTemplate body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public CategoryTemplateItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
