package com.microsoft.graph.beta.directory.templates.devicetemplates;

import com.microsoft.graph.beta.directory.templates.devicetemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.templates.devicetemplates.item.DeviceTemplateItemRequestBuilder;
...
public class DeviceTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directory/templates/deviceTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/directory/templates/deviceTemplates", pathParameters);
