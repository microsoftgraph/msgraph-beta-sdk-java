package com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions.item;

import com.microsoft.graph.beta.models.DocumentSetVersion;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions.item.restore.RestoreRequestBuilder;
...
public class DocumentSetVersionItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/documentsetversion-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/documentsetversion-get?view=graph-rest-beta">Find more info here</a>
     */
