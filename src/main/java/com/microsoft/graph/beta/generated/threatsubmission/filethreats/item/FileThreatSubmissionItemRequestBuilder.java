package com.microsoft.graph.beta.threatsubmission.filethreats.item;
...
public class FileThreatSubmissionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public FileThreatSubmissionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/threatSubmission/fileThreats/{fileThreatSubmission%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link FileThreatSubmissionItemRequestBuilder} and sets the default values.
    ...
    public FileThreatSubmissionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/threatSubmission/fileThreats/{fileThreatSubmission%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/threatSubmission/fileThreats/{fileThreatSubmission%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final FileThreatSubmission body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/threatSubmission/fileThreats/{fileThreatSubmission%2Did}", pathParameters);
