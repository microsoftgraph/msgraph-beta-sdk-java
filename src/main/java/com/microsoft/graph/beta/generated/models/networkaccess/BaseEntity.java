...
public class BaseEntity extends Entity implements Parsable {
    /**
     * Instantiates a new {@link BaseEntity} and sets the default values.
     */
    public BaseEntity() {
        super();
    }
    ...
    public static BaseEntity createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
