package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.toterm.ToTermRequestBuilder;
