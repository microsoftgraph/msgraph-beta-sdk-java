package com.microsoft.graph.beta.communications.calls.item.participants;

import com.microsoft.graph.beta.communications.calls.item.participants.admitallfromlobby.AdmitAllFromLobbyRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.participants.count.CountRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.participants.invite.InviteRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.participants.item.ParticipantItemRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.participants.muteall.MuteAllRequestBuilder;
...
public class ParticipantsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/call-list-participants?view=graph-rest-beta">Find more info here</a>
     */
