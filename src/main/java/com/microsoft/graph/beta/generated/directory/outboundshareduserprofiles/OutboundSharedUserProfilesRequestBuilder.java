package com.microsoft.graph.beta.directory.outboundshareduserprofiles;

import com.microsoft.graph.beta.directory.outboundshareduserprofiles.count.CountRequestBuilder;
import com.microsoft.graph.beta.directory.outboundshareduserprofiles.item.OutboundSharedUserProfileUserItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OutboundSharedUserProfile;
import com.microsoft.graph.beta.models.OutboundSharedUserProfileCollectionResponse;
...
public class OutboundSharedUserProfilesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directory-list-outboundshareduserprofiles?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/directory/outboundSharedUserProfiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
