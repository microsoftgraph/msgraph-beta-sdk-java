package com.microsoft.graph.beta.devicemanagement.reports.getcompliancesettingdetailsreport;
...
public class GetComplianceSettingDetailsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetComplianceSettingDetailsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetComplianceSettingDetailsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetComplianceSettingDetailsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
