package com.microsoft.graph.beta.applications.item.tokenissuancepolicies;

import com.microsoft.graph.beta.applications.item.tokenissuancepolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.applications.item.tokenissuancepolicies.item.TokenIssuancePolicyItemRequestBuilder;
import com.microsoft.graph.beta.applications.item.tokenissuancepolicies.ref.RefRequestBuilder;
...
public class TokenIssuancePoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public TokenIssuancePoliciesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/tokenIssuancePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TokenIssuancePoliciesRequestBuilder and sets the default values.
