package com.microsoft.graph.beta.authenticationmethodspolicy.authenticationmethodconfigurations;

import com.microsoft.graph.beta.authenticationmethodspolicy.authenticationmethodconfigurations.count.CountRequestBuilder;
import com.microsoft.graph.beta.authenticationmethodspolicy.authenticationmethodconfigurations.item.AuthenticationMethodConfigurationItemRequestBuilder;
...
public class AuthenticationMethodConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
