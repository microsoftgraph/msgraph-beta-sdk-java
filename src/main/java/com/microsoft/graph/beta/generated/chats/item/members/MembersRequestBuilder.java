package com.microsoft.graph.beta.chats.item.members;

import com.microsoft.graph.beta.chats.item.members.add.AddRequestBuilder;
import com.microsoft.graph.beta.chats.item.members.count.CountRequestBuilder;
import com.microsoft.graph.beta.chats.item.members.item.ConversationMemberItemRequestBuilder;
import com.microsoft.graph.beta.chats.item.members.remove.RemoveRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/chat-post-members?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
