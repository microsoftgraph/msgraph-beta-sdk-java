package com.microsoft.graph.beta.teams.item.schedule.offershiftrequests;
...
import com.microsoft.graph.beta.teams.item.schedule.offershiftrequests.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
...
public class OfferShiftRequestsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/offershiftrequest-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/offershiftrequest-post?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
