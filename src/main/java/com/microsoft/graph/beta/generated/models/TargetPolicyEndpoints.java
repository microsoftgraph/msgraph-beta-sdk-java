...
public class TargetPolicyEndpoints implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TargetPolicyEndpoints} and sets the default values.
     */
    ...
    public java.util.List<String> getPlatformTypes() {
        return this.backingStore.get("platformTypes");
    }
    /**
    ...
    public void setPlatformTypes(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("platformTypes", value);
    }
}
