...
public class AzureADPremiumFeatureUtilization implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AzureADPremiumFeatureUtilization} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AzureADPremiumFeatureUtilization createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AzureADPremiumFeatureUtilization();
    }
    /**
