package com.microsoft.graph.beta.external;

import com.microsoft.graph.beta.external.authorizationsystems.AuthorizationSystemsRequestBuilder;
import com.microsoft.graph.beta.external.connections.ConnectionsRequestBuilder;
import com.microsoft.graph.beta.external.industrydata.IndustryDataRequestBuilder;
import com.microsoft.graph.beta.models.externalconnectors.External;
...
public class ExternalRequestBuilder extends BaseRequestBuilder {
    ...
    public IndustryDataRequestBuilder industryData() {
        return new IndustryDataRequestBuilder(pathParameters, requestAdapter);
    }
    /**
