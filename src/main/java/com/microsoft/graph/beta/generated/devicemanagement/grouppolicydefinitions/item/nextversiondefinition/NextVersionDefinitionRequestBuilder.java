package com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition;

import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.category.CategoryRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.definitionfile.DefinitionFileRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.presentations.PresentationsRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.nextversiondefinition.previousversiondefinition.PreviousVersionDefinitionRequestBuilder;
...
public class NextVersionDefinitionRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link NextVersionDefinitionRequestBuilder} and sets the default values.
    ...
    public NextVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link NextVersionDefinitionRequestBuilder} and sets the default values.
    ...
    public NextVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GroupPolicyDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition", pathParameters);
