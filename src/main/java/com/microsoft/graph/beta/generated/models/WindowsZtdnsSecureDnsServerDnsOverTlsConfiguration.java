...
public class WindowsZtdnsSecureDnsServerDnsOverTlsConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WindowsZtdnsSecureDnsServerDnsOverTlsConfiguration} and sets the default values.
     */
    public WindowsZtdnsSecureDnsServerDnsOverTlsConfiguration() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static WindowsZtdnsSecureDnsServerDnsOverTlsConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tlsPort", (n) -> { this.setTlsPort(n.getIntegerValue()); });
    ...
    public Integer getTlsPort() {
        return this.backingStore.get("tlsPort");
    }
    /**
     ...
     * @param value Value to set for the tlsPort property.
     */
    public void setTlsPort(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("tlsPort", value);
    }
}
