package com.microsoft.graph.beta.termstore.sets.item.terms.item.children.item.relations;
...
import com.microsoft.graph.beta.termstore.sets.item.terms.item.children.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.beta.termstore.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
...
public class RelationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RelationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RelationsRequestBuilder} and sets the default values.
    ...
    public RelationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Relation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations", pathParameters);
