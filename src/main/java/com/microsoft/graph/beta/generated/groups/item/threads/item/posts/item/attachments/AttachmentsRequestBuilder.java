package com.microsoft.graph.beta.groups.item.threads.item.posts.item.attachments;

import com.microsoft.graph.beta.groups.item.threads.item.posts.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.posts.item.attachments.item.AttachmentItemRequestBuilder;
...
public class AttachmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/post-list-attachments?view=graph-rest-beta">Find more info here</a>
     */
