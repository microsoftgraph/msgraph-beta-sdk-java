...
public class MarkAsJunkPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MarkAsJunkPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link MarkAsJunkPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Boolean getMoveToJunk() {
        return this.backingStore.get("moveToJunk");
    }
    /**
    ...
    public void setMoveToJunk(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("moveToJunk", value);
    }
}
