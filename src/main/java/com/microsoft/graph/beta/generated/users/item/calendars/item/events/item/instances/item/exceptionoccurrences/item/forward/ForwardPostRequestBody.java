package com.microsoft.graph.beta.users.item.calendars.item.events.item.instances.item.exceptionoccurrences.item.forward;

import com.microsoft.graph.beta.models.Recipient;
