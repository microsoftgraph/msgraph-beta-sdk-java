...
public class CloudPcOnPremisesConnection extends Entity implements Parsable {
     ...
     * @return a CloudPcOnPremisesConnectionConnectionType
     */
    @jakarta.annotation.Nullable
    public CloudPcOnPremisesConnectionConnectionType getConnectionType() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("connectionType", (n) -> { this.setConnectionType(n.getEnumValue(CloudPcOnPremisesConnectionConnectionType::forValue)); });
     ...
     */
    public void setConnectionType(@jakarta.annotation.Nullable final CloudPcOnPremisesConnectionConnectionType value) {
