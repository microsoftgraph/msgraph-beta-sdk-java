package com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure;

import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.findings.FindingsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.PermissionsCreepIndexDistributionsRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PermissionsAnalytics;
...
public class AzureRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AzureRequestBuilder} and sets the default values.
    ...
    public AzureRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AzureRequestBuilder} and sets the default values.
    ...
    public AzureRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/identityGovernance/permissionsAnalytics/azure", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PermissionsAnalytics body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/identityGovernance/permissionsAnalytics/azure", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link AzureRequestBuilder}
     */
    @jakarta.annotation.Nonnull
