package com.microsoft.graph.beta.external.industrydata.sourcesystems;

import com.microsoft.graph.beta.external.industrydata.sourcesystems.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.industrydata.sourcesystems.item.SourceSystemDefinitionItemRequestBuilder;
import com.microsoft.graph.beta.models.industrydata.SourceSystemDefinition;
import com.microsoft.graph.beta.models.industrydata.SourceSystemDefinitionCollectionResponse;
...
public class SourceSystemsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link SourceSystemDefinitionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link SourceSystemsRequestBuilder} and sets the default values.
     ...
     * @return a {@link SourceSystemDefinitionCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-sourcesystemdefinition-list?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public SourceSystemDefinitionCollectionResponse get() {
        return get(null);
    }
    /**
     * Get a list of the sourceSystemDefinition objects and their properties.
     ...
     */
    @jakarta.annotation.Nullable
    public SourceSystemDefinitionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, SourceSystemDefinitionCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-sourcesystemdefinition-post?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public SourceSystemDefinition post(@jakarta.annotation.Nonnull final SourceSystemDefinition body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SourceSystemDefinition post(@jakarta.annotation.Nonnull final SourceSystemDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/external/industryData/sourceSystems{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SourceSystemDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/external/industryData/sourceSystems", pathParameters);
