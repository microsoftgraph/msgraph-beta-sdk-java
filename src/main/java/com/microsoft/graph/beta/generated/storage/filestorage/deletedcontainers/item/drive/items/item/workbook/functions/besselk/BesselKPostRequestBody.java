package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.besselk;
...
public class BesselKPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BesselKPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link BesselKPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static BesselKPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
