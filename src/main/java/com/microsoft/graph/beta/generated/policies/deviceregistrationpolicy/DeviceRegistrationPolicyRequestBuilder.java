package com.microsoft.graph.beta.policies.deviceregistrationpolicy;

import com.microsoft.graph.beta.models.DeviceRegistrationPolicy;
...
public class DeviceRegistrationPolicyRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DeviceRegistrationPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/policies/deviceRegistrationPolicy", pathParameters);
