package com.microsoft.graph.beta.storage.filestorage.containers.item.drive;

import com.microsoft.graph.beta.models.Drive;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.bundles.BundlesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.following.FollowingRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.ItemsRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.list.ListRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.recent.RecentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.root.RootRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.sharedwithme.SharedWithMeRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.special.SpecialRequestBuilder;
...
public class DriveRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link Drive}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/filestoragecontainer-get-drive?view=graph-rest-beta">Find more info here</a>
     */
