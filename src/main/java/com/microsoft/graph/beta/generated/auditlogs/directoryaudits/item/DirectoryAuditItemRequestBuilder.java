package com.microsoft.graph.beta.auditlogs.directoryaudits.item;

import com.microsoft.graph.beta.models.DirectoryAudit;
...
public class DirectoryAuditItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link DirectoryAuditItemRequestBuilder} and sets the default values.
    ...
    public DirectoryAuditItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DirectoryAuditItemRequestBuilder} and sets the default values.
    ...
    public DirectoryAuditItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryAudits/{directoryAudit%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link DirectoryAuditItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
