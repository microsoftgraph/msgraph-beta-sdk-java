package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.windowsdefenderupdatesignatures;
...
public class WindowsDefenderUpdateSignaturesRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link WindowsDefenderUpdateSignaturesRequestBuilder} and sets the default values.
    ...
    public WindowsDefenderUpdateSignaturesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", pathParameters);
    }
    /**
     * Instantiates a new {@link WindowsDefenderUpdateSignaturesRequestBuilder} and sets the default values.
    ...
    public WindowsDefenderUpdateSignaturesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures", rawUrl);
    }
    /**
