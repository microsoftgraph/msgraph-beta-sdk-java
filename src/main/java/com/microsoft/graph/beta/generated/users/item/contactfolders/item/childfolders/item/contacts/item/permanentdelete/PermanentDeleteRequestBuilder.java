package com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.permanentdelete;
...
public class PermanentDeleteRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/contact-permanentdelete?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void post() {
        post(null);
