package com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns;

import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.add.AddRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.WorkbookTableColumnItemRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.itematwithindex.ItemAtWithIndexRequestBuilder;
