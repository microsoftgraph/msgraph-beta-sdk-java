package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.lastmodifiedbyuser;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class LastModifiedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/lastModifiedByUser{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link LastModifiedByUserRequestBuilder} and sets the default values.
    ...
    public LastModifiedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/lastModifiedByUser{?%24expand,%24select}", rawUrl);
    }
    /**
