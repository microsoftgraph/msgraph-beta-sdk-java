package com.microsoft.graph.beta.auditlogs.directoryprovisioning.item;
...
public class ProvisioningObjectSummaryItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ProvisioningObjectSummaryItemRequestBuilder} and sets the default values.
    ...
    public ProvisioningObjectSummaryItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ProvisioningObjectSummaryItemRequestBuilder} and sets the default values.
    ...
    public ProvisioningObjectSummaryItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ProvisioningObjectSummary body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/auditLogs/directoryProvisioning/{provisioningObjectSummary%2Did}", pathParameters);
