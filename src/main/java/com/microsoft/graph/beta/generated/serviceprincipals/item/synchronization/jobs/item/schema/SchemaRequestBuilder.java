package com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SynchronizationSchema;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.directories.DirectoriesRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.functions.FunctionsRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.schema.parseexpression.ParseExpressionRequestBuilder;
