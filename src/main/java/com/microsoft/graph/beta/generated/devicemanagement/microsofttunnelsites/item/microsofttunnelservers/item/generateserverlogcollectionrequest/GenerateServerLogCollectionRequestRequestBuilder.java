package com.microsoft.graph.beta.devicemanagement.microsofttunnelsites.item.microsofttunnelservers.item.generateserverlogcollectionrequest;
...
public class GenerateServerLogCollectionRequestRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GenerateServerLogCollectionRequestRequestBuilder} and sets the default values.
    ...
    public MicrosoftTunnelServerLogCollectionResponse post(@jakarta.annotation.Nonnull final GenerateServerLogCollectionRequestPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public MicrosoftTunnelServerLogCollectionResponse post(@jakarta.annotation.Nonnull final GenerateServerLogCollectionRequestPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GenerateServerLogCollectionRequestPostRequestBody body) {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link GenerateServerLogCollectionRequestRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public GenerateServerLogCollectionRequestRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GenerateServerLogCollectionRequestRequestBuilder(rawUrl, requestAdapter);
    }
    /**
