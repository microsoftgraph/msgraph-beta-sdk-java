package com.microsoft.graph.beta.identitygovernance.accessreviews.historydefinitions;

import com.microsoft.graph.beta.identitygovernance.accessreviews.historydefinitions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.accessreviews.historydefinitions.item.AccessReviewHistoryDefinitionItemRequestBuilder;
import com.microsoft.graph.beta.models.AccessReviewHistoryDefinition;
import com.microsoft.graph.beta.models.AccessReviewHistoryDefinitionCollectionResponse;
...
public class HistoryDefinitionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link HistoryDefinitionsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/accessreviewset-list-historydefinitions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/accessreviewset-post-historydefinitions?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AccessReviewHistoryDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions", pathParameters);
