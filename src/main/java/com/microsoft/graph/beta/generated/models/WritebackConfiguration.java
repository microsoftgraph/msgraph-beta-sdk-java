...
public class WritebackConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WritebackConfiguration} and sets the default values.
     */
     ...
     * @return a {@link WritebackConfiguration}
     */
    @jakarta.annotation.Nonnull
    public static WritebackConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
