package com.microsoft.graph.beta.administrativeunits;

import com.microsoft.graph.beta.administrativeunits.count.CountRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.item.AdministrativeUnitItemRequestBuilder;
import com.microsoft.graph.beta.administrativeunits.validateproperties.ValidatePropertiesRequestBuilder;
...
public class AdministrativeUnitsRequestBuilder extends BaseRequestBuilder {
    ...
    public AdministrativeUnitsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AdministrativeUnitsRequestBuilder and sets the default values.
    ...
    public AdministrativeUnitsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
