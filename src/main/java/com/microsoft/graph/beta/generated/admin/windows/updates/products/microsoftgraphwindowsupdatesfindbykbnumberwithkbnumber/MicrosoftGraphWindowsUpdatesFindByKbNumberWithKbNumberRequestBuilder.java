...
public class MicrosoftGraphWindowsUpdatesFindByKbNumberWithKbNumberRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public MicrosoftGraphWindowsUpdatesFindByKbNumberWithKbNumberRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final Integer kbNumber) {
     ...
     */
    @jakarta.annotation.Nullable
    public FindByKbNumberWithKbNumberGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
