package com.microsoft.graph.beta.print.printers.item.jobs.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrintJob;
import com.microsoft.graph.beta.print.printers.item.jobs.item.abort.AbortRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.cancelprintjob.CancelPrintJobRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.documents.DocumentsRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.redirect.RedirectRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.startprintjob.StartPrintJobRequestBuilder;
import com.microsoft.graph.beta.print.printers.item.jobs.item.tasks.TasksRequestBuilder;
...
public class PrintJobItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printjob-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link PrintJob}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/printjob-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
