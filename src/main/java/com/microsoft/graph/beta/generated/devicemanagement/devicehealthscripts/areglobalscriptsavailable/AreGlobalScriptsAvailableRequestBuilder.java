package com.microsoft.graph.beta.devicemanagement.devicehealthscripts.areglobalscriptsavailable;

import com.microsoft.graph.beta.models.GlobalDeviceHealthScriptState;
...
public class AreGlobalScriptsAvailableRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AreGlobalScriptsAvailableRequestBuilder} and sets the default values.
     ...
     * @return a {@link GlobalDeviceHealthScriptState}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public GlobalDeviceHealthScriptState get() {
        return get(null);
    }
    /**
     * Invoke function areGlobalScriptsAvailable
     ...
     */
    @jakarta.annotation.Nullable
    public GlobalDeviceHealthScriptState get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendEnum(requestInfo, errorMapping, GlobalDeviceHealthScriptState::forValue);
    }
    /**
     * Invoke function areGlobalScriptsAvailable
