package com.microsoft.graph.beta.solutions.bookingcurrencies;

import com.microsoft.graph.beta.models.BookingCurrency;
import com.microsoft.graph.beta.models.BookingCurrencyCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.bookingcurrencies.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.bookingcurrencies.item.BookingCurrencyItemRequestBuilder;
...
public class BookingCurrenciesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link BookingCurrencyItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link BookingCurrenciesRequestBuilder} and sets the default values.
     ...
     * @return a {@link BookingCurrencyCollectionResponse}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/bookingcurrency-list?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/bookingCurrencies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final BookingCurrency body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/bookingCurrencies", pathParameters);
