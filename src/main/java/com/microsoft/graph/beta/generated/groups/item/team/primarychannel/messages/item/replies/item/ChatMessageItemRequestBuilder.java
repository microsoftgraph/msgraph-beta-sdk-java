package com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item;

import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.primarychannel.messages.item.replies.item.unsetreaction.UnsetReactionRequestBuilder;
...
public class ChatMessageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ChatMessageItemRequestBuilder} and sets the default values.
    ...
    public ChatMessageItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ChatMessage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}", pathParameters);
