package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.imsinh;
...
public class ImSinhPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImSinhPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImSinhPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImSinhPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
