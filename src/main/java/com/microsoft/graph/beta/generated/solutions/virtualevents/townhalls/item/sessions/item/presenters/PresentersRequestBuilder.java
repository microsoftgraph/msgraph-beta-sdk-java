package com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.presenters;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventPresenterCollectionResponse;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.presenters.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.presenters.item.VirtualEventPresenterItemRequestBuilder;
...
public class PresentersRequestBuilder extends BaseRequestBuilder {
    ...
    public PresentersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PresentersRequestBuilder and sets the default values.
    ...
    public PresentersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
