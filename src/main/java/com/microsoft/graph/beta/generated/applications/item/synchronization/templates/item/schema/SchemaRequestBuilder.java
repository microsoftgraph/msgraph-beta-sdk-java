package com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema;

import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.directories.DirectoriesRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.functions.FunctionsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.parseexpression.ParseExpressionRequestBuilder;
