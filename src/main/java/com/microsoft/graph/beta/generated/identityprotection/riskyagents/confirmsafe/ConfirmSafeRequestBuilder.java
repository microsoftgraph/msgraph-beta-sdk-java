package com.microsoft.graph.beta.identityprotection.riskyagents.confirmsafe;
...
public class ConfirmSafeRequestBuilder extends BaseRequestBuilder {
    ...
    public ConfirmSafeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityProtection/riskyAgents/confirmSafe", pathParameters);
    }
    /**
     * Instantiates a new {@link ConfirmSafeRequestBuilder} and sets the default values.
    ...
    public ConfirmSafeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityProtection/riskyAgents/confirmSafe", rawUrl);
    }
    /**
     * Confirm one or more riskyAgent objects as safe. This action sets the targeted agent&apos;s riskLevel to none.
     * @param body The request body
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/riskyagent-confirmsafe?view=graph-rest-beta">Find more info here</a>
     */
