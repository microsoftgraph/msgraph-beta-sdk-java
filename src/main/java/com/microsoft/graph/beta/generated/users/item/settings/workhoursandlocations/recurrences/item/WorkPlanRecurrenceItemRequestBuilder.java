package com.microsoft.graph.beta.users.item.settings.workhoursandlocations.recurrences.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WorkPlanRecurrence;
...
public class WorkPlanRecurrenceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkPlanRecurrenceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/workHoursAndLocations/recurrences/{workPlanRecurrence%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkPlanRecurrenceItemRequestBuilder} and sets the default values.
    ...
    public WorkPlanRecurrenceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/workHoursAndLocations/recurrences/{workPlanRecurrence%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/settings/workHoursAndLocations/recurrences/{workPlanRecurrence%2Did}{?%24expand,%24select}", pathParameters);
