package com.microsoft.graph.beta.users.item.authentication.methods;

import com.microsoft.graph.beta.models.AuthenticationMethod;
import com.microsoft.graph.beta.models.AuthenticationMethodCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.authentication.methods.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.authentication.methods.item.AuthenticationMethodItemRequestBuilder;
...
public class MethodsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link MethodsRequestBuilder} and sets the default values.
    ...
    public MethodsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link MethodsRequestBuilder} and sets the default values.
    ...
    public MethodsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AuthenticationMethod body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/authentication/methods", pathParameters);
