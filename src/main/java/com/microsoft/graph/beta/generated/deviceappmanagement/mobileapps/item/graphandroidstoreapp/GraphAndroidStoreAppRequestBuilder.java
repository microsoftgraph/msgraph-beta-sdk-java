package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphandroidstoreapp;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphandroidstoreapp.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphandroidstoreapp.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphandroidstoreapp.relationships.RelationshipsRequestBuilder;
import com.microsoft.graph.beta.models.AndroidStoreApp;
...
public class GraphAndroidStoreAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphAndroidStoreAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphAndroidStoreAppRequestBuilder and sets the default values.
    ...
    public GraphAndroidStoreAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp{?%24select,%24expand}", rawUrl);
    }
    /**
