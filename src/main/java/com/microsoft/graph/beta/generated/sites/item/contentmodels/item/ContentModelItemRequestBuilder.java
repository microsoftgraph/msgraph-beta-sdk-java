package com.microsoft.graph.beta.sites.item.contentmodels.item;

import com.microsoft.graph.beta.models.ContentModel;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.contentmodels.item.addtodrive.AddToDriveRequestBuilder;
import com.microsoft.graph.beta.sites.item.contentmodels.item.getapplieddrives.GetAppliedDrivesRequestBuilder;
import com.microsoft.graph.beta.sites.item.contentmodels.item.removefromdrive.RemoveFromDriveRequestBuilder;
...
public class ContentModelItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/contentmodel-get?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/sites/{site%2Did}/contentModels/{contentModel%2Did}{?%24expand,%24select}", pathParameters);
