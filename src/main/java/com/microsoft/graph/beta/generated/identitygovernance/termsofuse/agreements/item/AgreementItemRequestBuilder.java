package com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item;

import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.acceptances.AcceptancesRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.file.FileRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.files.FilesRequestBuilder;
...
public class AgreementItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agreement-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/agreement-list-files?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Agreement}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/agreement-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
