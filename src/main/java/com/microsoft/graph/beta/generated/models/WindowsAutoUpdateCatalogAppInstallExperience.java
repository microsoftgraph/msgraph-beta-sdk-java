...
public class WindowsAutoUpdateCatalogAppInstallExperience implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WindowsAutoUpdateCatalogAppInstallExperience} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WindowsAutoUpdateCatalogAppInstallExperience createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WindowsAutoUpdateCatalogAppInstallExperience();
    }
    /**
     ...
     * @return a {@link WindowsAutoUpdateCatalogAppRestartBehavior}
     */
    @jakarta.annotation.Nullable
    public WindowsAutoUpdateCatalogAppRestartBehavior getDeviceRestartBehavior() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceRestartBehavior", (n) -> { this.setDeviceRestartBehavior(n.getEnumValue(WindowsAutoUpdateCatalogAppRestartBehavior::forValue)); });
     ...
     */
    public void setDeviceRestartBehavior(@jakarta.annotation.Nullable final WindowsAutoUpdateCatalogAppRestartBehavior value) {
