package com.microsoft.graph.beta.devicemanagement.deviceconfigurationsallmanageddevicecertificatestates;

import com.microsoft.graph.beta.devicemanagement.deviceconfigurationsallmanageddevicecertificatestates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceconfigurationsallmanageddevicecertificatestates.item.ManagedAllDeviceCertificateStateItemRequestBuilder;
import com.microsoft.graph.beta.models.ManagedAllDeviceCertificateState;
import com.microsoft.graph.beta.models.ManagedAllDeviceCertificateStateCollectionResponse;
...
public class DeviceConfigurationsAllManagedDeviceCertificateStatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link DeviceConfigurationsAllManagedDeviceCertificateStatesRequestBuilder} and sets the default values.
    ...
    public DeviceConfigurationsAllManagedDeviceCertificateStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurationsAllManagedDeviceCertificateStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceConfigurationsAllManagedDeviceCertificateStatesRequestBuilder} and sets the default values.
    ...
    public DeviceConfigurationsAllManagedDeviceCertificateStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurationsAllManagedDeviceCertificateStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ManagedAllDeviceCertificateState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/deviceConfigurationsAllManagedDeviceCertificateStates", pathParameters);
