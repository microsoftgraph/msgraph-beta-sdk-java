package com.microsoft.graph.beta.networkaccess.threatintelligencepolicies.item.policyrules;
...
import com.microsoft.graph.beta.networkaccess.threatintelligencepolicies.item.policyrules.count.CountRequestBuilder;
import com.microsoft.graph.beta.networkaccess.threatintelligencepolicies.item.policyrules.item.PolicyRuleItemRequestBuilder;
...
public class PolicyRulesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/threatIntelligencePolicies/{threatIntelligencePolicy%2Did}/policyRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PolicyRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/networkAccess/threatIntelligencePolicies/{threatIntelligencePolicy%2Did}/policyRules", pathParameters);
