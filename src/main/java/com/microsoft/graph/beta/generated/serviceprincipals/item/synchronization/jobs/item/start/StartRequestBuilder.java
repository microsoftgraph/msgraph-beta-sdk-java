package com.microsoft.graph.beta.serviceprincipals.item.synchronization.jobs.item.start;
...
public class StartRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-start?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
