package com.microsoft.graph.beta.groups.item.planner.plans;

import com.microsoft.graph.beta.groups.item.planner.plans.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.planner.plans.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.planner.plans.item.PlannerPlanItemRequestBuilder;
...
public class PlansRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/plannergroup-list-plans?view=graph-rest-beta">Find more info here</a>
     */
