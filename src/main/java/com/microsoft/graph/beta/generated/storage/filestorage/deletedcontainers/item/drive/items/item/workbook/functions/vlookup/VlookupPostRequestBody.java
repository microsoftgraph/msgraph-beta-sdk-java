package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.vlookup;
...
public class VlookupPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link VlookupPostRequestBody} and sets the default values.
     */
    ...
    public UntypedNode getColIndexNum() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("colIndexNum", (n) -> { this.setColIndexNum(n.getObjectValue(UntypedNode::createFromDiscriminatorValue)); });
     ...
     */
    public void setColIndexNum(@jakarta.annotation.Nullable final UntypedNode value) {
