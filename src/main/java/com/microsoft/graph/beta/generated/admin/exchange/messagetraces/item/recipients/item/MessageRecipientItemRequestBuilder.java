package com.microsoft.graph.beta.admin.exchange.messagetraces.item.recipients.item;

import com.microsoft.graph.beta.admin.exchange.messagetraces.item.recipients.item.events.EventsRequestBuilder;
...
public class MessageRecipientItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link MessageRecipientItemRequestBuilder} and sets the default values.
    ...
    public MessageRecipientItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/exchange/messageTraces/{messageTrace%2Did}/recipients/{messageRecipient%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link MessageRecipientItemRequestBuilder} and sets the default values.
    ...
    public MessageRecipientItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/exchange/messageTraces/{messageTrace%2Did}/recipients/{messageRecipient%2Did}", rawUrl);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public MessageRecipient get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public MessageRecipient patch(@jakarta.annotation.Nonnull final MessageRecipient body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public MessageRecipient patch(@jakarta.annotation.Nonnull final MessageRecipient body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/exchange/messageTraces/{messageTrace%2Did}/recipients/{messageRecipient%2Did}{?%24expand,%24select}", pathParameters);
