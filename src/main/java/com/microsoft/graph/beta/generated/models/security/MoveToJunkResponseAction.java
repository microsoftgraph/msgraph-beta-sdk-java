...
public class MoveToJunkResponseAction extends ResponseAction implements Parsable {
    /**
     * Instantiates a new {@link MoveToJunkResponseAction} and sets the default values.
     */
    public MoveToJunkResponseAction() {
        super();
        this.setOdataType("#microsoft.graph.security.moveToJunkResponseAction");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link MoveToJunkResponseAction}
     */
