package com.microsoft.graph.beta.privilegedaccess.item.roleassignmentrequests;

import com.microsoft.graph.beta.models.GovernanceRoleAssignmentRequest;
import com.microsoft.graph.beta.models.GovernanceRoleAssignmentRequestCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.privilegedaccess.item.roleassignmentrequests.count.CountRequestBuilder;
import com.microsoft.graph.beta.privilegedaccess.item.roleassignmentrequests.item.GovernanceRoleAssignmentRequestItemRequestBuilder;
...
public class RoleAssignmentRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link RoleAssignmentRequestsRequestBuilder} and sets the default values.
    ...
    public RoleAssignmentRequestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleAssignmentRequestsRequestBuilder} and sets the default values.
    ...
    public RoleAssignmentRequestsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * A collection of role assignment requests for the provider.
     * @return a {@link GovernanceRoleAssignmentRequestCollectionResponse}
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GovernanceRoleAssignmentRequest body) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GovernanceRoleAssignmentRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests", pathParameters);
