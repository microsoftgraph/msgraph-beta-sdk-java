package com.microsoft.graph.beta.users.item.settings.regionalandlanguagesettings;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.RegionalAndLanguageSettings;
...
public class RegionalAndLanguageSettingsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RegionalAndLanguageSettingsRequestBuilder} and sets the default values.
    ...
    public RegionalAndLanguageSettingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/regionalAndLanguageSettings", pathParameters);
    }
    /**
     * Instantiates a new {@link RegionalAndLanguageSettingsRequestBuilder} and sets the default values.
    ...
    public RegionalAndLanguageSettingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/settings/regionalAndLanguageSettings", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/settings/regionalAndLanguageSettings{?%24expand,%24select}", pathParameters);
