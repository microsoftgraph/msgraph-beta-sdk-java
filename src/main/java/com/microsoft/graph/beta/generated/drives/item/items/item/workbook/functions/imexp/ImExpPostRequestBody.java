package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.imexp;
...
public class ImExpPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImExpPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImExpPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImExpPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
