...
public class ConnectionSummary implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ConnectionSummary} and sets the default values.
     */
     ...
     * @return a {@link ConnectionSummary}
     */
    @jakarta.annotation.Nonnull
    public static ConnectionSummary createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
