...
public class AppRoleAssignment extends DirectoryObject implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("creationTimestamp", (n) -> { this.setCreationTimestamp(n.getOffsetDateTimeValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeOffsetDateTimeValue("creationTimestamp", this.getCreationTimestamp());
