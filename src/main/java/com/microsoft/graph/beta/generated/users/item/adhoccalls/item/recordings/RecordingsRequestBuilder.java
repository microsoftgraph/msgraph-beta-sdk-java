package com.microsoft.graph.beta.users.item.adhoccalls.item.recordings;

import com.microsoft.graph.beta.models.CallRecording;
import com.microsoft.graph.beta.models.CallRecordingCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.adhoccalls.item.recordings.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.adhoccalls.item.recordings.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.adhoccalls.item.recordings.item.CallRecordingItemRequestBuilder;
...
public class RecordingsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/adhocCalls/{adhocCall%2Did}/recordings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CallRecording body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/adhocCalls/{adhocCall%2Did}/recordings", pathParameters);
