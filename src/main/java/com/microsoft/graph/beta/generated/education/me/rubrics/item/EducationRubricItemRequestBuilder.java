package com.microsoft.graph.beta.education.me.rubrics.item;

import com.microsoft.graph.beta.models.EducationRubric;
...
public class EducationRubricItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EducationRubricItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/rubrics/{educationRubric%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EducationRubricItemRequestBuilder} and sets the default values.
    ...
    public EducationRubricItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/rubrics/{educationRubric%2Did}", rawUrl);
    }
    /**
     * Delete an educationRubric object. Only teachers can perform this operation.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationrubric-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationrubric-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationRubric}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationrubric-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/me/rubrics/{educationRubric%2Did}{?%24expand,%24select}", pathParameters);
