package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.pages;

import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.pages.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
