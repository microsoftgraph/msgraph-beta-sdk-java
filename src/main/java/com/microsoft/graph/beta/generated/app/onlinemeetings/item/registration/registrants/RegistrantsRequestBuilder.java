package com.microsoft.graph.beta.app.onlinemeetings.item.registration.registrants;

import com.microsoft.graph.beta.app.onlinemeetings.item.registration.registrants.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.registration.registrants.item.MeetingRegistrantBaseItemRequestBuilder;
...
public class RegistrantsRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrantsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RegistrantsRequestBuilder} and sets the default values.
    ...
    public RegistrantsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MeetingRegistrantBase body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration/registrants", pathParameters);
