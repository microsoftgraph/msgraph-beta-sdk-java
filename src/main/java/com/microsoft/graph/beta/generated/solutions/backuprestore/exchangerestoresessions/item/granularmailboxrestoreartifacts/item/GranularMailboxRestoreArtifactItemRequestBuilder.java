package com.microsoft.graph.beta.solutions.backuprestore.exchangerestoresessions.item.granularmailboxrestoreartifacts.item;

import com.microsoft.graph.beta.models.GranularMailboxRestoreArtifact;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.backuprestore.exchangerestoresessions.item.granularmailboxrestoreartifacts.item.restorepoint.RestorePointRequestBuilder;
...
public class GranularMailboxRestoreArtifactItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GranularMailboxRestoreArtifactItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/granularMailboxRestoreArtifacts/{granularMailboxRestoreArtifact%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link GranularMailboxRestoreArtifactItemRequestBuilder} and sets the default values.
    ...
    public GranularMailboxRestoreArtifactItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/granularMailboxRestoreArtifacts/{granularMailboxRestoreArtifact%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/granularMailboxRestoreArtifacts/{granularMailboxRestoreArtifact%2Did}{?%24expand,%24select}", pathParameters);
