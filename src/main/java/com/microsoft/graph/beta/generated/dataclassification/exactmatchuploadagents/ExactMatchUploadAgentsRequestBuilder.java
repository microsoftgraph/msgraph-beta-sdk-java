package com.microsoft.graph.beta.dataclassification.exactmatchuploadagents;

import com.microsoft.graph.beta.dataclassification.exactmatchuploadagents.count.CountRequestBuilder;
import com.microsoft.graph.beta.dataclassification.exactmatchuploadagents.item.ExactMatchUploadAgentItemRequestBuilder;
import com.microsoft.graph.beta.models.ExactMatchUploadAgent;
import com.microsoft.graph.beta.models.ExactMatchUploadAgentCollectionResponse;
...
public class ExactMatchUploadAgentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ExactMatchUploadAgentItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link ExactMatchUploadAgentsRequestBuilder} and sets the default values.
    ...
    public ExactMatchUploadAgentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/exactMatchUploadAgents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExactMatchUploadAgentsRequestBuilder} and sets the default values.
    ...
    public ExactMatchUploadAgentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/exactMatchUploadAgents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * Get exactMatchUploadAgents from dataClassification
     * @return a {@link ExactMatchUploadAgentCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ExactMatchUploadAgent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/dataClassification/exactMatchUploadAgents", pathParameters);
