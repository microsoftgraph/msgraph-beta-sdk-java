package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.valueaxis.format;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.valueaxis.format.font.FontRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.valueaxis.format.line.LineRequestBuilder;
