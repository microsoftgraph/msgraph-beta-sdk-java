package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.list.contenttypes.addcopy;
...
public class AddCopyRequestBuilder extends BaseRequestBuilder {
    ...
    public AddCopyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopy", pathParameters);
    }
    /**
     * Instantiates a new {@link AddCopyRequestBuilder} and sets the default values.
    ...
    public AddCopyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopy", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/contenttype-addcopy?view=graph-rest-beta">Find more info here</a>
     */
