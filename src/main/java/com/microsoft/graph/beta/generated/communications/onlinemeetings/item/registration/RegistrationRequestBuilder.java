package com.microsoft.graph.beta.communications.onlinemeetings.item.registration;

import com.microsoft.graph.beta.communications.onlinemeetings.item.registration.customquestions.CustomQuestionsRequestBuilder;
import com.microsoft.graph.beta.communications.onlinemeetings.item.registration.registrants.RegistrantsRequestBuilder;
...
public class RegistrationRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link RegistrationRequestBuilder} and sets the default values.
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final MeetingRegistration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration", pathParameters);
