package com.microsoft.graph.beta.identity.continuousaccessevaluationpolicy;

import com.microsoft.graph.beta.models.ContinuousAccessEvaluationPolicy;
...
public class ContinuousAccessEvaluationPolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ContinuousAccessEvaluationPolicyRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ContinuousAccessEvaluationPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/continuousAccessEvaluationPolicy", pathParameters);
    }
    /**
     * Instantiates a new {@link ContinuousAccessEvaluationPolicyRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ContinuousAccessEvaluationPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/continuousAccessEvaluationPolicy", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/continuousaccessevaluationpolicy-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link ContinuousAccessEvaluationPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/continuousaccessevaluationpolicy-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/continuousAccessEvaluationPolicy{?%24expand,%24select}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ContinuousAccessEvaluationPolicyRequestBuilder}
     */
    @jakarta.annotation.Nonnull
