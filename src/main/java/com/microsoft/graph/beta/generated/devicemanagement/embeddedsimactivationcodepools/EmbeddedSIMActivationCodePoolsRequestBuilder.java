package com.microsoft.graph.beta.devicemanagement.embeddedsimactivationcodepools;

import com.microsoft.graph.beta.devicemanagement.embeddedsimactivationcodepools.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.embeddedsimactivationcodepools.item.EmbeddedSIMActivationCodePoolItemRequestBuilder;
import com.microsoft.graph.beta.models.EmbeddedSIMActivationCodePool;
import com.microsoft.graph.beta.models.EmbeddedSIMActivationCodePoolCollectionResponse;
...
public class EmbeddedSIMActivationCodePoolsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link EmbeddedSIMActivationCodePoolsRequestBuilder} and sets the default values.
    ...
    public EmbeddedSIMActivationCodePoolsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link EmbeddedSIMActivationCodePoolsRequestBuilder} and sets the default values.
    ...
    public EmbeddedSIMActivationCodePoolsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * The embedded SIM activation code pools created by this account.
     * @return a {@link EmbeddedSIMActivationCodePoolCollectionResponse}
    ...
    public EmbeddedSIMActivationCodePoolCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, EmbeddedSIMActivationCodePoolCollectionResponse::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools", pathParameters);
