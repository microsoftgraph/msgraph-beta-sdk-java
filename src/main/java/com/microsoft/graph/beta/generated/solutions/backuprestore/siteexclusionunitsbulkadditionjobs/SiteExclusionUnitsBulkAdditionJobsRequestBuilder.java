package com.microsoft.graph.beta.solutions.backuprestore.siteexclusionunitsbulkadditionjobs;
...
import com.microsoft.graph.beta.solutions.backuprestore.siteexclusionunitsbulkadditionjobs.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.backuprestore.siteexclusionunitsbulkadditionjobs.item.SiteExclusionUnitsBulkAdditionJobItemRequestBuilder;
...
public class SiteExclusionUnitsBulkAdditionJobsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteExclusionUnitsBulkAdditionJob post(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteExclusionUnitsBulkAdditionJob post(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/siteExclusionUnitsBulkAdditionJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/siteExclusionUnitsBulkAdditionJobs", pathParameters);
