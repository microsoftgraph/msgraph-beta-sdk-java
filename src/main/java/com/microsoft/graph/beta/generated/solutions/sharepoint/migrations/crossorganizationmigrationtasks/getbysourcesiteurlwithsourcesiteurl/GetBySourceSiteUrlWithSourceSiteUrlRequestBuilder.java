package com.microsoft.graph.beta.solutions.sharepoint.migrations.crossorganizationmigrationtasks.getbysourcesiteurlwithsourcesiteurl;
...
public class GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @param sourceSiteUrl Usage: sourceSiteUrl=&apos;{sourceSiteUrl}&apos;
     */
    public GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String sourceSiteUrl) {
        super(requestAdapter, "{+baseurl}/solutions/sharePoint/migrations/crossOrganizationMigrationTasks/getBySourceSiteUrl(sourceSiteUrl='{sourceSiteUrl}')", pathParameters);
        this.pathParameters.put("sourceSiteUrl", sourceSiteUrl);
    }
    /**
     * Instantiates a new {@link GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder(rawUrl, requestAdapter);
    }
    /**
