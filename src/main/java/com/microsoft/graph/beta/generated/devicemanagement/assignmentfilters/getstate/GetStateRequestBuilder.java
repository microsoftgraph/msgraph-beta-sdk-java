package com.microsoft.graph.beta.devicemanagement.assignmentfilters.getstate;

import com.microsoft.graph.beta.models.AssignmentFilterState;
...
public class GetStateRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link AssignmentFilterState}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    public AssignmentFilterState get() {
        return get(null);
    }
    /**
     * Invoke function getState
     ...
     */
    @jakarta.annotation.Nullable
    public AssignmentFilterState get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, AssignmentFilterState::createFromDiscriminatorValue);
    }
    /**
     * Invoke function getState
