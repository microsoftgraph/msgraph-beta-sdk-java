package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item;

import com.microsoft.graph.beta.models.DriveItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.assignsensitivitylabel.AssignSensitivityLabelRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.checkin.CheckinRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.checkout.CheckoutRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.contentstream.ContentStreamRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.copy.CopyRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.createlink.CreateLinkRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.deltawithtoken.DeltaWithTokenRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.follow.FollowRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.invite.InviteRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.lastmodifiedbyuser.LastModifiedByUserRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.listitem.ListItemRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.preview.PreviewRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.retentionlabel.RetentionLabelRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.subscriptions.SubscriptionsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.thumbnails.ThumbnailsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.unfollow.UnfollowRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.validatepermission.ValidatePermissionRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.versions.VersionsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.WorkbookRequestBuilder;
...
public class DriveItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemItemRequestBuilder} and sets the default values.
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
