package com.microsoft.graph.beta.shares.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SharedDriveItem;
import com.microsoft.graph.beta.shares.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.shares.item.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.beta.shares.item.items.ItemsRequestBuilder;
import com.microsoft.graph.beta.shares.item.lastmodifiedbyuser.LastModifiedByUserRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.ListRequestBuilder;
import com.microsoft.graph.beta.shares.item.listitem.ListItemRequestBuilder;
import com.microsoft.graph.beta.shares.item.permission.PermissionRequestBuilder;
import com.microsoft.graph.beta.shares.item.root.RootRequestBuilder;
import com.microsoft.graph.beta.shares.item.site.SiteRequestBuilder;
...
public class SharedDriveItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SharedDriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SharedDriveItemItemRequestBuilder} and sets the default values.
    ...
    public SharedDriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/shares-get?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/shares/{sharedDriveItem%2Did}{?%24expand,%24select}", pathParameters);
