package com.microsoft.graph.beta.groups.item.team.schedule;

import com.microsoft.graph.beta.groups.item.team.schedule.daynotes.DayNotesRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.openshifts.OpenShiftsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.share.ShareRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.shifts.ShiftsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.shiftsroledefinitions.ShiftsRoleDefinitionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.timecards.TimeCardsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.schedule.timesoff.TimesOffRequestBuilder;
