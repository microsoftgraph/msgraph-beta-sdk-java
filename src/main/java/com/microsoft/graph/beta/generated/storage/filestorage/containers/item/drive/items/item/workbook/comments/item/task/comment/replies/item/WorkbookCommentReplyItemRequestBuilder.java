package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.workbook.comments.item.task.comment.replies.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WorkbookCommentReply;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.workbook.comments.item.task.comment.replies.item.task.TaskRequestBuilder;
...
public class WorkbookCommentReplyItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WorkbookCommentReplyItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task/comment/replies/{workbookCommentReply%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorkbookCommentReplyItemRequestBuilder} and sets the default values.
    ...
    public WorkbookCommentReplyItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task/comment/replies/{workbookCommentReply%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
