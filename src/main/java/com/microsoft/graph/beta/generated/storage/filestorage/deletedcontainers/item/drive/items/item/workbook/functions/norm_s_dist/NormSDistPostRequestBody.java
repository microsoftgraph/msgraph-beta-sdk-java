package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.norm_s_dist;
...
public class NormSDistPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("z", (n) -> { this.setZ(n.getObjectValue(UntypedNode::createFromDiscriminatorValue)); });
     ...
     */
    public void setZ(@jakarta.annotation.Nullable final UntypedNode value) {
