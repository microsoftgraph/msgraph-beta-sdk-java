...
public class SubCategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public SubCategoriesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subCategories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SubCategoriesRequestBuilder and sets the default values.
    ...
    public SubCategoriesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subCategories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of subcategories subCategoryTemplate associated with a category template.
     * @return a SubCategoryTemplateCollectionResponse
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a SubCategoriesRequestBuilder
     */
    @jakarta.annotation.Nonnull
