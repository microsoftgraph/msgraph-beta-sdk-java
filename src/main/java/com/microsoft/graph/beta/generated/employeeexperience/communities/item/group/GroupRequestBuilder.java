package com.microsoft.graph.beta.employeeexperience.communities.item.group;

import com.microsoft.graph.beta.employeeexperience.communities.item.group.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class GroupRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/group{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GroupRequestBuilder and sets the default values.
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/group{?%24select,%24expand}", rawUrl);
    }
    /**
