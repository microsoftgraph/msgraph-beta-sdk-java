package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp.contentversions.item.files.item.renewupload;
...
public class RenewUploadRequestBuilder extends BaseRequestBuilder {
    ...
    public RenewUploadRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/renewUpload", pathParameters);
    }
    /**
     * Instantiates a new RenewUploadRequestBuilder and sets the default values.
    ...
    public RenewUploadRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/renewUpload", rawUrl);
    }
    /**
