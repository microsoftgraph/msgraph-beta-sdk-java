...
public class AuthenticationStrength implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AuthenticationStrength} and sets the default values.
     */
     ...
     * @return a {@link AuthenticationStrength}
     */
    @jakarta.annotation.Nonnull
    ...
    public String getAuthenticationStrengthId() {
        return this.backingStore.get("authenticationStrengthId");
    }
    /**
     ...
     * @return a {@link AuthenticationStrengthResult}
     */
    @jakarta.annotation.Nullable
    ...
    public void setAuthenticationStrengthId(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("authenticationStrengthId", value);
    }
    /**
