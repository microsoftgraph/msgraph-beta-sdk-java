package com.microsoft.graph.beta.reports.dailyprintusagesummariesbyprinter;
...
import com.microsoft.graph.beta.reports.dailyprintusagesummariesbyprinter.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.dailyprintusagesummariesbyprinter.item.PrintUsageByPrinterItemRequestBuilder;
...
public class DailyPrintUsageSummariesByPrinterRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link DailyPrintUsageSummariesByPrinterRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DailyPrintUsageSummariesByPrinterRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/dailyPrintUsageSummariesByPrinter{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DailyPrintUsageSummariesByPrinterRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DailyPrintUsageSummariesByPrinterRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/dailyPrintUsageSummariesByPrinter{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrintUsageByPrinter body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/dailyPrintUsageSummariesByPrinter", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public DailyPrintUsageSummariesByPrinterRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
