package com.microsoft.graph.beta.drives.item.activities.item.driveitem;

import com.microsoft.graph.beta.drives.item.activities.item.driveitem.content.ContentRequestBuilder;
import com.microsoft.graph.beta.drives.item.activities.item.driveitem.contentstream.ContentStreamRequestBuilder;
...
public class DriveItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemRequestBuilder} and sets the default values.
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24expand,%24select}", rawUrl);
    }
    /**
