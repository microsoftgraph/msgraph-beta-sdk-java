package com.microsoft.graph.beta.serviceprincipals.item.remotedesktopsecurityconfiguration.targetdevicegroups;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TargetDeviceGroup;
import com.microsoft.graph.beta.models.TargetDeviceGroupCollectionResponse;
import com.microsoft.graph.beta.serviceprincipals.item.remotedesktopsecurityconfiguration.targetdevicegroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.remotedesktopsecurityconfiguration.targetdevicegroups.item.TargetDeviceGroupItemRequestBuilder;
...
public class TargetDeviceGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/targetDeviceGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TargetDeviceGroup body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/targetDeviceGroups", pathParameters);
