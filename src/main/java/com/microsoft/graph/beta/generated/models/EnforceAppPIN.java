...
public class EnforceAppPIN implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EnforceAppPIN} and sets the default values.
     */
     ...
     * @return a {@link EnforceAppPIN}
     */
    @jakarta.annotation.Nonnull
    public static EnforceAppPIN createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
