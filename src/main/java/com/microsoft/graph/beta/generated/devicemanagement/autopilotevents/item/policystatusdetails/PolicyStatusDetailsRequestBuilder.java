package com.microsoft.graph.beta.devicemanagement.autopilotevents.item.policystatusdetails;

import com.microsoft.graph.beta.devicemanagement.autopilotevents.item.policystatusdetails.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.autopilotevents.item.policystatusdetails.item.DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceManagementAutopilotPolicyStatusDetail;
import com.microsoft.graph.beta.models.DeviceManagementAutopilotPolicyStatusDetailCollectionResponse;
...
public class PolicyStatusDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder byDeviceManagementAutopilotPolicyStatusDetailId(@jakarta.annotation.Nonnull final String deviceManagementAutopilotPolicyStatusDetailId) {
        Objects.requireNonNull(deviceManagementAutopilotPolicyStatusDetailId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("deviceManagementAutopilotPolicyStatusDetail%2Did", deviceManagementAutopilotPolicyStatusDetailId);
     ...
     */
    public PolicyStatusDetailsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/autopilotEvents/{deviceManagementAutopilotEvent%2Did}/policyStatusDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PolicyStatusDetailsRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PolicyStatusDetailsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/autopilotEvents/{deviceManagementAutopilotEvent%2Did}/policyStatusDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
