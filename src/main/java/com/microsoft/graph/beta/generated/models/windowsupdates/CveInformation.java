...
public class CveInformation implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CveInformation} and sets the default values.
     */
     ...
     * @return a {@link CveInformation}
     */
    @jakarta.annotation.Nonnull
    public static CveInformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
