package com.microsoft.graph.beta.devicemanagement.reports.getgrouppolicysettingsdevicesettingsreport;
...
public class GetGroupPolicySettingsDeviceSettingsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetGroupPolicySettingsDeviceSettingsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetGroupPolicySettingsDeviceSettingsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetGroupPolicySettingsDeviceSettingsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
