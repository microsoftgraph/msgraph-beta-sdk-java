package com.microsoft.graph.beta.contracts.item;

import com.microsoft.graph.beta.contracts.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.contracts.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.contracts.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.contracts.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.contracts.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.beta.models.Contract;
...
public class ContractItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/contract-get?view=graph-rest-beta">Find more info here</a>
     */
