package com.microsoft.graph.beta.users.item.photos.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ProfilePhoto;
import com.microsoft.graph.beta.users.item.photos.item.value.ContentRequestBuilder;
...
public class ProfilePhotoItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ProfilePhotoItemRequestBuilder} and sets the default values.
    ...
    public ProfilePhotoItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/photos/{profilePhoto%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ProfilePhotoItemRequestBuilder} and sets the default values.
