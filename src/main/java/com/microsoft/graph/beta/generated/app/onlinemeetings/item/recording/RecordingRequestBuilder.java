package com.microsoft.graph.beta.app.onlinemeetings.item.recording;
...
public class RecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public RecordingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recording", pathParameters);
    }
    /**
     * Instantiates a new {@link RecordingRequestBuilder} and sets the default values.
    ...
    public RecordingRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/recording", rawUrl);
    }
    /**
