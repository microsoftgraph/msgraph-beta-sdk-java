...
public class MobileAppManagementPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public MobileAppManagementPoliciesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/mobileAppManagementPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MobileAppManagementPoliciesRequestBuilder and sets the default values.
    ...
    public MobileAppManagementPoliciesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/mobileAppManagementPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of the mobilityManagementPolicy objects and their properties.
     * @return a MobilityManagementPolicyCollectionResponse
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MobileAppManagementPoliciesRequestBuilder
     */
    @jakarta.annotation.Nonnull
