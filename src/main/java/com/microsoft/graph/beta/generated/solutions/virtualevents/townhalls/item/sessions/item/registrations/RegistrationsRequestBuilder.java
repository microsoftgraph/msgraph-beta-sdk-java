package com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.registrations;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventRegistrationCollectionResponse;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.registrations.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.townhalls.item.sessions.item.registrations.item.VirtualEventRegistrationItemRequestBuilder;
...
public class RegistrationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/registrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new RegistrationsRequestBuilder and sets the default values.
    ...
    public RegistrationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/registrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
