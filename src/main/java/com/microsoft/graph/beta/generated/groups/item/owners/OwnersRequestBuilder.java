package com.microsoft.graph.beta.groups.item.owners;

import com.microsoft.graph.beta.groups.item.owners.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.groups.item.owners.ref.RefRequestBuilder;
...
public class OwnersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.groups.item.owners.item collection
    ...
    public OwnersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link OwnersRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-owners?view=graph-rest-beta">Find more info here</a>
     */
