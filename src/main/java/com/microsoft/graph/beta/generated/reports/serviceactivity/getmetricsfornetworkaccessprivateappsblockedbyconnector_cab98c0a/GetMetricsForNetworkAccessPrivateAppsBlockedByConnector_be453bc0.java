package com.microsoft.graph.beta.reports.serviceactivity.getmetricsfornetworkaccessprivateappsblockedbyconnector_cab98c0a;
...
public class GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a {@link GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/serviceactivity-getmetricsfornetworkaccessprivateappsblockedbyconnector?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f get() {
        return get(null);
    }
    /**
     * Retrieve the number of private applications that were blocked due to connector unavailability using Global Secure Access client. Microsoft Entra Private Access traffic could not reach the private application because the connector was either down or unreachable due to network connectivity issues.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f::createFromDiscriminatorValue);
    }
    /**
     * Retrieve the number of private applications that were blocked due to connector unavailability using Global Secure Access client. Microsoft Entra Private Access traffic could not reach the private application because the connector was either down or unreachable due to network connectivity issues.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0(rawUrl, requestAdapter);
    }
    /**
     * Retrieve the number of private applications that were blocked due to connector unavailability using Global Secure Access client. Microsoft Entra Private Access traffic could not reach the private application because the connector was either down or unreachable due to network connectivity issues.
     */
