package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.imsqrt;
...
public class ImSqrtPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImSqrtPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImSqrtPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ImSqrtPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
