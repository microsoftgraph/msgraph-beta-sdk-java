package com.microsoft.graph.beta.users.item.directreports;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.directreports.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.directreports.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.users.item.directreports.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.users.item.directreports.item.DirectoryObjectItemRequestBuilder;
...
public class DirectReportsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-list-directreports?view=graph-rest-beta">Find more info here</a>
     */
