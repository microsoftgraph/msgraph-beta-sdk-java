package com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.hostedcontents.item;

import com.microsoft.graph.beta.models.ChatMessageHostedContent;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.chats.item.targetedmessages.item.replies.item.hostedcontents.item.value.ContentRequestBuilder;
