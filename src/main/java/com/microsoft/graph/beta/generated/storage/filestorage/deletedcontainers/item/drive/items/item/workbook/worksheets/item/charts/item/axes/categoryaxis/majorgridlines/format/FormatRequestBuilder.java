package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.worksheets.item.charts.item.axes.categoryaxis.majorgridlines.format;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WorkbookChartGridlinesFormat;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.worksheets.item.charts.item.axes.categoryaxis.majorgridlines.format.line.LineRequestBuilder;
...
public class FormatRequestBuilder extends BaseRequestBuilder {
    ...
    public FormatRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/majorGridlines/format{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link FormatRequestBuilder} and sets the default values.
    ...
    public FormatRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/majorGridlines/format{?%24expand,%24select}", rawUrl);
    }
    /**
