package com.microsoft.graph.beta.teams.item.schedule.schedulinggroups;
...
import com.microsoft.graph.beta.teams.item.schedule.schedulinggroups.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.schedulinggroups.item.SchedulingGroupItemRequestBuilder;
...
public class SchedulingGroupsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/schedule-list-schedulinggroups?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/schedule-post-schedulinggroups?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
