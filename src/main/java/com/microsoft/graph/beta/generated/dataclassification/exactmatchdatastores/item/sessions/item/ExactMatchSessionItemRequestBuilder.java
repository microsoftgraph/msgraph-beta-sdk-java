package com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item;

import com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item.commit.CommitRequestBuilder;
import com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item.renew.RenewRequestBuilder;
import com.microsoft.graph.beta.dataclassification.exactmatchdatastores.item.sessions.item.uploadagent.UploadAgentRequestBuilder;
...
public class ExactMatchSessionItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ExactMatchSessionItemRequestBuilder} and sets the default values.
    ...
    public ExactMatchSessionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExactMatchSessionItemRequestBuilder} and sets the default values.
    ...
    public ExactMatchSessionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ExactMatchSession body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ExactMatchSessionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
