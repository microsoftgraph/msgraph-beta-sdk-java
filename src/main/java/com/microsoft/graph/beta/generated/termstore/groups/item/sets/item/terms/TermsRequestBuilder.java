package com.microsoft.graph.beta.termstore.groups.item.sets.item.terms;
...
import com.microsoft.graph.beta.termstore.groups.item.sets.item.terms.count.CountRequestBuilder;
import com.microsoft.graph.beta.termstore.groups.item.sets.item.terms.item.TermItemRequestBuilder;
...
public class TermsRequestBuilder extends BaseRequestBuilder {
    ...
    public TermsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TermsRequestBuilder} and sets the default values.
    ...
    public TermsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Term body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms", pathParameters);
