package com.microsoft.graph.beta.financials.companies.item.salesinvoicelines.item;

import com.microsoft.graph.beta.financials.companies.item.salesinvoicelines.item.account.AccountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salesinvoicelines.item.item.ItemRequestBuilder;
...
public class SalesInvoiceLineItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SalesInvoiceLineItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link SalesInvoiceLineItemRequestBuilder} and sets the default values.
    ...
    public SalesInvoiceLineItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SalesInvoiceLine body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}", pathParameters);
