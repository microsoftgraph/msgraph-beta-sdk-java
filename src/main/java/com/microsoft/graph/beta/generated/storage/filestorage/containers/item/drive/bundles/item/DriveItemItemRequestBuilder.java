package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.bundles.item;

import com.microsoft.graph.beta.models.DriveItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.bundles.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.bundles.item.contentstream.ContentStreamRequestBuilder;
...
public class DriveItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/bundles/{driveItem%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemItemRequestBuilder} and sets the default values.
    ...
    public DriveItemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/bundles/{driveItem%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
