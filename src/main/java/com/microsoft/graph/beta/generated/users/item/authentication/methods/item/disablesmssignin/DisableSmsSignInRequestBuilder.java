package com.microsoft.graph.beta.users.item.authentication.methods.item.disablesmssignin;
...
public class DisableSmsSignInRequestBuilder extends BaseRequestBuilder {
    ...
    public DisableSmsSignInRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/disableSmsSignIn", pathParameters);
    }
    /**
     * Instantiates a new {@link DisableSmsSignInRequestBuilder} and sets the default values.
    ...
    public DisableSmsSignInRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/disableSmsSignIn", rawUrl);
    }
    /**
