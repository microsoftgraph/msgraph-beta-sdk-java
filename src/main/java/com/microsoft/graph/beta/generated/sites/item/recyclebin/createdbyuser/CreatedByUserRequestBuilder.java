package com.microsoft.graph.beta.sites.item.recyclebin.createdbyuser;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.sites.item.recyclebin.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.sites.item.recyclebin.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class CreatedByUserRequestBuilder extends BaseRequestBuilder {
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin/createdByUser{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link CreatedByUserRequestBuilder} and sets the default values.
    ...
    public CreatedByUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin/createdByUser{?%24expand,%24select}", rawUrl);
    }
    /**
