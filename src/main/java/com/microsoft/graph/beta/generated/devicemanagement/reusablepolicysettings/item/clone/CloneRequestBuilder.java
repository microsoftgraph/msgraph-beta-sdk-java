package com.microsoft.graph.beta.devicemanagement.reusablepolicysettings.item.clone;
...
public class CloneRequestBuilder extends BaseRequestBuilder {
    ...
    public CloneRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reusablePolicySettings/{deviceManagementReusablePolicySetting%2Did}/clone", pathParameters);
    }
    /**
     * Instantiates a new {@link CloneRequestBuilder} and sets the default values.
    ...
    public CloneRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reusablePolicySettings/{deviceManagementReusablePolicySetting%2Did}/clone", rawUrl);
    }
    /**
     * Invoke action clone
    ...
    public DeviceManagementReusablePolicySetting post() {
        return post(null);
    }
    /**
     * Invoke action clone
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementReusablePolicySetting post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
