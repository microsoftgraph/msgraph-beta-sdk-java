package com.microsoft.graph.beta.teams.item.schedule.timeoffrequests;
...
import com.microsoft.graph.beta.teams.item.schedule.timeoffrequests.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.schedule.timeoffrequests.item.TimeOffRequestItemRequestBuilder;
...
public class TimeOffRequestsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/timeoffrequest-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/timeoffrequest-post?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
