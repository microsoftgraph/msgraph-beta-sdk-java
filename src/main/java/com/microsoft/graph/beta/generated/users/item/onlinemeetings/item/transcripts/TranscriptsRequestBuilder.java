package com.microsoft.graph.beta.users.item.onlinemeetings.item.transcripts;

import com.microsoft.graph.beta.models.CallTranscript;
import com.microsoft.graph.beta.models.CallTranscriptCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.onlinemeetings.item.transcripts.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.onlinemeetings.item.transcripts.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.onlinemeetings.item.transcripts.item.CallTranscriptItemRequestBuilder;
...
public class TranscriptsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/onlinemeeting-list-transcripts?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/transcripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CallTranscript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/transcripts", pathParameters);
