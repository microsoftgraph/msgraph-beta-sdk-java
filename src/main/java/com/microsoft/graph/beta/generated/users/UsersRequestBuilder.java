package com.microsoft.graph.beta.users;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.User;
import com.microsoft.graph.beta.models.UserCollectionResponse;
import com.microsoft.graph.beta.users.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.beta.users.getmanagedappblockedusers.GetManagedAppBlockedUsersRequestBuilder;
import com.microsoft.graph.beta.users.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.beta.users.item.UserItemRequestBuilder;
import com.microsoft.graph.beta.users.validatepassword.ValidatePasswordRequestBuilder;
import com.microsoft.graph.beta.users.validateproperties.ValidatePropertiesRequestBuilder;
...
public class UsersRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/user-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link User}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/user-post-users?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24top}", pathParameters);
