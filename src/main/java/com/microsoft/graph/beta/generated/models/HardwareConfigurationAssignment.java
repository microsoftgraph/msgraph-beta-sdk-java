...
public class HardwareConfigurationAssignment extends Entity implements Parsable {
    /**
     * Instantiates a new {@link HardwareConfigurationAssignment} and sets the default values.
     */
    public HardwareConfigurationAssignment() {
        super();
    }
    /**
    ...
    public static HardwareConfigurationAssignment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
