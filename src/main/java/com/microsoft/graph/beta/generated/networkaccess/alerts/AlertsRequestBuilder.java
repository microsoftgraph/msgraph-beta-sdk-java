...
import com.microsoft.graph.beta.networkaccess.alerts.microsoftgraphnetworkaccessgetalertfrequencieswithstart_99ef6a52.MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a;
import com.microsoft.graph.beta.networkaccess.alerts.microsoftgraphnetworkaccessgetalertseveritysummarieswit_f6162ffd.MicrosoftGraphNetworkaccessGetAlertSeveritySummariesWit_31ba57e6;
import com.microsoft.graph.beta.networkaccess.alerts.microsoftgraphnetworkaccessgetalertsummarieswithstartda_ffd0de28.MicrosoftGraphNetworkaccessGetAlertSummariesWithStartDa_97393dc7;
...
public class AlertsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/networkaccess-networkaccessroot-list-alerts?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a microsoftGraphNetworkaccessGetAlertFrequenciesWithStartDateTimeWithEndDateTime(@jakarta.annotation.Nonnull final OffsetDateTime endDateTime, @jakarta.annotation.Nonnull final OffsetDateTime startDateTime) {
        Objects.requireNonNull(endDateTime);
        Objects.requireNonNull(startDateTime);
        return new MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a(pathParameters, requestAdapter, endDateTime, startDateTime);
    }
    /**
     * Provides operations to call the getAlertSeveritySummaries method.
     * @param endDateTime Usage: endDateTime={endDateTime}
     * @param startDateTime Usage: startDateTime={startDateTime}
     * @return a {@link MicrosoftGraphNetworkaccessGetAlertSeveritySummariesWit_31ba57e6}
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetAlertSeveritySummariesWit_31ba57e6 microsoftGraphNetworkaccessGetAlertSeveritySummariesWithStartDateTimeWithEndDateTime(@jakarta.annotation.Nonnull final OffsetDateTime endDateTime, @jakarta.annotation.Nonnull final OffsetDateTime startDateTime) {
        Objects.requireNonNull(endDateTime);
        Objects.requireNonNull(startDateTime);
        return new MicrosoftGraphNetworkaccessGetAlertSeveritySummariesWit_31ba57e6(pathParameters, requestAdapter, endDateTime, startDateTime);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetAlertSummariesWithStartDa_97393dc7 microsoftGraphNetworkaccessGetAlertSummariesWithStartDateTimeWithEndDateTime(@jakarta.annotation.Nonnull final OffsetDateTime endDateTime, @jakarta.annotation.Nonnull final OffsetDateTime startDateTime) {
        Objects.requireNonNull(endDateTime);
        Objects.requireNonNull(startDateTime);
        return new MicrosoftGraphNetworkaccessGetAlertSummariesWithStartDa_97393dc7(pathParameters, requestAdapter, endDateTime, startDateTime);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/alerts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
