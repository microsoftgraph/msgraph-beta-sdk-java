package com.microsoft.graph.beta.policies.activitybasedtimeoutpolicies.item.appliesto;

import com.microsoft.graph.beta.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.policies.activitybasedtimeoutpolicies.item.appliesto.count.CountRequestBuilder;
import com.microsoft.graph.beta.policies.activitybasedtimeoutpolicies.item.appliesto.item.DirectoryObjectItemRequestBuilder;
...
public class AppliesToRequestBuilder extends BaseRequestBuilder {
    ...
    public AppliesToRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AppliesToRequestBuilder and sets the default values.
    ...
    public AppliesToRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
