package com.microsoft.graph.beta.teams.item.channels.item.filesfolder;

import com.microsoft.graph.beta.models.DriveItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teams.item.channels.item.filesfolder.content.ContentRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.filesfolder.contentstream.ContentStreamRequestBuilder;
...
public class FilesFolderRequestBuilder extends BaseRequestBuilder {
    ...
    public FilesFolderRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link FilesFolderRequestBuilder} and sets the default values.
    ...
    public FilesFolderRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24expand,%24select}", rawUrl);
    }
    /**
     * Get the metadata for the location where the files of a channel are stored.
     * @return a {@link DriveItem}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/channel-get-filesfolder?view=graph-rest-beta">Find more info here</a>
     */
