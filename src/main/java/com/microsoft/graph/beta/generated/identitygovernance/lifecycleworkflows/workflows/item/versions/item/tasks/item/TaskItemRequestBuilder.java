package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.versions.item.tasks.item;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.versions.item.tasks.item.taskprocessingresults.TaskProcessingResultsRequestBuilder;
...
public class TaskItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link Task}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/identitygovernance-task-get?view=graph-rest-beta">Find more info here</a>
     */
