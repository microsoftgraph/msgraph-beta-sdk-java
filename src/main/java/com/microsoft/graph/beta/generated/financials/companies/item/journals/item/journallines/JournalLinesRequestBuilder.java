package com.microsoft.graph.beta.financials.companies.item.journals.item.journallines;

import com.microsoft.graph.beta.financials.companies.item.journals.item.journallines.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.journals.item.journallines.item.JournalLineItemRequestBuilder;
import com.microsoft.graph.beta.models.JournalLine;
import com.microsoft.graph.beta.models.JournalLineCollectionResponse;
...
public class JournalLinesRequestBuilder extends BaseRequestBuilder {
    ...
    public JournalLinesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link JournalLinesRequestBuilder} and sets the default values.
    ...
    public JournalLinesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final JournalLine body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines", pathParameters);
