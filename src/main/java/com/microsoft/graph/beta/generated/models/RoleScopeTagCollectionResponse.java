...
public class RoleScopeTagCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link RoleScopeTagCollectionResponse} and sets the default values.
     */
    ...
    public static RoleScopeTagCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
