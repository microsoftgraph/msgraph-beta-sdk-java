package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.closesession;
...
public class CloseSessionRequestBuilder extends BaseRequestBuilder {
    ...
    public CloseSessionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/closeSession", pathParameters);
    }
    /**
     * Instantiates a new {@link CloseSessionRequestBuilder} and sets the default values.
    ...
    public CloseSessionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/closeSession", rawUrl);
    }
    /**
     * Use this API to close an existing workbook session.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/workbook-closesession?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
