package com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions.item;

import com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions.item.restore.RestoreRequestBuilder;
...
public class DocumentSetVersionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DocumentSetVersionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DocumentSetVersionItemRequestBuilder} and sets the default values.
    ...
    public DocumentSetVersionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24expand,%24select}", pathParameters);
