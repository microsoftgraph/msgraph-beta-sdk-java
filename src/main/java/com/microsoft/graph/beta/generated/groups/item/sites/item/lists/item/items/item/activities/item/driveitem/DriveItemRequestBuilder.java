package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.activities.item.driveitem;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.activities.item.driveitem.content.ContentRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.activities.item.driveitem.contentstream.ContentStreamRequestBuilder;
...
public class DriveItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveItemRequestBuilder} and sets the default values.
    ...
    public DriveItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24expand,%24select}", rawUrl);
    }
    /**
