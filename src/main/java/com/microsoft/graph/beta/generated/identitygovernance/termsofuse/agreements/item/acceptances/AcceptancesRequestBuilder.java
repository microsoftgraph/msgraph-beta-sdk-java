package com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.acceptances;

import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.acceptances.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.termsofuse.agreements.item.acceptances.item.AgreementAcceptanceItemRequestBuilder;
...
public class AcceptancesRequestBuilder extends BaseRequestBuilder {
    ...
    public AcceptancesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptancesRequestBuilder} and sets the default values.
    ...
    public AcceptancesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AgreementAcceptance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances", pathParameters);
