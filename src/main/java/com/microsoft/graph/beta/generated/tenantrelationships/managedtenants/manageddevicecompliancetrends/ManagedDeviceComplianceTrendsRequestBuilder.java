package com.microsoft.graph.beta.tenantrelationships.managedtenants.manageddevicecompliancetrends;

import com.microsoft.graph.beta.models.managedtenants.ManagedDeviceComplianceTrend;
import com.microsoft.graph.beta.models.managedtenants.ManagedDeviceComplianceTrendCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.manageddevicecompliancetrends.count.CountRequestBuilder;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.manageddevicecompliancetrends.item.ManagedDeviceComplianceTrendItemRequestBuilder;
...
public class ManagedDeviceComplianceTrendsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-manageddevicecompliancetrends?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/tenantRelationships/managedTenants/managedDeviceComplianceTrends{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
