...
public class CloudPcScopedPermission implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcScopedPermission} and sets the default values.
     */
     ...
     * @return a {@link CloudPcScopedPermission}
     */
    @jakarta.annotation.Nonnull
    public static CloudPcScopedPermission createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
