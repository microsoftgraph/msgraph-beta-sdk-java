package com.microsoft.graph.beta.templates;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Template;
import com.microsoft.graph.beta.templates.devicetemplates.DeviceTemplatesRequestBuilder;
...
public class TemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceTemplatesRequestBuilder deviceTemplates() {
        return new DeviceTemplatesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public Template patch(@jakarta.annotation.Nonnull final Template body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Template patch(@jakarta.annotation.Nonnull final Template body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/templates{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Template body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Template body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/templates", pathParameters);
