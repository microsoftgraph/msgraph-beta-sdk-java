package com.microsoft.graph.beta.users.item.manageddevices.item.windowsprotectionstate;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WindowsProtectionState;
import com.microsoft.graph.beta.users.item.manageddevices.item.windowsprotectionstate.detectedmalwarestate.DetectedMalwareStateRequestBuilder;
...
public class WindowsProtectionStateRequestBuilder extends BaseRequestBuilder {
    ...
    public WindowsProtectionStateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/windowsProtectionState", pathParameters);
    }
    /**
     * Instantiates a new {@link WindowsProtectionStateRequestBuilder} and sets the default values.
    ...
    public WindowsProtectionStateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/windowsProtectionState", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/windowsProtectionState{?%24expand,%24select}", pathParameters);
