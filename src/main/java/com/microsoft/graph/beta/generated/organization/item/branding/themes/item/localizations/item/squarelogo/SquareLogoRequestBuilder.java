package com.microsoft.graph.beta.organization.item.branding.themes.item.localizations.item.squarelogo;
...
public class SquareLogoRequestBuilder extends BaseRequestBuilder {
    ...
    public SquareLogoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/branding/themes/{organizationalBrandingTheme%2Did}/localizations/{organizationalBrandingThemeLocalization%2Dlocale}/squareLogo", pathParameters);
    }
    /**
     * Instantiates a new {@link SquareLogoRequestBuilder} and sets the default values.
    ...
    public SquareLogoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/branding/themes/{organizationalBrandingTheme%2Did}/localizations/{organizationalBrandingThemeLocalization%2Dlocale}/squareLogo", rawUrl);
    }
    /**
