...
public class ActionUrl implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ActionUrl} and sets the default values.
     */
    public ActionUrl() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static ActionUrl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
