package com.microsoft.graph.beta.education.users.item;

import com.microsoft.graph.beta.education.users.item.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.education.users.item.classes.ClassesRequestBuilder;
import com.microsoft.graph.beta.education.users.item.rubrics.RubricsRequestBuilder;
import com.microsoft.graph.beta.education.users.item.schools.SchoolsRequestBuilder;
import com.microsoft.graph.beta.education.users.item.taughtclasses.TaughtClassesRequestBuilder;
import com.microsoft.graph.beta.education.users.item.user.UserRequestBuilder;
...
public class EducationUserItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationuser-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationuser-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationUser}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/relatedcontact-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
