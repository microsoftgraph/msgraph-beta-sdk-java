package com.microsoft.graph.beta.domains.item.verificationdnsrecords;

import com.microsoft.graph.beta.domains.item.verificationdnsrecords.count.CountRequestBuilder;
import com.microsoft.graph.beta.domains.item.verificationdnsrecords.item.DomainDnsRecordItemRequestBuilder;
...
public class VerificationDnsRecordsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/domain-list-verificationdnsrecords?view=graph-rest-beta">Find more info here</a>
     */
