package com.microsoft.graph.beta.security.labels.retentionlabels.item.dispositionreviewstages.item;
...
public class DispositionReviewStageStageNumberItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DispositionReviewStageStageNumberItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/dispositionReviewStages/{dispositionReviewStage%2DstageNumber}", pathParameters);
    }
    /**
     * Instantiates a new {@link DispositionReviewStageStageNumberItemRequestBuilder} and sets the default values.
    ...
    public DispositionReviewStageStageNumberItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/dispositionReviewStages/{dispositionReviewStage%2DstageNumber}", rawUrl);
    }
    /**
    ...
    public DispositionReviewStage get() {
        return get(null);
    }
    /**
     * When action at the end of retention is chosen as &apos;dispositionReview&apos;, dispositionReviewStages specifies a sequential set of stages with at least one reviewer in each stage.
     ...
     */
    @jakarta.annotation.Nullable
    public DispositionReviewStage get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public DispositionReviewStage patch(@jakarta.annotation.Nonnull final DispositionReviewStage body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DispositionReviewStage patch(@jakarta.annotation.Nonnull final DispositionReviewStage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/dispositionReviewStages/{dispositionReviewStage%2DstageNumber}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DispositionReviewStage body) {
