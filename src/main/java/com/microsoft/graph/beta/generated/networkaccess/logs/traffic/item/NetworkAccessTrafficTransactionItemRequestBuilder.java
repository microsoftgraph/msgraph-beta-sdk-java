package com.microsoft.graph.beta.networkaccess.logs.traffic.item;
...
public class NetworkAccessTrafficTransactionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public NetworkAccessTrafficTransactionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link NetworkAccessTrafficTransactionItemRequestBuilder} and sets the default values.
    ...
    public NetworkAccessTrafficTransactionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final NetworkAccessTraffic body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link NetworkAccessTrafficTransactionItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
