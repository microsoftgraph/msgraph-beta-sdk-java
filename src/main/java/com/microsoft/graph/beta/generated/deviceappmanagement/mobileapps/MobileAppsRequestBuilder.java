...
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphandroidmanagedstoreapp.GraphAndroidManagedStoreAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphandroidstoreapp.GraphAndroidStoreAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphioslobapp.GraphIosLobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphiosstoreapp.GraphIosStoreAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphiosvppapp.GraphIosVppAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmacosdmgapp.GraphMacOSDmgAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmacoslobapp.GraphMacOSLobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmacospkgapp.GraphMacOSPkgAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmanagedandroidlobapp.GraphManagedAndroidLobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmanagedioslobapp.GraphManagedIOSLobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmanagedmobilelobapp.GraphManagedMobileLobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphmicrosoftstoreforbusinessapp.GraphMicrosoftStoreForBusinessAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwin32lobapp.GraphWin32LobAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwindowsappx.GraphWindowsAppXRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwindowsmobilemsi.GraphWindowsMobileMSIRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwindowsstoreapp.GraphWindowsStoreAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwindowsuniversalappx.GraphWindowsUniversalAppXRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwindowswebapp.GraphWindowsWebAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.graphwingetapp.GraphWinGetAppRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.haspayloadlinks.HasPayloadLinksRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.MobileAppItemRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.validatexml.ValidateXmlRequestBuilder;
import com.microsoft.graph.beta.models.MobileApp;
import com.microsoft.graph.beta.models.MobileAppCollectionResponse;
...
public class MobileAppsRequestBuilder extends BaseRequestBuilder {
    ...
    public ValidateXmlRequestBuilder validateXml() {
        return new ValidateXmlRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the mobileApps property of the microsoft.graph.deviceAppManagement entity.
