...
public class MdmWindowsInformationProtectionPolicy extends WindowsInformationProtection implements Parsable {
    /**
     * Instantiates a new {@link MdmWindowsInformationProtectionPolicy} and sets the default values.
     */
    ...
    public static MdmWindowsInformationProtectionPolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
