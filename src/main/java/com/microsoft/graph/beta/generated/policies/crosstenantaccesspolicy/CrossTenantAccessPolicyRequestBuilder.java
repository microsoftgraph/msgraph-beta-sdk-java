package com.microsoft.graph.beta.policies.crosstenantaccesspolicy;

import com.microsoft.graph.beta.models.CrossTenantAccessPolicy;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.defaultescaped.DefaultRequestBuilder;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.partners.PartnersRequestBuilder;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.templates.TemplatesRequestBuilder;
...
public class CrossTenantAccessPolicyRequestBuilder extends BaseRequestBuilder {
    ...
    public CrossTenantAccessPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy", pathParameters);
    }
    /**
     * Instantiates a new {@link CrossTenantAccessPolicyRequestBuilder} and sets the default values.
    ...
    public CrossTenantAccessPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link CrossTenantAccessPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/crossTenantAccessPolicy{?%24expand,%24select}", pathParameters);
