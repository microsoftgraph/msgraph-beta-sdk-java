package com.microsoft.graph.beta.users.item.managedapplogcollectionrequests;
...
import com.microsoft.graph.beta.users.item.managedapplogcollectionrequests.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.managedapplogcollectionrequests.item.ManagedAppLogCollectionRequestItemRequestBuilder;
...
public class ManagedAppLogCollectionRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/managedAppLogCollectionRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ManagedAppLogCollectionRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/managedAppLogCollectionRequests", pathParameters);
