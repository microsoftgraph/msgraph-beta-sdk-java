package com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.photo;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ProfilePhoto;
import com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.photo.value.ContentRequestBuilder;
...
public class PhotoRequestBuilder extends BaseRequestBuilder {
    ...
    public PhotoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PhotoRequestBuilder} and sets the default values.
    ...
    public PhotoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo{?%24expand,%24select}", rawUrl);
    }
    /**
     * The team photo.
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ProfilePhoto body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo", pathParameters);
