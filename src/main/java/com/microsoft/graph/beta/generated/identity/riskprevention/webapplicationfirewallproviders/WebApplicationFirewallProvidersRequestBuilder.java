package com.microsoft.graph.beta.identity.riskprevention.webapplicationfirewallproviders;

import com.microsoft.graph.beta.identity.riskprevention.webapplicationfirewallproviders.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.riskprevention.webapplicationfirewallproviders.item.WebApplicationFirewallProviderItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WebApplicationFirewallProvider;
import com.microsoft.graph.beta.models.WebApplicationFirewallProviderCollectionResponse;
...
public class WebApplicationFirewallProvidersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public WebApplicationFirewallProvidersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/riskpreventioncontainer-list-webapplicationfirewallproviders?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nullable
    public WebApplicationFirewallProviderCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/riskpreventioncontainer-post-webapplicationfirewallproviders?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
     ...
     */
    @jakarta.annotation.Nullable
    public WebApplicationFirewallProvider post(@jakarta.annotation.Nonnull final WebApplicationFirewallProvider body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/riskPrevention/webApplicationFirewallProviders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WebApplicationFirewallProvider body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/riskPrevention/webApplicationFirewallProviders", pathParameters);
