package com.microsoft.graph.beta.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.toterm;
...
public class ToTermRequestBuilder extends BaseRequestBuilder {
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ToTermRequestBuilder and sets the default values.
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", rawUrl);
    }
    /**
