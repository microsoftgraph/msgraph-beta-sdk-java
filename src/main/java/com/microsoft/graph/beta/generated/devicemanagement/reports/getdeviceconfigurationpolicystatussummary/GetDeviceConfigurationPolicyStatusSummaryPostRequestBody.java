package com.microsoft.graph.beta.devicemanagement.reports.getdeviceconfigurationpolicystatussummary;
...
public class GetDeviceConfigurationPolicyStatusSummaryPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDeviceConfigurationPolicyStatusSummaryPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDeviceConfigurationPolicyStatusSummaryPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceConfigurationPolicyStatusSummaryPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
