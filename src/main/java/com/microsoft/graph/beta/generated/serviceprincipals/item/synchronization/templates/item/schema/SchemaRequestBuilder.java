package com.microsoft.graph.beta.serviceprincipals.item.synchronization.templates.item.schema;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SynchronizationSchema;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.templates.item.schema.directories.DirectoriesRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.templates.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.templates.item.schema.functions.FunctionsRequestBuilder;
import com.microsoft.graph.beta.serviceprincipals.item.synchronization.templates.item.schema.parseexpression.ParseExpressionRequestBuilder;
...
public class SchemaRequestBuilder extends BaseRequestBuilder {
    ...
    public SchemaRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema", pathParameters);
    }
    /**
     * Instantiates a new {@link SchemaRequestBuilder} and sets the default values.
    ...
    public SchemaRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema{?%24expand,%24select}", pathParameters);
