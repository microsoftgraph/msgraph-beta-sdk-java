package com.microsoft.graph.beta.education.me.schools;

import com.microsoft.graph.beta.education.me.schools.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.me.schools.item.EducationSchoolItemRequestBuilder;
import com.microsoft.graph.beta.models.EducationSchoolCollectionResponse;
...
public class SchoolsRequestBuilder extends BaseRequestBuilder {
    ...
    public SchoolsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/me/schools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SchoolsRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationuser-list-schools?view=graph-rest-beta">Find more info here</a>
     */
