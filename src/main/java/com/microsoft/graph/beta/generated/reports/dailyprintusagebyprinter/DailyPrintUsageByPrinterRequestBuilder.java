package com.microsoft.graph.beta.reports.dailyprintusagebyprinter;
...
import com.microsoft.graph.beta.reports.dailyprintusagebyprinter.count.CountRequestBuilder;
import com.microsoft.graph.beta.reports.dailyprintusagebyprinter.item.PrintUsageByPrinterItemRequestBuilder;
...
public class DailyPrintUsageByPrinterRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link DailyPrintUsageByPrinterRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/reportroot-list-dailyprintusagebyprinter?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/reports/dailyPrintUsageByPrinter{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrintUsageByPrinter body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/reports/dailyPrintUsageByPrinter", pathParameters);
