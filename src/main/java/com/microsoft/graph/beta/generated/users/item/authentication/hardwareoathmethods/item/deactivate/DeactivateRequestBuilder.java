package com.microsoft.graph.beta.users.item.authentication.hardwareoathmethods.item.deactivate;
...
public class DeactivateRequestBuilder extends BaseRequestBuilder {
    ...
    public DeactivateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}/deactivate", pathParameters);
    }
    /**
     * Instantiates a new {@link DeactivateRequestBuilder} and sets the default values.
    ...
    public DeactivateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}/deactivate", rawUrl);
    }
    /**
     * Deactive a hardware OATH token. It remains assigned to a user.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/hardwareoathauthenticationmethod-deactivate?view=graph-rest-beta">Find more info here</a>
     */
    public void post() {
        post(null);
    }
