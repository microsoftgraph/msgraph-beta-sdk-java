package com.microsoft.graph.beta.security.threatintelligence.hosttrackers;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.HostTracker;
import com.microsoft.graph.beta.models.security.HostTrackerCollectionResponse;
import com.microsoft.graph.beta.security.threatintelligence.hosttrackers.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.hosttrackers.item.HostTrackerItemRequestBuilder;
...
public class HostTrackersRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatIntelligence/hostTrackers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
