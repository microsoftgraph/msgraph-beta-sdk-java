package com.microsoft.graph.beta.policies.featurerolloutpolicies;

import com.microsoft.graph.beta.models.FeatureRolloutPolicy;
import com.microsoft.graph.beta.models.FeatureRolloutPolicyCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.policies.featurerolloutpolicies.count.CountRequestBuilder;
import com.microsoft.graph.beta.policies.featurerolloutpolicies.item.FeatureRolloutPolicyItemRequestBuilder;
...
public class FeatureRolloutPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link FeatureRolloutPoliciesRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/list-featurerolloutpolicies?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/post-featurerolloutpolicies?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/featureRolloutPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final FeatureRolloutPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/policies/featureRolloutPolicies", pathParameters);
