...
public class ClearEnrollmentTimeDeviceMembershipTargetPostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ClearEnrollmentTimeDeviceMembershipTargetPostResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ClearEnrollmentTimeDeviceMembershipTargetPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
