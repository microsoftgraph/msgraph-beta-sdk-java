package com.microsoft.graph.beta.financials.companies.item.agedaccountspayable.item;

import com.microsoft.graph.beta.models.AgedAccountsPayable;
...
public class AgedAccountsPayableItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link AgedAccountsPayableItemRequestBuilder} and sets the default values.
    ...
    public AgedAccountsPayableItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/agedAccountsPayable/{agedAccountsPayable%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link AgedAccountsPayableItemRequestBuilder} and sets the default values.
    ...
    public AgedAccountsPayableItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/agedAccountsPayable/{agedAccountsPayable%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
     * Get agedAccountsPayable from financials
     * @return a {@link AgedAccountsPayable}
    ...
    public AgedAccountsPayable get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, AgedAccountsPayable::createFromDiscriminatorValue);
    }
    /**
     * Get agedAccountsPayable from financials
