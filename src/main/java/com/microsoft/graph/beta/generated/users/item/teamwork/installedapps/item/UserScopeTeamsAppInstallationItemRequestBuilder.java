package com.microsoft.graph.beta.users.item.teamwork.installedapps.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserScopeTeamsAppInstallation;
import com.microsoft.graph.beta.users.item.teamwork.installedapps.item.chat.ChatRequestBuilder;
import com.microsoft.graph.beta.users.item.teamwork.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import com.microsoft.graph.beta.users.item.teamwork.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
...
public class UserScopeTeamsAppInstallationItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @deprecated
     *  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see <a href="https://learn.microsoft.com/graph/api/userteamwork-delete-installedapps?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void delete() {
        delete(null);
     ...
     * @deprecated
     *  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see <a href="https://learn.microsoft.com/graph/api/userteamwork-get-installedapps?view=graph-rest-beta">Find more info here</a>
     */
