package com.microsoft.graph.beta.app.onlinemeetings.item.registration;

import com.microsoft.graph.beta.app.onlinemeetings.item.registration.customquestions.CustomQuestionsRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.registration.registrants.RegistrantsRequestBuilder;
...
public class RegistrationRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final MeetingRegistration body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration", pathParameters);
