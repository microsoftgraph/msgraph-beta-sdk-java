package com.microsoft.graph.beta.rolemanagement.enterpriseapps.item.transitiveroleassignments;
...
import com.microsoft.graph.beta.rolemanagement.enterpriseapps.item.transitiveroleassignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.enterpriseapps.item.transitiveroleassignments.item.UnifiedRoleAssignmentItemRequestBuilder;
...
public class TransitiveRoleAssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public TransitiveRoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/transitiveRoleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TransitiveRoleAssignmentsRequestBuilder} and sets the default values.
    ...
    public TransitiveRoleAssignmentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/transitiveRoleAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UnifiedRoleAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/transitiveRoleAssignments", pathParameters);
