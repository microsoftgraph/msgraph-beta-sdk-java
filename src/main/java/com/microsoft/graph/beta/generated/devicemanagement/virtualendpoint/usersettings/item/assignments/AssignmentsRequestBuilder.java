package com.microsoft.graph.beta.devicemanagement.virtualendpoint.usersettings.item.assignments;

import com.microsoft.graph.beta.devicemanagement.virtualendpoint.usersettings.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.virtualendpoint.usersettings.item.assignments.item.CloudPcUserSettingAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.models.CloudPcUserSettingAssignment;
import com.microsoft.graph.beta.models.CloudPcUserSettingAssignmentCollectionResponse;
...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
