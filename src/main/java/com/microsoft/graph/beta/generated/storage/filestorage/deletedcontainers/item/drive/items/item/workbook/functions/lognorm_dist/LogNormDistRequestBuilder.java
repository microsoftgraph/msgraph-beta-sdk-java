package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.lognorm_dist;
...
public class LogNormDistRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link LogNormDistRequestBuilder} and sets the default values.
    ...
    public LogNormDistRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/logNorm_Dist", pathParameters);
    }
    /**
     * Instantiates a new {@link LogNormDistRequestBuilder} and sets the default values.
    ...
    public LogNormDistRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/logNorm_Dist", rawUrl);
    }
    /**
