package com.microsoft.graph.beta.solutions.backuprestore.siteexclusionunitsbulkadditionjobs.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SiteExclusionUnitsBulkAdditionJob;
...
public class SiteExclusionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public SiteExclusionUnitsBulkAdditionJob patch(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SiteExclusionUnitsBulkAdditionJob patch(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/siteExclusionUnitsBulkAdditionJobs/{siteExclusionUnitsBulkAdditionJob%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final SiteExclusionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public SiteExclusionUnitsBulkAdditionJobItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
