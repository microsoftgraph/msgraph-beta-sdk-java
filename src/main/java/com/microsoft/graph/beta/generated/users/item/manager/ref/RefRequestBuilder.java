package com.microsoft.graph.beta.users.item.manager.ref;
...
public class RefRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentuser-delete-manager?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/user-post-manager?view=graph-rest-beta">Find more info here</a>
     */
