package com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.previousversiondefinition;

import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.previousversiondefinition.category.CategoryRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.previousversiondefinition.definitionfile.DefinitionFileRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.previousversiondefinition.nextversiondefinition.NextVersionDefinitionRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.grouppolicydefinitions.item.previousversiondefinition.presentations.PresentationsRequestBuilder;
...
public class PreviousVersionDefinitionRequestBuilder extends BaseRequestBuilder {
    ...
    public PreviousVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PreviousVersionDefinitionRequestBuilder} and sets the default values.
    ...
    public PreviousVersionDefinitionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GroupPolicyDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition", pathParameters);
