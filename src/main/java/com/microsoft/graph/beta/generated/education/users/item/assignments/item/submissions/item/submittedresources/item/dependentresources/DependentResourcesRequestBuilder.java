package com.microsoft.graph.beta.education.users.item.assignments.item.submissions.item.submittedresources.item.dependentresources;

import com.microsoft.graph.beta.education.users.item.assignments.item.submissions.item.submittedresources.item.dependentresources.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.users.item.assignments.item.submissions.item.submittedresources.item.dependentresources.item.EducationSubmissionResourceItemRequestBuilder;
