package com.microsoft.graph.beta.accessreviews.item.instances.item.reviewers;

import com.microsoft.graph.beta.accessreviews.item.instances.item.reviewers.count.CountRequestBuilder;
import com.microsoft.graph.beta.accessreviews.item.instances.item.reviewers.item.AccessReviewReviewerItemRequestBuilder;
...
public class ReviewersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ReviewersRequestBuilder} and sets the default values.
    ...
    public ReviewersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/reviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ReviewersRequestBuilder} and sets the default values.
    ...
    public ReviewersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/reviewers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public ReviewersRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
