package com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.connectivityconfiguration.links;

import com.microsoft.graph.beta.models.networkaccess.ConnectivityConfigurationLink;
import com.microsoft.graph.beta.models.networkaccess.ConnectivityConfigurationLinkCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.connectivityconfiguration.links.count.CountRequestBuilder;
import com.microsoft.graph.beta.networkaccess.connectivity.remotenetworks.item.connectivityconfiguration.links.item.ConnectivityConfigurationLinkItemRequestBuilder;
...
public class LinksRequestBuilder extends BaseRequestBuilder {
    ...
    public LinksRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration/links{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new LinksRequestBuilder and sets the default values.
    ...
    public LinksRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration/links{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public ConnectivityConfigurationLinkCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, ConnectivityConfigurationLinkCollectionResponse::createFromDiscriminatorValue);
    }
    /**
