package com.microsoft.graph.beta.reports.serviceactivity.getmetricsfornetworkaccessinternetapppolicyallowedappsw_0d885123;
...
public class GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a {@link GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/serviceactivity-getmetricsfornetworkaccessinternetapppolicyallowedapps?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009 get() {
        return get(null);
    }
    /**
     * Retrieve the number of internet applications allowed by web content filtering policies applied to specific FQDNs using Global Secure Access client.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009::createFromDiscriminatorValue);
    }
    /**
     * Retrieve the number of internet applications allowed by web content filtering policies applied to specific FQDNs using Global Secure Access client.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc(rawUrl, requestAdapter);
    }
    /**
     * Retrieve the number of internet applications allowed by web content filtering policies applied to specific FQDNs using Global Secure Access client.
     */
