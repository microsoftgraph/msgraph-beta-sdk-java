package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.createdby.CreatedByRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.lastmodifiedby.LastModifiedByRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.microsoftgraphidentitygovernancerestore.MicrosoftGraphIdentityGovernanceRestoreRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.lifecyclepolicies.item.versions.item.rules.RulesRequestBuilder;
...
public class LifecyclePolicyItemRequestBuilder extends BaseRequestBuilder {
    ...
    public LifecyclePolicyItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/lifecyclePolicies/{lifecyclePolicy%2Did}/versions/{lifecyclePolicy%2Did1}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link LifecyclePolicyItemRequestBuilder} and sets the default values.
    ...
    public LifecyclePolicyItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/lifecyclePolicies/{lifecyclePolicy%2Did}/versions/{lifecyclePolicy%2Did1}{?%24expand,%24select}", rawUrl);
    }
    /**
