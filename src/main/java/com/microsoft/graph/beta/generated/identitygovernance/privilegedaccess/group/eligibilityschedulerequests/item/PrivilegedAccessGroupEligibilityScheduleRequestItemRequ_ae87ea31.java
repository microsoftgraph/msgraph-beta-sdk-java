package com.microsoft.graph.beta.identitygovernance.privilegedaccess.group.eligibilityschedulerequests.item;

import com.microsoft.graph.beta.identitygovernance.privilegedaccess.group.eligibilityschedulerequests.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.privilegedaccess.group.eligibilityschedulerequests.item.group.GroupRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.privilegedaccess.group.eligibilityschedulerequests.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.privilegedaccess.group.eligibilityschedulerequests.item.targetschedule.TargetScheduleRequestBuilder;
...
public class PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31 extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new PrivilegedAccessGroupEligibilityScheduleRequestItemRequ_ae87ea31(rawUrl, requestAdapter);
    }
    /**
