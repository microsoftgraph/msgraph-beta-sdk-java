package com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.getorder;

import com.microsoft.graph.beta.models.AssignmentOrder;
...
public class GetOrderRequestBuilder extends BaseRequestBuilder {
    ...
    public GetOrderRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/getOrder()", pathParameters);
    }
    /**
     * Instantiates a new {@link GetOrderRequestBuilder} and sets the default values.
    ...
    public GetOrderRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/getOrder()", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-getorder?view=graph-rest-beta">Find more info here</a>
     */
