...
public class QueryCondition implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link QueryCondition} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static QueryCondition createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("queryText", (n) -> { this.setQueryText(n.getStringValue()); });
    ...
    public String getQueryText() {
        return this.backingStore.get("queryText");
    }
    /**
    ...
    public void setQueryText(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("queryText", value);
    }
}
