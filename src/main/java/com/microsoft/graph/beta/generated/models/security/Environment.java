...
public class Environment extends Entity implements Parsable {
    /**
     * Instantiates a new {@link Environment} and sets the default values.
     */
    public Environment() {
        super();
    }
    ...
    public static Environment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kind", (n) -> { this.setKind(n.getEnumValue(EnvironmentKind::forValue)); });
