package com.microsoft.graph.beta.connections.item;

import com.microsoft.graph.beta.connections.item.groups.GroupsRequestBuilder;
import com.microsoft.graph.beta.connections.item.items.ItemsRequestBuilder;
import com.microsoft.graph.beta.connections.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.connections.item.quota.QuotaRequestBuilder;
import com.microsoft.graph.beta.connections.item.schema.SchemaRequestBuilder;
...
public class ExternalConnectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ExternalConnectionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExternalConnectionItemRequestBuilder} and sets the default values.
    ...
    public ExternalConnectionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/connections/{externalConnection%2Did}{?%24expand,%24select}", pathParameters);
