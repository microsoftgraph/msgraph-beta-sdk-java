package com.microsoft.graph.beta.reports.serviceactivity.getmetricsforconditionalaccessmanageddevicessigninsucce_8443273f;
...
public class GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a {@link GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/serviceactivity-getmetricsforconditionalaccessmanageddevicessigninsuccess?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95 get() {
        return get(null);
    }
    /**
     * Get the number of user authentication requests, during a specific time period, that satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra.
     ...
     */
    @jakarta.annotation.Nullable
    public GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95::createFromDiscriminatorValue);
    }
    /**
     * Get the number of user authentication requests, during a specific time period, that satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra.
     ...
     */
    @jakarta.annotation.Nonnull
    public GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856(rawUrl, requestAdapter);
    }
    /**
     * Get the number of user authentication requests, during a specific time period, that satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra.
     */
