...
public class ResourcePermission implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ResourcePermission} and sets the default values.
     */
     ...
     * @return a {@link ResourcePermission}
     */
    @jakarta.annotation.Nonnull
    public static ResourcePermission createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setType(@jakarta.annotation.Nullable final PermissionType value) {
