...
public class TeamsMessageEvidence extends AlertEvidence implements Parsable {
    ...
    /**
     * Gets the messageId property value. The message identifier, unique within the thread.
     * @return a {@link String}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the messageId property value. The message identifier, unique within the thread.
