...
public class CloudPcAgentPoolScalingPolicy implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcAgentPoolScalingPolicy} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CloudPcAgentPoolScalingPolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CloudPcAgentPoolScalingPolicy();
    }
    /**
