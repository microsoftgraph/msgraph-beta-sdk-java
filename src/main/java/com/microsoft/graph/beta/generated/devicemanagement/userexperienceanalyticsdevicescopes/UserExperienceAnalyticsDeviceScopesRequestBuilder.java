package com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsdevicescopes;

import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsdevicescopes.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsdevicescopes.item.UserExperienceAnalyticsDeviceScopeItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsDeviceScope;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsDeviceScopeCollectionResponse;
...
public class UserExperienceAnalyticsDeviceScopesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserExperienceAnalyticsDeviceScopesRequestBuilder} and sets the default values.
    ...
    public UserExperienceAnalyticsDeviceScopesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceScopes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserExperienceAnalyticsDeviceScopesRequestBuilder} and sets the default values.
    ...
    public UserExperienceAnalyticsDeviceScopesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceScopes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserExperienceAnalyticsDeviceScope body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceScopes", pathParameters);
