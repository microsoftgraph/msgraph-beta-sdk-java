package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.createsession;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WorkbookSessionInfo;
...
public class CreateSessionRequestBuilder extends BaseRequestBuilder {
    ...
    public CreateSessionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/createSession", pathParameters);
    }
    /**
     * Instantiates a new {@link CreateSessionRequestBuilder} and sets the default values.
    ...
    public CreateSessionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/createSession", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/workbook-createsession?view=graph-rest-beta">Find more info here</a>
     */
