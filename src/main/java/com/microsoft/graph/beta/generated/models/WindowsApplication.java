...
public class WindowsApplication implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WindowsApplication} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WindowsApplication createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("packageSid", (n) -> { this.setPackageSid(n.getStringValue()); });
    ...
    public String getPackageSid() {
        return this.backingStore.get("packageSid");
    }
    /**
     ...
     */
    public void setPackageSid(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("packageSid", value);
    }
    /**
