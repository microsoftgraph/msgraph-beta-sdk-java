package com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.applicablecontent;

import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.applicablecontent.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.audience.applicablecontent.item.ApplicableContentCatalogEntryItemRequestBuilder;
...
public class ApplicableContentRequestBuilder extends BaseRequestBuilder {
    ...
    public ApplicableContentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApplicableContentRequestBuilder} and sets the default values.
    ...
    public ApplicableContentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
