package com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.termstore.Term;
import com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.set.SetRequestBuilder;
