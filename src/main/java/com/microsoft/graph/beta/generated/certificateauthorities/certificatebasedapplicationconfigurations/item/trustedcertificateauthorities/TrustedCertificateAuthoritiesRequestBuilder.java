package com.microsoft.graph.beta.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities;

import com.microsoft.graph.beta.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities.count.CountRequestBuilder;
import com.microsoft.graph.beta.certificateauthorities.certificatebasedapplicationconfigurations.item.trustedcertificateauthorities.item.CertificateAuthorityAsEntityItemRequestBuilder;
...
public class TrustedCertificateAuthoritiesRequestBuilder extends BaseRequestBuilder {
    ...
    public TrustedCertificateAuthoritiesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/certificateAuthorities/certificateBasedApplicationConfigurations/{certificateBasedApplicationConfiguration%2Did}/trustedCertificateAuthorities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TrustedCertificateAuthoritiesRequestBuilder} and sets the default values.
    ...
    public TrustedCertificateAuthoritiesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/certificateAuthorities/certificateBasedApplicationConfigurations/{certificateBasedApplicationConfiguration%2Did}/trustedCertificateAuthorities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
