package com.microsoft.graph.beta.devicemanagement.reports.getallcertificatesreport;
...
public class GetAllCertificatesReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetAllCertificatesReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetAllCertificatesReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetAllCertificatesReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
