package com.microsoft.graph.beta.identitygovernance.entitlementmanagement.accesspackages.item.accesspackageresourcerolescopes.item.accesspackageresourcescope.accesspackageresource.accesspackageresourceroles.item.accesspackageresource.externaloriginresourceconnector;
...
public class ExternalOriginResourceConnectorRequestBuilder extends BaseRequestBuilder {
    ...
    public ExternalOriginResourceConnectorRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageResourceRoleScopes/{accessPackageResourceRoleScope%2Did}/accessPackageResourceScope/accessPackageResource/accessPackageResourceRoles/{accessPackageResourceRole%2Did}/accessPackageResource/externalOriginResourceConnector{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ExternalOriginResourceConnectorRequestBuilder} and sets the default values.
