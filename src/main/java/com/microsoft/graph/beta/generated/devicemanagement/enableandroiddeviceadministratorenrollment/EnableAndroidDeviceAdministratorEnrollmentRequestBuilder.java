package com.microsoft.graph.beta.devicemanagement.enableandroiddeviceadministratorenrollment;
...
public class EnableAndroidDeviceAdministratorEnrollmentRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link EnableAndroidDeviceAdministratorEnrollmentRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nonnull
    public EnableAndroidDeviceAdministratorEnrollmentRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
