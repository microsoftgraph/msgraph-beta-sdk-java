...
public class WebauthnAuthenticatorAttestationResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WebauthnAuthenticatorAttestationResponse} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WebauthnAuthenticatorAttestationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getAttestationObject() {
        return this.backingStore.get("attestationObject");
    }
    /**
    ...
    public String getClientDataJSON() {
        return this.backingStore.get("clientDataJSON");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("attestationObject", (n) -> { this.setAttestationObject(n.getStringValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("attestationObject", this.getAttestationObject());
        writer.writeStringValue("clientDataJSON", this.getClientDataJSON());
    ...
    public void setAttestationObject(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("attestationObject", value);
    }
    /**
    ...
    public void setClientDataJSON(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("clientDataJSON", value);
    }
    /**
