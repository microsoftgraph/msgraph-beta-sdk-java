package com.microsoft.graph.beta.security.threatintelligence.intelprofiles;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.security.IntelligenceProfile;
import com.microsoft.graph.beta.models.security.IntelligenceProfileCollectionResponse;
import com.microsoft.graph.beta.security.threatintelligence.intelprofiles.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.threatintelligence.intelprofiles.item.IntelligenceProfileItemRequestBuilder;
...
public class IntelProfilesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-threatintelligence-list-intelprofiles?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/threatIntelligence/intelProfiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final IntelligenceProfile body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/threatIntelligence/intelProfiles", pathParameters);
