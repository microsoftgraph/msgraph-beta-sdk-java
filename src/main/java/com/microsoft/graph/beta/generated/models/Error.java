...
public class Error implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Error} and sets the default values.
     */
    public Error() {
    ...
    /**
     * Gets the message property value. The message for the error
     * @return a {@link String}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the message property value. The message for the error
