...
public class ContactInsightsRequestBuilder extends BaseRequestBuilder {
    ...
    public ContactInsightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings/contactInsights{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ContactInsightsRequestBuilder and sets the default values.
    ...
    public ContactInsightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organization/{organization%2Did}/settings/contactInsights{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a ContactInsightsRequestBuilder
     */
    @jakarta.annotation.Nonnull
