...
public class AddMembersPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AddMembersPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AddMembersPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static AddMembersPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
