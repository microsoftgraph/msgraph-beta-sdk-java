...
public class IosPkcsCertificateProfile extends IosCertificateProfileBase implements Parsable {
     ...
     * @return a IosPkcsCertificateProfileCertificateStore
     */
    @jakarta.annotation.Nullable
    public IosPkcsCertificateProfileCertificateStore getCertificateStore() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("certificateStore", (n) -> { this.setCertificateStore(n.getEnumValue(IosPkcsCertificateProfileCertificateStore::forValue)); });
     ...
     */
    public void setCertificateStore(@jakarta.annotation.Nullable final IosPkcsCertificateProfileCertificateStore value) {
