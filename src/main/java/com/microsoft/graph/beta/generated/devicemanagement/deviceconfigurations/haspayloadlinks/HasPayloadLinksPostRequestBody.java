package com.microsoft.graph.beta.devicemanagement.deviceconfigurations.haspayloadlinks;
...
public class HasPayloadLinksPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link HasPayloadLinksPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link HasPayloadLinksPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public java.util.List<String> getPayloadIds() {
        return this.backingStore.get("payloadIds");
    }
    /**
    ...
    public void setPayloadIds(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("payloadIds", value);
    }
}
