...
public class PersonDataSources implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link PersonDataSources} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static PersonDataSources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
