...
public class WorkbookNamedItem extends Entity implements Parsable {
    ...
    /**
     * Gets the worksheet property value. Return the worksheet to which the named item is scoped. Available only if the item is scoped to the worksheet. Read-only.
    ...
    /**
     * Sets the worksheet property value. Return the worksheet to which the named item is scoped. Available only if the item is scoped to the worksheet. Read-only.
