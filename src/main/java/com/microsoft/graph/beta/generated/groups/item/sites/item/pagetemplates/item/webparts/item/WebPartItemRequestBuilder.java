package com.microsoft.graph.beta.groups.item.sites.item.pagetemplates.item.webparts.item;

import com.microsoft.graph.beta.groups.item.sites.item.pagetemplates.item.webparts.item.getpositionofwebpart.GetPositionOfWebPartRequestBuilder;
...
public class WebPartItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WebPartItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/webParts/{webPart%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link WebPartItemRequestBuilder} and sets the default values.
    ...
    public WebPartItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/webParts/{webPart%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/webParts/{webPart%2Did}{?%24expand,%24select}", pathParameters);
