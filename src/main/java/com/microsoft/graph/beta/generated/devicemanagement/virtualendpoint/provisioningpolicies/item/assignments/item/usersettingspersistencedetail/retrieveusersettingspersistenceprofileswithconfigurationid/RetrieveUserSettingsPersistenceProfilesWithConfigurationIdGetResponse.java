...
public class RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse} and sets the default values.
     */
    public RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse() {
        super();
    }
    /**
    ...
    public static RetrieveUserSettingsPersistenceProfilesWithConfigurationIdGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
