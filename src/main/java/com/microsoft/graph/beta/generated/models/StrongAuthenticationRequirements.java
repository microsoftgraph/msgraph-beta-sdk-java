...
public class StrongAuthenticationRequirements implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link StrongAuthenticationRequirements} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static StrongAuthenticationRequirements createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("perUserMfaState", (n) -> { this.setPerUserMfaState(n.getEnumValue(PerUserMfaState::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public PerUserMfaState getPerUserMfaState() {
    ...
    public void setPerUserMfaState(@jakarta.annotation.Nullable final PerUserMfaState value) {
        this.backingStore.set("perUserMfaState", value);
    }
}
