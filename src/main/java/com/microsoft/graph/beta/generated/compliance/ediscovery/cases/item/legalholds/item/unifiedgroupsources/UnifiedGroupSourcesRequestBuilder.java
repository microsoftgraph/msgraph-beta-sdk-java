package com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.count.CountRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.item.UnifiedGroupSourceItemRequestBuilder;
...
public class UnifiedGroupSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public UnifiedGroupSourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link UnifiedGroupSourcesRequestBuilder} and sets the default values.
    ...
    public UnifiedGroupSourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
