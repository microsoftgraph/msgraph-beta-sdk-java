package com.microsoft.graph.beta.users.item.devices.item.memberof.graphadministrativeunit;

import com.microsoft.graph.beta.models.AdministrativeUnitCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.devices.item.memberof.graphadministrativeunit.count.CountRequestBuilder;
...
public class GraphAdministrativeUnitRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphAdministrativeUnitRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/graph.administrativeUnit{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphAdministrativeUnitRequestBuilder} and sets the default values.
    ...
    public GraphAdministrativeUnitRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/graph.administrativeUnit{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
