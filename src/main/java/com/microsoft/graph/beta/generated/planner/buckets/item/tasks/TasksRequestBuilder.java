package com.microsoft.graph.beta.planner.buckets.item.tasks;
...
import com.microsoft.graph.beta.planner.buckets.item.tasks.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.buckets.item.tasks.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.planner.buckets.item.tasks.item.PlannerTaskItemRequestBuilder;
...
public class TasksRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/plannerbucket-list-tasks?view=graph-rest-beta">Find more info here</a>
     */
