package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflowtemplates.item.tasks.item.taskprocessingresults.item.subject.mailboxsettings;
