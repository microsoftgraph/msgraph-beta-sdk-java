package com.microsoft.graph.beta.security.cases.ediscoverycases.item.custodians.item.sitesources;
...
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.custodians.item.sitesources.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.custodians.item.sitesources.item.SiteSourceItemRequestBuilder;
...
public class SiteSourcesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-ediscoverycustodian-list-sitesources?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/security-ediscoverycustodian-post-sitesources?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
