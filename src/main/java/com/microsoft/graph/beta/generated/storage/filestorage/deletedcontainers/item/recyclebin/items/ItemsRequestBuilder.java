package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.recyclebin.items;
...
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.recyclebin.items.count.CountRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.recyclebin.items.delete.DeleteRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.recyclebin.items.item.RecycleBinItemItemRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.recyclebin.items.restore.RestoreRequestBuilder;
...
public class ItemsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/recycleBin/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final RecycleBinItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/recycleBin/items", pathParameters);
