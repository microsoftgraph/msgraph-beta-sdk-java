package com.microsoft.graph.beta.education.schools.item;

import com.microsoft.graph.beta.education.schools.item.administrativeunit.AdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.education.schools.item.classes.ClassesRequestBuilder;
import com.microsoft.graph.beta.education.schools.item.users.UsersRequestBuilder;
...
public class EducationSchoolItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationschool-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationschool-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationSchool}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationschool-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
