...
public class GetDeviceInstallStatusReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDeviceInstallStatusReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDeviceInstallStatusReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceInstallStatusReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
