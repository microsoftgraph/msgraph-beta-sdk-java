package com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item;

import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.apps.AppsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.assign.AssignRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.changesettings.ChangeSettingsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.deploymentsummary.DeploymentSummaryRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.settings.SettingsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.targetedmanagedappconfigurations.item.targetapps.TargetAppsRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TargetedManagedAppConfiguration;
...
public class TargetedManagedAppConfigurationItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public ChangeSettingsRequestBuilder changeSettings() {
        return new ChangeSettingsRequestBuilder(pathParameters, requestAdapter);
    }
    /**
