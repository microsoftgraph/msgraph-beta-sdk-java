package com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.sitesources.SiteSourcesRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.UnifiedGroupSourcesRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.legalholds.item.usersources.UserSourcesRequestBuilder;
...
public class LegalHoldItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public LegalHoldItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link LegalHoldItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public LegalHoldItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}", rawUrl);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public LegalHold patch(@jakarta.annotation.Nonnull final LegalHold body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public LegalHold patch(@jakarta.annotation.Nonnull final LegalHold body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}{?%24expand,%24select}", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final LegalHold body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public LegalHoldItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
