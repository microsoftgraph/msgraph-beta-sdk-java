...
public enum IncidentDetermination implements ValuedEnum {
    Unknown("unknown"),
    Apt("apt"),
    Malware("malware"),
    ...
    IncidentDetermination(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static IncidentDetermination forValue(@jakarta.annotation.Nonnull final String searchValue) {
