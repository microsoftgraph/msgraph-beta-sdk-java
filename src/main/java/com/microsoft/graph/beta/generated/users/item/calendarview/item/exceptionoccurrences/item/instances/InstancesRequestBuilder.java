package com.microsoft.graph.beta.users.item.calendarview.item.exceptionoccurrences.item.instances;

import com.microsoft.graph.beta.models.EventCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendarview.item.exceptionoccurrences.item.instances.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendarview.item.exceptionoccurrences.item.instances.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.calendarview.item.exceptionoccurrences.item.instances.item.EventItemRequestBuilder;
...
public class InstancesRequestBuilder extends BaseRequestBuilder {
    ...
    public InstancesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link InstancesRequestBuilder} and sets the default values.
    ...
    public InstancesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
