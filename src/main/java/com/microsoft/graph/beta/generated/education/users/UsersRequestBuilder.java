package com.microsoft.graph.beta.education.users;

import com.microsoft.graph.beta.education.users.count.CountRequestBuilder;
import com.microsoft.graph.beta.education.users.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.education.users.item.EducationUserItemRequestBuilder;
...
public class UsersRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationroot-list-users?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationroot-post-users?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
