package com.microsoft.graph.beta.users.item.distributionlists.item.distributionlistmembers.item.contact;
...
public class ContactRequestBuilder extends BaseRequestBuilder {
    ...
    public ContactRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/distributionLists/{distributionList%2Did}/distributionListMembers/{distributionListMember%2Did}/contact{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ContactRequestBuilder} and sets the default values.
    ...
    public ContactRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/distributionLists/{distributionList%2Did}/distributionListMembers/{distributionListMember%2Did}/contact{?%24expand,%24select}", rawUrl);
    }
    /**
