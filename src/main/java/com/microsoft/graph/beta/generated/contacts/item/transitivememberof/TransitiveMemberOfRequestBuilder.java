package com.microsoft.graph.beta.contacts.item.transitivememberof;

import com.microsoft.graph.beta.contacts.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.contacts.item.transitivememberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.contacts.item.transitivememberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.contacts.item.transitivememberof.item.DirectoryObjectItemRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/orgcontact-list-transitivememberof?view=graph-rest-beta">Find more info here</a>
     */
