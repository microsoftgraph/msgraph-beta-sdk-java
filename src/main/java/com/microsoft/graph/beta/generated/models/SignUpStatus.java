...
public class SignUpStatus implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SignUpStatus} and sets the default values.
     */
    public SignUpStatus() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static SignUpStatus createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
