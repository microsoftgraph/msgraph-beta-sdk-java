package com.microsoft.graph.beta.teams.item.channels.item;

import com.microsoft.graph.beta.models.Channel;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teams.item.channels.item.allmembers.AllMembersRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.archive.ArchiveRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.completemigration.CompleteMigrationRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.doesuserhaveaccessuseriduseridtenantidtenantiduserprinc_363088ef.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrinc_40d13b0e;
...
import com.microsoft.graph.beta.teams.item.channels.item.provisionemail.ProvisionEmailRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.removeemail.RemoveEmailRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.sharedwithteams.SharedWithTeamsRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.startmigration.StartMigrationRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.tabs.TabsRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.unarchive.UnarchiveRequestBuilder;
...
public class ChannelItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/channel-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/channel-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link Channel}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/channel-patch?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
