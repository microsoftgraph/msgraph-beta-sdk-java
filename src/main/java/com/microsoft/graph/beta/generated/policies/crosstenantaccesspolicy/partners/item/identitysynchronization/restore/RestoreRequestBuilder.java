package com.microsoft.graph.beta.policies.crosstenantaccesspolicy.partners.item.identitysynchronization.restore;
...
public class RestoreRequestBuilder extends BaseRequestBuilder {
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/identitySynchronization/restore", pathParameters);
    }
    /**
     * Instantiates a new {@link RestoreRequestBuilder} and sets the default values.
    ...
    public RestoreRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/identitySynchronization/restore", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/crosstenantidentitysyncpolicypartner-restore?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public CrossTenantIdentitySyncPolicyPartner post() {
        return post(null);
    }
    /**
     * Restore a deleted crossTenantIdentitySyncPolicyPartner object.
     ...
     */
    @jakarta.annotation.Nullable
    public CrossTenantIdentitySyncPolicyPartner post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
