package com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats.item.activities.item.driveitem;

import com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats.item.activities.item.driveitem.content.ContentRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.analytics.itemactivitystats.item.activities.item.driveitem.contentstream.ContentStreamRequestBuilder;
