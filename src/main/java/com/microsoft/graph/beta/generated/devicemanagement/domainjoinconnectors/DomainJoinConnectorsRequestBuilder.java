package com.microsoft.graph.beta.devicemanagement.domainjoinconnectors;

import com.microsoft.graph.beta.devicemanagement.domainjoinconnectors.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.domainjoinconnectors.item.DeviceManagementDomainJoinConnectorItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceManagementDomainJoinConnector;
import com.microsoft.graph.beta.models.DeviceManagementDomainJoinConnectorCollectionResponse;
...
public class DomainJoinConnectorsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link DomainJoinConnectorsRequestBuilder} and sets the default values.
    ...
    public DomainJoinConnectorsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/domainJoinConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DomainJoinConnectorsRequestBuilder} and sets the default values.
    ...
    public DomainJoinConnectorsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/domainJoinConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * A list of connector objects.
     * @return a {@link DeviceManagementDomainJoinConnectorCollectionResponse}
    ...
    public DeviceManagementDomainJoinConnectorCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, DeviceManagementDomainJoinConnectorCollectionResponse::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementDomainJoinConnector body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/domainJoinConnectors", pathParameters);
