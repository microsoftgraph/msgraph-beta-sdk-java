package com.microsoft.graph.beta.users.item.approleassignments.item;
...
public class AppRoleAssignmentItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AppRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignments/{appRoleAssignment%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AppRoleAssignmentItemRequestBuilder} and sets the default values.
    ...
    public AppRoleAssignmentItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignments/{appRoleAssignment%2Did}", rawUrl);
    }
    /**
     * Delete an appRoleAssignment that has been granted to a user.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/user-delete-approleassignments?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24expand,%24select}", pathParameters);
