package com.microsoft.graph.beta.shares.item.list.columns;
...
import com.microsoft.graph.beta.shares.item.list.columns.count.CountRequestBuilder;
import com.microsoft.graph.beta.shares.item.list.columns.item.ColumnDefinitionItemRequestBuilder;
