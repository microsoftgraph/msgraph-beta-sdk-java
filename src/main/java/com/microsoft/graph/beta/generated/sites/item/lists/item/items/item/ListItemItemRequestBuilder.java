package com.microsoft.graph.beta.sites.item.lists.item.items.item;

import com.microsoft.graph.beta.models.ListItem;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.createlink.CreateLinkRequestBuilder;
...
public class ListItemItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/listitem-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/listitem-get?view=graph-rest-beta">Find more info here</a>
     */
