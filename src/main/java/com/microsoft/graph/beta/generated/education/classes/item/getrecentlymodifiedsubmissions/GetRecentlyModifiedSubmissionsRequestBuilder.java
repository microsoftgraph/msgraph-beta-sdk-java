package com.microsoft.graph.beta.education.classes.item.getrecentlymodifiedsubmissions;
...
public class GetRecentlyModifiedSubmissionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetRecentlyModifiedSubmissionsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetRecentlyModifiedSubmissionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/getRecentlyModifiedSubmissions(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetRecentlyModifiedSubmissionsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetRecentlyModifiedSubmissionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/educationclass-getrecentlymodifiedsubmissions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public GetRecentlyModifiedSubmissionsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
