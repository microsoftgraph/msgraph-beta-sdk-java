...
public class AlertAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AlertAction} and sets the default values.
     */
    public AlertAction() {
     ...
     * @return a {@link AlertAction}
     */
    @jakarta.annotation.Nonnull
    public static AlertAction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getActionText() {
        return this.backingStore.get("actionText");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionLink", (n) -> { this.setActionLink(n.getStringValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("actionLink", this.getActionLink());
    ...
    public void setActionText(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("actionText", value);
    }
    /**
