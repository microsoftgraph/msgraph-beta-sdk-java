package com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout.horizontalsections;
...
import com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout.horizontalsections.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.pagetemplates.item.canvaslayout.horizontalsections.item.HorizontalSectionItemRequestBuilder;
...
public class HorizontalSectionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/horizontalSections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final HorizontalSection body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/horizontalSections", pathParameters);
