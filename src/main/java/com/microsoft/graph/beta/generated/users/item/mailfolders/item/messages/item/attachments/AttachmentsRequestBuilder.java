package com.microsoft.graph.beta.users.item.mailfolders.item.messages.item.attachments;
...
import com.microsoft.graph.beta.users.item.mailfolders.item.messages.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.messages.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.messages.item.attachments.item.AttachmentItemRequestBuilder;
