package com.microsoft.graph.beta.admin.configurationmanagement.configurationsnapshotjobs.item;
...
public class ConfigurationSnapshotJobItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ConfigurationSnapshotJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationSnapshotJobs/{configurationSnapshotJob%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ConfigurationSnapshotJobItemRequestBuilder} and sets the default values.
    ...
    public ConfigurationSnapshotJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationSnapshotJobs/{configurationSnapshotJob%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/configurationManagement/configurationSnapshotJobs/{configurationSnapshotJob%2Did}{?%24expand,%24select}", pathParameters);
