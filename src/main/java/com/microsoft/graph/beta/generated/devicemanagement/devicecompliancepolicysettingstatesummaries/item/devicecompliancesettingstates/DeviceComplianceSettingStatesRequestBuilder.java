package com.microsoft.graph.beta.devicemanagement.devicecompliancepolicysettingstatesummaries.item.devicecompliancesettingstates;

import com.microsoft.graph.beta.devicemanagement.devicecompliancepolicysettingstatesummaries.item.devicecompliancesettingstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.devicecompliancepolicysettingstatesummaries.item.devicecompliancesettingstates.item.DeviceComplianceSettingStateItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceComplianceSettingState;
import com.microsoft.graph.beta.models.DeviceComplianceSettingStateCollectionResponse;
...
public class DeviceComplianceSettingStatesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public DeviceComplianceSettingStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DeviceComplianceSettingStatesRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DeviceComplianceSettingStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public DeviceComplianceSettingStateCollectionResponse get() {
        return get(null);
    }
    /**
     * Get deviceComplianceSettingStates from deviceManagement
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceSettingState post(@jakarta.annotation.Nonnull final DeviceComplianceSettingState body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceSettingState post(@jakarta.annotation.Nonnull final DeviceComplianceSettingState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
