...
public class CloudFirewallDestinationIpAddress extends CloudFirewallDestinationAddress implements Parsable {
    /**
     * Instantiates a new {@link CloudFirewallDestinationIpAddress} and sets the default values.
     */
    public CloudFirewallDestinationIpAddress() {
        super();
        this.setOdataType("#microsoft.graph.networkaccess.cloudFirewallDestinationIpAddress");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link CloudFirewallDestinationIpAddress}
     */
    @jakarta.annotation.Nonnull
    public static CloudFirewallDestinationIpAddress createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CloudFirewallDestinationIpAddress();
    }
    /**
