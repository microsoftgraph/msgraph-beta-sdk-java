...
public class Settings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Boolean getHasGraphMailbox() {
        return this.backingStore.get("hasGraphMailbox");
    }
    /**
    ...
    public Boolean getHasLicense() {
        return this.backingStore.get("hasLicense");
    }
    /**
    ...
    public Boolean getHasOptedOut() {
        return this.backingStore.get("hasOptedOut");
    }
    /**
    ...
    public void setHasGraphMailbox(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("hasGraphMailbox", value);
    }
    /**
    ...
    public void setHasLicense(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("hasLicense", value);
    }
    /**
    ...
    public void setHasOptedOut(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("hasOptedOut", value);
    }
    /**
