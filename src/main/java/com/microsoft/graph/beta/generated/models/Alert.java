...
public class Alert extends Entity implements Parsable {
    ...
    /**
     * Gets the createdDateTime property value. Time at which the alert provider created the alert. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Required.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the securityResources property value. Resources related to current alert. For example, some alerts have the Azure Resource value.
    ...
    /**
     * Gets the tags property value. User-definable labels that can be applied to an alert and can serve as filter conditions (for example, &apos;HVA&apos;, &apos;SAW&apos;). Updatable.
     * @return a {@link java.util.List<String>}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the createdDateTime property value. Time at which the alert provider created the alert. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Required.
    ...
    /**
     * Sets the securityResources property value. Resources related to current alert. For example, some alerts have the Azure Resource value.
    ...
    /**
     * Sets the tags property value. User-definable labels that can be applied to an alert and can serve as filter conditions (for example, &apos;HVA&apos;, &apos;SAW&apos;). Updatable.
