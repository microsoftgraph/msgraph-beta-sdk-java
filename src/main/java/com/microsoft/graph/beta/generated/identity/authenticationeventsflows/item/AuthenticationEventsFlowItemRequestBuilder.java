package com.microsoft.graph.beta.identity.authenticationeventsflows.item;

import com.microsoft.graph.beta.identity.authenticationeventsflows.item.conditions.ConditionsRequestBuilder;
import com.microsoft.graph.beta.identity.authenticationeventsflows.item.graphexternalusersselfservicesignupeventsflow.GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder;
import com.microsoft.graph.beta.models.AuthenticationEventsFlow;
...
public class AuthenticationEventsFlowItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AuthenticationEventsFlowItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthenticationEventsFlowItemRequestBuilder} and sets the default values.
    ...
    public AuthenticationEventsFlowItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/authenticationeventsflow-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/authenticationeventsflow-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link AuthenticationEventsFlow}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/authenticationeventsflow-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}{?%24expand,%24select}", pathParameters);
