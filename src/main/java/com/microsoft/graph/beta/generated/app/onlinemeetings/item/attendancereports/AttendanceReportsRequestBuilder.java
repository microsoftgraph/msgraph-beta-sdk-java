package com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports;

import com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.item.MeetingAttendanceReportItemRequestBuilder;
...
public class AttendanceReportsRequestBuilder extends BaseRequestBuilder {
    ...
    public AttendanceReportsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AttendanceReportsRequestBuilder and sets the default values.
    ...
    public AttendanceReportsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
