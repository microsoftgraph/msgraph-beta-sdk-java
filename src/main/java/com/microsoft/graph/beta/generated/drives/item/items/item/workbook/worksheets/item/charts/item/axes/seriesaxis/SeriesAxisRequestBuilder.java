package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.format.FormatRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.majorgridlines.MajorGridlinesRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.minorgridlines.MinorGridlinesRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.title.TitleRequestBuilder;
