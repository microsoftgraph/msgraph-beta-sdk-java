package com.microsoft.graph.beta.planner.plans.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerPlan;
import com.microsoft.graph.beta.planner.plans.item.archive.ArchiveRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.buckets.BucketsRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.details.DetailsRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.getusagerights.GetUsageRightsRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.movetocontainer.MoveToContainerRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.tasks.TasksRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.unarchive.UnarchiveRequestBuilder;
...
public class PlannerPlanItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PlannerPlanItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PlannerPlanItemRequestBuilder} and sets the default values.
    ...
    public PlannerPlanItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}", rawUrl);
    }
    /**
     * Delete a plannerPlan object.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannerplan-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannerplan-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link PlannerPlan}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/plannerplan-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/planner/plans/{plannerPlan%2Did}{?%24expand,%24select}", pathParameters);
