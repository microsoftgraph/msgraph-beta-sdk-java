...
public class BaselineResource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BaselineResource} and sets the default values.
     */
     ...
     * @return a {@link BaselineResource}
     */
    @jakarta.annotation.Nonnull
    public static BaselineResource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BaselineResource();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("properties", (n) -> { this.setProperties(n.getObjectValue(OpenComplexDictionaryType::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public OpenComplexDictionaryType getProperties() {
     ...
     */
    public void setProperties(@jakarta.annotation.Nullable final OpenComplexDictionaryType value) {
