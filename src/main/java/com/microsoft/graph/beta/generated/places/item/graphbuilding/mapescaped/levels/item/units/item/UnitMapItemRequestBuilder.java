package com.microsoft.graph.beta.places.item.graphbuilding.mapescaped.levels.item.units.item;
...
public class UnitMapItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/unitmap-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link UnitMap}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/unitmap-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
