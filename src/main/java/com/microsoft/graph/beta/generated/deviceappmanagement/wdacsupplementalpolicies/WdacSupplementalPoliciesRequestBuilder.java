...
public class WdacSupplementalPoliciesRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsDefenderApplicationControlSupplementalPolicy post(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsDefenderApplicationControlSupplementalPolicy post(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public WdacSupplementalPoliciesRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
