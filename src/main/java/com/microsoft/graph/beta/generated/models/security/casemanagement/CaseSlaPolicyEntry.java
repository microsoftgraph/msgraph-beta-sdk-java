...
public class CaseSlaPolicyEntry implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CaseSlaPolicyEntry} and sets the default values.
     */
     ...
     * @return a {@link CaseSlaPolicyEntry}
     */
    @jakarta.annotation.Nonnull
    public static CaseSlaPolicyEntry createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public OffsetDateTime getBreachTargetDateTime() {
        return this.backingStore.get("breachTargetDateTime");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("breachTargetDateTime", (n) -> { this.setBreachTargetDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(CaseSlaPolicyStatus::forValue)); });
     ...
     * @return a {@link CaseSlaPolicyStatus}
     */
    @jakarta.annotation.Nullable
    public CaseSlaPolicyStatus getStatus() {
     ...
     * @param value Value to set for the breachTargetDateTime property.
     */
    public void setBreachTargetDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("breachTargetDateTime", value);
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final CaseSlaPolicyStatus value) {
