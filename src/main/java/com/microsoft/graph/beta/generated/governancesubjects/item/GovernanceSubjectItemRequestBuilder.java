...
public class GovernanceSubjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GovernanceSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceSubjects/{governanceSubject%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GovernanceSubjectItemRequestBuilder and sets the default values.
    ...
    public GovernanceSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceSubjects/{governanceSubject%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
