package com.microsoft.graph.beta.devicemanagement.templates;

import com.microsoft.graph.beta.devicemanagement.templates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.importoffice365deviceconfigurationpolicies.ImportOffice365DeviceConfigurationPoliciesRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.templates.item.DeviceManagementTemplateItemRequestBuilder;
...
public class TemplatesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public DeviceManagementTemplateItemRequestBuilder byDeviceManagementTemplateId(@jakarta.annotation.Nonnull final String deviceManagementTemplateId) {
        Objects.requireNonNull(deviceManagementTemplateId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("deviceManagementTemplate%2Did", deviceManagementTemplateId);
    ...
    public TemplatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TemplatesRequestBuilder} and sets the default values.
    ...
    public TemplatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/templates", pathParameters);
