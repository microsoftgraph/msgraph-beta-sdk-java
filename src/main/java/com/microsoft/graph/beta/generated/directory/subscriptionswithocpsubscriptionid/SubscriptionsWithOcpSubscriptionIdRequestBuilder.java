package com.microsoft.graph.beta.directory.subscriptionswithocpsubscriptionid;
...
public class SubscriptionsWithOcpSubscriptionIdRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link SubscriptionsWithOcpSubscriptionIdRequestBuilder} and sets the default values.
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/directory/subscriptions(ocpSubscriptionId='{ocpSubscriptionId}')", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final CompanySubscription body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/directory/subscriptions(ocpSubscriptionId='{ocpSubscriptionId}')", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public SubscriptionsWithOcpSubscriptionIdRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
