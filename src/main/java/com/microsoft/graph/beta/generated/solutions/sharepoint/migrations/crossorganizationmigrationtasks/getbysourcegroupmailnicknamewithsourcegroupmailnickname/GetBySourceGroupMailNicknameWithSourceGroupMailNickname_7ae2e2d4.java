...
public class GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @param sourceGroupMailNickname Usage: sourceGroupMailNickname=&apos;{sourceGroupMailNickname}&apos;
     */
    public GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String sourceGroupMailNickname) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4(rawUrl, requestAdapter);
    }
    /**
