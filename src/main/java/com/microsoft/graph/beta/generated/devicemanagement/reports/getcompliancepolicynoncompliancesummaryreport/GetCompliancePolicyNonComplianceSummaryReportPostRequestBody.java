package com.microsoft.graph.beta.devicemanagement.reports.getcompliancepolicynoncompliancesummaryreport;
...
public class GetCompliancePolicyNonComplianceSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetCompliancePolicyNonComplianceSummaryReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetCompliancePolicyNonComplianceSummaryReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetCompliancePolicyNonComplianceSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
