package com.microsoft.graph.beta.identitygovernance.permissionsanalytics.gcp;

import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.gcp.findings.FindingsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.gcp.permissionscreepindexdistributions.PermissionsCreepIndexDistributionsRequestBuilder;
...
public class GcpRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PermissionsAnalytics body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp", pathParameters);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link GcpRequestBuilder}
     */
    @jakarta.annotation.Nonnull
