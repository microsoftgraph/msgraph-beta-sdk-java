package com.microsoft.graph.beta.teamwork.deletedteams.item.channels.getallmessages;
...
public class GetAllMessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public GetAllMessagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/getAllMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,model*}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllMessagesRequestBuilder} and sets the default values.
    ...
    public GetAllMessagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/getAllMessages(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,model*}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/channel-getallmessages?view=graph-rest-beta">Find more info here</a>
     */
