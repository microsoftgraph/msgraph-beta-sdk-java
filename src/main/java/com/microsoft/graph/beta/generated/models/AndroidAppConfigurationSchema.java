...
public class AndroidAppConfigurationSchema extends Entity implements Parsable {
    /**
     * Instantiates a new {@link AndroidAppConfigurationSchema} and sets the default values.
     */
    ...
    public static AndroidAppConfigurationSchema createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AndroidAppConfigurationSchema();
    }
    /**
     ...
     * @return a {@link java.util.List<AppConfigurationSchemaItemType>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<AppConfigurationSchemaItemType> getNestedSchemaItems() {
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<AppConfigurationSchemaItemType> getSchemaItems() {
     ...
     */
    public void setNestedSchemaItems(@jakarta.annotation.Nullable final java.util.List<AppConfigurationSchemaItemType> value) {
     ...
     */
    public void setSchemaItems(@jakarta.annotation.Nullable final java.util.List<AppConfigurationSchemaItemType> value) {
