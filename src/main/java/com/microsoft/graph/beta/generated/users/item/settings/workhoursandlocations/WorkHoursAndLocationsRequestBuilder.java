package com.microsoft.graph.beta.users.item.settings.workhoursandlocations;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.WorkHoursAndLocationsSetting;
import com.microsoft.graph.beta.users.item.settings.workhoursandlocations.occurrences.OccurrencesRequestBuilder;
import com.microsoft.graph.beta.users.item.settings.workhoursandlocations.occurrencesviewwithstartdatetimewithenddatetime.OccurrencesViewWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class WorkHoursAndLocationsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/settings/workHoursAndLocations{?%24expand,%24select}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final WorkHoursAndLocationsSetting body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/users/{user%2Did}/settings/workHoursAndLocations", pathParameters);
