package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp.assignments.AssignmentsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp.categories.CategoriesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp.contentversions.ContentVersionsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphwin32lobapp.relationships.RelationshipsRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Win32LobApp;
...
public class GraphWin32LobAppRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphWin32LobAppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphWin32LobAppRequestBuilder} and sets the default values.
    ...
    public GraphWin32LobAppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp{?%24expand,%24select}", rawUrl);
    }
    /**
