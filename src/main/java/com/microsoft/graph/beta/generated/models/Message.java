...
public class Message extends OutlookItem implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("mentionsPreview", (n) -> { this.setMentionsPreview(n.getObjectValue(MentionsPreview::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("unsubscribeData", (n) -> { this.setUnsubscribeData(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("unsubscribeEnabled", (n) -> { this.setUnsubscribeEnabled(n.getBooleanValue()); });
    ...
    public MentionsPreview getMentionsPreview() {
        return this.backingStore.get("mentionsPreview");
    }
    /**
    ...
    public java.util.List<String> getUnsubscribeData() {
        return this.backingStore.get("unsubscribeData");
    }
    /**
    ...
    public Boolean getUnsubscribeEnabled() {
        return this.backingStore.get("unsubscribeEnabled");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfPrimitiveValues("unsubscribeData", this.getUnsubscribeData());
        writer.writeBooleanValue("unsubscribeEnabled", this.getUnsubscribeEnabled());
    ...
    public void setMentionsPreview(@jakarta.annotation.Nullable final MentionsPreview value) {
        this.backingStore.set("mentionsPreview", value);
    }
    /**
    ...
    public void setUnsubscribeData(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("unsubscribeData", value);
    }
    /**
    ...
    public void setUnsubscribeEnabled(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("unsubscribeEnabled", value);
    }
    /**
