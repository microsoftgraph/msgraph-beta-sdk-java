package com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.setorder;
...
public class SetOrderRequestBuilder extends BaseRequestBuilder {
    ...
    public SetOrderRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/setOrder", pathParameters);
    }
    /**
     * Instantiates a new {@link SetOrderRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-setorder?view=graph-rest-beta">Find more info here</a>
     */
