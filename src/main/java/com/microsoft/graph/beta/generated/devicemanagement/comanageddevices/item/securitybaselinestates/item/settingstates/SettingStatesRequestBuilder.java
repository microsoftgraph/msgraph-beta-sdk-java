package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.securitybaselinestates.item.settingstates;

import com.microsoft.graph.beta.devicemanagement.comanageddevices.item.securitybaselinestates.item.settingstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.comanageddevices.item.securitybaselinestates.item.settingstates.item.SecurityBaselineSettingStateItemRequestBuilder;
...
public class SettingStatesRequestBuilder extends BaseRequestBuilder {
    ...
    public SettingStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SettingStatesRequestBuilder} and sets the default values.
    ...
    public SettingStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SecurityBaselineSettingState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates", pathParameters);
