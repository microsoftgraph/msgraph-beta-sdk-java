...
public class AffectedResource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AffectedResource} and sets the default values.
     */
     ...
     * @return a {@link AffectedResource}
     */
    @jakarta.annotation.Nonnull
    public static AffectedResource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
