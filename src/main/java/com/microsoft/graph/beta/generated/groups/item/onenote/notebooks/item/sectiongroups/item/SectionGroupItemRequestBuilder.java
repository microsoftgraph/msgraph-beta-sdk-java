package com.microsoft.graph.beta.groups.item.onenote.notebooks.item.sectiongroups.item;

import com.microsoft.graph.beta.groups.item.onenote.notebooks.item.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.notebooks.item.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.notebooks.item.sectiongroups.item.sections.SectionsRequestBuilder;
