package com.microsoft.graph.beta.groups.item.team.channels.item.messages;

import com.microsoft.graph.beta.groups.item.team.channels.item.messages.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.messages.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.messages.forwardtochat.ForwardToChatRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.messages.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.beta.groups.item.team.channels.item.messages.replywithquote.ReplyWithQuoteRequestBuilder;
