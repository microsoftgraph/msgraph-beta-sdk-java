package com.microsoft.graph.beta.users.item.outlook.taskgroups.item.taskfolders.item.tasks.item.complete;
...
public class CompletePostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new CompletePostResponse and sets the default values.
     */
