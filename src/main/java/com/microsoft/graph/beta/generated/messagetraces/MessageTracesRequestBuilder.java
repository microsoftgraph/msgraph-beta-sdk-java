package com.microsoft.graph.beta.messagetraces;

import com.microsoft.graph.beta.messagetraces.count.CountRequestBuilder;
import com.microsoft.graph.beta.messagetraces.item.MessageTraceItemRequestBuilder;
...
public class MessageTracesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/messageTraces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
