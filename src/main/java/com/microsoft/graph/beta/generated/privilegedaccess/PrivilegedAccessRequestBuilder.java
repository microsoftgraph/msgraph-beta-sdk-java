package com.microsoft.graph.beta.privilegedaccess;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrivilegedAccess;
import com.microsoft.graph.beta.models.PrivilegedAccessCollectionResponse;
import com.microsoft.graph.beta.privilegedaccess.count.CountRequestBuilder;
import com.microsoft.graph.beta.privilegedaccess.item.PrivilegedAccessItemRequestBuilder;
...
public class PrivilegedAccessRequestBuilder extends BaseRequestBuilder {
    ...
    public PrivilegedAccessRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedAccessRequestBuilder} and sets the default values.
    ...
    public PrivilegedAccessRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedAccess{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public PrivilegedAccessCollectionResponse get() {
        return get(null);
    }
    /**
     * Get entities from privilegedAccess
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegedAccessCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, PrivilegedAccessCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegedAccess post(@jakarta.annotation.Nonnull final PrivilegedAccess body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PrivilegedAccess post(@jakarta.annotation.Nonnull final PrivilegedAccess body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PrivilegedAccess body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/privilegedAccess", pathParameters);
