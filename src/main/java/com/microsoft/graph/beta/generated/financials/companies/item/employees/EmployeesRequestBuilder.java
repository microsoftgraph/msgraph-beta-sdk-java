package com.microsoft.graph.beta.financials.companies.item.employees;

import com.microsoft.graph.beta.financials.companies.item.employees.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.employees.item.EmployeeItemRequestBuilder;
import com.microsoft.graph.beta.models.Employee;
import com.microsoft.graph.beta.models.EmployeeCollectionResponse;
...
public class EmployeesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/financials/companies/{company%2Did}/employees{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
