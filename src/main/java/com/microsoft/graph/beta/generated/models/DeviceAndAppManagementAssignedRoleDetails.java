...
public class DeviceAndAppManagementAssignedRoleDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeviceAndAppManagementAssignedRoleDetails} and sets the default values.
     */
    ...
    public java.util.List<String> getRoleAssignmentIds() {
        return this.backingStore.get("roleAssignmentIds");
    }
    /**
    ...
    public java.util.List<String> getRoleDefinitionIds() {
        return this.backingStore.get("roleDefinitionIds");
    }
    /**
    ...
    public void setRoleAssignmentIds(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("roleAssignmentIds", value);
    }
    /**
    ...
    public void setRoleDefinitionIds(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("roleDefinitionIds", value);
    }
}
