...
public class ExactDataMatchStoreColumn implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ExactDataMatchStoreColumn} and sets the default values.
     */
     ...
     * @return a {@link ExactDataMatchStoreColumn}
     */
    @jakarta.annotation.Nonnull
    ...
    public java.util.List<String> getIgnoredDelimiters() {
        return this.backingStore.get("ignoredDelimiters");
    }
    /**
    ...
    public Boolean getIsCaseInsensitive() {
        return this.backingStore.get("isCaseInsensitive");
    }
    /**
    ...
    public void setIgnoredDelimiters(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("ignoredDelimiters", value);
    }
    /**
    ...
    public void setIsCaseInsensitive(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("isCaseInsensitive", value);
    }
    /**
