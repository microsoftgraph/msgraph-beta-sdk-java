package com.microsoft.graph.beta.users.item.onenote;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Onenote;
import com.microsoft.graph.beta.users.item.onenote.notebooks.NotebooksRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.resources.ResourcesRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.beta.users.item.onenote.sections.SectionsRequestBuilder;
...
public class OnenoteRequestBuilder extends BaseRequestBuilder {
    ...
    public OnenoteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote", pathParameters);
    }
    /**
     * Instantiates a new {@link OnenoteRequestBuilder} and sets the default values.
    ...
    public OnenoteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/onenote{?%24expand,%24select}", pathParameters);
