package com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions;
...
import com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions.count.CountRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/listitem-list-documentsetversions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/listitem-post-documentsetversions?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
