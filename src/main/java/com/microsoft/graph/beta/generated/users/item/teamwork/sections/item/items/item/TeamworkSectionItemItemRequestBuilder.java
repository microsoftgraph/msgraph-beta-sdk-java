package com.microsoft.graph.beta.users.item.teamwork.sections.item.items.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamworkSectionItem;
import com.microsoft.graph.beta.users.item.teamwork.sections.item.items.item.move.MoveRequestBuilder;
...
public class TeamworkSectionItemItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public TeamworkSectionItem get() {
        return get(null);
    }
    /**
     * The items (chats, channels, meetings, or communities) organized within the section.
     ...
     */
    @jakarta.annotation.Nullable
    public TeamworkSectionItem get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public TeamworkSectionItem patch(@jakarta.annotation.Nonnull final TeamworkSectionItem body) {
     ...
     */
    @jakarta.annotation.Nullable
    public TeamworkSectionItem patch(@jakarta.annotation.Nonnull final TeamworkSectionItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/teamwork/sections/{teamworkSection%2Did}/items/{teamworkSectionItem%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TeamworkSectionItem body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TeamworkSectionItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public TeamworkSectionItemItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new TeamworkSectionItemItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
