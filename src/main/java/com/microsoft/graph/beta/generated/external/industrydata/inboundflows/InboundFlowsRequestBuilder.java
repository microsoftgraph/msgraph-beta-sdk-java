package com.microsoft.graph.beta.external.industrydata.inboundflows;

import com.microsoft.graph.beta.external.industrydata.inboundflows.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.industrydata.inboundflows.item.InboundFlowItemRequestBuilder;
import com.microsoft.graph.beta.models.industrydata.InboundFlow;
import com.microsoft.graph.beta.models.industrydata.InboundFlowCollectionResponse;
...
public class InboundFlowsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-inboundflow-list?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/industrydata-inboundapiflow-post?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/external/industryData/inboundFlows{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
