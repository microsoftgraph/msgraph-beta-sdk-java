package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.versions.item.tasks.item.taskprocessingresults;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.versions.item.tasks.item.taskprocessingresults.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.versions.item.tasks.item.taskprocessingresults.item.TaskProcessingResultItemRequestBuilder;
