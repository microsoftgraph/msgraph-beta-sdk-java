package com.microsoft.graph.beta.devicemanagement.virtualendpoint.snapshots.getstorageaccountswithsubscriptionid;
...
public class GetStorageAccountsWithSubscriptionIdRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GetStorageAccountsWithSubscriptionIdRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String subscriptionId) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/getStorageAccounts(subscriptionId='{subscriptionId}'){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters);
        this.pathParameters.put("subscriptionId", subscriptionId);
    }
    /**
     * Instantiates a new GetStorageAccountsWithSubscriptionIdRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetStorageAccountsWithSubscriptionIdRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/getStorageAccounts(subscriptionId='{subscriptionId}'){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl);
    }
    /**
     * Invoke function getStorageAccounts
     * @return a GetStorageAccountsWithSubscriptionIdGetResponse
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public GetStorageAccountsWithSubscriptionIdRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
