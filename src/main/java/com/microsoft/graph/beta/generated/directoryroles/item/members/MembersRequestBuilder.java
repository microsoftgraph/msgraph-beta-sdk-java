package com.microsoft.graph.beta.directoryroles.item.members;

import com.microsoft.graph.beta.directoryroles.item.members.count.CountRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.ref.RefRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.directoryRoles.item.members.item collection
