package com.microsoft.graph.beta.users.item.authentication.resourceaccountkeyauthenticationmethods.item.device;
...
public class DeviceRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/resourceAccountKeyAuthenticationMethods/{resourceAccountKeyAuthenticationMethod%2Did}/device{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceRequestBuilder} and sets the default values.
    ...
    public DeviceRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/resourceAccountKeyAuthenticationMethods/{resourceAccountKeyAuthenticationMethod%2Did}/device{?%24expand,%24select}", rawUrl);
    }
    /**
