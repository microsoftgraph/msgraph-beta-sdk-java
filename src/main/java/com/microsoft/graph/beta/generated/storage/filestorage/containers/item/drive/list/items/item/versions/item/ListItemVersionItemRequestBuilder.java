package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.list.items.item.versions.item;

import com.microsoft.graph.beta.models.ListItemVersion;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.list.items.item.versions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.containers.item.drive.list.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
