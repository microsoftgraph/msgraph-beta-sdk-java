package com.microsoft.graph.beta.app.calls.item.stoptranscription;
...
public class StopTranscriptionPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link StopTranscriptionPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link StopTranscriptionPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static StopTranscriptionPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new StopTranscriptionPostRequestBody();
    }
    /**
