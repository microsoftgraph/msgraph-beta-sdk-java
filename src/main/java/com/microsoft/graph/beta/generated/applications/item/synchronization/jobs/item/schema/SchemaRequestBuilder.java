package com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema;

import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.directories.DirectoriesRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.functions.FunctionsRequestBuilder;
import com.microsoft.graph.beta.applications.item.synchronization.jobs.item.schema.parseexpression.ParseExpressionRequestBuilder;
...
public class SchemaRequestBuilder extends BaseRequestBuilder {
    ...
    public SchemaRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema", pathParameters);
    }
    /**
     * Instantiates a new {@link SchemaRequestBuilder} and sets the default values.
    ...
    public SchemaRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema{?%24expand,%24select}", pathParameters);
