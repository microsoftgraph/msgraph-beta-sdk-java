package com.microsoft.graph.beta.devicemanagement.windowsautopilotdeploymentprofiles.item.assigneddevices.item.deploymentprofile;
...
public class DeploymentProfileRequestBuilder extends BaseRequestBuilder {
    ...
    public DeploymentProfileRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}/deploymentProfile{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new DeploymentProfileRequestBuilder and sets the default values.
    ...
    public DeploymentProfileRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}/deploymentProfile{?%24expand,%24select}", rawUrl);
    }
    /**
