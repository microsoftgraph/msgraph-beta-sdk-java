...
public class SettingValue implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SettingValue} and sets the default values.
     */
    public SettingValue() {
     ...
     * @return a {@link SettingValue}
     */
    @jakarta.annotation.Nonnull
    public static SettingValue createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
