package com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.events.item.instances.item.attachments;
...
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.events.item.instances.item.attachments.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.events.item.instances.item.attachments.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.events.item.instances.item.attachments.item.AttachmentItemRequestBuilder;
