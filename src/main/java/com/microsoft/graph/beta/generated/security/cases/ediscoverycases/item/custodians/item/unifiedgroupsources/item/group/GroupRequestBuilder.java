package com.microsoft.graph.beta.security.cases.ediscoverycases.item.custodians.item.unifiedgroupsources.item.group;

import com.microsoft.graph.beta.models.Group;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.security.cases.ediscoverycases.item.custodians.item.unifiedgroupsources.item.group.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class GroupRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}/group{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new GroupRequestBuilder and sets the default values.
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}/group{?%24expand,%24select}", rawUrl);
    }
    /**
     * Represents a group.
     * @return a Group
