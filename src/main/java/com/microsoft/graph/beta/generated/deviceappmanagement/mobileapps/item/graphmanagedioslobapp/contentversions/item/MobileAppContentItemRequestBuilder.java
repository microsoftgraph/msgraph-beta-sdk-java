package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedioslobapp.contentversions.item;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedioslobapp.contentversions.item.containedapps.ContainedAppsRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedioslobapp.contentversions.item.files.FilesRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedioslobapp.contentversions.item.scripts.ScriptsRequestBuilder;
...
public class MobileAppContentItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MobileAppContentItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp/contentVersions/{mobileAppContent%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link MobileAppContentItemRequestBuilder} and sets the default values.
    ...
    public MobileAppContentItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp/contentVersions/{mobileAppContent%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedIOSLobApp/contentVersions/{mobileAppContent%2Did}{?%24expand,%24select}", pathParameters);
