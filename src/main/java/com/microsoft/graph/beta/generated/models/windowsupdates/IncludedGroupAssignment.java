...
public class IncludedGroupAssignment extends GroupAssignment implements Parsable {
    /**
     * Instantiates a new {@link IncludedGroupAssignment} and sets the default values.
     */
    public IncludedGroupAssignment() {
        super();
        this.setOdataType("#microsoft.graph.windowsUpdates.includedGroupAssignment");
    }
    /**
    ...
    public static IncludedGroupAssignment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new IncludedGroupAssignment();
    }
    /**
