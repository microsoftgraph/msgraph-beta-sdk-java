...
public class KeyRealValuePair extends KeyTypedValuePair implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getObjectValue(KeyRealValuePairValue::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the value property value. The real (floating-point) value of the key-value pair.
     * @return a {@link KeyRealValuePairValue}
     */
    @jakarta.annotation.Nullable
    public KeyRealValuePairValue getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final KeyRealValuePairValue value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class KeyRealValuePairValue implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link KeyRealValuePairValue} and sets the default values.
         */
        public KeyRealValuePairValue() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static KeyRealValuePairValue createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final KeyRealValuePairValue result = new KeyRealValuePairValue();
