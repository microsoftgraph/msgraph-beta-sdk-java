package com.microsoft.graph.beta.users.item.manageddevices.item.reprovisioncloudpc;
...
public class ReprovisionCloudPcRequestBuilder extends BaseRequestBuilder {
    ...
    public ReprovisionCloudPcRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/reprovisionCloudPc", pathParameters);
    }
    /**
     * Instantiates a new {@link ReprovisionCloudPcRequestBuilder} and sets the default values.
