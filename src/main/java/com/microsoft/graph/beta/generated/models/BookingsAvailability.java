...
public class BookingsAvailability implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BookingsAvailability} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static BookingsAvailability createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link BookingsServiceAvailabilityType}
     */
    @jakarta.annotation.Nullable
    public BookingsServiceAvailabilityType getAvailabilityType() {
        return this.backingStore.get("availabilityType");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("availabilityType", (n) -> { this.setAvailabilityType(n.getEnumValue(BookingsServiceAvailabilityType::forValue)); });
     ...
     */
    public void setAvailabilityType(@jakarta.annotation.Nullable final BookingsServiceAvailabilityType value) {
        this.backingStore.set("availabilityType", value);
    }
    /**
