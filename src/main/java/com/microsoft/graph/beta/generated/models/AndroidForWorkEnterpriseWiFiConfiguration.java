...
public class AndroidForWorkEnterpriseWiFiConfiguration extends AndroidForWorkWiFiConfiguration implements Parsable {
     ...
     * @return a AndroidForWorkEnterpriseWiFiConfigurationAuthenticationMethod
     */
    @jakarta.annotation.Nullable
    public AndroidForWorkEnterpriseWiFiConfigurationAuthenticationMethod getAuthenticationMethod() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationMethod", (n) -> { this.setAuthenticationMethod(n.getEnumValue(AndroidForWorkEnterpriseWiFiConfigurationAuthenticationMethod::forValue)); });
        ...
        deserializerMap.put("innerAuthenticationProtocolForEapTtls", (n) -> { this.setInnerAuthenticationProtocolForEapTtls(n.getEnumValue(AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls::forValue)); });
        deserializerMap.put("innerAuthenticationProtocolForPeap", (n) -> { this.setInnerAuthenticationProtocolForPeap(n.getEnumValue(AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap::forValue)); });
     ...
     * @return a AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls
     */
    @jakarta.annotation.Nullable
    public AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls getInnerAuthenticationProtocolForEapTtls() {
     ...
     * @return a AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap
     */
    @jakarta.annotation.Nullable
    public AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap getInnerAuthenticationProtocolForPeap() {
     ...
     */
    public void setAuthenticationMethod(@jakarta.annotation.Nullable final AndroidForWorkEnterpriseWiFiConfigurationAuthenticationMethod value) {
     ...
     */
    public void setInnerAuthenticationProtocolForEapTtls(@jakarta.annotation.Nullable final AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls value) {
     ...
     */
    public void setInnerAuthenticationProtocolForPeap(@jakarta.annotation.Nullable final AndroidForWorkEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap value) {
