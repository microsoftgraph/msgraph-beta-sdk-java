package com.microsoft.graph.beta.solutions.backuprestore.mailboxprotectionunitsbulkadditionjobs;

import com.microsoft.graph.beta.models.MailboxProtectionUnitsBulkAdditionJob;
import com.microsoft.graph.beta.models.MailboxProtectionUnitsBulkAdditionJobCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.solutions.backuprestore.mailboxprotectionunitsbulkadditionjobs.count.CountRequestBuilder;
import com.microsoft.graph.beta.solutions.backuprestore.mailboxprotectionunitsbulkadditionjobs.item.MailboxProtectionUnitsBulkAdditionJobItemRequestBuilder;
...
public class MailboxProtectionUnitsBulkAdditionJobsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxProtectionUnitsBulkAdditionJob post(@jakarta.annotation.Nonnull final MailboxProtectionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nullable
    public MailboxProtectionUnitsBulkAdditionJob post(@jakarta.annotation.Nonnull final MailboxProtectionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/solutions/backupRestore/mailboxProtectionUnitsBulkAdditionJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxProtectionUnitsBulkAdditionJob body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MailboxProtectionUnitsBulkAdditionJob body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/solutions/backupRestore/mailboxProtectionUnitsBulkAdditionJobs", pathParameters);
