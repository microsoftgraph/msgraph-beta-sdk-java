package com.microsoft.graph.beta.financials.companies.item.salesinvoices.item.salesinvoicelines;

import com.microsoft.graph.beta.financials.companies.item.salesinvoices.item.salesinvoicelines.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salesinvoices.item.salesinvoicelines.item.SalesInvoiceLineItemRequestBuilder;
...
public class SalesInvoiceLinesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SalesInvoiceLinesRequestBuilder} and sets the default values.
    ...
    public SalesInvoiceLinesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/salesInvoiceLines{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link SalesInvoiceLinesRequestBuilder} and sets the default values.
    ...
    public SalesInvoiceLinesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/salesInvoiceLines{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
