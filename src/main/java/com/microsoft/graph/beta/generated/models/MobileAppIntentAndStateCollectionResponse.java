...
public class MobileAppIntentAndStateCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link MobileAppIntentAndStateCollectionResponse} and sets the default values.
     */
    ...
    public static MobileAppIntentAndStateCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<MobileAppIntentAndState> value) {
