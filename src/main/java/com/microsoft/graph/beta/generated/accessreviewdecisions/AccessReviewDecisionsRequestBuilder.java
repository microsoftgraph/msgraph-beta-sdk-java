package com.microsoft.graph.beta.accessreviewdecisions;

import com.microsoft.graph.beta.accessreviewdecisions.count.CountRequestBuilder;
import com.microsoft.graph.beta.accessreviewdecisions.item.AccessReviewDecisionItemRequestBuilder;
...
public class AccessReviewDecisionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AccessReviewDecisionsRequestBuilder} and sets the default values.
    ...
    public AccessReviewDecisionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviewDecisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewDecisionsRequestBuilder} and sets the default values.
    ...
    public AccessReviewDecisionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/accessReviewDecisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
