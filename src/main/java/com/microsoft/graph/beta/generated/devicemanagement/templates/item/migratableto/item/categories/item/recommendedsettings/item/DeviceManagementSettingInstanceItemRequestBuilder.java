package com.microsoft.graph.beta.devicemanagement.templates.item.migratableto.item.categories.item.recommendedsettings.item;
...
public class DeviceManagementSettingInstanceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementSettingInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo/{deviceManagementTemplate%2Did1}/categories/{deviceManagementTemplateSettingCategory%2Did}/recommendedSettings/{deviceManagementSettingInstance%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceManagementSettingInstanceItemRequestBuilder} and sets the default values.
    ...
    public DeviceManagementSettingInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo/{deviceManagementTemplate%2Did1}/categories/{deviceManagementTemplateSettingCategory%2Did}/recommendedSettings/{deviceManagementSettingInstance%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
