package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.minorgridlines;

import com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.charts.item.axes.seriesaxis.minorgridlines.format.FormatRequestBuilder;
