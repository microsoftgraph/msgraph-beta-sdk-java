package com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies;
...
import com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies.forwardtochat.ForwardToChatRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.messages.item.replies.replywithquote.ReplyWithQuoteRequestBuilder;
...
public class RepliesRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/chatmessage-list-replies?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/chatmessage-post-replies?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
