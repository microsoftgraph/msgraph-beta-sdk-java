package com.microsoft.graph.beta.users.item.sendmail;
...
public class SendMailPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link SendMailPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SendMailPostRequestBody}
     */
    @jakarta.annotation.Nonnull
