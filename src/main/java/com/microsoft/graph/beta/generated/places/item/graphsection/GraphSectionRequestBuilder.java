package com.microsoft.graph.beta.places.item.graphsection;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Section;
import com.microsoft.graph.beta.places.item.graphsection.checkins.CheckInsRequestBuilder;
import com.microsoft.graph.beta.places.item.graphsection.children.ChildrenRequestBuilder;
...
public class GraphSectionRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphSectionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.section{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphSectionRequestBuilder} and sets the default values.
    ...
    public GraphSectionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.section{?%24expand,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public Section get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
