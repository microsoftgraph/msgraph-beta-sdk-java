package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.runs.item.userprocessingresults.item.taskprocessingresults.item.subject.serviceprovisioningerrors.count;
