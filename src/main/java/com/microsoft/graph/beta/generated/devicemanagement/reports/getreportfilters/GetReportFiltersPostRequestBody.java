package com.microsoft.graph.beta.devicemanagement.reports.getreportfilters;
...
public class GetReportFiltersPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetReportFiltersPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetReportFiltersPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetReportFiltersPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
