package com.microsoft.graph.beta.tenantrelationships.managedtenants.managementactiontenantdeploymentstatuses;

import com.microsoft.graph.beta.models.managedtenants.ManagementActionTenantDeploymentStatus;
import com.microsoft.graph.beta.models.managedtenants.ManagementActionTenantDeploymentStatusCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.managementactiontenantdeploymentstatuses.count.CountRequestBuilder;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.managementactiontenantdeploymentstatuses.item.ManagementActionTenantDeploymentStatusItemRequestBuilder;
import com.microsoft.graph.beta.tenantrelationships.managedtenants.managementactiontenantdeploymentstatuses.microsoftgraphmanagedtenantschangedeploymentstatus.MicrosoftGraphManagedTenantsChangeDeploymentStatusRequestBuilder;
...
public class ManagementActionTenantDeploymentStatusesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ManagementActionTenantDeploymentStatusesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ManagementActionTenantDeploymentStatusesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-managementactiontenantdeploymentstatuses?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    public ManagementActionTenantDeploymentStatusCollectionResponse get() {
        return get(null);
    }
    /**
     * Get a list of the managementActionTenantDeploymentStatus objects and their properties.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
