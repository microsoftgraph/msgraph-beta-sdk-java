package com.microsoft.graph.beta.devicemanagement.reports.getconfigurationsettingdetailsreport;
...
public class GetConfigurationSettingDetailsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetConfigurationSettingDetailsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetConfigurationSettingDetailsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetConfigurationSettingDetailsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
