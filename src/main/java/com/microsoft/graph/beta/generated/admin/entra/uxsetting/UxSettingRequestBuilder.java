package com.microsoft.graph.beta.admin.entra.uxsetting;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UxSetting;
...
public class UxSettingRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/entra/uxSetting{?%24expand,%24select}", pathParameters);
