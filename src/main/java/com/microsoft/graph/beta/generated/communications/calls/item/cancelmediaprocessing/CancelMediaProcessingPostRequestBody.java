...
public class CancelMediaProcessingPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CancelMediaProcessingPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CancelMediaProcessingPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static CancelMediaProcessingPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
