package com.microsoft.graph.beta.reports.partners.billing.usage;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.partners.billing.AzureUsage;
import com.microsoft.graph.beta.reports.partners.billing.usage.billed.BilledRequestBuilder;
import com.microsoft.graph.beta.reports.partners.billing.usage.unbilled.UnbilledRequestBuilder;
...
public class UsageRequestBuilder extends BaseRequestBuilder {
    ...
    public UsageRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/partners/billing/usage{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UsageRequestBuilder and sets the default values.
    ...
    public UsageRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/partners/billing/usage{?%24select,%24expand}", rawUrl);
    }
    /**
