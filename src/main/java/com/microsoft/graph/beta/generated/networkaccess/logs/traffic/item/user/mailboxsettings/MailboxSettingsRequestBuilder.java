package com.microsoft.graph.beta.networkaccess.logs.traffic.item.user.mailboxsettings;
...
/**
 * Builds and executes requests for operations under /networkAccess/logs/traffic/{networkAccessTraffic-transactionId}/user/mailboxSettings
 */
...
public class MailboxSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}/user/mailboxSettings{?%24expand,%24select}", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final MailboxSettings body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}/user/mailboxSettings", pathParameters);
