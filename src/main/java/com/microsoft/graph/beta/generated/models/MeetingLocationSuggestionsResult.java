...
public class MeetingLocationSuggestionsResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MeetingLocationSuggestionsResult} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MeetingLocationSuggestionsResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("meetingLocationSuggestions", (n) -> { this.setMeetingLocationSuggestions(n.getCollectionOfObjectValues(MeetingLocationSuggestion::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        return deserializerMap;
    }
    /**
     * Gets the meetingLocationSuggestions property value. The meetingLocationSuggestions property
     * @return a {@link java.util.List<MeetingLocationSuggestion>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<MeetingLocationSuggestion> getMeetingLocationSuggestions() {
        return this.backingStore.get("meetingLocationSuggestions");
    }
    /**
     ...
     * @param value Value to set for the meetingLocationSuggestions property.
     */
    public void setMeetingLocationSuggestions(@jakarta.annotation.Nullable final java.util.List<MeetingLocationSuggestion> value) {
        this.backingStore.set("meetingLocationSuggestions", value);
    }
    /**
