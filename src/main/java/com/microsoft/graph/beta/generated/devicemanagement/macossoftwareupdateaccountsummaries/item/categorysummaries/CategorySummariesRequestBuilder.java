package com.microsoft.graph.beta.devicemanagement.macossoftwareupdateaccountsummaries.item.categorysummaries;

import com.microsoft.graph.beta.devicemanagement.macossoftwareupdateaccountsummaries.item.categorysummaries.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.macossoftwareupdateaccountsummaries.item.categorysummaries.item.MacOSSoftwareUpdateCategorySummaryItemRequestBuilder;
import com.microsoft.graph.beta.models.MacOSSoftwareUpdateCategorySummary;
import com.microsoft.graph.beta.models.MacOSSoftwareUpdateCategorySummaryCollectionResponse;
...
public class CategorySummariesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/macOSSoftwareUpdateAccountSummaries/{macOSSoftwareUpdateAccountSummary%2Did}/categorySummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
