...
public class AndroidAospReferencedApp extends MobileApp implements Parsable {
    /**
     * Instantiates a new {@link AndroidAospReferencedApp} and sets the default values.
     */
    public AndroidAospReferencedApp() {
        super();
     ...
     * @return a {@link AndroidAospReferencedApp}
     */
    @jakarta.annotation.Nonnull
    public static AndroidAospReferencedApp createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
