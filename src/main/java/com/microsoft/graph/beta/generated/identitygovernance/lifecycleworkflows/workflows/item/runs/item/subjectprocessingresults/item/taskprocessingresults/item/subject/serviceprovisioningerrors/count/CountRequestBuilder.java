package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.runs.item.subjectprocessingresults.item.taskprocessingresults.item.subject.serviceprovisioningerrors.count;
