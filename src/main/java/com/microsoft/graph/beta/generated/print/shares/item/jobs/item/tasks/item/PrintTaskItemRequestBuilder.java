package com.microsoft.graph.beta.print.shares.item.jobs.item.tasks.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrintTask;
import com.microsoft.graph.beta.print.shares.item.jobs.item.tasks.item.definition.DefinitionRequestBuilder;
import com.microsoft.graph.beta.print.shares.item.jobs.item.tasks.item.trigger.TriggerRequestBuilder;
...
public class PrintTaskItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrintTaskItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrintTaskItemRequestBuilder} and sets the default values.
    ...
    public PrintTaskItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24expand,%24select}", pathParameters);
