package com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item;

import com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item.itemcategory.ItemCategoryRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item.picture.PictureRequestBuilder;
...
public class ItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}/item", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final Item body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}/item", pathParameters);
