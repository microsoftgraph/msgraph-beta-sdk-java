package com.microsoft.graph.beta.identitygovernance.accessreviews.historydefinitions.item.instances.item;

import com.microsoft.graph.beta.identitygovernance.accessreviews.historydefinitions.item.instances.item.generatedownloaduri.GenerateDownloadUriRequestBuilder;
import com.microsoft.graph.beta.models.AccessReviewHistoryInstance;
...
public class AccessReviewHistoryInstanceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewHistoryInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition%2Did}/instances/{accessReviewHistoryInstance%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link AccessReviewHistoryInstanceItemRequestBuilder} and sets the default values.
    ...
    public AccessReviewHistoryInstanceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition%2Did}/instances/{accessReviewHistoryInstance%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition%2Did}/instances/{accessReviewHistoryInstance%2Did}{?%24expand,%24select}", pathParameters);
