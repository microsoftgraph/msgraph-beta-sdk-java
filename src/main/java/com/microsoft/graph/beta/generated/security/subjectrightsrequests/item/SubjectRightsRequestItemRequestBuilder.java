package com.microsoft.graph.beta.security.subjectrightsrequests.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SubjectRightsRequest;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.approvers.ApproversRequestBuilder;
...
import com.microsoft.graph.beta.security.subjectrightsrequests.item.collaborators.CollaboratorsRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.collaboratorswithuserprincipalname.CollaboratorsWithUserPrincipalNameRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.getfinalattachment.GetFinalAttachmentRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.getfinalreport.GetFinalReportRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.notes.NotesRequestBuilder;
import com.microsoft.graph.beta.security.subjectrightsrequests.item.team.TeamRequestBuilder;
...
public class SubjectRightsRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SubjectRightsRequestItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link SubjectRightsRequestItemRequestBuilder} and sets the default values.
    ...
    public SubjectRightsRequestItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}{?%24expand,%24select}", pathParameters);
