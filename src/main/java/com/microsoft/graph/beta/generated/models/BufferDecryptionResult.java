...
public class BufferDecryptionResult implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BufferDecryptionResult} and sets the default values.
     */
    ...
    public byte[] getDecryptedBuffer() {
        return this.backingStore.get("decryptedBuffer");
    }
    /**
    ...
    public void setDecryptedBuffer(@jakarta.annotation.Nullable final byte[] value) {
        this.backingStore.set("decryptedBuffer", value);
    }
    /**
