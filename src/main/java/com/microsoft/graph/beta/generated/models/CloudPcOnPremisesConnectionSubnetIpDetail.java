...
public class CloudPcOnPremisesConnectionSubnetIpDetail implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CloudPcOnPremisesConnectionSubnetIpDetail} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CloudPcOnPremisesConnectionSubnetIpDetail createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("subnetAvailableIpCount", (n) -> { this.setSubnetAvailableIpCount(n.getIntegerValue()); });
        deserializerMap.put("subnetAvailableIpCountLastSyncDateTime", (n) -> { this.setSubnetAvailableIpCountLastSyncDateTime(n.getOffsetDateTimeValue()); });
     ...
     */
    @jakarta.annotation.Nullable
    public Integer getSubnetAvailableIpCount() {
     ...
     */
    @jakarta.annotation.Nullable
    public OffsetDateTime getSubnetAvailableIpCountLastSyncDateTime() {
        return this.backingStore.get("subnetAvailableIpCountLastSyncDateTime");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeOffsetDateTimeValue("subnetAvailableIpCountLastSyncDateTime", this.getSubnetAvailableIpCountLastSyncDateTime());
    ...
    public void setSubnetAvailableIpCountLastSyncDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("subnetAvailableIpCountLastSyncDateTime", value);
    }
}
