...
public class WorkbookChartFont extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("size", (n) -> { this.setSize(n.getObjectValue(WorkbookChartFontSize::createFromDiscriminatorValue)); });
     ...
     * @return a {@link WorkbookChartFontSize}
     */
    @jakarta.annotation.Nullable
    public WorkbookChartFontSize getSize() {
     ...
     */
    public void setSize(@jakarta.annotation.Nullable final WorkbookChartFontSize value) {
     ...
     */
    @jakarta.annotation.Generated("com.microsoft.kiota")
    public static class WorkbookChartFontSize implements BackedModel, ComposedTypeWrapper, Parsable {
        /**
        ...
        /**
         * Instantiates a new {@link WorkbookChartFontSize} and sets the default values.
         */
        public WorkbookChartFontSize() {
         ...
         */
        @jakarta.annotation.Nonnull
        public static WorkbookChartFontSize createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
            Objects.requireNonNull(parseNode);
            final WorkbookChartFontSize result = new WorkbookChartFontSize();
