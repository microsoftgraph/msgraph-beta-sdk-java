package com.microsoft.graph.beta.users.item.mobileapptroubleshootingevents;

import com.microsoft.graph.beta.models.MobileAppTroubleshootingEvent;
import com.microsoft.graph.beta.models.MobileAppTroubleshootingEventCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.mobileapptroubleshootingevents.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.mobileapptroubleshootingevents.item.MobileAppTroubleshootingEventItemRequestBuilder;
...
public class MobileAppTroubleshootingEventsRequestBuilder extends BaseRequestBuilder {
    ...
    public MobileAppTroubleshootingEventsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link MobileAppTroubleshootingEventsRequestBuilder} and sets the default values.
    ...
    public MobileAppTroubleshootingEventsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MobileAppTroubleshootingEvent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents", pathParameters);
