package com.microsoft.graph.beta.auditlogs.signineventsappsummary.item.application;

import com.microsoft.graph.beta.auditlogs.signineventsappsummary.item.application.logo.LogoRequestBuilder;
...
public class ApplicationRequestBuilder extends BaseRequestBuilder {
    ...
    public ApplicationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/signInEventsAppSummary/{signInEventsAppActivity%2DappId}/application{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApplicationRequestBuilder} and sets the default values.
    ...
    public ApplicationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/signInEventsAppSummary/{signInEventsAppActivity%2DappId}/application{?%24expand,%24select}", rawUrl);
    }
    /**
