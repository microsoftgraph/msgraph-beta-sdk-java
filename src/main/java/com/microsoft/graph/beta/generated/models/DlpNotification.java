...
public class DlpNotification implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DlpNotification} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static DlpNotification createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getAuthor() {
        return this.backingStore.get("author");
    }
    /**
    ...
    public void setAuthor(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("author", value);
    }
    /**
