package com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.VirtualEventSession;
import com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item.attendancereports.AttendanceReportsRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item.presenters.PresentersRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item.registrations.RegistrationsRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item.registrationswithemail.RegistrationsWithEmailRequestBuilder;
import com.microsoft.graph.beta.solutions.virtualevents.events.item.sessions.item.registrationswithuserid.RegistrationsWithUserIdRequestBuilder;
