...
public class AlertStatusCounts implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AlertStatusCounts} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AlertStatusCounts createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("new", (n) -> { this.setNew(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("resolved", (n) -> { this.setResolved(n.getIntegerValue()); });
    ...
    public Integer getNew() {
        return this.backingStore.get("new");
    }
    /**
    ...
    public Integer getResolved() {
        return this.backingStore.get("resolved");
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeIntegerValue("new", this.getNew());
     ...
     */
    public void setNew(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("new", value);
    }
    /**
     ...
     * @param value Value to set for the resolved property.
     */
    public void setResolved(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("resolved", value);
    }
}
