package com.microsoft.graph.beta.devicemanagement.reports.getremoteassistancesessionsreport;
...
public class GetRemoteAssistanceSessionsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetRemoteAssistanceSessionsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetRemoteAssistanceSessionsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetRemoteAssistanceSessionsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
