package com.microsoft.graph.beta.devicemanagement.rolescopetags;

import com.microsoft.graph.beta.devicemanagement.rolescopetags.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.rolescopetags.getrolescopetagsbyid.GetRoleScopeTagsByIdRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.rolescopetags.hascustomrolescopetag.HasCustomRoleScopeTagRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.rolescopetags.item.RoleScopeTagItemRequestBuilder;
...
public class RoleScopeTagsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/roleScopeTags{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
