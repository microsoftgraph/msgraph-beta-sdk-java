package com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.assignments;

import com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.managedebooks.item.assignments.item.ManagedEBookAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.models.ManagedEBookAssignment;
import com.microsoft.graph.beta.models.ManagedEBookAssignmentCollectionResponse;
...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
