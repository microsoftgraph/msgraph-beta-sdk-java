package com.microsoft.graph.beta.financials.companies.item.salesorders;

import com.microsoft.graph.beta.financials.companies.item.salesorders.count.CountRequestBuilder;
import com.microsoft.graph.beta.financials.companies.item.salesorders.item.SalesOrderItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SalesOrderCollectionResponse;
...
public class SalesOrdersRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SalesOrdersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SalesOrdersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
