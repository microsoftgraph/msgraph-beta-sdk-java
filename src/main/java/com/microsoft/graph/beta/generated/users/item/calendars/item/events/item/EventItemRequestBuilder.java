package com.microsoft.graph.beta.users.item.calendars.item.events.item;

import com.microsoft.graph.beta.models.Event;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.users.item.calendars.item.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
