...
public class GetSubscriptionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetSubscriptionsRequestBuilder} and sets the default values.
    ...
    public GetSubscriptionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/getSubscriptions(){?%24count,%24filter,%24search,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetSubscriptionsRequestBuilder} and sets the default values.
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link GetSubscriptionsRequestBuilder}
     */
    @jakarta.annotation.Nonnull
