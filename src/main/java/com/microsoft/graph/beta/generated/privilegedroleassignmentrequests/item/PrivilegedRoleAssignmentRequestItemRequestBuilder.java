package com.microsoft.graph.beta.privilegedroleassignmentrequests.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PrivilegedRoleAssignmentRequest;
import com.microsoft.graph.beta.privilegedroleassignmentrequests.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.privilegedroleassignmentrequests.item.roleinfo.RoleInfoRequestBuilder;
...
public class PrivilegedRoleAssignmentRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrivilegedRoleAssignmentRequestItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PrivilegedRoleAssignmentRequestItemRequestBuilder} and sets the default values.
    ...
    public PrivilegedRoleAssignmentRequestItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}{?%24expand,%24select}", pathParameters);
