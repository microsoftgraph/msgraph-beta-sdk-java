package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive;

import com.microsoft.graph.beta.models.Drive;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.bundles.BundlesRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.createdbyuser.CreatedByUserRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.following.FollowingRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.ItemsRequestBuilder;
...
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.list.ListRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.recent.RecentRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.root.RootRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.searchwithq.SearchWithQRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.sharedwithme.SharedWithMeRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.special.SpecialRequestBuilder;
...
public class DriveRequestBuilder extends BaseRequestBuilder {
    ...
    public DriveRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DriveRequestBuilder} and sets the default values.
    ...
    public DriveRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive{?%24expand,%24select}", rawUrl);
    }
    /**
