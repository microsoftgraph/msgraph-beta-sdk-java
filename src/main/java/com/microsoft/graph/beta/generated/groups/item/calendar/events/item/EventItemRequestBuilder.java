package com.microsoft.graph.beta.groups.item.calendar.events.item;

import com.microsoft.graph.beta.groups.item.calendar.events.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.beta.groups.item.calendar.events.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
