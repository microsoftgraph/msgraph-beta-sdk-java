package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item.relations.item.toterm;
...
public class ToTermRequestBuilder extends BaseRequestBuilder {
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ToTermRequestBuilder} and sets the default values.
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24expand,%24select}", rawUrl);
    }
    /**
