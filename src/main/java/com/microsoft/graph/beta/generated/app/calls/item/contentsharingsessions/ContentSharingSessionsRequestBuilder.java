package com.microsoft.graph.beta.app.calls.item.contentsharingsessions;

import com.microsoft.graph.beta.app.calls.item.contentsharingsessions.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.calls.item.contentsharingsessions.item.ContentSharingSessionItemRequestBuilder;
...
public class ContentSharingSessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ContentSharingSessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ContentSharingSessionsRequestBuilder} and sets the default values.
    ...
    public ContentSharingSessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
