package com.microsoft.graph.beta.security.securescores;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.SecureScore;
import com.microsoft.graph.beta.models.SecureScoreCollectionResponse;
import com.microsoft.graph.beta.security.securescores.count.CountRequestBuilder;
import com.microsoft.graph.beta.security.securescores.item.SecureScoreItemRequestBuilder;
...
public class SecureScoresRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link SecureScoresRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/security-list-securescores?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/security/secureScores{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SecureScore body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/security/secureScores", pathParameters);
