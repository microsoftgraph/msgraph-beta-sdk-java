package com.microsoft.graph.beta.serviceprincipals.item.createpasswordsinglesignoncredentials;

import com.microsoft.graph.beta.models.Credential;
...
public class CreatePasswordSingleSignOnCredentialsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CreatePasswordSingleSignOnCredentialsPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link CreatePasswordSingleSignOnCredentialsPostRequestBody}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link java.util.List<Credential>}
     */
