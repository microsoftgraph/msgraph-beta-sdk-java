package com.microsoft.graph.beta.programcontrols.item.program.controls;
...
import com.microsoft.graph.beta.programcontrols.item.program.controls.count.CountRequestBuilder;
import com.microsoft.graph.beta.programcontrols.item.program.controls.item.ProgramControlItemRequestBuilder;
...
public class ControlsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ControlsRequestBuilder} and sets the default values.
    ...
    public ControlsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/programControls/{programControl%2Did}/program/controls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ControlsRequestBuilder} and sets the default values.
    ...
    public ControlsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/programControls/{programControl%2Did}/program/controls{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ProgramControl body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/programControls/{programControl%2Did}/program/controls", pathParameters);
