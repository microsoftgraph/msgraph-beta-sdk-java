package com.microsoft.graph.beta.devicemanagement.reusablepolicysettings;

import com.microsoft.graph.beta.devicemanagement.reusablepolicysettings.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.reusablepolicysettings.item.DeviceManagementReusablePolicySettingItemRequestBuilder;
import com.microsoft.graph.beta.models.DeviceManagementReusablePolicySetting;
import com.microsoft.graph.beta.models.DeviceManagementReusablePolicySettingCollectionResponse;
...
public class ReusablePolicySettingsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link ReusablePolicySettingsRequestBuilder} and sets the default values.
    ...
    public ReusablePolicySettingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reusablePolicySettings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ReusablePolicySettingsRequestBuilder} and sets the default values.
    ...
    public ReusablePolicySettingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/reusablePolicySettings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementReusablePolicySetting body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/reusablePolicySettings", pathParameters);
