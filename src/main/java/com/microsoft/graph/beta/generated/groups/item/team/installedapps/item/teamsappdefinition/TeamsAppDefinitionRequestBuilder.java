package com.microsoft.graph.beta.groups.item.team.installedapps.item.teamsappdefinition;
...
public class TeamsAppDefinitionRequestBuilder extends BaseRequestBuilder {
    ...
    public TeamsAppDefinitionRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsAppDefinitionRequestBuilder} and sets the default values.
    ...
    public TeamsAppDefinitionRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24expand,%24select}", rawUrl);
    }
    /**
