...
import com.microsoft.graph.beta.models.security.ContentInfo;
...
public class ExtractContentLabelPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ExtractContentLabelPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ExtractContentLabelPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ExtractContentLabelPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
