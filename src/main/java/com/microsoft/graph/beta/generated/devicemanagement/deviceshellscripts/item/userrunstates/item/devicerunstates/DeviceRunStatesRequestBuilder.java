package com.microsoft.graph.beta.devicemanagement.deviceshellscripts.item.userrunstates.item.devicerunstates;

import com.microsoft.graph.beta.devicemanagement.deviceshellscripts.item.userrunstates.item.devicerunstates.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.deviceshellscripts.item.userrunstates.item.devicerunstates.item.DeviceManagementScriptDeviceStateItemRequestBuilder;
...
public class DeviceRunStatesRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceRunStatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeviceRunStatesRequestBuilder} and sets the default values.
    ...
    public DeviceRunStatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     * List of run states for this script across all devices of specific user.
     * @return a {@link DeviceManagementScriptDeviceStateCollectionResponse}
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementScriptDeviceState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates", pathParameters);
