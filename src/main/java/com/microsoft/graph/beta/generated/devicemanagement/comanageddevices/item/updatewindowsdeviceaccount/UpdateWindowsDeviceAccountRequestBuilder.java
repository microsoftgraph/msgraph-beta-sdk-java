package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.updatewindowsdeviceaccount;
...
public class UpdateWindowsDeviceAccountRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link UpdateWindowsDeviceAccountRequestBuilder} and sets the default values.
    ...
    public UpdateWindowsDeviceAccountRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", pathParameters);
    }
    /**
     * Instantiates a new {@link UpdateWindowsDeviceAccountRequestBuilder} and sets the default values.
    ...
    public UpdateWindowsDeviceAccountRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", rawUrl);
    }
    /**
