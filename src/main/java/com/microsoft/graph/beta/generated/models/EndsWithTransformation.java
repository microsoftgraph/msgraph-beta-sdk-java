...
public class EndsWithTransformation extends CustomClaimTransformation implements Parsable {
    /**
     * Instantiates a new {@link EndsWithTransformation} and sets the default values.
     */
    public EndsWithTransformation() {
        super();
        this.setOdataType("#microsoft.graph.endsWithTransformation");
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link EndsWithTransformation}
     */
    @jakarta.annotation.Nonnull
    public static EndsWithTransformation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
