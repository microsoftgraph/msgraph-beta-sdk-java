package com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item;

import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.parentgroup.ParentGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.termstore.sets.item.terms.TermsRequestBuilder;
