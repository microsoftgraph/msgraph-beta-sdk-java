package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.subjectprocessingresults.item.taskprocessingresults.item.subject;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.subjectprocessingresults.item.taskprocessingresults.item.subject.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.workflows.item.subjectprocessingresults.item.taskprocessingresults.item.subject.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
