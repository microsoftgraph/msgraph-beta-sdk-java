package com.microsoft.graph.beta.users.item.activities.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserActivity;
import com.microsoft.graph.beta.users.item.activities.item.historyitems.HistoryItemsRequestBuilder;
...
public class UserActivityItemRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserActivityItemRequestBuilder} and sets the default values.
    ...
    public UserActivityItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserActivityItemRequestBuilder} and sets the default values.
    ...
    public UserActivityItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}{?%24expand,%24select}", pathParameters);
