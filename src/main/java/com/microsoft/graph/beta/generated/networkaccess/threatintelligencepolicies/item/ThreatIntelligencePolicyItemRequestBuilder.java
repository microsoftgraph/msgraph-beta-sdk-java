package com.microsoft.graph.beta.networkaccess.threatintelligencepolicies.item;

import com.microsoft.graph.beta.models.networkaccess.ThreatIntelligencePolicy;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.networkaccess.threatintelligencepolicies.item.policyrules.PolicyRulesRequestBuilder;
...
public class ThreatIntelligencePolicyItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/networkAccess/threatIntelligencePolicies/{threatIntelligencePolicy%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ThreatIntelligencePolicy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ThreatIntelligencePolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public ThreatIntelligencePolicyItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new ThreatIntelligencePolicyItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
