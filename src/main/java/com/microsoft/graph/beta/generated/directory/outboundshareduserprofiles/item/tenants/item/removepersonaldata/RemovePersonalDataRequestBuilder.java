package com.microsoft.graph.beta.directory.outboundshareduserprofiles.item.tenants.item.removepersonaldata;
...
public class RemovePersonalDataRequestBuilder extends BaseRequestBuilder {
    ...
    public RemovePersonalDataRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile%2DuserId}/tenants/{tenantReference%2DtenantId}/removePersonalData", pathParameters);
    }
    /**
     * Instantiates a new RemovePersonalDataRequestBuilder and sets the default values.
    ...
    public RemovePersonalDataRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile%2DuserId}/tenants/{tenantReference%2DtenantId}/removePersonalData", rawUrl);
    }
    /**
     * Create a request to remove the personal data for an outboundSharedUserProfile.
     * @see <a href="https://learn.microsoft.com/graph/api/tenantreference-removepersonaldata?view=graph-rest-1.0">Find more info here</a>
     */
    public void post() {
        post(null);
    }
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a RemovePersonalDataRequestBuilder
     */
    @jakarta.annotation.Nonnull
