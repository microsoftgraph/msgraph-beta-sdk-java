package com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.categories;

import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.categories.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.mobileapps.item.graphmanagedmobilelobapp.categories.item.MobileAppCategoryItemRequestBuilder;
...
public class CategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public CategoriesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedMobileLobApp/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link CategoriesRequestBuilder} and sets the default values.
    ...
    public CategoriesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedMobileLobApp/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
