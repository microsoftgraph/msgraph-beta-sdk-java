package com.microsoft.graph.beta.groups.item.onenote.sections.item;

import com.microsoft.graph.beta.groups.item.onenote.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sections.item.pages.PagesRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.onenote.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
