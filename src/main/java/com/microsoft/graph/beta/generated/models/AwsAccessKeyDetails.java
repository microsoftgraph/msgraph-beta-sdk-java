...
public class AwsAccessKeyDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AwsAccessKeyDetails} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static AwsAccessKeyDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
