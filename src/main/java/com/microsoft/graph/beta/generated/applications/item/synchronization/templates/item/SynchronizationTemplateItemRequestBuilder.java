package com.microsoft.graph.beta.applications.item.synchronization.templates.item;

import com.microsoft.graph.beta.applications.item.synchronization.templates.item.schema.SchemaRequestBuilder;
...
public class SynchronizationTemplateItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link SynchronizationTemplate}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/synchronization-synchronizationtemplate-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
