package com.microsoft.graph.beta.devicemanagement.devicecompliancescripts.item.assign;
...
public class AssignPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public java.util.List<DeviceHealthScriptAssignment> getDeviceHealthScriptAssignments() {
        return this.backingStore.get("deviceHealthScriptAssignments");
    }
    /**
     ...
     */
    public void setDeviceHealthScriptAssignments(@jakarta.annotation.Nullable final java.util.List<DeviceHealthScriptAssignment> value) {
        this.backingStore.set("deviceHealthScriptAssignments", value);
    }
}
