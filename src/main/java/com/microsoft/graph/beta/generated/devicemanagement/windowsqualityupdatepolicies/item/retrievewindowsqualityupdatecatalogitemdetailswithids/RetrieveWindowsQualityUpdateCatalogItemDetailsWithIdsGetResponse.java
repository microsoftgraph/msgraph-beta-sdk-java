...
public class RetrieveWindowsQualityUpdateCatalogItemDetailsWithIdsGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * @return a {@link java.util.List<WindowsQualityUpdateCatalogItemPolicyDetail>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<WindowsQualityUpdateCatalogItemPolicyDetail> getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<WindowsQualityUpdateCatalogItemPolicyDetail> value) {
