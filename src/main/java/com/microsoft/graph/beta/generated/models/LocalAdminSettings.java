...
public class LocalAdminSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link LocalAdminSettings} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static LocalAdminSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Boolean getEnableGlobalAdmins() {
        return this.backingStore.get("enableGlobalAdmins");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enableGlobalAdmins", (n) -> { this.setEnableGlobalAdmins(n.getBooleanValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("registeringUsers", (n) -> { this.setRegisteringUsers(n.getObjectValue(DeviceRegistrationMembership::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceRegistrationMembership getRegisteringUsers() {
        return this.backingStore.get("registeringUsers");
    }
    /**
    ...
    public void setEnableGlobalAdmins(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("enableGlobalAdmins", value);
    }
    /**
    ...
    public void setRegisteringUsers(@jakarta.annotation.Nullable final DeviceRegistrationMembership value) {
        this.backingStore.set("registeringUsers", value);
    }
}
