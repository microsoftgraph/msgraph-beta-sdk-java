package com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PlannerTask;
import com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item.details.DetailsRequestBuilder;
import com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item.messages.MessagesRequestBuilder;
import com.microsoft.graph.beta.users.item.planner.plans.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
