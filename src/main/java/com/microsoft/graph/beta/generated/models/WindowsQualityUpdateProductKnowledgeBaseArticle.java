...
public class WindowsQualityUpdateProductKnowledgeBaseArticle implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link WindowsQualityUpdateProductKnowledgeBaseArticle} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static WindowsQualityUpdateProductKnowledgeBaseArticle createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getArticleId() {
        return this.backingStore.get("articleId");
    }
    /**
    ...
    public String getArticleUrl() {
        return this.backingStore.get("articleUrl");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("articleId", (n) -> { this.setArticleId(n.getStringValue()); });
     ...
     */
    public void setArticleId(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("articleId", value);
    }
    /**
     ...
     */
    public void setArticleUrl(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("articleUrl", value);
    }
    /**
