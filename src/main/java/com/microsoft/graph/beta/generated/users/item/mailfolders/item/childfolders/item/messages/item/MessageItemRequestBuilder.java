package com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item;

import com.microsoft.graph.beta.models.Message;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.copy.CopyRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.createforward.CreateForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.createreply.CreateReplyRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.createreplyall.CreateReplyAllRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.markasjunk.MarkAsJunkRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.markasnotjunk.MarkAsNotJunkRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.mentions.MentionsRequestBuilder;
import com.microsoft.graph.beta.users.item.mailfolders.item.childfolders.item.messages.item.move.MoveRequestBuilder;
