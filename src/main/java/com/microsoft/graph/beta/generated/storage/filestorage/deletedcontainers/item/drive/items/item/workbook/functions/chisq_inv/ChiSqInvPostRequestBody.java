package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.chisq_inv;
...
public class ChiSqInvPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ChiSqInvPostRequestBody} and sets the default values.
     */
    public ChiSqInvPostRequestBody() {
     ...
     * @return a {@link ChiSqInvPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static ChiSqInvPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ChiSqInvPostRequestBody();
    }
    /**
