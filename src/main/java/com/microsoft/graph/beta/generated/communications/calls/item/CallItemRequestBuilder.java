package com.microsoft.graph.beta.communications.calls.item;

import com.microsoft.graph.beta.communications.calls.item.addlargegalleryview.AddLargeGalleryViewRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.answer.AnswerRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.audioroutinggroups.AudioRoutingGroupsRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.cancelmediaprocessing.CancelMediaProcessingRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.changescreensharingrole.ChangeScreenSharingRoleRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.contentsharingsessions.ContentSharingSessionsRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.keepalive.KeepAliveRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.mute.MuteRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.participants.ParticipantsRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.playprompt.PlayPromptRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.record.RecordRequestBuilder;
import com.microsoft.graph.beta.communications.calls.item.recordresponse.RecordResponseRequestBuilder;
...
import com.microsoft.graph.beta.communications.calls.item.updaterecordingstatus.UpdateRecordingStatusRequestBuilder;
...
public class CallItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/call-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @return a {@link Call}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/call-get?view=graph-rest-beta">Find more info here</a>
     */
