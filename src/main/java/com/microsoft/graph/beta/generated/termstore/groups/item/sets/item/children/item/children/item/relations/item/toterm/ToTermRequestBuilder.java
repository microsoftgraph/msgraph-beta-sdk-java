package com.microsoft.graph.beta.termstore.groups.item.sets.item.children.item.children.item.relations.item.toterm;
...
public class ToTermRequestBuilder extends BaseRequestBuilder {
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ToTermRequestBuilder and sets the default values.
    ...
    public ToTermRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", rawUrl);
    }
    /**
