package com.microsoft.graph.beta.teamstemplates;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.TeamsTemplate;
import com.microsoft.graph.beta.models.TeamsTemplateCollectionResponse;
import com.microsoft.graph.beta.teamstemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.teamstemplates.item.TeamsTemplateItemRequestBuilder;
...
public class TeamsTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link TeamsTemplatesRequestBuilder} and sets the default values.
    ...
    public TeamsTemplatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamsTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link TeamsTemplatesRequestBuilder} and sets the default values.
    ...
    public TeamsTemplatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamsTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public TeamsTemplateCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, TeamsTemplateCollectionResponse::createFromDiscriminatorValue);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TeamsTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/teamsTemplates", pathParameters);
