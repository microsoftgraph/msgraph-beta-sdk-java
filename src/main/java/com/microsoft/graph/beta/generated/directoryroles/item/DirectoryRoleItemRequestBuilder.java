package com.microsoft.graph.beta.directoryroles.item;

import com.microsoft.graph.beta.directoryroles.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.getmembergroups.GetMemberGroupsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.members.MembersRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.restore.RestoreRequestBuilder;
import com.microsoft.graph.beta.directoryroles.item.scopedmembers.ScopedMembersRequestBuilder;
