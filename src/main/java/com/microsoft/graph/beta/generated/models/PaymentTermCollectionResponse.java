...
public class PaymentTermCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new {@link PaymentTermCollectionResponse} and sets the default values.
     */
    ...
    public static PaymentTermCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<PaymentTerm> value) {
