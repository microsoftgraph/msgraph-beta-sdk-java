package com.microsoft.graph.beta.drives.item.items.item.workbook.tables;

import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.add.AddRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.WorkbookTableItemRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.itematwithindex.ItemAtWithIndexRequestBuilder;
