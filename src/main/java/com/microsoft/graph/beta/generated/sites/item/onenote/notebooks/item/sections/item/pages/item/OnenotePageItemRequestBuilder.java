package com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OnenotePage;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.content.ContentRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.copytosection.CopyToSectionRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.onenotepatchcontent.OnenotePatchContentRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.parentsection.ParentSectionRequestBuilder;
import com.microsoft.graph.beta.sites.item.onenote.notebooks.item.sections.item.pages.item.preview.PreviewRequestBuilder;
