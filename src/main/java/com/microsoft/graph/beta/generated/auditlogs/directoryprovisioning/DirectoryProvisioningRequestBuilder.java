package com.microsoft.graph.beta.auditlogs.directoryprovisioning;

import com.microsoft.graph.beta.auditlogs.directoryprovisioning.count.CountRequestBuilder;
import com.microsoft.graph.beta.auditlogs.directoryprovisioning.item.ProvisioningObjectSummaryItemRequestBuilder;
...
public class DirectoryProvisioningRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link DirectoryProvisioningRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DirectoryProvisioningRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DirectoryProvisioningRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DirectoryProvisioningRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/auditLogs/directoryProvisioning{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ProvisioningObjectSummary body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/auditLogs/directoryProvisioning", pathParameters);
    ...
    public DirectoryProvisioningRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        ...
        return new DirectoryProvisioningRequestBuilder(rawUrl, requestAdapter);
    }
    /**
     * Get directoryProvisioning from auditLogs
     */
