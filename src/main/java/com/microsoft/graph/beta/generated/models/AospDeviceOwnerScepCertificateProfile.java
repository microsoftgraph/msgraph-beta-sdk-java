...
public class AospDeviceOwnerScepCertificateProfile extends AospDeviceOwnerCertificateProfileBase implements Parsable {
     ...
     * @return a AospDeviceOwnerScepCertificateProfileCertificateStore
     */
    @jakarta.annotation.Nullable
    public AospDeviceOwnerScepCertificateProfileCertificateStore getCertificateStore() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("certificateStore", (n) -> { this.setCertificateStore(n.getEnumValue(AospDeviceOwnerScepCertificateProfileCertificateStore::forValue)); });
     ...
     */
    public void setCertificateStore(@jakarta.annotation.Nullable final AospDeviceOwnerScepCertificateProfileCertificateStore value) {
