package com.microsoft.graph.beta.networkaccess.forwardingpolicies.item.policyrules;
...
import com.microsoft.graph.beta.networkaccess.forwardingpolicies.item.policyrules.count.CountRequestBuilder;
import com.microsoft.graph.beta.networkaccess.forwardingpolicies.item.policyrules.item.PolicyRuleItemRequestBuilder;
...
public class PolicyRulesRequestBuilder extends BaseRequestBuilder {
    ...
    public PolicyRulesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/forwardingPolicies/{forwardingPolicy%2Did}/policyRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PolicyRulesRequestBuilder} and sets the default values.
    ...
    public PolicyRulesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/networkAccess/forwardingPolicies/{forwardingPolicy%2Did}/policyRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PolicyRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/networkAccess/forwardingPolicies/{forwardingPolicy%2Did}/policyRules", pathParameters);
