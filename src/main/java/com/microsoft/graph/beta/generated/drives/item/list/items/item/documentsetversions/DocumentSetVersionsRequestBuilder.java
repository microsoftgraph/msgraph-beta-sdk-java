package com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions;

import com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.items.item.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder extends BaseRequestBuilder {
    ...
    public DocumentSetVersionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link DocumentSetVersionsRequestBuilder} and sets the default values.
    ...
    public DocumentSetVersionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DocumentSetVersion body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions", pathParameters);
