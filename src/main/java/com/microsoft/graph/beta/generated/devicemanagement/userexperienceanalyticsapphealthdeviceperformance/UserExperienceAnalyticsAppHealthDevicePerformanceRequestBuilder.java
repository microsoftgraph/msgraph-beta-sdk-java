package com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsapphealthdeviceperformance;

import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsapphealthdeviceperformance.count.CountRequestBuilder;
import com.microsoft.graph.beta.devicemanagement.userexperienceanalyticsapphealthdeviceperformance.item.UserExperienceAnalyticsAppHealthDevicePerformanceItemRe_ef0ccf8e;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsAppHealthDevicePerformance;
import com.microsoft.graph.beta.models.UserExperienceAnalyticsAppHealthDevicePerformanceCollec_a1e81389;
...
public class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UserExperienceAnalyticsAppHealthDevicePerformance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance", pathParameters);
