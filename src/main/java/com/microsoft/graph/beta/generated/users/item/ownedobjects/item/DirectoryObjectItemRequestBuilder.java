package com.microsoft.graph.beta.users.item.ownedobjects.item;

import com.microsoft.graph.beta.models.DirectoryObject;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.ownedobjects.item.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.item.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.users.item.ownedobjects.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
