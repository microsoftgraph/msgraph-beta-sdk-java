package com.microsoft.graph.beta.directorysettingtemplates.item.getmembergroups;
...
public class GetMemberGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetMemberGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}/getMemberGroups", pathParameters);
    }
    /**
     * Instantiates a new {@link GetMemberGroupsRequestBuilder} and sets the default values.
    ...
    public GetMemberGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}/getMemberGroups", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/directoryobject-getmembergroups?view=graph-rest-beta">Find more info here</a>
     */
