...
public class ShiftsRolePermission implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ShiftsRolePermission} and sets the default values.
     */
     ...
     * @return a {@link ShiftsRolePermission}
     */
    @jakarta.annotation.Nonnull
    public static ShiftsRolePermission createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
