...
public class AlertDefinitionsRequestBuilder extends BaseRequestBuilder {
    ...
    public AlertDefinitionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alertDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AlertDefinitionsRequestBuilder and sets the default values.
    ...
    public AlertDefinitionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/roleManagementAlerts/alertDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of the unifiedRoleManagementAlertDefinition objects and their properties.
     * @return a UnifiedRoleManagementAlertDefinitionCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/rolemanagementalert-list-alertdefinitions?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a AlertDefinitionsRequestBuilder
     */
    @jakarta.annotation.Nonnull
