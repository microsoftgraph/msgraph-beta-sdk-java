package com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.childfolders.item.items;

import com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.admin.exchange.mailboxes.item.folders.item.childfolders.item.items.item.MailboxItemItemRequestBuilder;
...
public class ItemsRequestBuilder extends BaseRequestBuilder {
    ...
    public ItemsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/{mailboxFolder%2Did1}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ItemsRequestBuilder} and sets the default values.
