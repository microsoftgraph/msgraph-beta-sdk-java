package com.microsoft.graph.beta.sites.item.lists.item.items.item.permissions.item;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Permission;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.permissions.item.grant.GrantRequestBuilder;
import com.microsoft.graph.beta.sites.item.lists.item.items.item.permissions.item.revokegrants.RevokeGrantsRequestBuilder;
...
public class PermissionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/permissions/{permission%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionItemRequestBuilder} and sets the default values.
    ...
    public PermissionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/permissions/{permission%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/permissions/{permission%2Did}{?%24expand,%24select}", pathParameters);
