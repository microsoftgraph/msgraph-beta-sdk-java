...
public class GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @param sourcePrincipalName Usage: sourcePrincipalName=&apos;{sourcePrincipalName}&apos;
     */
    public GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String sourcePrincipalName) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436(rawUrl, requestAdapter);
    }
    /**
