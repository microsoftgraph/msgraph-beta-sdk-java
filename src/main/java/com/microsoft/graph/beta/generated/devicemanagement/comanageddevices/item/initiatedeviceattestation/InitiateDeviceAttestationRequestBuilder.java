package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.initiatedeviceattestation;
...
public class InitiateDeviceAttestationRequestBuilder extends BaseRequestBuilder {
    ...
    public InitiateDeviceAttestationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateDeviceAttestation", pathParameters);
    }
    /**
     * Instantiates a new InitiateDeviceAttestationRequestBuilder and sets the default values.
    ...
    public InitiateDeviceAttestationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/initiateDeviceAttestation", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a InitiateDeviceAttestationRequestBuilder
     */
    @jakarta.annotation.Nonnull
