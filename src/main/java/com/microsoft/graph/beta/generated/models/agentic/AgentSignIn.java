...
public class AgentSignIn implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public AgentType getAgentType() {
        return this.backingStore.get("agentType");
    }
    /**
    ...
    public String getParentAppId() {
        return this.backingStore.get("parentAppId");
    }
    /**
     ...
     * @param value Value to set for the agentType property.
     */
    public void setAgentType(@jakarta.annotation.Nullable final AgentType value) {
        this.backingStore.set("agentType", value);
    }
    /**
    ...
    public void setParentAppId(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("parentAppId", value);
    }
}
