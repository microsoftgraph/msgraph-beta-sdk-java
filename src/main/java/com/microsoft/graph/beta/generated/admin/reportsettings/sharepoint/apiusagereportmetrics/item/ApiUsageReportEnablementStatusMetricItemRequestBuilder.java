...
public class ApiUsageReportEnablementStatusMetricItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ApiUsageReportEnablementStatusMetricItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/reportSettings/sharePoint/apiUsageReportMetrics/{apiUsageReportEnablementStatus%2Dmetric}", pathParameters);
    }
    /**
     * Instantiates a new {@link ApiUsageReportEnablementStatusMetricItemRequestBuilder} and sets the default values.
    ...
    public ApiUsageReportEnablementStatusMetricItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/reportSettings/sharePoint/apiUsageReportMetrics/{apiUsageReportEnablementStatus%2Dmetric}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ApiUsageReportEnablementStatus get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public ApiUsageReportEnablementStatus patch(@jakarta.annotation.Nonnull final ApiUsageReportEnablementStatus body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/reportSettings/sharePoint/apiUsageReportMetrics/{apiUsageReportEnablementStatus%2Dmetric}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ApiUsageReportEnablementStatus body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
