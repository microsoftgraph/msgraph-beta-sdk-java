package com.microsoft.graph.beta.users.item.joinedgroups;

import com.microsoft.graph.beta.models.GroupCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.joinedgroups.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.users.item.joinedgroups.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
...
public class JoinedGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public JoinedGroupsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl);
    }
    /**
