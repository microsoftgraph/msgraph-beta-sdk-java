package com.microsoft.graph.beta.users.item.drives;

import com.microsoft.graph.beta.models.DriveCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.drives.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.drives.item.DriveItemRequestBuilder;
...
public class DrivesRequestBuilder extends BaseRequestBuilder {
    ...
    public DrivesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DrivesRequestBuilder and sets the default values.
