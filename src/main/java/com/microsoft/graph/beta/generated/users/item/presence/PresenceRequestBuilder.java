package com.microsoft.graph.beta.users.item.presence;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.Presence;
import com.microsoft.graph.beta.users.item.presence.clearautomaticlocation.ClearAutomaticLocationRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.clearlocation.ClearLocationRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.clearpresence.ClearPresenceRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.clearuserpreferredpresence.ClearUserPreferredPresenceRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.setautomaticlocation.SetAutomaticLocationRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.setmanuallocation.SetManualLocationRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.setpresence.SetPresenceRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.setstatusmessage.SetStatusMessageRequestBuilder;
import com.microsoft.graph.beta.users.item.presence.setuserpreferredpresence.SetUserPreferredPresenceRequestBuilder;
