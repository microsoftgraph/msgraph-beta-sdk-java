package com.microsoft.graph.beta.groups.item.sites.item.analytics.itemactivitystats.item.activities.item;

import com.microsoft.graph.beta.groups.item.sites.item.analytics.itemactivitystats.item.activities.item.driveitem.DriveItemRequestBuilder;
