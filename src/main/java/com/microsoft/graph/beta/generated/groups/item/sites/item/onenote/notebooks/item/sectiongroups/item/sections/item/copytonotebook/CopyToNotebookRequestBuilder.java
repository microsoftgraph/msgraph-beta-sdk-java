package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.copytonotebook;
...
public class CopyToNotebookRequestBuilder extends BaseRequestBuilder {
    ...
    public CopyToNotebookRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", pathParameters);
    }
    /**
     * Instantiates a new {@link CopyToNotebookRequestBuilder} and sets the default values.
    ...
    public CopyToNotebookRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/section-copytonotebook?view=graph-rest-beta">Find more info here</a>
     */
