package com.microsoft.graph.beta.groups.item.sites.item.onenote.sectiongroups.item;

import com.microsoft.graph.beta.groups.item.sites.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
