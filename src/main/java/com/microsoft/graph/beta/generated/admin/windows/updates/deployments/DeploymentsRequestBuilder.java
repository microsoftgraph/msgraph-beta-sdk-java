package com.microsoft.graph.beta.admin.windows.updates.deployments;

import com.microsoft.graph.beta.admin.windows.updates.deployments.count.CountRequestBuilder;
import com.microsoft.graph.beta.admin.windows.updates.deployments.item.DeploymentItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.windowsupdates.Deployment;
import com.microsoft.graph.beta.models.windowsupdates.DeploymentCollectionResponse;
...
public class DeploymentsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public DeploymentItemRequestBuilder byDeploymentId(@jakarta.annotation.Nonnull final String deploymentId) {
        Objects.requireNonNull(deploymentId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("deployment%2Did", deploymentId);
    ...
    public DeploymentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DeploymentsRequestBuilder and sets the default values.
    ...
    public DeploymentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of deployment objects and their properties.
     * @return a DeploymentCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/adminwindowsupdates-list-deployments?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     * @return a Deployment
     * @see <a href="https://learn.microsoft.com/graph/api/adminwindowsupdates-post-deployments?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nullable
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Deployment body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Deployment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
