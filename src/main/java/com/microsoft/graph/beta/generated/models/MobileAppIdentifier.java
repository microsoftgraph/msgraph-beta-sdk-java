...
public class MobileAppIdentifier implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MobileAppIdentifier} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static MobileAppIdentifier createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
