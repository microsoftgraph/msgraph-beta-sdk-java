package com.microsoft.graph.beta.policies.federatedtokenvalidationpolicy;

import com.microsoft.graph.beta.models.FederatedTokenValidationPolicy;
...
public class FederatedTokenValidationPolicyRequestBuilder extends BaseRequestBuilder {
    ...
    public FederatedTokenValidationPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/federatedTokenValidationPolicy", pathParameters);
    }
    /**
     * Instantiates a new {@link FederatedTokenValidationPolicyRequestBuilder} and sets the default values.
    ...
    public FederatedTokenValidationPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/federatedTokenValidationPolicy", rawUrl);
    }
    /**
     ...
     * @return a {@link FederatedTokenValidationPolicy}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/federatedtokenvalidationpolicy-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/federatedTokenValidationPolicy{?%24expand,%24select}", pathParameters);
