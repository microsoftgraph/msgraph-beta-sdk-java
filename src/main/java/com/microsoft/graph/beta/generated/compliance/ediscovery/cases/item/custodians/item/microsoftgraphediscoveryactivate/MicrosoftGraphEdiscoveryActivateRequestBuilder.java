package com.microsoft.graph.beta.compliance.ediscovery.cases.item.custodians.item.microsoftgraphediscoveryactivate;
...
public class MicrosoftGraphEdiscoveryActivateRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphEdiscoveryActivateRequestBuilder} and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/ediscovery-custodian-activate?view=graph-rest-beta">Find more info here</a>
     */
    @Deprecated
    public void post() {
        post(null);
