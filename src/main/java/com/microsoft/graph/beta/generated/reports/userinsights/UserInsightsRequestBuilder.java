package com.microsoft.graph.beta.reports.userinsights;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.UserInsightsRoot;
import com.microsoft.graph.beta.reports.userinsights.daily.DailyRequestBuilder;
import com.microsoft.graph.beta.reports.userinsights.monthly.MonthlyRequestBuilder;
...
public class UserInsightsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link UserInsightsRequestBuilder} and sets the default values.
    ...
    public UserInsightsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link UserInsightsRequestBuilder} and sets the default values.
    ...
    public UserInsightsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/reports/userInsights{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/reports/userInsights", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final UserInsightsRoot body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/reports/userInsights", pathParameters);
