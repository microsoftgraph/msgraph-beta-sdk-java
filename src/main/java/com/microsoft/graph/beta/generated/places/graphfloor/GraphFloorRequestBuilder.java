package com.microsoft.graph.beta.places.graphfloor;

import com.microsoft.graph.beta.models.FloorCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.places.graphfloor.count.CountRequestBuilder;
...
public class GraphFloorRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphFloorRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/places/graph.floor{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GraphFloorRequestBuilder} and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public FloorCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
