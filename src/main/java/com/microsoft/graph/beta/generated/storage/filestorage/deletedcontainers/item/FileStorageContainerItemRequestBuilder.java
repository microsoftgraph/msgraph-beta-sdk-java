package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item;

import com.microsoft.graph.beta.models.FileStorageContainer;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.activate.ActivateRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.archive.ArchiveRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.columns.ColumnsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.DriveRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.lock.LockRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.migrationjobs.MigrationJobsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.permissions.PermissionsRequestBuilder;
import com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.provisionmigrationcontainers.ProvisionMigrationContainersRequestBuilder;
...
public class FileStorageContainerItemRequestBuilder extends BaseRequestBuilder {
    ...
    public FileStorageContainerItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link FileStorageContainerItemRequestBuilder} and sets the default values.
    ...
    public FileStorageContainerItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}{?%24expand,%24select}", pathParameters);
