...
public class DeploymentSummaryRequestBuilder extends BaseRequestBuilder {
    ...
    public DeploymentSummaryRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/windowsManagedAppProtections/{windowsManagedAppProtection%2Did}/deploymentSummary{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeploymentSummaryRequestBuilder} and sets the default values.
    ...
    public DeploymentSummaryRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/windowsManagedAppProtections/{windowsManagedAppProtection%2Did}/deploymentSummary{?%24expand,%24select}", rawUrl);
    }
    /**
