package com.microsoft.graph.beta.groups.item.threads.item;

import com.microsoft.graph.beta.groups.item.threads.item.posts.PostsRequestBuilder;
import com.microsoft.graph.beta.groups.item.threads.item.reply.ReplyRequestBuilder;
...
public class ConversationThreadItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link ConversationThread}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/group-update-thread?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
