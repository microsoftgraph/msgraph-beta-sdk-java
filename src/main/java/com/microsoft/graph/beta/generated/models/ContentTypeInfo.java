...
public class ContentTypeInfo implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ContentTypeInfo} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static ContentTypeInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
