package com.microsoft.graph.beta.dataclassification.sensitivitylabels;

import com.microsoft.graph.beta.dataclassification.sensitivitylabels.computeinheritancewithlabelidswithlocalewithcontentformats.ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e;
import com.microsoft.graph.beta.dataclassification.sensitivitylabels.computerightsandinheritance.ComputeRightsAndInheritanceRequestBuilder;
import com.microsoft.graph.beta.dataclassification.sensitivitylabels.count.CountRequestBuilder;
import com.microsoft.graph.beta.dataclassification.sensitivitylabels.evaluate.EvaluateRequestBuilder;
import com.microsoft.graph.beta.dataclassification.sensitivitylabels.item.SensitivityLabelItemRequestBuilder;
...
public class SensitivityLabelsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/dataClassification/sensitivityLabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SensitivityLabel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/dataClassification/sensitivityLabels", pathParameters);
