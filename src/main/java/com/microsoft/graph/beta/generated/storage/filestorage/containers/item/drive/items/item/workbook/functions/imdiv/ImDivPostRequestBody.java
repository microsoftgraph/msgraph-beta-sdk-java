package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.workbook.functions.imdiv;
...
public class ImDivPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ImDivPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ImDivPostRequestBody}
     */
    @jakarta.annotation.Nonnull
