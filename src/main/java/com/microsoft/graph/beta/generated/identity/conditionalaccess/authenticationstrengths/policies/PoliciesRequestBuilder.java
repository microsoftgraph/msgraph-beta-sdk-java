package com.microsoft.graph.beta.identity.conditionalaccess.authenticationstrengths.policies;

import com.microsoft.graph.beta.identity.conditionalaccess.authenticationstrengths.policies.count.CountRequestBuilder;
import com.microsoft.graph.beta.identity.conditionalaccess.authenticationstrengths.policies.findbymethodmodewithauthenticationmethodmodes.FindByMethodModeWithAuthenticationMethodModesRequestBuilder;
import com.microsoft.graph.beta.identity.conditionalaccess.authenticationstrengths.policies.item.AuthenticationStrengthPolicyItemRequestBuilder;
...
public class PoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public PoliciesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PoliciesRequestBuilder} and sets the default values.
    ...
    public PoliciesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AuthenticationStrengthPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies", pathParameters);
