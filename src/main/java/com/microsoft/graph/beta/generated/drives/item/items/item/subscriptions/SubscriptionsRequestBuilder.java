package com.microsoft.graph.beta.drives.item.items.item.subscriptions;

import com.microsoft.graph.beta.drives.item.items.item.subscriptions.count.CountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.subscriptions.getvapidpublickey.GetVapidPublicKeyRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.subscriptions.item.SubscriptionItemRequestBuilder;
