package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.range.resizedrangewithdeltarowswithdeltacolumns;
