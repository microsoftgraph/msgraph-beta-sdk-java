package com.microsoft.graph.beta.agreementacceptances;

import com.microsoft.graph.beta.agreementacceptances.item.AgreementAcceptanceItemRequestBuilder;
...
public class AgreementAcceptancesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/agreementAcceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
