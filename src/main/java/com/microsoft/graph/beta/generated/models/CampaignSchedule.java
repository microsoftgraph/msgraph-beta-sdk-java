...
public class CampaignSchedule implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CampaignSchedule} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static CampaignSchedule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(CampaignStatus::forValue)); });
