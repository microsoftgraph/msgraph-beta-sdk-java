package com.microsoft.graph.beta.groups.item.planner.plans.item.buckets.item;

import com.microsoft.graph.beta.groups.item.planner.plans.item.buckets.item.tasks.TasksRequestBuilder;
