...
public class RedirectUriBlockedSchemeConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RedirectUriBlockedSchemeConfiguration} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static RedirectUriBlockedSchemeConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<String> getBlockedSchemes() {
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<String> getExemptFormats() {
        return this.backingStore.get("exemptFormats");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blockedSchemes", (n) -> { this.setBlockedSchemes(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("exemptFormats", (n) -> { this.setExemptFormats(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("isStateSetByMicrosoft", (n) -> { this.setIsStateSetByMicrosoft(n.getBooleanValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("publicClient", (n) -> { this.setPublicClient(n.getObjectValue(RedirectUriPlatformBlockedSchemeConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("spa", (n) -> { this.setSpa(n.getObjectValue(RedirectUriPlatformBlockedSchemeConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AppManagementRestrictionState::forValue)); });
        deserializerMap.put("web", (n) -> { this.setWeb(n.getObjectValue(RedirectUriPlatformBlockedSchemeConfiguration::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedSchemeConfiguration getPublicClient() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedSchemeConfiguration getSpa() {
     ...
     */
    @jakarta.annotation.Nullable
    public RedirectUriPlatformBlockedSchemeConfiguration getWeb() {
