package com.microsoft.graph.beta.deviceappmanagement.ioslobappprovisioningconfigurations.item.assignments;

import com.microsoft.graph.beta.deviceappmanagement.ioslobappprovisioningconfigurations.item.assignments.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.ioslobappprovisioningconfigurations.item.assignments.item.IosLobAppProvisioningConfigurationAssignmentItemRequestBuilder;
import com.microsoft.graph.beta.models.IosLobAppProvisioningConfigurationAssignment;
import com.microsoft.graph.beta.models.IosLobAppProvisioningConfigurationAssignmentCollectionResponse;
...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/{iosLobAppProvisioningConfiguration%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
