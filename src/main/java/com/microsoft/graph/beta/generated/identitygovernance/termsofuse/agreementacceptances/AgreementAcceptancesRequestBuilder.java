package com.microsoft.graph.beta.identitygovernance.termsofuse.agreementacceptances;

import com.microsoft.graph.beta.identitygovernance.termsofuse.agreementacceptances.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.termsofuse.agreementacceptances.item.AgreementAcceptanceItemRequestBuilder;
import com.microsoft.graph.beta.models.AgreementAcceptance;
import com.microsoft.graph.beta.models.AgreementAcceptanceCollectionResponse;
...
public class AgreementAcceptancesRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/termsOfUse/agreementAcceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AgreementAcceptance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/identityGovernance/termsOfUse/agreementAcceptances", pathParameters);
