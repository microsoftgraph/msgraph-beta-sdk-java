package com.microsoft.graph.beta.groups.item.conversations.item.threads;

import com.microsoft.graph.beta.groups.item.conversations.item.threads.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.conversations.item.threads.item.ConversationThreadItemRequestBuilder;
...
public class ThreadsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/conversation-list-threads?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/conversation-post-threads?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
