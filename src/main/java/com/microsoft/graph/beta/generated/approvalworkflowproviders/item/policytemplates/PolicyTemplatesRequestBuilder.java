package com.microsoft.graph.beta.approvalworkflowproviders.item.policytemplates;

import com.microsoft.graph.beta.approvalworkflowproviders.item.policytemplates.count.CountRequestBuilder;
import com.microsoft.graph.beta.approvalworkflowproviders.item.policytemplates.item.GovernancePolicyTemplateItemRequestBuilder;
import com.microsoft.graph.beta.models.GovernancePolicyTemplate;
import com.microsoft.graph.beta.models.GovernancePolicyTemplateCollectionResponse;
...
public class PolicyTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link PolicyTemplatesRequestBuilder} and sets the default values.
    ...
    public PolicyTemplatesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/policyTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PolicyTemplatesRequestBuilder} and sets the default values.
    ...
    public PolicyTemplatesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/policyTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GovernancePolicyTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/policyTemplates", pathParameters);
