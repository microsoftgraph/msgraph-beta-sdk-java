package com.microsoft.graph.beta.deviceappmanagement.androidmanagedappprotections;

import com.microsoft.graph.beta.deviceappmanagement.androidmanagedappprotections.count.CountRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.androidmanagedappprotections.haspayloadlinks.HasPayloadLinksRequestBuilder;
import com.microsoft.graph.beta.deviceappmanagement.androidmanagedappprotections.item.AndroidManagedAppProtectionItemRequestBuilder;
import com.microsoft.graph.beta.models.AndroidManagedAppProtection;
import com.microsoft.graph.beta.models.AndroidManagedAppProtectionCollectionResponse;
...
public class AndroidManagedAppProtectionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Instantiates a new {@link AndroidManagedAppProtectionsRequestBuilder} and sets the default values.
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceAppManagement/androidManagedAppProtections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
