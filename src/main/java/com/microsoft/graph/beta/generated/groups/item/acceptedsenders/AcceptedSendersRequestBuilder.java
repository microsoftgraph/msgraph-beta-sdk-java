...
public class AcceptedSendersRequestBuilder extends BaseRequestBuilder {
    ...
    public AcceptedSendersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new AcceptedSendersRequestBuilder and sets the default values.
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a AcceptedSendersRequestBuilder
     */
    @jakarta.annotation.Nonnull
