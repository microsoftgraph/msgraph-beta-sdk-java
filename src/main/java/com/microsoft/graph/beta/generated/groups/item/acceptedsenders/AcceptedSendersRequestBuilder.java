package com.microsoft.graph.beta.groups.item.acceptedsenders;

import com.microsoft.graph.beta.groups.item.acceptedsenders.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.acceptedsenders.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.beta.groups.item.acceptedsenders.ref.RefRequestBuilder;
...
public class AcceptedSendersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.Beta.groups.item.acceptedSenders.item collection
    ...
    public AcceptedSendersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/acceptedSenders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AcceptedSendersRequestBuilder} and sets the default values.
    ...
    public AcceptedSendersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/acceptedSenders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
