package com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange;

import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.boundingrectwithanotherrange.BoundingRectWithAnotherRangeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.cellwithrowwithcolumn.CellWithRowWithColumnRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.clear.ClearRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.columnsafter.ColumnsAfterRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.columnsafterwithcount.ColumnsAfterWithCountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.columnsbefore.ColumnsBeforeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.columnsbeforewithcount.ColumnsBeforeWithCountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.columnwithcolumn.ColumnWithColumnRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.delete.DeleteRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.entirecolumn.EntireColumnRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.entirerow.EntireRowRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.format.FormatRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.insert.InsertRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.intersectionwithanotherrange.IntersectionWithAnotherRangeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.lastcell.LastCellRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.lastcolumn.LastColumnRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.lastrow.LastRowRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.merge.MergeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.offsetrangewithrowoffsetwithcolumnoffset.OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.resizedrangewithdeltarowswithdeltacolumns.ResizedRangeWithDeltaRowsWithDeltaColumnsRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.rowsabove.RowsAboveRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.rowsabovewithcount.RowsAboveWithCountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.rowsbelow.RowsBelowRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.rowsbelowwithcount.RowsBelowWithCountRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.rowwithrow.RowWithRowRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.sort.SortRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.unmerge.UnmergeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.usedrange.UsedRangeRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.usedrangewithvaluesonly.UsedRangeWithValuesOnlyRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.visibleview.VisibleViewRequestBuilder;
import com.microsoft.graph.beta.drives.item.items.item.workbook.tables.item.columns.item.headerrowrange.worksheet.WorksheetRequestBuilder;
...
public class HeaderRowRangeRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/tablecolumn-headerrowrange?view=graph-rest-beta">Find more info here</a>
     */
