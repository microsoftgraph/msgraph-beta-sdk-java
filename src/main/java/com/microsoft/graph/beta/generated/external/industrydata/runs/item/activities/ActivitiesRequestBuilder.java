package com.microsoft.graph.beta.external.industrydata.runs.item.activities;

import com.microsoft.graph.beta.external.industrydata.runs.item.activities.count.CountRequestBuilder;
import com.microsoft.graph.beta.external.industrydata.runs.item.activities.item.IndustryDataRunActivityItemRequestBuilder;
import com.microsoft.graph.beta.models.industrydata.IndustryDataRunActivityCollectionResponse;
...
public class ActivitiesRequestBuilder extends BaseRequestBuilder {
    ...
    public ActivitiesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
