...
public class MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String catalogID) {
     ...
     */
    @jakarta.annotation.Nullable
    public FindByCatalogIdWithCatalogIDGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
