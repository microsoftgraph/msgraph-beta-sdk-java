package com.microsoft.graph.beta.education.classes.item.modules.item;

import com.microsoft.graph.beta.education.classes.item.modules.item.pin.PinRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.item.publish.PublishRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.item.resources.ResourcesRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.item.setupresourcesfolder.SetUpResourcesFolderRequestBuilder;
import com.microsoft.graph.beta.education.classes.item.modules.item.unpin.UnpinRequestBuilder;
...
public class EducationModuleItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EducationModuleItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link EducationModuleItemRequestBuilder} and sets the default values.
    ...
    public EducationModuleItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}", rawUrl);
    }
    /**
     * Delete an existing module in a class. Only teachers within a class can delete modules.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationmodule-delete?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationmodule-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link EducationModule}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/educationmodule-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}{?%24expand,%24select}", pathParameters);
