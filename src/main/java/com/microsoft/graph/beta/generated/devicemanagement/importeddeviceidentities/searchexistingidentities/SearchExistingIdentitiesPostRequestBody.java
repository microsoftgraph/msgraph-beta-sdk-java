...
import com.microsoft.graph.beta.models.ImportedDeviceIdentity;
...
public class SearchExistingIdentitiesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SearchExistingIdentitiesPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SearchExistingIdentitiesPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static SearchExistingIdentitiesPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
