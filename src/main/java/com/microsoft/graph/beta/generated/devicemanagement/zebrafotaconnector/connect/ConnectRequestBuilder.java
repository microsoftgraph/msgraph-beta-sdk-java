package com.microsoft.graph.beta.devicemanagement.zebrafotaconnector.connect;
...
public class ConnectRequestBuilder extends BaseRequestBuilder {
    ...
    public ConnectRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/zebraFotaConnector/connect", pathParameters);
    }
    /**
     * Instantiates a new ConnectRequestBuilder and sets the default values.
    ...
    public ConnectRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/zebraFotaConnector/connect", rawUrl);
    }
    /**
     * Invoke action connect
     * @return a ConnectPostResponse
     */
    @jakarta.annotation.Nullable
    public ConnectPostResponse post() {
        return post(null);
    }
    /**
     * Invoke action connect
     ...
     */
    @jakarta.annotation.Nullable
    public ConnectPostResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, ConnectPostResponse::createFromDiscriminatorValue);
    }
    /**
     * Invoke action connect
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a ConnectRequestBuilder
     */
    @jakarta.annotation.Nonnull
