...
public class CloudPcExternalPartnerSettingItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CloudPcExternalPartnerSettingItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/externalPartnerSettings/{cloudPcExternalPartnerSetting%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CloudPcExternalPartnerSettingItemRequestBuilder and sets the default values.
    ...
    public CloudPcExternalPartnerSettingItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/externalPartnerSettings/{cloudPcExternalPartnerSetting%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
