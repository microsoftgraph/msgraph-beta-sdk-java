package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.driveitem;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.driveitem.content.ContentRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.driveitem.contentstream.ContentStreamRequestBuilder;
