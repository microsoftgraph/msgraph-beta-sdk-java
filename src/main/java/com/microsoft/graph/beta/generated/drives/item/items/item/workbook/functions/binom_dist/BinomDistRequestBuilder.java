package com.microsoft.graph.beta.drives.item.items.item.workbook.functions.binom_dist;
...
public class BinomDistRequestBuilder extends BaseRequestBuilder {
    ...
    public BinomDistRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/binom_Dist", pathParameters);
    }
    /**
     * Instantiates a new Binom_DistRequestBuilder and sets the default values.
    ...
    public BinomDistRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/binom_Dist", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a BinomDistRequestBuilder
     */
    @jakarta.annotation.Nonnull
