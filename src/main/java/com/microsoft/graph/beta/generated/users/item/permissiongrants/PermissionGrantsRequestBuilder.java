package com.microsoft.graph.beta.users.item.permissiongrants;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ResourceSpecificPermissionGrant;
import com.microsoft.graph.beta.models.ResourceSpecificPermissionGrantCollectionResponse;
import com.microsoft.graph.beta.users.item.permissiongrants.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
...
public class PermissionGrantsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionGrantsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionGrantsRequestBuilder} and sets the default values.
    ...
    public PermissionGrantsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/user-list-permissiongrants?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ResourceSpecificPermissionGrant body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/users/{user%2Did}/permissionGrants", pathParameters);
