package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.workbook.functions.networkdays;
...
public class NetworkDaysPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link NetworkDaysPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link NetworkDaysPostRequestBody}
     */
    @jakarta.annotation.Nonnull
