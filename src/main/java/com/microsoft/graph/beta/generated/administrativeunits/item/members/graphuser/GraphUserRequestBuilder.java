package com.microsoft.graph.beta.administrativeunits.item.members.graphuser;

import com.microsoft.graph.beta.administrativeunits.item.members.graphuser.count.CountRequestBuilder;
...
public class GraphUserRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphUserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new GraphUserRequestBuilder and sets the default values.
    ...
    public GraphUserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
