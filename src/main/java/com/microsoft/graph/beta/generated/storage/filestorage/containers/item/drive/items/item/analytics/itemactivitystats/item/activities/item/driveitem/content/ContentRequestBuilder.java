package com.microsoft.graph.beta.storage.filestorage.containers.item.drive.items.item.analytics.itemactivitystats.item.activities.item.driveitem.content;
