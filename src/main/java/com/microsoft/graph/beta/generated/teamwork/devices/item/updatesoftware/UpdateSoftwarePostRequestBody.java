...
import com.microsoft.graph.beta.models.TeamworkSoftwareType;
...
public class UpdateSoftwarePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("softwareType", (n) -> { this.setSoftwareType(n.getEnumValue(TeamworkSoftwareType::forValue)); });
