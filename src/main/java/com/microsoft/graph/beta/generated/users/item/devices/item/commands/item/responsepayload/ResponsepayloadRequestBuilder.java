package com.microsoft.graph.beta.users.item.devices.item.commands.item.responsepayload;
...
public class ResponsepayloadRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ResponsepayloadRequestBuilder} and sets the default values.
    ...
    public ResponsepayloadRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link ResponsepayloadRequestBuilder} and sets the default values.
    ...
    public ResponsepayloadRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24expand,%24select}", rawUrl);
    }
    /**
