package com.microsoft.graph.beta.communications.callrecords.item.participants_v2;

import com.microsoft.graph.beta.communications.callrecords.item.participants_v2.count.CountRequestBuilder;
import com.microsoft.graph.beta.communications.callrecords.item.participants_v2.item.ParticipantItemRequestBuilder;
import com.microsoft.graph.beta.models.callrecords.Participant;
import com.microsoft.graph.beta.models.callrecords.ParticipantCollectionResponse;
...
public class ParticipantsV2RequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/callrecords-callrecord-list-participants_v2?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Participant body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2", pathParameters);
