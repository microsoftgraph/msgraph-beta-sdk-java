package com.microsoft.graph.beta.policies.crosstenantaccesspolicy.templates.multitenantorganizationpartnerconfiguration;

import com.microsoft.graph.beta.models.MultiTenantOrganizationPartnerConfigurationTemplate;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.templates.multitenantorganizationpartnerconfiguration.resettodefaultsettings.ResetToDefaultSettingsRequestBuilder;
...
public class MultiTenantOrganizationPartnerConfigurationRequestBuilder extends BaseRequestBuilder {
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/multitenantorganizationpartnerconfigurationtemplate-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link MultiTenantOrganizationPartnerConfigurationTemplate}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/multitenantorganizationpartnerconfigurationtemplate-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration{?%24expand,%24select}", pathParameters);
