package com.microsoft.graph.beta.devicemanagement.grouppolicyuploadeddefinitionfiles.item.addlanguagefiles;
...
public class AddLanguageFilesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AddLanguageFilesPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link AddLanguageFilesPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static AddLanguageFilesPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
