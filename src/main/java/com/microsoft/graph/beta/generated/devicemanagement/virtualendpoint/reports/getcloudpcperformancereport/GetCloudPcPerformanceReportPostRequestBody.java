...
public class GetCloudPcPerformanceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reportName", (n) -> { this.setReportName(n.getEnumValue(GetCloudPcPerformanceReportPostRequestBodyReportName::forValue)); });
     ...
     * @return a GetCloudPcPerformanceReportPostRequestBodyReportName
     */
    @jakarta.annotation.Nullable
    public GetCloudPcPerformanceReportPostRequestBodyReportName getReportName() {
     ...
     */
    public void setReportName(@jakarta.annotation.Nullable final GetCloudPcPerformanceReportPostRequestBodyReportName value) {
