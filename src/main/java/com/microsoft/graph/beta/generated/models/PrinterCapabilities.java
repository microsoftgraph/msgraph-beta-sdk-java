...
public class PrinterCapabilities implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("feedDirections", (n) -> { this.setFeedDirections(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setFeedDirections(@jakarta.annotation.Nullable final java.util.List<String> value) {
