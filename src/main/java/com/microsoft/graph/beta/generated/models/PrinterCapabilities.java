...
public class PrinterCapabilities implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a java.util.List<PrinterCapabilitiesFeedDirections>
     */
    @jakarta.annotation.Nullable
    public java.util.List<PrinterCapabilitiesFeedDirections> getFeedDirections() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("feedDirections", (n) -> { this.setFeedDirections(n.getCollectionOfEnumValues(PrinterCapabilitiesFeedDirections::forValue)); });
     ...
     */
    public void setFeedDirections(@jakarta.annotation.Nullable final java.util.List<PrinterCapabilitiesFeedDirections> value) {
