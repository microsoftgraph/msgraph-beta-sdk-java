package com.microsoft.graph.beta.users.item.agreementacceptances;

import com.microsoft.graph.beta.models.AgreementAcceptanceCollectionResponse;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.agreementacceptances.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.agreementacceptances.item.AgreementAcceptanceItemRequestBuilder;
...
public class AgreementAcceptancesRequestBuilder extends BaseRequestBuilder {
    ...
    public AgreementAcceptancesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/agreementAcceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AgreementAcceptancesRequestBuilder} and sets the default values.
