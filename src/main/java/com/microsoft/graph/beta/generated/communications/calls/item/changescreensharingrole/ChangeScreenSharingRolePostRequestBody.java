package com.microsoft.graph.beta.communications.calls.item.changescreensharingrole;

import com.microsoft.graph.beta.models.ScreenSharingRole;
...
public class ChangeScreenSharingRolePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link ChangeScreenSharingRolePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link ChangeScreenSharingRolePostRequestBody}
     */
    @jakarta.annotation.Nonnull
     ...
     * @return a {@link ScreenSharingRole}
     */
