package com.microsoft.graph.beta.users.item.authentication;

import com.microsoft.graph.beta.models.Authentication;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.authentication.emailmethods.EmailMethodsRequestBuilder;
import com.microsoft.graph.beta.users.item.authentication.externalauthenticationmethods.ExternalAuthenticationMethodsRequestBuilder;
...
import com.microsoft.graph.beta.users.item.authentication.passwordlessmicrosoftauthenticatormethods.PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder;
...
public class AuthenticationRequestBuilder extends BaseRequestBuilder {
    ...
    public AuthenticationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication", pathParameters);
    }
    /**
     * Instantiates a new {@link AuthenticationRequestBuilder} and sets the default values.
    ...
    public AuthenticationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/users/{user%2Did}/authentication{?%24expand,%24select}", pathParameters);
