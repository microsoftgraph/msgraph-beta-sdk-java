package com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals;
...
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.directory.roleassignmentapprovals.item.ApprovalItemRequestBuilder;
...
public class RoleAssignmentApprovalsRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleAssignmentApprovalsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link RoleAssignmentApprovalsRequestBuilder} and sets the default values.
    ...
    public RoleAssignmentApprovalsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Approval body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals", pathParameters);
