package com.microsoft.graph.beta.rolemanagement.defender.roledefinitions.item.inheritspermissionsfrom;
...
import com.microsoft.graph.beta.rolemanagement.defender.roledefinitions.item.inheritspermissionsfrom.count.CountRequestBuilder;
import com.microsoft.graph.beta.rolemanagement.defender.roledefinitions.item.inheritspermissionsfrom.item.UnifiedRoleDefinitionItemRequestBuilder;
...
public class InheritsPermissionsFromRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/roleManagement/defender/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UnifiedRoleDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/roleManagement/defender/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom", pathParameters);
