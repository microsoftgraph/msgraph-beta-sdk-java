package com.microsoft.graph.beta.rolemanagement.enterpriseapps.item.resourcenamespaces.item.importresourceactions;
...
public class ImportResourceActionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ImportResourceActionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/importResourceActions", pathParameters);
    }
    /**
     * Instantiates a new ImportResourceActionsRequestBuilder and sets the default values.
    ...
    public ImportResourceActionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/importResourceActions", rawUrl);
    }
    /**
