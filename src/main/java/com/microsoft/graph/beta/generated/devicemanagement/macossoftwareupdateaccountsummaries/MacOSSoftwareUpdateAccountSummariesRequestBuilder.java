...
public class MacOSSoftwareUpdateAccountSummariesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link MacOSSoftwareUpdateAccountSummaryItemRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    ...
    /**
     * Instantiates a new {@link MacOSSoftwareUpdateAccountSummariesRequestBuilder} and sets the default values.
     ...
     * @return a {@link MacOSSoftwareUpdateAccountSummary}
     * @throws ODataError When receiving a 4XX or 5XX status code
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/deviceManagement/macOSSoftwareUpdateAccountSummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MacOSSoftwareUpdateAccountSummary body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/deviceManagement/macOSSoftwareUpdateAccountSummaries", pathParameters);
