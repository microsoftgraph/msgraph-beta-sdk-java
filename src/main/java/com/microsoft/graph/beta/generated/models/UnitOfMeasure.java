...
public class UnitOfMeasure implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UnitOfMeasure} and sets the default values.
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public static UnitOfMeasure createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getInternationalStandardCode() {
        return this.backingStore.get("internationalStandardCode");
    }
    /**
     ...
     */
    public void setInternationalStandardCode(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("internationalStandardCode", value);
    }
    /**
