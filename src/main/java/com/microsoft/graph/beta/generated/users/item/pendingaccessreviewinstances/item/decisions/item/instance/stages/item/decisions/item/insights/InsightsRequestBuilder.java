package com.microsoft.graph.beta.users.item.pendingaccessreviewinstances.item.decisions.item.instance.stages.item.decisions.item.insights;
...
import com.microsoft.graph.beta.users.item.pendingaccessreviewinstances.item.decisions.item.instance.stages.item.decisions.item.insights.count.CountRequestBuilder;
import com.microsoft.graph.beta.users.item.pendingaccessreviewinstances.item.decisions.item.instance.stages.item.decisions.item.insights.item.GovernanceInsightItemRequestBuilder;
