package com.microsoft.graph.beta.drives.item.items.item.workbook.worksheets.item.tables.item.databodyrange.worksheet;
...
public class WorksheetRequestBuilder extends BaseRequestBuilder {
    ...
    public WorksheetRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/dataBodyRange()/worksheet{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link WorksheetRequestBuilder} and sets the default values.
    ...
    public WorksheetRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/dataBodyRange()/worksheet{?%24expand,%24select}", rawUrl);
    }
    /**
