...
public class PermissionsRequestChangeItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionsRequestChangeItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges/{permissionsRequestChange%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PermissionsRequestChangeItemRequestBuilder and sets the default values.
    ...
    public PermissionsRequestChangeItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges/{permissionsRequestChange%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
