package com.microsoft.graph.beta.drives.item.list.items.item.lastmodifiedbyuser;

import com.microsoft.graph.beta.drives.item.list.items.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.drives.item.list.items.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
