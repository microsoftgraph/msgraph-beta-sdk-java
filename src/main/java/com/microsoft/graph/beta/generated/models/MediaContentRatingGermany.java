...
public class MediaContentRatingGermany implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static MediaContentRatingGermany createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("movieRating", (n) -> { this.setMovieRating(n.getEnumValue(RatingGermanyMoviesType::forValue)); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("tvRating", (n) -> { this.setTvRating(n.getEnumValue(RatingGermanyTelevisionType::forValue)); });
     ...
     */
    public void setMovieRating(@jakarta.annotation.Nullable final RatingGermanyMoviesType value) {
     ...
     */
    public void setTvRating(@jakarta.annotation.Nullable final RatingGermanyTelevisionType value) {
