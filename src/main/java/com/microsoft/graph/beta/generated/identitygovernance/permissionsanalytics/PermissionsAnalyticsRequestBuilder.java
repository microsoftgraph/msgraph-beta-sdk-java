package com.microsoft.graph.beta.identitygovernance.permissionsanalytics;

import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.aws.AwsRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.azure.AzureRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.permissionsanalytics.gcp.GcpRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.PermissionsAnalyticsAggregation;
...
public class PermissionsAnalyticsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a {@link AwsRequestBuilder}
     */
    ...
    /**
     * Instantiates a new {@link PermissionsAnalyticsRequestBuilder} and sets the default values.
    ...
    public PermissionsAnalyticsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PermissionsAnalyticsRequestBuilder} and sets the default values.
    ...
    public PermissionsAnalyticsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics{?%24expand,%24select}", rawUrl);
    }
    /**
    ...
    public RequestInformation toDeleteRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.DELETE, "{+baseurl}/identityGovernance/permissionsAnalytics", pathParameters);
    ...
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final PermissionsAnalyticsAggregation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.PATCH, "{+baseurl}/identityGovernance/permissionsAnalytics", pathParameters);
