package com.microsoft.graph.beta.agentregistry.agentinstances;

import com.microsoft.graph.beta.agentregistry.agentinstances.count.CountRequestBuilder;
import com.microsoft.graph.beta.agentregistry.agentinstances.item.AgentInstanceItemRequestBuilder;
...
public class AgentInstancesRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link AgentInstancesRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public AgentInstancesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public AgentInstancesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/agentregistry-list-agentinstances?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/agentregistry-post-agentinstances?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/agentRegistry/agentInstances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AgentInstance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/agentRegistry/agentInstances", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public AgentInstancesRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new AgentInstancesRequestBuilder(rawUrl, requestAdapter);
    }
    /**
     * Get a list of the agentInstance objects and their properties.
     */
