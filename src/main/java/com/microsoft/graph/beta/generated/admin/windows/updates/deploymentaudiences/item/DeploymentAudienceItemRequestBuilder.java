...
import com.microsoft.graph.beta.admin.windows.updates.deploymentaudiences.item.microsoftgraphwindowsupdatesupdateaudiencebyid.MicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder;
...
public class DeploymentAudienceItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public DeploymentAudienceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link DeploymentAudienceItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public DeploymentAudienceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}", rawUrl);
    }
    /**
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}{?%24expand,%24select}", pathParameters);
    ...
    public DeploymentAudienceItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        ...
        return new DeploymentAudienceItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
