package com.microsoft.graph.beta.scopedrolememberships;
...
import com.microsoft.graph.beta.scopedrolememberships.count.CountRequestBuilder;
import com.microsoft.graph.beta.scopedrolememberships.item.ScopedRoleMembershipItemRequestBuilder;
...
public class ScopedRoleMembershipsRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link ScopedRoleMembershipsRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ScopedRoleMembershipsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/scopedRoleMemberships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ScopedRoleMembershipsRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ScopedRoleMembershipsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/scopedRoleMemberships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ScopedRoleMembership body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.POST, "{+baseurl}/scopedRoleMemberships", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public ScopedRoleMembershipsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
