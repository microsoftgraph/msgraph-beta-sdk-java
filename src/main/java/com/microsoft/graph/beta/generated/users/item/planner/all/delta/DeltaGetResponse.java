package com.microsoft.graph.beta.users.item.planner.all.delta;
...
public class DeltaGetResponse extends BaseDeltaFunctionResponse implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(PlannerDelta::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the value property value. The value property
     * @return a {@link java.util.List<PlannerDelta>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<PlannerDelta> getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<PlannerDelta> value) {
