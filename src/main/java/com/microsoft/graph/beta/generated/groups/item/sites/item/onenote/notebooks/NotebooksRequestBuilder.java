package com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks;

import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.getnotebookfromweburl.GetNotebookFromWebUrlRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.getrecentnotebookswithincludepersonalnotebooks.GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.onenote.notebooks.item.NotebookItemRequestBuilder;
...
public class NotebooksRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
