package com.microsoft.graph.beta.groups.item.memberof;

import com.microsoft.graph.beta.groups.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberof.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.memberof.item.DirectoryObjectItemRequestBuilder;
...
public class MemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-memberof?view=graph-rest-beta">Find more info here</a>
     */
