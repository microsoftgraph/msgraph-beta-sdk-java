package com.microsoft.graph.beta.devicemanagement.comanageddevices.item.remotelock;
...
public class RemoteLockRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link RemoteLockRequestBuilder} and sets the default values.
    ...
    public RemoteLockRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/remoteLock", pathParameters);
    }
    /**
     * Instantiates a new {@link RemoteLockRequestBuilder} and sets the default values.
    ...
    public RemoteLockRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/remoteLock", rawUrl);
    }
    /**
     * Remote lock
