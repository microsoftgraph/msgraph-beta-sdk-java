package com.microsoft.graph.beta.planner.goals;
...
import com.microsoft.graph.beta.planner.goals.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.goals.item.PlannerGoalItemRequestBuilder;
...
public class GoalsRequestBuilder extends BaseRequestBuilder {
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GoalsRequestBuilder} and sets the default values.
    ...
    public GoalsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/goals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public PlannerGoal post(@jakarta.annotation.Nonnull final PlannerGoal body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public PlannerGoal post(@jakarta.annotation.Nonnull final PlannerGoal body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PlannerGoal body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PlannerGoal body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
