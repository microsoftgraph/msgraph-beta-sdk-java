package com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.channels.item.planner.plans.item.goals.item;
...
public class PlannerGoalItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PlannerGoalItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}/goals/{plannerGoal%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link PlannerGoalItemRequestBuilder} and sets the default values.
    ...
    public PlannerGoalItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}/goals/{plannerGoal%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
