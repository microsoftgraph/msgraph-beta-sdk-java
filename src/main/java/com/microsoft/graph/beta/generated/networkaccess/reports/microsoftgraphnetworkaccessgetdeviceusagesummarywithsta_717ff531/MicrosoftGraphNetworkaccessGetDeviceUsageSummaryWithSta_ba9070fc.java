package com.microsoft.graph.beta.networkaccess.reports.microsoftgraphnetworkaccessgetdeviceusagesummarywithsta_717ff531;
...
public class MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc(rawUrl, requestAdapter);
    }
    /**
