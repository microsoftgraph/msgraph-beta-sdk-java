package com.microsoft.graph.beta.app.calls.item.playprompt;
...
public class PlayPromptPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    /**
     * Instantiates a new {@link PlayPromptPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link PlayPromptPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("loop", (n) -> { this.setLoop(n.getBooleanValue()); });
     ...
     */
    public void setLoop(@jakarta.annotation.Nullable final Boolean value) {
