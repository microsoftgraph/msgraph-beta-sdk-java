...
public class AuthenticationFailure extends Entity implements Parsable {
    /**
     * Instantiates a new {@link AuthenticationFailure} and sets the default values.
     */
     ...
     * @return a {@link AuthenticationFailure}
     */
    @jakarta.annotation.Nonnull
    public static AuthenticationFailure createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reasonCode", (n) -> { this.setReasonCode(n.getEnumValue(AuthenticationFailureReasonCode::forValue)); });
     ...
     * @return a {@link AuthenticationFailureReasonCode}
     */
    @jakarta.annotation.Nullable
    public AuthenticationFailureReasonCode getReasonCode() {
     ...
     */
    public void setReasonCode(@jakarta.annotation.Nullable final AuthenticationFailureReasonCode value) {
