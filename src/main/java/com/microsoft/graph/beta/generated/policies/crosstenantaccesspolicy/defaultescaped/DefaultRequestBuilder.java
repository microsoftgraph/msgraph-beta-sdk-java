package com.microsoft.graph.beta.policies.crosstenantaccesspolicy.defaultescaped;

import com.microsoft.graph.beta.models.CrossTenantAccessPolicyConfigurationDefault;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.defaultescaped.m365capabilities.M365CapabilitiesRequestBuilder;
import com.microsoft.graph.beta.policies.crosstenantaccesspolicy.defaultescaped.resettosystemdefault.ResetToSystemDefaultRequestBuilder;
...
public class DefaultRequestBuilder extends BaseRequestBuilder {
    ...
    public DefaultRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/default", pathParameters);
    }
    /**
     * Instantiates a new {@link DefaultRequestBuilder} and sets the default values.
    ...
    public DefaultRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/default", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationdefault-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link CrossTenantAccessPolicyConfigurationDefault}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationdefault-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/policies/crossTenantAccessPolicy/default{?%24expand,%24select}", pathParameters);
