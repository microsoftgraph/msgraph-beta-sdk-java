...
public class DriftResourceInfo implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DriftResourceInfo} and sets the default values.
     */
    public DriftResourceInfo() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static DriftResourceInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getCatalogIdentifier() {
        return this.backingStore.get("catalogIdentifier");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("catalogIdentifier", (n) -> { this.setCatalogIdentifier(n.getStringValue()); });
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(AccessDriftResourceType::forValue)); });
     ...
     * @return a {@link AccessDriftResourceType}
     */
    @jakarta.annotation.Nullable
    public AccessDriftResourceType getType() {
     ...
     * @param value Value to set for the catalogIdentifier property.
     */
    public void setCatalogIdentifier(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("catalogIdentifier", value);
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final AccessDriftResourceType value) {
