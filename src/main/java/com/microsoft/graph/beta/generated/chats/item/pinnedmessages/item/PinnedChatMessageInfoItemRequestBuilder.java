package com.microsoft.graph.beta.chats.item.pinnedmessages.item;

import com.microsoft.graph.beta.chats.item.pinnedmessages.item.message.MessageRequestBuilder;
...
public class PinnedChatMessageInfoItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PinnedChatMessageInfoItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link PinnedChatMessageInfoItemRequestBuilder} and sets the default values.
    ...
    public PinnedChatMessageInfoItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}", rawUrl);
    }
    /**
     * Unpin a message from a chat.
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/chat-delete-pinnedmessages?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}{?%24expand,%24select}", pathParameters);
