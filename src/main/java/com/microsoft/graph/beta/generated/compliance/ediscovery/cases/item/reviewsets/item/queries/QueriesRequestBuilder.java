package com.microsoft.graph.beta.compliance.ediscovery.cases.item.reviewsets.item.queries;

import com.microsoft.graph.beta.compliance.ediscovery.cases.item.reviewsets.item.queries.count.CountRequestBuilder;
import com.microsoft.graph.beta.compliance.ediscovery.cases.item.reviewsets.item.queries.item.ReviewSetQueryItemRequestBuilder;
import com.microsoft.graph.beta.models.ediscovery.ReviewSetQuery;
import com.microsoft.graph.beta.models.ediscovery.ReviewSetQueryCollectionResponse;
...
public class QueriesRequestBuilder extends BaseRequestBuilder {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public ReviewSetQueryItemRequestBuilder byReviewSetQueryId(@jakarta.annotation.Nonnull final String reviewSetQueryId) {
    ...
    @Deprecated
    public ReviewSetQueryCollectionResponse get() {
        return get(null);
    }
    /**
     * Retrieve a list of eDiscovery reviewSetQuery objects.
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public ReviewSetQuery post(@jakarta.annotation.Nonnull final ReviewSetQuery body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public ReviewSetQuery post(@jakarta.annotation.Nonnull final ReviewSetQuery body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}/queries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ReviewSetQuery body) {
