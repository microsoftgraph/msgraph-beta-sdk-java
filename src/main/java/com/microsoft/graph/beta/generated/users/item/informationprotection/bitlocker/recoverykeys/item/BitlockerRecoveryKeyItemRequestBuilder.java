package com.microsoft.graph.beta.users.item.informationprotection.bitlocker.recoverykeys.item;
...
public class BitlockerRecoveryKeyItemRequestBuilder extends BaseRequestBuilder {
    ...
    public BitlockerRecoveryKeyItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link BitlockerRecoveryKeyItemRequestBuilder} and sets the default values.
    ...
    public BitlockerRecoveryKeyItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24expand,%24select}", rawUrl);
    }
    /**
