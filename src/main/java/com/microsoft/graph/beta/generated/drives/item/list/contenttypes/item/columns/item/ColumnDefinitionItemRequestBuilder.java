package com.microsoft.graph.beta.drives.item.list.contenttypes.item.columns.item;

import com.microsoft.graph.beta.drives.item.list.contenttypes.item.columns.item.sourcecolumn.SourceColumnRequestBuilder;
