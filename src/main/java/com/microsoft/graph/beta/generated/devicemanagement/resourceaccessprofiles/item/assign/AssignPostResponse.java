package com.microsoft.graph.beta.devicemanagement.resourceaccessprofiles.item.assign;
...
public class AssignPostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(DeviceManagementResourceAccessProfileAssignment::createFromDiscriminatorValue)); });
    ...
    public java.util.List<DeviceManagementResourceAccessProfileAssignment> getValue() {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<DeviceManagementResourceAccessProfileAssignment> value) {
