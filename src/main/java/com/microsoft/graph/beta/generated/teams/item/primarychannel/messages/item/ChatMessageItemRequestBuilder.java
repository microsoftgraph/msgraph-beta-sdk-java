package com.microsoft.graph.beta.teams.item.primarychannel.messages.item;

import com.microsoft.graph.beta.models.ChatMessage;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.hostedcontents.HostedContentsRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.replies.RepliesRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.setreaction.SetReactionRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.softdelete.SoftDeleteRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
import com.microsoft.graph.beta.teams.item.primarychannel.messages.item.unsetreaction.UnsetReactionRequestBuilder;
