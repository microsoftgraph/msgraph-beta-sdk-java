package com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item;

import com.microsoft.graph.beta.models.Contact;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.permanentdelete.PermanentDeleteRequestBuilder;
import com.microsoft.graph.beta.users.item.contactfolders.item.childfolders.item.contacts.item.photo.PhotoRequestBuilder;
