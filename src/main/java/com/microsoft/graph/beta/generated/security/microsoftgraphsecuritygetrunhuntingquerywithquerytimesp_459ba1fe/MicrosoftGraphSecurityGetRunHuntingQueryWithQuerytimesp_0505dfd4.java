package com.microsoft.graph.beta.security.microsoftgraphsecuritygetrunhuntingquerywithquerytimesp_459ba1fe;
...
public class MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param query Usage: query=&apos;{query}&apos;
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final String query) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4(rawUrl, requestAdapter);
    }
    /**
     * Query a specified set of event, activity, or entity data supported by Microsoft Defender XDR to proactively look for specific threats in your environment, by using a GET request. This function is the GET-based companion to the runHuntingQuery action. It accepts a query in Kusto Query Language (KQL) as a URL parameter, executes it against the advanced hunting schema, and returns the same huntingQueryResults shape as the POST action. Use this function in scenarios that can&apos;t issue authenticated POST requests, such as Power BI dashboards that authenticate through Web.Contents. Find out more about hunting for threats across devices, emails, apps, and identities. Learn about KQL. For information on using advanced hunting in the Microsoft Defender portal, see Proactively hunt for threats with advanced hunting in Microsoft Defender XDR.
     */
