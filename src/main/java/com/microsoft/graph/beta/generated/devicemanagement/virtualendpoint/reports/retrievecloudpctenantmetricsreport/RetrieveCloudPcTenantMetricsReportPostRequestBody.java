...
import com.microsoft.graph.beta.models.CloudPCPerformanceReportName;
...
public class RetrieveCloudPcTenantMetricsReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link RetrieveCloudPcTenantMetricsReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RetrieveCloudPcTenantMetricsReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RetrieveCloudPcTenantMetricsReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RetrieveCloudPcTenantMetricsReportPostRequestBody();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("reportName", (n) -> { this.setReportName(n.getEnumValue(CloudPCPerformanceReportName::forValue)); });
     ...
     */
    public void setReportName(@jakarta.annotation.Nullable final CloudPCPerformanceReportName value) {
