...
public class BusinessScenarioItemRequestBuilder extends BaseRequestBuilder {
    ...
    public BusinessScenarioItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new BusinessScenarioItemRequestBuilder and sets the default values.
    ...
    public BusinessScenarioItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
