package com.microsoft.graph.beta.groups.item.sites.item.contentmodels.item;

import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.item.addtodrive.AddToDriveRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.item.getapplieddrives.GetAppliedDrivesRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.contentmodels.item.removefromdrive.RemoveFromDriveRequestBuilder;
...
public class ContentModelItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ContentModelItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/{contentModel%2Did}", pathParameters);
    }
    /**
     * Instantiates a new {@link ContentModelItemRequestBuilder} and sets the default values.
    ...
    public ContentModelItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/{contentModel%2Did}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ContentModel patch(@jakarta.annotation.Nonnull final ContentModel body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ContentModel patch(@jakarta.annotation.Nonnull final ContentModel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/{contentModel%2Did}{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ContentModel body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ContentModel body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public ContentModelItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new ContentModelItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
