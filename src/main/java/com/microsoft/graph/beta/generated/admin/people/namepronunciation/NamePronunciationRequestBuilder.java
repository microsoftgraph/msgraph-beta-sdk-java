...
public class NamePronunciationRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public NamePronunciationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/people/namePronunciation", pathParameters);
    }
    /**
     * Instantiates a new {@link NamePronunciationRequestBuilder} and sets the default values.
    ...
    public NamePronunciationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/people/namePronunciation", rawUrl);
    }
    /**
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/namepronunciationsettings-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nullable
    public NamePronunciationSettings get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
     ...
     * @return a {@link NamePronunciationSettings}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/namepronunciationsettings-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
     ...
     */
    @jakarta.annotation.Nullable
    public NamePronunciationSettings patch(@jakarta.annotation.Nonnull final NamePronunciationSettings body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/admin/people/namePronunciation{?%24expand,%24select}", pathParameters);
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final NamePronunciationSettings body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
