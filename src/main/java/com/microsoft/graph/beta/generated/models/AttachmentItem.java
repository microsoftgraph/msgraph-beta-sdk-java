...
public class AttachmentItem implements AdditionalDataHolder, BackedModel, Parsable {
     ...
     * @return a AttachmentItemAttachmentType
     */
    @jakarta.annotation.Nullable
    public AttachmentItemAttachmentType getAttachmentType() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("attachmentType", (n) -> { this.setAttachmentType(n.getEnumValue(AttachmentItemAttachmentType::forValue)); });
     ...
     */
    public void setAttachmentType(@jakarta.annotation.Nullable final AttachmentItemAttachmentType value) {
