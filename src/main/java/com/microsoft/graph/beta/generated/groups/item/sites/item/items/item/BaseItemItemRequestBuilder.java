package com.microsoft.graph.beta.groups.item.sites.item.items.item;
...
public class BaseItemItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link BaseItemItemRequestBuilder} and sets the default values.
    ...
    public BaseItemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/items/{baseItem%2Did}{?%24expand,%24select}", pathParameters);
    }
    /**
     * Instantiates a new {@link BaseItemItemRequestBuilder} and sets the default values.
