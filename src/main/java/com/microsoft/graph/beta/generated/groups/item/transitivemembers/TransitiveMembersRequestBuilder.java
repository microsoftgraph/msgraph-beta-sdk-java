package com.microsoft.graph.beta.groups.item.transitivemembers;

import com.microsoft.graph.beta.groups.item.transitivemembers.count.CountRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphapplication.GraphApplicationRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphdevice.GraphDeviceRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphgroup.GraphGroupRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphorgcontact.GraphOrgContactRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.beta.groups.item.transitivemembers.item.DirectoryObjectItemRequestBuilder;
...
public class TransitiveMembersRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/group-list-transitivemembers?view=graph-rest-beta">Find more info here</a>
     */
