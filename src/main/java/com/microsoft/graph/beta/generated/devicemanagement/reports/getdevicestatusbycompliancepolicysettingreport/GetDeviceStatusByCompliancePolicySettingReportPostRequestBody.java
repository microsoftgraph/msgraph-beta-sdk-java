package com.microsoft.graph.beta.devicemanagement.reports.getdevicestatusbycompliancepolicysettingreport;
...
public class GetDeviceStatusByCompliancePolicySettingReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetDeviceStatusByCompliancePolicySettingReportPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link GetDeviceStatusByCompliancePolicySettingReportPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceStatusByCompliancePolicySettingReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
