package com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.customtaskextensions;

import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.customtaskextensions.count.CountRequestBuilder;
import com.microsoft.graph.beta.identitygovernance.lifecycleworkflows.customtaskextensions.item.CustomTaskExtensionItemRequestBuilder;
import com.microsoft.graph.beta.models.identitygovernance.CustomTaskExtension;
import com.microsoft.graph.beta.models.identitygovernance.CustomTaskExtensionCollectionResponse;
...
public class CustomTaskExtensionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/identitygovernance-lifecycleworkflowscontainer-list-customtaskextensions?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/identitygovernance-lifecycleworkflowscontainer-post-customtaskextensions?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
