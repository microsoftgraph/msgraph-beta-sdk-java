...
public class User extends DirectoryObject implements Parsable {
    ...
    public java.util.List<AppConsentRequest> getAppConsentRequestsForApproval() {
        return this.backingStore.get("appConsentRequestsForApproval");
    }
    /**
    ...
    public java.util.List<ServicePrincipal> getAppRoleAssignedResources() {
        return this.backingStore.get("appRoleAssignedResources");
    }
    /**
    ...
    public java.util.List<DeviceKey> getDeviceKeys() {
        return this.backingStore.get("deviceKeys");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("virtualEvents", (n) -> { this.setVirtualEvents(n.getObjectValue(UserVirtualEventsRoot::createFromDiscriminatorValue)); });
    ...
    public java.util.List<Group> getJoinedGroups() {
        return this.backingStore.get("joinedGroups");
    }
    /**
    ...
    public java.util.List<MobileAppIntentAndState> getMobileAppIntentAndStates() {
        return this.backingStore.get("mobileAppIntentAndStates");
    }
    /**
    ...
    /**
     * Gets the passwordProfile property value. Specifies the password profile for the user. The profile contains the user's password. This property is required when a user is created. The password in the profile must satisfy minimum requirements as specified by the passwordPolicies property. By default, a strong password is required. Supports $filter (eq, ne, not, in, and eq on null values). To update this property:  In delegated access, the calling app must be assigned the Directory.AccessAsUser.All delegated permission on behalf of the signed-in user.  In application-only access, the calling app must be assigned the User.ReadWrite.All (least privilege) or Directory.ReadWrite.All (higher privilege) application permission and at least the User Administrator Microsoft Entra role.
    ...
    public java.util.List<AccessReviewInstance> getPendingAccessReviewInstances() {
        return this.backingStore.get("pendingAccessReviewInstances");
    }
    /**
    ...
    public void setAppConsentRequestsForApproval(@jakarta.annotation.Nullable final java.util.List<AppConsentRequest> value) {
        this.backingStore.set("appConsentRequestsForApproval", value);
    }
    /**
    ...
    public void setAppRoleAssignedResources(@jakarta.annotation.Nullable final java.util.List<ServicePrincipal> value) {
        this.backingStore.set("appRoleAssignedResources", value);
    }
    /**
    ...
    public void setDeviceKeys(@jakarta.annotation.Nullable final java.util.List<DeviceKey> value) {
        this.backingStore.set("deviceKeys", value);
    }
    /**
    ...
    public void setJoinedGroups(@jakarta.annotation.Nullable final java.util.List<Group> value) {
        this.backingStore.set("joinedGroups", value);
    }
    /**
    ...
    public void setMobileAppIntentAndStates(@jakarta.annotation.Nullable final java.util.List<MobileAppIntentAndState> value) {
        this.backingStore.set("mobileAppIntentAndStates", value);
    }
    /**
    ...
    public void setPendingAccessReviewInstances(@jakarta.annotation.Nullable final java.util.List<AccessReviewInstance> value) {
        this.backingStore.set("pendingAccessReviewInstances", value);
    }
    /**
     ...
     */
    public void setVirtualEvents(@jakarta.annotation.Nullable final UserVirtualEventsRoot value) {
