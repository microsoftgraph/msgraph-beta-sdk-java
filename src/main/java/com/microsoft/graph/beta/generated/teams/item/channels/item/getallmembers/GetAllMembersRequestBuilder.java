package com.microsoft.graph.beta.teams.item.channels.item.getallmembers;
...
import com.microsoft.graph.beta.teams.item.channels.item.getallmembers.add.AddRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.getallmembers.count.CountRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.getallmembers.item.ConversationMemberItemRequestBuilder;
import com.microsoft.graph.beta.teams.item.channels.item.getallmembers.remove.RemoveRequestBuilder;
...
public class GetAllMembersRequestBuilder extends BaseRequestBuilder {
    ...
    public GetAllMembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/getAllMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link GetAllMembersRequestBuilder} and sets the default values.
    ...
    public GetAllMembersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/getAllMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
