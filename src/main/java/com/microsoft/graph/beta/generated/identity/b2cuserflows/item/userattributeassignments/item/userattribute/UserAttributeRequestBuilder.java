package com.microsoft.graph.beta.identity.b2cuserflows.item.userattributeassignments.item.userattribute;
...
public class UserAttributeRequestBuilder extends BaseRequestBuilder {
    ...
    public UserAttributeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}/userAttribute{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UserAttributeRequestBuilder and sets the default values.
    ...
    public UserAttributeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}/userAttribute{?%24select,%24expand}", rawUrl);
    }
    /**
