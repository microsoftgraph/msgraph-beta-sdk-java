package com.microsoft.graph.beta.users.item.outlook;

import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.OutlookUser;
import com.microsoft.graph.beta.users.item.outlook.mastercategories.MasterCategoriesRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.supportedlanguages.SupportedLanguagesRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.supportedtimezones.SupportedTimeZonesRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.supportedtimezoneswithtimezonestandard.SupportedTimeZonesWithTimeZoneStandardRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.taskfolders.TaskFoldersRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.taskgroups.TaskGroupsRequestBuilder;
import com.microsoft.graph.beta.users.item.outlook.tasks.TasksRequestBuilder;
