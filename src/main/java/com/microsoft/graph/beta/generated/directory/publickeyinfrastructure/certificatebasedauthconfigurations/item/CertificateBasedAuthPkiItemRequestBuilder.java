package com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations.item;

import com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations.item.certificateauthorities.CertificateAuthoritiesRequestBuilder;
import com.microsoft.graph.beta.directory.publickeyinfrastructure.certificatebasedauthconfigurations.item.upload.UploadRequestBuilder;
...
public class CertificateBasedAuthPkiItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/publickeyinfrastructureroot-delete-certificatebasedauthconfigurations?view=graph-rest-beta">Find more info here</a>
     */
    public void delete() {
        delete(null);
    }
     ...
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/certificatebasedauthpki-get?view=graph-rest-beta">Find more info here</a>
     */
     ...
     * @return a {@link CertificateBasedAuthPki}
     * @throws ODataError When receiving a 4XX or 5XX status code
     * @see <a href="https://learn.microsoft.com/graph/api/certificatebasedauthpki-update?view=graph-rest-beta">Find more info here</a>
     */
    @jakarta.annotation.Nullable
