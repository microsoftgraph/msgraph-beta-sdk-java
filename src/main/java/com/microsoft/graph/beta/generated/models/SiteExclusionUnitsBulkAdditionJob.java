...
public class SiteExclusionUnitsBulkAdditionJob extends ExclusionUnitBulkAdditionJob implements Parsable {
    /**
     * Instantiates a new {@link SiteExclusionUnitsBulkAdditionJob} and sets the default values.
     */
    public SiteExclusionUnitsBulkAdditionJob() {
        super();
    ...
    public static SiteExclusionUnitsBulkAdditionJob createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
