package com.microsoft.graph.beta.teamtemplatedefinition.item.teamdefinition.primarychannel.planner.plans.item.movetocontainer;

import com.microsoft.graph.beta.models.PlannerPlanContainer;
...
public class MoveToContainerPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MoveToContainerPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link MoveToContainerPostRequestBody}
     */
    @jakarta.annotation.Nonnull
