...
public class AttendeeNotificationInfo implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AttendeeNotificationInfo} and sets the default values.
     */
     ...
     * @return a {@link AttendeeNotificationInfo}
     */
    @jakarta.annotation.Nonnull
    public static AttendeeNotificationInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
