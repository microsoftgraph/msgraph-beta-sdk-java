...
public class MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegm_18174033 extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegm_18174033} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegm_18174033(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public GetDiscoveredApplicationSegmentReportWithStartDateTimeW_45f6b6f6 get() {
        return get(null);
    }
    /**
     * Returns a collection of discovered application segments based on aggregated traffic logs for a given period.
     ...
     */
    @jakarta.annotation.Nullable
    public GetDiscoveredApplicationSegmentReportWithStartDateTimeW_45f6b6f6 get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("XXX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetDiscoveredApplicationSegmentReportWithStartDateTimeW_45f6b6f6::createFromDiscriminatorValue);
    }
    /**
     * Returns a collection of discovered application segments based on aggregated traffic logs for a given period.
     ...
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegm_18174033 withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegm_18174033(rawUrl, requestAdapter);
    }
    /**
     * Returns a collection of discovered application segments based on aggregated traffic logs for a given period.
     */
