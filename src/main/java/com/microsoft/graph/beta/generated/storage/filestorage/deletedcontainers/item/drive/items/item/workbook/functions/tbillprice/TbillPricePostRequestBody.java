package com.microsoft.graph.beta.storage.filestorage.deletedcontainers.item.drive.items.item.workbook.functions.tbillprice;
...
public class TbillPricePostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TbillPricePostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link TbillPricePostRequestBody}
     */
    @jakarta.annotation.Nonnull
