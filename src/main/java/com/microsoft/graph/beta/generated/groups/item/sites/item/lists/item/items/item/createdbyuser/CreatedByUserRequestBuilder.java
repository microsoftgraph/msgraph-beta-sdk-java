package com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.createdbyuser;

import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.beta.groups.item.sites.item.lists.item.items.item.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
