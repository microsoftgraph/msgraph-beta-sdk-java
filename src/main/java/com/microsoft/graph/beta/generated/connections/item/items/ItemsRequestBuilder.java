package com.microsoft.graph.beta.connections.item.items;

import com.microsoft.graph.beta.connections.item.items.count.CountRequestBuilder;
import com.microsoft.graph.beta.connections.item.items.item.ExternalItemItemRequestBuilder;
import com.microsoft.graph.beta.models.externalconnectors.ExternalItem;
import com.microsoft.graph.beta.models.externalconnectors.ExternalItemCollectionResponse;
...
public class ItemsRequestBuilder extends BaseRequestBuilder {
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/connections/{externalConnection%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
