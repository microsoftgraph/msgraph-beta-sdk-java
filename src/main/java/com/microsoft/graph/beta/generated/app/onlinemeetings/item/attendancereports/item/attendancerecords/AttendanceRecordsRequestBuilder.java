package com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.item.attendancerecords;

import com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.item.attendancerecords.count.CountRequestBuilder;
import com.microsoft.graph.beta.app.onlinemeetings.item.attendancereports.item.attendancerecords.item.AttendanceRecordItemRequestBuilder;
...
public class AttendanceRecordsRequestBuilder extends BaseRequestBuilder {
    ...
    public AttendanceRecordsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link AttendanceRecordsRequestBuilder} and sets the default values.
    ...
    public AttendanceRecordsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
