package com.microsoft.graph.beta.users.item.calendargroups.item.calendars.item.calendarview.item.exceptionoccurrences.item.instances.item.snoozereminder;

import com.microsoft.graph.beta.models.DateTimeTimeZone;
