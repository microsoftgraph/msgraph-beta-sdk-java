package com.microsoft.graph.beta.auditlogs.provisioning;

import com.microsoft.graph.beta.auditlogs.provisioning.count.CountRequestBuilder;
import com.microsoft.graph.beta.auditlogs.provisioning.item.ProvisioningObjectSummaryItemRequestBuilder;
import com.microsoft.graph.beta.models.odataerrors.ODataError;
import com.microsoft.graph.beta.models.ProvisioningObjectSummary;
import com.microsoft.graph.beta.models.ProvisioningObjectSummaryCollectionResponse;
...
public class ProvisioningRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/provisioningobjectsummary-list?view=graph-rest-beta">Find more info here</a>
     */
    ...
    public RequestInformation toGetRequestInformation(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = new RequestInformation(HttpMethod.GET, "{+baseurl}/auditLogs/provisioning{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
