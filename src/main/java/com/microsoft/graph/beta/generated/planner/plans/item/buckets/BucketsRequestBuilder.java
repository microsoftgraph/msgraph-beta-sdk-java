package com.microsoft.graph.beta.planner.plans.item.buckets;
...
import com.microsoft.graph.beta.planner.plans.item.buckets.count.CountRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.buckets.delta.DeltaRequestBuilder;
import com.microsoft.graph.beta.planner.plans.item.buckets.item.PlannerBucketItemRequestBuilder;
...
public class BucketsRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/plannerplan-list-buckets?view=graph-rest-beta">Find more info here</a>
     */
