...
import microsoft.graph.models.DeviceAppManagementTaskStatus;
/** Provides operations to call the updateStatus method.  */
public class UpdateStatusRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updateStatusRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdateStatusRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateStatusRequestBody currentObject = this;
