...
public class DeviceAppManagementTasksRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the deviceAppManagementTasks property of the microsoft.graph.deviceAppManagement entity.
     * @param deviceAppManagementTaskId Unique identifier of the item
     * @return a DeviceAppManagementTaskItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeviceAppManagementTaskItemRequestBuilder byDeviceAppManagementTaskId(@javax.annotation.Nonnull final String deviceAppManagementTaskId) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceAppManagementTaskCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceAppManagementTask> post(@javax.annotation.Nonnull final DeviceAppManagementTask body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceAppManagementTask body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceAppManagementTask body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
