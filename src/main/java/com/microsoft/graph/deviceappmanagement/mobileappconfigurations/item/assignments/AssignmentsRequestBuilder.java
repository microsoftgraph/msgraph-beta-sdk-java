...
public class AssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ManagedDeviceMobileAppConfigurationAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ManagedDeviceMobileAppConfigurationAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse>() {{
