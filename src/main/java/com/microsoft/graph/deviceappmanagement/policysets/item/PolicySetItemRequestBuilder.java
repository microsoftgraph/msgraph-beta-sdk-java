...
public class PolicySetItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PolicySet> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PolicySet::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<PolicySet>() {{
                this.completeExceptionally(ex);
            }};
        }
    }
