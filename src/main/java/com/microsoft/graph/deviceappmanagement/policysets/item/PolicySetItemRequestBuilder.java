...
public class PolicySetItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PolicySetItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PolicySetItemRequestBuilder and sets the default values.
    ...
    public PolicySetItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<PolicySet> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PolicySet> executionException = new java.util.concurrent.CompletableFuture<PolicySet>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PolicySet> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PolicySet> patch(@javax.annotation.Nonnull final PolicySet body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final PolicySet body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final PolicySet body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
