...
public class ItemsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse>();
