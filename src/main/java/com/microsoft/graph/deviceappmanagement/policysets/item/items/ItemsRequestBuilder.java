...
public class ItemsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the items property of the microsoft.graph.policySet entity.
     * @param policySetItemId Unique identifier of the item
     * @return a PolicySetItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PolicySetItemItemRequestBuilder byPolicySetItemId(@javax.annotation.Nonnull final String policySetItemId) {
    ...
    public java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PolicySetItemCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PolicySetItem> post(@javax.annotation.Nonnull final PolicySetItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PolicySetItem body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PolicySetItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
