...
public class GroupAssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MobileAppProvisioningConfigGroupAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MobileAppProvisioningConfigGroupAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileAppProvisioningConfigGroupAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobileAppProvisioningConfigGroupAssignmentCollectionResponse>();
