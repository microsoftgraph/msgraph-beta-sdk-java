...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse
     */
    ...
    public WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsDefenderApplicationControlSupplementalPolicyAssignment post(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicyAssignment body) {
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsDefenderApplicationControlSupplementalPolicyAssignment post(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicyAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, WindowsDefenderApplicationControlSupplementalPolicyAssignment::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The associated group assignments for the Windows Defender Application Control Supplemental Policy.
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicyAssignment body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicyAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
