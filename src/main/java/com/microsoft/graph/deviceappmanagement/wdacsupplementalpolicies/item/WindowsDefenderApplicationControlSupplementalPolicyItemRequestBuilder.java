...
public class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> executionException = new java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
