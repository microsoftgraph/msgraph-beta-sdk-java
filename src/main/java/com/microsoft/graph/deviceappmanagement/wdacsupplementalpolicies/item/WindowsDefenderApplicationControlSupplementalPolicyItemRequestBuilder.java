...
public class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of windowsDefenderApplicationControlSupplementalPolicy
     */
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> patch(@javax.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of windowsDefenderApplicationControlSupplementalPolicy
     */
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> patch(@javax.annotation.Nonnull final WindowsDefenderApplicationControlSupplementalPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
