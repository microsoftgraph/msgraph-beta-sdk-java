...
public class DeploySummaryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyDeploymentSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyDeploymentSummary> executionException = new java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyDeploymentSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
