...
public class WdacSupplementalPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse>();
