...
public class WdacSupplementalPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    public WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
