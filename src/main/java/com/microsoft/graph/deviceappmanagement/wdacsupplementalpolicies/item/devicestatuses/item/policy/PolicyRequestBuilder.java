package com.microsoft.graph.deviceappmanagement.wdacsupplementalpolicies.item.devicestatuses.item.policy;
...
public class PolicyRequestBuilder {
    ...
    public PolicyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicy%2Did}/deviceStatuses/{windowsDefenderApplicationControlSupplementalPolicyDeploymentStatus%2Did}/policy{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of windowsDefenderApplicationControlSupplementalPolicy
     */
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of windowsDefenderApplicationControlSupplementalPolicy
     */
    public java.util.concurrent.CompletableFuture<WindowsDefenderApplicationControlSupplementalPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
