package com.microsoft.graph.deviceappmanagement.wdacsupplementalpolicies.item.assign;
...
public class AssignPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("wdacPolicyAssignments", (n) -> { currentObject.setWdacPolicyAssignments(n.getCollectionOfObjectValues(WindowsDefenderApplicationControlSupplementalPolicyAssignment::createFromDiscriminatorValue)); });
