...
public class AssignPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     */
    private java.util.List<WindowsDefenderApplicationControlSupplementalPolicyAssignment> wdacPolicyAssignments;
    /**
    ...
    public java.util.List<WindowsDefenderApplicationControlSupplementalPolicyAssignment> getWdacPolicyAssignments() {
        return this.wdacPolicyAssignments;
    }
    /**
     ...
     */
    public void setWdacPolicyAssignments(@jakarta.annotation.Nullable final java.util.List<WindowsDefenderApplicationControlSupplementalPolicyAssignment> value) {
        this.wdacPolicyAssignments = value;
    }
}
