...
public class WindowsInformationProtectionWipeActionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WindowsInformationProtectionWipeAction body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeActionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeActionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeActionCollectionResponse>();
