...
public class WindowsInformationProtectionWipeActionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final WindowsInformationProtectionWipeAction body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeAction> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeAction> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionWipeAction>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
