...
public class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse>();
