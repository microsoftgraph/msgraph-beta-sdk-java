 ...
 */
public class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String deviceId, @javax.annotation.Nullable final String userPrincipalName) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}'){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters);
    ...
    public GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}'){?%24top,%24skip,%24search,%24filter,%24count}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
