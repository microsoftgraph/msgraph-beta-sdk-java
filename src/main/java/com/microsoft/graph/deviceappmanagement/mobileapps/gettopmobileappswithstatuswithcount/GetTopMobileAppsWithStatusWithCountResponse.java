...
public class GetTopMobileAppsWithStatusWithCountResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getTopMobileAppsWithStatusWithCountResponse
     */
    @javax.annotation.Nonnull
    public static GetTopMobileAppsWithStatusWithCountResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
