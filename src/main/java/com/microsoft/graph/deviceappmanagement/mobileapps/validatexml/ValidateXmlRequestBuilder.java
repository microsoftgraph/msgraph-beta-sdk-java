...
public class ValidateXmlRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ValidateXmlPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ValidateXmlPostResponse> post(@jakarta.annotation.Nonnull final ValidateXmlPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ValidateXmlPostResponse> post(@jakarta.annotation.Nonnull final ValidateXmlPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ValidateXmlPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action validateXml
     * @param body The request body
