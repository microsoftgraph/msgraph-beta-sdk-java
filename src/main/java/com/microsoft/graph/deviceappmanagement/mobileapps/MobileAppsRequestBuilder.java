...
public class MobileAppsRequestBuilder {
     ...
     * @return a getMobileAppCountWithStatusRequestBuilder
     */
    @javax.annotation.Nonnull
    public GetMobileAppCountWithStatusRequestBuilder getMobileAppCountWithStatus(@javax.annotation.Nonnull final String status) {
     ...
     * @param status Usage: status='{status}'
     * @return a getTopMobileAppsWithStatusWithCountRequestBuilder
     */
    @javax.annotation.Nonnull
    public GetTopMobileAppsWithStatusWithCountRequestBuilder getTopMobileAppsWithStatusWithCount(@javax.annotation.Nonnull final Long count, @javax.annotation.Nonnull final String status) {
