package microsoft.graph.deviceappmanagement.mobileapps.item.devicestatuses.item;
...
import microsoft.graph.deviceappmanagement.mobileapps.item.devicestatuses.item.app.AppRequestBuilder;
