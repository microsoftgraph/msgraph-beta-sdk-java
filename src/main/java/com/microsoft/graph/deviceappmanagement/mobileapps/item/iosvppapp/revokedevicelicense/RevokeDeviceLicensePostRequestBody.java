...
public class RevokeDeviceLicensePostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a revokeDeviceLicensePostRequestBody
     */
    @javax.annotation.Nonnull
    public static RevokeDeviceLicensePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RevokeDeviceLicensePostRequestBody currentObject = this;
