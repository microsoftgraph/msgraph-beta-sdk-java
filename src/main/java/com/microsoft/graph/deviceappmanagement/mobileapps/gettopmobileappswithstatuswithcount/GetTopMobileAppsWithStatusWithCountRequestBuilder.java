...
public class GetTopMobileAppsWithStatusWithCountRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse> executionException = new java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse>();
