 ...
 */
public class GetTopMobileAppsWithStatusWithCountRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GetTopMobileAppsWithStatusWithCountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final Long count, @javax.annotation.Nullable final String status) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/getTopMobileApps(status='{status}',count={count}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters);
        this.pathParameters..put("count", count);
        this.pathParameters..put("status", status);
    }
    /**
     * Instantiates a new GetTopMobileAppsWithStatusWithCountRequestBuilder and sets the default values.
    ...
    public GetTopMobileAppsWithStatusWithCountRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/getTopMobileApps(status='{status}',count={count}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse> executionException = new java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetTopMobileAppsWithStatusWithCountResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
