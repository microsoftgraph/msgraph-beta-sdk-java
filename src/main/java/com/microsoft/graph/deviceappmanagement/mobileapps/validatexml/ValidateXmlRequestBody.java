package microsoft.graph.deviceappmanagement.mobileapps.validatexml;
...
public class ValidateXmlRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a validateXmlRequestBody
     */
    @javax.annotation.Nonnull
    public static ValidateXmlRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ValidateXmlRequestBody currentObject = this;
