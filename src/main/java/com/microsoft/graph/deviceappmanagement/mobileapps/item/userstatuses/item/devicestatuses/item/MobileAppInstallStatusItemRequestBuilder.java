...
public class MobileAppInstallStatusItemRequestBuilder {
     ...
     * @return a CompletableFuture of mobileAppInstallStatus
     */
    public java.util.concurrent.CompletableFuture<MobileAppInstallStatus> patch(@javax.annotation.Nonnull final MobileAppInstallStatus body, @javax.annotation.Nullable final java.util.function.Consumer<MobileAppInstallStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
