package com.microsoft.graph.deviceappmanagement.mobileapps.item.userstatuses.item.app;
...
public class AppRequestBuilder extends BaseRequestBuilder {
    ...
    public AppRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}/app{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AppRequestBuilder and sets the default values.
    ...
    public AppRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}/app{?%24select,%24expand}", rawUrl);
    }
    /**
