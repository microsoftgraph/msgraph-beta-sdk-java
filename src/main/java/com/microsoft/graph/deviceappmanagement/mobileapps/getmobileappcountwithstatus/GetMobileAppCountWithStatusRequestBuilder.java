...
public class GetMobileAppCountWithStatusRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetMobileAppCountWithStatusResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetMobileAppCountWithStatusResponse> executionException = new java.util.concurrent.CompletableFuture<GetMobileAppCountWithStatusResponse>();
