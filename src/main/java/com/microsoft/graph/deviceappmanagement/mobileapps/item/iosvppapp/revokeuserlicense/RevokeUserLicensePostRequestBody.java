...
public class RevokeUserLicensePostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a revokeUserLicensePostRequestBody
     */
    @javax.annotation.Nonnull
    public static RevokeUserLicensePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RevokeUserLicensePostRequestBody currentObject = this;
