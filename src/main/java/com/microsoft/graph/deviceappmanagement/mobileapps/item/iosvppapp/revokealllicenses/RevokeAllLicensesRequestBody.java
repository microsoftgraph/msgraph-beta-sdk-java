...
public class RevokeAllLicensesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a revokeAllLicensesRequestBody
     */
    @javax.annotation.Nonnull
    public static RevokeAllLicensesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RevokeAllLicensesRequestBody currentObject = this;
