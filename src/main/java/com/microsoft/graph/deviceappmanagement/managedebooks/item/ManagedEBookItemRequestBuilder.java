...
import microsoft.graph.deviceappmanagement.managedebooks.item.categories.CategoriesRequestBuilder;
import microsoft.graph.deviceappmanagement.managedebooks.item.categories.item.ManagedEBookCategoryItemRequestBuilder;
