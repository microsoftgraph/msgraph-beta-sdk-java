package microsoft.graph.deviceappmanagement.managedebooks.item.categories;
...
import microsoft.graph.deviceappmanagement.managedebooks.item.categories.count.CountRequestBuilder;
import microsoft.graph.models.ManagedEBookCategoryCollectionResponse;
