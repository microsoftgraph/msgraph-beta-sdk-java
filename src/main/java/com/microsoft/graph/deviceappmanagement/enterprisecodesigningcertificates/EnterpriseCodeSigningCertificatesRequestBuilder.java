...
public class EnterpriseCodeSigningCertificatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the enterpriseCodeSigningCertificates property of the microsoft.graph.deviceAppManagement entity.
     * @param enterpriseCodeSigningCertificateId Unique identifier of the item
     * @return a EnterpriseCodeSigningCertificateItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public EnterpriseCodeSigningCertificateItemRequestBuilder byEnterpriseCodeSigningCertificateId(@javax.annotation.Nonnull final String enterpriseCodeSigningCertificateId) {
    ...
    public java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EnterpriseCodeSigningCertificateCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificate> post(@javax.annotation.Nonnull final EnterpriseCodeSigningCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EnterpriseCodeSigningCertificate body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EnterpriseCodeSigningCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
