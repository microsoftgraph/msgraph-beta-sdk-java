...
public class EnterpriseCodeSigningCertificatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EnterpriseCodeSigningCertificateCollectionResponse>();
