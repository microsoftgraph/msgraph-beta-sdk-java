...
public class GetLicensesForAppWithBundleIdRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetLicensesForAppWithBundleIdGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetLicensesForAppWithBundleIdGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function getLicensesForApp
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetLicensesForAppWithBundleIdGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetLicensesForAppWithBundleIdGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getLicensesForApp
