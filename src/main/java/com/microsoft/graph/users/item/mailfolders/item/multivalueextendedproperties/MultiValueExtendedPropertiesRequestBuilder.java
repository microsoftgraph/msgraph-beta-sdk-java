package com.microsoft.graph.users.item.mailfolders.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.mailfolders.item.multivalueextendedproperties.count.CountRequestBuilder;
