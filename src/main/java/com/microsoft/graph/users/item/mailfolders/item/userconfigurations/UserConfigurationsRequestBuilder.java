package com.microsoft.graph.users.item.mailfolders.item.userconfigurations;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserConfigurationCollectionResponse;
import com.microsoft.graph.users.item.mailfolders.item.userconfigurations.count.CountRequestBuilder;
...
public class UserConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    public UserConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/userConfigurations{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new UserConfigurationsRequestBuilder and sets the default values.
    ...
    public UserConfigurationsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/userConfigurations{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserConfigurationCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
