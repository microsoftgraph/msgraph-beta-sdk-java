...
import com.microsoft.graph.users.item.manageddevices.appdiagnosticswithupn.AppDiagnosticsWithUpnRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.bulkreprovisioncloudpc.BulkReprovisionCloudPcRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.bulkrestorecloudpc.BulkRestoreCloudPcRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.bulksetcloudpcreviewstatus.BulkSetCloudPcReviewStatusRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.count.CountRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.downloadappdiagnostics.DownloadAppDiagnosticsRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.executeaction.ExecuteActionRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.movedevicestoou.MoveDevicesToOURequestBuilder;
