package microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.getloggedonmanageddevices;
...
public class GetLoggedOnManagedDevicesResponse implements AdditionalDataHolder, Parsable {
