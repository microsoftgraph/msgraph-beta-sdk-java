package com.microsoft.graph.users.item.authentication.methods.item.disablesmssignin;
...
public class DisableSmsSignInRequestBuilder {
    ...
    public DisableSmsSignInRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/methods/{authenticationMethod%2Did}/disableSmsSignIn";
