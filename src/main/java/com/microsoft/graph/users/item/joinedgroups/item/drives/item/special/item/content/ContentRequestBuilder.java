package microsoft.graph.users.item.joinedgroups.item.drives.item.special.item.content;
...
public class ContentRequestBuilder {
    ...
    public ContentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/special/{driveItem%2Did}/content";
