...
public class PositionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WorkPosition body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WorkPositionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WorkPositionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WorkPositionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WorkPosition> post(@javax.annotation.Nonnull final WorkPosition body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<WorkPosition> executionException = new java.util.concurrent.CompletableFuture<WorkPosition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
