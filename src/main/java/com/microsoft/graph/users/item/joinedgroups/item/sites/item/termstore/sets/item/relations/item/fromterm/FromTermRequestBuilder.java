package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.relations.item.fromterm;
...
public class FromTermRequestBuilder {
    ...
    public FromTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}";
