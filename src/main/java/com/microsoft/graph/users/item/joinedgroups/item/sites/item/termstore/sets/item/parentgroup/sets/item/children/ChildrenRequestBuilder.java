package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.count.CountRequestBuilder;
...
public class ChildrenRequestBuilder {
    ...
    public ChildrenRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
