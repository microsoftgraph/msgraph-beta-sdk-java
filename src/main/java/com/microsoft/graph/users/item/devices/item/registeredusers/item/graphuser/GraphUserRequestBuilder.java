package com.microsoft.graph.users.item.devices.item.registeredusers.item.graphuser;
...
public class GraphUserRequestBuilder {
    ...
    public GraphUserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.user{?%24select,%24expand}";
