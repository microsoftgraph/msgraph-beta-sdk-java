package com.microsoft.graph.users.item.tasks.lists.item.tasks.item.checklistitems.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists/{baseTaskList%2Did}/tasks/{baseTask%2Did}/checklistItems/$count";
