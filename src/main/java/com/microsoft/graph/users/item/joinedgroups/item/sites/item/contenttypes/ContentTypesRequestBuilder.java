package microsoft.graph.users.item.joinedgroups.item.sites.item.contenttypes;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
...
public class ContentTypesRequestBuilder {
    ...
    public ContentTypesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
