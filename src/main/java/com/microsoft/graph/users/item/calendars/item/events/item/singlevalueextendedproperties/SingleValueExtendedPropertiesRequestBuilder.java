package com.microsoft.graph.users.item.calendars.item.events.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.calendars.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
