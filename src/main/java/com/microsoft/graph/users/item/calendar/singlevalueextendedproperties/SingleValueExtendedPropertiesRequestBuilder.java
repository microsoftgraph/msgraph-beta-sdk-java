package com.microsoft.graph.users.item.calendar.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.singlevalueextendedproperties.count.CountRequestBuilder;
