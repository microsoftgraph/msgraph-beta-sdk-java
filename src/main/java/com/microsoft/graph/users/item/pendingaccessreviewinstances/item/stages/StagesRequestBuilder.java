package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages;
...
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.count.CountRequestBuilder;
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
...
public class StagesRequestBuilder extends BaseRequestBuilder {
    ...
    public StagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new StagesRequestBuilder and sets the default values.
    ...
    public StagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
