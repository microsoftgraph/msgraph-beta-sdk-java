package com.microsoft.graph.users.item.devices.item.registeredowners.item;

import com.microsoft.graph.users.item.devices.item.registeredowners.item.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.item.ref.RefRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
    ...
    public DirectoryObjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}", rawUrl);
    }
}
