package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.acceptrecommendations;
...
public class AcceptRecommendationsRequestBuilder {
    ...
    public AcceptRecommendationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/acceptRecommendations";
