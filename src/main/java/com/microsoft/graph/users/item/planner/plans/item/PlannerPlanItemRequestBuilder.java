...
public class PlannerPlanItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.planner.plans.item.buckets.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
