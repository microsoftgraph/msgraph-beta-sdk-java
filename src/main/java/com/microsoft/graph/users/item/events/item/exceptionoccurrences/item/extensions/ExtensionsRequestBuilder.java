package microsoft.graph.users.item.events.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.users.item.events.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
