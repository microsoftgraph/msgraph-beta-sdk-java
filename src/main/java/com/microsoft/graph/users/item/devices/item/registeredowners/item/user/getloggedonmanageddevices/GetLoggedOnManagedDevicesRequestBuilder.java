package microsoft.graph.users.item.devices.item.registeredowners.item.user.getloggedonmanageddevices;
...
public class GetLoggedOnManagedDevicesRequestBuilder {
    ...
    public GetLoggedOnManagedDevicesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getLoggedOnManagedDevices()";
