package microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
