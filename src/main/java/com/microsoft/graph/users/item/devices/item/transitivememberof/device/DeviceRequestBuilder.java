package microsoft.graph.users.item.devices.item.transitivememberof.device;
...
import microsoft.graph.users.item.devices.item.transitivememberof.device.count.CountRequestBuilder;
