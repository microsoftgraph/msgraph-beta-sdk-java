package microsoft.graph.users.item.devices.item.memberof.item.user.wipemanagedappregistrationsbydevicetag;
...
public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
    ...
    public WipeManagedAppRegistrationsByDeviceTagRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.wipeManagedAppRegistrationsByDeviceTag";
