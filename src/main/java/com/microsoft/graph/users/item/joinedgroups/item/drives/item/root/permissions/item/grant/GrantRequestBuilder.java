package microsoft.graph.users.item.joinedgroups.item.drives.item.root.permissions.item.grant;
...
public class GrantRequestBuilder {
    ...
    public GrantRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/permissions/{permission%2Did}/microsoft.graph.grant";
