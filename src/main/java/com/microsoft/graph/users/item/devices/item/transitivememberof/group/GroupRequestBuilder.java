package microsoft.graph.users.item.devices.item.transitivememberof.group;
...
import microsoft.graph.users.item.devices.item.transitivememberof.group.count.CountRequestBuilder;
