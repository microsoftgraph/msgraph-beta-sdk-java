package microsoft.graph.users.item.joinedgroups.item.team.schedule.timecards.item.clockout;
...
public class ClockOutRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a clockOutRequestBody
     */
    @javax.annotation.Nonnull
    public static ClockOutRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ClockOutRequestBody currentObject = this;
