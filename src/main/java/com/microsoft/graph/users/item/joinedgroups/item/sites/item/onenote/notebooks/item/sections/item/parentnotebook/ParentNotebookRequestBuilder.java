package microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sections.item.parentnotebook;
...
public class ParentNotebookRequestBuilder {
    ...
    public ParentNotebookRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}";
