...
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder;
...
public class AuthenticationRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.authentication.passwordlessMicrosoftAuthenticatorMethods.item collection
     * @param id Unique identifier of the item
     * @return a passwordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder passwordlessMicrosoftAuthenticatorMethods(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did", id);
