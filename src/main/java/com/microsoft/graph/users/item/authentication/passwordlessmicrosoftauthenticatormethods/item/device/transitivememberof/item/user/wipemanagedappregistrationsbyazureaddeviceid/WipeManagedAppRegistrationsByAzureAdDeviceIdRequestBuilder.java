package microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.user.wipemanagedappregistrationsbyazureaddeviceid;
...
public class WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder {
    ...
    public WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.wipeManagedAppRegistrationsByAzureAdDeviceId";
