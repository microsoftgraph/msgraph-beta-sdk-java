package com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof;

import com.microsoft.graph.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.count.CountRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.user.UserRequestBuilder;
