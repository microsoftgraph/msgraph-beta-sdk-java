package com.microsoft.graph.users.item.calendars.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendars.item.multivalueextendedproperties.count.CountRequestBuilder;
