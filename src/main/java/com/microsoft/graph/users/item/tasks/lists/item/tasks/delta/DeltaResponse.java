package com.microsoft.graph.users.item.tasks.lists.item.tasks.delta;
...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
    private java.util.List<BaseTask> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(BaseTask::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<BaseTask> getValue() {
        return this._value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<BaseTask> value) {
        this._value = value;
    }
}
