package microsoft.graph.users.item.manageddevices.item.overridecompliancestate;
...
public class OverrideComplianceStateRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a overrideComplianceStateRequestBody
     */
    @javax.annotation.Nonnull
    public static OverrideComplianceStateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final OverrideComplianceStateRequestBody currentObject = this;
