package com.microsoft.graph.users.item.devices.item.memberof.item.graphadministrativeunit;
...
public class GraphAdministrativeUnitRequestBuilder {
    ...
    public GraphAdministrativeUnitRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}";
