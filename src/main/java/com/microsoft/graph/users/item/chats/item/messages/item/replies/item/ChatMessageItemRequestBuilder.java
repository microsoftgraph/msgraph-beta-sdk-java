...
import microsoft.graph.users.item.chats.item.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.users.item.chats.item.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
