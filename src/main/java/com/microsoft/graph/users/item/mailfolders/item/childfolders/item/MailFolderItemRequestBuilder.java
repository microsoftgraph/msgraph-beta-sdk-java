package microsoft.graph.users.item.mailfolders.item.childfolders.item;
...
import microsoft.graph.users.item.mailfolders.item.childfolders.item.copy.CopyRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messagerules.item.MessageRuleItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messagerules.MessageRulesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.MessageItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.MessagesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.move.MoveRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.userconfigurations.item.UserConfigurationItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.childfolders.item.userconfigurations.UserConfigurationsRequestBuilder;
...
public class MailFolderItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.mailFolders.item.childFolders.item.userConfigurations.item collection
     * @param id Unique identifier of the item
     * @return a userConfigurationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public UserConfigurationItemRequestBuilder userConfigurations(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("userConfiguration%2Did", id);
