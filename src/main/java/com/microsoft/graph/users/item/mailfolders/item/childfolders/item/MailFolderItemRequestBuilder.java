...
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.userconfigurations.item.UserConfigurationItemRequestBuilder;
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.userconfigurations.UserConfigurationsRequestBuilder;
...
public class MailFolderItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.mailFolders.item.childFolders.item.messageRules.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.mailFolders.item.childFolders.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.mailFolders.item.childFolders.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.mailFolders.item.childFolders.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.mailFolders.item.childFolders.item.userConfigurations.item collection
     * @param id Unique identifier of the item
