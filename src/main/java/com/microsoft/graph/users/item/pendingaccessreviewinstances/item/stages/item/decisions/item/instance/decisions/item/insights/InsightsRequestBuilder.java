package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.decisions.item.insights;
...
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.decisions.item.insights.count.CountRequestBuilder;
