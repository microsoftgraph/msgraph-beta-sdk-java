...
import com.microsoft.graph.users.item.messages.item.markasjunk.MarkAsJunkRequestBuilder;
import com.microsoft.graph.users.item.messages.item.markasnotjunk.MarkAsNotJunkRequestBuilder;
