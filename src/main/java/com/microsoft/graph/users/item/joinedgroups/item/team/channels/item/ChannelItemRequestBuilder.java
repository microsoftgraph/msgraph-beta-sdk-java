package microsoft.graph.users.item.joinedgroups.item.team.channels.item;
...
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.completemigration.CompleteMigrationRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.filesfolder.FilesFolderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.members.item.ConversationMemberItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.members.MembersRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.messages.item.ChatMessageItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.messages.MessagesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.provisionemail.ProvisionEmailRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.removeemail.RemoveEmailRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.sharedwithteams.item.SharedWithChannelTeamInfoItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.sharedwithteams.SharedWithTeamsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.tabs.item.TeamsTabItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.tabs.TabsRequestBuilder;
...
public class ChannelItemRequestBuilder {
    ...
    public ChannelItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.channels.item.members.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.channels.item.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.channels.item.tabs.item collection
     * @param id Unique identifier of the item
