package microsoft.graph.users.item.outlook.taskgroups.item.taskfolders.item.tasks.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.outlook.taskgroups.item.taskfolders.item.tasks.item.multivalueextendedproperties.count.CountRequestBuilder;
