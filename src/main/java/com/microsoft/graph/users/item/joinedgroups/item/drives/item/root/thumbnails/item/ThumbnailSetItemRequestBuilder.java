package microsoft.graph.users.item.joinedgroups.item.drives.item.root.thumbnails.item;
...
public class ThumbnailSetItemRequestBuilder {
    ...
    public ThumbnailSetItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}";
