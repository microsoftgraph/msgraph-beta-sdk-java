...
public class LanguagesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the languages property of the microsoft.graph.profile entity.
     * @param languageProficiencyId Unique identifier of the item
     * @return a LanguageProficiencyItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public LanguageProficiencyItemRequestBuilder byLanguageProficiencyId(@javax.annotation.Nonnull final String languageProficiencyId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/profile-list-languages?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<LanguageProficiencyCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<LanguageProficiencyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LanguageProficiencyCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<LanguageProficiencyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/profile-post-languages?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<LanguageProficiency> post(@javax.annotation.Nonnull final LanguageProficiency body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final LanguageProficiency body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final LanguageProficiency body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
