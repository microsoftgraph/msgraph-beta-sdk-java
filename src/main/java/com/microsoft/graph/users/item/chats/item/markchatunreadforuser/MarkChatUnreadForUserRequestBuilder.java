...
public class MarkChatUnreadForUserRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<Void> post(@jakarta.annotation.Nonnull final MarkChatUnreadForUserPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> post(@jakarta.annotation.Nonnull final MarkChatUnreadForUserPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
