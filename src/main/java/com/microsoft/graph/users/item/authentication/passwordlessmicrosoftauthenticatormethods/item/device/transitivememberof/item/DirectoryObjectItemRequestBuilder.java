package com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item;

import com.microsoft.graph.models.DirectoryObject;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.device.DeviceRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.group.GroupRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.user.UserRequestBuilder;
