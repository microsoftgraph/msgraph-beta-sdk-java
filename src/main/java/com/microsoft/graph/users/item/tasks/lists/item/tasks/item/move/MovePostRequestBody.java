package com.microsoft.graph.users.item.tasks.lists.item.tasks.item.move;
...
public class MovePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private String _destinationTaskListId;
    /**
     ...
     */
    @javax.annotation.Nullable
    public String getDestinationTaskListId() {
        return this._destinationTaskListId;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("destinationTaskListId", (n) -> { currentObject.setDestinationTaskListId(n.getStringValue()); });
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("destinationTaskListId", this.getDestinationTaskListId());
     ...
     * @param value Value to set for the destinationTaskListId property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setDestinationTaskListId(@javax.annotation.Nullable final String value) {
        this._destinationTaskListId = value;
    }
}
