package com.microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.calendargroups.item.calendars.item.events.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
