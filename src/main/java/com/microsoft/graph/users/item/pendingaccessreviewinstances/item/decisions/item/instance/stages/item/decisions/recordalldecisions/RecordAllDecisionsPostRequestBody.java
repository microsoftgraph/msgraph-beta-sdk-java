package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.decisions.item.instance.stages.item.decisions.recordalldecisions;
...
public class RecordAllDecisionsPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a recordAllDecisionsPostRequestBody
     */
    @javax.annotation.Nonnull
    public static RecordAllDecisionsPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RecordAllDecisionsPostRequestBody currentObject = this;
