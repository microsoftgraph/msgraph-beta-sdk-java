package com.microsoft.graph.users.item.manageddevices.item.devicehealthscriptstates;

import com.microsoft.graph.models.DeviceHealthScriptPolicyStateCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.manageddevices.item.devicehealthscriptstates.count.CountRequestBuilder;
import com.microsoft.graph.users.item.manageddevices.item.devicehealthscriptstates.withidwithpolicyidwithdeviceid.WithIdWithPolicyIdWithDeviceIdRequestBuilder;
...
public class DeviceHealthScriptStatesRequestBuilder {
    ...
    public DeviceHealthScriptStatesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
