package com.microsoft.graph.users.item.contactfolders.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.contactfolders.item.singlevalueextendedproperties.count.CountRequestBuilder;
