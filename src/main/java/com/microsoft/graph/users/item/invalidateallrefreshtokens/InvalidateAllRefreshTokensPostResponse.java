...
public class InvalidateAllRefreshTokensPostResponse implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static InvalidateAllRefreshTokensPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
