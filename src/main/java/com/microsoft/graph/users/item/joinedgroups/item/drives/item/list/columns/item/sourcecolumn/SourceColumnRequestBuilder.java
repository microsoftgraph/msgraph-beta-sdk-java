package microsoft.graph.users.item.joinedgroups.item.drives.item.list.columns.item.sourcecolumn;
...
public class SourceColumnRequestBuilder {
    ...
    public SourceColumnRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}";
