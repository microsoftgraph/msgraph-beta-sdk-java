...
public class MentionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Mention body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MentionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MentionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MentionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Mention> post(@javax.annotation.Nonnull final Mention body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Mention> executionException = new java.util.concurrent.CompletableFuture<Mention>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
