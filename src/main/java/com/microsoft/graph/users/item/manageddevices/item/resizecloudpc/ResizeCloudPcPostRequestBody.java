package com.microsoft.graph.users.item.manageddevices.item.resizecloudpc;
...
public class ResizeCloudPcPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("targetServicePlanId", (n) -> { currentObject.setTargetServicePlanId(n.getStringValue()); });
