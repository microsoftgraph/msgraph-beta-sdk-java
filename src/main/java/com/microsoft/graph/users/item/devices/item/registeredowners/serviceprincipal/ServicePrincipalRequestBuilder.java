package microsoft.graph.users.item.devices.item.registeredowners.serviceprincipal;
...
import microsoft.graph.users.item.devices.item.registeredowners.serviceprincipal.count.CountRequestBuilder;
