...
import com.microsoft.graph.users.item.onlinemeetings.item.transcripts.item.CallTranscriptItemRequestBuilder;
...
public class OnlineMeetingItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onlineMeetings.item.attendanceReports.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.onlineMeetings.item.transcripts.item collection
     * @param id Unique identifier of the item
