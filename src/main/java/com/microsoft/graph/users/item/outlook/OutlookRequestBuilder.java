...
import microsoft.graph.users.item.outlook.taskfolders.item.OutlookTaskFolderItemRequestBuilder;
import microsoft.graph.users.item.outlook.taskfolders.TaskFoldersRequestBuilder;
import microsoft.graph.users.item.outlook.taskgroups.item.OutlookTaskGroupItemRequestBuilder;
import microsoft.graph.users.item.outlook.taskgroups.TaskGroupsRequestBuilder;
import microsoft.graph.users.item.outlook.tasks.item.OutlookTaskItemRequestBuilder;
import microsoft.graph.users.item.outlook.tasks.TasksRequestBuilder;
...
public class OutlookRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.outlook.taskFolders.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.outlook.taskGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.outlook.tasks.item collection
     * @param id Unique identifier of the item
