...
public class PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder extends BaseRequestBuilder {
    ...
    public PasswordlessMicrosoftAuthenticatorAuthenticationMethodCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, PasswordlessMicrosoftAuthenticatorAuthenticationMethodCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve a list of a user's Microsoft Authenticator Passwordless Phone Sign-in method objects and their properties. This API is available in the following national cloud deployments.
