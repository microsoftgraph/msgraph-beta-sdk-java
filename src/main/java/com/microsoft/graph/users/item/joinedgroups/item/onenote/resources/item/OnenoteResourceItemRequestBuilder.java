package microsoft.graph.users.item.joinedgroups.item.onenote.resources.item;
...
import microsoft.graph.users.item.joinedgroups.item.onenote.resources.item.content.ContentRequestBuilder;
...
public class OnenoteResourceItemRequestBuilder {
    ...
    public OnenoteResourceItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/resources/{onenoteResource%2Did}{?%24select,%24expand}";
