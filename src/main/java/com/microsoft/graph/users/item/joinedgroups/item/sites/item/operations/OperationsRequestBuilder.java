package microsoft.graph.users.item.joinedgroups.item.sites.item.operations;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
