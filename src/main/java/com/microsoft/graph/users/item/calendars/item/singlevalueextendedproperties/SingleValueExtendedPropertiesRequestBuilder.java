package com.microsoft.graph.users.item.calendars.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.calendars.item.singlevalueextendedproperties.count.CountRequestBuilder;
