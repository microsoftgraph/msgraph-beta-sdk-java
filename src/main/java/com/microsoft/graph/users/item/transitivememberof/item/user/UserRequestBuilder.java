...
import microsoft.graph.users.item.transitivememberof.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
...
import microsoft.graph.users.item.transitivememberof.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
...
import microsoft.graph.users.item.transitivememberof.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
...
import microsoft.graph.users.item.transitivememberof.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
...
import microsoft.graph.users.item.transitivememberof.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
...
import microsoft.graph.users.item.transitivememberof.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.users.item.transitivememberof.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
