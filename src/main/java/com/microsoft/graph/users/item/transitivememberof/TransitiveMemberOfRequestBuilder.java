...
import com.microsoft.graph.users.item.transitivememberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.device.DeviceRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.group.GroupRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.transitivememberof.user.UserRequestBuilder;
