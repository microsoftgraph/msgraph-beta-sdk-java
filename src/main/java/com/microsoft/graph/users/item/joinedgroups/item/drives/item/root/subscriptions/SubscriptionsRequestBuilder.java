package microsoft.graph.users.item.joinedgroups.item.drives.item.root.subscriptions;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.subscriptions.count.CountRequestBuilder;
...
public class SubscriptionsRequestBuilder {
    ...
    public SubscriptionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
