package microsoft.graph.users.item.joinedgroups.item.planner.plans.item;
...
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.buckets.BucketsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.buckets.item.PlannerBucketItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.details.DetailsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.TasksRequestBuilder;
...
public class PlannerPlanItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.planner.plans.item.buckets.item collection
    ...
    public PlannerPlanItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<PlannerPlanItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of plannerPlan
     */
    public java.util.concurrent.CompletableFuture<PlannerPlan> get(@javax.annotation.Nullable final java.util.function.Consumer<PlannerPlanItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PlannerPlan body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PlannerPlan body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerPlanItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final PlannerPlan body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerPlanItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
