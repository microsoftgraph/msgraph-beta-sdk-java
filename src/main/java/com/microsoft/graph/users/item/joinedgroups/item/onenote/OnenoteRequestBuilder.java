package microsoft.graph.users.item.joinedgroups.item.onenote;
...
import microsoft.graph.users.item.joinedgroups.item.onenote.notebooks.item.NotebookItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.notebooks.NotebooksRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.operations.item.OnenoteOperationItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.operations.OperationsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.pages.PagesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.resources.item.OnenoteResourceItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.resources.ResourcesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.SectionsRequestBuilder;
...
public class OnenoteRequestBuilder {
    ...
    public OnenoteRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.notebooks.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.pages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.sectionGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.sections.item collection
     * @param id Unique identifier of the item
