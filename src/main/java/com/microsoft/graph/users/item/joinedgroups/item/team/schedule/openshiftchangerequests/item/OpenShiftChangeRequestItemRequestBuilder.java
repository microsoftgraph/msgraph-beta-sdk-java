package microsoft.graph.users.item.joinedgroups.item.team.schedule.openshiftchangerequests.item;
...
public class OpenShiftChangeRequestItemRequestBuilder {
    ...
    public OpenShiftChangeRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24select,%24expand}";
