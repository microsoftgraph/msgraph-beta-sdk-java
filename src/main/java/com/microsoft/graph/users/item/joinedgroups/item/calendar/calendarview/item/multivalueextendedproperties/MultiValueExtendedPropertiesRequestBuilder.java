package microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.item.multivalueextendedproperties.count.CountRequestBuilder;
...
public class MultiValueExtendedPropertiesRequestBuilder {
    ...
    public MultiValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
