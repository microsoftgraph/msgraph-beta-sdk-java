...
public class MobileAppTroubleshootingEventsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MobileAppTroubleshootingEvent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEventCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEventCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEventCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEvent> post(@javax.annotation.Nonnull final MobileAppTroubleshootingEvent body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEvent> executionException = new java.util.concurrent.CompletableFuture<MobileAppTroubleshootingEvent>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
