package com.microsoft.graph.users.item.tasks.lists;
...
import com.microsoft.graph.users.item.tasks.lists.count.CountRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.delta.DeltaRequestBuilder;
...
public class ListsRequestBuilder {
    ...
    public ListsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
