...
public class InvalidateAllRefreshTokensRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<InvalidateAllRefreshTokensResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<InvalidateAllRefreshTokensResponse> executionException = new java.util.concurrent.CompletableFuture<InvalidateAllRefreshTokensResponse>();
