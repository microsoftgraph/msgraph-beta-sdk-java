...
import com.microsoft.graph.users.item.devices.item.memberof.item.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.item.graphgroup.GraphGroupRequestBuilder;
