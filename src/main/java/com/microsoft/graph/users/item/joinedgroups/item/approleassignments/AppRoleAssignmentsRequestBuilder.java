package microsoft.graph.users.item.joinedgroups.item.approleassignments;
...
import microsoft.graph.users.item.joinedgroups.item.approleassignments.count.CountRequestBuilder;
...
public class AppRoleAssignmentsRequestBuilder {
    ...
    public AppRoleAssignmentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
