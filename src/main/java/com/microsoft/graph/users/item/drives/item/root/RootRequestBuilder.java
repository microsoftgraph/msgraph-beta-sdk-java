...
import microsoft.graph.users.item.drives.item.root.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.drives.item.root.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.users.item.drives.item.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.drives.item.root.activities.item collection
