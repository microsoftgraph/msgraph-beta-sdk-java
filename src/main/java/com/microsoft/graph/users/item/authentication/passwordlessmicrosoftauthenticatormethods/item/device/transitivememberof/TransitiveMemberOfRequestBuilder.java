package microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof;
...
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.user.UserRequestBuilder;
