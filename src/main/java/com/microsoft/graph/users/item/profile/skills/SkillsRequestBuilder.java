...
public class SkillsRequestBuilder extends BaseRequestBuilder {
    ...
    public SkillProficiencyCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, SkillProficiencyCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public SkillProficiency post(@jakarta.annotation.Nonnull final SkillProficiency body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, SkillProficiency::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve a list of skillProficiency objects in a user's profile. This API is available in the following national cloud deployments.
