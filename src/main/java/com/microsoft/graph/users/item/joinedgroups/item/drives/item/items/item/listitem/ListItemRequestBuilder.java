package microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.createlink.CreateLinkRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.items.item.listItem.activities.item collection
    ...
    public ListItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.items.item.listItem.documentSetVersions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
