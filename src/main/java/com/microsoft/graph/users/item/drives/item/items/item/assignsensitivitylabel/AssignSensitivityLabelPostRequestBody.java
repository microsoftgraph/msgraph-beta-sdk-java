package com.microsoft.graph.users.item.drives.item.items.item.assignsensitivitylabel;
...
public class AssignSensitivityLabelPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("assignmentMethod", (n) -> { currentObject.setAssignmentMethod(n.getEnumValue(SensitivityLabelAssignmentMethod.class)); });
