package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item.relations.item.fromterm;
...
public class FromTermRequestBuilder {
    ...
    public FromTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}";
