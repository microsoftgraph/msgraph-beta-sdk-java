...
public class AccountRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserAccountInformation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserAccountInformationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserAccountInformationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserAccountInformationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserAccountInformation> post(@javax.annotation.Nonnull final UserAccountInformation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserAccountInformation> executionException = new java.util.concurrent.CompletableFuture<UserAccountInformation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
