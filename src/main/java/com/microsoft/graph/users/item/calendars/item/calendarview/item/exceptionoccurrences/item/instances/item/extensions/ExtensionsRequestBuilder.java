package microsoft.graph.users.item.calendars.item.calendarview.item.exceptionoccurrences.item.instances.item.extensions;
...
import microsoft.graph.users.item.calendars.item.calendarview.item.exceptionoccurrences.item.instances.item.extensions.count.CountRequestBuilder;
...
public class ExtensionsRequestBuilder {
    ...
    public ExtensionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
