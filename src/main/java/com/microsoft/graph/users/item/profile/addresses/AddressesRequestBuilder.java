...
public class AddressesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ItemAddressCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ItemAddressCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ItemAddressCollectionResponse>();
