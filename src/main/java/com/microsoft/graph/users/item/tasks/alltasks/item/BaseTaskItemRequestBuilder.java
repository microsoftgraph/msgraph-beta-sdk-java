package microsoft.graph.users.item.tasks.alltasks.item;
...
import microsoft.graph.users.item.tasks.alltasks.item.checklistitems.ChecklistItemsRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.checklistitems.item.ChecklistItemItemRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.linkedresources.item.LinkedResource_v2ItemRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.linkedresources.LinkedResourcesRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.move.MoveRequestBuilder;
import microsoft.graph.users.item.tasks.alltasks.item.parentlist.ParentListRequestBuilder;
