package com.microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.events.item.multivalueextendedproperties.count.CountRequestBuilder;
