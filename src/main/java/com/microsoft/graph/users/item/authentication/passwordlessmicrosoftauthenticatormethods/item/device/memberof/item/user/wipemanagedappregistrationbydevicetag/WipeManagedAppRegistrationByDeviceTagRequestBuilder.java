package microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.memberof.item.user.wipemanagedappregistrationbydevicetag;
...
public class WipeManagedAppRegistrationByDeviceTagRequestBuilder {
    ...
    public WipeManagedAppRegistrationByDeviceTagRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.wipeManagedAppRegistrationByDeviceTag";
