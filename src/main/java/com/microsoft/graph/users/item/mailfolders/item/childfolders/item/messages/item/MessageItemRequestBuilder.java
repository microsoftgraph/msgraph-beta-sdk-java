...
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.markasjunk.MarkAsJunkRequestBuilder;
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.markasnotjunk.MarkAsNotJunkRequestBuilder;
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.mentions.MentionsRequestBuilder;
...
import com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
