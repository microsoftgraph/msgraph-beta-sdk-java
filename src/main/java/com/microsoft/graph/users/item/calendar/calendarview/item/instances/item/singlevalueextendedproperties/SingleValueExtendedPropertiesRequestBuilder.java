package com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
