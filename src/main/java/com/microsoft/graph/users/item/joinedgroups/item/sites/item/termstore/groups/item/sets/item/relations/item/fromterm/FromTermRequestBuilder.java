package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.relations.item.fromterm;
...
public class FromTermRequestBuilder {
    ...
    public FromTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}";
