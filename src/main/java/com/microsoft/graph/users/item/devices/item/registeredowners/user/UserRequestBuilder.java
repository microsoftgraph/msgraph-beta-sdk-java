package microsoft.graph.users.item.devices.item.registeredowners.user;
...
import microsoft.graph.users.item.devices.item.registeredowners.user.count.CountRequestBuilder;
