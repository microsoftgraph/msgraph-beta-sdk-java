package microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item;
...
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.instances.item.exceptionOccurrences.item.attachments.item collection
    ...
    public EventItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.instances.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.instances.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.instances.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
