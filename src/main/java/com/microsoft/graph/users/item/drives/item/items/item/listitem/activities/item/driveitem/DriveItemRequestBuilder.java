package com.microsoft.graph.users.item.drives.item.items.item.listitem.activities.item.driveitem;

import com.microsoft.graph.models.DriveItem;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.drives.item.items.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    public DriveItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
