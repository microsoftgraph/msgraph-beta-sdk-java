package com.microsoft.graph.users.item.joinedgroups.evaluatedynamicmembership;
...
public class EvaluateDynamicMembershipPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("memberId", (n) -> { currentObject.setMemberId(n.getStringValue()); });
