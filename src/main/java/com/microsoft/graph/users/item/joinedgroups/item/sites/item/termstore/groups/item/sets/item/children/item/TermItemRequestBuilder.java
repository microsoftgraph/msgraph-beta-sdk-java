package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.children.item;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.children.item.children.ChildrenRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.item.sets.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.termStore.groups.item.sets.item.children.item.children.item collection
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.termStore.groups.item.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
