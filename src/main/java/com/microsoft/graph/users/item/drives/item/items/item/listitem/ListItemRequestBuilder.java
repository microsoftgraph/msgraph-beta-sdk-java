...
import microsoft.graph.users.item.drives.item.items.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.listitem.createlink.CreateLinkRequestBuilder;
