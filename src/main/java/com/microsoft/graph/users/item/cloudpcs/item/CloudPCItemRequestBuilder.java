...
import com.microsoft.graph.users.item.cloudpcs.item.getfrontlinecloudpcaccessstate.GetFrontlineCloudPcAccessStateRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.item.getshiftworkcloudpcaccessstate.GetShiftWorkCloudPcAccessStateRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.item.getsupportedcloudpcremoteactions.GetSupportedCloudPcRemoteActionsRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.item.poweroff.PowerOffRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.item.poweron.PowerOnRequestBuilder;
...
import com.microsoft.graph.users.item.cloudpcs.item.stop.StopRequestBuilder;
