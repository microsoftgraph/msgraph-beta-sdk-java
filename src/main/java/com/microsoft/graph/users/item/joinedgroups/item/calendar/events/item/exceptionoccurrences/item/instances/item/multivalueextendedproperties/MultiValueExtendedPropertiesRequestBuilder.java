package microsoft.graph.users.item.joinedgroups.item.calendar.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.joinedgroups.item.calendar.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
...
public class MultiValueExtendedPropertiesRequestBuilder {
    ...
    public MultiValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
