package com.microsoft.graph.users.item.activities.item.historyitems.item.activity;
...
public class ActivityRequestBuilder {
     ...
     * @return a CompletableFuture of userActivity
     */
    public java.util.concurrent.CompletableFuture<UserActivity> get(@javax.annotation.Nullable final java.util.function.Consumer<ActivityRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
