package microsoft.graph.users.item.joinedgroups.item.onenote.pages.item.copytosection;
...
public class CopyToSectionRequestBuilder {
    ...
    public CopyToSectionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.copyToSection";
