...
import com.microsoft.graph.users.item.drives.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.users.item.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.activities.item collection
