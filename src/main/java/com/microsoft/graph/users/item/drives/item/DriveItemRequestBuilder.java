...
import microsoft.graph.users.item.drives.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.drives.item.activities.item collection
