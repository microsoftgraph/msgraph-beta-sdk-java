package com.microsoft.graph.users.item.devices.item.registeredusers;

import com.microsoft.graph.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.devices.item.registeredusers.count.CountRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.ref.RefRequestBuilder;
...
public class RegisteredUsersRequestBuilder extends BaseRequestBuilder {
    ...
    public RegisteredUsersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RegisteredUsersRequestBuilder and sets the default values.
    ...
    public RegisteredUsersRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
