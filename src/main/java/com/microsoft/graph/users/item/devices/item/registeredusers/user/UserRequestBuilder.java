package microsoft.graph.users.item.devices.item.registeredusers.user;
...
import microsoft.graph.users.item.devices.item.registeredusers.user.count.CountRequestBuilder;
