package microsoft.graph.users.item.joinedgroups.item.threads;
...
import microsoft.graph.users.item.joinedgroups.item.threads.count.CountRequestBuilder;
...
public class ThreadsRequestBuilder {
    ...
    public ThreadsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
    ...
    /**
     * Create new navigation property to threads for users
     * @param body 
     * @return a RequestInformation
     */
    @javax.annotation.Nonnull
