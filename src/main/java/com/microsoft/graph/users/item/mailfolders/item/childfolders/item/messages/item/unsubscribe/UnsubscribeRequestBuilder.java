package com.microsoft.graph.users.item.mailfolders.item.childfolders.item.messages.item.unsubscribe;
...
public class UnsubscribeRequestBuilder {
    ...
    public UnsubscribeRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/unsubscribe";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/message-unsubscribe?view=graph-rest-1.0">Find more info here</a>
     */
