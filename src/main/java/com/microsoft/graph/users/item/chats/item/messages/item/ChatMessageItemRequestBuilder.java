...
import microsoft.graph.users.item.chats.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.users.item.chats.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
