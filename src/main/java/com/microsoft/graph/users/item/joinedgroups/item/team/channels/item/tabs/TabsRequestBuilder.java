package microsoft.graph.users.item.joinedgroups.item.team.channels.item.tabs;
...
import microsoft.graph.users.item.joinedgroups.item.team.channels.item.tabs.count.CountRequestBuilder;
...
public class TabsRequestBuilder {
    ...
    public TabsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
