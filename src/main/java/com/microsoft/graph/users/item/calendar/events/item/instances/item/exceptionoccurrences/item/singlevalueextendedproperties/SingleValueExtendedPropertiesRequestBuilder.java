package microsoft.graph.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.count.CountRequestBuilder;
