package microsoft.graph.users.item.joinedgroups.item.calendar.calendarview;
...
import microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.delta.DeltaRequestBuilder;
...
public class CalendarViewRequestBuilder {
    ...
    public CalendarViewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
