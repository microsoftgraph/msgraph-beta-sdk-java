package microsoft.graph.users.item.joinedgroups.item.drives.item.root.subscriptions.item;
...
public class SubscriptionItemRequestBuilder {
    ...
    public SubscriptionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}{?%24select,%24expand}";
