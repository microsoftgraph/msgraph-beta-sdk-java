...
public class PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PasswordlessMicrosoftAuthenticatorAuthenticationMethod> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PasswordlessMicrosoftAuthenticatorAuthenticationMethod> executionException = new java.util.concurrent.CompletableFuture<PasswordlessMicrosoftAuthenticatorAuthenticationMethod>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
