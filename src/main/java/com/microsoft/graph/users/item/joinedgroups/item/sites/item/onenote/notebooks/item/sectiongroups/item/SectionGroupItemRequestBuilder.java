package microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.notebooks.item.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    public SectionGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
