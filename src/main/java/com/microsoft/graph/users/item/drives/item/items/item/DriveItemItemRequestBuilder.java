...
import microsoft.graph.users.item.drives.item.items.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.drives.item.items.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.users.item.drives.item.items.item.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.drives.item.items.item.activities.item collection
