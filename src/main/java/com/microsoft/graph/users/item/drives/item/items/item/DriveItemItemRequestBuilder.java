...
import com.microsoft.graph.users.item.drives.item.items.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.assignsensitivitylabel.AssignSensitivityLabelRequestBuilder;
...
import com.microsoft.graph.users.item.drives.item.items.item.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.items.item.activities.item collection
