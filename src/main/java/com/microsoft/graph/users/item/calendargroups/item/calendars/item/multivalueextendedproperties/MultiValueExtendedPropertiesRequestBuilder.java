package com.microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendargroups.item.calendars.item.multivalueextendedproperties.count.CountRequestBuilder;
