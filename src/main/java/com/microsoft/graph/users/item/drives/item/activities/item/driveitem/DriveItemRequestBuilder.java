package microsoft.graph.users.item.drives.item.activities.item.driveitem;
...
import microsoft.graph.users.item.drives.item.activities.item.driveitem.content.ContentRequestBuilder;
