package microsoft.graph.users.item.joinedgroups.item.team.tags.item.members;
...
import microsoft.graph.models.TeamworkTagMemberCollectionResponse;
import microsoft.graph.users.item.joinedgroups.item.team.tags.item.members.count.CountRequestBuilder;
...
public class MembersRequestBuilder {
    ...
    public MembersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/tags/{teamworkTag%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
