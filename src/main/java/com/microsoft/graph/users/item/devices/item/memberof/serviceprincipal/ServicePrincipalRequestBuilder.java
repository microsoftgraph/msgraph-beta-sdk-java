package microsoft.graph.users.item.devices.item.memberof.serviceprincipal;
...
import microsoft.graph.users.item.devices.item.memberof.serviceprincipal.count.CountRequestBuilder;
