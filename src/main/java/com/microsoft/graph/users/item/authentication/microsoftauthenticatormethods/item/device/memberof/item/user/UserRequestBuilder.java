package microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user;
...
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
import microsoft.graph.users.item.authentication.microsoftauthenticatormethods.item.device.memberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
