package microsoft.graph.users.item.joinedgroups.item.drives.item.bundles.item;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.bundles.item.content.ContentRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}{?%24select,%24expand}";
