package microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.listitem.documentsetversions.item.restore;
...
public class RestoreRequestBuilder {
    ...
    public RestoreRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore";
