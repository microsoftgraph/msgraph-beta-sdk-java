package microsoft.graph.users.item.joinedgroups.item.drives.item.root;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.children.ChildrenRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.children.item.DriveItemItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.content.ContentRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.listitem.ListItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.permissions.item.PermissionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.permissions.PermissionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.subscriptions.item.SubscriptionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.subscriptions.SubscriptionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.thumbnails.item.ThumbnailSetItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.thumbnails.ThumbnailsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.versions.item.DriveItemVersionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.versions.VersionsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.activities.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.children.item collection
     * @param id Unique identifier of the item
    ...
    public RootRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.root.versions.item collection
     * @param id Unique identifier of the item
