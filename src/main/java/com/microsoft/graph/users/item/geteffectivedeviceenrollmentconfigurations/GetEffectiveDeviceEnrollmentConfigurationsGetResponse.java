...
public class GetEffectiveDeviceEnrollmentConfigurationsGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * Instantiates a new GetEffectiveDeviceEnrollmentConfigurationsGetResponse and sets the default values.
     */
    public GetEffectiveDeviceEnrollmentConfigurationsGetResponse() {
        super();
    }
    /**
    ...
    public static GetEffectiveDeviceEnrollmentConfigurationsGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
