package com.microsoft.graph.users.item.getmanageddeviceswithfailedorpendingapps;
...
public class GetManagedDevicesWithFailedOrPendingAppsGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    /**
     * Instantiates a new GetManagedDevicesWithFailedOrPendingAppsGetResponse and sets the default values.
     */
