...
public class WindowsInformationProtectionDeviceRegistrationsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the windowsInformationProtectionDeviceRegistrations property of the microsoft.graph.user entity.
     * @param windowsInformationProtectionDeviceRegistrationId Unique identifier of the item
     * @return a WindowsInformationProtectionDeviceRegistrationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public WindowsInformationProtectionDeviceRegistrationItemRequestBuilder byWindowsInformationProtectionDeviceRegistrationId(@javax.annotation.Nonnull final String windowsInformationProtectionDeviceRegistrationId) {
    ...
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionDeviceRegistrationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WindowsInformationProtectionDeviceRegistrationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsInformationProtectionDeviceRegistrationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsInformationProtectionDeviceRegistrationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
