...
public class WindowsInformationProtectionDeviceRegistrationsRequestBuilder extends BaseRequestBuilder {
    ...
    public WindowsInformationProtectionDeviceRegistrationCollectionResponse get() {
        return get(null);
    }
    /**
     * Zero or more WIP device registrations that belong to the user.
     ...
     */
    @jakarta.annotation.Nullable
    public WindowsInformationProtectionDeviceRegistrationCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, WindowsInformationProtectionDeviceRegistrationCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Zero or more WIP device registrations that belong to the user.
