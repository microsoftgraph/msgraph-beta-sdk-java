package com.microsoft.graph.users.item.appconsentrequestsforapproval.item.userconsentrequests.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserConsentRequest;
import com.microsoft.graph.users.item.appconsentrequestsforapproval.item.userconsentrequests.item.approval.ApprovalRequestBuilder;
...
public class UserConsentRequestItemRequestBuilder {
    ...
    public UserConsentRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}{?%24select,%24expand}";
