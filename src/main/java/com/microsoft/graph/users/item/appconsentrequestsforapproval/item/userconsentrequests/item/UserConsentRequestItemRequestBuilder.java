package microsoft.graph.users.item.appconsentrequestsforapproval.item.userconsentrequests.item;
...
import microsoft.graph.users.item.appconsentrequestsforapproval.item.userconsentrequests.item.approval.ApprovalRequestBuilder;
