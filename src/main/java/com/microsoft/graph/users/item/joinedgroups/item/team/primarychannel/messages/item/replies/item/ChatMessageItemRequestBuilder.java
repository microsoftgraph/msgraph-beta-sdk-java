package microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.replies.item;
...
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.replies.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.primaryChannel.messages.item.replies.item.hostedContents.item collection
