package com.microsoft.graph.users.item.chats.item.members;

import com.microsoft.graph.models.ConversationMember;
import com.microsoft.graph.models.ConversationMemberCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.chats.item.members.add.AddRequestBuilder;
import com.microsoft.graph.users.item.chats.item.members.count.CountRequestBuilder;
...
public class MembersRequestBuilder extends BaseRequestBuilder {
    ...
    public MembersRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MembersRequestBuilder and sets the default values.
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/chat-list-members?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nonnull
