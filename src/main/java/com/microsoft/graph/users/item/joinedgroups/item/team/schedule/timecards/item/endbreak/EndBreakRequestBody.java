package microsoft.graph.users.item.joinedgroups.item.team.schedule.timecards.item.endbreak;
...
public class EndBreakRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a endBreakRequestBody
     */
    @javax.annotation.Nonnull
    public static EndBreakRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EndBreakRequestBody currentObject = this;
