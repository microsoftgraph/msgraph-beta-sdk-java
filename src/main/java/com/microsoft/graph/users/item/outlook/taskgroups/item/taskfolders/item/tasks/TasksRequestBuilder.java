...
public class TasksRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OutlookTaskCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OutlookTaskCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OutlookTaskCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<OutlookTask> post(@javax.annotation.Nonnull final OutlookTask body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OutlookTask> executionException = new java.util.concurrent.CompletableFuture<OutlookTask>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
