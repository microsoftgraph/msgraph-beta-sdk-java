...
import com.microsoft.graph.users.item.calendars.item.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.users.item.calendars.item.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.users.item.calendars.item.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendars.item.calendarView.item.exceptionOccurrences.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendars.item.calendarView.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendars.item.calendarView.item.exceptionOccurrences.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendars.item.calendarView.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendars.item.calendarView.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
