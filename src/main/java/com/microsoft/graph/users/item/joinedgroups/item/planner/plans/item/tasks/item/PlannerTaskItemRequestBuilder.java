package microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item;
...
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item.details.DetailsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
...
public class PlannerTaskItemRequestBuilder {
    ...
    public PlannerTaskItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
