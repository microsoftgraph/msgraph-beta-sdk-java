package microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
