package microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.calendar;
...
public class CalendarRequestBuilder {
    ...
    public CalendarRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/calendar{?%24select}";
