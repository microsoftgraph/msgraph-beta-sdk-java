package microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.users.item.joinedgroups.item.calendar.calendarview.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
...
public class SingleValueExtendedPropertiesRequestBuilder {
    ...
    public SingleValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
