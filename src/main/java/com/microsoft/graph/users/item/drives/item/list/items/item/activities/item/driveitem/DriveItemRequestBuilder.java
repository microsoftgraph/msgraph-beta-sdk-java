package microsoft.graph.users.item.drives.item.list.items.item.activities.item.driveitem;
...
import microsoft.graph.users.item.drives.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
