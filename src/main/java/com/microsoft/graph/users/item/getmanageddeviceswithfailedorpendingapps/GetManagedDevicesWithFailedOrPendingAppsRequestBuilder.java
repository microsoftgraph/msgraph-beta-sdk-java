...
public class GetManagedDevicesWithFailedOrPendingAppsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetManagedDevicesWithFailedOrPendingAppsResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetManagedDevicesWithFailedOrPendingAppsResponse> executionException = new java.util.concurrent.CompletableFuture<GetManagedDevicesWithFailedOrPendingAppsResponse>();
