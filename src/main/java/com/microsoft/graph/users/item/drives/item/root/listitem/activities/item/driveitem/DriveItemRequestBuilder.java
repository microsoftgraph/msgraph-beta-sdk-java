package microsoft.graph.users.item.drives.item.root.listitem.activities.item.driveitem;
...
import microsoft.graph.users.item.drives.item.root.listitem.activities.item.driveitem.content.ContentRequestBuilder;
