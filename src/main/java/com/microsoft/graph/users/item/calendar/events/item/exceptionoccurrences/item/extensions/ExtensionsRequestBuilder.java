package microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.users.item.calendar.events.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
