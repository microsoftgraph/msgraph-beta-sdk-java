...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
...
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
