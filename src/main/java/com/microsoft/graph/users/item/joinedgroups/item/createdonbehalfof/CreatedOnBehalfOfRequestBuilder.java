package microsoft.graph.users.item.joinedgroups.item.createdonbehalfof;
...
public class CreatedOnBehalfOfRequestBuilder {
    ...
    public CreatedOnBehalfOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/createdOnBehalfOf{?%24select,%24expand}";
