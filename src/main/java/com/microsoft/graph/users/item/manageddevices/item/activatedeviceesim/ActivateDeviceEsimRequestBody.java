...
public class ActivateDeviceEsimRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a activateDeviceEsimRequestBody
     */
    @javax.annotation.Nonnull
    public static ActivateDeviceEsimRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ActivateDeviceEsimRequestBody currentObject = this;
