package microsoft.graph.users.item.drives.item.root.listitem.documentsetversions;
...
import microsoft.graph.users.item.drives.item.root.listitem.documentsetversions.count.CountRequestBuilder;
