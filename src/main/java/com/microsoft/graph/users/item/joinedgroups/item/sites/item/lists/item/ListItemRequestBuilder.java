package microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.columns.ColumnsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.columns.item.ColumnDefinitionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.contenttypes.ContentTypesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.contenttypes.item.ContentTypeItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.drive.DriveRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.items.item.ListItemItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.items.ItemsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.operations.item.RichLongRunningOperationItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.operations.OperationsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.subscriptions.item.SubscriptionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.lists.item.subscriptions.SubscriptionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.lists.item.columns.item collection
    ...
    public ListItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.lists.item.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.lists.item.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.lists.item.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.lists.item.subscriptions.item collection
     * @param id Unique identifier of the item
