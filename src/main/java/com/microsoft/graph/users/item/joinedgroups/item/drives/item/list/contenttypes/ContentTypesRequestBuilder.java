package microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
...
public class ContentTypesRequestBuilder {
    ...
    public ContentTypesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
