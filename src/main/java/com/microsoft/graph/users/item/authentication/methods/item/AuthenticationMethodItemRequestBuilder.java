...
import microsoft.graph.users.item.authentication.methods.item.disablesmssignin.DisableSmsSignInRequestBuilder;
import microsoft.graph.users.item.authentication.methods.item.enablesmssignin.EnableSmsSignInRequestBuilder;
