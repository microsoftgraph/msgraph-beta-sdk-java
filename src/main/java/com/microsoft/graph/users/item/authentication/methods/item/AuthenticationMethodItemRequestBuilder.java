...
import com.microsoft.graph.users.item.authentication.methods.item.disablesmssignin.DisableSmsSignInRequestBuilder;
import com.microsoft.graph.users.item.authentication.methods.item.enablesmssignin.EnableSmsSignInRequestBuilder;
