package microsoft.graph.users.item.joinedgroups.item.planner.plans.item.buckets.item;
...
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.buckets.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.planner.plans.item.buckets.item.tasks.TasksRequestBuilder;
...
public class PlannerBucketItemRequestBuilder {
    ...
    public PlannerBucketItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.planner.plans.item.buckets.item.tasks.item collection
