package microsoft.graph.users.item.joinedgroups.item.transitivememberof;
...
import microsoft.graph.users.item.joinedgroups.item.transitivememberof.count.CountRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder {
    ...
    public TransitiveMemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
