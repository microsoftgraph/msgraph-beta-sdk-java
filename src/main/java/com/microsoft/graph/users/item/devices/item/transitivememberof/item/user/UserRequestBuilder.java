package microsoft.graph.users.item.devices.item.transitivememberof.item.user;
...
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
