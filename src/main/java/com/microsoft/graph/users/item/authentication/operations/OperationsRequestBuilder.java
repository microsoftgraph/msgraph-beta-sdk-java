package microsoft.graph.users.item.authentication.operations;
...
import microsoft.graph.models.LongRunningOperationCollectionResponse;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.users.item.authentication.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<LongRunningOperationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, LongRunningOperationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of LongRunningOperationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<LongRunningOperationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<OperationsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, LongRunningOperationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of longRunningOperation
     */
    public java.util.concurrent.CompletableFuture<LongRunningOperation> post(@javax.annotation.Nonnull final LongRunningOperation body, @javax.annotation.Nullable final java.util.function.Consumer<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
