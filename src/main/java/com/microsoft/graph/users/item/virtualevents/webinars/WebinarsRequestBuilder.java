package com.microsoft.graph.users.item.virtualevents.webinars;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventWebinarCollectionResponse;
import com.microsoft.graph.users.item.virtualevents.webinars.count.CountRequestBuilder;
import com.microsoft.graph.users.item.virtualevents.webinars.item.VirtualEventWebinarItemRequestBuilder;
