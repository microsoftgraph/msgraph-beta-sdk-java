package microsoft.graph.users.item.chats.item.permissiongrants;
...
import microsoft.graph.users.item.chats.item.permissiongrants.count.CountRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.getbyids.GetByIdsRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
