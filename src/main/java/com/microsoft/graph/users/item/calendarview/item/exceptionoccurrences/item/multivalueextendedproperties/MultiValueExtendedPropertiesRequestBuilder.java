package microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties;
...
import microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.count.CountRequestBuilder;
