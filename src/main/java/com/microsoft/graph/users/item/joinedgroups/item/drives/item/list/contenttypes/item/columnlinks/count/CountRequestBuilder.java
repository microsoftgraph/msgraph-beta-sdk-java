package microsoft.graph.users.item.joinedgroups.item.drives.item.list.contenttypes.item.columnlinks.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks/$count";
