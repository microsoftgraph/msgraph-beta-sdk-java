package com.microsoft.graph.users.item.contactfolders.item.contacts.item.singlevalueextendedproperties;
...
import com.microsoft.graph.users.item.contactfolders.item.contacts.item.singlevalueextendedproperties.count.CountRequestBuilder;
