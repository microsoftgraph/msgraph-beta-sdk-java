package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.terms.item.relations.item;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.terms.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.terms.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.terms.item.relations.item.toterm.ToTermRequestBuilder;
...
public class RelationItemRequestBuilder {
    ...
    public RelationItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}";
