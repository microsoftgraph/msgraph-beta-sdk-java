package com.microsoft.graph.users.item.security.informationprotection.sensitivitylabels.securityevaluateapplication;
 ...
 */
public class SecurityEvaluateApplicationRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public SecurityEvaluateApplicationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/security.evaluateApplication", pathParameters);
    }
    /**
     * Instantiates a new SecurityEvaluateApplicationRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public SecurityEvaluateApplicationRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/security.evaluateApplication", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-sensitivitylabel-evaluateapplication?view=graph-rest-1.0">Find more info here</a>
     */
