package microsoft.graph.users.item.calendarview.item.exceptionoccurrences.item.instances.item.dismissreminder;
...
public class DismissReminderRequestBuilder {
    ...
    public DismissReminderRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/microsoft.graph.dismissReminder";
