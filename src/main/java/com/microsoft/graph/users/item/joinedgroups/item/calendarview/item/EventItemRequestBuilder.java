package microsoft.graph.users.item.joinedgroups.item.calendarview.item;
...
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.InstancesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.calendarview.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.attachments.item collection
    ...
    public EventItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}{?%24select}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.exceptionOccurrences.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder exceptionOccurrences(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
        return new microsoft.graph.users.item.joinedgroups.item.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.instances.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.EventItemRequestBuilder instances(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
        return new microsoft.graph.users.item.joinedgroups.item.calendarview.item.instances.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.calendarView.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
