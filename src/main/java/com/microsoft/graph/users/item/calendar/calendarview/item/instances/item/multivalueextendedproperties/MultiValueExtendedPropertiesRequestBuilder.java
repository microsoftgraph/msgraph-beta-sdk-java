package com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
