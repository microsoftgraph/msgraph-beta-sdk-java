package microsoft.graph.users.item.joinedgroups.item.sites.item.permissions.item.grant;
...
public class GrantRequestBuilder {
    ...
    public GrantRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/permissions/{permission%2Did}/microsoft.graph.grant";
