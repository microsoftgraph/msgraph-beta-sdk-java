package com.microsoft.graph.users.item.manageddevices.downloadappdiagnostics;
...
public class DownloadAppDiagnosticsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("request", (n) -> { currentObject.setRequest(n.getObjectValue(PowerliftDownloadRequest::createFromDiscriminatorValue)); });
