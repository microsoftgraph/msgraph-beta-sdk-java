...
import microsoft.graph.users.item.mailfolders.item.messages.item.eventmessagerequest.EventMessageRequestRequestBuilder;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.users.item.mailfolders.item.messages.item.mentions.MentionsRequestBuilder;
...
import microsoft.graph.users.item.mailfolders.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
