...
import com.microsoft.graph.users.item.mailfolders.item.messages.item.markasjunk.MarkAsJunkRequestBuilder;
import com.microsoft.graph.users.item.mailfolders.item.messages.item.markasnotjunk.MarkAsNotJunkRequestBuilder;
import com.microsoft.graph.users.item.mailfolders.item.messages.item.mentions.MentionsRequestBuilder;
...
import com.microsoft.graph.users.item.mailfolders.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
