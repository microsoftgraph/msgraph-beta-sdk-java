package microsoft.graph.users.item.joinedgroups.item.team.photo;
...
import microsoft.graph.users.item.joinedgroups.item.team.photo.value.ContentRequestBuilder;
...
public class PhotoRequestBuilder {
    ...
    public PhotoRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/photo{?%24select,%24expand}";
