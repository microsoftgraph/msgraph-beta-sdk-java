package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.groups.count.CountRequestBuilder;
...
public class GroupsRequestBuilder {
    ...
    public GroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
    ...
    /**
     * Create new navigation property to groups for users
     * @param body 
     * @return a RequestInformation
     */
    @javax.annotation.Nonnull
