...
public class CopyNotebookRequestBuilder extends BaseRequestBuilder {
    ...
    public CopyNotebookRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/copyNotebook", pathParameters);
    }
    /**
     * Instantiates a new CopyNotebookRequestBuilder and sets the default values.
    ...
    public CopyNotebookRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/copyNotebook", rawUrl);
    }
    /**
