package com.microsoft.graph.users.item.mobileapptroubleshootingevents.item.applogcollectionrequests;
...
import com.microsoft.graph.users.item.mobileapptroubleshootingevents.item.applogcollectionrequests.count.CountRequestBuilder;
...
public class AppLogCollectionRequestsRequestBuilder {
    ...
    public AppLogCollectionRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
