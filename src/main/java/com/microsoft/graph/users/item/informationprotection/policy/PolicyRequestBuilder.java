package microsoft.graph.users.item.informationprotection.policy;
...
import microsoft.graph.users.item.informationprotection.policy.labels.item.InformationProtectionLabelItemRequestBuilder;
import microsoft.graph.users.item.informationprotection.policy.labels.LabelsRequestBuilder;
...
public class PolicyRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.informationProtection.policy.labels.item collection
