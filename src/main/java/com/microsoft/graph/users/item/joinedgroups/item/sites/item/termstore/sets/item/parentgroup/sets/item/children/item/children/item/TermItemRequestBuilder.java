package microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item;
...
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.sites.item.termStore.sets.item.parentGroup.sets.item.children.item.children.item.relations.item collection
