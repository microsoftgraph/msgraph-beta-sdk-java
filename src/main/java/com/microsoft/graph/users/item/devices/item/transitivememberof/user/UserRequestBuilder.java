package microsoft.graph.users.item.devices.item.transitivememberof.user;
...
import microsoft.graph.users.item.devices.item.transitivememberof.user.count.CountRequestBuilder;
