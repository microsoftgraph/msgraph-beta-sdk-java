...
public class CloudPCsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CloudPC body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CloudPCCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPCCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPCCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPC> post(@javax.annotation.Nonnull final CloudPC body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPC> executionException = new java.util.concurrent.CompletableFuture<CloudPC>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
