...
import com.microsoft.graph.users.item.cloudpcs.bulkresize.BulkResizeRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.count.CountRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.getprovisionedcloudpcswithgroupidwithserviceplanid.GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.item.CloudPCItemRequestBuilder;
import com.microsoft.graph.users.item.cloudpcs.validatebulkresize.ValidateBulkResizeRequestBuilder;
...
public class CloudPCsRequestBuilder extends BaseRequestBuilder {
    ...
    public CloudPCCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, CloudPCCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public CloudPC post(@jakarta.annotation.Nonnull final CloudPC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CloudPC::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * List the cloudPC devices that are attributed to the signed-in user.  This API is available in the following national cloud deployments.
