package microsoft.graph.users.item.joinedgroups.item.team.schedule;
...
import microsoft.graph.users.item.joinedgroups.item.team.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.openshiftchangerequests.item.OpenShiftChangeRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.openshifts.item.OpenShiftItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.openshifts.OpenShiftsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.schedulinggroups.item.SchedulingGroupItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.share.ShareRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.shifts.item.ShiftItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.shifts.ShiftsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.swapshiftschangerequests.item.SwapShiftsChangeRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timecards.item.TimeCardItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timecards.TimeCardsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timeoffreasons.item.TimeOffReasonItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timeoffrequests.item.TimeOffRequestItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timesoff.item.TimeOffItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.schedule.timesoff.TimesOffRequestBuilder;
...
public class ScheduleRequestBuilder {
    ...
    public ScheduleRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.timeCards.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.schedule.timesOff.item collection
     * @param id Unique identifier of the item
