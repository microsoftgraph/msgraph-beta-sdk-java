package com.microsoft.graph.users.item.events.item.exceptionoccurrences;

import com.microsoft.graph.models.EventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder;
