package microsoft.graph.users.item.joinedgroups.item.events;
...
import microsoft.graph.users.item.joinedgroups.item.events.count.CountRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.delta.DeltaRequestBuilder;
...
public class EventsRequestBuilder {
    ...
    public EventsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
