package com.microsoft.graph.users.item.onlinemeetings.item.transcripts;
...
import com.microsoft.graph.users.item.onlinemeetings.item.transcripts.count.CountRequestBuilder;
