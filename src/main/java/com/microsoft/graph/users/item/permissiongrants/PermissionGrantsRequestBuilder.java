...
import com.microsoft.graph.users.item.permissiongrants.delta.DeltaRequestBuilder;
import com.microsoft.graph.users.item.permissiongrants.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.users.item.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.users.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import com.microsoft.graph.users.item.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
