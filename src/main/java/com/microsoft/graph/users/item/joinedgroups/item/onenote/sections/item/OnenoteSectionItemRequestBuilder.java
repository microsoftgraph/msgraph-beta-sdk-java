package microsoft.graph.users.item.joinedgroups.item.onenote.sections.item;
...
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.onenote.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    public OnenoteSectionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.onenote.sections.item.pages.item collection
