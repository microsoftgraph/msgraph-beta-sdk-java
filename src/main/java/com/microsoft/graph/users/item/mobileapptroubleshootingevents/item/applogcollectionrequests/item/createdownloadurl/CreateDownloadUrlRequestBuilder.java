package com.microsoft.graph.users.item.mobileapptroubleshootingevents.item.applogcollectionrequests.item.createdownloadurl;
...
public class CreateDownloadUrlRequestBuilder {
    ...
    public CreateDownloadUrlRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}/createDownloadUrl";
