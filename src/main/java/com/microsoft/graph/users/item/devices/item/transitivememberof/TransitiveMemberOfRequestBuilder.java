package microsoft.graph.users.item.devices.item.transitivememberof;
...
import microsoft.graph.users.item.devices.item.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.devices.item.transitivememberof.user.UserRequestBuilder;
