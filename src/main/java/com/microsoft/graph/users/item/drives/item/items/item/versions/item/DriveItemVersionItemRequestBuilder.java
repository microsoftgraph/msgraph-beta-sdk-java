package com.microsoft.graph.users.item.drives.item.items.item.versions.item;

import com.microsoft.graph.models.DriveItemVersion;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.drives.item.items.item.versions.item.content.ContentRequestBuilder;
import com.microsoft.graph.users.item.drives.item.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
