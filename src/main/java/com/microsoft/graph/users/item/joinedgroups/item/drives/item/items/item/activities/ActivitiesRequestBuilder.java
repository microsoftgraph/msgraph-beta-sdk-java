package microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.activities;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.activities.count.CountRequestBuilder;
...
public class ActivitiesRequestBuilder {
    ...
    public ActivitiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
