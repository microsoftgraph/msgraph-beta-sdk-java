...
import com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.commands.CommandsRequestBuilder;
import com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.commands.item.CommandItemRequestBuilder;
...
import com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.usagerights.item.UsageRightItemRequestBuilder;
import com.microsoft.graph.users.item.authentication.windowshelloforbusinessmethods.item.device.usagerights.UsageRightsRequestBuilder;
...
public class DeviceRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.authentication.windowsHelloForBusinessMethods.item.device.commands.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.authentication.windowsHelloForBusinessMethods.item.device.usageRights.item collection
     * @param id Unique identifier of the item
