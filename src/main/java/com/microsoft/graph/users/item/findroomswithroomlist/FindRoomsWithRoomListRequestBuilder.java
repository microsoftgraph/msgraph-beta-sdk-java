...
public class FindRoomsWithRoomListRequestBuilder extends BaseRequestBuilder {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public FindRoomsWithRoomListRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @return a FindRoomsWithRoomListGetResponse
     */
    @jakarta.annotation.Nullable
    public FindRoomsWithRoomListGetResponse get() {
        return get(null);
    }
    /**
     * Invoke function findRooms
     ...
     */
    @jakarta.annotation.Nullable
    public FindRoomsWithRoomListGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, FindRoomsWithRoomListGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function findRooms
