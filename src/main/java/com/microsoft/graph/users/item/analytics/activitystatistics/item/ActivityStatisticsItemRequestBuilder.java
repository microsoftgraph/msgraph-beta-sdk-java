package com.microsoft.graph.users.item.analytics.activitystatistics.item;
...
public class ActivityStatisticsItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ActivityStatisticsItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/analytics/activityStatistics/{activityStatistics%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ActivityStatisticsItemRequestBuilder and sets the default values.
    ...
    public ActivityStatisticsItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/analytics/activityStatistics/{activityStatistics%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ActivityStatistics body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ActivityStatistics body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
