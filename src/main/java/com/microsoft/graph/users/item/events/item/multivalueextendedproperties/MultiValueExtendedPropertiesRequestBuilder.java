package com.microsoft.graph.users.item.events.item.multivalueextendedproperties;
...
import com.microsoft.graph.users.item.events.item.multivalueextendedproperties.count.CountRequestBuilder;
