package microsoft.graph.users.item.devices.item.transitivememberof.serviceprincipal;
...
import microsoft.graph.users.item.devices.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
