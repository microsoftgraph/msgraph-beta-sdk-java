package microsoft.graph.users.item.joinedgroups.item.drives.item;
...
import microsoft.graph.users.item.joinedgroups.item.drives.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.bundles.BundlesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.following.FollowingRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.items.ItemsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.list.ListRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.root.RootRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.drives.item.special.SpecialRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.activities.item collection
    ...
    public ItemActivityOLDItemRequestBuilder activities(@javax.annotation.Nonnull final String id) {
        ...
        urlTplParams.put("itemActivityOLD%2Did", id);
        return new ItemActivityOLDItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.bundles.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.drives.item.bundles.item.DriveItemItemRequestBuilder bundles(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.users.item.joinedgroups.item.drives.item.bundles.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public DriveItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.following.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.drives.item.following.item.DriveItemItemRequestBuilder following(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.users.item.joinedgroups.item.drives.item.following.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * The group's drives. Read-only.
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.items.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.DriveItemItemRequestBuilder items(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.users.item.joinedgroups.item.drives.item.items.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property drives in users
     * @param body 
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.drives.item.special.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.users.item.joinedgroups.item.drives.item.special.item.DriveItemItemRequestBuilder special(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.users.item.joinedgroups.item.drives.item.special.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
