...
public class VirtualEventsRequestBuilder extends BaseRequestBuilder {
    ...
    public UserVirtualEventsRoot get() {
        return get(null);
    }
    /**
     * Get virtualEvents from users
     ...
     */
    @jakarta.annotation.Nullable
    public UserVirtualEventsRoot get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, UserVirtualEventsRoot::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public UserVirtualEventsRoot patch(@jakarta.annotation.Nonnull final UserVirtualEventsRoot body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UserVirtualEventsRoot patch(@jakarta.annotation.Nonnull final UserVirtualEventsRoot body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
