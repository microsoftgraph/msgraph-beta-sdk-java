package microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.user.findroomswithroomlist;
...
public class FindRoomsWithRoomListResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a findRoomsWithRoomListResponse
     */
    @javax.annotation.Nonnull
    public static FindRoomsWithRoomListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FindRoomsWithRoomListResponse currentObject = this;
