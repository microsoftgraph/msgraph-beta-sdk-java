...
import com.microsoft.graph.users.item.planner.favoriteplans.item.PlannerPlanItemRequestBuilder;
 ...
 */
public class FavoritePlansRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public FavoritePlansRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/planner/favoritePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new FavoritePlansRequestBuilder and sets the default values.
    ...
    public FavoritePlansRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/planner/favoritePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/planneruser-list-favoriteplans?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
