package com.microsoft.graph.users.item.events.item.exceptionoccurrences.item;

import com.microsoft.graph.models.Event;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
...
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.users.item.events.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.events.item.exceptionOccurrences.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.events.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.events.item.exceptionOccurrences.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.events.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.events.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
