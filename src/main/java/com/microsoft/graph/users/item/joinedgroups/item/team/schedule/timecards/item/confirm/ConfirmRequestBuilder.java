package microsoft.graph.users.item.joinedgroups.item.team.schedule.timecards.item.confirm;
...
public class ConfirmRequestBuilder {
    ...
    public ConfirmRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}/microsoft.graph.confirm";
