package com.microsoft.graph.users.item.deviceenrollmentconfigurations.item.assignments;
...
import com.microsoft.graph.users.item.deviceenrollmentconfigurations.item.assignments.count.CountRequestBuilder;
