package microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item;
...
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.accept.AcceptRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.calendar.CalendarRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.cancel.CancelRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.decline.DeclineRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.forward.ForwardRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.events.item.exceptionoccurrences.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.events.item.exceptionOccurrences.item.instances.item.attachments.item collection
    ...
    public EventItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}{?%24select}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.events.item.exceptionOccurrences.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.events.item.exceptionOccurrences.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.events.item.exceptionOccurrences.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
