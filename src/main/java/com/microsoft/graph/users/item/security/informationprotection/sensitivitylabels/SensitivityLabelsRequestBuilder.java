...
import com.microsoft.graph.users.item.security.informationprotection.sensitivitylabels.securityevaluateapplication.SecurityEvaluateApplicationRequestBuilder;
import com.microsoft.graph.users.item.security.informationprotection.sensitivitylabels.securityevaluateclassificationresults.SecurityEvaluateClassificationResultsRequestBuilder;
import com.microsoft.graph.users.item.security.informationprotection.sensitivitylabels.securityevaluateremoval.SecurityEvaluateRemovalRequestBuilder;
import com.microsoft.graph.users.item.security.informationprotection.sensitivitylabels.securityextractcontentlabel.SecurityExtractContentLabelRequestBuilder;
...
public class SensitivityLabelsRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-informationprotection-list-sensitivitylabels?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
