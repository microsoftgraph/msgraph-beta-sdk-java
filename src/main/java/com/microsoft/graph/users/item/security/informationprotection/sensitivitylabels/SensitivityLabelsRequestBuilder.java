...
public class SensitivityLabelsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SensitivityLabel body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SensitivityLabelCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SensitivityLabelCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SensitivityLabelCollectionResponse>();
