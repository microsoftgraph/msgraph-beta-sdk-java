package com.microsoft.graph.users.item.tasks.lists.item.tasks.item;

import com.microsoft.graph.models.BaseTask;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.checklistitems.ChecklistItemsRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.checklistitems.item.ChecklistItemItemRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.linkedresources.item.LinkedResource_v2ItemRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.linkedresources.LinkedResourcesRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.move.MoveRequestBuilder;
import com.microsoft.graph.users.item.tasks.lists.item.tasks.item.parentlist.ParentListRequestBuilder;
...
public class BaseTaskItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.tasks.lists.item.tasks.item.checklistItems.item collection
    ...
    public BaseTaskItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists/{baseTaskList%2Did}/tasks/{baseTask%2Did}{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<BaseTaskItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.tasks.lists.item.tasks.item.extensions.item collection
     * @param id Unique identifier of the item
     ...
     * @return a CompletableFuture of baseTask
     */
    public java.util.concurrent.CompletableFuture<BaseTask> get(@javax.annotation.Nullable final java.util.function.Consumer<BaseTaskItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.tasks.lists.item.tasks.item.linkedResources.item collection
     * @param id Unique identifier of the item
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final BaseTask body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final BaseTask body, @javax.annotation.Nullable final java.util.function.Consumer<BaseTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final BaseTask body, @javax.annotation.Nullable final java.util.function.Consumer<BaseTaskItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
