...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.calendarView.item.exceptionOccurrences.item collection
     * @param id Unique identifier of the item
     * @return a EventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder exceptionOccurrences(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
        return new com.microsoft.graph.users.item.calendar.calendarview.item.exceptionoccurrences.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.EventItemRequestBuilder instances(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
        return new com.microsoft.graph.users.item.calendar.calendarview.item.instances.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
