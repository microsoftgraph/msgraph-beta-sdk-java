package microsoft.graph.users.item.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredusers.item.user.exportdeviceandappmanagementdatawithskipwithtop;
...
public class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
    ...
    public ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final Integer skip, @javax.annotation.Nullable final Integer top) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportDeviceAndAppManagementData(skip={skip},top={top})";
