package microsoft.graph.users.item.chats.item.permissiongrants.item;
...
import microsoft.graph.users.item.chats.item.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.users.item.chats.item.permissiongrants.item.restore.RestoreRequestBuilder;
...
public class ResourceSpecificPermissionGrantItemRequestBuilder {
    ...
    public ResourceSpecificPermissionGrantItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}";
