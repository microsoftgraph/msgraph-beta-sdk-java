package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.decisions.item.instance.resetdecisions;
...
public class ResetDecisionsRequestBuilder {
    ...
    public ResetDecisionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/resetDecisions";
