...
import com.microsoft.graph.users.item.devices.item.registeredowners.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredowners.item.DirectoryObjectItemRequestBuilder;
...
public class RegisteredOwnersRequestBuilder extends BaseRequestBuilder {
    ...
    public RegisteredOwnersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RegisteredOwnersRequestBuilder and sets the default values.
    ...
    public RegisteredOwnersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
