...
public class GetPasswordSingleSignOnCredentialsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetPasswordSingleSignOnCredentialsPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetPasswordSingleSignOnCredentialsPostResponse> post() {
        return post(null);
    }
    /**
     * Invoke action getPasswordSingleSignOnCredentials
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetPasswordSingleSignOnCredentialsPostResponse> post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetPasswordSingleSignOnCredentialsPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action getPasswordSingleSignOnCredentials
