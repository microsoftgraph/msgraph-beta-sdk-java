...
public class EmailsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the emails property of the microsoft.graph.profile entity.
     * @param itemEmailId Unique identifier of the item
     * @return a ItemEmailItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ItemEmailItemRequestBuilder byItemEmailId(@javax.annotation.Nonnull final String itemEmailId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemEmail body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemEmail body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
