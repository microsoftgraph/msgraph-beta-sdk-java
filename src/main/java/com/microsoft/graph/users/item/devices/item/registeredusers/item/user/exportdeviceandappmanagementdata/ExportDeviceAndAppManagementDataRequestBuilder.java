package microsoft.graph.users.item.devices.item.registeredusers.item.user.exportdeviceandappmanagementdata;
...
public class ExportDeviceAndAppManagementDataRequestBuilder {
    ...
    public ExportDeviceAndAppManagementDataRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportDeviceAndAppManagementData()";
