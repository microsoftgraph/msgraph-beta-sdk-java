...
public class TaskGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public OutlookTaskGroupCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, OutlookTaskGroupCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public OutlookTaskGroup post(@jakarta.annotation.Nonnull final OutlookTaskGroup body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, OutlookTaskGroup::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get all the Outlook task groups in the user's mailbox. The response always includes the default task group My Tasks, and any other task groups that have been created in the mailbox. This API is available in the following national cloud deployments.
