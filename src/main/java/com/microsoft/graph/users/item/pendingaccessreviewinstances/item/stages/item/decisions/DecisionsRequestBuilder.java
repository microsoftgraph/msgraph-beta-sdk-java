package com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions;

import com.microsoft.graph.models.AccessReviewInstanceDecisionItem;
import com.microsoft.graph.models.AccessReviewInstanceDecisionItemCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.count.CountRequestBuilder;
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.item.AccessReviewInstanceDecisionItemItemRequestBuilder;
import com.microsoft.graph.users.item.pendingaccessreviewinstances.item.stages.item.decisions.recordalldecisions.RecordAllDecisionsRequestBuilder;
