...
public class SetUserPreferredPresenceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a setUserPreferredPresenceRequestBody
     */
    @javax.annotation.Nonnull
    public static SetUserPreferredPresenceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SetUserPreferredPresenceRequestBody currentObject = this;
