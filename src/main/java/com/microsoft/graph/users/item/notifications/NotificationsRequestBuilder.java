...
public class NotificationsRequestBuilder extends BaseRequestBuilder {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final Notification body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public NotificationsRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
