package com.microsoft.graph.users.item.deviceenrollmentconfigurations.item.assign;
...
public class AssignPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enrollmentConfigurationAssignments", (n) -> { currentObject.setEnrollmentConfigurationAssignments(n.getCollectionOfObjectValues(EnrollmentConfigurationAssignment::createFromDiscriminatorValue)); });
