...
public class CustomQuestionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<MeetingRegistrationQuestionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingRegistrationQuestionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MeetingRegistrationQuestionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MeetingRegistrationQuestion> post(@javax.annotation.Nonnull final MeetingRegistrationQuestion body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingRegistrationQuestion> executionException = new java.util.concurrent.CompletableFuture<MeetingRegistrationQuestion>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
