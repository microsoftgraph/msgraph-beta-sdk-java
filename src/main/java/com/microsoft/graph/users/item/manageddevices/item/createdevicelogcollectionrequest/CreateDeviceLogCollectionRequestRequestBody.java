package microsoft.graph.users.item.manageddevices.item.createdevicelogcollectionrequest;
...
public class CreateDeviceLogCollectionRequestRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createDeviceLogCollectionRequestRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateDeviceLogCollectionRequestRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateDeviceLogCollectionRequestRequestBody currentObject = this;
