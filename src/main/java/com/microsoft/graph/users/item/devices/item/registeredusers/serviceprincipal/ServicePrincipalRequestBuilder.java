package microsoft.graph.users.item.devices.item.registeredusers.serviceprincipal;
...
import microsoft.graph.users.item.devices.item.registeredusers.serviceprincipal.count.CountRequestBuilder;
