...
import microsoft.graph.users.item.drives.item.root.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.users.item.drives.item.root.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.drives.item.root.listItem.activities.item collection
