...
import com.microsoft.graph.users.item.drives.item.root.listitem.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.users.item.drives.item.root.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.users.item.drives.item.root.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.users.item.drives.item.root.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.drives.item.root.listItem.activities.item collection
