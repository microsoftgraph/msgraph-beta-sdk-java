package microsoft.graph.users.item.joinedgroups.item.sites.item.onenote.pages.item.preview;
...
public class PreviewRequestBuilder {
    ...
    public PreviewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.preview()";
