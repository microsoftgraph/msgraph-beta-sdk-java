...
import com.microsoft.graph.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
...
import com.microsoft.graph.users.item.calendar.events.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.instances.item.exceptionOccurrences.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.instances.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.instances.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.calendar.events.item.instances.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
