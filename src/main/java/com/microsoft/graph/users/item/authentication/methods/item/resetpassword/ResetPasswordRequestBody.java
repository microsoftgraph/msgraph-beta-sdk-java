...
public class ResetPasswordRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a resetPasswordRequestBody
     */
    @javax.annotation.Nonnull
    public static ResetPasswordRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ResetPasswordRequestBody currentObject = this;
