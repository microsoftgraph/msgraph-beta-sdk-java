...
import com.microsoft.graph.users.item.devices.item.registeredusers.item.endpoint.EndpointRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.user.UserRequestBuilder;
