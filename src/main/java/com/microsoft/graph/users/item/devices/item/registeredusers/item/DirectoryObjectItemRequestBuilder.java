package com.microsoft.graph.users.item.devices.item.registeredusers.item;

import com.microsoft.graph.users.item.devices.item.registeredusers.item.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.users.item.devices.item.registeredusers.item.ref.RefRequestBuilder;
