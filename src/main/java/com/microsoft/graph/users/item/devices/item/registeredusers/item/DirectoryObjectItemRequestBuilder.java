package microsoft.graph.users.item.devices.item.registeredusers.item;
...
import microsoft.graph.users.item.devices.item.registeredusers.item.endpoint.EndpointRequestBuilder;
import microsoft.graph.users.item.devices.item.registeredusers.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.devices.item.registeredusers.item.user.UserRequestBuilder;
