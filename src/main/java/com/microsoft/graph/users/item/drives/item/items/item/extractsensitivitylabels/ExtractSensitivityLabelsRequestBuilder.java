package com.microsoft.graph.users.item.drives.item.items.item.extractsensitivitylabels;
...
public class ExtractSensitivityLabelsRequestBuilder {
    ...
    public ExtractSensitivityLabelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.extractSensitivityLabels";
