package com.microsoft.graph.users.item.mailfolders.item.messages.item.markasjunk;
...
public class MarkAsJunkRequestBuilder extends BaseRequestBuilder {
    ...
    public MarkAsJunkRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/markAsJunk", pathParameters);
    }
    /**
     * Instantiates a new MarkAsJunkRequestBuilder and sets the default values.
    ...
    public MarkAsJunkRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/markAsJunk", rawUrl);
    }
    /**
