...
import com.microsoft.graph.users.item.devices.item.memberof.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.graphgroup.GraphGroupRequestBuilder;
