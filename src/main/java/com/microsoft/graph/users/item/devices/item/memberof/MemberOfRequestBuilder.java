package com.microsoft.graph.users.item.devices.item.memberof;

import com.microsoft.graph.models.DirectoryObjectCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.users.item.devices.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.users.item.devices.item.memberof.user.UserRequestBuilder;
...
public class MemberOfRequestBuilder {
    ...
    public MemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
