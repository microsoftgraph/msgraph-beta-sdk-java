package microsoft.graph.users.item.devices.item.memberof;
...
import microsoft.graph.users.item.devices.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.count.CountRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.users.item.devices.item.memberof.user.UserRequestBuilder;
