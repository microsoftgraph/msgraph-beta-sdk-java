...
import microsoft.graph.users.item.calendarview.item.instances.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.calendarView.item.instances.item.exceptionOccurrences.item collection
     * @param id Unique identifier of the item
