package com.microsoft.graph.users.item.informationprotection.threatassessmentrequests.item;
...
import com.microsoft.graph.users.item.informationprotection.threatassessmentrequests.item.results.ResultsRequestBuilder;
...
public class ThreatAssessmentRequestItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.informationProtection.threatAssessmentRequests.item.results.item collection
