package microsoft.graph.users.item.joinedgroups.item.team.primarychannel;
...
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.completemigration.CompleteMigrationRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.filesfolder.FilesFolderRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.members.item.ConversationMemberItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.members.MembersRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.item.ChatMessageItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.messages.MessagesRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.provisionemail.ProvisionEmailRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.removeemail.RemoveEmailRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.sharedwithteams.item.SharedWithChannelTeamInfoItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.sharedwithteams.SharedWithTeamsRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.tabs.item.TeamsTabItemRequestBuilder;
import microsoft.graph.users.item.joinedgroups.item.team.primarychannel.tabs.TabsRequestBuilder;
...
public class PrimaryChannelRequestBuilder {
    ...
    public PrimaryChannelRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.primaryChannel.members.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.primaryChannel.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.primaryChannel.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.joinedGroups.item.team.primaryChannel.tabs.item collection
     * @param id Unique identifier of the item
