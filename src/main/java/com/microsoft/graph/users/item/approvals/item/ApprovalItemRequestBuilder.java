package microsoft.graph.users.item.approvals.item;
...
import microsoft.graph.users.item.approvals.item.steps.item.ApprovalStepItemRequestBuilder;
import microsoft.graph.users.item.approvals.item.steps.StepsRequestBuilder;
...
public class ApprovalItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.users.item.approvals.item.steps.item collection
