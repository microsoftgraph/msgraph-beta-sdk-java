package com.microsoft.graph.users.item.approvals.item;
...
import com.microsoft.graph.users.item.approvals.item.steps.StepsRequestBuilder;
...
public class ApprovalItemRequestBuilder {
    ...
    public ApprovalItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user%2Did}/approvals/{approval%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.users.item.approvals.item.steps.item collection
