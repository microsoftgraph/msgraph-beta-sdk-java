...
public class ValidatePasswordRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ValidatePasswordPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PasswordValidationInformation> post(@javax.annotation.Nonnull final ValidatePasswordPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<PasswordValidationInformation> executionException = new java.util.concurrent.CompletableFuture<PasswordValidationInformation>();
