package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies.item.hostedcontents;
...
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies.item.hostedcontents.count.CountRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
