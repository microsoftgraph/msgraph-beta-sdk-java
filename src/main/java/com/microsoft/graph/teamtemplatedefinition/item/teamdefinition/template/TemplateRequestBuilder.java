package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.template;
...
public class TemplateRequestBuilder {
    ...
    public TemplateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/template{?%24select,%24expand}";
