package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies;

import com.microsoft.graph.models.ChatMessage;
import com.microsoft.graph.models.ChatMessageCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
...
public class RepliesRequestBuilder {
    ...
    public RepliesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
