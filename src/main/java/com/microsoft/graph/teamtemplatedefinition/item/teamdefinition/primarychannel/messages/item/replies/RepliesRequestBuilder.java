package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.primarychannel.messages.item.replies;

import com.microsoft.graph.models.ChatMessage;
import com.microsoft.graph.models.ChatMessageCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.primarychannel.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.primarychannel.messages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.primarychannel.messages.item.replies.item.ChatMessageItemRequestBuilder;
