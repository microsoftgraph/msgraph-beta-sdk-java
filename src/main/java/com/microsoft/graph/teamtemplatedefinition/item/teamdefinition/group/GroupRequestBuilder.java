package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.group;

import com.microsoft.graph.models.Group;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.group.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class GroupRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/group{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GroupRequestBuilder and sets the default values.
    ...
    public GroupRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/group{?%24select,%24expand}", rawUrl);
    }
    /**
