package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.completemigration;
...
public class CompleteMigrationRequestBuilder extends BaseRequestBuilder {
    ...
    public CompleteMigrationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/completeMigration", pathParameters);
    }
    /**
     * Instantiates a new CompleteMigrationRequestBuilder and sets the default values.
    ...
    public CompleteMigrationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/completeMigration", rawUrl);
    }
    /**
