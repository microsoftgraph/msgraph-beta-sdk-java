package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.hostedcontents;
...
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.hostedcontents.count.CountRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
...
public class HostedContentsRequestBuilder extends BaseRequestBuilder {
    ...
    public HostedContentsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new HostedContentsRequestBuilder and sets the default values.
    ...
    public HostedContentsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
