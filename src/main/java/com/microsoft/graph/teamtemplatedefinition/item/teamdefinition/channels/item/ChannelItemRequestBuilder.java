package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item;

import com.microsoft.graph.models.Channel;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.completemigration.CompleteMigrationRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.doesuserhaveaccessuseriduseridtenantidtenantiduserprincipalnameuserprincipalname.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.filesfolder.FilesFolderRequestBuilder;
...
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.members.MembersRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.item.ChatMessageItemRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.messages.MessagesRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.provisionemail.ProvisionEmailRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.removeemail.RemoveEmailRequestBuilder;
...
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.sharedwithteams.SharedWithTeamsRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.tabs.item.TeamsTabItemRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.tabs.TabsRequestBuilder;
...
public class ChannelItemRequestBuilder {
    ...
    public ChannelItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamTemplateDefinition.item.teamDefinition.channels.item.members.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamTemplateDefinition.item.teamDefinition.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamTemplateDefinition.item.teamDefinition.channels.item.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamTemplateDefinition.item.teamDefinition.channels.item.tabs.item collection
     * @param id Unique identifier of the item
