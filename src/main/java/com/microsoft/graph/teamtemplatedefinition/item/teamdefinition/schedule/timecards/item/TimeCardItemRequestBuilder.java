...
public class TimeCardItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TimeCard body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TimeCard> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TimeCard> executionException = new java.util.concurrent.CompletableFuture<TimeCard>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
