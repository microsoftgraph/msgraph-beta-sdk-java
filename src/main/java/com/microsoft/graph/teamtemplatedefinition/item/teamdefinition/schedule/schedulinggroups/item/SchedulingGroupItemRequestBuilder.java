package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.schedule.schedulinggroups.item;
...
public class SchedulingGroupItemRequestBuilder {
    ...
    public SchedulingGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}";
