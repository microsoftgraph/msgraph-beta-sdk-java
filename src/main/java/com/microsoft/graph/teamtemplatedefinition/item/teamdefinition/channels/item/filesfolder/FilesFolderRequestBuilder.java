package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.filesfolder;

import com.microsoft.graph.models.DriveItem;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.channels.item.filesfolder.content.ContentRequestBuilder;
...
public class FilesFolderRequestBuilder {
    ...
    public FilesFolderRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
