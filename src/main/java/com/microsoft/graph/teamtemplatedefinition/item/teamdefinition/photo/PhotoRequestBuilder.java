package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.photo;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.ProfilePhoto;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.photo.value.ContentRequestBuilder;
...
public class PhotoRequestBuilder extends BaseRequestBuilder {
    ...
    public PhotoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PhotoRequestBuilder and sets the default values.
    ...
    public PhotoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/photo{?%24select,%24expand}", rawUrl);
    }
    /**
     * The team photo.
