package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.schedule.timecards.item.clockout;
...
public class ClockOutPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ClockOutPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
