package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.installedapps.item.teamsapp;
...
public class TeamsAppRequestBuilder {
    ...
    public TeamsAppRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}";
