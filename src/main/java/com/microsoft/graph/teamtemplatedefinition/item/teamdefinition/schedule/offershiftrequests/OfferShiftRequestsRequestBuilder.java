package com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.schedule.offershiftrequests;
...
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.schedule.offershiftrequests.count.CountRequestBuilder;
import com.microsoft.graph.teamtemplatedefinition.item.teamdefinition.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
...
public class OfferShiftRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public OfferShiftRequestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OfferShiftRequestsRequestBuilder and sets the default values.
    ...
    public OfferShiftRequestsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<OfferShiftRequestCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<OfferShiftRequestCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OfferShiftRequestCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final OfferShiftRequest body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final OfferShiftRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
