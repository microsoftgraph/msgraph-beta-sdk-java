...
public class OfferShiftRequestsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OfferShiftRequestCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OfferShiftRequestCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of OfferShiftRequestCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<OfferShiftRequestCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<OfferShiftRequestsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, OfferShiftRequestCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of offerShiftRequest
     */
    public java.util.concurrent.CompletableFuture<OfferShiftRequest> post(@javax.annotation.Nonnull final OfferShiftRequest body, @javax.annotation.Nullable final java.util.function.Consumer<OfferShiftRequestsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
