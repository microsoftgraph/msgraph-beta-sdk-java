package microsoft.graph.app.onlinemeetings.item.attendancereports.item;
...
import microsoft.graph.app.onlinemeetings.item.attendancereports.item.attendancerecords.AttendanceRecordsRequestBuilder;
import microsoft.graph.app.onlinemeetings.item.attendancereports.item.attendancerecords.item.AttendanceRecordItemRequestBuilder;
...
public class MeetingAttendanceReportItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.app.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection
