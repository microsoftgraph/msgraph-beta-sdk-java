package com.microsoft.graph.app.onlinemeetings.item.attendancereports.item;

import com.microsoft.graph.app.onlinemeetings.item.attendancereports.item.attendancerecords.AttendanceRecordsRequestBuilder;
import com.microsoft.graph.app.onlinemeetings.item.attendancereports.item.attendancerecords.item.AttendanceRecordItemRequestBuilder;
...
public class MeetingAttendanceReportItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.app.onlineMeetings.item.attendanceReports.item.attendanceRecords.item collection
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<MeetingAttendanceReportItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of meetingAttendanceReport
     */
    public java.util.concurrent.CompletableFuture<MeetingAttendanceReport> get(@javax.annotation.Nullable final java.util.function.Consumer<MeetingAttendanceReportItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final MeetingAttendanceReport body, @javax.annotation.Nullable final java.util.function.Consumer<MeetingAttendanceReportItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final MeetingAttendanceReport body, @javax.annotation.Nullable final java.util.function.Consumer<MeetingAttendanceReportItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
