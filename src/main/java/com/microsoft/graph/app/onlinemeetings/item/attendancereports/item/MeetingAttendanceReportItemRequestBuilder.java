...
public class MeetingAttendanceReportItemRequestBuilder {
     ...
     * @return a CompletableFuture of meetingAttendanceReport
     */
    public java.util.concurrent.CompletableFuture<MeetingAttendanceReport> patch(@javax.annotation.Nonnull final MeetingAttendanceReport body, @javax.annotation.Nullable final java.util.function.Consumer<MeetingAttendanceReportItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
