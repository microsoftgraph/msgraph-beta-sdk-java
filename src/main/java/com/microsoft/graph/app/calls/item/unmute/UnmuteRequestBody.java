package microsoft.graph.app.calls.item.unmute;
...
public class UnmuteRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unmuteRequestBody
     */
    @javax.annotation.Nonnull
    public static UnmuteRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnmuteRequestBody currentObject = this;
