package com.microsoft.graph.app.calls.item.participants.item;

import com.microsoft.graph.app.calls.item.participants.item.mute.MuteRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.item.startholdmusic.StartHoldMusicRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.item.stopholdmusic.StopHoldMusicRequestBuilder;
...
public class ParticipantItemRequestBuilder {
    ...
    public ParticipantItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}{?%24select,%24expand}";
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<ParticipantItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of participant
     */
    public java.util.concurrent.CompletableFuture<Participant> get(@javax.annotation.Nullable final java.util.function.Consumer<ParticipantItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Participant body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Participant body, @javax.annotation.Nullable final java.util.function.Consumer<ParticipantItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
