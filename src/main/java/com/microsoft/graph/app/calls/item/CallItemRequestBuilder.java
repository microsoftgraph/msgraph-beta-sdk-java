package microsoft.graph.app.calls.item;
...
import microsoft.graph.app.calls.item.addlargegalleryview.AddLargeGalleryViewRequestBuilder;
import microsoft.graph.app.calls.item.answer.AnswerRequestBuilder;
import microsoft.graph.app.calls.item.audioroutinggroups.AudioRoutingGroupsRequestBuilder;
import microsoft.graph.app.calls.item.audioroutinggroups.item.AudioRoutingGroupItemRequestBuilder;
import microsoft.graph.app.calls.item.cancelmediaprocessing.CancelMediaProcessingRequestBuilder;
import microsoft.graph.app.calls.item.changescreensharingrole.ChangeScreenSharingRoleRequestBuilder;
import microsoft.graph.app.calls.item.contentsharingsessions.ContentSharingSessionsRequestBuilder;
import microsoft.graph.app.calls.item.contentsharingsessions.item.ContentSharingSessionItemRequestBuilder;
import microsoft.graph.app.calls.item.keepalive.KeepAliveRequestBuilder;
import microsoft.graph.app.calls.item.mute.MuteRequestBuilder;
import microsoft.graph.app.calls.item.operations.item.CommsOperationItemRequestBuilder;
import microsoft.graph.app.calls.item.operations.OperationsRequestBuilder;
import microsoft.graph.app.calls.item.participants.item.ParticipantItemRequestBuilder;
import microsoft.graph.app.calls.item.participants.ParticipantsRequestBuilder;
import microsoft.graph.app.calls.item.playprompt.PlayPromptRequestBuilder;
import microsoft.graph.app.calls.item.record.RecordRequestBuilder;
import microsoft.graph.app.calls.item.recordresponse.RecordResponseRequestBuilder;
import microsoft.graph.app.calls.item.redirect.RedirectRequestBuilder;
import microsoft.graph.app.calls.item.reject.RejectRequestBuilder;
import microsoft.graph.app.calls.item.subscribetotone.SubscribeToToneRequestBuilder;
import microsoft.graph.app.calls.item.transfer.TransferRequestBuilder;
import microsoft.graph.app.calls.item.unmute.UnmuteRequestBuilder;
import microsoft.graph.app.calls.item.updaterecordingstatus.UpdateRecordingStatusRequestBuilder;
...
public class CallItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.app.calls.item.audioRoutingGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.app.calls.item.contentSharingSessions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.app.calls.item.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.app.calls.item.participants.item collection
     * @param id Unique identifier of the item
