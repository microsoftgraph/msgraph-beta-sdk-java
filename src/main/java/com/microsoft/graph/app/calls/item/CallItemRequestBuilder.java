package com.microsoft.graph.app.calls.item;

import com.microsoft.graph.app.calls.item.addlargegalleryview.AddLargeGalleryViewRequestBuilder;
import com.microsoft.graph.app.calls.item.answer.AnswerRequestBuilder;
import com.microsoft.graph.app.calls.item.audioroutinggroups.AudioRoutingGroupsRequestBuilder;
import com.microsoft.graph.app.calls.item.audioroutinggroups.item.AudioRoutingGroupItemRequestBuilder;
import com.microsoft.graph.app.calls.item.cancelmediaprocessing.CancelMediaProcessingRequestBuilder;
import com.microsoft.graph.app.calls.item.changescreensharingrole.ChangeScreenSharingRoleRequestBuilder;
import com.microsoft.graph.app.calls.item.contentsharingsessions.ContentSharingSessionsRequestBuilder;
import com.microsoft.graph.app.calls.item.contentsharingsessions.item.ContentSharingSessionItemRequestBuilder;
import com.microsoft.graph.app.calls.item.keepalive.KeepAliveRequestBuilder;
import com.microsoft.graph.app.calls.item.mute.MuteRequestBuilder;
import com.microsoft.graph.app.calls.item.operations.item.CommsOperationItemRequestBuilder;
import com.microsoft.graph.app.calls.item.operations.OperationsRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.item.ParticipantItemRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.ParticipantsRequestBuilder;
import com.microsoft.graph.app.calls.item.playprompt.PlayPromptRequestBuilder;
import com.microsoft.graph.app.calls.item.record.RecordRequestBuilder;
import com.microsoft.graph.app.calls.item.recordresponse.RecordResponseRequestBuilder;
import com.microsoft.graph.app.calls.item.redirect.RedirectRequestBuilder;
import com.microsoft.graph.app.calls.item.reject.RejectRequestBuilder;
import com.microsoft.graph.app.calls.item.subscribetotone.SubscribeToToneRequestBuilder;
import com.microsoft.graph.app.calls.item.transfer.TransferRequestBuilder;
import com.microsoft.graph.app.calls.item.unmute.UnmuteRequestBuilder;
import com.microsoft.graph.app.calls.item.updaterecordingstatus.UpdateRecordingStatusRequestBuilder;
...
public class CallItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.app.calls.item.audioRoutingGroups.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.app.calls.item.contentSharingSessions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.app.calls.item.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.app.calls.item.participants.item collection
     * @param id Unique identifier of the item
