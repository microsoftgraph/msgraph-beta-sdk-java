...
public class SubscribeToToneRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SubscribeToToneOperation> post(@javax.annotation.Nonnull final SubscribeToTonePostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SubscribeToToneOperation::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of subscribeToToneOperation
     */
    public java.util.concurrent.CompletableFuture<SubscribeToToneOperation> post(@javax.annotation.Nonnull final SubscribeToTonePostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<SubscribeToToneRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, SubscribeToToneOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
