...
public class MuteAllRequestBuilder extends BaseRequestBuilder {
    ...
    public MuteAllRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/participants/muteAll", pathParameters);
    }
    /**
     * Instantiates a new MuteAllRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> post(@javax.annotation.Nonnull final MuteAllPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<MuteParticipantsOperation> executionException = new java.util.concurrent.CompletableFuture<MuteParticipantsOperation>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MuteAllPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MuteAllPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
