...
public class MuteAllRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a muteAllRequestBody
     */
    @javax.annotation.Nonnull
    public static MuteAllRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MuteAllRequestBody currentObject = this;
