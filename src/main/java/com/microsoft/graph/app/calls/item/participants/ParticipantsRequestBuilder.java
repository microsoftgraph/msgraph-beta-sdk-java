package com.microsoft.graph.app.calls.item.participants;

import com.microsoft.graph.app.calls.item.participants.count.CountRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.invite.InviteRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.item.ParticipantItemRequestBuilder;
import com.microsoft.graph.app.calls.item.participants.muteall.MuteAllRequestBuilder;
...
public class ParticipantsRequestBuilder extends BaseRequestBuilder {
    ...
    public ParticipantsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/participants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ParticipantsRequestBuilder and sets the default values.
    ...
    public ParticipantsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls/{call%2Did}/participants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
