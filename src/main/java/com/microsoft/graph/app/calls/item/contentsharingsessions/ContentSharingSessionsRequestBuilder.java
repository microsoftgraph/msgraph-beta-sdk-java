package com.microsoft.graph.app.calls.item.contentsharingsessions;

import com.microsoft.graph.app.calls.item.contentsharingsessions.count.CountRequestBuilder;
...
public class ContentSharingSessionsRequestBuilder {
    ...
    public ContentSharingSessionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
