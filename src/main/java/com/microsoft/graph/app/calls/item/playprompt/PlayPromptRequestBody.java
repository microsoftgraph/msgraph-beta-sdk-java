...
public class PlayPromptRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a playPromptRequestBody
     */
    @javax.annotation.Nonnull
    public static PlayPromptRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PlayPromptRequestBody currentObject = this;
