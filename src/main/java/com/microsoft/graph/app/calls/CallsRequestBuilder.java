package com.microsoft.graph.app.calls;

import com.microsoft.graph.app.calls.count.CountRequestBuilder;
import com.microsoft.graph.app.calls.item.CallItemRequestBuilder;
import com.microsoft.graph.app.calls.logteleconferencedevicequality.LogTeleconferenceDeviceQualityRequestBuilder;
...
public class CallsRequestBuilder extends BaseRequestBuilder {
    ...
    public CallsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CallsRequestBuilder and sets the default values.
    ...
    public CallsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/app/calls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get calls from app
