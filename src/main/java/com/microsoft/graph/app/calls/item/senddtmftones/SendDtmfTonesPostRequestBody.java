package com.microsoft.graph.app.calls.item.senddtmftones;
...
public class SendDtmfTonesPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private Integer delayBetweenTonesMs;
    /**
     * The tones property
     */
    private java.util.List<Tone> tones;
    /**
    ...
    public Integer getDelayBetweenTonesMs() {
        return this.delayBetweenTonesMs;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tones", (n) -> { this.setTones(n.getCollectionOfEnumValues(Tone.class)); });
    ...
    public void setDelayBetweenTonesMs(@jakarta.annotation.Nullable final Integer value) {
        this.delayBetweenTonesMs = value;
    }
    /**
