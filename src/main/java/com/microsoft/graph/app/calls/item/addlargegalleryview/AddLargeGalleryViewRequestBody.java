...
public class AddLargeGalleryViewRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a addLargeGalleryViewRequestBody
     */
    @javax.annotation.Nonnull
    public static AddLargeGalleryViewRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddLargeGalleryViewRequestBody currentObject = this;
