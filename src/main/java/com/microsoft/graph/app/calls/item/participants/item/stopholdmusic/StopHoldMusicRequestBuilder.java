...
public class StopHoldMusicRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final StopHoldMusicPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<StopHoldMusicOperation> post(@javax.annotation.Nonnull final StopHoldMusicPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<StopHoldMusicOperation> executionException = new java.util.concurrent.CompletableFuture<StopHoldMusicOperation>();
