...
public class StopHoldMusicPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a stopHoldMusicPostRequestBody
     */
    @javax.annotation.Nonnull
    public static StopHoldMusicPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StopHoldMusicPostRequestBody currentObject = this;
