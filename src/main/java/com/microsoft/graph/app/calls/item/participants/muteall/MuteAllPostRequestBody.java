...
public class MuteAllPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a MuteAllPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static MuteAllPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("participants", (n) -> { this.setParticipants(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setParticipants(@jakarta.annotation.Nullable final java.util.List<String> value) {
