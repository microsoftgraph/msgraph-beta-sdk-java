...
public class CancelMediaProcessingPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static CancelMediaProcessingPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CancelMediaProcessingPostRequestBody currentObject = this;
