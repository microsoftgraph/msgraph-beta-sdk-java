package com.microsoft.graph.app.calls.item.updaterecordingstatus;
...
public class UpdateRecordingStatusPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(RecordingStatus.class)); });
