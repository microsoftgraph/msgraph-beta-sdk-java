...
public class PlayPromptRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PlayPromptOperation> post(@javax.annotation.Nonnull final PlayPromptPostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PlayPromptOperation::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of playPromptOperation
     */
    public java.util.concurrent.CompletableFuture<PlayPromptOperation> post(@javax.annotation.Nonnull final PlayPromptPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PlayPromptRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, PlayPromptOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
