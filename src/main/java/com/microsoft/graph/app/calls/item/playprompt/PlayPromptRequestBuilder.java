...
public class PlayPromptRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PlayPromptPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PlayPromptOperation> post(@javax.annotation.Nonnull final PlayPromptPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlayPromptOperation> executionException = new java.util.concurrent.CompletableFuture<PlayPromptOperation>();
