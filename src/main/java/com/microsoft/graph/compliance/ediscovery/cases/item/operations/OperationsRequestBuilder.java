package com.microsoft.graph.compliance.ediscovery.cases.item.operations;

import com.microsoft.graph.compliance.ediscovery.cases.item.operations.count.CountRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.operations.microsoftgraphediscoverycaseexportoperation.MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder;
import com.microsoft.graph.models.ediscovery.CaseOperation;
import com.microsoft.graph.models.ediscovery.CaseOperationCollectionResponse;
...
public class OperationsRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder microsoftGraphEdiscoveryCaseExportOperation() {
        return new MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OperationsRequestBuilder and sets the default values.
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
