package com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources;

import com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.count.CountRequestBuilder;
...
import com.microsoft.graph.models.ediscovery.UnifiedGroupSourceCollectionResponse;
...
public class UnifiedGroupSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public UnifiedGroupSourcesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UnifiedGroupSourcesRequestBuilder and sets the default values.
    ...
    public UnifiedGroupSourcesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
