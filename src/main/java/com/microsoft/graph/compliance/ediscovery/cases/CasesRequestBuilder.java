...
public class CasesRequestBuilder extends BaseRequestBuilder {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public CaseItemRequestBuilder byCaseId(@jakarta.annotation.Nonnull final String caseId) {
    ...
    @Deprecated
    public CaseCollectionResponse get() {
        return get(null);
    }
    /**
     * Retrieve a list of case objects. This API is available in the following national cloud deployments.
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CaseCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseEscaped post(@jakarta.annotation.Nonnull final CaseEscaped body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public CaseEscaped post(@jakarta.annotation.Nonnull final CaseEscaped body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CaseEscaped::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve a list of case objects. This API is available in the following national cloud deployments.
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CaseEscaped body) {
    ...
    @jakarta.annotation.Nonnull
    @Deprecated
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CaseEscaped body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
