...
public class RemoveHoldRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeHoldRequestBody
     */
    @javax.annotation.Nonnull
    public static RemoveHoldRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveHoldRequestBody currentObject = this;
