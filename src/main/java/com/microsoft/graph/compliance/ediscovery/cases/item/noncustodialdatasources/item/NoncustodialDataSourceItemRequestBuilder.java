...
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.item.ediscoveryapplyhold.EdiscoveryApplyHoldRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.item.ediscoveryrelease.EdiscoveryReleaseRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.item.ediscoveryremovehold.EdiscoveryRemoveHoldRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.item.ediscoveryupdateindex.EdiscoveryUpdateIndexRequestBuilder;
...
public class NoncustodialDataSourceItemRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public EdiscoveryReleaseRequestBuilder ediscoveryRelease() {
        return new EdiscoveryReleaseRequestBuilder(pathParameters, requestAdapter);
    }
    ...
    @javax.annotation.Nonnull
    public EdiscoveryUpdateIndexRequestBuilder ediscoveryUpdateIndex() {
        return new EdiscoveryUpdateIndexRequestBuilder(pathParameters, requestAdapter);
    }
