...
public class AddToReviewSetOperationRequestBuilder extends BaseRequestBuilder {
    ...
    public AddToReviewSetOperationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/addToReviewSetOperation{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AddToReviewSetOperationRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/ediscovery-sourcecollection-list-addtoreviewsetoperation?view=graph-rest-1.0">Find more info here</a>
     */
    ...
    public java.util.concurrent.CompletableFuture<AddToReviewSetOperation> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AddToReviewSetOperation> executionException = new java.util.concurrent.CompletableFuture<AddToReviewSetOperation>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AddToReviewSetOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
