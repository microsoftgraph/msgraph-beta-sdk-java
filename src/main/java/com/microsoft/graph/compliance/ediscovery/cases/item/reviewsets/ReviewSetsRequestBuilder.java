...
public class ReviewSetsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ReviewSet> post(@javax.annotation.Nonnull final ReviewSet body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ReviewSet> executionException = new java.util.concurrent.CompletableFuture<ReviewSet>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
