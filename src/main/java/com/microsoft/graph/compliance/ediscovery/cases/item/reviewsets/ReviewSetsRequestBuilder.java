...
public class ReviewSetsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the reviewSets property of the microsoft.graph.ediscovery.case entity.
     * @param reviewSetId Unique identifier of the item
     * @return a ReviewSetItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ReviewSetItemRequestBuilder byReviewSetId(@javax.annotation.Nonnull final String reviewSetId) {
    ...
    public java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ReviewSetCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/ediscovery-case-post-reviewsets?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ReviewSet> post(@javax.annotation.Nonnull final ReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ReviewSet body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
