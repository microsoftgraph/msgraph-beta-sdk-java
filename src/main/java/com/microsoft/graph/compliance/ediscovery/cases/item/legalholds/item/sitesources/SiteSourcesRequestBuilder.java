package com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.sitesources;

import com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.sitesources.count.CountRequestBuilder;
...
public class SiteSourcesRequestBuilder {
    ...
    public SiteSourcesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/siteSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
