...
import com.microsoft.graph.compliance.ediscovery.cases.item.sourcecollections.item.ediscoveryestimatestatistics.EdiscoveryEstimateStatisticsRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.sourcecollections.item.ediscoverypurgedata.EdiscoveryPurgeDataRequestBuilder;
...
public class SourceCollectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public EdiscoveryEstimateStatisticsRequestBuilder ediscoveryEstimateStatistics() {
        return new EdiscoveryEstimateStatisticsRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the purgeData method. */
    @javax.annotation.Nonnull
    public EdiscoveryPurgeDataRequestBuilder ediscoveryPurgeData() {
        return new EdiscoveryPurgeDataRequestBuilder(pathParameters, requestAdapter);
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final SourceCollection body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final SourceCollection body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
