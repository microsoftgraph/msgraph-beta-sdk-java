...
public class ApplyTagsPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     */
    private java.util.List<Tag> tagsToRemove;
    /**
     ...
     */
    public void setTagsToAdd(@jakarta.annotation.Nullable final java.util.List<Tag> value) {
     ...
     */
    public void setTagsToRemove(@jakarta.annotation.Nullable final java.util.List<Tag> value) {
