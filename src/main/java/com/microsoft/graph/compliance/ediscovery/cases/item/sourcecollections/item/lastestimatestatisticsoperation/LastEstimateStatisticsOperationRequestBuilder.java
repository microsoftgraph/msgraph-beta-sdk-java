package microsoft.graph.compliance.ediscovery.cases.item.sourcecollections.item.lastestimatestatisticsoperation;
...
import microsoft.graph.models.ediscovery.EstimateStatisticsOperation;
...
public class LastEstimateStatisticsOperationRequestBuilder {
    ...
    public LastEstimateStatisticsOperationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/lastEstimateStatisticsOperation{?%24select,%24expand}";
     ...
     */
    public java.util.concurrent.CompletableFuture<EstimateStatisticsOperation> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EstimateStatisticsOperation::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of estimateStatisticsOperation
     */
    public java.util.concurrent.CompletableFuture<EstimateStatisticsOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of estimateStatisticsOperation
     */
    public java.util.concurrent.CompletableFuture<EstimateStatisticsOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, EstimateStatisticsOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
