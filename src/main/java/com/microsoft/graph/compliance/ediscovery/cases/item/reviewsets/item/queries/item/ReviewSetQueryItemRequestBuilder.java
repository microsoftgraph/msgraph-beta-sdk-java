...
public class ReviewSetQueryItemRequestBuilder {
     ...
     * @return a CompletableFuture of reviewSetQuery
     */
    public java.util.concurrent.CompletableFuture<ReviewSetQuery> patch(@javax.annotation.Nonnull final ReviewSetQuery body, @javax.annotation.Nullable final java.util.function.Consumer<ReviewSetQueryItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
