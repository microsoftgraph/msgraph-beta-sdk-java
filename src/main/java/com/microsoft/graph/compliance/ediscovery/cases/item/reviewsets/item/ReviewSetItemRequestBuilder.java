...
public class ReviewSetItemRequestBuilder {
     ...
     * @return a CompletableFuture of reviewSet
     */
    public java.util.concurrent.CompletableFuture<ReviewSet> patch(@javax.annotation.Nonnull final ReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<ReviewSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of reviewSet
     */
    public java.util.concurrent.CompletableFuture<ReviewSet> patch(@javax.annotation.Nonnull final ReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<ReviewSetItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
