package com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.item;

import com.microsoft.graph.compliance.ediscovery.cases.item.legalholds.item.unifiedgroupsources.item.group.GroupRequestBuilder;
...
public class UnifiedGroupSourceItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UnifiedGroupSourceItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UnifiedGroupSourceItemRequestBuilder and sets the default values.
    ...
    public UnifiedGroupSourceItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
