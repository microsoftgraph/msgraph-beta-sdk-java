package com.microsoft.graph.compliance.ediscovery.cases.item.ediscoveryclose;
 ...
 */
public class EdiscoveryCloseRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public EdiscoveryCloseRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/ediscovery.close", pathParameters);
    }
    /**
     * Instantiates a new EdiscoveryCloseRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public EdiscoveryCloseRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/ediscovery.close", rawUrl);
    }
    /**
