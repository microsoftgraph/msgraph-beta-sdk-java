...
public class LegalHoldItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final LegalHold body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LegalHold> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LegalHold> executionException = new java.util.concurrent.CompletableFuture<LegalHold>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
