...
public class MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder extends BaseRequestBuilder {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder
     * @deprecated
     * The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     */
    @jakarta.annotation.Nonnull
    @Deprecated
    public MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
