...
public class ApplyTagsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(2) {{
            this.put("tagsToAdd", (n) -> { currentObject.setTagsToAdd(n.getCollectionOfObjectValues(Tag::createFromDiscriminatorValue)); });
            this.put("tagsToRemove", (n) -> { currentObject.setTagsToRemove(n.getCollectionOfObjectValues(Tag::createFromDiscriminatorValue)); });
        }};
    }
    /**
