package com.microsoft.graph.compliance.ediscovery.cases.item.reviewsets.item.queries.item.applytags;
...
public class ApplyTagsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<Tag> _tagsToAdd;
    /** The tagsToRemove property */
    private java.util.List<Tag> _tagsToRemove;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tagsToAdd", (n) -> { currentObject.setTagsToAdd(n.getCollectionOfObjectValues(Tag::createFromDiscriminatorValue)); });
        deserializerMap.put("tagsToRemove", (n) -> { currentObject.setTagsToRemove(n.getCollectionOfObjectValues(Tag::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<Tag> getTagsToRemove() {
     ...
     */
    @javax.annotation.Nonnull
    public void setTagsToAdd(@javax.annotation.Nullable final java.util.List<Tag> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTagsToRemove(@javax.annotation.Nullable final java.util.List<Tag> value) {
