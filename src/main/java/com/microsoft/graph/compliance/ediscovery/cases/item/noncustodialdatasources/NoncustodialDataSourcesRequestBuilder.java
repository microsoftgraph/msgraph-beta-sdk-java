...
public class NoncustodialDataSourcesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final NoncustodialDataSource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<NoncustodialDataSource> post(@javax.annotation.Nonnull final NoncustodialDataSource body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<NoncustodialDataSource> executionException = new java.util.concurrent.CompletableFuture<NoncustodialDataSource>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
