...
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.ediscoveryapplyhold.EdiscoveryApplyHoldRequestBuilder;
import com.microsoft.graph.compliance.ediscovery.cases.item.noncustodialdatasources.ediscoveryremovehold.EdiscoveryRemoveHoldRequestBuilder;
...
public class NoncustodialDataSourcesRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public EdiscoveryApplyHoldRequestBuilder ediscoveryApplyHold() {
        return new EdiscoveryApplyHoldRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the removeHold method. */
    @javax.annotation.Nonnull
    public EdiscoveryRemoveHoldRequestBuilder ediscoveryRemoveHold() {
        return new EdiscoveryRemoveHoldRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the noncustodialDataSources property of the microsoft.graph.ediscovery.case entity.
     * @param noncustodialDataSourceId Unique identifier of the item
     * @return a NoncustodialDataSourceItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public NoncustodialDataSourceItemRequestBuilder byNoncustodialDataSourceId(@javax.annotation.Nonnull final String noncustodialDataSourceId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/ediscovery-noncustodialdatasource-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<NoncustodialDataSourceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/ediscovery-noncustodialdatasource-post?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<NoncustodialDataSource> post(@javax.annotation.Nonnull final NoncustodialDataSource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final NoncustodialDataSource body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final NoncustodialDataSource body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
