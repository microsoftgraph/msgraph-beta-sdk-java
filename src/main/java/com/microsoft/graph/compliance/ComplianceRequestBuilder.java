package microsoft.graph.compliance;
...
import microsoft.graph.compliance.ediscovery.EdiscoveryRequestBuilder;
import microsoft.graph.models.Compliance;
...
public class ComplianceRequestBuilder {
    ...
    public EdiscoveryRequestBuilder ediscovery() {
        return new EdiscoveryRequestBuilder(pathParameters, requestAdapter);
    }
    ...
    public java.util.concurrent.CompletableFuture<Compliance> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, Compliance::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of Compliance
     */
    public java.util.concurrent.CompletableFuture<Compliance> get(@javax.annotation.Nullable final java.util.function.Consumer<ComplianceRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, Compliance::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Compliance body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Compliance body, @javax.annotation.Nullable final java.util.function.Consumer<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Compliance body, @javax.annotation.Nullable final java.util.function.Consumer<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
