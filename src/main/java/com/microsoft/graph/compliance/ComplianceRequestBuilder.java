...
public class ComplianceRequestBuilder {
     ...
     * @return a CompletableFuture of Compliance
     */
    public java.util.concurrent.CompletableFuture<Compliance> patch(@javax.annotation.Nonnull final Compliance body, @javax.annotation.Nullable final java.util.function.Consumer<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
