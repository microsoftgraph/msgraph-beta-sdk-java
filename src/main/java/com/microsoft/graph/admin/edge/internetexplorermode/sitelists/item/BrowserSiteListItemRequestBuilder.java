...
public class BrowserSiteListItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final BrowserSiteListItemRequestBuilderDeleteRequestConfiguration requestConfig = new BrowserSiteListItemRequestBuilderDeleteRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        final RequestInformation requestInfo = new RequestInformation() {{
        ...
        if (requestConfiguration != null) {
            final BrowserSiteListItemRequestBuilderGetRequestConfiguration requestConfig = new BrowserSiteListItemRequestBuilderGetRequestConfiguration();
            requestConfiguration.accept(requestConfig);
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final BrowserSiteList body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final BrowserSiteList body, @javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final BrowserSiteListItemRequestBuilderPatchRequestConfiguration requestConfig = new BrowserSiteListItemRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<BrowserSiteList> get(@javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<BrowserSiteList> patch(@javax.annotation.Nonnull final BrowserSiteList body, @javax.annotation.Nullable final java.util.function.Consumer<BrowserSiteListItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
    ...
    public class BrowserSiteListItemRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public BrowserSiteListItemRequestBuilderGetQueryParameters queryParameters = new BrowserSiteListItemRequestBuilderGetQueryParameters();
        /**
