...
public class SiteListsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final BrowserSiteList body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BrowserSiteListCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BrowserSiteListCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BrowserSiteListCollectionResponse>();
