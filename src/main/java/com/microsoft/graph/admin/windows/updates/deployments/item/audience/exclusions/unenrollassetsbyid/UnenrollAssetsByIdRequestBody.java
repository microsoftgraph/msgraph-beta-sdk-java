...
public class UnenrollAssetsByIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unenrollAssetsByIdRequestBody
     */
    @javax.annotation.Nonnull
    public static UnenrollAssetsByIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnenrollAssetsByIdRequestBody currentObject = this;
