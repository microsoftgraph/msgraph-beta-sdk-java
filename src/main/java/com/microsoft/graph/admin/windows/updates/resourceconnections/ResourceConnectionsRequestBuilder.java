...
public class ResourceConnectionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ResourceConnectionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, ResourceConnectionCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public ResourceConnection post(@jakarta.annotation.Nonnull final ResourceConnection body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, ResourceConnection::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the resourceConnection objects and their properties. This API is available in the following national cloud deployments.
