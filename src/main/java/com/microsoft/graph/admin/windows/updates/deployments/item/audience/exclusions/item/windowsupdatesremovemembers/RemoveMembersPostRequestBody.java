package com.microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.item.windowsupdatesremovemembers;
...
public class RemoveMembersPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static RemoveMembersPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
