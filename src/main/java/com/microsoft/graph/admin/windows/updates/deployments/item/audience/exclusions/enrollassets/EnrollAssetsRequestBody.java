package microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.enrollassets;
...
public class EnrollAssetsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a enrollAssetsRequestBody
     */
    @javax.annotation.Nonnull
    public static EnrollAssetsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EnrollAssetsRequestBody currentObject = this;
