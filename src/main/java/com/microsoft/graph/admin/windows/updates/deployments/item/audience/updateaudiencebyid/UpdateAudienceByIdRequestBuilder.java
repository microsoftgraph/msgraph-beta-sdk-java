...
public class UpdateAudienceByIdRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UpdateAudienceByIdRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UpdateAudienceByIdRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<UpdateAudienceByIdRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final UpdateAudienceByIdRequestBody body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final UpdateAudienceByIdRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<UpdateAudienceByIdRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final UpdateAudienceByIdRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<UpdateAudienceByIdRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
