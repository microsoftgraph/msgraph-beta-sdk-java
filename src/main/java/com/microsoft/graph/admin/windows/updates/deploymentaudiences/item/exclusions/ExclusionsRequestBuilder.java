...
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.windowsupdatesenrollassets.WindowsUpdatesEnrollAssetsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.windowsupdatesenrollassetsbyid.WindowsUpdatesEnrollAssetsByIdRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.windowsupdatesunenrollassets.WindowsUpdatesUnenrollAssetsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.windowsupdatesunenrollassetsbyid.WindowsUpdatesUnenrollAssetsByIdRequestBuilder;
...
public class ExclusionsRequestBuilder {
    ...
    public ExclusionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
