package com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.exclusions.microsoftgraphwindowsupdatesenrollassets;
...
public class EnrollAssetsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a EnrollAssetsPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static EnrollAssetsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
