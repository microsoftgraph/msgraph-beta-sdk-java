...
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.members.item.windowsupdatesaddmembers.WindowsUpdatesAddMembersRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.members.item.windowsupdatesaddmembersbyid.WindowsUpdatesAddMembersByIdRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.members.item.windowsupdatesremovemembers.WindowsUpdatesRemoveMembersRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.members.item.windowsupdatesremovemembersbyid.WindowsUpdatesRemoveMembersByIdRequestBuilder;
...
public class UpdatableAssetItemRequestBuilder {
    ...
    public UpdatableAssetItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}{?%24select,%24expand}";
