...
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.windowsupdatesenrollassets.WindowsUpdatesEnrollAssetsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.windowsupdatesenrollassetsbyid.WindowsUpdatesEnrollAssetsByIdRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.windowsupdatesunenrollassets.WindowsUpdatesUnenrollAssetsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.windowsupdatesunenrollassetsbyid.WindowsUpdatesUnenrollAssetsByIdRequestBuilder;
...
public class ExclusionsRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public WindowsUpdatesEnrollAssetsRequestBuilder windowsUpdatesEnrollAssets() {
        return new WindowsUpdatesEnrollAssetsRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the enrollAssetsById method. */
    @javax.annotation.Nonnull
    public WindowsUpdatesEnrollAssetsByIdRequestBuilder windowsUpdatesEnrollAssetsById() {
        return new WindowsUpdatesEnrollAssetsByIdRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the unenrollAssets method. */
    @javax.annotation.Nonnull
    public WindowsUpdatesUnenrollAssetsRequestBuilder windowsUpdatesUnenrollAssets() {
        return new WindowsUpdatesUnenrollAssetsRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the unenrollAssetsById method. */
    @javax.annotation.Nonnull
    public WindowsUpdatesUnenrollAssetsByIdRequestBuilder windowsUpdatesUnenrollAssetsById() {
        return new WindowsUpdatesUnenrollAssetsByIdRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the exclusions property of the microsoft.graph.windowsUpdates.deploymentAudience entity.
    ...
    public ExclusionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/exclusions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ExclusionsRequestBuilder and sets the default values.
    ...
    public ExclusionsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/exclusions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/windowsupdates-deploymentaudience-list-exclusions?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
