package microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.enrollassetsbyid;
...
import microsoft.graph.models.windowsupdates.UpdateCategory;
/** Provides operations to call the enrollAssetsById method.  */
public class EnrollAssetsByIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a enrollAssetsByIdRequestBody
     */
    @javax.annotation.Nonnull
    public static EnrollAssetsByIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EnrollAssetsByIdRequestBody currentObject = this;
