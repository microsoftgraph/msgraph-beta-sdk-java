package com.microsoft.graph.admin.windows.updates.deploymentaudiences.item;

import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.ExclusionsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.item.UpdatableAssetItemRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.members.MembersRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.windowsupdatesupdateaudience.WindowsUpdatesUpdateAudienceRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.windowsupdatesupdateaudiencebyid.WindowsUpdatesUpdateAudienceByIdRequestBuilder;
 ...
 */
public class DeploymentAudienceItemRequestBuilder {
    ...
    public DeploymentAudienceItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public DeploymentAudienceItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.item.UpdatableAssetItemRequestBuilder exclusions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("updatableAsset%2Did", id);
        return new com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.exclusions.item.UpdatableAssetItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.members.item.UpdatableAssetItemRequestBuilder members(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("updatableAsset%2Did", id);
        return new com.microsoft.graph.admin.windows.updates.deploymentaudiences.item.members.item.UpdatableAssetItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
