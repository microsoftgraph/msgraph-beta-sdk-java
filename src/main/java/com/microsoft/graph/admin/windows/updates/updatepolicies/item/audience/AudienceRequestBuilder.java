package com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience;

import com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.exclusions.ExclusionsRequestBuilder;
import com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.members.item.UpdatableAssetItemRequestBuilder;
import com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.members.MembersRequestBuilder;
import com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.windowsupdatesupdateaudience.WindowsUpdatesUpdateAudienceRequestBuilder;
import com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.windowsupdatesupdateaudiencebyid.WindowsUpdatesUpdateAudienceByIdRequestBuilder;
...
public class AudienceRequestBuilder {
    ...
    public AudienceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.exclusions.item.UpdatableAssetItemRequestBuilder exclusions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("updatableAsset%2Did", id);
        return new com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.exclusions.item.UpdatableAssetItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.members.item.UpdatableAssetItemRequestBuilder members(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("updatableAsset%2Did", id);
        return new com.microsoft.graph.admin.windows.updates.updatepolicies.item.audience.members.item.UpdatableAssetItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
