...
public class UnenrollAssetsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unenrollAssetsRequestBody
     */
    @javax.annotation.Nonnull
    public static UnenrollAssetsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnenrollAssetsRequestBody currentObject = this;
