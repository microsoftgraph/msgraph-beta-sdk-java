package microsoft.graph.admin.windows.updates.deployments.item.audience.members.item.addmembers;
...
public class AddMembersRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a addMembersRequestBody
     */
    @javax.annotation.Nonnull
    public static AddMembersRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddMembersRequestBody currentObject = this;
