...
public class AudienceRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeploymentAudience body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeploymentAudience> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeploymentAudience> executionException = new java.util.concurrent.CompletableFuture<DeploymentAudience>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
