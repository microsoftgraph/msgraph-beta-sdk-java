...
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.windowsupdatesupdateaudience.WindowsUpdatesUpdateAudienceRequestBuilder;
import com.microsoft.graph.admin.windows.updates.deployments.item.audience.windowsupdatesupdateaudiencebyid.WindowsUpdatesUpdateAudienceByIdRequestBuilder;
...
public class AudienceRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public WindowsUpdatesUpdateAudienceRequestBuilder windowsUpdatesUpdateAudience() {
        return new WindowsUpdatesUpdateAudienceRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the updateAudienceById method. */
    @javax.annotation.Nonnull
    public WindowsUpdatesUpdateAudienceByIdRequestBuilder windowsUpdatesUpdateAudienceById() {
        return new WindowsUpdatesUpdateAudienceByIdRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public AudienceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AudienceRequestBuilder and sets the default values.
    ...
    public AudienceRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience{?%24select,%24expand}", rawUrl);
    }
    /**
