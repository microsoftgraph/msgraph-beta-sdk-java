...
public class EntriesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CatalogEntry body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CatalogEntryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CatalogEntryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CatalogEntryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CatalogEntry> post(@javax.annotation.Nonnull final CatalogEntry body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CatalogEntry> executionException = new java.util.concurrent.CompletableFuture<CatalogEntry>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
