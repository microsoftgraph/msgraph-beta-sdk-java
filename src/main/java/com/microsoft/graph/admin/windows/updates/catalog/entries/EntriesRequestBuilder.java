...
public class EntriesRequestBuilder extends BaseRequestBuilder {
    ...
    public CatalogEntryCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, CatalogEntryCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public CatalogEntry post(@jakarta.annotation.Nonnull final CatalogEntry body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CatalogEntry::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of catalogEntry resources from the catalog. Currently, this operation returns entries of the featureUpdateCatalogEntry or qualityUpdateCatalog types, inherited from catalogEntry.  This API is available in the following national cloud deployments.
