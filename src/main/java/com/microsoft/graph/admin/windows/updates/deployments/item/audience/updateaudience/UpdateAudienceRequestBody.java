package microsoft.graph.admin.windows.updates.deployments.item.audience.updateaudience;
...
public class UpdateAudienceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updateAudienceRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdateAudienceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateAudienceRequestBody currentObject = this;
