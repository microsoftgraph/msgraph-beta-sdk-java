package microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.item.removemembersbyid;
...
public class RemoveMembersByIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeMembersByIdRequestBody
     */
    @javax.annotation.Nonnull
    public static RemoveMembersByIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveMembersByIdRequestBody currentObject = this;
