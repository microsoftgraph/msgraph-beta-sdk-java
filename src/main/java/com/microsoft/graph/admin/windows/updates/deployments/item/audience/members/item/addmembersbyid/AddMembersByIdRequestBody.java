...
public class AddMembersByIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a addMembersByIdRequestBody
     */
    @javax.annotation.Nonnull
    public static AddMembersByIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddMembersByIdRequestBody currentObject = this;
