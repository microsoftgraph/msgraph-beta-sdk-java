package microsoft.graph.admin.windows.updates.deployments.item.audience.exclusions.item.removemembers;
...
public class RemoveMembersRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a removeMembersRequestBody
     */
    @javax.annotation.Nonnull
    public static RemoveMembersRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveMembersRequestBody currentObject = this;
