...
public class DeploymentAudiencesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the deploymentAudiences property of the microsoft.graph.adminWindowsUpdates entity.
     * @param deploymentAudienceId Unique identifier of the item
     * @return a DeploymentAudienceItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeploymentAudienceItemRequestBuilder byDeploymentAudienceId(@javax.annotation.Nonnull final String deploymentAudienceId) {
    ...
    public DeploymentAudiencesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public DeploymentAudiencesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeploymentAudience body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeploymentAudience body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
