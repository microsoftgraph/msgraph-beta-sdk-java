...
public class AdminRequestBuilder {
     ...
     * @return a CompletableFuture of Admin
     */
    public java.util.concurrent.CompletableFuture<Admin> patch(@javax.annotation.Nonnull final Admin body, @javax.annotation.Nullable final java.util.function.Consumer<AdminRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of Admin
     */
    public java.util.concurrent.CompletableFuture<Admin> patch(@javax.annotation.Nonnull final Admin body, @javax.annotation.Nullable final java.util.function.Consumer<AdminRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
