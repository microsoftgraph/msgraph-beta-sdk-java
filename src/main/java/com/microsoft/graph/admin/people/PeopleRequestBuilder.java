...
public class PeopleRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PeopleAdminSettings> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PeopleAdminSettings> executionException = new java.util.concurrent.CompletableFuture<PeopleAdminSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PeopleAdminSettings> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PeopleAdminSettings> patch(@javax.annotation.Nonnull final PeopleAdminSettings body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PeopleAdminSettings> patch(@javax.annotation.Nonnull final PeopleAdminSettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final PeopleAdminSettings body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final PeopleAdminSettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
