...
public class PrivilegedSignupStatusRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PrivilegedSignupStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedSignupStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrivilegedSignupStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrivilegedSignupStatusCollectionResponse>();
