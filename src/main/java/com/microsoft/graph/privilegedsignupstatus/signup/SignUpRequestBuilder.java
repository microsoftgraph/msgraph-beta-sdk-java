...
public class SignUpRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedSignupStatus> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrivilegedSignupStatus> executionException = new java.util.concurrent.CompletableFuture<PrivilegedSignupStatus>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PrivilegedSignupStatus> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
