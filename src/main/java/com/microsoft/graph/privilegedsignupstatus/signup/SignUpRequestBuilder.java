 ...
 */
public class SignUpRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public SignUpRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedSignupStatus/signUp", pathParameters);
    }
    /**
     * Instantiates a new SignUpRequestBuilder and sets the default values.
    ...
    public SignUpRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/privilegedSignupStatus/signUp", rawUrl);
    }
    /**
