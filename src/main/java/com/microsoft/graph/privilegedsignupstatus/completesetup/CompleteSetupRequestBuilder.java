...
public class CompleteSetupRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of CompleteSetupPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CompleteSetupPostResponse> post(@jakarta.annotation.Nonnull final CompleteSetupPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CompleteSetupPostResponse> post(@jakarta.annotation.Nonnull final CompleteSetupPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, CompleteSetupPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action completeSetup
     * @param body The request body
