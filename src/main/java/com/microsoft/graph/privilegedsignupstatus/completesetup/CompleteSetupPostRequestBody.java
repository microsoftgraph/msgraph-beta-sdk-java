...
public class CompleteSetupPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public TenantSetupInfo getTenantSetupInfo() {
        return this.BackingStore.get("tenantSetupInfo");
    }
    /**
    ...
    public void setTenantSetupInfo(@jakarta.annotation.Nullable final TenantSetupInfo value) {
        this.BackingStore.set("tenantSetupInfo", value);
    }
}
