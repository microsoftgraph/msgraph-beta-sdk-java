...
/**
 * The class for the Labels Root Request Builder.
 */
public class LabelsRootRequestBuilder extends BaseRequestBuilder<LabelsRoot> {

    /**
     * The request builder for the LabelsRoot
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public LabelsRootRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the LabelsRootRequest instance
     */
    @Nonnull
    public LabelsRootRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public LabelsRootRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.security.requests.LabelsRootRequest(getRequestUrl(), getClient(), requestOptions);
    }
    ...
    /**
     * Gets a request builder for the RetentionLabel item
     *
