...
/**
 * The class for the Ediscovery Review Set Reference Request.
 */
public class EdiscoveryReviewSetReferenceRequest extends BaseReferenceRequest<EdiscoveryReviewSet> {
     ...
     */
    public EdiscoveryReviewSetReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewSetReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryReviewSetReferenceRequest expand(@Nonnull final String value) {
