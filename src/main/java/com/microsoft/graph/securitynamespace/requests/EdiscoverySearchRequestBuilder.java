...
public class EdiscoverySearchRequestBuilder extends BaseRequestBuilder<EdiscoverySearch> {
     ...
     */
    @Nonnull
    public EdiscoverySearchExportReportRequestBuilder exportReport(@Nonnull final EdiscoverySearchExportReportParameterSet parameters) {
        return new EdiscoverySearchExportReportRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.exportReport"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public EdiscoverySearchExportResultRequestBuilder exportResult(@Nonnull final EdiscoverySearchExportResultParameterSet parameters) {
        return new EdiscoverySearchExportResultRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.exportResult"), getClient(), null, parameters);
    }
