...
public class EdiscoverySearchRequestBuilder extends BaseRequestBuilder<EdiscoverySearch> {
     ...
     */
    @Nonnull
    public EdiscoverySearchPurgeDataRequestBuilder purgeData() {
        return new EdiscoverySearchPurgeDataRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.purgeData"), getClient(), null);
    }
}
