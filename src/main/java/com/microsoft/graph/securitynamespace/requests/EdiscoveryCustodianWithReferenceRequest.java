...
/**
 * The class for the Ediscovery Custodian With Reference Request.
 */
public class EdiscoveryCustodianWithReferenceRequest extends BaseWithReferenceRequest<EdiscoveryCustodian> {
     ...
     */
    public EdiscoveryCustodianWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public EdiscoveryCustodianWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public EdiscoveryCustodianWithReferenceRequest expand(@Nonnull final String value) {
