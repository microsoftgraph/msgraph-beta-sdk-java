...
public class EdiscoveryReviewSetQueryExportParameterSet {
    ...
    public static final class EdiscoveryReviewSetQueryExportParameterSetBuilder {
         ...
         */
        @Nonnull
        public EdiscoveryReviewSetQueryExportParameterSetBuilder withAzureBlobContainer(@Nullable final String val) {
         ...
         */
        @Nonnull
        public EdiscoveryReviewSetQueryExportParameterSetBuilder withAzureBlobToken(@Nullable final String val) {
