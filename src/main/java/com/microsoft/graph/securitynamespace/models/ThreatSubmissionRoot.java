...
public class ThreatSubmissionRoot extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(@Nonnull final ISerializer serializer, @Nonnull final JsonObject json) {
        ...
        if (json.has("emailThreats")) {
            emailThreats = serializer.deserializeObject(json.get("emailThreats"), EmailThreatSubmissionCollectionPage.class);
        }

        if (json.has("emailThreatSubmissionPolicies")) {
            emailThreatSubmissionPolicies = serializer.deserializeObject(json.get("emailThreatSubmissionPolicies"), EmailThreatSubmissionPolicyCollectionPage.class);
        }

        if (json.has("fileThreats")) {
            fileThreats = serializer.deserializeObject(json.get("fileThreats"), FileThreatSubmissionCollectionPage.class);
        }

        if (json.has("urlThreats")) {
            urlThreats = serializer.deserializeObject(json.get("urlThreats"), UrlThreatSubmissionCollectionPage.class);
        }
    }
}
