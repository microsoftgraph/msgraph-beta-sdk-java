package com.microsoft.graph.print.shares.item.jobs.item.cancelprintjob;
...
public class CancelPrintJobRequestBuilder extends BaseRequestBuilder {
    ...
    public CancelPrintJobRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public CancelPrintJobRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
