...
import com.microsoft.graph.print.printershares.item.PrinterShareItemRequestBuilder;
import com.microsoft.graph.print.printershares.PrinterSharesRequestBuilder;
import com.microsoft.graph.print.reports.ReportsRequestBuilder;
...
public class PrintRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.print.printerShares.item collection
     * @param id Unique identifier of the item
     * @return a PrinterShareItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.print.printershares.item.PrinterShareItemRequestBuilder printerShares(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printerShare%2Did", id);
        return new com.microsoft.graph.print.printershares.item.PrinterShareItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.print.shares.item.PrinterShareItemRequestBuilder shares(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("printerShare%2Did", id);
        return new com.microsoft.graph.print.shares.item.PrinterShareItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
