...
public class ManagedDeviceEnrollmentFailureTrendsRequestBuilder extends BaseRequestBuilder {
    ...
    public ManagedDeviceEnrollmentFailureTrendsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentFailureTrends()", pathParameters);
    }
    /**
     * Instantiates a new ManagedDeviceEnrollmentFailureTrendsRequestBuilder and sets the default values.
    ...
    public ManagedDeviceEnrollmentFailureTrendsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentFailureTrends()", rawUrl);
    }
    /**
