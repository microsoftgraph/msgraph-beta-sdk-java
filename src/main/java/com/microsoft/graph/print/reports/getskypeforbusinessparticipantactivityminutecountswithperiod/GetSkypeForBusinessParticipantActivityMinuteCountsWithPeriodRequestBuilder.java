package com.microsoft.graph.print.reports.getskypeforbusinessparticipantactivityminutecountswithperiod;
...
public class GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder extends BaseRequestBuilder {
    ...
    public GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String period) {
        super(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')", pathParameters);
    ...
    public GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriodRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')", rawUrl);
    }
    /**
