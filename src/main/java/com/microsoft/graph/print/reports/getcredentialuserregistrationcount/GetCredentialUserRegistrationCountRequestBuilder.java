...
public class GetCredentialUserRegistrationCountRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetCredentialUserRegistrationCountResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetCredentialUserRegistrationCountResponse> executionException = new java.util.concurrent.CompletableFuture<GetCredentialUserRegistrationCountResponse>();
