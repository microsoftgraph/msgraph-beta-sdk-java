package com.microsoft.graph.print.reports.monthlyprintusagebyprinter;
...
import com.microsoft.graph.print.reports.monthlyprintusagebyprinter.count.CountRequestBuilder;
...
public class MonthlyPrintUsageByPrinterRequestBuilder extends BaseRequestBuilder {
    ...
    public MonthlyPrintUsageByPrinterRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/monthlyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MonthlyPrintUsageByPrinterRequestBuilder and sets the default values.
    ...
    public MonthlyPrintUsageByPrinterRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/monthlyPrintUsageByPrinter{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Retrieve a list of monthly print usage summaries, grouped by printer.
     * @return a CompletableFuture of PrintUsageByPrinterCollectionResponse
     * @see <a href="https://docs.microsoft.com/graph/api/reportroot-list-monthlyprintusagebyprinter?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
