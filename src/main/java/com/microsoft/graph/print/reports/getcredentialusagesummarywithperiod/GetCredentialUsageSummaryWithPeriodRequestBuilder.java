...
public class GetCredentialUsageSummaryWithPeriodRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse> executionException = new java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse>();
