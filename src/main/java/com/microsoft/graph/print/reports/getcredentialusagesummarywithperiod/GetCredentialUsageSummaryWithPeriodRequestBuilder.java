 ...
 */
public class GetCredentialUsageSummaryWithPeriodRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GetCredentialUsageSummaryWithPeriodRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String period) {
        super(requestAdapter, "{+baseurl}/print/reports/getCredentialUsageSummary(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters);
    ...
    public GetCredentialUsageSummaryWithPeriodRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/getCredentialUsageSummary(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse> executionException = new java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetCredentialUsageSummaryWithPeriodResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
