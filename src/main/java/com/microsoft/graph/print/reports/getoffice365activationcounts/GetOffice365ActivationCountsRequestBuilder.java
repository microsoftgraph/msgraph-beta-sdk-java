package com.microsoft.graph.print.reports.getoffice365activationcounts;
...
public class GetOffice365ActivationCountsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetOffice365ActivationCountsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/getOffice365ActivationCounts()", pathParameters);
    }
    /**
     * Instantiates a new GetOffice365ActivationCountsRequestBuilder and sets the default values.
    ...
    public GetOffice365ActivationCountsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/getOffice365ActivationCounts()", rawUrl);
    }
    /**
