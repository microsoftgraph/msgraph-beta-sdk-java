...
public class GetOffice365ActiveUserDetailWithPeriodResponse implements AdditionalDataHolder, Parsable {
    ...
    /** The value property */
    private java.util.List<Office365ActiveUserDetail> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetOffice365ActiveUserDetailWithPeriodResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Office365ActiveUserDetail::createFromDiscriminatorValue)); });
        }};
    }
    /**
