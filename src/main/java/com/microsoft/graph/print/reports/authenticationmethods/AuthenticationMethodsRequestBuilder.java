...
public class AuthenticationMethodsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AuthenticationMethodsRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodsRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodsRoot> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodsRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
