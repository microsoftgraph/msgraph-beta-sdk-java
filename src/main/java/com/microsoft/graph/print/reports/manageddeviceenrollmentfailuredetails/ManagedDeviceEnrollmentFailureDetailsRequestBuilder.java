package com.microsoft.graph.print.reports.manageddeviceenrollmentfailuredetails;
...
public class ManagedDeviceEnrollmentFailureDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public ManagedDeviceEnrollmentFailureDetailsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentFailureDetails()", pathParameters);
    }
    /**
     * Instantiates a new ManagedDeviceEnrollmentFailureDetailsRequestBuilder and sets the default values.
    ...
    public ManagedDeviceEnrollmentFailureDetailsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentFailureDetails()", rawUrl);
    }
    /**
