package com.microsoft.graph.print.reports.deviceconfigurationuseractivity;
...
public class DeviceConfigurationUserActivityRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceConfigurationUserActivityRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/deviceConfigurationUserActivity()", pathParameters);
    }
    /**
     * Instantiates a new DeviceConfigurationUserActivityRequestBuilder and sets the default values.
    ...
    public DeviceConfigurationUserActivityRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/deviceConfigurationUserActivity()", rawUrl);
    }
    /**
