...
public class UsersRegisteredByMethodRequestBuilder extends BaseRequestBuilder {
    ...
    public UsersRegisteredByMethodRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/authenticationMethods/usersRegisteredByMethod()", pathParameters);
    }
    /**
     * Instantiates a new UsersRegisteredByMethodRequestBuilder and sets the default values.
    ...
    public UsersRegisteredByMethodRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/authenticationMethods/usersRegisteredByMethod()", rawUrl);
    }
    /**
