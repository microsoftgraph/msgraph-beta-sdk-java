...
public class UsersRegisteredByMethodRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserRegistrationMethodSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserRegistrationMethodSummary> executionException = new java.util.concurrent.CompletableFuture<UserRegistrationMethodSummary>();
