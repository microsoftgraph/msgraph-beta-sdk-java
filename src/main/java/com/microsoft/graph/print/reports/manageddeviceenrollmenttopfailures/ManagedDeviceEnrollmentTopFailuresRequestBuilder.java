...
public class ManagedDeviceEnrollmentTopFailuresRequestBuilder extends BaseRequestBuilder {
    ...
    public ManagedDeviceEnrollmentTopFailuresRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentTopFailures()", pathParameters);
    }
    /**
     * Instantiates a new ManagedDeviceEnrollmentTopFailuresRequestBuilder and sets the default values.
    ...
    public ManagedDeviceEnrollmentTopFailuresRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/managedDeviceEnrollmentTopFailures()", rawUrl);
    }
    /**
