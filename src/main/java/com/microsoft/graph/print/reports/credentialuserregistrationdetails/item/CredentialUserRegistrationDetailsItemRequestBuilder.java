package com.microsoft.graph.print.reports.credentialuserregistrationdetails.item;
...
public class CredentialUserRegistrationDetailsItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CredentialUserRegistrationDetailsItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/credentialUserRegistrationDetails/{credentialUserRegistrationDetails%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CredentialUserRegistrationDetailsItemRequestBuilder and sets the default values.
    ...
    public CredentialUserRegistrationDetailsItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/reports/credentialUserRegistrationDetails/{credentialUserRegistrationDetails%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
