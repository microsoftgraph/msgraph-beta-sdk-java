...
public class ConnectorsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrintConnectorCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrintConnectorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrintConnectorCollectionResponse>();
