package microsoft.graph.print.printers.item;
...
import microsoft.graph.print.printers.item.connectors.ConnectorsRequestBuilder;
import microsoft.graph.print.printers.item.connectors.item.PrintConnectorItemRequestBuilder;
import microsoft.graph.print.printers.item.getcapabilities.GetCapabilitiesRequestBuilder;
import microsoft.graph.print.printers.item.resetdefaults.ResetDefaultsRequestBuilder;
import microsoft.graph.print.printers.item.restorefactorydefaults.RestoreFactoryDefaultsRequestBuilder;
import microsoft.graph.print.printers.item.share.ShareRequestBuilder;
import microsoft.graph.print.printers.item.shares.item.PrinterShareItemRequestBuilder;
import microsoft.graph.print.printers.item.shares.SharesRequestBuilder;
import microsoft.graph.print.printers.item.tasktriggers.item.PrintTaskTriggerItemRequestBuilder;
import microsoft.graph.print.printers.item.tasktriggers.TaskTriggersRequestBuilder;
...
public class PrinterItemRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public ResetDefaultsRequestBuilder resetDefaults() {
        return new ResetDefaultsRequestBuilder(pathParameters, requestAdapter);
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<PrinterItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of printer
     */
    public java.util.concurrent.CompletableFuture<Printer> get(@javax.annotation.Nullable final java.util.function.Consumer<PrinterItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Printer body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Printer body, @javax.annotation.Nullable final java.util.function.Consumer<PrinterItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final Printer body, @javax.annotation.Nullable final java.util.function.Consumer<PrinterItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
