package com.microsoft.graph.print.printershares.item.allowedgroups.item;

import com.microsoft.graph.print.printershares.item.allowedgroups.item.ref.RefRequestBuilder;
import com.microsoft.graph.print.printershares.item.allowedgroups.item.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class GroupItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups/{group%2Did}", pathParameters);
    }
    /**
     * Instantiates a new GroupItemRequestBuilder and sets the default values.
    ...
    public GroupItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups/{group%2Did}", rawUrl);
    }
}
