package com.microsoft.graph.print.printershares.item.allowedusers.item;

import com.microsoft.graph.print.printershares.item.allowedusers.item.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.print.printershares.item.allowedusers.item.ref.RefRequestBuilder;
import com.microsoft.graph.print.printershares.item.allowedusers.item.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
...
public class UserItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers/{user%2Did}", pathParameters);
    }
    /**
     * Instantiates a new UserItemRequestBuilder and sets the default values.
    ...
    public UserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers/{user%2Did}", rawUrl);
    }
}
