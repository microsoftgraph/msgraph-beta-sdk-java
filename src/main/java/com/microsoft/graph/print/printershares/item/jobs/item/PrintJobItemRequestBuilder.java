package com.microsoft.graph.print.printershares.item.jobs.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.PrintJob;
import com.microsoft.graph.print.printershares.item.jobs.item.abort.AbortRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.cancelprintjob.CancelPrintJobRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.documents.DocumentsRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.redirect.RedirectRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.start.StartRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.startprintjob.StartPrintJobRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.tasks.TasksRequestBuilder;
...
public class PrintJobItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PrintJobItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PrintJobItemRequestBuilder and sets the default values.
    ...
    public PrintJobItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
