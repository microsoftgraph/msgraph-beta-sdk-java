package com.microsoft.graph.print.printershares.item.jobs.item.documents.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.PrintDocument;
import com.microsoft.graph.print.printershares.item.jobs.item.documents.item.createuploadsession.CreateUploadSessionRequestBuilder;
import com.microsoft.graph.print.printershares.item.jobs.item.documents.item.value.ContentRequestBuilder;
