package com.microsoft.graph.print.printershares.item.allowedusers;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UserCollectionResponse;
import com.microsoft.graph.print.printershares.item.allowedusers.count.CountRequestBuilder;
import com.microsoft.graph.print.printershares.item.allowedusers.ref.RefRequestBuilder;
...
public class AllowedUsersRequestBuilder {
    ...
    public AllowedUsersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
