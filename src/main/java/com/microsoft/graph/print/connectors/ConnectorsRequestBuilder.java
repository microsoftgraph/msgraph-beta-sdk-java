...
public class ConnectorsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PrintConnector body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PrintConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrintConnectorCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrintConnectorCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<PrintConnectorCollectionResponse>() {{
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PrintConnector> post(@javax.annotation.Nonnull final PrintConnector body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PrintConnector> post(@javax.annotation.Nonnull final PrintConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
