package com.microsoft.graph.sites.item.termstore.sets.item.parentgroup;
...
import com.microsoft.graph.sites.item.termstore.sets.item.parentgroup.sets.SetsRequestBuilder;
