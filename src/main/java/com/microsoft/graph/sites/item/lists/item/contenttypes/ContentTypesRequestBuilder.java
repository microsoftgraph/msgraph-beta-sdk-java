package microsoft.graph.sites.item.lists.item.contenttypes;
...
import microsoft.graph.sites.item.lists.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.sites.item.lists.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.sites.item.lists.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.sites.item.lists.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
