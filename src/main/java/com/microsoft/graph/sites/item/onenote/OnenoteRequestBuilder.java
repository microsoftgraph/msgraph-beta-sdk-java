package microsoft.graph.sites.item.onenote;
...
import microsoft.graph.sites.item.onenote.notebooks.item.NotebookItemRequestBuilder;
import microsoft.graph.sites.item.onenote.notebooks.NotebooksRequestBuilder;
import microsoft.graph.sites.item.onenote.operations.item.OnenoteOperationItemRequestBuilder;
import microsoft.graph.sites.item.onenote.operations.OperationsRequestBuilder;
import microsoft.graph.sites.item.onenote.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.sites.item.onenote.pages.PagesRequestBuilder;
import microsoft.graph.sites.item.onenote.resources.item.OnenoteResourceItemRequestBuilder;
import microsoft.graph.sites.item.onenote.resources.ResourcesRequestBuilder;
import microsoft.graph.sites.item.onenote.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.sites.item.onenote.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.sites.item.onenote.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.sites.item.onenote.sections.SectionsRequestBuilder;
