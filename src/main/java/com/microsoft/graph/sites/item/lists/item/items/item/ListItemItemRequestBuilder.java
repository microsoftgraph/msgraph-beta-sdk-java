...
import com.microsoft.graph.sites.item.lists.item.items.item.activities.ActivitiesRequestBuilder;
...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.sites.item.lists.item.items.item.activities.item collection
