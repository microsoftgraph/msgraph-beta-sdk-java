...
import microsoft.graph.sites.item.lists.item.items.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.sites.item.lists.item.items.item.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.sites.item.lists.item.items.item.analytics.AnalyticsRequestBuilder;
import microsoft.graph.sites.item.lists.item.items.item.createlink.CreateLinkRequestBuilder;
...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.lists.item.items.item.activities.item collection
