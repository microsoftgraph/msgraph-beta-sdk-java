package com.microsoft.graph.sites.item.informationprotection.sensitivitylabels.item.sublabels;
...
import com.microsoft.graph.sites.item.informationprotection.sensitivitylabels.item.sublabels.count.CountRequestBuilder;
import com.microsoft.graph.sites.item.informationprotection.sensitivitylabels.item.sublabels.evaluate.EvaluateRequestBuilder;
...
public class SublabelsRequestBuilder {
    ...
    public SublabelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
