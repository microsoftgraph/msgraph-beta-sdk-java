...
import com.microsoft.graph.sites.item.informationprotection.InformationProtectionRequestBuilder;
...
import com.microsoft.graph.sites.item.pages.item.SitePageItemRequestBuilder;
