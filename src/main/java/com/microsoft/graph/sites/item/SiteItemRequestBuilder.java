...
import microsoft.graph.sites.item.pages.item.SitePageItemRequestBuilder;
import microsoft.graph.sites.item.pages.PagesRequestBuilder;
...
public class SiteItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.sites.item.pages.item collection
     * @param id Unique identifier of the item
