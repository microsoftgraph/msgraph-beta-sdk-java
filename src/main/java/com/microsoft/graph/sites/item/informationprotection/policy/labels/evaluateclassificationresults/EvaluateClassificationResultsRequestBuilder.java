...
public class EvaluateClassificationResultsRequestBuilder {
    ...
    public EvaluateClassificationResultsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/evaluateClassificationResults";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/informationprotectionlabel-evaluateclassificationresults?view=graph-rest-1.0">Find more info here</a>
     */
