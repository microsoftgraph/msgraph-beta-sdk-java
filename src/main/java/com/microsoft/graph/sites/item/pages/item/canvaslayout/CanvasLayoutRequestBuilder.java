package com.microsoft.graph.sites.item.pages.item.canvaslayout;

import com.microsoft.graph.models.CanvasLayout;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.sites.item.pages.item.canvaslayout.horizontalsections.HorizontalSectionsRequestBuilder;
...
import com.microsoft.graph.sites.item.pages.item.canvaslayout.verticalsection.VerticalSectionRequestBuilder;
...
public class CanvasLayoutRequestBuilder extends BaseRequestBuilder {
    ...
    public CanvasLayoutRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CanvasLayoutRequestBuilder and sets the default values.
    ...
    public CanvasLayoutRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}", rawUrl);
    }
    /**
