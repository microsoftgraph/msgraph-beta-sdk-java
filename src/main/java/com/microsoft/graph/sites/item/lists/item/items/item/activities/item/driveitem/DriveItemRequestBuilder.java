package com.microsoft.graph.sites.item.lists.item.items.item.activities.item.driveitem;

import com.microsoft.graph.models.DriveItem;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.sites.item.lists.item.items.item.activities.item.driveitem.content.ContentRequestBuilder;
