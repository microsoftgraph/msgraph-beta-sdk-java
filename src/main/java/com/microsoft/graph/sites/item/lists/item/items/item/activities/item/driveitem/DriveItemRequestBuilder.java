package microsoft.graph.sites.item.lists.item.items.item.activities.item.driveitem;
...
import microsoft.graph.sites.item.lists.item.items.item.activities.item.driveitem.content.ContentRequestBuilder;
