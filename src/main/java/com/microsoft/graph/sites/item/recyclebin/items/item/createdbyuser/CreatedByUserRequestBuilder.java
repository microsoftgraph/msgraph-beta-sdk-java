package com.microsoft.graph.sites.item.recyclebin.items.item.createdbyuser;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.User;
import com.microsoft.graph.sites.item.recyclebin.items.item.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.sites.item.recyclebin.items.item.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
