package com.microsoft.graph.sites.item.termstore.groups.item.sets.item.terms.item.relations;
...
import com.microsoft.graph.sites.item.termstore.groups.item.sets.item.terms.item.relations.count.CountRequestBuilder;
