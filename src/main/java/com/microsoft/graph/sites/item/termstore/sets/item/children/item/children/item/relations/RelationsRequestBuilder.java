package com.microsoft.graph.sites.item.termstore.sets.item.children.item.children.item.relations;
...
import com.microsoft.graph.sites.item.termstore.sets.item.children.item.children.item.relations.count.CountRequestBuilder;
