...
public class DataLossPreventionPoliciesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the dataLossPreventionPolicies property of the microsoft.graph.informationProtection entity.
     * @param dataLossPreventionPolicyId Unique identifier of the item
     * @return a DataLossPreventionPolicyItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DataLossPreventionPolicyItemRequestBuilder byDataLossPreventionPolicyId(@javax.annotation.Nonnull final String dataLossPreventionPolicyId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DataLossPreventionPolicy body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DataLossPreventionPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
