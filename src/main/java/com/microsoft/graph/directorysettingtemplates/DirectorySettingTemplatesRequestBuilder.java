...
public class DirectorySettingTemplatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the collection of directorySettingTemplate entities.
     * @param directorySettingTemplateId Unique identifier of the item
     * @return a DirectorySettingTemplateItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DirectorySettingTemplateItemRequestBuilder byDirectorySettingTemplateId(@javax.annotation.Nonnull final String directorySettingTemplateId) {
    ...
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DirectorySettingTemplate body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DirectorySettingTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
