...
public class DirectorySettingTemplatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DirectorySettingTemplateCollectionResponse>();
