...
public class DirectorySettingTemplateItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplate> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DirectorySettingTemplate> executionException = new java.util.concurrent.CompletableFuture<DirectorySettingTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
