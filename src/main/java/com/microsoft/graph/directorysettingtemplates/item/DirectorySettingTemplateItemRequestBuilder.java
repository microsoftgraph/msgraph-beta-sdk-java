...
public class DirectorySettingTemplateItemRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplate> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DirectorySettingTemplate> executionException = new java.util.concurrent.CompletableFuture<DirectorySettingTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplate> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplate> patch(@jakarta.annotation.Nonnull final DirectorySettingTemplate body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DirectorySettingTemplate> patch(@jakarta.annotation.Nonnull final DirectorySettingTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DirectorySettingTemplate body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DirectorySettingTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
