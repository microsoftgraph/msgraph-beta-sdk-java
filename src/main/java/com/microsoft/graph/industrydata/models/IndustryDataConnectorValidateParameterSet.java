...
/**
 * The class for the Industry Data Connector Validate Parameter Set.
 */
public class IndustryDataConnectorValidateParameterSet {

    /**
     * Instiaciates a new IndustryDataConnectorValidateParameterSet
     */
     ...
     */
    protected IndustryDataConnectorValidateParameterSet(@Nonnull final IndustryDataConnectorValidateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the IndustryDataConnectorValidateParameterSet
     */
    public static final class IndustryDataConnectorValidateParameterSetBuilder {
        /**
         * Instanciates a new IndustryDataConnectorValidateParameterSetBuilder
         */
        @Nullable
