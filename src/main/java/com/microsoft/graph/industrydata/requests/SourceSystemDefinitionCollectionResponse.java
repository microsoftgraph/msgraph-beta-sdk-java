...
/**
 * The class for the Source System Definition Collection Response.
 */
public class SourceSystemDefinitionCollectionResponse extends BaseCollectionResponse<SourceSystemDefinition> {
