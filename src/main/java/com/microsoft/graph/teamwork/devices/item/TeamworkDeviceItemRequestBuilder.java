...
public class TeamworkDeviceItemRequestBuilder {
     ...
     * @return a CompletableFuture of teamworkDevice
     */
    public java.util.concurrent.CompletableFuture<TeamworkDevice> patch(@javax.annotation.Nonnull final TeamworkDevice body, @javax.annotation.Nullable final java.util.function.Consumer<TeamworkDeviceItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of teamworkDevice
     */
    public java.util.concurrent.CompletableFuture<TeamworkDevice> patch(@javax.annotation.Nonnull final TeamworkDevice body, @javax.annotation.Nullable final java.util.function.Consumer<TeamworkDeviceItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
