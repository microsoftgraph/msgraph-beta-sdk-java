...
public class UpdateSoftwarePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("softwareType", (n) -> { currentObject.setSoftwareType(n.getEnumValue(TeamworkSoftwareType.class)); });
        deserializerMap.put("softwareVersion", (n) -> { currentObject.setSoftwareVersion(n.getStringValue()); });
