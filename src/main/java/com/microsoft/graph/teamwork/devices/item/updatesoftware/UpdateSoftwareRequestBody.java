package microsoft.graph.teamwork.devices.item.updatesoftware;
...
import microsoft.graph.models.TeamworkSoftwareType;
/** Provides operations to call the updateSoftware method.  */
public class UpdateSoftwareRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updateSoftwareRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdateSoftwareRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateSoftwareRequestBody currentObject = this;
