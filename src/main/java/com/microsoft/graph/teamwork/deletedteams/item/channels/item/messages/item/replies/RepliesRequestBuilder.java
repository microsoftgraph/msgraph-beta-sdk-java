package microsoft.graph.teamwork.deletedteams.item.channels.item.messages.item.replies;
...
import microsoft.graph.teamwork.deletedteams.item.channels.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
