package microsoft.graph.teamwork.deletedteams.item.channels.item.sharedwithteams.item.allowedmembers;
...
import microsoft.graph.teamwork.deletedteams.item.channels.item.sharedwithteams.item.allowedmembers.count.CountRequestBuilder;
