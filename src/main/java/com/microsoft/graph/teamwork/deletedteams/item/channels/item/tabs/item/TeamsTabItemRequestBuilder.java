package microsoft.graph.teamwork.deletedteams.item.channels.item.tabs.item;
...
import microsoft.graph.teamwork.deletedteams.item.channels.item.tabs.item.teamsapp.TeamsAppRequestBuilder;
