package microsoft.graph.teamwork.deletedteams.item.channels.item.tabs;
...
import microsoft.graph.teamwork.deletedteams.item.channels.item.tabs.count.CountRequestBuilder;
