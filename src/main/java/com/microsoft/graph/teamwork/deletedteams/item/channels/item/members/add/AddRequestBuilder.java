package microsoft.graph.teamwork.deletedteams.item.channels.item.members.add;
...
public class AddRequestBuilder {
    ...
    public AddRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/members/microsoft.graph.add";
