package microsoft.graph.teamwork.deletedteams.item.channels.item;
...
import microsoft.graph.teamwork.deletedteams.item.channels.item.completemigration.CompleteMigrationRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.filesfolder.FilesFolderRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.members.item.ConversationMemberItemRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.members.MembersRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.messages.item.ChatMessageItemRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.messages.MessagesRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.provisionemail.ProvisionEmailRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.removeemail.RemoveEmailRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.sharedwithteams.item.SharedWithChannelTeamInfoItemRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.sharedwithteams.SharedWithTeamsRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.tabs.item.TeamsTabItemRequestBuilder;
import microsoft.graph.teamwork.deletedteams.item.channels.item.tabs.TabsRequestBuilder;
...
public class ChannelItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.deletedTeams.item.channels.item.members.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.deletedTeams.item.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.deletedTeams.item.channels.item.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.deletedTeams.item.channels.item.tabs.item collection
     * @param id Unique identifier of the item
