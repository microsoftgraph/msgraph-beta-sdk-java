...
import com.microsoft.graph.teamwork.deletedteams.item.channels.item.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
...
public class ChannelItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamwork.deletedTeams.item.channels.item.members.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamwork.deletedTeams.item.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamwork.deletedTeams.item.channels.item.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamwork.deletedTeams.item.channels.item.tabs.item collection
     * @param id Unique identifier of the item
