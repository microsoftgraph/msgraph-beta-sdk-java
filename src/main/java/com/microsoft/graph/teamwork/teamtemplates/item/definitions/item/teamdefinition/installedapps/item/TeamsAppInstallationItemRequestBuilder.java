package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.installedapps.item;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.installedapps.item.upgrade.UpgradeRequestBuilder;
