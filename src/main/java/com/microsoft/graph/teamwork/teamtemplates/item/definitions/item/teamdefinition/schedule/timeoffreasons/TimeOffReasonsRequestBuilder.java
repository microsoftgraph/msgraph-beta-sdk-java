package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffreasons;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffreasons.count.CountRequestBuilder;
