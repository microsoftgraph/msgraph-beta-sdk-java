package com.microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timecards.item.startbreak;
...
public class StartBreakPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     * @return a startBreakPostRequestBody
     */
    @javax.annotation.Nonnull
    public static StartBreakPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
