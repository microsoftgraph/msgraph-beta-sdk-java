package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.schedulinggroups;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.schedulinggroups.count.CountRequestBuilder;
