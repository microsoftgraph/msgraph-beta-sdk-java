package com.microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.item.replies;

import com.microsoft.graph.models.ChatMessage;
import com.microsoft.graph.models.ChatMessageCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.item.replies.count.CountRequestBuilder;
import com.microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.item.replies.delta.DeltaRequestBuilder;
import com.microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.item.replies.item.ChatMessageItemRequestBuilder;
...
public class RepliesRequestBuilder extends BaseRequestBuilder {
    ...
    public RepliesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RepliesRequestBuilder and sets the default values.
    ...
    public RepliesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
