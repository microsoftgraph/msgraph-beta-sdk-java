package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.completemigration.CompleteMigrationRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.doesuserhaveaccesswithuseridwithtenantidwithuserprincipalname.DoesUserHaveAccessWithUserIdWithTenantIdWithUserPrincipalNameRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.filesfolder.FilesFolderRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.members.item.ConversationMemberItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.members.MembersRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.item.ChatMessageItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.messages.MessagesRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.provisionemail.ProvisionEmailRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.removeemail.RemoveEmailRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.sharedwithteams.item.SharedWithChannelTeamInfoItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.sharedwithteams.SharedWithTeamsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.tabs.item.TeamsTabItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.primarychannel.tabs.TabsRequestBuilder;
...
public class PrimaryChannelRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.members.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.sharedWithTeams.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.tabs.item collection
     * @param id Unique identifier of the item
