...
public class ChatMessageItemRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.primaryChannel.messages.item.replies.item.hostedContents.item collection
