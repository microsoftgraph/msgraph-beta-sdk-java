package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.offershiftrequests.item.OfferShiftRequestItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.offershiftrequests.OfferShiftRequestsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.openshiftchangerequests.item.OpenShiftChangeRequestItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.openshiftchangerequests.OpenShiftChangeRequestsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.openshifts.item.OpenShiftItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.openshifts.OpenShiftsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.schedulinggroups.item.SchedulingGroupItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.schedulinggroups.SchedulingGroupsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.share.ShareRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.shifts.item.ShiftItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.shifts.ShiftsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.swapshiftschangerequests.item.SwapShiftsChangeRequestItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.swapshiftschangerequests.SwapShiftsChangeRequestsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timecards.item.TimeCardItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timecards.TimeCardsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffreasons.item.TimeOffReasonItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffreasons.TimeOffReasonsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffrequests.item.TimeOffRequestItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timeoffrequests.TimeOffRequestsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timesoff.item.TimeOffItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.schedule.timesoff.TimesOffRequestBuilder;
...
public class ScheduleRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.offerShiftRequests.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.openShiftChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.openShifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.schedulingGroups.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.shifts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.swapShiftsChangeRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.timeCards.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.timeOffReasons.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.timeOffRequests.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.schedule.timesOff.item collection
     * @param id Unique identifier of the item
