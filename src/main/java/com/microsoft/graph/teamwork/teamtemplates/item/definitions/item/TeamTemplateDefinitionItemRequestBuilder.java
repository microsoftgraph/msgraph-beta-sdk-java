package microsoft.graph.teamwork.teamtemplates.item.definitions.item;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.TeamDefinitionRequestBuilder;
