package microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item;
...
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item.replies.RepliesRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.teamwork.teamtemplates.item.definitions.item.teamdefinition.channels.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.teamwork.teamTemplates.item.definitions.item.teamDefinition.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
