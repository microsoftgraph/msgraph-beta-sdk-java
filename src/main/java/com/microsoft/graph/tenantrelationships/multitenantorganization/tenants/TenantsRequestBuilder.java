...
public class TenantsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the tenants property of the microsoft.graph.multiTenantOrganization entity.
     * @param multiTenantOrganizationMemberId Unique identifier of the item
     * @return a MultiTenantOrganizationMemberItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public MultiTenantOrganizationMemberItemRequestBuilder byMultiTenantOrganizationMemberId(@javax.annotation.Nonnull final String multiTenantOrganizationMemberId) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationMemberCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<MultiTenantOrganizationMemberCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MultiTenantOrganizationMemberCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationMemberCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationMember> post(@javax.annotation.Nonnull final MultiTenantOrganizationMember body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationMember> post(@javax.annotation.Nonnull final MultiTenantOrganizationMember body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MultiTenantOrganizationMember body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MultiTenantOrganizationMember body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
