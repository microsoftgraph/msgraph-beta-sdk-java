...
public class DelegatedAdminRelationshipItemRequestBuilder {
     ...
     * @return a CompletableFuture of delegatedAdminRelationship
     */
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationship> patch(@javax.annotation.Nonnull final DelegatedAdminRelationship body, @javax.annotation.Nullable final java.util.function.Consumer<DelegatedAdminRelationshipItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of delegatedAdminRelationship
     */
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationship> patch(@javax.annotation.Nonnull final DelegatedAdminRelationship body, @javax.annotation.Nullable final java.util.function.Consumer<DelegatedAdminRelationshipItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
