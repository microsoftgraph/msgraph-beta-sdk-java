...
public class DelegatedAdminRelationshipsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminRelationship body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationship> post(@javax.annotation.Nonnull final DelegatedAdminRelationship body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminRelationship> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationship>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
