...
public class AccessAssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse>();
