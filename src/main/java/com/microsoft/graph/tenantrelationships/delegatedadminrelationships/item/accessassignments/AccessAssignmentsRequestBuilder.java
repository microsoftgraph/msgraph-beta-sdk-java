...
public class AccessAssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminAccessAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignment> post(@javax.annotation.Nonnull final DelegatedAdminAccessAssignment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignment> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminAccessAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
