...
public class DelegatedAdminRelationshipOperationItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperation> patch(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
