...
public class OperationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DelegatedAdminRelationshipOperation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DelegatedAdminRelationshipOperationCollectionResponse>();
