...
public class DelegatedAdminCustomerItemRequestBuilder {
     ...
     * @return a CompletableFuture of delegatedAdminCustomer
     */
    public java.util.concurrent.CompletableFuture<DelegatedAdminCustomer> patch(@javax.annotation.Nonnull final DelegatedAdminCustomer body, @javax.annotation.Nullable final java.util.function.Consumer<DelegatedAdminCustomerItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of delegatedAdminCustomer
     */
    public java.util.concurrent.CompletableFuture<DelegatedAdminCustomer> patch(@javax.annotation.Nonnull final DelegatedAdminCustomer body, @javax.annotation.Nullable final java.util.function.Consumer<DelegatedAdminCustomerItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
