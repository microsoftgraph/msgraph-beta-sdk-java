package com.microsoft.graph.tenantrelationships.managedtenants.managementactiontenantdeploymentstatuses.managedtenantschangedeploymentstatus;
 ...
 */
public class ManagedTenantsChangeDeploymentStatusRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ManagedTenantsChangeDeploymentStatusRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/managedTenants.changeDeploymentStatus", pathParameters);
    }
    /**
     * Instantiates a new ManagedTenantsChangeDeploymentStatusRequestBuilder and sets the default values.
    ...
    public ManagedTenantsChangeDeploymentStatusRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/managedTenants.changeDeploymentStatus", rawUrl);
    }
    /**
