...
public class MicrosoftGraphManagedTenantsAddUserInputLogRequestBuilder extends BaseRequestBuilder {
    ...
    public ManagedTenantAlert post(@jakarta.annotation.Nonnull final AddUserInputLogPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ManagedTenantAlert post(@jakarta.annotation.Nonnull final AddUserInputLogPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AddUserInputLogPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final AddUserInputLogPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MicrosoftGraphManagedTenantsAddUserInputLogRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public MicrosoftGraphManagedTenantsAddUserInputLogRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
