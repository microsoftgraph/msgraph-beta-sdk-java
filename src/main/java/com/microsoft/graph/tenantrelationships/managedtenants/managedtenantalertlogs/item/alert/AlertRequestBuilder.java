package com.microsoft.graph.tenantrelationships.managedtenants.managedtenantalertlogs.item.alert;
...
public class AlertRequestBuilder {
    ...
    public AlertRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlertLogs/{managedTenantAlertLog%2Did}/alert{?%24select,%24expand}";
