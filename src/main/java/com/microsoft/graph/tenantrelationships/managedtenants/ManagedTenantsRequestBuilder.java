...
public class ManagedTenantsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public AppPerformanceItemRequestBuilder appPerformances(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("appPerformance%2Did", id);
     ...
     */
    @javax.annotation.Nonnull
    public DeviceAppPerformanceItemRequestBuilder deviceAppPerformances(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("deviceAppPerformance%2Did", id);
     ...
     */
    @javax.annotation.Nonnull
    public DeviceHealthStatusItemRequestBuilder deviceHealthStatuses(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("deviceHealthStatus%2Did", id);
