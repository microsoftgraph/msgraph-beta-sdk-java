...
public class ManagedTenantsRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantAlertLogs.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantAlertRuleDefinitions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantAlertRules.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantAlerts.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantApiNotifications.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantEmailNotifications.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.tenantRelationships.managedTenants.managedTenantTicketingEndpoints.item collection
     * @param id Unique identifier of the item
