...
public class ApplyRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a applyRequestBody
     */
    @javax.annotation.Nonnull
    public static ApplyRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ApplyRequestBody currentObject = this;
