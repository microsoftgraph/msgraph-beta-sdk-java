package com.microsoft.graph.tenantrelationships.managedtenants.tenants.item.managedtenantsoffboardtenant;
 ...
 */
public class ManagedTenantsOffboardTenantRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ManagedTenantsOffboardTenantRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.offboardTenant", pathParameters);
    }
    /**
     * Instantiates a new ManagedTenantsOffboardTenantRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public ManagedTenantsOffboardTenantRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.offboardTenant", rawUrl);
    }
    /**
