...
public class MyRolesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MyRole body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MyRoleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MyRoleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MyRoleCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MyRole> post(@javax.annotation.Nonnull final MyRole body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MyRole> executionException = new java.util.concurrent.CompletableFuture<MyRole>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
