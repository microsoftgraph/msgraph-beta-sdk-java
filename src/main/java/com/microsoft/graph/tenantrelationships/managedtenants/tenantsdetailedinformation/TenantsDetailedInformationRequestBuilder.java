package microsoft.graph.tenantrelationships.managedtenants.tenantsdetailedinformation;
...
import microsoft.graph.models.managedtenants.TenantDetailedInformationCollectionResponse;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.tenantrelationships.managedtenants.tenantsdetailedinformation.count.CountRequestBuilder;
...
public class TenantsDetailedInformationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TenantDetailedInformationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantDetailedInformationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TenantDetailedInformationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TenantDetailedInformationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TenantsDetailedInformationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantDetailedInformationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of tenantDetailedInformation
     */
    public java.util.concurrent.CompletableFuture<TenantDetailedInformation> post(@javax.annotation.Nonnull final TenantDetailedInformation body, @javax.annotation.Nullable final java.util.function.Consumer<TenantsDetailedInformationRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
