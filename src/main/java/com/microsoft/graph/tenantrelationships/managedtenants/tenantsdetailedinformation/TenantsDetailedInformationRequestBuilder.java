...
public class TenantsDetailedInformationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TenantDetailedInformationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TenantDetailedInformationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TenantDetailedInformationCollectionResponse>();
