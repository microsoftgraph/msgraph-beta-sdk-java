...
import com.microsoft.graph.tenantrelationships.managedtenants.tenantgroups.managedtenantstenantsearch.ManagedTenantsTenantSearchRequestBuilder;
...
public class TenantGroupsRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public ManagedTenantsTenantSearchRequestBuilder managedTenantsTenantSearch() {
        return new ManagedTenantsTenantSearchRequestBuilder(pathParameters, requestAdapter);
    }
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/managedtenants-managedtenant-list-tenantgroups?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
