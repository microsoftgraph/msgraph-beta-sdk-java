...
public class UnassignTagRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unassignTagRequestBody
     */
    @javax.annotation.Nonnull
    public static UnassignTagRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnassignTagRequestBody currentObject = this;
