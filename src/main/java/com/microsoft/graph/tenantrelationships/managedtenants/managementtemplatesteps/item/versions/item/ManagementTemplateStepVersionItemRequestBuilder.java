...
public class ManagementTemplateStepVersionItemRequestBuilder {
     ...
     * @return a CompletableFuture of managementTemplateStepVersion
     */
    public java.util.concurrent.CompletableFuture<ManagementTemplateStepVersion> get(@javax.annotation.Nullable final java.util.function.Consumer<ManagementTemplateStepVersionItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
