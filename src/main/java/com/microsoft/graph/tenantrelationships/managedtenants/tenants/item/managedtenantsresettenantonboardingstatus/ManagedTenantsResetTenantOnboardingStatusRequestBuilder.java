package com.microsoft.graph.tenantrelationships.managedtenants.tenants.item.managedtenantsresettenantonboardingstatus;
 ...
 */
public class ManagedTenantsResetTenantOnboardingStatusRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ManagedTenantsResetTenantOnboardingStatusRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.resetTenantOnboardingStatus", pathParameters);
    }
    /**
     * Instantiates a new ManagedTenantsResetTenantOnboardingStatusRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public ManagedTenantsResetTenantOnboardingStatusRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.resetTenantOnboardingStatus", rawUrl);
    }
    /**
