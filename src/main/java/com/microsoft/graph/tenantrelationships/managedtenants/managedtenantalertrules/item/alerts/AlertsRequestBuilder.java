...
public class AlertsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ManagedTenantAlertCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AlertsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
