...
public class ManagementTemplateStepVersionItemRequestBuilder {
     ...
     * @return a CompletableFuture of managementTemplateStepVersion
     */
    public java.util.concurrent.CompletableFuture<ManagementTemplateStepVersion> patch(@javax.annotation.Nonnull final ManagementTemplateStepVersion body, @javax.annotation.Nullable final java.util.function.Consumer<ManagementTemplateStepVersionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
