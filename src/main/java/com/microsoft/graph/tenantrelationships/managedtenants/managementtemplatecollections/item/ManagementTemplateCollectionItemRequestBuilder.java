...
public class ManagementTemplateCollectionItemRequestBuilder {
     ...
     * @return a CompletableFuture of managementTemplateCollection
     */
    public java.util.concurrent.CompletableFuture<ManagementTemplateCollection> patch(@javax.annotation.Nonnull final ManagementTemplateCollection body, @javax.annotation.Nullable final java.util.function.Consumer<ManagementTemplateCollectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of managementTemplateCollection
     */
    public java.util.concurrent.CompletableFuture<ManagementTemplateCollection> patch(@javax.annotation.Nonnull final ManagementTemplateCollection body, @javax.annotation.Nullable final java.util.function.Consumer<ManagementTemplateCollectionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
