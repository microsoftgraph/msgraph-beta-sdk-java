package microsoft.graph.tenantrelationships.managedtenants.conditionalaccesspolicycoverages.item;
...
import microsoft.graph.models.managedtenants.ConditionalAccessPolicyCoverage;
...
public class ConditionalAccessPolicyCoverageItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<ConditionalAccessPolicyCoverageItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ConditionalAccessPolicyCoverage::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of conditionalAccessPolicyCoverage
     */
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage> get(@javax.annotation.Nullable final java.util.function.Consumer<ConditionalAccessPolicyCoverageItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ConditionalAccessPolicyCoverage::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body, @javax.annotation.Nullable final java.util.function.Consumer<ConditionalAccessPolicyCoverageItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body, @javax.annotation.Nullable final java.util.function.Consumer<ConditionalAccessPolicyCoverageItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
