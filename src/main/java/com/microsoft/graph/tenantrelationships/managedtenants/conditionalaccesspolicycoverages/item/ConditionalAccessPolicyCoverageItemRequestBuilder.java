...
public class ConditionalAccessPolicyCoverageItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
