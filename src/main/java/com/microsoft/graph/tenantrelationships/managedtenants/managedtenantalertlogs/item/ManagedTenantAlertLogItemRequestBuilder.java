...
public class ManagedTenantAlertLogItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ManagedTenantAlertLog body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagedTenantAlertLog> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ManagedTenantAlertLog> executionException = new java.util.concurrent.CompletableFuture<ManagedTenantAlertLog>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
