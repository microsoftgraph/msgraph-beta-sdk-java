...
public class EmailNotificationsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the emailNotifications property of the microsoft.graph.managedTenants.managedTenantAlert entity.
     * @param managedTenantEmailNotificationId Unique identifier of the item
     * @return a ManagedTenantEmailNotificationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ManagedTenantEmailNotificationItemRequestBuilder byManagedTenantEmailNotificationId(@javax.annotation.Nonnull final String managedTenantEmailNotificationId) {
    ...
    public java.util.concurrent.CompletableFuture<ManagedTenantEmailNotificationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ManagedTenantEmailNotificationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagedTenantEmailNotificationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ManagedTenantEmailNotificationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
