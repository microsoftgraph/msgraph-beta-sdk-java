...
public class WindowsProtectionStateItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new WindowsProtectionStateItemRequestBuilder and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WindowsProtectionStateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates/{windowsProtectionState%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new WindowsProtectionStateItemRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WindowsProtectionStateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates/{windowsProtectionState%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://learn.microsoft.com/graph/api/managedtenants-windowsprotectionstate-get?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     */
    @jakarta.annotation.Nonnull
    public WindowsProtectionStateItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
