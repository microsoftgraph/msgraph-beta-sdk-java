package com.microsoft.graph.tenantrelationships.managedtenants.managedtenantalertrules.item.alerts.item;
...
public class ManagedTenantAlertItemRequestBuilder {
    ...
    public ManagedTenantAlertItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlertRules/{managedTenantAlertRule%2Did}/alerts/{managedTenantAlert%2Did}{?%24select,%24expand}";
