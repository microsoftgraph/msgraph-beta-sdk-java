...
public class ConditionalAccessPolicyCoveragesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the conditionalAccessPolicyCoverages property of the microsoft.graph.managedTenants.managedTenant entity.
     * @param conditionalAccessPolicyCoverageId Unique identifier of the item
     * @return a ConditionalAccessPolicyCoverageItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ConditionalAccessPolicyCoverageItemRequestBuilder byConditionalAccessPolicyCoverageId(@javax.annotation.Nonnull final String conditionalAccessPolicyCoverageId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/managedtenants-managedtenant-list-conditionalaccesspolicycoverages?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverageCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverageCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverageCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConditionalAccessPolicyCoverage> post(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ConditionalAccessPolicyCoverage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
