...
import com.microsoft.graph.tenantrelationships.managedtenants.managedtenantalerts.item.managedtenantsadduserinputlog.ManagedTenantsAddUserInputLogRequestBuilder;
...
public class ManagedTenantAlertItemRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public ManagedTenantsAddUserInputLogRequestBuilder managedTenantsAddUserInputLog() {
        return new ManagedTenantsAddUserInputLogRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the alertLogs property of the microsoft.graph.managedTenants.managedTenantAlert entity.
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ManagedTenantAlert body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ManagedTenantAlert body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
