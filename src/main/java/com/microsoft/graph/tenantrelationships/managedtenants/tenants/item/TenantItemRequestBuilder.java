...
public class TenantItemRequestBuilder {
     ...
     * @return a CompletableFuture of tenant
     */
    public java.util.concurrent.CompletableFuture<Tenant> patch(@javax.annotation.Nonnull final Tenant body, @javax.annotation.Nullable final java.util.function.Consumer<TenantItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
