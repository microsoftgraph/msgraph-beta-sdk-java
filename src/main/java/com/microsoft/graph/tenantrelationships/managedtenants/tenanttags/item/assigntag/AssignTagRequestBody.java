...
public class AssignTagRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a assignTagRequestBody
     */
    @javax.annotation.Nonnull
    public static AssignTagRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AssignTagRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AssignTagRequestBody currentObject = this;
