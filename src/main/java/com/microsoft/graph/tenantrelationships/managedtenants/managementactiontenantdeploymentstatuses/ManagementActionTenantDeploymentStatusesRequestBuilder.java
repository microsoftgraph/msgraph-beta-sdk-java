...
public class ManagementActionTenantDeploymentStatusesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ManagementActionTenantDeploymentStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatusCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatusCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatus> post(@javax.annotation.Nonnull final ManagementActionTenantDeploymentStatus body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatus> executionException = new java.util.concurrent.CompletableFuture<ManagementActionTenantDeploymentStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
