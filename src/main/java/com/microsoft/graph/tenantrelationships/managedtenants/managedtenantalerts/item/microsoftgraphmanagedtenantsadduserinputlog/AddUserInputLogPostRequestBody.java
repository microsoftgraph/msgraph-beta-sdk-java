...
public class AddUserInputLogPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static AddUserInputLogPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("logInformation", (n) -> { this.setLogInformation(n.getStringValue()); });
    ...
    public String getLogInformation() {
        return this.backingStore.get("logInformation");
    }
    /**
     ...
     */
    public void setLogInformation(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("logInformation", value);
    }
}
