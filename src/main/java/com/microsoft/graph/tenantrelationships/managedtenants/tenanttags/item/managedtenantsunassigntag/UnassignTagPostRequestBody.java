...
public class UnassignTagPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unassignTagPostRequestBody
     */
    @javax.annotation.Nonnull
    public static UnassignTagPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
