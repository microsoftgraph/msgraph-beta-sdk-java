package com.microsoft.graph.tenantrelationships.managedtenants.tenants.item.microsoftgraphmanagedtenantsresettenantonboardingstatus;
 ...
 */
public class MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/microsoft.graph.managedTenants.resetTenantOnboardingStatus", pathParameters);
    }
    /**
     * Instantiates a new MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/managedtenants-tenant-resettenantonboardingstatus?view=graph-rest-1.0">Find more info here</a>
     */
