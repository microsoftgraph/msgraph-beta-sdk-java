package microsoft.graph.tenantrelationships.managedtenants.tenantscustomizedinformation;
...
import microsoft.graph.models.managedtenants.TenantCustomizedInformation;
import microsoft.graph.models.managedtenants.TenantCustomizedInformationCollectionResponse;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.tenantrelationships.managedtenants.tenantscustomizedinformation.count.CountRequestBuilder;
...
public class TenantsCustomizedInformationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantCustomizedInformationCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TenantCustomizedInformationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<TenantsCustomizedInformationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantCustomizedInformationCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformation> post(@javax.annotation.Nonnull final TenantCustomizedInformation body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantCustomizedInformation::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of tenantCustomizedInformation
     */
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformation> post(@javax.annotation.Nonnull final TenantCustomizedInformation body, @javax.annotation.Nullable final java.util.function.Consumer<TenantsCustomizedInformationRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, TenantCustomizedInformation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
