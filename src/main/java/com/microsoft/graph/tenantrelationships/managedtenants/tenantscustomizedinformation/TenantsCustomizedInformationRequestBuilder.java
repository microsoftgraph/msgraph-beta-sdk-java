...
public class TenantsCustomizedInformationRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the tenantsCustomizedInformation property of the microsoft.graph.managedTenants.managedTenant entity.
     * @param tenantCustomizedInformationId Unique identifier of the item
     * @return a TenantCustomizedInformationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public TenantCustomizedInformationItemRequestBuilder byTenantCustomizedInformationId(@javax.annotation.Nonnull final String tenantCustomizedInformationId) {
        Objects.requireNonNull(tenantCustomizedInformationId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("tenantCustomizedInformation%2Did", tenantCustomizedInformationId);
    ...
    public TenantsCustomizedInformationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenantsCustomizedInformation{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TenantsCustomizedInformationRequestBuilder and sets the default values.
    ...
    public TenantsCustomizedInformationRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenantsCustomizedInformation{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/managedtenants-managedtenant-list-tenantscustomizedinformation?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformation> post(@javax.annotation.Nonnull final TenantCustomizedInformation body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TenantCustomizedInformation> executionException = new java.util.concurrent.CompletableFuture<TenantCustomizedInformation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformation> post(@javax.annotation.Nonnull final TenantCustomizedInformation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final TenantCustomizedInformation body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final TenantCustomizedInformation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
