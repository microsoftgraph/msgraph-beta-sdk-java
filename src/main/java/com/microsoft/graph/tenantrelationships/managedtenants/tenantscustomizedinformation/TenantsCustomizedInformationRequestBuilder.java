...
public class TenantsCustomizedInformationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TenantCustomizedInformationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TenantCustomizedInformation> post(@javax.annotation.Nonnull final TenantCustomizedInformation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TenantCustomizedInformation> executionException = new java.util.concurrent.CompletableFuture<TenantCustomizedInformation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
