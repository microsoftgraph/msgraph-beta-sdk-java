...
public class DomainItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Domain body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Domain> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Domain> executionException = new java.util.concurrent.CompletableFuture<Domain>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
    ...
    public SharedEmailDomainInvitationItemRequestBuilder sharedEmailDomainInvitations(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("sharedEmailDomainInvitation%2Did", id);
