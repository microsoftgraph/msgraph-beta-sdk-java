...
public class FederationConfigurationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final InternalDomainFederation body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<InternalDomainFederationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<InternalDomainFederationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<InternalDomainFederationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<InternalDomainFederation> post(@javax.annotation.Nonnull final InternalDomainFederation body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<InternalDomainFederation> executionException = new java.util.concurrent.CompletableFuture<InternalDomainFederation>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
