package com.microsoft.graph.riskyusers.item.history;
...
import com.microsoft.graph.riskyusers.item.history.count.CountRequestBuilder;
...
public class HistoryRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> post(@javax.annotation.Nonnull final RiskyUserHistoryItem body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> executionException = new java.util.concurrent.CompletableFuture<RiskyUserHistoryItem>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> post(@javax.annotation.Nonnull final RiskyUserHistoryItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final RiskyUserHistoryItem body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final RiskyUserHistoryItem body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
