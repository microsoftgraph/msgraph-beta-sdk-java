...
public class HistoryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RiskyUserHistoryItemCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of RiskyUserHistoryItemCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<HistoryRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, RiskyUserHistoryItemCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> post(@javax.annotation.Nonnull final RiskyUserHistoryItem body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RiskyUserHistoryItem::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> post(@javax.annotation.Nonnull final RiskyUserHistoryItem body, @javax.annotation.Nullable final java.util.function.Consumer<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        ...
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, RiskyUserHistoryItem::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
