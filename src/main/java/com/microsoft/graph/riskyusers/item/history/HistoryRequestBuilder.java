...
public class HistoryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RiskyUserHistoryItemCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> post(@javax.annotation.Nonnull final RiskyUserHistoryItem body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskyUserHistoryItem> executionException = new java.util.concurrent.CompletableFuture<RiskyUserHistoryItem>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
