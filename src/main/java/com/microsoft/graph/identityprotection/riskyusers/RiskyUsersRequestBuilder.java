...
public class RiskyUsersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyUserCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskyUserCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RiskyUserCollectionResponse>();
