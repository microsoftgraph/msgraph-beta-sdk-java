...
public class IdentityProtectionRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityProtection.riskyServicePrincipals.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityProtection.servicePrincipalRiskDetections.item collection
     * @param id Unique identifier of the item
