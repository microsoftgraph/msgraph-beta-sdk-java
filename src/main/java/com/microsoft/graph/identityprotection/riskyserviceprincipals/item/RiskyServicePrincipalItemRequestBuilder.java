...
public class RiskyServicePrincipalItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final RiskyServicePrincipal body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RiskyServicePrincipal> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskyServicePrincipal> executionException = new java.util.concurrent.CompletableFuture<RiskyServicePrincipal>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
