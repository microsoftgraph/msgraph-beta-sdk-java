package microsoft.graph.identityprotection.riskyserviceprincipals.dismiss;
...
public class DismissRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(1) {{
            this.put("servicePrincipalIds", (n) -> { currentObject.setServicePrincipalIds(n.getCollectionOfPrimitiveValues(String.class)); });
        }};
    }
    /**
