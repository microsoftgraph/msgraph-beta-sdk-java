...
public class HistoryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyServicePrincipalHistoryItemCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<RiskyServicePrincipalHistoryItemCollectionResponse>() {{
    ...
    public java.util.concurrent.CompletableFuture<RiskyServicePrincipalHistoryItem> post(@javax.annotation.Nonnull final RiskyServicePrincipalHistoryItem body) {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<RiskyServicePrincipalHistoryItem>() {{
                this.completeExceptionally(ex);
            }};
        }
    }
