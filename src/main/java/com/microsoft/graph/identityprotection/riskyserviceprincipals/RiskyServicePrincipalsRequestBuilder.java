...
public class RiskyServicePrincipalsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RiskyServicePrincipalCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskyServicePrincipalCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RiskyServicePrincipalCollectionResponse>();
