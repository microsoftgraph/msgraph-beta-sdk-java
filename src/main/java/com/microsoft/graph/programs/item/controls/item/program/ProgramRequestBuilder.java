...
public class ProgramRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Program body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Program> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Program> executionException = new java.util.concurrent.CompletableFuture<Program>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
