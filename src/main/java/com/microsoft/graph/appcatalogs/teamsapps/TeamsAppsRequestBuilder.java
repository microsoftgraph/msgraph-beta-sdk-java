...
public class TeamsAppsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TeamsAppCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamsAppCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TeamsAppCollectionResponse>();
