...
public class OutlineIconRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TeamsAppIcon body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TeamsAppIcon> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TeamsAppIcon> executionException = new java.util.concurrent.CompletableFuture<TeamsAppIcon>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
