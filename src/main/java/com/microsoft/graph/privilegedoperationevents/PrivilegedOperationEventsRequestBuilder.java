...
public class PrivilegedOperationEventsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedOperationEventCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrivilegedOperationEventCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrivilegedOperationEventCollectionResponse>();
