package microsoft.graph.privilegedapproval.item.roleinfo.assignments;
...
import microsoft.graph.privilegedapproval.item.roleinfo.assignments.count.CountRequestBuilder;
