package com.microsoft.graph.privilegedapproval.item.roleinfo.assignments.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/$count{?%24search,%24filter}";
