...
public class TrustFrameworkRequestBuilder {
     ...
     * @return a CompletableFuture of TrustFramework
     */
    public java.util.concurrent.CompletableFuture<TrustFramework> patch(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of TrustFramework
     */
    public java.util.concurrent.CompletableFuture<TrustFramework> patch(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
