...
public class TrustFrameworkRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TrustFramework body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final TrustFrameworkRequestBuilderPatchRequestConfiguration requestConfig = new TrustFrameworkRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<TrustFramework> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrustFramework::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TrustFramework
     */
    public java.util.concurrent.CompletableFuture<TrustFramework> get(@javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of TrustFramework
     */
    public java.util.concurrent.CompletableFuture<TrustFramework> get(@javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrustFramework::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final TrustFramework body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<TrustFrameworkRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
    ...
    public class TrustFrameworkRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public TrustFrameworkRequestBuilderGetQueryParameters queryParameters = new TrustFrameworkRequestBuilderGetQueryParameters();
        /**
