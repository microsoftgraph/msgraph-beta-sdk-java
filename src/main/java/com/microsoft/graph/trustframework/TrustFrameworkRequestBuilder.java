...
public class TrustFrameworkRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TrustFramework body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TrustFramework> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TrustFramework> executionException = new java.util.concurrent.CompletableFuture<TrustFramework>();
