...
public class UploadPkcs12RequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TrustFrameworkKey> post(@jakarta.annotation.Nonnull final UploadPkcs12PostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TrustFrameworkKey> executionException = new java.util.concurrent.CompletableFuture<TrustFrameworkKey>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TrustFrameworkKey> post(@jakarta.annotation.Nonnull final UploadPkcs12PostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UploadPkcs12PostRequestBody body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UploadPkcs12PostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
