...
public class GenerateKeyRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a generateKeyRequestBody
     */
    @javax.annotation.Nonnull
    public static GenerateKeyRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GenerateKeyRequestBody currentObject = this;
