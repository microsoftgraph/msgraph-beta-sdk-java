...
public class KeySetsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySetCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TrustFrameworkKeySetCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TrustFrameworkKeySetCollectionResponse>();
