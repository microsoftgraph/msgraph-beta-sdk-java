package microsoft.graph.trustframework.keysets;
...
import microsoft.graph.models.TrustFrameworkKeySetCollectionResponse;
import microsoft.graph.trustframework.keysets.count.CountRequestBuilder;
...
public class KeySetsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySetCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrustFrameworkKeySetCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of TrustFrameworkKeySetCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySetCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<KeySetsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, TrustFrameworkKeySetCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of trustFrameworkKeySet
     */
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> post(@javax.annotation.Nonnull final TrustFrameworkKeySet body, @javax.annotation.Nullable final java.util.function.Consumer<KeySetsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
