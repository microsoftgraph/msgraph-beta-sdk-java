...
public class KeySetsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the keySets property of the microsoft.graph.trustFramework entity.
     * @param trustFrameworkKeySetId Unique identifier of the item
     * @return a TrustFrameworkKeySetItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public TrustFrameworkKeySetItemRequestBuilder byTrustFrameworkKeySetId(@javax.annotation.Nonnull final String trustFrameworkKeySetId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final TrustFrameworkKeySet body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final TrustFrameworkKeySet body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
