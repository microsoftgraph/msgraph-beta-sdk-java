 ...
 */
public class TrustFrameworkKeySetItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public TrustFrameworkKeySetItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TrustFrameworkKeySetItemRequestBuilder and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public TrustFrameworkKeySetItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> executionException = new java.util.concurrent.CompletableFuture<TrustFrameworkKeySet>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> patch(@jakarta.annotation.Nonnull final TrustFrameworkKeySet body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TrustFrameworkKeySet> patch(@jakarta.annotation.Nonnull final TrustFrameworkKeySet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TrustFrameworkKeySet body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final TrustFrameworkKeySet body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
