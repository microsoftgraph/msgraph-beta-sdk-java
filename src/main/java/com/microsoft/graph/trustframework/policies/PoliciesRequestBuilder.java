...
public class PoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TrustFrameworkPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TrustFrameworkPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TrustFrameworkPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TrustFrameworkPolicyCollectionResponse>();
