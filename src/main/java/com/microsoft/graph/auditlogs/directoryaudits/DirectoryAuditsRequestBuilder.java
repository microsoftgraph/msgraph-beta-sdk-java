...
public class DirectoryAuditsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DirectoryAuditCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DirectoryAuditCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DirectoryAuditCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DirectoryAuditCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DirectoryAuditsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DirectoryAuditCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of directoryAudit
     */
    public java.util.concurrent.CompletableFuture<DirectoryAudit> post(@javax.annotation.Nonnull final DirectoryAudit body, @javax.annotation.Nullable final java.util.function.Consumer<DirectoryAuditsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
