...
public class ConfirmSafeRequestBody implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private Map<String, Object> _additionalData;
    /** The requestIds property  */
    private java.util.List<String> _requestIds;
    /**
     * Instantiates a new confirmSafeRequestBody and sets the default values.
     * @return a void
     */
    public ConfirmSafeRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a confirmSafeRequestBody
     */
    @javax.annotation.Nonnull
    public static ConfirmSafeRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ConfirmSafeRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ConfirmSafeRequestBody currentObject = this;
