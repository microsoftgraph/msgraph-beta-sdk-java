...
public class RiskDetectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RiskDetection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RiskDetectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskDetectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RiskDetectionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<RiskDetection> post(@javax.annotation.Nonnull final RiskDetection body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RiskDetection> executionException = new java.util.concurrent.CompletableFuture<RiskDetection>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
