...
import microsoft.graph.chats.item.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.chats.item.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
