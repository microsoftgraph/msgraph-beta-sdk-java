...
import microsoft.graph.chats.item.hideforuser.HideForUserRequestBuilder;
...
import microsoft.graph.chats.item.lastmessagepreview.LastMessagePreviewRequestBuilder;
import microsoft.graph.chats.item.markchatreadforuser.MarkChatReadForUserRequestBuilder;
import microsoft.graph.chats.item.markchatunreadforuser.MarkChatUnreadForUserRequestBuilder;
...
import microsoft.graph.chats.item.operations.item.TeamsAsyncOperationItemRequestBuilder;
import microsoft.graph.chats.item.operations.OperationsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.PermissionGrantsRequestBuilder;
import microsoft.graph.chats.item.pinnedmessages.item.PinnedChatMessageInfoItemRequestBuilder;
import microsoft.graph.chats.item.pinnedmessages.PinnedMessagesRequestBuilder;
...
import microsoft.graph.chats.item.unhideforuser.UnhideForUserRequestBuilder;
