...
import microsoft.graph.chats.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.chats.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
