...
public class MarkChatReadForUserRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a markChatReadForUserRequestBody
     */
    @javax.annotation.Nonnull
    public static MarkChatReadForUserRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MarkChatReadForUserRequestBody currentObject = this;
