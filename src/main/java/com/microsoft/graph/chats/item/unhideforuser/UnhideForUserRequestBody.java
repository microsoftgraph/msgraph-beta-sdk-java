...
public class UnhideForUserRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a unhideForUserRequestBody
     */
    @javax.annotation.Nonnull
    public static UnhideForUserRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UnhideForUserRequestBody currentObject = this;
