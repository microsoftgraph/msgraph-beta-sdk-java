package microsoft.graph.chats.item.permissiongrants.item;
...
import microsoft.graph.chats.item.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.item.restore.RestoreRequestBuilder;
