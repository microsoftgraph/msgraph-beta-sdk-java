package microsoft.graph.chats.item.permissiongrants;
...
import microsoft.graph.chats.item.permissiongrants.count.CountRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.getbyids.GetByIdsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import microsoft.graph.chats.item.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
