package com.microsoft.graph.groups.item.drives.item.root.subscriptions.item.reauthorize;
...
public class ReauthorizeRequestBuilder {
    ...
    public ReauthorizeRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
