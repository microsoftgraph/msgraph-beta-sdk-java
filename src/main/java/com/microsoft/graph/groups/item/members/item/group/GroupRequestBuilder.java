package microsoft.graph.groups.item.members.item.group;
...
import microsoft.graph.groups.item.members.item.group.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
