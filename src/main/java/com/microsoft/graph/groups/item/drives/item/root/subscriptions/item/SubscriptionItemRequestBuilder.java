package com.microsoft.graph.groups.item.drives.item.root.subscriptions.item;

import com.microsoft.graph.groups.item.drives.item.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
