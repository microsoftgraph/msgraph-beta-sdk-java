package com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.lastmodifiedbyuser;

import com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
