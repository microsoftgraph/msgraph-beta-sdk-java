package microsoft.graph.groups.item.team.permissiongrants.item;
...
import microsoft.graph.groups.item.team.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.item.restore.RestoreRequestBuilder;
...
public class ResourceSpecificPermissionGrantItemRequestBuilder {
    ...
    public ResourceSpecificPermissionGrantItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}";
