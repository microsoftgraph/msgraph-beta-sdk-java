...
import microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.groups.item.team.primarychannel.messages.item.replies.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
