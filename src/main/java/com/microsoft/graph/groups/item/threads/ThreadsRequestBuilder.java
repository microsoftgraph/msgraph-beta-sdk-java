...
public class ThreadsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ConversationThread body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ConversationThreadCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConversationThreadCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConversationThreadCollectionResponse>();
