...
import com.microsoft.graph.groups.item.endpoints.EndpointsRequestBuilder;
import com.microsoft.graph.groups.item.endpoints.item.EndpointItemRequestBuilder;
import com.microsoft.graph.groups.item.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
...
public class GroupItemRequestBuilder {
    ...
    public GroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}{?%24select}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.endpoints.item collection
     * @param id Unique identifier of the item
