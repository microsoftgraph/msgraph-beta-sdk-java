...
import microsoft.graph.groups.item.endpoints.EndpointsRequestBuilder;
import microsoft.graph.groups.item.endpoints.item.EndpointItemRequestBuilder;
import microsoft.graph.groups.item.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
...
import microsoft.graph.groups.item.settings.item.DirectorySettingItemRequestBuilder;
...
public class GroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.endpoints.item collection
     * @param id Unique identifier of the item
