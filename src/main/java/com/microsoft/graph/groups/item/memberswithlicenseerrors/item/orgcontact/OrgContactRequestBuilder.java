package com.microsoft.graph.groups.item.memberswithlicenseerrors.item.orgcontact;
...
public class OrgContactRequestBuilder {
    ...
    public OrgContactRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}";
