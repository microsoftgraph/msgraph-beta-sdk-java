package com.microsoft.graph.groups.item.threads.item.posts.item.mentions.item;
...
public class MentionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MentionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/mentions/{mention%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MentionItemRequestBuilder and sets the default values.
    ...
    public MentionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/mentions/{mention%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
