...
import microsoft.graph.groups.item.drives.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.groups.item.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
