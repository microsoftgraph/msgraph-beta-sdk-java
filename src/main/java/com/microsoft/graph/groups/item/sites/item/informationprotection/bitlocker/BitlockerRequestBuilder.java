package com.microsoft.graph.groups.item.sites.item.informationprotection.bitlocker;
...
import com.microsoft.graph.groups.item.sites.item.informationprotection.bitlocker.recoverykeys.RecoveryKeysRequestBuilder;
...
public class BitlockerRequestBuilder extends BaseRequestBuilder {
    ...
    public BitlockerRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/bitlocker{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new BitlockerRequestBuilder and sets the default values.
    ...
    public BitlockerRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/bitlocker{?%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<Bitlocker> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<Bitlocker> executionException = new java.util.concurrent.CompletableFuture<Bitlocker>();
