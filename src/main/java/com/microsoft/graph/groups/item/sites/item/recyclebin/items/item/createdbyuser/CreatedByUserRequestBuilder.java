package com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.createdbyuser;

import com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
