package com.microsoft.graph.groups.item.onenote.sectiongroups.item.sections;

import com.microsoft.graph.groups.item.onenote.sectiongroups.item.sections.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.onenote.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
