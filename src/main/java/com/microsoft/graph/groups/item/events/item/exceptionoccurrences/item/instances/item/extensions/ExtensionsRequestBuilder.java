package com.microsoft.graph.groups.item.events.item.exceptionoccurrences.item.instances.item.extensions;

import com.microsoft.graph.groups.item.events.item.exceptionoccurrences.item.instances.item.extensions.count.CountRequestBuilder;
