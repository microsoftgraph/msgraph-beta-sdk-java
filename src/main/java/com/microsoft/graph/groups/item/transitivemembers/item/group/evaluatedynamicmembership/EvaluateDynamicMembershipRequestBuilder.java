package microsoft.graph.groups.item.transitivemembers.item.group.evaluatedynamicmembership;
...
public class EvaluateDynamicMembershipRequestBuilder {
    ...
    public EvaluateDynamicMembershipRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.evaluateDynamicMembership";
