package com.microsoft.graph.groups.item.sites.item.recyclebin.items;

import com.microsoft.graph.groups.item.sites.item.recyclebin.items.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.recyclebin.items.item.RecycleBinItemItemRequestBuilder;
...
public class ItemsRequestBuilder extends BaseRequestBuilder {
    ...
    public ItemsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ItemsRequestBuilder and sets the default values.
    ...
    public ItemsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get a list of recycleBinItems under the specified site. This API is available in the following national cloud deployments.
     * @return a CompletableFuture of RecycleBinItemCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/recyclebin-list-items?view=graph-rest-1.0">Find more info here</a>
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RecycleBinItemCollectionResponse> get() {
        return get(null);
    }
    /**
     * Get a list of recycleBinItems under the specified site. This API is available in the following national cloud deployments.
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RecycleBinItemCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, RecycleBinItemCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Create new navigation property to items for groups
     * @param body The request body
     * @return a CompletableFuture of RecycleBinItem
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RecycleBinItem> post(@jakarta.annotation.Nonnull final RecycleBinItem body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RecycleBinItem> post(@jakarta.annotation.Nonnull final RecycleBinItem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, RecycleBinItem::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of recycleBinItems under the specified site. This API is available in the following national cloud deployments.
