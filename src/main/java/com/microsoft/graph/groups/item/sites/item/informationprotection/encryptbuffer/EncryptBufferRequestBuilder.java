...
public class EncryptBufferRequestBuilder extends BaseRequestBuilder {
    ...
    @Deprecated
    public BufferEncryptionResult post(@jakarta.annotation.Nonnull final EncryptBufferPostRequestBody body) {
    ...
    @jakarta.annotation.Nullable
    @Deprecated
    public BufferEncryptionResult post(@jakarta.annotation.Nonnull final EncryptBufferPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, BufferEncryptionResult::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action encryptBuffer
     * @param body The request body
