package microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties;
...
import microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties.count.CountRequestBuilder;
