...
import microsoft.graph.groups.item.team.channels.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.groups.item.team.channels.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
