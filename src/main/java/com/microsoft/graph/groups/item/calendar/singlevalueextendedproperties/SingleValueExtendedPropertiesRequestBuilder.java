package com.microsoft.graph.groups.item.calendar.singlevalueextendedproperties;

import com.microsoft.graph.groups.item.calendar.singlevalueextendedproperties.count.CountRequestBuilder;
