package com.microsoft.graph.groups.item.sites.item.contenttypes.item.columnlinks;

import com.microsoft.graph.groups.item.sites.item.contenttypes.item.columnlinks.count.CountRequestBuilder;
