package microsoft.graph.groups.item.sites.item.lists.item.items.item.activities.item.driveitem;
...
import microsoft.graph.groups.item.sites.item.lists.item.items.item.activities.item.driveitem.content.ContentRequestBuilder;
