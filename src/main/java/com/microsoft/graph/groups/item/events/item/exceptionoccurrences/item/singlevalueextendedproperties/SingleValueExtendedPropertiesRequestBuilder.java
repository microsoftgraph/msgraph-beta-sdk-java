package microsoft.graph.groups.item.events.item.exceptionoccurrences.item.singlevalueextendedproperties;
...
import microsoft.graph.groups.item.events.item.exceptionoccurrences.item.singlevalueextendedproperties.count.CountRequestBuilder;
