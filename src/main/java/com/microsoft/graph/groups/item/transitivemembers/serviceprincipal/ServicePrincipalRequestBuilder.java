package com.microsoft.graph.groups.item.transitivemembers.serviceprincipal;

import com.microsoft.graph.groups.item.transitivemembers.serviceprincipal.count.CountRequestBuilder;
