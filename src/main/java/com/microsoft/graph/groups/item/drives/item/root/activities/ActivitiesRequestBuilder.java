package microsoft.graph.groups.item.drives.item.root.activities;
...
import microsoft.graph.groups.item.drives.item.root.activities.count.CountRequestBuilder;
