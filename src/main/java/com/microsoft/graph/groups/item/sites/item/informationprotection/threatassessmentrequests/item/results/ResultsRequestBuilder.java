package com.microsoft.graph.groups.item.sites.item.informationprotection.threatassessmentrequests.item.results;

import com.microsoft.graph.groups.item.sites.item.informationprotection.threatassessmentrequests.item.results.count.CountRequestBuilder;
