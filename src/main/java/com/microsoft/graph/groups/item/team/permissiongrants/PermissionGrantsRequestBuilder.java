package microsoft.graph.groups.item.team.permissiongrants;
...
import microsoft.graph.groups.item.team.permissiongrants.count.CountRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.getbyids.GetByIdsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
