...
import com.microsoft.graph.groups.item.team.permissiongrants.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.team.permissiongrants.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.groups.item.team.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.groups.item.team.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
...
public class PermissionGrantsRequestBuilder {
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
