package com.microsoft.graph.groups.item.transitivememberof.device;

import com.microsoft.graph.groups.item.transitivememberof.device.count.CountRequestBuilder;
