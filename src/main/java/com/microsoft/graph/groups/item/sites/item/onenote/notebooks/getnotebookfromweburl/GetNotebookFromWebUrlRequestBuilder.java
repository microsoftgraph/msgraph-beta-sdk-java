package com.microsoft.graph.groups.item.sites.item.onenote.notebooks.getnotebookfromweburl;
...
public class GetNotebookFromWebUrlRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetNotebookFromWebUrlPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetNotebookFromWebUrlPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CopyNotebookModel> post(@javax.annotation.Nonnull final GetNotebookFromWebUrlPostRequestBody body) {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<CopyNotebookModel>() {{
