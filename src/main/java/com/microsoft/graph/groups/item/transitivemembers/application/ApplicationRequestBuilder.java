package com.microsoft.graph.groups.item.transitivemembers.application;

import com.microsoft.graph.groups.item.transitivemembers.application.count.CountRequestBuilder;
