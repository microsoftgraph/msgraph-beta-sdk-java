package com.microsoft.graph.groups.item.events.item.singlevalueextendedproperties;

import com.microsoft.graph.groups.item.events.item.singlevalueextendedproperties.count.CountRequestBuilder;
