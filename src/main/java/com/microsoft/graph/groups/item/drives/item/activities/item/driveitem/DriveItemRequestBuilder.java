package microsoft.graph.groups.item.drives.item.activities.item.driveitem;
...
import microsoft.graph.groups.item.drives.item.activities.item.driveitem.content.ContentRequestBuilder;
