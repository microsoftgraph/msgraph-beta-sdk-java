...
import microsoft.graph.groups.item.drives.item.items.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.groups.item.drives.item.items.item.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.drives.item.items.item.listItem.activities.item collection
