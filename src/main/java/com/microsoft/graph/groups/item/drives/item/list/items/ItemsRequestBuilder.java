...
import com.microsoft.graph.groups.item.drives.item.list.items.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.list.items.deltawithtoken.DeltaWithTokenRequestBuilder;
