package com.microsoft.graph.groups.item.drives.item.list.items.item.versions.item;

import com.microsoft.graph.groups.item.drives.item.list.items.item.versions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.list.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
