...
import com.microsoft.graph.groups.item.sites.item.pages.item.canvaslayout.horizontalsections.item.HorizontalSectionItemRequestBuilder;
...
public class CanvasLayoutRequestBuilder {
    ...
    public CanvasLayoutRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public HorizontalSectionItemRequestBuilder horizontalSections(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("horizontalSection%2Did", id);
