...
import microsoft.graph.groups.item.threads.item.posts.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.groups.item.threads.item.posts.item.mentions.MentionsRequestBuilder;
