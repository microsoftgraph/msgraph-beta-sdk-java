...
public class RenewGroupRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of RenewGroupPostResponse
    ...
    public java.util.concurrent.CompletableFuture<RenewGroupPostResponse> post(@jakarta.annotation.Nonnull final RenewGroupPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<RenewGroupPostResponse> post(@jakarta.annotation.Nonnull final RenewGroupPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, RenewGroupPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Renew a group's expiration. When a group is renewed, the group expiration is extended by the number of days defined in the policy. This API is supported in the following national cloud deployments.
     * @param body The request body
