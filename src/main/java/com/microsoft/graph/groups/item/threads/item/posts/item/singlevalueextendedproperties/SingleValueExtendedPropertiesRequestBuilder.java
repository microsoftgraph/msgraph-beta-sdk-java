package com.microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties;

import com.microsoft.graph.groups.item.threads.item.posts.item.singlevalueextendedproperties.count.CountRequestBuilder;
