package com.microsoft.graph.groups.item.onenote.sectiongroups.item;

import com.microsoft.graph.groups.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.groups.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import com.microsoft.graph.groups.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import com.microsoft.graph.groups.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder extends BaseRequestBuilder {
    ...
    public SectionGroupItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SectionGroupItemRequestBuilder and sets the default values.
    ...
    public SectionGroupItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
