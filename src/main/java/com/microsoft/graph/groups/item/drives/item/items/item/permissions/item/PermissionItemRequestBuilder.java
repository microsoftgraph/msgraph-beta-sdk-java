package com.microsoft.graph.groups.item.drives.item.items.item.permissions.item;

import com.microsoft.graph.groups.item.drives.item.items.item.permissions.item.grant.GrantRequestBuilder;
import com.microsoft.graph.groups.item.drives.item.items.item.permissions.item.revokegrants.RevokeGrantsRequestBuilder;
