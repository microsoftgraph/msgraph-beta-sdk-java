package com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item;

import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.termstore.groups.item.sets.item.relations.item.toterm.ToTermRequestBuilder;
