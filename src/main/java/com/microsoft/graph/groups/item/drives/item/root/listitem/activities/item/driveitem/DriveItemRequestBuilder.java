package microsoft.graph.groups.item.drives.item.root.listitem.activities.item.driveitem;
...
import microsoft.graph.groups.item.drives.item.root.listitem.activities.item.driveitem.content.ContentRequestBuilder;
