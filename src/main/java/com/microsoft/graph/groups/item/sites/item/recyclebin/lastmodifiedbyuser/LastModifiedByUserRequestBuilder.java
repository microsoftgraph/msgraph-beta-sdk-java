package com.microsoft.graph.groups.item.sites.item.recyclebin.lastmodifiedbyuser;

import com.microsoft.graph.groups.item.sites.item.recyclebin.lastmodifiedbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.recyclebin.lastmodifiedbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
