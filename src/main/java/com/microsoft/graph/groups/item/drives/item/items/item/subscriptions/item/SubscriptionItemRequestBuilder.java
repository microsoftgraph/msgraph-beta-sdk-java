package com.microsoft.graph.groups.item.drives.item.items.item.subscriptions.item;

import com.microsoft.graph.groups.item.drives.item.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
