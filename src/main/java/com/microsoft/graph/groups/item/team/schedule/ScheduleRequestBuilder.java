...
import microsoft.graph.groups.item.team.schedule.timecards.item.TimeCardItemRequestBuilder;
import microsoft.graph.groups.item.team.schedule.timecards.TimeCardsRequestBuilder;
...
public class ScheduleRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.team.schedule.timeCards.item collection
     * @param id Unique identifier of the item
