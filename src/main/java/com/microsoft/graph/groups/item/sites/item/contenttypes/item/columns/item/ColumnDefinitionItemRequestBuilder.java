package com.microsoft.graph.groups.item.sites.item.contenttypes.item.columns.item;

import com.microsoft.graph.groups.item.sites.item.contenttypes.item.columns.item.sourcecolumn.SourceColumnRequestBuilder;
...
public class ColumnDefinitionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ColumnDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ColumnDefinitionItemRequestBuilder and sets the default values.
    ...
    public ColumnDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
