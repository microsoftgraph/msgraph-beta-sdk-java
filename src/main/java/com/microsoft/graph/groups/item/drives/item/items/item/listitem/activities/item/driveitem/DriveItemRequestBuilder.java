package microsoft.graph.groups.item.drives.item.items.item.listitem.activities.item.driveitem;
...
import microsoft.graph.groups.item.drives.item.items.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
