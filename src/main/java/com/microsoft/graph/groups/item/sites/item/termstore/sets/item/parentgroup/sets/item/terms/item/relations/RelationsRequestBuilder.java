package com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.relations;

import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.relations.count.CountRequestBuilder;
