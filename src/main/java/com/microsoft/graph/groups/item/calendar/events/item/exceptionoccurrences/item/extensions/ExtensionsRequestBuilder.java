package microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.groups.item.calendar.events.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
