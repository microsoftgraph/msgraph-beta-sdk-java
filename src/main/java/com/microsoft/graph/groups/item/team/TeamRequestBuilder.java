...
import com.microsoft.graph.groups.item.team.owners.OwnersRequestBuilder;
...
public class TeamRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.owners.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.groups.item.team.permissionGrants.item collection
     * @param id Unique identifier of the item
