...
import microsoft.graph.groups.item.team.owners.item.UserItemRequestBuilder;
import microsoft.graph.groups.item.team.owners.OwnersRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import microsoft.graph.groups.item.team.permissiongrants.PermissionGrantsRequestBuilder;
...
import microsoft.graph.groups.item.team.tags.item.TeamworkTagItemRequestBuilder;
import microsoft.graph.groups.item.team.tags.TagsRequestBuilder;
