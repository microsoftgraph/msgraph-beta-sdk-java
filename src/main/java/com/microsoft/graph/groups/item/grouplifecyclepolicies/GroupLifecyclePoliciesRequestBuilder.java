...
public class GroupLifecyclePoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GroupLifecyclePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GroupLifecyclePolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupLifecyclePolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<GroupLifecyclePolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<GroupLifecyclePolicy> post(@javax.annotation.Nonnull final GroupLifecyclePolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupLifecyclePolicy> executionException = new java.util.concurrent.CompletableFuture<GroupLifecyclePolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
