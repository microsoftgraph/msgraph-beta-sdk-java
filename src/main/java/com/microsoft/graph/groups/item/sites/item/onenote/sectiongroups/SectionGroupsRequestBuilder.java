package com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups;

import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.onenote.sectiongroups.item.SectionGroupItemRequestBuilder;
...
public class SectionGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public SectionGroupsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SectionGroupsRequestBuilder and sets the default values.
