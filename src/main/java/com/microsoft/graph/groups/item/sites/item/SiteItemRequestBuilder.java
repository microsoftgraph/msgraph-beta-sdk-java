...
import microsoft.graph.groups.item.sites.item.pages.item.SitePageItemRequestBuilder;
import microsoft.graph.groups.item.sites.item.pages.PagesRequestBuilder;
...
public class SiteItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.groups.item.sites.item.pages.item collection
     * @param id Unique identifier of the item
     * @return a SitePageItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public SitePageItemRequestBuilder pages(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("sitePage%2Did", id);
