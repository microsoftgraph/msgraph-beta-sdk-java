package com.microsoft.graph.groups.item.sites.item.recyclebin.createdbyuser;

import com.microsoft.graph.groups.item.sites.item.recyclebin.createdbyuser.mailboxsettings.MailboxSettingsRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.recyclebin.createdbyuser.serviceprovisioningerrors.ServiceProvisioningErrorsRequestBuilder;
