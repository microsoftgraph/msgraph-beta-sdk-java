package com.microsoft.graph.groups.item.events.item.exceptionoccurrences;

import com.microsoft.graph.groups.item.events.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.events.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.groups.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder;
