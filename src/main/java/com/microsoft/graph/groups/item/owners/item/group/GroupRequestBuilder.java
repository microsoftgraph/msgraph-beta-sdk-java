package microsoft.graph.groups.item.owners.item.group;
...
import microsoft.graph.groups.item.owners.item.group.addfavorite.AddFavoriteRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.checkgrantedpermissionsforapp.CheckGrantedPermissionsForAppRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.removefavorite.RemoveFavoriteRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.renew.RenewRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.resetunseencount.ResetUnseenCountRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.restore.RestoreRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.subscribebymail.SubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.unsubscribebymail.UnsubscribeByMailRequestBuilder;
import microsoft.graph.groups.item.owners.item.group.validateproperties.ValidatePropertiesRequestBuilder;
