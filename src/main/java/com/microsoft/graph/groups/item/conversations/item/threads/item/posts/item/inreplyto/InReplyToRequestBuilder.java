...
public class InReplyToRequestBuilder {
     ...
     * @return a CompletableFuture of post
     */
    public java.util.concurrent.CompletableFuture<Post> patch(@javax.annotation.Nonnull final Post body, @javax.annotation.Nullable final java.util.function.Consumer<InReplyToRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of post
     */
    public java.util.concurrent.CompletableFuture<Post> patch(@javax.annotation.Nonnull final Post body, @javax.annotation.Nullable final java.util.function.Consumer<InReplyToRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
