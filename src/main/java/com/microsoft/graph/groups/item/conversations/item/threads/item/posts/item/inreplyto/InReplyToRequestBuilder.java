package microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto;
...
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.attachments.AttachmentsRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.extensions.ExtensionsRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.forward.ForwardRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.mentions.MentionsRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.reply.ReplyRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.groups.item.conversations.item.threads.item.posts.item.inreplyto.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
