package com.microsoft.graph.groups.item.sites.item.contenttypes;

import com.microsoft.graph.groups.item.sites.item.contenttypes.addcopy.AddCopyRequestBuilder;
