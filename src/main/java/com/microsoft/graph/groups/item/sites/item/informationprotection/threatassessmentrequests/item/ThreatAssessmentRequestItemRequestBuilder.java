package com.microsoft.graph.groups.item.sites.item.informationprotection.threatassessmentrequests.item;

import com.microsoft.graph.groups.item.sites.item.informationprotection.threatassessmentrequests.item.results.item.ThreatAssessmentResultItemRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.informationprotection.threatassessmentrequests.item.results.ResultsRequestBuilder;
...
public class ThreatAssessmentRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ThreatAssessmentRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ThreatAssessmentRequestItemRequestBuilder and sets the default values.
    ...
    public ThreatAssessmentRequestItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
