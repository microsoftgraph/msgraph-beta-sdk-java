package com.microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.children.item.relations;

import com.microsoft.graph.groups.item.sites.item.termstore.sets.item.terms.item.children.item.relations.count.CountRequestBuilder;
