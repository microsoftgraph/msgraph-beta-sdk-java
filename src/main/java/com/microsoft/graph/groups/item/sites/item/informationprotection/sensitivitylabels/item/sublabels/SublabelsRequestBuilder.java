package com.microsoft.graph.groups.item.sites.item.informationprotection.sensitivitylabels.item.sublabels;

import com.microsoft.graph.groups.item.sites.item.informationprotection.sensitivitylabels.item.sublabels.count.CountRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.informationprotection.sensitivitylabels.item.sublabels.evaluate.EvaluateRequestBuilder;
import com.microsoft.graph.groups.item.sites.item.informationprotection.sensitivitylabels.item.sublabels.item.SensitivityLabelItemRequestBuilder;
