...
public class EvaluateDynamicMembershipRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a evaluateDynamicMembershipRequestBody
     */
    @javax.annotation.Nonnull
    public static EvaluateDynamicMembershipRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EvaluateDynamicMembershipRequestBody currentObject = this;
