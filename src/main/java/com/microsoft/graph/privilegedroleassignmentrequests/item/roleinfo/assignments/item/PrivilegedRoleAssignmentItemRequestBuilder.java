package com.microsoft.graph.privilegedroleassignmentrequests.item.roleinfo.assignments.item;
...
public class PrivilegedRoleAssignmentItemRequestBuilder {
    ...
    public PrivilegedRoleAssignmentItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}";
