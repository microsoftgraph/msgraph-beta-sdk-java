package com.microsoft.graph.privilegedroleassignmentrequests.item.cancel;
...
public class CancelRequestBuilder {
    ...
    public CancelRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/cancel";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/privilegedroleassignmentrequest-cancel?view=graph-rest-1.0">Find more info here</a>
     */
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentRequest> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
