package microsoft.graph.privilegedroleassignmentrequests.item.roleinfo.assignments;
...
import microsoft.graph.models.PrivilegedRoleAssignmentCollectionResponse;
import microsoft.graph.privilegedroleassignmentrequests.item.roleinfo.assignments.count.CountRequestBuilder;
...
public class AssignmentsRequestBuilder {
    ...
    public AssignmentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedRoleAssignmentCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of PrivilegedRoleAssignmentCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of PrivilegedRoleAssignmentCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedRoleAssignmentCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
