...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PrivilegedRoleAssignmentCollectionResponse>();
