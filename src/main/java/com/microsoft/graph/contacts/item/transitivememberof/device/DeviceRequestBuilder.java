package com.microsoft.graph.contacts.item.transitivememberof.device;

import com.microsoft.graph.contacts.item.transitivememberof.device.count.CountRequestBuilder;
