...
import com.microsoft.graph.contacts.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.contacts.item.memberof.user.UserRequestBuilder;
