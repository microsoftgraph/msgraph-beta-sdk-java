...
import com.microsoft.graph.contacts.item.directreports.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.contacts.item.directreports.item.user.UserRequestBuilder;
