...
import com.microsoft.graph.contacts.item.transitivememberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.device.DeviceRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.group.GroupRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.contacts.item.transitivememberof.user.UserRequestBuilder;
