package com.microsoft.graph.privilegedroles.item.assignments.item;
...
public class PrivilegedRoleAssignmentItemRequestBuilder {
    ...
    public PrivilegedRoleAssignmentItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}";
