...
public class PrivilegeManagementElevationsRequestBuilder extends BaseRequestBuilder {
    ...
    public PrivilegeManagementElevationCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, PrivilegeManagementElevationCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public PrivilegeManagementElevation post(@jakarta.annotation.Nonnull final PrivilegeManagementElevation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, PrivilegeManagementElevation::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The endpoint privilege management elevation event entity contains elevation details.
