...
public class SendCustomNotificationToCompanyPortalPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<String> _groupsToNotify;
    ...
    public static SendCustomNotificationToCompanyPortalPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
