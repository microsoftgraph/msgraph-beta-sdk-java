...
import com.microsoft.graph.devicemanagement.templates.item.categories.item.DeviceManagementTemplateSettingCategoryItemRequestBuilder;
...
public class DeviceManagementTemplateItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.templates.item.categories.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.templates.item.migratableTo.item collection
     * @param id Unique identifier of the item
     ...
     * @return a CompletableFuture of deviceManagementTemplate
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplate> patch(@javax.annotation.Nonnull final DeviceManagementTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of deviceManagementTemplate
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplate> patch(@javax.annotation.Nonnull final DeviceManagementTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.templates.item.settings.item collection
     * @param id Unique identifier of the item
