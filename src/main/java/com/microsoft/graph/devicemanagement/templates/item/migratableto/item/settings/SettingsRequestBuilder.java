package microsoft.graph.devicemanagement.templates.item.migratableto.item.settings;
...
import microsoft.graph.devicemanagement.templates.item.migratableto.item.settings.count.CountRequestBuilder;
