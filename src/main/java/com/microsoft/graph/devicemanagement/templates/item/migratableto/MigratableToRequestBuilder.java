...
public class MigratableToRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the migratableTo property of the microsoft.graph.deviceManagementTemplate entity.
     * @param deviceManagementTemplateId1 Unique identifier of the item
     * @return a DeviceManagementTemplateItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeviceManagementTemplateItemRequestBuilder byDeviceManagementTemplateId1(@javax.annotation.Nonnull final String deviceManagementTemplateId1) {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplateCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceManagementTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementTemplateCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplate> post(@javax.annotation.Nonnull final DeviceManagementTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementTemplate body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
