package microsoft.graph.devicemanagement.templates.item.settings;
...
import microsoft.graph.devicemanagement.templates.item.settings.count.CountRequestBuilder;
