...
public class CreateInstanceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createInstanceRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateInstanceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateInstanceRequestBody currentObject = this;
