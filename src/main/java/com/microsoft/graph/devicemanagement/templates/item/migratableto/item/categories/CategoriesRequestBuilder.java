...
public class CategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplateSettingCategoryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementTemplateSettingCategoryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DeviceManagementTemplateSettingCategoryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplateSettingCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementTemplateSettingCategoryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of deviceManagementTemplateSettingCategory
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementTemplateSettingCategory> post(@javax.annotation.Nonnull final DeviceManagementTemplateSettingCategory body, @javax.annotation.Nullable final java.util.function.Consumer<CategoriesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
