package microsoft.graph.devicemanagement.templates.item.migratableto.item.categories;
...
import microsoft.graph.devicemanagement.templates.item.migratableto.item.categories.count.CountRequestBuilder;
