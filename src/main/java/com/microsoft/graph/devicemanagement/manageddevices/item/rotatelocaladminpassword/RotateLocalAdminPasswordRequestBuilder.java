package com.microsoft.graph.devicemanagement.manageddevices.item.rotatelocaladminpassword;
...
public class RotateLocalAdminPasswordRequestBuilder extends BaseRequestBuilder {
    ...
    public RotateLocalAdminPasswordRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword", pathParameters);
    }
    /**
     * Instantiates a new RotateLocalAdminPasswordRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public RotateLocalAdminPasswordRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword", rawUrl);
    }
    /**
