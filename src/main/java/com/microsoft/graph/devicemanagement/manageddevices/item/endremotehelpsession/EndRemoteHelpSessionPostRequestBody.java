package com.microsoft.graph.devicemanagement.manageddevices.item.endremotehelpsession;
...
public class EndRemoteHelpSessionPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a endRemoteHelpSessionPostRequestBody
     */
    @javax.annotation.Nonnull
    public static EndRemoteHelpSessionPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EndRemoteHelpSessionPostRequestBody currentObject = this;
