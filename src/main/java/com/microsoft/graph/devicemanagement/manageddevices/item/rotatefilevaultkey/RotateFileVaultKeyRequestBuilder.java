package com.microsoft.graph.devicemanagement.manageddevices.item.rotatefilevaultkey;
...
public class RotateFileVaultKeyRequestBuilder {
    ...
    public RotateFileVaultKeyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rotateFileVaultKey";
