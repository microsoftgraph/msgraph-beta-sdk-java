package com.microsoft.graph.devicemanagement.manageddevices.item.detectedapps;

import com.microsoft.graph.devicemanagement.manageddevices.item.detectedapps.count.CountRequestBuilder;
