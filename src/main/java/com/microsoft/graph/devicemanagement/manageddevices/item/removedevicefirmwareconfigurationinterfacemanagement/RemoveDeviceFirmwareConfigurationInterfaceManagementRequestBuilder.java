package com.microsoft.graph.devicemanagement.manageddevices.item.removedevicefirmwareconfigurationinterfacemanagement;
...
public class RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder {
    ...
    public RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/removeDeviceFirmwareConfigurationInterfaceManagement";
