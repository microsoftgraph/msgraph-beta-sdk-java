package microsoft.graph.devicemanagement.manageddevices.item.users;
...
import microsoft.graph.devicemanagement.manageddevices.item.users.count.CountRequestBuilder;
