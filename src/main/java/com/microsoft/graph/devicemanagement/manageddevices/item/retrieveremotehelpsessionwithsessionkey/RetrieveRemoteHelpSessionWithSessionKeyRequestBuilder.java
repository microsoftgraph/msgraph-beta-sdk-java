package com.microsoft.graph.devicemanagement.manageddevices.item.retrieveremotehelpsessionwithsessionkey;
 ...
 */
public class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String sessionKey) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", pathParameters);
        this.pathParameters.put("sessionKey", sessionKey);
    }
    /**
     * Instantiates a new RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder and sets the default values.
    ...
    public RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/retrieveRemoteHelpSession(sessionKey='{sessionKey}')", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<RetrieveRemoteHelpSessionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<RetrieveRemoteHelpSessionResponse> executionException = new java.util.concurrent.CompletableFuture<RetrieveRemoteHelpSessionResponse>();
