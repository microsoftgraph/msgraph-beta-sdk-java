...
public class OverrideComplianceStatePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("complianceState", (n) -> { currentObject.setComplianceState(n.getEnumValue(AdministratorConfiguredDeviceComplianceState.class)); });
        deserializerMap.put("remediationUrl", (n) -> { currentObject.setRemediationUrl(n.getStringValue()); });
