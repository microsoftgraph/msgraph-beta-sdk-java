package com.microsoft.graph.devicemanagement.manageddevices.item.enrollnowaction;
...
public class EnrollNowActionRequestBuilder {
    ...
    public EnrollNowActionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/enrollNowAction";
