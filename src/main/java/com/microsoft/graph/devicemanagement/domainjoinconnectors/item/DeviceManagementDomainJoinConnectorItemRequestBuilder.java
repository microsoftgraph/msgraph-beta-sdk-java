...
public class DeviceManagementDomainJoinConnectorItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceManagementDomainJoinConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementDomainJoinConnector> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementDomainJoinConnector> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementDomainJoinConnector>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
