package com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.item.getsupportedcloudpcremoteactions;
...
public class GetSupportedCloudPcRemoteActionsGetResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final java.util.List<CloudPcRemoteActionCapability> value) {
