...
import com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.bulkresize.BulkResizeRequestBuilder;
import com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.count.CountRequestBuilder;
import com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.getprovisionedcloudpcswithgroupidwithserviceplanid.GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder;
import com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.item.CloudPCItemRequestBuilder;
import com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.validatebulkresize.ValidateBulkResizeRequestBuilder;
...
public class CloudPCsRequestBuilder extends BaseRequestBuilder {
    ...
    public CloudPCsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CloudPCsRequestBuilder and sets the default values.
