...
import com.microsoft.graph.devicemanagement.virtualendpoint.bulkactions.BulkActionsRequestBuilder;
...
import com.microsoft.graph.devicemanagement.virtualendpoint.retrievescopedpermissions.RetrieveScopedPermissionsRequestBuilder;
import com.microsoft.graph.devicemanagement.virtualendpoint.retrievetenantencryptionsetting.RetrieveTenantEncryptionSettingRequestBuilder;
...
public class VirtualEndpointRequestBuilder extends BaseRequestBuilder {
    ...
    public VirtualEndpoint get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, VirtualEndpoint::createFromDiscriminatorValue, errorMapping);
    }
    /**
