package com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.item.getfrontlinecloudpcaccessstate;
...
public class GetFrontlineCloudPcAccessStateRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of FrontlineCloudPcAccessState
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FrontlineCloudPcAccessState> get() {
        return get(null);
    }
    /**
     * Invoke function getFrontlineCloudPcAccessState
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FrontlineCloudPcAccessState> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendEnumAsync(requestInfo, FrontlineCloudPcAccessState.class, errorMapping);
    }
    /**
     * Invoke function getFrontlineCloudPcAccessState
