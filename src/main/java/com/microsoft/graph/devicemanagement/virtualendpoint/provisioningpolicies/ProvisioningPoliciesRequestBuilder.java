...
public class ProvisioningPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CloudPcProvisioningPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcProvisioningPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcProvisioningPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcProvisioningPolicyCollectionResponse>();
