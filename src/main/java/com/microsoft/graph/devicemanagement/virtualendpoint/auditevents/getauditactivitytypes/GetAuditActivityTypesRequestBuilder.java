...
public class GetAuditActivityTypesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetAuditActivityTypesGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetAuditActivityTypesGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function getAuditActivityTypes
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetAuditActivityTypesGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetAuditActivityTypesGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getAuditActivityTypes
