...
public class ReportsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final CloudPcReports body, @javax.annotation.Nullable final java.util.function.Consumer<ReportsRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.virtualEndpoint.reports.exportJobs.item collection
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcReports> get(@javax.annotation.Nullable final java.util.function.Consumer<ReportsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcReports> patch(@javax.annotation.Nonnull final CloudPcReports body, @javax.annotation.Nullable final java.util.function.Consumer<ReportsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
