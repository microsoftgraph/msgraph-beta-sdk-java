...
public class UserSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the userSettings property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcUserSettingId Unique identifier of the item
     * @return a CloudPcUserSettingItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcUserSettingItemRequestBuilder byCloudPcUserSettingId(@javax.annotation.Nonnull final String cloudPcUserSettingId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcUserSetting body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcUserSetting body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
