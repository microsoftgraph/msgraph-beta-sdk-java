...
public class UserSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcUserSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcUserSettingCollectionResponse>();
