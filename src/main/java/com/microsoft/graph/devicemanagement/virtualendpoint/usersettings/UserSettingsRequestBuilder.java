...
public class UserSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    public CloudPcUserSettingCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, CloudPcUserSettingCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public CloudPcUserSetting post(@jakarta.annotation.Nonnull final CloudPcUserSetting body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, CloudPcUserSetting::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve a list of cloudPcUserSetting objects. This API is available in the following national cloud deployments.
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CloudPcUserSetting body) {
