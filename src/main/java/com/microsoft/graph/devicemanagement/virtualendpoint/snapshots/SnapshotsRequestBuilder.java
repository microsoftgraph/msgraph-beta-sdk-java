...
public class SnapshotsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcSnapshotCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcSnapshotCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcSnapshotCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcSnapshot> post(@javax.annotation.Nonnull final CloudPcSnapshot body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcSnapshot> executionException = new java.util.concurrent.CompletableFuture<CloudPcSnapshot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
