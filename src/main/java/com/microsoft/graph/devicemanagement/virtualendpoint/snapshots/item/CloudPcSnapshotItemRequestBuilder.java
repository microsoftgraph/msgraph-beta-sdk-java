...
public class CloudPcSnapshotItemRequestBuilder {
     ...
     * @return a CompletableFuture of cloudPcSnapshot
     */
    public java.util.concurrent.CompletableFuture<CloudPcSnapshot> patch(@javax.annotation.Nonnull final CloudPcSnapshot body, @javax.annotation.Nullable final java.util.function.Consumer<CloudPcSnapshotItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
