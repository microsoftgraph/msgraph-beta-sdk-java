...
public class OnPremisesConnectionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnectionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnection> post(@javax.annotation.Nonnull final CloudPcOnPremisesConnection body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnection> executionException = new java.util.concurrent.CompletableFuture<CloudPcOnPremisesConnection>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
