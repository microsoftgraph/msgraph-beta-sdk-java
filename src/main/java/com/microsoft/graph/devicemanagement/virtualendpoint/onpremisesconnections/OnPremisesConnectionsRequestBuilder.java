...
public class OnPremisesConnectionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the onPremisesConnections property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcOnPremisesConnectionId Unique identifier of the item
     * @return a CloudPcOnPremisesConnectionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcOnPremisesConnectionItemRequestBuilder byCloudPcOnPremisesConnectionId(@javax.annotation.Nonnull final String cloudPcOnPremisesConnectionId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcOnPremisesConnection body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcOnPremisesConnection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
