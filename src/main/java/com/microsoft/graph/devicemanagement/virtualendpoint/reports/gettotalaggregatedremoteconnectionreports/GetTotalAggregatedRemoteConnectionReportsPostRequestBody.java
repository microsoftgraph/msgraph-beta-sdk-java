...
public class GetTotalAggregatedRemoteConnectionReportsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetTotalAggregatedRemoteConnectionReportsPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetTotalAggregatedRemoteConnectionReportsPostRequestBody currentObject = this;
