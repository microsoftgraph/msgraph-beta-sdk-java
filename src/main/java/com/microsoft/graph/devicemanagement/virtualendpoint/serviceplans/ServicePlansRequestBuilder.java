...
public class ServicePlansRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the servicePlans property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcServicePlanId Unique identifier of the item
     * @return a CloudPcServicePlanItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcServicePlanItemRequestBuilder byCloudPcServicePlanId(@javax.annotation.Nonnull final String cloudPcServicePlanId) {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcServicePlanCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcServicePlanCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcServicePlanCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcServicePlan> post(@javax.annotation.Nonnull final CloudPcServicePlan body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcServicePlan> executionException = new java.util.concurrent.CompletableFuture<CloudPcServicePlan>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcServicePlan> post(@javax.annotation.Nonnull final CloudPcServicePlan body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcServicePlan body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcServicePlan body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
