...
public class ValidateBulkResizeResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * The value property
     */
    ...
    public static ValidateBulkResizeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<CloudPcResizeValidationResult> value) {
        this.value = value;
    }
}
