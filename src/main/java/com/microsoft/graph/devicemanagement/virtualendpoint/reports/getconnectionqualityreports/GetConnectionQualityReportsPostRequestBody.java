package com.microsoft.graph.devicemanagement.virtualendpoint.reports.getconnectionqualityreports;
...
public class GetConnectionQualityReportsPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new GetConnectionQualityReportsPostRequestBody and sets the default values.
     */
     ...
     * @return a GetConnectionQualityReportsPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetConnectionQualityReportsPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
