...
public class GetDailyAggregatedRemoteConnectionReportsPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDailyAggregatedRemoteConnectionReportsPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDailyAggregatedRemoteConnectionReportsPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDailyAggregatedRemoteConnectionReportsPostRequestBody currentObject = this;
