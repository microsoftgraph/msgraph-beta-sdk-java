package microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.item.changeuseraccounttype;
...
public class ChangeUserAccountTypeRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a changeUserAccountTypeRequestBody
     */
    @javax.annotation.Nonnull
    public static ChangeUserAccountTypeRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ChangeUserAccountTypeRequestBody currentObject = this;
