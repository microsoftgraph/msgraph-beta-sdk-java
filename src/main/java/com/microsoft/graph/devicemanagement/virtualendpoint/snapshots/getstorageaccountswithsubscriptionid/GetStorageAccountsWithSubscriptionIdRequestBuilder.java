...
public class GetStorageAccountsWithSubscriptionIdRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse>();
