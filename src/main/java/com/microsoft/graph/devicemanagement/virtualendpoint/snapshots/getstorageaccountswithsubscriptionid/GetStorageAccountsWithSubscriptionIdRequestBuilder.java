...
public class GetStorageAccountsWithSubscriptionIdRequestBuilder {
    ...
    public GetStorageAccountsWithSubscriptionIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String subscriptionId) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/getStorageAccounts(subscriptionId='{subscriptionId}'){?%24top,%24skip,%24search,%24filter,%24count}";
    ...
    public java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetStorageAccountsWithSubscriptionIdResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse> executionException = new java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetStorageAccountsWithSubscriptionIdResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
