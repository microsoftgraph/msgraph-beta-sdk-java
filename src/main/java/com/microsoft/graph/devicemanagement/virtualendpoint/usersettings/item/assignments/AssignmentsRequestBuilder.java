...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the assignments property of the microsoft.graph.cloudPcUserSetting entity.
     * @param cloudPcUserSettingAssignmentId Unique identifier of the item
     * @return a CloudPcUserSettingAssignmentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcUserSettingAssignmentItemRequestBuilder byCloudPcUserSettingAssignmentId(@javax.annotation.Nonnull final String cloudPcUserSettingAssignmentId) {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment> post(@javax.annotation.Nonnull final CloudPcUserSettingAssignment body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment> executionException = new java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment> post(@javax.annotation.Nonnull final CloudPcUserSettingAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcUserSettingAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcUserSettingAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
