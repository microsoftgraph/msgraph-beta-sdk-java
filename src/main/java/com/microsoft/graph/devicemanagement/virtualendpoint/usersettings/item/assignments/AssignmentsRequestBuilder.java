...
public class AssignmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignmentCollectionResponse>() {{
    ...
    public java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment> post(@javax.annotation.Nonnull final CloudPcUserSettingAssignment body) {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<CloudPcUserSettingAssignment>() {{
                this.completeExceptionally(ex);
            }};
        }
    }
