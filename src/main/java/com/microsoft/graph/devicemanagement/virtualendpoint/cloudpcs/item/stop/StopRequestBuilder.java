package com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.item.stop;
...
public class StopRequestBuilder extends BaseRequestBuilder {
    ...
    public StopRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/stop", pathParameters);
    }
    /**
     * Instantiates a new StopRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/cloudpc-stop?view=graph-rest-1.0">Find more info here</a>
     */
