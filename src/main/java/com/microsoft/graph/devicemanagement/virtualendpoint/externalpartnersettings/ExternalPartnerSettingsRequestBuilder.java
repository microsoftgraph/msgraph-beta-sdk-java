...
public class ExternalPartnerSettingsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the externalPartnerSettings property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcExternalPartnerSettingId Unique identifier of the item
     * @return a CloudPcExternalPartnerSettingItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcExternalPartnerSettingItemRequestBuilder byCloudPcExternalPartnerSettingId(@javax.annotation.Nonnull final String cloudPcExternalPartnerSettingId) {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting> post(@javax.annotation.Nonnull final CloudPcExternalPartnerSetting body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting> executionException = new java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcExternalPartnerSetting body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcExternalPartnerSetting body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
