...
public class ExternalPartnerSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSettingCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting> post(@javax.annotation.Nonnull final CloudPcExternalPartnerSetting body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting> executionException = new java.util.concurrent.CompletableFuture<CloudPcExternalPartnerSetting>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
