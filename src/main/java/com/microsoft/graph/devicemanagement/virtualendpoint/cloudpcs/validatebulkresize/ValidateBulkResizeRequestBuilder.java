...
public class ValidateBulkResizeRequestBuilder extends BaseRequestBuilder {
    ...
    public ValidateBulkResizePostResponse post(@jakarta.annotation.Nonnull final ValidateBulkResizePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ValidateBulkResizePostResponse post(@jakarta.annotation.Nonnull final ValidateBulkResizePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, ValidateBulkResizePostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Validate that a set of cloudPC devices meet the requirements to be bulk resized. This API is available in the following national cloud deployments.
     * @param body The request body
