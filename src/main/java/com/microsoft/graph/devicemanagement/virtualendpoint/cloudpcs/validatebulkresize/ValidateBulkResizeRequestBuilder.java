package com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.validatebulkresize;
...
public class ValidateBulkResizeRequestBuilder extends BaseRequestBuilder {
    ...
    public ValidateBulkResizeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public ValidateBulkResizeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/validateBulkResize", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<ValidateBulkResizeResponse> post(@jakarta.annotation.Nonnull final ValidateBulkResizePostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ValidateBulkResizeResponse> executionException = new java.util.concurrent.CompletableFuture<ValidateBulkResizeResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ValidateBulkResizePostRequestBody body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ValidateBulkResizePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
