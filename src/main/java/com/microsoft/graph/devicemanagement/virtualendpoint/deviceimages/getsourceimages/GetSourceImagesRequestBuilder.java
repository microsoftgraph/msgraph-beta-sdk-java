...
public class GetSourceImagesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetSourceImagesGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetSourceImagesGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function getSourceImages
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetSourceImagesGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetSourceImagesGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getSourceImages
