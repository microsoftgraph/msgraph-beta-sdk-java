...
public class GetRemoteConnectionHistoricalReportsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetRemoteConnectionHistoricalReportsPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRemoteConnectionHistoricalReportsPostRequestBody currentObject = this;
