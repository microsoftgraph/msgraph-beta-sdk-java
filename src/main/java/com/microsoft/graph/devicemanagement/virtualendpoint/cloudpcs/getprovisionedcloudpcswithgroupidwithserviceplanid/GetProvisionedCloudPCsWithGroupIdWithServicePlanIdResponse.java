package com.microsoft.graph.devicemanagement.virtualendpoint.cloudpcs.getprovisionedcloudpcswithgroupidwithserviceplanid;
...
public class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static GetProvisionedCloudPCsWithGroupIdWithServicePlanIdResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
