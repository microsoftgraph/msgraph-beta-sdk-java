...
public class DeviceImagesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcDeviceImage> post(@javax.annotation.Nonnull final CloudPcDeviceImage body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcDeviceImage> executionException = new java.util.concurrent.CompletableFuture<CloudPcDeviceImage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
