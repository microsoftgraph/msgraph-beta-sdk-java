...
public class DeviceImagesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the deviceImages property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcDeviceImageId Unique identifier of the item
     * @return a CloudPcDeviceImageItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcDeviceImageItemRequestBuilder byCloudPcDeviceImageId(@javax.annotation.Nonnull final String cloudPcDeviceImageId) {
    ...
    public DeviceImagesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DeviceImagesRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcDeviceImageCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcDeviceImage> post(@javax.annotation.Nonnull final CloudPcDeviceImage body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcDeviceImage> executionException = new java.util.concurrent.CompletableFuture<CloudPcDeviceImage>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcDeviceImage body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcDeviceImage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
