...
public class ReuploadRequestBuilder {
    ...
    public ReuploadRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}/reupload";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/cloudpcdeviceimage-reupload?view=graph-rest-1.0">Find more info here</a>
     */
