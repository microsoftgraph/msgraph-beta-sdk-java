...
public class AuditEventsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse>();
