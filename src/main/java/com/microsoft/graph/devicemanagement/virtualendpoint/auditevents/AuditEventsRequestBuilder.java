...
public class AuditEventsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CloudPcAuditEventCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse>() {{
