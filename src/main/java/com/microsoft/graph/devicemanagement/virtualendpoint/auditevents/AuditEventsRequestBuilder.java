...
public class AuditEventsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the auditEvents property of the microsoft.graph.virtualEndpoint entity.
     * @param cloudPcAuditEventId Unique identifier of the item
     * @return a CloudPcAuditEventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CloudPcAuditEventItemRequestBuilder byCloudPcAuditEventId(@javax.annotation.Nonnull final String cloudPcAuditEventId) {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcAuditEventCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CloudPcAuditEvent> post(@javax.annotation.Nonnull final CloudPcAuditEvent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcAuditEvent body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CloudPcAuditEvent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
