...
public class SupportedRegionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CloudPcSupportedRegion body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcSupportedRegionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcSupportedRegionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPcSupportedRegionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CloudPcSupportedRegion> post(@javax.annotation.Nonnull final CloudPcSupportedRegion body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPcSupportedRegion> executionException = new java.util.concurrent.CompletableFuture<CloudPcSupportedRegion>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
