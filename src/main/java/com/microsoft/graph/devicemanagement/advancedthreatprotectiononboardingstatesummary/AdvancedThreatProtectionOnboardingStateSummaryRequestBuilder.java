...
public class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingStateSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingStateSummary> executionException = new java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingStateSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
