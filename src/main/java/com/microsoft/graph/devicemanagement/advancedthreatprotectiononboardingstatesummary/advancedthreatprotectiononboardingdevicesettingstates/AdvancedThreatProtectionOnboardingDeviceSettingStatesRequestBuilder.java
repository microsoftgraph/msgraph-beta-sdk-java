...
public class AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse>();
