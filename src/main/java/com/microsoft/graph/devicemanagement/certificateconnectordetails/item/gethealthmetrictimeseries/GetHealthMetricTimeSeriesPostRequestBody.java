...
public class GetHealthMetricTimeSeriesPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public TimeSeriesParameter getTimeSeries() {
        return this.backingStore.get("timeSeries");
    }
    /**
    ...
    public void setTimeSeries(@jakarta.annotation.Nullable final TimeSeriesParameter value) {
        this.backingStore.set("timeSeries", value);
    }
}
