...
import microsoft.graph.models.CertificateConnectorHealthMetricValue;
...
public class GetHealthMetricTimeSeriesResponse implements AdditionalDataHolder, Parsable {
    ...
    /** The value property  */
    private java.util.List<CertificateConnectorHealthMetricValue> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(CertificateConnectorHealthMetricValue::createFromDiscriminatorValue)); });
        }};
    }
    /**
