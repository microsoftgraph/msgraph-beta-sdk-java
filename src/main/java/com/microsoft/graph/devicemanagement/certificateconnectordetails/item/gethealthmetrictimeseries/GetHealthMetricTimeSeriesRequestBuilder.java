...
public class GetHealthMetricTimeSeriesRequestBuilder {
    ...
    public GetHealthMetricTimeSeriesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/certificateConnectorDetails/{certificateConnectorDetails%2Did}/getHealthMetricTimeSeries";
    ...
    public java.util.concurrent.CompletableFuture<GetHealthMetricTimeSeriesResponse> post(@javax.annotation.Nonnull final GetHealthMetricTimeSeriesPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetHealthMetricTimeSeriesResponse> executionException = new java.util.concurrent.CompletableFuture<GetHealthMetricTimeSeriesResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GetHealthMetricTimeSeriesPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GetHealthMetricTimeSeriesPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
