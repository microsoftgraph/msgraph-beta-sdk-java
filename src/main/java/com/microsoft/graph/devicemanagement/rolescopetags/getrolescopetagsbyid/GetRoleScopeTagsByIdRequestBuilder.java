...
public class GetRoleScopeTagsByIdRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetRoleScopeTagsByIdPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdPostResponse> post(@jakarta.annotation.Nonnull final GetRoleScopeTagsByIdPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdPostResponse> post(@jakarta.annotation.Nonnull final GetRoleScopeTagsByIdPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetRoleScopeTagsByIdPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action getRoleScopeTagsById
     * @param body The request body
