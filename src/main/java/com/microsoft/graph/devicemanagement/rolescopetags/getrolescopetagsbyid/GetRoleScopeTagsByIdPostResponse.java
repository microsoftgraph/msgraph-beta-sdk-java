...
public class GetRoleScopeTagsByIdPostResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * The value property
     */
    private java.util.List<RoleScopeTag> value;
    /**
     * Instantiates a new GetRoleScopeTagsByIdPostResponse and sets the default values.
     */
    public GetRoleScopeTagsByIdPostResponse() {
        super();
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a GetRoleScopeTagsByIdPostResponse
     */
    @jakarta.annotation.Nonnull
    public static GetRoleScopeTagsByIdPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
