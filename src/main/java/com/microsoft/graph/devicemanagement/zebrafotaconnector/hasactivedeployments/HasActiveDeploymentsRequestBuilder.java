...
public class HasActiveDeploymentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<HasActiveDeploymentsResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<HasActiveDeploymentsResponse> executionException = new java.util.concurrent.CompletableFuture<HasActiveDeploymentsResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HasActiveDeploymentsResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
