...
public class DisconnectRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DisconnectResponse> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DisconnectResponse> executionException = new java.util.concurrent.CompletableFuture<DisconnectResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DisconnectResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
