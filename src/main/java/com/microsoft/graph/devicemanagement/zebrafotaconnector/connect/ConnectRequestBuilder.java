...
public class ConnectRequestBuilder {
    ...
    public ConnectRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/zebraFotaConnector/connect";
    ...
    public java.util.concurrent.CompletableFuture<ConnectResponse> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConnectResponse> executionException = new java.util.concurrent.CompletableFuture<ConnectResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConnectResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
