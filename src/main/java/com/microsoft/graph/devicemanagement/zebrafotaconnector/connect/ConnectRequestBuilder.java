...
public class ConnectRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<ConnectResponse> post() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ConnectResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of connectResponse
     */
    public java.util.concurrent.CompletableFuture<ConnectResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of connectResponse
     */
    public java.util.concurrent.CompletableFuture<ConnectResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<ConnectRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ConnectResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
