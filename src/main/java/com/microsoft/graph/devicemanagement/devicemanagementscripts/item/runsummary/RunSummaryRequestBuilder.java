...
public class RunSummaryRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementScriptRunSummary get() {
        return get(null);
    }
    /**
     * Run summary for device management script.
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementScriptRunSummary get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, DeviceManagementScriptRunSummary::createFromDiscriminatorValue);
    }
    /**
     * Run summary for device management script.
