...
public class DeviceManagementScriptsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementScript body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementScriptCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementScriptCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> post(@javax.annotation.Nonnull final DeviceManagementScript body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementScript> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementScript>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
