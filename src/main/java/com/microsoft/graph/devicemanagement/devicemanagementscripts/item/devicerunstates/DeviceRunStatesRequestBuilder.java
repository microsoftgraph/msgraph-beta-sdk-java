package microsoft.graph.devicemanagement.devicemanagementscripts.item.devicerunstates;
...
import microsoft.graph.devicemanagement.devicemanagementscripts.item.devicerunstates.count.CountRequestBuilder;
