...
public class LocalizedNotificationMessagesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final LocalizedNotificationMessage body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final LocalizedNotificationMessage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse>() {{
