...
public class LocalizedNotificationMessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public LocalizedNotificationMessagesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public LocalizedNotificationMessagesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LocalizedNotificationMessageCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final LocalizedNotificationMessage body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final LocalizedNotificationMessage body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
