...
public class WindowsAutopilotDeploymentProfilesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WindowsAutopilotDeploymentProfile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfileCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfileCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfileCollectionResponse>();
