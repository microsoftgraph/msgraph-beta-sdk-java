package com.microsoft.graph.devicemanagement.windowsautopilotdeploymentprofiles.item.assigneddevices.item.assignresourceaccounttodevice;
...
public class AssignResourceAccountToDevicePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static AssignResourceAccountToDevicePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
