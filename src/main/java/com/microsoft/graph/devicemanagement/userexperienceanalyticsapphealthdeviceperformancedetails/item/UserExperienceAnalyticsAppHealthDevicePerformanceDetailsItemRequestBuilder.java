...
public class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAppHealthDevicePerformanceDetails> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAppHealthDevicePerformanceDetails> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAppHealthDevicePerformanceDetails>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
