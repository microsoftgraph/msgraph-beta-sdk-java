...
public class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> executionException = new java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse>();
