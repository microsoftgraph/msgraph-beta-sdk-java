...
public class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of SummarizeDeviceRemoteConnectionWithSummarizeByGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function summarizeDeviceRemoteConnection
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, SummarizeDeviceRemoteConnectionWithSummarizeByGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function summarizeDeviceRemoteConnection
