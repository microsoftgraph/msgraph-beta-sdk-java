...
public class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> executionException = new java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SummarizeDeviceRemoteConnectionWithSummarizeByResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
