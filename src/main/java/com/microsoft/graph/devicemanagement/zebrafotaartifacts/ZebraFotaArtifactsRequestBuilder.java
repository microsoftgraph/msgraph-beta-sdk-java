...
public class ZebraFotaArtifactsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse>();
