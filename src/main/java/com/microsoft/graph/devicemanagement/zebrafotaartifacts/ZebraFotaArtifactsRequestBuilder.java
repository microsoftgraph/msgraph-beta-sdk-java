...
public class ZebraFotaArtifactsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the zebraFotaArtifacts property of the microsoft.graph.deviceManagement entity.
     * @param zebraFotaArtifactId Unique identifier of the item
     * @return a ZebraFotaArtifactItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ZebraFotaArtifactItemRequestBuilder byZebraFotaArtifactId(@javax.annotation.Nonnull final String zebraFotaArtifactId) {
    ...
    public java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ZebraFotaArtifactCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ZebraFotaArtifact> post(@javax.annotation.Nonnull final ZebraFotaArtifact body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ZebraFotaArtifact body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ZebraFotaArtifact body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
