...
public class SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SummarizeDevicePerformanceDevicesWithSummarizeByResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SummarizeDevicePerformanceDevicesWithSummarizeByResponse> executionException = new java.util.concurrent.CompletableFuture<SummarizeDevicePerformanceDevicesWithSummarizeByResponse>();
