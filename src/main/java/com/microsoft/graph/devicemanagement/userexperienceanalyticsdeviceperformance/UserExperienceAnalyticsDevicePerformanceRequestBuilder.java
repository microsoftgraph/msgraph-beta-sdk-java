...
public class UserExperienceAnalyticsDevicePerformanceRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsDevicePerformance body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse>();
