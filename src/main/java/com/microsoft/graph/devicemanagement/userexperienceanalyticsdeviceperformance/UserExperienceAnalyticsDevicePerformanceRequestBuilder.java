...
public class UserExperienceAnalyticsDevicePerformanceRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDevicePerformanceCollectionResponse>();
