...
public class UserExperienceAnalyticsBatteryHealthModelPerformanceRequestBuilder extends BaseRequestBuilder {
    ...
    public UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse get() {
        return get(null);
    }
    /**
     * User Experience Analytics Battery Health Model Performance
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsBatteryHealthModelPerformance post(@jakarta.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthModelPerformance body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsBatteryHealthModelPerformance post(@jakarta.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthModelPerformance body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, UserExperienceAnalyticsBatteryHealthModelPerformance::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * User Experience Analytics Battery Health Model Performance
