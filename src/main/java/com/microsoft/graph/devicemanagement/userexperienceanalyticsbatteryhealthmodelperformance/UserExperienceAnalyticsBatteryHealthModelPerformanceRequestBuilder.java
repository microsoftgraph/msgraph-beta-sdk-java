...
public class UserExperienceAnalyticsBatteryHealthModelPerformanceRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthModelPerformance body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformanceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformance> post(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthModelPerformance body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformance> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthModelPerformance>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
