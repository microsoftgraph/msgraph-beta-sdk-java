...
public class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
