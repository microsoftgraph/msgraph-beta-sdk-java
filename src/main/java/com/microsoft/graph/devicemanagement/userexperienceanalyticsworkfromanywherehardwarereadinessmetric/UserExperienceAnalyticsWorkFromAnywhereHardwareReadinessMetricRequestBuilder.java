...
public class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric body, @javax.annotation.Nullable final java.util.function.Consumer<UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
