...
public class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereMetric body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetric> post(@javax.annotation.Nonnull final UserExperienceAnalyticsWorkFromAnywhereMetric body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetric> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsWorkFromAnywhereMetric>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
