...
public class UserExperienceAnalyticsBaselineItemRequestBuilder {
     ...
     * @return a CompletableFuture of userExperienceAnalyticsBaseline
     */
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBaseline body, @javax.annotation.Nullable final java.util.function.Consumer<UserExperienceAnalyticsBaselineItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of userExperienceAnalyticsBaseline
     */
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBaseline> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBaseline body, @javax.annotation.Nullable final java.util.function.Consumer<UserExperienceAnalyticsBaselineItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
