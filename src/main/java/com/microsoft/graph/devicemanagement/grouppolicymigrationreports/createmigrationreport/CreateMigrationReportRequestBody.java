...
public class CreateMigrationReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a createMigrationReportRequestBody
     */
    @javax.annotation.Nonnull
    public static CreateMigrationReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreateMigrationReportRequestBody currentObject = this;
