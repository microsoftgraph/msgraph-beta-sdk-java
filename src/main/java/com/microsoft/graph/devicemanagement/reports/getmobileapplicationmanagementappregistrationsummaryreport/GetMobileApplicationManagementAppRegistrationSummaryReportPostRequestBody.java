...
public class GetMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody currentObject = this;
