...
public class GetEnrollmentConfigurationPoliciesByDeviceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getEnrollmentConfigurationPoliciesByDeviceRequestBody
     */
    @javax.annotation.Nonnull
    public static GetEnrollmentConfigurationPoliciesByDeviceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetEnrollmentConfigurationPoliciesByDeviceRequestBody currentObject = this;
