...
public class GetConfigurationSettingDetailsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationSettingDetailsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingDetailsReportPostRequestBody currentObject = this;
