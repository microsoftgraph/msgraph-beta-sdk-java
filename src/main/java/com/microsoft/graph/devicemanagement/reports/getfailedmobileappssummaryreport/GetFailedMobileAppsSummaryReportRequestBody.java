...
public class GetFailedMobileAppsSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getFailedMobileAppsSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetFailedMobileAppsSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetFailedMobileAppsSummaryReportRequestBody currentObject = this;
