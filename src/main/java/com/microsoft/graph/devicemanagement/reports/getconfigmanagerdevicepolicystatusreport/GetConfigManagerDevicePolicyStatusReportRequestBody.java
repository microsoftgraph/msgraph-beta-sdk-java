package microsoft.graph.devicemanagement.reports.getconfigmanagerdevicepolicystatusreport;
...
public class GetConfigManagerDevicePolicyStatusReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getConfigManagerDevicePolicyStatusReportRequestBody and sets the default values.
     * @return a void
     */
    public GetConfigManagerDevicePolicyStatusReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getConfigManagerDevicePolicyStatusReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigManagerDevicePolicyStatusReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetConfigManagerDevicePolicyStatusReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigManagerDevicePolicyStatusReportRequestBody currentObject = this;
