...
public class GetUnhealthyDefenderAgentsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyDefenderAgentsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyDefenderAgentsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyDefenderAgentsReportRequestBody currentObject = this;
