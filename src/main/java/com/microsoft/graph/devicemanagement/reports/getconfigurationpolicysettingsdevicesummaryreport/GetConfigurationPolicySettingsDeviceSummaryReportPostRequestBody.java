...
public class GetConfigurationPolicySettingsDeviceSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationPolicySettingsDeviceSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicySettingsDeviceSummaryReportPostRequestBody currentObject = this;
