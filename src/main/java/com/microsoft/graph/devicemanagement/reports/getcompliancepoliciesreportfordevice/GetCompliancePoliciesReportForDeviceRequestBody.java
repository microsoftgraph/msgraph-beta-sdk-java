...
public class GetCompliancePoliciesReportForDeviceRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getCompliancePoliciesReportForDeviceRequestBody and sets the default values.
     * @return a void
     */
    public GetCompliancePoliciesReportForDeviceRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getCompliancePoliciesReportForDeviceRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePoliciesReportForDeviceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetCompliancePoliciesReportForDeviceRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePoliciesReportForDeviceRequestBody currentObject = this;
