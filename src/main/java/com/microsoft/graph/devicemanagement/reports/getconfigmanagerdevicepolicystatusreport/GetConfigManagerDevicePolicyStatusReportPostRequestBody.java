...
public class GetConfigManagerDevicePolicyStatusReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigManagerDevicePolicyStatusReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigManagerDevicePolicyStatusReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigManagerDevicePolicyStatusReportPostRequestBody currentObject = this;
