...
public class GetUnhealthyDefenderAgentsReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyDefenderAgentsReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyDefenderAgentsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyDefenderAgentsReportPostRequestBody currentObject = this;
