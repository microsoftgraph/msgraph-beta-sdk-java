...
public class GetQuietTimePolicyUsersReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("skipToken", (n) -> { currentObject.setSkipToken(n.getStringValue()); });
