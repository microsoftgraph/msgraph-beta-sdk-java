package com.microsoft.graph.devicemanagement.reports.getcompliancepolicydevicesreport;
...
public class GetCompliancePolicyDevicesReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCompliancePolicyDevicesReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyDevicesReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyDevicesReportPostRequestBody currentObject = this;
