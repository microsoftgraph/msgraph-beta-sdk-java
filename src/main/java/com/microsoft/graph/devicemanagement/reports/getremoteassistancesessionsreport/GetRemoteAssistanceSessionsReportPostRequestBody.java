...
public class GetRemoteAssistanceSessionsReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getRemoteAssistanceSessionsReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetRemoteAssistanceSessionsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRemoteAssistanceSessionsReportPostRequestBody currentObject = this;
