...
public class GetAllCertificatesReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetAllCertificatesReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAllCertificatesReportPostRequestBody currentObject = this;
