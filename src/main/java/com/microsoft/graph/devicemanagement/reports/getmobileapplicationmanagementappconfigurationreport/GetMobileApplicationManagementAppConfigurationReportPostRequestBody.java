...
public class GetMobileApplicationManagementAppConfigurationReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetMobileApplicationManagementAppConfigurationReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetMobileApplicationManagementAppConfigurationReportPostRequestBody currentObject = this;
