...
public class GetQuietTimePolicyUserSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getQuietTimePolicyUserSummaryReportRequestBody and sets the default values.
     * @return a void
     */
    public GetQuietTimePolicyUserSummaryReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getQuietTimePolicyUserSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetQuietTimePolicyUserSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetQuietTimePolicyUserSummaryReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetQuietTimePolicyUserSummaryReportRequestBody currentObject = this;
