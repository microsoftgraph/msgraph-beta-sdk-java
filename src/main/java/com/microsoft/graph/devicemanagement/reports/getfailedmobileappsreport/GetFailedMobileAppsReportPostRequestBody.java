...
public class GetFailedMobileAppsReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getFailedMobileAppsReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetFailedMobileAppsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetFailedMobileAppsReportPostRequestBody currentObject = this;
