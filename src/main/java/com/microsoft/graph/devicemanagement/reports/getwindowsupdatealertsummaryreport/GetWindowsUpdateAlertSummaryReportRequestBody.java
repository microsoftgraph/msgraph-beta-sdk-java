package microsoft.graph.devicemanagement.reports.getwindowsupdatealertsummaryreport;
...
public class GetWindowsUpdateAlertSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public GetWindowsUpdateAlertSummaryReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getWindowsUpdateAlertSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsUpdateAlertSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetWindowsUpdateAlertSummaryReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsUpdateAlertSummaryReportRequestBody currentObject = this;
