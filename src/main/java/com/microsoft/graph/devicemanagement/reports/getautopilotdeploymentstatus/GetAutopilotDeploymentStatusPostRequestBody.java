...
public class GetAutopilotDeploymentStatusPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    private Integer top;
    /**
     * Instantiates a new getAutopilotDeploymentStatusPostRequestBody and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public GetAutopilotDeploymentStatusPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getAutopilotDeploymentStatusPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAutopilotDeploymentStatusPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetAutopilotDeploymentStatusPostRequestBody();
    }
    /**
