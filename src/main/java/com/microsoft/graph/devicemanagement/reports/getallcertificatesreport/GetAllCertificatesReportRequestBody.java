...
public class GetAllCertificatesReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getAllCertificatesReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAllCertificatesReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAllCertificatesReportRequestBody currentObject = this;
