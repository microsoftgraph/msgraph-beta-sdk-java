...
public class GetConfigurationPoliciesReportForDeviceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPoliciesReportForDeviceRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPoliciesReportForDeviceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPoliciesReportForDeviceRequestBody currentObject = this;
