package com.microsoft.graph.devicemanagement.reports.getquiettimepolicyusersummaryreport;
...
public class GetQuietTimePolicyUserSummaryReportRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetQuietTimePolicyUserSummaryReportPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetQuietTimePolicyUserSummaryReportPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<GetQuietTimePolicyUserSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<InputStream> post(@javax.annotation.Nonnull final GetQuietTimePolicyUserSummaryReportPostRequestBody body) {
        try {
     ...
     * @return a CompletableFuture of InputStream
     */
    public java.util.concurrent.CompletableFuture<InputStream> post(@javax.annotation.Nonnull final GetQuietTimePolicyUserSummaryReportPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<GetQuietTimePolicyUserSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of InputStream
     */
    public java.util.concurrent.CompletableFuture<InputStream> post(@javax.annotation.Nonnull final GetQuietTimePolicyUserSummaryReportPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<GetQuietTimePolicyUserSummaryReportRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
