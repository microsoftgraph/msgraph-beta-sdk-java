...
public class GetAppStatusOverviewReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getAppStatusOverviewReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAppStatusOverviewReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAppStatusOverviewReportRequestBody currentObject = this;
