...
public class GetConfigurationPolicyDevicesReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyDevicesReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyDevicesReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyDevicesReportRequestBody currentObject = this;
