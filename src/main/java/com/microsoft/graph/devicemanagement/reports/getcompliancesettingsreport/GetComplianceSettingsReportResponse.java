...
public class GetComplianceSettingsReportResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getComplianceSettingsReportResponse
     */
    @javax.annotation.Nonnull
    public static GetComplianceSettingsReportResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingsReportResponse currentObject = this;
