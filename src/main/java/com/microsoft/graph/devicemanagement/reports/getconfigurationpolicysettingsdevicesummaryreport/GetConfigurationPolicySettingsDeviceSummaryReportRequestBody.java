...
public class GetConfigurationPolicySettingsDeviceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicySettingsDeviceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicySettingsDeviceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicySettingsDeviceSummaryReportRequestBody currentObject = this;
