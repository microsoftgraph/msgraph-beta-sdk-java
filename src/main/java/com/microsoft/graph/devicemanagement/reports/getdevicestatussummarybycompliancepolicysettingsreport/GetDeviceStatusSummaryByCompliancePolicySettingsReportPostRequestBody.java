...
public class GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
