...
public class GetConfigurationPolicyDevicesReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationPolicyDevicesReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyDevicesReportPostRequestBody currentObject = this;
