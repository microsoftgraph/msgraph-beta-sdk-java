...
public class GetCertificatesReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCertificatesReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCertificatesReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCertificatesReportRequestBody currentObject = this;
