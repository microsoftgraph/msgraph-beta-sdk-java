...
public class GetRemoteAssistanceSessionsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getRemoteAssistanceSessionsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetRemoteAssistanceSessionsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRemoteAssistanceSessionsReportRequestBody currentObject = this;
