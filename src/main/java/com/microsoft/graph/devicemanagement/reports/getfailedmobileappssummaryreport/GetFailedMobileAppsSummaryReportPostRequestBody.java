...
public class GetFailedMobileAppsSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getFailedMobileAppsSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetFailedMobileAppsSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetFailedMobileAppsSummaryReportPostRequestBody currentObject = this;
