...
public class GetCompliancePolicyDeviceSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCompliancePolicyDeviceSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyDeviceSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyDeviceSummaryReportPostRequestBody currentObject = this;
