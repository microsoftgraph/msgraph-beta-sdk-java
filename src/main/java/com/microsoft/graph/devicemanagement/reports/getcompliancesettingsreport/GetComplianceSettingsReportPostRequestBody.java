...
public class GetComplianceSettingsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetComplianceSettingsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingsReportPostRequestBody currentObject = this;
