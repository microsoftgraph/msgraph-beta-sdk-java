...
public class GetConfigurationPolicyDeviceSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationPolicyDeviceSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyDeviceSummaryReportPostRequestBody currentObject = this;
