...
public class GetZebraFotaDeploymentReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getZebraFotaDeploymentReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetZebraFotaDeploymentReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetZebraFotaDeploymentReportPostRequestBody currentObject = this;
