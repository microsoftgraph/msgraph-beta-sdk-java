...
public class GetComplianceSettingDetailsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetComplianceSettingDetailsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingDetailsReportPostRequestBody currentObject = this;
