...
public class GetConfigurationSettingDetailsReportRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<InputStream> post(@jakarta.annotation.Nonnull final GetConfigurationSettingDetailsReportPostRequestBody body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<InputStream> post(@jakarta.annotation.Nonnull final GetConfigurationSettingDetailsReportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetConfigurationSettingDetailsReportPostRequestBody body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetConfigurationSettingDetailsReportPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
