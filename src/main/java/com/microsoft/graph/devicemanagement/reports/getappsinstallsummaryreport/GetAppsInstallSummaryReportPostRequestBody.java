...
public class GetAppsInstallSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a GetAppsInstallSummaryReportPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetAppsInstallSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
