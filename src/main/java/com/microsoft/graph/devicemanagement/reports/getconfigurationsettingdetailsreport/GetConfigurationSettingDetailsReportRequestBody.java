...
public class GetConfigurationSettingDetailsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationSettingDetailsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationSettingDetailsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingDetailsReportRequestBody currentObject = this;
