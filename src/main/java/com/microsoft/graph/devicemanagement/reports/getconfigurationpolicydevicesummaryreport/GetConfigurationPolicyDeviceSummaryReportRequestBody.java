...
public class GetConfigurationPolicyDeviceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationPolicyDeviceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationPolicyDeviceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPolicyDeviceSummaryReportRequestBody currentObject = this;
