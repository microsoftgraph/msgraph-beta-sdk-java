...
public class GetUnhealthyFirewallReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getUnhealthyFirewallReportRequestBody and sets the default values.
     * @return a void
     */
    public GetUnhealthyFirewallReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getUnhealthyFirewallReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyFirewallReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetUnhealthyFirewallReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyFirewallReportRequestBody currentObject = this;
