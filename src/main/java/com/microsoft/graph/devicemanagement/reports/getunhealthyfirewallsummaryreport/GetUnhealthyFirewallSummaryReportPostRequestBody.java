package com.microsoft.graph.devicemanagement.reports.getunhealthyfirewallsummaryreport;
...
public class GetUnhealthyFirewallSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyFirewallSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyFirewallSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyFirewallSummaryReportPostRequestBody currentObject = this;
