...
public class GetAppStatusOverviewReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getAppStatusOverviewReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAppStatusOverviewReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAppStatusOverviewReportPostRequestBody currentObject = this;
