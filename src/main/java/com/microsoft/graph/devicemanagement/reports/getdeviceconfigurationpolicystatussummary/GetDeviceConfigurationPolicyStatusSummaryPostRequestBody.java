...
public class GetDeviceConfigurationPolicyStatusSummaryPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetDeviceConfigurationPolicyStatusSummaryPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceConfigurationPolicyStatusSummaryPostRequestBody currentObject = this;
