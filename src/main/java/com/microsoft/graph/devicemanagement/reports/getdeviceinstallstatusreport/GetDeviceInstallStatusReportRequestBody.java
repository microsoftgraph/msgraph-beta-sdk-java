...
public class GetDeviceInstallStatusReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceInstallStatusReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceInstallStatusReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceInstallStatusReportRequestBody currentObject = this;
