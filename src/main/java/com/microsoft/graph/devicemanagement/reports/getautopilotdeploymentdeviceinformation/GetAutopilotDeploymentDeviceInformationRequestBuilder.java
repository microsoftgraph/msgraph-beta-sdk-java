...
public class GetAutopilotDeploymentDeviceInformationRequestBuilder extends BaseRequestBuilder {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a getAutopilotDeploymentDeviceInformationRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public GetAutopilotDeploymentDeviceInformationRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GetAutopilotDeploymentDeviceInformationRequestBuilder(rawUrl, requestAdapter);
    }
    /**
