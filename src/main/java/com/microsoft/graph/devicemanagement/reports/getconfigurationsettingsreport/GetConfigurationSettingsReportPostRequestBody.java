...
public class GetConfigurationSettingsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationSettingsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingsReportPostRequestBody currentObject = this;
