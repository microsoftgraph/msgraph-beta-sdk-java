...
public class GetFailedMobileAppsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public GetFailedMobileAppsReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getFailedMobileAppsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetFailedMobileAppsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetFailedMobileAppsReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetFailedMobileAppsReportRequestBody currentObject = this;
