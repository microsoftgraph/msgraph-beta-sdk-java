...
public class GetGroupPolicySettingsDeviceSettingsReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetGroupPolicySettingsDeviceSettingsReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetGroupPolicySettingsDeviceSettingsReportPostRequestBody currentObject = this;
