package microsoft.graph.devicemanagement.reports.getgrouppolicysettingsdevicesettingsreport;
...
public class GetGroupPolicySettingsDeviceSettingsReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getGroupPolicySettingsDeviceSettingsReportRequestBody and sets the default values.
     * @return a void
     */
    public GetGroupPolicySettingsDeviceSettingsReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getGroupPolicySettingsDeviceSettingsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetGroupPolicySettingsDeviceSettingsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetGroupPolicySettingsDeviceSettingsReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetGroupPolicySettingsDeviceSettingsReportRequestBody currentObject = this;
