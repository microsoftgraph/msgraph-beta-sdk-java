...
public class GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody currentObject = this;
