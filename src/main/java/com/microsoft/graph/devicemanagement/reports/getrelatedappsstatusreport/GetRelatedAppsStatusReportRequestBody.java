...
public class GetRelatedAppsStatusReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getRelatedAppsStatusReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetRelatedAppsStatusReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRelatedAppsStatusReportRequestBody currentObject = this;
