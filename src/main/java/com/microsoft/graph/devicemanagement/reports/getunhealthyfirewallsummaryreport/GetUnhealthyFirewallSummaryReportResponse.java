package microsoft.graph.devicemanagement.reports.getunhealthyfirewallsummaryreport;
...
public class GetUnhealthyFirewallSummaryReportResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyFirewallSummaryReportResponse
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyFirewallSummaryReportResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyFirewallSummaryReportResponse currentObject = this;
