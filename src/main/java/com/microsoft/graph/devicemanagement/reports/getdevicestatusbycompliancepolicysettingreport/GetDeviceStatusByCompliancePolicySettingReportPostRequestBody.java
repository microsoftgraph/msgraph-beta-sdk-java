...
public class GetDeviceStatusByCompliancePolicySettingReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetDeviceStatusByCompliancePolicySettingReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
