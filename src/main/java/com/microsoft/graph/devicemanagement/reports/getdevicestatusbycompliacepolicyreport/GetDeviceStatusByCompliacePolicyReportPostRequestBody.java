...
public class GetDeviceStatusByCompliacePolicyReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a GetDeviceStatusByCompliacePolicyReportPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetDeviceStatusByCompliacePolicyReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
