...
public class GetConfigurationPoliciesReportForDevicePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetConfigurationPoliciesReportForDevicePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationPoliciesReportForDevicePostRequestBody currentObject = this;
