...
public class GetConfigurationPoliciesReportForDeviceRequestBuilder extends BaseRequestBuilder {
    ...
    public InputStream post(@jakarta.annotation.Nonnull final GetConfigurationPoliciesReportForDevicePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public InputStream post(@jakarta.annotation.Nonnull final GetConfigurationPoliciesReportForDevicePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
