package microsoft.graph.devicemanagement.reports.getcompliancepolicydevicesreport;
...
public class GetCompliancePolicyDevicesReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCompliancePolicyDevicesReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyDevicesReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyDevicesReportRequestBody currentObject = this;
