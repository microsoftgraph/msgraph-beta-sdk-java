package com.microsoft.graph.devicemanagement.reports.getcertificatesreport;
...
public class GetCertificatesReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getCertificatesReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCertificatesReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCertificatesReportPostRequestBody currentObject = this;
