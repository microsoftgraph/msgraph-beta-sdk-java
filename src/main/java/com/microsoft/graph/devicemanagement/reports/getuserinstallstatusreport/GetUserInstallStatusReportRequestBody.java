...
public class GetUserInstallStatusReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUserInstallStatusReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUserInstallStatusReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUserInstallStatusReportRequestBody currentObject = this;
