...
public class GetEncryptionReportForDevicesPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetEncryptionReportForDevicesPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetEncryptionReportForDevicesPostRequestBody currentObject = this;
