...
public class GetWindowsQualityUpdateAlertSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsQualityUpdateAlertSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsQualityUpdateAlertSummaryReportRequestBody currentObject = this;
