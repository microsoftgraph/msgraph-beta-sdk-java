...
public class GetRelatedAppsStatusReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getRelatedAppsStatusReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetRelatedAppsStatusReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetRelatedAppsStatusReportPostRequestBody currentObject = this;
