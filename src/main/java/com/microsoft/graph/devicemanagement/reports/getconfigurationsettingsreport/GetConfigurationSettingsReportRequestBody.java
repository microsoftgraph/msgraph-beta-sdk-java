...
public class GetConfigurationSettingsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getConfigurationSettingsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetConfigurationSettingsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetConfigurationSettingsReportRequestBody currentObject = this;
