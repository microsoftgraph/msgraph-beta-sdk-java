...
public class GetWindowsUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsUpdateAlertSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsUpdateAlertSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsUpdateAlertSummaryReportPostRequestBody currentObject = this;
