...
public class GetCompliancePolicyDeviceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new getCompliancePolicyDeviceSummaryReportRequestBody and sets the default values.
     * @return a void
     */
    public GetCompliancePolicyDeviceSummaryReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getCompliancePolicyDeviceSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetCompliancePolicyDeviceSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetCompliancePolicyDeviceSummaryReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePolicyDeviceSummaryReportRequestBody currentObject = this;
