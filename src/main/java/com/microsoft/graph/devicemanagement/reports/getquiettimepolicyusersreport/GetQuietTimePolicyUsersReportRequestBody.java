...
public class GetQuietTimePolicyUsersReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getQuietTimePolicyUsersReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetQuietTimePolicyUsersReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetQuietTimePolicyUsersReportRequestBody currentObject = this;
