...
public class GetDeviceConfigurationPolicyStatusSummaryRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getDeviceConfigurationPolicyStatusSummaryRequestBody
     */
    @javax.annotation.Nonnull
    public static GetDeviceConfigurationPolicyStatusSummaryRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetDeviceConfigurationPolicyStatusSummaryRequestBody currentObject = this;
