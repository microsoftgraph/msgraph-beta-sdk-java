package microsoft.graph.devicemanagement.reports.getcompliancesettingsreport;
...
public class GetComplianceSettingsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getComplianceSettingsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetComplianceSettingsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingsReportRequestBody currentObject = this;
