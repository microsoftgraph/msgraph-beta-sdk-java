...
public class GetWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody currentObject = this;
