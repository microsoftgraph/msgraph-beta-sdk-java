...
public class GetUnhealthyFirewallSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyFirewallSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyFirewallSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyFirewallSummaryReportRequestBody currentObject = this;
