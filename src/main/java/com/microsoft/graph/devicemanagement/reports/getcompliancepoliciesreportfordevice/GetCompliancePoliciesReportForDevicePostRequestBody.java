...
public class GetCompliancePoliciesReportForDevicePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetCompliancePoliciesReportForDevicePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetCompliancePoliciesReportForDevicePostRequestBody currentObject = this;
