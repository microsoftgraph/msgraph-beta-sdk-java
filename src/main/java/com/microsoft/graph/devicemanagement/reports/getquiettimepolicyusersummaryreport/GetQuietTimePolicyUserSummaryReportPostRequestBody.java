...
public class GetQuietTimePolicyUserSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetQuietTimePolicyUserSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetQuietTimePolicyUserSummaryReportPostRequestBody currentObject = this;
