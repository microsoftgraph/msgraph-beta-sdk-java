package com.microsoft.graph.devicemanagement.reports.getwindowsqualityupdatealertsummaryreport;
...
public class GetWindowsQualityUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsQualityUpdateAlertSummaryReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertSummaryReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsQualityUpdateAlertSummaryReportPostRequestBody currentObject = this;
