...
public class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody currentObject = this;
