...
public class GetComplianceSettingDetailsReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getComplianceSettingDetailsReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetComplianceSettingDetailsReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetComplianceSettingDetailsReportRequestBody currentObject = this;
