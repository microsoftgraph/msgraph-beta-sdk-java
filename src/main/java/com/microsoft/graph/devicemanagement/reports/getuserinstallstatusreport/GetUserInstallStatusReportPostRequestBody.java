...
public class GetUserInstallStatusReportPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static GetUserInstallStatusReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUserInstallStatusReportPostRequestBody currentObject = this;
