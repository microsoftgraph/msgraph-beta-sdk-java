...
public class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
