...
public class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody currentObject = this;
