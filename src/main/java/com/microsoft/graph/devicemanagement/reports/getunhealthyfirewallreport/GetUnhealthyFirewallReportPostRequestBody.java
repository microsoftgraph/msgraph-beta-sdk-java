...
public class GetUnhealthyFirewallReportPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getUnhealthyFirewallReportPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetUnhealthyFirewallReportPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetUnhealthyFirewallReportPostRequestBody currentObject = this;
