...
public class GetAppsInstallSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getAppsInstallSummaryReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAppsInstallSummaryReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAppsInstallSummaryReportRequestBody currentObject = this;
