...
public class GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a void
     */
    public GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody
     */
    @javax.annotation.Nonnull
    public static GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody();
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody currentObject = this;
