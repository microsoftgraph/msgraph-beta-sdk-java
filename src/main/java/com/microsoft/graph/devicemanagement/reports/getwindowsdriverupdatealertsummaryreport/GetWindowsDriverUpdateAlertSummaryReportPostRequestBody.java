package com.microsoft.graph.devicemanagement.reports.getwindowsdriverupdatealertsummaryreport;
...
public class GetWindowsDriverUpdateAlertSummaryReportPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     * @return a GetWindowsDriverUpdateAlertSummaryReportPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static GetWindowsDriverUpdateAlertSummaryReportPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
