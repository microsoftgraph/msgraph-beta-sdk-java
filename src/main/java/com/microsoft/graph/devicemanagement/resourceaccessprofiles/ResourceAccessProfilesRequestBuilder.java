...
public class ResourceAccessProfilesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the resourceAccessProfiles property of the microsoft.graph.deviceManagement entity.
     * @param deviceManagementResourceAccessProfileBaseId Unique identifier of the item
     * @return a DeviceManagementResourceAccessProfileBaseItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeviceManagementResourceAccessProfileBaseItemRequestBuilder byDeviceManagementResourceAccessProfileBaseId(@javax.annotation.Nonnull final String deviceManagementResourceAccessProfileBaseId) {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBaseCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBaseCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBaseCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBaseCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase> post(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
