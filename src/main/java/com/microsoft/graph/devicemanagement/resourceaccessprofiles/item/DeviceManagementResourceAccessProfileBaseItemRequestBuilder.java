...
public class DeviceManagementResourceAccessProfileBaseItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
