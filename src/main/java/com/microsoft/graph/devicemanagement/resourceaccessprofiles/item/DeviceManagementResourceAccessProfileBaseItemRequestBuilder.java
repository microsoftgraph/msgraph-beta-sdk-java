package microsoft.graph.devicemanagement.resourceaccessprofiles.item;
...
import microsoft.graph.devicemanagement.resourceaccessprofiles.item.assign.AssignRequestBuilder;
import microsoft.graph.devicemanagement.resourceaccessprofiles.item.assignments.AssignmentsRequestBuilder;
import microsoft.graph.devicemanagement.resourceaccessprofiles.item.assignments.item.DeviceManagementResourceAccessProfileAssignmentItemRequestBuilder;
...
public class DeviceManagementResourceAccessProfileBaseItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementResourceAccessProfileBaseItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementResourceAccessProfileBase::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of deviceManagementResourceAccessProfileBase
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementResourceAccessProfileBase> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementResourceAccessProfileBaseItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementResourceAccessProfileBase::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementResourceAccessProfileBaseItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final DeviceManagementResourceAccessProfileBase body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementResourceAccessProfileBaseItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
