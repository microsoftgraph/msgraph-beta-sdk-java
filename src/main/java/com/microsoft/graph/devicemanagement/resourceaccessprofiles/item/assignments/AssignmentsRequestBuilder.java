...
public class AssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementResourceAccessProfileAssignmentCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeviceManagementResourceAccessProfileAssignmentCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public DeviceManagementResourceAccessProfileAssignment post(@jakarta.annotation.Nonnull final DeviceManagementResourceAccessProfileAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementResourceAccessProfileAssignment::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The list of assignments for the device configuration profile.
