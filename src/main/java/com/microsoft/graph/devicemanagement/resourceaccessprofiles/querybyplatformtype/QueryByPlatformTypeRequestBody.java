package microsoft.graph.devicemanagement.resourceaccessprofiles.querybyplatformtype;
...
import microsoft.graph.models.PolicyPlatformType;
/** Provides operations to call the queryByPlatformType method.  */
public class QueryByPlatformTypeRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a queryByPlatformTypeRequestBody
     */
    @javax.annotation.Nonnull
    public static QueryByPlatformTypeRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final QueryByPlatformTypeRequestBody currentObject = this;
