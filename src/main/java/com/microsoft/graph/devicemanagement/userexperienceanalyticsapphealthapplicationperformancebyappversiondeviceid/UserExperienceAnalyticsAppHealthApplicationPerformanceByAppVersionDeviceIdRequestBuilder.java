...
public class UserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDeviceIdRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdItemRequestBuilder byUserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdId(@javax.annotation.Nonnull final String userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdId) {
