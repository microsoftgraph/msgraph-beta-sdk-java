...
public class DeviceManagementConfigurationSettingItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationSetting> patch(@javax.annotation.Nonnull final DeviceManagementConfigurationSetting body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementConfigurationSettingItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.reusablePolicySettings.item.referencingConfigurationPolicies.item.settings.item.settingDefinitions.item collection
