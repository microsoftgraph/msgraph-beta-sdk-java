package com.microsoft.graph.devicemanagement.deviceshellscripts.item.devicerunstates.item;

import com.microsoft.graph.devicemanagement.deviceshellscripts.item.devicerunstates.item.manageddevice.ManagedDeviceRequestBuilder;
