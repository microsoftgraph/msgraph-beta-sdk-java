...
public class GroupAssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementScriptGroupAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptGroupAssignmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementScriptGroupAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementScriptGroupAssignmentCollectionResponse>();
