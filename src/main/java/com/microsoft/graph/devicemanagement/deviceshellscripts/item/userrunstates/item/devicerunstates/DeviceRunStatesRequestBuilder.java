package microsoft.graph.devicemanagement.deviceshellscripts.item.userrunstates.item.devicerunstates;
...
import microsoft.graph.devicemanagement.deviceshellscripts.item.userrunstates.item.devicerunstates.count.CountRequestBuilder;
