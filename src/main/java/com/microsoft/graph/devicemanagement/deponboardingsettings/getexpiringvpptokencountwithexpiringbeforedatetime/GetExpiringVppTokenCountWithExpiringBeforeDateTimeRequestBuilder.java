package com.microsoft.graph.devicemanagement.deponboardingsettings.getexpiringvpptokencountwithexpiringbeforedatetime;
...
public class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder {
     ...
     * @return a void
     */
    public GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String expiringBeforeDateTime) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    /**
     * Invoke function getExpiringVppTokenCount
     * @return a CompletableFuture of getExpiringVppTokenCountWithExpiringBeforeDateTimeResponse
     */
    public java.util.concurrent.CompletableFuture<GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetExpiringVppTokenCountWithExpiringBeforeDateTimeResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    /** Configuration for the request such as headers, query parameters, and middleware options. */
    public class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration {
        /** Request headers */
         ...
         * @return a void
         */
        public GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration() {
        }
    }
}
