...
public class UploadDepTokenRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a uploadDepTokenRequestBody
     */
    @javax.annotation.Nonnull
    public static UploadDepTokenRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UploadDepTokenRequestBody currentObject = this;
