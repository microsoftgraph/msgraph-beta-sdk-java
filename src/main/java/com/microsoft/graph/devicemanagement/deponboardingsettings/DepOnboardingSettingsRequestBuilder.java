...
public class DepOnboardingSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse>();
