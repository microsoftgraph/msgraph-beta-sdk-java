package com.microsoft.graph.devicemanagement.deponboardingsettings;

import com.microsoft.graph.devicemanagement.deponboardingsettings.count.CountRequestBuilder;
import com.microsoft.graph.devicemanagement.deponboardingsettings.getexpiringvpptokencountwithexpiringbeforedatetime.GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder;
import com.microsoft.graph.models.DepOnboardingSetting;
import com.microsoft.graph.models.DepOnboardingSettingCollectionResponse;
...
public class DepOnboardingSettingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DepOnboardingSetting body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DepOnboardingSettingCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DepOnboardingSettingCollectionResponse>();
