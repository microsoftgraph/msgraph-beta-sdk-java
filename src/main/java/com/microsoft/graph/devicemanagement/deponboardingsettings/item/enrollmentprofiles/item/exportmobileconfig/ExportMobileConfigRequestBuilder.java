...
public class ExportMobileConfigRequestBuilder {
    ...
    public ExportMobileConfigRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/enrollmentProfiles/{enrollmentProfile%2Did}/exportMobileConfig()";
    ...
    public java.util.concurrent.CompletableFuture<ExportMobileConfigResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ExportMobileConfigResponse> executionException = new java.util.concurrent.CompletableFuture<ExportMobileConfigResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExportMobileConfigResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
