package microsoft.graph.devicemanagement.deponboardingsettings.item.importedappledeviceidentities.importappledeviceidentitylist;
...
public class ImportAppleDeviceIdentityListRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a importAppleDeviceIdentityListRequestBody
     */
    @javax.annotation.Nonnull
    public static ImportAppleDeviceIdentityListRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ImportAppleDeviceIdentityListRequestBody currentObject = this;
