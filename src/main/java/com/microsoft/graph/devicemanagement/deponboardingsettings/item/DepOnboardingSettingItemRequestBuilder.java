...
public class DepOnboardingSettingItemRequestBuilder {
     ...
     * @return a CompletableFuture of depOnboardingSetting
     */
    public java.util.concurrent.CompletableFuture<DepOnboardingSetting> patch(@javax.annotation.Nonnull final DepOnboardingSetting body, @javax.annotation.Nullable final java.util.function.Consumer<DepOnboardingSettingItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of depOnboardingSetting
     */
    public java.util.concurrent.CompletableFuture<DepOnboardingSetting> patch(@javax.annotation.Nonnull final DepOnboardingSetting body, @javax.annotation.Nullable final java.util.function.Consumer<DepOnboardingSettingItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
