...
public class ImportAppleDeviceIdentityListRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ImportAppleDeviceIdentityListPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ImportAppleDeviceIdentityListPostResponse> post(@jakarta.annotation.Nonnull final ImportAppleDeviceIdentityListPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ImportAppleDeviceIdentityListPostResponse> post(@jakarta.annotation.Nonnull final ImportAppleDeviceIdentityListPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ImportAppleDeviceIdentityListPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action importAppleDeviceIdentityList
     * @param body The request body
