...
public class UpdateDeviceProfileAssignmentRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updateDeviceProfileAssignmentRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdateDeviceProfileAssignmentRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateDeviceProfileAssignmentRequestBody currentObject = this;
