...
public class ApproveAppsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("approveAllPermissions", (n) -> { currentObject.setApproveAllPermissions(n.getBooleanValue()); });
        deserializerMap.put("packageIds", (n) -> { currentObject.setPackageIds(n.getCollectionOfPrimitiveValues(String.class)); });
