...
public class SetAndroidDeviceOwnerFullyManagedEnrollmentStatePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static SetAndroidDeviceOwnerFullyManagedEnrollmentStatePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SetAndroidDeviceOwnerFullyManagedEnrollmentStatePostRequestBody currentObject = this;
