package com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings;

import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.approveapps.ApproveAppsRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.completesignup.CompleteSignupRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.creategoogleplaywebtoken.CreateGooglePlayWebTokenRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.requestsignupurl.RequestSignupUrlRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.setandroiddeviceownerfullymanagedenrollmentstate.SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.syncapps.SyncAppsRequestBuilder;
import com.microsoft.graph.devicemanagement.androidmanagedstoreaccountenterprisesettings.unbind.UnbindRequestBuilder;
...
public class AndroidManagedStoreAccountEnterpriseSettingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AndroidManagedStoreAccountEnterpriseSettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> get() {
        try {
            ...
            errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
            errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
            return this.requestAdapter.sendAsync(requestInfo, AndroidManagedStoreAccountEnterpriseSettings::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> executionException = new java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
