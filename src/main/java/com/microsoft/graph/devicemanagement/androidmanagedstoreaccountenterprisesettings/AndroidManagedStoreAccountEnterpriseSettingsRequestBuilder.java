...
public class AndroidManagedStoreAccountEnterpriseSettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> executionException = new java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
