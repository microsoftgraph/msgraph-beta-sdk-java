...
public class AndroidManagedStoreAccountEnterpriseSettingsRequestBuilder {
     ...
     * @return a CompletableFuture of androidManagedStoreAccountEnterpriseSettings
     */
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> patch(@javax.annotation.Nonnull final AndroidManagedStoreAccountEnterpriseSettings body, @javax.annotation.Nullable final java.util.function.Consumer<AndroidManagedStoreAccountEnterpriseSettingsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of androidManagedStoreAccountEnterpriseSettings
     */
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAccountEnterpriseSettings> patch(@javax.annotation.Nonnull final AndroidManagedStoreAccountEnterpriseSettings body, @javax.annotation.Nullable final java.util.function.Consumer<AndroidManagedStoreAccountEnterpriseSettingsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
