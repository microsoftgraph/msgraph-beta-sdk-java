...
public class RequestSignupUrlRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a requestSignupUrlRequestBody
     */
    @javax.annotation.Nonnull
    public static RequestSignupUrlRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RequestSignupUrlRequestBody currentObject = this;
