...
public class UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the userExperienceAnalyticsAnomalyCorrelationGroupOverview property of the microsoft.graph.deviceManagement entity.
     * @param userExperienceAnalyticsAnomalyCorrelationGroupOverviewId Unique identifier of the item
     * @return a UserExperienceAnalyticsAnomalyCorrelationGroupOverviewItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsAnomalyCorrelationGroupOverviewItemRequestBuilder byUserExperienceAnalyticsAnomalyCorrelationGroupOverviewId(@javax.annotation.Nonnull final String userExperienceAnalyticsAnomalyCorrelationGroupOverviewId) {
    ...
    public UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverview> post(@javax.annotation.Nonnull final UserExperienceAnalyticsAnomalyCorrelationGroupOverview body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverview> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverview>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsAnomalyCorrelationGroupOverview> post(@javax.annotation.Nonnull final UserExperienceAnalyticsAnomalyCorrelationGroupOverview body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsAnomalyCorrelationGroupOverview body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsAnomalyCorrelationGroupOverview body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
