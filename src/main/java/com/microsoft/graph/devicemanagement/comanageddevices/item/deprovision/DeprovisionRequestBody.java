package microsoft.graph.devicemanagement.comanageddevices.item.deprovision;
...
public class DeprovisionRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a deprovisionRequestBody
     */
    @javax.annotation.Nonnull
    public static DeprovisionRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeprovisionRequestBody currentObject = this;
