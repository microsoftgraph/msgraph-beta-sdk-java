...
public class DeviceConfigurationStateItemRequestBuilder {
     ...
     * @return a CompletableFuture of deviceConfigurationState
     */
    public java.util.concurrent.CompletableFuture<DeviceConfigurationState> patch(@javax.annotation.Nonnull final DeviceConfigurationState body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceConfigurationStateItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
