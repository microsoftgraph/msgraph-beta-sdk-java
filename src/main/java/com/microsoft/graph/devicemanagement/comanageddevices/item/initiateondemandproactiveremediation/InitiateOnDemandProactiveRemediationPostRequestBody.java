...
public class InitiateOnDemandProactiveRemediationPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public String getScriptPolicyId() {
        return this.backingStore.get("scriptPolicyId");
    }
    /**
    ...
    public void setScriptPolicyId(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("scriptPolicyId", value);
    }
}
