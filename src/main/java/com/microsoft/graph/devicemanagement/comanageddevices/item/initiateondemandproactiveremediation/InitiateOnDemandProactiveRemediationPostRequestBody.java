package com.microsoft.graph.devicemanagement.comanageddevices.item.initiateondemandproactiveremediation;
...
public class InitiateOnDemandProactiveRemediationPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static InitiateOnDemandProactiveRemediationPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setScriptPolicyId(@javax.annotation.Nullable final String value) {
