package microsoft.graph.devicemanagement.comanageddevices.item.playlostmodesound;
...
public class PlayLostModeSoundRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a playLostModeSoundRequestBody
     */
    @javax.annotation.Nonnull
    public static PlayLostModeSoundRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PlayLostModeSoundRequestBody currentObject = this;
