...
public class CleanWindowsDeviceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a cleanWindowsDeviceRequestBody
     */
    @javax.annotation.Nonnull
    public static CleanWindowsDeviceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CleanWindowsDeviceRequestBody currentObject = this;
