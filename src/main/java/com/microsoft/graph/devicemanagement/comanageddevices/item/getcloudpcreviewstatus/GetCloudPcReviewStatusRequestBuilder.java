...
public class GetCloudPcReviewStatusRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GetCloudPcReviewStatusRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcReviewStatus> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<CloudPcReviewStatus>() {{
