package com.microsoft.graph.devicemanagement.comanageddevices.item.requestremoteassistance;
...
public class RequestRemoteAssistanceRequestBuilder {
    ...
    public RequestRemoteAssistanceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/requestRemoteAssistance";
