...
public class BulkReprovisionCloudPcPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a bulkReprovisionCloudPcPostRequestBody
     */
    @javax.annotation.Nonnull
    public static BulkReprovisionCloudPcPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final BulkReprovisionCloudPcPostRequestBody currentObject = this;
