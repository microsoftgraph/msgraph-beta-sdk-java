...
public class SetDeviceNameRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a setDeviceNameRequestBody
     */
    @javax.annotation.Nonnull
    public static SetDeviceNameRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SetDeviceNameRequestBody currentObject = this;
