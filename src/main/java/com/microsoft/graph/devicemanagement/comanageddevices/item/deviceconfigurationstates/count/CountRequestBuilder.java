package com.microsoft.graph.devicemanagement.comanageddevices.item.deviceconfigurationstates.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceConfigurationStates/$count{?%24search,%24filter}";
