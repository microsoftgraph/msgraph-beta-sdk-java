package com.microsoft.graph.devicemanagement.comanageddevices.item.enablelostmode;
...
public class EnableLostModePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("footer", (n) -> { currentObject.setFooter(n.getStringValue()); });
