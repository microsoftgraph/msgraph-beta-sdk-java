package com.microsoft.graph.devicemanagement.comanageddevices.item.shutdown;
...
public class ShutDownRequestBuilder {
    ...
    public ShutDownRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/shutDown";
