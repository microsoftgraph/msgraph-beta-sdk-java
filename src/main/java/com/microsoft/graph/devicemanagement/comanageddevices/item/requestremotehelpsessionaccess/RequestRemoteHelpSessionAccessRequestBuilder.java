...
public class RequestRemoteHelpSessionAccessRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final RequestRemoteHelpSessionAccessPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RequestRemoteHelpSessionAccessResponse> post(@javax.annotation.Nonnull final RequestRemoteHelpSessionAccessPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<RequestRemoteHelpSessionAccessResponse> executionException = new java.util.concurrent.CompletableFuture<RequestRemoteHelpSessionAccessResponse>();
