package microsoft.graph.devicemanagement.comanageddevices.item.enablelostmode;
...
public class EnableLostModeRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a enableLostModeRequestBody
     */
    @javax.annotation.Nonnull
    public static EnableLostModeRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EnableLostModeRequestBody currentObject = this;
