package com.microsoft.graph.devicemanagement.comanageddevices.item.detectedapps;

import com.microsoft.graph.devicemanagement.comanageddevices.item.detectedapps.count.CountRequestBuilder;
