package com.microsoft.graph.devicemanagement.intents.item.categories.item.settingdefinitions;

import com.microsoft.graph.devicemanagement.intents.item.categories.item.settingdefinitions.count.CountRequestBuilder;
import com.microsoft.graph.devicemanagement.intents.item.categories.item.settingdefinitions.item.DeviceManagementSettingDefinitionItemRequestBuilder;
...
public class SettingDefinitionsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementSettingDefinitionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeviceManagementSettingDefinitionCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public DeviceManagementSettingDefinition post(@jakarta.annotation.Nonnull final DeviceManagementSettingDefinition body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementSettingDefinition::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The setting definitions this category contains
