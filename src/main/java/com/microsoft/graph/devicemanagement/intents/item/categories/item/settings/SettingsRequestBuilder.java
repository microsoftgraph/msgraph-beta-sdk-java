package microsoft.graph.devicemanagement.intents.item.categories.item.settings;
...
import microsoft.graph.devicemanagement.intents.item.categories.item.settings.count.CountRequestBuilder;
