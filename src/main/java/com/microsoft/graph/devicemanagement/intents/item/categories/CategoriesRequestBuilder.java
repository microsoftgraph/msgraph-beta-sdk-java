...
public class CategoriesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public DeviceManagementIntentSettingCategoryItemRequestBuilder byDeviceManagementIntentSettingCategoryId(@jakarta.annotation.Nonnull final String deviceManagementIntentSettingCategoryId) {
    ...
    public DeviceManagementIntentSettingCategoryCollectionResponse get() {
        return get(null);
    }
    /**
     * Collection of setting categories within the intent
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentSettingCategoryCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementIntentSettingCategoryCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentSettingCategory post(@jakarta.annotation.Nonnull final DeviceManagementIntentSettingCategory body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentSettingCategory post(@jakarta.annotation.Nonnull final DeviceManagementIntentSettingCategory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementIntentSettingCategory::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Collection of setting categories within the intent
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementIntentSettingCategory body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementIntentSettingCategory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
