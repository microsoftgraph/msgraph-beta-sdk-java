package com.microsoft.graph.devicemanagement.intents.item.assignments.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/assignments/$count{?%24search,%24filter}";
