...
public class IntentsRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementIntentCollectionResponse get() {
        return get(null);
    }
    /**
     * The device management intents
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementIntentCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntent post(@jakarta.annotation.Nonnull final DeviceManagementIntent body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntent post(@jakarta.annotation.Nonnull final DeviceManagementIntent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
