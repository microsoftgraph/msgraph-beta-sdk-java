...
public class IntentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the intents property of the microsoft.graph.deviceManagement entity.
     * @param deviceManagementIntentId Unique identifier of the item
     * @return a DeviceManagementIntentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeviceManagementIntentItemRequestBuilder byDeviceManagementIntentId(@javax.annotation.Nonnull final String deviceManagementIntentId) {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceManagementIntentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementIntentCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntent> post(@javax.annotation.Nonnull final DeviceManagementIntent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementIntent body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementIntent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
