package com.microsoft.graph.devicemanagement.intents.item.settings;

import com.microsoft.graph.devicemanagement.intents.item.settings.count.CountRequestBuilder;
...
public class SettingsRequestBuilder {
    ...
    public SettingsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/settings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
