...
public class DeviceSettingStateSummariesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse
     */
    ...
    public DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentDeviceSettingStateSummary post(@jakarta.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementIntentDeviceSettingStateSummary post(@jakarta.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementIntentDeviceSettingStateSummary::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Collection of settings and their states and counts of devices that belong to corresponding state for all settings within the intent
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body) {
