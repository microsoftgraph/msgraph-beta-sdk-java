...
public class DeviceSettingStateSummariesRequestBuilder {
    ...
    public DeviceSettingStateSummariesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/deviceSettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary> post(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementIntentDeviceSettingStateSummary::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of deviceManagementIntentDeviceSettingStateSummary
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary> post(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary> post(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        ...
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementIntentDeviceSettingStateSummary::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
