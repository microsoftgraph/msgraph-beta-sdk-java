...
public class DeviceSettingStateSummariesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary> post(@javax.annotation.Nonnull final DeviceManagementIntentDeviceSettingStateSummary body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementIntentDeviceSettingStateSummary>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
