...
public class WindowsDriverUpdateProfileItemRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> executionException = new java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> patch(@javax.annotation.Nonnull final WindowsDriverUpdateProfile body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final WindowsDriverUpdateProfile body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final WindowsDriverUpdateProfile body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
