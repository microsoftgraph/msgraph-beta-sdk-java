...
public class WindowsDriverUpdateProfileItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile> executionException = new java.util.concurrent.CompletableFuture<WindowsDriverUpdateProfile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
