package microsoft.graph.devicemanagement.userexperienceanalyticsbatteryhealthruntimedetails;
...
import microsoft.graph.models.UserExperienceAnalyticsBatteryHealthRuntimeDetails;
...
public class UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthRuntimeDetails body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthRuntimeDetails body, @javax.annotation.Nullable final java.util.function.Consumer<UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
