...
public class UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthRuntimeDetails> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthRuntimeDetails> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthRuntimeDetails>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
