package com.microsoft.graph.devicemanagement.userexperienceanalyticsregressionsummary.summarizedeviceregressionperformancewithsummarizeby;
...
public class SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration requestConfig = new SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetRequestConfiguration();
