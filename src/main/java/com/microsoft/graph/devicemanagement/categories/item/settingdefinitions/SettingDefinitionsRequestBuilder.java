package com.microsoft.graph.devicemanagement.categories.item.settingdefinitions;

import com.microsoft.graph.devicemanagement.categories.item.settingdefinitions.count.CountRequestBuilder;
