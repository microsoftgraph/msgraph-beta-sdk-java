...
public class CategoriesRequestBuilder extends BaseRequestBuilder {
    ...
    public DeviceManagementSettingCategoryCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeviceManagementSettingCategoryCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public DeviceManagementSettingCategory post(@jakarta.annotation.Nonnull final DeviceManagementSettingCategory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceManagementSettingCategory::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The available categories
