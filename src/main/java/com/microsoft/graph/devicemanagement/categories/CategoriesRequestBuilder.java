...
public class CategoriesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementSettingCategory body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementSettingCategoryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementSettingCategoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementSettingCategoryCollectionResponse>();
