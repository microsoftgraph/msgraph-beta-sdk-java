...
public class DeviceStatusesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceConfigurationDeviceStatus body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceConfigurationDeviceStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatusCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<DeviceConfigurationDeviceStatusCollectionResponse>() {{
