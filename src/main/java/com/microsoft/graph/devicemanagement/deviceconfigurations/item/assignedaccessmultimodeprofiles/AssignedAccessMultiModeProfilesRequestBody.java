...
public class AssignedAccessMultiModeProfilesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a assignedAccessMultiModeProfilesRequestBody
     */
    @javax.annotation.Nonnull
    public static AssignedAccessMultiModeProfilesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AssignedAccessMultiModeProfilesRequestBody currentObject = this;
