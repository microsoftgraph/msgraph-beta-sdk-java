...
public class GetTargetedUsersAndDevicesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getTargetedUsersAndDevicesRequestBody
     */
    @javax.annotation.Nonnull
    public static GetTargetedUsersAndDevicesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetTargetedUsersAndDevicesRequestBody currentObject = this;
