...
public class GetTargetedUsersAndDevicesPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<String> _deviceConfigurationIds;
    /**
    ...
    public java.util.List<String> getDeviceConfigurationIds() {
        return this._deviceConfigurationIds;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetTargetedUsersAndDevicesPostRequestBody currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(1);
        deserializerMap.put("deviceConfigurationIds", (n) -> { currentObject.setDeviceConfigurationIds(n.getCollectionOfPrimitiveValues(String.class)); });
    ...
    public void setDeviceConfigurationIds(@javax.annotation.Nullable final java.util.List<String> value) {
        this._deviceConfigurationIds = value;
    }
}
