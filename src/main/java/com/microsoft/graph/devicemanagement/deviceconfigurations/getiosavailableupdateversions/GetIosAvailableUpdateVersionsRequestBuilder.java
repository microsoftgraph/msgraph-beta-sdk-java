...
public class GetIosAvailableUpdateVersionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetIosAvailableUpdateVersionsResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetIosAvailableUpdateVersionsResponse> executionException = new java.util.concurrent.CompletableFuture<GetIosAvailableUpdateVersionsResponse>();
