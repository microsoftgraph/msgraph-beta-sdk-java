...
public class HasPayloadLinksRequestBuilder extends BaseRequestBuilder {
    ...
    public HasPayloadLinksRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/hasPayloadLinks", pathParameters);
    }
    /**
     * Instantiates a new HasPayloadLinksRequestBuilder and sets the default values.
    ...
    public HasPayloadLinksRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/hasPayloadLinks", rawUrl);
    }
    /**
