...
public class GroupAssignmentsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a DeviceConfigurationGroupAssignmentCollectionResponse
     */
    @jakarta.annotation.Nullable
    public DeviceConfigurationGroupAssignmentCollectionResponse get() {
        return get(null);
    }
    /**
     * The list of group assignments for the device configuration profile.
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceConfigurationGroupAssignmentCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, DeviceConfigurationGroupAssignmentCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceConfigurationGroupAssignment post(@jakarta.annotation.Nonnull final DeviceConfigurationGroupAssignment body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceConfigurationGroupAssignment post(@jakarta.annotation.Nonnull final DeviceConfigurationGroupAssignment body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
