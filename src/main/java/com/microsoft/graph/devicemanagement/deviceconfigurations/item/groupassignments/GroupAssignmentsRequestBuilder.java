...
public class GroupAssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the groupAssignments property of the microsoft.graph.deviceConfiguration entity.
     * @param deviceConfigurationGroupAssignmentId Unique identifier of the item
     * @return a DeviceConfigurationGroupAssignmentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public DeviceConfigurationGroupAssignmentItemRequestBuilder byDeviceConfigurationGroupAssignmentId(@javax.annotation.Nonnull final String deviceConfigurationGroupAssignmentId) {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignmentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignmentCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignmentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignment> post(@javax.annotation.Nonnull final DeviceConfigurationGroupAssignment body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignment> executionException = new java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceConfigurationGroupAssignment> post(@javax.annotation.Nonnull final DeviceConfigurationGroupAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceConfigurationGroupAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceConfigurationGroupAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
