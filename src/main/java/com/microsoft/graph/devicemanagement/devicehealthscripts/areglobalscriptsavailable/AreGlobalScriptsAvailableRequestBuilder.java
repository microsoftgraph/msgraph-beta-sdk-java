...
public class AreGlobalScriptsAvailableRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GlobalDeviceHealthScriptState> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GlobalDeviceHealthScriptState> executionException = new java.util.concurrent.CompletableFuture<GlobalDeviceHealthScriptState>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GlobalDeviceHealthScriptState> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
