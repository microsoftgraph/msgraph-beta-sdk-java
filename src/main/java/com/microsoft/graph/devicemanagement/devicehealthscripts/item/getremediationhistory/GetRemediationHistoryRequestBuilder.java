...
public class GetRemediationHistoryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationHistory> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationHistory> executionException = new java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationHistory>();
