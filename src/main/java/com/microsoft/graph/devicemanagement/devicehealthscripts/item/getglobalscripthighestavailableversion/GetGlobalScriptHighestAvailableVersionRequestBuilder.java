...
public class GetGlobalScriptHighestAvailableVersionRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse> executionException = new java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse>();
