...
public class GetGlobalScriptHighestAvailableVersionRequestBuilder {
    ...
    public GetGlobalScriptHighestAvailableVersionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/getGlobalScriptHighestAvailableVersion";
    ...
    public java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse> executionException = new java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetGlobalScriptHighestAvailableVersionResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
