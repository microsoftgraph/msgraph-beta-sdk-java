package com.microsoft.graph.devicemanagement.devicehealthscripts.getremediationsummary;
...
public class GetRemediationSummaryRequestBuilder {
    ...
    public GetRemediationSummaryRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/deviceHealthScripts/getRemediationSummary()";
    ...
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceHealthScriptRemediationSummary::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary> executionException = new java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
