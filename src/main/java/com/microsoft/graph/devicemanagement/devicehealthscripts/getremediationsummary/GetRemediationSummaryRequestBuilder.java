...
public class GetRemediationSummaryRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary> executionException = new java.util.concurrent.CompletableFuture<DeviceHealthScriptRemediationSummary>();
