...
public class DeviceHealthScriptsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse>();
