...
public class DeviceHealthScriptsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a DeviceHealthScriptCollectionResponse
     */
    @jakarta.annotation.Nullable
    public DeviceHealthScriptCollectionResponse get() {
        return get(null);
    }
    /**
     * The list of device health scripts associated with the tenant.
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceHealthScriptCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceHealthScriptCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceHealthScript post(@jakarta.annotation.Nonnull final DeviceHealthScript body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceHealthScript post(@jakarta.annotation.Nonnull final DeviceHealthScript body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceHealthScript::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * The list of device health scripts associated with the tenant.
