...
public class DeviceHealthScriptsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceHealthScriptCollectionResponse>();
