...
public class EmbeddedSIMActivationCodePoolItemRequestBuilder {
     ...
     * @return a CompletableFuture of embeddedSIMActivationCodePool
     */
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool> patch(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @javax.annotation.Nullable final java.util.function.Consumer<EmbeddedSIMActivationCodePoolItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of embeddedSIMActivationCodePool
     */
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool> patch(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @javax.annotation.Nullable final java.util.function.Consumer<EmbeddedSIMActivationCodePoolItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
