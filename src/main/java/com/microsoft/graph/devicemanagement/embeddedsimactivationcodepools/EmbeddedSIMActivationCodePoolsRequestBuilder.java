...
public class EmbeddedSIMActivationCodePoolsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the embeddedSIMActivationCodePools property of the microsoft.graph.deviceManagement entity.
     * @param embeddedSIMActivationCodePoolId Unique identifier of the item
     * @return a EmbeddedSIMActivationCodePoolItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public EmbeddedSIMActivationCodePoolItemRequestBuilder byEmbeddedSIMActivationCodePoolId(@javax.annotation.Nonnull final String embeddedSIMActivationCodePoolId) {
    ...
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EmbeddedSIMActivationCodePoolCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool> post(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
