...
public class EmbeddedSIMActivationCodePoolsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePoolCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool> post(@javax.annotation.Nonnull final EmbeddedSIMActivationCodePool body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool> executionException = new java.util.concurrent.CompletableFuture<EmbeddedSIMActivationCodePool>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
