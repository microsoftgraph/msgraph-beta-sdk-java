package microsoft.graph.devicemanagement.getassignedroledetails;
...
import microsoft.graph.models.DeviceAndAppManagementAssignedRoleDetails;
...
public class GetAssignedRoleDetailsRequestBuilder {
     ...
     * @return a void
     */
    public GetAssignedRoleDetailsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/deviceManagement/microsoft.graph.getAssignedRoleDetails()";
     ...
     * @return a void
     */
    public GetAssignedRoleDetailsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/deviceManagement/microsoft.graph.getAssignedRoleDetails()";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration requestConfig = new GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration();
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignedRoleDetails> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceAndAppManagementAssignedRoleDetails::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignedRoleDetails> get(@javax.annotation.Nullable final java.util.function.Consumer<GetAssignedRoleDetailsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceAndAppManagementAssignedRoleDetails::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
