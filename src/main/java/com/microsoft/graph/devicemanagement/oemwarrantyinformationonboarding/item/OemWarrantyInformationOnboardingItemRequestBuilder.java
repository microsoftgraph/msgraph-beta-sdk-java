package microsoft.graph.devicemanagement.oemwarrantyinformationonboarding.item;
...
import microsoft.graph.devicemanagement.oemwarrantyinformationonboarding.item.disable.DisableRequestBuilder;
import microsoft.graph.devicemanagement.oemwarrantyinformationonboarding.item.enable.EnableRequestBuilder;
...
public class OemWarrantyInformationOnboardingItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<OemWarrantyInformationOnboardingItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of oemWarrantyInformationOnboarding
     */
    public java.util.concurrent.CompletableFuture<OemWarrantyInformationOnboarding> get(@javax.annotation.Nullable final java.util.function.Consumer<OemWarrantyInformationOnboardingItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final OemWarrantyInformationOnboarding body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final OemWarrantyInformationOnboarding body, @javax.annotation.Nullable final java.util.function.Consumer<OemWarrantyInformationOnboardingItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final OemWarrantyInformationOnboarding body, @javax.annotation.Nullable final java.util.function.Consumer<OemWarrantyInformationOnboardingItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
