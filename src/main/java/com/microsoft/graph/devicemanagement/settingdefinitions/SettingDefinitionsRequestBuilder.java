...
public class SettingDefinitionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementSettingDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinitionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinitionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinitionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinition> post(@javax.annotation.Nonnull final DeviceManagementSettingDefinition body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinition> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementSettingDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
