...
public class UserExperienceAnalyticsSummarizedDeviceScopesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDeviceScopeSummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDeviceScopeSummary> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsDeviceScopeSummary>();
