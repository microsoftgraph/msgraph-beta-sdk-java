...
public class UserExperienceAnalyticsSummarizedDeviceScopesRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public UserExperienceAnalyticsDeviceScopeSummary get() {
        return get(null);
    }
    /**
     * Invoke function userExperienceAnalyticsSummarizedDeviceScopes
     ...
     */
    @jakarta.annotation.Nullable
    public UserExperienceAnalyticsDeviceScopeSummary get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, UserExperienceAnalyticsDeviceScopeSummary::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function userExperienceAnalyticsSummarizedDeviceScopes
