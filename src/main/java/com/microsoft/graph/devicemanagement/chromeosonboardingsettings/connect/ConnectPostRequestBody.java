...
public class ConnectPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public String getOwnerAccessToken() {
        return this.BackingStore.get("ownerAccessToken");
    }
    /**
    ...
    public void setOwnerAccessToken(@jakarta.annotation.Nullable final String value) {
        this.BackingStore.set("ownerAccessToken", value);
    }
    /**
