...
public class ConnectPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ConnectPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ConnectPostRequestBody currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("ownerAccessToken", (n) -> { currentObject.setOwnerAccessToken(n.getStringValue()); });
