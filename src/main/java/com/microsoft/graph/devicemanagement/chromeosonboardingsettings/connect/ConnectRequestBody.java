...
public class ConnectRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a connectRequestBody
     */
    @javax.annotation.Nonnull
    public static ConnectRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ConnectRequestBody currentObject = this;
