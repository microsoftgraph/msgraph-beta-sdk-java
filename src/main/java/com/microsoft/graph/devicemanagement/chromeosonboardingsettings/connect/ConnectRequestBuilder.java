...
public class ConnectRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ConnectPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ChromeOSOnboardingStatus> post(@javax.annotation.Nonnull final ConnectPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ChromeOSOnboardingStatus> executionException = new java.util.concurrent.CompletableFuture<ChromeOSOnboardingStatus>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ChromeOSOnboardingStatus> post(@javax.annotation.Nonnull final ConnectPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
