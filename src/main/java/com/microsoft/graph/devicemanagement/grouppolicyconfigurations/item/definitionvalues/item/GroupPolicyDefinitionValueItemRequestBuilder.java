...
public class GroupPolicyDefinitionValueItemRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public GroupPolicyDefinitionValue get() {
        return get(null);
    }
    /**
     * The list of enabled or disabled group policy definition values for the configuration.
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyDefinitionValue get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GroupPolicyDefinitionValue::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyDefinitionValue patch(@jakarta.annotation.Nonnull final GroupPolicyDefinitionValue body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyDefinitionValue patch(@jakarta.annotation.Nonnull final GroupPolicyDefinitionValue body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GroupPolicyDefinitionValue body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final GroupPolicyDefinitionValue body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public GroupPolicyDefinitionValueItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new GroupPolicyDefinitionValueItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
