...
public class GroupPolicyDefinitionValueItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final GroupPolicyDefinitionValue body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValue> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValue> executionException = new java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValue>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
