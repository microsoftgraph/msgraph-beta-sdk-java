...
public class DefinitionValuesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GroupPolicyDefinitionValue body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValueCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValueCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<GroupPolicyDefinitionValueCollectionResponse>();
