...
public class DataSharingConsentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DataSharingConsent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DataSharingConsentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DataSharingConsentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DataSharingConsentCollectionResponse>();
