...
public class GetAllElevationRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public GetAllElevationRequestsPostResponse post() {
        return post(null);
    }
    /**
     * Invoke action getAllElevationRequests
     ...
     */
    @jakarta.annotation.Nullable
    public GetAllElevationRequestsPostResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, GetAllElevationRequestsPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action getAllElevationRequests
