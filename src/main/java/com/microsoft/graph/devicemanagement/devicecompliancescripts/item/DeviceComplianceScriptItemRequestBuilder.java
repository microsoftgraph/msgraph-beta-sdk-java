...
public class DeviceComplianceScriptItemRequestBuilder {
     ...
     * @return a CompletableFuture of deviceComplianceScript
     */
    public java.util.concurrent.CompletableFuture<DeviceComplianceScript> patch(@javax.annotation.Nonnull final DeviceComplianceScript body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceComplianceScriptItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of deviceComplianceScript
     */
    public java.util.concurrent.CompletableFuture<DeviceComplianceScript> patch(@javax.annotation.Nonnull final DeviceComplianceScript body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceComplianceScriptItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
