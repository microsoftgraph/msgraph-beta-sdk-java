...
public class DeviceRunStatesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public DeviceComplianceScriptDeviceStateItemRequestBuilder byDeviceComplianceScriptDeviceStateId(@jakarta.annotation.Nonnull final String deviceComplianceScriptDeviceStateId) {
     ...
     * @return a DeviceComplianceScriptDeviceStateCollectionResponse
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceScriptDeviceStateCollectionResponse get() {
        return get(null);
    }
    /**
     * List of run states for the device compliance script across all devices
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceScriptDeviceStateCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceComplianceScriptDeviceStateCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceScriptDeviceState post(@jakarta.annotation.Nonnull final DeviceComplianceScriptDeviceState body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceComplianceScriptDeviceState post(@jakarta.annotation.Nonnull final DeviceComplianceScriptDeviceState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DeviceComplianceScriptDeviceState::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * List of run states for the device compliance script across all devices
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceComplianceScriptDeviceState body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceComplianceScriptDeviceState body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
