...
public class DeviceRunStatesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceComplianceScriptDeviceState body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceStateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceStateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceStateCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceState> post(@javax.annotation.Nonnull final DeviceComplianceScriptDeviceState body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceState> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceScriptDeviceState>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
