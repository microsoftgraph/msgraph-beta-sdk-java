...
public class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the userExperienceAnalyticsBatteryHealthOsPerformance property of the microsoft.graph.deviceManagement entity.
     * @param userExperienceAnalyticsBatteryHealthOsPerformanceId Unique identifier of the item
     * @return a UserExperienceAnalyticsBatteryHealthOsPerformanceItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsBatteryHealthOsPerformanceItemRequestBuilder byUserExperienceAnalyticsBatteryHealthOsPerformanceId(@javax.annotation.Nonnull final String userExperienceAnalyticsBatteryHealthOsPerformanceId) {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformance> post(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthOsPerformance body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthOsPerformance body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthOsPerformance body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
