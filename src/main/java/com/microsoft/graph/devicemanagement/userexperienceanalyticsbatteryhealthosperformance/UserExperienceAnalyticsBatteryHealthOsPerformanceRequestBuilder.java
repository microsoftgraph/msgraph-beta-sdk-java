...
public class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse>();
