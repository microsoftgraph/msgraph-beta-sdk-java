...
public class OrganizationalMessageDetailItemRequestBuilder {
     ...
     * @return a CompletableFuture of organizationalMessageDetail
     */
    public java.util.concurrent.CompletableFuture<OrganizationalMessageDetail> patch(@javax.annotation.Nonnull final OrganizationalMessageDetail body, @javax.annotation.Nullable final java.util.function.Consumer<OrganizationalMessageDetailItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
