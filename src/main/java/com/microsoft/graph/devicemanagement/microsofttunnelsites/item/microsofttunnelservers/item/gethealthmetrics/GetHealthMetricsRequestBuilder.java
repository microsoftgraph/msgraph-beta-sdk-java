...
public class GetHealthMetricsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetHealthMetricsPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetHealthMetricsPostResponse> post(@jakarta.annotation.Nonnull final GetHealthMetricsPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetHealthMetricsPostResponse> post(@jakarta.annotation.Nonnull final GetHealthMetricsPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetHealthMetricsPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action getHealthMetrics
     * @param body The request body
