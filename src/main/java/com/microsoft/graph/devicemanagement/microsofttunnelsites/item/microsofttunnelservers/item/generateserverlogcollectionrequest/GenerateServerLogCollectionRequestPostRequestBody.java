...
public class GenerateServerLogCollectionRequestPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a generateServerLogCollectionRequestPostRequestBody
     */
    @javax.annotation.Nonnull
    public static GenerateServerLogCollectionRequestPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GenerateServerLogCollectionRequestPostRequestBody currentObject = this;
