...
import microsoft.graph.models.MetricTimeSeriesDataPoint;
/** Provides operations to call the getHealthMetricTimeSeries method.  */
public class GetHealthMetricTimeSeriesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private Map<String, Object> _additionalData;
    /** The value property  */
    private java.util.List<MetricTimeSeriesDataPoint> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetHealthMetricTimeSeriesResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(MetricTimeSeriesDataPoint::createFromDiscriminatorValue)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final java.util.List<MetricTimeSeriesDataPoint> value) {
        this._value = value;
    }
}
