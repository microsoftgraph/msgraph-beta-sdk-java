...
public class GetHealthMetricsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getHealthMetricsRequestBody
     */
    @javax.annotation.Nonnull
    public static GetHealthMetricsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetHealthMetricsRequestBody currentObject = this;
