...
public class CancelRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CancelResponse> post() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CancelResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<CancelResponse> executionException = new java.util.concurrent.CompletableFuture<CancelResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CancelResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
