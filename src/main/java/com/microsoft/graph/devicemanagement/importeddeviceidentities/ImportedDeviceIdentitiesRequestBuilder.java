...
public class ImportedDeviceIdentitiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ImportedDeviceIdentity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ImportedDeviceIdentityCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ImportedDeviceIdentityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ImportedDeviceIdentityCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ImportedDeviceIdentity> post(@javax.annotation.Nonnull final ImportedDeviceIdentity body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ImportedDeviceIdentity> executionException = new java.util.concurrent.CompletableFuture<ImportedDeviceIdentity>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
