...
public class SearchExistingIdentitiesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a searchExistingIdentitiesRequestBody
     */
    @javax.annotation.Nonnull
    public static SearchExistingIdentitiesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SearchExistingIdentitiesRequestBody currentObject = this;
