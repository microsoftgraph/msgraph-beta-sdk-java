...
public class ImportDeviceIdentityListRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a importDeviceIdentityListRequestBody
     */
    @javax.annotation.Nonnull
    public static ImportDeviceIdentityListRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ImportDeviceIdentityListRequestBody currentObject = this;
