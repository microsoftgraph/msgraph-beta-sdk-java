package microsoft.graph.devicemanagement.importeddeviceidentities.importdeviceidentitylist;
...
import microsoft.graph.models.ImportedDeviceIdentityResult;
/** Provides operations to call the importDeviceIdentityList method.  */
public class ImportDeviceIdentityListResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.  */
    private Map<String, Object> _additionalData;
    /** The value property  */
    private java.util.List<ImportedDeviceIdentityResult> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ImportDeviceIdentityListResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(ImportedDeviceIdentityResult::createFromDiscriminatorValue)); });
        }};
    }
    /**
