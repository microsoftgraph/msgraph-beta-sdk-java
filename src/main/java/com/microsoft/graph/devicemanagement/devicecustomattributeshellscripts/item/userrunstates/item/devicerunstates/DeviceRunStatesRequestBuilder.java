package microsoft.graph.devicemanagement.devicecustomattributeshellscripts.item.userrunstates.item.devicerunstates;
...
import microsoft.graph.devicemanagement.devicecustomattributeshellscripts.item.userrunstates.item.devicerunstates.count.CountRequestBuilder;
import microsoft.graph.models.DeviceManagementScriptDeviceState;
import microsoft.graph.models.DeviceManagementScriptDeviceStateCollectionResponse;
...
public class DeviceRunStatesRequestBuilder {
    ...
    public DeviceRunStatesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceStateCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementScriptDeviceStateCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of DeviceManagementScriptDeviceStateCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceStateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<DeviceRunStatesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeviceManagementScriptDeviceStateCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
