package com.microsoft.graph.devicemanagement.devicecustomattributeshellscripts.item.devicerunstates.item.manageddevice;
...
public class ManagedDeviceRequestBuilder {
    ...
    public ManagedDeviceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}/managedDevice{?%24select,%24expand}";
