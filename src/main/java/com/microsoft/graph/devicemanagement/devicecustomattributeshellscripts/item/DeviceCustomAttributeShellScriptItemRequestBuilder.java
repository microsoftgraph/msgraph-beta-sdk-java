...
public class DeviceCustomAttributeShellScriptItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.deviceCustomAttributeShellScripts.item.assignments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.deviceCustomAttributeShellScripts.item.deviceRunStates.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.deviceCustomAttributeShellScripts.item.groupAssignments.item collection
     * @param id Unique identifier of the item
     ...
     * @return a CompletableFuture of deviceCustomAttributeShellScript
     */
    public java.util.concurrent.CompletableFuture<DeviceCustomAttributeShellScript> patch(@javax.annotation.Nonnull final DeviceCustomAttributeShellScript body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCustomAttributeShellScriptItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of deviceCustomAttributeShellScript
     */
    public java.util.concurrent.CompletableFuture<DeviceCustomAttributeShellScript> patch(@javax.annotation.Nonnull final DeviceCustomAttributeShellScript body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceCustomAttributeShellScriptItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.deviceCustomAttributeShellScripts.item.userRunStates.item collection
     * @param id Unique identifier of the item
