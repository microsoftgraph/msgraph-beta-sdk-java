package microsoft.graph.devicemanagement.devicecustomattributeshellscripts.item.devicerunstates;
...
import microsoft.graph.devicemanagement.devicecustomattributeshellscripts.item.devicerunstates.count.CountRequestBuilder;
...
public class DeviceRunStatesRequestBuilder {
    ...
    public DeviceRunStatesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/deviceRunStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
