...
import com.microsoft.graph.devicemanagement.privilegemanagementelevations.PrivilegeManagementElevationsRequestBuilder;
...
import com.microsoft.graph.devicemanagement.userexperienceanalyticsanomalycorrelationgroupoverview.UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder;
...
public class DeviceManagementRequestBuilder extends BaseRequestBuilder {
    ...
    public PrivilegeManagementElevationsRequestBuilder privilegeManagementElevations() {
        return new PrivilegeManagementElevationsRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder userExperienceAnalyticsAnomalyCorrelationGroupOverview() {
        return new UserExperienceAnalyticsAnomalyCorrelationGroupOverviewRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DeviceManagement body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final DeviceManagement body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
