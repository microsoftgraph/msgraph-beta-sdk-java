...
public class UserExperienceAnalyticsBatteryHealthDevicePerformanceItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthDevicePerformance> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthDevicePerformance> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsBatteryHealthDevicePerformance>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
