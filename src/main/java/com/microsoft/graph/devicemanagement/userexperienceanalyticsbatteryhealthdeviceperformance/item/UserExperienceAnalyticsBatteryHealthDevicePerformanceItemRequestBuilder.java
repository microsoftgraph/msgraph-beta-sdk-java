package microsoft.graph.devicemanagement.userexperienceanalyticsbatteryhealthdeviceperformance.item;
...
import microsoft.graph.models.UserExperienceAnalyticsBatteryHealthDevicePerformance;
...
public class UserExperienceAnalyticsBatteryHealthDevicePerformanceItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthDevicePerformance body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthDevicePerformance body, @javax.annotation.Nullable final java.util.function.Consumer<UserExperienceAnalyticsBatteryHealthDevicePerformanceItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
