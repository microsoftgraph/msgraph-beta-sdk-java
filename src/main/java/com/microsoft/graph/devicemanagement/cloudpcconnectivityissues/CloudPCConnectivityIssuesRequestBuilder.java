...
public class CloudPCConnectivityIssuesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CloudPCConnectivityIssueCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CloudPCConnectivityIssueCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CloudPCConnectivityIssueCollectionResponse>();
