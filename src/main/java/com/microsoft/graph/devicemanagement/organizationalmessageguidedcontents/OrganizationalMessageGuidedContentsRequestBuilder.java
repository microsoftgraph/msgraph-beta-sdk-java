...
public class OrganizationalMessageGuidedContentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OrganizationalMessageGuidedContentCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OrganizationalMessageGuidedContentCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<OrganizationalMessageGuidedContentCollectionResponse>() {{
