...
public class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryRequestBuilder extends BaseRequestBuilder {
    ...
    public UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory post(@jakarta.annotation.Nonnull final UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * User Experience Analytics Battery Health Device Runtime History
