...
public class GetAssignmentFiltersStatusDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AssignmentFilterStatusDetails> post(@jakarta.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AssignmentFilterStatusDetails> executionException = new java.util.concurrent.CompletableFuture<AssignmentFilterStatusDetails>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AssignmentFilterStatusDetails> post(@jakarta.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
