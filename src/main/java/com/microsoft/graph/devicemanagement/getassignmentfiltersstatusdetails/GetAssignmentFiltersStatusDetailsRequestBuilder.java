...
public class GetAssignmentFiltersStatusDetailsRequestBuilder {
    ...
    public GetAssignmentFiltersStatusDetailsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/getAssignmentFiltersStatusDetails";
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AssignmentFilterStatusDetails> post(@javax.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GetAssignmentFiltersStatusDetailsPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
