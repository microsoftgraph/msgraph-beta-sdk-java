...
public class GetAssignmentFiltersStatusDetailsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getAssignmentFiltersStatusDetailsRequestBody
     */
    @javax.annotation.Nonnull
    public static GetAssignmentFiltersStatusDetailsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetAssignmentFiltersStatusDetailsRequestBody currentObject = this;
