...
public class GetAuditCategoriesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse>() {{
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetAuditCategoriesResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
