...
public class MobileThreatDefenseConnectorsRequestBuilder extends BaseRequestBuilder {
    ...
    public MobileThreatDefenseConnectorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MobileThreatDefenseConnectorsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MobileThreatDefenseConnector body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final MobileThreatDefenseConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
