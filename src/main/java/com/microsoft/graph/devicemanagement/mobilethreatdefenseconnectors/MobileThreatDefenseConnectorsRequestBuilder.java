...
public class MobileThreatDefenseConnectorsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MobileThreatDefenseConnector body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MobileThreatDefenseConnector body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<MobileThreatDefenseConnectorCollectionResponse>() {{
