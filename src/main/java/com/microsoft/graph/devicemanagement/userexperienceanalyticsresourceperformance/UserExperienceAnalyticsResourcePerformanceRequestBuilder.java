...
public class UserExperienceAnalyticsResourcePerformanceRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformanceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformanceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformanceCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformance> post(@javax.annotation.Nonnull final UserExperienceAnalyticsResourcePerformance body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformance> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsResourcePerformance>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
