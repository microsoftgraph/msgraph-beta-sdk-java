...
public class SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse> executionException = new java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse>();
