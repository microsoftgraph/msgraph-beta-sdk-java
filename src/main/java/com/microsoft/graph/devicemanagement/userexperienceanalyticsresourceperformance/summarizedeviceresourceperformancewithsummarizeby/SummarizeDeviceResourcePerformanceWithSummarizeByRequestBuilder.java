...
public class SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse> executionException = new java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SummarizeDeviceResourcePerformanceWithSummarizeByResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
