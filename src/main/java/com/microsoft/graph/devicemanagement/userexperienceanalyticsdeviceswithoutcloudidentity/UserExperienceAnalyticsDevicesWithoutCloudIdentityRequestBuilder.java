...
public class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the userExperienceAnalyticsDevicesWithoutCloudIdentity property of the microsoft.graph.deviceManagement entity.
     * @param userExperienceAnalyticsDeviceWithoutCloudIdentityId Unique identifier of the item
     * @return a UserExperienceAnalyticsDeviceWithoutCloudIdentityItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsDeviceWithoutCloudIdentityItemRequestBuilder byUserExperienceAnalyticsDeviceWithoutCloudIdentityId(@javax.annotation.Nonnull final String userExperienceAnalyticsDeviceWithoutCloudIdentityId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsDeviceWithoutCloudIdentity body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsDeviceWithoutCloudIdentity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
