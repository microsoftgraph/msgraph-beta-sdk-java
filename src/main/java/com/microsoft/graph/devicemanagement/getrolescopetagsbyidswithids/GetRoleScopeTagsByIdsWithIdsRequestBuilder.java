package com.microsoft.graph.devicemanagement.getrolescopetagsbyidswithids;
...
public class GetRoleScopeTagsByIdsWithIdsRequestBuilder {
    ...
    public GetRoleScopeTagsByIdsWithIdsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String ids) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/getRoleScopeTagsByIds(ids={ids}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
    ...
    public java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, GetRoleScopeTagsByIdsWithIdsResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse> executionException = new java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
