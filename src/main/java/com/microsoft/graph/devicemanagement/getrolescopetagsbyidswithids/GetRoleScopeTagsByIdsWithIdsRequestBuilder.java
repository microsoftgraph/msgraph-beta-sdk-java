...
public class GetRoleScopeTagsByIdsWithIdsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse> executionException = new java.util.concurrent.CompletableFuture<GetRoleScopeTagsByIdsWithIdsResponse>();
