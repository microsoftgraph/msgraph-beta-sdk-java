...
public class ScheduledActionsForRuleRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a DeviceManagementComplianceScheduledActionForRuleCollectionResponse
     */
    ...
    public DeviceManagementComplianceScheduledActionForRuleCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeviceManagementComplianceScheduledActionForRuleCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementComplianceScheduledActionForRule post(@jakarta.annotation.Nonnull final DeviceManagementComplianceScheduledActionForRule body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DeviceManagementComplianceScheduledActionForRule post(@jakarta.annotation.Nonnull final DeviceManagementComplianceScheduledActionForRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementComplianceScheduledActionForRule body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final DeviceManagementComplianceScheduledActionForRule body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
