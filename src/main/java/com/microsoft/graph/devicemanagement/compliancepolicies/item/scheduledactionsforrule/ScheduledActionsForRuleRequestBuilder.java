...
public class ScheduledActionsForRuleRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementComplianceScheduledActionForRule body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementComplianceScheduledActionForRuleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementComplianceScheduledActionForRuleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementComplianceScheduledActionForRuleCollectionResponse>();
