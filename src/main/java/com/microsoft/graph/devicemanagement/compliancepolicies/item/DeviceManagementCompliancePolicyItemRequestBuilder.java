...
public class DeviceManagementCompliancePolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of deviceManagementCompliancePolicy
     */
    public java.util.concurrent.CompletableFuture<DeviceManagementCompliancePolicy> patch(@javax.annotation.Nonnull final DeviceManagementCompliancePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<DeviceManagementCompliancePolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
