...
public class DeviceManagementCompliancePolicyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeviceManagementCompliancePolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementCompliancePolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementCompliancePolicy> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementCompliancePolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
