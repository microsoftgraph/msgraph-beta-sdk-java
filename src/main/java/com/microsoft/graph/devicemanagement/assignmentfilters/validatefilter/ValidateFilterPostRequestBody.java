...
public class ValidateFilterPostRequestBody implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public DeviceAndAppManagementAssignmentFilter getDeviceAndAppManagementAssignmentFilter() {
        return this.backingStore.get("deviceAndAppManagementAssignmentFilter");
    }
    /**
    ...
    public void setDeviceAndAppManagementAssignmentFilter(@jakarta.annotation.Nullable final DeviceAndAppManagementAssignmentFilter value) {
        this.backingStore.set("deviceAndAppManagementAssignmentFilter", value);
    }
}
