...
public class ValidateFilterPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ValidateFilterPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceAndAppManagementAssignmentFilter", (n) -> { currentObject.setDeviceAndAppManagementAssignmentFilter(n.getObjectValue(DeviceAndAppManagementAssignmentFilter::createFromDiscriminatorValue)); });
