...
public class GetPlatformSupportedPropertiesWithPlatformRequestBuilder {
    ...
    public GetPlatformSupportedPropertiesWithPlatformRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String platform) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/assignmentFilters/getPlatformSupportedProperties(platform='{platform}'){?%24top,%24skip,%24search,%24filter,%24count}";
    ...
    public java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse> executionException = new java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
