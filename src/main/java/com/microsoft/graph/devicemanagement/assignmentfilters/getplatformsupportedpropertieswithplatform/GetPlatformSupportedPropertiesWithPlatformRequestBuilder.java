...
public class GetPlatformSupportedPropertiesWithPlatformRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse> executionException = new java.util.concurrent.CompletableFuture<GetPlatformSupportedPropertiesWithPlatformResponse>();
