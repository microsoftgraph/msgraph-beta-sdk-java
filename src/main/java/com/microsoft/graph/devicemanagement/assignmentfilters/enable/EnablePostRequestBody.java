...
public class EnablePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static EnablePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EnablePostRequestBody currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(1);
        deserializerMap.put("enable", (n) -> { currentObject.setEnable(n.getBooleanValue()); });
