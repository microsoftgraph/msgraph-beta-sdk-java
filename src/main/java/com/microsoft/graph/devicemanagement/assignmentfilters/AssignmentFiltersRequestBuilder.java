...
public class AssignmentFiltersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilterCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilterCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilterCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilter> post(@javax.annotation.Nonnull final DeviceAndAppManagementAssignmentFilter body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilter> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementAssignmentFilter>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
