...
public class IosUpdateStatusesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IosUpdateDeviceStatus body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IosUpdateDeviceStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IosUpdateDeviceStatusCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<IosUpdateDeviceStatusCollectionResponse>() {{
