package com.microsoft.graph.devicemanagement.androidforworkenrollmentprofiles.item.revoketoken;
...
public class RevokeTokenRequestBuilder {
    ...
    public RevokeTokenRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/androidForWorkEnrollmentProfiles/{androidForWorkEnrollmentProfile%2Did}/revokeToken";
