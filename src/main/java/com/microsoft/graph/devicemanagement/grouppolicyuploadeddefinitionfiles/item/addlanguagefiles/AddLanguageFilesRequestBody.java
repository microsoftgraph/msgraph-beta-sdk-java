package microsoft.graph.devicemanagement.grouppolicyuploadeddefinitionfiles.item.addlanguagefiles;
...
public class AddLanguageFilesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a addLanguageFilesRequestBody
     */
    @javax.annotation.Nonnull
    public static AddLanguageFilesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AddLanguageFilesRequestBody currentObject = this;
