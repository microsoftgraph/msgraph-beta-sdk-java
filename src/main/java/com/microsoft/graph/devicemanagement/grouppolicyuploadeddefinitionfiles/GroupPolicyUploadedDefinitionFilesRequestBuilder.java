...
public class GroupPolicyUploadedDefinitionFilesRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupPolicyUploadedDefinitionFileCollectionResponse get() {
        return get(null);
    }
    /**
     * The available group policy uploaded definition files for this account.
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyUploadedDefinitionFileCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GroupPolicyUploadedDefinitionFileCollectionResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyUploadedDefinitionFile post(@jakarta.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GroupPolicyUploadedDefinitionFile post(@jakarta.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GroupPolicyUploadedDefinitionFile::createFromDiscriminatorValue);
    }
    /**
     * The available group policy uploaded definition files for this account.
