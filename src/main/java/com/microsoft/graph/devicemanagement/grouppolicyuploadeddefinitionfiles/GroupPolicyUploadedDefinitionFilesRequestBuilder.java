...
public class GroupPolicyUploadedDefinitionFilesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the groupPolicyUploadedDefinitionFiles property of the microsoft.graph.deviceManagement entity.
     * @param groupPolicyUploadedDefinitionFileId Unique identifier of the item
     * @return a GroupPolicyUploadedDefinitionFileItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public GroupPolicyUploadedDefinitionFileItemRequestBuilder byGroupPolicyUploadedDefinitionFileId(@javax.annotation.Nonnull final String groupPolicyUploadedDefinitionFileId) {
    ...
    public java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFileCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFileCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFileCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFileCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFile> post(@javax.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFile> executionException = new java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFile>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyUploadedDefinitionFile> post(@javax.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final GroupPolicyUploadedDefinitionFile body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
