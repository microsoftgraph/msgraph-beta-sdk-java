...
public class UpdateLanguageFilesRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updateLanguageFilesRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdateLanguageFilesRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateLanguageFilesRequestBody currentObject = this;
