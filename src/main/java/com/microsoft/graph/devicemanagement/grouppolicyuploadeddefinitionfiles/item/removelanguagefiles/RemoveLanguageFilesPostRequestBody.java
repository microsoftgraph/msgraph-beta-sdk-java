...
public class RemoveLanguageFilesPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static RemoveLanguageFilesPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RemoveLanguageFilesPostRequestBody currentObject = this;
