package com.microsoft.graph.devicemanagement.grouppolicydefinitions.item.presentations.item.definition;
...
public class DefinitionRequestBuilder {
    ...
    public DefinitionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/presentations/{groupPolicyPresentation%2Did}/definition{?%24select,%24expand}";
