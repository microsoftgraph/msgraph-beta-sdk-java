package com.microsoft.graph.devicemanagement.grouppolicydefinitions.item.previousversiondefinition.definitionfile;
...
public class DefinitionFileRequestBuilder {
    ...
    public DefinitionFileRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/definitionFile{?%24select,%24expand}";
