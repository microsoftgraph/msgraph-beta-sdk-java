...
public class CategoryRequestBuilder extends BaseRequestBuilder {
    ...
    public CategoryRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/category{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CategoryRequestBuilder and sets the default values.
    ...
    public CategoryRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/category{?%24select,%24expand}", rawUrl);
    }
    /**
