...
public class PreviousVersionDefinitionRequestBuilder extends BaseRequestBuilder {
    ...
    public PreviousVersionDefinitionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PreviousVersionDefinitionRequestBuilder and sets the default values.
    ...
    public PreviousVersionDefinitionRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24select,%24expand}", rawUrl);
    }
    /**
