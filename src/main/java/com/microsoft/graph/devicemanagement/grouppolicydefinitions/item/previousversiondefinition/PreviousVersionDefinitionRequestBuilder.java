...
public class PreviousVersionDefinitionRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final GroupPolicyDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<GroupPolicyDefinition> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<GroupPolicyDefinition> executionException = new java.util.concurrent.CompletableFuture<GroupPolicyDefinition>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
