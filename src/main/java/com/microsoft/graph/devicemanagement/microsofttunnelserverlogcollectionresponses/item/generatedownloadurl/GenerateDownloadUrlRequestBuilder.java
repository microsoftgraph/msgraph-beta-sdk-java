...
public class GenerateDownloadUrlRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GenerateDownloadUrlPostResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GenerateDownloadUrlPostResponse> post() {
        return post(null);
    }
    /**
     * Invoke action generateDownloadUrl
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GenerateDownloadUrlPostResponse> post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GenerateDownloadUrlPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke action generateDownloadUrl
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a GenerateDownloadUrlRequestBuilder
     */
    @jakarta.annotation.Nonnull
