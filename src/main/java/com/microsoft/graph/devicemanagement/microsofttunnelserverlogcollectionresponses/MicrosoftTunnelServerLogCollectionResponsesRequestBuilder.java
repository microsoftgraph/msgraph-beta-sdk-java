...
public class MicrosoftTunnelServerLogCollectionResponsesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MicrosoftTunnelServerLogCollectionResponse body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponseCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponseCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponseCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponse> post(@javax.annotation.Nonnull final MicrosoftTunnelServerLogCollectionResponse body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MicrosoftTunnelServerLogCollectionResponse>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
