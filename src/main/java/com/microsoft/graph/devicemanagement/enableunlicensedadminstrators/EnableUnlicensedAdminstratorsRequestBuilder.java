package microsoft.graph.devicemanagement.enableunlicensedadminstrators;
...
public class EnableUnlicensedAdminstratorsRequestBuilder {
    ...
    public EnableUnlicensedAdminstratorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/microsoft.graph.enableUnlicensedAdminstrators";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<EnableUnlicensedAdminstratorsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final EnableUnlicensedAdminstratorsRequestBuilderPostRequestConfiguration requestConfig = new EnableUnlicensedAdminstratorsRequestBuilderPostRequestConfiguration();
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nullable final java.util.function.Consumer<EnableUnlicensedAdminstratorsRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nullable final java.util.function.Consumer<EnableUnlicensedAdminstratorsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
