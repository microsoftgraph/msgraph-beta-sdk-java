...
public class TenantAttachRBACRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TenantAttachRBAC body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TenantAttachRBAC> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TenantAttachRBAC> executionException = new java.util.concurrent.CompletableFuture<TenantAttachRBAC>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
