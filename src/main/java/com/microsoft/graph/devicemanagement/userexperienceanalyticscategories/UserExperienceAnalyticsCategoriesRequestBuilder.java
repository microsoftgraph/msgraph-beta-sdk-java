...
public class UserExperienceAnalyticsCategoriesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public UserExperienceAnalyticsCategoryItemRequestBuilder byUserExperienceAnalyticsCategoryId(@javax.annotation.Nonnull final String userExperienceAnalyticsCategoryId) {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsCategoryCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserExperienceAnalyticsCategoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsCategoryCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsCategoryCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsCategory> post(@javax.annotation.Nonnull final UserExperienceAnalyticsCategory body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsCategory body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsCategory body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
