package microsoft.graph.devicemanagement.configurationpolicies.item.settings.item;
...
import microsoft.graph.devicemanagement.configurationpolicies.item.settings.item.settingdefinitions.item.DeviceManagementConfigurationSettingDefinitionItemRequestBuilder;
import microsoft.graph.devicemanagement.configurationpolicies.item.settings.item.settingdefinitions.SettingDefinitionsRequestBuilder;
...
public class DeviceManagementConfigurationSettingItemRequestBuilder {
    ...
    public DeviceManagementConfigurationSettingItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/settings/{deviceManagementConfigurationSetting%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.deviceManagement.configurationPolicies.item.settings.item.settingDefinitions.item collection
