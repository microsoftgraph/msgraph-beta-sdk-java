package com.microsoft.graph.devicemanagement.configurationpolicies.item.settings.item;
...
import com.microsoft.graph.devicemanagement.configurationpolicies.item.settings.item.settingdefinitions.SettingDefinitionsRequestBuilder;
...
public class DeviceManagementConfigurationSettingItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.deviceManagement.configurationPolicies.item.settings.item.settingDefinitions.item collection
