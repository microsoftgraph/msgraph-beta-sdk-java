...
public class ConfigurationPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceManagementConfigurationPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicy> post(@javax.annotation.Nonnull final DeviceManagementConfigurationPolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicy> executionException = new java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
