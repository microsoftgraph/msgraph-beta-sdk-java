package microsoft.graph.devicemanagement.mobileapptroubleshootingevents.item;
...
import microsoft.graph.devicemanagement.mobileapptroubleshootingevents.item.applogcollectionrequests.AppLogCollectionRequestsRequestBuilder;
import microsoft.graph.devicemanagement.mobileapptroubleshootingevents.item.applogcollectionrequests.item.AppLogCollectionRequestItemRequestBuilder;
...
public class MobileAppTroubleshootingEventItemRequestBuilder {
    ...
    public MobileAppTroubleshootingEventItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}";
