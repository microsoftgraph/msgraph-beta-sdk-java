...
public class UserPfxCertificatesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserPFXCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserPFXCertificateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserPFXCertificateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserPFXCertificateCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserPFXCertificate> post(@javax.annotation.Nonnull final UserPFXCertificate body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserPFXCertificate> executionException = new java.util.concurrent.CompletableFuture<UserPFXCertificate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
