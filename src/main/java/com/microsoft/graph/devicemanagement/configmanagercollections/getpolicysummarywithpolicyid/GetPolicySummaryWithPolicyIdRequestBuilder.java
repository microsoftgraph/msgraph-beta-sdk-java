...
public class GetPolicySummaryWithPolicyIdRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConfigManagerPolicySummary> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConfigManagerPolicySummary> executionException = new java.util.concurrent.CompletableFuture<ConfigManagerPolicySummary>();
