...
public class ConfigManagerCollectionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ConfigManagerCollection body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse>();
