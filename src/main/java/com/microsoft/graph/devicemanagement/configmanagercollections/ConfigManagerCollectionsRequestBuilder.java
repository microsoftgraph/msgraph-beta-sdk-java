...
public class ConfigManagerCollectionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConfigManagerCollectionCollectionResponse>();
