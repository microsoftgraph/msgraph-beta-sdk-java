...
public class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> executionException = new java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit>();
