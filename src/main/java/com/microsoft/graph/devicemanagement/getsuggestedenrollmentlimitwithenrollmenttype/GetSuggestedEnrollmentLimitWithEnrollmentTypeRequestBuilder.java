package microsoft.graph.devicemanagement.getsuggestedenrollmentlimitwithenrollmenttype;
...
import microsoft.graph.models.SuggestedEnrollmentLimit;
...
public class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SuggestedEnrollmentLimit::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> get(@javax.annotation.Nullable final java.util.function.Consumer<GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SuggestedEnrollmentLimit::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
