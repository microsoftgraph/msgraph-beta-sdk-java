...
public class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> executionException = new java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SuggestedEnrollmentLimit> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
