...
public class UserExperienceAnalyticsScoreHistoryRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserExperienceAnalyticsScoreHistory body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsScoreHistoryCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserExperienceAnalyticsScoreHistoryCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserExperienceAnalyticsScoreHistoryCollectionResponse>();
