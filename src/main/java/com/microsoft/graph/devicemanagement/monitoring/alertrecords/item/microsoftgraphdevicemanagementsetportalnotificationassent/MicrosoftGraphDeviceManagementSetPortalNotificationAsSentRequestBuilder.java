package com.microsoft.graph.devicemanagement.monitoring.alertrecords.item.microsoftgraphdevicemanagementsetportalnotificationassent;
...
public class MicrosoftGraphDeviceManagementSetPortalNotificationAsSentRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphDeviceManagementSetPortalNotificationAsSentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MicrosoftGraphDeviceManagementSetPortalNotificationAsSentRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/devicemanagement-alertrecord-setportalnotificationassent?view=graph-rest-1.0">Find more info here</a>
     */
