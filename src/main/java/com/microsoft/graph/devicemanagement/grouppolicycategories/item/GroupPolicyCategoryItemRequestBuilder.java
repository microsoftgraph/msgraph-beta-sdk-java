...
public class GroupPolicyCategoryItemRequestBuilder {
     ...
     * @return a CompletableFuture of groupPolicyCategory
     */
    public java.util.concurrent.CompletableFuture<GroupPolicyCategory> patch(@javax.annotation.Nonnull final GroupPolicyCategory body, @javax.annotation.Nullable final java.util.function.Consumer<GroupPolicyCategoryItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
