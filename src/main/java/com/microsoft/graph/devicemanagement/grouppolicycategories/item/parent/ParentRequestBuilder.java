...
public class ParentRequestBuilder extends BaseRequestBuilder {
    ...
    public ParentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/parent{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ParentRequestBuilder and sets the default values.
    ...
    public ParentRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/parent{?%24select,%24expand}", rawUrl);
    }
    /**
     * The parent category
