...
public class ManagedDeviceEncryptionStatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the managedDeviceEncryptionStates property of the microsoft.graph.deviceManagement entity.
     * @param managedDeviceEncryptionStateId Unique identifier of the item
     * @return a ManagedDeviceEncryptionStateItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ManagedDeviceEncryptionStateItemRequestBuilder byManagedDeviceEncryptionStateId(@javax.annotation.Nonnull final String managedDeviceEncryptionStateId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ManagedDeviceEncryptionState body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ManagedDeviceEncryptionState body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
