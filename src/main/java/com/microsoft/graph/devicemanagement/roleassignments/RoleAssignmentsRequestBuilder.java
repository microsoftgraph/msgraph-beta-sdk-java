...
public class RoleAssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse>() {{
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> post(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body) {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment>() {{
                this.completeExceptionally(ex);
            }};
        }
    }
