...
public class RoleAssignmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignmentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> post(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementRoleAssignment> post(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceAndAppManagementRoleAssignment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
