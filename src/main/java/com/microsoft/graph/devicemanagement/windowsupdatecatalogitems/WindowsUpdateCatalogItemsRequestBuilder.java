package microsoft.graph.devicemanagement.windowsupdatecatalogitems;
...
import microsoft.graph.devicemanagement.windowsupdatecatalogitems.count.CountRequestBuilder;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.models.WindowsUpdateCatalogItem;
...
public class WindowsUpdateCatalogItemsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItemCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsUpdateCatalogItemCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of WindowsUpdateCatalogItemCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItemCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<WindowsUpdateCatalogItemsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsUpdateCatalogItemCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItem> post(@javax.annotation.Nonnull final WindowsUpdateCatalogItem body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsUpdateCatalogItem::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of windowsUpdateCatalogItem
     */
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItem> post(@javax.annotation.Nonnull final WindowsUpdateCatalogItem body, @javax.annotation.Nullable final java.util.function.Consumer<WindowsUpdateCatalogItemsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, WindowsUpdateCatalogItem::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
