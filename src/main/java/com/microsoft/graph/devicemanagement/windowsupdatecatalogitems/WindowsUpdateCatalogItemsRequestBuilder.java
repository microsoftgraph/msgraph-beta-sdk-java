...
public class WindowsUpdateCatalogItemsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItemCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItemCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItemCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItem> post(@javax.annotation.Nonnull final WindowsUpdateCatalogItem body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItem> executionException = new java.util.concurrent.CompletableFuture<WindowsUpdateCatalogItem>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
