...
public class GetNoncompliantDevicesToRetirePostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getNoncompliantDevicesToRetirePostRequestBody
     */
    @javax.annotation.Nonnull
    public static GetNoncompliantDevicesToRetirePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetNoncompliantDevicesToRetirePostRequestBody currentObject = this;
