...
public class UserStatusesRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public DeviceComplianceUserStatusItemRequestBuilder byDeviceComplianceUserStatusId(@javax.annotation.Nonnull final String deviceComplianceUserStatusId) {
    ...
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatusCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceComplianceUserStatusCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceUserStatusCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatusCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> post(@javax.annotation.Nonnull final DeviceComplianceUserStatus body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> executionException = new java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeviceComplianceUserStatus> post(@javax.annotation.Nonnull final DeviceComplianceUserStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceComplianceUserStatus body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeviceComplianceUserStatus body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
