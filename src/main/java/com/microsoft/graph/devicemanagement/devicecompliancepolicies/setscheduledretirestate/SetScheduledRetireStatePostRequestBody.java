...
public class SetScheduledRetireStatePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("scopedToAllDevices", (n) -> { currentObject.setScopedToAllDevices(n.getBooleanValue()); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(ScheduledRetireState.class)); });
