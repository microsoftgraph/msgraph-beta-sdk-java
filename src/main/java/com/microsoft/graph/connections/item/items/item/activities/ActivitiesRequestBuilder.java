...
public class ActivitiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ExternalActivity body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ExternalActivityCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalActivityCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ExternalActivityCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ExternalActivity> post(@javax.annotation.Nonnull final ExternalActivity body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalActivity> executionException = new java.util.concurrent.CompletableFuture<ExternalActivity>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
