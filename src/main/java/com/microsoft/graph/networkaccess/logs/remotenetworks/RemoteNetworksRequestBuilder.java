package com.microsoft.graph.networkaccess.logs.remotenetworks;

import com.microsoft.graph.models.networkaccess.RemoteNetworkHealthEvent;
import com.microsoft.graph.models.networkaccess.RemoteNetworkHealthEventCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.networkaccess.logs.remotenetworks.count.CountRequestBuilder;
import com.microsoft.graph.networkaccess.logs.remotenetworks.item.RemoteNetworkHealthEventItemRequestBuilder;
...
public class RemoteNetworksRequestBuilder extends BaseRequestBuilder {
    ...
    public RemoteNetworkHealthEventCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, RemoteNetworkHealthEventCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public RemoteNetworkHealthEvent post(@jakarta.annotation.Nonnull final RemoteNetworkHealthEvent body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, RemoteNetworkHealthEvent::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Retrieve a list of remote network health status microsoft.graph.networkaccess.remoteNetworkHealthStatusEvent events, providing insights into the health and status of remote networks.
