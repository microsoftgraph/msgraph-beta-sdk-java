package com.microsoft.graph.networkaccess.filteringprofiles.item;

import com.microsoft.graph.models.networkaccess.FilteringProfile;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.networkaccess.filteringprofiles.item.conditionalaccesspolicies.ConditionalAccessPoliciesRequestBuilder;
import com.microsoft.graph.networkaccess.filteringprofiles.item.policies.PoliciesRequestBuilder;
...
public class FilteringProfileItemRequestBuilder extends BaseRequestBuilder {
    ...
    public FilteringProfile get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, FilteringProfile::createFromDiscriminatorValue, errorMapping);
    }
    /**
