...
/**
 * The class for the Web Categories Summary.
 */
public class WebCategoriesSummary implements IJsonBackedObject {
     ...
     */
    @SerializedName(value = "webCategory", alternate = {"WebCategory"})
    @Expose
	@Nullable
