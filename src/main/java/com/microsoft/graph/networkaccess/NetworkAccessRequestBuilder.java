...
import com.microsoft.graph.networkaccess.filteringpolicies.FilteringPoliciesRequestBuilder;
import com.microsoft.graph.networkaccess.filteringprofiles.FilteringProfilesRequestBuilder;
...
public class NetworkAccessRequestBuilder extends BaseRequestBuilder {
    ...
    public NetworkAccessRoot get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, NetworkAccessRoot::createFromDiscriminatorValue, errorMapping);
    }
    /**
