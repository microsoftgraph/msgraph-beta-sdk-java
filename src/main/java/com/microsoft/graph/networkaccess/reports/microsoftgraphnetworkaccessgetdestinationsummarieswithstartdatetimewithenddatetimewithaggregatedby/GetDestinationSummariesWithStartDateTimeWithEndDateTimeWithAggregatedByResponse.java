...
public class GetDestinationSummariesWithStartDateTimeWithEndDateTimeWithAggregatedByResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static GetDestinationSummariesWithStartDateTimeWithEndDateTimeWithAggregatedByResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<DestinationSummary> value) {
        this.value = value;
    }
}
