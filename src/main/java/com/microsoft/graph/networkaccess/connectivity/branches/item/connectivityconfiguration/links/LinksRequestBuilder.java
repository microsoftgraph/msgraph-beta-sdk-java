...
public class LinksRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ConnectivityConfigurationLinkCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ConnectivityConfigurationLinkCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ConnectivityConfigurationLinkCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConnectivityConfigurationLinkCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ConnectivityConfigurationLink> post(@jakarta.annotation.Nonnull final ConnectivityConfigurationLink body) {
        try {
            ...
            errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
            errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
            return this.requestAdapter.sendAsync(requestInfo, ConnectivityConfigurationLink::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ConnectivityConfigurationLink> executionException = new java.util.concurrent.CompletableFuture<ConnectivityConfigurationLink>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConnectivityConfigurationLink body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ConnectivityConfigurationLink body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
