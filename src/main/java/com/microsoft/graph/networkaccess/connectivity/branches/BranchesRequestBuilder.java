...
public class BranchesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the branches property of the microsoft.graph.networkaccess.connectivity entity.
     * @param branchSiteId Unique identifier of the item
     * @return a BranchSiteItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public BranchSiteItemRequestBuilder byBranchSiteId(@javax.annotation.Nonnull final String branchSiteId) {
    ...
    public BranchesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public BranchesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<BranchSiteCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<BranchSiteCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BranchSiteCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final BranchSite body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final BranchSite body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
