package com.microsoft.graph.networkaccess.connectivity.branches.item.forwardingprofiles.item.policies.item.policy;
...
public class PolicyRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Policy.
     * @return a CompletableFuture of policy
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Policy> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
            errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
            errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
            return this.requestAdapter.sendAsync(requestInfo, Policy::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<Policy> executionException = new java.util.concurrent.CompletableFuture<Policy>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Policy> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
