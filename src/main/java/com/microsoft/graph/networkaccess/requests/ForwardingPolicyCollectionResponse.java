...
/**
 * The class for the Forwarding Policy Collection Response.
 */
public class ForwardingPolicyCollectionResponse extends BaseCollectionResponse<ForwardingPolicy> {
