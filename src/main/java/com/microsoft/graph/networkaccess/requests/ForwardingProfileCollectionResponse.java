...
/**
 * The class for the Forwarding Profile Collection Response.
 */
public class ForwardingProfileCollectionResponse extends BaseCollectionResponse<ForwardingProfile> {
