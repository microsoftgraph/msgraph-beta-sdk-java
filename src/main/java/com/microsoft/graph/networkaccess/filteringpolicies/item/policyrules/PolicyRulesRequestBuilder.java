package com.microsoft.graph.networkaccess.filteringpolicies.item.policyrules;
...
import com.microsoft.graph.networkaccess.filteringpolicies.item.policyrules.count.CountRequestBuilder;
import com.microsoft.graph.networkaccess.filteringpolicies.item.policyrules.item.PolicyRuleItemRequestBuilder;
...
public class PolicyRulesRequestBuilder extends BaseRequestBuilder {
    ...
    public PolicyRuleCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, PolicyRuleCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
