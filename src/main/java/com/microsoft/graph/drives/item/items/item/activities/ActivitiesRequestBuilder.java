package com.microsoft.graph.drives.item.items.item.activities;

import com.microsoft.graph.drives.item.items.item.activities.count.CountRequestBuilder;
...
public class ActivitiesRequestBuilder {
    ...
    public ActivitiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
