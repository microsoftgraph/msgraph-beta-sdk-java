...
import com.microsoft.graph.drives.item.activities.ActivitiesRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.activities.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.bundles.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.following.item collection
     * @param id Unique identifier of the item
     * @return a DriveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item collection
     * @param id Unique identifier of the item
     * @return a DriveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.special.item collection
     * @param id Unique identifier of the item
     * @return a DriveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
