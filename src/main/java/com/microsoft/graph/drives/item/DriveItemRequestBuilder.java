package microsoft.graph.drives.item;
...
import microsoft.graph.drives.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.drives.item.bundles.BundlesRequestBuilder;
import microsoft.graph.drives.item.following.FollowingRequestBuilder;
import microsoft.graph.drives.item.items.ItemsRequestBuilder;
import microsoft.graph.drives.item.list.ListRequestBuilder;
import microsoft.graph.drives.item.recent.RecentRequestBuilder;
import microsoft.graph.drives.item.root.RootRequestBuilder;
import microsoft.graph.drives.item.searchwithq.SearchWithQRequestBuilder;
import microsoft.graph.drives.item.sharedwithme.SharedWithMeRequestBuilder;
import microsoft.graph.drives.item.special.SpecialRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drives.item.activities.item collection
