package microsoft.graph.drives.item.list.items.item.activities.item.driveitem;
...
import microsoft.graph.drives.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
