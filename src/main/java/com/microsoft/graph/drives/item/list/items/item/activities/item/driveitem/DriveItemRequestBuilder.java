package com.microsoft.graph.drives.item.list.items.item.activities.item.driveitem;

import com.microsoft.graph.drives.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
