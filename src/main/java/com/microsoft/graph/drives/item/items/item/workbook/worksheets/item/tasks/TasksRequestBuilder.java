...
public class TasksRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the tasks property of the microsoft.graph.workbookWorksheet entity.
     * @param workbookDocumentTaskId Unique identifier of the item
     * @return a WorkbookDocumentTaskItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public WorkbookDocumentTaskItemRequestBuilder byWorkbookDocumentTaskId(@javax.annotation.Nonnull final String workbookDocumentTaskId) {
    ...
    public java.util.concurrent.CompletableFuture<WorkbookDocumentTaskCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WorkbookDocumentTaskCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WorkbookDocumentTaskCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookDocumentTaskCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookDocumentTask> post(@javax.annotation.Nonnull final WorkbookDocumentTask body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkbookDocumentTask> post(@javax.annotation.Nonnull final WorkbookDocumentTask body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WorkbookDocumentTask body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WorkbookDocumentTask body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
