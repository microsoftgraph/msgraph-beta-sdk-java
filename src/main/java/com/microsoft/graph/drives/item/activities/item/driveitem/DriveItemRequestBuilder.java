package com.microsoft.graph.drives.item.activities.item.driveitem;

import com.microsoft.graph.drives.item.activities.item.driveitem.content.ContentRequestBuilder;
