package microsoft.graph.drives.item.activities.item.driveitem;
...
import microsoft.graph.drives.item.activities.item.driveitem.content.ContentRequestBuilder;
