package com.microsoft.graph.drives.item.items.item.workbook.tables.item.sort.reapply;
...
public class ReapplyRequestBuilder extends BaseRequestBuilder {
    ...
    public ReapplyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/sort/reapply", pathParameters);
    }
    /**
     * Instantiates a new ReapplyRequestBuilder and sets the default values.
