...
import com.microsoft.graph.drives.item.items.item.listitem.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.createlink.CreateLinkRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.listItem.activities.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.listItem.documentSetVersions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
