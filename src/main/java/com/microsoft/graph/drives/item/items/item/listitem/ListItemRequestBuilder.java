package microsoft.graph.drives.item.items.item.listitem;
...
import microsoft.graph.drives.item.items.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.createlink.CreateLinkRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.documentsetversions.DocumentSetVersionsRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.documentsetversions.item.DocumentSetVersionItemRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.driveitem.DriveItemRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.fields.FieldsRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.getactivitiesbyintervalwithstartdatetimewithenddatetimewithinterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.versions.item.ListItemVersionItemRequestBuilder;
import microsoft.graph.drives.item.items.item.listitem.versions.VersionsRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drives.item.items.item.listItem.activities.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.drives.item.items.item.listItem.documentSetVersions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.drives.item.items.item.listItem.versions.item collection
     * @param id Unique identifier of the item
