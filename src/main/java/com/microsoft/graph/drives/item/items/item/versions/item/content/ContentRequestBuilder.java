...
public class ContentRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveItemVersion put(@jakarta.annotation.Nonnull final InputStream body) {
     ...
     */
    @jakarta.annotation.Nullable
    public DriveItemVersion put(@jakarta.annotation.Nonnull final InputStream body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
