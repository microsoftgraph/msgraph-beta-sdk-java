...
import com.microsoft.graph.drives.item.root.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.drives.item.root.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.drives.item.root.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drives.item.root.assignsensitivitylabel.AssignSensitivityLabelRequestBuilder;
...
import com.microsoft.graph.drives.item.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.root.activities.item collection
