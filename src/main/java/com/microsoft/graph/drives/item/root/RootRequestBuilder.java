...
import microsoft.graph.drives.item.root.activities.ActivitiesRequestBuilder;
import microsoft.graph.drives.item.root.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.drives.item.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drives.item.root.activities.item collection
