...
import com.microsoft.graph.drives.item.list.items.item.activities.ActivitiesRequestBuilder;
...
public class ListItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drives.item.list.items.item.activities.item collection
