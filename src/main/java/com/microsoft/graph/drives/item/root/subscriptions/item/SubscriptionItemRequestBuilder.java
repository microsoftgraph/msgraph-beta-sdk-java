package com.microsoft.graph.drives.item.root.subscriptions.item;

import com.microsoft.graph.drives.item.root.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
