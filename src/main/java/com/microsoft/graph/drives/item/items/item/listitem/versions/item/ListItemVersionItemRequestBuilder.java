package com.microsoft.graph.drives.item.items.item.listitem.versions.item;

import com.microsoft.graph.drives.item.items.item.listitem.versions.item.fields.FieldsRequestBuilder;
import com.microsoft.graph.drives.item.items.item.listitem.versions.item.restoreversion.RestoreVersionRequestBuilder;
