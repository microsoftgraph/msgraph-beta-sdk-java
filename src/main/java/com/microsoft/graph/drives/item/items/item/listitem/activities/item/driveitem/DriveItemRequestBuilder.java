package microsoft.graph.drives.item.items.item.listitem.activities.item.driveitem;
...
import microsoft.graph.drives.item.items.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
