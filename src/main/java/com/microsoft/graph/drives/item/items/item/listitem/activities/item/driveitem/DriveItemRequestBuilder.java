package com.microsoft.graph.drives.item.items.item.listitem.activities.item.driveitem;

import com.microsoft.graph.drives.item.items.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
