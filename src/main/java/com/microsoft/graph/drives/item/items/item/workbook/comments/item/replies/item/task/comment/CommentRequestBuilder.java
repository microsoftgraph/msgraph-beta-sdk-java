package com.microsoft.graph.drives.item.items.item.workbook.comments.item.replies.item.task.comment;

import com.microsoft.graph.drives.item.items.item.workbook.comments.item.replies.item.task.comment.task.TaskRequestBuilder;
...
public class CommentRequestBuilder extends BaseRequestBuilder {
    ...
    public CommentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/comment{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CommentRequestBuilder and sets the default values.
    ...
    public CommentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/comment{?%24select,%24expand}", rawUrl);
    }
    /**
