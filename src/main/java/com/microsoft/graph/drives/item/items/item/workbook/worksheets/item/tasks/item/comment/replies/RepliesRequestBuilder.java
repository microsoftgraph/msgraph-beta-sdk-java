package com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.tasks.item.comment.replies;

import com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.tasks.item.comment.replies.count.CountRequestBuilder;
import com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.tasks.item.comment.replies.item.WorkbookCommentReplyItemRequestBuilder;
