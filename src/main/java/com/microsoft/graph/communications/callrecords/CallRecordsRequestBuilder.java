...
import com.microsoft.graph.communications.callrecords.callrecordsgetpstnblockeduserslogwithfromdatetimewithtodatetime.CallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder;
...
import com.microsoft.graph.communications.callrecords.callrecordsgetpstnonlinemeetingdialoutreportwithfromdatetimewithtodatetime.CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeRequestBuilder;
import com.microsoft.graph.communications.callrecords.callrecordsgetsmslogwithfromdatetimewithtodatetime.CallRecordsGetSmsLogWithFromDateTimeWithToDateTimeRequestBuilder;
...
public class CallRecordsRequestBuilder extends BaseRequestBuilder {
     ...
     * @param fromDateTime Usage: fromDateTime={fromDateTime}
     * @param toDateTime Usage: toDateTime={toDateTime}
     * @return a callRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder
     */
    @javax.annotation.Nonnull
    public CallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder callRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime(@javax.annotation.Nonnull final OffsetDateTime fromDateTime, @javax.annotation.Nonnull final OffsetDateTime toDateTime) {
        Objects.requireNonNull(fromDateTime);
        Objects.requireNonNull(toDateTime);
     ...
     * @param fromDateTime Usage: fromDateTime={fromDateTime}
     * @param toDateTime Usage: toDateTime={toDateTime}
     * @return a callRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeRequestBuilder
     */
    @javax.annotation.Nonnull
    public CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeRequestBuilder callRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTime(@javax.annotation.Nonnull final OffsetDateTime fromDateTime, @javax.annotation.Nonnull final OffsetDateTime toDateTime) {
        Objects.requireNonNull(fromDateTime);
        Objects.requireNonNull(toDateTime);
     ...
     * @param fromDateTime Usage: fromDateTime={fromDateTime}
     * @param toDateTime Usage: toDateTime={toDateTime}
     * @return a callRecordsGetSmsLogWithFromDateTimeWithToDateTimeRequestBuilder
     */
    @javax.annotation.Nonnull
    public CallRecordsGetSmsLogWithFromDateTimeWithToDateTimeRequestBuilder callRecordsGetSmsLogWithFromDateTimeWithToDateTime(@javax.annotation.Nonnull final OffsetDateTime fromDateTime, @javax.annotation.Nonnull final OffsetDateTime toDateTime) {
        Objects.requireNonNull(fromDateTime);
        Objects.requireNonNull(toDateTime);
