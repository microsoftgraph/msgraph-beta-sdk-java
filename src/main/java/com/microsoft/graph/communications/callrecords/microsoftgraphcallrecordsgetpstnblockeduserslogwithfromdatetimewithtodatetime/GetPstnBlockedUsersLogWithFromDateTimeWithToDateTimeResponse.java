...
public class GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /**
     * The value property
     */
    private java.util.List<PstnBlockedUsersLogRow> value;
    /**
     * Instantiates a new getPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse() {
        super();
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a getPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse
     */
    @javax.annotation.Nonnull
    public static GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<PstnBlockedUsersLogRow> value) {
        this.value = value;
    }
}
