...
public class GetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static GetPstnOnlineMeetingDialoutReportWithFromDateTimeWithToDateTimeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<PstnOnlineMeetingDialoutReport> value) {
        this.value = value;
    }
}
