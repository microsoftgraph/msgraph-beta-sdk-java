...
public class RecordRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private Boolean _streamWhileRecording;
    /**
     ...
     * @return a recordRequestBody
     */
    @javax.annotation.Nonnull
    public static RecordRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RecordRequestBody currentObject = this;
    ...
    public Boolean getStreamWhileRecording() {
        return this._streamWhileRecording;
    }
    /**
