...
public class RecordPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static RecordPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
