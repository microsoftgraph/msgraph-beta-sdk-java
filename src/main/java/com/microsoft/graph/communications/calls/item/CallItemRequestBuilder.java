...
import microsoft.graph.communications.calls.item.addlargegalleryview.AddLargeGalleryViewRequestBuilder;
...
import microsoft.graph.communications.calls.item.contentsharingsessions.ContentSharingSessionsRequestBuilder;
import microsoft.graph.communications.calls.item.contentsharingsessions.item.ContentSharingSessionItemRequestBuilder;
...
import microsoft.graph.communications.calls.item.record.RecordRequestBuilder;
...
public class CallItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.communications.calls.item.contentSharingSessions.item collection
     * @param id Unique identifier of the item
