...
public class RegistrationRequestBuilder {
    ...
    public RegistrationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.communications.onlineMeetings.item.registration.customQuestions.item collection
