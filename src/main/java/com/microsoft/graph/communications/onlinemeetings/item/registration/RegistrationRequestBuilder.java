package microsoft.graph.communications.onlinemeetings.item.registration;
...
import microsoft.graph.communications.onlinemeetings.item.registration.customquestions.CustomQuestionsRequestBuilder;
import microsoft.graph.communications.onlinemeetings.item.registration.customquestions.item.MeetingRegistrationQuestionItemRequestBuilder;
...
public class RegistrationRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.communications.onlineMeetings.item.registration.customQuestions.item collection
