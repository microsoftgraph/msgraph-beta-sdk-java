...
public class ProgramControlTypesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ProgramControlType body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ProgramControlTypeCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProgramControlTypeCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ProgramControlTypeCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ProgramControlType> post(@javax.annotation.Nonnull final ProgramControlType body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProgramControlType> executionException = new java.util.concurrent.CompletableFuture<ProgramControlType>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
