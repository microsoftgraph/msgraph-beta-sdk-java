...
public class ProgramControlsRequestBuilder {
     ...
     * @return a CompletableFuture of ProgramControlCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ProgramControlCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ProgramControlsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of programControl
     */
    public java.util.concurrent.CompletableFuture<ProgramControl> post(@javax.annotation.Nonnull final ProgramControl body, @javax.annotation.Nullable final java.util.function.Consumer<ProgramControlsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
