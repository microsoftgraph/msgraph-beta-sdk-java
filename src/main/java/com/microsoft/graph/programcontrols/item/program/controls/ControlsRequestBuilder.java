...
public class ControlsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ProgramControl body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ProgramControlCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProgramControlCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ProgramControlCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ProgramControl> post(@javax.annotation.Nonnull final ProgramControl body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProgramControl> executionException = new java.util.concurrent.CompletableFuture<ProgramControl>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
