package com.microsoft.graph.onpremisespublishingprofiles.item.connectorgroups.item.applications.item.logo;
...
public class LogoRequestBuilder {
    ...
    public LogoRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups/{connectorGroup%2Did}/applications/{application%2Did}/logo";
