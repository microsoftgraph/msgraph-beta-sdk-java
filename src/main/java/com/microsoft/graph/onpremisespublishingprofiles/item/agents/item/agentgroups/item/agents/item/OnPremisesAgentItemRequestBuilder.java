package microsoft.graph.onpremisespublishingprofiles.item.agents.item.agentgroups.item.agents.item;
...
public class OnPremisesAgentItemRequestBuilder {
    ...
    public OnPremisesAgentItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agents/{onPremisesAgent%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/agents/{onPremisesAgent%2Did1}{?%24select,%24expand}";
