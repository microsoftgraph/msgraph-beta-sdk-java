package microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.agents.item.agentgroups;
...
import microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.agents.item.agentgroups.count.CountRequestBuilder;
...
public class AgentGroupsRequestBuilder {
    ...
    public AgentGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}/agents/{onPremisesAgent%2Did}/agentGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
