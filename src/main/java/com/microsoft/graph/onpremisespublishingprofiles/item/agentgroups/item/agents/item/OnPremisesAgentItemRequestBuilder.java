...
public class OnPremisesAgentItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final OnPremisesAgent body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesAgent> executionException = new java.util.concurrent.CompletableFuture<OnPremisesAgent>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
