package microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.agents.item;
...
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.agents.item.agentgroups.AgentGroupsRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.agents.item.agentgroups.item.OnPremisesAgentGroupItemRequestBuilder;
...
public class OnPremisesAgentItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.onPremisesPublishingProfiles.item.publishedResources.item.agentGroups.item.agents.item.agentGroups.item collection
    ...
    public OnPremisesAgentItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/agents/{onPremisesAgent%2Did}{?%24select,%24expand}";
