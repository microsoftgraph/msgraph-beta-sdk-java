package microsoft.graph.onpremisespublishingprofiles.item.agents.item;
...
import microsoft.graph.onpremisespublishingprofiles.item.agents.item.agentgroups.AgentGroupsRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.agents.item.agentgroups.item.OnPremisesAgentGroupItemRequestBuilder;
