...
public class OnPremisesAgentGroupItemRequestBuilder {
     ...
     * @return a CompletableFuture of onPremisesAgentGroup
     */
    public java.util.concurrent.CompletableFuture<OnPremisesAgentGroup> patch(@javax.annotation.Nonnull final OnPremisesAgentGroup body, @javax.annotation.Nullable final java.util.function.Consumer<OnPremisesAgentGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of onPremisesAgentGroup
     */
    public java.util.concurrent.CompletableFuture<OnPremisesAgentGroup> patch(@javax.annotation.Nonnull final OnPremisesAgentGroup body, @javax.annotation.Nullable final java.util.function.Consumer<OnPremisesAgentGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
