...
import microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.agents.item.agentgroups.item.publishedresources.item.PublishedResourceItemRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.agents.item.agentgroups.item.publishedresources.PublishedResourcesRequestBuilder;
...
public class OnPremisesAgentGroupItemRequestBuilder {
    ...
    public OnPremisesAgentGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/agents/{onPremisesAgent%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.onPremisesPublishingProfiles.item.agentGroups.item.agents.item.agentGroups.item.publishedResources.item collection
