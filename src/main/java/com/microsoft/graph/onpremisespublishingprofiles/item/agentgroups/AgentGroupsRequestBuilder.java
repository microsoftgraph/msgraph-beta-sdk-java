package com.microsoft.graph.onpremisespublishingprofiles.item.agentgroups;
...
import com.microsoft.graph.onpremisespublishingprofiles.item.agentgroups.count.CountRequestBuilder;
...
public class AgentGroupsRequestBuilder {
    ...
    public AgentGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final OnPremisesAgentGroup body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesAgentGroupCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesAgentGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OnPremisesAgentGroupCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesAgentGroup> post(@javax.annotation.Nonnull final OnPremisesAgentGroup body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<OnPremisesAgentGroup> executionException = new java.util.concurrent.CompletableFuture<OnPremisesAgentGroup>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
