package com.microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof;

import com.microsoft.graph.models.ConnectorGroupCollectionResponse;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof.count.CountRequestBuilder;
...
import com.microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof.ref.RefRequestBuilder;
...
public class MemberOfRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public ConnectorGroupItemRequestBuilder byConnectorGroupId(@javax.annotation.Nonnull final String connectorGroupId) {
        Objects.requireNonNull(connectorGroupId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("connectorGroup%2Did", connectorGroupId);
    ...
    public MemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MemberOfRequestBuilder and sets the default values.
    ...
    public MemberOfRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<ConnectorGroupCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConnectorGroupCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ConnectorGroupCollectionResponse>();
