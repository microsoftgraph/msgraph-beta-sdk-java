package microsoft.graph.onpremisespublishingprofiles.item.connectorgroups.item.members.item.memberof.item.applications;
...
import microsoft.graph.onpremisespublishingprofiles.item.connectorgroups.item.members.item.memberof.item.applications.count.CountRequestBuilder;
...
public class ApplicationsRequestBuilder {
    ...
    public ApplicationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups/{connectorGroup%2Did}/members/{connector%2Did}/memberOf/{connectorGroup%2Did1}/applications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     * @return a CompletableFuture of ApplicationCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<ApplicationCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<ApplicationsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
