package microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof.item.members.item;
...
public class ConnectorItemRequestBuilder {
    ...
    public ConnectorItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf/{connectorGroup%2Did}/members/{connector%2Did1}{?%24select,%24expand}";
