package microsoft.graph.onpremisespublishingprofiles.item.connectorgroups.item.members.item.memberof.item.applications.item;
...
import microsoft.graph.onpremisespublishingprofiles.item.connectorgroups.item.members.item.memberof.item.applications.item.logo.LogoRequestBuilder;
...
public class ApplicationItemRequestBuilder {
    ...
    public ApplicationItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups/{connectorGroup%2Did}/members/{connector%2Did}/memberOf/{connectorGroup%2Did1}/applications/{application%2Did}{?%24select,%24expand}";
