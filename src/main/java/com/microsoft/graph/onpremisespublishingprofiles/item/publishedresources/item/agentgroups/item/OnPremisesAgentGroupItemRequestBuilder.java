...
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.agents.AgentsRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.agents.item.OnPremisesAgentItemRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.publishedresources.item.PublishedResourceItemRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.publishedresources.item.agentgroups.item.publishedresources.PublishedResourcesRequestBuilder;
...
public class OnPremisesAgentGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.onPremisesPublishingProfiles.item.publishedResources.item.agentGroups.item.agents.item collection
    ...
    public OnPremisesAgentGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.onPremisesPublishingProfiles.item.publishedResources.item.agentGroups.item.publishedResources.item collection
     * @param id Unique identifier of the item
