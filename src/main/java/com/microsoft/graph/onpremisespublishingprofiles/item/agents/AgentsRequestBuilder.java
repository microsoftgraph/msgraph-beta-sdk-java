...
public class AgentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the agents property of the microsoft.graph.onPremisesPublishingProfile entity.
     * @param onPremisesAgentId Unique identifier of the item
     * @return a OnPremisesAgentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public OnPremisesAgentItemRequestBuilder byOnPremisesAgentId(@javax.annotation.Nonnull final String onPremisesAgentId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/onpremisesagent-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final OnPremisesAgent body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final OnPremisesAgent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
