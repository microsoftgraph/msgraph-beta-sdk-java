package microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof.item.applications;
...
import microsoft.graph.onpremisespublishingprofiles.item.connectors.item.memberof.item.applications.count.CountRequestBuilder;
...
public class ApplicationsRequestBuilder {
    ...
    public ApplicationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf/{connectorGroup%2Did}/applications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
