package microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.agents.item.agentgroups.item;
...
public class OnPremisesAgentGroupItemRequestBuilder {
    ...
    public OnPremisesAgentGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}/agents/{onPremisesAgent%2Did}/agentGroups/{onPremisesAgentGroup%2Did2}{?%24select,%24expand}";
