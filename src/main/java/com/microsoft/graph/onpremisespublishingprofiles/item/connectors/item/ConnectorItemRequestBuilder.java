...
public class ConnectorItemRequestBuilder {
     ...
     * @return a CompletableFuture of connector
     */
    public java.util.concurrent.CompletableFuture<Connector> patch(@javax.annotation.Nonnull final Connector body, @javax.annotation.Nullable final java.util.function.Consumer<ConnectorItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
