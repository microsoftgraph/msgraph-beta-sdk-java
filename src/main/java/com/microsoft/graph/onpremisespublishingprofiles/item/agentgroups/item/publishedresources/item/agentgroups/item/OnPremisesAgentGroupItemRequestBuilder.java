package microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item;
...
import microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.agents.AgentsRequestBuilder;
import microsoft.graph.onpremisespublishingprofiles.item.agentgroups.item.publishedresources.item.agentgroups.item.agents.item.OnPremisesAgentItemRequestBuilder;
...
public class OnPremisesAgentGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.onPremisesPublishingProfiles.item.agentGroups.item.publishedResources.item.agentGroups.item.agents.item collection
    ...
    public OnPremisesAgentGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}{?%24select,%24expand}";
