...
public class AppManagementPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AppManagementPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppManagementPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AppManagementPolicyCollectionResponse>();
