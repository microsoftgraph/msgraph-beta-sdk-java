package com.microsoft.graph.applications.item.owners.serviceprincipal;

import com.microsoft.graph.applications.item.owners.serviceprincipal.count.CountRequestBuilder;
