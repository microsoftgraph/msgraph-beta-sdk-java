package microsoft.graph.applications.item.synchronization.jobs.item.schema.filteroperators;
...
public class FilterOperatorsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> _additionalData;
    /** The value property */
    private java.util.List<FilterOperatorSchema> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FilterOperatorsResponse currentObject = this;
        return new HashMap<>(1) {{
            this.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(FilterOperatorSchema::createFromDiscriminatorValue)); });
        }};
    }
    /**
