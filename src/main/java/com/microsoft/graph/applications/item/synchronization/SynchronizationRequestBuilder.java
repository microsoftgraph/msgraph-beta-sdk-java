...
import com.microsoft.graph.applications.item.synchronization.ping.PingRequestBuilder;
...
public class SynchronizationRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.applications.item.synchronization.jobs.item collection
     ...
     * @return a CompletableFuture of synchronization
     */
    public java.util.concurrent.CompletableFuture<Synchronization> patch(@javax.annotation.Nonnull final Synchronization body) {
        try {
     ...
     * @return a CompletableFuture of synchronization
     */
    public java.util.concurrent.CompletableFuture<Synchronization> patch(@javax.annotation.Nonnull final Synchronization body, @javax.annotation.Nullable final java.util.function.Consumer<SynchronizationRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.applications.item.synchronization.templates.item collection
     * @param id Unique identifier of the item
