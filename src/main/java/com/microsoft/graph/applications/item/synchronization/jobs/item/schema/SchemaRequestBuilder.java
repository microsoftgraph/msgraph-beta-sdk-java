package com.microsoft.graph.applications.item.synchronization.jobs.item.schema;

import com.microsoft.graph.applications.item.synchronization.jobs.item.schema.directories.DirectoriesRequestBuilder;
import com.microsoft.graph.applications.item.synchronization.jobs.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
import com.microsoft.graph.applications.item.synchronization.jobs.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import com.microsoft.graph.applications.item.synchronization.jobs.item.schema.functions.FunctionsRequestBuilder;
import com.microsoft.graph.applications.item.synchronization.jobs.item.schema.parseexpression.ParseExpressionRequestBuilder;
...
public class SchemaRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.applications.item.synchronization.jobs.item.schema.directories.item collection
