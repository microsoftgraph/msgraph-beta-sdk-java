package microsoft.graph.applications.item.synchronization.jobs.item.schema;
...
import microsoft.graph.applications.item.synchronization.jobs.item.schema.directories.DirectoriesRequestBuilder;
import microsoft.graph.applications.item.synchronization.jobs.item.schema.directories.item.DirectoryDefinitionItemRequestBuilder;
import microsoft.graph.applications.item.synchronization.jobs.item.schema.filteroperators.FilterOperatorsRequestBuilder;
import microsoft.graph.applications.item.synchronization.jobs.item.schema.functions.FunctionsRequestBuilder;
import microsoft.graph.applications.item.synchronization.jobs.item.schema.parseexpression.ParseExpressionRequestBuilder;
