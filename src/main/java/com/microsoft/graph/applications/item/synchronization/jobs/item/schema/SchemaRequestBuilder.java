...
public class SchemaRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SynchronizationSchema body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SynchronizationSchema> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SynchronizationSchema> executionException = new java.util.concurrent.CompletableFuture<SynchronizationSchema>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
