...
public class DiscoverRequestBuilder extends BaseRequestBuilder {
    ...
    public DiscoverRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories/{directoryDefinition%2Did}/discover", pathParameters);
    }
    /**
     * Instantiates a new DiscoverRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/directorydefinition-discover?view=graph-rest-1.0">Find more info here</a>
     */
