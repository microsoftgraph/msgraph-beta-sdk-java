package com.microsoft.graph.applications.item.synchronization.templates.item.schema.directories.item.discover;
...
public class DiscoverRequestBuilder {
    ...
    public DiscoverRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories/{directoryDefinition%2Did}/microsoft.graph.discover";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<DiscoverRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of directoryDefinition
     */
    public java.util.concurrent.CompletableFuture<DirectoryDefinition> post(@javax.annotation.Nullable final java.util.function.Consumer<DiscoverRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of directoryDefinition
     */
    public java.util.concurrent.CompletableFuture<DirectoryDefinition> post(@javax.annotation.Nullable final java.util.function.Consumer<DiscoverRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
