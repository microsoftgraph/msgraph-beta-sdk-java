...
public class SourceSystemsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the sourceSystems property of the microsoft.graph.industryData.industryDataRoot entity.
     * @param sourceSystemDefinitionId Unique identifier of the item
     * @return a SourceSystemDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public SourceSystemDefinitionItemRequestBuilder bySourceSystemDefinitionId(@javax.annotation.Nonnull final String sourceSystemDefinitionId) {
    ...
    public SourceSystemsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public SourceSystemsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-sourcesystemdefinition-list?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SourceSystemDefinitionCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SourceSystemDefinitionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SourceSystemDefinitionCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SourceSystemDefinitionCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-sourcesystemdefinition-post?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SourceSystemDefinition> post(@javax.annotation.Nonnull final SourceSystemDefinition body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SourceSystemDefinition> post(@javax.annotation.Nonnull final SourceSystemDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final SourceSystemDefinition body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final SourceSystemDefinition body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
