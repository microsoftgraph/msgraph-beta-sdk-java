package com.microsoft.graph.external.industrydata.inboundflows.item;

import com.microsoft.graph.external.industrydata.inboundflows.item.dataconnector.DataConnectorRequestBuilder;
import com.microsoft.graph.external.industrydata.inboundflows.item.year.YearRequestBuilder;
...
public class InboundFlowItemRequestBuilder extends BaseRequestBuilder {
    ...
    public InboundFlowItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public InboundFlowItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-inboundfileflow-delete?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-inboundfileflow-get?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     * @return a CompletableFuture of inboundFlow
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-inboundfileflow-update?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final InboundFlow body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final InboundFlow body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
