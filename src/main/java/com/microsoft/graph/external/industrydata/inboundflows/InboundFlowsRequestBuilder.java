...
public class InboundFlowsRequestBuilder {
    ...
    public InboundFlowsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/external/industryData/inboundFlows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/industrydata-inboundfileflow-post?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
