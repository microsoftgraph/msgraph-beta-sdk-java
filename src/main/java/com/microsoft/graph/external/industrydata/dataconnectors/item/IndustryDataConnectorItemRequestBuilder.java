...
import com.microsoft.graph.external.industrydata.dataconnectors.item.industrydatavalidate.IndustryDataValidateRequestBuilder;
...
public class IndustryDataConnectorItemRequestBuilder {
    ...
    public IndustryDataValidateRequestBuilder industryDataValidate() {
        return new IndustryDataValidateRequestBuilder(pathParameters, requestAdapter);
    }
    ...
    public IndustryDataConnectorItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}{?%24select,%24expand}";
