 ...
 */
public class ExternalConnectorsAddActivitiesRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public ExternalConnectorsAddActivitiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities", pathParameters);
    }
    /**
     * Instantiates a new ExternalConnectorsAddActivitiesRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public ExternalConnectorsAddActivitiesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities", rawUrl);
    }
    /**
