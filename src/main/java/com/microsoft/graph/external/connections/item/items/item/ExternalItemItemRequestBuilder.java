...
import com.microsoft.graph.external.connections.item.items.item.externalconnectorsaddactivities.ExternalConnectorsAddActivitiesRequestBuilder;
...
public class ExternalItemItemRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public ExternalConnectorsAddActivitiesRequestBuilder externalConnectorsAddActivities() {
        return new ExternalConnectorsAddActivitiesRequestBuilder(pathParameters, requestAdapter);
    }
    /**
     * Provides operations to manage the activities property of the microsoft.graph.externalConnectors.externalItem entity.
