package com.microsoft.graph.external.authorizationsystems.item;

import com.microsoft.graph.external.authorizationsystems.item.datacollectioninfo.DataCollectionInfoRequestBuilder;
...
public class AuthorizationSystemItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AuthorizationSystemItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/authorizationSystems/{authorizationSystem%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AuthorizationSystemItemRequestBuilder and sets the default values.
    ...
    public AuthorizationSystemItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/external/authorizationSystems/{authorizationSystem%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AuthorizationSystem> patch(@jakarta.annotation.Nonnull final AuthorizationSystem body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AuthorizationSystem> patch(@jakarta.annotation.Nonnull final AuthorizationSystem body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
