package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.toterm;
...
public class ToTermRequestBuilder {
    ...
    public ToTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24select,%24expand}";
