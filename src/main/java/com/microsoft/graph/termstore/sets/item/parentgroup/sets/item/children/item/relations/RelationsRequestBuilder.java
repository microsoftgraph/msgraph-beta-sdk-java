package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.relations;
...
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.relations.count.CountRequestBuilder;
