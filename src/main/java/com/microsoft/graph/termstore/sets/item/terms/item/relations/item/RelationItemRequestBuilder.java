package microsoft.graph.termstore.sets.item.terms.item.relations.item;
...
import microsoft.graph.termstore.sets.item.terms.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.termstore.sets.item.terms.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.termstore.sets.item.terms.item.relations.item.toterm.ToTermRequestBuilder;
