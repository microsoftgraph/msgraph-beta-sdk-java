package com.microsoft.graph.termstore.sets.item.children.item.children;
...
import com.microsoft.graph.termstore.sets.item.children.item.children.count.CountRequestBuilder;
...
public class ChildrenRequestBuilder {
    ...
    public ChildrenRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
