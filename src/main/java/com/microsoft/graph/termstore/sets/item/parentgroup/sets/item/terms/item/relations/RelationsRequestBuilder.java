package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations;
...
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations.count.CountRequestBuilder;
