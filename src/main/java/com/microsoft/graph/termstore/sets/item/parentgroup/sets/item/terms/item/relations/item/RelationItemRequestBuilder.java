package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Relation;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.relations.item.toterm.ToTermRequestBuilder;
