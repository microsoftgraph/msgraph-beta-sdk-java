package com.microsoft.graph.termstore.sets.item.children.item.children.item;
...
import com.microsoft.graph.termstore.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.termstore.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.termStore.sets.item.children.item.children.item.relations.item collection
