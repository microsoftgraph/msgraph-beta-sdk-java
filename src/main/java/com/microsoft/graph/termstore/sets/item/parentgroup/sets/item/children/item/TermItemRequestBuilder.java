package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Term;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.children.ChildrenRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.relations.item.RelationItemRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.termStore.sets.item.parentGroup.sets.item.children.item.children.item collection
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.termStore.sets.item.parentGroup.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
