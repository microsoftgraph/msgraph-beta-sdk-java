package microsoft.graph.termstore.sets.item.terms.item;
...
import microsoft.graph.termstore.sets.item.terms.item.children.ChildrenRequestBuilder;
import microsoft.graph.termstore.sets.item.terms.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.termstore.sets.item.terms.item.relations.RelationsRequestBuilder;
import microsoft.graph.termstore.sets.item.terms.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.termStore.sets.item.terms.item.children.item collection
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.termStore.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
