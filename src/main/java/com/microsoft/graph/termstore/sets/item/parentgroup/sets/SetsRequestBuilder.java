package com.microsoft.graph.termstore.sets.item.parentgroup.sets;
...
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.count.CountRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.SetItemRequestBuilder;
...
public class SetsRequestBuilder extends BaseRequestBuilder {
    ...
    public SetsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SetsRequestBuilder and sets the default values.
    ...
    public SetsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
