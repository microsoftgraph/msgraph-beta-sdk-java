package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Relation;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.fromterm.FromTermRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.set.SetRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.toterm.ToTermRequestBuilder;
...
public class RelationItemRequestBuilder extends BaseRequestBuilder {
    ...
    public RelationItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RelationItemRequestBuilder and sets the default values.
    ...
    public RelationItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
