package microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item;
...
import microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.termstore.sets.item.parentgroup.sets.item.relations.item.toterm.ToTermRequestBuilder;
