package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations;
...
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
