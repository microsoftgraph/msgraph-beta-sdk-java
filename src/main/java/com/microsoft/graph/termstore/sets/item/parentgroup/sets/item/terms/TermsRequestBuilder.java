package com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms;
...
import com.microsoft.graph.termstore.sets.item.parentgroup.sets.item.terms.count.CountRequestBuilder;
...
public class TermsRequestBuilder {
    ...
    public TermsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
