package com.microsoft.graph.termstore.groups.item.sets.item.relations.item.toterm;
...
public class ToTermRequestBuilder {
    ...
    public ToTermRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}";
