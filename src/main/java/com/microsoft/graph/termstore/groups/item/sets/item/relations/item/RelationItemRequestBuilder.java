package microsoft.graph.termstore.groups.item.sets.item.relations.item;
...
import microsoft.graph.termstore.groups.item.sets.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.relations.item.toterm.ToTermRequestBuilder;
