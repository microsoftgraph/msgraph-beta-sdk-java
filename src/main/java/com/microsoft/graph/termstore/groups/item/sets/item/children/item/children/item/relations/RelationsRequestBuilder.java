package com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations;
...
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations.count.CountRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
