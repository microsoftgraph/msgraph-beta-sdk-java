package com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children;
...
import com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children.count.CountRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.TermItemRequestBuilder;
...
public class ChildrenRequestBuilder extends BaseRequestBuilder {
    ...
    public ChildrenRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ChildrenRequestBuilder and sets the default values.
    ...
    public ChildrenRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
