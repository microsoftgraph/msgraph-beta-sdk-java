package com.microsoft.graph.termstore.groups.item.sets.item.children.item.relations;
...
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.relations.count.CountRequestBuilder;
