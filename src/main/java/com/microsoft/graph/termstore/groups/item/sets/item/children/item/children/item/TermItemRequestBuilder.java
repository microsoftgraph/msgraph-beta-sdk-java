package com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item;
...
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.termStore.groups.item.sets.item.children.item.children.item.relations.item collection
