package microsoft.graph.termstore.groups.item.sets.item.children.item.children.item;
...
import microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.children.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.termStore.groups.item.sets.item.children.item.children.item.relations.item collection
