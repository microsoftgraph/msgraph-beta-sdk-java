package com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item;
...
import com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.set.SetRequestBuilder;
