package microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item;
...
import microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.relations.item.RelationItemRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.relations.RelationsRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.item.terms.item.children.item.set.SetRequestBuilder;
...
public class TermItemRequestBuilder {
    ...
    public TermItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.termStore.groups.item.sets.item.terms.item.children.item.relations.item collection
