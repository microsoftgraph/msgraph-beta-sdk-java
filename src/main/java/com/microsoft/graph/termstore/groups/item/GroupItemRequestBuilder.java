package microsoft.graph.termstore.groups.item;
...
import microsoft.graph.termstore.groups.item.sets.item.SetItemRequestBuilder;
import microsoft.graph.termstore.groups.item.sets.SetsRequestBuilder;
...
public class GroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.termStore.groups.item.sets.item collection
