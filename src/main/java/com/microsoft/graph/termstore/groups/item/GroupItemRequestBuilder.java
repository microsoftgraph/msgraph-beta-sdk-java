package com.microsoft.graph.termstore.groups.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.termstore.Group;
import com.microsoft.graph.termstore.groups.item.sets.item.SetItemRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.SetsRequestBuilder;
...
public class GroupItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GroupItemRequestBuilder and sets the default values.
    ...
    public GroupItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
