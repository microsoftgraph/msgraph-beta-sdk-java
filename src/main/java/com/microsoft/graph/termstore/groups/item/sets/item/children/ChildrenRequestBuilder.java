package com.microsoft.graph.termstore.groups.item.sets.item.children;
...
import com.microsoft.graph.termstore.groups.item.sets.item.children.count.CountRequestBuilder;
import com.microsoft.graph.termstore.groups.item.sets.item.children.item.TermItemRequestBuilder;
