...
import com.microsoft.graph.termstore.requests.extensions.ITermCollectionPage;
 ...
 */
public class TermCollectionRequest extends BaseCollectionRequest<TermCollectionResponse, ITermCollectionPage> implements ITermCollectionRequest {
     ...
     */
    public TermCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ITermCollectionPage get() throws ClientException {
        final TermCollectionResponse response = send();
     ...
     */
    public ITermCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ITermCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ITermCollectionRequest top(final int value) {
    ...
    public ITermCollectionPage buildFromResponse(final TermCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new TermCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final TermCollectionPage page = new TermCollectionPage(response, builder);
