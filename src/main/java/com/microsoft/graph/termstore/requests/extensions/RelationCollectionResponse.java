 ...
 */
public class RelationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Relation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Relation> value;
