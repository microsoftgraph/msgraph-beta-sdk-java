 ...
 */
public class TermReferenceRequest extends BaseReferenceRequest<Term> {
     ...
     */
    public TermReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public TermReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public TermReferenceRequest expand(@Nonnull final String value) {
