...
public class AccessReviewDecisionItemRequestBuilder {
     ...
     * @return a CompletableFuture of accessReviewDecision
     */
    public java.util.concurrent.CompletableFuture<AccessReviewDecision> patch(@javax.annotation.Nonnull final AccessReviewDecision body, @javax.annotation.Nullable final java.util.function.Consumer<AccessReviewDecisionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
