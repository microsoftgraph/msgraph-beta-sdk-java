package com.microsoft.graph.accessreviews.item.applydecisions;
...
public class ApplyDecisionsRequestBuilder {
    ...
    public ApplyDecisionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/accessReviews/{accessReview%2Did}/applyDecisions";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/accessreview-apply?view=graph-rest-1.0">Find more info here</a>
     */
