package com.microsoft.graph.accessreviews.item.instances.item.applydecisions;
...
public class ApplyDecisionsRequestBuilder {
    ...
    public ApplyDecisionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/applyDecisions";
