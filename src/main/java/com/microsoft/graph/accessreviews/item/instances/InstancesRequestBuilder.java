...
public class InstancesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessReviewCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessReviewCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessReviewCollectionResponse>();
