...
import com.microsoft.graph.accessreviews.item.instances.item.AccessReviewItemRequestBuilder;
...
public class InstancesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the instances property of the microsoft.graph.accessReview entity.
     * @param accessReviewId1 Unique identifier of the item
     * @return a AccessReviewItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public AccessReviewItemRequestBuilder byAccessReviewId1(@javax.annotation.Nonnull final String accessReviewId1) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessReview body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessReview body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
