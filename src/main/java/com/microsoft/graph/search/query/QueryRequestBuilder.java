...
public class QueryRequestBuilder {
    ...
    public QueryRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/search/query";
    ...
    public java.util.concurrent.CompletableFuture<QueryResponse> post(@javax.annotation.Nonnull final QueryPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<QueryResponse> executionException = new java.util.concurrent.CompletableFuture<QueryResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final QueryPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final QueryPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
