...
public class QnasRequestBuilder extends BaseRequestBuilder {
    ...
    public QnaCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, QnaCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public Qna post(@jakarta.annotation.Nonnull final Qna body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, Qna::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the qna objects and their properties. This API is available in the following national cloud deployments.
