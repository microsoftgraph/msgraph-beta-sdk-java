...
public class AcronymsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Acronym body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AcronymCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AcronymCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AcronymCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<Acronym> post(@javax.annotation.Nonnull final Acronym body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<Acronym> executionException = new java.util.concurrent.CompletableFuture<Acronym>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
