...
public class DecryptBufferRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a decryptBufferRequestBody
     */
    @javax.annotation.Nonnull
    public static DecryptBufferRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DecryptBufferRequestBody currentObject = this;
