package microsoft.graph.informationprotection.policy.labels.evaluateremoval;
...
import microsoft.graph.models.DowngradeJustification;
/** Provides operations to call the evaluateRemoval method. */
public class EvaluateRemovalRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a evaluateRemovalRequestBody
     */
    @javax.annotation.Nonnull
    public static EvaluateRemovalRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EvaluateRemovalRequestBody currentObject = this;
