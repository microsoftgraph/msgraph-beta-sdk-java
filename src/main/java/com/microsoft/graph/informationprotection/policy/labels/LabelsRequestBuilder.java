...
public class LabelsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final InformationProtectionLabel body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse>();
