...
public class LabelsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final InformationProtectionLabel body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final InformationProtectionLabel body, @javax.annotation.Nullable final java.util.function.Consumer<LabelsRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final LabelsRequestBuilderPostRequestConfiguration requestConfig = new LabelsRequestBuilderPostRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
    ...
    public java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, InformationProtectionLabelCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of InformationProtectionLabelCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<LabelsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of InformationProtectionLabelCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<InformationProtectionLabelCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<LabelsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, InformationProtectionLabelCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of informationProtectionLabel
     */
    public java.util.concurrent.CompletableFuture<InformationProtectionLabel> post(@javax.annotation.Nonnull final InformationProtectionLabel body, @javax.annotation.Nullable final java.util.function.Consumer<LabelsRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of informationProtectionLabel
     */
    public java.util.concurrent.CompletableFuture<InformationProtectionLabel> post(@javax.annotation.Nonnull final InformationProtectionLabel body, @javax.annotation.Nullable final java.util.function.Consumer<LabelsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
