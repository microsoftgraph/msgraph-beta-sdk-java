package microsoft.graph.informationprotection.policy.labels.extractlabel;
...
public class ExtractLabelPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ExtractLabelPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExtractLabelPostRequestBody currentObject = this;
