...
public class PolicyRequestBuilder {
     ...
     * @return a CompletableFuture of informationProtectionPolicy
     */
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> patch(@javax.annotation.Nonnull final InformationProtectionPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
