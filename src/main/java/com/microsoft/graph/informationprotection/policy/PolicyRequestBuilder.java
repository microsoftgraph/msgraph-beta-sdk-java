package microsoft.graph.informationprotection.policy;
...
import microsoft.graph.informationprotection.policy.labels.item.InformationProtectionLabelItemRequestBuilder;
import microsoft.graph.informationprotection.policy.labels.LabelsRequestBuilder;
...
public class PolicyRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.informationProtection.policy.labels.item collection
