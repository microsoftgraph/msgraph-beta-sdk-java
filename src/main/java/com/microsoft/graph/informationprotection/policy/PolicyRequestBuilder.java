...
public class PolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<InformationProtectionPolicy> executionException = new java.util.concurrent.CompletableFuture<InformationProtectionPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
