...
import com.microsoft.graph.informationprotection.threatassessmentrequests.count.CountRequestBuilder;
...
public class ThreatAssessmentRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public ThreatAssessmentRequestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/informationProtection/threatAssessmentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ThreatAssessmentRequestsRequestBuilder and sets the default values.
