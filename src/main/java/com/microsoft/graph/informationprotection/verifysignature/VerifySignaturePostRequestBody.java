...
public class VerifySignaturePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("digest", (n) -> { currentObject.setDigest(n.getByteArrayValue()); });
        deserializerMap.put("signature", (n) -> { currentObject.setSignature(n.getByteArrayValue()); });
        deserializerMap.put("signingKeyId", (n) -> { currentObject.setSigningKeyId(n.getStringValue()); });
