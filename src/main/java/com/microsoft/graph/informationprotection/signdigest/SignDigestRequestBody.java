...
public class SignDigestRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a signDigestRequestBody
     */
    @javax.annotation.Nonnull
    public static SignDigestRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SignDigestRequestBody currentObject = this;
