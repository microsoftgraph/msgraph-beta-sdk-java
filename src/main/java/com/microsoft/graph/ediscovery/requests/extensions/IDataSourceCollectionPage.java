...
/**
 * The interface for the Data Source Collection Page.
 */
public interface IDataSourceCollectionPage extends IBaseCollectionPage<DataSource, IDataSourceCollectionRequestBuilder> {
}
