...
/**
 * The interface for the Add To Review Set Operation Request Builder.
 */
public interface IAddToReviewSetOperationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAddToReviewSetOperationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAddToReviewSetOperationRequest instance
     */
    IAddToReviewSetOperationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
