...
/**
 * The class for the Source Collection Object With Reference Request Builder.
 */
public class SourceCollectionObjectWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<SourceCollectionObject, SourceCollectionObjectWithReferenceRequest, SourceCollectionObjectReferenceRequestBuilder> {

    /**
     * The request builder for the SourceCollectionObject
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public SourceCollectionObjectWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SourceCollectionObjectWithReferenceRequest.class, SourceCollectionObjectReferenceRequestBuilder.class);
    }
}
