 ...
 */
public class SourceCollectionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SourceCollection within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SourceCollection> value;
