...
/**
 * The interface for the Tag Reference Request Builder.
 */
public interface ITagReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ITagReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ITagReferenceRequest instance
     */
    ITagReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
