...
/**
 * The interface for the Source Collection Collection Page.
 */
public interface ISourceCollectionCollectionPage extends IBaseCollectionPage<SourceCollection, ISourceCollectionCollectionRequestBuilder> {
}
