...
public class NoncustodialDataSourceCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<NoncustodialDataSource, NoncustodialDataSourceWithReferenceRequest, NoncustodialDataSourceReferenceRequestBuilder, NoncustodialDataSourceWithReferenceRequestBuilder, NoncustodialDataSourceCollectionResponse, NoncustodialDataSourceCollectionWithReferencesPage, NoncustodialDataSourceCollectionWithReferencesRequest> {
     ...
     */
    public NoncustodialDataSourceCollectionWithReferencesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public NoncustodialDataSourceCollectionWithReferencesRequest count() {
        addCountOption(true);
        return this;
    }
}
