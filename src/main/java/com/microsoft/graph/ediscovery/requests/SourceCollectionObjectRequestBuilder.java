...
/**
 * The class for the Source Collection Object Request Builder.
 */
public class SourceCollectionObjectRequestBuilder extends BaseRequestBuilder<SourceCollectionObject> {
     ...
     */
    public SourceCollectionObjectRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the SourceCollectionObjectRequest instance
     */
    @Nonnull
    public SourceCollectionObjectRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public SourceCollectionObjectRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.ediscovery.requests.SourceCollectionObjectRequest(getRequestUrl(), getClient(), requestOptions);
    }
