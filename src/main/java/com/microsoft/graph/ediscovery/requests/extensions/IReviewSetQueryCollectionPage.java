...
/**
 * The interface for the Review Set Query Collection Page.
 */
public interface IReviewSetQueryCollectionPage extends IBaseCollectionPage<ReviewSetQuery, IReviewSetQueryCollectionRequestBuilder> {
}
