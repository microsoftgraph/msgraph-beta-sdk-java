 ...
 */
public class ReviewSetQueryCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ReviewSetQuery within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ReviewSetQuery> value;
