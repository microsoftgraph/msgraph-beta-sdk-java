 ...
 */
public class DataSourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DataSource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DataSource> value;
