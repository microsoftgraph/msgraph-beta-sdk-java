...
/**
 * The interface for the User Source Collection Page.
 */
public interface IUserSourceCollectionPage extends IBaseCollectionPage<UserSource, IUserSourceCollectionRequestBuilder> {
}
