...
/**
 * The interface for the Source Collection With Reference Request Builder.
 */
public interface ISourceCollectionWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    ISourceCollectionWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISourceCollectionWithReferenceRequest instance
     */
    ISourceCollectionWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    ISourceCollectionReferenceRequestBuilder reference();
