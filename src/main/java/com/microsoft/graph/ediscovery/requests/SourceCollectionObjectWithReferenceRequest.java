...
/**
 * The class for the Source Collection Object With Reference Request.
 */
public class SourceCollectionObjectWithReferenceRequest extends BaseWithReferenceRequest<SourceCollectionObject> {
     ...
     */
    public SourceCollectionObjectWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public SourceCollectionObjectWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SourceCollectionObjectWithReferenceRequest expand(@Nonnull final String value) {
