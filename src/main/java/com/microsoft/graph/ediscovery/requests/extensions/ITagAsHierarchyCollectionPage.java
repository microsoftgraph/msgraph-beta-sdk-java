...
/**
 * The interface for the Tag As Hierarchy Collection Page.
 */
public interface ITagAsHierarchyCollectionPage extends IBaseCollectionPage<Tag, ITagAsHierarchyCollectionRequestBuilder> {
}
