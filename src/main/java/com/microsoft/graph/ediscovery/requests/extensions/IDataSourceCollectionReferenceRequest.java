...
/**
 * The interface for the Data Source Collection Reference Request.
 */
public interface IDataSourceCollectionReferenceRequest {

    IDataSourceCollectionReferenceRequest select(final String value);

    IDataSourceCollectionReferenceRequest top(final int value);
