...
/**
 * The interface for the Site Source Collection Page.
 */
public interface ISiteSourceCollectionPage extends IBaseCollectionPage<SiteSource, ISiteSourceCollectionRequestBuilder> {
}
