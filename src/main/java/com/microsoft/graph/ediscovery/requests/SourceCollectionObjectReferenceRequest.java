...
/**
 * The class for the Source Collection Object Reference Request.
 */
public class SourceCollectionObjectReferenceRequest extends BaseReferenceRequest<SourceCollectionObject> {
     ...
     */
    public SourceCollectionObjectReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public SourceCollectionObjectReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SourceCollectionObjectReferenceRequest expand(@Nonnull final String value) {
