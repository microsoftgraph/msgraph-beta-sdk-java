...
/**
 * The class for the Source Collection Object Reference Request Builder.
 */
public class SourceCollectionObjectReferenceRequestBuilder extends BaseReferenceRequestBuilder<SourceCollectionObject, SourceCollectionObjectReferenceRequest> {
     ...
     */
    public SourceCollectionObjectReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, SourceCollectionObjectReferenceRequest.class);
    }
}
