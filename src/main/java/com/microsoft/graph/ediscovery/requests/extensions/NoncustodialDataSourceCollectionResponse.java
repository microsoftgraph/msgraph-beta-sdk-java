 ...
 */
public class NoncustodialDataSourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of NoncustodialDataSource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<NoncustodialDataSource> value;
