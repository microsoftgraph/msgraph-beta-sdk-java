package com.microsoft.graph.privilegedroleassignments.item.roleinfo.settings;
...
public class SettingsRequestBuilder {
    ...
    public SettingsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/settings{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PrivilegedRoleSettings body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final PrivilegedRoleSettings body, @javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedRoleSettings::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of privilegedRoleSettings
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> get(@javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of privilegedRoleSettings
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> get(@javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PrivilegedRoleSettings::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of privilegedRoleSettings
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> patch(@javax.annotation.Nonnull final PrivilegedRoleSettings body) {
        try {
     ...
     * @return a CompletableFuture of privilegedRoleSettings
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> patch(@javax.annotation.Nonnull final PrivilegedRoleSettings body, @javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of privilegedRoleSettings
     */
    public java.util.concurrent.CompletableFuture<PrivilegedRoleSettings> patch(@javax.annotation.Nonnull final PrivilegedRoleSettings body, @javax.annotation.Nullable final java.util.function.Consumer<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
