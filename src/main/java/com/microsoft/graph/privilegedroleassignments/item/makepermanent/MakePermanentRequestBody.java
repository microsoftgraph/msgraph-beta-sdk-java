...
public class MakePermanentRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a makePermanentRequestBody
     */
    @javax.annotation.Nonnull
    public static MakePermanentRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final MakePermanentRequestBody currentObject = this;
