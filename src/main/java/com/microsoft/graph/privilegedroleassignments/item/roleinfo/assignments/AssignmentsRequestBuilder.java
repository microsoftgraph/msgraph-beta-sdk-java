package microsoft.graph.privilegedroleassignments.item.roleinfo.assignments;
...
import microsoft.graph.privilegedroleassignments.item.roleinfo.assignments.count.CountRequestBuilder;
