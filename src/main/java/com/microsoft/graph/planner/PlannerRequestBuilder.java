...
import microsoft.graph.planner.rosters.item.PlannerRosterItemRequestBuilder;
import microsoft.graph.planner.rosters.RostersRequestBuilder;
...
public class PlannerRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.planner.rosters.item collection
     * @param id Unique identifier of the item
     * @return a plannerRosterItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PlannerRosterItemRequestBuilder rosters(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("plannerRoster%2Did", id);
