package com.microsoft.graph.planner.plans.item.movetocontainer;
...
public class MoveToContainerRequestBuilder extends BaseRequestBuilder {
    ...
    public MoveToContainerRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/moveToContainer", pathParameters);
    }
    /**
     * Instantiates a new MoveToContainerRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<PlannerPlan> post(@jakarta.annotation.Nonnull final MoveToContainerPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PlannerPlan> post(@jakarta.annotation.Nonnull final MoveToContainerPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MoveToContainerRequestBuilder
     */
    @jakarta.annotation.Nonnull
