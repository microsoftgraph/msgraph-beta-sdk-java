...
public class MembersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PlannerRosterMemberCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PlannerRosterMemberCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PlannerRosterMemberCollectionResponse>();
