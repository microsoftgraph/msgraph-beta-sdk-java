...
public class MembersRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the members property of the microsoft.graph.plannerRoster entity.
     * @param plannerRosterMemberId Unique identifier of the item
     * @return a PlannerRosterMemberItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PlannerRosterMemberItemRequestBuilder byPlannerRosterMemberId(@javax.annotation.Nonnull final String plannerRosterMemberId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PlannerRosterMember body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PlannerRosterMember body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
