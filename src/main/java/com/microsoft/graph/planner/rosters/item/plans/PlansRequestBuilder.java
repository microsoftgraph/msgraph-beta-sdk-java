...
public class PlansRequestBuilder extends BaseRequestBuilder {
    ...
    public PlansRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/rosters/{plannerRoster%2Did}/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PlansRequestBuilder and sets the default values.
    ...
    public PlansRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/planner/rosters/{plannerRoster%2Did}/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get the plannerPlans contained by the plannerRoster.
     * @return a CompletableFuture of plannerPlanCollectionResponse
     * @see <a href="https://learn.microsoft.com/graph/api/plannerroster-list-plans?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
