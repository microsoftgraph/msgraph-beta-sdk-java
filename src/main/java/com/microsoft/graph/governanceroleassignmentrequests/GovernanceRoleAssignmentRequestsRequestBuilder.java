...
public class GovernanceRoleAssignmentRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public GovernanceRoleAssignmentRequestsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public GovernanceRoleAssignmentRequestsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
