...
/**
 * The class for the Alert Record Set Portal Notification As Sent Parameter Set.
 */
public class AlertRecordSetPortalNotificationAsSentParameterSet {

    /**
     * Instiaciates a new AlertRecordSetPortalNotificationAsSentParameterSet
     */
     ...
     */
    protected AlertRecordSetPortalNotificationAsSentParameterSet(@Nonnull final AlertRecordSetPortalNotificationAsSentParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the AlertRecordSetPortalNotificationAsSentParameterSet
     */
    public static final class AlertRecordSetPortalNotificationAsSentParameterSetBuilder {
        /**
         * Instanciates a new AlertRecordSetPortalNotificationAsSentParameterSetBuilder
         */
        @Nullable
