...
public class B2xUserFlowsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final B2xIdentityUserFlow body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<B2xIdentityUserFlowCollectionResponse> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<B2xIdentityUserFlowCollectionResponse>() {{
