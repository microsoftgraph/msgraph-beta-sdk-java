package com.microsoft.graph.identity.b2cuserflows.item.languages.item.overridespages.item;

import com.microsoft.graph.identity.b2cuserflows.item.languages.item.overridespages.item.value.ContentRequestBuilder;
...
public class UserFlowLanguagePageItemRequestBuilder {
    ...
    public UserFlowLanguagePageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages/{userFlowLanguagePage%2Did}{?%24select,%24expand}";
