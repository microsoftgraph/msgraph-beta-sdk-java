package com.microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages;

import com.microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.count.CountRequestBuilder;
