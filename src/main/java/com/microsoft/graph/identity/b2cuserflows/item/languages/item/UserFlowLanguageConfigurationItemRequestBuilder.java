package microsoft.graph.identity.b2cuserflows.item.languages.item;
...
import microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.DefaultPagesRequestBuilder;
import microsoft.graph.identity.b2cuserflows.item.languages.item.overridespages.OverridesPagesRequestBuilder;
...
public class UserFlowLanguageConfigurationItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.identity.b2cUserFlows.item.languages.item.defaultPages.item collection
     * @param id Unique identifier of the item
     * @return a userFlowLanguagePageItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.item.UserFlowLanguagePageItemRequestBuilder defaultPages(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("userFlowLanguagePage%2Did", id);
        return new microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.item.UserFlowLanguagePageItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Delete navigation property languages for identity
    ...
    /**
     * Gets an item from the Microsoft.Graph.identity.b2cUserFlows.item.languages.item.overridesPages.item collection
     * @param id Unique identifier of the item
     * @return a userFlowLanguagePageItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.identity.b2cuserflows.item.languages.item.overridespages.item.UserFlowLanguagePageItemRequestBuilder overridesPages(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("userFlowLanguagePage%2Did", id);
        return new microsoft.graph.identity.b2cuserflows.item.languages.item.overridespages.item.UserFlowLanguagePageItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property languages in identity
     * @param body 
