package com.microsoft.graph.identity.b2cuserflows.item.userflowidentityproviders.item;
...
public class IdentityProviderBaseItemRequestBuilder {
    ...
    public IdentityProviderBaseItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userFlowIdentityProviders/{identityProviderBase%2Did}{?%24select,%24expand}";
