package microsoft.graph.identity.b2cuserflows.item.userattributeassignments.item;
...
import microsoft.graph.identity.b2cuserflows.item.userattributeassignments.item.userattribute.UserAttributeRequestBuilder;
