package com.microsoft.graph.identity.b2cuserflows.item.userattributeassignments;

import com.microsoft.graph.identity.b2cuserflows.item.userattributeassignments.count.CountRequestBuilder;
import com.microsoft.graph.identity.b2cuserflows.item.userattributeassignments.getorder.GetOrderRequestBuilder;
import com.microsoft.graph.identity.b2cuserflows.item.userattributeassignments.setorder.SetOrderRequestBuilder;
...
public class UserAttributeAssignmentsRequestBuilder {
    ...
    public UserAttributeAssignmentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
