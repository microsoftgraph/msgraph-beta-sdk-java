package microsoft.graph.identity.b2cuserflows.item.userattributeassignments;
...
import microsoft.graph.identity.b2cuserflows.item.userattributeassignments.count.CountRequestBuilder;
import microsoft.graph.identity.b2cuserflows.item.userattributeassignments.getorder.GetOrderRequestBuilder;
import microsoft.graph.identity.b2cuserflows.item.userattributeassignments.setorder.SetOrderRequestBuilder;
