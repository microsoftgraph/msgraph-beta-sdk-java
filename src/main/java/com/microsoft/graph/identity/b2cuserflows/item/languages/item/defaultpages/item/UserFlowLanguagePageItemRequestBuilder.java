package microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.item;
...
import microsoft.graph.identity.b2cuserflows.item.languages.item.defaultpages.item.value.ContentRequestBuilder;
