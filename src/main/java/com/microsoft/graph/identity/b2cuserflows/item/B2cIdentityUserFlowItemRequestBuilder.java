...
public class B2cIdentityUserFlowItemRequestBuilder {
     ...
     * @return a CompletableFuture of b2cIdentityUserFlow
     */
    public java.util.concurrent.CompletableFuture<B2cIdentityUserFlow> patch(@javax.annotation.Nonnull final B2cIdentityUserFlow body, @javax.annotation.Nullable final java.util.function.Consumer<B2cIdentityUserFlowItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of b2cIdentityUserFlow
     */
    public java.util.concurrent.CompletableFuture<B2cIdentityUserFlow> patch(@javax.annotation.Nonnull final B2cIdentityUserFlow body, @javax.annotation.Nullable final java.util.function.Consumer<B2cIdentityUserFlowItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
