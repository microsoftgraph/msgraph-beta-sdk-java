...
public class UserFlowsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final IdentityUserFlow body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<IdentityUserFlowCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityUserFlowCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IdentityUserFlowCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<IdentityUserFlow> post(@javax.annotation.Nonnull final IdentityUserFlow body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<IdentityUserFlow> executionException = new java.util.concurrent.CompletableFuture<IdentityUserFlow>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
