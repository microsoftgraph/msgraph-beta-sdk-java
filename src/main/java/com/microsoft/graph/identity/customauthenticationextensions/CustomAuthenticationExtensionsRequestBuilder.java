...
public class CustomAuthenticationExtensionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse>();
