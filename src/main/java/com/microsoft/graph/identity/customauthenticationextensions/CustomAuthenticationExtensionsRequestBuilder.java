...
import com.microsoft.graph.identity.customauthenticationextensions.item.CustomAuthenticationExtensionItemRequestBuilder;
...
public class CustomAuthenticationExtensionsRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomAuthenticationExtensionItemRequestBuilder byCustomAuthenticationExtensionId(@jakarta.annotation.Nonnull final String customAuthenticationExtensionId) {
        ...
        urlTplParams.put("customAuthenticationExtension%2Did", customAuthenticationExtensionId);
    ...
    public CustomAuthenticationExtensionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identity/customAuthenticationExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CustomAuthenticationExtensionsRequestBuilder and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public CustomAuthenticationExtensionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtensionCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtension> post(@jakarta.annotation.Nonnull final CustomAuthenticationExtension body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtension> post(@jakarta.annotation.Nonnull final CustomAuthenticationExtension body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CustomAuthenticationExtension body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CustomAuthenticationExtension body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
