...
public class CustomAuthenticationExtensionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the customAuthenticationExtensions property of the microsoft.graph.identityContainer entity.
     * @param customAuthenticationExtensionId Unique identifier of the item
     * @return a CustomAuthenticationExtensionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public CustomAuthenticationExtensionItemRequestBuilder byCustomAuthenticationExtensionId(@javax.annotation.Nonnull final String customAuthenticationExtensionId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CustomAuthenticationExtension body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final CustomAuthenticationExtension body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
