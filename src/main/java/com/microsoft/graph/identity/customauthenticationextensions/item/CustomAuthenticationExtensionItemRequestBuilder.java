...
public class CustomAuthenticationExtensionItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final CustomAuthenticationExtension body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CustomAuthenticationExtension> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomAuthenticationExtension> executionException = new java.util.concurrent.CompletableFuture<CustomAuthenticationExtension>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
