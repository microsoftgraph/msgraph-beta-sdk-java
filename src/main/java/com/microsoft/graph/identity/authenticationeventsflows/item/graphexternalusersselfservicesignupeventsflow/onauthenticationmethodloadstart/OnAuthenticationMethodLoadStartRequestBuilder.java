...
public class OnAuthenticationMethodLoadStartRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of OnAuthenticationMethodLoadStartHandler
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OnAuthenticationMethodLoadStartHandler> get() {
        return get(null);
    }
    /**
     * Required. The configuration for what to invoke when authentication methods are ready to be presented to the user. Must have at least one identity provider linked.
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OnAuthenticationMethodLoadStartHandler> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, OnAuthenticationMethodLoadStartHandler::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Required. The configuration for what to invoke when authentication methods are ready to be presented to the user. Must have at least one identity provider linked.
