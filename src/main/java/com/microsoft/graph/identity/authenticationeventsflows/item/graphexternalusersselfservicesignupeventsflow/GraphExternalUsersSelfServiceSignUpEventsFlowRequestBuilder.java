...
public class GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ExternalUsersSelfServiceSignUpEventsFlow
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExternalUsersSelfServiceSignUpEventsFlow> get() {
        return get(null);
    }
    /**
     * Get the item of type microsoft.graph.authenticationEventsFlow as microsoft.graph.externalUsersSelfServiceSignUpEventsFlow
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExternalUsersSelfServiceSignUpEventsFlow> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, ExternalUsersSelfServiceSignUpEventsFlow::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get the item of type microsoft.graph.authenticationEventsFlow as microsoft.graph.externalUsersSelfServiceSignUpEventsFlow
