...
public class AuthenticationEventsFlowsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the authenticationEventsFlows property of the microsoft.graph.identityContainer entity.
     * @param authenticationEventsFlowId Unique identifier of the item
     * @return a AuthenticationEventsFlowItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public AuthenticationEventsFlowItemRequestBuilder byAuthenticationEventsFlowId(@javax.annotation.Nonnull final String authenticationEventsFlowId) {
    ...
    public AuthenticationEventsFlowsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public AuthenticationEventsFlowsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AuthenticationEventsFlow body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AuthenticationEventsFlow body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
