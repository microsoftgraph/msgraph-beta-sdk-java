...
public class ContinuousAccessEvaluationPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ContinuousAccessEvaluationPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ContinuousAccessEvaluationPolicy> executionException = new java.util.concurrent.CompletableFuture<ContinuousAccessEvaluationPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
