...
public class ContinuousAccessEvaluationPolicyRequestBuilder {
     ...
     * @return a CompletableFuture of continuousAccessEvaluationPolicy
     */
    public java.util.concurrent.CompletableFuture<ContinuousAccessEvaluationPolicy> patch(@javax.annotation.Nonnull final ContinuousAccessEvaluationPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ContinuousAccessEvaluationPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of continuousAccessEvaluationPolicy
     */
    public java.util.concurrent.CompletableFuture<ContinuousAccessEvaluationPolicy> patch(@javax.annotation.Nonnull final ContinuousAccessEvaluationPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ContinuousAccessEvaluationPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
