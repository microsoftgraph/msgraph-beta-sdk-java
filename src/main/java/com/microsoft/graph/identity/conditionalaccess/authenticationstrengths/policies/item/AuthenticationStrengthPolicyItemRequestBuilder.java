...
public class AuthenticationStrengthPolicyItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identity.conditionalAccess.authenticationStrengths.policies.item.combinationConfigurations.item collection
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final AuthenticationStrengthPolicyItemRequestBuilderDeleteRequestConfiguration requestConfig = new AuthenticationStrengthPolicyItemRequestBuilderDeleteRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        final RequestInformation requestInfo = new RequestInformation() {{
        ...
        if (requestConfiguration != null) {
            final AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration requestConfig = new AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration();
            requestConfiguration.accept(requestConfig);
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final AuthenticationStrengthPolicyItemRequestBuilderPatchRequestConfiguration requestConfig = new AuthenticationStrengthPolicyItemRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AuthenticationStrengthPolicy::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of authenticationStrengthPolicy
     */
    public java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of authenticationStrengthPolicy
     */
    public java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, AuthenticationStrengthPolicy::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<AuthenticationStrengthPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
    ...
    public class AuthenticationStrengthPolicyItemRequestBuilderGetRequestConfiguration {
        ...
        @javax.annotation.Nullable
        public AuthenticationStrengthPolicyItemRequestBuilderGetQueryParameters queryParameters = new AuthenticationStrengthPolicyItemRequestBuilderGetQueryParameters();
        /**
