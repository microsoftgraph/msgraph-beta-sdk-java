package microsoft.graph.identity.conditionalaccess.authenticationcontextclassreferences.item;
...
import microsoft.graph.models.AuthenticationContextClassReference;
...
public class AuthenticationContextClassReferenceItemRequestBuilder {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationContextClassReference body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationContextClassReference body, @javax.annotation.Nullable final java.util.function.Consumer<AuthenticationContextClassReferenceItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AuthenticationContextClassReference body, @javax.annotation.Nullable final java.util.function.Consumer<AuthenticationContextClassReferenceItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
