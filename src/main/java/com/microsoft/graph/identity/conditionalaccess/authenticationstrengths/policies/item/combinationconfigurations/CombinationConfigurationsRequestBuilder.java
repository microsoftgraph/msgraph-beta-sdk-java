...
public class CombinationConfigurationsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AuthenticationCombinationConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationCombinationConfigurationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationCombinationConfigurationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AuthenticationCombinationConfigurationCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationCombinationConfiguration> post(@javax.annotation.Nonnull final AuthenticationCombinationConfiguration body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationCombinationConfiguration> executionException = new java.util.concurrent.CompletableFuture<AuthenticationCombinationConfiguration>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
