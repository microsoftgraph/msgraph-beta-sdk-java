...
public class AuthenticationMethodModesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AuthenticationMethodModeDetail body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetailCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetailCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetailCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetail> post(@javax.annotation.Nonnull final AuthenticationMethodModeDetail body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetail> executionException = new java.util.concurrent.CompletableFuture<AuthenticationMethodModeDetail>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
