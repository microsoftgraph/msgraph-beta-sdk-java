...
public class DataClassificationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DataClassificationService body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DataClassificationService> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DataClassificationService> executionException = new java.util.concurrent.CompletableFuture<DataClassificationService>();
