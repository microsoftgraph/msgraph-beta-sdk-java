...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ExactMatchSessionCollectionResponse get() {
        return get(null);
    }
    /**
     * Get sessions from dataClassification
     ...
     */
    @jakarta.annotation.Nullable
    public ExactMatchSessionCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, ExactMatchSessionCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ExactMatchSession post(@jakarta.annotation.Nonnull final ExactMatchSession body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ExactMatchSession post(@jakarta.annotation.Nonnull final ExactMatchSession body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
