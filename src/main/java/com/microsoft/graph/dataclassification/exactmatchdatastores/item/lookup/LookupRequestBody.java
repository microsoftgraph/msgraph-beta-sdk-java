...
public class LookupRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a lookupRequestBody
     */
    @javax.annotation.Nonnull
    public static LookupRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final LookupRequestBody currentObject = this;
