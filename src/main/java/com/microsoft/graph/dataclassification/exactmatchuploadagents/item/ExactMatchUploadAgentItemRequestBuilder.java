...
public class ExactMatchUploadAgentItemRequestBuilder {
     ...
     * @return a CompletableFuture of exactMatchUploadAgent
     */
    public java.util.concurrent.CompletableFuture<ExactMatchUploadAgent> patch(@javax.annotation.Nonnull final ExactMatchUploadAgent body, @javax.annotation.Nullable final java.util.function.Consumer<ExactMatchUploadAgentItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
