...
public class JobsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final SynchronizationJob body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SynchronizationJobCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SynchronizationJobCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SynchronizationJobCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<SynchronizationJob> post(@javax.annotation.Nonnull final SynchronizationJob body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<SynchronizationJob> executionException = new java.util.concurrent.CompletableFuture<SynchronizationJob>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
