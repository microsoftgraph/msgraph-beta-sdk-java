...
public class StringKeyStringValuePairPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a StringKeyStringValuePairPostRequestBody
     */
    @javax.annotation.Nonnull
    public static StringKeyStringValuePairPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StringKeyStringValuePairPostRequestBody currentObject = this;
