package microsoft.graph.serviceprincipals.item.updatepasswordsinglesignoncredentials;
...
public class UpdatePasswordSingleSignOnCredentialsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a updatePasswordSingleSignOnCredentialsRequestBody
     */
    @javax.annotation.Nonnull
    public static UpdatePasswordSingleSignOnCredentialsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdatePasswordSingleSignOnCredentialsRequestBody currentObject = this;
