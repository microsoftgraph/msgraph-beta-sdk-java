package microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.createpasswordsinglesignoncredentials;
...
public class CreatePasswordSingleSignOnCredentialsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CreatePasswordSingleSignOnCredentialsPostRequestBody currentObject = this;
