package microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.addtokensigningcertificate.AddTokenSigningCertificateRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.createpasswordsinglesignoncredentials.CreatePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.deletepasswordsinglesignoncredentials.DeletePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.getpasswordsinglesignoncredentials.GetPasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.restore.RestoreRequestBuilder;
import microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.updatepasswordsinglesignoncredentials.UpdatePasswordSingleSignOnCredentialsRequestBuilder;
