package microsoft.graph.serviceprincipals.item.synchronization.templates.item.schema.filteroperators;
...
public class FilterOperatorsRequestBuilder {
    ...
    public FilterOperatorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/microsoft.graph.filterOperators()";
