...
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.createpasswordsinglesignoncredentials.CreatePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.deletepasswordsinglesignoncredentials.DeletePasswordSingleSignOnCredentialsRequestBuilder;
...
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.getpasswordsinglesignoncredentials.GetPasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.restore.RestoreRequestBuilder;
import microsoft.graph.serviceprincipals.item.owners.item.serviceprincipal.updatepasswordsinglesignoncredentials.UpdatePasswordSingleSignOnCredentialsRequestBuilder;
