package microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal;
...
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.addtokensigningcertificate.AddTokenSigningCertificateRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.createpasswordsinglesignoncredentials.CreatePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.deletepasswordsinglesignoncredentials.DeletePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.getpasswordsinglesignoncredentials.GetPasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.restore.RestoreRequestBuilder;
import microsoft.graph.serviceprincipals.item.ownedobjects.item.serviceprincipal.updatepasswordsinglesignoncredentials.UpdatePasswordSingleSignOnCredentialsRequestBuilder;
