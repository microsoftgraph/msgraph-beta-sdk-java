package microsoft.graph.serviceprincipals.item.synchronization.jobs.item.provisionondemand;
...
public class StringKeyStringValuePairRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a StringKeyStringValuePairRequestBody
     */
    @javax.annotation.Nonnull
    public static StringKeyStringValuePairRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final StringKeyStringValuePairRequestBody currentObject = this;
