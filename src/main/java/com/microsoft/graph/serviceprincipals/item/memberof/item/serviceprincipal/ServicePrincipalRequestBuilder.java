...
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.createpasswordsinglesignoncredentials.CreatePasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.deletepasswordsinglesignoncredentials.DeletePasswordSingleSignOnCredentialsRequestBuilder;
...
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.getpasswordsinglesignoncredentials.GetPasswordSingleSignOnCredentialsRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.restore.RestoreRequestBuilder;
import microsoft.graph.serviceprincipals.item.memberof.item.serviceprincipal.updatepasswordsinglesignoncredentials.UpdatePasswordSingleSignOnCredentialsRequestBuilder;
