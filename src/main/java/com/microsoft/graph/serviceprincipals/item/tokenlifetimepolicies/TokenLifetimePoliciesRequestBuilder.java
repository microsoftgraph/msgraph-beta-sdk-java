...
public class TokenLifetimePoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TokenLifetimePolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TokenLifetimePolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TokenLifetimePolicyCollectionResponse>();
