package microsoft.graph.serviceprincipals.item.createdobjects.item.serviceprincipal.getpasswordsinglesignoncredentials;
...
public class GetPasswordSingleSignOnCredentialsRequestBuilder {
    ...
    public GetPasswordSingleSignOnCredentialsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects/{directoryObject%2Did}/microsoft.graph.servicePrincipal/microsoft.graph.getPasswordSingleSignOnCredentials";
