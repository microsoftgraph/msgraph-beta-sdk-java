...
public class RestartRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a restartRequestBody
     */
    @javax.annotation.Nonnull
    public static RestartRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RestartRequestBody currentObject = this;
