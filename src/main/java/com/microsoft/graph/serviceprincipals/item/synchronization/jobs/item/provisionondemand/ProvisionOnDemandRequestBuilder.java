...
public class ProvisionOnDemandRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ProvisionOnDemandPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<StringKeyStringValuePair> post(@javax.annotation.Nonnull final ProvisionOnDemandPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<StringKeyStringValuePair> executionException = new java.util.concurrent.CompletableFuture<StringKeyStringValuePair>();
