...
import com.microsoft.graph.organization.item.partnerinformation.PartnerInformationRequestBuilder;
...
public class OrganizationItemRequestBuilder extends BaseRequestBuilder {
    ...
    public PartnerInformationRequestBuilder partnerInformation() {
        return new PartnerInformationRequestBuilder(pathParameters, requestAdapter);
    }
    /**
