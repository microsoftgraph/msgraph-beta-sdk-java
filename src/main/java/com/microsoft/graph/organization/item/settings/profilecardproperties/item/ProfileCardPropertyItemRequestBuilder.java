...
public class ProfileCardPropertyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ProfileCardProperty body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ProfileCardProperty> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProfileCardProperty> executionException = new java.util.concurrent.CompletableFuture<ProfileCardProperty>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
