...
public class ProfileCardPropertiesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ProfileCardProperty body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ProfileCardPropertyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ProfileCardPropertyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ProfileCardPropertyCollectionResponse>();
