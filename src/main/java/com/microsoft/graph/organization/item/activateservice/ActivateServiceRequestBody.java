package microsoft.graph.organization.item.activateservice;
...
public class ActivateServiceRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a activateServiceRequestBody
     */
    @javax.annotation.Nonnull
    public static ActivateServiceRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ActivateServiceRequestBody currentObject = this;
