...
public class OrganizationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OrganizationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OrganizationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OrganizationCollectionResponse>();
