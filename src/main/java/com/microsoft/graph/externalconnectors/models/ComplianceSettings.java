...
/**
 * The class for the Compliance Settings.
 */
public class ComplianceSettings implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<DisplayTemplate> eDiscoveryResultTemplates;
