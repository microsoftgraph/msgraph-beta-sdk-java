...
public class ExternalItemRequestBuilder extends BaseRequestBuilder<ExternalItem> {
     ...
     */
    @Nonnull
    public ExternalActivityCollectionRequestBuilder activities() {
        return new ExternalActivityCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("activities"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public ExternalActivityRequestBuilder activities(@Nonnull final String id) {
        return new ExternalActivityRequestBuilder(getRequestUrlWithAdditionalSegment("activities") + "/" + id, getClient(), null);
    }
