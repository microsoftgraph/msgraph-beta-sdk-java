package microsoft.graph.bookingbusinesses.item.calendarview.item;
...
import microsoft.graph.bookingbusinesses.item.calendarview.item.cancel.CancelRequestBuilder;
