...
public class GetStaffAvailabilityRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a getStaffAvailabilityRequestBody
     */
    @javax.annotation.Nonnull
    public static GetStaffAvailabilityRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GetStaffAvailabilityRequestBody currentObject = this;
