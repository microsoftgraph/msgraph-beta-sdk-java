package com.microsoft.graph.bookingbusinesses.item.unpublish;
...
public class UnpublishRequestBuilder extends BaseRequestBuilder {
    ...
    public UnpublishRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/unpublish", pathParameters);
    }
    /**
     * Instantiates a new UnpublishRequestBuilder and sets the default values.
    ...
    public UnpublishRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/unpublish", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/bookingbusiness-unpublish?view=graph-rest-1.0">Find more info here</a>
     */
