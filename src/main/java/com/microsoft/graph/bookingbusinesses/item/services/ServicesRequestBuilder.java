...
public class ServicesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final BookingService body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BookingServiceCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BookingServiceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BookingServiceCollectionResponse>();
