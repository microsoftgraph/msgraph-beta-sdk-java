...
public class CalendarViewRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final BookingAppointment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BookingAppointmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BookingAppointmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BookingAppointmentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<BookingAppointment> post(@javax.annotation.Nonnull final BookingAppointment body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<BookingAppointment> executionException = new java.util.concurrent.CompletableFuture<BookingAppointment>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
