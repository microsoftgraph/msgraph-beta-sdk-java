...
public class BookingBusinessItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.appointments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.calendarView.item collection
     * @param id Unique identifier of the item
     * @return a BookingAppointmentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.customers.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.customQuestions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.services.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.bookingBusinesses.item.staffMembers.item collection
     * @param id Unique identifier of the item
