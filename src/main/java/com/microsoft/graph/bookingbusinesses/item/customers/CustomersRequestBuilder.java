...
public class CustomersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final BookingCustomer body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BookingCustomerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BookingCustomerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BookingCustomerCollectionResponse>();
