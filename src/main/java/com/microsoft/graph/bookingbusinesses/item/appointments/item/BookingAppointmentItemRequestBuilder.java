package microsoft.graph.bookingbusinesses.item.appointments.item;
...
import microsoft.graph.bookingbusinesses.item.appointments.item.cancel.CancelRequestBuilder;
