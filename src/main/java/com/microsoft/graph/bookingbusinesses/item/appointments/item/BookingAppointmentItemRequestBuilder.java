package com.microsoft.graph.bookingbusinesses.item.appointments.item;

import com.microsoft.graph.bookingbusinesses.item.appointments.item.cancel.CancelRequestBuilder;
