package com.microsoft.graph.solutions.virtualevents.townhalls.item.sessions.item.presenters.item.profilephoto;
...
public class ProfilePhotoRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public ProfilePhotoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}/profilePhoto", pathParameters);
    }
    /**
     * Instantiates a new ProfilePhotoRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ProfilePhotoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}/profilePhoto", rawUrl);
    }
    /**
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a ProfilePhotoRequestBuilder
     */
    @jakarta.annotation.Nonnull
    public ProfilePhotoRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
