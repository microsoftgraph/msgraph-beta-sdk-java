package com.microsoft.graph.solutions.virtualevents.townhalls.item.presenters.item.sessions;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventSessionCollectionResponse;
import com.microsoft.graph.solutions.virtualevents.townhalls.item.presenters.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.townhalls.item.presenters.item.sessions.item.VirtualEventSessionItemRequestBuilder;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/presenters/{virtualEventPresenter%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SessionsRequestBuilder and sets the default values.
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/presenters/{virtualEventPresenter%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
