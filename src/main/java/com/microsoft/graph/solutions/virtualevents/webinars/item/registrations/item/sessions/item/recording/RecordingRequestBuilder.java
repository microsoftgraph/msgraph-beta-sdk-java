package com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions.item.recording;
...
public class RecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public RecordingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/recording", pathParameters);
    }
    /**
     * Instantiates a new RecordingRequestBuilder and sets the default values.
    ...
    public RecordingRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/recording", rawUrl);
    }
    /**
