package com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions.item.alternativerecording;
...
public class AlternativeRecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public AlternativeRecordingRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/alternativeRecording", pathParameters);
    }
    /**
     * Instantiates a new AlternativeRecordingRequestBuilder and sets the default values.
    ...
    public AlternativeRecordingRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/alternativeRecording", rawUrl);
    }
    /**
