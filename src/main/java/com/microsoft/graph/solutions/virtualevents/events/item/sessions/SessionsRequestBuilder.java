...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the sessions property of the microsoft.graph.virtualEvent entity.
     * @param virtualEventSessionId Unique identifier of the item
     * @return a VirtualEventSessionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public VirtualEventSessionItemRequestBuilder byVirtualEventSessionId(@javax.annotation.Nonnull final String virtualEventSessionId) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VirtualEventSessionCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VirtualEventSession> post(@javax.annotation.Nonnull final VirtualEventSession body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VirtualEventSession> post(@javax.annotation.Nonnull final VirtualEventSession body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final VirtualEventSession body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final VirtualEventSession body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
