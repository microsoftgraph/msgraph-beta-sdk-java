package com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.registration.customquestions.item;
...
public class MeetingRegistrationQuestionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MeetingRegistrationQuestionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MeetingRegistrationQuestionItemRequestBuilder and sets the default values.
    ...
    public MeetingRegistrationQuestionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
