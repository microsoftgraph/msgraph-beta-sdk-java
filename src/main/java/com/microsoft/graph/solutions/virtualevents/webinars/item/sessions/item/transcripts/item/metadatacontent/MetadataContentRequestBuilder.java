package com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.transcripts.item.metadatacontent;
...
public class MetadataContentRequestBuilder extends BaseRequestBuilder {
    ...
    public MetadataContentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/transcripts/{callTranscript%2Did}/metadataContent", pathParameters);
    }
    /**
     * Instantiates a new MetadataContentRequestBuilder and sets the default values.
    ...
    public MetadataContentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/transcripts/{callTranscript%2Did}/metadataContent", rawUrl);
    }
    /**
