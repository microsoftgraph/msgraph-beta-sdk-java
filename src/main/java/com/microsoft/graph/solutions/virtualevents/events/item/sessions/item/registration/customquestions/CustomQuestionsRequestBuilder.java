package com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.registration.customquestions;
...
import com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.registration.customquestions.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.registration.customquestions.item.MeetingRegistrationQuestionItemRequestBuilder;
...
public class CustomQuestionsRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomQuestionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/registration/customQuestions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CustomQuestionsRequestBuilder and sets the default values.
