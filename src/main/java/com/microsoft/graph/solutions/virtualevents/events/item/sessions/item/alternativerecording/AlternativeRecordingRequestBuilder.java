package com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.alternativerecording;
...
public class AlternativeRecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public AlternativeRecordingRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/alternativeRecording", pathParameters);
    }
    /**
     * Instantiates a new AlternativeRecordingRequestBuilder and sets the default values.
