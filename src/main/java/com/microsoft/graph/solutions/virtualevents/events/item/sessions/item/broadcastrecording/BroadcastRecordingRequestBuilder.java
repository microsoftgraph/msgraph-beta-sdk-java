package com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.broadcastrecording;
...
public class BroadcastRecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public BroadcastRecordingRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/broadcastRecording", pathParameters);
    }
    /**
     * Instantiates a new BroadcastRecordingRequestBuilder and sets the default values.
    ...
    public BroadcastRecordingRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/broadcastRecording", rawUrl);
    }
    /**
