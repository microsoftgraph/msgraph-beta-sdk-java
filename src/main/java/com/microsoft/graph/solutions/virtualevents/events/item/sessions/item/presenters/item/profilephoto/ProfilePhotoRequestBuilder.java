package com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.presenters.item.profilephoto;
...
public class ProfilePhotoRequestBuilder extends BaseRequestBuilder {
    ...
    public ProfilePhotoRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}/profilePhoto", pathParameters);
    }
    /**
     * Instantiates a new ProfilePhotoRequestBuilder and sets the default values.
    ...
    public ProfilePhotoRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}/profilePhoto", rawUrl);
    }
    /**
