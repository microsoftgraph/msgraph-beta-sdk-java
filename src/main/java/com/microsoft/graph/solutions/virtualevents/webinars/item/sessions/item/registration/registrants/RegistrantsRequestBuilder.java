package com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.registration.registrants;
...
import com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.registration.registrants.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.registration.registrants.item.MeetingRegistrantBaseItemRequestBuilder;
...
public class RegistrantsRequestBuilder extends BaseRequestBuilder {
    ...
    public RegistrantsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registration/registrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RegistrantsRequestBuilder and sets the default values.
    ...
    public RegistrantsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registration/registrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
