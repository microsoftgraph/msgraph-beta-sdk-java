...
public class GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetByUserIdAndRoleWithUserIdWithRoleGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetByUserIdAndRoleWithUserIdWithRoleGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function getByUserIdAndRole
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetByUserIdAndRoleWithUserIdWithRoleGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetByUserIdAndRoleWithUserIdWithRoleGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getByUserIdAndRole
