package com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.transcripts.item;

import com.microsoft.graph.models.CallTranscript;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.transcripts.item.content.ContentRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.webinars.item.sessions.item.transcripts.item.metadatacontent.MetadataContentRequestBuilder;
...
public class CallTranscriptItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CallTranscriptItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CallTranscriptItemRequestBuilder and sets the default values.
    ...
    public CallTranscriptItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
