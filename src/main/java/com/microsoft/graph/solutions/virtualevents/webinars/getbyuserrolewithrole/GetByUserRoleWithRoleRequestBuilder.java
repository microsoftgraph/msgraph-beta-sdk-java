...
public class GetByUserRoleWithRoleRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of GetByUserRoleWithRoleGetResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetByUserRoleWithRoleGetResponse> get() {
        return get(null);
    }
    /**
     * Invoke function getByUserRole
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<GetByUserRoleWithRoleGetResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, GetByUserRoleWithRoleGetResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Invoke function getByUserRole
