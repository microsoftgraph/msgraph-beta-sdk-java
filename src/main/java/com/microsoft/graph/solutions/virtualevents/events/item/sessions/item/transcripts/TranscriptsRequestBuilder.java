package com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.transcripts;
...
import com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.transcripts.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.events.item.sessions.item.transcripts.item.CallTranscriptItemRequestBuilder;
...
public class TranscriptsRequestBuilder extends BaseRequestBuilder {
    ...
    public TranscriptsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/transcripts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TranscriptsRequestBuilder and sets the default values.
    ...
    public TranscriptsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/transcripts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
