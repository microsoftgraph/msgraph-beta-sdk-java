package com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.VirtualEventSessionCollectionResponse;
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions.count.CountRequestBuilder;
import com.microsoft.graph.solutions.virtualevents.webinars.item.registrations.item.sessions.item.VirtualEventSessionItemRequestBuilder;
...
public class SessionsRequestBuilder extends BaseRequestBuilder {
    ...
    public SessionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SessionsRequestBuilder and sets the default values.
    ...
    public java.util.concurrent.CompletableFuture<VirtualEventSessionCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<VirtualEventSessionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<VirtualEventSessionCollectionResponse>();
