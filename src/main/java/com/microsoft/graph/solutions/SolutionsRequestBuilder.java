...
import com.microsoft.graph.solutions.businessscenarios.BusinessScenariosRequestBuilder;
...
public class SolutionsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public BusinessScenarioItemRequestBuilder businessScenarios(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("businessScenario%2Did", id);
