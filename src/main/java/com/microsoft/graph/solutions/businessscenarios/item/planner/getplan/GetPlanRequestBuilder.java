...
public class GetPlanRequestBuilder {
    ...
    public GetPlanRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/microsoft.graph.getPlan";
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetPlanPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final GetPlanPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BusinessScenarioPlanReference> post(@javax.annotation.Nonnull final GetPlanPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessScenarioPlanReference> executionException = new java.util.concurrent.CompletableFuture<BusinessScenarioPlanReference>();
