...
public class PlannerRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final BusinessScenarioPlanner body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final BusinessScenarioPlanner body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BusinessScenarioPlanner> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessScenarioPlanner> executionException = new java.util.concurrent.CompletableFuture<BusinessScenarioPlanner>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
