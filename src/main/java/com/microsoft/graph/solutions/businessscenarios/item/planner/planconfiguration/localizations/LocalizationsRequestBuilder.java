package com.microsoft.graph.solutions.businessscenarios.item.planner.planconfiguration.localizations;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.PlannerPlanConfigurationLocalization;
import com.microsoft.graph.models.PlannerPlanConfigurationLocalizationCollectionResponse;
import com.microsoft.graph.solutions.businessscenarios.item.planner.planconfiguration.localizations.count.CountRequestBuilder;
...
public class LocalizationsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the localizations property of the microsoft.graph.plannerPlanConfiguration entity.
     * @param plannerPlanConfigurationLocalizationId Unique identifier of the item
     * @return a PlannerPlanConfigurationLocalizationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PlannerPlanConfigurationLocalizationItemRequestBuilder byPlannerPlanConfigurationLocalizationId(@javax.annotation.Nonnull final String plannerPlanConfigurationLocalizationId) {
    ...
    public java.util.concurrent.CompletableFuture<PlannerPlanConfigurationLocalizationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PlannerPlanConfigurationLocalizationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PlannerPlanConfigurationLocalizationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PlannerPlanConfigurationLocalization body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PlannerPlanConfigurationLocalization body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
