...
public class TasksRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the tasks property of the microsoft.graph.businessScenarioPlanner entity.
     * @param businessScenarioTaskId Unique identifier of the item
     * @return a BusinessScenarioTaskItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public BusinessScenarioTaskItemRequestBuilder byBusinessScenarioTaskId(@javax.annotation.Nonnull final String businessScenarioTaskId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final BusinessScenarioTask body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final BusinessScenarioTask body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
