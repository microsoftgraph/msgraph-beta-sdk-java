...
public class TasksRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BusinessScenarioTaskCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessScenarioTaskCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BusinessScenarioTaskCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<BusinessScenarioTask> post(@javax.annotation.Nonnull final BusinessScenarioTask body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessScenarioTask> executionException = new java.util.concurrent.CompletableFuture<BusinessScenarioTask>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
