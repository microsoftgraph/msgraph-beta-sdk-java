...
public class LearningContentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final LearningContent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LearningContentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LearningContentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LearningContentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<LearningContent> post(@javax.annotation.Nonnull final LearningContent body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<LearningContent> executionException = new java.util.concurrent.CompletableFuture<LearningContent>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
