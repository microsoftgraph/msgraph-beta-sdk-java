...
public class LearningProvidersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse>();
