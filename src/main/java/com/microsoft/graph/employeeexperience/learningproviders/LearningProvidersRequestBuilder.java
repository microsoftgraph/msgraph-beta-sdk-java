...
public class LearningProvidersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final LearningProvider body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<LearningProviderCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<LearningProvider> post(@javax.annotation.Nonnull final LearningProvider body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<LearningProvider> executionException = new java.util.concurrent.CompletableFuture<LearningProvider>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
