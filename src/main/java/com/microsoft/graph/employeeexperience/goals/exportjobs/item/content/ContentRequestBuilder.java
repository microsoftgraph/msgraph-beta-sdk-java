package com.microsoft.graph.employeeexperience.goals.exportjobs.item.content;
...
public class ContentRequestBuilder extends BaseRequestBuilder {
    ...
    public ContentRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/goals/exportJobs/{goalsExportJob%2Did}/content", pathParameters);
    }
    /**
     * Instantiates a new ContentRequestBuilder and sets the default values.
    ...
    public ContentRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/employeeExperience/goals/exportJobs/{goalsExportJob%2Did}/content", rawUrl);
    }
    /**
     * Get content for the navigation property exportJobs from employeeExperience
    ...
    /**
     * Update content for the navigation property exportJobs in employeeExperience
     * @param body Binary request body
     * @return a GoalsExportJob
     */
    @jakarta.annotation.Nullable
    public GoalsExportJob put(@jakarta.annotation.Nonnull final InputStream body) {
     ...
     */
    @jakarta.annotation.Nullable
    public GoalsExportJob put(@jakarta.annotation.Nonnull final InputStream body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
