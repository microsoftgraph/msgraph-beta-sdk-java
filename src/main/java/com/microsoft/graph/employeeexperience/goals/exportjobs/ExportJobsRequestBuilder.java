package com.microsoft.graph.employeeexperience.goals.exportjobs;

import com.microsoft.graph.employeeexperience.goals.exportjobs.count.CountRequestBuilder;
import com.microsoft.graph.employeeexperience.goals.exportjobs.item.GoalsExportJobItemRequestBuilder;
import com.microsoft.graph.models.GoalsExportJob;
import com.microsoft.graph.models.GoalsExportJobCollectionResponse;
...
public class ExportJobsRequestBuilder extends BaseRequestBuilder {
    ...
    public GoalsExportJobCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, GoalsExportJobCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
