...
public class EmployeeExperienceRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EmployeeExperience body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EmployeeExperience> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EmployeeExperience> executionException = new java.util.concurrent.CompletableFuture<EmployeeExperience>();
