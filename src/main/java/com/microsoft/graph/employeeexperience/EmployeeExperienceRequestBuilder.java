...
public class EmployeeExperienceRequestBuilder {
     ...
     * @return a CompletableFuture of EmployeeExperience
     */
    public java.util.concurrent.CompletableFuture<EmployeeExperience> patch(@javax.annotation.Nonnull final EmployeeExperience body, @javax.annotation.Nullable final java.util.function.Consumer<EmployeeExperienceRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of EmployeeExperience
     */
    public java.util.concurrent.CompletableFuture<EmployeeExperience> patch(@javax.annotation.Nonnull final EmployeeExperience body, @javax.annotation.Nullable final java.util.function.Consumer<EmployeeExperienceRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
