package microsoft.graph.approvalworkflowproviders.item.businessflowswithrequestsawaitingmydecision;
...
import microsoft.graph.approvalworkflowproviders.item.businessflowswithrequestsawaitingmydecision.count.CountRequestBuilder;
...
public class BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder {
     ...
     * @return a CompletableFuture of BusinessFlowCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<BusinessFlowCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of businessFlow
     */
    public java.util.concurrent.CompletableFuture<BusinessFlow> post(@javax.annotation.Nonnull final BusinessFlow body, @javax.annotation.Nullable final java.util.function.Consumer<BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
