...
public class GovernancePolicyTemplateItemRequestBuilder {
     ...
     * @return a CompletableFuture of governancePolicyTemplate
     */
    public java.util.concurrent.CompletableFuture<GovernancePolicyTemplate> patch(@javax.annotation.Nonnull final GovernancePolicyTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<GovernancePolicyTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
