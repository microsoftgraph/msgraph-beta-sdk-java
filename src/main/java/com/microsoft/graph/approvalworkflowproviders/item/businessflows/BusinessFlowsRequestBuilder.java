...
public class BusinessFlowsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<BusinessFlowCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessFlowCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BusinessFlowCollectionResponse>();
