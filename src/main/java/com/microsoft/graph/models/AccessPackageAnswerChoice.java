...
public class AccessPackageAnswerChoice implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actualValue", (n) -> { currentObject.setActualValue(n.getStringValue()); });
        deserializerMap.put("displayValue", (n) -> { currentObject.setDisplayValue(n.getObjectValue(AccessPackageLocalizedContent::createFromDiscriminatorValue)); });
