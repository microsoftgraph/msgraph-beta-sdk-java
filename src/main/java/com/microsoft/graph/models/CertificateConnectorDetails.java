...
public class CertificateConnectorDetails extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("connectorName", (n) -> { currentObject.setConnectorName(n.getStringValue()); });
        deserializerMap.put("connectorVersion", (n) -> { currentObject.setConnectorVersion(n.getStringValue()); });
        deserializerMap.put("enrollmentDateTime", (n) -> { currentObject.setEnrollmentDateTime(n.getOffsetDateTimeValue()); });
