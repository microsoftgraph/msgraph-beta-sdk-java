...
public class BrowserSiteList extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("publishedBy", (n) -> { currentObject.setPublishedBy(n.getObjectValue(IdentitySet::createFromDiscriminatorValue)); });
            ...
            this.put("sharedCookies", (n) -> { currentObject.setSharedCookies(n.getCollectionOfObjectValues(BrowserSharedCookie::createFromDiscriminatorValue)); });
            this.put("sites", (n) -> { currentObject.setSites(n.getCollectionOfObjectValues(BrowserSite::createFromDiscriminatorValue)); });
            this.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(BrowserSiteListStatus.class)); });
        }};
    }
    /**
