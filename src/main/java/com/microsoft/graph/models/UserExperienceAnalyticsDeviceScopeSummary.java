...
public class UserExperienceAnalyticsDeviceScopeSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(5) {{
            this.put("completedDeviceScopeIds", (n) -> { currentObject.setCompletedDeviceScopeIds(n.getCollectionOfPrimitiveValues(String.class)); });
            this.put("insufficientDataDeviceScopeIds", (n) -> { currentObject.setInsufficientDataDeviceScopeIds(n.getCollectionOfPrimitiveValues(String.class)); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("totalDeviceScopes", (n) -> { currentObject.setTotalDeviceScopes(n.getIntegerValue()); });
            this.put("totalDeviceScopesEnabled", (n) -> { currentObject.setTotalDeviceScopesEnabled(n.getIntegerValue()); });
        }};
    }
    /**
