...
public class OnPremisesDirectorySynchronization extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("configuration", (n) -> { currentObject.setConfiguration(n.getObjectValue(OnPremisesDirectorySynchronizationConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("features", (n) -> { currentObject.setFeatures(n.getObjectValue(OnPremisesDirectorySynchronizationFeature::createFromDiscriminatorValue)); });
