...
public class EducationOneRosterApiDataProvider extends EducationSynchronizationDataProvider implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("connectionSettings", (n) -> { currentObject.setConnectionSettings(n.getObjectValue(EducationSynchronizationConnectionSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("connectionUrl", (n) -> { currentObject.setConnectionUrl(n.getStringValue()); });
        ...
        deserializerMap.put("schoolsIds", (n) -> { currentObject.setSchoolsIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("termIds", (n) -> { currentObject.setTermIds(n.getCollectionOfPrimitiveValues(String.class)); });
