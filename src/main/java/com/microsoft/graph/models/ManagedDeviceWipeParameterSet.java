...
public class ManagedDeviceWipeParameterSet {
    ...
    /**
     * The use Protected Wipe.
     * 
     */
    @SerializedName(value = "useProtectedWipe", alternate = {"UseProtectedWipe"})
    @Expose
	@Nullable
    public Boolean useProtectedWipe;
    ...
    public static final class ManagedDeviceWipeParameterSetBuilder {
        ...
        /**
         * The useProtectedWipe parameter value
         */
        @Nullable
        protected Boolean useProtectedWipe;
        /**
         * Sets the UseProtectedWipe
         * @param val the value to set it to
         * @return the current builder object
         */
        @Nonnull
        public ManagedDeviceWipeParameterSetBuilder withUseProtectedWipe(@Nullable final Boolean val) {
            this.useProtectedWipe = val;
            return this;
        }
        /**
    ...
    public java.util.List<com.microsoft.graph.options.FunctionOption> getFunctionOptions() {
        ...
        if(this.useProtectedWipe != null) {
            result.add(new com.microsoft.graph.options.FunctionOption("useProtectedWipe", useProtectedWipe));
        }
        return result;
    }
}
