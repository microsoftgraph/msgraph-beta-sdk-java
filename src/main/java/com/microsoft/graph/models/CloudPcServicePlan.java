...
public class CloudPcServicePlan extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("ramInGB", (n) -> { currentObject.setRamInGB(n.getIntegerValue()); });
        deserializerMap.put("storageInGB", (n) -> { currentObject.setStorageInGB(n.getIntegerValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(CloudPcServicePlanType.class)); });
        deserializerMap.put("userProfileInGB", (n) -> { currentObject.setUserProfileInGB(n.getIntegerValue()); });
        deserializerMap.put("vCpuCount", (n) -> { currentObject.setVCpuCount(n.getIntegerValue()); });
