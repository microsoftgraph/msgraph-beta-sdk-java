...
public class AndroidForWorkAppConfigurationSchema extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exampleJson", (n) -> { currentObject.setExampleJson(n.getByteArrayValue()); });
        deserializerMap.put("schemaItems", (n) -> { currentObject.setSchemaItems(n.getCollectionOfObjectValues(AndroidForWorkAppConfigurationSchemaItem::createFromDiscriminatorValue)); });
