...
public class AuthenticationMethodModeDetail extends Entity implements Parsable {
    ...
    private BaseAuthenticationMethod _authenticationMethod;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AuthenticationMethodModeDetail currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("authenticationMethod", (n) -> { currentObject.setAuthenticationMethod(n.getEnumValue(BaseAuthenticationMethod.class)); });
