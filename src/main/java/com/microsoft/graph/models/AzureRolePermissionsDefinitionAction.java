...
public class AzureRolePermissionsDefinitionAction extends AzurePermissionsDefinitionAction implements Parsable {
     ...
     * The roles property
     */
    private java.util.List<PermissionsDefinitionAzureRole> roles;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("roles", (n) -> { this.setRoles(n.getCollectionOfObjectValues(PermissionsDefinitionAzureRole::createFromDiscriminatorValue)); });
     ...
     */
    public void setRoles(@jakarta.annotation.Nullable final java.util.List<PermissionsDefinitionAzureRole> value) {
        this.roles = value;
    }
}
