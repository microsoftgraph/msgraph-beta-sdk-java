...
public class ExtendedKeyUsage implements AdditionalDataHolder, Parsable {
    ...
    public static ExtendedKeyUsage createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("objectIdentifier", (n) -> { currentObject.setObjectIdentifier(n.getStringValue()); });
