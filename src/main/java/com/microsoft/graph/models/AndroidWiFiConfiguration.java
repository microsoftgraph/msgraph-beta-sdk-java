...
public class AndroidWiFiConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public static AndroidWiFiConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidWiFiConfiguration currentObject = this;
        ...
        deserializerMap.put("wiFiSecurityType", (n) -> { currentObject.setWiFiSecurityType(n.getEnumValue(AndroidWiFiSecurityType.class)); });
