...
public class AuthenticationConditionsApplications implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("includeAllApplications", (n) -> { currentObject.setIncludeAllApplications(n.getBooleanValue()); });
        deserializerMap.put("includeApplications", (n) -> { currentObject.setIncludeApplications(n.getCollectionOfObjectValues(AuthenticationConditionApplication::createFromDiscriminatorValue)); });
