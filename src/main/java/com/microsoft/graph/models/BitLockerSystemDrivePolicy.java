...
public class BitLockerSystemDrivePolicy implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("prebootRecoveryEnableMessageAndUrl", (n) -> { currentObject.setPrebootRecoveryEnableMessageAndUrl(n.getBooleanValue()); });
        deserializerMap.put("prebootRecoveryMessage", (n) -> { currentObject.setPrebootRecoveryMessage(n.getStringValue()); });
        deserializerMap.put("prebootRecoveryUrl", (n) -> { currentObject.setPrebootRecoveryUrl(n.getStringValue()); });
        deserializerMap.put("recoveryOptions", (n) -> { currentObject.setRecoveryOptions(n.getObjectValue(BitLockerRecoveryOptions::createFromDiscriminatorValue)); });
        deserializerMap.put("startupAuthenticationBlockWithoutTpmChip", (n) -> { currentObject.setStartupAuthenticationBlockWithoutTpmChip(n.getBooleanValue()); });
        deserializerMap.put("startupAuthenticationRequired", (n) -> { currentObject.setStartupAuthenticationRequired(n.getBooleanValue()); });
        deserializerMap.put("startupAuthenticationTpmKeyUsage", (n) -> { currentObject.setStartupAuthenticationTpmKeyUsage(n.getEnumValue(ConfigurationUsage.class)); });
        deserializerMap.put("startupAuthenticationTpmPinAndKeyUsage", (n) -> { currentObject.setStartupAuthenticationTpmPinAndKeyUsage(n.getEnumValue(ConfigurationUsage.class)); });
        deserializerMap.put("startupAuthenticationTpmPinUsage", (n) -> { currentObject.setStartupAuthenticationTpmPinUsage(n.getEnumValue(ConfigurationUsage.class)); });
        deserializerMap.put("startupAuthenticationTpmUsage", (n) -> { currentObject.setStartupAuthenticationTpmUsage(n.getEnumValue(ConfigurationUsage.class)); });
