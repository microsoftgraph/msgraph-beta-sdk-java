...
public class OnTokenIssuanceStartCustomExtension extends CustomAuthenticationExtension implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("claimsForTokenConfiguration", (n) -> { currentObject.setClaimsForTokenConfiguration(n.getCollectionOfObjectValues(OnTokenIssuanceStartReturnClaim::createFromDiscriminatorValue)); });
