...
public class WindowsMinimumOperatingSystem implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("v10_1607", (n) -> { currentObject.setV10_1607(n.getBooleanValue()); });
        deserializerMap.put("v10_1703", (n) -> { currentObject.setV10_1703(n.getBooleanValue()); });
        deserializerMap.put("v10_1709", (n) -> { currentObject.setV10_1709(n.getBooleanValue()); });
        deserializerMap.put("v10_1803", (n) -> { currentObject.setV10_1803(n.getBooleanValue()); });
        deserializerMap.put("v10_1809", (n) -> { currentObject.setV10_1809(n.getBooleanValue()); });
        deserializerMap.put("v10_1903", (n) -> { currentObject.setV10_1903(n.getBooleanValue()); });
        deserializerMap.put("v10_1909", (n) -> { currentObject.setV10_1909(n.getBooleanValue()); });
        deserializerMap.put("v10_2004", (n) -> { currentObject.setV10_2004(n.getBooleanValue()); });
        deserializerMap.put("v10_21H1", (n) -> { currentObject.setV10_21H1(n.getBooleanValue()); });
        deserializerMap.put("v10_2H20", (n) -> { currentObject.setV10_2H20(n.getBooleanValue()); });
