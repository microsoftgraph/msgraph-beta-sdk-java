...
public class DeviceManagementConfigurationDependentOn implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceManagementConfigurationDependentOn createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dependentOn", (n) -> { currentObject.setDependentOn(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("parentSettingId", (n) -> { currentObject.setParentSettingId(n.getStringValue()); });
