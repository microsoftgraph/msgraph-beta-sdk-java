...
public class ManagedDeviceMobileAppConfigurationState extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("settingStates", (n) -> { currentObject.setSettingStates(n.getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationSettingState::createFromDiscriminatorValue)); });
