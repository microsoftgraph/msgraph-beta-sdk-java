...
public class ManagedDeviceMobileAppConfigurationState extends Entity implements Parsable {
    ...
    private java.util.List<ManagedDeviceMobileAppConfigurationSettingState> _settingStates;
    /** The state property */
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ManagedDeviceMobileAppConfigurationState currentObject = this;
        ...
        deserializerMap.put("settingStates", (n) -> { currentObject.setSettingStates(n.getCollectionOfObjectValues(ManagedDeviceMobileAppConfigurationSettingState::createFromDiscriminatorValue)); });
