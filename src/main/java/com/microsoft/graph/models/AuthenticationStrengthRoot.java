...
public class AuthenticationStrengthRoot extends Entity implements Parsable {
    ...
    private java.util.List<AuthenticationMethodModes> _authenticationCombinations;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationCombinations", (n) -> { currentObject.setAuthenticationCombinations(n.getCollectionOfEnumValues(AuthenticationMethodModes.class)); });
        deserializerMap.put("authenticationMethodModes", (n) -> { currentObject.setAuthenticationMethodModes(n.getCollectionOfObjectValues(AuthenticationMethodModeDetail::createFromDiscriminatorValue)); });
        deserializerMap.put("policies", (n) -> { currentObject.setPolicies(n.getCollectionOfObjectValues(AuthenticationStrengthPolicy::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationCombinations(@javax.annotation.Nullable final java.util.List<AuthenticationMethodModes> value) {
