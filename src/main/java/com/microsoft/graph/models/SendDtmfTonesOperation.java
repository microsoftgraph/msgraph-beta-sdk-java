...
public class SendDtmfTonesOperation extends CommsOperation implements Parsable {
     ...
     */
    private SendDtmfCompletionReason completionReason;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("completionReason", (n) -> { this.setCompletionReason(n.getEnumValue(SendDtmfCompletionReason.class)); });
