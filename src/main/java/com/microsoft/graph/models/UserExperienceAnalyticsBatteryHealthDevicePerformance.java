...
public class UserExperienceAnalyticsBatteryHealthDevicePerformance extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("batteryAgeInDays", (n) -> { currentObject.setBatteryAgeInDays(n.getIntegerValue()); });
        deserializerMap.put("deviceBatteryHealthScore", (n) -> { currentObject.setDeviceBatteryHealthScore(n.getIntegerValue()); });
        ...
        deserializerMap.put("estimatedRuntimeInMinutes", (n) -> { currentObject.setEstimatedRuntimeInMinutes(n.getIntegerValue()); });
        ...
        deserializerMap.put("maxCapacityPercentage", (n) -> { currentObject.setMaxCapacityPercentage(n.getIntegerValue()); });
