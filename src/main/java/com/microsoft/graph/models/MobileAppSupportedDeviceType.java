...
public class MobileAppSupportedDeviceType implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maximumOperatingSystemVersion", (n) -> { currentObject.setMaximumOperatingSystemVersion(n.getStringValue()); });
        deserializerMap.put("minimumOperatingSystemVersion", (n) -> { currentObject.setMinimumOperatingSystemVersion(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(DeviceType.class)); });
