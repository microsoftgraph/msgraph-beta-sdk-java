...
public class TenantAllowBlockListEntryResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("entryType", (n) -> { currentObject.setEntryType(n.getEnumValue(TenantAllowBlockListEntryType.class)); });
        deserializerMap.put("expirationDateTime", (n) -> { currentObject.setExpirationDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("identity", (n) -> { currentObject.setIdentity(n.getStringValue()); });
