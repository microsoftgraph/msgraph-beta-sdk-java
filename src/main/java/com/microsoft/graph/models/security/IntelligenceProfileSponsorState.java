...
public class IntelligenceProfileSponsorState implements AdditionalDataHolder, Parsable {
    ...
    public static IntelligenceProfileSponsorState createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
