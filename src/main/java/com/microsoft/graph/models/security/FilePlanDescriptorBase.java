...
public class FilePlanDescriptorBase implements AdditionalDataHolder, Parsable {
    /**
     ...
     * @return a filePlanDescriptorBase
     */
    @javax.annotation.Nonnull
    public static FilePlanDescriptorBase createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
