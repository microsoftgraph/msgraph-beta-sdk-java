...
public class SubCategoryTemplateCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<SubCategoryTemplate> value;
    /**
    ...
    public static SubCategoryTemplateCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<SubCategoryTemplate> value) {
        this.value = value;
    }
}
