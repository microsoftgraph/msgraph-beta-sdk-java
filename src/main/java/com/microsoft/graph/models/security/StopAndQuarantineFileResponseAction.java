...
public class StopAndQuarantineFileResponseAction extends ResponseAction implements Parsable {
    ...
    public static StopAndQuarantineFileResponseAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIdentifier(@javax.annotation.Nullable final StopAndQuarantineFileEntityIdentifier value) {
