...
public class RetentionLabel extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionAfterRetentionPeriod", (n) -> { currentObject.setActionAfterRetentionPeriod(n.getEnumValue(ActionAfterRetentionPeriod.class)); });
        deserializerMap.put("behaviorDuringRetentionPeriod", (n) -> { currentObject.setBehaviorDuringRetentionPeriod(n.getEnumValue(BehaviorDuringRetentionPeriod.class)); });
        ...
        deserializerMap.put("defaultRecordBehavior", (n) -> { currentObject.setDefaultRecordBehavior(n.getEnumValue(DefaultRecordBehavior.class)); });
        deserializerMap.put("descriptionForAdmins", (n) -> { currentObject.setDescriptionForAdmins(n.getStringValue()); });
        deserializerMap.put("descriptionForUsers", (n) -> { currentObject.setDescriptionForUsers(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("dispositionReviewStages", (n) -> { currentObject.setDispositionReviewStages(n.getCollectionOfObjectValues(DispositionReviewStage::createFromDiscriminatorValue)); });
        deserializerMap.put("isInUse", (n) -> { currentObject.setIsInUse(n.getBooleanValue()); });
        deserializerMap.put("labelToBeApplied", (n) -> { currentObject.setLabelToBeApplied(n.getStringValue()); });
        ...
        deserializerMap.put("retentionDuration", (n) -> { currentObject.setRetentionDuration(n.getObjectValue(RetentionDuration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("retentionTrigger", (n) -> { currentObject.setRetentionTrigger(n.getEnumValue(RetentionTrigger.class)); });
