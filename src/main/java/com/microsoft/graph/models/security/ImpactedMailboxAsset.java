...
public class ImpactedMailboxAsset extends ImpactedAsset implements Parsable {
    ...
    public static ImpactedMailboxAsset createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("identifier", (n) -> { this.setIdentifier(n.getEnumValue(MailboxAssetIdentifier.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setIdentifier(@javax.annotation.Nullable final MailboxAssetIdentifier value) {
