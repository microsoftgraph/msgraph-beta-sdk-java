...
public class ImpactedDeviceAsset extends ImpactedAsset implements Parsable {
    ...
    public static ImpactedDeviceAsset createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIdentifier(@javax.annotation.Nullable final DeviceAssetIdentifier value) {
