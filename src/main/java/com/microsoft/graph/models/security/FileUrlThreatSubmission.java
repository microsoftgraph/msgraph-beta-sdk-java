...
public class FileUrlThreatSubmission extends FileThreatSubmission implements Parsable {
    ...
    public static FileUrlThreatSubmission createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FileUrlThreatSubmission currentObject = this;
