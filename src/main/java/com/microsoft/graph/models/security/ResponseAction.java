...
public class ResponseAction implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ResponseAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
