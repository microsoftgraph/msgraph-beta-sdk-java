...
public class MoveToDeletedItemsResponseAction extends ResponseAction implements Parsable {
    ...
    public static MoveToDeletedItemsResponseAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIdentifier(@javax.annotation.Nullable final EmailEntityIdentifier value) {
