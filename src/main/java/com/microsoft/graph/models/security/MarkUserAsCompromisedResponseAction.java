...
public class MarkUserAsCompromisedResponseAction extends ResponseAction implements Parsable {
    ...
    public static MarkUserAsCompromisedResponseAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIdentifier(@javax.annotation.Nullable final MarkUserAsCompromisedEntityIdentifier value) {
