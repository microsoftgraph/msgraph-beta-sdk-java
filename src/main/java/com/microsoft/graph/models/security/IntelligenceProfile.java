...
public class IntelligenceProfile extends Entity implements Parsable {
    ...
    private java.util.List<IntelligenceProfileSponsorState> sponsorStates;
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sponsorStates", (n) -> { this.setSponsorStates(n.getCollectionOfObjectValues(IntelligenceProfileSponsorState::createFromDiscriminatorValue)); });
     ...
     * @return a intelligenceProfileSponsorState
     */
    @javax.annotation.Nullable
    public java.util.List<IntelligenceProfileSponsorState> getSponsorStates() {
        return this.sponsorStates;
    }
    /**
     ...
     * @param value Value to set for the sponsorStates property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setSponsorStates(@javax.annotation.Nullable final java.util.List<IntelligenceProfileSponsorState> value) {
        this.sponsorStates = value;
    }
    /**
