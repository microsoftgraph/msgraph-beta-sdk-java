...
public class MailClusterEvidence extends AlertEvidence implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("clusterBy", (n) -> { currentObject.setClusterBy(n.getStringValue()); });
        deserializerMap.put("clusterByValue", (n) -> { currentObject.setClusterByValue(n.getStringValue()); });
        deserializerMap.put("emailCount", (n) -> { currentObject.setEmailCount(n.getLongValue()); });
        deserializerMap.put("networkMessageIds", (n) -> { currentObject.setNetworkMessageIds(n.getCollectionOfPrimitiveValues(String.class)); });
