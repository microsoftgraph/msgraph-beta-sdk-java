...
public class RuleSchedule implements AdditionalDataHolder, Parsable {
    ...
    public static RuleSchedule createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPeriod(@javax.annotation.Nullable final String value) {
        this.period = value;
    }
}
