...
public class OrganizationalScope implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public java.util.List<String> getScopeNames() {
        return this.backingStore.get("scopeNames");
    }
    /**
    ...
    public void setScopeNames(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("scopeNames", value);
    }
    /**
