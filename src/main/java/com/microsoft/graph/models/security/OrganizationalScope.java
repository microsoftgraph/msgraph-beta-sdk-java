...
public class OrganizationalScope implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationalScope createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setScopeNames(@javax.annotation.Nullable final java.util.List<String> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setScopeType(@javax.annotation.Nullable final ScopeType value) {
