...
public class HostSslCertificate extends Artifact implements Parsable {
    ...
    public static HostSslCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPorts(@javax.annotation.Nullable final java.util.List<HostSslCertificatePort> value) {
        this.ports = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSslCertificate(@javax.annotation.Nullable final SslCertificate value) {
