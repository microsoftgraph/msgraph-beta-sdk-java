...
public class ReactionsFacet implements AdditionalDataHolder, Parsable {
    ...
    public static ReactionsFacet createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCommentCount(@javax.annotation.Nullable final Integer value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setLikeCount(@javax.annotation.Nullable final Integer value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setShareCount(@javax.annotation.Nullable final Integer value) {
