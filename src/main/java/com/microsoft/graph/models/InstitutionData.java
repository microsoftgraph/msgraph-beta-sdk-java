...
public class InstitutionData implements AdditionalDataHolder, Parsable {
    ...
    public static InstitutionData createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("location", (n) -> { currentObject.setLocation(n.getObjectValue(PhysicalAddress::createFromDiscriminatorValue)); });
