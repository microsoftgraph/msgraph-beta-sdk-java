...
public class DeliveryOptimizationBandwidthPercentage extends DeliveryOptimizationBandwidth implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maximumBackgroundBandwidthPercentage", (n) -> { currentObject.setMaximumBackgroundBandwidthPercentage(n.getIntegerValue()); });
        deserializerMap.put("maximumForegroundBandwidthPercentage", (n) -> { currentObject.setMaximumForegroundBandwidthPercentage(n.getIntegerValue()); });
