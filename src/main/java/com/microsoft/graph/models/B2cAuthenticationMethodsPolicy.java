...
public class B2cAuthenticationMethodsPolicy extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isEmailPasswordAuthenticationEnabled", (n) -> { currentObject.setIsEmailPasswordAuthenticationEnabled(n.getBooleanValue()); });
        deserializerMap.put("isPhoneOneTimePasswordAuthenticationEnabled", (n) -> { currentObject.setIsPhoneOneTimePasswordAuthenticationEnabled(n.getBooleanValue()); });
        deserializerMap.put("isUserNameAuthenticationEnabled", (n) -> { currentObject.setIsUserNameAuthenticationEnabled(n.getBooleanValue()); });
