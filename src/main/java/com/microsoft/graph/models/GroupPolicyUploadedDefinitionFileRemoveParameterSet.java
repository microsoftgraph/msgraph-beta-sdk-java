...
/**
 * The class for the Group Policy Uploaded Definition File Remove Parameter Set.
 */
public class GroupPolicyUploadedDefinitionFileRemoveParameterSet {

    /**
     * Instiaciates a new GroupPolicyUploadedDefinitionFileRemoveParameterSet
     */
     ...
     */
    protected GroupPolicyUploadedDefinitionFileRemoveParameterSet(@Nonnull final GroupPolicyUploadedDefinitionFileRemoveParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the GroupPolicyUploadedDefinitionFileRemoveParameterSet
     */
    public static final class GroupPolicyUploadedDefinitionFileRemoveParameterSetBuilder {
        /**
         * Instanciates a new GroupPolicyUploadedDefinitionFileRemoveParameterSetBuilder
         */
        @Nullable
