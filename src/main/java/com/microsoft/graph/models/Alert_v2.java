...
import com.microsoft.graph.models.ServiceSource;
import com.microsoft.graph.models.AlertSeverity_v2;
import com.microsoft.graph.models.AlertStatus_v2;
...
/**
 * The class for the Alert_v2.
 */
public class Alert_v2 extends Entity implements IJsonBackedObject {
     ...
     * 
     */
    @SerializedName(value = "aadTenantId", alternate = {"AadTenantId"})
    @Expose
	@Nullable
