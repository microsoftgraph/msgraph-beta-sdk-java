...
public class WindowsPhone81TrustedRootCertificate extends DeviceConfiguration implements Parsable {
    ...
    public static WindowsPhone81TrustedRootCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final WindowsPhone81TrustedRootCertificate currentObject = this;
