...
public class SynchronizationTaskExecution implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activityIdentifier", (n) -> { currentObject.setActivityIdentifier(n.getStringValue()); });
        deserializerMap.put("countEntitled", (n) -> { currentObject.setCountEntitled(n.getLongValue()); });
        deserializerMap.put("countEntitledForProvisioning", (n) -> { currentObject.setCountEntitledForProvisioning(n.getLongValue()); });
        deserializerMap.put("countEscrowed", (n) -> { currentObject.setCountEscrowed(n.getLongValue()); });
        deserializerMap.put("countEscrowedRaw", (n) -> { currentObject.setCountEscrowedRaw(n.getLongValue()); });
        deserializerMap.put("countExported", (n) -> { currentObject.setCountExported(n.getLongValue()); });
        deserializerMap.put("countExports", (n) -> { currentObject.setCountExports(n.getLongValue()); });
        deserializerMap.put("countImported", (n) -> { currentObject.setCountImported(n.getLongValue()); });
        deserializerMap.put("countImportedDeltas", (n) -> { currentObject.setCountImportedDeltas(n.getLongValue()); });
        deserializerMap.put("countImportedReferenceDeltas", (n) -> { currentObject.setCountImportedReferenceDeltas(n.getLongValue()); });
        ...
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(SynchronizationTaskExecutionResult.class)); });
        deserializerMap.put("timeBegan", (n) -> { currentObject.setTimeBegan(n.getOffsetDateTimeValue()); });
        deserializerMap.put("timeEnded", (n) -> { currentObject.setTimeEnded(n.getOffsetDateTimeValue()); });
