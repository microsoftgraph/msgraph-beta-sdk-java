...
public class HybridAgentUpdaterConfiguration implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Boolean getAllowUpdateConfigurationOverride() {
        return this.backingStore.get("allowUpdateConfigurationOverride");
    }
    /**
    ...
    public OffsetDateTime getDeferUpdateDateTime() {
        return this.backingStore.get("deferUpdateDateTime");
    }
    /**
    ...
    public UpdateWindow getUpdateWindow() {
        return this.backingStore.get("updateWindow");
    }
    /**
    ...
    public void setAllowUpdateConfigurationOverride(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("allowUpdateConfigurationOverride", value);
    }
    /**
    ...
    public void setDeferUpdateDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("deferUpdateDateTime", value);
    }
    /**
    ...
    public void setUpdateWindow(@jakarta.annotation.Nullable final UpdateWindow value) {
        this.backingStore.set("updateWindow", value);
    }
}
