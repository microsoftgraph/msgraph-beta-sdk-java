...
public class WindowsWifiEnterpriseEAPConfiguration extends WindowsWifiConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationPeriodInSeconds", (n) -> { currentObject.setAuthenticationPeriodInSeconds(n.getIntegerValue()); });
        deserializerMap.put("authenticationRetryDelayPeriodInSeconds", (n) -> { currentObject.setAuthenticationRetryDelayPeriodInSeconds(n.getIntegerValue()); });
        deserializerMap.put("authenticationType", (n) -> { currentObject.setAuthenticationType(n.getEnumValue(WifiAuthenticationType.class)); });
        deserializerMap.put("cacheCredentials", (n) -> { currentObject.setCacheCredentials(n.getBooleanValue()); });
        deserializerMap.put("disableUserPromptForServerValidation", (n) -> { currentObject.setDisableUserPromptForServerValidation(n.getBooleanValue()); });
        deserializerMap.put("eapolStartPeriodInSeconds", (n) -> { currentObject.setEapolStartPeriodInSeconds(n.getIntegerValue()); });
        deserializerMap.put("eapType", (n) -> { currentObject.setEapType(n.getEnumValue(EapType.class)); });
        deserializerMap.put("enablePairwiseMasterKeyCaching", (n) -> { currentObject.setEnablePairwiseMasterKeyCaching(n.getBooleanValue()); });
        deserializerMap.put("enablePreAuthentication", (n) -> { currentObject.setEnablePreAuthentication(n.getBooleanValue()); });
        deserializerMap.put("identityCertificateForClientAuthentication", (n) -> { currentObject.setIdentityCertificateForClientAuthentication(n.getObjectValue(WindowsCertificateProfileBase::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("maximumAuthenticationFailures", (n) -> { currentObject.setMaximumAuthenticationFailures(n.getIntegerValue()); });
        deserializerMap.put("maximumAuthenticationTimeoutInSeconds", (n) -> { currentObject.setMaximumAuthenticationTimeoutInSeconds(n.getIntegerValue()); });
        deserializerMap.put("maximumEAPOLStartMessages", (n) -> { currentObject.setMaximumEAPOLStartMessages(n.getIntegerValue()); });
        deserializerMap.put("maximumNumberOfPairwiseMasterKeysInCache", (n) -> { currentObject.setMaximumNumberOfPairwiseMasterKeysInCache(n.getIntegerValue()); });
        deserializerMap.put("maximumPairwiseMasterKeyCacheTimeInMinutes", (n) -> { currentObject.setMaximumPairwiseMasterKeyCacheTimeInMinutes(n.getIntegerValue()); });
        deserializerMap.put("maximumPreAuthenticationAttempts", (n) -> { currentObject.setMaximumPreAuthenticationAttempts(n.getIntegerValue()); });
        deserializerMap.put("networkSingleSignOn", (n) -> { currentObject.setNetworkSingleSignOn(n.getEnumValue(NetworkSingleSignOnType.class)); });
        ...
        deserializerMap.put("performServerValidation", (n) -> { currentObject.setPerformServerValidation(n.getBooleanValue()); });
        deserializerMap.put("promptForAdditionalAuthenticationCredentials", (n) -> { currentObject.setPromptForAdditionalAuthenticationCredentials(n.getBooleanValue()); });
        deserializerMap.put("requireCryptographicBinding", (n) -> { currentObject.setRequireCryptographicBinding(n.getBooleanValue()); });
        deserializerMap.put("rootCertificateForClientValidation", (n) -> { currentObject.setRootCertificateForClientValidation(n.getObjectValue(Windows81TrustedRootCertificate::createFromDiscriminatorValue)); });
        deserializerMap.put("rootCertificatesForServerValidation", (n) -> { currentObject.setRootCertificatesForServerValidation(n.getCollectionOfObjectValues(Windows81TrustedRootCertificate::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("userBasedVirtualLan", (n) -> { currentObject.setUserBasedVirtualLan(n.getBooleanValue()); });
