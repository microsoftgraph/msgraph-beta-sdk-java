...
public class DeviceEnrollmentPlatformRestriction implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blockedManufacturers", (n) -> { currentObject.setBlockedManufacturers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("blockedSkus", (n) -> { currentObject.setBlockedSkus(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("personalDeviceEnrollmentBlocked", (n) -> { currentObject.setPersonalDeviceEnrollmentBlocked(n.getBooleanValue()); });
        deserializerMap.put("platformBlocked", (n) -> { currentObject.setPlatformBlocked(n.getBooleanValue()); });
