...
public class CommsApplication implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static CommsApplication createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
