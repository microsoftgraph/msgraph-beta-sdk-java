...
public class CloudPcTenantEncryptionSetting implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private CloudPcDiskEncryptionType tenantDiskEncryptionType;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tenantDiskEncryptionType", (n) -> { this.setTenantDiskEncryptionType(n.getEnumValue(CloudPcDiskEncryptionType.class)); });
    ...
    public CloudPcDiskEncryptionType getTenantDiskEncryptionType() {
        return this.tenantDiskEncryptionType;
    }
    /**
    ...
    public void setTenantDiskEncryptionType(@jakarta.annotation.Nullable final CloudPcDiskEncryptionType value) {
        this.tenantDiskEncryptionType = value;
    }
}
