...
/**
 * The class for the Managed Device Get Cloud Pc Remote Action Results Parameter Set.
 */
public class ManagedDeviceGetCloudPcRemoteActionResultsParameterSet {

    /**
     * Instiaciates a new ManagedDeviceGetCloudPcRemoteActionResultsParameterSet
     */
     ...
     */
    protected ManagedDeviceGetCloudPcRemoteActionResultsParameterSet(@Nonnull final ManagedDeviceGetCloudPcRemoteActionResultsParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ManagedDeviceGetCloudPcRemoteActionResultsParameterSet
     */
    public static final class ManagedDeviceGetCloudPcRemoteActionResultsParameterSetBuilder {
        /**
         * Instanciates a new ManagedDeviceGetCloudPcRemoteActionResultsParameterSetBuilder
         */
        @Nullable
