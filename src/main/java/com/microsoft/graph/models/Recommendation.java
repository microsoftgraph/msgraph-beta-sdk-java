...
public class Recommendation extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionSteps", (n) -> { currentObject.setActionSteps(n.getCollectionOfObjectValues(ActionStep::createFromDiscriminatorValue)); });
        deserializerMap.put("benefits", (n) -> { currentObject.setBenefits(n.getStringValue()); });
        deserializerMap.put("category", (n) -> { currentObject.setCategory(n.getEnumValue(RecommendationCategory.class)); });
        ...
        deserializerMap.put("impactStartDateTime", (n) -> { currentObject.setImpactStartDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("impactType", (n) -> { currentObject.setImpactType(n.getStringValue()); });
        deserializerMap.put("insights", (n) -> { currentObject.setInsights(n.getStringValue()); });
        deserializerMap.put("lastCheckedDateTime", (n) -> { currentObject.setLastCheckedDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("priority", (n) -> { currentObject.setPriority(n.getEnumValue(RecommendationPriority.class)); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(RecommendationStatus.class)); });
