...
public class DelegatedAdminRelationshipCustomerParticipant implements AdditionalDataHolder, Parsable {
    ...
    public static DelegatedAdminRelationshipCustomerParticipant createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DelegatedAdminRelationshipCustomerParticipant currentObject = this;
