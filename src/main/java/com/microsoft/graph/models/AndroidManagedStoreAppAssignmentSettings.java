...
/**
 * The class for the Android Managed Store App Assignment Settings.
 */
public class AndroidManagedStoreAppAssignmentSettings extends MobileAppAssignmentSettings implements IJsonBackedObject {
