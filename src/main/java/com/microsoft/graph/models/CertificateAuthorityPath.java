...
public class CertificateAuthorityPath extends Entity implements Parsable {
    ...
    public static CertificateAuthorityPath createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCertificateBasedApplicationConfigurations(@javax.annotation.Nullable final java.util.List<CertificateBasedApplicationConfiguration> value) {
