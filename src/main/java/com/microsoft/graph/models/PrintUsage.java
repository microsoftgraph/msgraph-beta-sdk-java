...
public class PrintUsage extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blackAndWhitePageCount", (n) -> { currentObject.setBlackAndWhitePageCount(n.getLongValue()); });
        deserializerMap.put("colorPageCount", (n) -> { currentObject.setColorPageCount(n.getLongValue()); });
        ...
        deserializerMap.put("completedJobCount", (n) -> { currentObject.setCompletedJobCount(n.getLongValue()); });
        deserializerMap.put("doubleSidedSheetCount", (n) -> { currentObject.setDoubleSidedSheetCount(n.getLongValue()); });
        deserializerMap.put("incompleteJobCount", (n) -> { currentObject.setIncompleteJobCount(n.getLongValue()); });
        deserializerMap.put("mediaSheetCount", (n) -> { currentObject.setMediaSheetCount(n.getLongValue()); });
        deserializerMap.put("pageCount", (n) -> { currentObject.setPageCount(n.getLongValue()); });
        deserializerMap.put("singleSidedSheetCount", (n) -> { currentObject.setSingleSidedSheetCount(n.getLongValue()); });
