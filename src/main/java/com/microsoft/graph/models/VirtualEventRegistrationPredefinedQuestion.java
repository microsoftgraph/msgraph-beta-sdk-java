...
public class VirtualEventRegistrationPredefinedQuestion extends VirtualEventRegistrationQuestionBase implements Parsable {
     ...
     * @return a VirtualEventRegistrationPredefinedQuestion
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("label", (n) -> { this.setLabel(n.getEnumValue(VirtualEventRegistrationPredefinedQuestionLabel.class)); });
        return deserializerMap;
    }
    /**
     * Gets the label property value. The label property
     * @return a VirtualEventRegistrationPredefinedQuestionLabel
     */
