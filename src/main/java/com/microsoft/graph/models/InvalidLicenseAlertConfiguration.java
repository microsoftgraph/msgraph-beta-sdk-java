...
public class InvalidLicenseAlertConfiguration extends UnifiedRoleManagementAlertConfiguration implements Parsable {
    ...
    public InvalidLicenseAlertConfiguration() {
        super();
        this.setOdataType("#microsoft.graph.invalidLicenseAlertConfiguration");
    }
    /**
    ...
    public static InvalidLicenseAlertConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
