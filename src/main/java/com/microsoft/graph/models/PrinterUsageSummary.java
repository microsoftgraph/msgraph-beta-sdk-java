...
public class PrinterUsageSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(8) {{
            ...
            this.put("printer", (n) -> { currentObject.setPrinter(n.getObjectValue(DirectoryObject::createFromDiscriminatorValue)); });
            this.put("printerDisplayName", (n) -> { currentObject.setPrinterDisplayName(n.getStringValue()); });
            this.put("printerId", (n) -> { currentObject.setPrinterId(n.getStringValue()); });
            this.put("printerManufacturer", (n) -> { currentObject.setPrinterManufacturer(n.getStringValue()); });
            this.put("printerModel", (n) -> { currentObject.setPrinterModel(n.getStringValue()); });
        }};
    }
    /**
