...
public class PrinterUsageSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PrinterUsageSummary currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(8);
        deserializerMap.put("completedJobCount", (n) -> { currentObject.setCompletedJobCount(n.getIntegerValue()); });
        deserializerMap.put("incompleteJobCount", (n) -> { currentObject.setIncompleteJobCount(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("printer", (n) -> { currentObject.setPrinter(n.getObjectValue(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("printerDisplayName", (n) -> { currentObject.setPrinterDisplayName(n.getStringValue()); });
        deserializerMap.put("printerId", (n) -> { currentObject.setPrinterId(n.getStringValue()); });
        deserializerMap.put("printerManufacturer", (n) -> { currentObject.setPrinterManufacturer(n.getStringValue()); });
        deserializerMap.put("printerModel", (n) -> { currentObject.setPrinterModel(n.getStringValue()); });
