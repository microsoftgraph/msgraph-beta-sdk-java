...
public class UserExperienceAnalyticsAnomalySeverityOverview implements AdditionalDataHolder, Parsable {
    ...
    private Integer _otherSeverityAnomalyCount;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(6) {{
            this.put("highSeverityAnomalyCount", (n) -> { currentObject.setHighSeverityAnomalyCount(n.getIntegerValue()); });
            this.put("informationalSeverityAnomalyCount", (n) -> { currentObject.setInformationalSeverityAnomalyCount(n.getIntegerValue()); });
            this.put("lowSeverityAnomalyCount", (n) -> { currentObject.setLowSeverityAnomalyCount(n.getIntegerValue()); });
            this.put("mediumSeverityAnomalyCount", (n) -> { currentObject.setMediumSeverityAnomalyCount(n.getIntegerValue()); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("otherSeverityAnomalyCount", (n) -> { currentObject.setOtherSeverityAnomalyCount(n.getIntegerValue()); });
        }};
    }
    /**
     ...
     */
    @javax.annotation.Nullable
    public Integer getOtherSeverityAnomalyCount() {
        return this._otherSeverityAnomalyCount;
    }
    /**
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeIntegerValue("otherSeverityAnomalyCount", this.getOtherSeverityAnomalyCount());
     ...
     * @param value Value to set for the otherSeverityAnomalyCount property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setOtherSeverityAnomalyCount(@javax.annotation.Nullable final Integer value) {
        this._otherSeverityAnomalyCount = value;
    }
}
