...
public class PayloadTypes implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("rawContent", (n) -> { currentObject.setRawContent(n.getStringValue()); });
        deserializerMap.put("visualContent", (n) -> { currentObject.setVisualContent(n.getObjectValue(VisualProperties::createFromDiscriminatorValue)); });
