...
public class ExternalMeetingRegistration extends MeetingRegistrationBase implements Parsable {
    ...
    public static ExternalMeetingRegistration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExternalMeetingRegistration currentObject = this;
