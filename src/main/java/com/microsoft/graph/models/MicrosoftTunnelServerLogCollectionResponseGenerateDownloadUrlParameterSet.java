...
/**
 * The class for the Microsoft Tunnel Server Log Collection Response Generate Download Url Parameter Set.
 */
public class MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSet {

    /**
     * Instiaciates a new MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSet
     */
     ...
     */
    protected MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSet(@Nonnull final MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSet
     */
    public static final class MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSetBuilder {
        /**
         * Instanciates a new MicrosoftTunnelServerLogCollectionResponseGenerateDownloadUrlParameterSetBuilder
         */
        @Nullable
