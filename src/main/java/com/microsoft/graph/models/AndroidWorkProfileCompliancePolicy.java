...
public class AndroidWorkProfileCompliancePolicy extends DeviceCompliancePolicy implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("advancedThreatProtectionRequiredSecurityLevel", (n) -> { currentObject.setAdvancedThreatProtectionRequiredSecurityLevel(n.getEnumValue(DeviceThreatProtectionLevel.class)); });
        ...
        deserializerMap.put("securityRequiredAndroidSafetyNetEvaluationType", (n) -> { currentObject.setSecurityRequiredAndroidSafetyNetEvaluationType(n.getEnumValue(AndroidSafetyNetEvaluationType.class)); });
    ...
    public AndroidSafetyNetEvaluationType getSecurityRequiredAndroidSafetyNetEvaluationType() {
        return this._securityRequiredAndroidSafetyNetEvaluationType;
    }
    /**
