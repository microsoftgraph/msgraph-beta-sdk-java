...
/**
 * The class for the Planner Bucket Delta Parameter Set.
 */
public class PlannerBucketDeltaParameterSet {

    /**
     * Instiaciates a new PlannerBucketDeltaParameterSet
     */
     ...
     */
    protected PlannerBucketDeltaParameterSet(@Nonnull final PlannerBucketDeltaParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PlannerBucketDeltaParameterSet
     */
    public static final class PlannerBucketDeltaParameterSetBuilder {
        /**
         * Instanciates a new PlannerBucketDeltaParameterSetBuilder
         */
        @Nullable
