...
public class WindowsKioskAppBase implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("appType", (n) -> { currentObject.setAppType(n.getEnumValue(WindowsKioskAppType.class)); });
        deserializerMap.put("autoLaunch", (n) -> { currentObject.setAutoLaunch(n.getBooleanValue()); });
        deserializerMap.put("name", (n) -> { currentObject.setName(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("startLayoutTileSize", (n) -> { currentObject.setStartLayoutTileSize(n.getEnumValue(WindowsAppStartLayoutTileSize.class)); });
