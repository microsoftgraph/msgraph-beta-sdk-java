...
/**
 * The class for the Managed Device Get Cloud Pc Review Status Parameter Set.
 */
public class ManagedDeviceGetCloudPcReviewStatusParameterSet {

    /**
     * Instiaciates a new ManagedDeviceGetCloudPcReviewStatusParameterSet
     */
     ...
     */
    protected ManagedDeviceGetCloudPcReviewStatusParameterSet(@Nonnull final ManagedDeviceGetCloudPcReviewStatusParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ManagedDeviceGetCloudPcReviewStatusParameterSet
     */
    public static final class ManagedDeviceGetCloudPcReviewStatusParameterSetBuilder {
        /**
         * Instanciates a new ManagedDeviceGetCloudPcReviewStatusParameterSetBuilder
         */
        @Nullable
