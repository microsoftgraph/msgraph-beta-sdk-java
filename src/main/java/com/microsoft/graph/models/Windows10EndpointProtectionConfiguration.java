...
public class Windows10EndpointProtectionConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applicationGuardAllowCameraMicrophoneRedirection", (n) -> { currentObject.setApplicationGuardAllowCameraMicrophoneRedirection(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowFileSaveOnHost", (n) -> { currentObject.setApplicationGuardAllowFileSaveOnHost(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowPersistence", (n) -> { currentObject.setApplicationGuardAllowPersistence(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowPrintToLocalPrinters", (n) -> { currentObject.setApplicationGuardAllowPrintToLocalPrinters(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowPrintToNetworkPrinters", (n) -> { currentObject.setApplicationGuardAllowPrintToNetworkPrinters(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowPrintToPDF", (n) -> { currentObject.setApplicationGuardAllowPrintToPDF(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowPrintToXPS", (n) -> { currentObject.setApplicationGuardAllowPrintToXPS(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardAllowVirtualGPU", (n) -> { currentObject.setApplicationGuardAllowVirtualGPU(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardBlockClipboardSharing", (n) -> { currentObject.setApplicationGuardBlockClipboardSharing(n.getEnumValue(ApplicationGuardBlockClipboardSharingType.class)); });
        deserializerMap.put("applicationGuardBlockFileTransfer", (n) -> { currentObject.setApplicationGuardBlockFileTransfer(n.getEnumValue(ApplicationGuardBlockFileTransferType.class)); });
        deserializerMap.put("applicationGuardBlockNonEnterpriseContent", (n) -> { currentObject.setApplicationGuardBlockNonEnterpriseContent(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardCertificateThumbprints", (n) -> { currentObject.setApplicationGuardCertificateThumbprints(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("applicationGuardEnabled", (n) -> { currentObject.setApplicationGuardEnabled(n.getBooleanValue()); });
        deserializerMap.put("applicationGuardEnabledOptions", (n) -> { currentObject.setApplicationGuardEnabledOptions(n.getEnumValue(ApplicationGuardEnabledOptions.class)); });
        deserializerMap.put("applicationGuardForceAuditing", (n) -> { currentObject.setApplicationGuardForceAuditing(n.getBooleanValue()); });
        deserializerMap.put("appLockerApplicationControl", (n) -> { currentObject.setAppLockerApplicationControl(n.getEnumValue(AppLockerApplicationControlType.class)); });
        deserializerMap.put("bitLockerAllowStandardUserEncryption", (n) -> { currentObject.setBitLockerAllowStandardUserEncryption(n.getBooleanValue()); });
        deserializerMap.put("bitLockerDisableWarningForOtherDiskEncryption", (n) -> { currentObject.setBitLockerDisableWarningForOtherDiskEncryption(n.getBooleanValue()); });
        deserializerMap.put("bitLockerEnableStorageCardEncryptionOnMobile", (n) -> { currentObject.setBitLockerEnableStorageCardEncryptionOnMobile(n.getBooleanValue()); });
        deserializerMap.put("bitLockerEncryptDevice", (n) -> { currentObject.setBitLockerEncryptDevice(n.getBooleanValue()); });
        deserializerMap.put("bitLockerFixedDrivePolicy", (n) -> { currentObject.setBitLockerFixedDrivePolicy(n.getObjectValue(BitLockerFixedDrivePolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("bitLockerRecoveryPasswordRotation", (n) -> { currentObject.setBitLockerRecoveryPasswordRotation(n.getEnumValue(BitLockerRecoveryPasswordRotationType.class)); });
        deserializerMap.put("bitLockerRemovableDrivePolicy", (n) -> { currentObject.setBitLockerRemovableDrivePolicy(n.getObjectValue(BitLockerRemovableDrivePolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("bitLockerSystemDrivePolicy", (n) -> { currentObject.setBitLockerSystemDrivePolicy(n.getObjectValue(BitLockerSystemDrivePolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("defenderAdditionalGuardedFolders", (n) -> { currentObject.setDefenderAdditionalGuardedFolders(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("defenderAdobeReaderLaunchChildProcess", (n) -> { currentObject.setDefenderAdobeReaderLaunchChildProcess(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderAdvancedRansomewareProtectionType", (n) -> { currentObject.setDefenderAdvancedRansomewareProtectionType(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderAllowBehaviorMonitoring", (n) -> { currentObject.setDefenderAllowBehaviorMonitoring(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowCloudProtection", (n) -> { currentObject.setDefenderAllowCloudProtection(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowEndUserAccess", (n) -> { currentObject.setDefenderAllowEndUserAccess(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowIntrusionPreventionSystem", (n) -> { currentObject.setDefenderAllowIntrusionPreventionSystem(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowOnAccessProtection", (n) -> { currentObject.setDefenderAllowOnAccessProtection(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowRealTimeMonitoring", (n) -> { currentObject.setDefenderAllowRealTimeMonitoring(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowScanArchiveFiles", (n) -> { currentObject.setDefenderAllowScanArchiveFiles(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowScanDownloads", (n) -> { currentObject.setDefenderAllowScanDownloads(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowScanNetworkFiles", (n) -> { currentObject.setDefenderAllowScanNetworkFiles(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowScanRemovableDrivesDuringFullScan", (n) -> { currentObject.setDefenderAllowScanRemovableDrivesDuringFullScan(n.getBooleanValue()); });
        deserializerMap.put("defenderAllowScanScriptsLoadedInInternetExplorer", (n) -> { currentObject.setDefenderAllowScanScriptsLoadedInInternetExplorer(n.getBooleanValue()); });
        deserializerMap.put("defenderAttackSurfaceReductionExcludedPaths", (n) -> { currentObject.setDefenderAttackSurfaceReductionExcludedPaths(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("defenderBlockEndUserAccess", (n) -> { currentObject.setDefenderBlockEndUserAccess(n.getBooleanValue()); });
        deserializerMap.put("defenderBlockPersistenceThroughWmiType", (n) -> { currentObject.setDefenderBlockPersistenceThroughWmiType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderCheckForSignaturesBeforeRunningScan", (n) -> { currentObject.setDefenderCheckForSignaturesBeforeRunningScan(n.getBooleanValue()); });
        ...
        deserializerMap.put("defenderCloudExtendedTimeoutInSeconds", (n) -> { currentObject.setDefenderCloudExtendedTimeoutInSeconds(n.getIntegerValue()); });
        ...
        deserializerMap.put("defenderDisableBehaviorMonitoring", (n) -> { currentObject.setDefenderDisableBehaviorMonitoring(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableCatchupFullScan", (n) -> { currentObject.setDefenderDisableCatchupFullScan(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableCatchupQuickScan", (n) -> { currentObject.setDefenderDisableCatchupQuickScan(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableCloudProtection", (n) -> { currentObject.setDefenderDisableCloudProtection(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableIntrusionPreventionSystem", (n) -> { currentObject.setDefenderDisableIntrusionPreventionSystem(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableOnAccessProtection", (n) -> { currentObject.setDefenderDisableOnAccessProtection(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableRealTimeMonitoring", (n) -> { currentObject.setDefenderDisableRealTimeMonitoring(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableScanArchiveFiles", (n) -> { currentObject.setDefenderDisableScanArchiveFiles(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableScanDownloads", (n) -> { currentObject.setDefenderDisableScanDownloads(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableScanNetworkFiles", (n) -> { currentObject.setDefenderDisableScanNetworkFiles(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableScanRemovableDrivesDuringFullScan", (n) -> { currentObject.setDefenderDisableScanRemovableDrivesDuringFullScan(n.getBooleanValue()); });
        deserializerMap.put("defenderDisableScanScriptsLoadedInInternetExplorer", (n) -> { currentObject.setDefenderDisableScanScriptsLoadedInInternetExplorer(n.getBooleanValue()); });
        deserializerMap.put("defenderEmailContentExecution", (n) -> { currentObject.setDefenderEmailContentExecution(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderEmailContentExecutionType", (n) -> { currentObject.setDefenderEmailContentExecutionType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderEnableLowCpuPriority", (n) -> { currentObject.setDefenderEnableLowCpuPriority(n.getBooleanValue()); });
        deserializerMap.put("defenderEnableScanIncomingMail", (n) -> { currentObject.setDefenderEnableScanIncomingMail(n.getBooleanValue()); });
        deserializerMap.put("defenderEnableScanMappedNetworkDrivesDuringFullScan", (n) -> { currentObject.setDefenderEnableScanMappedNetworkDrivesDuringFullScan(n.getBooleanValue()); });
        deserializerMap.put("defenderExploitProtectionXml", (n) -> { currentObject.setDefenderExploitProtectionXml(n.getByteArrayValue()); });
        deserializerMap.put("defenderExploitProtectionXmlFileName", (n) -> { currentObject.setDefenderExploitProtectionXmlFileName(n.getStringValue()); });
        ...
        deserializerMap.put("defenderGuardedFoldersAllowedAppPaths", (n) -> { currentObject.setDefenderGuardedFoldersAllowedAppPaths(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("defenderGuardMyFoldersType", (n) -> { currentObject.setDefenderGuardMyFoldersType(n.getEnumValue(FolderProtectionType.class)); });
        deserializerMap.put("defenderNetworkProtectionType", (n) -> { currentObject.setDefenderNetworkProtectionType(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeAppsExecutableContentCreationOrLaunch", (n) -> { currentObject.setDefenderOfficeAppsExecutableContentCreationOrLaunch(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeAppsExecutableContentCreationOrLaunchType", (n) -> { currentObject.setDefenderOfficeAppsExecutableContentCreationOrLaunchType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderOfficeAppsLaunchChildProcess", (n) -> { currentObject.setDefenderOfficeAppsLaunchChildProcess(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeAppsLaunchChildProcessType", (n) -> { currentObject.setDefenderOfficeAppsLaunchChildProcessType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderOfficeAppsOtherProcessInjection", (n) -> { currentObject.setDefenderOfficeAppsOtherProcessInjection(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeAppsOtherProcessInjectionType", (n) -> { currentObject.setDefenderOfficeAppsOtherProcessInjectionType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderOfficeCommunicationAppsLaunchChildProcess", (n) -> { currentObject.setDefenderOfficeCommunicationAppsLaunchChildProcess(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeMacroCodeAllowWin32Imports", (n) -> { currentObject.setDefenderOfficeMacroCodeAllowWin32Imports(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderOfficeMacroCodeAllowWin32ImportsType", (n) -> { currentObject.setDefenderOfficeMacroCodeAllowWin32ImportsType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderPotentiallyUnwantedAppAction", (n) -> { currentObject.setDefenderPotentiallyUnwantedAppAction(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderPreventCredentialStealingType", (n) -> { currentObject.setDefenderPreventCredentialStealingType(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderProcessCreation", (n) -> { currentObject.setDefenderProcessCreation(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderProcessCreationType", (n) -> { currentObject.setDefenderProcessCreationType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        ...
        deserializerMap.put("defenderScanDirection", (n) -> { currentObject.setDefenderScanDirection(n.getEnumValue(DefenderRealtimeScanDirection.class)); });
        deserializerMap.put("defenderScanMaxCpuPercentage", (n) -> { currentObject.setDefenderScanMaxCpuPercentage(n.getIntegerValue()); });
        ...
        deserializerMap.put("defenderScheduledScanDay", (n) -> { currentObject.setDefenderScheduledScanDay(n.getEnumValue(WeeklySchedule.class)); });
        deserializerMap.put("defenderScheduledScanTime", (n) -> { currentObject.setDefenderScheduledScanTime(n.getLocalTimeValue()); });
        deserializerMap.put("defenderScriptDownloadedPayloadExecution", (n) -> { currentObject.setDefenderScriptDownloadedPayloadExecution(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderScriptDownloadedPayloadExecutionType", (n) -> { currentObject.setDefenderScriptDownloadedPayloadExecutionType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderScriptObfuscatedMacroCode", (n) -> { currentObject.setDefenderScriptObfuscatedMacroCode(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderScriptObfuscatedMacroCodeType", (n) -> { currentObject.setDefenderScriptObfuscatedMacroCodeType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderSecurityCenterBlockExploitProtectionOverride", (n) -> { currentObject.setDefenderSecurityCenterBlockExploitProtectionOverride(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableAccountUI", (n) -> { currentObject.setDefenderSecurityCenterDisableAccountUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableAppBrowserUI", (n) -> { currentObject.setDefenderSecurityCenterDisableAppBrowserUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableClearTpmUI", (n) -> { currentObject.setDefenderSecurityCenterDisableClearTpmUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableFamilyUI", (n) -> { currentObject.setDefenderSecurityCenterDisableFamilyUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableHardwareUI", (n) -> { currentObject.setDefenderSecurityCenterDisableHardwareUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableHealthUI", (n) -> { currentObject.setDefenderSecurityCenterDisableHealthUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableNetworkUI", (n) -> { currentObject.setDefenderSecurityCenterDisableNetworkUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableNotificationAreaUI", (n) -> { currentObject.setDefenderSecurityCenterDisableNotificationAreaUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableRansomwareUI", (n) -> { currentObject.setDefenderSecurityCenterDisableRansomwareUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableSecureBootUI", (n) -> { currentObject.setDefenderSecurityCenterDisableSecureBootUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableTroubleshootingUI", (n) -> { currentObject.setDefenderSecurityCenterDisableTroubleshootingUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableVirusUI", (n) -> { currentObject.setDefenderSecurityCenterDisableVirusUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterDisableVulnerableTpmFirmwareUpdateUI", (n) -> { currentObject.setDefenderSecurityCenterDisableVulnerableTpmFirmwareUpdateUI(n.getBooleanValue()); });
        deserializerMap.put("defenderSecurityCenterHelpEmail", (n) -> { currentObject.setDefenderSecurityCenterHelpEmail(n.getStringValue()); });
        deserializerMap.put("defenderSecurityCenterHelpPhone", (n) -> { currentObject.setDefenderSecurityCenterHelpPhone(n.getStringValue()); });
        deserializerMap.put("defenderSecurityCenterHelpURL", (n) -> { currentObject.setDefenderSecurityCenterHelpURL(n.getStringValue()); });
        deserializerMap.put("defenderSecurityCenterITContactDisplay", (n) -> { currentObject.setDefenderSecurityCenterITContactDisplay(n.getEnumValue(DefenderSecurityCenterITContactDisplayType.class)); });
        deserializerMap.put("defenderSecurityCenterNotificationsFromApp", (n) -> { currentObject.setDefenderSecurityCenterNotificationsFromApp(n.getEnumValue(DefenderSecurityCenterNotificationsFromAppType.class)); });
        deserializerMap.put("defenderSecurityCenterOrganizationDisplayName", (n) -> { currentObject.setDefenderSecurityCenterOrganizationDisplayName(n.getStringValue()); });
        ...
        deserializerMap.put("defenderSubmitSamplesConsentType", (n) -> { currentObject.setDefenderSubmitSamplesConsentType(n.getEnumValue(DefenderSubmitSamplesConsentType.class)); });
        deserializerMap.put("defenderUntrustedExecutable", (n) -> { currentObject.setDefenderUntrustedExecutable(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderUntrustedExecutableType", (n) -> { currentObject.setDefenderUntrustedExecutableType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("defenderUntrustedUSBProcess", (n) -> { currentObject.setDefenderUntrustedUSBProcess(n.getEnumValue(DefenderProtectionType.class)); });
        deserializerMap.put("defenderUntrustedUSBProcessType", (n) -> { currentObject.setDefenderUntrustedUSBProcessType(n.getEnumValue(DefenderAttackSurfaceType.class)); });
        deserializerMap.put("deviceGuardEnableSecureBootWithDMA", (n) -> { currentObject.setDeviceGuardEnableSecureBootWithDMA(n.getBooleanValue()); });
        deserializerMap.put("deviceGuardEnableVirtualizationBasedSecurity", (n) -> { currentObject.setDeviceGuardEnableVirtualizationBasedSecurity(n.getBooleanValue()); });
        deserializerMap.put("deviceGuardLaunchSystemGuard", (n) -> { currentObject.setDeviceGuardLaunchSystemGuard(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("deviceGuardLocalSystemAuthorityCredentialGuardSettings", (n) -> { currentObject.setDeviceGuardLocalSystemAuthorityCredentialGuardSettings(n.getEnumValue(DeviceGuardLocalSystemAuthorityCredentialGuardType.class)); });
        deserializerMap.put("deviceGuardSecureBootWithDMA", (n) -> { currentObject.setDeviceGuardSecureBootWithDMA(n.getEnumValue(SecureBootWithDMAType.class)); });
        deserializerMap.put("dmaGuardDeviceEnumerationPolicy", (n) -> { currentObject.setDmaGuardDeviceEnumerationPolicy(n.getEnumValue(DmaGuardDeviceEnumerationPolicyType.class)); });
        deserializerMap.put("firewallBlockStatefulFTP", (n) -> { currentObject.setFirewallBlockStatefulFTP(n.getBooleanValue()); });
        deserializerMap.put("firewallCertificateRevocationListCheckMethod", (n) -> { currentObject.setFirewallCertificateRevocationListCheckMethod(n.getEnumValue(FirewallCertificateRevocationListCheckMethodType.class)); });
        deserializerMap.put("firewallIdleTimeoutForSecurityAssociationInSeconds", (n) -> { currentObject.setFirewallIdleTimeoutForSecurityAssociationInSeconds(n.getIntegerValue()); });
        deserializerMap.put("firewallIPSecExemptionsAllowDHCP", (n) -> { currentObject.setFirewallIPSecExemptionsAllowDHCP(n.getBooleanValue()); });
        deserializerMap.put("firewallIPSecExemptionsAllowICMP", (n) -> { currentObject.setFirewallIPSecExemptionsAllowICMP(n.getBooleanValue()); });
        deserializerMap.put("firewallIPSecExemptionsAllowNeighborDiscovery", (n) -> { currentObject.setFirewallIPSecExemptionsAllowNeighborDiscovery(n.getBooleanValue()); });
        deserializerMap.put("firewallIPSecExemptionsAllowRouterDiscovery", (n) -> { currentObject.setFirewallIPSecExemptionsAllowRouterDiscovery(n.getBooleanValue()); });
        deserializerMap.put("firewallIPSecExemptionsNone", (n) -> { currentObject.setFirewallIPSecExemptionsNone(n.getBooleanValue()); });
        deserializerMap.put("firewallMergeKeyingModuleSettings", (n) -> { currentObject.setFirewallMergeKeyingModuleSettings(n.getBooleanValue()); });
        deserializerMap.put("firewallPacketQueueingMethod", (n) -> { currentObject.setFirewallPacketQueueingMethod(n.getEnumValue(FirewallPacketQueueingMethodType.class)); });
        deserializerMap.put("firewallPreSharedKeyEncodingMethod", (n) -> { currentObject.setFirewallPreSharedKeyEncodingMethod(n.getEnumValue(FirewallPreSharedKeyEncodingMethodType.class)); });
        deserializerMap.put("firewallProfileDomain", (n) -> { currentObject.setFirewallProfileDomain(n.getObjectValue(WindowsFirewallNetworkProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("firewallProfilePrivate", (n) -> { currentObject.setFirewallProfilePrivate(n.getObjectValue(WindowsFirewallNetworkProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("firewallProfilePublic", (n) -> { currentObject.setFirewallProfilePublic(n.getObjectValue(WindowsFirewallNetworkProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("firewallRules", (n) -> { currentObject.setFirewallRules(n.getCollectionOfObjectValues(WindowsFirewallRule::createFromDiscriminatorValue)); });
        deserializerMap.put("lanManagerAuthenticationLevel", (n) -> { currentObject.setLanManagerAuthenticationLevel(n.getEnumValue(LanManagerAuthenticationLevel.class)); });
        deserializerMap.put("lanManagerWorkstationDisableInsecureGuestLogons", (n) -> { currentObject.setLanManagerWorkstationDisableInsecureGuestLogons(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAdministratorAccountName", (n) -> { currentObject.setLocalSecurityOptionsAdministratorAccountName(n.getStringValue()); });
        deserializerMap.put("localSecurityOptionsAdministratorElevationPromptBehavior", (n) -> { currentObject.setLocalSecurityOptionsAdministratorElevationPromptBehavior(n.getEnumValue(LocalSecurityOptionsAdministratorElevationPromptBehaviorType.class)); });
        deserializerMap.put("localSecurityOptionsAllowAnonymousEnumerationOfSAMAccountsAndShares", (n) -> { currentObject.setLocalSecurityOptionsAllowAnonymousEnumerationOfSAMAccountsAndShares(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowPKU2UAuthenticationRequests", (n) -> { currentObject.setLocalSecurityOptionsAllowPKU2UAuthenticationRequests(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowRemoteCallsToSecurityAccountsManager", (n) -> { currentObject.setLocalSecurityOptionsAllowRemoteCallsToSecurityAccountsManager(n.getStringValue()); });
        deserializerMap.put("localSecurityOptionsAllowRemoteCallsToSecurityAccountsManagerHelperBool", (n) -> { currentObject.setLocalSecurityOptionsAllowRemoteCallsToSecurityAccountsManagerHelperBool(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowSystemToBeShutDownWithoutHavingToLogOn", (n) -> { currentObject.setLocalSecurityOptionsAllowSystemToBeShutDownWithoutHavingToLogOn(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowUIAccessApplicationElevation", (n) -> { currentObject.setLocalSecurityOptionsAllowUIAccessApplicationElevation(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowUIAccessApplicationsForSecureLocations", (n) -> { currentObject.setLocalSecurityOptionsAllowUIAccessApplicationsForSecureLocations(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsAllowUndockWithoutHavingToLogon", (n) -> { currentObject.setLocalSecurityOptionsAllowUndockWithoutHavingToLogon(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsBlockMicrosoftAccounts", (n) -> { currentObject.setLocalSecurityOptionsBlockMicrosoftAccounts(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsBlockRemoteLogonWithBlankPassword", (n) -> { currentObject.setLocalSecurityOptionsBlockRemoteLogonWithBlankPassword(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsBlockRemoteOpticalDriveAccess", (n) -> { currentObject.setLocalSecurityOptionsBlockRemoteOpticalDriveAccess(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsBlockUsersInstallingPrinterDrivers", (n) -> { currentObject.setLocalSecurityOptionsBlockUsersInstallingPrinterDrivers(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsClearVirtualMemoryPageFile", (n) -> { currentObject.setLocalSecurityOptionsClearVirtualMemoryPageFile(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsClientDigitallySignCommunicationsAlways", (n) -> { currentObject.setLocalSecurityOptionsClientDigitallySignCommunicationsAlways(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsClientSendUnencryptedPasswordToThirdPartySMBServers", (n) -> { currentObject.setLocalSecurityOptionsClientSendUnencryptedPasswordToThirdPartySMBServers(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDetectApplicationInstallationsAndPromptForElevation", (n) -> { currentObject.setLocalSecurityOptionsDetectApplicationInstallationsAndPromptForElevation(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDisableAdministratorAccount", (n) -> { currentObject.setLocalSecurityOptionsDisableAdministratorAccount(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDisableClientDigitallySignCommunicationsIfServerAgrees", (n) -> { currentObject.setLocalSecurityOptionsDisableClientDigitallySignCommunicationsIfServerAgrees(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDisableGuestAccount", (n) -> { currentObject.setLocalSecurityOptionsDisableGuestAccount(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDisableServerDigitallySignCommunicationsAlways", (n) -> { currentObject.setLocalSecurityOptionsDisableServerDigitallySignCommunicationsAlways(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDisableServerDigitallySignCommunicationsIfClientAgrees", (n) -> { currentObject.setLocalSecurityOptionsDisableServerDigitallySignCommunicationsIfClientAgrees(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDoNotAllowAnonymousEnumerationOfSAMAccounts", (n) -> { currentObject.setLocalSecurityOptionsDoNotAllowAnonymousEnumerationOfSAMAccounts(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDoNotRequireCtrlAltDel", (n) -> { currentObject.setLocalSecurityOptionsDoNotRequireCtrlAltDel(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsDoNotStoreLANManagerHashValueOnNextPasswordChange", (n) -> { currentObject.setLocalSecurityOptionsDoNotStoreLANManagerHashValueOnNextPasswordChange(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsFormatAndEjectOfRemovableMediaAllowedUser", (n) -> { currentObject.setLocalSecurityOptionsFormatAndEjectOfRemovableMediaAllowedUser(n.getEnumValue(LocalSecurityOptionsFormatAndEjectOfRemovableMediaAllowedUserType.class)); });
        deserializerMap.put("localSecurityOptionsGuestAccountName", (n) -> { currentObject.setLocalSecurityOptionsGuestAccountName(n.getStringValue()); });
        deserializerMap.put("localSecurityOptionsHideLastSignedInUser", (n) -> { currentObject.setLocalSecurityOptionsHideLastSignedInUser(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsHideUsernameAtSignIn", (n) -> { currentObject.setLocalSecurityOptionsHideUsernameAtSignIn(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsInformationDisplayedOnLockScreen", (n) -> { currentObject.setLocalSecurityOptionsInformationDisplayedOnLockScreen(n.getEnumValue(LocalSecurityOptionsInformationDisplayedOnLockScreenType.class)); });
        deserializerMap.put("localSecurityOptionsInformationShownOnLockScreen", (n) -> { currentObject.setLocalSecurityOptionsInformationShownOnLockScreen(n.getEnumValue(LocalSecurityOptionsInformationShownOnLockScreenType.class)); });
        deserializerMap.put("localSecurityOptionsLogOnMessageText", (n) -> { currentObject.setLocalSecurityOptionsLogOnMessageText(n.getStringValue()); });
        deserializerMap.put("localSecurityOptionsLogOnMessageTitle", (n) -> { currentObject.setLocalSecurityOptionsLogOnMessageTitle(n.getStringValue()); });
        deserializerMap.put("localSecurityOptionsMachineInactivityLimit", (n) -> { currentObject.setLocalSecurityOptionsMachineInactivityLimit(n.getIntegerValue()); });
        deserializerMap.put("localSecurityOptionsMachineInactivityLimitInMinutes", (n) -> { currentObject.setLocalSecurityOptionsMachineInactivityLimitInMinutes(n.getIntegerValue()); });
        deserializerMap.put("localSecurityOptionsMinimumSessionSecurityForNtlmSspBasedClients", (n) -> { currentObject.setLocalSecurityOptionsMinimumSessionSecurityForNtlmSspBasedClients(n.getEnumValue(LocalSecurityOptionsMinimumSessionSecurity.class)); });
        deserializerMap.put("localSecurityOptionsMinimumSessionSecurityForNtlmSspBasedServers", (n) -> { currentObject.setLocalSecurityOptionsMinimumSessionSecurityForNtlmSspBasedServers(n.getEnumValue(LocalSecurityOptionsMinimumSessionSecurity.class)); });
        deserializerMap.put("localSecurityOptionsOnlyElevateSignedExecutables", (n) -> { currentObject.setLocalSecurityOptionsOnlyElevateSignedExecutables(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsRestrictAnonymousAccessToNamedPipesAndShares", (n) -> { currentObject.setLocalSecurityOptionsRestrictAnonymousAccessToNamedPipesAndShares(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsSmartCardRemovalBehavior", (n) -> { currentObject.setLocalSecurityOptionsSmartCardRemovalBehavior(n.getEnumValue(LocalSecurityOptionsSmartCardRemovalBehaviorType.class)); });
        deserializerMap.put("localSecurityOptionsStandardUserElevationPromptBehavior", (n) -> { currentObject.setLocalSecurityOptionsStandardUserElevationPromptBehavior(n.getEnumValue(LocalSecurityOptionsStandardUserElevationPromptBehaviorType.class)); });
        deserializerMap.put("localSecurityOptionsSwitchToSecureDesktopWhenPromptingForElevation", (n) -> { currentObject.setLocalSecurityOptionsSwitchToSecureDesktopWhenPromptingForElevation(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsUseAdminApprovalMode", (n) -> { currentObject.setLocalSecurityOptionsUseAdminApprovalMode(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsUseAdminApprovalModeForAdministrators", (n) -> { currentObject.setLocalSecurityOptionsUseAdminApprovalModeForAdministrators(n.getBooleanValue()); });
        deserializerMap.put("localSecurityOptionsVirtualizeFileAndRegistryWriteFailuresToPerUserLocations", (n) -> { currentObject.setLocalSecurityOptionsVirtualizeFileAndRegistryWriteFailuresToPerUserLocations(n.getBooleanValue()); });
        deserializerMap.put("smartScreenBlockOverrideForFiles", (n) -> { currentObject.setSmartScreenBlockOverrideForFiles(n.getBooleanValue()); });
        deserializerMap.put("smartScreenEnableInShell", (n) -> { currentObject.setSmartScreenEnableInShell(n.getBooleanValue()); });
        deserializerMap.put("userRightsAccessCredentialManagerAsTrustedCaller", (n) -> { currentObject.setUserRightsAccessCredentialManagerAsTrustedCaller(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsActAsPartOfTheOperatingSystem", (n) -> { currentObject.setUserRightsActAsPartOfTheOperatingSystem(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsAllowAccessFromNetwork", (n) -> { currentObject.setUserRightsAllowAccessFromNetwork(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsBackupData", (n) -> { currentObject.setUserRightsBackupData(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsBlockAccessFromNetwork", (n) -> { currentObject.setUserRightsBlockAccessFromNetwork(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsChangeSystemTime", (n) -> { currentObject.setUserRightsChangeSystemTime(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsCreateGlobalObjects", (n) -> { currentObject.setUserRightsCreateGlobalObjects(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsCreatePageFile", (n) -> { currentObject.setUserRightsCreatePageFile(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsCreatePermanentSharedObjects", (n) -> { currentObject.setUserRightsCreatePermanentSharedObjects(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsCreateSymbolicLinks", (n) -> { currentObject.setUserRightsCreateSymbolicLinks(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsCreateToken", (n) -> { currentObject.setUserRightsCreateToken(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsDebugPrograms", (n) -> { currentObject.setUserRightsDebugPrograms(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsDelegation", (n) -> { currentObject.setUserRightsDelegation(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsDenyLocalLogOn", (n) -> { currentObject.setUserRightsDenyLocalLogOn(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsGenerateSecurityAudits", (n) -> { currentObject.setUserRightsGenerateSecurityAudits(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsImpersonateClient", (n) -> { currentObject.setUserRightsImpersonateClient(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsIncreaseSchedulingPriority", (n) -> { currentObject.setUserRightsIncreaseSchedulingPriority(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsLoadUnloadDrivers", (n) -> { currentObject.setUserRightsLoadUnloadDrivers(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsLocalLogOn", (n) -> { currentObject.setUserRightsLocalLogOn(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsLockMemory", (n) -> { currentObject.setUserRightsLockMemory(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsManageAuditingAndSecurityLogs", (n) -> { currentObject.setUserRightsManageAuditingAndSecurityLogs(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsManageVolumes", (n) -> { currentObject.setUserRightsManageVolumes(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsModifyFirmwareEnvironment", (n) -> { currentObject.setUserRightsModifyFirmwareEnvironment(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsModifyObjectLabels", (n) -> { currentObject.setUserRightsModifyObjectLabels(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsProfileSingleProcess", (n) -> { currentObject.setUserRightsProfileSingleProcess(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsRemoteDesktopServicesLogOn", (n) -> { currentObject.setUserRightsRemoteDesktopServicesLogOn(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsRemoteShutdown", (n) -> { currentObject.setUserRightsRemoteShutdown(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsRestoreData", (n) -> { currentObject.setUserRightsRestoreData(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("userRightsTakeOwnership", (n) -> { currentObject.setUserRightsTakeOwnership(n.getObjectValue(DeviceManagementUserRightsSetting::createFromDiscriminatorValue)); });
        deserializerMap.put("windowsDefenderTamperProtection", (n) -> { currentObject.setWindowsDefenderTamperProtection(n.getEnumValue(WindowsDefenderTamperProtectionOptions.class)); });
        deserializerMap.put("xboxServicesAccessoryManagementServiceStartupMode", (n) -> { currentObject.setXboxServicesAccessoryManagementServiceStartupMode(n.getEnumValue(ServiceStartType.class)); });
        deserializerMap.put("xboxServicesEnableXboxGameSaveTask", (n) -> { currentObject.setXboxServicesEnableXboxGameSaveTask(n.getBooleanValue()); });
        deserializerMap.put("xboxServicesLiveAuthManagerServiceStartupMode", (n) -> { currentObject.setXboxServicesLiveAuthManagerServiceStartupMode(n.getEnumValue(ServiceStartType.class)); });
        deserializerMap.put("xboxServicesLiveGameSaveServiceStartupMode", (n) -> { currentObject.setXboxServicesLiveGameSaveServiceStartupMode(n.getEnumValue(ServiceStartType.class)); });
        deserializerMap.put("xboxServicesLiveNetworkingServiceStartupMode", (n) -> { currentObject.setXboxServicesLiveNetworkingServiceStartupMode(n.getEnumValue(ServiceStartType.class)); });
