...
/**
 * The class for the Device Management Setting Abstract Implementation Constraint.
 */
public class DeviceManagementSettingAbstractImplementationConstraint extends DeviceManagementConstraint implements IJsonBackedObject {
