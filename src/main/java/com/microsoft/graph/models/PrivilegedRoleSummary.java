...
public class PrivilegedRoleSummary extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("elevatedCount", (n) -> { currentObject.setElevatedCount(n.getIntegerValue()); });
        deserializerMap.put("managedCount", (n) -> { currentObject.setManagedCount(n.getIntegerValue()); });
        deserializerMap.put("mfaEnabled", (n) -> { currentObject.setMfaEnabled(n.getBooleanValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(RoleSummaryStatus.class)); });
        deserializerMap.put("usersCount", (n) -> { currentObject.setUsersCount(n.getIntegerValue()); });
