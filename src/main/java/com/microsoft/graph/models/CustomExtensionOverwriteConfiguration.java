...
public class CustomExtensionOverwriteConfiguration implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static CustomExtensionOverwriteConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
