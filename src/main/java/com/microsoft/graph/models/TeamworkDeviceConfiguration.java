...
public class TeamworkDeviceConfiguration extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("cameraConfiguration", (n) -> { currentObject.setCameraConfiguration(n.getObjectValue(TeamworkCameraConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("displayConfiguration", (n) -> { currentObject.setDisplayConfiguration(n.getObjectValue(TeamworkDisplayConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("hardwareConfiguration", (n) -> { currentObject.setHardwareConfiguration(n.getObjectValue(TeamworkHardwareConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("microphoneConfiguration", (n) -> { currentObject.setMicrophoneConfiguration(n.getObjectValue(TeamworkMicrophoneConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("softwareVersions", (n) -> { currentObject.setSoftwareVersions(n.getObjectValue(TeamworkDeviceSoftwareVersions::createFromDiscriminatorValue)); });
        deserializerMap.put("speakerConfiguration", (n) -> { currentObject.setSpeakerConfiguration(n.getObjectValue(TeamworkSpeakerConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("systemConfiguration", (n) -> { currentObject.setSystemConfiguration(n.getObjectValue(TeamworkSystemConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("teamsClientConfiguration", (n) -> { currentObject.setTeamsClientConfiguration(n.getObjectValue(TeamworkTeamsClientConfiguration::createFromDiscriminatorValue)); });
