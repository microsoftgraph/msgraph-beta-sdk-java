...
public class ExpeditedQualityUpdateReference extends QualityUpdateReference implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExpeditedQualityUpdateReference currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("equivalentContent", (n) -> { currentObject.setEquivalentContent(n.getEnumValue(EquivalentContentOption.class)); });
