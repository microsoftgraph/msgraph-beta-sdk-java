...
public class ApplicableContentDeviceMatchCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<ApplicableContentDeviceMatch> value;
    /**
     ...
     * @return a ApplicableContentDeviceMatchCollectionResponse
     */
    @javax.annotation.Nonnull
    public static ApplicableContentDeviceMatchCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<ApplicableContentDeviceMatch> value) {
        this.value = value;
    }
}
