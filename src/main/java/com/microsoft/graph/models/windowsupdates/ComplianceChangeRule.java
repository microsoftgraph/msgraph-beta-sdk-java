...
public class ComplianceChangeRule implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OffsetDateTime lastEvaluatedDateTime;
    /**
    ...
    public static ComplianceChangeRule createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public OffsetDateTime getLastEvaluatedDateTime() {
        return this.lastEvaluatedDateTime;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setLastEvaluatedDateTime(@javax.annotation.Nullable final OffsetDateTime value) {
        this.lastEvaluatedDateTime = value;
    }
    /**
