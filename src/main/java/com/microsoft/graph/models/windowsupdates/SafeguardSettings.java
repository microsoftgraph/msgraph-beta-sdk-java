...
public class SafeguardSettings implements AdditionalDataHolder, Parsable {
    ...
    public SafeguardSettings() {
        ...
        this.setOdataType("#microsoft.graph.windowsUpdates.safeguardSettings");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("disabledSafeguardProfiles", (n) -> { currentObject.setDisabledSafeguardProfiles(n.getCollectionOfObjectValues(SafeguardProfile::createFromDiscriminatorValue)); });
