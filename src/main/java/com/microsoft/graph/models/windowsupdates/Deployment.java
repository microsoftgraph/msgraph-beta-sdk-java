...
public class Deployment extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("audience", (n) -> { currentObject.setAudience(n.getObjectValue(DeploymentAudience::createFromDiscriminatorValue)); });
        deserializerMap.put("content", (n) -> { currentObject.setContent(n.getObjectValue(DeployableContent::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("settings", (n) -> { currentObject.setSettings(n.getObjectValue(DeploymentSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getObjectValue(DeploymentState::createFromDiscriminatorValue)); });
