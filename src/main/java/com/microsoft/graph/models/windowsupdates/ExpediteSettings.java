...
public class ExpediteSettings implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static ExpediteSettings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIsExpedited(@javax.annotation.Nullable final Boolean value) {
