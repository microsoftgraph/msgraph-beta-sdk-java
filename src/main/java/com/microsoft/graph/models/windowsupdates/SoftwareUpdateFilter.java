...
public class SoftwareUpdateFilter extends ContentFilter implements Parsable {
    ...
    public SoftwareUpdateFilter() {
        super();
        this.setOdataType("#microsoft.graph.windowsUpdates.softwareUpdateFilter");
    }
    /**
    ...
    public static SoftwareUpdateFilter createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        ...
        return new SoftwareUpdateFilter();
    }
    /**
