...
import com.microsoft.graph.models.CloudPcAuditProperty;
...
/**
 * The class for the Cloud Pc Audit Resource.
 */
public class CloudPcAuditResource implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<CloudPcAuditProperty> modifiedProperties;
