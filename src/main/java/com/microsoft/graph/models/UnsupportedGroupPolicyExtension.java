...
public class UnsupportedGroupPolicyExtension extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("extensionType", (n) -> { currentObject.setExtensionType(n.getStringValue()); });
        deserializerMap.put("namespaceUrl", (n) -> { currentObject.setNamespaceUrl(n.getStringValue()); });
        deserializerMap.put("nodeName", (n) -> { currentObject.setNodeName(n.getStringValue()); });
