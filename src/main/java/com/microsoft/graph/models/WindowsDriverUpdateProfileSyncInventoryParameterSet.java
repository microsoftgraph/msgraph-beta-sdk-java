...
/**
 * The class for the Windows Driver Update Profile Sync Inventory Parameter Set.
 */
public class WindowsDriverUpdateProfileSyncInventoryParameterSet {

    /**
     * Instiaciates a new WindowsDriverUpdateProfileSyncInventoryParameterSet
     */
     ...
     */
    protected WindowsDriverUpdateProfileSyncInventoryParameterSet(@Nonnull final WindowsDriverUpdateProfileSyncInventoryParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the WindowsDriverUpdateProfileSyncInventoryParameterSet
     */
    public static final class WindowsDriverUpdateProfileSyncInventoryParameterSetBuilder {
        /**
         * Instanciates a new WindowsDriverUpdateProfileSyncInventoryParameterSetBuilder
         */
        @Nullable
