...
/**
 * The class for the Cloud PCEnd Grace Period Parameter Set.
 */
public class CloudPCEndGracePeriodParameterSet {

    /**
     * Instiaciates a new CloudPCEndGracePeriodParameterSet
     */
     ...
     */
    protected CloudPCEndGracePeriodParameterSet(@Nonnull final CloudPCEndGracePeriodParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the CloudPCEndGracePeriodParameterSet
     */
    public static final class CloudPCEndGracePeriodParameterSetBuilder {
        /**
         * Instanciates a new CloudPCEndGracePeriodParameterSetBuilder
         */
        @Nullable
