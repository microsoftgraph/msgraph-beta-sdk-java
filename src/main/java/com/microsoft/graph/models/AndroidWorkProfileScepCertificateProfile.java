...
public class AndroidWorkProfileScepCertificateProfile extends AndroidWorkProfileCertificateProfileBase implements Parsable {
    ...
    public static AndroidWorkProfileScepCertificateProfile createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidWorkProfileScepCertificateProfile currentObject = this;
