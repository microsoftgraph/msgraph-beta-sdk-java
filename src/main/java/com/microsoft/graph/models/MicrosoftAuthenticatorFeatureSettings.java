...
public class MicrosoftAuthenticatorFeatureSettings implements AdditionalDataHolder, Parsable {
    ...
    private AuthenticationMethodFeatureConfiguration _numberMatchingRequiredState;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("numberMatchingRequiredState", (n) -> { currentObject.setNumberMatchingRequiredState(n.getObjectValue(AuthenticationMethodFeatureConfiguration::createFromDiscriminatorValue)); });
