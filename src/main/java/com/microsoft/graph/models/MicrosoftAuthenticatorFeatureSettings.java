...
public class MicrosoftAuthenticatorFeatureSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(4) {{
            ...
            this.put("numberMatchingRequiredState", (n) -> { currentObject.setNumberMatchingRequiredState(n.getObjectValue(AuthenticationMethodFeatureConfiguration::createFromDiscriminatorValue)); });
