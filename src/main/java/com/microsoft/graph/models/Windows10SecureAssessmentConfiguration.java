...
public class Windows10SecureAssessmentConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("assessmentAppUserModelId", (n) -> { currentObject.setAssessmentAppUserModelId(n.getStringValue()); });
        deserializerMap.put("configurationAccount", (n) -> { currentObject.setConfigurationAccount(n.getStringValue()); });
        deserializerMap.put("configurationAccountType", (n) -> { currentObject.setConfigurationAccountType(n.getEnumValue(SecureAssessmentAccountType.class)); });
        deserializerMap.put("launchUri", (n) -> { currentObject.setLaunchUri(n.getStringValue()); });
        deserializerMap.put("localGuestAccountName", (n) -> { currentObject.setLocalGuestAccountName(n.getStringValue()); });
