...
public class OnPremisesDirectorySynchronizationFeature implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(20) {{
            this.put("blockCloudObjectTakeoverThroughHardMatchEnabled", (n) -> { currentObject.setBlockCloudObjectTakeoverThroughHardMatchEnabled(n.getBooleanValue()); });
            this.put("blockSoftMatchEnabled", (n) -> { currentObject.setBlockSoftMatchEnabled(n.getBooleanValue()); });
            this.put("bypassDirSyncOverridesEnabled", (n) -> { currentObject.setBypassDirSyncOverridesEnabled(n.getBooleanValue()); });
            this.put("cloudPasswordPolicyForPasswordSyncedUsersEnabled", (n) -> { currentObject.setCloudPasswordPolicyForPasswordSyncedUsersEnabled(n.getBooleanValue()); });
            this.put("concurrentCredentialUpdateEnabled", (n) -> { currentObject.setConcurrentCredentialUpdateEnabled(n.getBooleanValue()); });
            this.put("concurrentOrgIdProvisioningEnabled", (n) -> { currentObject.setConcurrentOrgIdProvisioningEnabled(n.getBooleanValue()); });
            this.put("deviceWritebackEnabled", (n) -> { currentObject.setDeviceWritebackEnabled(n.getBooleanValue()); });
            this.put("directoryExtensionsEnabled", (n) -> { currentObject.setDirectoryExtensionsEnabled(n.getBooleanValue()); });
            this.put("fopeConflictResolutionEnabled", (n) -> { currentObject.setFopeConflictResolutionEnabled(n.getBooleanValue()); });
            this.put("groupWriteBackEnabled", (n) -> { currentObject.setGroupWriteBackEnabled(n.getBooleanValue()); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("passwordSyncEnabled", (n) -> { currentObject.setPasswordSyncEnabled(n.getBooleanValue()); });
            this.put("passwordWritebackEnabled", (n) -> { currentObject.setPasswordWritebackEnabled(n.getBooleanValue()); });
            this.put("quarantineUponProxyAddressesConflictEnabled", (n) -> { currentObject.setQuarantineUponProxyAddressesConflictEnabled(n.getBooleanValue()); });
            this.put("quarantineUponUpnConflictEnabled", (n) -> { currentObject.setQuarantineUponUpnConflictEnabled(n.getBooleanValue()); });
            this.put("softMatchOnUpnEnabled", (n) -> { currentObject.setSoftMatchOnUpnEnabled(n.getBooleanValue()); });
            this.put("synchronizeUpnForManagedUsersEnabled", (n) -> { currentObject.setSynchronizeUpnForManagedUsersEnabled(n.getBooleanValue()); });
            this.put("unifiedGroupWritebackEnabled", (n) -> { currentObject.setUnifiedGroupWritebackEnabled(n.getBooleanValue()); });
            this.put("userForcePasswordChangeOnLogonEnabled", (n) -> { currentObject.setUserForcePasswordChangeOnLogonEnabled(n.getBooleanValue()); });
            this.put("userWritebackEnabled", (n) -> { currentObject.setUserWritebackEnabled(n.getBooleanValue()); });
        }};
    }
    /**
