...
/**
 * The class for the Recommendation Reactivate Parameter Set.
 */
public class RecommendationReactivateParameterSet {

    /**
     * Instiaciates a new RecommendationReactivateParameterSet
     */
     ...
     */
    protected RecommendationReactivateParameterSet(@Nonnull final RecommendationReactivateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the RecommendationReactivateParameterSet
     */
    public static final class RecommendationReactivateParameterSetBuilder {
        /**
         * Instanciates a new RecommendationReactivateParameterSetBuilder
         */
        @Nullable
