...
/**
 * The class for the Teams User Activity Distribution User Counts.
 */
public class TeamsUserActivityDistributionUserCounts extends Entity implements IJsonBackedObject {
