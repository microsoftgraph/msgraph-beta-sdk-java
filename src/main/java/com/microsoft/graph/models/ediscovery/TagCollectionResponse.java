...
public class TagCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public static TagCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TagCollectionResponse currentObject = this;
