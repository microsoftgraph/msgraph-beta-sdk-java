...
public class Custodian extends DataSourceContainer implements Parsable {
    ...
    private Boolean _applyHoldToSources;
    ...
    public Boolean getApplyHoldToSources() {
        return this._applyHoldToSources;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applyHoldToSources", (n) -> { currentObject.setApplyHoldToSources(n.getBooleanValue()); });
