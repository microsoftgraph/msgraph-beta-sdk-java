...
public class LegalHold extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { currentObject.setErrors(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(LegalHoldStatus.class)); });
