...
public class DataSourceContainer extends Entity implements Parsable {
    ...
    private CaseIndexOperation _lastIndexOperation;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastIndexOperation", (n) -> { currentObject.setLastIndexOperation(n.getObjectValue(CaseIndexOperation::createFromDiscriminatorValue)); });
