...
/**
 * The class for the On Authentication Method Load Start Listener.
 */
public class OnAuthenticationMethodLoadStartListener extends AuthenticationEventListener implements IJsonBackedObject {
