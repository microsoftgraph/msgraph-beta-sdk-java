...
public class MetaDataKeyValuePair implements AdditionalDataHolder, Parsable {
    ...
    public static MetaDataKeyValuePair createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
