...
public class DetectedSensitiveContentWrapper implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> _additionalData;
    /** The classification property */
    private java.util.List<DetectedSensitiveContent> _classification;
    ...
    public static DetectedSensitiveContentWrapper createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
