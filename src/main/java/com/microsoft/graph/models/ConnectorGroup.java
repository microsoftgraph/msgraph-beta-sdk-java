...
public class ConnectorGroup extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applications", (n) -> { currentObject.setApplications(n.getCollectionOfObjectValues(Application::createFromDiscriminatorValue)); });
        deserializerMap.put("connectorGroupType", (n) -> { currentObject.setConnectorGroupType(n.getEnumValue(ConnectorGroupType.class)); });
        deserializerMap.put("isDefault", (n) -> { currentObject.setIsDefault(n.getBooleanValue()); });
        deserializerMap.put("members", (n) -> { currentObject.setMembers(n.getCollectionOfObjectValues(Connector::createFromDiscriminatorValue)); });
        deserializerMap.put("name", (n) -> { currentObject.setName(n.getStringValue()); });
        deserializerMap.put("region", (n) -> { currentObject.setRegion(n.getEnumValue(ConnectorGroupRegion.class)); });
