...
/**
 * The class for the Workbook Functions Degrees Parameter Set.
 */
public class WorkbookFunctionsDegreesParameterSet {
    ...
    public static final class WorkbookFunctionsDegreesParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDegreesParameterSetBuilder withAngle(@Nullable final com.google.gson.JsonElement val) {
            this.angle = val;
            return this;
        }
        /**
