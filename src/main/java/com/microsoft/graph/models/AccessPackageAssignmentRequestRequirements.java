...
public class AccessPackageAssignmentRequestRequirements implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("existingAnswers", (n) -> { currentObject.setExistingAnswers(n.getCollectionOfObjectValues(AccessPackageAnswer::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("isCustomAssignmentScheduleAllowed", (n) -> { currentObject.setIsCustomAssignmentScheduleAllowed(n.getBooleanValue()); });
