...
public class RoleDefinition extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isBuiltInRoleDefinition", (n) -> { currentObject.setIsBuiltInRoleDefinition(n.getBooleanValue()); });
        deserializerMap.put("permissions", (n) -> { currentObject.setPermissions(n.getCollectionOfObjectValues(RolePermission::createFromDiscriminatorValue)); });
