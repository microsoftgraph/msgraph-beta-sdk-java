...
public class AndroidDeviceOwnerTrustedRootCertificate extends DeviceConfiguration implements Parsable {
    ...
    public static AndroidDeviceOwnerTrustedRootCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidDeviceOwnerTrustedRootCertificate currentObject = this;
