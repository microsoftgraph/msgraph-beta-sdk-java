...
public class GcpAuthorizationSystem extends AuthorizationSystem implements Parsable {
     ...
     */
    private java.util.List<GcpAuthorizationSystemTypeAction> actions;
    /**
     * The associatedIdentities property
     */
    private GcpAssociatedIdentities associatedIdentities;
    /**
     * The resources property
     */
    private java.util.List<GcpAuthorizationSystemResource> resources;
    /**
     * The roles property
     */
    private java.util.List<GcpRole> roles;
    /**
