...
public class GeneralLedgerEntry extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accountNumber", (n) -> { currentObject.setAccountNumber(n.getStringValue()); });
        deserializerMap.put("creditAmount", (n) -> { currentObject.setCreditAmount(n.getBigDecimalValue()); });
        deserializerMap.put("debitAmount", (n) -> { currentObject.setDebitAmount(n.getBigDecimalValue()); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("documentNumber", (n) -> { currentObject.setDocumentNumber(n.getStringValue()); });
        deserializerMap.put("documentType", (n) -> { currentObject.setDocumentType(n.getStringValue()); });
