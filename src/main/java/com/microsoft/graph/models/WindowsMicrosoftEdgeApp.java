...
public class WindowsMicrosoftEdgeApp extends MobileApp implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("channel", (n) -> { currentObject.setChannel(n.getEnumValue(MicrosoftEdgeChannel.class)); });
        deserializerMap.put("displayLanguageLocale", (n) -> { currentObject.setDisplayLanguageLocale(n.getStringValue()); });
