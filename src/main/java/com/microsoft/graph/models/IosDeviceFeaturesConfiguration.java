...
public class IosDeviceFeaturesConfiguration extends AppleDeviceFeaturesConfigurationBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("contentFilterSettings", (n) -> { currentObject.setContentFilterSettings(n.getObjectValue(IosWebContentFilterBase::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("homeScreenGridHeight", (n) -> { currentObject.setHomeScreenGridHeight(n.getIntegerValue()); });
        deserializerMap.put("homeScreenGridWidth", (n) -> { currentObject.setHomeScreenGridWidth(n.getIntegerValue()); });
        ...
        deserializerMap.put("iosSingleSignOnExtension", (n) -> { currentObject.setIosSingleSignOnExtension(n.getObjectValue(IosSingleSignOnExtension::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("singleSignOnExtensionPkinitCertificate", (n) -> { currentObject.setSingleSignOnExtensionPkinitCertificate(n.getObjectValue(IosCertificateProfileBase::createFromDiscriminatorValue)); });
        deserializerMap.put("singleSignOnSettings", (n) -> { currentObject.setSingleSignOnSettings(n.getObjectValue(IosSingleSignOnSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("wallpaperDisplayLocation", (n) -> { currentObject.setWallpaperDisplayLocation(n.getEnumValue(IosWallpaperDisplayLocation.class)); });
        deserializerMap.put("wallpaperImage", (n) -> { currentObject.setWallpaperImage(n.getObjectValue(MimeContent::createFromDiscriminatorValue)); });
