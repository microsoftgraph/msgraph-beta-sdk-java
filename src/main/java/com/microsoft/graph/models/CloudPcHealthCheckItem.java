...
public class CloudPcHealthCheckItem implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastHealthCheckDateTime", (n) -> { currentObject.setLastHealthCheckDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("result", (n) -> { currentObject.setResult(n.getEnumValue(CloudPcConnectivityEventResult.class)); });
