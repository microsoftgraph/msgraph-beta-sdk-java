...
/**
 * The class for the Apple Expedited Checkin Configuration Base.
 */
public class AppleExpeditedCheckinConfigurationBase extends DeviceConfiguration implements IJsonBackedObject {
