...
public class OemWarranty implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additionalWarranties", (n) -> { currentObject.setAdditionalWarranties(n.getCollectionOfObjectValues(WarrantyOffer::createFromDiscriminatorValue)); });
        deserializerMap.put("baseWarranties", (n) -> { currentObject.setBaseWarranties(n.getCollectionOfObjectValues(WarrantyOffer::createFromDiscriminatorValue)); });
        deserializerMap.put("deviceConfigurationUrl", (n) -> { currentObject.setDeviceConfigurationUrl(n.getStringValue()); });
        deserializerMap.put("deviceWarrantyUrl", (n) -> { currentObject.setDeviceWarrantyUrl(n.getStringValue()); });
