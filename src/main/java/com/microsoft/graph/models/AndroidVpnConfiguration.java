...
public class AndroidVpnConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public static AndroidVpnConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidVpnConfiguration currentObject = this;
        ...
        deserializerMap.put("connectionType", (n) -> { currentObject.setConnectionType(n.getEnumValue(AndroidVpnConnectionType.class)); });
        ...
        deserializerMap.put("identityCertificate", (n) -> { currentObject.setIdentityCertificate(n.getObjectValue(AndroidCertificateProfileBase::createFromDiscriminatorValue)); });
