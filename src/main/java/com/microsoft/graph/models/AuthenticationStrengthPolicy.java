...
public class AuthenticationStrengthPolicy extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("combinationConfigurations", (n) -> { currentObject.setCombinationConfigurations(n.getCollectionOfObjectValues(AuthenticationCombinationConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("policyType", (n) -> { currentObject.setPolicyType(n.getEnumValue(AuthenticationStrengthPolicyType.class)); });
        deserializerMap.put("requirementsSatisfied", (n) -> { currentObject.setRequirementsSatisfied(n.getEnumValue(AuthenticationStrengthRequirements.class)); });
