...
public class EducationAssignmentGradeType implements AdditionalDataHolder, Parsable {
    ...
    public static EducationAssignmentGradeType createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EducationAssignmentGradeType currentObject = this;
