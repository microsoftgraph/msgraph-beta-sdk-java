...
public class DeviceManagementSettingXmlConstraint extends DeviceManagementConstraint implements Parsable {
    ...
    public static DeviceManagementSettingXmlConstraint createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementSettingXmlConstraint currentObject = this;
