...
public class EdgeHomeButtonOpensNewTab extends EdgeHomeButtonConfiguration implements Parsable {
    ...
    public static EdgeHomeButtonOpensNewTab createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EdgeHomeButtonOpensNewTab currentObject = this;
