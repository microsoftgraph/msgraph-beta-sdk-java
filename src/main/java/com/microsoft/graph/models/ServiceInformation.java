...
public class ServiceInformation implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceInformation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ServiceInformation currentObject = this;
