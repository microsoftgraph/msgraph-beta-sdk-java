...
public class IndustryDataRun extends Entity implements Parsable {
    ...
    public static IndustryDataRun createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setActivities(@javax.annotation.Nullable final java.util.List<IndustryDataRunActivity> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final IndustryDataRunStatus value) {
        this.status = value;
    }
}
