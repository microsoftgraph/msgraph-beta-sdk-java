...
public class IndustryDataRunRoleCountMetric implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static IndustryDataRunRoleCountMetric createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
