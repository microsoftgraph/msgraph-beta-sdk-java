...
public class DeviceManagementConfigurationIntegerSettingValueDefinitionTemplate implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maxValue", (n) -> { currentObject.setMaxValue(n.getIntegerValue()); });
        deserializerMap.put("minValue", (n) -> { currentObject.setMinValue(n.getIntegerValue()); });
