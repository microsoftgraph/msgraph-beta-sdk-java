...
/**
 * The class for the User Experience Analytics Battery Health Device App Impact.
 */
public class UserExperienceAnalyticsBatteryHealthDeviceAppImpact extends Entity implements IJsonBackedObject {
