...
public class GroupPolicyPresentationListBox extends GroupPolicyUploadedPresentation implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("explicitValue", (n) -> { currentObject.setExplicitValue(n.getBooleanValue()); });
        deserializerMap.put("valuePrefix", (n) -> { currentObject.setValuePrefix(n.getStringValue()); });
