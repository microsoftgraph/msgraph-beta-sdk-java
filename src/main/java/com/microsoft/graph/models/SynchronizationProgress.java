...
public class SynchronizationProgress implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("completedUnits", (n) -> { currentObject.setCompletedUnits(n.getLongValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("progressObservationDateTime", (n) -> { currentObject.setProgressObservationDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("totalUnits", (n) -> { currentObject.setTotalUnits(n.getLongValue()); });
        deserializerMap.put("units", (n) -> { currentObject.setUnits(n.getStringValue()); });
