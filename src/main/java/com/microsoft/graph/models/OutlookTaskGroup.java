...
public class OutlookTaskGroup extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("groupKey", (n) -> { currentObject.setGroupKey(n.getStringValue()); });
        deserializerMap.put("isDefaultGroup", (n) -> { currentObject.setIsDefaultGroup(n.getBooleanValue()); });
