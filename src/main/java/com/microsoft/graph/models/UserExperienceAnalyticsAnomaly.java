...
public class UserExperienceAnalyticsAnomaly extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            this.put("anomalyFirstOccurrenceDateTime", (n) -> { currentObject.setAnomalyFirstOccurrenceDateTime(n.getOffsetDateTimeValue()); });
            this.put("anomalyId", (n) -> { currentObject.setAnomalyId(n.getStringValue()); });
            this.put("anomalyLatestOccurrenceDateTime", (n) -> { currentObject.setAnomalyLatestOccurrenceDateTime(n.getOffsetDateTimeValue()); });
            this.put("anomalyName", (n) -> { currentObject.setAnomalyName(n.getStringValue()); });
            this.put("anomalyType", (n) -> { currentObject.setAnomalyType(n.getEnumValue(UserExperienceAnalyticsAnomalyType.class)); });
            this.put("assetName", (n) -> { currentObject.setAssetName(n.getStringValue()); });
            this.put("assetPublisher", (n) -> { currentObject.setAssetPublisher(n.getStringValue()); });
            this.put("assetVersion", (n) -> { currentObject.setAssetVersion(n.getStringValue()); });
            this.put("detectionModelId", (n) -> { currentObject.setDetectionModelId(n.getStringValue()); });
            this.put("deviceImpactedCount", (n) -> { currentObject.setDeviceImpactedCount(n.getIntegerValue()); });
            this.put("issueId", (n) -> { currentObject.setIssueId(n.getStringValue()); });
            this.put("severity", (n) -> { currentObject.setSeverity(n.getEnumValue(UserExperienceAnalyticsAnomalySeverity.class)); });
            this.put("state", (n) -> { currentObject.setState(n.getEnumValue(UserExperienceAnalyticsAnomalyState.class)); });
        }};
    }
    /**
