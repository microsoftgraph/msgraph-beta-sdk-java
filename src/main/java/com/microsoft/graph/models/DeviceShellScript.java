...
public class DeviceShellScript extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blockExecutionNotifications", (n) -> { currentObject.setBlockExecutionNotifications(n.getBooleanValue()); });
        ...
        deserializerMap.put("executionFrequency", (n) -> { currentObject.setExecutionFrequency(n.getPeriodValue()); });
        ...
        deserializerMap.put("retryCount", (n) -> { currentObject.setRetryCount(n.getIntegerValue()); });
