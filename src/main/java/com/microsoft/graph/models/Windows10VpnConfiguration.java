...
public class Windows10VpnConfiguration extends WindowsVpnConfiguration implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("eapXml", (n) -> { this.setEapXml(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("eapXml", this.getEapXml());
     ...
     */
    public void setEapXml(@jakarta.annotation.Nullable final Base64url value) {
        this.eapXml = value;
    }
    /**
