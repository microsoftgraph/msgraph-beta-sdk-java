...
public class ProgramControl extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("controlId", (n) -> { currentObject.setControlId(n.getStringValue()); });
        deserializerMap.put("controlTypeId", (n) -> { currentObject.setControlTypeId(n.getStringValue()); });
        deserializerMap.put("createdDateTime", (n) -> { currentObject.setCreatedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("owner", (n) -> { currentObject.setOwner(n.getObjectValue(UserIdentity::createFromDiscriminatorValue)); });
        deserializerMap.put("program", (n) -> { currentObject.setProgram(n.getObjectValue(Program::createFromDiscriminatorValue)); });
        deserializerMap.put("programId", (n) -> { currentObject.setProgramId(n.getStringValue()); });
        deserializerMap.put("resource", (n) -> { currentObject.setResource(n.getObjectValue(ProgramResource::createFromDiscriminatorValue)); });
