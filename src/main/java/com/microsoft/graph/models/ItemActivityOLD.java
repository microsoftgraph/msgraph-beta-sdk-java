...
public class ItemActivityOLD extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { currentObject.setAction(n.getObjectValue(ItemActionSet::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("times", (n) -> { currentObject.setTimes(n.getObjectValue(ItemActivityTimeSet::createFromDiscriminatorValue)); });
