...
public class CloudPC extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("aadDeviceId", (n) -> { currentObject.setAadDeviceId(n.getStringValue()); });
        deserializerMap.put("connectivityResult", (n) -> { currentObject.setConnectivityResult(n.getObjectValue(CloudPcConnectivityResult::createFromDiscriminatorValue)); });
        deserializerMap.put("diskEncryptionState", (n) -> { currentObject.setDiskEncryptionState(n.getEnumValue(CloudPcDiskEncryptionState.class)); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("gracePeriodEndDateTime", (n) -> { currentObject.setGracePeriodEndDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("imageDisplayName", (n) -> { currentObject.setImageDisplayName(n.getStringValue()); });
        deserializerMap.put("lastLoginResult", (n) -> { currentObject.setLastLoginResult(n.getObjectValue(CloudPcLoginResult::createFromDiscriminatorValue)); });
        deserializerMap.put("lastModifiedDateTime", (n) -> { currentObject.setLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("lastRemoteActionResult", (n) -> { currentObject.setLastRemoteActionResult(n.getObjectValue(CloudPcRemoteActionResult::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("onPremisesConnectionName", (n) -> { currentObject.setOnPremisesConnectionName(n.getStringValue()); });
        ...
        deserializerMap.put("provisioningPolicyName", (n) -> { currentObject.setProvisioningPolicyName(n.getStringValue()); });
        ...
        deserializerMap.put("servicePlanType", (n) -> { currentObject.setServicePlanType(n.getEnumValue(CloudPcServicePlanType.class)); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(CloudPcStatus.class)); });
