...
public class EducationalActivityDetail implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("abbreviation", (n) -> { currentObject.setAbbreviation(n.getStringValue()); });
        deserializerMap.put("activities", (n) -> { currentObject.setActivities(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("awards", (n) -> { currentObject.setAwards(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("fieldsOfStudy", (n) -> { currentObject.setFieldsOfStudy(n.getCollectionOfPrimitiveValues(String.class)); });
