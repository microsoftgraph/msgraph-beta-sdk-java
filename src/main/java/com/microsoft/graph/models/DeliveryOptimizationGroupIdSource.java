...
public class DeliveryOptimizationGroupIdSource implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static DeliveryOptimizationGroupIdSource createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
