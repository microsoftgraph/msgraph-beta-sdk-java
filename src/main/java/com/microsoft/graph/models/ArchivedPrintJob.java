...
public class ArchivedPrintJob implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blackAndWhitePageCount", (n) -> { currentObject.setBlackAndWhitePageCount(n.getIntegerValue()); });
        deserializerMap.put("colorPageCount", (n) -> { currentObject.setColorPageCount(n.getIntegerValue()); });
        ...
        deserializerMap.put("duplexPageCount", (n) -> { currentObject.setDuplexPageCount(n.getIntegerValue()); });
        deserializerMap.put("id", (n) -> { currentObject.setId(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("pageCount", (n) -> { currentObject.setPageCount(n.getIntegerValue()); });
        ...
        deserializerMap.put("simplexPageCount", (n) -> { currentObject.setSimplexPageCount(n.getIntegerValue()); });
