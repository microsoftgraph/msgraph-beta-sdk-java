...
import com.microsoft.graph.models.PlannerExternalPlanSource;
...
public class PlannerPlanCreation implements AdditionalDataHolder, Parsable {
    ...
    public static PlannerPlanCreation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
