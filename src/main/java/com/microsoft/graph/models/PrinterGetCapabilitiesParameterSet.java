...
/**
 * The class for the Printer Get Capabilities Parameter Set.
 */
public class PrinterGetCapabilitiesParameterSet {

    /**
     * Instiaciates a new PrinterGetCapabilitiesParameterSet
     */
     ...
     */
    protected PrinterGetCapabilitiesParameterSet(@Nonnull final PrinterGetCapabilitiesParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PrinterGetCapabilitiesParameterSet
     */
    public static final class PrinterGetCapabilitiesParameterSetBuilder {
        /**
         * Instanciates a new PrinterGetCapabilitiesParameterSetBuilder
         */
        @Nullable
