...
public class VppLicensingType implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("supportDeviceLicensing", (n) -> { currentObject.setSupportDeviceLicensing(n.getBooleanValue()); });
        deserializerMap.put("supportsDeviceLicensing", (n) -> { currentObject.setSupportsDeviceLicensing(n.getBooleanValue()); });
        deserializerMap.put("supportsUserLicensing", (n) -> { currentObject.setSupportsUserLicensing(n.getBooleanValue()); });
        deserializerMap.put("supportUserLicensing", (n) -> { currentObject.setSupportUserLicensing(n.getBooleanValue()); });
