...
/**
 * The class for the Report Root Get Teams Device Usage Distribution Total User Counts Parameter Set.
 */
public class ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSet {
    ...
    /**
     * Instiaciates a new ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSet
     */
     ...
     */
    protected ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSet(@Nonnull final ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSet
     */
    public static final class ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSetBuilder withPeriod(@Nullable final String val) {
            this.period = val;
            return this;
        }
        /**
         * Instanciates a new ReportRootGetTeamsDeviceUsageDistributionTotalUserCountsParameterSetBuilder
         */
        @Nullable
