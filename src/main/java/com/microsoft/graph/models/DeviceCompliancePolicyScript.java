...
public class DeviceCompliancePolicyScript implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceComplianceScriptId", (n) -> { currentObject.setDeviceComplianceScriptId(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("rulesContent", (n) -> { currentObject.setRulesContent(n.getByteArrayValue()); });
