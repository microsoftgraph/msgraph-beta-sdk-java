...
/**
 * The class for the Device Management User Experience Analytics Summarized Device Scopes Parameter Set.
 */
public class DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSet {

    /**
     * Instiaciates a new DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSet
     */
     ...
     */
    protected DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSet(@Nonnull final DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSet
     */
    public static final class DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSetBuilder {
        /**
         * Instanciates a new DeviceManagementUserExperienceAnalyticsSummarizedDeviceScopesParameterSetBuilder
         */
        @Nullable
