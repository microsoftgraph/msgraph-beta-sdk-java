...
public class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration implements Parsable {
    ...
    private java.util.List<WindowsUpdateState> deviceUpdateStates;
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceUpdateStates", (n) -> { this.setDeviceUpdateStates(n.getCollectionOfObjectValues(WindowsUpdateState::createFromDiscriminatorValue)); });
