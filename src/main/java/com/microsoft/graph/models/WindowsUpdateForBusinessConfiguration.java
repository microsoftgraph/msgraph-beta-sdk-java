...
public class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceUpdateStates", (n) -> { currentObject.setDeviceUpdateStates(n.getCollectionOfObjectValues(WindowsUpdateState::createFromDiscriminatorValue)); });
