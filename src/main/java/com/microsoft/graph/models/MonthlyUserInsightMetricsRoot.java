...
public class MonthlyUserInsightMetricsRoot extends Entity implements Parsable {
     ...
     */
    private java.util.List<MonthlyInactiveUsersMetric> inactiveUsers;
    /**
     * The inactiveUsersByApplication property
     */
    private java.util.List<MonthlyInactiveUsersByApplicationMetric> inactiveUsersByApplication;
    /**
     ...
     */
    private java.util.List<UserRequestsMetric> requests;
    /**
