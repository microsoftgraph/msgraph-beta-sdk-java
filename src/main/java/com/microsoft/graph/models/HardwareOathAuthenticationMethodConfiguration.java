...
/**
 * The class for the Hardware Oath Authentication Method Configuration.
 */
public class HardwareOathAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements IJsonBackedObject {
