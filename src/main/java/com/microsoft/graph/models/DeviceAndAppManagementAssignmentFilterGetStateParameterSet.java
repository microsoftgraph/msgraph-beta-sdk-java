...
/**
 * The class for the Device And App Management Assignment Filter Get State Parameter Set.
 */
public class DeviceAndAppManagementAssignmentFilterGetStateParameterSet {

    /**
     * Instiaciates a new DeviceAndAppManagementAssignmentFilterGetStateParameterSet
     */
     ...
     */
    protected DeviceAndAppManagementAssignmentFilterGetStateParameterSet(@Nonnull final DeviceAndAppManagementAssignmentFilterGetStateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceAndAppManagementAssignmentFilterGetStateParameterSet
     */
    public static final class DeviceAndAppManagementAssignmentFilterGetStateParameterSetBuilder {
        /**
         * Instanciates a new DeviceAndAppManagementAssignmentFilterGetStateParameterSetBuilder
         */
        @Nullable
