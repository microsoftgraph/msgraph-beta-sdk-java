...
public class IosTrustedRootCertificate extends DeviceConfiguration implements Parsable {
    ...
    public static IosTrustedRootCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final IosTrustedRootCertificate currentObject = this;
