...
public class MicrosoftManagedDesktop implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("profile", (n) -> { currentObject.setProfile(n.getStringValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(MicrosoftManagedDesktopType.class)); });
