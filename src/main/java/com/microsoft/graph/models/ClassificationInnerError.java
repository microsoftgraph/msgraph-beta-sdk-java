...
public class ClassificationInnerError implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activityId", (n) -> { currentObject.setActivityId(n.getStringValue()); });
        deserializerMap.put("clientRequestId", (n) -> { currentObject.setClientRequestId(n.getStringValue()); });
        deserializerMap.put("code", (n) -> { currentObject.setCode(n.getStringValue()); });
        deserializerMap.put("errorDateTime", (n) -> { currentObject.setErrorDateTime(n.getOffsetDateTimeValue()); });
