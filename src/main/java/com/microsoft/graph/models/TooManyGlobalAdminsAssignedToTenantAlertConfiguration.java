...
/**
 * The class for the Too Many Global Admins Assigned To Tenant Alert Configuration.
 */
public class TooManyGlobalAdminsAssignedToTenantAlertConfiguration extends UnifiedRoleManagementAlertConfiguration implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public Integer globalAdminCountThreshold;
    ...
    @Expose
	@Nullable
    public Integer percentageOfGlobalAdminsOutOfRolesThreshold;
