...
public class EmbeddedSIMActivationCode implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integratedCircuitCardIdentifier", (n) -> { currentObject.setIntegratedCircuitCardIdentifier(n.getStringValue()); });
        deserializerMap.put("matchingIdentifier", (n) -> { currentObject.setMatchingIdentifier(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("smdpPlusServerAddress", (n) -> { currentObject.setSmdpPlusServerAddress(n.getStringValue()); });
