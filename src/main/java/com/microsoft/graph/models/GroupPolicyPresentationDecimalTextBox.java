...
public class GroupPolicyPresentationDecimalTextBox extends GroupPolicyUploadedPresentation implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("defaultValue", (n) -> { currentObject.setDefaultValue(n.getLongValue()); });
        deserializerMap.put("maxValue", (n) -> { currentObject.setMaxValue(n.getLongValue()); });
        deserializerMap.put("minValue", (n) -> { currentObject.setMinValue(n.getLongValue()); });
        deserializerMap.put("required", (n) -> { currentObject.setRequired(n.getBooleanValue()); });
        deserializerMap.put("spin", (n) -> { currentObject.setSpin(n.getBooleanValue()); });
        deserializerMap.put("spinStep", (n) -> { currentObject.setSpinStep(n.getLongValue()); });
