...
public class X509CertificateIssuerHintsConfiguration implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The state property
     */
    private X509CertificateIssuerHintsState state;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(X509CertificateIssuerHintsState.class)); });
