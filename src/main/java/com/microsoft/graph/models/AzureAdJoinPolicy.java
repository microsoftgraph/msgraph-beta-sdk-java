...
public class AzureAdJoinPolicy implements AdditionalDataHolder, Parsable {
    ...
    public static AzureAdJoinPolicy createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedGroups", (n) -> { currentObject.setAllowedGroups(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("allowedUsers", (n) -> { currentObject.setAllowedUsers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("appliesTo", (n) -> { currentObject.setAppliesTo(n.getEnumValue(PolicyScope.class)); });
        deserializerMap.put("isAdminConfigurable", (n) -> { currentObject.setIsAdminConfigurable(n.getBooleanValue()); });
