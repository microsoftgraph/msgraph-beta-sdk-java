...
public class KeyLongValuePair implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static KeyLongValuePair createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
