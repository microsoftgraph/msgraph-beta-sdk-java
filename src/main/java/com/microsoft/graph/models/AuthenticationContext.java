...
public class AuthenticationContext implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("detail", (n) -> { this.setDetail(n.getEnumValue(AuthenticationContextDetail::forValue)); });
