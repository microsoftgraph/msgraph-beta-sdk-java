...
public class DeviceManagementConfigurationReferredSettingInformation implements AdditionalDataHolder, Parsable {
    ...
    public DeviceManagementConfigurationReferredSettingInformation() {
        ...
        this.setOdataType("#microsoft.graph.deviceManagementConfigurationReferredSettingInformation");
    }
    /**
    ...
    public static DeviceManagementConfigurationReferredSettingInformation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementConfigurationReferredSettingInformation currentObject = this;
