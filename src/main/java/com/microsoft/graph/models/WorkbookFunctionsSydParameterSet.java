...
/**
 * The class for the Workbook Functions Syd Parameter Set.
 */
public class WorkbookFunctionsSydParameterSet {
    ...
    public static final class WorkbookFunctionsSydParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsSydParameterSetBuilder withCost(@Nullable final com.google.gson.JsonElement val) {
            this.cost = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsSydParameterSetBuilder withSalvage(@Nullable final com.google.gson.JsonElement val) {
            this.salvage = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsSydParameterSetBuilder withLife(@Nullable final com.google.gson.JsonElement val) {
            this.life = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsSydParameterSetBuilder withPer(@Nullable final com.google.gson.JsonElement val) {
            this.per = val;
            return this;
        }
        /**
