...
public class SharedAppleDeviceUser implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dataQuota", (n) -> { currentObject.setDataQuota(n.getLongValue()); });
        deserializerMap.put("dataToSync", (n) -> { currentObject.setDataToSync(n.getBooleanValue()); });
        deserializerMap.put("dataUsed", (n) -> { currentObject.setDataUsed(n.getLongValue()); });
