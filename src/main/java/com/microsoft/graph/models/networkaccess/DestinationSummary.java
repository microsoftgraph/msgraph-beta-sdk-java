...
public class DestinationSummary implements AdditionalDataHolder, Parsable {
    ...
    public static DestinationSummary createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDestination(@javax.annotation.Nullable final String value) {
