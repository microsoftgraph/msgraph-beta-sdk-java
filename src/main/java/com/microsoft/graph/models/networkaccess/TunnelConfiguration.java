...
public class TunnelConfiguration implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static TunnelConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
