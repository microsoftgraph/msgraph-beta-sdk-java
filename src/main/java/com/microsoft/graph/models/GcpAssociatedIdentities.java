...
public class GcpAssociatedIdentities implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The all property
     */
    private java.util.List<GcpIdentity> all;
    /**
     ...
     */
    private java.util.List<GcpServiceAccount> serviceAccounts;
    /**
     * The users property
     */
    private java.util.List<GcpUser> users;
    /**
     ...
     * @return a java.util.List<GcpIdentity>
     */
     ...
     * @return a java.util.List<GcpServiceAccount>
     */
    @jakarta.annotation.Nullable
     ...
     * @return a java.util.List<GcpUser>
     */
    @jakarta.annotation.Nullable
