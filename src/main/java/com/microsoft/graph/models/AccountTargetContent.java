...
public class AccountTargetContent implements AdditionalDataHolder, Parsable {
    ...
    public static AccountTargetContent createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final AccountTargetContentType value) {
        this.type = value;
    }
}
