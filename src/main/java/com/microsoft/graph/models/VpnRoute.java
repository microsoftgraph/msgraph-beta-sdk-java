...
public class VpnRoute implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("destinationPrefix", (n) -> { currentObject.setDestinationPrefix(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("prefixSize", (n) -> { currentObject.setPrefixSize(n.getIntegerValue()); });
