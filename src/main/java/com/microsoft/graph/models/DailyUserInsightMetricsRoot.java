...
import com.microsoft.graph.requests.DailyInactiveUsersMetricCollectionPage;
import com.microsoft.graph.requests.DailyInactiveUsersByApplicationMetricCollectionPage;
...
import com.microsoft.graph.requests.UserCountMetricCollectionPage;
...
/**
 * The class for the Daily User Insight Metrics Root.
 */
public class DailyUserInsightMetricsRoot extends Entity implements IJsonBackedObject {
     ...
     */
	@Nullable
    public com.microsoft.graph.requests.DailyInactiveUsersMetricCollectionPage inactiveUsers;
     ...
     */
	@Nullable
    public com.microsoft.graph.requests.DailyInactiveUsersByApplicationMetricCollectionPage inactiveUsersByApplication;
     ...
     */
	@Nullable
    public com.microsoft.graph.requests.UserCountMetricCollectionPage userCount;
    ...
    public void setRawObject(@Nonnull final ISerializer serializer, @Nonnull final JsonObject json) {
        ...
        if (json.has("inactiveUsers")) {
            inactiveUsers = serializer.deserializeObject(json.get("inactiveUsers"), com.microsoft.graph.requests.DailyInactiveUsersMetricCollectionPage.class);
        }

        if (json.has("inactiveUsersByApplication")) {
            inactiveUsersByApplication = serializer.deserializeObject(json.get("inactiveUsersByApplication"), com.microsoft.graph.requests.DailyInactiveUsersByApplicationMetricCollectionPage.class);
        }
        ...
        if (json.has("userCount")) {
            userCount = serializer.deserializeObject(json.get("userCount"), com.microsoft.graph.requests.UserCountMetricCollectionPage.class);
        }
    }
}
