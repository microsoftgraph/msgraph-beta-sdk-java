...
public class ConfigManagerCollection extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("collectionIdentifier", (n) -> { currentObject.setCollectionIdentifier(n.getStringValue()); });
        deserializerMap.put("createdDateTime", (n) -> { currentObject.setCreatedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("hierarchyIdentifier", (n) -> { currentObject.setHierarchyIdentifier(n.getStringValue()); });
        deserializerMap.put("hierarchyName", (n) -> { currentObject.setHierarchyName(n.getStringValue()); });
