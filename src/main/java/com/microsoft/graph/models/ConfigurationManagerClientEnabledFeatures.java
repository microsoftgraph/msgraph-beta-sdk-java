...
public class ConfigurationManagerClientEnabledFeatures implements AdditionalDataHolder, Parsable {
    ...
    private Boolean _endpointProtection;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endpointProtection", (n) -> { currentObject.setEndpointProtection(n.getBooleanValue()); });
        ...
        deserializerMap.put("officeApps", (n) -> { currentObject.setOfficeApps(n.getBooleanValue()); });
