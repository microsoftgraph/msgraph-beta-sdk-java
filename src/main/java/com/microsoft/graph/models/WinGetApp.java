...
public class WinGetApp extends MobileApp implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("installExperience", (n) -> { currentObject.setInstallExperience(n.getObjectValue(WinGetAppInstallExperience::createFromDiscriminatorValue)); });
        deserializerMap.put("manifestHash", (n) -> { currentObject.setManifestHash(n.getStringValue()); });
        deserializerMap.put("packageIdentifier", (n) -> { currentObject.setPackageIdentifier(n.getStringValue()); });
