...
/**
 * The class for the Tenant Attach RBACGet State Parameter Set.
 */
public class TenantAttachRBACGetStateParameterSet {

    /**
     * Instiaciates a new TenantAttachRBACGetStateParameterSet
     */
     ...
     */
    protected TenantAttachRBACGetStateParameterSet(@Nonnull final TenantAttachRBACGetStateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the TenantAttachRBACGetStateParameterSet
     */
    public static final class TenantAttachRBACGetStateParameterSetBuilder {
        /**
         * Instanciates a new TenantAttachRBACGetStateParameterSetBuilder
         */
        @Nullable
