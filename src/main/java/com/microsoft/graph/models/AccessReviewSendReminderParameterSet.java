...
/**
 * The class for the Access Review Send Reminder Parameter Set.
 */
public class AccessReviewSendReminderParameterSet {

    /**
     * Instiaciates a new AccessReviewSendReminderParameterSet
     */
     ...
     */
    protected AccessReviewSendReminderParameterSet(@Nonnull final AccessReviewSendReminderParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the AccessReviewSendReminderParameterSet
     */
    public static final class AccessReviewSendReminderParameterSetBuilder {
        /**
         * Instanciates a new AccessReviewSendReminderParameterSetBuilder
         */
        @Nullable
