...
public class AzureRoleDefinition extends Entity implements Parsable {
     ...
     */
    private java.util.List<String> assignableScopes;
    /**
     * The azureRoleDefinitionType property
     */
    private AzureRoleDefinitionType azureRoleDefinitionType;
    /**
    ...
    public AzureRoleDefinitionType getAzureRoleDefinitionType() {
        return this.azureRoleDefinitionType;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("azureRoleDefinitionType", (n) -> { this.setAzureRoleDefinitionType(n.getEnumValue(AzureRoleDefinitionType.class)); });
    ...
    public void setAzureRoleDefinitionType(@jakarta.annotation.Nullable final AzureRoleDefinitionType value) {
        this.azureRoleDefinitionType = value;
    }
    /**
