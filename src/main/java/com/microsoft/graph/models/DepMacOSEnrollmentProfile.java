...
public class DepMacOSEnrollmentProfile extends DepEnrollmentBaseProfile implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isLocalPrimaryAccount", (n) -> { this.setIsLocalPrimaryAccount(n.getBooleanValue()); });
        deserializerMap.put("isPrimaryUser", (n) -> { this.setIsPrimaryUser(n.getBooleanValue()); });
        deserializerMap.put("lockPrimaryAccountInfo", (n) -> { this.setLockPrimaryAccountInfo(n.getBooleanValue()); });
        deserializerMap.put("managedLocalUserShortName", (n) -> { this.setManagedLocalUserShortName(n.getBooleanValue()); });
        deserializerMap.put("passCodeDisabled", (n) -> { this.setPassCodeDisabled(n.getBooleanValue()); });
        deserializerMap.put("prefillAccountInfo", (n) -> { this.setPrefillAccountInfo(n.getBooleanValue()); });
        ...
        deserializerMap.put("primaryUser", (n) -> { this.setPrimaryUser(n.getStringValue()); });
        deserializerMap.put("primaryUserFullName", (n) -> { this.setPrimaryUserFullName(n.getStringValue()); });
