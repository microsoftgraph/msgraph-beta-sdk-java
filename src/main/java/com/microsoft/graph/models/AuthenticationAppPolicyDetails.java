...
public class AuthenticationAppPolicyDetails implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(5) {{
            this.put("adminConfiguration", (n) -> { currentObject.setAdminConfiguration(n.getEnumValue(AuthenticationAppAdminConfiguration.class)); });
            this.put("authenticationEvaluation", (n) -> { currentObject.setAuthenticationEvaluation(n.getEnumValue(AuthenticationAppEvaluation.class)); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("policyName", (n) -> { currentObject.setPolicyName(n.getStringValue()); });
            this.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(AuthenticationAppPolicyStatus.class)); });
        }};
    }
    /**
