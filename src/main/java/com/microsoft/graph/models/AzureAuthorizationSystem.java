...
public class AzureAuthorizationSystem extends AuthorizationSystem implements Parsable {
     ...
     */
    private java.util.List<AzureAuthorizationSystemTypeAction> actions;
    /**
     * The associatedIdentities property
     */
    private AzureAssociatedIdentities associatedIdentities;
    /**
     * The resources property
     */
    private java.util.List<AzureAuthorizationSystemResource> resources;
    /**
     * The roleDefinitions property
     */
    private java.util.List<AzureRoleDefinition> roleDefinitions;
    /**
     * The services property
     */
    private java.util.List<AuthorizationSystemTypeService> services;
    /**
