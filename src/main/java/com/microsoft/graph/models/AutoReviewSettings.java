...
public class AutoReviewSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static AutoReviewSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("notReviewedResult", (n) -> { this.setNotReviewedResult(n.getStringValue()); });
    ...
    public String getNotReviewedResult() {
        return this.backingStore.get("notReviewedResult");
    }
    /**
     ...
     */
    public void setNotReviewedResult(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("notReviewedResult", value);
    }
    /**
