...
public class PrintTask extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("definition", (n) -> { currentObject.setDefinition(n.getObjectValue(PrintTaskDefinition::createFromDiscriminatorValue)); });
        deserializerMap.put("parentUrl", (n) -> { currentObject.setParentUrl(n.getStringValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getObjectValue(PrintTaskStatus::createFromDiscriminatorValue)); });
        deserializerMap.put("trigger", (n) -> { currentObject.setTrigger(n.getObjectValue(PrintTaskTrigger::createFromDiscriminatorValue)); });
