...
public class DataClassificationService extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("classifyFileJobs", (n) -> { currentObject.setClassifyFileJobs(n.getCollectionOfObjectValues(JobResponseBase::createFromDiscriminatorValue)); });
        deserializerMap.put("classifyTextJobs", (n) -> { currentObject.setClassifyTextJobs(n.getCollectionOfObjectValues(JobResponseBase::createFromDiscriminatorValue)); });
        deserializerMap.put("evaluateDlpPoliciesJobs", (n) -> { currentObject.setEvaluateDlpPoliciesJobs(n.getCollectionOfObjectValues(JobResponseBase::createFromDiscriminatorValue)); });
        deserializerMap.put("evaluateLabelJobs", (n) -> { currentObject.setEvaluateLabelJobs(n.getCollectionOfObjectValues(JobResponseBase::createFromDiscriminatorValue)); });
        deserializerMap.put("exactMatchDataStores", (n) -> { currentObject.setExactMatchDataStores(n.getCollectionOfObjectValues(ExactMatchDataStore::createFromDiscriminatorValue)); });
        deserializerMap.put("exactMatchUploadAgents", (n) -> { currentObject.setExactMatchUploadAgents(n.getCollectionOfObjectValues(ExactMatchUploadAgent::createFromDiscriminatorValue)); });
        deserializerMap.put("jobs", (n) -> { currentObject.setJobs(n.getCollectionOfObjectValues(JobResponseBase::createFromDiscriminatorValue)); });
        deserializerMap.put("sensitiveTypes", (n) -> { currentObject.setSensitiveTypes(n.getCollectionOfObjectValues(SensitiveType::createFromDiscriminatorValue)); });
