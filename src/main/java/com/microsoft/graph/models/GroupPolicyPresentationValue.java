...
public class GroupPolicyPresentationValue extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("definitionValue", (n) -> { currentObject.setDefinitionValue(n.getObjectValue(GroupPolicyDefinitionValue::createFromDiscriminatorValue)); });
        deserializerMap.put("lastModifiedDateTime", (n) -> { currentObject.setLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("presentation", (n) -> { currentObject.setPresentation(n.getObjectValue(GroupPolicyPresentation::createFromDiscriminatorValue)); });
