...
public class WorkbookFunctionsDstDevPParameterSet {
    ...
    public static final class WorkbookFunctionsDstDevPParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPParameterSetBuilder withDatabase(@Nullable final com.google.gson.JsonElement val) {
            this.database = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPParameterSetBuilder withField(@Nullable final com.google.gson.JsonElement val) {
            this.field = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsDstDevPParameterSetBuilder withCriteria(@Nullable final com.google.gson.JsonElement val) {
            this.criteria = val;
            return this;
        }
        /**
