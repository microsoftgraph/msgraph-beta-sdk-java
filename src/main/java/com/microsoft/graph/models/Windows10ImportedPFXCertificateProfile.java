...
public class Windows10ImportedPFXCertificateProfile extends WindowsCertificateProfileBase implements Parsable {
    ...
    public static Windows10ImportedPFXCertificateProfile createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final Windows10ImportedPFXCertificateProfile currentObject = this;
