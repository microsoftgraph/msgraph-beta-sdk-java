...
/**
 * The class for the User Experience Analytics Device Timeline Events.
 */
public class UserExperienceAnalyticsDeviceTimelineEvents extends Entity implements IJsonBackedObject {
     ...
     */
    @SerializedName(value = "eventAdditionalInformation", alternate = {"EventAdditionalInformation"})
    @Expose
	@Nullable
