...
public class ComplianceManagementPartner extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("windowsEnrollmentAssignments", (n) -> { this.setWindowsEnrollmentAssignments(n.getCollectionOfObjectValues(ComplianceManagementPartnerAssignment::createFromDiscriminatorValue)); });
        deserializerMap.put("windowsOnboarded", (n) -> { this.setWindowsOnboarded(n.getBooleanValue()); });
