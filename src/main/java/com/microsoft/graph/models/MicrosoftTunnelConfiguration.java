...
public class MicrosoftTunnelConfiguration extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("advancedSettings", (n) -> { currentObject.setAdvancedSettings(n.getCollectionOfObjectValues(KeyValuePair::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultDomainSuffix", (n) -> { currentObject.setDefaultDomainSuffix(n.getStringValue()); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("disableUdpConnections", (n) -> { currentObject.setDisableUdpConnections(n.getBooleanValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("dnsServers", (n) -> { currentObject.setDnsServers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("lastUpdateDateTime", (n) -> { currentObject.setLastUpdateDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("listenPort", (n) -> { currentObject.setListenPort(n.getIntegerValue()); });
        deserializerMap.put("network", (n) -> { currentObject.setNetwork(n.getStringValue()); });
        deserializerMap.put("roleScopeTagIds", (n) -> { currentObject.setRoleScopeTagIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("routeExcludes", (n) -> { currentObject.setRouteExcludes(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("routeIncludes", (n) -> { currentObject.setRouteIncludes(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("routesExclude", (n) -> { currentObject.setRoutesExclude(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("routesInclude", (n) -> { currentObject.setRoutesInclude(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("splitDNS", (n) -> { currentObject.setSplitDNS(n.getCollectionOfPrimitiveValues(String.class)); });
