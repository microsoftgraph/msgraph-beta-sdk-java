...
public class MicrosoftTunnelConfiguration extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("routeExcludes", (n) -> { currentObject.setRouteExcludes(n.getCollectionOfPrimitiveValues(String.class)); });
            this.put("routeIncludes", (n) -> { currentObject.setRouteIncludes(n.getCollectionOfPrimitiveValues(String.class)); });
