...
public class SharePointOneDriveOptions implements AdditionalDataHolder, Parsable {
    ...
    private SearchContent _includeContent;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SharePointOneDriveOptions currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("includeContent", (n) -> { currentObject.setIncludeContent(n.getEnumValue(SearchContent.class)); });
