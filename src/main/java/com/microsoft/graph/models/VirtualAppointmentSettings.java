...
public class VirtualAppointmentSettings implements AdditionalDataHolder, Parsable {
     ...
     */
    private Boolean allowClientToJoinUsingBrowser;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowClientToJoinUsingBrowser", (n) -> { this.setAllowClientToJoinUsingBrowser(n.getBooleanValue()); });
