...
public class EntitlementsDataCollection extends EntitlementsDataCollectionInfo implements Parsable {
     ...
     */
    private OffsetDateTime lastCollectionDateTime;
    /**
     * The permissionsModificationCapability property
     */
    private PermissionsModificationCapability permissionsModificationCapability;
    /**
     * The status property
     */
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permissionsModificationCapability", (n) -> { this.setPermissionsModificationCapability(n.getEnumValue(PermissionsModificationCapability.class)); });
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(DataCollectionStatus.class)); });
    ...
    public OffsetDateTime getLastCollectionDateTime() {
        return this.lastCollectionDateTime;
    }
    /**
    ...
    public PermissionsModificationCapability getPermissionsModificationCapability() {
        return this.permissionsModificationCapability;
    }
    /**
    ...
    public void setLastCollectionDateTime(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.lastCollectionDateTime = value;
    }
    /**
    ...
    public void setPermissionsModificationCapability(@jakarta.annotation.Nullable final PermissionsModificationCapability value) {
        this.permissionsModificationCapability = value;
    }
    /**
