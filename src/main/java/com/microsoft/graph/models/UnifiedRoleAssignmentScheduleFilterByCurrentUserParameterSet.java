...
/**
 * The class for the Unified Role Assignment Schedule Filter By Current User Parameter Set.
 */
public class UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSet {
    ...
    /**
     * Instiaciates a new UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSet
     */
     ...
     */
    protected UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSet(@Nonnull final UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSetBuilder builder) {
        this.on = builder.on;
    }
    /**
    ...
    public static final class UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSetBuilder withOn(@Nullable final RoleAssignmentScheduleFilterByCurrentUserOptions val) {
            this.on = val;
            return this;
        }
        /**
         * Instanciates a new UnifiedRoleAssignmentScheduleFilterByCurrentUserParameterSetBuilder
         */
        @Nullable
