...
public class SessionLifetimePolicy implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("detail", (n) -> { currentObject.setDetail(n.getStringValue()); });
        deserializerMap.put("expirationRequirement", (n) -> { currentObject.setExpirationRequirement(n.getEnumValue(ExpirationRequirement.class)); });
