...
public class GroupPolicyDefinition extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("category", (n) -> { currentObject.setCategory(n.getObjectValue(GroupPolicyCategory::createFromDiscriminatorValue)); });
        deserializerMap.put("categoryPath", (n) -> { currentObject.setCategoryPath(n.getStringValue()); });
        deserializerMap.put("classType", (n) -> { currentObject.setClassType(n.getEnumValue(GroupPolicyDefinitionClassType.class)); });
        deserializerMap.put("definitionFile", (n) -> { currentObject.setDefinitionFile(n.getObjectValue(GroupPolicyDefinitionFile::createFromDiscriminatorValue)); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("explainText", (n) -> { currentObject.setExplainText(n.getStringValue()); });
        deserializerMap.put("groupPolicyCategoryId", (n) -> { currentObject.setGroupPolicyCategoryId(n.getStringValue()); });
        deserializerMap.put("hasRelatedDefinitions", (n) -> { currentObject.setHasRelatedDefinitions(n.getBooleanValue()); });
        deserializerMap.put("lastModifiedDateTime", (n) -> { currentObject.setLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("minDeviceCspVersion", (n) -> { currentObject.setMinDeviceCspVersion(n.getStringValue()); });
        deserializerMap.put("minUserCspVersion", (n) -> { currentObject.setMinUserCspVersion(n.getStringValue()); });
        deserializerMap.put("nextVersionDefinition", (n) -> { currentObject.setNextVersionDefinition(n.getObjectValue(GroupPolicyDefinition::createFromDiscriminatorValue)); });
        deserializerMap.put("policyType", (n) -> { currentObject.setPolicyType(n.getEnumValue(GroupPolicyType.class)); });
        deserializerMap.put("presentations", (n) -> { currentObject.setPresentations(n.getCollectionOfObjectValues(GroupPolicyPresentation::createFromDiscriminatorValue)); });
        deserializerMap.put("previousVersionDefinition", (n) -> { currentObject.setPreviousVersionDefinition(n.getObjectValue(GroupPolicyDefinition::createFromDiscriminatorValue)); });
        deserializerMap.put("supportedOn", (n) -> { currentObject.setSupportedOn(n.getStringValue()); });
