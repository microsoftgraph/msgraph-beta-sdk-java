...
public class RemoteAssistanceSettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowSessionsToUnenrolledDevices", (n) -> { currentObject.setAllowSessionsToUnenrolledDevices(n.getBooleanValue()); });
        deserializerMap.put("blockChat", (n) -> { currentObject.setBlockChat(n.getBooleanValue()); });
        deserializerMap.put("remoteAssistanceState", (n) -> { currentObject.setRemoteAssistanceState(n.getEnumValue(RemoteAssistanceState.class)); });
