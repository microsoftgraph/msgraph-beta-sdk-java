...
public class WindowsUpdateRolloutSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("offerEndDateTimeInUTC", (n) -> { currentObject.setOfferEndDateTimeInUTC(n.getOffsetDateTimeValue()); });
        deserializerMap.put("offerIntervalInDays", (n) -> { currentObject.setOfferIntervalInDays(n.getIntegerValue()); });
        deserializerMap.put("offerStartDateTimeInUTC", (n) -> { currentObject.setOfferStartDateTimeInUTC(n.getOffsetDateTimeValue()); });
