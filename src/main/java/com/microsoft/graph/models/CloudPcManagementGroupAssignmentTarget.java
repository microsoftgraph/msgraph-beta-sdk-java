...
/**
 * The class for the Cloud Pc Management Group Assignment Target.
 */
public class CloudPcManagementGroupAssignmentTarget extends CloudPcManagementAssignmentTarget implements IJsonBackedObject {
