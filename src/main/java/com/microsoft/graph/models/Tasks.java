...
public class Tasks extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alltasks", (n) -> { currentObject.setAlltasks(n.getCollectionOfObjectValues(BaseTask::createFromDiscriminatorValue)); });
        deserializerMap.put("lists", (n) -> { currentObject.setLists(n.getCollectionOfObjectValues(BaseTaskList::createFromDiscriminatorValue)); });
