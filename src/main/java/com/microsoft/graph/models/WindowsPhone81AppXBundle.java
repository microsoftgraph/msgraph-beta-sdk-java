...
public class WindowsPhone81AppXBundle extends WindowsPhone81AppX implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("appXPackageInformationList", (n) -> { currentObject.setAppXPackageInformationList(n.getCollectionOfObjectValues(WindowsPackageInformation::createFromDiscriminatorValue)); });
