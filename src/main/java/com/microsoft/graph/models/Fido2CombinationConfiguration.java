...
public class Fido2CombinationConfiguration extends AuthenticationCombinationConfiguration implements Parsable {
    ...
    private java.util.List<String> _allowedAAGUIDs;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final Fido2CombinationConfiguration currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("allowedAAGUIDs", (n) -> { currentObject.setAllowedAAGUIDs(n.getCollectionOfPrimitiveValues(String.class)); });
