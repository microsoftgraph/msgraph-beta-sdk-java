...
public class OfficeSuiteApp extends MobileApp implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("autoAcceptEula", (n) -> { currentObject.setAutoAcceptEula(n.getBooleanValue()); });
        deserializerMap.put("excludedApps", (n) -> { currentObject.setExcludedApps(n.getObjectValue(ExcludedApps::createFromDiscriminatorValue)); });
        deserializerMap.put("installProgressDisplayLevel", (n) -> { currentObject.setInstallProgressDisplayLevel(n.getEnumValue(OfficeSuiteInstallProgressDisplayLevel.class)); });
        deserializerMap.put("localesToInstall", (n) -> { currentObject.setLocalesToInstall(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("officeConfigurationXml", (n) -> { currentObject.setOfficeConfigurationXml(n.getByteArrayValue()); });
        deserializerMap.put("officePlatformArchitecture", (n) -> { currentObject.setOfficePlatformArchitecture(n.getEnumValue(WindowsArchitecture.class)); });
        deserializerMap.put("officeSuiteAppDefaultFileFormat", (n) -> { currentObject.setOfficeSuiteAppDefaultFileFormat(n.getEnumValue(OfficeSuiteDefaultFileFormatType.class)); });
        deserializerMap.put("productIds", (n) -> { currentObject.setProductIds(n.getCollectionOfEnumValues(OfficeProductId.class)); });
        deserializerMap.put("shouldUninstallOlderVersionsOfOffice", (n) -> { currentObject.setShouldUninstallOlderVersionsOfOffice(n.getBooleanValue()); });
        deserializerMap.put("targetVersion", (n) -> { currentObject.setTargetVersion(n.getStringValue()); });
        deserializerMap.put("updateChannel", (n) -> { currentObject.setUpdateChannel(n.getEnumValue(OfficeUpdateChannel.class)); });
        deserializerMap.put("updateVersion", (n) -> { currentObject.setUpdateVersion(n.getStringValue()); });
        deserializerMap.put("useSharedComputerActivation", (n) -> { currentObject.setUseSharedComputerActivation(n.getBooleanValue()); });
