...
public class NumberRange implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lowerNumber", (n) -> { currentObject.setLowerNumber(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("upperNumber", (n) -> { currentObject.setUpperNumber(n.getIntegerValue()); });
