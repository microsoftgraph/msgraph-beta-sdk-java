...
/**
 * The class for the Education Module Unpin Parameter Set.
 */
public class EducationModuleUnpinParameterSet {

    /**
     * Instiaciates a new EducationModuleUnpinParameterSet
     */
     ...
     */
    protected EducationModuleUnpinParameterSet(@Nonnull final EducationModuleUnpinParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EducationModuleUnpinParameterSet
     */
    public static final class EducationModuleUnpinParameterSetBuilder {
        /**
         * Instanciates a new EducationModuleUnpinParameterSetBuilder
         */
        @Nullable
