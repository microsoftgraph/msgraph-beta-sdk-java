...
public class EmployeeExperience implements AdditionalDataHolder, Parsable {
    ...
    public static EmployeeExperience createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("learningProviders", (n) -> { currentObject.setLearningProviders(n.getCollectionOfObjectValues(LearningProvider::createFromDiscriminatorValue)); });
