...
public class UsageRight extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("serviceIdentifier", (n) -> { currentObject.setServiceIdentifier(n.getStringValue()); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(UsageRightState.class)); });
