 ...
 * Setting Insights
 */
public class DeviceManagementSettingInsightsDefinition implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DeviceManagementConfigurationSettingValue settingInsight;
    /**
    ...
    public static DeviceManagementSettingInsightsDefinition createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSettingInsight(@javax.annotation.Nullable final DeviceManagementConfigurationSettingValue value) {
        this.settingInsight = value;
    }
}
