...
public class SensitivityPolicySettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("downgradeSensitivityRequiresJustification", (n) -> { currentObject.setDowngradeSensitivityRequiresJustification(n.getBooleanValue()); });
        deserializerMap.put("helpWebUrl", (n) -> { currentObject.setHelpWebUrl(n.getStringValue()); });
