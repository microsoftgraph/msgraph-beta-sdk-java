...
public class LocalAdminPasswordSettings implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static LocalAdminPasswordSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
