...
public class CloudPcUserRoleScopeTagInfo implements AdditionalDataHolder, Parsable {
    ...
    public static CloudPcUserRoleScopeTagInfo createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CloudPcUserRoleScopeTagInfo currentObject = this;
