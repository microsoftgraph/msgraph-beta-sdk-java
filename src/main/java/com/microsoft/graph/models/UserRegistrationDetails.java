...
public class UserRegistrationDetails extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("defaultMfaMethod", (n) -> { currentObject.setDefaultMfaMethod(n.getEnumValue(DefaultMfaMethodType.class)); });
        deserializerMap.put("isAdmin", (n) -> { currentObject.setIsAdmin(n.getBooleanValue()); });
        deserializerMap.put("isMfaCapable", (n) -> { currentObject.setIsMfaCapable(n.getBooleanValue()); });
        deserializerMap.put("isMfaRegistered", (n) -> { currentObject.setIsMfaRegistered(n.getBooleanValue()); });
        deserializerMap.put("isPasswordlessCapable", (n) -> { currentObject.setIsPasswordlessCapable(n.getBooleanValue()); });
        deserializerMap.put("isSsprCapable", (n) -> { currentObject.setIsSsprCapable(n.getBooleanValue()); });
        deserializerMap.put("isSsprEnabled", (n) -> { currentObject.setIsSsprEnabled(n.getBooleanValue()); });
        deserializerMap.put("isSsprRegistered", (n) -> { currentObject.setIsSsprRegistered(n.getBooleanValue()); });
        deserializerMap.put("methodsRegistered", (n) -> { currentObject.setMethodsRegistered(n.getCollectionOfPrimitiveValues(String.class)); });
