...
/**
 * The class for the Stale Sign In Alert Incident.
 */
public class StaleSignInAlertIncident extends UnifiedRoleManagementAlertIncident implements IJsonBackedObject {
