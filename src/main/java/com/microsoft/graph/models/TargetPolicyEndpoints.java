...
public class TargetPolicyEndpoints implements AdditionalDataHolder, Parsable {
    ...
    public TargetPolicyEndpoints() {
        ...
        this.setOdataType("#microsoft.graph.targetPolicyEndpoints");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("platformTypes", (n) -> { currentObject.setPlatformTypes(n.getCollectionOfPrimitiveValues(String.class)); });
