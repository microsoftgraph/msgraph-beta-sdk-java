...
/**
 * The class for the Invalid License Alert Incident.
 */
public class InvalidLicenseAlertIncident extends UnifiedRoleManagementAlertIncident implements IJsonBackedObject {
