...
public class SingleValueLegacyExtendedPropertyCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
     ...
     * @return a SingleValueLegacyExtendedPropertyCollectionResponse
     */
    @javax.annotation.Nonnull
    public static SingleValueLegacyExtendedPropertyCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SingleValueLegacyExtendedPropertyCollectionResponse currentObject = this;
