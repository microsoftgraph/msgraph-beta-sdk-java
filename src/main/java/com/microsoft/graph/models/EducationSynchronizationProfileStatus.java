...
public class EducationSynchronizationProfileStatus extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errorCount", (n) -> { currentObject.setErrorCount(n.getLongValue()); });
        deserializerMap.put("lastActivityDateTime", (n) -> { currentObject.setLastActivityDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("lastSynchronizationDateTime", (n) -> { currentObject.setLastSynchronizationDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(EducationSynchronizationStatus.class)); });
