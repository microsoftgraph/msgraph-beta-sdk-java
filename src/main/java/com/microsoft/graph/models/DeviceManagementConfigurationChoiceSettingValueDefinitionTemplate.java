...
public class DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedOptions", (n) -> { currentObject.setAllowedOptions(n.getCollectionOfObjectValues(DeviceManagementConfigurationOptionDefinitionTemplate::createFromDiscriminatorValue)); });
