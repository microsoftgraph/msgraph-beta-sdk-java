...
import com.microsoft.graph.models.PlannerExternalBucketSource;
...
public class PlannerBucketCreation implements AdditionalDataHolder, Parsable {
    ...
    public static PlannerBucketCreation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        final ParseNode mappingValueNode = parseNode.getChildNode("@odata.type");
        if (mappingValueNode != null) {
            final String mappingValue = mappingValueNode.getStringValue();
            switch (mappingValue) {
                case "#microsoft.graph.plannerExternalBucketSource": return new PlannerExternalBucketSource();
            }
        }
