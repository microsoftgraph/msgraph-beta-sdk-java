...
public class CloudPcManagementAssignmentTarget implements AdditionalDataHolder, Parsable {
    ...
    public CloudPcManagementAssignmentTarget() {
        ...
        this.setOdataType("#microsoft.graph.cloudPcManagementAssignmentTarget");
    }
    /**
    ...
    public static CloudPcManagementAssignmentTarget createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CloudPcManagementAssignmentTarget currentObject = this;
