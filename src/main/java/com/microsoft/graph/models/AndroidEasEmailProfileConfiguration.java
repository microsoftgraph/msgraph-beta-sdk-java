...
public class AndroidEasEmailProfileConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customDomainName", (n) -> { currentObject.setCustomDomainName(n.getStringValue()); });
        ...
        deserializerMap.put("smimeSigningCertificate", (n) -> { currentObject.setSmimeSigningCertificate(n.getObjectValue(AndroidCertificateProfileBase::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("syncNotes", (n) -> { currentObject.setSyncNotes(n.getBooleanValue()); });
        deserializerMap.put("syncTasks", (n) -> { currentObject.setSyncTasks(n.getBooleanValue()); });
        deserializerMap.put("userDomainNameSource", (n) -> { currentObject.setUserDomainNameSource(n.getEnumValue(DomainNameSource.class)); });
