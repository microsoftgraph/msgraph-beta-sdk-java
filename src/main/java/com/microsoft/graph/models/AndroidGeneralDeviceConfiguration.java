...
public class AndroidGeneralDeviceConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Boolean getDateAndTimeBlockChanges() {
        return this.backingStore.get("dateAndTimeBlockChanges");
    }
    /**
     ...
     */
    public void setDateAndTimeBlockChanges(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("dateAndTimeBlockChanges", value);
    }
    /**
