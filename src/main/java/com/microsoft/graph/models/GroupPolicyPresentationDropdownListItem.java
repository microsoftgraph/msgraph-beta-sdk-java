...
public class GroupPolicyPresentationDropdownListItem implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static GroupPolicyPresentationDropdownListItem createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
