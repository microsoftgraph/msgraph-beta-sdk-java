...
public class TriggerAndScopeBasedConditions extends WorkflowExecutionConditions implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("scope", (n) -> { currentObject.setScope(n.getObjectValue(SubjectSet::createFromDiscriminatorValue)); });
        deserializerMap.put("trigger", (n) -> { currentObject.setTrigger(n.getObjectValue(WorkflowExecutionTrigger::createFromDiscriminatorValue)); });
