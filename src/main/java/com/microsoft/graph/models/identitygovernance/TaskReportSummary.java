...
public class TaskReportSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("failedTasks", (n) -> { currentObject.setFailedTasks(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("successfulTasks", (n) -> { currentObject.setSuccessfulTasks(n.getIntegerValue()); });
        deserializerMap.put("totalTasks", (n) -> { currentObject.setTotalTasks(n.getIntegerValue()); });
        deserializerMap.put("unprocessedTasks", (n) -> { currentObject.setUnprocessedTasks(n.getIntegerValue()); });
