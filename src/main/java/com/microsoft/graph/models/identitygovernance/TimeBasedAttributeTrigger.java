...
public class TimeBasedAttributeTrigger extends WorkflowExecutionTrigger implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("offsetInDays", (n) -> { currentObject.setOffsetInDays(n.getIntegerValue()); });
        deserializerMap.put("timeBasedAttribute", (n) -> { currentObject.setTimeBasedAttribute(n.getEnumValue(WorkflowTriggerTimeBasedAttribute.class)); });
