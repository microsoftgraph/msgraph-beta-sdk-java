...
public class UserProcessingResult extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("failedTasksCount", (n) -> { currentObject.setFailedTasksCount(n.getIntegerValue()); });
        deserializerMap.put("processingStatus", (n) -> { currentObject.setProcessingStatus(n.getEnumValue(LifecycleWorkflowProcessingStatus.class)); });
        deserializerMap.put("scheduledDateTime", (n) -> { currentObject.setScheduledDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("totalTasksCount", (n) -> { currentObject.setTotalTasksCount(n.getIntegerValue()); });
        deserializerMap.put("totalUnprocessedTasksCount", (n) -> { currentObject.setTotalUnprocessedTasksCount(n.getIntegerValue()); });
        deserializerMap.put("workflowExecutionType", (n) -> { currentObject.setWorkflowExecutionType(n.getEnumValue(WorkflowExecutionType.class)); });
        deserializerMap.put("workflowVersion", (n) -> { currentObject.setWorkflowVersion(n.getIntegerValue()); });
