...
public class RunSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("failedRuns", (n) -> { currentObject.setFailedRuns(n.getIntegerValue()); });
        deserializerMap.put("failedTasks", (n) -> { currentObject.setFailedTasks(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("successfulRuns", (n) -> { currentObject.setSuccessfulRuns(n.getIntegerValue()); });
        deserializerMap.put("totalRuns", (n) -> { currentObject.setTotalRuns(n.getIntegerValue()); });
        deserializerMap.put("totalTasks", (n) -> { currentObject.setTotalTasks(n.getIntegerValue()); });
        deserializerMap.put("totalUsers", (n) -> { currentObject.setTotalUsers(n.getIntegerValue()); });
