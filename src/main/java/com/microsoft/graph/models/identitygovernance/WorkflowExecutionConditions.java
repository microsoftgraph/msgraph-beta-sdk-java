...
import com.microsoft.graph.models.identitygovernance.OnDemandExecutionOnly;
...
public class WorkflowExecutionConditions implements AdditionalDataHolder, Parsable {
    ...
    public WorkflowExecutionConditions() {
        ...
        this.setOdataType("#microsoft.graph.identityGovernance.workflowExecutionConditions");
    }
    /**
    ...
    public static WorkflowExecutionConditions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final WorkflowExecutionConditions currentObject = this;
