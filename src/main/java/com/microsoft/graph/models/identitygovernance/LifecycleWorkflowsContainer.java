...
public class LifecycleWorkflowsContainer extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customTaskExtensions", (n) -> { currentObject.setCustomTaskExtensions(n.getCollectionOfObjectValues(CustomTaskExtension::createFromDiscriminatorValue)); });
        deserializerMap.put("deletedItems", (n) -> { currentObject.setDeletedItems(n.getObjectValue(DeletedItemContainer::createFromDiscriminatorValue)); });
        deserializerMap.put("settings", (n) -> { currentObject.setSettings(n.getObjectValue(LifecycleManagementSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("taskDefinitions", (n) -> { currentObject.setTaskDefinitions(n.getCollectionOfObjectValues(TaskDefinition::createFromDiscriminatorValue)); });
        deserializerMap.put("workflows", (n) -> { currentObject.setWorkflows(n.getCollectionOfObjectValues(Workflow::createFromDiscriminatorValue)); });
        deserializerMap.put("workflowTemplates", (n) -> { currentObject.setWorkflowTemplates(n.getCollectionOfObjectValues(WorkflowTemplate::createFromDiscriminatorValue)); });
