...
public class UserSummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("failedUsers", (n) -> { currentObject.setFailedUsers(n.getIntegerValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("successfulUsers", (n) -> { currentObject.setSuccessfulUsers(n.getIntegerValue()); });
