...
public class TaskReport extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("failedUsersCount", (n) -> { currentObject.setFailedUsersCount(n.getIntegerValue()); });
        ...
        deserializerMap.put("runId", (n) -> { currentObject.setRunId(n.getStringValue()); });
        deserializerMap.put("startedDateTime", (n) -> { currentObject.setStartedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("successfulUsersCount", (n) -> { currentObject.setSuccessfulUsersCount(n.getIntegerValue()); });
        deserializerMap.put("task", (n) -> { currentObject.setTask(n.getObjectValue(Task::createFromDiscriminatorValue)); });
        deserializerMap.put("taskDefinition", (n) -> { currentObject.setTaskDefinition(n.getObjectValue(TaskDefinition::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("totalUsersCount", (n) -> { currentObject.setTotalUsersCount(n.getIntegerValue()); });
        deserializerMap.put("unprocessedUsersCount", (n) -> { currentObject.setUnprocessedUsersCount(n.getIntegerValue()); });
