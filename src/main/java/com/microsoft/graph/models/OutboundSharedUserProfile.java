...
public class OutboundSharedUserProfile implements AdditionalDataHolder, Parsable {
    ...
    public OutboundSharedUserProfile() {
        ...
        this.setOdataType("#microsoft.graph.outboundSharedUserProfile");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tenants", (n) -> { currentObject.setTenants(n.getCollectionOfObjectValues(TenantReference::createFromDiscriminatorValue)); });
