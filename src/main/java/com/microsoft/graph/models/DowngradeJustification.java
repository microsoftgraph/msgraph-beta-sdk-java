...
public class DowngradeJustification implements AdditionalDataHolder, Parsable {
    ...
    public DowngradeJustification() {
        ...
        this.setOdataType("#microsoft.graph.downgradeJustification");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isDowngradeJustified", (n) -> { currentObject.setIsDowngradeJustified(n.getBooleanValue()); });
        deserializerMap.put("justificationMessage", (n) -> { currentObject.setJustificationMessage(n.getStringValue()); });
