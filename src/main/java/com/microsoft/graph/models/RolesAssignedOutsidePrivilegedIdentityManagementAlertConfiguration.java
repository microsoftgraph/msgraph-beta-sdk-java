...
public class RolesAssignedOutsidePrivilegedIdentityManagementAlertConfiguration extends UnifiedRoleManagementAlertConfiguration implements Parsable {
    ...
    public static RolesAssignedOutsidePrivilegedIdentityManagementAlertConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
