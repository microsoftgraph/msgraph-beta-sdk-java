...
/**
 * The class for the Cloud PCGet Cloud Pc Connectivity History Parameter Set.
 */
public class CloudPCGetCloudPcConnectivityHistoryParameterSet {

    /**
     * Instiaciates a new CloudPCGetCloudPcConnectivityHistoryParameterSet
     */
     ...
     */
    protected CloudPCGetCloudPcConnectivityHistoryParameterSet(@Nonnull final CloudPCGetCloudPcConnectivityHistoryParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the CloudPCGetCloudPcConnectivityHistoryParameterSet
     */
    public static final class CloudPCGetCloudPcConnectivityHistoryParameterSetBuilder {
        /**
         * Instanciates a new CloudPCGetCloudPcConnectivityHistoryParameterSetBuilder
         */
        @Nullable
