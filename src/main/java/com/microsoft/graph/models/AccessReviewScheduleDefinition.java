...
public class AccessReviewScheduleDefinition extends Entity implements Parsable {
    ...
    private java.util.List<AccessReviewReviewerScope> _backupReviewers;
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<AccessReviewReviewerScope> getBackupReviewers() {
        return this._backupReviewers;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("backupReviewers", (n) -> { currentObject.setBackupReviewers(n.getCollectionOfObjectValues(AccessReviewReviewerScope::createFromDiscriminatorValue)); });
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfObjectValues("backupReviewers", this.getBackupReviewers());
     ...
     */
    @javax.annotation.Nonnull
    public void setBackupReviewers(@javax.annotation.Nullable final java.util.List<AccessReviewReviewerScope> value) {
        this._backupReviewers = value;
    }
    /**
