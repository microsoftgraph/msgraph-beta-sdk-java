...
public class ApplicationTemplate extends Entity implements Parsable {
    ...
    private InformationalUrls _informationalUrls;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("informationalUrls", (n) -> { currentObject.setInformationalUrls(n.getObjectValue(InformationalUrls::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("supportedClaimConfiguration", (n) -> { currentObject.setSupportedClaimConfiguration(n.getObjectValue(SupportedClaimConfiguration::createFromDiscriminatorValue)); });
    ...
    public InformationalUrls getInformationalUrls() {
        return this._informationalUrls;
    }
    /**
