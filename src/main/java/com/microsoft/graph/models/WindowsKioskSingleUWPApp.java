...
public class WindowsKioskSingleUWPApp extends WindowsKioskAppConfiguration implements Parsable {
    /** The uwpApp property */
    private WindowsKioskUWPApp _uwpApp;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("uwpApp", (n) -> { currentObject.setUwpApp(n.getObjectValue(WindowsKioskUWPApp::createFromDiscriminatorValue)); });
