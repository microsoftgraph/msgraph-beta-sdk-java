...
public class FilterOperatorSchemaCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FilterOperatorSchemaCollectionResponse currentObject = this;
