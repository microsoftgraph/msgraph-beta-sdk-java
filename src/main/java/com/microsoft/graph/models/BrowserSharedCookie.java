...
public class BrowserSharedCookie extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("history", (n) -> { currentObject.setHistory(n.getCollectionOfObjectValues(BrowserSharedCookieHistory::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(BrowserSharedCookieStatus.class)); });
