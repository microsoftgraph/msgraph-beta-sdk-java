...
public class BrowserSharedCookie extends Entity implements Parsable {
    ...
    private java.util.List<BrowserSharedCookieHistory> _history;
    ...
    /** The status property */
    private BrowserSharedCookieStatus _status;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final BrowserSharedCookie currentObject = this;
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("history", (n) -> { currentObject.setHistory(n.getCollectionOfObjectValues(BrowserSharedCookieHistory::createFromDiscriminatorValue)); });
            this.put("hostOnly", (n) -> { currentObject.setHostOnly(n.getBooleanValue()); });
            this.put("hostOrDomain", (n) -> { currentObject.setHostOrDomain(n.getStringValue()); });
            ...
            this.put("sourceEnvironment", (n) -> { currentObject.setSourceEnvironment(n.getEnumValue(BrowserSharedCookieSourceEnvironment.class)); });
            this.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(BrowserSharedCookieStatus.class)); });
        }};
    }
    /**
