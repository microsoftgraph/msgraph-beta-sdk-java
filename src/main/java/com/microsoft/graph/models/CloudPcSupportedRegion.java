...
public class CloudPcSupportedRegion extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("regionStatus", (n) -> { currentObject.setRegionStatus(n.getEnumValue(CloudPcSupportedRegionStatus.class)); });
        deserializerMap.put("supportedSolution", (n) -> { currentObject.setSupportedSolution(n.getEnumValue(CloudPcManagementService.class)); });
