...
public class TranslationPreferences implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("languageOverrides", (n) -> { currentObject.setLanguageOverrides(n.getCollectionOfObjectValues(TranslationLanguageOverride::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("untranslatedLanguages", (n) -> { currentObject.setUntranslatedLanguages(n.getCollectionOfPrimitiveValues(String.class)); });
