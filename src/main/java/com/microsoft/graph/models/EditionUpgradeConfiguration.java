...
public class EditionUpgradeConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("license", (n) -> { currentObject.setLicense(n.getStringValue()); });
        deserializerMap.put("licenseType", (n) -> { currentObject.setLicenseType(n.getEnumValue(EditionUpgradeLicenseType.class)); });
        deserializerMap.put("productKey", (n) -> { currentObject.setProductKey(n.getStringValue()); });
        deserializerMap.put("targetEdition", (n) -> { currentObject.setTargetEdition(n.getEnumValue(Windows10EditionType.class)); });
        deserializerMap.put("windowsSMode", (n) -> { currentObject.setWindowsSMode(n.getEnumValue(WindowsSModeConfiguration.class)); });
