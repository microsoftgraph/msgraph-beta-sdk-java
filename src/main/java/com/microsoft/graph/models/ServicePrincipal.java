...
public class ServicePrincipal extends DirectoryObject implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errorUrl", (n) -> { currentObject.setErrorUrl(n.getStringValue()); });
        ...
        deserializerMap.put("passwordSingleSignOnSettings", (n) -> { currentObject.setPasswordSingleSignOnSettings(n.getObjectValue(PasswordSingleSignOnSettings::createFromDiscriminatorValue)); });
        deserializerMap.put("preferredSingleSignOnMode", (n) -> { currentObject.setPreferredSingleSignOnMode(n.getStringValue()); });
        deserializerMap.put("preferredTokenSigningKeyEndDateTime", (n) -> { currentObject.setPreferredTokenSigningKeyEndDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("publishedPermissionScopes", (n) -> { currentObject.setPublishedPermissionScopes(n.getCollectionOfObjectValues(PermissionScope::createFromDiscriminatorValue)); });
