...
public class SmsAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable {
    ...
    private java.util.List<SmsAuthenticationMethodTarget> _includeTargets;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("includeTargets", (n) -> { currentObject.setIncludeTargets(n.getCollectionOfObjectValues(SmsAuthenticationMethodTarget::createFromDiscriminatorValue)); });
