...
public class VerifiableCredentialType implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static VerifiableCredentialType createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCredentialType(@javax.annotation.Nullable final String value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIssuers(@javax.annotation.Nullable final java.util.List<String> value) {
        this.issuers = value;
    }
    /**
