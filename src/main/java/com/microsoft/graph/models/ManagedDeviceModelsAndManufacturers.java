...
public class ManagedDeviceModelsAndManufacturers implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static ManagedDeviceModelsAndManufacturers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<String> getDeviceManufacturers() {
        return this.backingStore.get("deviceManufacturers");
    }
    /**
    ...
    public java.util.List<String> getDeviceModels() {
        return this.backingStore.get("deviceModels");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceManufacturers", (n) -> { this.setDeviceManufacturers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("deviceModels", (n) -> { this.setDeviceModels(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setDeviceManufacturers(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("deviceManufacturers", value);
    }
    /**
     ...
     */
    public void setDeviceModels(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("deviceModels", value);
    }
    /**
