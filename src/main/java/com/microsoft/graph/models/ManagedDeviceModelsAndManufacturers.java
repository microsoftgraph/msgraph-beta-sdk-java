...
public class ManagedDeviceModelsAndManufacturers implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceManufacturers", (n) -> { currentObject.setDeviceManufacturers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("deviceModels", (n) -> { currentObject.setDeviceModels(n.getCollectionOfPrimitiveValues(String.class)); });
