...
import com.microsoft.graph.models.SubjectRightsRequestAllSiteLocation;
...
public class SubjectRightsRequestSiteLocation implements AdditionalDataHolder, Parsable {
    ...
    public SubjectRightsRequestSiteLocation() {
        ...
        this.setOdataType("#microsoft.graph.subjectRightsRequestSiteLocation");
    }
    /**
    ...
    public static SubjectRightsRequestSiteLocation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SubjectRightsRequestSiteLocation currentObject = this;
