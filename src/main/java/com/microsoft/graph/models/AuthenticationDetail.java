...
public class AuthenticationDetail implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationMethodDetail", (n) -> { currentObject.setAuthenticationMethodDetail(n.getStringValue()); });
        deserializerMap.put("authenticationStepDateTime", (n) -> { currentObject.setAuthenticationStepDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("authenticationStepRequirement", (n) -> { currentObject.setAuthenticationStepRequirement(n.getStringValue()); });
        deserializerMap.put("authenticationStepResultDetail", (n) -> { currentObject.setAuthenticationStepResultDetail(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("succeeded", (n) -> { currentObject.setSucceeded(n.getBooleanValue()); });
