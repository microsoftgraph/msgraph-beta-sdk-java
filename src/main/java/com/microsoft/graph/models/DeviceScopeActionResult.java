...
public class DeviceScopeActionResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceScopeAction", (n) -> { currentObject.setDeviceScopeAction(n.getStringValue()); });
        deserializerMap.put("deviceScopeId", (n) -> { currentObject.setDeviceScopeId(n.getStringValue()); });
        deserializerMap.put("failedMessage", (n) -> { currentObject.setFailedMessage(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(DeviceScopeActionStatus.class)); });
