...
public class Windows10XVpnConfiguration extends DeviceManagementResourceAccessProfileBase implements Parsable {
    ...
    public static Windows10XVpnConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationCertificateId", (n) -> { currentObject.setAuthenticationCertificateId(n.getStringValue()); });
        deserializerMap.put("customXml", (n) -> { currentObject.setCustomXml(n.getByteArrayValue()); });
        deserializerMap.put("customXmlFileName", (n) -> { currentObject.setCustomXmlFileName(n.getStringValue()); });
