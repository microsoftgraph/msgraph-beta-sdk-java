...
/**
 * The class for the Sales Invoice Send Parameter Set.
 */
public class SalesInvoiceSendParameterSet {

    /**
     * Instiaciates a new SalesInvoiceSendParameterSet
     */
     ...
     */
    protected SalesInvoiceSendParameterSet(@Nonnull final SalesInvoiceSendParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the SalesInvoiceSendParameterSet
     */
    public static final class SalesInvoiceSendParameterSetBuilder {
        /**
         * Instanciates a new SalesInvoiceSendParameterSetBuilder
         */
        @Nullable
