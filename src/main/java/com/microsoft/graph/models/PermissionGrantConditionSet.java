...
public class PermissionGrantConditionSet extends Entity implements Parsable {
    ...
    public Boolean getCertifiedClientApplicationsOnly() {
        return this._certifiedClientApplicationsOnly;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("certifiedClientApplicationsOnly", (n) -> { currentObject.setCertifiedClientApplicationsOnly(n.getBooleanValue()); });
