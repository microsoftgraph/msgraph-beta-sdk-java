...
public class BaseEndUserNotification implements AdditionalDataHolder, Parsable {
    ...
    public static BaseEndUserNotification createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndUserNotification(@javax.annotation.Nullable final EndUserNotification value) {
