...
public class Office365GroupsActivityCounts extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exchangeEmailsReceived", (n) -> { currentObject.setExchangeEmailsReceived(n.getLongValue()); });
        ...
        deserializerMap.put("yammerMessagesLiked", (n) -> { currentObject.setYammerMessagesLiked(n.getLongValue()); });
        deserializerMap.put("yammerMessagesPosted", (n) -> { currentObject.setYammerMessagesPosted(n.getLongValue()); });
        deserializerMap.put("yammerMessagesRead", (n) -> { currentObject.setYammerMessagesRead(n.getLongValue()); });
