...
public class TeamsAppDefinition extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedInstallationScopes", (n) -> { currentObject.setAllowedInstallationScopes(n.getEnumValue(TeamsAppInstallationScopes.class)); });
        ...
        deserializerMap.put("colorIcon", (n) -> { currentObject.setColorIcon(n.getObjectValue(TeamsAppIcon::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("outlineIcon", (n) -> { currentObject.setOutlineIcon(n.getObjectValue(TeamsAppIcon::createFromDiscriminatorValue)); });
