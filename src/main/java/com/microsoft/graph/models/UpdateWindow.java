...
public class UpdateWindow implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("updateWindowEndTime", (n) -> { currentObject.setUpdateWindowEndTime(n.getLocalTimeValue()); });
        deserializerMap.put("updateWindowStartTime", (n) -> { currentObject.setUpdateWindowStartTime(n.getLocalTimeValue()); });
