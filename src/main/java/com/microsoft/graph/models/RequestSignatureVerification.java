...
public class RequestSignatureVerification implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedWeakAlgorithms", (n) -> { currentObject.setAllowedWeakAlgorithms(n.getEnumValue(WeakAlgorithms.class)); });
        deserializerMap.put("isSignedRequestRequired", (n) -> { currentObject.setIsSignedRequestRequired(n.getBooleanValue()); });
