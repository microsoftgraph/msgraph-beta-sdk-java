...
public class Person extends Entity implements Parsable {
    ...
    private java.util.List<RankedEmailAddress> _emailAddresses;
    ...
    private java.util.List<PersonDataSource> _sources;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("emailAddresses", (n) -> { currentObject.setEmailAddresses(n.getCollectionOfObjectValues(RankedEmailAddress::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("mailboxType", (n) -> { currentObject.setMailboxType(n.getStringValue()); });
        ...
        deserializerMap.put("personType", (n) -> { currentObject.setPersonType(n.getStringValue()); });
        ...
        deserializerMap.put("sources", (n) -> { currentObject.setSources(n.getCollectionOfObjectValues(PersonDataSource::createFromDiscriminatorValue)); });
