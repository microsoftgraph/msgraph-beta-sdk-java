...
public class Person extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("emailAddresses", (n) -> { currentObject.setEmailAddresses(n.getCollectionOfObjectValues(RankedEmailAddress::createFromDiscriminatorValue)); });
            ...
            this.put("mailboxType", (n) -> { currentObject.setMailboxType(n.getStringValue()); });
            ...
            this.put("personType", (n) -> { currentObject.setPersonType(n.getStringValue()); });
            ...
            this.put("sources", (n) -> { currentObject.setSources(n.getCollectionOfObjectValues(PersonDataSource::createFromDiscriminatorValue)); });
