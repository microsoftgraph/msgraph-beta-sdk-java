...
public class TypedEmailAddress extends EmailAddress implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("otherLabel", (n) -> { currentObject.setOtherLabel(n.getStringValue()); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(EmailType.class)); });
