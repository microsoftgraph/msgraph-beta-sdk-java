...
public class OrganizationalBrandingProperties extends Entity implements Parsable {
     ...
     */
    private Base64url backgroundImage;
    /**
     ...
     */
    private ContentCustomization contentCustomization;
    /**
     ...
     */
    private Base64url squareLogo;
    /**
     * A square dark version of your company logo that appears in Windows 10 out-of-box experiences (OOBE) and when Windows Autopilot is enabled for deployment. Allowed types are PNG or JPEG not larger than 240 x 240 pixels and not more than 10 KB in size. We recommend using a transparent image with no padding around the logo.
     */
    private Base64url squareLogoDark;
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getBackgroundImage() {
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getBannerLogo() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("backgroundImage", (n) -> { this.setBackgroundImage(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("backgroundImageRelativeUrl", (n) -> { this.setBackgroundImageRelativeUrl(n.getStringValue()); });
        deserializerMap.put("bannerLogo", (n) -> { this.setBannerLogo(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("customCSS", (n) -> { this.setCustomCSS(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("favicon", (n) -> { this.setFavicon(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("headerLogo", (n) -> { this.setHeaderLogo(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("squareLogo", (n) -> { this.setSquareLogo(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
        deserializerMap.put("squareLogoDark", (n) -> { this.setSquareLogoDark(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getHeaderLogo() {
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getSquareLogo() {
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getSquareLogoDark() {
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("backgroundImage", this.getBackgroundImage());
        writer.writeStringValue("backgroundImageRelativeUrl", this.getBackgroundImageRelativeUrl());
        writer.writeObjectValue("bannerLogo", this.getBannerLogo());
        ...
        writer.writeObjectValue("customCSS", this.getCustomCSS());
        ...
        writer.writeObjectValue("favicon", this.getFavicon());
        ...
        writer.writeObjectValue("headerLogo", this.getHeaderLogo());
        ...
        writer.writeObjectValue("squareLogo", this.getSquareLogo());
        writer.writeObjectValue("squareLogoDark", this.getSquareLogoDark());
     ...
     */
    public void setBackgroundImage(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setBannerLogo(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setCustomCSS(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setFavicon(@jakarta.annotation.Nullable final Base64url value) {
        this.favicon = value;
    }
    /**
     ...
     */
    public void setHeaderLogo(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setSquareLogo(@jakarta.annotation.Nullable final Base64url value) {
     ...
     */
    public void setSquareLogoDark(@jakarta.annotation.Nullable final Base64url value) {
