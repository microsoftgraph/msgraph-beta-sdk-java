...
public class ConfigManagerPolicySummary implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enforcedDeviceCount", (n) -> { currentObject.setEnforcedDeviceCount(n.getIntegerValue()); });
        ...
        deserializerMap.put("targetedDeviceCount", (n) -> { currentObject.setTargetedDeviceCount(n.getIntegerValue()); });
