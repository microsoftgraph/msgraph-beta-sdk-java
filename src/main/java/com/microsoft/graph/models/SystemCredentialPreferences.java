...
/**
 * The class for the System Credential Preferences.
 */
public class SystemCredentialPreferences implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<IncludeTarget> includeTargets;
