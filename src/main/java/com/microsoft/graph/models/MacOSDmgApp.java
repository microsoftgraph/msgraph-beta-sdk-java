...
public class MacOSDmgApp extends MobileLobApp implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("includedApps", (n) -> { currentObject.setIncludedApps(n.getCollectionOfObjectValues(MacOSIncludedApp::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("primaryBundleId", (n) -> { currentObject.setPrimaryBundleId(n.getStringValue()); });
        deserializerMap.put("primaryBundleVersion", (n) -> { currentObject.setPrimaryBundleVersion(n.getStringValue()); });
