...
public class DomainSecurityProfile extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("countInOrg", (n) -> { currentObject.setCountInOrg(n.getIntegerValue()); });
        deserializerMap.put("domainCategories", (n) -> { currentObject.setDomainCategories(n.getCollectionOfObjectValues(ReputationCategory::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("registrant", (n) -> { currentObject.setRegistrant(n.getObjectValue(DomainRegistrant::createFromDiscriminatorValue)); });
