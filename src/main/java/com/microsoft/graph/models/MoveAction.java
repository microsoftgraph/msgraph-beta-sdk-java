...
public class MoveAction implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static MoveAction createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
