...
/**
 * The class for the Activate Device Esim Action Result.
 */
public class ActivateDeviceEsimActionResult extends DeviceActionResult implements IJsonBackedObject {
