 ...
 */
public class SalesOrder implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public com.microsoft.graph.core.DateOnly orderDate;
    ...
    @Expose
	@Nullable
    public com.microsoft.graph.core.DateOnly requestedDeliveryDate;
