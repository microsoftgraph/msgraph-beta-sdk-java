...
public class SalesOrder extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("fullyShipped", (n) -> { currentObject.setFullyShipped(n.getBooleanValue()); });
        ...
        deserializerMap.put("orderDate", (n) -> { currentObject.setOrderDate(n.getLocalDateValue()); });
        deserializerMap.put("partialShipping", (n) -> { currentObject.setPartialShipping(n.getBooleanValue()); });
        ...
        deserializerMap.put("requestedDeliveryDate", (n) -> { currentObject.setRequestedDeliveryDate(n.getLocalDateValue()); });
        deserializerMap.put("salesOrderLines", (n) -> { currentObject.setSalesOrderLines(n.getCollectionOfObjectValues(SalesOrderLine::createFromDiscriminatorValue)); });
