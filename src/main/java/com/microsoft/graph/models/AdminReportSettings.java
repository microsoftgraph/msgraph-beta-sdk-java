...
/**
 * The class for the Admin Report Settings.
 */
public class AdminReportSettings extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public Boolean displayConcealedNames;
