...
/**
 * The class for the Workbook Functions Imaginary Parameter Set.
 */
public class WorkbookFunctionsImaginaryParameterSet {
    /**
     * The inumber.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsImaginaryParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsImaginaryParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsImaginaryParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsImaginaryParameterSetBuilder withInumber(@Nullable final com.google.gson.JsonElement val) {
            this.inumber = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsImaginaryParameterSetBuilder
         */
        @Nullable
         ...
         */
        @Nonnull
        public WorkbookFunctionsImaginaryParameterSet build() {
            return new WorkbookFunctionsImaginaryParameterSet(this);
        }
    }
    /**
