...
/**
 * The class for the Deleted Chat Undo Delete Parameter Set.
 */
public class DeletedChatUndoDeleteParameterSet {

    /**
     * Instiaciates a new DeletedChatUndoDeleteParameterSet
     */
     ...
     */
    protected DeletedChatUndoDeleteParameterSet(@Nonnull final DeletedChatUndoDeleteParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeletedChatUndoDeleteParameterSet
     */
    public static final class DeletedChatUndoDeleteParameterSetBuilder {
        /**
         * Instanciates a new DeletedChatUndoDeleteParameterSetBuilder
         */
        @Nullable
