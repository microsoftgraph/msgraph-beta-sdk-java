...
public class BufferDecryptionResult implements AdditionalDataHolder, Parsable {
    ...
    public BufferDecryptionResult() {
        ...
        this.setOdataType("#microsoft.graph.bufferDecryptionResult");
    }
    /**
    ...
    public static BufferDecryptionResult createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final BufferDecryptionResult currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("decryptedBuffer", (n) -> { currentObject.setDecryptedBuffer(n.getByteArrayValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setDecryptedBuffer(@javax.annotation.Nullable final byte[] value) {
        this._decryptedBuffer = value;
    }
    /**
