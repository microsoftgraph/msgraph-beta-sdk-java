...
public class SubjectRightsRequestAllSiteLocation extends SubjectRightsRequestSiteLocation implements Parsable {
    ...
    public static SubjectRightsRequestAllSiteLocation createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SubjectRightsRequestAllSiteLocation currentObject = this;
