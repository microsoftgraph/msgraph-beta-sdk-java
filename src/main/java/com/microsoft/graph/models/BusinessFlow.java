...
public class BusinessFlow extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deDuplicationId", (n) -> { currentObject.setDeDuplicationId(n.getStringValue()); });
        ...
        deserializerMap.put("policyTemplateId", (n) -> { currentObject.setPolicyTemplateId(n.getStringValue()); });
        deserializerMap.put("recordVersion", (n) -> { currentObject.setRecordVersion(n.getStringValue()); });
        deserializerMap.put("schemaId", (n) -> { currentObject.setSchemaId(n.getStringValue()); });
