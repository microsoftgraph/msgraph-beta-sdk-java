...
public class TermsAndConditions extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("groupAssignments", (n) -> { currentObject.setGroupAssignments(n.getCollectionOfObjectValues(TermsAndConditionsGroupAssignment::createFromDiscriminatorValue)); });
