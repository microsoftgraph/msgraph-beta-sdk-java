...
public class MembershipRuleProcessingStatus implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public OffsetDateTime getLastMembershipUpdated() {
        return this.backingStore.get("lastMembershipUpdated");
    }
    /**
    ...
    public void setLastMembershipUpdated(@jakarta.annotation.Nullable final OffsetDateTime value) {
        this.backingStore.set("lastMembershipUpdated", value);
    }
    /**
