...
public class FilterGroup implements AdditionalDataHolder, Parsable {
    ...
    public FilterGroup() {
        ...
        this.setOdataType("#microsoft.graph.filterGroup");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("clauses", (n) -> { currentObject.setClauses(n.getCollectionOfObjectValues(FilterClause::createFromDiscriminatorValue)); });
