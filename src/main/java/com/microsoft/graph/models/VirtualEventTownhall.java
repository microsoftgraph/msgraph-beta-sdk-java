...
/**
 * The class for the Virtual Event Townhall.
 */
public class VirtualEventTownhall extends VirtualEvent implements IJsonBackedObject {
     ...
     * 
     */
    @SerializedName(value = "invitedAttendees", alternate = {"InvitedAttendees"})
    @Expose
	@Nullable
    public java.util.List<CommunicationsUserIdentity> invitedAttendees;

    /**
     * The Is Invite Only.
     * 
     */
    @SerializedName(value = "isInviteOnly", alternate = {"IsInviteOnly"})
    @Expose
	@Nullable
