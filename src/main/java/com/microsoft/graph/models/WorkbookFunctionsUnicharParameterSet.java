...
/**
 * The class for the Workbook Functions Unichar Parameter Set.
 */
public class WorkbookFunctionsUnicharParameterSet {
    /**
     * The number.
     * 
     */
     ...
     */
    @Nonnull
    public static WorkbookFunctionsUnicharParameterSetBuilder newBuilder() {
        return new WorkbookFunctionsUnicharParameterSetBuilder();
    }
    /**
    ...
    public static final class WorkbookFunctionsUnicharParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsUnicharParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         ...
         */
        @Nonnull
        public WorkbookFunctionsUnicharParameterSet build() {
            return new WorkbookFunctionsUnicharParameterSet(this);
        }
    }
    /**
