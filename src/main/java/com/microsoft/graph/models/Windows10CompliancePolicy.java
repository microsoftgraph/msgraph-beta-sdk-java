...
public class Windows10CompliancePolicy extends DeviceCompliancePolicy implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activeFirewallRequired", (n) -> { currentObject.setActiveFirewallRequired(n.getBooleanValue()); });
        deserializerMap.put("antiSpywareRequired", (n) -> { currentObject.setAntiSpywareRequired(n.getBooleanValue()); });
        deserializerMap.put("antivirusRequired", (n) -> { currentObject.setAntivirusRequired(n.getBooleanValue()); });
        ...
        deserializerMap.put("configurationManagerComplianceRequired", (n) -> { currentObject.setConfigurationManagerComplianceRequired(n.getBooleanValue()); });
        deserializerMap.put("defenderEnabled", (n) -> { currentObject.setDefenderEnabled(n.getBooleanValue()); });
        deserializerMap.put("defenderVersion", (n) -> { currentObject.setDefenderVersion(n.getStringValue()); });
        deserializerMap.put("deviceCompliancePolicyScript", (n) -> { currentObject.setDeviceCompliancePolicyScript(n.getObjectValue(DeviceCompliancePolicyScript::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("rtpEnabled", (n) -> { currentObject.setRtpEnabled(n.getBooleanValue()); });
        deserializerMap.put("secureBootEnabled", (n) -> { currentObject.setSecureBootEnabled(n.getBooleanValue()); });
        deserializerMap.put("signatureOutOfDate", (n) -> { currentObject.setSignatureOutOfDate(n.getBooleanValue()); });
        deserializerMap.put("storageRequireEncryption", (n) -> { currentObject.setStorageRequireEncryption(n.getBooleanValue()); });
        deserializerMap.put("tpmRequired", (n) -> { currentObject.setTpmRequired(n.getBooleanValue()); });
        deserializerMap.put("validOperatingSystemBuildRanges", (n) -> { currentObject.setValidOperatingSystemBuildRanges(n.getCollectionOfObjectValues(OperatingSystemVersionRange::createFromDiscriminatorValue)); });
