...
public class AutoLabeling implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static AutoLabeling createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
