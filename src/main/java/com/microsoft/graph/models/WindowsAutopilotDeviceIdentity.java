...
public class WindowsAutopilotDeviceIdentity extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deploymentProfile", (n) -> { currentObject.setDeploymentProfile(n.getObjectValue(WindowsAutopilotDeploymentProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("deploymentProfileAssignedDateTime", (n) -> { currentObject.setDeploymentProfileAssignedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("deploymentProfileAssignmentDetailedStatus", (n) -> { currentObject.setDeploymentProfileAssignmentDetailedStatus(n.getEnumValue(WindowsAutopilotProfileAssignmentDetailedStatus.class)); });
        deserializerMap.put("deploymentProfileAssignmentStatus", (n) -> { currentObject.setDeploymentProfileAssignmentStatus(n.getEnumValue(WindowsAutopilotProfileAssignmentStatus.class)); });
        deserializerMap.put("deviceAccountPassword", (n) -> { currentObject.setDeviceAccountPassword(n.getStringValue()); });
        deserializerMap.put("deviceAccountUpn", (n) -> { currentObject.setDeviceAccountUpn(n.getStringValue()); });
        deserializerMap.put("deviceFriendlyName", (n) -> { currentObject.setDeviceFriendlyName(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("enrollmentState", (n) -> { currentObject.setEnrollmentState(n.getEnumValue(EnrollmentState.class)); });
        deserializerMap.put("groupTag", (n) -> { currentObject.setGroupTag(n.getStringValue()); });
        deserializerMap.put("intendedDeploymentProfile", (n) -> { currentObject.setIntendedDeploymentProfile(n.getObjectValue(WindowsAutopilotDeploymentProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("lastContactedDateTime", (n) -> { currentObject.setLastContactedDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("purchaseOrderIdentifier", (n) -> { currentObject.setPurchaseOrderIdentifier(n.getStringValue()); });
        deserializerMap.put("remediationState", (n) -> { currentObject.setRemediationState(n.getEnumValue(WindowsAutopilotDeviceRemediationState.class)); });
        deserializerMap.put("remediationStateLastModifiedDateTime", (n) -> { currentObject.setRemediationStateLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("skuNumber", (n) -> { currentObject.setSkuNumber(n.getStringValue()); });
        deserializerMap.put("systemFamily", (n) -> { currentObject.setSystemFamily(n.getStringValue()); });
