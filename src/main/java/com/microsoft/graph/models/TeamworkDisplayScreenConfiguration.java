...
public class TeamworkDisplayScreenConfiguration implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("backlightBrightness", (n) -> { currentObject.setBacklightBrightness(n.getIntegerValue()); });
        deserializerMap.put("backlightTimeout", (n) -> { currentObject.setBacklightTimeout(n.getPeriodValue()); });
        deserializerMap.put("isHighContrastEnabled", (n) -> { currentObject.setIsHighContrastEnabled(n.getBooleanValue()); });
        deserializerMap.put("isScreensaverEnabled", (n) -> { currentObject.setIsScreensaverEnabled(n.getBooleanValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("screensaverTimeout", (n) -> { currentObject.setScreensaverTimeout(n.getPeriodValue()); });
