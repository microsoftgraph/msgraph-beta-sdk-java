...
public class RegionalFormatOverrides implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("calendar", (n) -> { currentObject.setCalendar(n.getStringValue()); });
        deserializerMap.put("firstDayOfWeek", (n) -> { currentObject.setFirstDayOfWeek(n.getStringValue()); });
        deserializerMap.put("longDateFormat", (n) -> { currentObject.setLongDateFormat(n.getStringValue()); });
        deserializerMap.put("longTimeFormat", (n) -> { currentObject.setLongTimeFormat(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("shortDateFormat", (n) -> { currentObject.setShortDateFormat(n.getStringValue()); });
        deserializerMap.put("shortTimeFormat", (n) -> { currentObject.setShortTimeFormat(n.getStringValue()); });
