...
public class ExternalIdentitiesPolicy extends PolicyBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowDeletedIdentitiesDataRemoval", (n) -> { currentObject.setAllowDeletedIdentitiesDataRemoval(n.getBooleanValue()); });
        deserializerMap.put("allowExternalIdentitiesToLeave", (n) -> { currentObject.setAllowExternalIdentitiesToLeave(n.getBooleanValue()); });
