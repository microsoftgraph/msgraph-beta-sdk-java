...
public class ZebraFotaDeploymentSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("batteryRuleMinimumBatteryLevelPercentage", (n) -> { currentObject.setBatteryRuleMinimumBatteryLevelPercentage(n.getIntegerValue()); });
        deserializerMap.put("batteryRuleRequireCharger", (n) -> { currentObject.setBatteryRuleRequireCharger(n.getBooleanValue()); });
        deserializerMap.put("deviceModel", (n) -> { currentObject.setDeviceModel(n.getStringValue()); });
        deserializerMap.put("downloadRuleNetworkType", (n) -> { currentObject.setDownloadRuleNetworkType(n.getEnumValue(ZebraFotaNetworkType.class)); });
        deserializerMap.put("downloadRuleStartDateTime", (n) -> { currentObject.setDownloadRuleStartDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("firmwareTargetArtifactDescription", (n) -> { currentObject.setFirmwareTargetArtifactDescription(n.getStringValue()); });
        deserializerMap.put("firmwareTargetBoardSupportPackageVersion", (n) -> { currentObject.setFirmwareTargetBoardSupportPackageVersion(n.getStringValue()); });
        deserializerMap.put("firmwareTargetOsVersion", (n) -> { currentObject.setFirmwareTargetOsVersion(n.getStringValue()); });
        deserializerMap.put("firmwareTargetPatch", (n) -> { currentObject.setFirmwareTargetPatch(n.getStringValue()); });
        deserializerMap.put("installRuleStartDateTime", (n) -> { currentObject.setInstallRuleStartDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("installRuleWindowEndTime", (n) -> { currentObject.setInstallRuleWindowEndTime(n.getLocalTimeValue()); });
        deserializerMap.put("installRuleWindowStartTime", (n) -> { currentObject.setInstallRuleWindowStartTime(n.getLocalTimeValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("scheduleDurationInDays", (n) -> { currentObject.setScheduleDurationInDays(n.getIntegerValue()); });
        deserializerMap.put("scheduleMode", (n) -> { currentObject.setScheduleMode(n.getEnumValue(ZebraFotaScheduleMode.class)); });
        deserializerMap.put("timeZoneOffsetInMinutes", (n) -> { currentObject.setTimeZoneOffsetInMinutes(n.getIntegerValue()); });
        deserializerMap.put("updateType", (n) -> { currentObject.setUpdateType(n.getEnumValue(ZebraFotaUpdateType.class)); });
