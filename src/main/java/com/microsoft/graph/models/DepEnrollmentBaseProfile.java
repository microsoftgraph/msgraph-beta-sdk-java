...
public class DepEnrollmentBaseProfile extends EnrollmentProfile implements Parsable {
     ...
     */
    private java.util.List<UUID> enrollmentTimeAzureAdGroupIds;
    /**
    ...
    public java.util.List<UUID> getEnrollmentTimeAzureAdGroupIds() {
        return this.enrollmentTimeAzureAdGroupIds;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setEnrollmentTimeAzureAdGroupIds(@javax.annotation.Nullable final java.util.List<UUID> value) {
        this.enrollmentTimeAzureAdGroupIds = value;
    }
    /**
