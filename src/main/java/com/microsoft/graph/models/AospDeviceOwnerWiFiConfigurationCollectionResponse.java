...
public class AospDeviceOwnerWiFiConfigurationCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<AospDeviceOwnerWiFiConfiguration> value;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { this.setValue(n.getCollectionOfObjectValues(AospDeviceOwnerWiFiConfiguration::createFromDiscriminatorValue)); });
