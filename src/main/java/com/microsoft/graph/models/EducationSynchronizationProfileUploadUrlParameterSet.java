...
/**
 * The class for the Education Synchronization Profile Upload Url Parameter Set.
 */
public class EducationSynchronizationProfileUploadUrlParameterSet {

    /**
     * Instiaciates a new EducationSynchronizationProfileUploadUrlParameterSet
     */
     ...
     */
    protected EducationSynchronizationProfileUploadUrlParameterSet(@Nonnull final EducationSynchronizationProfileUploadUrlParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EducationSynchronizationProfileUploadUrlParameterSet
     */
    public static final class EducationSynchronizationProfileUploadUrlParameterSetBuilder {
        /**
         * Instanciates a new EducationSynchronizationProfileUploadUrlParameterSetBuilder
         */
        @Nullable
