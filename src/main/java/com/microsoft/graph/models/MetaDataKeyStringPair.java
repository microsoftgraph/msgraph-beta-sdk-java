...
public class MetaDataKeyStringPair implements AdditionalDataHolder, Parsable {
    ...
    public static MetaDataKeyStringPair createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
