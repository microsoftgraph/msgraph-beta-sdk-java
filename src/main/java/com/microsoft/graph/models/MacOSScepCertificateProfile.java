...
public class MacOSScepCertificateProfile extends MacOSCertificateProfileBase implements Parsable {
    ...
    private MacOSTrustedRootCertificate _rootCertificate;
    /** SCEP Server Url(s). */
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowAllAppsAccess", (n) -> { currentObject.setAllowAllAppsAccess(n.getBooleanValue()); });
        ...
        deserializerMap.put("rootCertificate", (n) -> { currentObject.setRootCertificate(n.getObjectValue(MacOSTrustedRootCertificate::createFromDiscriminatorValue)); });
