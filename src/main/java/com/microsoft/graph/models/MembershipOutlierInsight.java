...
public class MembershipOutlierInsight extends GovernanceInsight implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("container", (n) -> { currentObject.setContainer(n.getObjectValue(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("containerId", (n) -> { currentObject.setContainerId(n.getStringValue()); });
        deserializerMap.put("member", (n) -> { currentObject.setMember(n.getObjectValue(DirectoryObject::createFromDiscriminatorValue)); });
        deserializerMap.put("memberId", (n) -> { currentObject.setMemberId(n.getStringValue()); });
        deserializerMap.put("outlierContainerType", (n) -> { currentObject.setOutlierContainerType(n.getEnumValue(OutlierContainerType.class)); });
        deserializerMap.put("outlierMemberType", (n) -> { currentObject.setOutlierMemberType(n.getEnumValue(OutlierMemberType.class)); });
