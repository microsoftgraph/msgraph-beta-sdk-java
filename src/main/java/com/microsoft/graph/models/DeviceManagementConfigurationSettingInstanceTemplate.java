...
/**
 * The class for the Device Management Configuration Setting Instance Template.
 */
public class DeviceManagementConfigurationSettingInstanceTemplate implements IJsonBackedObject {
