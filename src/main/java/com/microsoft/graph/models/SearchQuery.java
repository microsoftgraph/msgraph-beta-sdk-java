...
public class SearchQuery implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("query_string", (n) -> { currentObject.setQuery_string(n.getObjectValue(SearchQueryString::createFromDiscriminatorValue)); });
        deserializerMap.put("queryString", (n) -> { currentObject.setQueryString(n.getStringValue()); });
        deserializerMap.put("queryTemplate", (n) -> { currentObject.setQueryTemplate(n.getStringValue()); });
