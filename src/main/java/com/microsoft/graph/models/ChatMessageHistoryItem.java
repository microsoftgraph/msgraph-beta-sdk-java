...
public class ChatMessageHistoryItem implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actions", (n) -> { currentObject.setActions(n.getEnumValue(ChatMessageActions.class)); });
        deserializerMap.put("modifiedDateTime", (n) -> { currentObject.setModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("reaction", (n) -> { currentObject.setReaction(n.getObjectValue(ChatMessageReaction::createFromDiscriminatorValue)); });
