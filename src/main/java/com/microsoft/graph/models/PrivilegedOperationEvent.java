...
public class PrivilegedOperationEvent extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("referenceKey", (n) -> { currentObject.setReferenceKey(n.getStringValue()); });
        deserializerMap.put("referenceSystem", (n) -> { currentObject.setReferenceSystem(n.getStringValue()); });
        deserializerMap.put("requestorId", (n) -> { currentObject.setRequestorId(n.getStringValue()); });
        deserializerMap.put("requestorName", (n) -> { currentObject.setRequestorName(n.getStringValue()); });
        ...
        deserializerMap.put("roleName", (n) -> { currentObject.setRoleName(n.getStringValue()); });
        ...
        deserializerMap.put("userMail", (n) -> { currentObject.setUserMail(n.getStringValue()); });
