...
public class GcpRole extends Entity implements Parsable {
     ...
     */
    private GcpRoleType gcpRoleType;
    /**
     * The scopes property
     */
    private java.util.List<GcpScope> scopes;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("gcpRoleType", (n) -> { this.setGcpRoleType(n.getEnumValue(GcpRoleType.class)); });
