...
public class SitePage extends BaseItem implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pageLayoutType", (n) -> { currentObject.setPageLayoutType(n.getStringValue()); });
        deserializerMap.put("publishingState", (n) -> { currentObject.setPublishingState(n.getObjectValue(PublicationFacet::createFromDiscriminatorValue)); });
        deserializerMap.put("title", (n) -> { currentObject.setTitle(n.getStringValue()); });
        deserializerMap.put("webParts", (n) -> { currentObject.setWebParts(n.getCollectionOfObjectValues(WebPart::createFromDiscriminatorValue)); });
