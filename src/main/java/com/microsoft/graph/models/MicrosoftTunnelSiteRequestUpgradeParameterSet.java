...
/**
 * The class for the Microsoft Tunnel Site Request Upgrade Parameter Set.
 */
public class MicrosoftTunnelSiteRequestUpgradeParameterSet {

    /**
     * Instiaciates a new MicrosoftTunnelSiteRequestUpgradeParameterSet
     */
     ...
     */
    protected MicrosoftTunnelSiteRequestUpgradeParameterSet(@Nonnull final MicrosoftTunnelSiteRequestUpgradeParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the MicrosoftTunnelSiteRequestUpgradeParameterSet
     */
    public static final class MicrosoftTunnelSiteRequestUpgradeParameterSetBuilder {
        /**
         * Instanciates a new MicrosoftTunnelSiteRequestUpgradeParameterSetBuilder
         */
        @Nullable
