...
public class UpdateAllowedCombinationsResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(5) {{
            ...
            this.put("currentCombinations", (n) -> { currentObject.setCurrentCombinations(n.getCollectionOfEnumValues(AuthenticationMethodModes.class)); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("previousCombinations", (n) -> { currentObject.setPreviousCombinations(n.getCollectionOfEnumValues(AuthenticationMethodModes.class)); });
        }};
    }
    /**
