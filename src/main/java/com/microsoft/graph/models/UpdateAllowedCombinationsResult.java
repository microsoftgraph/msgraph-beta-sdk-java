...
public class UpdateAllowedCombinationsResult implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<AuthenticationMethodModes> _currentCombinations;
    ...
    private java.util.List<AuthenticationMethodModes> _previousCombinations;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("conditionalAccessReferences", (n) -> { currentObject.setConditionalAccessReferences(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("currentCombinations", (n) -> { currentObject.setCurrentCombinations(n.getCollectionOfEnumValues(AuthenticationMethodModes.class)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("previousCombinations", (n) -> { currentObject.setPreviousCombinations(n.getCollectionOfEnumValues(AuthenticationMethodModes.class)); });
