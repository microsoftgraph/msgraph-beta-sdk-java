...
public class MeetingActivityStatistics extends ActivityStatistics implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(super.getFieldDeserializers()) {{
            ...
            this.put("multitasking", (n) -> { currentObject.setMultitasking(n.getPeriodValue()); });
            this.put("organized", (n) -> { currentObject.setOrganized(n.getPeriodValue()); });
            this.put("recurring", (n) -> { currentObject.setRecurring(n.getPeriodValue()); });
        }};
    }
    /**
