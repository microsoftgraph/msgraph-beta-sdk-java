...
/**
 * The class for the Impacted Resource Reactivate Parameter Set.
 */
public class ImpactedResourceReactivateParameterSet {

    /**
     * Instiaciates a new ImpactedResourceReactivateParameterSet
     */
     ...
     */
    protected ImpactedResourceReactivateParameterSet(@Nonnull final ImpactedResourceReactivateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ImpactedResourceReactivateParameterSet
     */
    public static final class ImpactedResourceReactivateParameterSetBuilder {
        /**
         * Instanciates a new ImpactedResourceReactivateParameterSetBuilder
         */
        @Nullable
