...
/**
 * The class for the Planner Task Delta Parameter Set.
 */
public class PlannerTaskDeltaParameterSet {

    /**
     * Instiaciates a new PlannerTaskDeltaParameterSet
     */
     ...
     */
    protected PlannerTaskDeltaParameterSet(@Nonnull final PlannerTaskDeltaParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PlannerTaskDeltaParameterSet
     */
    public static final class PlannerTaskDeltaParameterSetBuilder {
        /**
         * Instanciates a new PlannerTaskDeltaParameterSetBuilder
         */
        @Nullable
