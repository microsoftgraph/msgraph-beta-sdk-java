...
public class PurchaseInvoice extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("buyFromAddress", (n) -> { currentObject.setBuyFromAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("payToAddress", (n) -> { currentObject.setPayToAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        deserializerMap.put("payToContact", (n) -> { currentObject.setPayToContact(n.getStringValue()); });
        deserializerMap.put("payToName", (n) -> { currentObject.setPayToName(n.getStringValue()); });
        deserializerMap.put("payToVendorId", (n) -> { currentObject.setPayToVendorId(n.getStringValue()); });
        deserializerMap.put("payToVendorNumber", (n) -> { currentObject.setPayToVendorNumber(n.getStringValue()); });
        ...
        deserializerMap.put("shipToAddress", (n) -> { currentObject.setShipToAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("vendor", (n) -> { currentObject.setVendor(n.getObjectValue(Vendor::createFromDiscriminatorValue)); });
        deserializerMap.put("vendorId", (n) -> { currentObject.setVendorId(n.getStringValue()); });
        deserializerMap.put("vendorInvoiceNumber", (n) -> { currentObject.setVendorInvoiceNumber(n.getStringValue()); });
        deserializerMap.put("vendorName", (n) -> { currentObject.setVendorName(n.getStringValue()); });
