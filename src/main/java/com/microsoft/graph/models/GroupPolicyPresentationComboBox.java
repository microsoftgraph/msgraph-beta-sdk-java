...
public class GroupPolicyPresentationComboBox extends GroupPolicyUploadedPresentation implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maxLength", (n) -> { currentObject.setMaxLength(n.getLongValue()); });
        deserializerMap.put("required", (n) -> { currentObject.setRequired(n.getBooleanValue()); });
        deserializerMap.put("suggestions", (n) -> { currentObject.setSuggestions(n.getCollectionOfPrimitiveValues(String.class)); });
