...
public class DeviceManagementSettingInstanceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceManagementSettingInstanceCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementSettingInstanceCollectionResponse currentObject = this;
