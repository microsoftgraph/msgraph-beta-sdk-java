...
public class AndroidDeviceOwnerUserFacingMessage implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("defaultMessage", (n) -> { currentObject.setDefaultMessage(n.getStringValue()); });
        deserializerMap.put("localizedMessages", (n) -> { currentObject.setLocalizedMessages(n.getCollectionOfObjectValues(KeyValuePair::createFromDiscriminatorValue)); });
