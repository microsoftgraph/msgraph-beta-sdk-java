...
public class PrivilegedApproval extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("approvalDuration", (n) -> { currentObject.setApprovalDuration(n.getPeriodValue()); });
        deserializerMap.put("approvalState", (n) -> { currentObject.setApprovalState(n.getEnumValue(ApprovalState.class)); });
        deserializerMap.put("approvalType", (n) -> { currentObject.setApprovalType(n.getStringValue()); });
        deserializerMap.put("approverReason", (n) -> { currentObject.setApproverReason(n.getStringValue()); });
        deserializerMap.put("endDateTime", (n) -> { currentObject.setEndDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("request", (n) -> { currentObject.setRequest(n.getObjectValue(PrivilegedRoleAssignmentRequest::createFromDiscriminatorValue)); });
        deserializerMap.put("requestorReason", (n) -> { currentObject.setRequestorReason(n.getStringValue()); });
