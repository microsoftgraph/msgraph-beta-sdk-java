...
public class AndroidForWorkCustomConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public AndroidForWorkCustomConfiguration() {
        super();
        this.setOdataType("#microsoft.graph.androidForWorkCustomConfiguration");
    }
    /**
    ...
    public static AndroidForWorkCustomConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidForWorkCustomConfiguration currentObject = this;
