...
public class RequestRemoteHelpSessionAccessResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pubSubEncryption", (n) -> { currentObject.setPubSubEncryption(n.getStringValue()); });
        deserializerMap.put("pubSubEncryptionKey", (n) -> { currentObject.setPubSubEncryptionKey(n.getStringValue()); });
