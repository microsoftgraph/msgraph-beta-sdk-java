...
public class RegionalAndLanguageSettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authoringLanguages", (n) -> { currentObject.setAuthoringLanguages(n.getCollectionOfObjectValues(LocaleInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultDisplayLanguage", (n) -> { currentObject.setDefaultDisplayLanguage(n.getObjectValue(LocaleInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultRegionalFormat", (n) -> { currentObject.setDefaultRegionalFormat(n.getObjectValue(LocaleInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultSpeechInputLanguage", (n) -> { currentObject.setDefaultSpeechInputLanguage(n.getObjectValue(LocaleInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultTranslationLanguage", (n) -> { currentObject.setDefaultTranslationLanguage(n.getObjectValue(LocaleInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("regionalFormatOverrides", (n) -> { currentObject.setRegionalFormatOverrides(n.getObjectValue(RegionalFormatOverrides::createFromDiscriminatorValue)); });
        deserializerMap.put("translationPreferences", (n) -> { currentObject.setTranslationPreferences(n.getObjectValue(TranslationPreferences::createFromDiscriminatorValue)); });
