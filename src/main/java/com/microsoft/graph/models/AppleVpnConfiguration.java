...
public class AppleVpnConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(super.getFieldDeserializers()) {{
            ...
            this.put("connectionType", (n) -> { currentObject.setConnectionType(n.getEnumValue(AppleVpnConnectionType.class)); });
            ...
            this.put("disableOnDemandUserOverride", (n) -> { currentObject.setDisableOnDemandUserOverride(n.getBooleanValue()); });
            this.put("disconnectOnIdle", (n) -> { currentObject.setDisconnectOnIdle(n.getBooleanValue()); });
            this.put("disconnectOnIdleTimerInSeconds", (n) -> { currentObject.setDisconnectOnIdleTimerInSeconds(n.getIntegerValue()); });
            this.put("enablePerApp", (n) -> { currentObject.setEnablePerApp(n.getBooleanValue()); });
            this.put("enableSplitTunneling", (n) -> { currentObject.setEnableSplitTunneling(n.getBooleanValue()); });
            this.put("excludedDomains", (n) -> { currentObject.setExcludedDomains(n.getCollectionOfPrimitiveValues(String.class)); });
            ...
            this.put("onDemandRules", (n) -> { currentObject.setOnDemandRules(n.getCollectionOfObjectValues(VpnOnDemandRule::createFromDiscriminatorValue)); });
            this.put("optInToDeviceIdSharing", (n) -> { currentObject.setOptInToDeviceIdSharing(n.getBooleanValue()); });
            this.put("providerType", (n) -> { currentObject.setProviderType(n.getEnumValue(VpnProviderType.class)); });
            ...
            this.put("safariDomains", (n) -> { currentObject.setSafariDomains(n.getCollectionOfPrimitiveValues(String.class)); });
            this.put("server", (n) -> { currentObject.setServer(n.getObjectValue(VpnServer::createFromDiscriminatorValue)); });
        }};
    }
    /**
