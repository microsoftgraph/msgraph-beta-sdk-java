...
public class DeviceManagementConfigurationApplicationSettingApplicability extends DeviceManagementConfigurationSettingApplicability implements Parsable {
     ...
     * @return a DeviceManagementConfigurationApplicationSettingApplicability
     */
    @javax.annotation.Nonnull
    public static DeviceManagementConfigurationApplicationSettingApplicability createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
