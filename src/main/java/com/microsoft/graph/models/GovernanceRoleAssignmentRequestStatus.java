...
public class GovernanceRoleAssignmentRequestStatus implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("statusDetails", (n) -> { currentObject.setStatusDetails(n.getCollectionOfObjectValues(KeyValue::createFromDiscriminatorValue)); });
        deserializerMap.put("subStatus", (n) -> { currentObject.setSubStatus(n.getStringValue()); });
