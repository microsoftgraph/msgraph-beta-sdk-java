...
public class ActivitySettings implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<UrlToItemResolverBase> _urlToItemResolvers;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ActivitySettings currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("urlToItemResolvers", (n) -> { currentObject.setUrlToItemResolvers(n.getCollectionOfObjectValues(UrlToItemResolverBase::createFromDiscriminatorValue)); });
    ...
    public java.util.List<UrlToItemResolverBase> getUrlToItemResolvers() {
        return this._urlToItemResolvers;
    }
    /**
    ...
    public void setUrlToItemResolvers(@javax.annotation.Nullable final java.util.List<UrlToItemResolverBase> value) {
        this._urlToItemResolvers = value;
    }
}
