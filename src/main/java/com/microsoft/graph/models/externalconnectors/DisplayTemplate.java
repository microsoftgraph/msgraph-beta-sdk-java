...
public class DisplayTemplate implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("layout", (n) -> { currentObject.setLayout(n.getObjectValue(Json::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("priority", (n) -> { currentObject.setPriority(n.getIntegerValue()); });
        deserializerMap.put("rules", (n) -> { currentObject.setRules(n.getCollectionOfObjectValues(PropertyRule::createFromDiscriminatorValue)); });
