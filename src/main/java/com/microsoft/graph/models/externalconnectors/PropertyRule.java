...
public class PropertyRule implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("operation", (n) -> { currentObject.setOperation(n.getEnumValue(RuleOperation.class)); });
        deserializerMap.put("property", (n) -> { currentObject.setProperty(n.getStringValue()); });
        deserializerMap.put("values", (n) -> { currentObject.setValues(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("valuesJoinedBy", (n) -> { currentObject.setValuesJoinedBy(n.getEnumValue(BinaryOperator.class)); });
