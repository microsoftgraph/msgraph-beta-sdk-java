...
public class ComplianceSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("eDiscoveryResultTemplates", (n) -> { currentObject.setEDiscoveryResultTemplates(n.getCollectionOfObjectValues(DisplayTemplate::createFromDiscriminatorValue)); });
