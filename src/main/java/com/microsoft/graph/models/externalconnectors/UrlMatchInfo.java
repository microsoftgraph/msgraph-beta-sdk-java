...
public class UrlMatchInfo implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<String> _baseUrls;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("baseUrls", (n) -> { currentObject.setBaseUrls(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("urlPattern", (n) -> { currentObject.setUrlPattern(n.getStringValue()); });
