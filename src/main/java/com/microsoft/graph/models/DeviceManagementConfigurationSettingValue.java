...
public class DeviceManagementConfigurationSettingValue implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("settingValueTemplateReference", (n) -> { this.setSettingValueTemplateReference(n.getObjectValue(DeviceManagementConfigurationSettingValueTemplateReference::createFromDiscriminatorValue)); });
    ...
    public DeviceManagementConfigurationSettingValueTemplateReference getSettingValueTemplateReference() {
        return this.backingStore.get("settingValueTemplateReference");
    }
    /**
    ...
    public void setSettingValueTemplateReference(@jakarta.annotation.Nullable final DeviceManagementConfigurationSettingValueTemplateReference value) {
        this.backingStore.set("settingValueTemplateReference", value);
    }
}
