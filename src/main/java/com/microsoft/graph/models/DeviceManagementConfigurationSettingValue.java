...
import com.microsoft.graph.models.DeviceManagementConfigurationChoiceSettingValue;
import com.microsoft.graph.models.DeviceManagementConfigurationGroupSettingValue;
...
public class DeviceManagementConfigurationSettingValue implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("settingValueTemplateReference", (n) -> { currentObject.setSettingValueTemplateReference(n.getObjectValue(DeviceManagementConfigurationSettingValueTemplateReference::createFromDiscriminatorValue)); });
