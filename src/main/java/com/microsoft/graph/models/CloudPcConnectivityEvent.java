...
public class CloudPcConnectivityEvent implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("eventResult", (n) -> { currentObject.setEventResult(n.getEnumValue(CloudPcConnectivityEventResult.class)); });
        deserializerMap.put("eventType", (n) -> { currentObject.setEventType(n.getEnumValue(CloudPcConnectivityEventType.class)); });
