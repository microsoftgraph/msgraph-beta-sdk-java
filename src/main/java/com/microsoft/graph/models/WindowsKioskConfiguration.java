...
public class WindowsKioskConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("edgeKioskEnablePublicBrowsing", (n) -> { currentObject.setEdgeKioskEnablePublicBrowsing(n.getBooleanValue()); });
        deserializerMap.put("kioskBrowserBlockedUrlExceptions", (n) -> { currentObject.setKioskBrowserBlockedUrlExceptions(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("kioskBrowserBlockedURLs", (n) -> { currentObject.setKioskBrowserBlockedURLs(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("kioskBrowserDefaultUrl", (n) -> { currentObject.setKioskBrowserDefaultUrl(n.getStringValue()); });
        deserializerMap.put("kioskBrowserEnableEndSessionButton", (n) -> { currentObject.setKioskBrowserEnableEndSessionButton(n.getBooleanValue()); });
        deserializerMap.put("kioskBrowserEnableHomeButton", (n) -> { currentObject.setKioskBrowserEnableHomeButton(n.getBooleanValue()); });
        deserializerMap.put("kioskBrowserEnableNavigationButtons", (n) -> { currentObject.setKioskBrowserEnableNavigationButtons(n.getBooleanValue()); });
        deserializerMap.put("kioskBrowserRestartOnIdleTimeInMinutes", (n) -> { currentObject.setKioskBrowserRestartOnIdleTimeInMinutes(n.getIntegerValue()); });
        deserializerMap.put("kioskProfiles", (n) -> { currentObject.setKioskProfiles(n.getCollectionOfObjectValues(WindowsKioskProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("windowsKioskForceUpdateSchedule", (n) -> { currentObject.setWindowsKioskForceUpdateSchedule(n.getObjectValue(WindowsKioskForceUpdateSchedule::createFromDiscriminatorValue)); });
