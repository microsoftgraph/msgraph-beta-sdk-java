...
public class AwsAuthorizationSystem extends AuthorizationSystem implements Parsable {
     ...
     */
    private java.util.List<AwsAuthorizationSystemTypeAction> actions;
    /**
     * The associatedIdentities property
     */
    private AwsAssociatedIdentities associatedIdentities;
    /**
     * The policies property
     */
    private java.util.List<AwsPolicy> policies;
    /**
     * The resources property
     */
    private java.util.List<AwsAuthorizationSystemResource> resources;
    /**
