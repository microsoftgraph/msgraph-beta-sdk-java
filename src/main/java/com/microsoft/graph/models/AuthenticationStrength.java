...
public class AuthenticationStrength implements AdditionalDataHolder, Parsable {
    ...
    private String _authenticationStrengthId;
    ...
    public AuthenticationStrength() {
        ...
        this.setOdataType("#microsoft.graph.authenticationStrength");
    }
    /**
    ...
    public static AuthenticationStrength createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getAuthenticationStrengthId() {
        return this._authenticationStrengthId;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AuthenticationStrength currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(3);
        deserializerMap.put("authenticationStrengthId", (n) -> { currentObject.setAuthenticationStrengthId(n.getStringValue()); });
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationStrengthId(@javax.annotation.Nullable final String value) {
        this._authenticationStrengthId = value;
    }
    /**
