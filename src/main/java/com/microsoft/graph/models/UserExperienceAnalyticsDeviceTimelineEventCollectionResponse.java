...
public class UserExperienceAnalyticsDeviceTimelineEventCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<UserExperienceAnalyticsDeviceTimelineEvent> value;
    /**
    ...
    public static UserExperienceAnalyticsDeviceTimelineEventCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<UserExperienceAnalyticsDeviceTimelineEvent> value) {
        this.value = value;
    }
}
