...
public class GroupPolicyDefinitionValue extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("configurationType", (n) -> { currentObject.setConfigurationType(n.getEnumValue(GroupPolicyConfigurationType.class)); });
        ...
        deserializerMap.put("presentationValues", (n) -> { currentObject.setPresentationValues(n.getCollectionOfObjectValues(GroupPolicyPresentationValue::createFromDiscriminatorValue)); });
