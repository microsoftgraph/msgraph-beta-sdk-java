...
public class DataProcessorServiceForWindowsFeaturesOnboarding implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("areDataProcessorServiceForWindowsFeaturesEnabled", (n) -> { currentObject.setAreDataProcessorServiceForWindowsFeaturesEnabled(n.getBooleanValue()); });
        deserializerMap.put("hasValidWindowsLicense", (n) -> { currentObject.setHasValidWindowsLicense(n.getBooleanValue()); });
