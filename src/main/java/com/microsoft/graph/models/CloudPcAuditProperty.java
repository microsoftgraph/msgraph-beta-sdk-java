...
public class CloudPcAuditProperty implements AdditionalDataHolder, Parsable {
    ...
    public static CloudPcAuditProperty createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CloudPcAuditProperty currentObject = this;
