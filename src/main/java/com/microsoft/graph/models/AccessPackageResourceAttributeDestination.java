...
public class AccessPackageResourceAttributeDestination implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static AccessPackageResourceAttributeDestination createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
