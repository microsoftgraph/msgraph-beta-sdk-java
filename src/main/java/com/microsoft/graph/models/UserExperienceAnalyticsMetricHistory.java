...
public class UserExperienceAnalyticsMetricHistory extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("metricDateTime", (n) -> { currentObject.setMetricDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("metricType", (n) -> { currentObject.setMetricType(n.getStringValue()); });
