...
public class TeamworkTagIdentity extends Identity implements Parsable {
    ...
    public static TeamworkTagIdentity createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TeamworkTagIdentity currentObject = this;
