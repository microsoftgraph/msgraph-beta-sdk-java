...
public class DeviceManagementConfigurationPolicyPolicySetItem extends PolicySetItem implements Parsable {
    ...
    public static DeviceManagementConfigurationPolicyPolicySetItem createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementConfigurationPolicyPolicySetItem currentObject = this;
