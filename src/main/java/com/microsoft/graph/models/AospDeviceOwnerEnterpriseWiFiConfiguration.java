...
public class AospDeviceOwnerEnterpriseWiFiConfiguration extends AospDeviceOwnerWiFiConfiguration implements Parsable {
     ...
     */
    public void setIdentityCertificateForClientAuthentication(@jakarta.annotation.Nullable final AospDeviceOwnerCertificateProfileBase value) {
     ...
     */
    public void setRootCertificateForServerValidation(@jakarta.annotation.Nullable final AospDeviceOwnerTrustedRootCertificate value) {
