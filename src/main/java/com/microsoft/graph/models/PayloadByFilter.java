...
public class PayloadByFilter implements AdditionalDataHolder, Parsable {
    ...
    private AssociatedAssignmentPayloadType _payloadType;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final PayloadByFilter currentObject = this;
        ...
        deserializerMap.put("payloadType", (n) -> { currentObject.setPayloadType(n.getEnumValue(AssociatedAssignmentPayloadType.class)); });
