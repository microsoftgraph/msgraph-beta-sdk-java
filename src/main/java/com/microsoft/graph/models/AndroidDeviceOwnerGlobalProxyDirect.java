...
public class AndroidDeviceOwnerGlobalProxyDirect extends AndroidDeviceOwnerGlobalProxy implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("excludedHosts", (n) -> { currentObject.setExcludedHosts(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("host", (n) -> { currentObject.setHost(n.getStringValue()); });
