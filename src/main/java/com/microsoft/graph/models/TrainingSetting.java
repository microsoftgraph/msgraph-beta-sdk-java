...
public class TrainingSetting implements AdditionalDataHolder, Parsable {
    ...
    public static TrainingSetting createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSettingType(@javax.annotation.Nullable final TrainingSettingType value) {
