...
public class MacOSEndpointProtectionConfiguration extends DeviceConfiguration implements Parsable {
     ...
     */
    private Base64url fileVaultInstitutionalRecoveryKeyCertificate;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("fileVaultInstitutionalRecoveryKeyCertificate", (n) -> { this.setFileVaultInstitutionalRecoveryKeyCertificate(n.getObjectValue(Base64url::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public Base64url getFileVaultInstitutionalRecoveryKeyCertificate() {
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeObjectValue("fileVaultInstitutionalRecoveryKeyCertificate", this.getFileVaultInstitutionalRecoveryKeyCertificate());
     ...
     */
    public void setFileVaultInstitutionalRecoveryKeyCertificate(@jakarta.annotation.Nullable final Base64url value) {
