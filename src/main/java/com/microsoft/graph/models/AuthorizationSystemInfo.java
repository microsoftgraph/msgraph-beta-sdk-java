...
public class AuthorizationSystemInfo implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static AuthorizationSystemInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authorizationSystemType", (n) -> { this.setAuthorizationSystemType(n.getEnumValue(AuthorizationSystemType.class)); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeEnumValue("authorizationSystemType", this.getAuthorizationSystemType());
