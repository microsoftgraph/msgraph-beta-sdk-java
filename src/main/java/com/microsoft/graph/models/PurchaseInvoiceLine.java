...
public class PurchaseInvoiceLine extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("amountExcludingTax", (n) -> { currentObject.setAmountExcludingTax(n.getBigDecimalValue()); });
        deserializerMap.put("amountIncludingTax", (n) -> { currentObject.setAmountIncludingTax(n.getBigDecimalValue()); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("discountAmount", (n) -> { currentObject.setDiscountAmount(n.getBigDecimalValue()); });
        deserializerMap.put("discountAppliedBeforeTax", (n) -> { currentObject.setDiscountAppliedBeforeTax(n.getBooleanValue()); });
        deserializerMap.put("discountPercent", (n) -> { currentObject.setDiscountPercent(n.getBigDecimalValue()); });
        deserializerMap.put("documentId", (n) -> { currentObject.setDocumentId(n.getStringValue()); });
        deserializerMap.put("expectedReceiptDate", (n) -> { currentObject.setExpectedReceiptDate(n.getLocalDateValue()); });
        deserializerMap.put("invoiceDiscountAllocation", (n) -> { currentObject.setInvoiceDiscountAllocation(n.getBigDecimalValue()); });
        deserializerMap.put("item", (n) -> { currentObject.setItem(n.getObjectValue(Item::createFromDiscriminatorValue)); });
        deserializerMap.put("itemId", (n) -> { currentObject.setItemId(n.getStringValue()); });
        deserializerMap.put("lineType", (n) -> { currentObject.setLineType(n.getStringValue()); });
        deserializerMap.put("netAmount", (n) -> { currentObject.setNetAmount(n.getBigDecimalValue()); });
        deserializerMap.put("netAmountIncludingTax", (n) -> { currentObject.setNetAmountIncludingTax(n.getBigDecimalValue()); });
        deserializerMap.put("netTaxAmount", (n) -> { currentObject.setNetTaxAmount(n.getBigDecimalValue()); });
        deserializerMap.put("quantity", (n) -> { currentObject.setQuantity(n.getBigDecimalValue()); });
        deserializerMap.put("sequence", (n) -> { currentObject.setSequence(n.getIntegerValue()); });
        deserializerMap.put("taxCode", (n) -> { currentObject.setTaxCode(n.getStringValue()); });
        deserializerMap.put("taxPercent", (n) -> { currentObject.setTaxPercent(n.getBigDecimalValue()); });
