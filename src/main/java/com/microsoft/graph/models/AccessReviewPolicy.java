...
/**
 * The class for the Access Review Policy.
 */
public class AccessReviewPolicy extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public Boolean isGroupOwnerManagementEnabled;
