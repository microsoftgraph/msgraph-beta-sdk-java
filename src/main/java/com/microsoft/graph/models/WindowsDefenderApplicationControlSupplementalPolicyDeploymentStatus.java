...
public class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deploymentStatus", (n) -> { currentObject.setDeploymentStatus(n.getEnumValue(WindowsDefenderApplicationControlSupplementalPolicyStatuses.class)); });
        ...
        deserializerMap.put("policy", (n) -> { currentObject.setPolicy(n.getObjectValue(WindowsDefenderApplicationControlSupplementalPolicy::createFromDiscriminatorValue)); });
