...
public class DeviceEnrollmentNotificationConfiguration extends DeviceEnrollmentConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("brandingOptions", (n) -> { currentObject.setBrandingOptions(n.getEnumValue(EnrollmentNotificationBrandingOptions.class)); });
        deserializerMap.put("defaultLocale", (n) -> { currentObject.setDefaultLocale(n.getStringValue()); });
        deserializerMap.put("notificationMessageTemplateId", (n) -> { currentObject.setNotificationMessageTemplateId(n.getStringValue()); });
        deserializerMap.put("notificationTemplates", (n) -> { currentObject.setNotificationTemplates(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("platformType", (n) -> { currentObject.setPlatformType(n.getEnumValue(EnrollmentRestrictionPlatformType.class)); });
        deserializerMap.put("templateType", (n) -> { currentObject.setTemplateType(n.getEnumValue(EnrollmentNotificationTemplateType.class)); });
