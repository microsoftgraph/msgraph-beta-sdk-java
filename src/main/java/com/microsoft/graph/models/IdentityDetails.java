...
public class IdentityDetails implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static IdentityDetails createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
