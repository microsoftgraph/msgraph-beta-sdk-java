...
public class DeviceManagementSettingDefinition extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("constraints", (n) -> { currentObject.setConstraints(n.getCollectionOfObjectValues(DeviceManagementConstraint::createFromDiscriminatorValue)); });
        deserializerMap.put("dependencies", (n) -> { currentObject.setDependencies(n.getCollectionOfObjectValues(DeviceManagementSettingDependency::createFromDiscriminatorValue)); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("documentationUrl", (n) -> { currentObject.setDocumentationUrl(n.getStringValue()); });
        deserializerMap.put("headerSubtitle", (n) -> { currentObject.setHeaderSubtitle(n.getStringValue()); });
        deserializerMap.put("headerTitle", (n) -> { currentObject.setHeaderTitle(n.getStringValue()); });
        deserializerMap.put("isTopLevel", (n) -> { currentObject.setIsTopLevel(n.getBooleanValue()); });
        deserializerMap.put("keywords", (n) -> { currentObject.setKeywords(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("placeholderText", (n) -> { currentObject.setPlaceholderText(n.getStringValue()); });
        deserializerMap.put("valueType", (n) -> { currentObject.setValueType(n.getEnumValue(DeviceManangementIntentValueType.class)); });
