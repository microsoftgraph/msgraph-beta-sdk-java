...
/**
 * The class for the Stale Sign In Alert Configuration.
 */
public class StaleSignInAlertConfiguration extends UnifiedRoleManagementAlertConfiguration implements IJsonBackedObject {
