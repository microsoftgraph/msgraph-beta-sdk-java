...
import com.microsoft.graph.models.ConditionalAccessAllExternalTenants;
import com.microsoft.graph.models.ConditionalAccessEnumeratedExternalTenants;
...
public class ConditionalAccessExternalTenants implements AdditionalDataHolder, Parsable {
    ...
    private ConditionalAccessExternalTenantsMembershipKind _membershipKind;
    ...
    public static ConditionalAccessExternalTenants createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ConditionalAccessExternalTenants currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(2);
        deserializerMap.put("membershipKind", (n) -> { currentObject.setMembershipKind(n.getEnumValue(ConditionalAccessExternalTenantsMembershipKind.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setMembershipKind(@javax.annotation.Nullable final ConditionalAccessExternalTenantsMembershipKind value) {
