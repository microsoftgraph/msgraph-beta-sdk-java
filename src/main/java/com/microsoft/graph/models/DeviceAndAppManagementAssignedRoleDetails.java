...
public class DeviceAndAppManagementAssignedRoleDetails implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("roleAssignmentIds", (n) -> { currentObject.setRoleAssignmentIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("roleDefinitionIds", (n) -> { currentObject.setRoleDefinitionIds(n.getCollectionOfPrimitiveValues(String.class)); });
