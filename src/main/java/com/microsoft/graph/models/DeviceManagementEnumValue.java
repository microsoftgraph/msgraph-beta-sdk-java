...
public class DeviceManagementEnumValue implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceManagementEnumValue createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
