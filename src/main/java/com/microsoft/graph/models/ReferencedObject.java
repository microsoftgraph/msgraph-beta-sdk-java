...
public class ReferencedObject implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("referencedObjectName", (n) -> { currentObject.setReferencedObjectName(n.getStringValue()); });
        deserializerMap.put("referencedProperty", (n) -> { currentObject.setReferencedProperty(n.getStringValue()); });
