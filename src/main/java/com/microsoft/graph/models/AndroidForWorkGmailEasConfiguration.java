...
public class AndroidForWorkGmailEasConfiguration extends AndroidForWorkEasEmailProfileBase implements Parsable {
    ...
    public static AndroidForWorkGmailEasConfiguration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidForWorkGmailEasConfiguration currentObject = this;
