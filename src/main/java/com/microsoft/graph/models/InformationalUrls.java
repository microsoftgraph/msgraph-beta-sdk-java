...
public class InformationalUrls implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static InformationalUrls createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public String getAppSignUpUrl() {
        return this.backingStore.get("appSignUpUrl");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("appSignUpUrl", (n) -> { this.setAppSignUpUrl(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { this.setOdataType(n.getStringValue()); });
        deserializerMap.put("singleSignOnDocumentationUrl", (n) -> { this.setSingleSignOnDocumentationUrl(n.getStringValue()); });
    ...
    public String getSingleSignOnDocumentationUrl() {
        return this.backingStore.get("singleSignOnDocumentationUrl");
    }
    /**
     ...
     */
    public void setAppSignUpUrl(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("appSignUpUrl", value);
    }
    /**
     ...
     */
    public void setSingleSignOnDocumentationUrl(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("singleSignOnDocumentationUrl", value);
    }
}
