...
public class InformationalUrls implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("appSignUpUrl", (n) -> { currentObject.setAppSignUpUrl(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("singleSignOnDocumentationUrl", (n) -> { currentObject.setSingleSignOnDocumentationUrl(n.getStringValue()); });
