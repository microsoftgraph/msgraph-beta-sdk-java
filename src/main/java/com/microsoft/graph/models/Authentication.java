...
public class Authentication extends Entity implements Parsable {
    ...
    private java.util.List<PasswordlessMicrosoftAuthenticatorAuthenticationMethod> _passwordlessMicrosoftAuthenticatorMethods;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("passwordlessMicrosoftAuthenticatorMethods", (n) -> { currentObject.setPasswordlessMicrosoftAuthenticatorMethods(n.getCollectionOfObjectValues(PasswordlessMicrosoftAuthenticatorAuthenticationMethod::createFromDiscriminatorValue)); });
