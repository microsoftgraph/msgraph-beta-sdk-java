...
public class InferenceData implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("confidenceScore", (n) -> { currentObject.setConfidenceScore(n.getDoubleValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("userHasVerifiedAccuracy", (n) -> { currentObject.setUserHasVerifiedAccuracy(n.getBooleanValue()); });
