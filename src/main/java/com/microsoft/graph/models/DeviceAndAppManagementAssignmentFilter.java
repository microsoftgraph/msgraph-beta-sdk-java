...
public class DeviceAndAppManagementAssignmentFilter extends Entity implements Parsable {
    ...
    private java.util.List<PayloadByFilter> _payloads;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("payloads", (n) -> { currentObject.setPayloads(n.getCollectionOfObjectValues(PayloadByFilter::createFromDiscriminatorValue)); });
