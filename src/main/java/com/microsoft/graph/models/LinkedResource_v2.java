...
public class LinkedResource_v2 extends Entity implements Parsable {
    ...
    public static LinkedResource_v2 createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final LinkedResource_v2 currentObject = this;
