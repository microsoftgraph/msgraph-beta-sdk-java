...
public class EvaluateLabelJobResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("responsiblePolicy", (n) -> { currentObject.setResponsiblePolicy(n.getObjectValue(ResponsiblePolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("responsibleSensitiveTypes", (n) -> { currentObject.setResponsibleSensitiveTypes(n.getCollectionOfObjectValues(ResponsibleSensitiveType::createFromDiscriminatorValue)); });
        deserializerMap.put("sensitivityLabel", (n) -> { currentObject.setSensitivityLabel(n.getObjectValue(MatchingLabel::createFromDiscriminatorValue)); });
