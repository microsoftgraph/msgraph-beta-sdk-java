...
/**
 * The class for the Skype For Business Participant Activity Minute Counts.
 */
public class SkypeForBusinessParticipantActivityMinuteCounts extends Entity implements IJsonBackedObject {
