...
public class OnlineMeetingBase extends Entity implements IJsonBackedObject {
    ...
    /**
     * The Is End To End Encryption Enabled.
     * 
     */
    @SerializedName(value = "isEndToEndEncryptionEnabled", alternate = {"IsEndToEndEncryptionEnabled"})
    @Expose
	@Nullable
    public Boolean isEndToEndEncryptionEnabled;
