...
public class ParticipantInfo implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endpointType", (n) -> { currentObject.setEndpointType(n.getEnumValue(EndpointType.class)); });
        deserializerMap.put("identity", (n) -> { currentObject.setIdentity(n.getObjectValue(IdentitySet::createFromDiscriminatorValue)); });
        deserializerMap.put("languageId", (n) -> { currentObject.setLanguageId(n.getStringValue()); });
        deserializerMap.put("nonAnonymizedIdentity", (n) -> { currentObject.setNonAnonymizedIdentity(n.getObjectValue(IdentitySet::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("participantId", (n) -> { currentObject.setParticipantId(n.getStringValue()); });
        deserializerMap.put("platformId", (n) -> { currentObject.setPlatformId(n.getStringValue()); });
