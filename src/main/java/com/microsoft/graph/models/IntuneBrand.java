...
public class IntuneBrand implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(29) {{
            ...
            this.put("showConfigurationManagerApps", (n) -> { currentObject.setShowConfigurationManagerApps(n.getBooleanValue()); });
