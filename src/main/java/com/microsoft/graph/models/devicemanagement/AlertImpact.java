...
public class AlertImpact implements AdditionalDataHolder, Parsable {
    ...
    public AlertImpact() {
        ...
        this.setOdataType("#microsoft.graph.deviceManagement.alertImpact");
    }
    /**
    ...
    public static AlertImpact createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AlertImpact currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(3);
        deserializerMap.put("aggregationType", (n) -> { currentObject.setAggregationType(n.getEnumValue(AggregationType.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setAggregationType(@javax.annotation.Nullable final AggregationType value) {
