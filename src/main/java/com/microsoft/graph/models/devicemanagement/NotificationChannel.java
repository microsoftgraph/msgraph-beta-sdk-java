...
public class NotificationChannel implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("notificationChannelType", (n) -> { currentObject.setNotificationChannelType(n.getEnumValue(NotificationChannelType.class)); });
        deserializerMap.put("notificationReceivers", (n) -> { currentObject.setNotificationReceivers(n.getCollectionOfObjectValues(NotificationReceiver::createFromDiscriminatorValue)); });
