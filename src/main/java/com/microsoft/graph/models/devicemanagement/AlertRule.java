...
public class AlertRule extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isSystemRule", (n) -> { currentObject.setIsSystemRule(n.getBooleanValue()); });
        deserializerMap.put("notificationChannels", (n) -> { currentObject.setNotificationChannels(n.getCollectionOfObjectValues(NotificationChannel::createFromDiscriminatorValue)); });
        deserializerMap.put("severity", (n) -> { currentObject.setSeverity(n.getEnumValue(RuleSeverityType.class)); });
        deserializerMap.put("threshold", (n) -> { currentObject.setThreshold(n.getObjectValue(RuleThreshold::createFromDiscriminatorValue)); });
