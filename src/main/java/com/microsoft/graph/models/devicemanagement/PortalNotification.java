...
public class PortalNotification implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alertRecordId", (n) -> { currentObject.setAlertRecordId(n.getStringValue()); });
        deserializerMap.put("alertRuleId", (n) -> { currentObject.setAlertRuleId(n.getStringValue()); });
        deserializerMap.put("alertRuleName", (n) -> { currentObject.setAlertRuleName(n.getStringValue()); });
        ...
        deserializerMap.put("isPortalNotificationSent", (n) -> { currentObject.setIsPortalNotificationSent(n.getBooleanValue()); });
