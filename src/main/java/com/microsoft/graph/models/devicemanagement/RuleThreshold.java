...
public class RuleThreshold implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("aggregation", (n) -> { currentObject.setAggregation(n.getEnumValue(AggregationType.class)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("operator", (n) -> { currentObject.setOperator(n.getEnumValue(OperatorType.class)); });
        deserializerMap.put("target", (n) -> { currentObject.setTarget(n.getIntegerValue()); });
