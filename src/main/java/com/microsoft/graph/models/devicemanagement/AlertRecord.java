...
public class AlertRecord extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alertImpact", (n) -> { currentObject.setAlertImpact(n.getObjectValue(AlertImpact::createFromDiscriminatorValue)); });
        deserializerMap.put("alertRuleId", (n) -> { currentObject.setAlertRuleId(n.getStringValue()); });
        deserializerMap.put("alertRuleTemplate", (n) -> { currentObject.setAlertRuleTemplate(n.getEnumValue(AlertRuleTemplate.class)); });
        ...
        deserializerMap.put("severity", (n) -> { currentObject.setSeverity(n.getEnumValue(RuleSeverityType.class)); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(AlertStatusType.class)); });
