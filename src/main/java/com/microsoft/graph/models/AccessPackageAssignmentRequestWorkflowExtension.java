...
/**
 * The class for the Access Package Assignment Request Workflow Extension.
 */
public class AccessPackageAssignmentRequestWorkflowExtension extends CustomCalloutExtension implements IJsonBackedObject {
