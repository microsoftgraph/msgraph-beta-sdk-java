...
public class AdminAppsAndServices extends Entity implements Parsable {
    ...
    public static AdminAppsAndServices createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setSettings(@jakarta.annotation.Nullable final AppsAndServicesSettings value) {
        this.settings = value;
    }
}
