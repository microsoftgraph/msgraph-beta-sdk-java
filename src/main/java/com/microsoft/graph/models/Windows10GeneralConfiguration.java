...
public class Windows10GeneralConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activateAppsWithVoice", (n) -> { currentObject.setActivateAppsWithVoice(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("antiTheftModeBlocked", (n) -> { currentObject.setAntiTheftModeBlocked(n.getBooleanValue()); });
        deserializerMap.put("appManagementMSIAllowUserControlOverInstall", (n) -> { currentObject.setAppManagementMSIAllowUserControlOverInstall(n.getBooleanValue()); });
        deserializerMap.put("appManagementMSIAlwaysInstallWithElevatedPrivileges", (n) -> { currentObject.setAppManagementMSIAlwaysInstallWithElevatedPrivileges(n.getBooleanValue()); });
        deserializerMap.put("appManagementPackageFamilyNamesToLaunchAfterLogOn", (n) -> { currentObject.setAppManagementPackageFamilyNamesToLaunchAfterLogOn(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("authenticationAllowSecondaryDevice", (n) -> { currentObject.setAuthenticationAllowSecondaryDevice(n.getBooleanValue()); });
        deserializerMap.put("authenticationPreferredAzureADTenantDomainName", (n) -> { currentObject.setAuthenticationPreferredAzureADTenantDomainName(n.getStringValue()); });
        deserializerMap.put("authenticationWebSignIn", (n) -> { currentObject.setAuthenticationWebSignIn(n.getEnumValue(Enablement.class)); });
        ...
        deserializerMap.put("bluetoothBlockPromptedProximalConnections", (n) -> { currentObject.setBluetoothBlockPromptedProximalConnections(n.getBooleanValue()); });
        ...
        deserializerMap.put("cellularData", (n) -> { currentObject.setCellularData(n.getEnumValue(ConfigurationUsage.class)); });
        ...
        deserializerMap.put("configureTimeZone", (n) -> { currentObject.setConfigureTimeZone(n.getStringValue()); });
        ...
        deserializerMap.put("cryptographyAllowFipsAlgorithmPolicy", (n) -> { currentObject.setCryptographyAllowFipsAlgorithmPolicy(n.getBooleanValue()); });
        deserializerMap.put("dataProtectionBlockDirectMemoryAccess", (n) -> { currentObject.setDataProtectionBlockDirectMemoryAccess(n.getBooleanValue()); });
        deserializerMap.put("defenderBlockEndUserAccess", (n) -> { currentObject.setDefenderBlockEndUserAccess(n.getBooleanValue()); });
        deserializerMap.put("defenderBlockOnAccessProtection", (n) -> { currentObject.setDefenderBlockOnAccessProtection(n.getBooleanValue()); });
        ...
        deserializerMap.put("defenderCloudExtendedTimeout", (n) -> { currentObject.setDefenderCloudExtendedTimeout(n.getIntegerValue()); });
        ...
        deserializerMap.put("defenderPotentiallyUnwantedAppAction", (n) -> { currentObject.setDefenderPotentiallyUnwantedAppAction(n.getEnumValue(DefenderPotentiallyUnwantedAppAction.class)); });
        deserializerMap.put("defenderPotentiallyUnwantedAppActionSetting", (n) -> { currentObject.setDefenderPotentiallyUnwantedAppActionSetting(n.getEnumValue(DefenderProtectionType.class)); });
        ...
        deserializerMap.put("defenderScheduleScanEnableLowCpuPriority", (n) -> { currentObject.setDefenderScheduleScanEnableLowCpuPriority(n.getBooleanValue()); });
        ...
        deserializerMap.put("displayAppListWithGdiDPIScalingTurnedOff", (n) -> { currentObject.setDisplayAppListWithGdiDPIScalingTurnedOff(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("displayAppListWithGdiDPIScalingTurnedOn", (n) -> { currentObject.setDisplayAppListWithGdiDPIScalingTurnedOn(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("edgeBlockEditFavorites", (n) -> { currentObject.setEdgeBlockEditFavorites(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockExtensions", (n) -> { currentObject.setEdgeBlockExtensions(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockFullScreenMode", (n) -> { currentObject.setEdgeBlockFullScreenMode(n.getBooleanValue()); });
        ...
        deserializerMap.put("edgeBlockPrelaunch", (n) -> { currentObject.setEdgeBlockPrelaunch(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockPrinting", (n) -> { currentObject.setEdgeBlockPrinting(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockSavingHistory", (n) -> { currentObject.setEdgeBlockSavingHistory(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockSearchEngineCustomization", (n) -> { currentObject.setEdgeBlockSearchEngineCustomization(n.getBooleanValue()); });
        ...
        deserializerMap.put("edgeBlockSideloadingExtensions", (n) -> { currentObject.setEdgeBlockSideloadingExtensions(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockTabPreloading", (n) -> { currentObject.setEdgeBlockTabPreloading(n.getBooleanValue()); });
        deserializerMap.put("edgeBlockWebContentOnNewTabPage", (n) -> { currentObject.setEdgeBlockWebContentOnNewTabPage(n.getBooleanValue()); });
        ...
        deserializerMap.put("edgeFavoritesBarVisibility", (n) -> { currentObject.setEdgeFavoritesBarVisibility(n.getEnumValue(VisibilitySetting.class)); });
        deserializerMap.put("edgeFavoritesListLocation", (n) -> { currentObject.setEdgeFavoritesListLocation(n.getStringValue()); });
        deserializerMap.put("edgeFirstRunUrl", (n) -> { currentObject.setEdgeFirstRunUrl(n.getStringValue()); });
        deserializerMap.put("edgeHomeButtonConfiguration", (n) -> { currentObject.setEdgeHomeButtonConfiguration(n.getObjectValue(EdgeHomeButtonConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("edgeHomeButtonConfigurationEnabled", (n) -> { currentObject.setEdgeHomeButtonConfigurationEnabled(n.getBooleanValue()); });
        deserializerMap.put("edgeHomepageUrls", (n) -> { currentObject.setEdgeHomepageUrls(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("edgeKioskModeRestriction", (n) -> { currentObject.setEdgeKioskModeRestriction(n.getEnumValue(EdgeKioskModeRestrictionType.class)); });
        deserializerMap.put("edgeKioskResetAfterIdleTimeInMinutes", (n) -> { currentObject.setEdgeKioskResetAfterIdleTimeInMinutes(n.getIntegerValue()); });
        deserializerMap.put("edgeNewTabPageURL", (n) -> { currentObject.setEdgeNewTabPageURL(n.getStringValue()); });
        deserializerMap.put("edgeOpensWith", (n) -> { currentObject.setEdgeOpensWith(n.getEnumValue(EdgeOpenOptions.class)); });
        deserializerMap.put("edgePreventCertificateErrorOverride", (n) -> { currentObject.setEdgePreventCertificateErrorOverride(n.getBooleanValue()); });
        deserializerMap.put("edgeRequiredExtensionPackageFamilyNames", (n) -> { currentObject.setEdgeRequiredExtensionPackageFamilyNames(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("edgeShowMessageWhenOpeningInternetExplorerSites", (n) -> { currentObject.setEdgeShowMessageWhenOpeningInternetExplorerSites(n.getEnumValue(InternetExplorerMessageSetting.class)); });
        ...
        deserializerMap.put("edgeTelemetryForMicrosoft365Analytics", (n) -> { currentObject.setEdgeTelemetryForMicrosoft365Analytics(n.getEnumValue(EdgeTelemetryMode.class)); });
        deserializerMap.put("enableAutomaticRedeployment", (n) -> { currentObject.setEnableAutomaticRedeployment(n.getBooleanValue()); });
        deserializerMap.put("energySaverOnBatteryThresholdPercentage", (n) -> { currentObject.setEnergySaverOnBatteryThresholdPercentage(n.getIntegerValue()); });
        deserializerMap.put("energySaverPluggedInThresholdPercentage", (n) -> { currentObject.setEnergySaverPluggedInThresholdPercentage(n.getIntegerValue()); });
        ...
        deserializerMap.put("experienceDoNotSyncBrowserSettings", (n) -> { currentObject.setExperienceDoNotSyncBrowserSettings(n.getEnumValue(BrowserSyncSetting.class)); });
        deserializerMap.put("findMyFiles", (n) -> { currentObject.setFindMyFiles(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("gameDvrBlocked", (n) -> { currentObject.setGameDvrBlocked(n.getBooleanValue()); });
        deserializerMap.put("inkWorkspaceAccess", (n) -> { currentObject.setInkWorkspaceAccess(n.getEnumValue(InkAccessSetting.class)); });
        deserializerMap.put("inkWorkspaceAccessState", (n) -> { currentObject.setInkWorkspaceAccessState(n.getEnumValue(StateManagementSetting.class)); });
        deserializerMap.put("inkWorkspaceBlockSuggestedApps", (n) -> { currentObject.setInkWorkspaceBlockSuggestedApps(n.getBooleanValue()); });
        ...
        deserializerMap.put("lockScreenActivateAppsWithVoice", (n) -> { currentObject.setLockScreenActivateAppsWithVoice(n.getEnumValue(Enablement.class)); });
        ...
        deserializerMap.put("messagingBlockMMS", (n) -> { currentObject.setMessagingBlockMMS(n.getBooleanValue()); });
        deserializerMap.put("messagingBlockRichCommunicationServices", (n) -> { currentObject.setMessagingBlockRichCommunicationServices(n.getBooleanValue()); });
        deserializerMap.put("messagingBlockSync", (n) -> { currentObject.setMessagingBlockSync(n.getBooleanValue()); });
        ...
        deserializerMap.put("microsoftAccountSignInAssistantSettings", (n) -> { currentObject.setMicrosoftAccountSignInAssistantSettings(n.getEnumValue(SignInAssistantOptions.class)); });
        ...
        deserializerMap.put("passwordMinimumAgeInDays", (n) -> { currentObject.setPasswordMinimumAgeInDays(n.getIntegerValue()); });
        ...
        deserializerMap.put("powerButtonActionOnBattery", (n) -> { currentObject.setPowerButtonActionOnBattery(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("powerButtonActionPluggedIn", (n) -> { currentObject.setPowerButtonActionPluggedIn(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("powerHybridSleepOnBattery", (n) -> { currentObject.setPowerHybridSleepOnBattery(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("powerHybridSleepPluggedIn", (n) -> { currentObject.setPowerHybridSleepPluggedIn(n.getEnumValue(Enablement.class)); });
        deserializerMap.put("powerLidCloseActionOnBattery", (n) -> { currentObject.setPowerLidCloseActionOnBattery(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("powerLidCloseActionPluggedIn", (n) -> { currentObject.setPowerLidCloseActionPluggedIn(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("powerSleepButtonActionOnBattery", (n) -> { currentObject.setPowerSleepButtonActionOnBattery(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("powerSleepButtonActionPluggedIn", (n) -> { currentObject.setPowerSleepButtonActionPluggedIn(n.getEnumValue(PowerActionType.class)); });
        deserializerMap.put("printerBlockAddition", (n) -> { currentObject.setPrinterBlockAddition(n.getBooleanValue()); });
        deserializerMap.put("printerDefaultName", (n) -> { currentObject.setPrinterDefaultName(n.getStringValue()); });
        deserializerMap.put("printerNames", (n) -> { currentObject.setPrinterNames(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("privacyAccessControls", (n) -> { currentObject.setPrivacyAccessControls(n.getCollectionOfObjectValues(WindowsPrivacyDataAccessControlItem::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("privacyBlockActivityFeed", (n) -> { currentObject.setPrivacyBlockActivityFeed(n.getBooleanValue()); });
        ...
        deserializerMap.put("privacyBlockPublishUserActivities", (n) -> { currentObject.setPrivacyBlockPublishUserActivities(n.getBooleanValue()); });
        deserializerMap.put("privacyDisableLaunchExperience", (n) -> { currentObject.setPrivacyDisableLaunchExperience(n.getBooleanValue()); });
        ...
        deserializerMap.put("searchBlockWebResults", (n) -> { currentObject.setSearchBlockWebResults(n.getBooleanValue()); });
        ...
        deserializerMap.put("searchDisableLocation", (n) -> { currentObject.setSearchDisableLocation(n.getBooleanValue()); });
        deserializerMap.put("searchDisableUseLocation", (n) -> { currentObject.setSearchDisableUseLocation(n.getBooleanValue()); });
        ...
        deserializerMap.put("securityBlockAzureADJoinedDevicesAutoEncryption", (n) -> { currentObject.setSecurityBlockAzureADJoinedDevicesAutoEncryption(n.getBooleanValue()); });
        ...
        deserializerMap.put("smartScreenAppInstallControl", (n) -> { currentObject.setSmartScreenAppInstallControl(n.getEnumValue(AppInstallControlType.class)); });
        ...
        deserializerMap.put("systemTelemetryProxyServer", (n) -> { currentObject.setSystemTelemetryProxyServer(n.getStringValue()); });
        deserializerMap.put("taskManagerBlockEndTask", (n) -> { currentObject.setTaskManagerBlockEndTask(n.getBooleanValue()); });
        ...
        deserializerMap.put("windows10AppsForceUpdateSchedule", (n) -> { currentObject.setWindows10AppsForceUpdateSchedule(n.getObjectValue(Windows10AppsForceUpdateSchedule::createFromDiscriminatorValue)); });
