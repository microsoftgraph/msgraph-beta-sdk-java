...
public class DlpPoliciesJobResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("auditCorrelationId", (n) -> { currentObject.setAuditCorrelationId(n.getStringValue()); });
        deserializerMap.put("evaluationDateTime", (n) -> { currentObject.setEvaluationDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("matchingRules", (n) -> { currentObject.setMatchingRules(n.getCollectionOfObjectValues(MatchingDlpRule::createFromDiscriminatorValue)); });
