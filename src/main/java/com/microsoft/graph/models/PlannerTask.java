...
public class PlannerTask extends PlannerDelta implements Parsable {
    ...
    private PlannerTaskCreation _creationSource;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("creationSource", (n) -> { currentObject.setCreationSource(n.getObjectValue(PlannerTaskCreation::createFromDiscriminatorValue)); });
