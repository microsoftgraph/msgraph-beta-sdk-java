...
public class DeliveryOptimizationBandwidthBusinessHoursLimit implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("bandwidthBeginBusinessHours", (n) -> { currentObject.setBandwidthBeginBusinessHours(n.getIntegerValue()); });
        deserializerMap.put("bandwidthEndBusinessHours", (n) -> { currentObject.setBandwidthEndBusinessHours(n.getIntegerValue()); });
        deserializerMap.put("bandwidthPercentageDuringBusinessHours", (n) -> { currentObject.setBandwidthPercentageDuringBusinessHours(n.getIntegerValue()); });
        deserializerMap.put("bandwidthPercentageOutsideBusinessHours", (n) -> { currentObject.setBandwidthPercentageOutsideBusinessHours(n.getIntegerValue()); });
