...
public class EntitlementManagementSettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("daysUntilExternalUserDeletedAfterBlocked", (n) -> { currentObject.setDaysUntilExternalUserDeletedAfterBlocked(n.getIntegerValue()); });
        deserializerMap.put("externalUserLifecycleAction", (n) -> { currentObject.setExternalUserLifecycleAction(n.getStringValue()); });
