...
public class GovernanceNotificationTemplate implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public String getCulture() {
        return this.backingStore.get("culture");
    }
    /**
    ...
    public void setCulture(@jakarta.annotation.Nullable final String value) {
        this.backingStore.set("culture", value);
    }
    /**
