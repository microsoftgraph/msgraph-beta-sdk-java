...
/**
 * The class for the Tenant Reference Remove Personal Data Parameter Set.
 */
public class TenantReferenceRemovePersonalDataParameterSet {

    /**
     * Instiaciates a new TenantReferenceRemovePersonalDataParameterSet
     */
     ...
     */
    protected TenantReferenceRemovePersonalDataParameterSet(@Nonnull final TenantReferenceRemovePersonalDataParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the TenantReferenceRemovePersonalDataParameterSet
     */
    public static final class TenantReferenceRemovePersonalDataParameterSetBuilder {
        /**
         * Instanciates a new TenantReferenceRemovePersonalDataParameterSetBuilder
         */
        @Nullable
