...
public class ManagedAppProtection extends ManagedAppPolicy implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("mobileThreatDefensePartnerPriority", (n) -> { currentObject.setMobileThreatDefensePartnerPriority(n.getEnumValue(MobileThreatDefensePartnerPriority.class)); });
