...
public class OnPremisesAgent extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(AgentStatus.class)); });
        deserializerMap.put("supportedPublishingTypes", (n) -> { currentObject.setSupportedPublishingTypes(n.getCollectionOfEnumValues(OnPremisesPublishingType.class)); });
