...
public class AppLogCollectionRequest extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customLogFolders", (n) -> { currentObject.setCustomLogFolders(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("errorMessage", (n) -> { currentObject.setErrorMessage(n.getStringValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(AppLogUploadState.class)); });
