...
public class SynchronizationTemplate extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("default", (n) -> { currentObject.setDefault(n.getBooleanValue()); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("discoverable", (n) -> { currentObject.setDiscoverable(n.getBooleanValue()); });
        deserializerMap.put("factoryTag", (n) -> { currentObject.setFactoryTag(n.getStringValue()); });
        ...
        deserializerMap.put("schema", (n) -> { currentObject.setSchema(n.getObjectValue(SynchronizationSchema::createFromDiscriminatorValue)); });
