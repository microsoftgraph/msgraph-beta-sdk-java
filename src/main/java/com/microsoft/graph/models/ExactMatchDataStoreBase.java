...
public class ExactMatchDataStoreBase extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { currentObject.setColumns(n.getCollectionOfObjectValues(ExactDataMatchStoreColumn::createFromDiscriminatorValue)); });
        deserializerMap.put("dataLastUpdatedDateTime", (n) -> { currentObject.setDataLastUpdatedDateTime(n.getOffsetDateTimeValue()); });
