...
public class KeyStringValuePair extends KeyTypedValuePair implements Parsable {
    ...
    public static KeyStringValuePair createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final KeyStringValuePair currentObject = this;
