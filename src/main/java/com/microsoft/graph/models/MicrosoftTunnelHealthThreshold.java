...
public class MicrosoftTunnelHealthThreshold extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("defaultHealthyThreshold", (n) -> { currentObject.setDefaultHealthyThreshold(n.getLongValue()); });
        deserializerMap.put("defaultUnhealthyThreshold", (n) -> { currentObject.setDefaultUnhealthyThreshold(n.getLongValue()); });
        deserializerMap.put("healthyThreshold", (n) -> { currentObject.setHealthyThreshold(n.getLongValue()); });
        deserializerMap.put("unhealthyThreshold", (n) -> { currentObject.setUnhealthyThreshold(n.getLongValue()); });
