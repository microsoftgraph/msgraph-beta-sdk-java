...
public class PlannerRuleOverride implements AdditionalDataHolder, Parsable {
    ...
    /** The rules property */
    private java.util.List<String> _rules;
    /**
    ...
    public static PlannerRuleOverride createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRules(@javax.annotation.Nullable final java.util.List<String> value) {
        this._rules = value;
    }
}
