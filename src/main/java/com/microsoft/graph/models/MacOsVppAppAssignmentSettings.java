...
/**
 * The class for the Mac Os Vpp App Assignment Settings.
 */
public class MacOsVppAppAssignmentSettings extends MobileAppAssignmentSettings implements IJsonBackedObject {
