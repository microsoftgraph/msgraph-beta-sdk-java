...
public class SalesQuote extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acceptedDate", (n) -> { currentObject.setAcceptedDate(n.getLocalDateValue()); });
        deserializerMap.put("billingPostalAddress", (n) -> { currentObject.setBillingPostalAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        deserializerMap.put("billToCustomerId", (n) -> { currentObject.setBillToCustomerId(n.getStringValue()); });
        deserializerMap.put("billToCustomerNumber", (n) -> { currentObject.setBillToCustomerNumber(n.getStringValue()); });
        deserializerMap.put("billToName", (n) -> { currentObject.setBillToName(n.getStringValue()); });
        deserializerMap.put("currency", (n) -> { currentObject.setCurrency(n.getObjectValue(Currency::createFromDiscriminatorValue)); });
        deserializerMap.put("currencyCode", (n) -> { currentObject.setCurrencyCode(n.getStringValue()); });
        deserializerMap.put("currencyId", (n) -> { currentObject.setCurrencyId(n.getStringValue()); });
        ...
        deserializerMap.put("customerName", (n) -> { currentObject.setCustomerName(n.getStringValue()); });
        deserializerMap.put("customerNumber", (n) -> { currentObject.setCustomerNumber(n.getStringValue()); });
        deserializerMap.put("discountAmount", (n) -> { currentObject.setDiscountAmount(n.getBigDecimalValue()); });
        deserializerMap.put("documentDate", (n) -> { currentObject.setDocumentDate(n.getLocalDateValue()); });
        deserializerMap.put("dueDate", (n) -> { currentObject.setDueDate(n.getLocalDateValue()); });
        ...
        deserializerMap.put("paymentTerm", (n) -> { currentObject.setPaymentTerm(n.getObjectValue(PaymentTerm::createFromDiscriminatorValue)); });
        deserializerMap.put("paymentTermsId", (n) -> { currentObject.setPaymentTermsId(n.getStringValue()); });
        deserializerMap.put("phoneNumber", (n) -> { currentObject.setPhoneNumber(n.getStringValue()); });
        deserializerMap.put("salesperson", (n) -> { currentObject.setSalesperson(n.getStringValue()); });
        deserializerMap.put("salesQuoteLines", (n) -> { currentObject.setSalesQuoteLines(n.getCollectionOfObjectValues(SalesQuoteLine::createFromDiscriminatorValue)); });
        deserializerMap.put("sellingPostalAddress", (n) -> { currentObject.setSellingPostalAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        deserializerMap.put("sentDate", (n) -> { currentObject.setSentDate(n.getOffsetDateTimeValue()); });
        deserializerMap.put("shipmentMethod", (n) -> { currentObject.setShipmentMethod(n.getObjectValue(ShipmentMethod::createFromDiscriminatorValue)); });
        deserializerMap.put("shipmentMethodId", (n) -> { currentObject.setShipmentMethodId(n.getStringValue()); });
        deserializerMap.put("shippingPostalAddress", (n) -> { currentObject.setShippingPostalAddress(n.getObjectValue(PostalAddressType::createFromDiscriminatorValue)); });
        deserializerMap.put("shipToContact", (n) -> { currentObject.setShipToContact(n.getStringValue()); });
        deserializerMap.put("shipToName", (n) -> { currentObject.setShipToName(n.getStringValue()); });
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getStringValue()); });
        deserializerMap.put("totalAmountExcludingTax", (n) -> { currentObject.setTotalAmountExcludingTax(n.getBigDecimalValue()); });
        deserializerMap.put("totalAmountIncludingTax", (n) -> { currentObject.setTotalAmountIncludingTax(n.getBigDecimalValue()); });
        deserializerMap.put("totalTaxAmount", (n) -> { currentObject.setTotalTaxAmount(n.getBigDecimalValue()); });
        deserializerMap.put("validUntilDate", (n) -> { currentObject.setValidUntilDate(n.getLocalDateValue()); });
