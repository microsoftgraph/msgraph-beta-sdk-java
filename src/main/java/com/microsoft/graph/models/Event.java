...
public class Event extends OutlookItem implements Parsable {
    ...
    private java.util.List<String> _cancelledOccurrences;
    /** The date, time, and time zone that the event ends. By default, the end time is in UTC. */
    private DateTimeTimeZone _end;
    /** The exceptionOccurrences property */
    private java.util.List<Event> _exceptionOccurrences;
    ...
    public java.util.List<String> getCancelledOccurrences() {
        return this._cancelledOccurrences;
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("uid", (n) -> { this.setUid(n.getStringValue()); });
