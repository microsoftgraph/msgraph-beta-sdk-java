...
public class AwsLambda extends AwsIdentity implements Parsable {
    /**
     * The resource property
     */
    private AwsAuthorizationSystemResource resource;
    /**
    ...
    public static AwsLambda createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
