...
public class UnifiedRoleManagementPolicyAssignment extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("policy", (n) -> { currentObject.setPolicy(n.getObjectValue(UnifiedRoleManagementPolicy::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("scopeId", (n) -> { currentObject.setScopeId(n.getStringValue()); });
