...
public class WindowsDefenderAdvancedThreatProtectionConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("advancedThreatProtectionAutoPopulateOnboardingBlob", (n) -> { currentObject.setAdvancedThreatProtectionAutoPopulateOnboardingBlob(n.getBooleanValue()); });
        deserializerMap.put("advancedThreatProtectionOffboardingBlob", (n) -> { currentObject.setAdvancedThreatProtectionOffboardingBlob(n.getStringValue()); });
        deserializerMap.put("advancedThreatProtectionOffboardingFilename", (n) -> { currentObject.setAdvancedThreatProtectionOffboardingFilename(n.getStringValue()); });
        deserializerMap.put("advancedThreatProtectionOnboardingBlob", (n) -> { currentObject.setAdvancedThreatProtectionOnboardingBlob(n.getStringValue()); });
        deserializerMap.put("advancedThreatProtectionOnboardingFilename", (n) -> { currentObject.setAdvancedThreatProtectionOnboardingFilename(n.getStringValue()); });
