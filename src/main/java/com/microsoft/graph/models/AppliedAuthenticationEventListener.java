...
public class AppliedAuthenticationEventListener implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("eventType", (n) -> { currentObject.setEventType(n.getEnumValue(AuthenticationEventType.class)); });
        deserializerMap.put("executedListenerId", (n) -> { currentObject.setExecutedListenerId(n.getStringValue()); });
        deserializerMap.put("handlerResult", (n) -> { currentObject.setHandlerResult(n.getObjectValue(AuthenticationEventHandlerResult::createFromDiscriminatorValue)); });
