...
public class ExactMatchSession extends ExactMatchSessionBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("checksum", (n) -> { currentObject.setChecksum(n.getStringValue()); });
        deserializerMap.put("dataUploadURI", (n) -> { currentObject.setDataUploadURI(n.getStringValue()); });
        ...
        deserializerMap.put("rowsPerBlock", (n) -> { currentObject.setRowsPerBlock(n.getIntegerValue()); });
        deserializerMap.put("salt", (n) -> { currentObject.setSalt(n.getStringValue()); });
        deserializerMap.put("uploadAgent", (n) -> { currentObject.setUploadAgent(n.getObjectValue(ExactMatchUploadAgent::createFromDiscriminatorValue)); });
        deserializerMap.put("uploadAgentId", (n) -> { currentObject.setUploadAgentId(n.getStringValue()); });
