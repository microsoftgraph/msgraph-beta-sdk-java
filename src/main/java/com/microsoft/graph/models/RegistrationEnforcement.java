...
public class RegistrationEnforcement implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationMethodsRegistrationCampaign", (n) -> { currentObject.setAuthenticationMethodsRegistrationCampaign(n.getObjectValue(AuthenticationMethodsRegistrationCampaign::createFromDiscriminatorValue)); });
