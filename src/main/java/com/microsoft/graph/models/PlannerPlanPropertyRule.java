...
public class PlannerPlanPropertyRule extends PlannerPropertyRule implements Parsable {
    ...
    private java.util.List<String> _buckets;
    /** The categoryDescriptions property */
    private PlannerFieldRules _categoryDescriptions;
    /** The tasks property */
    private java.util.List<String> _tasks;
    /** The title property */
    private PlannerFieldRules _title;
    /**
