...
/**
 * The class for the Windows Management App Set As Managed Installer Parameter Set.
 */
public class WindowsManagementAppSetAsManagedInstallerParameterSet {

    /**
     * Instiaciates a new WindowsManagementAppSetAsManagedInstallerParameterSet
     */
     ...
     */
    protected WindowsManagementAppSetAsManagedInstallerParameterSet(@Nonnull final WindowsManagementAppSetAsManagedInstallerParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the WindowsManagementAppSetAsManagedInstallerParameterSet
     */
    public static final class WindowsManagementAppSetAsManagedInstallerParameterSetBuilder {
        /**
         * Instanciates a new WindowsManagementAppSetAsManagedInstallerParameterSetBuilder
         */
        @Nullable
