...
public class ZebraFotaConnector extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enrollmentAuthorizationUrl", (n) -> { currentObject.setEnrollmentAuthorizationUrl(n.getStringValue()); });
        deserializerMap.put("enrollmentToken", (n) -> { currentObject.setEnrollmentToken(n.getStringValue()); });
        deserializerMap.put("fotaAppsApproved", (n) -> { currentObject.setFotaAppsApproved(n.getBooleanValue()); });
        deserializerMap.put("lastSyncDateTime", (n) -> { currentObject.setLastSyncDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(ZebraFotaConnectorState.class)); });
