...
/**
 * The class for the Device Management Intent Get Customized Settings Parameter Set.
 */
public class DeviceManagementIntentGetCustomizedSettingsParameterSet {

    /**
     * Instiaciates a new DeviceManagementIntentGetCustomizedSettingsParameterSet
     */
     ...
     */
    protected DeviceManagementIntentGetCustomizedSettingsParameterSet(@Nonnull final DeviceManagementIntentGetCustomizedSettingsParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceManagementIntentGetCustomizedSettingsParameterSet
     */
    public static final class DeviceManagementIntentGetCustomizedSettingsParameterSetBuilder {
        /**
         * Instanciates a new DeviceManagementIntentGetCustomizedSettingsParameterSetBuilder
         */
        @Nullable
