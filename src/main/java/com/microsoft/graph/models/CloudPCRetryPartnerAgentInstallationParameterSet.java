...
/**
 * The class for the Cloud PCRetry Partner Agent Installation Parameter Set.
 */
public class CloudPCRetryPartnerAgentInstallationParameterSet {

    /**
     * Instiaciates a new CloudPCRetryPartnerAgentInstallationParameterSet
     */
     ...
     */
    protected CloudPCRetryPartnerAgentInstallationParameterSet(@Nonnull final CloudPCRetryPartnerAgentInstallationParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the CloudPCRetryPartnerAgentInstallationParameterSet
     */
    public static final class CloudPCRetryPartnerAgentInstallationParameterSetBuilder {
        /**
         * Instanciates a new CloudPCRetryPartnerAgentInstallationParameterSetBuilder
         */
        @Nullable
