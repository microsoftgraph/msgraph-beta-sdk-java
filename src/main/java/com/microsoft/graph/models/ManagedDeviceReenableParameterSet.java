...
/**
 * The class for the Managed Device Reenable Parameter Set.
 */
public class ManagedDeviceReenableParameterSet {

    /**
     * Instiaciates a new ManagedDeviceReenableParameterSet
     */
     ...
     */
    protected ManagedDeviceReenableParameterSet(@Nonnull final ManagedDeviceReenableParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ManagedDeviceReenableParameterSet
     */
    public static final class ManagedDeviceReenableParameterSetBuilder {
        /**
         * Instanciates a new ManagedDeviceReenableParameterSetBuilder
         */
        @Nullable
