...
public class KeyTypedValuePair implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static KeyTypedValuePair createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        ...
        if (mappingValueNode != null) {
            ...
            switch (mappingValue) {
                case "#microsoft.graph.keyBooleanValuePair": return new KeyBooleanValuePair();
                case "#microsoft.graph.keyIntegerValuePair": return new KeyIntegerValuePair();
                case "#microsoft.graph.keyRealValuePair": return new KeyRealValuePair();
                case "#microsoft.graph.keyStringValuePair": return new KeyStringValuePair();
            }
        }
        return new KeyTypedValuePair();
    }
    /**
