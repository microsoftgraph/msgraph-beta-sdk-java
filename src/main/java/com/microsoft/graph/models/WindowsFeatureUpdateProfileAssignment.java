...
public class WindowsFeatureUpdateProfileAssignment extends Entity implements Parsable {
    ...
    public static WindowsFeatureUpdateProfileAssignment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final WindowsFeatureUpdateProfileAssignment currentObject = this;
