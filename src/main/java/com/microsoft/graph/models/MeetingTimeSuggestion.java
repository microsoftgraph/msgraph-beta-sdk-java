...
public class MeetingTimeSuggestion implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("attendeeAvailability", (n) -> { currentObject.setAttendeeAvailability(n.getCollectionOfObjectValues(AttendeeAvailability::createFromDiscriminatorValue)); });
        deserializerMap.put("confidence", (n) -> { currentObject.setConfidence(n.getDoubleValue()); });
        ...
        deserializerMap.put("meetingTimeSlot", (n) -> { currentObject.setMeetingTimeSlot(n.getObjectValue(TimeSlot::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("order", (n) -> { currentObject.setOrder(n.getIntegerValue()); });
        deserializerMap.put("organizerAvailability", (n) -> { currentObject.setOrganizerAvailability(n.getEnumValue(FreeBusyStatus.class)); });
        deserializerMap.put("suggestionReason", (n) -> { currentObject.setSuggestionReason(n.getStringValue()); });
