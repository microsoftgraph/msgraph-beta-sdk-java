...
public class Win32LobAppProductCodeDetection extends Win32LobAppDetection implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("productCode", (n) -> { currentObject.setProductCode(n.getStringValue()); });
        deserializerMap.put("productVersion", (n) -> { currentObject.setProductVersion(n.getStringValue()); });
        deserializerMap.put("productVersionOperator", (n) -> { currentObject.setProductVersionOperator(n.getEnumValue(Win32LobAppDetectionOperator.class)); });
