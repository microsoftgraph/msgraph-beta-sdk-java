...
public class ExactMatchClassificationResult implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("classification", (n) -> { currentObject.setClassification(n.getCollectionOfObjectValues(ExactMatchDetectedSensitiveContent::createFromDiscriminatorValue)); });
        deserializerMap.put("errors", (n) -> { currentObject.setErrors(n.getCollectionOfObjectValues(ClassificationError::createFromDiscriminatorValue)); });
