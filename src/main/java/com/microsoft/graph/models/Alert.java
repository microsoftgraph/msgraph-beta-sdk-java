...
public class Alert extends Entity implements Parsable {
    ...
    private java.util.List<AlertDetection> alertDetections;
    ...
    private java.util.List<InvestigationSecurityState> investigationSecurityStates;
    ...
    private java.util.List<MessageSecurityState> messageSecurityStates;
    ...
    private java.util.List<UriClickSecurityState> uriClickSecurityStates;
