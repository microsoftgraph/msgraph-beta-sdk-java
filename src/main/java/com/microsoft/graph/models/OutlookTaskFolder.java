...
public class OutlookTaskFolder extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isDefaultFolder", (n) -> { currentObject.setIsDefaultFolder(n.getBooleanValue()); });
        ...
        deserializerMap.put("parentGroupKey", (n) -> { currentObject.setParentGroupKey(n.getStringValue()); });
