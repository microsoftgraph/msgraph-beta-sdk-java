...
/**
 * The class for the Verifiable Credential Retrieved.
 */
public class VerifiableCredentialRetrieved extends VerifiableCredentialRequirementStatus implements IJsonBackedObject {
