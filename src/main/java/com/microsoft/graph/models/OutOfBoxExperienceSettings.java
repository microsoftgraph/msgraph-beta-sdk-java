...
public class OutOfBoxExperienceSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("deviceUsageType", (n) -> { currentObject.setDeviceUsageType(n.getEnumValue(WindowsDeviceUsageType.class)); });
        deserializerMap.put("hideEscapeLink", (n) -> { currentObject.setHideEscapeLink(n.getBooleanValue()); });
        deserializerMap.put("hideEULA", (n) -> { currentObject.setHideEULA(n.getBooleanValue()); });
        deserializerMap.put("hidePrivacySettings", (n) -> { currentObject.setHidePrivacySettings(n.getBooleanValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("skipKeyboardSelectionPage", (n) -> { currentObject.setSkipKeyboardSelectionPage(n.getBooleanValue()); });
        deserializerMap.put("userType", (n) -> { currentObject.setUserType(n.getEnumValue(WindowsUserType.class)); });
