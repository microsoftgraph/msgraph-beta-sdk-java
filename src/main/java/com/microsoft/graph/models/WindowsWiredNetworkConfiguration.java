...
public class WindowsWiredNetworkConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationBlockPeriodInMinutes", (n) -> { currentObject.setAuthenticationBlockPeriodInMinutes(n.getIntegerValue()); });
        deserializerMap.put("authenticationMethod", (n) -> { currentObject.setAuthenticationMethod(n.getEnumValue(WiredNetworkAuthenticationMethod.class)); });
        ...
        deserializerMap.put("authenticationType", (n) -> { currentObject.setAuthenticationType(n.getEnumValue(WiredNetworkAuthenticationType.class)); });
        ...
        deserializerMap.put("enforce8021X", (n) -> { currentObject.setEnforce8021X(n.getBooleanValue()); });
        deserializerMap.put("forceFIPSCompliance", (n) -> { currentObject.setForceFIPSCompliance(n.getBooleanValue()); });
        ...
        deserializerMap.put("secondaryAuthenticationMethod", (n) -> { currentObject.setSecondaryAuthenticationMethod(n.getEnumValue(WiredNetworkAuthenticationMethod.class)); });
        deserializerMap.put("secondaryIdentityCertificateForClientAuthentication", (n) -> { currentObject.setSecondaryIdentityCertificateForClientAuthentication(n.getObjectValue(WindowsCertificateProfileBase::createFromDiscriminatorValue)); });
        deserializerMap.put("secondaryRootCertificateForClientValidation", (n) -> { currentObject.setSecondaryRootCertificateForClientValidation(n.getObjectValue(Windows81TrustedRootCertificate::createFromDiscriminatorValue)); });
