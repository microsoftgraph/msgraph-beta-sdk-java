...
public class DeviceManagementConfigurationCategory extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("categoryDescription", (n) -> { currentObject.setCategoryDescription(n.getStringValue()); });
        deserializerMap.put("childCategoryIds", (n) -> { currentObject.setChildCategoryIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("helpText", (n) -> { currentObject.setHelpText(n.getStringValue()); });
        deserializerMap.put("name", (n) -> { currentObject.setName(n.getStringValue()); });
        deserializerMap.put("parentCategoryId", (n) -> { currentObject.setParentCategoryId(n.getStringValue()); });
        deserializerMap.put("platforms", (n) -> { currentObject.setPlatforms(n.getEnumValue(DeviceManagementConfigurationPlatforms.class)); });
        deserializerMap.put("rootCategoryId", (n) -> { currentObject.setRootCategoryId(n.getStringValue()); });
