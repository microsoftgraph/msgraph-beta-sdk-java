...
public class TeamworkSystemConfiguration implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dateTimeConfiguration", (n) -> { currentObject.setDateTimeConfiguration(n.getObjectValue(TeamworkDateTimeConfiguration::createFromDiscriminatorValue)); });
        deserializerMap.put("defaultPassword", (n) -> { currentObject.setDefaultPassword(n.getStringValue()); });
        deserializerMap.put("deviceLockTimeout", (n) -> { currentObject.setDeviceLockTimeout(n.getPeriodValue()); });
        deserializerMap.put("isDeviceLockEnabled", (n) -> { currentObject.setIsDeviceLockEnabled(n.getBooleanValue()); });
        deserializerMap.put("isLoggingEnabled", (n) -> { currentObject.setIsLoggingEnabled(n.getBooleanValue()); });
        deserializerMap.put("isPowerSavingEnabled", (n) -> { currentObject.setIsPowerSavingEnabled(n.getBooleanValue()); });
        deserializerMap.put("isScreenCaptureEnabled", (n) -> { currentObject.setIsScreenCaptureEnabled(n.getBooleanValue()); });
        deserializerMap.put("isSilentModeEnabled", (n) -> { currentObject.setIsSilentModeEnabled(n.getBooleanValue()); });
        deserializerMap.put("language", (n) -> { currentObject.setLanguage(n.getStringValue()); });
        deserializerMap.put("lockPin", (n) -> { currentObject.setLockPin(n.getStringValue()); });
        deserializerMap.put("loggingLevel", (n) -> { currentObject.setLoggingLevel(n.getStringValue()); });
        deserializerMap.put("networkConfiguration", (n) -> { currentObject.setNetworkConfiguration(n.getObjectValue(TeamworkNetworkConfiguration::createFromDiscriminatorValue)); });
