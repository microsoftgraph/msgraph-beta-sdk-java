...
/**
 * The class for the Planner Delta Delta Parameter Set.
 */
public class PlannerDeltaDeltaParameterSet {

    /**
     * Instiaciates a new PlannerDeltaDeltaParameterSet
     */
     ...
     */
    protected PlannerDeltaDeltaParameterSet(@Nonnull final PlannerDeltaDeltaParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PlannerDeltaDeltaParameterSet
     */
    public static final class PlannerDeltaDeltaParameterSetBuilder {
        /**
         * Instanciates a new PlannerDeltaDeltaParameterSetBuilder
         */
        @Nullable
