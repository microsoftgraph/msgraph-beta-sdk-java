...
public class CompanyInformation extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("currentFiscalYearStartDate", (n) -> { currentObject.setCurrentFiscalYearStartDate(n.getLocalDateValue()); });
        ...
        deserializerMap.put("industry", (n) -> { currentObject.setIndustry(n.getStringValue()); });
        ...
        deserializerMap.put("picture", (n) -> { currentObject.setPicture(n.getByteArrayValue()); });
