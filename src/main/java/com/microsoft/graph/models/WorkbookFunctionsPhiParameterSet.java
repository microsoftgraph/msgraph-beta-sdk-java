...
/**
 * The class for the Workbook Functions Phi Parameter Set.
 */
public class WorkbookFunctionsPhiParameterSet {
    ...
    public static final class WorkbookFunctionsPhiParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsPhiParameterSetBuilder withX(@Nullable final com.google.gson.JsonElement val) {
            this.x = val;
            return this;
        }
        /**
