...
public class UnifiedRoleManagementAlertDefinitionCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<UnifiedRoleManagementAlertDefinition> value;
    /**
     * Instantiates a new unifiedRoleManagementAlertDefinitionCollectionResponse and sets the default values.
     * @return a void
     */
    ...
    public static UnifiedRoleManagementAlertDefinitionCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<UnifiedRoleManagementAlertDefinition> value) {
        this.value = value;
    }
}
