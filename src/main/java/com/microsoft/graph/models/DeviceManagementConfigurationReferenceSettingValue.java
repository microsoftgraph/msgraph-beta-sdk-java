...
public class DeviceManagementConfigurationReferenceSettingValue extends DeviceManagementConfigurationStringSettingValue implements Parsable {
    ...
    public static DeviceManagementConfigurationReferenceSettingValue createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("note", (n) -> { currentObject.setNote(n.getStringValue()); });
