...
public class DeviceManagementScriptAssignment extends Entity implements Parsable {
    ...
    public DeviceManagementScriptAssignment() {
        super();
        this.setOdataType("#microsoft.graph.deviceManagementScriptAssignment");
    }
    /**
    ...
    public static DeviceManagementScriptAssignment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementScriptAssignment currentObject = this;
