...
public class SynchronizationSchedule implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("expiration", (n) -> { currentObject.setExpiration(n.getOffsetDateTimeValue()); });
        deserializerMap.put("interval", (n) -> { currentObject.setInterval(n.getPeriodValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(SynchronizationScheduleState.class)); });
