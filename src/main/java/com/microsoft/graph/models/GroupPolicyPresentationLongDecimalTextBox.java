...
public class GroupPolicyPresentationLongDecimalTextBox extends GroupPolicyPresentation implements Parsable {
    ...
    public static GroupPolicyPresentationLongDecimalTextBox createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final GroupPolicyPresentationLongDecimalTextBox currentObject = this;
