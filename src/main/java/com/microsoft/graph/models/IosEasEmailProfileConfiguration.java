...
public class IosEasEmailProfileConfiguration extends EasEmailProfileConfigurationBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("blockMovingMessagesToOtherEmailAccounts", (n) -> { currentObject.setBlockMovingMessagesToOtherEmailAccounts(n.getBooleanValue()); });
        deserializerMap.put("blockSendingEmailFromThirdPartyApps", (n) -> { currentObject.setBlockSendingEmailFromThirdPartyApps(n.getBooleanValue()); });
        deserializerMap.put("blockSyncingRecentlyUsedEmailAddresses", (n) -> { currentObject.setBlockSyncingRecentlyUsedEmailAddresses(n.getBooleanValue()); });
        ...
        deserializerMap.put("easServices", (n) -> { currentObject.setEasServices(n.getEnumValue(EasServices.class)); });
        deserializerMap.put("easServicesUserOverrideEnabled", (n) -> { currentObject.setEasServicesUserOverrideEnabled(n.getBooleanValue()); });
        deserializerMap.put("emailAddressSource", (n) -> { currentObject.setEmailAddressSource(n.getEnumValue(UserEmailSource.class)); });
        deserializerMap.put("encryptionCertificateType", (n) -> { currentObject.setEncryptionCertificateType(n.getEnumValue(EmailCertificateType.class)); });
        ...
        deserializerMap.put("perAppVPNProfileId", (n) -> { currentObject.setPerAppVPNProfileId(n.getStringValue()); });
        deserializerMap.put("requireSmime", (n) -> { currentObject.setRequireSmime(n.getBooleanValue()); });
        deserializerMap.put("requireSsl", (n) -> { currentObject.setRequireSsl(n.getBooleanValue()); });
        deserializerMap.put("signingCertificateType", (n) -> { currentObject.setSigningCertificateType(n.getEnumValue(EmailCertificateType.class)); });
        deserializerMap.put("smimeEnablePerMessageSwitch", (n) -> { currentObject.setSmimeEnablePerMessageSwitch(n.getBooleanValue()); });
        deserializerMap.put("smimeEncryptByDefaultEnabled", (n) -> { currentObject.setSmimeEncryptByDefaultEnabled(n.getBooleanValue()); });
        deserializerMap.put("smimeEncryptByDefaultUserOverrideEnabled", (n) -> { currentObject.setSmimeEncryptByDefaultUserOverrideEnabled(n.getBooleanValue()); });
        deserializerMap.put("smimeEncryptionCertificate", (n) -> { currentObject.setSmimeEncryptionCertificate(n.getObjectValue(IosCertificateProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("smimeEncryptionCertificateUserOverrideEnabled", (n) -> { currentObject.setSmimeEncryptionCertificateUserOverrideEnabled(n.getBooleanValue()); });
        deserializerMap.put("smimeSigningCertificate", (n) -> { currentObject.setSmimeSigningCertificate(n.getObjectValue(IosCertificateProfile::createFromDiscriminatorValue)); });
        deserializerMap.put("smimeSigningCertificateUserOverrideEnabled", (n) -> { currentObject.setSmimeSigningCertificateUserOverrideEnabled(n.getBooleanValue()); });
        deserializerMap.put("smimeSigningEnabled", (n) -> { currentObject.setSmimeSigningEnabled(n.getBooleanValue()); });
        deserializerMap.put("smimeSigningUserOverrideEnabled", (n) -> { currentObject.setSmimeSigningUserOverrideEnabled(n.getBooleanValue()); });
        deserializerMap.put("useOAuth", (n) -> { currentObject.setUseOAuth(n.getBooleanValue()); });
