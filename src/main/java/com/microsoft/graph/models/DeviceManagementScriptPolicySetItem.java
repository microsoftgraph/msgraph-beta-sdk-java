...
public class DeviceManagementScriptPolicySetItem extends PolicySetItem implements Parsable {
    ...
    public static DeviceManagementScriptPolicySetItem createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementScriptPolicySetItem currentObject = this;
