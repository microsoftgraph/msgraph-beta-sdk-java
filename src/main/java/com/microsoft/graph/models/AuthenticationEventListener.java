...
public class AuthenticationEventListener extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authenticationEventsFlowId", (n) -> { currentObject.setAuthenticationEventsFlowId(n.getStringValue()); });
        deserializerMap.put("conditions", (n) -> { currentObject.setConditions(n.getObjectValue(AuthenticationConditions::createFromDiscriminatorValue)); });
        deserializerMap.put("priority", (n) -> { currentObject.setPriority(n.getIntegerValue()); });
        deserializerMap.put("tags", (n) -> { currentObject.setTags(n.getCollectionOfObjectValues(KeyValuePair::createFromDiscriminatorValue)); });
