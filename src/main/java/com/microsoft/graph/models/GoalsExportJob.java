...
public class GoalsExportJob extends LongRunningOperation implements Parsable {
    ...
    /**
     * Gets the explorerViewId property value. The explorerViewId property
     * @return a String
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the goalsOrganizationId property value. The goalsOrganizationId property
     * @return a String
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the explorerViewId property value. The explorerViewId property
    ...
    /**
     * Sets the goalsOrganizationId property value. The goalsOrganizationId property
