...
public class ProtectOnlineMeetingAction extends LabelActionBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedForwarders", (n) -> { currentObject.setAllowedForwarders(n.getEnumValue(OnlineMeetingForwarders.class)); });
        deserializerMap.put("allowedPresenters", (n) -> { currentObject.setAllowedPresenters(n.getEnumValue(OnlineMeetingPresenters.class)); });
        deserializerMap.put("isCopyToClipboardEnabled", (n) -> { currentObject.setIsCopyToClipboardEnabled(n.getBooleanValue()); });
        deserializerMap.put("isLobbyEnabled", (n) -> { currentObject.setIsLobbyEnabled(n.getBooleanValue()); });
