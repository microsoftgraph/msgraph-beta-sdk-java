...
public class ApprovalSettings implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("approvalStages", (n) -> { currentObject.setApprovalStages(n.getCollectionOfObjectValues(ApprovalStage::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setApprovalStages(@javax.annotation.Nullable final java.util.List<ApprovalStage> value) {
