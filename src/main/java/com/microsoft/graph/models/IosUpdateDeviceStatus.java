...
public class IosUpdateDeviceStatus extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final IosUpdateDeviceStatus currentObject = this;
        ...
        deserializerMap.put("installStatus", (n) -> { currentObject.setInstallStatus(n.getEnumValue(IosUpdatesInstallStatus.class)); });
        ...
        deserializerMap.put("platform", (n) -> { currentObject.setPlatform(n.getIntegerValue()); });
