...
public class WindowsDriverUpdateInventory extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applicableDeviceCount", (n) -> { currentObject.setApplicableDeviceCount(n.getIntegerValue()); });
        deserializerMap.put("approvalStatus", (n) -> { currentObject.setApprovalStatus(n.getEnumValue(DriverApprovalStatus.class)); });
        deserializerMap.put("category", (n) -> { currentObject.setCategory(n.getEnumValue(DriverCategory.class)); });
        deserializerMap.put("deployDateTime", (n) -> { currentObject.setDeployDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("driverClass", (n) -> { currentObject.setDriverClass(n.getStringValue()); });
