...
public class AttributeMappingSource implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("parameters", (n) -> { currentObject.setParameters(n.getCollectionOfObjectValues(StringKeyAttributeMappingSourceValuePair::createFromDiscriminatorValue)); });
        deserializerMap.put("type", (n) -> { currentObject.setType(n.getEnumValue(AttributeMappingSourceType.class)); });
