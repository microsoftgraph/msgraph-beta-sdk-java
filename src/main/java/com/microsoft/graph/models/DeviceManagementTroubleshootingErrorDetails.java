...
public class DeviceManagementTroubleshootingErrorDetails implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("context", (n) -> { currentObject.setContext(n.getStringValue()); });
        deserializerMap.put("failure", (n) -> { currentObject.setFailure(n.getStringValue()); });
        deserializerMap.put("failureDetails", (n) -> { currentObject.setFailureDetails(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("remediation", (n) -> { currentObject.setRemediation(n.getStringValue()); });
        deserializerMap.put("resources", (n) -> { currentObject.setResources(n.getCollectionOfObjectValues(DeviceManagementTroubleshootingErrorResource::createFromDiscriminatorValue)); });
