...
public class UserExperienceAnalyticsAppHealthDevicePerformance extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("crashedAppCount", (n) -> { currentObject.setCrashedAppCount(n.getIntegerValue()); });
        deserializerMap.put("deviceAppHealthScore", (n) -> { currentObject.setDeviceAppHealthScore(n.getDoubleValue()); });
        deserializerMap.put("deviceAppHealthStatus", (n) -> { currentObject.setDeviceAppHealthStatus(n.getStringValue()); });
