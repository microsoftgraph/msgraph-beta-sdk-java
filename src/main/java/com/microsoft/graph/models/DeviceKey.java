...
public class DeviceKey implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("keyMaterial", (n) -> { currentObject.setKeyMaterial(n.getByteArrayValue()); });
        deserializerMap.put("keyType", (n) -> { currentObject.setKeyType(n.getStringValue()); });
