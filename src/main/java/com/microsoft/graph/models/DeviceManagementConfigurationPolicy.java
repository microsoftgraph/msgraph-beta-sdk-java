...
public class DeviceManagementConfigurationPolicy extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("priorityMetaData", (n) -> { currentObject.setPriorityMetaData(n.getObjectValue(DeviceManagementPriorityMetaData::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("templateReference", (n) -> { currentObject.setTemplateReference(n.getObjectValue(DeviceManagementConfigurationPolicyTemplateReference::createFromDiscriminatorValue)); });
