...
public class MeetingRegistration extends MeetingRegistrationBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customQuestions", (n) -> { currentObject.setCustomQuestions(n.getCollectionOfObjectValues(MeetingRegistrationQuestion::createFromDiscriminatorValue)); });
        deserializerMap.put("description", (n) -> { currentObject.setDescription(n.getStringValue()); });
        deserializerMap.put("endDateTime", (n) -> { currentObject.setEndDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("registrationPageViewCount", (n) -> { currentObject.setRegistrationPageViewCount(n.getIntegerValue()); });
        deserializerMap.put("registrationPageWebUrl", (n) -> { currentObject.setRegistrationPageWebUrl(n.getStringValue()); });
        deserializerMap.put("speakers", (n) -> { currentObject.setSpeakers(n.getCollectionOfObjectValues(MeetingSpeaker::createFromDiscriminatorValue)); });
