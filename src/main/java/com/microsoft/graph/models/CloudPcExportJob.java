...
public class CloudPcExportJob extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("exportJobStatus", (n) -> { currentObject.setExportJobStatus(n.getEnumValue(CloudPcExportJobStatus.class)); });
            this.put("exportUrl", (n) -> { currentObject.setExportUrl(n.getStringValue()); });
            this.put("filter", (n) -> { currentObject.setFilter(n.getStringValue()); });
            this.put("format", (n) -> { currentObject.setFormat(n.getStringValue()); });
            this.put("reportName", (n) -> { currentObject.setReportName(n.getEnumValue(CloudPcReportName.class)); });
