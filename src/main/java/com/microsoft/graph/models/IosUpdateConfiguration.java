...
public class IosUpdateConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("desiredOsVersion", (n) -> { currentObject.setDesiredOsVersion(n.getStringValue()); });
        deserializerMap.put("enforcedSoftwareUpdateDelayInDays", (n) -> { currentObject.setEnforcedSoftwareUpdateDelayInDays(n.getIntegerValue()); });
        deserializerMap.put("isEnabled", (n) -> { currentObject.setIsEnabled(n.getBooleanValue()); });
        deserializerMap.put("scheduledInstallDays", (n) -> { currentObject.setScheduledInstallDays(n.getCollectionOfEnumValues(DayOfWeek.class)); });
        deserializerMap.put("updateScheduleType", (n) -> { currentObject.setUpdateScheduleType(n.getEnumValue(IosSoftwareUpdateScheduleType.class)); });
        deserializerMap.put("utcTimeOffsetInMinutes", (n) -> { currentObject.setUtcTimeOffsetInMinutes(n.getIntegerValue()); });
