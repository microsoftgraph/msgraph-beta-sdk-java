...
public class ProfileCardProperty extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("annotations", (n) -> { currentObject.setAnnotations(n.getCollectionOfObjectValues(ProfileCardAnnotation::createFromDiscriminatorValue)); });
        deserializerMap.put("directoryPropertyName", (n) -> { currentObject.setDirectoryPropertyName(n.getStringValue()); });
