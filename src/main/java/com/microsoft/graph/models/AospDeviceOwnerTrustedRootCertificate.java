...
public class AospDeviceOwnerTrustedRootCertificate extends DeviceConfiguration implements Parsable {
    ...
    public static AospDeviceOwnerTrustedRootCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AospDeviceOwnerTrustedRootCertificate currentObject = this;
