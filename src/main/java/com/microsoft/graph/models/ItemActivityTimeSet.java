...
public class ItemActivityTimeSet implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastRecordedDateTime", (n) -> { currentObject.setLastRecordedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("observedDateTime", (n) -> { currentObject.setObservedDateTime(n.getOffsetDateTimeValue()); });
