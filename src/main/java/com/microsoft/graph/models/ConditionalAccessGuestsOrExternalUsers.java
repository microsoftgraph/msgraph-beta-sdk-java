...
public class ConditionalAccessGuestsOrExternalUsers implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("externalTenants", (n) -> { currentObject.setExternalTenants(n.getObjectValue(ConditionalAccessExternalTenants::createFromDiscriminatorValue)); });
        deserializerMap.put("guestOrExternalUserTypes", (n) -> { currentObject.setGuestOrExternalUserTypes(n.getEnumValue(ConditionalAccessGuestOrExternalUserTypes.class)); });
