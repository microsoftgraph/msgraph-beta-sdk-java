...
public class UserExperienceAnalyticsAnomalyDevice extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("anomalyOnDeviceFirstOccurrenceDateTime", (n) -> { currentObject.setAnomalyOnDeviceFirstOccurrenceDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("anomalyOnDeviceLatestOccurrenceDateTime", (n) -> { currentObject.setAnomalyOnDeviceLatestOccurrenceDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("osName", (n) -> { currentObject.setOsName(n.getStringValue()); });
