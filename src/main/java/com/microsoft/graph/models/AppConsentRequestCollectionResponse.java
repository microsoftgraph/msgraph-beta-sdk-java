...
public class AppConsentRequestCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static AppConsentRequestCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AppConsentRequestCollectionResponse currentObject = this;
