...
/**
 * The class for the Managed Device Remove Device Firmware Configuration Interface Management Parameter Set.
 */
public class ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSet {

    /**
     * Instiaciates a new ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSet
     */
     ...
     */
    protected ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSet(@Nonnull final ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSet
     */
    public static final class ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSetBuilder {
        /**
         * Instanciates a new ManagedDeviceRemoveDeviceFirmwareConfigurationInterfaceManagementParameterSetBuilder
         */
        @Nullable
