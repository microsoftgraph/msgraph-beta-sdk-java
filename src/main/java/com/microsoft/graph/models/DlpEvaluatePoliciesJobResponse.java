...
public class DlpEvaluatePoliciesJobResponse extends JobResponseBase implements Parsable {
    /** The result property */
    private DlpPoliciesJobResult _result;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("result", (n) -> { currentObject.setResult(n.getObjectValue(DlpPoliciesJobResult::createFromDiscriminatorValue)); });
