...
public class TenantStatusInformation implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("delegatedPrivilegeStatus", (n) -> { currentObject.setDelegatedPrivilegeStatus(n.getEnumValue(DelegatedPrivilegeStatus.class)); });
        deserializerMap.put("lastDelegatedPrivilegeRefreshDateTime", (n) -> { currentObject.setLastDelegatedPrivilegeRefreshDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("offboardedByUserId", (n) -> { currentObject.setOffboardedByUserId(n.getStringValue()); });
        deserializerMap.put("offboardedDateTime", (n) -> { currentObject.setOffboardedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("onboardedByUserId", (n) -> { currentObject.setOnboardedByUserId(n.getStringValue()); });
        deserializerMap.put("onboardedDateTime", (n) -> { currentObject.setOnboardedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("onboardingStatus", (n) -> { currentObject.setOnboardingStatus(n.getEnumValue(TenantOnboardingStatus.class)); });
        deserializerMap.put("tenantOnboardingEligibilityReason", (n) -> { currentObject.setTenantOnboardingEligibilityReason(n.getEnumValue(TenantOnboardingEligibilityReason.class)); });
        deserializerMap.put("workloadStatuses", (n) -> { currentObject.setWorkloadStatuses(n.getCollectionOfObjectValues(WorkloadStatus::createFromDiscriminatorValue)); });
