...
public class ManagementTemplateStepVersion extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acceptedFor", (n) -> { currentObject.setAcceptedFor(n.getObjectValue(ManagementTemplateStep::createFromDiscriminatorValue)); });
        deserializerMap.put("contentMarkdown", (n) -> { currentObject.setContentMarkdown(n.getStringValue()); });
        deserializerMap.put("createdByUserId", (n) -> { currentObject.setCreatedByUserId(n.getStringValue()); });
        deserializerMap.put("createdDateTime", (n) -> { currentObject.setCreatedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("deployments", (n) -> { currentObject.setDeployments(n.getCollectionOfObjectValues(ManagementTemplateStepDeployment::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("templateStep", (n) -> { currentObject.setTemplateStep(n.getObjectValue(ManagementTemplateStep::createFromDiscriminatorValue)); });
        deserializerMap.put("version", (n) -> { currentObject.setVersion(n.getIntegerValue()); });
        deserializerMap.put("versionInformation", (n) -> { currentObject.setVersionInformation(n.getStringValue()); });
