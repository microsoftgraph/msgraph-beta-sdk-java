...
public class Email implements AdditionalDataHolder, Parsable {
    ...
    public Email() {
        ...
        this.setOdataType("#microsoft.graph.managedTenants.email");
    }
    /**
    ...
    public static Email createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final Email currentObject = this;
