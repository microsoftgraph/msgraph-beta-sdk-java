...
public class CloudPcDevice extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("cloudPcStatus", (n) -> { currentObject.setCloudPcStatus(n.getStringValue()); });
        deserializerMap.put("deviceSpecification", (n) -> { currentObject.setDeviceSpecification(n.getStringValue()); });
        ...
        deserializerMap.put("provisioningPolicyId", (n) -> { currentObject.setProvisioningPolicyId(n.getStringValue()); });
        deserializerMap.put("servicePlanName", (n) -> { currentObject.setServicePlanName(n.getStringValue()); });
        deserializerMap.put("servicePlanType", (n) -> { currentObject.setServicePlanType(n.getStringValue()); });
