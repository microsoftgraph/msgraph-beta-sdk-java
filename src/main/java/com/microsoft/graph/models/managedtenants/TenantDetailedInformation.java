...
public class TenantDetailedInformation extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("countryName", (n) -> { currentObject.setCountryName(n.getStringValue()); });
        deserializerMap.put("defaultDomainName", (n) -> { currentObject.setDefaultDomainName(n.getStringValue()); });
        deserializerMap.put("displayName", (n) -> { currentObject.setDisplayName(n.getStringValue()); });
        deserializerMap.put("industryName", (n) -> { currentObject.setIndustryName(n.getStringValue()); });
        deserializerMap.put("region", (n) -> { currentObject.setRegion(n.getStringValue()); });
        deserializerMap.put("segmentName", (n) -> { currentObject.setSegmentName(n.getStringValue()); });
        deserializerMap.put("tenantId", (n) -> { currentObject.setTenantId(n.getStringValue()); });
        deserializerMap.put("verticalName", (n) -> { currentObject.setVerticalName(n.getStringValue()); });
