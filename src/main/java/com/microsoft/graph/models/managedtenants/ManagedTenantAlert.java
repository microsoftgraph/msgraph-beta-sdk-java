...
public class ManagedTenantAlert extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alertData", (n) -> { currentObject.setAlertData(n.getObjectValue(AlertData::createFromDiscriminatorValue)); });
        deserializerMap.put("alertDataReferenceStrings", (n) -> { currentObject.setAlertDataReferenceStrings(n.getCollectionOfObjectValues(AlertDataReferenceString::createFromDiscriminatorValue)); });
        deserializerMap.put("alertLogs", (n) -> { currentObject.setAlertLogs(n.getCollectionOfObjectValues(ManagedTenantAlertLog::createFromDiscriminatorValue)); });
        deserializerMap.put("alertRule", (n) -> { currentObject.setAlertRule(n.getObjectValue(ManagedTenantAlertRule::createFromDiscriminatorValue)); });
        deserializerMap.put("alertRuleDisplayName", (n) -> { currentObject.setAlertRuleDisplayName(n.getStringValue()); });
        deserializerMap.put("apiNotifications", (n) -> { currentObject.setApiNotifications(n.getCollectionOfObjectValues(ManagedTenantApiNotification::createFromDiscriminatorValue)); });
        deserializerMap.put("assignedToUserId", (n) -> { currentObject.setAssignedToUserId(n.getStringValue()); });
        deserializerMap.put("correlationCount", (n) -> { currentObject.setCorrelationCount(n.getIntegerValue()); });
        ...
        deserializerMap.put("emailNotifications", (n) -> { currentObject.setEmailNotifications(n.getCollectionOfObjectValues(ManagedTenantEmailNotification::createFromDiscriminatorValue)); });
