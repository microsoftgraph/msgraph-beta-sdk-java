...
public class ManagedTenantAlertRule extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("alertDisplayName", (n) -> { currentObject.setAlertDisplayName(n.getStringValue()); });
        deserializerMap.put("alerts", (n) -> { currentObject.setAlerts(n.getCollectionOfObjectValues(ManagedTenantAlert::createFromDiscriminatorValue)); });
        deserializerMap.put("alertTTL", (n) -> { currentObject.setAlertTTL(n.getIntegerValue()); });
        ...
        deserializerMap.put("notificationFinalDestinations", (n) -> { currentObject.setNotificationFinalDestinations(n.getEnumValue(NotificationDestination.class)); });
        deserializerMap.put("ruleDefinition", (n) -> { currentObject.setRuleDefinition(n.getObjectValue(ManagedTenantAlertRuleDefinition::createFromDiscriminatorValue)); });
        deserializerMap.put("severity", (n) -> { currentObject.setSeverity(n.getEnumValue(AlertSeverity.class)); });
        deserializerMap.put("targets", (n) -> { currentObject.setTargets(n.getCollectionOfObjectValues(NotificationTarget::createFromDiscriminatorValue)); });
        deserializerMap.put("tenantIds", (n) -> { currentObject.setTenantIds(n.getCollectionOfObjectValues(TenantInfo::createFromDiscriminatorValue)); });
