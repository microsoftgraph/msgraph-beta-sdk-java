...
public class ManagedTenantEmailNotification extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("emailAddresses", (n) -> { currentObject.setEmailAddresses(n.getCollectionOfObjectValues(Email::createFromDiscriminatorValue)); });
        deserializerMap.put("emailBody", (n) -> { currentObject.setEmailBody(n.getStringValue()); });
