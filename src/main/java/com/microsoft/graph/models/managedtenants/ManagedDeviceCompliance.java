...
public class ManagedDeviceCompliance extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("complianceStatus", (n) -> { currentObject.setComplianceStatus(n.getStringValue()); });
        deserializerMap.put("deviceType", (n) -> { currentObject.setDeviceType(n.getStringValue()); });
        deserializerMap.put("inGracePeriodUntilDateTime", (n) -> { currentObject.setInGracePeriodUntilDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("ownerType", (n) -> { currentObject.setOwnerType(n.getStringValue()); });
