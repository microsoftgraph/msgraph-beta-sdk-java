...
public class ManagementTemplateStepDeployment extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("error", (n) -> { currentObject.setError(n.getObjectValue(GraphAPIErrorDetails::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(ManagementTemplateDeploymentStatus.class)); });
        deserializerMap.put("templateStepVersion", (n) -> { currentObject.setTemplateStepVersion(n.getObjectValue(ManagementTemplateStepVersion::createFromDiscriminatorValue)); });
