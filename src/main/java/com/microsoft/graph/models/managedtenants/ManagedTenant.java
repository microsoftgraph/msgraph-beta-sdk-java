...
public class ManagedTenant extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers()) {{
            ...
            this.put("managedTenantAlertLogs", (n) -> { currentObject.setManagedTenantAlertLogs(n.getCollectionOfObjectValues(ManagedTenantAlertLog::createFromDiscriminatorValue)); });
            this.put("managedTenantAlertRuleDefinitions", (n) -> { currentObject.setManagedTenantAlertRuleDefinitions(n.getCollectionOfObjectValues(ManagedTenantAlertRuleDefinition::createFromDiscriminatorValue)); });
            this.put("managedTenantAlertRules", (n) -> { currentObject.setManagedTenantAlertRules(n.getCollectionOfObjectValues(ManagedTenantAlertRule::createFromDiscriminatorValue)); });
            this.put("managedTenantAlerts", (n) -> { currentObject.setManagedTenantAlerts(n.getCollectionOfObjectValues(ManagedTenantAlert::createFromDiscriminatorValue)); });
            this.put("managedTenantApiNotifications", (n) -> { currentObject.setManagedTenantApiNotifications(n.getCollectionOfObjectValues(ManagedTenantApiNotification::createFromDiscriminatorValue)); });
            this.put("managedTenantEmailNotifications", (n) -> { currentObject.setManagedTenantEmailNotifications(n.getCollectionOfObjectValues(ManagedTenantEmailNotification::createFromDiscriminatorValue)); });
            this.put("managedTenantTicketingEndpoints", (n) -> { currentObject.setManagedTenantTicketingEndpoints(n.getCollectionOfObjectValues(ManagedTenantTicketingEndpoint::createFromDiscriminatorValue)); });
