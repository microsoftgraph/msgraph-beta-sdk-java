...
public class TenantInfo implements AdditionalDataHolder, Parsable {
    ...
    public TenantInfo() {
        ...
        this.setOdataType("#microsoft.graph.managedTenants.tenantInfo");
    }
    /**
    ...
    public static TenantInfo createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final TenantInfo currentObject = this;
