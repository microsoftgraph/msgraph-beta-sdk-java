...
public class AuthenticationStrengthUsage implements AdditionalDataHolder, Parsable {
    ...
    /** The mfa property */
    private java.util.List<ConditionalAccessPolicy> _mfa;
    /** The none property */
    private java.util.List<ConditionalAccessPolicy> _none;
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AuthenticationStrengthUsage currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(3);
        deserializerMap.put("mfa", (n) -> { currentObject.setMfa(n.getCollectionOfObjectValues(ConditionalAccessPolicy::createFromDiscriminatorValue)); });
        deserializerMap.put("none", (n) -> { currentObject.setNone(n.getCollectionOfObjectValues(ConditionalAccessPolicy::createFromDiscriminatorValue)); });
