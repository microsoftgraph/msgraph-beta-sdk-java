...
/**
 * The class for the Ios Imported PFXCertificate Profile.
 */
public class IosImportedPFXCertificateProfile extends IosCertificateProfile implements IJsonBackedObject {
