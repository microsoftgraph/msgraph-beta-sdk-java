...
public class UserRegistrationCount implements AdditionalDataHolder, Parsable {
    ...
    public static UserRegistrationCount createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UserRegistrationCount currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(3);
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("registrationCount", (n) -> { currentObject.setRegistrationCount(n.getLongValue()); });
        deserializerMap.put("registrationStatus", (n) -> { currentObject.setRegistrationStatus(n.getEnumValue(RegistrationStatusType.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setRegistrationCount(@javax.annotation.Nullable final Long value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRegistrationStatus(@javax.annotation.Nullable final RegistrationStatusType value) {
