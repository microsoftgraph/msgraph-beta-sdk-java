...
public class UserRegistrationCount implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("registrationStatus", (n) -> { this.setRegistrationStatus(n.getEnumValue(RegistrationStatusType::forValue)); });
    ...
    public Long getRegistrationCount() {
        return this.backingStore.get("registrationCount");
    }
    /**
    ...
    public RegistrationStatusType getRegistrationStatus() {
        return this.backingStore.get("registrationStatus");
    }
    /**
    ...
    public void setRegistrationCount(@jakarta.annotation.Nullable final Long value) {
        this.backingStore.set("registrationCount", value);
    }
    /**
    ...
    public void setRegistrationStatus(@jakarta.annotation.Nullable final RegistrationStatusType value) {
        this.backingStore.set("registrationStatus", value);
    }
}
