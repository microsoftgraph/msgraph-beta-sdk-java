...
public class RetrieveRemoteHelpSessionResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acsGroupId", (n) -> { currentObject.setAcsGroupId(n.getStringValue()); });
        deserializerMap.put("acsHelperUserId", (n) -> { currentObject.setAcsHelperUserId(n.getStringValue()); });
        deserializerMap.put("acsHelperUserToken", (n) -> { currentObject.setAcsHelperUserToken(n.getStringValue()); });
        deserializerMap.put("acsSharerUserId", (n) -> { currentObject.setAcsSharerUserId(n.getStringValue()); });
        deserializerMap.put("deviceName", (n) -> { currentObject.setDeviceName(n.getStringValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("pubSubGroupId", (n) -> { currentObject.setPubSubGroupId(n.getStringValue()); });
        deserializerMap.put("pubSubHelperAccessUri", (n) -> { currentObject.setPubSubHelperAccessUri(n.getStringValue()); });
        deserializerMap.put("sessionExpirationDateTime", (n) -> { currentObject.setSessionExpirationDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("sessionKey", (n) -> { currentObject.setSessionKey(n.getStringValue()); });
