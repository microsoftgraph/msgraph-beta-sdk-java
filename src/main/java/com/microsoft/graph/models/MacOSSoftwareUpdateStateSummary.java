...
public class MacOSSoftwareUpdateStateSummary extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getEnumValue(MacOSSoftwareUpdateState.class)); });
        deserializerMap.put("updateCategory", (n) -> { currentObject.setUpdateCategory(n.getEnumValue(MacOSSoftwareUpdateCategory.class)); });
