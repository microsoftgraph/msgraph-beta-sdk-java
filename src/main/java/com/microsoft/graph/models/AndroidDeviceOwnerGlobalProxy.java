...
public class AndroidDeviceOwnerGlobalProxy implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public static AndroidDeviceOwnerGlobalProxy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
