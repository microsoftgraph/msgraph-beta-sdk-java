...
public class MeetingInfo implements AdditionalDataHolder, BackedModel, Parsable {
    ...
    public Boolean getAllowConversationWithoutHost() {
        return this.backingStore.get("allowConversationWithoutHost");
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowConversationWithoutHost", (n) -> { this.setAllowConversationWithoutHost(n.getBooleanValue()); });
     ...
     */
    public void setAllowConversationWithoutHost(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("allowConversationWithoutHost", value);
    }
    /**
