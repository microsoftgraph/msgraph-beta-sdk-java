...
public class SalesOrderLine extends Entity implements Parsable {
    ...
    private BigDecimal _invoicedQuantity;
    /** The invoiceQuantity property */
    private BigDecimal _invoiceQuantity;
    /** The item property */
    private Item _item;
    /** The itemId property */
    ...
    public static SalesOrderLine createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("invoicedQuantity", (n) -> { currentObject.setInvoicedQuantity(n.getBigDecimalValue()); });
        deserializerMap.put("invoiceQuantity", (n) -> { currentObject.setInvoiceQuantity(n.getBigDecimalValue()); });
        ...
        deserializerMap.put("shippedQuantity", (n) -> { currentObject.setShippedQuantity(n.getBigDecimalValue()); });
        deserializerMap.put("shipQuantity", (n) -> { currentObject.setShipQuantity(n.getBigDecimalValue()); });
