...
public class BookingAppointment extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customerEmailAddress", (n) -> { currentObject.setCustomerEmailAddress(n.getStringValue()); });
        deserializerMap.put("customerId", (n) -> { currentObject.setCustomerId(n.getStringValue()); });
        deserializerMap.put("customerLocation", (n) -> { currentObject.setCustomerLocation(n.getObjectValue(Location::createFromDiscriminatorValue)); });
        deserializerMap.put("customerName", (n) -> { currentObject.setCustomerName(n.getStringValue()); });
        deserializerMap.put("customerNotes", (n) -> { currentObject.setCustomerNotes(n.getStringValue()); });
        deserializerMap.put("customerPhone", (n) -> { currentObject.setCustomerPhone(n.getStringValue()); });
        ...
        deserializerMap.put("invoiceAmount", (n) -> { currentObject.setInvoiceAmount(n.getDoubleValue()); });
        deserializerMap.put("invoiceDate", (n) -> { currentObject.setInvoiceDate(n.getObjectValue(DateTimeTimeZone::createFromDiscriminatorValue)); });
        deserializerMap.put("invoiceId", (n) -> { currentObject.setInvoiceId(n.getStringValue()); });
        deserializerMap.put("invoiceStatus", (n) -> { currentObject.setInvoiceStatus(n.getEnumValue(BookingInvoiceStatus.class)); });
        deserializerMap.put("invoiceUrl", (n) -> { currentObject.setInvoiceUrl(n.getStringValue()); });
