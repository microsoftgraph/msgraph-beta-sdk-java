...
public class Windows10XSCEPCertificateProfile extends Windows10XCertificateProfile implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("hashAlgorithm", (n) -> { currentObject.setHashAlgorithm(n.getCollectionOfEnumValues(HashAlgorithms.class)); });
        ...
        deserializerMap.put("rootCertificateId", (n) -> { currentObject.setRootCertificateId(n.getStringValue()); });
        deserializerMap.put("scepServerUrls", (n) -> { currentObject.setScepServerUrls(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("subjectAlternativeNameFormats", (n) -> { currentObject.setSubjectAlternativeNameFormats(n.getCollectionOfObjectValues(Windows10XCustomSubjectAlternativeName::createFromDiscriminatorValue)); });
