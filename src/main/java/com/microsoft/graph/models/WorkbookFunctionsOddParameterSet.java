...
/**
 * The class for the Workbook Functions Odd Parameter Set.
 */
public class WorkbookFunctionsOddParameterSet {
    ...
    /**
     * Instiaciates a new WorkbookFunctionsOddParameterSet
     */
     ...
     */
    protected WorkbookFunctionsOddParameterSet(@Nonnull final WorkbookFunctionsOddParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the WorkbookFunctionsOddParameterSet
     */
    public static final class WorkbookFunctionsOddParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsOddParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsOddParameterSetBuilder
         */
        @Nullable
