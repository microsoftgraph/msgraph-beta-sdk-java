...
public class EvaluateLabelJobResultGroup implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("automatic", (n) -> { currentObject.setAutomatic(n.getObjectValue(EvaluateLabelJobResult::createFromDiscriminatorValue)); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("recommended", (n) -> { currentObject.setRecommended(n.getObjectValue(EvaluateLabelJobResult::createFromDiscriminatorValue)); });
