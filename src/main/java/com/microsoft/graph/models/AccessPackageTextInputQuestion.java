...
public class AccessPackageTextInputQuestion extends AccessPackageQuestion implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("isSingleLineQuestion", (n) -> { currentObject.setIsSingleLineQuestion(n.getBooleanValue()); });
        deserializerMap.put("regexPattern", (n) -> { currentObject.setRegexPattern(n.getStringValue()); });
