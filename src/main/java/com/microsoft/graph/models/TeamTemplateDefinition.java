...
public class TeamTemplateDefinition extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("audience", (n) -> { currentObject.setAudience(n.getEnumValue(TeamTemplateAudience.class)); });
        ...
        deserializerMap.put("parentTemplateId", (n) -> { currentObject.setParentTemplateId(n.getStringValue()); });
        ...
        deserializerMap.put("teamDefinition", (n) -> { currentObject.setTeamDefinition(n.getObjectValue(Team::createFromDiscriminatorValue)); });
