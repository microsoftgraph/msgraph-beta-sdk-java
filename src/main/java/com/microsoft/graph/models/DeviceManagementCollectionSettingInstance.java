...
/**
 * The class for the Device Management Collection Setting Instance.
 */
public class DeviceManagementCollectionSettingInstance extends DeviceManagementSettingInstance implements IJsonBackedObject {
