...
public class MacOSKerberosSingleSignOnExtension extends MacOSSingleSignOnExtension implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("credentialsCacheMonitored", (n) -> { currentObject.setCredentialsCacheMonitored(n.getBooleanValue()); });
        ...
        deserializerMap.put("kerberosAppsInBundleIdACLIncluded", (n) -> { currentObject.setKerberosAppsInBundleIdACLIncluded(n.getBooleanValue()); });
        ...
        deserializerMap.put("modeCredentialUsed", (n) -> { currentObject.setModeCredentialUsed(n.getStringValue()); });
        ...
        deserializerMap.put("preferredKDCs", (n) -> { currentObject.setPreferredKDCs(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("tlsForLDAPRequired", (n) -> { currentObject.setTlsForLDAPRequired(n.getBooleanValue()); });
        deserializerMap.put("usernameLabelCustom", (n) -> { currentObject.setUsernameLabelCustom(n.getStringValue()); });
        deserializerMap.put("userPrincipalName", (n) -> { currentObject.setUserPrincipalName(n.getStringValue()); });
        deserializerMap.put("userSetupDelayed", (n) -> { currentObject.setUserSetupDelayed(n.getBooleanValue()); });
