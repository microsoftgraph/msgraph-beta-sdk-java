...
public class AzureADAuthentication extends Entity implements Parsable {
    ...
    public static AzureADAuthentication createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAttainments(@javax.annotation.Nullable final java.util.List<ServiceLevelAgreementAttainment> value) {
