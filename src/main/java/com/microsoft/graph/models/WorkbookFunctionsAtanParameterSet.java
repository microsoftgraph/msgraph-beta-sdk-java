...
/**
 * The class for the Workbook Functions Atan Parameter Set.
 */
public class WorkbookFunctionsAtanParameterSet {
    ...
    public static final class WorkbookFunctionsAtanParameterSetBuilder {
         ...
         */
        @Nonnull
        public WorkbookFunctionsAtanParameterSetBuilder withNumber(@Nullable final com.google.gson.JsonElement val) {
            this.number = val;
            return this;
        }
        /**
         * Instanciates a new WorkbookFunctionsAtanParameterSetBuilder
         */
        @Nullable
