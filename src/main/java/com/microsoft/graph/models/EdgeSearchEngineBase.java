...
public class EdgeSearchEngineBase implements AdditionalDataHolder, Parsable {
    ...
    public static EdgeSearchEngineBase createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EdgeSearchEngineBase currentObject = this;
