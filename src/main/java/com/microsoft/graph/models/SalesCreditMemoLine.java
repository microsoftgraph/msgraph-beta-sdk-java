...
public class SalesCreditMemoLine extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final SalesCreditMemoLine currentObject = this;
        ...
        deserializerMap.put("shipmentDate", (n) -> { currentObject.setShipmentDate(n.getLocalDateValue()); });
        ...
        deserializerMap.put("unitOfMeasureId", (n) -> { currentObject.setUnitOfMeasureId(n.getStringValue()); });
