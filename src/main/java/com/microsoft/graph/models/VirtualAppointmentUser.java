...
/**
 * The class for the Virtual Appointment User.
 */
public class VirtualAppointmentUser implements IJsonBackedObject {
    ...
    /**
     * The Sms Capable Phone Number.
     * The phone number for sending SMS texts for the user who participates in a virtual appointment. Optional.
     */
    @SerializedName(value = "smsCapablePhoneNumber", alternate = {"SmsCapablePhoneNumber"})
    @Expose
	@Nullable
