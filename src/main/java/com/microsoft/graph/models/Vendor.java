...
public class Vendor implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("balance", (n) -> { this.setBalance(n.getObjectValue(Decimal::createFromDiscriminatorValue)); });
     ...
     */
    public void setBalance(@jakarta.annotation.Nullable final Decimal value) {
        this.balance = value;
    }
    /**
