...
public class OpenAwsSecurityGroupFinding extends Finding implements Parsable {
     ...
     */
    private java.util.List<AssignedComputeInstanceDetails> assignedComputeInstancesDetails;
    /**
     * The inboundPorts property
     */
    private InboundPorts inboundPorts;
    /**
     * The securityGroup property
     */
    private AwsAuthorizationSystemResource securityGroup;
    /**
     * The totalStorageBucketCount property
     */
    private Integer totalStorageBucketCount;
    /**
    ...
    public java.util.List<AssignedComputeInstanceDetails> getAssignedComputeInstancesDetails() {
        return this.assignedComputeInstancesDetails;
    }
    /**
    ...
    public Integer getTotalStorageBucketCount() {
        return this.totalStorageBucketCount;
    }
    /**
    ...
    public void setAssignedComputeInstancesDetails(@jakarta.annotation.Nullable final java.util.List<AssignedComputeInstanceDetails> value) {
        this.assignedComputeInstancesDetails = value;
    }
    /**
    ...
    public void setTotalStorageBucketCount(@jakarta.annotation.Nullable final Integer value) {
        this.totalStorageBucketCount = value;
    }
}
