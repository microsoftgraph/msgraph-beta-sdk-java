...
public class DeviceManagementIntentSettingSecretConstraint extends DeviceManagementConstraint implements Parsable {
    ...
    public static DeviceManagementIntentSettingSecretConstraint createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementIntentSettingSecretConstraint currentObject = this;
