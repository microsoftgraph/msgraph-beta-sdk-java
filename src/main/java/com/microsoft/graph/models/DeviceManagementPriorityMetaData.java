...
public class DeviceManagementPriorityMetaData implements AdditionalDataHolder, Parsable {
    ...
    public static DeviceManagementPriorityMetaData createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementPriorityMetaData currentObject = this;
