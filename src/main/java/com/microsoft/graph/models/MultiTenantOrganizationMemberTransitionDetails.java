...
public class MultiTenantOrganizationMemberTransitionDetails implements AdditionalDataHolder, Parsable {
    ...
    public static MultiTenantOrganizationMemberTransitionDetails createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDesiredRole(@javax.annotation.Nullable final MultiTenantOrganizationMemberRole value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDesiredState(@javax.annotation.Nullable final MultiTenantOrganizationMemberState value) {
