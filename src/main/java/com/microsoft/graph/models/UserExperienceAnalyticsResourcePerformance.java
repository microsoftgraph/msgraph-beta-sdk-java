...
public class UserExperienceAnalyticsResourcePerformance extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("averageSpikeTimeScore", (n) -> { currentObject.setAverageSpikeTimeScore(n.getIntegerValue()); });
        deserializerMap.put("cpuSpikeTimePercentage", (n) -> { currentObject.setCpuSpikeTimePercentage(n.getDoubleValue()); });
        deserializerMap.put("cpuSpikeTimePercentageThreshold", (n) -> { currentObject.setCpuSpikeTimePercentageThreshold(n.getDoubleValue()); });
        deserializerMap.put("cpuSpikeTimeScore", (n) -> { currentObject.setCpuSpikeTimeScore(n.getIntegerValue()); });
        ...
        deserializerMap.put("deviceResourcePerformanceScore", (n) -> { currentObject.setDeviceResourcePerformanceScore(n.getIntegerValue()); });
        ...
        deserializerMap.put("ramSpikeTimePercentage", (n) -> { currentObject.setRamSpikeTimePercentage(n.getDoubleValue()); });
        deserializerMap.put("ramSpikeTimePercentageThreshold", (n) -> { currentObject.setRamSpikeTimePercentageThreshold(n.getDoubleValue()); });
        deserializerMap.put("ramSpikeTimeScore", (n) -> { currentObject.setRamSpikeTimeScore(n.getIntegerValue()); });
