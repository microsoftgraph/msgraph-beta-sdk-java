...
/**
 * The class for the Android For Work Imported PFXCertificate Profile.
 */
public class AndroidForWorkImportedPFXCertificateProfile extends AndroidCertificateProfileBase implements IJsonBackedObject {
