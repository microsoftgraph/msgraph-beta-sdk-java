...
public class AndroidForWorkImportedPFXCertificateProfile extends AndroidCertificateProfileBase implements Parsable {
    ...
    public static AndroidForWorkImportedPFXCertificateProfile createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidForWorkImportedPFXCertificateProfile currentObject = this;
