...
public class Office365GroupsActivityDetail extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exchangeMailboxStorageUsedInBytes", (n) -> { currentObject.setExchangeMailboxStorageUsedInBytes(n.getLongValue()); });
        deserializerMap.put("exchangeMailboxTotalItemCount", (n) -> { currentObject.setExchangeMailboxTotalItemCount(n.getLongValue()); });
        deserializerMap.put("exchangeReceivedEmailCount", (n) -> { currentObject.setExchangeReceivedEmailCount(n.getLongValue()); });
        deserializerMap.put("externalMemberCount", (n) -> { currentObject.setExternalMemberCount(n.getLongValue()); });
        deserializerMap.put("groupDisplayName", (n) -> { currentObject.setGroupDisplayName(n.getStringValue()); });
        deserializerMap.put("groupId", (n) -> { currentObject.setGroupId(n.getStringValue()); });
        deserializerMap.put("groupType", (n) -> { currentObject.setGroupType(n.getStringValue()); });
        deserializerMap.put("isDeleted", (n) -> { currentObject.setIsDeleted(n.getBooleanValue()); });
        deserializerMap.put("lastActivityDate", (n) -> { currentObject.setLastActivityDate(n.getLocalDateValue()); });
        deserializerMap.put("memberCount", (n) -> { currentObject.setMemberCount(n.getLongValue()); });
        deserializerMap.put("ownerPrincipalName", (n) -> { currentObject.setOwnerPrincipalName(n.getStringValue()); });
        ...
        deserializerMap.put("sharePointActiveFileCount", (n) -> { currentObject.setSharePointActiveFileCount(n.getLongValue()); });
        deserializerMap.put("sharePointSiteStorageUsedInBytes", (n) -> { currentObject.setSharePointSiteStorageUsedInBytes(n.getLongValue()); });
        deserializerMap.put("sharePointTotalFileCount", (n) -> { currentObject.setSharePointTotalFileCount(n.getLongValue()); });
        deserializerMap.put("yammerLikedMessageCount", (n) -> { currentObject.setYammerLikedMessageCount(n.getLongValue()); });
        deserializerMap.put("yammerPostedMessageCount", (n) -> { currentObject.setYammerPostedMessageCount(n.getLongValue()); });
        deserializerMap.put("yammerReadMessageCount", (n) -> { currentObject.setYammerReadMessageCount(n.getLongValue()); });
