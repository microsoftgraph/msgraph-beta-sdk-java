...
public class TeamworkDevice extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activity", (n) -> { currentObject.setActivity(n.getObjectValue(TeamworkDeviceActivity::createFromDiscriminatorValue)); });
        deserializerMap.put("activityState", (n) -> { currentObject.setActivityState(n.getEnumValue(TeamworkDeviceActivityState.class)); });
        deserializerMap.put("companyAssetTag", (n) -> { currentObject.setCompanyAssetTag(n.getStringValue()); });
        deserializerMap.put("configuration", (n) -> { currentObject.setConfiguration(n.getObjectValue(TeamworkDeviceConfiguration::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("currentUser", (n) -> { currentObject.setCurrentUser(n.getObjectValue(TeamworkUserIdentity::createFromDiscriminatorValue)); });
        deserializerMap.put("deviceType", (n) -> { currentObject.setDeviceType(n.getEnumValue(TeamworkDeviceType.class)); });
        deserializerMap.put("hardwareDetail", (n) -> { currentObject.setHardwareDetail(n.getObjectValue(TeamworkHardwareDetail::createFromDiscriminatorValue)); });
        deserializerMap.put("health", (n) -> { currentObject.setHealth(n.getObjectValue(TeamworkDeviceHealth::createFromDiscriminatorValue)); });
        deserializerMap.put("healthStatus", (n) -> { currentObject.setHealthStatus(n.getEnumValue(TeamworkDeviceHealthStatus.class)); });
        ...
        deserializerMap.put("operations", (n) -> { currentObject.setOperations(n.getCollectionOfObjectValues(TeamworkDeviceOperation::createFromDiscriminatorValue)); });
