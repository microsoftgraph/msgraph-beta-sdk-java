...
public class OperatingSystemVersionRange implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("highestVersion", (n) -> { currentObject.setHighestVersion(n.getStringValue()); });
        deserializerMap.put("lowestVersion", (n) -> { currentObject.setLowestVersion(n.getStringValue()); });
