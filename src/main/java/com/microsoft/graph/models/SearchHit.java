...
public class SearchHit implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("_id", (n) -> { this.set_id(n.getStringValue()); });
        deserializerMap.put("_score", (n) -> { this.set_score(n.getIntegerValue()); });
        deserializerMap.put("_source", (n) -> { this.set_source(n.getObjectValue(Entity::createFromDiscriminatorValue)); });
        deserializerMap.put("_summary", (n) -> { this.set_summary(n.getStringValue()); });
