...
public class SearchHit implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("_id", (n) -> { currentObject.set_id(n.getStringValue()); });
        deserializerMap.put("_score", (n) -> { currentObject.set_score(n.getIntegerValue()); });
        deserializerMap.put("_source", (n) -> { currentObject.set_source(n.getObjectValue(Entity::createFromDiscriminatorValue)); });
        deserializerMap.put("_summary", (n) -> { currentObject.set_summary(n.getStringValue()); });
