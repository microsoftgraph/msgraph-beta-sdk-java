...
public class AndroidDeviceOwnerSilentCertificateAccess implements AdditionalDataHolder, Parsable {
    ...
    public static AndroidDeviceOwnerSilentCertificateAccess createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidDeviceOwnerSilentCertificateAccess currentObject = this;
