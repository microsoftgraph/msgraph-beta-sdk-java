...
public class CustomExtensionCalloutResult extends AuthenticationEventHandlerResult implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("calloutDateTime", (n) -> { currentObject.setCalloutDateTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("httpStatus", (n) -> { currentObject.setHttpStatus(n.getIntegerValue()); });
        deserializerMap.put("numberOfAttempts", (n) -> { currentObject.setNumberOfAttempts(n.getIntegerValue()); });
