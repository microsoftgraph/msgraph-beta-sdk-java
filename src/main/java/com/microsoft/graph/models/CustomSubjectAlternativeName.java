...
public class CustomSubjectAlternativeName implements AdditionalDataHolder, Parsable {
    ...
    public static CustomSubjectAlternativeName createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
