...
public class ItemFacet extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedAudiences", (n) -> { currentObject.setAllowedAudiences(n.getEnumValue(AllowedAudiences.class)); });
        ...
        deserializerMap.put("inference", (n) -> { currentObject.setInference(n.getObjectValue(InferenceData::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("source", (n) -> { currentObject.setSource(n.getObjectValue(PersonDataSources::createFromDiscriminatorValue)); });
