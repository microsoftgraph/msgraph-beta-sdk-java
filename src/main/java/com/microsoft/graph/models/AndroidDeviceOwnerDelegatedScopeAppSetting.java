...
public class AndroidDeviceOwnerDelegatedScopeAppSetting implements AdditionalDataHolder, Parsable {
    ...
    public static AndroidDeviceOwnerDelegatedScopeAppSetting createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAppDetail(@javax.annotation.Nullable final AppListItem value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAppScopes(@javax.annotation.Nullable final java.util.List<AndroidDeviceOwnerDelegatedAppScopeType> value) {
