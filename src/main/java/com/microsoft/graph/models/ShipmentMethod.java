...
public class ShipmentMethod extends Entity implements Parsable {
    /** The code property */
    ...
    public static ShipmentMethod createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ShipmentMethod currentObject = this;
