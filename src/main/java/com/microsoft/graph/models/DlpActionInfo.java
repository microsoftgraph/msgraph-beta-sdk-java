...
import com.microsoft.graph.models.BlockAccessAction;
import com.microsoft.graph.models.DeviceRestrictionAction;
import com.microsoft.graph.models.NotifyUserAction;
...
public class DlpActionInfo implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { currentObject.setAction(n.getEnumValue(DlpAction.class)); });
