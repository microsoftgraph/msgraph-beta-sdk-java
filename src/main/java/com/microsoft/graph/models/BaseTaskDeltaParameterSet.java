...
/**
 * The class for the Base Task Delta Parameter Set.
 */
public class BaseTaskDeltaParameterSet {

    /**
     * Instiaciates a new BaseTaskDeltaParameterSet
     */
     ...
     */
    protected BaseTaskDeltaParameterSet(@Nonnull final BaseTaskDeltaParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the BaseTaskDeltaParameterSet
     */
    public static final class BaseTaskDeltaParameterSetBuilder {
        /**
         * Instanciates a new BaseTaskDeltaParameterSetBuilder
         */
        @Nullable
