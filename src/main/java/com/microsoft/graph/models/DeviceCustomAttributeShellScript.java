...
public class DeviceCustomAttributeShellScript extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customAttributeName", (n) -> { currentObject.setCustomAttributeName(n.getStringValue()); });
        deserializerMap.put("customAttributeType", (n) -> { currentObject.setCustomAttributeType(n.getEnumValue(DeviceCustomAttributeValueType.class)); });
