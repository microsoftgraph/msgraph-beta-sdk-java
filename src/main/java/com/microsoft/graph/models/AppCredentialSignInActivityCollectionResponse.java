...
public class AppCredentialSignInActivityCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    /** The value property */
    private java.util.List<AppCredentialSignInActivity> value;
    /**
     * Instantiates a new AppCredentialSignInActivityCollectionResponse and sets the default values.
     * @return a void
     */
    ...
    public static AppCredentialSignInActivityCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<AppCredentialSignInActivity> value) {
        this.value = value;
    }
}
