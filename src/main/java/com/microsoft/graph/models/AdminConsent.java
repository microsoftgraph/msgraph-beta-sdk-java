...
public class AdminConsent implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("shareAPNSData", (n) -> { this.setShareAPNSData(n.getEnumValue(AdminConsentState::forValue)); });
        deserializerMap.put("shareUserExperienceAnalyticsData", (n) -> { this.setShareUserExperienceAnalyticsData(n.getEnumValue(AdminConsentState::forValue)); });
    ...
    public AdminConsentState getShareAPNSData() {
        return this.backingStore.get("shareAPNSData");
    }
    /**
    ...
    public AdminConsentState getShareUserExperienceAnalyticsData() {
        return this.backingStore.get("shareUserExperienceAnalyticsData");
    }
    /**
    ...
    public void setShareAPNSData(@jakarta.annotation.Nullable final AdminConsentState value) {
        this.backingStore.set("shareAPNSData", value);
    }
    /**
    ...
    public void setShareUserExperienceAnalyticsData(@jakarta.annotation.Nullable final AdminConsentState value) {
        this.backingStore.set("shareUserExperienceAnalyticsData", value);
    }
}
