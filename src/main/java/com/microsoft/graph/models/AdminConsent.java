...
public class AdminConsent implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("shareAPNSData", (n) -> { currentObject.setShareAPNSData(n.getEnumValue(AdminConsentState.class)); });
        deserializerMap.put("shareUserExperienceAnalyticsData", (n) -> { currentObject.setShareUserExperienceAnalyticsData(n.getEnumValue(AdminConsentState.class)); });
