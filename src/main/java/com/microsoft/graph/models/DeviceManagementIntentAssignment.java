...
public class DeviceManagementIntentAssignment extends Entity implements Parsable {
    ...
    public static DeviceManagementIntentAssignment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeviceManagementIntentAssignment currentObject = this;
