...
public class AuthenticationSourceFilter implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static AuthenticationSourceFilter createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
