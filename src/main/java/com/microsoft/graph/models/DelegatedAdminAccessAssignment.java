...
public class DelegatedAdminAccessAssignment extends Entity implements Parsable {
    ...
    public DelegatedAdminAccessAssignment() {
        super();
        this.setOdataType("#microsoft.graph.delegatedAdminAccessAssignment");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accessContainer", (n) -> { currentObject.setAccessContainer(n.getObjectValue(DelegatedAdminAccessContainer::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { currentObject.setStatus(n.getEnumValue(DelegatedAdminAccessAssignmentStatus.class)); });
