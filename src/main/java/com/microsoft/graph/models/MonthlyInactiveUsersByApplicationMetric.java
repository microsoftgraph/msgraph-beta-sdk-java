...
public class MonthlyInactiveUsersByApplicationMetric extends InactiveUsersByApplicationMetricBase implements Parsable {
     ...
     */
    private Long inactiveCalendarMonthCount;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("inactiveCalendarMonthCount", (n) -> { this.setInactiveCalendarMonthCount(n.getLongValue()); });
    ...
    public Long getInactiveCalendarMonthCount() {
        return this.inactiveCalendarMonthCount;
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeLongValue("inactiveCalendarMonthCount", this.getInactiveCalendarMonthCount());
    }
    /**
     ...
     */
    public void setInactiveCalendarMonthCount(@jakarta.annotation.Nullable final Long value) {
        this.inactiveCalendarMonthCount = value;
    }
}
