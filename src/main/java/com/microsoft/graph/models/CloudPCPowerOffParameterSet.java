...
/**
 * The class for the Cloud PCPower Off Parameter Set.
 */
public class CloudPCPowerOffParameterSet {

    /**
     * Instiaciates a new CloudPCPowerOffParameterSet
     */
     ...
     */
    protected CloudPCPowerOffParameterSet(@Nonnull final CloudPCPowerOffParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the CloudPCPowerOffParameterSet
     */
    public static final class CloudPCPowerOffParameterSetBuilder {
        /**
         * Instanciates a new CloudPCPowerOffParameterSetBuilder
         */
        @Nullable
