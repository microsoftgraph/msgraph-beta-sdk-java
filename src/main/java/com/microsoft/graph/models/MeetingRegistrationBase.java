...
public class MeetingRegistrationBase extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowedRegistrant", (n) -> { currentObject.setAllowedRegistrant(n.getEnumValue(MeetingAudience.class)); });
        deserializerMap.put("registrants", (n) -> { currentObject.setRegistrants(n.getCollectionOfObjectValues(MeetingRegistrantBase::createFromDiscriminatorValue)); });
