...
/**
 * The class for the Platform Credential Authentication Method.
 */
public class PlatformCredentialAuthenticationMethod extends AuthenticationMethod implements IJsonBackedObject {
