...
public class UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
