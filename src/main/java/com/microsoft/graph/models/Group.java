...
public class Group extends DirectoryObject implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accessType", (n) -> { currentObject.setAccessType(n.getEnumValue(GroupAccessType.class)); });
        ...
        deserializerMap.put("membershipRuleProcessingStatus", (n) -> { currentObject.setMembershipRuleProcessingStatus(n.getObjectValue(MembershipRuleProcessingStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("organizationId", (n) -> { currentObject.setOrganizationId(n.getStringValue()); });
        ...
        deserializerMap.put("resourceBehaviorOptions", (n) -> { currentObject.setResourceBehaviorOptions(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("resourceProvisioningOptions", (n) -> { currentObject.setResourceProvisioningOptions(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("settings", (n) -> { currentObject.setSettings(n.getCollectionOfObjectValues(DirectorySetting::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("unseenConversationsCount", (n) -> { currentObject.setUnseenConversationsCount(n.getIntegerValue()); });
        deserializerMap.put("unseenCount", (n) -> { currentObject.setUnseenCount(n.getIntegerValue()); });
        deserializerMap.put("unseenMessagesCount", (n) -> { currentObject.setUnseenMessagesCount(n.getIntegerValue()); });
        deserializerMap.put("visibility", (n) -> { currentObject.setVisibility(n.getStringValue()); });
        deserializerMap.put("writebackConfiguration", (n) -> { currentObject.setWritebackConfiguration(n.getObjectValue(GroupWritebackConfiguration::createFromDiscriminatorValue)); });
