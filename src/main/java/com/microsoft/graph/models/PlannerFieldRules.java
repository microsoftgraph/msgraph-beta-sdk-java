...
import com.microsoft.graph.models.PlannerRuleOverride;
...
/**
 * The class for the Planner Field Rules.
 */
public class PlannerFieldRules implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<String> defaultRules;
    ...
    @Expose
	@Nullable
    public java.util.List<PlannerRuleOverride> overrides;
