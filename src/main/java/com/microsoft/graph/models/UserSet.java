...
public class UserSet implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static UserSet createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Boolean getIsBackup() {
        return this.backingStore.get("isBackup");
    }
    /**
     ...
     */
    public void setIsBackup(@jakarta.annotation.Nullable final Boolean value) {
        this.backingStore.set("isBackup", value);
    }
    /**
