...
public class DeviceManagementExchangeOnPremisesPolicy extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("accessRules", (n) -> { currentObject.setAccessRules(n.getCollectionOfObjectValues(DeviceManagementExchangeAccessRule::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("defaultAccessLevel", (n) -> { currentObject.setDefaultAccessLevel(n.getEnumValue(DeviceManagementExchangeAccessLevel.class)); });
        deserializerMap.put("knownDeviceClasses", (n) -> { currentObject.setKnownDeviceClasses(n.getCollectionOfObjectValues(DeviceManagementExchangeDeviceClass::createFromDiscriminatorValue)); });
        deserializerMap.put("notificationContent", (n) -> { currentObject.setNotificationContent(n.getByteArrayValue()); });
