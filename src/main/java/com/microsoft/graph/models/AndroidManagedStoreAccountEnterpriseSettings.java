...
public class AndroidManagedStoreAccountEnterpriseSettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("androidDeviceOwnerFullyManagedEnrollmentEnabled", (n) -> { currentObject.setAndroidDeviceOwnerFullyManagedEnrollmentEnabled(n.getBooleanValue()); });
        deserializerMap.put("bindStatus", (n) -> { currentObject.setBindStatus(n.getEnumValue(AndroidManagedStoreAccountBindStatus.class)); });
        deserializerMap.put("companyCodes", (n) -> { currentObject.setCompanyCodes(n.getCollectionOfObjectValues(AndroidEnrollmentCompanyCode::createFromDiscriminatorValue)); });
        deserializerMap.put("deviceOwnerManagementEnabled", (n) -> { currentObject.setDeviceOwnerManagementEnabled(n.getBooleanValue()); });
        deserializerMap.put("enrollmentTarget", (n) -> { currentObject.setEnrollmentTarget(n.getEnumValue(AndroidManagedStoreAccountEnrollmentTarget.class)); });
        deserializerMap.put("lastAppSyncDateTime", (n) -> { currentObject.setLastAppSyncDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("lastAppSyncStatus", (n) -> { currentObject.setLastAppSyncStatus(n.getEnumValue(AndroidManagedStoreAccountAppSyncStatus.class)); });
        deserializerMap.put("lastModifiedDateTime", (n) -> { currentObject.setLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("managedGooglePlayInitialScopeTagIds", (n) -> { currentObject.setManagedGooglePlayInitialScopeTagIds(n.getCollectionOfPrimitiveValues(String.class)); });
