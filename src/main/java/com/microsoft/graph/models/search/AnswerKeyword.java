...
public class AnswerKeyword implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("matchSimilarKeywords", (n) -> { currentObject.setMatchSimilarKeywords(n.getBooleanValue()); });
        deserializerMap.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
        deserializerMap.put("reservedKeywords", (n) -> { currentObject.setReservedKeywords(n.getCollectionOfPrimitiveValues(String.class)); });
