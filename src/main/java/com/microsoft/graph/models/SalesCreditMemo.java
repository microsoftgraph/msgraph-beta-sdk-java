...
public class SalesCreditMemo extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("creditMemoDate", (n) -> { currentObject.setCreditMemoDate(n.getLocalDateValue()); });
        ...
        deserializerMap.put("invoiceNumber", (n) -> { currentObject.setInvoiceNumber(n.getStringValue()); });
