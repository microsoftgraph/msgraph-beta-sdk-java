...
public class PropertyToEvaluate implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public String getPropertyValue() {
        return this.BackingStore.get("propertyValue");
    }
    /**
    ...
    public void setPropertyValue(@jakarta.annotation.Nullable final String value) {
        this.BackingStore.set("propertyValue", value);
    }
}
