...
public class UserExperienceAnalyticsBatteryHealthCapacityDetails extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("batteryCapacityFair", (n) -> { currentObject.setBatteryCapacityFair(n.getIntegerValue()); });
        deserializerMap.put("batteryCapacityGood", (n) -> { currentObject.setBatteryCapacityGood(n.getIntegerValue()); });
        deserializerMap.put("batteryCapacityPoor", (n) -> { currentObject.setBatteryCapacityPoor(n.getIntegerValue()); });
