...
public class CloudPcCrossCloudGovernmentOrganizationMapping extends Entity implements Parsable {
    ...
    private java.util.List<String> _organizationIdsInUSGovCloud;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final CloudPcCrossCloudGovernmentOrganizationMapping currentObject = this;
        final HashMap<String, Consumer<ParseNode>> deserializerMap = new HashMap<String, Consumer<ParseNode>>(super.getFieldDeserializers());
        deserializerMap.put("organizationIdsInUSGovCloud", (n) -> { currentObject.setOrganizationIdsInUSGovCloud(n.getCollectionOfPrimitiveValues(String.class)); });
    ...
    public java.util.List<String> getOrganizationIdsInUSGovCloud() {
        return this._organizationIdsInUSGovCloud;
    }
    /**
    ...
    public void setOrganizationIdsInUSGovCloud(@javax.annotation.Nullable final java.util.List<String> value) {
        this._organizationIdsInUSGovCloud = value;
    }
}
