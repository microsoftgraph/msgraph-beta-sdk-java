...
/**
 * The class for the Trust Framework Key Set Get Active Key Parameter Set.
 */
public class TrustFrameworkKeySetGetActiveKeyParameterSet {

    /**
     * Instiaciates a new TrustFrameworkKeySetGetActiveKeyParameterSet
     */
     ...
     */
    protected TrustFrameworkKeySetGetActiveKeyParameterSet(@Nonnull final TrustFrameworkKeySetGetActiveKeyParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the TrustFrameworkKeySetGetActiveKeyParameterSet
     */
    public static final class TrustFrameworkKeySetGetActiveKeyParameterSetBuilder {
        /**
         * Instanciates a new TrustFrameworkKeySetGetActiveKeyParameterSetBuilder
         */
        @Nullable
