...
/**
 * The class for the Workbook Document Task Count Parameter Set.
 */
public class WorkbookDocumentTaskCountParameterSet {

    /**
     * Instiaciates a new WorkbookDocumentTaskCountParameterSet
     */
     ...
     */
    protected WorkbookDocumentTaskCountParameterSet(@Nonnull final WorkbookDocumentTaskCountParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the WorkbookDocumentTaskCountParameterSet
     */
    public static final class WorkbookDocumentTaskCountParameterSetBuilder {
        /**
         * Instanciates a new WorkbookDocumentTaskCountParameterSetBuilder
         */
        @Nullable
