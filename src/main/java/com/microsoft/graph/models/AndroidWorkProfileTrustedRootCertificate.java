...
public class AndroidWorkProfileTrustedRootCertificate extends DeviceConfiguration implements Parsable {
    ...
    public static AndroidWorkProfileTrustedRootCertificate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final AndroidWorkProfileTrustedRootCertificate currentObject = this;
