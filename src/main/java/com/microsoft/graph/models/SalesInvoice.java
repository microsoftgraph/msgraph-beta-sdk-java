...
public class SalesInvoice extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("customerPurchaseOrderReference", (n) -> { currentObject.setCustomerPurchaseOrderReference(n.getStringValue()); });
        ...
        deserializerMap.put("invoiceDate", (n) -> { currentObject.setInvoiceDate(n.getLocalDateValue()); });
        ...
        deserializerMap.put("orderId", (n) -> { currentObject.setOrderId(n.getStringValue()); });
        deserializerMap.put("orderNumber", (n) -> { currentObject.setOrderNumber(n.getStringValue()); });
        ...
        deserializerMap.put("pricesIncludeTax", (n) -> { currentObject.setPricesIncludeTax(n.getBooleanValue()); });
        deserializerMap.put("salesInvoiceLines", (n) -> { currentObject.setSalesInvoiceLines(n.getCollectionOfObjectValues(SalesInvoiceLine::createFromDiscriminatorValue)); });
