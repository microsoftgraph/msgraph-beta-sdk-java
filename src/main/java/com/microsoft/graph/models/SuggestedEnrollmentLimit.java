...
public class SuggestedEnrollmentLimit implements AdditionalDataHolder, BackedModel, Parsable {
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public static SuggestedEnrollmentLimit createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("suggestedDailyLimit", (n) -> { this.setSuggestedDailyLimit(n.getIntegerValue()); });
    ...
    public Integer getSuggestedDailyLimit() {
        return this.backingStore.get("suggestedDailyLimit");
    }
    /**
     ...
     */
    public void setSuggestedDailyLimit(@jakarta.annotation.Nullable final Integer value) {
        this.backingStore.set("suggestedDailyLimit", value);
    }
}
