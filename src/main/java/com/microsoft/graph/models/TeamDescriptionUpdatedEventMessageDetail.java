...
/**
 * The class for the Team Description Updated Event Message Detail.
 */
public class TeamDescriptionUpdatedEventMessageDetail extends EventMessageDetail implements IJsonBackedObject {
