...
public class AuthenticationCombinationConfiguration extends Entity implements Parsable {
    ...
    private java.util.List<String> _appliesToCombinations;
    /**
    ...
    public java.util.List<String> getAppliesToCombinations() {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<>(super.getFieldDeserializers()) {{
            this.put("appliesToCombinations", (n) -> { currentObject.setAppliesToCombinations(n.getCollectionOfPrimitiveValues(String.class)); });
        }};
    }
    /**
    ...
    public void serialize(@javax.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfPrimitiveValues("appliesToCombinations", this.getAppliesToCombinations());
    }
    /**
     ...
     * @return a void
     */
    public void setAppliesToCombinations(@javax.annotation.Nullable final java.util.List<String> value) {
