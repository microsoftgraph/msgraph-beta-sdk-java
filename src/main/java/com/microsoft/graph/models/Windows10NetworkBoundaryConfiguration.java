...
public class Windows10NetworkBoundaryConfiguration extends DeviceConfiguration implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("windowsNetworkIsolationPolicy", (n) -> { currentObject.setWindowsNetworkIsolationPolicy(n.getObjectValue(WindowsNetworkIsolationPolicy::createFromDiscriminatorValue)); });
