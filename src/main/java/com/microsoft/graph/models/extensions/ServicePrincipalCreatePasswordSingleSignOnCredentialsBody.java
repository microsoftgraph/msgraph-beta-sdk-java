...
/**
 * The class for the Service Principal Create Password Single Sign On Credentials Body.
 */
public class ServicePrincipalCreatePasswordSingleSignOnCredentialsBody {
