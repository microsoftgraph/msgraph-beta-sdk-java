...
/**
 * The class for the Channel Get All Messages Parameter Set.
 */
public class ChannelGetAllMessagesParameterSet {
     ...
     */
    protected ChannelGetAllMessagesParameterSet(@Nonnull final ChannelGetAllMessagesParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the ChannelGetAllMessagesParameterSet
     */
    public static final class ChannelGetAllMessagesParameterSetBuilder {
        /**
         * Instanciates a new ChannelGetAllMessagesParameterSetBuilder
         */
        @Nullable
