...
public class ReportRootGetGroupPrintUsageSummaryParameterSet {
    ...
    public static final class ReportRootGetGroupPrintUsageSummaryParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetGroupPrintUsageSummaryParameterSetBuilder withPeriodStart(@Nullable final java.util.Calendar val) {
         ...
         */
        @Nonnull
        public ReportRootGetGroupPrintUsageSummaryParameterSetBuilder withPeriodEnd(@Nullable final java.util.Calendar val) {
            this.periodEnd = val;
            return this;
        }
        /**
