...
/**
 * The class for the Android Device Owner Enrollment Profile Revoke Token Parameter Set.
 */
public class AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSet {

    /**
     * Instiaciates a new AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSet
     */
     ...
     */
    protected AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSet(@Nonnull final AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSet
     */
    public static final class AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSetBuilder {
        /**
         * Instanciates a new AndroidDeviceOwnerEnrollmentProfileRevokeTokenParameterSetBuilder
         */
        @Nullable
