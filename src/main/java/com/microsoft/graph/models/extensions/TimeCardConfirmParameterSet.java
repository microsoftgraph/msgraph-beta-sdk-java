...
/**
 * The class for the Time Card Confirm Parameter Set.
 */
public class TimeCardConfirmParameterSet {

    /**
     * Instiaciates a new TimeCardConfirmParameterSet
     */
     ...
     */
    protected TimeCardConfirmParameterSet(@Nonnull final TimeCardConfirmParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the TimeCardConfirmParameterSet
     */
    public static final class TimeCardConfirmParameterSetBuilder {
        /**
         * Instanciates a new TimeCardConfirmParameterSetBuilder
         */
        @Nullable
