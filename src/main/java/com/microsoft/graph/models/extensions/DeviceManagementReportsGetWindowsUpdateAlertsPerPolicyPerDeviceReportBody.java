...
/**
 * The class for the Device Management Reports Get Windows Update Alerts Per Policy Per Device Report Body.
 */
public class DeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportBody {
