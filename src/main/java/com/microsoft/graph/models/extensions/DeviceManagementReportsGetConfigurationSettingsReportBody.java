...
/**
 * The class for the Device Management Reports Get Configuration Settings Report Body.
 */
public class DeviceManagementReportsGetConfigurationSettingsReportBody {
