...
public class DeviceManagementConfigurationSetting extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("settingDefinitions")) {
            settingDefinitions = serializer.deserializeObject(json.get("settingDefinitions").toString(), DeviceManagementConfigurationSettingDefinitionCollectionPage.class);
        }
    }
}
