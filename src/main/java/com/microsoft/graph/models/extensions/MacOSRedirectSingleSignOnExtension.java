...
/**
 * The class for the Mac OSRedirect Single Sign On Extension.
 */
public class MacOSRedirectSingleSignOnExtension extends MacOSSingleSignOnExtension implements IJsonBackedObject {
