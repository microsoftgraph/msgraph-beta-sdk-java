...
/**
 * The class for the Device Management Get Assigned Role Details Parameter Set.
 */
public class DeviceManagementGetAssignedRoleDetailsParameterSet {

    /**
     * Instiaciates a new DeviceManagementGetAssignedRoleDetailsParameterSet
     */
     ...
     */
    protected DeviceManagementGetAssignedRoleDetailsParameterSet(@Nonnull final DeviceManagementGetAssignedRoleDetailsParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceManagementGetAssignedRoleDetailsParameterSet
     */
    public static final class DeviceManagementGetAssignedRoleDetailsParameterSetBuilder {
        /**
         * Instanciates a new DeviceManagementGetAssignedRoleDetailsParameterSetBuilder
         */
        @Nullable
