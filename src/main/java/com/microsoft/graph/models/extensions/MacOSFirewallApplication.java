...
/**
 * The class for the Mac OSFirewall Application.
 */
public class MacOSFirewallApplication implements IJsonBackedObject {
     ...
     */
    @SerializedName(value = "allowsIncomingConnections", alternate = {"AllowsIncomingConnections"})
    @Expose
