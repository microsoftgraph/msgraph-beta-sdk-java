...
/**
 * The class for the Ios Derived Credential Authentication Configuration.
 */
public class IosDerivedCredentialAuthenticationConfiguration extends DeviceConfiguration implements IJsonBackedObject {
