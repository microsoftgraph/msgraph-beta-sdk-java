...
/**
 * The class for the Microsoft Store For Business Contained App.
 */
public class MicrosoftStoreForBusinessContainedApp extends MobileContainedApp implements IJsonBackedObject {
