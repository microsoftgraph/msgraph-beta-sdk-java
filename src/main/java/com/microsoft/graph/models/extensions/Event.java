...
public class Event extends OutlookItem implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("exceptionOccurrences")) {
            ...
            if (json.has("exceptionOccurrences@odata.nextLink")) {
                response.nextLink = json.get("exceptionOccurrences@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("exceptionOccurrences").toString(), JsonObject[].class);
            ...
            response.value = Arrays.asList(array);
            exceptionOccurrences = new EventCollectionPage(response, null);
        }
