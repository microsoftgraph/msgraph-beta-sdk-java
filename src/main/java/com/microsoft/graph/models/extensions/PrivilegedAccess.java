...
public class PrivilegedAccess extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("resources")) {
            final GovernanceResourceCollectionResponse response = new GovernanceResourceCollectionResponse();
            ...
            final GovernanceResource[] array = new GovernanceResource[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), GovernanceResource.class);
