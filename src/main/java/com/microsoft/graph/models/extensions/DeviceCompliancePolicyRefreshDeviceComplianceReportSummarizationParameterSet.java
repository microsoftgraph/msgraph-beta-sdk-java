...
/**
 * The class for the Device Compliance Policy Refresh Device Compliance Report Summarization Parameter Set.
 */
public class DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSet {

    /**
     * Instiaciates a new DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSet
     */
     ...
     */
    protected DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSet(@Nonnull final DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSet
     */
    public static final class DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSetBuilder {
        /**
         * Instanciates a new DeviceCompliancePolicyRefreshDeviceComplianceReportSummarizationParameterSetBuilder
         */
        @Nullable
