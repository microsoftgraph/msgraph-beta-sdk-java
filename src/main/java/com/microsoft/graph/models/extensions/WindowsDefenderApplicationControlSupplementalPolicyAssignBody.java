...
/**
 * The class for the Windows Defender Application Control Supplemental Policy Assign Body.
 */
public class WindowsDefenderApplicationControlSupplementalPolicyAssignBody {
