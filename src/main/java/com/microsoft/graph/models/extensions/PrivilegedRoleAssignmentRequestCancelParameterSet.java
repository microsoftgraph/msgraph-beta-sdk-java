...
/**
 * The class for the Privileged Role Assignment Request Cancel Parameter Set.
 */
public class PrivilegedRoleAssignmentRequestCancelParameterSet {

    /**
     * Instiaciates a new PrivilegedRoleAssignmentRequestCancelParameterSet
     */
     ...
     */
    protected PrivilegedRoleAssignmentRequestCancelParameterSet(@Nonnull final PrivilegedRoleAssignmentRequestCancelParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PrivilegedRoleAssignmentRequestCancelParameterSet
     */
    public static final class PrivilegedRoleAssignmentRequestCancelParameterSetBuilder {
        /**
         * Instanciates a new PrivilegedRoleAssignmentRequestCancelParameterSetBuilder
         */
        @Nullable
