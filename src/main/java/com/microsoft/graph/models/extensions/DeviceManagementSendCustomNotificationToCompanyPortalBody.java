...
/**
 * The class for the Device Management Send Custom Notification To Company Portal Body.
 */
public class DeviceManagementSendCustomNotificationToCompanyPortalBody {
