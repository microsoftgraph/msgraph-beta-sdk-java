...
public class ReportRootGetOverallPrintUsageSummaryParameterSet {
    ...
    public static final class ReportRootGetOverallPrintUsageSummaryParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetOverallPrintUsageSummaryParameterSetBuilder withPeriodStart(@Nullable final java.util.Calendar val) {
         ...
         */
        @Nonnull
        public ReportRootGetOverallPrintUsageSummaryParameterSetBuilder withPeriodEnd(@Nullable final java.util.Calendar val) {
            this.periodEnd = val;
            return this;
        }
        /**
