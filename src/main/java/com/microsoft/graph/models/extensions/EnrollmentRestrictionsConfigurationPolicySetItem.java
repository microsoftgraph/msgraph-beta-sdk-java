...
/**
 * The class for the Enrollment Restrictions Configuration Policy Set Item.
 */
public class EnrollmentRestrictionsConfigurationPolicySetItem extends PolicySetItem implements IJsonBackedObject {
