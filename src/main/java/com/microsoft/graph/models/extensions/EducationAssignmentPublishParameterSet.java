...
/**
 * The class for the Education Assignment Publish Parameter Set.
 */
public class EducationAssignmentPublishParameterSet {

    /**
     * Instiaciates a new EducationAssignmentPublishParameterSet
     */
     ...
     */
    protected EducationAssignmentPublishParameterSet(@Nonnull final EducationAssignmentPublishParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EducationAssignmentPublishParameterSet
     */
    public static final class EducationAssignmentPublishParameterSetBuilder {
        /**
         * Instanciates a new EducationAssignmentPublishParameterSetBuilder
         */
        @Nullable
