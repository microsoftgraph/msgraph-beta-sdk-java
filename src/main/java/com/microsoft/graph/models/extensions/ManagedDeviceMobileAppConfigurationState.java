...
/**
 * The class for the Managed Device Mobile App Configuration State.
 */
public class ManagedDeviceMobileAppConfigurationState extends Entity implements IJsonBackedObject {
