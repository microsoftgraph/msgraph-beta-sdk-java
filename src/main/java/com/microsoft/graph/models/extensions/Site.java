...
public class Site extends BaseItem implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("pages")) {
            final SitePageCollectionResponse response = new SitePageCollectionResponse();
            ...
            final SitePage[] array = new SitePage[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), SitePage.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            pages = new SitePageCollectionPage(response, null);
        }
