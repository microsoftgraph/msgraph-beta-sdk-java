...
/**
 * The class for the Privileged Approval My Requests Parameter Set.
 */
public class PrivilegedApprovalMyRequestsParameterSet {

    /**
     * Instiaciates a new PrivilegedApprovalMyRequestsParameterSet
     */
     ...
     */
    protected PrivilegedApprovalMyRequestsParameterSet(@Nonnull final PrivilegedApprovalMyRequestsParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the PrivilegedApprovalMyRequestsParameterSet
     */
    public static final class PrivilegedApprovalMyRequestsParameterSetBuilder {
        /**
         * Instanciates a new PrivilegedApprovalMyRequestsParameterSetBuilder
         */
        @Nullable
