...
public class CallPlayPromptParameterSet {
    ...
    public static final class CallPlayPromptParameterSetBuilder {
         ...
         */
        @Nonnull
        public CallPlayPromptParameterSetBuilder withLoop(@Nullable final Boolean val) {
            this.loop = val;
            return this;
        }
        /**
    ...
    public java.util.List<com.microsoft.graph.options.FunctionOption> getFunctionOptions() {
        ...
        if(this.loop != null) {
            result.add(new com.microsoft.graph.options.FunctionOption("loop", loop));
        }
