...
/**
 * The class for the Windows Autopilot Device Identity Assign Resource Account To Device Body.
 */
public class WindowsAutopilotDeviceIdentityAssignResourceAccountToDeviceBody {
