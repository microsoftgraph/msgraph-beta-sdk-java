...
/**
 * The class for the Device Management Reports Get Windows Update Alert Summary Report Body.
 */
public class DeviceManagementReportsGetWindowsUpdateAlertSummaryReportBody {
