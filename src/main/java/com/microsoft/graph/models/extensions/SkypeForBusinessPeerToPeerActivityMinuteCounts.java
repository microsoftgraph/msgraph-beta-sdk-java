...
/**
 * The class for the Skype For Business Peer To Peer Activity Minute Counts.
 */
public class SkypeForBusinessPeerToPeerActivityMinuteCounts extends Entity implements IJsonBackedObject {
