...
/**
 * The class for the Group Policy Presentation Check Box.
 */
public class GroupPolicyPresentationCheckBox extends GroupPolicyPresentation implements IJsonBackedObject {
