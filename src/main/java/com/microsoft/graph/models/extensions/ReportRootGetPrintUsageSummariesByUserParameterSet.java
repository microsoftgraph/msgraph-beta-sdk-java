...
public class ReportRootGetPrintUsageSummariesByUserParameterSet {
    ...
    public static final class ReportRootGetPrintUsageSummariesByUserParameterSetBuilder {
         ...
         */
        @Nonnull
        public ReportRootGetPrintUsageSummariesByUserParameterSetBuilder withPeriodStart(@Nullable final java.util.Calendar val) {
         ...
         */
        @Nonnull
        public ReportRootGetPrintUsageSummariesByUserParameterSetBuilder withPeriodEnd(@Nullable final java.util.Calendar val) {
            this.periodEnd = val;
            return this;
        }
        /**
