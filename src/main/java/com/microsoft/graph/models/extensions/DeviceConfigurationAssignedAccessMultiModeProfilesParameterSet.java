...
/**
 * The class for the Device Configuration Assigned Access Multi Mode Profiles Parameter Set.
 */
public class DeviceConfigurationAssignedAccessMultiModeProfilesParameterSet {
    ...
    /**
     * Instiaciates a new DeviceConfigurationAssignedAccessMultiModeProfilesParameterSet
     */
     ...
     */
    protected DeviceConfigurationAssignedAccessMultiModeProfilesParameterSet(@Nonnull final DeviceConfigurationAssignedAccessMultiModeProfilesParameterSetBuilder builder) {
        this.assignedAccessMultiModeProfiles = builder.assignedAccessMultiModeProfiles;
    }
    /**
    ...
    /**
     * Fluent builder for the DeviceConfigurationAssignedAccessMultiModeProfilesParameterSet
     */
    public static final class DeviceConfigurationAssignedAccessMultiModeProfilesParameterSetBuilder {
        /**
         * The assignedAccessMultiModeProfiles parameter value
         */
        @Nullable
         ...
         */
        @Nonnull
        public DeviceConfigurationAssignedAccessMultiModeProfilesParameterSetBuilder withAssignedAccessMultiModeProfiles(@Nullable final java.util.List<WindowsAssignedAccessProfile> val) {
            this.assignedAccessMultiModeProfiles = val;
            return this;
        }
        /**
         * Instanciates a new DeviceConfigurationAssignedAccessMultiModeProfilesParameterSetBuilder
         */
        @Nullable
    ...
    public java.util.List<com.microsoft.graph.options.FunctionOption> getFunctionOptions() {
        ...
        if(this.assignedAccessMultiModeProfiles != null) {
            result.add(new com.microsoft.graph.options.FunctionOption("assignedAccessMultiModeProfiles", assignedAccessMultiModeProfiles));
        }
        return result;
    }
    /**
