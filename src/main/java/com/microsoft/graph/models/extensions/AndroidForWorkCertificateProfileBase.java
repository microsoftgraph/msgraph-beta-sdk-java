...
/**
 * The class for the Android For Work Certificate Profile Base.
 */
public class AndroidForWorkCertificateProfileBase extends DeviceConfiguration implements IJsonBackedObject {
