...
/**
 * The class for the Android For Work Enrollment Profile Revoke Token Parameter Set.
 */
public class AndroidForWorkEnrollmentProfileRevokeTokenParameterSet {

    /**
     * Instiaciates a new AndroidForWorkEnrollmentProfileRevokeTokenParameterSet
     */
     ...
     */
    protected AndroidForWorkEnrollmentProfileRevokeTokenParameterSet(@Nonnull final AndroidForWorkEnrollmentProfileRevokeTokenParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the AndroidForWorkEnrollmentProfileRevokeTokenParameterSet
     */
    public static final class AndroidForWorkEnrollmentProfileRevokeTokenParameterSetBuilder {
        /**
         * Instanciates a new AndroidForWorkEnrollmentProfileRevokeTokenParameterSetBuilder
         */
        @Nullable
