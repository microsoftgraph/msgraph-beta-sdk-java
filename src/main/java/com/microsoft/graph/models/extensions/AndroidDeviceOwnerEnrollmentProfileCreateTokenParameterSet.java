...
/**
 * The class for the Android Device Owner Enrollment Profile Create Token Parameter Set.
 */
public class AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSet {
    ...
    /**
     * Instiaciates a new AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSet
     */
     ...
     */
    protected AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSet(@Nonnull final AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSet
     */
    public static final class AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSetBuilder {
         ...
         */
        @Nonnull
        public AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSetBuilder withTokenValidityInSeconds(@Nullable final Integer val) {
            this.tokenValidityInSeconds = val;
            return this;
        }
        /**
         * Instanciates a new AndroidDeviceOwnerEnrollmentProfileCreateTokenParameterSetBuilder
         */
        @Nullable
