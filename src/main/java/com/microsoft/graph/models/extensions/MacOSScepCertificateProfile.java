...
/**
 * The class for the Mac OSScep Certificate Profile.
 */
public class MacOSScepCertificateProfile extends MacOSCertificateProfileBase implements IJsonBackedObject {
