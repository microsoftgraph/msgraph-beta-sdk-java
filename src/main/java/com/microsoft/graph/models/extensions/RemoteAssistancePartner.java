...
public class RemoteAssistancePartner extends Entity implements IJsonBackedObject {
    ...
    /**
     * The Onboarding Request Expiry Date Time.
     * When the OnboardingStatus is Onboarding, This is the date time when the onboarding request expires.
     */
    @SerializedName(value = "onboardingRequestExpiryDateTime", alternate = {"OnboardingRequestExpiryDateTime"})
    @Expose
	@Nullable
    public java.util.Calendar onboardingRequestExpiryDateTime;
