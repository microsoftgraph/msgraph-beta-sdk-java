...
public class User extends DirectoryObject implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("joinedGroups")) {
            joinedGroups = serializer.deserializeObject(json.get("joinedGroups").toString(), GroupCollectionPage.class);
        }
        ...
        if (json.has("appConsentRequestsForApproval")) {
            appConsentRequestsForApproval = serializer.deserializeObject(json.get("appConsentRequestsForApproval").toString(), AppConsentRequestCollectionPage.class);
        }

        if (json.has("approvals")) {
            approvals = serializer.deserializeObject(json.get("approvals").toString(), ApprovalCollectionPage.class);
        }

        if (json.has("pendingAccessReviewInstances")) {
            pendingAccessReviewInstances = serializer.deserializeObject(json.get("pendingAccessReviewInstances").toString(), AccessReviewInstanceCollectionPage.class);
        }
        ...
        if (json.has("mobileAppIntentAndStates")) {
            mobileAppIntentAndStates = serializer.deserializeObject(json.get("mobileAppIntentAndStates").toString(), MobileAppIntentAndStateCollectionPage.class);
        }
        ...
        if (json.has("devices")) {
            devices = serializer.deserializeObject(json.get("devices").toString(), DeviceCollectionPage.class);
        }
        ...
        if (json.has("chats")) {
            chats = serializer.deserializeObject(json.get("chats").toString(), ChatCollectionPage.class);
        }
