...
import com.microsoft.graph.models.extensions.SignInActivity;
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("appConsentRequestsForApproval")) {
            ...
            if (json.has("appConsentRequestsForApproval@odata.nextLink")) {
                response.nextLink = json.get("appConsentRequestsForApproval@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("appConsentRequestsForApproval").toString(), JsonObject[].class);
            final AppConsentRequest[] array = new AppConsentRequest[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), AppConsentRequest.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
        ...
        if (json.has("pendingAccessReviewInstances")) {
            ...
            if (json.has("pendingAccessReviewInstances@odata.nextLink")) {
                response.nextLink = json.get("pendingAccessReviewInstances@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("pendingAccessReviewInstances").toString(), JsonObject[].class);
            ...
            response.value = Arrays.asList(array);
            pendingAccessReviewInstances = new AccessReviewInstanceCollectionPage(response, null);
        }
        ...
        if (json.has("mobileAppIntentAndStates")) {
            final MobileAppIntentAndStateCollectionResponse response = new MobileAppIntentAndStateCollectionResponse();
            if (json.has("mobileAppIntentAndStates@odata.nextLink")) {
                response.nextLink = json.get("mobileAppIntentAndStates@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("mobileAppIntentAndStates").toString(), JsonObject[].class);
            final MobileAppIntentAndState[] array = new MobileAppIntentAndState[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), MobileAppIntentAndState.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            mobileAppIntentAndStates = new MobileAppIntentAndStateCollectionPage(response, null);
        }
        ...
        if (json.has("notifications")) {
            final NotificationCollectionResponse response = new NotificationCollectionResponse();
            if (json.has("notifications@odata.nextLink")) {
                response.nextLink = json.get("notifications@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("notifications").toString(), JsonObject[].class);
            final Notification[] array = new Notification[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), Notification.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            notifications = new NotificationCollectionPage(response, null);
        }
        ...
        if (json.has("devices")) {
            final DeviceCollectionResponse response = new DeviceCollectionResponse();
            if (json.has("devices@odata.nextLink")) {
                response.nextLink = json.get("devices@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("devices").toString(), JsonObject[].class);
            final Device[] array = new Device[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), Device.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            devices = new DeviceCollectionPage(response, null);
        }
        ...
        if (json.has("chats")) {
            final ChatCollectionResponse response = new ChatCollectionResponse();
            if (json.has("chats@odata.nextLink")) {
                response.nextLink = json.get("chats@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("chats").toString(), JsonObject[].class);
            final Chat[] array = new Chat[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), Chat.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            chats = new ChatCollectionPage(response, null);
        }
