...
/**
 * The class for the Device Management User Rights Local User Or Group.
 */
public class DeviceManagementUserRightsLocalUserOrGroup implements IJsonBackedObject {
