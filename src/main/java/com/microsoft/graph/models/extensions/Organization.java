...
import com.microsoft.graph.models.extensions.DirectorySizeQuota;
...
public class Organization extends DirectoryObject implements IJsonBackedObject {
     ...
     * 
     */
    @SerializedName("directorySizeQuota")
    @Expose
     ...
     */
    @SerializedName("isMultipleDataLocationsForServicesEnabled")
    @Expose
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("brandings")) {
            final OrganizationalBrandingCollectionResponse response = new OrganizationalBrandingCollectionResponse();
            if (json.has("brandings@odata.nextLink")) {
                response.nextLink = json.get("brandings@odata.nextLink").getAsString();
            }

            final JsonObject[] sourceArray = serializer.deserializeObject(json.get("brandings").toString(), JsonObject[].class);
            final OrganizationalBranding[] array = new OrganizationalBranding[sourceArray.length];
            for (int i = 0; i < sourceArray.length; i++) {
                array[i] = serializer.deserializeObject(sourceArray[i].toString(), OrganizationalBranding.class);
                array[i].setRawObject(serializer, sourceArray[i]);
            }
            response.value = Arrays.asList(array);
            brandings = new OrganizationalBrandingCollectionPage(response, null);
        }
