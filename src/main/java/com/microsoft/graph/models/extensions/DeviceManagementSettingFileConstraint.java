...
/**
 * The class for the Device Management Setting File Constraint.
 */
public class DeviceManagementSettingFileConstraint extends DeviceManagementConstraint implements IJsonBackedObject {
