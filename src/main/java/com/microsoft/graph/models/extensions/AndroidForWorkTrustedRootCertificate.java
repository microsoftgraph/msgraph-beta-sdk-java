...
/**
 * The class for the Android For Work Trusted Root Certificate.
 */
public class AndroidForWorkTrustedRootCertificate extends DeviceConfiguration implements IJsonBackedObject {
