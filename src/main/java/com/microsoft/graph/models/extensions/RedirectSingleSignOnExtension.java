...
/**
 * The class for the Redirect Single Sign On Extension.
 */
public class RedirectSingleSignOnExtension extends SingleSignOnExtension implements IJsonBackedObject {
