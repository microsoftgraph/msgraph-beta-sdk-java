...
public class WindowsNetworkIsolationPolicy implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("enterpriseCloudResources", (n) -> { currentObject.setEnterpriseCloudResources(n.getCollectionOfObjectValues(ProxiedDomain::createFromDiscriminatorValue)); });
        deserializerMap.put("enterpriseInternalProxyServers", (n) -> { currentObject.setEnterpriseInternalProxyServers(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("enterpriseIPRanges", (n) -> { currentObject.setEnterpriseIPRanges(n.getCollectionOfObjectValues(IpRange::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("enterpriseNetworkDomainNames", (n) -> { currentObject.setEnterpriseNetworkDomainNames(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("enterpriseProxyServers", (n) -> { currentObject.setEnterpriseProxyServers(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("neutralDomainResources", (n) -> { currentObject.setNeutralDomainResources(n.getCollectionOfPrimitiveValues(String.class)); });
