...
/**
 * The class for the Mac OSAssociated Domains Item.
 */
public class MacOSAssociatedDomainsItem implements IJsonBackedObject {
    ...
    /**
     * The Direct Downloads Enabled.
     * Determines whether data should be downloaded directly or via a CDN.
     */
    @SerializedName(value = "directDownloadsEnabled", alternate = {"DirectDownloadsEnabled"})
    @Expose
	@Nullable
    public Boolean directDownloadsEnabled;
