...
public class PrivilegedRoleSettings extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("approvalOnElevation", (n) -> { currentObject.setApprovalOnElevation(n.getBooleanValue()); });
        deserializerMap.put("approverIds", (n) -> { currentObject.setApproverIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("elevationDuration", (n) -> { currentObject.setElevationDuration(n.getPeriodValue()); });
        deserializerMap.put("isMfaOnElevationConfigurable", (n) -> { currentObject.setIsMfaOnElevationConfigurable(n.getBooleanValue()); });
        deserializerMap.put("lastGlobalAdmin", (n) -> { currentObject.setLastGlobalAdmin(n.getBooleanValue()); });
        deserializerMap.put("maxElavationDuration", (n) -> { currentObject.setMaxElavationDuration(n.getPeriodValue()); });
        deserializerMap.put("mfaOnElevation", (n) -> { currentObject.setMfaOnElevation(n.getBooleanValue()); });
        deserializerMap.put("minElevationDuration", (n) -> { currentObject.setMinElevationDuration(n.getPeriodValue()); });
        deserializerMap.put("notificationToUserOnElevation", (n) -> { currentObject.setNotificationToUserOnElevation(n.getBooleanValue()); });
        deserializerMap.put("ticketingInfoOnElevation", (n) -> { currentObject.setTicketingInfoOnElevation(n.getBooleanValue()); });
