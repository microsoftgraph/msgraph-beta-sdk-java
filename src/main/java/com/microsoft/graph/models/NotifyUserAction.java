...
public class NotifyUserAction extends DlpActionInfo implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionLastModifiedDateTime", (n) -> { currentObject.setActionLastModifiedDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("emailText", (n) -> { currentObject.setEmailText(n.getStringValue()); });
        deserializerMap.put("overrideOption", (n) -> { currentObject.setOverrideOption(n.getEnumValue(OverrideOption.class)); });
