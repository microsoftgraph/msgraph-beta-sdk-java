...
public class IosManagedAppProtection extends TargetedManagedAppProtection implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("exemptedUniversalLinks", (n) -> { currentObject.setExemptedUniversalLinks(n.getCollectionOfPrimitiveValues(String.class)); });
        ...
        deserializerMap.put("managedUniversalLinks", (n) -> { currentObject.setManagedUniversalLinks(n.getCollectionOfPrimitiveValues(String.class)); });
