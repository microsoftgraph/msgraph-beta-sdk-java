...
public class OnPremisesDirectorySynchronizationConfiguration implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        return new HashMap<String, Consumer<ParseNode>>(4) {{
            this.put("accidentalDeletionPrevention", (n) -> { currentObject.setAccidentalDeletionPrevention(n.getObjectValue(OnPremisesAccidentalDeletionPrevention::createFromDiscriminatorValue)); });
            this.put("customerRequestedSynchronizationInterval", (n) -> { currentObject.setCustomerRequestedSynchronizationInterval(n.getPeriodValue()); });
            this.put("@odata.type", (n) -> { currentObject.setOdataType(n.getStringValue()); });
            this.put("synchronizationInterval", (n) -> { currentObject.setSynchronizationInterval(n.getPeriodValue()); });
        }};
    }
    /**
