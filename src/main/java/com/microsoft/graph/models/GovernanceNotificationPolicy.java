...
public class GovernanceNotificationPolicy implements AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    public java.util.List<String> getEnabledTemplateTypes() {
        return this.backingStore.get("enabledTemplateTypes");
    }
    /**
     ...
     * @return a java.util.List<GovernanceNotificationTemplate>
     */
    @jakarta.annotation.Nullable
    ...
    public void setEnabledTemplateTypes(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.backingStore.set("enabledTemplateTypes", value);
    }
    /**
