...
public class AndroidDeviceOwnerEnterpriseWiFiConfiguration extends AndroidDeviceOwnerWiFiConfiguration implements Parsable {
     ...
     */
    private AndroidDeviceOwnerCertificateProfileBase identityCertificateForClientAuthentication;
    /**
     ...
     */
    private AndroidDeviceOwnerTrustedRootCertificate rootCertificateForServerValidation;
    /**
    ...
    public static AndroidDeviceOwnerEnterpriseWiFiConfiguration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setIdentityCertificateForClientAuthentication(@jakarta.annotation.Nullable final AndroidDeviceOwnerCertificateProfileBase value) {
