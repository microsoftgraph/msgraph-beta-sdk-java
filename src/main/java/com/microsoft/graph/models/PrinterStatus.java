...
public class PrinterStatus implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("processingState", (n) -> { currentObject.setProcessingState(n.getEnumValue(PrinterProcessingState.class)); });
        deserializerMap.put("processingStateDescription", (n) -> { currentObject.setProcessingStateDescription(n.getStringValue()); });
        deserializerMap.put("processingStateReasons", (n) -> { currentObject.setProcessingStateReasons(n.getCollectionOfEnumValues(PrinterProcessingStateReason.class)); });
