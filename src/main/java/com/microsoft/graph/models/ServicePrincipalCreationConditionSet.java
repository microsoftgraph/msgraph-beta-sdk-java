...
public class ServicePrincipalCreationConditionSet extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("applicationIds", (n) -> { currentObject.setApplicationIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("applicationPublisherIds", (n) -> { currentObject.setApplicationPublisherIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("applicationsFromVerifiedPublisherOnly", (n) -> { currentObject.setApplicationsFromVerifiedPublisherOnly(n.getBooleanValue()); });
        deserializerMap.put("applicationTenantIds", (n) -> { currentObject.setApplicationTenantIds(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("certifiedApplicationsOnly", (n) -> { currentObject.setCertifiedApplicationsOnly(n.getBooleanValue()); });
