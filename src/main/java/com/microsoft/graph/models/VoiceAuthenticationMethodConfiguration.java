...
import com.microsoft.graph.requests.VoiceAuthenticationMethodTargetCollectionPage;
...
public class VoiceAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public com.microsoft.graph.requests.VoiceAuthenticationMethodTargetCollectionPage includeTargets;
    ...
    public void setRawObject(@Nonnull final ISerializer serializer, @Nonnull final JsonObject json) {
        ...
        if (json.has("includeTargets")) {
            includeTargets = serializer.deserializeObject(json.get("includeTargets"), com.microsoft.graph.requests.VoiceAuthenticationMethodTargetCollectionPage.class);
        }
    }
}
