...
public class MobileApp extends Entity implements Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("installSummary", (n) -> { this.setInstallSummary(n.getObjectValue(MobileAppInstallSummary::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("userStatuses", (n) -> { this.setUserStatuses(n.getCollectionOfObjectValues(UserAppInstallStatus::createFromDiscriminatorValue)); });
