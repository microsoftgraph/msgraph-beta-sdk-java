...
/**
 * The class for the Skype For Business Organizer Activity Minute Counts.
 */
public class SkypeForBusinessOrganizerActivityMinuteCounts extends Entity implements IJsonBackedObject {
