...
public class PrivilegedAccessGroupEligibilityScheduleCollectionResponse extends BaseCollectionPaginationCountResponse implements Parsable {
    ...
    public static PrivilegedAccessGroupEligibilityScheduleCollectionResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
