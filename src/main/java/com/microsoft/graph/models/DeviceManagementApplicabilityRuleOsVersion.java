...
public class DeviceManagementApplicabilityRuleOsVersion implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maxOSVersion", (n) -> { currentObject.setMaxOSVersion(n.getStringValue()); });
        deserializerMap.put("minOSVersion", (n) -> { currentObject.setMinOSVersion(n.getStringValue()); });
