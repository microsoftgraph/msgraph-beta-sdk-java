...
public class DeviceManagementComplianceActionItem extends Entity implements Parsable {
    ...
    public static DeviceManagementComplianceActionItem createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("actionType", (n) -> { currentObject.setActionType(n.getEnumValue(DeviceManagementComplianceActionType.class)); });
