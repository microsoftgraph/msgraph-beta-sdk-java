...
/**
 * The class for the Aosp Device Owner Pkcs Certificate Profile.
 */
public class AospDeviceOwnerPkcsCertificateProfile extends AospDeviceOwnerCertificateProfileBase implements IJsonBackedObject {
