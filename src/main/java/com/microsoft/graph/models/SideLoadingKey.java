...
public class SideLoadingKey extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastUpdatedDateTime", (n) -> { this.setLastUpdatedDateTime(n.getStringValue()); });
        deserializerMap.put("totalActivation", (n) -> { this.setTotalActivation(n.getIntegerValue()); });
