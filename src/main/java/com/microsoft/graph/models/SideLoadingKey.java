...
public class SideLoadingKey extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("lastUpdatedDateTime", (n) -> { currentObject.setLastUpdatedDateTime(n.getStringValue()); });
        deserializerMap.put("totalActivation", (n) -> { currentObject.setTotalActivation(n.getIntegerValue()); });
