...
public class PlannerChecklistRequirement implements AdditionalDataHolder, Parsable {
    ...
    public static PlannerChecklistRequirement createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("requiredChecklistItemIds", (n) -> { this.setRequiredChecklistItemIds(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setRequiredChecklistItemIds(@javax.annotation.Nullable final java.util.List<String> value) {
