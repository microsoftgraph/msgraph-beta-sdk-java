...
public class OAuth2PermissionGrant extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("expiryTime", (n) -> { currentObject.setExpiryTime(n.getOffsetDateTimeValue()); });
        ...
        deserializerMap.put("startTime", (n) -> { currentObject.setStartTime(n.getOffsetDateTimeValue()); });
