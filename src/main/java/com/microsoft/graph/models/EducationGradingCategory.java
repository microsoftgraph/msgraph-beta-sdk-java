...
/**
 * The class for the Education Grading Category.
 */
public class EducationGradingCategory extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public Integer percentageWeight;
