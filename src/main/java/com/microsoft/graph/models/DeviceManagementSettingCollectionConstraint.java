...
public class DeviceManagementSettingCollectionConstraint extends DeviceManagementConstraint implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("maximumLength", (n) -> { currentObject.setMaximumLength(n.getIntegerValue()); });
        deserializerMap.put("minimumLength", (n) -> { currentObject.setMinimumLength(n.getIntegerValue()); });
