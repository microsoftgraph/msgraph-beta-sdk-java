...
public class ExactMatchSessionBase extends ExactMatchJobBase implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dataStoreId", (n) -> { currentObject.setDataStoreId(n.getStringValue()); });
        deserializerMap.put("processingCompletionDateTime", (n) -> { currentObject.setProcessingCompletionDateTime(n.getOffsetDateTimeValue()); });
        deserializerMap.put("remainingBlockCount", (n) -> { currentObject.setRemainingBlockCount(n.getIntegerValue()); });
        deserializerMap.put("remainingJobCount", (n) -> { currentObject.setRemainingJobCount(n.getIntegerValue()); });
        deserializerMap.put("state", (n) -> { currentObject.setState(n.getStringValue()); });
        deserializerMap.put("totalBlockCount", (n) -> { currentObject.setTotalBlockCount(n.getIntegerValue()); });
        deserializerMap.put("totalJobCount", (n) -> { currentObject.setTotalJobCount(n.getIntegerValue()); });
        deserializerMap.put("uploadCompletionDateTime", (n) -> { currentObject.setUploadCompletionDateTime(n.getOffsetDateTimeValue()); });
