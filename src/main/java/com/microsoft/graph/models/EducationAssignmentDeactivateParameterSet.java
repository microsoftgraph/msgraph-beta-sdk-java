...
/**
 * The class for the Education Assignment Deactivate Parameter Set.
 */
public class EducationAssignmentDeactivateParameterSet {

    /**
     * Instiaciates a new EducationAssignmentDeactivateParameterSet
     */
     ...
     */
    protected EducationAssignmentDeactivateParameterSet(@Nonnull final EducationAssignmentDeactivateParameterSetBuilder builder) {
    }
    /**
    ...
    /**
     * Fluent builder for the EducationAssignmentDeactivateParameterSet
     */
    public static final class EducationAssignmentDeactivateParameterSetBuilder {
        /**
         * Instanciates a new EducationAssignmentDeactivateParameterSetBuilder
         */
        @Nullable
