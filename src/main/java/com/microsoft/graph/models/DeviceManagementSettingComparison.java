...
public class DeviceManagementSettingComparison implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("comparisonResult", (n) -> { currentObject.setComparisonResult(n.getEnumValue(DeviceManagementComparisonResult.class)); });
        deserializerMap.put("currentValueJson", (n) -> { currentObject.setCurrentValueJson(n.getStringValue()); });
        ...
        deserializerMap.put("newValueJson", (n) -> { currentObject.setNewValueJson(n.getStringValue()); });
