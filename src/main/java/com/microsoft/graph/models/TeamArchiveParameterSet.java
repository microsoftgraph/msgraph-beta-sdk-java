...
public class TeamArchiveParameterSet {
    ...
    public static final class TeamArchiveParameterSetBuilder {
         ...
         */
        @Nonnull
        public TeamArchiveParameterSetBuilder withShouldSetSpoSiteReadOnlyForMembers(@Nullable final Boolean val) {
            this.shouldSetSpoSiteReadOnlyForMembers = val;
            return this;
        }
        /**
         * Instanciates a new TeamArchiveParameterSetBuilder
         */
        @Nullable
