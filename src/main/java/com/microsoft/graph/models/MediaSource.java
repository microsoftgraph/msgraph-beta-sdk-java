...
public class MediaSource implements AdditionalDataHolder, Parsable {
    ...
    private MediaSourceContentCategory contentCategory;
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("contentCategory", (n) -> { this.setContentCategory(n.getEnumValue(MediaSourceContentCategory.class)); });
