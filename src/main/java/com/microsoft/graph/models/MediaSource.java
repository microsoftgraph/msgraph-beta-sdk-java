...
public class MediaSource implements AdditionalDataHolder, Parsable {
    ...
    public MediaSource() {
        ...
        this.setOdataType("#microsoft.graph.mediaSource");
    }
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("contentCategory", (n) -> { currentObject.setContentCategory(n.getEnumValue(MediaSourceContentCategory.class)); });
