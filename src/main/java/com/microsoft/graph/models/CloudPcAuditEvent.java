...
public class CloudPcAuditEvent extends Entity implements Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("activityOperationType", (n) -> { currentObject.setActivityOperationType(n.getEnumValue(CloudPcAuditActivityOperationType.class)); });
        deserializerMap.put("activityResult", (n) -> { currentObject.setActivityResult(n.getEnumValue(CloudPcAuditActivityResult.class)); });
        deserializerMap.put("activityType", (n) -> { currentObject.setActivityType(n.getStringValue()); });
        deserializerMap.put("actor", (n) -> { currentObject.setActor(n.getObjectValue(CloudPcAuditActor::createFromDiscriminatorValue)); });
        deserializerMap.put("category", (n) -> { currentObject.setCategory(n.getEnumValue(CloudPcAuditCategory.class)); });
        ...
        deserializerMap.put("resources", (n) -> { currentObject.setResources(n.getCollectionOfObjectValues(CloudPcAuditResource::createFromDiscriminatorValue)); });
