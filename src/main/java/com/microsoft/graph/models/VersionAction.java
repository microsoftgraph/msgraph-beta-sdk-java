...
public class VersionAction implements AdditionalDataHolder, Parsable {
    ...
    public static VersionAction createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("newVersion", (n) -> { currentObject.setNewVersion(n.getStringValue()); });
