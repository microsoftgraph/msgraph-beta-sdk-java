package microsoft.graph.administrativeunits.item.members.serviceprincipal;
...
import microsoft.graph.administrativeunits.item.members.serviceprincipal.count.CountRequestBuilder;
