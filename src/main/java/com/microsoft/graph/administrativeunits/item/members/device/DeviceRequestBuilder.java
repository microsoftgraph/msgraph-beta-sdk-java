package microsoft.graph.administrativeunits.item.members.device;
...
import microsoft.graph.administrativeunits.item.members.device.count.CountRequestBuilder;
