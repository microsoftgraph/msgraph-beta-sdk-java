package com.microsoft.graph.administrativeunits.item.members.device;

import com.microsoft.graph.administrativeunits.item.members.device.count.CountRequestBuilder;
