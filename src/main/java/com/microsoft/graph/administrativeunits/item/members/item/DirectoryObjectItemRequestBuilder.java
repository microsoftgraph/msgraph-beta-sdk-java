package microsoft.graph.administrativeunits.item.members.item;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.administrativeunits.item.members.item.application.ApplicationRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.device.DeviceRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.group.GroupRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.ref.RefRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.administrativeunits.item.members.item.user.UserRequestBuilder;
