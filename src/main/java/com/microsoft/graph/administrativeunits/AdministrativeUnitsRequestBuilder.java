package com.microsoft.graph.administrativeunits;

import com.microsoft.graph.administrativeunits.count.CountRequestBuilder;
import com.microsoft.graph.administrativeunits.delta.DeltaRequestBuilder;
import com.microsoft.graph.administrativeunits.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.administrativeunits.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.administrativeunits.item.AdministrativeUnitItemRequestBuilder;
import com.microsoft.graph.administrativeunits.validateproperties.ValidatePropertiesRequestBuilder;
