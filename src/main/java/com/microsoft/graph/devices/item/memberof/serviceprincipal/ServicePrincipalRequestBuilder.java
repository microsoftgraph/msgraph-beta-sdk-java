package com.microsoft.graph.devices.item.memberof.serviceprincipal;

import com.microsoft.graph.devices.item.memberof.serviceprincipal.count.CountRequestBuilder;
...
public class ServicePrincipalRequestBuilder {
    ...
    public ServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
