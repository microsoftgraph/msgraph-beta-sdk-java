package com.microsoft.graph.devices.item.transitivememberof.group;

import com.microsoft.graph.devices.item.transitivememberof.group.count.CountRequestBuilder;
