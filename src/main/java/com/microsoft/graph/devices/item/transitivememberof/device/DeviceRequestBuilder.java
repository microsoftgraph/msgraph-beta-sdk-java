package com.microsoft.graph.devices.item.transitivememberof.device;

import com.microsoft.graph.devices.item.transitivememberof.device.count.CountRequestBuilder;
