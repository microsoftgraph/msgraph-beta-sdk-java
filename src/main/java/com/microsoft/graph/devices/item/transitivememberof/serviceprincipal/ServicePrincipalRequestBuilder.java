package com.microsoft.graph.devices.item.transitivememberof.serviceprincipal;

import com.microsoft.graph.devices.item.transitivememberof.serviceprincipal.count.CountRequestBuilder;
