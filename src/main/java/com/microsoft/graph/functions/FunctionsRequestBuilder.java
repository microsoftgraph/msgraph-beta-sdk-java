...
public class FunctionsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse>();
