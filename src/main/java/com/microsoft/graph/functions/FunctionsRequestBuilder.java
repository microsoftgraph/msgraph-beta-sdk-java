...
public class FunctionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AttributeMappingFunctionSchema body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchemaCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AttributeMappingFunctionSchema> post(@javax.annotation.Nonnull final AttributeMappingFunctionSchema body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
