...
public class WorkflowVersionVersionNumberItemRequestBuilder {
     ...
     * @return a CompletableFuture of workflowVersion
     */
    public java.util.concurrent.CompletableFuture<WorkflowVersion> patch(@javax.annotation.Nonnull final WorkflowVersion body, @javax.annotation.Nullable final java.util.function.Consumer<WorkflowVersionVersionNumberItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
