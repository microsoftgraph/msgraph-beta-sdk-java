...
public class WorkflowVersionVersionNumberItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final WorkflowVersion body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<WorkflowVersion> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<WorkflowVersion> executionException = new java.util.concurrent.CompletableFuture<WorkflowVersion>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<WorkflowVersion> patch(@javax.annotation.Nonnull final WorkflowVersion body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
