...
public class CustomTaskExtensionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CustomTaskExtension body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CustomTaskExtensionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomTaskExtensionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomTaskExtensionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CustomTaskExtension> post(@javax.annotation.Nonnull final CustomTaskExtension body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomTaskExtension> executionException = new java.util.concurrent.CompletableFuture<CustomTaskExtension>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
