...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.runs.identitygovernancesummarywithstartdatetimewithenddatetime.IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class RunsRequestBuilder {
    ...
    public RunsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
