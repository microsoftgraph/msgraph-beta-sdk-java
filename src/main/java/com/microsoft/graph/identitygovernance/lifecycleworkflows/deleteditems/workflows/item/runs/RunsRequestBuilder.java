...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.runs.summarywithstartdatetimewithenddatetime.SummaryWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class RunsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final Run body) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<RunCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RunCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RunCollectionResponse>();
