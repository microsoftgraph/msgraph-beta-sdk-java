...
public class LifecycleWorkflowsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final LifecycleWorkflowsContainer body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer> executionException = new java.util.concurrent.CompletableFuture<LifecycleWorkflowsContainer>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
