package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.restore;
...
public class RestoreRequestBuilder {
     ...
     * @return a CompletableFuture of workflow
     */
    public java.util.concurrent.CompletableFuture<Workflow> post(@javax.annotation.Nullable final java.util.function.Consumer<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of workflow
     */
    public java.util.concurrent.CompletableFuture<Workflow> post(@javax.annotation.Nullable final java.util.function.Consumer<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createPostRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
