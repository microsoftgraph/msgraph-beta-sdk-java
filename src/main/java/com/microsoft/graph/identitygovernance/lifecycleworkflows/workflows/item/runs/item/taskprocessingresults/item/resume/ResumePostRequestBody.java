package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.runs.item.taskprocessingresults.item.resume;
...
public class ResumePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { currentObject.setData(n.getObjectValue(CustomTaskExtensionCallbackData::createFromDiscriminatorValue)); });
