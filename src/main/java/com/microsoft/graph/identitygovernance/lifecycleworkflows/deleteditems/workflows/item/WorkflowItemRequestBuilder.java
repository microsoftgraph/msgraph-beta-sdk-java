...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.activate.ActivateRequestBuilder;
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.createnewversion.CreateNewVersionRequestBuilder;
...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.executionscope.item.UserItemRequestBuilder;
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.restore.RestoreRequestBuilder;
...
public class WorkflowItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.lifecycleWorkflows.deletedItems.workflows.item.executionScope.item collection
     ...
     * @return a CompletableFuture of workflow
     */
    public java.util.concurrent.CompletableFuture<Workflow> patch(@javax.annotation.Nonnull final Workflow body, @javax.annotation.Nullable final java.util.function.Consumer<WorkflowItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of workflow
     */
    public java.util.concurrent.CompletableFuture<Workflow> patch(@javax.annotation.Nonnull final Workflow body, @javax.annotation.Nullable final java.util.function.Consumer<WorkflowItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.lifecycleWorkflows.deletedItems.workflows.item.runs.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.lifecycleWorkflows.deletedItems.workflows.item.taskReports.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.lifecycleWorkflows.deletedItems.workflows.item.userProcessingResults.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.identityGovernance.lifecycleWorkflows.deletedItems.workflows.item.versions.item collection
     * @param id Unique identifier of the item
