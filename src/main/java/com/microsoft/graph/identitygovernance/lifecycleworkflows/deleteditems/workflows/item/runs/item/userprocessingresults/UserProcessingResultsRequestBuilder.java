...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.runs.item.userprocessingresults.identitygovernancesummarywithstartdatetimewithenddatetime.IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class UserProcessingResultsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a identityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder
     */
    @javax.annotation.Nonnull
    public IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder identityGovernanceSummaryWithStartDateTimeWithEndDateTime(@javax.annotation.Nonnull final OffsetDateTime endDateTime, @javax.annotation.Nonnull final OffsetDateTime startDateTime) {
