...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.deleteditems.workflows.item.runs.item.userprocessingresults.summarywithstartdatetimewithenddatetime.SummaryWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class UserProcessingResultsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserProcessingResultCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserProcessingResultCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of UserProcessingResultCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<UserProcessingResultCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<UserProcessingResultsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserProcessingResultCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<UserProcessingResult> post(@javax.annotation.Nonnull final UserProcessingResult body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserProcessingResult::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of userProcessingResult
     */
    public java.util.concurrent.CompletableFuture<UserProcessingResult> post(@javax.annotation.Nonnull final UserProcessingResult body, @javax.annotation.Nullable final java.util.function.Consumer<UserProcessingResultsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, UserProcessingResult::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
