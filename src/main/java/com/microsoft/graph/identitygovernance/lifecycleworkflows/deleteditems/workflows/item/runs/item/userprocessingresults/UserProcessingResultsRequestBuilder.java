...
public class UserProcessingResultsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UserProcessingResult body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UserProcessingResultCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserProcessingResultCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UserProcessingResultCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UserProcessingResult> post(@javax.annotation.Nonnull final UserProcessingResult body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UserProcessingResult> executionException = new java.util.concurrent.CompletableFuture<UserProcessingResult>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserProcessingResult> post(@javax.annotation.Nonnull final UserProcessingResult body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
