...
import com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.taskreports.identitygovernancesummarywithstartdatetimewithenddatetime.IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder;
...
public class TaskReportsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public TaskReportItemRequestBuilder byTaskReportId(@javax.annotation.Nonnull final String taskReportId) {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/identitygovernance-workflow-list-taskreports?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
