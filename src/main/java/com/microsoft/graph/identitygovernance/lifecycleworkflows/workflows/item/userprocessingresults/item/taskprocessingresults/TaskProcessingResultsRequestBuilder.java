...
public class TaskProcessingResultsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TaskProcessingResult body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TaskProcessingResultCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TaskProcessingResultCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TaskProcessingResultCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TaskProcessingResult> post(@javax.annotation.Nonnull final TaskProcessingResult body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TaskProcessingResult> executionException = new java.util.concurrent.CompletableFuture<TaskProcessingResult>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TaskProcessingResult> post(@javax.annotation.Nonnull final TaskProcessingResult body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
