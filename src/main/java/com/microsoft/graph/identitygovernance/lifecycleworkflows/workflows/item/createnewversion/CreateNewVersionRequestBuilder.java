package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.createnewversion;
...
public class CreateNewVersionRequestBuilder {
     ...
     * @return a CompletableFuture of workflow
     */
    public java.util.concurrent.CompletableFuture<Workflow> post(@javax.annotation.Nonnull final CreateNewVersionPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<CreateNewVersionRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
