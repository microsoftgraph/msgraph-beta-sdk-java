...
public class SettingsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<LifecycleManagementSettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<LifecycleManagementSettings> executionException = new java.util.concurrent.CompletableFuture<LifecycleManagementSettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
