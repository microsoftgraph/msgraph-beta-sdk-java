package com.microsoft.graph.identitygovernance.lifecycleworkflows.workflows.item.identitygovernancerestore;
 ...
 */
public class IdentityGovernanceRestoreRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public IdentityGovernanceRestoreRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.restore", pathParameters);
    }
    /**
     * Instantiates a new IdentityGovernanceRestoreRequestBuilder and sets the default values.
    ...
    public IdentityGovernanceRestoreRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/identityGovernance.restore", rawUrl);
    }
    /**
