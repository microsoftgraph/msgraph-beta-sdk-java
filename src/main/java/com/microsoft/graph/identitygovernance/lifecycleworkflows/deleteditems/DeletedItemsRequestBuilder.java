...
public class DeletedItemsRequestBuilder {
     ...
     * @return a CompletableFuture of deletedItemContainer
     */
    public java.util.concurrent.CompletableFuture<DeletedItemContainer> patch(@javax.annotation.Nonnull final DeletedItemContainer body, @javax.annotation.Nullable final java.util.function.Consumer<DeletedItemsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
