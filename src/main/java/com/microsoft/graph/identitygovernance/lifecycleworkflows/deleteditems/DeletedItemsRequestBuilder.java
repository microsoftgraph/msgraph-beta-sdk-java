...
public class DeletedItemsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final DeletedItemContainer body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<DeletedItemContainer> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeletedItemContainer> executionException = new java.util.concurrent.CompletableFuture<DeletedItemContainer>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeletedItemContainer> patch(@javax.annotation.Nonnull final DeletedItemContainer body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
