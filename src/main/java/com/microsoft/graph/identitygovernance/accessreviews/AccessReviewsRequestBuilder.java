...
public class AccessReviewsRequestBuilder {
     ...
     * @return a CompletableFuture of accessReviewSet
     */
    public java.util.concurrent.CompletableFuture<AccessReviewSet> patch(@javax.annotation.Nonnull final AccessReviewSet body, @javax.annotation.Nullable final java.util.function.Consumer<AccessReviewsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
