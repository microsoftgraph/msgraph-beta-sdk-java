package com.microsoft.graph.identitygovernance.accessreviews.policy;
...
public class PolicyRequestBuilder {
    ...
    public PolicyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/policy{?%24select,%24expand}";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AccessReviewPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     * @return a CompletableFuture of accessReviewPolicy
     */
    public java.util.concurrent.CompletableFuture<AccessReviewPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of accessReviewPolicy
     */
    public java.util.concurrent.CompletableFuture<AccessReviewPolicy> get(@javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AccessReviewPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final AccessReviewPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
