...
public class PolicyRequestBuilder {
     ...
     * @return a CompletableFuture of accessReviewPolicy
     */
    public java.util.concurrent.CompletableFuture<AccessReviewPolicy> patch(@javax.annotation.Nonnull final AccessReviewPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of accessReviewPolicy
     */
    public java.util.concurrent.CompletableFuture<AccessReviewPolicy> patch(@javax.annotation.Nonnull final AccessReviewPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PolicyRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
