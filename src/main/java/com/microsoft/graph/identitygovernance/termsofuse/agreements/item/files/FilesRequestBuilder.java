package com.microsoft.graph.identitygovernance.termsofuse.agreements.item.files;

import com.microsoft.graph.identitygovernance.termsofuse.agreements.item.files.count.CountRequestBuilder;
