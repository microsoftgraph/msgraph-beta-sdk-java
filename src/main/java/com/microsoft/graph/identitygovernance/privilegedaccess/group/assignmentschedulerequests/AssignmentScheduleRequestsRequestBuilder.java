...
public class AssignmentScheduleRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the assignmentScheduleRequests property of the microsoft.graph.privilegedAccessGroup entity.
     * @param privilegedAccessGroupAssignmentScheduleRequestId Unique identifier of the item
     * @return a PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder byPrivilegedAccessGroupAssignmentScheduleRequestId(@javax.annotation.Nonnull final String privilegedAccessGroupAssignmentScheduleRequestId) {
    ...
    public AssignmentScheduleRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public AssignmentScheduleRequestsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PrivilegedAccessGroupAssignmentScheduleRequest body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final PrivilegedAccessGroupAssignmentScheduleRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
