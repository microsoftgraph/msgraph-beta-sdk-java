...
public class PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder {
    ...
    public PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}{?%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<PrivilegedAccessGroupAssignmentScheduleRequest> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PrivilegedAccessGroupAssignmentScheduleRequest> executionException = new java.util.concurrent.CompletableFuture<PrivilegedAccessGroupAssignmentScheduleRequest>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
