...
public class FilterByCurrentUserWithOnResponse extends BaseCollectionPaginationCountResponse implements Parsable {
     ...
     * The value property
     */
    private java.util.List<PrivilegedAccessGroupEligibilityScheduleRequest> value;
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<PrivilegedAccessGroupEligibilityScheduleRequest> value) {
        this.value = value;
    }
}
