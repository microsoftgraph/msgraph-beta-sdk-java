...
public class CustomExtensionHandlersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CustomExtensionHandler body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CustomExtensionHandlerCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomExtensionHandlerCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomExtensionHandlerCollectionResponse>();
