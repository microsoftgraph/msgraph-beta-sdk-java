...
public class AccessPackageAssignmentResourceRoleItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRole> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRole> executionException = new java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRole>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
