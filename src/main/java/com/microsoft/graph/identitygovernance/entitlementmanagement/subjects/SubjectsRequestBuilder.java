...
public class SubjectsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the subjects property of the microsoft.graph.entitlementManagement entity.
     * @param accessPackageSubjectId Unique identifier of the item
     * @return a AccessPackageSubjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public AccessPackageSubjectItemRequestBuilder byAccessPackageSubjectId(@javax.annotation.Nonnull final String accessPackageSubjectId) {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageSubjectCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccessPackageSubjectCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageSubjectCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessPackageSubject body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final AccessPackageSubject body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
