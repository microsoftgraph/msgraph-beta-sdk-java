...
public class CustomAccessPackageWorkflowExtensionsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CustomAccessPackageWorkflowExtension body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtensionCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtensionCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtensionCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtension> post(@javax.annotation.Nonnull final CustomAccessPackageWorkflowExtension body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtension> executionException = new java.util.concurrent.CompletableFuture<CustomAccessPackageWorkflowExtension>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
