...
import com.microsoft.graph.identitygovernance.entitlementmanagement.accesspackages.item.movetocatalog.MoveToCatalogRequestBuilder;
...
public class AccessPackageItemRequestBuilder extends BaseRequestBuilder {
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/accesspackage-list-accesspackageresourcerolescopes?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
