...
public class AccessPackageCatalogRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessPackageCatalogRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageCatalog{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AccessPackageCatalogRequestBuilder and sets the default values.
    ...
    public AccessPackageCatalogRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageCatalog{?%24select,%24expand}", rawUrl);
    }
    /**
