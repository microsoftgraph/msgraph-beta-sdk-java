...
public class AccessPackageSubjectItemRequestBuilder extends BaseRequestBuilder {
    /**
     ...
     */
    public AccessPackageSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AccessPackageSubjectItemRequestBuilder and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public AccessPackageSubjectItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects/{accessPackageSubject%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public AccessPackageSubjectItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new AccessPackageSubjectItemRequestBuilder(rawUrl, requestAdapter);
    }
    /**
