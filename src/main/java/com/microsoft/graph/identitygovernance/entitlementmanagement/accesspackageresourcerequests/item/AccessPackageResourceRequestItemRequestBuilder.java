...
public class AccessPackageResourceRequestItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AccessPackageResourceRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceRequest> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageResourceRequest> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceRequest>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
