package microsoft.graph.identitygovernance.entitlementmanagement.accesspackageassignmentresourceroles;
...
import microsoft.graph.identitygovernance.entitlementmanagement.accesspackageassignmentresourceroles.count.CountRequestBuilder;
import microsoft.graph.identitygovernance.entitlementmanagement.accesspackageassignmentresourceroles.my.MyRequestBuilder;
import microsoft.graph.models.AccessPackageAssignmentResourceRole;
import microsoft.graph.models.AccessPackageAssignmentResourceRoleCollectionResponse;
...
public class AccessPackageAssignmentResourceRolesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRoleCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessPackageAssignmentResourceRoleCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of AccessPackageAssignmentResourceRoleCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRoleCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AccessPackageAssignmentResourceRolesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, AccessPackageAssignmentResourceRoleCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of accessPackageAssignmentResourceRole
     */
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRole> post(@javax.annotation.Nonnull final AccessPackageAssignmentResourceRole body, @javax.annotation.Nullable final java.util.function.Consumer<AccessPackageAssignmentResourceRolesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
