...
public class AccessPackageAssignmentResourceRolesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRoleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRoleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageAssignmentResourceRoleCollectionResponse>();
