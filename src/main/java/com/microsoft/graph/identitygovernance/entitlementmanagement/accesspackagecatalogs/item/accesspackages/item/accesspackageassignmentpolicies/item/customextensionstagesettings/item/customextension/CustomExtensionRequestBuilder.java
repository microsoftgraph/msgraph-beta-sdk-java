package com.microsoft.graph.identitygovernance.entitlementmanagement.accesspackagecatalogs.item.accesspackages.item.accesspackageassignmentpolicies.item.customextensionstagesettings.item.customextension;
