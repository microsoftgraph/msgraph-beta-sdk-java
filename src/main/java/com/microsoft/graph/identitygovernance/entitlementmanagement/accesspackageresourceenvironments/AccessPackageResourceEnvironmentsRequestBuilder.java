...
public class AccessPackageResourceEnvironmentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceEnvironmentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageResourceEnvironmentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceEnvironmentCollectionResponse>();
