...
public class AccessPackageCatalogItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public CustomCalloutExtensionItemRequestBuilder accessPackageCustomWorkflowExtensions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("customCalloutExtension%2Did", id);
