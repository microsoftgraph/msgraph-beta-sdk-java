...
public class AccessPackageResourceRoleScopesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AccessPackageResourceRoleScope body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScopeCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScopeCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScopeCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScope> post(@javax.annotation.Nonnull final AccessPackageResourceRoleScope body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScope> executionException = new java.util.concurrent.CompletableFuture<AccessPackageResourceRoleScope>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
