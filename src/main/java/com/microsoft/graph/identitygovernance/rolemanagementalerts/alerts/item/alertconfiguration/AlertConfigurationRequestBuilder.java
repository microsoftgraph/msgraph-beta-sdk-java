package com.microsoft.graph.identitygovernance.rolemanagementalerts.alerts.item.alertconfiguration;
...
public class AlertConfigurationRequestBuilder extends BaseRequestBuilder {
    ...
    public AlertConfigurationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public AlertConfigurationRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
