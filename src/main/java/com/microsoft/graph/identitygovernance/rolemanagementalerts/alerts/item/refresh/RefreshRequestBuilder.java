package com.microsoft.graph.identitygovernance.rolemanagementalerts.alerts.item.refresh;
...
public class RefreshRequestBuilder {
    ...
    public RefreshRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/refresh";
