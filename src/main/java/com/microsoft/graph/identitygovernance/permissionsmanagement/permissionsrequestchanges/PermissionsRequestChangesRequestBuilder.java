...
public class PermissionsRequestChangesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of PermissionsRequestChangeCollectionResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsRequestChangeCollectionResponse> get() {
        return get(null);
    }
    /**
     * Get permissionsRequestChanges from identityGovernance
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsRequestChangeCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, PermissionsRequestChangeCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Create new navigation property to permissionsRequestChanges for identityGovernance
     * @param body The request body
     * @return a CompletableFuture of PermissionsRequestChange
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsRequestChange> post(@jakarta.annotation.Nonnull final PermissionsRequestChange body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsRequestChange> post(@jakarta.annotation.Nonnull final PermissionsRequestChange body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, PermissionsRequestChange::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get permissionsRequestChanges from identityGovernance
