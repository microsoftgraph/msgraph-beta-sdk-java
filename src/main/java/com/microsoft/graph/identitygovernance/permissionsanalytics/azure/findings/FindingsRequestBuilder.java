package com.microsoft.graph.identitygovernance.permissionsanalytics.azure.findings;

import com.microsoft.graph.identitygovernance.permissionsanalytics.azure.findings.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.permissionsanalytics.azure.findings.item.FindingItemRequestBuilder;
...
public class FindingsRequestBuilder extends BaseRequestBuilder {
    ...
    public FindingsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/findings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new FindingsRequestBuilder and sets the default values.
    ...
    public FindingsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/findings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
