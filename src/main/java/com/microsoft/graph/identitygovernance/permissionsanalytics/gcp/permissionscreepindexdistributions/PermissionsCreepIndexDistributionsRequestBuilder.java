package com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.permissionscreepindexdistributions;

import com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.permissionscreepindexdistributions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.permissionscreepindexdistributions.item.PermissionsCreepIndexDistributionItemRequestBuilder;
...
public class PermissionsCreepIndexDistributionsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionsCreepIndexDistributionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp/permissionsCreepIndexDistributions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
    ...
    public PermissionsCreepIndexDistributionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp/permissionsCreepIndexDistributions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
