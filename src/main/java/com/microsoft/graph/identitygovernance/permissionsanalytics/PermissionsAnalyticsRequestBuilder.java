...
public class PermissionsAnalyticsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of PermissionsAnalyticsAggregation
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalyticsAggregation> get() {
        return get(null);
    }
    /**
     * Get permissionsAnalytics from identityGovernance
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalyticsAggregation> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, PermissionsAnalyticsAggregation::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalyticsAggregation> patch(@jakarta.annotation.Nonnull final PermissionsAnalyticsAggregation body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalyticsAggregation> patch(@jakarta.annotation.Nonnull final PermissionsAnalyticsAggregation body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
