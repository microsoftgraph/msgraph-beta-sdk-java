package com.microsoft.graph.identitygovernance.permissionsanalytics.aws;

import com.microsoft.graph.identitygovernance.permissionsanalytics.aws.findings.FindingsRequestBuilder;
import com.microsoft.graph.identitygovernance.permissionsanalytics.aws.permissionscreepindexdistributions.PermissionsCreepIndexDistributionsRequestBuilder;
...
public class AwsRequestBuilder extends BaseRequestBuilder {
    ...
    public AwsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/aws{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AwsRequestBuilder and sets the default values.
    ...
    public AwsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/aws{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @return a CompletableFuture of PermissionsAnalytics
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalytics> get() {
        return get(null);
    }
    /**
     * Get aws from identityGovernance
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalytics> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, PermissionsAnalytics::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalytics> patch(@jakarta.annotation.Nonnull final PermissionsAnalytics body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsAnalytics> patch(@jakarta.annotation.Nonnull final PermissionsAnalytics body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
