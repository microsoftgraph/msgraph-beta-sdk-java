package com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.findings;

import com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.findings.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.permissionsanalytics.gcp.findings.item.FindingItemRequestBuilder;
import com.microsoft.graph.models.Finding;
import com.microsoft.graph.models.FindingCollectionResponse;
...
public class FindingsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of FindingCollectionResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FindingCollectionResponse> get() {
        return get(null);
    }
    /**
     * Get findings from identityGovernance
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FindingCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, FindingCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Create new navigation property to findings for identityGovernance
     * @param body The request body
     * @return a CompletableFuture of Finding
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Finding> post(@jakarta.annotation.Nonnull final Finding body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Finding> post(@jakarta.annotation.Nonnull final Finding body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, Finding::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get findings from identityGovernance
