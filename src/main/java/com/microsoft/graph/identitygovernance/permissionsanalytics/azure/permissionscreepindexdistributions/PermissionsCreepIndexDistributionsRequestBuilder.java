package com.microsoft.graph.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions;

import com.microsoft.graph.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.count.CountRequestBuilder;
import com.microsoft.graph.identitygovernance.permissionsanalytics.azure.permissionscreepindexdistributions.item.PermissionsCreepIndexDistributionItemRequestBuilder;
import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.PermissionsCreepIndexDistribution;
import com.microsoft.graph.models.PermissionsCreepIndexDistributionCollectionResponse;
...
public class PermissionsCreepIndexDistributionsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionsCreepIndexDistributionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
    ...
    public PermissionsCreepIndexDistributionsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get permissionsCreepIndexDistributions from identityGovernance
     * @return a CompletableFuture of PermissionsCreepIndexDistributionCollectionResponse
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsCreepIndexDistributionCollectionResponse> get() {
        return get(null);
    }
    /**
     * Get permissionsCreepIndexDistributions from identityGovernance
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsCreepIndexDistributionCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, PermissionsCreepIndexDistributionCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsCreepIndexDistribution> post(@jakarta.annotation.Nonnull final PermissionsCreepIndexDistribution body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PermissionsCreepIndexDistribution> post(@jakarta.annotation.Nonnull final PermissionsCreepIndexDistribution body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a PermissionsCreepIndexDistributionsRequestBuilder
     */
    @jakarta.annotation.Nonnull
