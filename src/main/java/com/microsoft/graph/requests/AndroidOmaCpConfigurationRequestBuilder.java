...
/**
 * The class for the Android Oma Cp Configuration Request Builder.
 */
public class AndroidOmaCpConfigurationRequestBuilder extends BaseRequestBuilder<AndroidOmaCpConfiguration> {

    /**
     * The request builder for the AndroidOmaCpConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidOmaCpConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidOmaCpConfigurationRequest instance
     */
    @Nonnull
    public AndroidOmaCpConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidOmaCpConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidOmaCpConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
