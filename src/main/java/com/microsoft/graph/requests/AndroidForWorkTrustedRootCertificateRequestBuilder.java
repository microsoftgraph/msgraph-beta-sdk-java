 ...
 */
public class AndroidForWorkTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<AndroidForWorkTrustedRootCertificate> {
     ...
     */
    public AndroidForWorkTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkTrustedRootCertificateRequest instance
     */
    @Nonnull
    public AndroidForWorkTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
