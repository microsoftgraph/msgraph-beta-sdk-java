...
import com.microsoft.graph.requests.AppRoleAssignmentCollectionRequest;
...
public class AppRoleAssignmentCollectionRequestBuilder extends BaseCollectionRequestBuilder<AppRoleAssignment, AppRoleAssignmentRequestBuilder, AppRoleAssignmentCollectionResponse, AppRoleAssignmentCollectionPage, AppRoleAssignmentCollectionRequest> {
     ...
     */
    public AppRoleAssignmentCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AppRoleAssignmentRequestBuilder.class, AppRoleAssignmentCollectionRequest.class);
    }
