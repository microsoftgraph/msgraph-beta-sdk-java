 ...
 */
public class AndroidDeviceOwnerCompliancePolicyRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerCompliancePolicy> {
     ...
     */
    public AndroidDeviceOwnerCompliancePolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerCompliancePolicyRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerCompliancePolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerCompliancePolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerCompliancePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
