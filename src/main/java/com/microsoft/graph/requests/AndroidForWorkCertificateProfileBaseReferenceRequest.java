 ...
 */
public class AndroidForWorkCertificateProfileBaseReferenceRequest extends BaseReferenceRequest<AndroidForWorkCertificateProfileBase> {
     ...
     */
    public AndroidForWorkCertificateProfileBaseReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkCertificateProfileBaseReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public AndroidForWorkCertificateProfileBaseReferenceRequest expand(@Nonnull final String value) {
