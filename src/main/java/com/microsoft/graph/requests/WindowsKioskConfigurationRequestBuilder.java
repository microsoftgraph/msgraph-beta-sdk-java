 ...
 */
public class WindowsKioskConfigurationRequestBuilder extends BaseRequestBuilder<WindowsKioskConfiguration> {
     ...
     */
    public WindowsKioskConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsKioskConfigurationRequest instance
     */
    @Nonnull
    public WindowsKioskConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsKioskConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsKioskConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
