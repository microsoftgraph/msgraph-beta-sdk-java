...
public class TeamsUserActivityUserDetailRequest extends BaseRequest<TeamsUserActivityUserDetail> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TeamsUserActivityUserDetail> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TeamsUserActivityUserDetail> deleteAsync() {
     ...
     */
    @Nullable
    public TeamsUserActivityUserDetail delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TeamsUserActivityUserDetail> patchAsync(@Nonnull final TeamsUserActivityUserDetail sourceTeamsUserActivityUserDetail) {
        return sendAsync(HttpMethod.PATCH, sourceTeamsUserActivityUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TeamsUserActivityUserDetail> postAsync(@Nonnull final TeamsUserActivityUserDetail newTeamsUserActivityUserDetail) {
        return sendAsync(HttpMethod.POST, newTeamsUserActivityUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TeamsUserActivityUserDetail> putAsync(@Nonnull final TeamsUserActivityUserDetail newTeamsUserActivityUserDetail) {
        return sendAsync(HttpMethod.PUT, newTeamsUserActivityUserDetail);
    }
