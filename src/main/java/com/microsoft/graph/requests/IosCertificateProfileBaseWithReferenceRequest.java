 ...
 */
public class IosCertificateProfileBaseWithReferenceRequest extends BaseWithReferenceRequest<IosCertificateProfileBase> {
     ...
     */
    public IosCertificateProfileBaseWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public IosCertificateProfileBaseWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public IosCertificateProfileBaseWithReferenceRequest expand(@Nonnull final String value) {
