...
/**
 * The class for the Base Task List Reference Request Builder.
 */
public class BaseTaskListReferenceRequestBuilder extends BaseReferenceRequestBuilder<BaseTaskList, BaseTaskListReferenceRequest> {
     ...
     */
    public BaseTaskListReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseTaskListReferenceRequest.class);
    }
}
