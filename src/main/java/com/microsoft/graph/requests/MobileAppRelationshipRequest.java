...
public class MobileAppRelationshipRequest extends BaseRequest<MobileAppRelationship> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MobileAppRelationship> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MobileAppRelationship> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MobileAppRelationship> patchAsync(@Nonnull final MobileAppRelationship sourceMobileAppRelationship) {
        return sendAsync(HttpMethod.PATCH, sourceMobileAppRelationship);
    }
    ...
    public java.util.concurrent.CompletableFuture<MobileAppRelationship> postAsync(@Nonnull final MobileAppRelationship newMobileAppRelationship) {
        return sendAsync(HttpMethod.POST, newMobileAppRelationship);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MobileAppRelationship> putAsync(@Nonnull final MobileAppRelationship newMobileAppRelationship) {
        return sendAsync(HttpMethod.PUT, newMobileAppRelationship);
    }
