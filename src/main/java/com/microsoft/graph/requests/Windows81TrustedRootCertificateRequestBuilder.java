...
/**
 * The class for the Windows81Trusted Root Certificate Request Builder.
 */
public class Windows81TrustedRootCertificateRequestBuilder extends BaseRequestBuilder<Windows81TrustedRootCertificate> {
     ...
     */
    public Windows81TrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows81TrustedRootCertificateRequest instance
     */
    @Nonnull
    public Windows81TrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows81TrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
