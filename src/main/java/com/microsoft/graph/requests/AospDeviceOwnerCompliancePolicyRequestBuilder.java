...
/**
 * The class for the Aosp Device Owner Compliance Policy Request Builder.
 */
public class AospDeviceOwnerCompliancePolicyRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerCompliancePolicy> {

    /**
     * The request builder for the AospDeviceOwnerCompliancePolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerCompliancePolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerCompliancePolicyRequest instance
     */
    @Nonnull
    public AospDeviceOwnerCompliancePolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerCompliancePolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerCompliancePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
