...
/**
 * The class for the Windows81Trusted Root Certificate Collection With References Request.
 */
public class Windows81TrustedRootCertificateCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<Windows81TrustedRootCertificate, Windows81TrustedRootCertificateWithReferenceRequest, Windows81TrustedRootCertificateReferenceRequestBuilder, Windows81TrustedRootCertificateWithReferenceRequestBuilder, Windows81TrustedRootCertificateCollectionResponse, Windows81TrustedRootCertificateCollectionWithReferencesPage, Windows81TrustedRootCertificateCollectionWithReferencesRequest> {
     ...
     */
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateCollectionWithReferencesRequest count() {
        addCountOption(true);
        return this;
    }
}
