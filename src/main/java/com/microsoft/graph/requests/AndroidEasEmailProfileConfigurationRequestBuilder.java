...
public class AndroidEasEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder<AndroidEasEmailProfileConfiguration> {
    ...
    public AndroidEasEmailProfileConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidEasEmailProfileConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
        return new com.microsoft.graph.requests.AndroidCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificate"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidCertificateProfileBaseWithReferenceRequestBuilder smimeSigningCertificate() {
        return new com.microsoft.graph.requests.AndroidCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("smimeSigningCertificate"), getClient(), null);
    }
