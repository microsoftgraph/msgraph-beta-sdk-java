...
public class MacOSDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder<MacOSDeviceFeaturesConfiguration> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSCertificateProfileBaseWithReferenceRequestBuilder singleSignOnExtensionPkinitCertificate() {
        return new com.microsoft.graph.requests.MacOSCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("singleSignOnExtensionPkinitCertificate"), getClient(), null);
    }
