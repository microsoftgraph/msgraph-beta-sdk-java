...
/**
 * The class for the Windows Managed App Registration Request Builder.
 */
public class WindowsManagedAppRegistrationRequestBuilder extends BaseRequestBuilder<WindowsManagedAppRegistration> {

    /**
     * The request builder for the WindowsManagedAppRegistration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsManagedAppRegistrationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsManagedAppRegistrationRequest instance
     */
    @Nonnull
    public WindowsManagedAppRegistrationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsManagedAppRegistrationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsManagedAppRegistrationRequest(getRequestUrl(), getClient(), requestOptions);
    }
