...
/**
 * The class for the Windows81Certificate Profile Base Request Builder.
 */
public class Windows81CertificateProfileBaseRequestBuilder extends BaseRequestBuilder<Windows81CertificateProfileBase> {

    /**
     * The request builder for the Windows81CertificateProfileBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public Windows81CertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows81CertificateProfileBaseRequest instance
     */
    @Nonnull
    public Windows81CertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows81CertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows81CertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
