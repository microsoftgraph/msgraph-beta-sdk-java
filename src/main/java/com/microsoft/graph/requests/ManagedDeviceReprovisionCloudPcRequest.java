...
import com.microsoft.graph.requests.ManagedDeviceReprovisionCloudPcRequest;
...
public class ManagedDeviceReprovisionCloudPcRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceReprovisionCloudPcRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the ManagedDeviceReprovisionCloudPc
     *
