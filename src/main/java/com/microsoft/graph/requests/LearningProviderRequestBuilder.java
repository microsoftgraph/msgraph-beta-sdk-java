...
public class LearningProviderRequestBuilder extends BaseRequestBuilder<LearningProvider> {
     ...
     */
    @Nonnull
    public LearningContentRequestBuilder learningContents(@Nonnull final String id) {
        return new LearningContentRequestBuilder(getRequestUrlWithAdditionalSegment("learningContents") + "/" + id, getClient(), null);
    }
}
