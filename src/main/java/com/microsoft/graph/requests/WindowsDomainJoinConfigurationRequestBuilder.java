...
public class WindowsDomainJoinConfigurationRequestBuilder extends BaseRequestBuilder<WindowsDomainJoinConfiguration> {
    ...
    public WindowsDomainJoinConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsDomainJoinConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceConfigurationCollectionWithReferencesRequestBuilder networkAccessConfigurations() {
        return new com.microsoft.graph.requests.DeviceConfigurationCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("networkAccessConfigurations"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceConfigurationWithReferenceRequestBuilder networkAccessConfigurations(@Nonnull final String id) {
        return new com.microsoft.graph.requests.DeviceConfigurationWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("networkAccessConfigurations") + "/" + id, getClient(), null);
    }
