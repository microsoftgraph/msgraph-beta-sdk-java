...
/**
 * The class for the Identity Provider Base Reference Request.
 */
public class IdentityProviderBaseReferenceRequest extends BaseReferenceRequest<IdentityProviderBase> {
     ...
     */
    public IdentityProviderBaseReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public IdentityProviderBaseReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public IdentityProviderBaseReferenceRequest expand(@Nonnull final String value) {
        addExpandOption(value);
        return this;
    }
    /**
     * Puts the IdentityProviderBase
     *
     * @param srcIdentityProviderBase the IdentityProviderBase reference to PUT
     ...
     *
     * @param srcIdentityProviderBase the IdentityProviderBase reference to PUT
     * @return the IdentityProviderBase
