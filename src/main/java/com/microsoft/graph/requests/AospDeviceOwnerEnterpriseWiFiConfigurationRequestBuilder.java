...
public class AospDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerEnterpriseWiFiConfiguration> {
     ...
     */
    @Nonnull
    public AospDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new AospDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
