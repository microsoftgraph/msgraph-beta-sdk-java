...
/**
 * The class for the Aosp Device Owner Enterprise Wi Fi Configuration Request Builder.
 */
public class AospDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerEnterpriseWiFiConfiguration> {

    /**
     * The request builder for the AospDeviceOwnerEnterpriseWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerEnterpriseWiFiConfigurationRequest instance
     */
    @Nonnull
    public AospDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
    ...
    /**
     * Gets the request builder for AospDeviceOwnerCertificateProfileBase
     *
     * @return the AospDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.AospDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.AospDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new com.microsoft.graph.requests.AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
