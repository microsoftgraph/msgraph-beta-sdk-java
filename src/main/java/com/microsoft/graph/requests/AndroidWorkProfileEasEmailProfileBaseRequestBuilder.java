...
public class AndroidWorkProfileEasEmailProfileBaseRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileEasEmailProfileBase> {
    ...
    public AndroidWorkProfileEasEmailProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidWorkProfileEasEmailProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
        return new com.microsoft.graph.requests.AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificate"), getClient(), null);
    }
