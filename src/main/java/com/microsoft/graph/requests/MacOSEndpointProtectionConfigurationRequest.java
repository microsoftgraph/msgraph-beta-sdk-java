...
public class MacOSEndpointProtectionConfigurationRequest extends BaseRequest<MacOSEndpointProtectionConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSEndpointProtectionConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSEndpointProtectionConfiguration> deleteAsync() {
     ...
     */
    @Nullable
    public MacOSEndpointProtectionConfiguration delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSEndpointProtectionConfiguration> patchAsync(@Nonnull final MacOSEndpointProtectionConfiguration sourceMacOSEndpointProtectionConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceMacOSEndpointProtectionConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSEndpointProtectionConfiguration> postAsync(@Nonnull final MacOSEndpointProtectionConfiguration newMacOSEndpointProtectionConfiguration) {
        return sendAsync(HttpMethod.POST, newMacOSEndpointProtectionConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSEndpointProtectionConfiguration> putAsync(@Nonnull final MacOSEndpointProtectionConfiguration newMacOSEndpointProtectionConfiguration) {
        return sendAsync(HttpMethod.PUT, newMacOSEndpointProtectionConfiguration);
    }
