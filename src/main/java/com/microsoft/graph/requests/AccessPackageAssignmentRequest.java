 ...
 */
public class AccessPackageAssignmentRequest extends BaseRequest<AccessPackageAssignment> {
     ...
     */
    public AccessPackageAssignmentRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AccessPackageAssignment> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AccessPackageAssignment> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AccessPackageAssignment> patchAsync(@Nonnull final AccessPackageAssignment sourceAccessPackageAssignment) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AccessPackageAssignment> postAsync(@Nonnull final AccessPackageAssignment newAccessPackageAssignment) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AccessPackageAssignment> putAsync(@Nonnull final AccessPackageAssignment newAccessPackageAssignment) {
