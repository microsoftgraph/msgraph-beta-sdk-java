...
public class Windows10VpnConfigurationRequest extends BaseRequest<Windows10VpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10VpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10VpnConfiguration> deleteAsync() {
     ...
     */
    @Nullable
    public Windows10VpnConfiguration delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10VpnConfiguration> patchAsync(@Nonnull final Windows10VpnConfiguration sourceWindows10VpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceWindows10VpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10VpnConfiguration> postAsync(@Nonnull final Windows10VpnConfiguration newWindows10VpnConfiguration) {
        return sendAsync(HttpMethod.POST, newWindows10VpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10VpnConfiguration> putAsync(@Nonnull final Windows10VpnConfiguration newWindows10VpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newWindows10VpnConfiguration);
    }
