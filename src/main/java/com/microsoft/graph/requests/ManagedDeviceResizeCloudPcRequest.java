...
public class ManagedDeviceResizeCloudPcRequest extends BaseRequest<Void> {
     ...
     */
    public ManagedDeviceResizeCloudPcRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

	/** The body for the method */
    @Nullable
    public ManagedDeviceResizeCloudPcParameterSet body;
    /**
     * Creates the ManagedDeviceResizeCloudPc
     *
