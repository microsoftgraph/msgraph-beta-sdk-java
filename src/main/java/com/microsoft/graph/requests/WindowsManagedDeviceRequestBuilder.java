...
public class WindowsManagedDeviceRequestBuilder extends BaseRequestBuilder<WindowsManagedDevice> {
     ...
     */
    @Nonnull
    public ManagedDeviceRequestRemoteHelpSessionAccessRequestBuilder requestRemoteHelpSessionAccess(@Nonnull final ManagedDeviceRequestRemoteHelpSessionAccessParameterSet parameters) {
        return new ManagedDeviceRequestRemoteHelpSessionAccessRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.requestRemoteHelpSessionAccess"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public ManagedDeviceRetrieveRemoteHelpSessionRequestBuilder retrieveRemoteHelpSession(@Nonnull final ManagedDeviceRetrieveRemoteHelpSessionParameterSet parameters) {
        return new ManagedDeviceRetrieveRemoteHelpSessionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.retrieveRemoteHelpSession"), getClient(), null, parameters);
    }
}
