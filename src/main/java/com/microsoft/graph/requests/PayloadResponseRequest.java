...
public class PayloadResponseRequest extends BaseRequest<PayloadResponse> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<PayloadResponse> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<PayloadResponse> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<PayloadResponse> patchAsync(@Nonnull final PayloadResponse sourcePayloadResponse) {
        return sendAsync(HttpMethod.PATCH, sourcePayloadResponse);
    }
    ...
    public java.util.concurrent.CompletableFuture<PayloadResponse> postAsync(@Nonnull final PayloadResponse newPayloadResponse) {
        return sendAsync(HttpMethod.POST, newPayloadResponse);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<PayloadResponse> putAsync(@Nonnull final PayloadResponse newPayloadResponse) {
        return sendAsync(HttpMethod.PUT, newPayloadResponse);
    }
