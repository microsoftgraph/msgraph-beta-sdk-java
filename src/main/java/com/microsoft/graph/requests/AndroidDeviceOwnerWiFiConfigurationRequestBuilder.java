...
/**
 * The class for the Android Device Owner Wi Fi Configuration Request Builder.
 */
public class AndroidDeviceOwnerWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerWiFiConfiguration> {

    /**
     * The request builder for the AndroidDeviceOwnerWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidDeviceOwnerWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
