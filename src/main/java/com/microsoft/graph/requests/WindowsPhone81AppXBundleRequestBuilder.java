...
/**
 * The class for the Windows Phone81App XBundle Request Builder.
 */
public class WindowsPhone81AppXBundleRequestBuilder extends BaseRequestBuilder<WindowsPhone81AppXBundle> {

    /**
     * The request builder for the WindowsPhone81AppXBundle
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsPhone81AppXBundleRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81AppXBundleRequest instance
     */
    @Nonnull
    public WindowsPhone81AppXBundleRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81AppXBundleRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsPhone81AppXBundleRequest(getRequestUrl(), getClient(), requestOptions);
    }
