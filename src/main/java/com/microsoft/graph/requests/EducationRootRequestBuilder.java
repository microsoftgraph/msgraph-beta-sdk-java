...
public class EducationRootRequestBuilder extends BaseRequestBuilder<EducationRoot> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EducationSynchronizationProfileCollectionRequestBuilder synchronizationProfiles() {
        return new com.microsoft.graph.requests.EducationSynchronizationProfileCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("synchronizationProfiles"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EducationSynchronizationProfileRequestBuilder synchronizationProfiles(@Nonnull final String id) {
        return new com.microsoft.graph.requests.EducationSynchronizationProfileRequestBuilder(getRequestUrlWithAdditionalSegment("synchronizationProfiles") + "/" + id, getClient(), null);
    }
    /**
