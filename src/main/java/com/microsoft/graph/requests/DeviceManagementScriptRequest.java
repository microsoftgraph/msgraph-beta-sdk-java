...
public class DeviceManagementScriptRequest extends BaseRequest<DeviceManagementScript> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> patchAsync(@Nonnull final DeviceManagementScript sourceDeviceManagementScript) {
        return sendAsync(HttpMethod.PATCH, sourceDeviceManagementScript);
    }
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> postAsync(@Nonnull final DeviceManagementScript newDeviceManagementScript) {
        return sendAsync(HttpMethod.POST, newDeviceManagementScript);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScript> putAsync(@Nonnull final DeviceManagementScript newDeviceManagementScript) {
        return sendAsync(HttpMethod.PUT, newDeviceManagementScript);
    }
