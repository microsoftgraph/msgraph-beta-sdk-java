 ...
 */
public class AndroidDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerEnterpriseWiFiConfiguration> {
     ...
     */
    public AndroidDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerEnterpriseWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceManagementDerivedCredentialSettingsWithReferenceRequestBuilder derivedCredentialSettings() {
        return new com.microsoft.graph.requests.DeviceManagementDerivedCredentialSettingsWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("derivedCredentialSettings"), getClient(), null);
    }

    /**
     * Gets the request builder for AndroidDeviceOwnerCertificateProfileBase
     *
     * @return the AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
