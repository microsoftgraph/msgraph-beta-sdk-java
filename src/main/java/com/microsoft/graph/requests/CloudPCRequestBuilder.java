...
public class CloudPCRequestBuilder extends BaseRequestBuilder<CloudPC> {
     ...
     */
    @Nonnull
    public CloudPCGetFrontlineCloudPcAccessStateRequestBuilder getFrontlineCloudPcAccessState() {
        return new CloudPCGetFrontlineCloudPcAccessStateRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.getFrontlineCloudPcAccessState"), getClient(), null);
    }
