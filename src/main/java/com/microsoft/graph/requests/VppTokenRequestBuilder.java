...
public class VppTokenRequestBuilder extends BaseRequestBuilder<VppToken> {
     ...
     */
    @Nonnull
    public VppTokenRevokeLicensesRequestBuilder revokeLicenses(@Nonnull final VppTokenRevokeLicensesParameterSet parameters) {
        return new VppTokenRevokeLicensesRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.revokeLicenses"), getClient(), null, parameters);
    }
