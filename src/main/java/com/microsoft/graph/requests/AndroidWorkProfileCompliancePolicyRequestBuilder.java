 ...
 */
public class AndroidWorkProfileCompliancePolicyRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileCompliancePolicy> {
     ...
     */
    public AndroidWorkProfileCompliancePolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileCompliancePolicyRequest instance
     */
    @Nonnull
    public AndroidWorkProfileCompliancePolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileCompliancePolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidWorkProfileCompliancePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
