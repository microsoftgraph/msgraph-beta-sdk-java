...
import com.microsoft.graph.requests.OrganizationActivateServiceRequest;
...
public class OrganizationActivateServiceRequest extends BaseRequest<Void> {
     ...
     */
    public OrganizationActivateServiceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

	/** The body for the method */
    @Nullable
    public OrganizationActivateServiceParameterSet body;
    /**
     * Creates the OrganizationActivateService
     *
