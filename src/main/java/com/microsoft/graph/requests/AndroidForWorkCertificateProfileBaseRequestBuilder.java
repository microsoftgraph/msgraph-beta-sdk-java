 ...
 */
public class AndroidForWorkCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<AndroidForWorkCertificateProfileBase> {
     ...
     */
    public AndroidForWorkCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkCertificateProfileBaseRequest instance
     */
    @Nonnull
    public AndroidForWorkCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidForWorkTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
        return new com.microsoft.graph.requests.AndroidForWorkTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificate"), getClient(), null);
    }
