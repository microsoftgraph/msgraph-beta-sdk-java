...
public class SharePointActivityUserDetailRequest extends BaseRequest<SharePointActivityUserDetail> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SharePointActivityUserDetail> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SharePointActivityUserDetail> deleteAsync() {
     ...
     */
    @Nullable
    public SharePointActivityUserDetail delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SharePointActivityUserDetail> patchAsync(@Nonnull final SharePointActivityUserDetail sourceSharePointActivityUserDetail) {
        return sendAsync(HttpMethod.PATCH, sourceSharePointActivityUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SharePointActivityUserDetail> postAsync(@Nonnull final SharePointActivityUserDetail newSharePointActivityUserDetail) {
        return sendAsync(HttpMethod.POST, newSharePointActivityUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SharePointActivityUserDetail> putAsync(@Nonnull final SharePointActivityUserDetail newSharePointActivityUserDetail) {
        return sendAsync(HttpMethod.PUT, newSharePointActivityUserDetail);
    }
