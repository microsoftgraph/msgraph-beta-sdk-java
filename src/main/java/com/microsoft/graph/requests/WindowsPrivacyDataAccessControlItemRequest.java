...
public class WindowsPrivacyDataAccessControlItemRequest extends BaseRequest<WindowsPrivacyDataAccessControlItem> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPrivacyDataAccessControlItem> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPrivacyDataAccessControlItem> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPrivacyDataAccessControlItem> patchAsync(@Nonnull final WindowsPrivacyDataAccessControlItem sourceWindowsPrivacyDataAccessControlItem) {
        return sendAsync(HttpMethod.PATCH, sourceWindowsPrivacyDataAccessControlItem);
    }
    ...
    public java.util.concurrent.CompletableFuture<WindowsPrivacyDataAccessControlItem> postAsync(@Nonnull final WindowsPrivacyDataAccessControlItem newWindowsPrivacyDataAccessControlItem) {
        return sendAsync(HttpMethod.POST, newWindowsPrivacyDataAccessControlItem);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPrivacyDataAccessControlItem> putAsync(@Nonnull final WindowsPrivacyDataAccessControlItem newWindowsPrivacyDataAccessControlItem) {
        return sendAsync(HttpMethod.PUT, newWindowsPrivacyDataAccessControlItem);
    }
