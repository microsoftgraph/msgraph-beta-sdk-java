 ...
 */
public class PlannerPlanReferenceRequestBuilder extends BaseReferenceRequestBuilder<PlannerPlan, PlannerPlanReferenceRequest> {
     ...
     */
    public PlannerPlanReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PlannerPlanReferenceRequest.class);
    }
}
