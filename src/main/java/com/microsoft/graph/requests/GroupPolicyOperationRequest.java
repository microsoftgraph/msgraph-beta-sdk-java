...
public class GroupPolicyOperationRequest extends BaseRequest<GroupPolicyOperation> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyOperation> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyOperation> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyOperation> patchAsync(@Nonnull final GroupPolicyOperation sourceGroupPolicyOperation) {
        return sendAsync(HttpMethod.PATCH, sourceGroupPolicyOperation);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyOperation> postAsync(@Nonnull final GroupPolicyOperation newGroupPolicyOperation) {
        return sendAsync(HttpMethod.POST, newGroupPolicyOperation);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyOperation> putAsync(@Nonnull final GroupPolicyOperation newGroupPolicyOperation) {
        return sendAsync(HttpMethod.PUT, newGroupPolicyOperation);
    }
