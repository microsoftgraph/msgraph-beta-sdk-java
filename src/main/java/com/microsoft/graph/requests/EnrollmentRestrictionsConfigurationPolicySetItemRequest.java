...
public class EnrollmentRestrictionsConfigurationPolicySetItemRequest extends BaseRequest<EnrollmentRestrictionsConfigurationPolicySetItem> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EnrollmentRestrictionsConfigurationPolicySetItem> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EnrollmentRestrictionsConfigurationPolicySetItem> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EnrollmentRestrictionsConfigurationPolicySetItem> patchAsync(@Nonnull final EnrollmentRestrictionsConfigurationPolicySetItem sourceEnrollmentRestrictionsConfigurationPolicySetItem) {
        return sendAsync(HttpMethod.PATCH, sourceEnrollmentRestrictionsConfigurationPolicySetItem);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EnrollmentRestrictionsConfigurationPolicySetItem> postAsync(@Nonnull final EnrollmentRestrictionsConfigurationPolicySetItem newEnrollmentRestrictionsConfigurationPolicySetItem) {
        return sendAsync(HttpMethod.POST, newEnrollmentRestrictionsConfigurationPolicySetItem);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<EnrollmentRestrictionsConfigurationPolicySetItem> putAsync(@Nonnull final EnrollmentRestrictionsConfigurationPolicySetItem newEnrollmentRestrictionsConfigurationPolicySetItem) {
        return sendAsync(HttpMethod.PUT, newEnrollmentRestrictionsConfigurationPolicySetItem);
    }
