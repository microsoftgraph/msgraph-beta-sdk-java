...
import com.microsoft.graph.requests.ManagedDeviceSetDeviceNameRequest;
...
public class ManagedDeviceSetDeviceNameRequestBuilder extends BaseActionRequestBuilder<ManagedDevice> {
     ...
     */
    public ManagedDeviceSetDeviceNameRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ManagedDeviceSetDeviceNameRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final ManagedDeviceSetDeviceNameRequest request = new ManagedDeviceSetDeviceNameRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
