...
public class EventRequestBuilder extends BaseRequestBuilder<Event> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EventCollectionRequestBuilder exceptionOccurrences() {
        return new com.microsoft.graph.requests.EventCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("exceptionOccurrences"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EventRequestBuilder exceptionOccurrences(@Nonnull final String id) {
        return new com.microsoft.graph.requests.EventRequestBuilder(getRequestUrlWithAdditionalSegment("exceptionOccurrences") + "/" + id, getClient(), null);
    }
    /**
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EventCollectionRequestBuilder instances() {
        return new com.microsoft.graph.requests.EventCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("instances"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.EventRequestBuilder instances(@Nonnull final String id) {
        return new com.microsoft.graph.requests.EventRequestBuilder(getRequestUrlWithAdditionalSegment("instances") + "/" + id, getClient(), null);
    }
    /**
