...
public class AospDeviceOwnerScepCertificateProfileRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerScepCertificateProfile> {
     ...
     */
    @Nonnull
    public ManagedDeviceCertificateStateCollectionWithReferencesRequestBuilder managedDeviceCertificateStates() {
        return new ManagedDeviceCertificateStateCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public ManagedDeviceCertificateStateWithReferenceRequestBuilder managedDeviceCertificateStates(@Nonnull final String id) {
        return new ManagedDeviceCertificateStateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates") + "/" + id, getClient(), null);
    }
