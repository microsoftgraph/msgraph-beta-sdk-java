...
/**
 * The class for the Aosp Device Owner Scep Certificate Profile Request Builder.
 */
public class AospDeviceOwnerScepCertificateProfileRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerScepCertificateProfile> {

    /**
     * The request builder for the AospDeviceOwnerScepCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerScepCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerScepCertificateProfileRequest instance
     */
    @Nonnull
    public AospDeviceOwnerScepCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerScepCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
        return new com.microsoft.graph.requests.AospDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificate"), getClient(), null);
    }
    /**
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.ManagedDeviceCertificateStateCollectionWithReferencesRequestBuilder managedDeviceCertificateStates() {
        return new com.microsoft.graph.requests.ManagedDeviceCertificateStateCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.ManagedDeviceCertificateStateWithReferenceRequestBuilder managedDeviceCertificateStates(@Nonnull final String id) {
        return new com.microsoft.graph.requests.ManagedDeviceCertificateStateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates") + "/" + id, getClient(), null);
    }
