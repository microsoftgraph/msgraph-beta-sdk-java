 ...
 */
public class DeviceManagementResourceAccessProfileBaseRequestBuilder extends BaseRequestBuilder<DeviceManagementResourceAccessProfileBase> {
     ...
     */
    public DeviceManagementResourceAccessProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the DeviceManagementResourceAccessProfileBaseRequest instance
     */
    @Nonnull
    public DeviceManagementResourceAccessProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceManagementResourceAccessProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DeviceManagementResourceAccessProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
