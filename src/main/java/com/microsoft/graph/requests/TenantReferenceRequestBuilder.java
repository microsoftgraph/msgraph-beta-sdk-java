...
/**
 * The class for the Tenant Reference Request Builder.
 */
public class TenantReferenceRequestBuilder extends BaseRequestBuilder<TenantReference> {

    /**
     * The request builder for the TenantReference
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public TenantReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the TenantReferenceRequest instance
     */
    @Nonnull
    public TenantReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TenantReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.TenantReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
