...
/**
 * The class for the Device Enrollment Notification Configuration Request Builder.
 */
public class DeviceEnrollmentNotificationConfigurationRequestBuilder extends BaseRequestBuilder<DeviceEnrollmentNotificationConfiguration> {

    /**
     * The request builder for the DeviceEnrollmentNotificationConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public DeviceEnrollmentNotificationConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the DeviceEnrollmentNotificationConfigurationRequest instance
     */
    @Nonnull
    public DeviceEnrollmentNotificationConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceEnrollmentNotificationConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DeviceEnrollmentNotificationConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
