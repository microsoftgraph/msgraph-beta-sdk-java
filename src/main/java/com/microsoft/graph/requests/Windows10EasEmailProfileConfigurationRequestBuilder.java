 ...
 */
public class Windows10EasEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder<Windows10EasEmailProfileConfiguration> {
     ...
     */
    public Windows10EasEmailProfileConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10EasEmailProfileConfigurationRequest instance
     */
    @Nonnull
    public Windows10EasEmailProfileConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10EasEmailProfileConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows10EasEmailProfileConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
