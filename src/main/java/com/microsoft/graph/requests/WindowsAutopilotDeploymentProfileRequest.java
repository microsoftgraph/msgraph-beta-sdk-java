...
public class WindowsAutopilotDeploymentProfileRequest extends BaseRequest<WindowsAutopilotDeploymentProfile> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfile> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfile> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfile> patchAsync(@Nonnull final WindowsAutopilotDeploymentProfile sourceWindowsAutopilotDeploymentProfile) {
        return sendAsync(HttpMethod.PATCH, sourceWindowsAutopilotDeploymentProfile);
    }
    ...
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfile> postAsync(@Nonnull final WindowsAutopilotDeploymentProfile newWindowsAutopilotDeploymentProfile) {
        return sendAsync(HttpMethod.POST, newWindowsAutopilotDeploymentProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsAutopilotDeploymentProfile> putAsync(@Nonnull final WindowsAutopilotDeploymentProfile newWindowsAutopilotDeploymentProfile) {
        return sendAsync(HttpMethod.PUT, newWindowsAutopilotDeploymentProfile);
    }
