 ...
 */
public class PlannerPlanWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<PlannerPlan, PlannerPlanWithReferenceRequest, PlannerPlanReferenceRequestBuilder> {
     ...
     */
    public PlannerPlanWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PlannerPlanWithReferenceRequest.class, PlannerPlanReferenceRequestBuilder.class);
    }
}
