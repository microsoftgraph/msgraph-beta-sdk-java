 ...
 */
public class IosScepCertificateProfileRequestBuilder extends BaseRequestBuilder<IosScepCertificateProfile> {
     ...
     */
    public IosScepCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosScepCertificateProfileRequest instance
     */
    @Nonnull
    public IosScepCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosScepCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     *
     * @return the IosTrustedRootCertificateWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.IosTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
        return new com.microsoft.graph.requests.IosTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificate"), getClient(), null);
    }
