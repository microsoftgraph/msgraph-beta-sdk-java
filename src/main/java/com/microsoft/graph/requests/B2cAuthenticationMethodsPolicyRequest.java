...
public class B2cAuthenticationMethodsPolicyRequest extends BaseRequest<B2cAuthenticationMethodsPolicy> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<B2cAuthenticationMethodsPolicy> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<B2cAuthenticationMethodsPolicy> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<B2cAuthenticationMethodsPolicy> patchAsync(@Nonnull final B2cAuthenticationMethodsPolicy sourceB2cAuthenticationMethodsPolicy) {
        return sendAsync(HttpMethod.PATCH, sourceB2cAuthenticationMethodsPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<B2cAuthenticationMethodsPolicy> postAsync(@Nonnull final B2cAuthenticationMethodsPolicy newB2cAuthenticationMethodsPolicy) {
        return sendAsync(HttpMethod.POST, newB2cAuthenticationMethodsPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<B2cAuthenticationMethodsPolicy> putAsync(@Nonnull final B2cAuthenticationMethodsPolicy newB2cAuthenticationMethodsPolicy) {
        return sendAsync(HttpMethod.PUT, newB2cAuthenticationMethodsPolicy);
    }
