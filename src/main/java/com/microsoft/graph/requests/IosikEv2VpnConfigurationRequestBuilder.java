...
/**
 * The class for the Iosik Ev2Vpn Configuration Request Builder.
 */
public class IosikEv2VpnConfigurationRequestBuilder extends BaseRequestBuilder<IosikEv2VpnConfiguration> {

    /**
     * The request builder for the IosikEv2VpnConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public IosikEv2VpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosikEv2VpnConfigurationRequest instance
     */
    @Nonnull
    public IosikEv2VpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosikEv2VpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosikEv2VpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
        return new com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificate"), getClient(), null);
    }
