 ...
 */
public class AndroidForWorkImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidForWorkImportedPFXCertificateProfile> {
     ...
     */
    public AndroidForWorkImportedPFXCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkImportedPFXCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidForWorkImportedPFXCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkImportedPFXCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
