...
public class ComanagementEligibleDeviceRequest extends BaseRequest<ComanagementEligibleDevice> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ComanagementEligibleDevice> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ComanagementEligibleDevice> deleteAsync() {
     ...
     */
    @Nullable
    public ComanagementEligibleDevice delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ComanagementEligibleDevice> patchAsync(@Nonnull final ComanagementEligibleDevice sourceComanagementEligibleDevice) {
        return sendAsync(HttpMethod.PATCH, sourceComanagementEligibleDevice);
    }
    ...
    public java.util.concurrent.CompletableFuture<ComanagementEligibleDevice> postAsync(@Nonnull final ComanagementEligibleDevice newComanagementEligibleDevice) {
        return sendAsync(HttpMethod.POST, newComanagementEligibleDevice);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ComanagementEligibleDevice> putAsync(@Nonnull final ComanagementEligibleDevice newComanagementEligibleDevice) {
        return sendAsync(HttpMethod.PUT, newComanagementEligibleDevice);
    }
