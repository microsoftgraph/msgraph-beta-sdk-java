...
/**
 * The class for the Win Get App Request Builder.
 */
public class WinGetAppRequestBuilder extends BaseRequestBuilder<WinGetApp> {

    /**
     * The request builder for the WinGetApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WinGetAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WinGetAppRequest instance
     */
    @Nonnull
    public WinGetAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WinGetAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WinGetAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
