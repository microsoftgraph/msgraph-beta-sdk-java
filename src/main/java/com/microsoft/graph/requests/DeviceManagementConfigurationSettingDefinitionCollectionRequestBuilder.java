...
/**
 * The class for the Device Management Configuration Setting Definition Collection Request Builder.
 */
public class DeviceManagementConfigurationSettingDefinitionCollectionRequestBuilder extends BaseCollectionRequestBuilder<DeviceManagementConfigurationSettingDefinition, DeviceManagementConfigurationSettingDefinitionRequestBuilder, DeviceManagementConfigurationSettingDefinitionCollectionResponse, DeviceManagementConfigurationSettingDefinitionCollectionPage, DeviceManagementConfigurationSettingDefinitionCollectionRequest> {
     ...
     */
    public DeviceManagementConfigurationSettingDefinitionCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceManagementConfigurationSettingDefinitionRequestBuilder.class, DeviceManagementConfigurationSettingDefinitionCollectionRequest.class);
    }
