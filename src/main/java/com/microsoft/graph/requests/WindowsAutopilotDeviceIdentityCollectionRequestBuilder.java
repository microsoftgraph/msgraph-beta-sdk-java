...
public class WindowsAutopilotDeviceIdentityCollectionRequestBuilder extends BaseCollectionRequestBuilder<WindowsAutopilotDeviceIdentity, WindowsAutopilotDeviceIdentityRequestBuilder, WindowsAutopilotDeviceIdentityCollectionResponse, WindowsAutopilotDeviceIdentityCollectionPage, WindowsAutopilotDeviceIdentityCollectionRequest> {
     ...
     */
    @Nonnull
    public WindowsAutopilotDeviceIdentityDeleteDevicesCollectionRequestBuilder deleteDevices(@Nonnull final WindowsAutopilotDeviceIdentityDeleteDevicesParameterSet parameters) {
        return new WindowsAutopilotDeviceIdentityDeleteDevicesCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.deleteDevices"), getClient(), null, parameters);
    }
