...
/**
 * The class for the Iosi Pad OSWeb Clip Request Builder.
 */
public class IosiPadOSWebClipRequestBuilder extends BaseRequestBuilder<IosiPadOSWebClip> {

    /**
     * The request builder for the IosiPadOSWebClip
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public IosiPadOSWebClipRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosiPadOSWebClipRequest instance
     */
    @Nonnull
    public IosiPadOSWebClipRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosiPadOSWebClipRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosiPadOSWebClipRequest(getRequestUrl(), getClient(), requestOptions);
    }
