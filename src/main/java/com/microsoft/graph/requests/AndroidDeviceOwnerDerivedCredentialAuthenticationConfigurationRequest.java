...
public class AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequest extends BaseRequest<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> patchAsync(@Nonnull final AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration sourceAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> postAsync(@Nonnull final AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration newAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration) {
        return sendAsync(HttpMethod.POST, newAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> putAsync(@Nonnull final AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration newAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration) {
        return sendAsync(HttpMethod.PUT, newAndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration);
    }
