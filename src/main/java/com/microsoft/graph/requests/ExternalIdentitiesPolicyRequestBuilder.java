...
/**
 * The class for the External Identities Policy Request Builder.
 */
public class ExternalIdentitiesPolicyRequestBuilder extends BaseRequestBuilder<ExternalIdentitiesPolicy> {

    /**
     * The request builder for the ExternalIdentitiesPolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public ExternalIdentitiesPolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the ExternalIdentitiesPolicyRequest instance
     */
    @Nonnull
    public ExternalIdentitiesPolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ExternalIdentitiesPolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.ExternalIdentitiesPolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
