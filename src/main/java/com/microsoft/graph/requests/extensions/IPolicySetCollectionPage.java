...
/**
 * The interface for the Policy Set Collection Page.
 */
public interface IPolicySetCollectionPage extends IBaseCollectionPage<PolicySet, IPolicySetCollectionRequestBuilder> {
}
