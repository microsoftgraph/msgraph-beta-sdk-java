 ...
 */
public class GroupPolicyMigrationReportCollectionResponse implements IJsonBackedObject {

    /**
     * The list of GroupPolicyMigrationReport within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GroupPolicyMigrationReport> value;
