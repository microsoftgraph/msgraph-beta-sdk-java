 ...
 */
public class ReportRootGetSharePointActivityUserDetailCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<SharePointActivityUserDetail> value;
