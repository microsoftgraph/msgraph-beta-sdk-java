 ...
 */
public class CallCancelMediaProcessingRequest extends BaseRequest implements ICallCancelMediaProcessingRequest {
     ...
     */
    public CallCancelMediaProcessingRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ICallCancelMediaProcessingRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ICallCancelMediaProcessingRequest top(final int value) {
