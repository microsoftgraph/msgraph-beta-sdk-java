 ...
 */
public class Windows10VpnConfigurationRequestBuilder extends BaseRequestBuilder implements IWindows10VpnConfigurationRequestBuilder {
     ...
     * @return the IWindows10VpnConfigurationRequest instance
     */
    public IWindows10VpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
