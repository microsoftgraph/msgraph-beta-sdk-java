...
/**
 * The interface for the Android Wi Fi Configuration Request Builder.
 */
public interface IAndroidWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWiFiConfigurationRequest instance
     */
    IAndroidWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
