...
public class MacOSMdatpAppRequestBuilder extends BaseRequestBuilder implements IMacOSMdatpAppRequestBuilder {
     ...
     */
    public MacOSMdatpAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IMacOSMdatpAppRequest instance
     */
    public IMacOSMdatpAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
