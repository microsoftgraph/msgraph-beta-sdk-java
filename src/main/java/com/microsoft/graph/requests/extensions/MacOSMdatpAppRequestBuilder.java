 ...
 */
public class MacOSMdatpAppRequestBuilder extends BaseRequestBuilder<MacOSMdatpApp> {
     ...
     */
    public MacOSMdatpAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSMdatpAppRequest instance
     */
    @Nonnull
    public MacOSMdatpAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSMdatpAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSMdatpAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
