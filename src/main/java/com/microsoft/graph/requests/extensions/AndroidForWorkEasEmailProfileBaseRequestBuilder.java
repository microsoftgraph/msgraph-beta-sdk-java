 ...
 */
public class AndroidForWorkEasEmailProfileBaseRequestBuilder extends BaseRequestBuilder<AndroidForWorkEasEmailProfileBase> {
     ...
     */
    public AndroidForWorkEasEmailProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkEasEmailProfileBaseRequest instance
     */
    @Nonnull
    public AndroidForWorkEasEmailProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkEasEmailProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
