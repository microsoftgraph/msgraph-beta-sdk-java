 ...
 */
public class TaxGroupCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TaxGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TaxGroup> value;
