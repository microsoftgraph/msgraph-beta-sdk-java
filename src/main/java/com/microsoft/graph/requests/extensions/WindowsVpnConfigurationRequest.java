...
public class WindowsVpnConfigurationRequest extends BaseRequest implements IWindowsVpnConfigurationRequest {
     ...
     */
    public void get(final ICallback<? super WindowsVpnConfiguration> callback) {
     ...
     */
    public void delete(final ICallback<? super WindowsVpnConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final WindowsVpnConfiguration sourceWindowsVpnConfiguration, final ICallback<? super WindowsVpnConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final WindowsVpnConfiguration newWindowsVpnConfiguration, final ICallback<? super WindowsVpnConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final WindowsVpnConfiguration newWindowsVpnConfiguration, final ICallback<? super WindowsVpnConfiguration> callback) {
