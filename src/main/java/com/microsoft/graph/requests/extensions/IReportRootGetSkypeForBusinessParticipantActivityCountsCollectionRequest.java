 ...
 */
public interface IReportRootGetSkypeForBusinessParticipantActivityCountsCollectionRequest {

    void get(final ICallback<IReportRootGetSkypeForBusinessParticipantActivityCountsCollectionPage> callback);
