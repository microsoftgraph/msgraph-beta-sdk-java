 ...
 */
public class GroupPolicyCategoryCollectionReferenceRequest extends BaseCollectionRequest<GroupPolicyCategoryCollectionResponse, IGroupPolicyCategoryCollectionPage> implements IGroupPolicyCategoryCollectionReferenceRequest {
     ...
     */
    public GroupPolicyCategoryCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IGroupPolicyCategoryCollectionReferenceRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IGroupPolicyCategoryCollectionReferenceRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IGroupPolicyCategoryCollectionReferenceRequest top(final int value) {
