...
public class MacOSPkcsCertificateProfileRequest extends BaseRequest implements IMacOSPkcsCertificateProfileRequest {
     ...
     */
    public void get(final ICallback<MacOSPkcsCertificateProfile> callback) {
     ...
     */
    public void delete(final ICallback<MacOSPkcsCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final MacOSPkcsCertificateProfile sourceMacOSPkcsCertificateProfile, final ICallback<MacOSPkcsCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final MacOSPkcsCertificateProfile newMacOSPkcsCertificateProfile, final ICallback<MacOSPkcsCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final MacOSPkcsCertificateProfile newMacOSPkcsCertificateProfile, final ICallback<MacOSPkcsCertificateProfile> callback) {
     ...
     * @return the updated request
     */
     public IMacOSPkcsCertificateProfileRequest filter(final String value) {
