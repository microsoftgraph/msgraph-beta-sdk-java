...
/**
 * The class for the Policy Set Item Collection Response.
 */
public class PolicySetItemCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PolicySetItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PolicySetItem> value;
