 ...
 */
public class CurrencyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Currency within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Currency> value;
