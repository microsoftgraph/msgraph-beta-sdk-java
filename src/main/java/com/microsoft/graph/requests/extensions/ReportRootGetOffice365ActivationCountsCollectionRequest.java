...
public class ReportRootGetOffice365ActivationCountsCollectionRequest extends BaseCollectionRequest<ReportRootGetOffice365ActivationCountsCollectionResponse, IReportRootGetOffice365ActivationCountsCollectionPage> implements IReportRootGetOffice365ActivationCountsCollectionRequest {
    ...
    public void get(final ICallback<? super IReportRootGetOffice365ActivationCountsCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActivationCountsCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActivationCountsCollectionRequest orderBy(final String value) {
