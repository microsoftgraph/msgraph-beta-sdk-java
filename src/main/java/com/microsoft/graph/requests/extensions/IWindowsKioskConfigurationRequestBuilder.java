...
/**
 * The interface for the Windows Kiosk Configuration Request Builder.
 */
public interface IWindowsKioskConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsKioskConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsKioskConfigurationRequest instance
     */
    IWindowsKioskConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
