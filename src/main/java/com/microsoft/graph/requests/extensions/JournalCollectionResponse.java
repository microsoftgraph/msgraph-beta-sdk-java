...
/**
 * The class for the Journal Collection Response.
 */
public class JournalCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Journal within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Journal> value;
