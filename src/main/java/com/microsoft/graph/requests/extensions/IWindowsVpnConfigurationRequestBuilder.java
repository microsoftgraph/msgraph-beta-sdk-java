...
/**
 * The interface for the Windows Vpn Configuration Request Builder.
 */
public interface IWindowsVpnConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IWindowsVpnConfigurationRequest instance
     */
    IWindowsVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsVpnConfigurationRequest instance
     */
    IWindowsVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
