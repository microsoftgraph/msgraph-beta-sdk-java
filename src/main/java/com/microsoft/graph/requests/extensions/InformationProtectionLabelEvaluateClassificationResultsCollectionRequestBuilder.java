 ...
 */
public class InformationProtectionLabelEvaluateClassificationResultsCollectionRequestBuilder extends BaseActionRequestBuilder implements IInformationProtectionLabelEvaluateClassificationResultsCollectionRequestBuilder {
    ...
    public InformationProtectionLabelEvaluateClassificationResultsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final ContentInfo contentInfo, final java.util.List<ClassificationResult> classificationResults) {
  	 ...
  	 if(contentInfo!=null){
    	 ...
    	 if(classificationResults!=null){
			bodyParams.put("classificationResults", classificationResults);
		}
      }
     ...
     */
    public IInformationProtectionLabelEvaluateClassificationResultsCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IInformationProtectionLabelEvaluateClassificationResultsCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        ...
        if (hasParameter("classificationResults")) {
            request.body.classificationResults = getParameter("classificationResults");
        }
