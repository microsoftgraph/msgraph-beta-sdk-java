...
public class ReportRootGetEmailAppUsageVersionsUserCountsCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetEmailAppUsageVersionsUserCountsCollectionRequestBuilder {
     ...
     */
    public ReportRootGetEmailAppUsageVersionsUserCountsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String period) {
