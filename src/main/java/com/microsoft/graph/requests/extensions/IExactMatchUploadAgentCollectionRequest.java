...
/**
 * The interface for the Exact Match Upload Agent Collection Request.
 */
public interface IExactMatchUploadAgentCollectionRequest {
     ...
     */
    IExactMatchUploadAgentCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IExactMatchUploadAgentCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IExactMatchUploadAgentCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IExactMatchUploadAgentCollectionRequest skip(final int value);
