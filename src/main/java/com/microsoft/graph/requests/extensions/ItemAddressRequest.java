...
import com.microsoft.graph.requests.extensions.ItemAddressRequest;
...
public class ItemAddressRequest extends BaseRequest implements IItemAddressRequest {
     ...
     */
    public ItemAddressRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
