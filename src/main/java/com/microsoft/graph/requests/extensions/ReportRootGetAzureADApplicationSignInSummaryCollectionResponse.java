 ...
 */
public class ReportRootGetAzureADApplicationSignInSummaryCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<ApplicationSignInSummary> value;
