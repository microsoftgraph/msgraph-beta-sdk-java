...
public class OnPremisesAgentCollectionRequestBuilder extends BaseRequestBuilder implements IOnPremisesAgentCollectionRequestBuilder {
     ...
     */
    public OnPremisesAgentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IOnPremisesAgentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
