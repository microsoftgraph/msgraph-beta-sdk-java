 ...
 */
public class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> value;
