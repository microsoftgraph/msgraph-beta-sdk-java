...
import com.microsoft.graph.requests.extensions.AgedAccountsPayableRequest;
...
public class AgedAccountsPayableRequest extends BaseRequest implements IAgedAccountsPayableRequest {
     ...
     */
    public AgedAccountsPayableRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
