...
import com.microsoft.graph.requests.extensions.Windows81SCEPCertificateProfileRequest;
...
public class Windows81SCEPCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindows81SCEPCertificateProfileRequestBuilder {
     ...
     */
    public Windows81SCEPCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IWindows81SCEPCertificateProfileRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new Windows81SCEPCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
