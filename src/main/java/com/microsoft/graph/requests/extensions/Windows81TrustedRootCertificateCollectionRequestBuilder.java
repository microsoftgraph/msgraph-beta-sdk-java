...
public class Windows81TrustedRootCertificateCollectionRequestBuilder extends BaseRequestBuilder implements IWindows81TrustedRootCertificateCollectionRequestBuilder {
     ...
     */
    public Windows81TrustedRootCertificateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IWindows81TrustedRootCertificateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
