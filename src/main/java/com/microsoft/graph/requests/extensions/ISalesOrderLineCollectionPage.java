...
/**
 * The interface for the Sales Order Line Collection Page.
 */
public interface ISalesOrderLineCollectionPage extends IBaseCollectionPage<SalesOrderLine, ISalesOrderLineCollectionRequestBuilder> {
}
