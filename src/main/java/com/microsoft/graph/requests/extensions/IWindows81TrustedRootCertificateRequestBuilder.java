...
/**
 * The interface for the Windows81Trusted Root Certificate Request Builder.
 */
public interface IWindows81TrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows81TrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows81TrustedRootCertificateRequest instance
     */
    IWindows81TrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
