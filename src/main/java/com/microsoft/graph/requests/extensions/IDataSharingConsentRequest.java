...
/**
 * The interface for the Data Sharing Consent Request.
 */
public interface IDataSharingConsentRequest extends IHttpRequest {
     ...
     */
    DataSharingConsent get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    DataSharingConsent patch(final DataSharingConsent sourceDataSharingConsent) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    DataSharingConsent put(final DataSharingConsent newDataSharingConsent) throws ClientException;
     ...
     */
    IDataSharingConsentRequest select(final String value);
     ...
     * @return the updated request
     */
    IDataSharingConsentRequest expand(final String value);
