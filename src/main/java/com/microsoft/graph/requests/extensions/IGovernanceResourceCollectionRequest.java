...
/**
 * The interface for the Governance Resource Collection Request.
 */
public interface IGovernanceResourceCollectionRequest {
     ...
     */
    IGovernanceResourceCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IGovernanceResourceCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IGovernanceResourceCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IGovernanceResourceCollectionRequest skip(final int value);
