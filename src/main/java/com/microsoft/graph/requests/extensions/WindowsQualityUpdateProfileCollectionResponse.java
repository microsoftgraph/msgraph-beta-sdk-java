 ...
 */
public class WindowsQualityUpdateProfileCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WindowsQualityUpdateProfile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WindowsQualityUpdateProfile> value;
