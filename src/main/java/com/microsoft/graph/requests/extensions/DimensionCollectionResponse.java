...
/**
 * The class for the Dimension Collection Response.
 */
public class DimensionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Dimension within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Dimension> value;
