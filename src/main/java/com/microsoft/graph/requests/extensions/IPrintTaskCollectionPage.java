...
/**
 * The interface for the Print Task Collection Page.
 */
public interface IPrintTaskCollectionPage extends IBaseCollectionPage<PrintTask, IPrintTaskCollectionRequestBuilder> {
}
