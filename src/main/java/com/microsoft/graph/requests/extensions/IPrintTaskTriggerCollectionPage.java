...
/**
 * The interface for the Print Task Trigger Collection Page.
 */
public interface IPrintTaskTriggerCollectionPage extends IBaseCollectionPage<PrintTaskTrigger, IPrintTaskTriggerCollectionRequestBuilder> {
}
