 ...
 */
public class IosikEv2VpnConfigurationRequestBuilder extends BaseRequestBuilder implements IIosikEv2VpnConfigurationRequestBuilder {
     ...
     */
    public IosikEv2VpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosikEv2VpnConfigurationRequest instance
     */
    public IIosikEv2VpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
