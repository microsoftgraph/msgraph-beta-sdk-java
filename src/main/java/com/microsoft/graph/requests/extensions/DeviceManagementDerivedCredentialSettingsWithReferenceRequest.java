 ...
 */
public class DeviceManagementDerivedCredentialSettingsWithReferenceRequest extends BaseRequest implements IDeviceManagementDerivedCredentialSettingsWithReferenceRequest {
     ...
     */
    public DeviceManagementDerivedCredentialSettingsWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public DeviceManagementDerivedCredentialSettings post(final DeviceManagementDerivedCredentialSettings newDeviceManagementDerivedCredentialSettings, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IDeviceManagementDerivedCredentialSettingsWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IDeviceManagementDerivedCredentialSettingsWithReferenceRequest)this;
    }
