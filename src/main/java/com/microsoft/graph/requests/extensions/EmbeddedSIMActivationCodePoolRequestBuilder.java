...
public class EmbeddedSIMActivationCodePoolRequestBuilder extends BaseRequestBuilder implements IEmbeddedSIMActivationCodePoolRequestBuilder {
     ...
     */
    public IEmbeddedSIMActivationCodePoolRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IEmbeddedSIMActivationCodePoolRequest instance
     */
    public IEmbeddedSIMActivationCodePoolRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
