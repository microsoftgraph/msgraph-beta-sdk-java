...
import com.microsoft.graph.requests.extensions.IExternalGroupMemberRequest;
import com.microsoft.graph.requests.extensions.ExternalGroupMemberRequest;
...
public class ExternalGroupMemberRequest extends BaseRequest implements IExternalGroupMemberRequest {
     ...
     */
    public ExternalGroupMemberRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
