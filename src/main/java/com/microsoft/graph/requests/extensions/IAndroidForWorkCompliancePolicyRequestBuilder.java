...
/**
 * The interface for the Android For Work Compliance Policy Request Builder.
 */
public interface IAndroidForWorkCompliancePolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkCompliancePolicyRequest instance
     */
    IAndroidForWorkCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
