 ...
 */
public class DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest instance
     */
    public IDeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest request = new DeviceManagementReportsGetCompliancePolicyNonComplianceReportRequest(
                getRequestUrl(),
                getClient(),
                requestOptions
        );
