...
/**
 * The class for the Payment Term Collection Response.
 */
public class PaymentTermCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PaymentTerm within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PaymentTerm> value;
