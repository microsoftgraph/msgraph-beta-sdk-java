 ...
 */
public class DeviceManagementReportsGetPolicyNonComplianceSummaryReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequestBuilder {
    ...
    /**
     * Creates the IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetPolicyNonComplianceSummaryReportRequest instance
     */
