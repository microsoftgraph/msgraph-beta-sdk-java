...
/**
 * The interface for the Tax Area Collection Page.
 */
public interface ITaxAreaCollectionPage extends IBaseCollectionPage<TaxArea, ITaxAreaCollectionRequestBuilder> {
}
