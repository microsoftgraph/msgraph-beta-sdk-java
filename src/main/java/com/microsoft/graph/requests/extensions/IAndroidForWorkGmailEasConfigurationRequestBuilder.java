...
/**
 * The interface for the Android For Work Gmail Eas Configuration Request Builder.
 */
public interface IAndroidForWorkGmailEasConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkGmailEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkGmailEasConfigurationRequest instance
     */
    IAndroidForWorkGmailEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
