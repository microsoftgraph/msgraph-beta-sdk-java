...
public interface IIosScepCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosScepCertificateProfileRequest instance
     */
    IIosScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
