...
/**
 * The interface for the Rbac Application Multiple Request Builder.
 */
public interface IRbacApplicationMultipleRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IRbacApplicationMultipleRequest instance
     */
    IRbacApplicationMultipleRequest buildRequest();
     ...
     * @return the IRbacApplicationMultipleRequest instance
     */
    IRbacApplicationMultipleRequest buildRequest(final java.util.List<? extends Option> requestOptions);
