...
/**
 * The interface for the Windows Health Monitoring Configuration Request Builder.
 */
public interface IWindowsHealthMonitoringConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsHealthMonitoringConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsHealthMonitoringConfigurationRequest instance
     */
    IWindowsHealthMonitoringConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
