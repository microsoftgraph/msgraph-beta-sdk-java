...
/**
 * The interface for the External Group Member Collection Page.
 */
public interface IExternalGroupMemberCollectionPage extends IBaseCollectionPage<ExternalGroupMember, IExternalGroupMemberCollectionRequestBuilder> {
}
