...
public class IosVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IIosVpnConfigurationRequestBuilder {
     ...
     */
    public IosVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIosVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosVpnConfigurationRequest instance
     */
    public IIosVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
