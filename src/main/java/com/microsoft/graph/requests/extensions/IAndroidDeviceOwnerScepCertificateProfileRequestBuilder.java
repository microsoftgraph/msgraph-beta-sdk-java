...
/**
 * The interface for the Android Device Owner Scep Certificate Profile Request Builder.
 */
public interface IAndroidDeviceOwnerScepCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidDeviceOwnerScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerScepCertificateProfileRequest instance
     */
    IAndroidDeviceOwnerScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
