...
/**
 * The interface for the Item Patent Collection Page.
 */
public interface IItemPatentCollectionPage extends IBaseCollectionPage<ItemPatent, IItemPatentCollectionRequestBuilder> {
}
