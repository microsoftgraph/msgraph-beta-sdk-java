...
/**
 * The interface for the Journal Collection Page.
 */
public interface IJournalCollectionPage extends IBaseCollectionPage<Journal, IJournalCollectionRequestBuilder> {
}
