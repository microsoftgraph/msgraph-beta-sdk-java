...
/**
 * The class for the Planner Roster Collection Response.
 */
public class PlannerRosterCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PlannerRoster within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PlannerRoster> value;
