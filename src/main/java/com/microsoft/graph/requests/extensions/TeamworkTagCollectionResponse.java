...
/**
 * The class for the Teamwork Tag Collection Response.
 */
public class TeamworkTagCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TeamworkTag within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TeamworkTag> value;
