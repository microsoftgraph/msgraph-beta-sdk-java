...
public class DataLossPreventionPolicyCollectionRequest extends BaseCollectionRequest<DataLossPreventionPolicyCollectionResponse, IDataLossPreventionPolicyCollectionPage> implements IDataLossPreventionPolicyCollectionRequest {
    ...
    public void get(final ICallback<? super IDataLossPreventionPolicyCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IDataLossPreventionPolicyCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDataLossPreventionPolicyCollectionRequest orderBy(final String value) {
