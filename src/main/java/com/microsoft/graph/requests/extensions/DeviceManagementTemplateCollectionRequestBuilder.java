...
public class DeviceManagementTemplateCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementTemplateCollectionRequestBuilder {
     ...
     */
    public DeviceManagementTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
