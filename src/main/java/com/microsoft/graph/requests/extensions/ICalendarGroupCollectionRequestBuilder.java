 ...
 */
public interface ICalendarGroupCollectionRequestBuilder extends IRequestBuilder {

    ICalendarGroupCollectionRequest buildRequest();

    ICalendarGroupCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
