...
import com.microsoft.graph.requests.extensions.IOnPremisesPublishingProfileCollectionPage;
 ...
 */
public class OnPremisesPublishingProfileCollectionRequest extends BaseCollectionRequest<OnPremisesPublishingProfileCollectionResponse, IOnPremisesPublishingProfileCollectionPage> implements IOnPremisesPublishingProfileCollectionRequest {
     ...
     */
    public OnPremisesPublishingProfileCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IOnPremisesPublishingProfileCollectionPage get() throws ClientException {
        final OnPremisesPublishingProfileCollectionResponse response = send();
     ...
     */
    public IOnPremisesPublishingProfileCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IOnPremisesPublishingProfileCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IOnPremisesPublishingProfileCollectionRequest top(final int value) {
    ...
    public IOnPremisesPublishingProfileCollectionPage buildFromResponse(final OnPremisesPublishingProfileCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new OnPremisesPublishingProfileCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final OnPremisesPublishingProfileCollectionPage page = new OnPremisesPublishingProfileCollectionPage(response, builder);
