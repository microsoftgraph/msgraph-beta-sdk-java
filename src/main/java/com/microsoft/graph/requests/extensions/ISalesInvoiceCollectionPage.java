...
/**
 * The interface for the Sales Invoice Collection Page.
 */
public interface ISalesInvoiceCollectionPage extends IBaseCollectionPage<SalesInvoice, ISalesInvoiceCollectionRequestBuilder> {
}
