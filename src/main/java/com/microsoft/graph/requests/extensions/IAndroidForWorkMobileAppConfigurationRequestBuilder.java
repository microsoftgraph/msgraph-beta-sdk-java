...
/**
 * The interface for the Android For Work Mobile App Configuration Request Builder.
 */
public interface IAndroidForWorkMobileAppConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkMobileAppConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkMobileAppConfigurationRequest instance
     */
    IAndroidForWorkMobileAppConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
