...
/**
 * The interface for the Item Email Collection Page.
 */
public interface IItemEmailCollectionPage extends IBaseCollectionPage<ItemEmail, IItemEmailCollectionRequestBuilder> {
}
