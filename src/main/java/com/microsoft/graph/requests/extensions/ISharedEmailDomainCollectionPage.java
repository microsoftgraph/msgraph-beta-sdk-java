...
/**
 * The interface for the Shared Email Domain Collection Page.
 */
public interface ISharedEmailDomainCollectionPage extends IBaseCollectionPage<SharedEmailDomain, ISharedEmailDomainCollectionRequestBuilder> {
}
