...
/**
 * The interface for the Ios Derived Credential Authentication Configuration Request Builder.
 */
public interface IIosDerivedCredentialAuthenticationConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IIosDerivedCredentialAuthenticationConfigurationRequest instance
     */
    IIosDerivedCredentialAuthenticationConfigurationRequest buildRequest();
     ...
     * @return the IIosDerivedCredentialAuthenticationConfigurationRequest instance
     */
    IIosDerivedCredentialAuthenticationConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions);
