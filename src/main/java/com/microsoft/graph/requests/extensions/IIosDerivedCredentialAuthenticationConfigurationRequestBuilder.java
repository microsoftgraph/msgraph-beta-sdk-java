...
public interface IIosDerivedCredentialAuthenticationConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosDerivedCredentialAuthenticationConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosDerivedCredentialAuthenticationConfigurationRequest instance
     */
    IIosDerivedCredentialAuthenticationConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
