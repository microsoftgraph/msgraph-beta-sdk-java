...
public class WindowsHealthMonitoringConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsHealthMonitoringConfigurationRequestBuilder {
     ...
     */
    public WindowsHealthMonitoringConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsHealthMonitoringConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsHealthMonitoringConfigurationRequest instance
     */
    public IWindowsHealthMonitoringConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsHealthMonitoringConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
