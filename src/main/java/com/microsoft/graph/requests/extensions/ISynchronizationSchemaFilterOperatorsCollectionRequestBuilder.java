...
public interface ISynchronizationSchemaFilterOperatorsCollectionRequestBuilder extends IRequestBuilder {
    ...
    ISynchronizationSchemaFilterOperatorsCollectionRequest buildRequest();

    ISynchronizationSchemaFilterOperatorsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
