...
/**
 * The interface for the Print Document Create Upload Session Request.
 */
public interface IPrintDocumentCreateUploadSessionRequest extends IHttpRequest {
     ...
     */
    IPrintDocumentCreateUploadSessionRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IPrintDocumentCreateUploadSessionRequest top(final int value);
     ...
     * @return the updated request
     */
    IPrintDocumentCreateUploadSessionRequest expand(final String value);
