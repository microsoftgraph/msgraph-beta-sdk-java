 ...
 */
public class Windows10PFXImportCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindows10PFXImportCertificateProfileRequestBuilder {
     ...
     */
    public Windows10PFXImportCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindows10PFXImportCertificateProfileRequest instance
     */
    public IWindows10PFXImportCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
