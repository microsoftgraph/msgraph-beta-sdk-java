...
/**
 * The class for the Windows10PFXImport Certificate Profile Request Builder.
 */
public class Windows10PFXImportCertificateProfileRequestBuilder extends BaseRequestBuilder<Windows10PFXImportCertificateProfile> {

    /**
     * The request builder for the Windows10PFXImportCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public Windows10PFXImportCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10PFXImportCertificateProfileRequest instance
     */
    @Nonnull
    public Windows10PFXImportCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10PFXImportCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows10PFXImportCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
