...
public class SalesQuoteLineCollectionRequestBuilder extends BaseRequestBuilder implements ISalesQuoteLineCollectionRequestBuilder {
     ...
     */
    public SalesQuoteLineCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
