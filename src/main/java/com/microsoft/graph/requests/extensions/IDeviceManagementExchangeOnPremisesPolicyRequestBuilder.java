...
/**
 * The interface for the Device Management Exchange On Premises Policy Request Builder.
 */
public interface IDeviceManagementExchangeOnPremisesPolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceManagementExchangeOnPremisesPolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceManagementExchangeOnPremisesPolicyRequest instance
     */
    IDeviceManagementExchangeOnPremisesPolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
