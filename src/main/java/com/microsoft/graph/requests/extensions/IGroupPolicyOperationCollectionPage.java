...
/**
 * The interface for the Group Policy Operation Collection Page.
 */
public interface IGroupPolicyOperationCollectionPage extends IBaseCollectionPage<GroupPolicyOperation, IGroupPolicyOperationCollectionRequestBuilder> {
}
