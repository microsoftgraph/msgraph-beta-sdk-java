...
/**
 * The interface for the Item Email Collection Request.
 */
public interface IItemEmailCollectionRequest {
     ...
     */
    IItemEmailCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IItemEmailCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IItemEmailCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IItemEmailCollectionRequest skip(final int value);
