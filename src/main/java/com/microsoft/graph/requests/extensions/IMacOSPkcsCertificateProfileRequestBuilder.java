...
/**
 * The interface for the Mac OSPkcs Certificate Profile Request Builder.
 */
public interface IMacOSPkcsCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSPkcsCertificateProfileRequest instance
     */
    IMacOSPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
