 ...
 */
public class TeamSendActivityNotificationRequest extends BaseRequest<Void> {
    /**
     ...
     */
    public TeamSendActivityNotificationRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TeamSendActivityNotificationParameterSet parameters) {
    ...
    @Nullable
    protected TeamSendActivityNotificationParameterSet body;
    /**
