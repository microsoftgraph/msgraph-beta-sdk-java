...
/**
 * The interface for the Device Configuration Collection With References Request.
 */
public interface IDeviceConfigurationCollectionWithReferencesRequest {
    ...
    IDeviceConfigurationCollectionWithReferencesRequest expand(final String value);
    
    IDeviceConfigurationCollectionWithReferencesRequest select(final String value);

    IDeviceConfigurationCollectionWithReferencesRequest top(final int value);
