 ...
 */
public class JournalLineCollectionResponse implements IJsonBackedObject {

    /**
     * The list of JournalLine within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<JournalLine> value;
