...
public class UserExperienceAnalyticsScoreHistoryCollectionRequestBuilder extends BaseRequestBuilder implements IUserExperienceAnalyticsScoreHistoryCollectionRequestBuilder {
     ...
     */
    public UserExperienceAnalyticsScoreHistoryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsScoreHistoryCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
