...
public class DeviceManagementReportScheduleRequest extends BaseRequest<DeviceManagementReportSchedule> {
     ...
     */
    public void get(@Nonnull final ICallback<? super DeviceManagementReportSchedule> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super DeviceManagementReportSchedule> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final DeviceManagementReportSchedule sourceDeviceManagementReportSchedule, @Nonnull final ICallback<? super DeviceManagementReportSchedule> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final DeviceManagementReportSchedule newDeviceManagementReportSchedule, @Nonnull final ICallback<? super DeviceManagementReportSchedule> callback) {
