...
import com.microsoft.graph.requests.extensions.IIosCertificateProfileBaseRequest;
import com.microsoft.graph.requests.extensions.IosCertificateProfileBaseRequest;
...
public class IosCertificateProfileBaseRequest extends BaseRequest implements IIosCertificateProfileBaseRequest {
     ...
     * @param requestOptions the options for this request
     */
    public IosCertificateProfileBaseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final IosCertificateProfileBase newIosCertificateProfileBase, final ICallback<IosCertificateProfileBase> callback) {
