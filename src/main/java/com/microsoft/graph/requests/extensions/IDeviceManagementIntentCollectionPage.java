...
/**
 * The interface for the Device Management Intent Collection Page.
 */
public interface IDeviceManagementIntentCollectionPage extends IBaseCollectionPage<DeviceManagementIntent, IDeviceManagementIntentCollectionRequestBuilder> {
}
