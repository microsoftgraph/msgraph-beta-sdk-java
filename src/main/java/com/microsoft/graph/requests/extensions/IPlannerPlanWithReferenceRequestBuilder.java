...
/**
 * The interface for the Planner Plan With Reference Request Builder.
 */
public interface IPlannerPlanWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlannerPlanWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerPlanWithReferenceRequest instance
     */
    IPlannerPlanWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IPlannerPlanReferenceRequestBuilder reference();
