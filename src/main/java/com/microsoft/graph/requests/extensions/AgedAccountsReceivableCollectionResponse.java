...
/**
 * The class for the Aged Accounts Receivable Collection Response.
 */
public class AgedAccountsReceivableCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AgedAccountsReceivable within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AgedAccountsReceivable> value;
