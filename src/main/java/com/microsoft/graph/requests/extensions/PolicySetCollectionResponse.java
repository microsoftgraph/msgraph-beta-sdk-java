...
/**
 * The class for the Policy Set Collection Response.
 */
public class PolicySetCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PolicySet within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PolicySet> value;
