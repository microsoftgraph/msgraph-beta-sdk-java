...
/**
 * The class for the Space Collection Response.
 */
public class SpaceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Space within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Space> value;
