 ...
 */
public class ReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<SkypeForBusinessPeerToPeerActivityMinuteCounts> value;
