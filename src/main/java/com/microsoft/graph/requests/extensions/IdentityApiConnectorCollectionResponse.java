 ...
 */
public class IdentityApiConnectorCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IdentityApiConnector within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IdentityApiConnector> value;
