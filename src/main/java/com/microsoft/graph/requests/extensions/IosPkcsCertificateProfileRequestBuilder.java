...
public class IosPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IIosPkcsCertificateProfileRequestBuilder {
     ...
     */
    public IIosPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosPkcsCertificateProfileRequest instance
     */
    public IIosPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
