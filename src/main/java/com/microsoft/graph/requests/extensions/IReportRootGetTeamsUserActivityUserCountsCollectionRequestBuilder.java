...
public interface IReportRootGetTeamsUserActivityUserCountsCollectionRequestBuilder extends IRequestBuilder {
    ...
    IReportRootGetTeamsUserActivityUserCountsCollectionRequest buildRequest();

    IReportRootGetTeamsUserActivityUserCountsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
