...
public interface IUserAccountInformationCollectionRequestBuilder extends IRequestBuilder {
    ...
    IUserAccountInformationCollectionRequest buildRequest();

    IUserAccountInformationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
