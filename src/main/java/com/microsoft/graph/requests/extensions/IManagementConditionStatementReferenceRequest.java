...
/**
 * The interface for the Management Condition Statement Reference Request.
 */
public interface IManagementConditionStatementReferenceRequest extends IHttpRequest {
     ...
     */
    IManagementConditionStatementReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagementConditionStatementReferenceRequest expand(final String value);
     ...
     */
    ManagementConditionStatement put(ManagementConditionStatement srcManagementConditionStatement) throws ClientException;
}
