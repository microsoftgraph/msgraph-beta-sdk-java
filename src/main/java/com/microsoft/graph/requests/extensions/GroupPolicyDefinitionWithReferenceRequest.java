 ...
 */
public class GroupPolicyDefinitionWithReferenceRequest extends BaseWithReferenceRequest<GroupPolicyDefinition> {
     ...
     */
    public GroupPolicyDefinitionWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GroupPolicyDefinitionWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public GroupPolicyDefinitionWithReferenceRequest expand(@Nonnull final String value) {
