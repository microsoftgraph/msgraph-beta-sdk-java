...
/**
 * The interface for the App Scope Collection Page.
 */
public interface IAppScopeCollectionPage extends IBaseCollectionPage<AppScope, IAppScopeCollectionRequestBuilder> {
}
