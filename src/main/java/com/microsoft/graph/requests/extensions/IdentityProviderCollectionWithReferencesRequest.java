 ...
 */
public class IdentityProviderCollectionWithReferencesRequest extends BaseCollectionRequest<IdentityProviderCollectionResponse, IIdentityProviderCollectionPage> implements IIdentityProviderCollectionWithReferencesRequest {
    ...
    public IIdentityProviderCollectionWithReferencesPage get() throws ClientException {
    ...
    public IIdentityProviderCollectionWithReferencesPage buildFromResponse(final IdentityProviderCollectionResponse response) {
        final IIdentityProviderCollectionWithReferencesRequestBuilder builder;
        if (response.nextLink != null) {
            builder = new IdentityProviderCollectionWithReferencesRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final IdentityProviderCollectionWithReferencesPage page = new IdentityProviderCollectionWithReferencesPage(response, builder);
