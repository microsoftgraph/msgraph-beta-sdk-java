...
import com.microsoft.graph.requests.extensions.IUserExperienceAnalyticsDevicePerformanceCollectionPage;
 ...
 */
public class UserExperienceAnalyticsDevicePerformanceCollectionRequest extends BaseCollectionRequest<UserExperienceAnalyticsDevicePerformanceCollectionResponse, IUserExperienceAnalyticsDevicePerformanceCollectionPage> implements IUserExperienceAnalyticsDevicePerformanceCollectionRequest {
     ...
     */
    public UserExperienceAnalyticsDevicePerformanceCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsDevicePerformanceCollectionPage get() throws ClientException {
        final UserExperienceAnalyticsDevicePerformanceCollectionResponse response = send();
     ...
     */
    public IUserExperienceAnalyticsDevicePerformanceCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsDevicePerformanceCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsDevicePerformanceCollectionRequest top(final int value) {
    ...
    public IUserExperienceAnalyticsDevicePerformanceCollectionPage buildFromResponse(final UserExperienceAnalyticsDevicePerformanceCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new UserExperienceAnalyticsDevicePerformanceCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final UserExperienceAnalyticsDevicePerformanceCollectionPage page = new UserExperienceAnalyticsDevicePerformanceCollectionPage(response, builder);
