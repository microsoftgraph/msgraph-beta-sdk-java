...
/**
 * The interface for the Item Address Collection Request.
 */
public interface IItemAddressCollectionRequest {
     ...
     */
    IItemAddressCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IItemAddressCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IItemAddressCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IItemAddressCollectionRequest skip(final int value);
