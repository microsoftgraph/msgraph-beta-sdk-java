...
/**
 * The interface for the Group Policy Definition Value Request Builder.
 */
public interface IGroupPolicyDefinitionValueRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IGroupPolicyDefinitionValueRequest instance
     */
    IGroupPolicyDefinitionValueRequest buildRequest();
     ...
     * @return the IGroupPolicyDefinitionValueRequest instance
     */
    IGroupPolicyDefinitionValueRequest buildRequest(final java.util.List<? extends Option> requestOptions);
