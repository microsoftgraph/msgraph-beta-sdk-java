...
public class WindowsPhone81TrustedRootCertificateRequest extends BaseRequest implements IWindowsPhone81TrustedRootCertificateRequest {
     ...
     */
    public WindowsPhone81TrustedRootCertificateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
