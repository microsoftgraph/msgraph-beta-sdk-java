...
public class Office365ServicesUserCountsRequest extends BaseRequest implements IOffice365ServicesUserCountsRequest {
     ...
     */
    public Office365ServicesUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Office365ServicesUserCounts> callback) {
     ...
     */
    public void delete(final ICallback<Office365ServicesUserCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Office365ServicesUserCounts sourceOffice365ServicesUserCounts, final ICallback<Office365ServicesUserCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Office365ServicesUserCounts newOffice365ServicesUserCounts, final ICallback<Office365ServicesUserCounts> callback) {
