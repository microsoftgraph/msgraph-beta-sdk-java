...
/**
 * The interface for the Device Compliance Policy Assignment Request Builder.
 */
public interface IDeviceCompliancePolicyAssignmentRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
