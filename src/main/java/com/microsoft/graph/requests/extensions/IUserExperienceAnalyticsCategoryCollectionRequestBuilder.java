...
/**
 * The interface for the User Experience Analytics Category Collection Request Builder.
 */
public interface IUserExperienceAnalyticsCategoryCollectionRequestBuilder extends IRequestBuilder {
    ...
    IUserExperienceAnalyticsCategoryCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
