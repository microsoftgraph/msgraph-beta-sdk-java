...
/**
 * The interface for the Outlook Task Folder Request Builder.
 */
public interface IOutlookTaskFolderRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IOutlookTaskFolderRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOutlookTaskFolderRequest instance
     */
    IOutlookTaskFolderRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
