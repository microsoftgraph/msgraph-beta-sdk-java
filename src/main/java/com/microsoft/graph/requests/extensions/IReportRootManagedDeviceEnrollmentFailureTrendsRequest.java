...
/**
 * The interface for the Report Root Managed Device Enrollment Failure Trends Request.
 */
public interface IReportRootManagedDeviceEnrollmentFailureTrendsRequest extends IHttpRequest {
     ...
     */
    IReportRootManagedDeviceEnrollmentFailureTrendsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootManagedDeviceEnrollmentFailureTrendsRequest expand(final String value);
