 ...
 */
public class UnifiedRoleScheduleInstanceBaseRequestBuilder extends BaseRequestBuilder implements IUnifiedRoleScheduleInstanceBaseRequestBuilder {
     ...
     */
    public UnifiedRoleScheduleInstanceBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IUnifiedRoleScheduleInstanceBaseRequest instance
     */
    public IUnifiedRoleScheduleInstanceBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUnifiedRoleScheduleInstanceBaseRequest instance
     */
    public IUnifiedRoleScheduleInstanceBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.UnifiedRoleScheduleInstanceBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
