 ...
 */
public class UserGetManagedDevicesWithFailedOrPendingAppsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<ManagedDeviceSummarizedAppState> value;
