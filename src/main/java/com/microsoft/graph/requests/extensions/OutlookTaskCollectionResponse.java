 ...
 */
public class OutlookTaskCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OutlookTask within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OutlookTask> value;
