...
public class AccessPackageAssignmentResourceRoleMyCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IAccessPackageAssignmentResourceRoleMyCollectionRequestBuilder {
     ...
     */
    public AccessPackageAssignmentResourceRoleMyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IAccessPackageAssignmentResourceRoleMyCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IAccessPackageAssignmentResourceRoleMyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
