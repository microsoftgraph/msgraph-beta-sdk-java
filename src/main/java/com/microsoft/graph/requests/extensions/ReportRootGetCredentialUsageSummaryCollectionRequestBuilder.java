...
public class ReportRootGetCredentialUsageSummaryCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetCredentialUsageSummaryCollectionRequestBuilder {
     ...
     */
    public ReportRootGetCredentialUsageSummaryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
    ...
    public IReportRootGetCredentialUsageSummaryCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
