...
/**
 * The interface for the Connector Group Collection Request.
 */
public interface IConnectorGroupCollectionRequest {
     ...
     */
    IConnectorGroupCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IConnectorGroupCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IConnectorGroupCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IConnectorGroupCollectionRequest skip(final int value);
