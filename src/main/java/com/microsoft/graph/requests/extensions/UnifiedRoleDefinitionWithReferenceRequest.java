...
public class UnifiedRoleDefinitionWithReferenceRequest extends BaseRequest implements IUnifiedRoleDefinitionWithReferenceRequest {
     ...
     */
    public UnifiedRoleDefinitionWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, UnifiedRoleDefinition.class);
    }

    public void post(final UnifiedRoleDefinition newUnifiedRoleDefinition, final IJsonBackedObject payload, final ICallback<UnifiedRoleDefinition> callback) {
