...
/**
 * The interface for the User Experience Analytics App Health Device Model Performance Collection Request.
 */
public interface IUserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionRequest extends IHttpRequest {
     ...
     */
    IUserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionRequest skip(final int value);
