...
import com.microsoft.graph.requests.extensions.IUserExperienceAnalyticsDeviceStartupHistoryCollectionPage;
 ...
 */
public class UserExperienceAnalyticsDeviceStartupHistoryCollectionRequest extends BaseCollectionRequest<UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse, IUserExperienceAnalyticsDeviceStartupHistoryCollectionPage> implements IUserExperienceAnalyticsDeviceStartupHistoryCollectionRequest {
     ...
     */
    public UserExperienceAnalyticsDeviceStartupHistoryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsDeviceStartupHistoryCollectionPage get() throws ClientException {
        final UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse response = send();
     ...
     */
    public IUserExperienceAnalyticsDeviceStartupHistoryCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsDeviceStartupHistoryCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsDeviceStartupHistoryCollectionRequest top(final int value) {
    ...
    public IUserExperienceAnalyticsDeviceStartupHistoryCollectionPage buildFromResponse(final UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new UserExperienceAnalyticsDeviceStartupHistoryCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final UserExperienceAnalyticsDeviceStartupHistoryCollectionPage page = new UserExperienceAnalyticsDeviceStartupHistoryCollectionPage(response, builder);
