 ...
 */
public class IosExpeditedCheckinConfigurationRequestBuilder extends BaseRequestBuilder implements IIosExpeditedCheckinConfigurationRequestBuilder {
     ...
     */
    public IosExpeditedCheckinConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosExpeditedCheckinConfigurationRequest instance
     */
    public IIosExpeditedCheckinConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosExpeditedCheckinConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
