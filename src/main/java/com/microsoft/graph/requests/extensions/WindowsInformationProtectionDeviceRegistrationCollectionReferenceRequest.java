...
public class WindowsInformationProtectionDeviceRegistrationCollectionReferenceRequest extends BaseCollectionRequest<WindowsInformationProtectionDeviceRegistrationCollectionResponse, IWindowsInformationProtectionDeviceRegistrationCollectionPage> implements IWindowsInformationProtectionDeviceRegistrationCollectionReferenceRequest {
     ...
     */
    public WindowsInformationProtectionDeviceRegistrationCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
