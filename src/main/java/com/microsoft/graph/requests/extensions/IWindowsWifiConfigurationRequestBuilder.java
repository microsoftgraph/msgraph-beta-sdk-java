...
/**
 * The interface for the Windows Wifi Configuration Request Builder.
 */
public interface IWindowsWifiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsWifiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsWifiConfigurationRequest instance
     */
    IWindowsWifiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
