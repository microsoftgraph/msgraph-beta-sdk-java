 ...
 */
public class RoleScopeTagWithReferenceRequestBuilder extends BaseRequestBuilder implements IRoleScopeTagWithReferenceRequestBuilder {
     ...
     */
    public IRoleScopeTagWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IRoleScopeTagReferenceRequestBuilder reference(){
        return new RoleScopeTagReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
