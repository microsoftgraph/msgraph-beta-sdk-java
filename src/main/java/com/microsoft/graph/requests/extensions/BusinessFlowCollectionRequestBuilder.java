...
public class BusinessFlowCollectionRequestBuilder extends BaseRequestBuilder implements IBusinessFlowCollectionRequestBuilder {
     ...
     */
    public BusinessFlowCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IBusinessFlowCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
