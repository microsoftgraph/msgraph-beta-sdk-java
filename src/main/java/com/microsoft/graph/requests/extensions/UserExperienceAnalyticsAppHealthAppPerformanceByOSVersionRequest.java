...
public class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionRequest extends BaseRequest<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> {
     ...
     */
    public void get(@Nonnull final ICallback<? super UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion sourceUserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, @Nonnull final ICallback<? super UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion newUserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, @Nonnull final ICallback<? super UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion newUserExperienceAnalyticsAppHealthAppPerformanceByOSVersion, @Nonnull final ICallback<? super UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> callback) {
