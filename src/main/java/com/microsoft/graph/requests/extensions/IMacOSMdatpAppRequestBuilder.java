...
/**
 * The interface for the Mac OSMdatp App Request Builder.
 */
public interface IMacOSMdatpAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSMdatpAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSMdatpAppRequest instance
     */
    IMacOSMdatpAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
