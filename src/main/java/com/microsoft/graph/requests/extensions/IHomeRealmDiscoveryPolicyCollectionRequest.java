...
/**
 * The interface for the Home Realm Discovery Policy Collection Request.
 */
public interface IHomeRealmDiscoveryPolicyCollectionRequest {
     ...
     */
    IHomeRealmDiscoveryPolicyCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IHomeRealmDiscoveryPolicyCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IHomeRealmDiscoveryPolicyCollectionRequest top(final int value);
