...
/**
 * The interface for the Mobile Contained App Collection Page.
 */
public interface IMobileContainedAppCollectionPage extends IBaseCollectionPage<MobileContainedApp, IMobileContainedAppCollectionRequestBuilder> {
}
