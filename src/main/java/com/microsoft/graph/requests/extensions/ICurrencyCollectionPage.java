...
/**
 * The interface for the Currency Collection Page.
 */
public interface ICurrencyCollectionPage extends IBaseCollectionPage<Currency, ICurrencyCollectionRequestBuilder> {
}
