...
/**
 * The interface for the Print Task Definition Request Builder.
 */
public interface IPrintTaskDefinitionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IPrintTaskDefinitionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPrintTaskDefinitionRequest instance
     */
    IPrintTaskDefinitionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
