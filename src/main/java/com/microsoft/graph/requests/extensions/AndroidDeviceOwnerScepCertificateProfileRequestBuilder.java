...
public class AndroidDeviceOwnerScepCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerScepCertificateProfileRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerScepCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidDeviceOwnerScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerScepCertificateProfileRequest instance
     */
    public IAndroidDeviceOwnerScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidDeviceOwnerScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
