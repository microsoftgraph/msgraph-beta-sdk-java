...
public interface IGroupPolicyPresentationValueListRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupPolicyPresentationValueListRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupPolicyPresentationValueListRequest instance
     */
    IGroupPolicyPresentationValueListRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
