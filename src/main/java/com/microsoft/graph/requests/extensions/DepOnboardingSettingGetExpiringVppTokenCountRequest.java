...
public class DepOnboardingSettingGetExpiringVppTokenCountRequest extends BaseRequest implements IDepOnboardingSettingGetExpiringVppTokenCountRequest {
     ...
     * @return the updated request
     */
    public IDepOnboardingSettingGetExpiringVppTokenCountRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDepOnboardingSettingGetExpiringVppTokenCountRequest orderBy(final String value) {
