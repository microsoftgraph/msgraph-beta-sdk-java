...
public interface IIntuneBrandingProfileAssignmentRequestBuilder extends IRequestBuilder {
     ...
     */
    IIntuneBrandingProfileAssignmentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIntuneBrandingProfileAssignmentRequest instance
     */
    IIntuneBrandingProfileAssignmentRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
