...
import com.microsoft.graph.requests.extensions.IMacOSCertificateProfileBaseRequest;
import com.microsoft.graph.requests.extensions.MacOSCertificateProfileBaseRequest;
...
public class MacOSCertificateProfileBaseRequest extends BaseRequest implements IMacOSCertificateProfileBaseRequest {
     ...
     * @param requestOptions the options for this request
     */
    public MacOSCertificateProfileBaseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final MacOSCertificateProfileBase newMacOSCertificateProfileBase, final ICallback<MacOSCertificateProfileBase> callback) {
