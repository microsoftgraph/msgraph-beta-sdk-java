...
public class PrintRequestBuilder extends BaseRequestBuilder<Print> {
    ...
    /**
     *  Gets a request builder for the ReportRoot collection
     *
     * @return the collection request builder
     */
    @Nonnull
    public ReportRootCollectionRequestBuilder reports() {
        return new ReportRootCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("reports"), getClient(), null);
    }

    /**
     * Gets a request builder for the ReportRoot item
     *
     * @return the request builder
     * @param id the item identifier
     */
    @Nonnull
    public ReportRootRequestBuilder reports(@Nonnull final String id) {
