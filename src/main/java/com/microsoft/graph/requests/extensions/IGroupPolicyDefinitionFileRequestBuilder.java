...
/**
 * The interface for the Group Policy Definition File Request Builder.
 */
public interface IGroupPolicyDefinitionFileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IGroupPolicyDefinitionFileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
