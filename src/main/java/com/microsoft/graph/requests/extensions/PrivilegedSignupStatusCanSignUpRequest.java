 ...
 */
public class PrivilegedSignupStatusCanSignUpRequest extends BaseRequest implements IPrivilegedSignupStatusCanSignUpRequest {
     ...
     */
    public PrivilegedSignupStatusCanSignUpRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IPrivilegedSignupStatusCanSignUpRequest orderBy(final String value) {
