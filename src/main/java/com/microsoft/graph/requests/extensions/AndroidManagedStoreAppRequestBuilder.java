...
public class AndroidManagedStoreAppRequestBuilder extends BaseRequestBuilder implements IAndroidManagedStoreAppRequestBuilder {
     ...
     */
    public AndroidManagedStoreAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidManagedStoreAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidManagedStoreAppRequest instance
     */
    public IAndroidManagedStoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidManagedStoreAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
