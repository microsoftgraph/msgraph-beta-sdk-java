...
public class ReportRootGetM365AppPlatformUserCountsRequest extends BaseRequest implements IReportRootGetM365AppPlatformUserCountsRequest {
     ...
     */
    public ReportRootGetM365AppPlatformUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
