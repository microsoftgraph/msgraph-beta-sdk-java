...
/**
 * The interface for the User PFXCertificate Collection Request.
 */
public interface IUserPFXCertificateCollectionRequest {
     ...
     */
    IUserPFXCertificateCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserPFXCertificateCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserPFXCertificateCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserPFXCertificateCollectionRequest skip(final int value);
