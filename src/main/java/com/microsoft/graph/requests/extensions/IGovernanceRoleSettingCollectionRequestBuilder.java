...
public interface IGovernanceRoleSettingCollectionRequestBuilder extends IRequestBuilder {
    ...
    IGovernanceRoleSettingCollectionRequest buildRequest();

    IGovernanceRoleSettingCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
