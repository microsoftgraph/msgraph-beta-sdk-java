...
public class RiskyUserCollectionRequestBuilder extends BaseRequestBuilder implements IRiskyUserCollectionRequestBuilder {
     ...
     */
    public RiskyUserCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IRiskyUserCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public IRiskyUserCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
