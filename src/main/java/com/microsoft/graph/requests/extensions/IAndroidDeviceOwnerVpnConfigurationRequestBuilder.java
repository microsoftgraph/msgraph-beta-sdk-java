...
/**
 * The interface for the Android Device Owner Vpn Configuration Request Builder.
 */
public interface IAndroidDeviceOwnerVpnConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidDeviceOwnerVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
