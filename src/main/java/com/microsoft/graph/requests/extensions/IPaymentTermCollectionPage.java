...
/**
 * The interface for the Payment Term Collection Page.
 */
public interface IPaymentTermCollectionPage extends IBaseCollectionPage<PaymentTerm, IPaymentTermCollectionRequestBuilder> {
}
