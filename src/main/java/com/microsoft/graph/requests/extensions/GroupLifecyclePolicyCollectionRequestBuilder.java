...
public class GroupLifecyclePolicyCollectionRequestBuilder extends BaseRequestBuilder implements IGroupLifecyclePolicyCollectionRequestBuilder {
    ...
    public IGroupLifecyclePolicyRenewGroupRequestBuilder renewGroup(final String groupId) {
        return new GroupLifecyclePolicyRenewGroupRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.renewGroup"), getClient(), null, groupId);
    }
}
