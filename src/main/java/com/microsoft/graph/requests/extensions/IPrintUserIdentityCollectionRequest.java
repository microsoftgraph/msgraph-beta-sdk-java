...
/**
 * The interface for the Print User Identity Collection Request.
 */
public interface IPrintUserIdentityCollectionRequest {
     ...
     */
    IPrintUserIdentityCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IPrintUserIdentityCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrintUserIdentityCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IPrintUserIdentityCollectionRequest skip(final int value);
