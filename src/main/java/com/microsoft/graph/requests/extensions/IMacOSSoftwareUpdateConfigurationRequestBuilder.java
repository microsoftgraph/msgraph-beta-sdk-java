...
/**
 * The interface for the Mac OSSoftware Update Configuration Request Builder.
 */
public interface IMacOSSoftwareUpdateConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSSoftwareUpdateConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSSoftwareUpdateConfigurationRequest instance
     */
    IMacOSSoftwareUpdateConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
