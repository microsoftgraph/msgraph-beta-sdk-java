...
public class RoleScopeTagAutoAssignmentRequest extends BaseRequest implements IRoleScopeTagAutoAssignmentRequest {
     ...
     */
    public RoleScopeTagAutoAssignmentRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<RoleScopeTagAutoAssignment> callback) {
     ...
     */
    public void delete(final ICallback<RoleScopeTagAutoAssignment> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final RoleScopeTagAutoAssignment sourceRoleScopeTagAutoAssignment, final ICallback<RoleScopeTagAutoAssignment> callback) {
