 ...
 */
public class MacOSExtensionsConfigurationRequestBuilder extends BaseRequestBuilder<MacOSExtensionsConfiguration> {
     ...
     */
    public MacOSExtensionsConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSExtensionsConfigurationRequest instance
     */
    @Nonnull
    public MacOSExtensionsConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSExtensionsConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSExtensionsConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
