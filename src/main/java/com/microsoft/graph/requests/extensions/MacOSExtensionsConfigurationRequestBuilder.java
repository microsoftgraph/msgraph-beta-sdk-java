...
public class MacOSExtensionsConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSExtensionsConfigurationRequestBuilder {
     ...
     */
    public MacOSExtensionsConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSExtensionsConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSExtensionsConfigurationRequest instance
     */
    public IMacOSExtensionsConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
