 ...
 */
public class InformationProtectionLabelCollectionResponse implements IJsonBackedObject {

    /**
     * The list of InformationProtectionLabel within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<InformationProtectionLabel> value;
