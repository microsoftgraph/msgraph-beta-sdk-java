...
public class BookingStaffMemberRequestBuilder extends BaseRequestBuilder implements IBookingStaffMemberRequestBuilder {
     ...
     */
    public BookingStaffMemberRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IBookingStaffMemberRequest buildRequest() {
