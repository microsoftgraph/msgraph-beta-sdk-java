...
public class CertificateBasedAuthConfigurationCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements ICertificateBasedAuthConfigurationCollectionWithReferencesRequestBuilder {
     ...
     */
    public CertificateBasedAuthConfigurationCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ICertificateBasedAuthConfigurationCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
