...
/**
 * The interface for the Aged Accounts Payable Collection Page.
 */
public interface IAgedAccountsPayableCollectionPage extends IBaseCollectionPage<AgedAccountsPayable, IAgedAccountsPayableCollectionRequestBuilder> {
}
