 ...
 */
public class PrintJobCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintJob within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintJob> value;
