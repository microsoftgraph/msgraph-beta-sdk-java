...
public class ItemActivityStatCollectionRequestBuilder extends BaseRequestBuilder implements IItemActivityStatCollectionRequestBuilder {
     ...
     */
    public ItemActivityStatCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IItemActivityStatCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
