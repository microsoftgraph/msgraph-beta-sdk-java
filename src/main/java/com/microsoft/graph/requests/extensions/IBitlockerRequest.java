...
public interface IBitlockerRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<? super Bitlocker> callback);
     ...
     */
    void delete(final ICallback<? super Bitlocker> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final Bitlocker sourceBitlocker, final ICallback<? super Bitlocker> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void post(final Bitlocker newBitlocker, final ICallback<? super Bitlocker> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final Bitlocker newBitlocker, final ICallback<? super Bitlocker> callback);
