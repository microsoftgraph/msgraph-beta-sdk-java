...
/**
 * The interface for the Apple Expedited Checkin Configuration Base Request Builder.
 */
public interface IAppleExpeditedCheckinConfigurationBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAppleExpeditedCheckinConfigurationBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAppleExpeditedCheckinConfigurationBaseRequest instance
     */
    IAppleExpeditedCheckinConfigurationBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
