...
public interface IDeviceManagementDomainJoinConnectorRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceManagementDomainJoinConnectorRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceManagementDomainJoinConnectorRequest instance
     */
    IDeviceManagementDomainJoinConnectorRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
