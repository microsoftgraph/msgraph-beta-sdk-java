 ...
 */
public class ChatCollectionRequest extends BaseEntityCollectionRequest<Chat, ChatCollectionResponse, ChatCollectionPage> {
     ...
     */
    @Nonnull
    public ChatCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ChatCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
