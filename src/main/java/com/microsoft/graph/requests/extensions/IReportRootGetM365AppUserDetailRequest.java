...
/**
 * The interface for the Report Root Get M365App User Detail Request.
 */
public interface IReportRootGetM365AppUserDetailRequest extends IHttpRequest {
     ...
     */
    IReportRootGetM365AppUserDetailRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetM365AppUserDetailRequest expand(final String value);
