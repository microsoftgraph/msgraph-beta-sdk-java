...
/**
 * The interface for the Windows Management App With Reference Request Builder.
 */
public interface IWindowsManagementAppWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindowsManagementAppWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
