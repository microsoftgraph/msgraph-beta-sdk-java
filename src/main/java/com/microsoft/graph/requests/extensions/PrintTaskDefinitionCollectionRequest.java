...
public class PrintTaskDefinitionCollectionRequest extends BaseCollectionRequest<PrintTaskDefinitionCollectionResponse, IPrintTaskDefinitionCollectionPage> implements IPrintTaskDefinitionCollectionRequest {
     ...
     */
    public PrintTaskDefinitionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public void get(final ICallback<IPrintTaskDefinitionCollectionPage> callback) {
