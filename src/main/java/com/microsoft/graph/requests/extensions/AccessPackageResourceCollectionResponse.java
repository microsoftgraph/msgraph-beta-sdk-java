 ...
 */
public class AccessPackageResourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AccessPackageResource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AccessPackageResource> value;
