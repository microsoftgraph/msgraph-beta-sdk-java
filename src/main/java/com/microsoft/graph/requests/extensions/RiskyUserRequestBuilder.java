...
public class RiskyUserRequestBuilder extends BaseRequestBuilder implements IRiskyUserRequestBuilder {
     ...
     */
    public RiskyUserRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IRiskyUserRequest instance
     */
    public IRiskyUserRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
