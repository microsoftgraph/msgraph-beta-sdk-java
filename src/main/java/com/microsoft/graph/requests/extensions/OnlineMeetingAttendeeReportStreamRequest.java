 ...
 */
public class OnlineMeetingAttendeeReportStreamRequest extends BaseStreamRequest<OnlineMeeting> implements IOnlineMeetingAttendeeReportStreamRequest {
     ...
     */
    public OnlineMeetingAttendeeReportStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
