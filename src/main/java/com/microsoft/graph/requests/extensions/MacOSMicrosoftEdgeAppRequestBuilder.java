...
public class MacOSMicrosoftEdgeAppRequestBuilder extends BaseRequestBuilder implements IMacOSMicrosoftEdgeAppRequestBuilder {
     ...
     */
    public MacOSMicrosoftEdgeAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IMacOSMicrosoftEdgeAppRequest instance
     */
    public IMacOSMicrosoftEdgeAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
