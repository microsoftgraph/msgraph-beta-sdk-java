...
/**
 * The interface for the User Experience Analytics App Health Device Performance Details Collection Request.
 */
public interface IUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionRequest extends IHttpRequest {
     ...
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionRequest skip(final int value);
