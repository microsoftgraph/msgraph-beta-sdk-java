...
public interface IWindows10NetworkBoundaryConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindows10NetworkBoundaryConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows10NetworkBoundaryConfigurationRequest instance
     */
    IWindows10NetworkBoundaryConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
