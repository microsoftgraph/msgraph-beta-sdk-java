 ...
 */
public class AndroidManagedStoreAccountEnterpriseSettingsCreateGooglePlayWebTokenRequest extends BaseRequest<String> {
    /**
    ...
    @Nullable
    protected AndroidManagedStoreAccountEnterpriseSettingsCreateGooglePlayWebTokenParameterSet body;
    /**
     ...
     */
    @Nonnull
    public AndroidManagedStoreAccountEnterpriseSettingsCreateGooglePlayWebTokenRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public AndroidManagedStoreAccountEnterpriseSettingsCreateGooglePlayWebTokenRequest expand(@Nonnull final String value) {
