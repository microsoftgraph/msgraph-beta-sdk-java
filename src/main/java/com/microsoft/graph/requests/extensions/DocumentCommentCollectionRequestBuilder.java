...
public class DocumentCommentCollectionRequestBuilder extends BaseRequestBuilder implements IDocumentCommentCollectionRequestBuilder {
     ...
     */
    public DocumentCommentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDocumentCommentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
