...
public class AppConsentRequestRequest extends BaseRequest<AppConsentRequest> {
     ...
     */
    public void get(@Nonnull final ICallback<? super AppConsentRequest> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super AppConsentRequest> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final AppConsentRequest sourceAppConsentRequest, @Nonnull final ICallback<? super AppConsentRequest> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final AppConsentRequest newAppConsentRequest, @Nonnull final ICallback<? super AppConsentRequest> callback) {
