...
public class DeviceManagementGetAssignedRoleDetailsRequest extends BaseRequest implements IDeviceManagementGetAssignedRoleDetailsRequest {
     ...
     */
    public DeviceManagementGetAssignedRoleDetailsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<DeviceAndAppManagementAssignedRoleDetails> callback) {
