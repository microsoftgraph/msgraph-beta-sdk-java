...
public class DimensionValueCollectionRequestBuilder extends BaseRequestBuilder implements IDimensionValueCollectionRequestBuilder {
     ...
     */
    public DimensionValueCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDimensionValueCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
