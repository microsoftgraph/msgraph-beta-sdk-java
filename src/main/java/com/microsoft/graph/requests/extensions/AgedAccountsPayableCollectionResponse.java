...
/**
 * The class for the Aged Accounts Payable Collection Response.
 */
public class AgedAccountsPayableCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AgedAccountsPayable within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AgedAccountsPayable> value;
