...
public interface IIosImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosImportedPFXCertificateProfileRequest instance
     */
    IIosImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
