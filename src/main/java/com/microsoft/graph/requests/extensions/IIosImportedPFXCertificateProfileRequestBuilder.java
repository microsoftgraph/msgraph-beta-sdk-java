...
/**
 * The interface for the Ios Imported PFXCertificate Profile Request Builder.
 */
public interface IIosImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IIosImportedPFXCertificateProfileRequest instance
     */
    IIosImportedPFXCertificateProfileRequest buildRequest();
     ...
     * @return the IIosImportedPFXCertificateProfileRequest instance
     */
    IIosImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends Option> requestOptions);
