...
import com.microsoft.graph.requests.extensions.GovernanceRoleAssignmentRequestRequest;
...
public class GovernanceRoleAssignmentRequestRequest extends BaseRequest implements IGovernanceRoleAssignmentRequestRequest {
     ...
     */
    public GovernanceRoleAssignmentRequestRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
