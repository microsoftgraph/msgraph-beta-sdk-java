...
public class PrivilegedRoleAssignmentCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IPrivilegedRoleAssignmentCollectionWithReferencesRequestBuilder {
     ...
     */
    public PrivilegedRoleAssignmentCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IPrivilegedRoleAssignmentCollectionWithReferencesRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IPrivilegedRoleAssignmentCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
