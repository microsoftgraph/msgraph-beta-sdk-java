...
public class IosExpeditedCheckinConfigurationRequest extends BaseRequest<IosExpeditedCheckinConfiguration> {
     ...
     */
    public void get(@Nonnull final ICallback<? super IosExpeditedCheckinConfiguration> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super IosExpeditedCheckinConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final IosExpeditedCheckinConfiguration sourceIosExpeditedCheckinConfiguration, @Nonnull final ICallback<? super IosExpeditedCheckinConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final IosExpeditedCheckinConfiguration newIosExpeditedCheckinConfiguration, @Nonnull final ICallback<? super IosExpeditedCheckinConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final IosExpeditedCheckinConfiguration newIosExpeditedCheckinConfiguration, @Nonnull final ICallback<? super IosExpeditedCheckinConfiguration> callback) {
