...
import com.microsoft.graph.requests.extensions.ClassificationJobResponseRequest;
...
public class ClassificationJobResponseRequest extends BaseRequest implements IClassificationJobResponseRequest {
     ...
     */
    public ClassificationJobResponseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
