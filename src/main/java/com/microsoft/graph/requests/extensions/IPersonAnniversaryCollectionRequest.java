...
/**
 * The interface for the Person Anniversary Collection Request.
 */
public interface IPersonAnniversaryCollectionRequest {
     ...
     */
    IPersonAnniversaryCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IPersonAnniversaryCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IPersonAnniversaryCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IPersonAnniversaryCollectionRequest skip(final int value);
