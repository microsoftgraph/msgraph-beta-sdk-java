...
public class PurchaseInvoiceCollectionRequestBuilder extends BaseRequestBuilder implements IPurchaseInvoiceCollectionRequestBuilder {
     ...
     */
    public PurchaseInvoiceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
