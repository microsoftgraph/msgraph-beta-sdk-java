...
/**
 * The interface for the Aged Accounts Receivable Collection Request.
 */
public interface IAgedAccountsReceivableCollectionRequest {
     ...
     */
    IAgedAccountsReceivableCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IAgedAccountsReceivableCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IAgedAccountsReceivableCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IAgedAccountsReceivableCollectionRequest skip(final int value);
