...
/**
 * The interface for the Android Device Owner Compliance Policy Request Builder.
 */
public interface IAndroidDeviceOwnerCompliancePolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IAndroidDeviceOwnerCompliancePolicyRequest instance
     */
    IAndroidDeviceOwnerCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
