 ...
 */
public class PrinterShareWithReferenceRequest extends BaseWithReferenceRequest<PrinterShare> {
     ...
     */
    public PrinterShareWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public PrinterShareWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterShareWithReferenceRequest expand(@Nonnull final String value) {
