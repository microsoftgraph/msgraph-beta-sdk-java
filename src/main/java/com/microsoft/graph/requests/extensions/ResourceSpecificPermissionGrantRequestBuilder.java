...
public class ResourceSpecificPermissionGrantRequestBuilder extends BaseRequestBuilder implements IResourceSpecificPermissionGrantRequestBuilder {
     ...
     */
    public ResourceSpecificPermissionGrantRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
