...
/**
 * The class for the Group Policy Object File Collection Response.
 */
public class GroupPolicyObjectFileCollectionResponse implements IJsonBackedObject {

    /**
     * The list of GroupPolicyObjectFile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GroupPolicyObjectFile> value;
