...
public class TrustFrameworkPolicyRequest extends BaseRequest implements ITrustFrameworkPolicyRequest {
     ...
     */
    public TrustFrameworkPolicyRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<TrustFrameworkPolicy> callback) {
     ...
     */
    public void delete(final ICallback<TrustFrameworkPolicy> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final TrustFrameworkPolicy sourceTrustFrameworkPolicy, final ICallback<TrustFrameworkPolicy> callback) {
