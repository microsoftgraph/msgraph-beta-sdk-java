...
/**
 * The interface for the Person Award Collection Page.
 */
public interface IPersonAwardCollectionPage extends IBaseCollectionPage<PersonAward, IPersonAwardCollectionRequestBuilder> {
}
