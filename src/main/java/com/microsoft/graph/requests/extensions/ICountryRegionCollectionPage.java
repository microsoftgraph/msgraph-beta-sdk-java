...
/**
 * The interface for the Country Region Collection Page.
 */
public interface ICountryRegionCollectionPage extends IBaseCollectionPage<CountryRegion, ICountryRegionCollectionRequestBuilder> {
}
