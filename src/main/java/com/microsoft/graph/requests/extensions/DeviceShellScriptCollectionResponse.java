...
/**
 * The class for the Device Shell Script Collection Response.
 */
public class DeviceShellScriptCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DeviceShellScript within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DeviceShellScript> value;
