 ...
 */
public class WindowsPhoneXAPRequestBuilder extends BaseRequestBuilder implements IWindowsPhoneXAPRequestBuilder {
     ...
     */
    public WindowsPhoneXAPRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsPhoneXAPRequest instance
     */
    public IWindowsPhoneXAPRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
