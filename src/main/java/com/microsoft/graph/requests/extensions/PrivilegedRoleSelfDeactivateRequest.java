...
public class PrivilegedRoleSelfDeactivateRequest extends BaseRequest implements IPrivilegedRoleSelfDeactivateRequest {
     ...
     */
    public PrivilegedRoleSelfDeactivateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IPrivilegedRoleSelfDeactivateRequest filter(final String value) {
