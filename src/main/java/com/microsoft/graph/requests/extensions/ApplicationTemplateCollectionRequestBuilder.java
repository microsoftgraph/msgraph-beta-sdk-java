...
public class ApplicationTemplateCollectionRequestBuilder extends BaseRequestBuilder implements IApplicationTemplateCollectionRequestBuilder {
     ...
     */
    public ApplicationTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IApplicationTemplateCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IApplicationTemplateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
