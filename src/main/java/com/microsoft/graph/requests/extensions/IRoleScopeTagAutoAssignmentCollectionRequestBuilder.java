...
/**
 * The interface for the Role Scope Tag Auto Assignment Collection Request Builder.
 */
public interface IRoleScopeTagAutoAssignmentCollectionRequestBuilder extends IRequestBuilder {
    ...
    IRoleScopeTagAutoAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
