...
/**
 * The interface for the Skill Proficiency Collection Request.
 */
public interface ISkillProficiencyCollectionRequest {
     ...
     */
    ISkillProficiencyCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISkillProficiencyCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISkillProficiencyCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISkillProficiencyCollectionRequest skip(final int value);
