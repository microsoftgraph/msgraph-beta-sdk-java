...
/**
 * The class for the Privileged Approval Collection Response.
 */
public class PrivilegedApprovalCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrivilegedApproval within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrivilegedApproval> value;
