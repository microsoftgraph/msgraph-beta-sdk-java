...
/**
 * The interface for the Open Shift Change Request Collection Request.
 */
public interface IOpenShiftChangeRequestCollectionRequest {
     ...
     */
    IOpenShiftChangeRequestCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOpenShiftChangeRequestCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOpenShiftChangeRequestCollectionRequest top(final int value);
