...
public interface IAndroidVpnConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidVpnConfigurationRequest instance
     */
    IAndroidVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
