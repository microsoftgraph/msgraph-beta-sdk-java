...
public interface IGroupPolicyPresentationValueDecimalRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupPolicyPresentationValueDecimalRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupPolicyPresentationValueDecimalRequest instance
     */
    IGroupPolicyPresentationValueDecimalRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
