...
import com.microsoft.graph.requests.extensions.IGroupPolicyPresentationValueDecimalRequest;
...
/**
 * The interface for the Group Policy Presentation Value Decimal Request Builder.
 */
public interface IGroupPolicyPresentationValueDecimalRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IGroupPolicyPresentationValueDecimalRequest instance
     */
    IGroupPolicyPresentationValueDecimalRequest buildRequest();
     ...
     * @return the IGroupPolicyPresentationValueDecimalRequest instance
     */
    IGroupPolicyPresentationValueDecimalRequest buildRequest(final java.util.List<? extends Option> requestOptions);
