...
public class UserExperienceAnalyticsMetricHistoryCollectionRequestBuilder extends BaseRequestBuilder implements IUserExperienceAnalyticsMetricHistoryCollectionRequestBuilder {
     ...
     */
    public UserExperienceAnalyticsMetricHistoryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsMetricHistoryCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
