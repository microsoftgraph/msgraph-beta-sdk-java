...
import com.microsoft.graph.requests.extensions.IIdentityUserFlowCollectionPage;
 ...
 */
public class IdentityUserFlowCollectionRequest extends BaseCollectionRequest<IdentityUserFlowCollectionResponse, IIdentityUserFlowCollectionPage> implements IIdentityUserFlowCollectionRequest {
     ...
     */
    public IdentityUserFlowCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IIdentityUserFlowCollectionPage get() throws ClientException {
        final IdentityUserFlowCollectionResponse response = send();
     ...
     */
    public IIdentityUserFlowCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IIdentityUserFlowCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IIdentityUserFlowCollectionRequest top(final int value) {
    ...
    public IIdentityUserFlowCollectionPage buildFromResponse(final IdentityUserFlowCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new IdentityUserFlowCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final IdentityUserFlowCollectionPage page = new IdentityUserFlowCollectionPage(response, builder);
