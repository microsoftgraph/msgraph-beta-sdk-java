...
/**
 * The interface for the Windows Certificate Profile Base Reference Request Builder.
 */
public interface IWindowsCertificateProfileBaseReferenceRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWindowsCertificateProfileBaseReferenceRequest instance
     */
    IWindowsCertificateProfileBaseReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
