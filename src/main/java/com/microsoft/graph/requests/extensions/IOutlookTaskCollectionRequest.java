...
/**
 * The interface for the Outlook Task Collection Request.
 */
public interface IOutlookTaskCollectionRequest {
     ...
     */
    IOutlookTaskCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOutlookTaskCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOutlookTaskCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOutlookTaskCollectionRequest skip(final int value);
