...
public class IosImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IIosImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public IosImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosImportedPFXCertificateProfileRequest instance
     */
    public IIosImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
