...
/**
 * The interface for the Note Request Builder.
 */
public interface INoteRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    INoteRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the INoteRequest instance
     */
    INoteRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
