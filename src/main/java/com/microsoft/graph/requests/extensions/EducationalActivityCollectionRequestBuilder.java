...
public class EducationalActivityCollectionRequestBuilder extends BaseRequestBuilder implements IEducationalActivityCollectionRequestBuilder {
     ...
     */
    public EducationalActivityCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IEducationalActivityCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
