...
/**
 * The class for the Person Certification Collection Response.
 */
public class PersonCertificationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PersonCertification within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PersonCertification> value;
