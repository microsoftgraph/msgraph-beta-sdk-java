 ...
 */
public class DeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder {
    ...
    /**
     * Creates the IDeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequest instance
     */
    public IDeviceManagementReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
