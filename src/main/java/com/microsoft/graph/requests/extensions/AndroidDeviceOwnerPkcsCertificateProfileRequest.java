...
import com.microsoft.graph.requests.extensions.IAndroidDeviceOwnerPkcsCertificateProfileRequest;
import com.microsoft.graph.requests.extensions.AndroidDeviceOwnerPkcsCertificateProfileRequest;
...
public class AndroidDeviceOwnerPkcsCertificateProfileRequest extends BaseRequest implements IAndroidDeviceOwnerPkcsCertificateProfileRequest {
     ...
     */
    public AndroidDeviceOwnerPkcsCertificateProfileRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
