...
/**
 * The class for the Purchase Invoice Collection Response.
 */
public class PurchaseInvoiceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PurchaseInvoice within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PurchaseInvoice> value;
