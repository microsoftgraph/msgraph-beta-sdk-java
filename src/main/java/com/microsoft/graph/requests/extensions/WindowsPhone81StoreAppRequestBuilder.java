 ...
 */
public class WindowsPhone81StoreAppRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81StoreAppRequestBuilder {
     ...
     */
    public WindowsPhone81StoreAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsPhone81StoreAppRequest instance
     */
    public IWindowsPhone81StoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
