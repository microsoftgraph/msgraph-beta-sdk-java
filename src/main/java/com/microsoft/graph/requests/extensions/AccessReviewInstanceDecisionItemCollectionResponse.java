 ...
 */
public class AccessReviewInstanceDecisionItemCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AccessReviewInstanceDecisionItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AccessReviewInstanceDecisionItem> value;
