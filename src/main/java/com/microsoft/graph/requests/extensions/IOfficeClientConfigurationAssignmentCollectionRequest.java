...
/**
 * The interface for the Office Client Configuration Assignment Collection Request.
 */
public interface IOfficeClientConfigurationAssignmentCollectionRequest {
     ...
     */
    IOfficeClientConfigurationAssignmentCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOfficeClientConfigurationAssignmentCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOfficeClientConfigurationAssignmentCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOfficeClientConfigurationAssignmentCollectionRequest skip(final int value);
