...
/**
 * The interface for the Chat Collection With References Page.
 */
public interface IChatCollectionWithReferencesPage extends IBaseCollectionPage<Chat, IChatCollectionWithReferencesRequestBuilder> {
}
