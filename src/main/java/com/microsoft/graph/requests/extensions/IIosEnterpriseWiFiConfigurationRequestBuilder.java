...
/**
 * The interface for the Ios Enterprise Wi Fi Configuration Request Builder.
 */
public interface IIosEnterpriseWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IIosEnterpriseWiFiConfigurationRequest instance
     */
    IIosEnterpriseWiFiConfigurationRequest buildRequest();
     ...
     * @return the IIosEnterpriseWiFiConfigurationRequest instance
     */
    IIosEnterpriseWiFiConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions);
