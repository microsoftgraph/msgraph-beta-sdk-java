...
public class PrivilegedRoleAssignmentRequestCancelRequest extends BaseRequest implements IPrivilegedRoleAssignmentRequestCancelRequest {
     ...
     */
    public PrivilegedRoleAssignmentRequestCancelRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
