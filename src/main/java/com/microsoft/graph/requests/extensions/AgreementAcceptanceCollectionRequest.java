...
public class AgreementAcceptanceCollectionRequest extends BaseCollectionRequest<AgreementAcceptanceCollectionResponse, IAgreementAcceptanceCollectionPage> implements IAgreementAcceptanceCollectionRequest {
     ...
     */
    public AgreementAcceptanceCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public void get(final ICallback<IAgreementAcceptanceCollectionPage> callback) {
