...
/**
 * The interface for the Android For Work Scep Certificate Profile Request Builder.
 */
public interface IAndroidForWorkScepCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
