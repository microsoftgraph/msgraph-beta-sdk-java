 ...
 */
public class PrinterShareReferenceRequestBuilder extends BaseReferenceRequestBuilder<PrinterShare, PrinterShareReferenceRequest> {
     ...
     */
    public PrinterShareReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PrinterShareReferenceRequest.class);
    }
}
