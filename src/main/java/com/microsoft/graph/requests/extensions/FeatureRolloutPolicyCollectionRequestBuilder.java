...
import com.microsoft.graph.requests.extensions.FeatureRolloutPolicyCollectionRequest;
...
public class FeatureRolloutPolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<FeatureRolloutPolicy, FeatureRolloutPolicyRequestBuilder, FeatureRolloutPolicyCollectionResponse, FeatureRolloutPolicyCollectionPage, FeatureRolloutPolicyCollectionRequest> {
     ...
     */
    public FeatureRolloutPolicyCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, FeatureRolloutPolicyRequestBuilder.class, FeatureRolloutPolicyCollectionRequest.class);
    }
