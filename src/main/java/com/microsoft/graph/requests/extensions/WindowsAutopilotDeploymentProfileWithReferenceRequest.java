...
public class WindowsAutopilotDeploymentProfileWithReferenceRequest extends BaseRequest implements IWindowsAutopilotDeploymentProfileWithReferenceRequest {
     ...
     */
    public WindowsAutopilotDeploymentProfileWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
