 ...
 */
public class ExternalItemCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ExternalItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ExternalItem> value;
