...
public class PermissionGrantConditionSetRequest extends BaseRequest implements IPermissionGrantConditionSetRequest {
     ...
     */
    public PermissionGrantConditionSetRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<PermissionGrantConditionSet> callback) {
     ...
     */
    public void delete(final ICallback<PermissionGrantConditionSet> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final PermissionGrantConditionSet sourcePermissionGrantConditionSet, final ICallback<PermissionGrantConditionSet> callback) {
