 ...
 */
public class MacOSCertificateProfileBaseWithReferenceRequest extends BaseRequest implements IMacOSCertificateProfileBaseWithReferenceRequest {
    ...
    public MacOSCertificateProfileBase post(final MacOSCertificateProfileBase newMacOSCertificateProfileBase, final IJsonBackedObject payload) throws ClientException {
