...
/**
 * The class for the Windows Update Catalog Item Collection Response.
 */
public class WindowsUpdateCatalogItemCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WindowsUpdateCatalogItem within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WindowsUpdateCatalogItem> value;
