...
/**
 * The interface for the Sales Quote Line Collection Request.
 */
public interface ISalesQuoteLineCollectionRequest {
     ...
     */
    ISalesQuoteLineCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISalesQuoteLineCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISalesQuoteLineCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISalesQuoteLineCollectionRequest skip(final int value);
