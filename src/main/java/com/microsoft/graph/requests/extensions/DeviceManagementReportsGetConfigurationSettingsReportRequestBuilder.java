 ...
 */
public class DeviceManagementReportsGetConfigurationSettingsReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetConfigurationSettingsReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetConfigurationSettingsReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetConfigurationSettingsReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetConfigurationSettingsReportRequest instance
     */
    public IDeviceManagementReportsGetConfigurationSettingsReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
