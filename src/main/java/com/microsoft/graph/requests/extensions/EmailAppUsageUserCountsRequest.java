...
import com.microsoft.graph.requests.extensions.IEmailAppUsageUserCountsRequest;
import com.microsoft.graph.requests.extensions.EmailAppUsageUserCountsRequest;
...
public class EmailAppUsageUserCountsRequest extends BaseRequest implements IEmailAppUsageUserCountsRequest {
     ...
     */
    public EmailAppUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
