 ...
 */
public class ProvisioningObjectSummaryCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ProvisioningObjectSummary within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ProvisioningObjectSummary> value;
