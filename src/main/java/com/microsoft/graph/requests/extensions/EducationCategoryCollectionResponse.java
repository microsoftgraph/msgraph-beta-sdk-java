 ...
 */
public class EducationCategoryCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EducationCategory within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationCategory> value;
