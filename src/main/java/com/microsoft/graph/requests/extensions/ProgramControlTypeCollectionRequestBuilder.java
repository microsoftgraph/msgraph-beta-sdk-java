 ...
 */
public class ProgramControlTypeCollectionRequestBuilder extends BaseRequestBuilder implements IProgramControlTypeCollectionRequestBuilder {
     ...
     */
    public IProgramControlTypeCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IProgramControlTypeRequestBuilder byId(final String id) {
        return new ProgramControlTypeRequestBuilder(getRequestUrlWithAdditionalSegment(id), getClient(), getOptions());
    }
