...
/**
 * The interface for the Windows Phone81App XRequest Builder.
 */
public interface IWindowsPhone81AppXRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81AppXRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81AppXRequest instance
     */
    IWindowsPhone81AppXRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
