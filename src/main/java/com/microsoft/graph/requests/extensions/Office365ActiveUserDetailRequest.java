...
public class Office365ActiveUserDetailRequest extends BaseRequest implements IOffice365ActiveUserDetailRequest {
     ...
     */
    public Office365ActiveUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Office365ActiveUserDetail> callback) {
     ...
     */
    public void delete(final ICallback<Office365ActiveUserDetail> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Office365ActiveUserDetail sourceOffice365ActiveUserDetail, final ICallback<Office365ActiveUserDetail> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Office365ActiveUserDetail newOffice365ActiveUserDetail, final ICallback<Office365ActiveUserDetail> callback) {
