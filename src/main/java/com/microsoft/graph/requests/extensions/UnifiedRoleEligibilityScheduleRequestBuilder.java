 ...
 */
public class UnifiedRoleEligibilityScheduleRequestBuilder extends BaseRequestBuilder implements IUnifiedRoleEligibilityScheduleRequestBuilder {
     ...
     */
    public UnifiedRoleEligibilityScheduleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IUnifiedRoleEligibilityScheduleRequest instance
     */
    public IUnifiedRoleEligibilityScheduleRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUnifiedRoleEligibilityScheduleRequest instance
     */
    public IUnifiedRoleEligibilityScheduleRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.UnifiedRoleEligibilityScheduleRequest(getRequestUrl(), getClient(), requestOptions);
    }
