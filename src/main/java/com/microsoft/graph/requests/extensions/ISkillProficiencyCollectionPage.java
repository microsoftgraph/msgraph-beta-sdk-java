...
/**
 * The interface for the Skill Proficiency Collection Page.
 */
public interface ISkillProficiencyCollectionPage extends IBaseCollectionPage<SkillProficiency, ISkillProficiencyCollectionRequestBuilder> {
}
