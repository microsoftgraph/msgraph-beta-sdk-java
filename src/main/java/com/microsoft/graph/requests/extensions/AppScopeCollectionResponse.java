...
/**
 * The class for the App Scope Collection Response.
 */
public class AppScopeCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AppScope within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AppScope> value;
