...
import com.microsoft.graph.requests.extensions.IReviewSetQueryRequest;
import com.microsoft.graph.requests.extensions.ReviewSetQueryRequest;
...
public class ReviewSetQueryRequest extends BaseRequest implements IReviewSetQueryRequest {
     ...
     */
    public ReviewSetQueryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
