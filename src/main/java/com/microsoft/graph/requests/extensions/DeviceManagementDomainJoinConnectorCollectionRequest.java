...
import com.microsoft.graph.requests.extensions.IDeviceManagementDomainJoinConnectorCollectionPage;
 ...
 */
public class DeviceManagementDomainJoinConnectorCollectionRequest extends BaseCollectionRequest<DeviceManagementDomainJoinConnectorCollectionResponse, IDeviceManagementDomainJoinConnectorCollectionPage> implements IDeviceManagementDomainJoinConnectorCollectionRequest {
     ...
     */
    public DeviceManagementDomainJoinConnectorCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceManagementDomainJoinConnectorCollectionPage get() throws ClientException {
        final DeviceManagementDomainJoinConnectorCollectionResponse response = send();
     ...
     */
    public IDeviceManagementDomainJoinConnectorCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementDomainJoinConnectorCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementDomainJoinConnectorCollectionRequest top(final int value) {
    ...
    public IDeviceManagementDomainJoinConnectorCollectionPage buildFromResponse(final DeviceManagementDomainJoinConnectorCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DeviceManagementDomainJoinConnectorCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DeviceManagementDomainJoinConnectorCollectionPage page = new DeviceManagementDomainJoinConnectorCollectionPage(response, builder);
