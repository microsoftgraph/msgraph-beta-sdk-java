...
public class ReportRootGetSharePointSiteUsagePagesCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetSharePointSiteUsagePagesCollectionRequestBuilder {
     ...
     */
    public ReportRootGetSharePointSiteUsagePagesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
    ...
    public IReportRootGetSharePointSiteUsagePagesCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IReportRootGetSharePointSiteUsagePagesCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
