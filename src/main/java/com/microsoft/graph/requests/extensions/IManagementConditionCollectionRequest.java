...
/**
 * The interface for the Management Condition Collection Request.
 */
public interface IManagementConditionCollectionRequest {
     ...
     */
    IManagementConditionCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IManagementConditionCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagementConditionCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IManagementConditionCollectionRequest skip(final int value);
