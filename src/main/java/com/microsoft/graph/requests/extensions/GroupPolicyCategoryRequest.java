...
import com.microsoft.graph.requests.extensions.GroupPolicyCategoryRequest;
...
public class GroupPolicyCategoryRequest extends BaseRequest implements IGroupPolicyCategoryRequest {
     ...
     */
    public GroupPolicyCategoryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
