...
public class Windows10NetworkBoundaryConfigurationRequestBuilder extends BaseRequestBuilder implements IWindows10NetworkBoundaryConfigurationRequestBuilder {
     ...
     */
    public Windows10NetworkBoundaryConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindows10NetworkBoundaryConfigurationRequest instance
     */
    public IWindows10NetworkBoundaryConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
