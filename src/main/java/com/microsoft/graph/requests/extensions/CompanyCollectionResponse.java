...
/**
 * The class for the Company Collection Response.
 */
public class CompanyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Company within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Company> value;
