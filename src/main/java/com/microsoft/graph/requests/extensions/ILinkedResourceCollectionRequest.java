 ...
 */
public interface ILinkedResourceCollectionRequest {

    void get(final ICallback<ILinkedResourceCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	ILinkedResourceCollectionRequest skipToken(String skipToken);
}
