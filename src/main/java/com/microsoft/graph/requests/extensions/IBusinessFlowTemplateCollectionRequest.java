...
/**
 * The interface for the Business Flow Template Collection Request.
 */
public interface IBusinessFlowTemplateCollectionRequest {
     ...
     */
    IBusinessFlowTemplateCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IBusinessFlowTemplateCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IBusinessFlowTemplateCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IBusinessFlowTemplateCollectionRequest skip(final int value);
