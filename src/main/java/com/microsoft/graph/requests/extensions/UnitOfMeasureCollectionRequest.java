...
import com.microsoft.graph.requests.extensions.IUnitOfMeasureCollectionPage;
 ...
 */
public class UnitOfMeasureCollectionRequest extends BaseCollectionRequest<UnitOfMeasureCollectionResponse, IUnitOfMeasureCollectionPage> implements IUnitOfMeasureCollectionRequest {
     ...
     */
    public UnitOfMeasureCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IUnitOfMeasureCollectionPage get() throws ClientException {
        final UnitOfMeasureCollectionResponse response = send();
     ...
     */
    public IUnitOfMeasureCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IUnitOfMeasureCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IUnitOfMeasureCollectionRequest top(final int value) {
    ...
    public IUnitOfMeasureCollectionPage buildFromResponse(final UnitOfMeasureCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new UnitOfMeasureCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final UnitOfMeasureCollectionPage page = new UnitOfMeasureCollectionPage(response, builder);
