...
/**
 * The interface for the Windows Autopilot Deployment Profile With Reference Request Builder.
 */
public interface IWindowsAutopilotDeploymentProfileWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindowsAutopilotDeploymentProfileWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsAutopilotDeploymentProfileWithReferenceRequest instance
     */
    IWindowsAutopilotDeploymentProfileWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWindowsAutopilotDeploymentProfileReferenceRequestBuilder reference();
