...
import com.microsoft.graph.requests.extensions.IBookingPersonRequest;
import com.microsoft.graph.requests.extensions.BookingPersonRequest;
...
public class BookingPersonRequest extends BaseRequest implements IBookingPersonRequest {
     ...
     * @param requestOptions the options for this request
     */
    public BookingPersonRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<BookingPerson> callback) {
     ...
     */
    public void delete(final ICallback<BookingPerson> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final BookingPerson sourceBookingPerson, final ICallback<BookingPerson> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final BookingPerson newBookingPerson, final ICallback<BookingPerson> callback) {
