 ...
 */
public class DeviceManagementAutopilotEventRequestBuilder extends BaseRequestBuilder implements IDeviceManagementAutopilotEventRequestBuilder {
     ...
     */
    public DeviceManagementAutopilotEventRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IDeviceManagementAutopilotEventRequest instance
     */
    public IDeviceManagementAutopilotEventRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceManagementAutopilotPolicyStatusDetailCollectionRequestBuilder policyStatusDetails() {
    ...
    public IDeviceManagementAutopilotPolicyStatusDetailRequestBuilder policyStatusDetails(final String id) {
