...
public class DeviceManagementAutopilotEventRequestBuilder extends BaseRequestBuilder implements IDeviceManagementAutopilotEventRequestBuilder {
     ...
     */
    public DeviceManagementAutopilotEventRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
