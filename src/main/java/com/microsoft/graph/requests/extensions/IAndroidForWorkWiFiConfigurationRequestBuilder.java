...
public interface IAndroidForWorkWiFiConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkWiFiConfigurationRequest instance
     */
    IAndroidForWorkWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
