...
/**
 * The interface for the Android Work Profile Pkcs Certificate Profile Request Builder.
 */
public interface IAndroidWorkProfilePkcsCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IAndroidWorkProfilePkcsCertificateProfileRequest instance
     */
    IAndroidWorkProfilePkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
