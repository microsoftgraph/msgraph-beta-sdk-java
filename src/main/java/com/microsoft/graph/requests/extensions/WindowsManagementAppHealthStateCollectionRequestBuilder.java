...
public class WindowsManagementAppHealthStateCollectionRequestBuilder extends BaseRequestBuilder implements IWindowsManagementAppHealthStateCollectionRequestBuilder {
     ...
     */
    public WindowsManagementAppHealthStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IWindowsManagementAppHealthStateCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IWindowsManagementAppHealthStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
