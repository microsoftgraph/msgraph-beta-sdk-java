...
public interface IAndroidWorkProfileScepCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidWorkProfileScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileScepCertificateProfileRequest instance
     */
    IAndroidWorkProfileScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
