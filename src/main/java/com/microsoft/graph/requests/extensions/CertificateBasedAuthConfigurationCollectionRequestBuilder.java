...
public class CertificateBasedAuthConfigurationCollectionRequestBuilder extends BaseRequestBuilder implements ICertificateBasedAuthConfigurationCollectionRequestBuilder {
     ...
     */
    public CertificateBasedAuthConfigurationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ICertificateBasedAuthConfigurationCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ICertificateBasedAuthConfigurationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
