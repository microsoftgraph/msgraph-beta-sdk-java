 ...
 */
public class MobileContainedAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of MobileContainedApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<MobileContainedApp> value;
