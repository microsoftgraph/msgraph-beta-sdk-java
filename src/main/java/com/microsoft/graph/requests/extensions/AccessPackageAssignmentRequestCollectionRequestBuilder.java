 ...
 */
public class AccessPackageAssignmentRequestCollectionRequestBuilder extends BaseRequestBuilder implements IAccessPackageAssignmentRequestCollectionRequestBuilder {
    ...
    public IAccessPackageAssignmentRequestRequestBuilder byId(final String id) {
        return new AccessPackageAssignmentRequestRequestBuilder(getRequestUrlWithAdditionalSegment(id), getClient(), getOptions());
    }



    public IAccessPackageAssignmentRequestMyCollectionRequestBuilder my() {
        return new AccessPackageAssignmentRequestMyCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.My"), getClient(), null);
    }
}
