 ...
 */
public class B2xIdentityUserFlowCollectionResponse implements IJsonBackedObject {

    /**
     * The list of B2xIdentityUserFlow within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<B2xIdentityUserFlow> value;
