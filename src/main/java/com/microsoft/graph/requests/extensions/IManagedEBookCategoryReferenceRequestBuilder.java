...
/**
 * The interface for the Managed EBook Category Reference Request Builder.
 */
public interface IManagedEBookCategoryReferenceRequestBuilder extends IRequestBuilder {
