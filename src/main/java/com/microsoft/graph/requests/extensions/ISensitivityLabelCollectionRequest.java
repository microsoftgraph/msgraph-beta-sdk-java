...
/**
 * The interface for the Sensitivity Label Collection Request.
 */
public interface ISensitivityLabelCollectionRequest {
     ...
     */
    ISensitivityLabelCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISensitivityLabelCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISensitivityLabelCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISensitivityLabelCollectionRequest skip(final int value);
