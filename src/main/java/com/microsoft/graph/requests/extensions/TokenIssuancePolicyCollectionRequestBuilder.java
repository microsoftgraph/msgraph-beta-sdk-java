...
public class TokenIssuancePolicyCollectionRequestBuilder extends BaseRequestBuilder implements ITokenIssuancePolicyCollectionRequestBuilder {
     ...
     */
    public TokenIssuancePolicyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITokenIssuancePolicyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
