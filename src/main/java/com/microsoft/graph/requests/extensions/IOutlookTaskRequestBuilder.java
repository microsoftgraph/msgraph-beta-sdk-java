...
/**
 * The interface for the Outlook Task Request Builder.
 */
public interface IOutlookTaskRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IOutlookTaskRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
    ...
    IOutlookTaskCompleteCollectionRequestBuilder complete();
