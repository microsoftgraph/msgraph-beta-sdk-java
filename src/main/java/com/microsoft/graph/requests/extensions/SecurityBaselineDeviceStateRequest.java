...
public class SecurityBaselineDeviceStateRequest extends BaseRequest implements ISecurityBaselineDeviceStateRequest {
     ...
     */
    public void get(final ICallback<SecurityBaselineDeviceState> callback) {
     ...
     */
    public void delete(final ICallback<SecurityBaselineDeviceState> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final SecurityBaselineDeviceState sourceSecurityBaselineDeviceState, final ICallback<SecurityBaselineDeviceState> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final SecurityBaselineDeviceState newSecurityBaselineDeviceState, final ICallback<SecurityBaselineDeviceState> callback) {
     ...
     * @return the updated request
     */
     public ISecurityBaselineDeviceStateRequest filter(final String value) {
