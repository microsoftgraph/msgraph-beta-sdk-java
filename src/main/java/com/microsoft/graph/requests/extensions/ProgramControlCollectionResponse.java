...
/**
 * The class for the Program Control Collection Response.
 */
public class ProgramControlCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ProgramControl within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ProgramControl> value;
