...
public interface IDeviceManagementDerivedCredentialSettingsRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    DeviceManagementDerivedCredentialSettings put(final DeviceManagementDerivedCredentialSettings newDeviceManagementDerivedCredentialSettings) throws ClientException;
