...
/**
 * The interface for the Device Management Report Schedule Collection Request.
 */
public interface IDeviceManagementReportScheduleCollectionRequest {
     ...
     */
    IDeviceManagementReportScheduleCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IDeviceManagementReportScheduleCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IDeviceManagementReportScheduleCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IDeviceManagementReportScheduleCollectionRequest skip(final int value);
