...
import com.microsoft.graph.requests.extensions.IConnectionOperationCollectionPage;
 ...
 */
public class ConnectionOperationCollectionRequest extends BaseCollectionRequest<ConnectionOperationCollectionResponse, IConnectionOperationCollectionPage> implements IConnectionOperationCollectionRequest {
     ...
     */
    public ConnectionOperationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IConnectionOperationCollectionPage get() throws ClientException {
        final ConnectionOperationCollectionResponse response = send();
     ...
     */
    public IConnectionOperationCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IConnectionOperationCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IConnectionOperationCollectionRequest top(final int value) {
    ...
    public IConnectionOperationCollectionPage buildFromResponse(final ConnectionOperationCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new ConnectionOperationCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final ConnectionOperationCollectionPage page = new ConnectionOperationCollectionPage(response, builder);
