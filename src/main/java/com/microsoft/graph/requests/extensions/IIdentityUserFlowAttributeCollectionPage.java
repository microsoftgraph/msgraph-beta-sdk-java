...
/**
 * The interface for the Identity User Flow Attribute Collection Page.
 */
public interface IIdentityUserFlowAttributeCollectionPage extends IBaseCollectionPage<IdentityUserFlowAttribute, IIdentityUserFlowAttributeCollectionRequestBuilder> {
}
