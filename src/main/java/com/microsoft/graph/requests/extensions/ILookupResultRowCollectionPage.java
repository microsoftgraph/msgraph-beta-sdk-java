...
/**
 * The interface for the Lookup Result Row Collection Page.
 */
public interface ILookupResultRowCollectionPage extends IBaseCollectionPage<LookupResultRow, ILookupResultRowCollectionRequestBuilder> {
}
