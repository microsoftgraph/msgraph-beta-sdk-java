...
/**
 * The interface for the Sensitivity Label Collection Page.
 */
public interface ISensitivityLabelCollectionPage extends IBaseCollectionPage<SensitivityLabel, ISensitivityLabelCollectionRequestBuilder> {
}
