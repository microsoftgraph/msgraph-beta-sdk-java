 ...
 */
public class ReviewSetCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ReviewSet within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ReviewSet> value;
