 ...
 */
public class WindowsPhone81VpnConfigurationRequestBuilder extends BaseRequestBuilder<WindowsPhone81VpnConfiguration> {
     ...
     */
    public WindowsPhone81VpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81VpnConfigurationRequest instance
     */
    @Nonnull
    public WindowsPhone81VpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81VpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @return the WindowsPhone81CertificateProfileBaseWithReferenceRequestBuilder instance
     */
    @Nonnull
    public WindowsPhone81CertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
