 ...
 */
public class CartToClassAssociationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CartToClassAssociation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CartToClassAssociation> value;
