...
public interface ITemporaryAccessPassAuthenticationMethodCollectionRequestBuilder extends IRequestBuilder {
    ...
    ITemporaryAccessPassAuthenticationMethodCollectionRequest buildRequest();

    ITemporaryAccessPassAuthenticationMethodCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
