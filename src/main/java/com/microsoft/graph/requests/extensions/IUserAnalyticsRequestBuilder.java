...
/**
 * The interface for the User Analytics Request Builder.
 */
public interface IUserAnalyticsRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IUserAnalyticsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserAnalyticsRequest instance
     */
    IUserAnalyticsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
