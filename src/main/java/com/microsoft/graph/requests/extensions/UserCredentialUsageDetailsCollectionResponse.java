 ...
 */
public class UserCredentialUsageDetailsCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserCredentialUsageDetails within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserCredentialUsageDetails> value;
