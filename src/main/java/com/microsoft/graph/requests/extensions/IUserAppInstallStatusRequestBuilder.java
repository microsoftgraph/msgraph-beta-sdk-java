...
public interface IUserAppInstallStatusRequestBuilder extends IRequestBuilder {
     ...
     */
    IUserAppInstallStatusRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserAppInstallStatusRequest instance
     */
    IUserAppInstallStatusRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
