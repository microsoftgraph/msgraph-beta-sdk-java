...
public interface IPrivilegedApprovalRequestBuilder extends IRequestBuilder {
     ...
     */
    IPrivilegedApprovalRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPrivilegedApprovalRequest instance
     */
    IPrivilegedApprovalRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
