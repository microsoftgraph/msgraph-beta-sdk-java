...
/**
 * The interface for the Employee Collection Page.
 */
public interface IEmployeeCollectionPage extends IBaseCollectionPage<Employee, IEmployeeCollectionRequestBuilder> {
}
