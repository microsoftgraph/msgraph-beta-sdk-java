...
/**
 * The interface for the Ios Certificate Profile Base Request Builder.
 */
public interface IIosCertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosCertificateProfileBaseRequest instance
     */
    IIosCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
