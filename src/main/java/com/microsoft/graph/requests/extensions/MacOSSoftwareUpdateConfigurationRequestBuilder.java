 ...
 */
public class MacOSSoftwareUpdateConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSSoftwareUpdateConfigurationRequestBuilder {
     ...
     */
    public MacOSSoftwareUpdateConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IMacOSSoftwareUpdateConfigurationRequest instance
     */
    public IMacOSSoftwareUpdateConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSSoftwareUpdateConfigurationRequest instance
     */
    public IMacOSSoftwareUpdateConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
