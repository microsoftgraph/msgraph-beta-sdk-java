...
/**
 * The class for the Mac OSSoftware Update Configuration Request Builder.
 */
public class MacOSSoftwareUpdateConfigurationRequestBuilder extends BaseRequestBuilder<MacOSSoftwareUpdateConfiguration> {

    /**
     * The request builder for the MacOSSoftwareUpdateConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSSoftwareUpdateConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSSoftwareUpdateConfigurationRequest instance
     */
    @Nonnull
    public MacOSSoftwareUpdateConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSSoftwareUpdateConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSSoftwareUpdateConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
