...
/**
 * The interface for the User Experience Analytics App Health OSVersion Performance Collection Request.
 */
public interface IUserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionRequest extends IHttpRequest {
     ...
     */
    IUserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionRequest skip(final int value);
