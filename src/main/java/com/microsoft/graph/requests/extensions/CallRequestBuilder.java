...
import com.microsoft.graph.requests.extensions.AudioRoutingGroupRequestBuilder;
...
public class CallRequestBuilder extends BaseRequestBuilder implements ICallRequestBuilder {
    ...
    public IAudioRoutingGroupCollectionRequestBuilder audioRoutingGroups() {
    ...
    public IAudioRoutingGroupRequestBuilder audioRoutingGroups(final String id) {
    ...
    public ICallPlayPromptRequestBuilder playPrompt(final java.util.List<Prompt> prompts, final Boolean loop, final String clientContext) {
        return new CallPlayPromptRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.playPrompt"), getClient(), null, prompts, loop, clientContext);
    }
    ...
    public ICallRecordRequestBuilder record(final java.util.List<Prompt> prompts, final Boolean bargeInAllowed, final Integer initialSilenceTimeoutInSeconds, final Integer maxSilenceTimeoutInSeconds, final Integer maxRecordDurationInSeconds, final Boolean playBeep, final Boolean streamWhileRecording, final java.util.List<String> stopTones, final String clientContext) {
        return new CallRecordRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.record"), getClient(), null, prompts, bargeInAllowed, initialSilenceTimeoutInSeconds, maxSilenceTimeoutInSeconds, maxRecordDurationInSeconds, playBeep, streamWhileRecording, stopTones, clientContext);
    }
