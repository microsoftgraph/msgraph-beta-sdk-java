...
public class DeviceManagementReportScheduleRequestBuilder extends BaseRequestBuilder implements IDeviceManagementReportScheduleRequestBuilder {
     ...
     */
    public DeviceManagementReportScheduleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
