...
public class DeviceManagementBooleanSettingInstanceRequest extends BaseRequest implements IDeviceManagementBooleanSettingInstanceRequest {
     ...
     */
    public DeviceManagementBooleanSettingInstanceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
