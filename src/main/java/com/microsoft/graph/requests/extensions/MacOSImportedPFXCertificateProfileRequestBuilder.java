...
public class MacOSImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IMacOSImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public MacOSImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSImportedPFXCertificateProfileRequest instance
     */
    public IMacOSImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
