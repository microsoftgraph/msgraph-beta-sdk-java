...
/**
 * The interface for the Team Collection Reference Request.
 */
public interface ITeamCollectionReferenceRequest {

    void post(final Team newTeam, final ICallback<? super Team> callback);

    Team post(final Team newTeam) throws ClientException;

    ITeamCollectionReferenceRequest select(final String value);

    ITeamCollectionReferenceRequest top(final int value);
