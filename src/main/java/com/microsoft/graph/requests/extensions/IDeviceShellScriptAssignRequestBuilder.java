...
/**
 * The interface for the Device Shell Script Assign Request Builder.
 */
public interface IDeviceShellScriptAssignRequestBuilder extends IRequestBuilder {
     ...
     * @return the IDeviceShellScriptAssignRequest instance
     */
    IDeviceShellScriptAssignRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
