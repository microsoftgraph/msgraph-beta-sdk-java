...
/**
 * The interface for the Person Website Collection Page.
 */
public interface IPersonWebsiteCollectionPage extends IBaseCollectionPage<PersonWebsite, IPersonWebsiteCollectionRequestBuilder> {
}
