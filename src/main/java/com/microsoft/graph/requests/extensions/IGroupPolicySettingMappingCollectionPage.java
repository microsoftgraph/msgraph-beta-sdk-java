...
/**
 * The interface for the Group Policy Setting Mapping Collection Page.
 */
public interface IGroupPolicySettingMappingCollectionPage extends IBaseCollectionPage<GroupPolicySettingMapping, IGroupPolicySettingMappingCollectionRequestBuilder> {
}
