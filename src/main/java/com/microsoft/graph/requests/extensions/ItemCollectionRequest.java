...
import com.microsoft.graph.requests.extensions.IItemCollectionPage;
 ...
 */
public class ItemCollectionRequest extends BaseCollectionRequest<ItemCollectionResponse, IItemCollectionPage> implements IItemCollectionRequest {
     ...
     */
    public ItemCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ItemCollectionResponse.class, IItemCollectionPage.class);
    }

    public void get(final ICallback<? super IItemCollectionPage> callback) {
    ...
    public IItemCollectionPage get() throws ClientException {
        final ItemCollectionResponse response = send();
     ...
     * @return the updated request
     */
    public IItemCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IItemCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IItemCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IItemCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IItemCollectionRequest)this;
    }
    public IItemCollectionPage buildFromResponse(final ItemCollectionResponse response) {
