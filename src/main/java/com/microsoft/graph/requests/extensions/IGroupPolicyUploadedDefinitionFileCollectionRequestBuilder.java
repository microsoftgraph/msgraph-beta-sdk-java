...
public interface IGroupPolicyUploadedDefinitionFileCollectionRequestBuilder extends IRequestBuilder {
    ...
    IGroupPolicyUploadedDefinitionFileCollectionRequest buildRequest();

    IGroupPolicyUploadedDefinitionFileCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
