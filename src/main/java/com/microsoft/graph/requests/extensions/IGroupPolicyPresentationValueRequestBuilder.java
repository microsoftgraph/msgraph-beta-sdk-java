...
/**
 * The interface for the Group Policy Presentation Value Request Builder.
 */
public interface IGroupPolicyPresentationValueRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IGroupPolicyPresentationValueRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupPolicyPresentationValueRequest instance
     */
    IGroupPolicyPresentationValueRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
