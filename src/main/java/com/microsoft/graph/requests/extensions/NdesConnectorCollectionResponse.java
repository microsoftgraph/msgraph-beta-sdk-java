...
/**
 * The class for the Ndes Connector Collection Response.
 */
public class NdesConnectorCollectionResponse implements IJsonBackedObject {

    /**
     * The list of NdesConnector within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<NdesConnector> value;
