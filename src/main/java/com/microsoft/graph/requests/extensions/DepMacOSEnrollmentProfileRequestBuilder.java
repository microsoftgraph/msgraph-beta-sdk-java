...
public class DepMacOSEnrollmentProfileRequestBuilder extends BaseRequestBuilder implements IDepMacOSEnrollmentProfileRequestBuilder {
     ...
     */
    public DepMacOSEnrollmentProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IDepMacOSEnrollmentProfileRequest buildRequest() {
