...
/**
 * The interface for the Mac OSLob App Request Builder.
 */
public interface IMacOSLobAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSLobAppRequest instance
     */
    IMacOSLobAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
