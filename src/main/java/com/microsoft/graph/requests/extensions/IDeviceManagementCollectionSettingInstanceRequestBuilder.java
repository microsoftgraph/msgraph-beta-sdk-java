...
public interface IDeviceManagementCollectionSettingInstanceRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceManagementCollectionSettingInstanceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceManagementCollectionSettingInstanceRequest instance
     */
    IDeviceManagementCollectionSettingInstanceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
