 ...
 */
public class AndroidEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidEnterpriseWiFiConfiguration> {
     ...
     */
    public AndroidEnterpriseWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidEnterpriseWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidEnterpriseWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
