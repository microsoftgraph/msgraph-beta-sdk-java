 ...
 */
public class AndroidWorkProfileTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileTrustedRootCertificate> {
     ...
     */
    public AndroidWorkProfileTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileTrustedRootCertificateRequest instance
     */
    @Nonnull
    public AndroidWorkProfileTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
