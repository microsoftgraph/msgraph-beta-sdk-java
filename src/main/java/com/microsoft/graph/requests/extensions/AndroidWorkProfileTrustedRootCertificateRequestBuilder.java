...
public class AndroidWorkProfileTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileTrustedRootCertificateRequestBuilder {
     ...
     */
    public AndroidWorkProfileTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidWorkProfileTrustedRootCertificateRequest instance
     */
    public IAndroidWorkProfileTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
