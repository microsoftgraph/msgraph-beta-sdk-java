 ...
 */
public class AppleExpeditedCheckinConfigurationBaseRequestBuilder extends BaseRequestBuilder implements IAppleExpeditedCheckinConfigurationBaseRequestBuilder {
     ...
     */
    public AppleExpeditedCheckinConfigurationBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAppleExpeditedCheckinConfigurationBaseRequest instance
     */
    public IAppleExpeditedCheckinConfigurationBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
