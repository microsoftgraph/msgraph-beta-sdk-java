...
/**
 * The class for the Apple Expedited Checkin Configuration Base Request Builder.
 */
public class AppleExpeditedCheckinConfigurationBaseRequestBuilder extends BaseRequestBuilder<AppleExpeditedCheckinConfigurationBase> {

    /**
     * The request builder for the AppleExpeditedCheckinConfigurationBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AppleExpeditedCheckinConfigurationBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AppleExpeditedCheckinConfigurationBaseRequest instance
     */
    @Nonnull
    public AppleExpeditedCheckinConfigurationBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AppleExpeditedCheckinConfigurationBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AppleExpeditedCheckinConfigurationBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
