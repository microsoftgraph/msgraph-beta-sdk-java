...
/**
 * The interface for the Payload Response Collection Page.
 */
public interface IPayloadResponseCollectionPage extends IBaseCollectionPage<PayloadResponse, IPayloadResponseCollectionRequestBuilder> {
}
