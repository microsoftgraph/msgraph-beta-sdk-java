...
public class RequestRecordDecisionsRequestBuilder extends BaseActionRequestBuilder implements IRequestRecordDecisionsRequestBuilder {
     ...
     */
    public RequestRecordDecisionsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String reviewResult, final String justification) {
     ...
     * @return the IRequestRecordDecisionsRequest instance
     */
    public IRequestRecordDecisionsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
