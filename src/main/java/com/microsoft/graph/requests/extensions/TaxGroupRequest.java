...
public class TaxGroupRequest extends BaseRequest<TaxGroup> {
     ...
     */
    public void get(@Nonnull final ICallback<? super TaxGroup> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super TaxGroup> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final TaxGroup sourceTaxGroup, @Nonnull final ICallback<? super TaxGroup> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final TaxGroup newTaxGroup, @Nonnull final ICallback<? super TaxGroup> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final TaxGroup newTaxGroup, @Nonnull final ICallback<? super TaxGroup> callback) {
