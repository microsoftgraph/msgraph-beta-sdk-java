...
/**
 * The interface for the Conversation Member Add Collection Request.
 */
public interface IConversationMemberAddCollectionRequest extends IHttpRequest {
     ...
     */
    IConversationMemberAddCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IConversationMemberAddCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IConversationMemberAddCollectionRequest top(final int value);
