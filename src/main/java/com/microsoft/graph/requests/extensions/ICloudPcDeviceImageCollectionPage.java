...
/**
 * The interface for the Cloud Pc Device Image Collection Page.
 */
public interface ICloudPcDeviceImageCollectionPage extends IBaseCollectionPage<CloudPcDeviceImage, ICloudPcDeviceImageCollectionRequestBuilder> {
}
