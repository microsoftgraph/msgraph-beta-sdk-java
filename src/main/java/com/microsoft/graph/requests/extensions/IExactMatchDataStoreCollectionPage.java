...
/**
 * The interface for the Exact Match Data Store Collection Page.
 */
public interface IExactMatchDataStoreCollectionPage extends IBaseCollectionPage<ExactMatchDataStore, IExactMatchDataStoreCollectionRequestBuilder> {
}
