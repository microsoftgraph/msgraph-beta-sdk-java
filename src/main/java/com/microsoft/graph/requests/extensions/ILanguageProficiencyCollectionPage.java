...
/**
 * The interface for the Language Proficiency Collection Page.
 */
public interface ILanguageProficiencyCollectionPage extends IBaseCollectionPage<LanguageProficiency, ILanguageProficiencyCollectionRequestBuilder> {
}
