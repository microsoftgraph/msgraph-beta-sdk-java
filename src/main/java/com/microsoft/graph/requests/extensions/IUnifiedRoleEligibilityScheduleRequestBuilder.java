...
/**
 * The interface for the Unified Role Eligibility Schedule Request Builder.
 */
public interface IUnifiedRoleEligibilityScheduleRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IUnifiedRoleEligibilityScheduleRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUnifiedRoleEligibilityScheduleRequest instance
     */
    IUnifiedRoleEligibilityScheduleRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
