 ...
 */
public class ManagedDeviceGetNonCompliantSettingsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<DeviceCompliancePolicySettingState> value;
