 ...
 */
public class GroupPolicySettingMappingCollectionResponse implements IJsonBackedObject {

    /**
     * The list of GroupPolicySettingMapping within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GroupPolicySettingMapping> value;
