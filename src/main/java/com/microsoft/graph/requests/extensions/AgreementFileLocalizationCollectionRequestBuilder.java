...
public class AgreementFileLocalizationCollectionRequestBuilder extends BaseRequestBuilder implements IAgreementFileLocalizationCollectionRequestBuilder {
     ...
     */
    public AgreementFileLocalizationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
