...
/**
 * The interface for the Windows Managed Device Request.
 */
public interface IWindowsManagedDeviceRequest extends IHttpRequest {
     ...
     */
    WindowsManagedDevice get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    WindowsManagedDevice patch(final WindowsManagedDevice sourceWindowsManagedDevice) throws ClientException;
     ...
     */
    IWindowsManagedDeviceRequest select(final String value);
     ...
     * @return the updated request
     */
    IWindowsManagedDeviceRequest expand(final String value);
