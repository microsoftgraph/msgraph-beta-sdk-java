...
/**
 * The interface for the Ios Edu Device Configuration Request Builder.
 */
public interface IIosEduDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosEduDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosEduDeviceConfigurationRequest instance
     */
    IIosEduDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
