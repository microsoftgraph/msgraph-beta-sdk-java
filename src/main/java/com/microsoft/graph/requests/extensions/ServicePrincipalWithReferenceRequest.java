...
public class ServicePrincipalWithReferenceRequest extends BaseRequest implements IServicePrincipalWithReferenceRequest {
    ...
    public void post(final ServicePrincipal newServicePrincipal, final IJsonBackedObject payload, final ICallback<ServicePrincipal> callback) {
     ...
     * @return the updated request
     */
    public IServicePrincipalWithReferenceRequest filter(final String value) {
