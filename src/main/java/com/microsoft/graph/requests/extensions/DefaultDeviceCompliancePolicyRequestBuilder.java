...
/**
 * The class for the Default Device Compliance Policy Request Builder.
 */
public class DefaultDeviceCompliancePolicyRequestBuilder extends BaseRequestBuilder<DefaultDeviceCompliancePolicy> {

    /**
     * The request builder for the DefaultDeviceCompliancePolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public DefaultDeviceCompliancePolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the DefaultDeviceCompliancePolicyRequest instance
     */
    @Nonnull
    public DefaultDeviceCompliancePolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DefaultDeviceCompliancePolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.DefaultDeviceCompliancePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
