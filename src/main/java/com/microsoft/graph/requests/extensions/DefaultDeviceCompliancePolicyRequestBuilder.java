 ...
 */
public class DefaultDeviceCompliancePolicyRequestBuilder extends BaseRequestBuilder implements IDefaultDeviceCompliancePolicyRequestBuilder {
     ...
     */
    public DefaultDeviceCompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IDefaultDeviceCompliancePolicyRequest instance
     */
    public IDefaultDeviceCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
