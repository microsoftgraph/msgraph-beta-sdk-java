 ...
 */
public class MacOSLobAppRequestBuilder extends BaseRequestBuilder implements IMacOSLobAppRequestBuilder {
     ...
     */
    public MacOSLobAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IMacOSLobAppRequest instance
     */
    public IMacOSLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSLobAppRequest instance
     */
    public IMacOSLobAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSLobAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
