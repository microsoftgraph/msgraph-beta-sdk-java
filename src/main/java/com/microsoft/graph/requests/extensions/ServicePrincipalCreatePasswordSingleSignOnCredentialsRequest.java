...
public class ServicePrincipalCreatePasswordSingleSignOnCredentialsRequest extends BaseRequest<PasswordSingleSignOnCredentialSet> {
    ...
    @Nullable
    protected ServicePrincipalCreatePasswordSingleSignOnCredentialsParameterSet body;
    /**
