...
public class IdentityProviderAvailableProviderTypesCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IIdentityProviderAvailableProviderTypesCollectionRequestBuilder {
     ...
     */
    public IdentityProviderAvailableProviderTypesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IIdentityProviderAvailableProviderTypesCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
