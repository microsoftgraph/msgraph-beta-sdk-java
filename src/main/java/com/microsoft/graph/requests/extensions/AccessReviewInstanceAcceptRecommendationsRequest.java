 ...
 */
public class AccessReviewInstanceAcceptRecommendationsRequest extends BaseRequest implements IAccessReviewInstanceAcceptRecommendationsRequest {
     ...
     */
    public AccessReviewInstanceAcceptRecommendationsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
