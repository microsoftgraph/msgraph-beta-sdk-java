 ...
 */
public class ReportRootGetOffice365GroupsActivityDetailCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<Office365GroupsActivityDetail> value;
