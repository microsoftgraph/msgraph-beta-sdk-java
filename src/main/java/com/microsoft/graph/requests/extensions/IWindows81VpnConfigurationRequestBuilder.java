...
/**
 * The interface for the Windows81Vpn Configuration Request Builder.
 */
public interface IWindows81VpnConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows81VpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
