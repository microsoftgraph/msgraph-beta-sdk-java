...
/**
 * The interface for the Person Annual Event Collection Page.
 */
public interface IPersonAnnualEventCollectionPage extends IBaseCollectionPage<PersonAnnualEvent, IPersonAnnualEventCollectionRequestBuilder> {
}
