 ...
 */
public class ExternalConnectionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ExternalConnection within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ExternalConnection> value;
