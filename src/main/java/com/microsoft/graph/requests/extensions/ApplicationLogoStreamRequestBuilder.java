...
public class ApplicationLogoStreamRequestBuilder extends BaseRequestBuilder implements IApplicationLogoStreamRequestBuilder {
     ...
     */
    public ApplicationLogoStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IApplicationLogoStreamRequest instance
     */
    public IApplicationLogoStreamRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
