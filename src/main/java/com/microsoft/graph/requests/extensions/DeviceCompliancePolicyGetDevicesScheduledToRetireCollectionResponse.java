 ...
 */
public class DeviceCompliancePolicyGetDevicesScheduledToRetireCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<RetireScheduledManagedDevice> value;
