...
/**
 * The interface for the Vendor Collection Request.
 */
public interface IVendorCollectionRequest {
     ...
     */
    IVendorCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IVendorCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IVendorCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IVendorCollectionRequest skip(final int value);
