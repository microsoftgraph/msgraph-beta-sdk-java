...
public class Windows10GeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows10GeneralConfiguration> {
     ...
     */
    @Nonnull
    public WindowsPrivacyDataAccessControlItemCollectionRequestBuilder privacyAccessControls() {
        return new WindowsPrivacyDataAccessControlItemCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("privacyAccessControls"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public WindowsPrivacyDataAccessControlItemRequestBuilder privacyAccessControls(@Nonnull final String id) {
