 ...
 */
public interface IAccessPackageCollectionRequest {

    void get(final ICallback<IAccessPackageCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	IAccessPackageCollectionRequest skipToken(String skipToken);
}
