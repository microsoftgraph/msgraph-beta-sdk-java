...
public interface IAndroidForWorkImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkImportedPFXCertificateProfileRequest instance
     */
    IAndroidForWorkImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
