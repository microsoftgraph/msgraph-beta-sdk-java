...
import com.microsoft.graph.requests.extensions.DeviceCompliancePolicyPolicySetItemRequest;
...
public class DeviceCompliancePolicyPolicySetItemRequest extends BaseRequest implements IDeviceCompliancePolicyPolicySetItemRequest {
     ...
     */
    public DeviceCompliancePolicyPolicySetItemRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<DeviceCompliancePolicyPolicySetItem> callback) {
     ...
     */
    public void delete(final ICallback<DeviceCompliancePolicyPolicySetItem> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final DeviceCompliancePolicyPolicySetItem sourceDeviceCompliancePolicyPolicySetItem, final ICallback<DeviceCompliancePolicyPolicySetItem> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final DeviceCompliancePolicyPolicySetItem newDeviceCompliancePolicyPolicySetItem, final ICallback<DeviceCompliancePolicyPolicySetItem> callback) {
