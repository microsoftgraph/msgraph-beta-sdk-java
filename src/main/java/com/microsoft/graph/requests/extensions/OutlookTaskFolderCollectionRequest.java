...
import com.microsoft.graph.requests.extensions.IOutlookTaskFolderCollectionPage;
...
public class OutlookTaskFolderCollectionRequest extends BaseCollectionRequest<OutlookTaskFolderCollectionResponse, IOutlookTaskFolderCollectionPage> implements IOutlookTaskFolderCollectionRequest {
     ...
     */
    public OutlookTaskFolderCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OutlookTaskFolderCollectionResponse.class, IOutlookTaskFolderCollectionPage.class);
    }

    public void get(final ICallback<? super IOutlookTaskFolderCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IOutlookTaskFolderCollectionRequest orderBy(final String value) {
