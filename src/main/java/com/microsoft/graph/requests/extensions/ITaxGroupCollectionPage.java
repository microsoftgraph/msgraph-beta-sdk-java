...
/**
 * The interface for the Tax Group Collection Page.
 */
public interface ITaxGroupCollectionPage extends IBaseCollectionPage<TaxGroup, ITaxGroupCollectionRequestBuilder> {
}
