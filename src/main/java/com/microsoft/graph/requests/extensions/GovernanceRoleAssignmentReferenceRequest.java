 ...
 */
public class GovernanceRoleAssignmentReferenceRequest extends BaseReferenceRequest<GovernanceRoleAssignment> {
     ...
     */
    public GovernanceRoleAssignmentReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GovernanceRoleAssignmentReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public GovernanceRoleAssignmentReferenceRequest expand(@Nonnull final String value) {
