...
public class WindowsInformationProtectionWipeActionRequest extends BaseRequest implements IWindowsInformationProtectionWipeActionRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final WindowsInformationProtectionWipeAction newWindowsInformationProtectionWipeAction, final ICallback<WindowsInformationProtectionWipeAction> callback) {
     ...
     * @return the updated request
     */
     public IWindowsInformationProtectionWipeActionRequest filter(final String value) {
