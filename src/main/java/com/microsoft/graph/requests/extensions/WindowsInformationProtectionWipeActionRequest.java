...
public class WindowsInformationProtectionWipeActionRequest extends BaseRequest implements IWindowsInformationProtectionWipeActionRequest {
     ...
     */
    public WindowsInformationProtectionWipeActionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<WindowsInformationProtectionWipeAction> callback) {
     ...
     */
    public void delete(final ICallback<WindowsInformationProtectionWipeAction> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final WindowsInformationProtectionWipeAction sourceWindowsInformationProtectionWipeAction, final ICallback<WindowsInformationProtectionWipeAction> callback) {
