...
import com.microsoft.graph.requests.extensions.IOrganizationalBrandingCollectionPage;
...
/**
 * The class for the Organizational Branding Collection Request.
 */
public class OrganizationalBrandingCollectionRequest extends BaseCollectionRequest<OrganizationalBrandingCollectionResponse, IOrganizationalBrandingCollectionPage> implements IOrganizationalBrandingCollectionRequest {
     ...
     */
    public OrganizationalBrandingCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OrganizationalBrandingCollectionResponse.class, IOrganizationalBrandingCollectionPage.class);
    }

    public void get(final ICallback<IOrganizationalBrandingCollectionPage> callback) {
    ...
    public IOrganizationalBrandingCollectionPage get() throws ClientException {
        final OrganizationalBrandingCollectionResponse response = send();
     ...
     */
    public IOrganizationalBrandingCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IOrganizationalBrandingCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IOrganizationalBrandingCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IOrganizationalBrandingCollectionRequest top(final int value) {
    ...
    public IOrganizationalBrandingCollectionPage buildFromResponse(final OrganizationalBrandingCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new OrganizationalBrandingCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final OrganizationalBrandingCollectionPage page = new OrganizationalBrandingCollectionPage(response, builder);
