...
public class OutlookTaskGroupCollectionRequest extends BaseCollectionRequest<OutlookTaskGroupCollectionResponse, IOutlookTaskGroupCollectionPage> implements IOutlookTaskGroupCollectionRequest {
     ...
     */
    public OutlookTaskGroupCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
