...
public class MessageUnsubscribeRequestBuilder extends BaseActionRequestBuilder implements IMessageUnsubscribeRequestBuilder {
     ...
     */
    public MessageUnsubscribeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IMessageUnsubscribeRequest instance
     */
    public IMessageUnsubscribeRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
