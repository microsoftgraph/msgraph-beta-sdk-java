 ...
 */
public class OfferShiftRequestCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OfferShiftRequest within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OfferShiftRequest> value;
