...
/**
 * The class for the Print Usage Summary By Printer Collection Response.
 */
public class PrintUsageSummaryByPrinterCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintUsageSummaryByPrinter within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintUsageSummaryByPrinter> value;
