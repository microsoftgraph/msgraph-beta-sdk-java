 ...
 */
public class PrivilegedRoleAssignmentCollectionReferenceRequest extends BaseCollectionRequest<PrivilegedRoleAssignmentCollectionResponse, IPrivilegedRoleAssignmentCollectionPage> implements IPrivilegedRoleAssignmentCollectionReferenceRequest {
     ...
     */
    public PrivilegedRoleAssignmentCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
