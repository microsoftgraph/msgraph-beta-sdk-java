...
public interface IDeviceManagementExportJobCollectionRequestBuilder extends IRequestBuilder {
    ...
    IDeviceManagementExportJobCollectionRequest buildRequest();

    IDeviceManagementExportJobCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
