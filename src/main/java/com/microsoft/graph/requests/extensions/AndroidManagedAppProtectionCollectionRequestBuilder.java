...
public class AndroidManagedAppProtectionCollectionRequestBuilder extends BaseRequestBuilder implements IAndroidManagedAppProtectionCollectionRequestBuilder {
    ...
    public IAndroidManagedAppProtectionHasPayloadLinksCollectionRequestBuilder hasPayloadLinks(final java.util.List<String> payloadIds) {
        return new AndroidManagedAppProtectionHasPayloadLinksCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.hasPayloadLinks"), getClient(), null, payloadIds);
    }
}
