...
public interface IDeviceManagementAutopilotEventRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceManagementAutopilotEventRequest buildRequest();
     ...
     * @return the IDeviceManagementAutopilotEventRequest instance
     */
    IDeviceManagementAutopilotEventRequest buildRequest(final java.util.List<? extends Option> requestOptions);
