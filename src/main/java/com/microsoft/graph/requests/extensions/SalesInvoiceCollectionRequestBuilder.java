...
public class SalesInvoiceCollectionRequestBuilder extends BaseRequestBuilder implements ISalesInvoiceCollectionRequestBuilder {
     ...
     */
    public SalesInvoiceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ISalesInvoiceCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
