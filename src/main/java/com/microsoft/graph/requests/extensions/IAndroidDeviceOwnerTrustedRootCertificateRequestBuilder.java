...
import com.microsoft.graph.requests.extensions.IAndroidDeviceOwnerTrustedRootCertificateRequest;
...
/**
 * The interface for the Android Device Owner Trusted Root Certificate Request Builder.
 */
public interface IAndroidDeviceOwnerTrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IAndroidDeviceOwnerTrustedRootCertificateRequest instance
     */
    IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest();
     ...
     * @return the IAndroidDeviceOwnerTrustedRootCertificateRequest instance
     */
    IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(final java.util.List<? extends Option> requestOptions);
