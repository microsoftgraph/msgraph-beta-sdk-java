...
public interface IAndroidDeviceOwnerTrustedRootCertificateRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerTrustedRootCertificateRequest instance
     */
    IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
