 ...
 */
public class AndroidDeviceOwnerWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerWiFiConfigurationRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IAndroidDeviceOwnerWiFiConfigurationRequest instance
     */
    public IAndroidDeviceOwnerWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerWiFiConfigurationRequest instance
     */
    public IAndroidDeviceOwnerWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidDeviceOwnerWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
