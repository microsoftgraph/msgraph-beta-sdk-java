...
/**
 * The interface for the Comms Application Request Builder.
 */
public interface ICommsApplicationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ICommsApplicationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ICommsApplicationRequest instance
     */
    ICommsApplicationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
