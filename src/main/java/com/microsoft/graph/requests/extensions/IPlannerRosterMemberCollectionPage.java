...
/**
 * The interface for the Planner Roster Member Collection Page.
 */
public interface IPlannerRosterMemberCollectionPage extends IBaseCollectionPage<PlannerRosterMember, IPlannerRosterMemberCollectionRequestBuilder> {
}
