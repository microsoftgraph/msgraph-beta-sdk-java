...
/**
 * The interface for the Program Control Type Collection Page.
 */
public interface IProgramControlTypeCollectionPage extends IBaseCollectionPage<ProgramControlType, IProgramControlTypeCollectionRequestBuilder> {
}
