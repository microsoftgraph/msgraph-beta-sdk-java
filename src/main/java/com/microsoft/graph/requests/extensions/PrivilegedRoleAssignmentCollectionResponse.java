...
/**
 * The class for the Privileged Role Assignment Collection Response.
 */
public class PrivilegedRoleAssignmentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrivilegedRoleAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrivilegedRoleAssignment> value;
