...
/**
 * The interface for the Sales Credit Memo Collection Request.
 */
public interface ISalesCreditMemoCollectionRequest {
     ...
     */
    ISalesCreditMemoCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISalesCreditMemoCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISalesCreditMemoCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISalesCreditMemoCollectionRequest skip(final int value);
