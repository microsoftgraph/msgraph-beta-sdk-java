...
public interface IAndroidWorkProfileCertificateProfileBaseRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidWorkProfileCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileCertificateProfileBaseRequest instance
     */
    IAndroidWorkProfileCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
