...
public class AndroidForWorkTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkTrustedRootCertificateRequestBuilder {
     ...
     */
    public AndroidForWorkTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidForWorkTrustedRootCertificateRequest instance
     */
    public IAndroidForWorkTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
