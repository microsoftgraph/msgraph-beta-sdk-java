 ...
 */
public class GroupPolicyConfigurationAssignCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<GroupPolicyConfigurationAssignment> value;
