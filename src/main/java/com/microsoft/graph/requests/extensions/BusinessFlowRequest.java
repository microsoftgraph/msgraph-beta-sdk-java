 ...
 */
public class BusinessFlowRequest extends BaseRequest implements IBusinessFlowRequest {
     ...
     */
    public BusinessFlowRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public BusinessFlow patch(final BusinessFlow sourceBusinessFlow) throws ClientException {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public BusinessFlow put(final BusinessFlow newBusinessFlow) throws ClientException {
     ...
     */
     public IBusinessFlowRequest select(final String value) {
