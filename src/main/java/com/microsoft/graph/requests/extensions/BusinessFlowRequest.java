...
public class BusinessFlowRequest extends BaseRequest<BusinessFlow> {
     ...
     */
    public void get(@Nonnull final ICallback<? super BusinessFlow> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super BusinessFlow> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final BusinessFlow sourceBusinessFlow, @Nonnull final ICallback<? super BusinessFlow> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final BusinessFlow newBusinessFlow, @Nonnull final ICallback<? super BusinessFlow> callback) {
