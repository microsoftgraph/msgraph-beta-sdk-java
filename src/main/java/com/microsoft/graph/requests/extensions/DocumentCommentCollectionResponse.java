...
/**
 * The class for the Document Comment Collection Response.
 */
public class DocumentCommentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DocumentComment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DocumentComment> value;
