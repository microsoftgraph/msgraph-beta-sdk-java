...
public class Windows10PFXImportCertificateProfileRequest extends BaseRequest implements IWindows10PFXImportCertificateProfileRequest {
     ...
     */
    public Windows10PFXImportCertificateProfileRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Windows10PFXImportCertificateProfile> callback) {
     ...
     */
    public void delete(final ICallback<Windows10PFXImportCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Windows10PFXImportCertificateProfile sourceWindows10PFXImportCertificateProfile, final ICallback<Windows10PFXImportCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Windows10PFXImportCertificateProfile newWindows10PFXImportCertificateProfile, final ICallback<Windows10PFXImportCertificateProfile> callback) {
