...
public class Windows10PFXImportCertificateProfileRequest extends BaseRequest implements IWindows10PFXImportCertificateProfileRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final Windows10PFXImportCertificateProfile newWindows10PFXImportCertificateProfile, final ICallback<Windows10PFXImportCertificateProfile> callback) {
     ...
     * @return the updated request
     */
     public IWindows10PFXImportCertificateProfileRequest filter(final String value) {
