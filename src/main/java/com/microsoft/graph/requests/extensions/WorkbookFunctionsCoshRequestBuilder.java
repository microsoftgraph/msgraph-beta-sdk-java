...
public class WorkbookFunctionsCoshRequestBuilder extends BaseActionRequestBuilder implements IWorkbookFunctionsCoshRequestBuilder {
     ...
     */
    public WorkbookFunctionsCoshRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.google.gson.JsonElement number) {
