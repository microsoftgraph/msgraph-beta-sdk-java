...
/**
 * The interface for the Published Resource Collection Page.
 */
public interface IPublishedResourceCollectionPage extends IBaseCollectionPage<PublishedResource, IPublishedResourceCollectionRequestBuilder> {
}
