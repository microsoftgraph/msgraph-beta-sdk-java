...
/**
 * The interface for the Security Configuration Task Request.
 */
public interface ISecurityConfigurationTaskRequest extends IHttpRequest {
     ...
     */
    SecurityConfigurationTask get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    SecurityConfigurationTask patch(final SecurityConfigurationTask sourceSecurityConfigurationTask) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    SecurityConfigurationTask post(final SecurityConfigurationTask newSecurityConfigurationTask) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    SecurityConfigurationTask put(final SecurityConfigurationTask newSecurityConfigurationTask) throws ClientException;
     ...
     */
    ISecurityConfigurationTaskRequest select(final String value);
     ...
     * @return the updated request
     */
    ISecurityConfigurationTaskRequest expand(final String value);
