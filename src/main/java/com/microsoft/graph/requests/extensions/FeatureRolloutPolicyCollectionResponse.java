 ...
 */
public class FeatureRolloutPolicyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of FeatureRolloutPolicy within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<FeatureRolloutPolicy> value;
