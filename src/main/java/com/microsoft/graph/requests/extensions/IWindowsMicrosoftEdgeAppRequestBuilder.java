...
/**
 * The interface for the Windows Microsoft Edge App Request Builder.
 */
public interface IWindowsMicrosoftEdgeAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IWindowsMicrosoftEdgeAppRequest instance
     */
    IWindowsMicrosoftEdgeAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsMicrosoftEdgeAppRequest instance
     */
    IWindowsMicrosoftEdgeAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
