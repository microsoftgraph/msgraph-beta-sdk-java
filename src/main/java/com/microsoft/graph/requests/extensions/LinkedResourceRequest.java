...
public class LinkedResourceRequest extends BaseRequest implements ILinkedResourceRequest {
     ...
     */
    public void get(final ICallback<LinkedResource> callback) {
     ...
     */
    public void delete(final ICallback<LinkedResource> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final LinkedResource sourceLinkedResource, final ICallback<LinkedResource> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final LinkedResource newLinkedResource, final ICallback<LinkedResource> callback) {
     ...
     * @return the updated request
     */
     public ILinkedResourceRequest filter(final String value) {
