 ...
 */
public class ApplicationTemplateCollectionRequest extends BaseCollectionRequest<ApplicationTemplateCollectionResponse, IApplicationTemplateCollectionPage> implements IApplicationTemplateCollectionRequest {
     ...
     */
    public ApplicationTemplateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public void get(final ICallback<IApplicationTemplateCollectionPage> callback) {
    ...
    public IApplicationTemplateCollectionPage get() throws ClientException {
        final ApplicationTemplateCollectionResponse response = send();
     ...
     */
    public IApplicationTemplateCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IApplicationTemplateCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IApplicationTemplateCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IApplicationTemplateCollectionRequest top(final int value) {
    ...
    public IApplicationTemplateCollectionPage buildFromResponse(final ApplicationTemplateCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new ApplicationTemplateCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final ApplicationTemplateCollectionPage page = new ApplicationTemplateCollectionPage(response, builder);
