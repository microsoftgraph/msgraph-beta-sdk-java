...
/**
 * The interface for the Connector Request Builder.
 */
public interface IConnectorRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IConnectorRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
