...
public class MobileAppInstallStatusCollectionRequest extends BaseCollectionRequest<MobileAppInstallStatusCollectionResponse, IMobileAppInstallStatusCollectionPage> implements IMobileAppInstallStatusCollectionRequest {
     ...
     */
    public MobileAppInstallStatusCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
