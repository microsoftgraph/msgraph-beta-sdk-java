...
public class IosVppAppRevokeAllLicensesRequestBuilder extends BaseActionRequestBuilder implements IIosVppAppRevokeAllLicensesRequestBuilder {
     ...
     */
    public IosVppAppRevokeAllLicensesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Boolean notifyManagedDevices) {
     ...
     * @return the IIosVppAppRevokeAllLicensesRequest instance
     */
    public IIosVppAppRevokeAllLicensesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
