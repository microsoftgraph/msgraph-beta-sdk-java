...
public class GroupPolicyUploadedDefinitionFileRemoveLanguageFilesRequest extends BaseRequest<Void> {
    ...
    @Nullable
    protected GroupPolicyUploadedDefinitionFileRemoveLanguageFilesParameterSet body;
    /**
