...
public interface IAndroidDeviceOwnerCertificateProfileBaseRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidDeviceOwnerCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerCertificateProfileBaseRequest instance
     */
    IAndroidDeviceOwnerCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
