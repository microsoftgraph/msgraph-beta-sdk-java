 ...
 */
public class DeviceCompliancePolicyReferenceRequest extends BaseReferenceRequest<DeviceCompliancePolicy> {
     ...
     */
    public DeviceCompliancePolicyReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceCompliancePolicyReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceCompliancePolicyReferenceRequest expand(@Nonnull final String value) {
