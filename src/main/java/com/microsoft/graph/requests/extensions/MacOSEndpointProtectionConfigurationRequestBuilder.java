...
public class MacOSEndpointProtectionConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSEndpointProtectionConfigurationRequestBuilder {
     ...
     */
    public MacOSEndpointProtectionConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSEndpointProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSEndpointProtectionConfigurationRequest instance
     */
    public IMacOSEndpointProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
