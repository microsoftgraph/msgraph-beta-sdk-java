 ...
 */
public class MacOSEndpointProtectionConfigurationRequestBuilder extends BaseRequestBuilder<MacOSEndpointProtectionConfiguration> {
     ...
     */
    public MacOSEndpointProtectionConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSEndpointProtectionConfigurationRequest instance
     */
    @Nonnull
    public MacOSEndpointProtectionConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSEndpointProtectionConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSEndpointProtectionConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
