 ...
 */
public class DeviceManagementReportsGetPolicyNonComplianceReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetPolicyNonComplianceReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetPolicyNonComplianceReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetPolicyNonComplianceReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetPolicyNonComplianceReportRequest instance
     */
    public IDeviceManagementReportsGetPolicyNonComplianceReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
