...
public class UserExperienceAnalyticsScoreHistoryRequestBuilder extends BaseRequestBuilder implements IUserExperienceAnalyticsScoreHistoryRequestBuilder {
     ...
     */
    public UserExperienceAnalyticsScoreHistoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
