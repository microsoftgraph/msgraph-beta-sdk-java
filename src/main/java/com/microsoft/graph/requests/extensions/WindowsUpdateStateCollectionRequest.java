...
import com.microsoft.graph.requests.extensions.IWindowsUpdateStateCollectionPage;
...
public class WindowsUpdateStateCollectionRequest extends BaseCollectionRequest<WindowsUpdateStateCollectionResponse, IWindowsUpdateStateCollectionPage> implements IWindowsUpdateStateCollectionRequest {
     ...
     */
    public WindowsUpdateStateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
