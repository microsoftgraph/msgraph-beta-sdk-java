...
/**
 * The interface for the Report Root Collection Page.
 */
public interface IReportRootCollectionPage extends IBaseCollectionPage<ReportRoot, IReportRootCollectionRequestBuilder> {
}
