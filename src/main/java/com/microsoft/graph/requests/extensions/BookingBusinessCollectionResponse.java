 ...
 */
public class BookingBusinessCollectionResponse implements IJsonBackedObject {

    /**
     * The list of BookingBusiness within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<BookingBusiness> value;
