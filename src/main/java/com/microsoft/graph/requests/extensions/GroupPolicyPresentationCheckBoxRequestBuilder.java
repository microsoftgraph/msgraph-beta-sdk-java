 ...
 */
public class GroupPolicyPresentationCheckBoxRequestBuilder extends BaseRequestBuilder implements IGroupPolicyPresentationCheckBoxRequestBuilder {
     ...
     */
    public GroupPolicyPresentationCheckBoxRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IGroupPolicyPresentationCheckBoxRequest instance
     */
    public IGroupPolicyPresentationCheckBoxRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
