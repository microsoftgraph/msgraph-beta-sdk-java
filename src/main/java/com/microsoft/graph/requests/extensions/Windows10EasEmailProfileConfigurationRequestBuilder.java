...
public class Windows10EasEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder implements IWindows10EasEmailProfileConfigurationRequestBuilder {
     ...
     */
    public Windows10EasEmailProfileConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindows10EasEmailProfileConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindows10EasEmailProfileConfigurationRequest instance
     */
    public IWindows10EasEmailProfileConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
