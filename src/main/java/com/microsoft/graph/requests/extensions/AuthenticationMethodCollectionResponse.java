 ...
 */
public class AuthenticationMethodCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AuthenticationMethod within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AuthenticationMethod> value;
