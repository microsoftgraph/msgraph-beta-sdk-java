...
public interface IAndroidForWorkTrustedRootCertificateRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkTrustedRootCertificateRequest instance
     */
    IAndroidForWorkTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
