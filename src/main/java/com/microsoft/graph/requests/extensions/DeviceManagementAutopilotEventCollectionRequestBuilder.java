...
public class DeviceManagementAutopilotEventCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementAutopilotEventCollectionRequestBuilder {
     ...
     */
    public DeviceManagementAutopilotEventCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceManagementAutopilotEventCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
