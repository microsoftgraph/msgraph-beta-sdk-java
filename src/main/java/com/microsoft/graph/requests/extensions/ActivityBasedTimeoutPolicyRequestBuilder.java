...
public class ActivityBasedTimeoutPolicyRequestBuilder extends BaseRequestBuilder implements IActivityBasedTimeoutPolicyRequestBuilder {
     ...
     */
    public ActivityBasedTimeoutPolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IActivityBasedTimeoutPolicyRequest instance
     */
    public IActivityBasedTimeoutPolicyRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
