...
/**
 * The interface for the Trust Framework Policy Collection Request.
 */
public interface ITrustFrameworkPolicyCollectionRequest {
     ...
     */
    ITrustFrameworkPolicyCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITrustFrameworkPolicyCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITrustFrameworkPolicyCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ITrustFrameworkPolicyCollectionRequest skip(final int value);
