...
/**
 * The interface for the Outlook Task Collection Page.
 */
public interface IOutlookTaskCollectionPage extends IBaseCollectionPage<OutlookTask, IOutlookTaskCollectionRequestBuilder> {
}
