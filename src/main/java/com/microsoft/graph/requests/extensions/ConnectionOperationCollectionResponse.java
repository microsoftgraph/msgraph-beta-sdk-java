 ...
 */
public class ConnectionOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ConnectionOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ConnectionOperation> value;
