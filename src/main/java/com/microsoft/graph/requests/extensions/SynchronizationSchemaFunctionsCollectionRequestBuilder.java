...
public class SynchronizationSchemaFunctionsCollectionRequestBuilder extends BaseFunctionRequestBuilder implements ISynchronizationSchemaFunctionsCollectionRequestBuilder {
     ...
     */
    public SynchronizationSchemaFunctionsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ISynchronizationSchemaFunctionsCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ISynchronizationSchemaFunctionsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
