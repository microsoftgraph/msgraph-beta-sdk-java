...
public class TokenLifetimePolicyCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements ITokenLifetimePolicyCollectionWithReferencesRequestBuilder {
     ...
     */
    public TokenLifetimePolicyCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ITokenLifetimePolicyCollectionWithReferencesRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ITokenLifetimePolicyCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
