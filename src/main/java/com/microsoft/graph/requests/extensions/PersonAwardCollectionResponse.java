...
/**
 * The class for the Person Award Collection Response.
 */
public class PersonAwardCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PersonAward within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PersonAward> value;
