 ...
 */
public class EducationOutcomeCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EducationOutcome within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationOutcome> value;
