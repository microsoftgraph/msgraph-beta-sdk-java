...
/**
 * The class for the Privileged Access Collection Response.
 */
public class PrivilegedAccessCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrivilegedAccess within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrivilegedAccess> value;
