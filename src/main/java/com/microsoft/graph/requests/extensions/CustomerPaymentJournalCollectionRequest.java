...
import com.microsoft.graph.requests.extensions.ICustomerPaymentJournalCollectionPage;
...
import com.microsoft.graph.requests.extensions.ICustomerPaymentJournalCollectionRequest;
 ...
 */
public class CustomerPaymentJournalCollectionRequest extends BaseCollectionRequest<CustomerPaymentJournalCollectionResponse, ICustomerPaymentJournalCollectionPage> implements ICustomerPaymentJournalCollectionRequest {
     ...
     */
    public CustomerPaymentJournalCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ICustomerPaymentJournalCollectionPage get() throws ClientException {
        final CustomerPaymentJournalCollectionResponse response = send();
     ...
     */
    public ICustomerPaymentJournalCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ICustomerPaymentJournalCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ICustomerPaymentJournalCollectionRequest top(final int value) {
    ...
    public ICustomerPaymentJournalCollectionPage buildFromResponse(final CustomerPaymentJournalCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new CustomerPaymentJournalCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final CustomerPaymentJournalCollectionPage page = new CustomerPaymentJournalCollectionPage(response, builder);
