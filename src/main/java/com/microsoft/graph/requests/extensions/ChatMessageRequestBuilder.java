...
public class ChatMessageRequestBuilder extends BaseRequestBuilder implements IChatMessageRequestBuilder {
     ...
     */
    public ChatMessageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IChatMessageRequest buildRequest() {
