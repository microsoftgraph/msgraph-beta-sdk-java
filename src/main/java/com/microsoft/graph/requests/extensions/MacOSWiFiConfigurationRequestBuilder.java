...
public class MacOSWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSWiFiConfigurationRequestBuilder {
     ...
     */
    public MacOSWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IMacOSWiFiConfigurationRequest instance
     */
    public IMacOSWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
