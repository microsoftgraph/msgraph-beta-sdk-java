...
/**
 * The class for the Mac OSWi Fi Configuration Request Builder.
 */
public class MacOSWiFiConfigurationRequestBuilder extends BaseRequestBuilder<MacOSWiFiConfiguration> {

    /**
     * The request builder for the MacOSWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSWiFiConfigurationRequest instance
     */
    @Nonnull
    public MacOSWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
