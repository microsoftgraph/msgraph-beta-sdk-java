...
/**
 * The interface for the Dimension Value Collection Request.
 */
public interface IDimensionValueCollectionRequest {
     ...
     */
    IDimensionValueCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IDimensionValueCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IDimensionValueCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IDimensionValueCollectionRequest skip(final int value);
