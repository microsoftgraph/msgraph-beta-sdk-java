 ...
 */
public class UnifiedRoleManagementPolicyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRoleManagementPolicy within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleManagementPolicy> value;
