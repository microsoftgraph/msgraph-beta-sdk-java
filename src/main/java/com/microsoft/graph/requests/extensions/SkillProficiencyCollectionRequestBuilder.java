...
public class SkillProficiencyCollectionRequestBuilder extends BaseRequestBuilder implements ISkillProficiencyCollectionRequestBuilder {
     ...
     */
    public SkillProficiencyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ISkillProficiencyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
