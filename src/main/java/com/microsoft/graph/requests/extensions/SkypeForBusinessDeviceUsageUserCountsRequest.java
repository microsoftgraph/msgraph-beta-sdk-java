...
import com.microsoft.graph.requests.extensions.SkypeForBusinessDeviceUsageUserCountsRequest;
...
public class SkypeForBusinessDeviceUsageUserCountsRequest extends BaseRequest implements ISkypeForBusinessDeviceUsageUserCountsRequest {
     ...
     */
    public SkypeForBusinessDeviceUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
