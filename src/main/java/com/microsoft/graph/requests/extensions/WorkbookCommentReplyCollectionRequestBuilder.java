...
public class WorkbookCommentReplyCollectionRequestBuilder extends BaseRequestBuilder implements IWorkbookCommentReplyCollectionRequestBuilder {
     ...
     */
    public WorkbookCommentReplyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IWorkbookCommentReplyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
