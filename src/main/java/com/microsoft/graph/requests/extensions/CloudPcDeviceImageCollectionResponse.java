...
/**
 * The class for the Cloud Pc Device Image Collection Response.
 */
public class CloudPcDeviceImageCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CloudPcDeviceImage within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CloudPcDeviceImage> value;
