 ...
 */
public class Windows81CertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IWindows81CertificateProfileBaseRequestBuilder {
     ...
     */
    public Windows81CertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindows81CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindows81CertificateProfileBaseRequest instance
     */
    public IWindows81CertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
