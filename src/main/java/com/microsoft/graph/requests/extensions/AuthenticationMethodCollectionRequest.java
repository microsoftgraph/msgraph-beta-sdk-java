...
public class AuthenticationMethodCollectionRequest extends BaseCollectionRequest<AuthenticationMethodCollectionResponse, IAuthenticationMethodCollectionPage> implements IAuthenticationMethodCollectionRequest {
     ...
     */
    public AuthenticationMethodCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IAuthenticationMethodCollectionPage get() throws ClientException {
        final AuthenticationMethodCollectionResponse response = send();
     ...
     */
    public IAuthenticationMethodCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IAuthenticationMethodCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IAuthenticationMethodCollectionRequest top(final int value) {
    ...
    public IAuthenticationMethodCollectionPage buildFromResponse(final AuthenticationMethodCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new AuthenticationMethodCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final AuthenticationMethodCollectionPage page = new AuthenticationMethodCollectionPage(response, builder);
