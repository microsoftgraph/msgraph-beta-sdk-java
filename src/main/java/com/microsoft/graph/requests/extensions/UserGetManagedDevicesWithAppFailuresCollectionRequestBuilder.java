...
public class UserGetManagedDevicesWithAppFailuresCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IUserGetManagedDevicesWithAppFailuresCollectionRequestBuilder {
     ...
     */
    public UserGetManagedDevicesWithAppFailuresCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IUserGetManagedDevicesWithAppFailuresCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
