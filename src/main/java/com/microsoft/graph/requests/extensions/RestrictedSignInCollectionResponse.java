 ...
 */
public class RestrictedSignInCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RestrictedSignIn within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<RestrictedSignIn> value;
