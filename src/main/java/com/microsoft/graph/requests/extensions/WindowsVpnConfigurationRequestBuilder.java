 ...
 */
public class WindowsVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsVpnConfigurationRequestBuilder {
     ...
     */
    public WindowsVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsVpnConfigurationRequest instance
     */
    public IWindowsVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
