...
/**
 * The interface for the Aosp Device Owner Device Configuration Request Builder.
 */
public interface IAospDeviceOwnerDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAospDeviceOwnerDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAospDeviceOwnerDeviceConfigurationRequest instance
     */
    IAospDeviceOwnerDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
