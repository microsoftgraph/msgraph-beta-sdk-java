 ...
 */
public class EmailAuthenticationMethodCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EmailAuthenticationMethod within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EmailAuthenticationMethod> value;
