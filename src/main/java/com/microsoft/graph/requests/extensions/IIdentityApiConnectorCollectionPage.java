...
/**
 * The interface for the Identity Api Connector Collection Page.
 */
public interface IIdentityApiConnectorCollectionPage extends IBaseCollectionPage<IdentityApiConnector, IIdentityApiConnectorCollectionRequestBuilder> {
}
