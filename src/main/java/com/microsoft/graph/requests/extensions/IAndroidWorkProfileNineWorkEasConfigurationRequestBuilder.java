...
/**
 * The interface for the Android Work Profile Nine Work Eas Configuration Request Builder.
 */
public interface IAndroidWorkProfileNineWorkEasConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileNineWorkEasConfigurationRequest instance
     */
    IAndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
