...
import com.microsoft.graph.requests.extensions.IDeviceComplianceScriptCollectionPage;
...
/**
 * The class for the Device Compliance Script Collection Request.
 */
public class DeviceComplianceScriptCollectionRequest extends BaseCollectionRequest<DeviceComplianceScriptCollectionResponse, IDeviceComplianceScriptCollectionPage> implements IDeviceComplianceScriptCollectionRequest {
     ...
     */
    public DeviceComplianceScriptCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceComplianceScriptCollectionResponse.class, IDeviceComplianceScriptCollectionPage.class);
    }

    public void get(final ICallback<? super IDeviceComplianceScriptCollectionPage> callback) {
    ...
    public IDeviceComplianceScriptCollectionPage get() throws ClientException {
        final DeviceComplianceScriptCollectionResponse response = send();
     ...
     */
    public IDeviceComplianceScriptCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceComplianceScriptCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceComplianceScriptCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceComplianceScriptCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceComplianceScriptCollectionRequest top(final int value) {
    ...
    public IDeviceComplianceScriptCollectionPage buildFromResponse(final DeviceComplianceScriptCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DeviceComplianceScriptCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DeviceComplianceScriptCollectionPage page = new DeviceComplianceScriptCollectionPage(response, builder);
