...
/**
 * The interface for the Management Condition Collection Page.
 */
public interface IManagementConditionCollectionPage extends IBaseCollectionPage<ManagementCondition, IManagementConditionCollectionRequestBuilder> {
}
