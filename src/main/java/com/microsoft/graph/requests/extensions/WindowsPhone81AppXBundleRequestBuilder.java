 ...
 */
public class WindowsPhone81AppXBundleRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81AppXBundleRequestBuilder {
     ...
     */
    public WindowsPhone81AppXBundleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsPhone81AppXBundleRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsPhone81AppXBundleRequest instance
     */
    public IWindowsPhone81AppXBundleRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
