...
public class SiteGetActivitiesByIntervalCollectionRequest extends BaseFunctionCollectionRequest<ItemActivityStat, SiteGetActivitiesByIntervalCollectionResponse, SiteGetActivitiesByIntervalCollectionPage> {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public SiteGetActivitiesByIntervalCollectionRequest skipToken(@Nonnull final String skipToken) {
