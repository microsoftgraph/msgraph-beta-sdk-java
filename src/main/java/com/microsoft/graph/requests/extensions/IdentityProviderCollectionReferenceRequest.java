 ...
 */
public class IdentityProviderCollectionReferenceRequest extends BaseCollectionRequest<IdentityProviderCollectionResponse, IIdentityProviderCollectionPage> implements IIdentityProviderCollectionReferenceRequest {
     ...
     */
    public IdentityProviderCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIdentityProviderCollectionReferenceRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IIdentityProviderCollectionReferenceRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IIdentityProviderCollectionReferenceRequest top(final int value) {
