 ...
 */
public class UserConsentRequestCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserConsentRequest within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserConsentRequest> value;
