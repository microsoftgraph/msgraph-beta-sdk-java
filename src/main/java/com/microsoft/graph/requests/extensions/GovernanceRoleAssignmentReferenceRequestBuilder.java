 ...
 */
public class GovernanceRoleAssignmentReferenceRequestBuilder extends BaseReferenceRequestBuilder<GovernanceRoleAssignment, GovernanceRoleAssignmentReferenceRequest> {
     ...
     */
    public GovernanceRoleAssignmentReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, GovernanceRoleAssignmentReferenceRequest.class);
    }
}
