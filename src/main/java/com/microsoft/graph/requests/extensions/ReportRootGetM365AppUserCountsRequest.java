 ...
 */
public class ReportRootGetM365AppUserCountsRequest extends BaseRequest implements IReportRootGetM365AppUserCountsRequest {
     ...
     */
    public ReportRootGetM365AppUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetM365AppUserCounts
    ...
    /**
     * Puts the ReportRootGetM365AppUserCounts
     *
     ...
     */
    public IReportRootGetM365AppUserCountsRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetM365AppUserCountsRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetM365AppUserCountsRequest orderBy(final String value) {
