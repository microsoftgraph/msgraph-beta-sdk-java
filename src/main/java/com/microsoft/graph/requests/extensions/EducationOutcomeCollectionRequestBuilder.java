...
public class EducationOutcomeCollectionRequestBuilder extends BaseRequestBuilder implements IEducationOutcomeCollectionRequestBuilder {
     ...
     */
    public EducationOutcomeCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IEducationOutcomeCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
