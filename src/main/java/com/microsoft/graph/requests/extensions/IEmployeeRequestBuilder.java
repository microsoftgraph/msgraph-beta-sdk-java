...
public interface IEmployeeRequestBuilder extends IRequestBuilder {
     ...
     */
    IEmployeeRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IEmployeeRequest instance
     */
    IEmployeeRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
