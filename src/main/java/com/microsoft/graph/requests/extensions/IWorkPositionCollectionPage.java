...
/**
 * The interface for the Work Position Collection Page.
 */
public interface IWorkPositionCollectionPage extends IBaseCollectionPage<WorkPosition, IWorkPositionCollectionRequestBuilder> {
}
