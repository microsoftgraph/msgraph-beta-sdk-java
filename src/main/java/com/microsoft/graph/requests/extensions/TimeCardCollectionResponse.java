...
/**
 * The class for the Time Card Collection Response.
 */
public class TimeCardCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TimeCard within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TimeCard> value;
