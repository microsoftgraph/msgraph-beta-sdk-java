 ...
 */
public class AudioRoutingGroupCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AudioRoutingGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AudioRoutingGroup> value;
