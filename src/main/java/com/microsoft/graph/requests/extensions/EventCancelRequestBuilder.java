...
public class EventCancelRequestBuilder extends BaseActionRequestBuilder implements IEventCancelRequestBuilder {
     ...
     */
    public EventCancelRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String comment) {
     ...
     */
    public IEventCancelRequest buildRequest() {
     ...
     * @return the IEventCancelRequest instance
     */
    public IEventCancelRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
