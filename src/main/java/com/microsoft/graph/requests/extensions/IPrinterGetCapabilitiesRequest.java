...
/**
 * The interface for the Printer Get Capabilities Request.
 */
public interface IPrinterGetCapabilitiesRequest extends IHttpRequest {
     ...
     */
    PrinterCapabilities get() throws ClientException;
     ...
     */
    IPrinterGetCapabilitiesRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrinterGetCapabilitiesRequest expand(final String value);
