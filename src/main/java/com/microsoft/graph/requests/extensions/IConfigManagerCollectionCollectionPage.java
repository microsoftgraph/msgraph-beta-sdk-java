...
/**
 * The interface for the Config Manager Collection Collection Page.
 */
public interface IConfigManagerCollectionCollectionPage extends IBaseCollectionPage<ConfigManagerCollection, IConfigManagerCollectionCollectionRequestBuilder> {
}
