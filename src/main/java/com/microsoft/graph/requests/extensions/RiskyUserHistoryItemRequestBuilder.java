...
public class RiskyUserHistoryItemRequestBuilder extends BaseRequestBuilder implements IRiskyUserHistoryItemRequestBuilder {
     ...
     */
    public RiskyUserHistoryItemRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IRiskyUserHistoryItemRequest instance
     */
    public IRiskyUserHistoryItemRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
