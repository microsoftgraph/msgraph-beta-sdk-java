...
public class ReportRootGetM365AppUserCountsRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetM365AppUserCountsRequestBuilder {
     ...
     */
    public ReportRootGetM365AppUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetM365AppUserCountsRequest instance
     */
    public IReportRootGetM365AppUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
