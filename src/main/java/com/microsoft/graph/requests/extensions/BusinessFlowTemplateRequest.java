...
import com.microsoft.graph.requests.extensions.IBusinessFlowTemplateRequest;
import com.microsoft.graph.requests.extensions.BusinessFlowTemplateRequest;
...
public class BusinessFlowTemplateRequest extends BaseRequest implements IBusinessFlowTemplateRequest {
     ...
     */
    public BusinessFlowTemplateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
