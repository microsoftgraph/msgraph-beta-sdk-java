...
/**
 * The interface for the Authentication Method Enable Sms Sign In Request.
 */
public interface IAuthenticationMethodEnableSmsSignInRequest extends IHttpRequest {
