 ...
 */
public class DeviceCustomAttributeShellScriptRequestBuilder extends BaseRequestBuilder<DeviceCustomAttributeShellScript> {
     ...
     */
    public DeviceCustomAttributeShellScriptRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the DeviceCustomAttributeShellScriptRequest instance
     */
    @Nonnull
    public DeviceCustomAttributeShellScriptRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DeviceCustomAttributeShellScriptRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceCustomAttributeShellScriptAssignRequestBuilder assign(@Nonnull final DeviceCustomAttributeShellScriptAssignParameterSet parameters) {
        return new DeviceCustomAttributeShellScriptAssignRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.assign"), getClient(), null, parameters);
    }
}
