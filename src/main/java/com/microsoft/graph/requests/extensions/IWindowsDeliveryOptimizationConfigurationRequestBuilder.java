...
/**
 * The interface for the Windows Delivery Optimization Configuration Request Builder.
 */
public interface IWindowsDeliveryOptimizationConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsDeliveryOptimizationConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsDeliveryOptimizationConfigurationRequest instance
     */
    IWindowsDeliveryOptimizationConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
