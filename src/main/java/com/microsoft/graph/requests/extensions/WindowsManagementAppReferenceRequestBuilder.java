 ...
 */
public class WindowsManagementAppReferenceRequestBuilder extends BaseReferenceRequestBuilder<WindowsManagementApp, WindowsManagementAppReferenceRequest> {
     ...
     */
    public WindowsManagementAppReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsManagementAppReferenceRequest.class);
    }
}
