...
/**
 * The interface for the Office Client Configuration Policy Payload Stream Request.
 */
public interface IOfficeClientConfigurationPolicyPayloadStreamRequest extends IHttpStreamRequest {
