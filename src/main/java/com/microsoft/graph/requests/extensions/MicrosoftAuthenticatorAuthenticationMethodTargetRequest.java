...
import com.microsoft.graph.requests.extensions.IMicrosoftAuthenticatorAuthenticationMethodTargetRequest;
import com.microsoft.graph.requests.extensions.MicrosoftAuthenticatorAuthenticationMethodTargetRequest;
...
public class MicrosoftAuthenticatorAuthenticationMethodTargetRequest extends BaseRequest implements IMicrosoftAuthenticatorAuthenticationMethodTargetRequest {
     ...
     */
    public MicrosoftAuthenticatorAuthenticationMethodTargetRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<MicrosoftAuthenticatorAuthenticationMethodTarget> callback) {
     ...
     */
    public void delete(final ICallback<MicrosoftAuthenticatorAuthenticationMethodTarget> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final MicrosoftAuthenticatorAuthenticationMethodTarget sourceMicrosoftAuthenticatorAuthenticationMethodTarget, final ICallback<MicrosoftAuthenticatorAuthenticationMethodTarget> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final MicrosoftAuthenticatorAuthenticationMethodTarget newMicrosoftAuthenticatorAuthenticationMethodTarget, final ICallback<MicrosoftAuthenticatorAuthenticationMethodTarget> callback) {
