 ...
 */
public class ApprovalCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Approval within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Approval> value;
