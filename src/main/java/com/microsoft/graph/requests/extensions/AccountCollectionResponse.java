...
/**
 * The class for the Account Collection Response.
 */
public class AccountCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Account within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Account> value;
