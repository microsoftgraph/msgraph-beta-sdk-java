...
/**
 * The class for the Unsupported Device Configuration Request Builder.
 */
public class UnsupportedDeviceConfigurationRequestBuilder extends BaseRequestBuilder<UnsupportedDeviceConfiguration> {

    /**
     * The request builder for the UnsupportedDeviceConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public UnsupportedDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the UnsupportedDeviceConfigurationRequest instance
     */
    @Nonnull
    public UnsupportedDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UnsupportedDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.UnsupportedDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
