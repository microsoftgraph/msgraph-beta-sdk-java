 ...
 */
public class UnsupportedDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IUnsupportedDeviceConfigurationRequestBuilder {
     ...
     */
    public UnsupportedDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IUnsupportedDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUnsupportedDeviceConfigurationRequest instance
     */
    public IUnsupportedDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
