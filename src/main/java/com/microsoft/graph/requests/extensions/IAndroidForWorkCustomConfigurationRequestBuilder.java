...
/**
 * The interface for the Android For Work Custom Configuration Request Builder.
 */
public interface IAndroidForWorkCustomConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkCustomConfigurationRequest instance
     */
    IAndroidForWorkCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
