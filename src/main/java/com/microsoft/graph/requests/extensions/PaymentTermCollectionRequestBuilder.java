...
public class PaymentTermCollectionRequestBuilder extends BaseRequestBuilder implements IPaymentTermCollectionRequestBuilder {
     ...
     */
    public PaymentTermCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IPaymentTermCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
