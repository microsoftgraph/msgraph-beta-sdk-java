...
/**
 * The interface for the Picture Collection Page.
 */
public interface IPictureCollectionPage extends IBaseCollectionPage<Picture, IPictureCollectionRequestBuilder> {
}
