 ...
 */
public class CustodianCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Custodian within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Custodian> value;
