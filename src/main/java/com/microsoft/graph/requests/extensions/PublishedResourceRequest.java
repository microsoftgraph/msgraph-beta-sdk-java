 ...
 */
public class PublishedResourceRequest extends BaseRequest implements IPublishedResourceRequest {
     ...
     */
    public PublishedResourceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public PublishedResource patch(final PublishedResource sourcePublishedResource) throws ClientException {
     ...
     */
     public IPublishedResourceRequest select(final String value) {
