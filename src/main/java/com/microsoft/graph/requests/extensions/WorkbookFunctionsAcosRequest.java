 ...
 */
public class WorkbookFunctionsAcosRequest extends BaseRequest implements IWorkbookFunctionsAcosRequest {
    protected final WorkbookFunctionsAcosBody body;
    ...
    public WorkbookFunctionsAcosRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        ...
        body = new WorkbookFunctionsAcosBody();
    }
