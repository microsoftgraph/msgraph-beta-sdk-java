 ...
 */
public class DomainSecurityProfileCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DomainSecurityProfile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DomainSecurityProfile> value;
