...
public class OrganizationalBrandingLocalizationCollectionRequest extends BaseEntityCollectionRequest<OrganizationalBrandingLocalization, OrganizationalBrandingLocalizationCollectionResponse, OrganizationalBrandingLocalizationCollectionPage> {
     ...
     */
    public OrganizationalBrandingLocalizationCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OrganizationalBrandingLocalizationCollectionResponse.class, OrganizationalBrandingLocalizationCollectionPage.class, OrganizationalBrandingLocalizationCollectionRequestBuilder.class);
    }

    /**
     * Creates a new OrganizationalBrandingLocalization
     * @param newOrganizationalBrandingLocalization the OrganizationalBrandingLocalization to create
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public OrganizationalBrandingLocalizationCollectionRequest skipToken(@Nonnull final String skipToken) {
