...
import com.microsoft.graph.requests.extensions.DriveItemContentStreamRequest;
...
public class DriveItemContentStreamRequestBuilder extends BaseRequestBuilder implements IDriveItemContentStreamRequestBuilder {
     ...
     */
    public DriveItemContentStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IDriveItemContentStreamRequest buildRequest() {
     ...
     * @return the IDriveItemContentStreamRequest instance
     */
    public IDriveItemContentStreamRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
