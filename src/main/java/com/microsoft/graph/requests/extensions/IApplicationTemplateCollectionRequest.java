...
public interface IApplicationTemplateCollectionRequest extends IHttpRequest {
    ...
    void get(final ICallback<? super IApplicationTemplateCollectionPage> callback);
     ...
     * @return the updated request
     */
    IApplicationTemplateCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    IApplicationTemplateCollectionRequest orderBy(final String value);
	 ...
	 * @return the updated request
	 */
	IApplicationTemplateCollectionRequest skipToken(final String skipToken);
}
