...
public class ManagedDeviceCertificateStateRequest extends BaseRequest implements IManagedDeviceCertificateStateRequest {
     ...
     */
    public void get(final ICallback<ManagedDeviceCertificateState> callback) {
     ...
     */
    public void delete(final ICallback<ManagedDeviceCertificateState> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final ManagedDeviceCertificateState sourceManagedDeviceCertificateState, final ICallback<ManagedDeviceCertificateState> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final ManagedDeviceCertificateState newManagedDeviceCertificateState, final ICallback<ManagedDeviceCertificateState> callback) {
     ...
     * @return the updated request
     */
     public IManagedDeviceCertificateStateRequest filter(final String value) {
