...
public interface IReportRootGetSharePointSiteUsageSiteCountsCollectionRequestBuilder extends IRequestBuilder {
    ...
    IReportRootGetSharePointSiteUsageSiteCountsCollectionRequest buildRequest();

    IReportRootGetSharePointSiteUsageSiteCountsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
