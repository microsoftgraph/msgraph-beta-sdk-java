...
public class AccessReviewInstanceCollectionRequestBuilder extends BaseRequestBuilder implements IAccessReviewInstanceCollectionRequestBuilder {
     ...
     */
    public AccessReviewInstanceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IAccessReviewInstanceCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IAccessReviewInstanceCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
