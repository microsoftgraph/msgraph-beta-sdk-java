...
/**
 * The interface for the Ios Education Device Configuration Request Builder.
 */
public interface IIosEducationDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosEducationDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosEducationDeviceConfigurationRequest instance
     */
    IIosEducationDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
