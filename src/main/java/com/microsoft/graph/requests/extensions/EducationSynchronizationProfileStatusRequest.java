...
import com.microsoft.graph.requests.extensions.IEducationSynchronizationProfileStatusRequest;
import com.microsoft.graph.requests.extensions.EducationSynchronizationProfileStatusRequest;
...
public class EducationSynchronizationProfileStatusRequest extends BaseRequest implements IEducationSynchronizationProfileStatusRequest {
     ...
     */
    public EducationSynchronizationProfileStatusRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
