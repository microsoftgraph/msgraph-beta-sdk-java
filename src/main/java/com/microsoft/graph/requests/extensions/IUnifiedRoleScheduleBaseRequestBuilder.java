...
/**
 * The interface for the Unified Role Schedule Base Request Builder.
 */
public interface IUnifiedRoleScheduleBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IUnifiedRoleScheduleBaseRequest instance
     */
    IUnifiedRoleScheduleBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUnifiedRoleScheduleBaseRequest instance
     */
    IUnifiedRoleScheduleBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
