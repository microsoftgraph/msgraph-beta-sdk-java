...
public class EnterpriseCodeSigningCertificateRequestBuilder extends BaseRequestBuilder implements IEnterpriseCodeSigningCertificateRequestBuilder {
     ...
     */
    public EnterpriseCodeSigningCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
