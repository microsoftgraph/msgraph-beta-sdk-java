...
/**
 * The interface for the Item Publication Collection Page.
 */
public interface IItemPublicationCollectionPage extends IBaseCollectionPage<ItemPublication, IItemPublicationCollectionRequestBuilder> {
}
