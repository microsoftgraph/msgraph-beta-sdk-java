...
public class ActivityStatisticsCollectionRequestBuilder extends BaseRequestBuilder implements IActivityStatisticsCollectionRequestBuilder {
     ...
     */
    public ActivityStatisticsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IActivityStatisticsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
