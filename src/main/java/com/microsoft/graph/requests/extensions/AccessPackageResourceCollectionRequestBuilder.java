...
public class AccessPackageResourceCollectionRequestBuilder extends BaseRequestBuilder implements IAccessPackageResourceCollectionRequestBuilder {
     ...
     */
    public AccessPackageResourceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAccessPackageResourceCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
