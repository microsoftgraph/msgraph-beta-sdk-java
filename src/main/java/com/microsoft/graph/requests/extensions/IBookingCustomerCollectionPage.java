...
/**
 * The interface for the Booking Customer Collection Page.
 */
public interface IBookingCustomerCollectionPage extends IBaseCollectionPage<BookingCustomer, IBookingCustomerCollectionRequestBuilder> {
}
