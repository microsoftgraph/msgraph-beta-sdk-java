...
public class Windows10ImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindows10ImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public IWindows10ImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindows10ImportedPFXCertificateProfileRequest instance
     */
    public IWindows10ImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
