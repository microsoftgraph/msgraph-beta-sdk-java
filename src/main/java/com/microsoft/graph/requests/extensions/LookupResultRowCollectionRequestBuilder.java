...
public class LookupResultRowCollectionRequestBuilder extends BaseRequestBuilder implements ILookupResultRowCollectionRequestBuilder {
     ...
     */
    public LookupResultRowCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ILookupResultRowCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
