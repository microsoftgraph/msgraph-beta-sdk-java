...
/**
 * The interface for the Device Management Derived Credential Settings Reference Request.
 */
public interface IDeviceManagementDerivedCredentialSettingsReferenceRequest extends IHttpRequest {
     ...
     */
    IDeviceManagementDerivedCredentialSettingsReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IDeviceManagementDerivedCredentialSettingsReferenceRequest expand(final String value);
     ...
     */
    DeviceManagementDerivedCredentialSettings put(DeviceManagementDerivedCredentialSettings srcDeviceManagementDerivedCredentialSettings) throws ClientException;
}
