...
/**
 * The interface for the Android Device Owner Pkcs Certificate Profile Request Builder.
 */
public interface IAndroidDeviceOwnerPkcsCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidDeviceOwnerPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerPkcsCertificateProfileRequest instance
     */
    IAndroidDeviceOwnerPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
