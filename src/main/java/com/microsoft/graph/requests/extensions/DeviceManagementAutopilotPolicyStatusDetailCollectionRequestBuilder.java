...
public class DeviceManagementAutopilotPolicyStatusDetailCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementAutopilotPolicyStatusDetailCollectionRequestBuilder {
     ...
     */
    public DeviceManagementAutopilotPolicyStatusDetailCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IDeviceManagementAutopilotPolicyStatusDetailCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IDeviceManagementAutopilotPolicyStatusDetailCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
