...
public class DeviceManagementAutopilotPolicyStatusDetailRequestBuilder extends BaseRequestBuilder implements IDeviceManagementAutopilotPolicyStatusDetailRequestBuilder {
     ...
     */
    public DeviceManagementAutopilotPolicyStatusDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IDeviceManagementAutopilotPolicyStatusDetailRequest buildRequest() {
