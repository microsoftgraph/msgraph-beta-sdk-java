...
public class DeviceManagementIntentAssignRequest extends BaseRequest<Void> {
     ...
     */
    public DeviceManagementIntentAssignRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final DeviceManagementIntentAssignParameterSet parameters) {
    ...
    @Nullable
    protected DeviceManagementIntentAssignParameterSet body;
    /**
