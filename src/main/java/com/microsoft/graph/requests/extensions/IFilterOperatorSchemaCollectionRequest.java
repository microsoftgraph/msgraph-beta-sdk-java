...
/**
 * The interface for the Filter Operator Schema Collection Request.
 */
public interface IFilterOperatorSchemaCollectionRequest {
     ...
     */
    IFilterOperatorSchemaCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IFilterOperatorSchemaCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IFilterOperatorSchemaCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IFilterOperatorSchemaCollectionRequest skip(final int value);
