...
/**
 * The interface for the Access Package Reference Request Builder.
 */
public interface IAccessPackageReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IAccessPackageReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAccessPackageReferenceRequest instance
     */
    IAccessPackageReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
