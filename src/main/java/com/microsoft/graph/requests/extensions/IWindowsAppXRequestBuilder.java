...
/**
 * The interface for the Windows App XRequest Builder.
 */
public interface IWindowsAppXRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsAppXRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsAppXRequest instance
     */
    IWindowsAppXRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
