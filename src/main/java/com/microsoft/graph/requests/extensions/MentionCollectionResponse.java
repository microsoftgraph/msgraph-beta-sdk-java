...
/**
 * The class for the Mention Collection Response.
 */
public class MentionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Mention within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Mention> value;
