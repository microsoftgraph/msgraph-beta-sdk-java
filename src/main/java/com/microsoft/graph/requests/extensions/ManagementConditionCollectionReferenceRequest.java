...
public class ManagementConditionCollectionReferenceRequest extends BaseCollectionRequest<ManagementConditionCollectionResponse, IManagementConditionCollectionPage> implements IManagementConditionCollectionReferenceRequest {
     ...
     */
    public ManagementConditionCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IManagementConditionCollectionReferenceRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IManagementConditionCollectionReferenceRequest orderBy(final String value) {
