...
/**
 * The class for the Connector Collection Response.
 */
public class ConnectorCollectionResponse implements IJsonBackedObject {
    ...
    @Expose
    public java.util.List<Connector> value;
