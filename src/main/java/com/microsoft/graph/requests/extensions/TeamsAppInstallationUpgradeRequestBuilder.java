...
public class TeamsAppInstallationUpgradeRequestBuilder extends BaseActionRequestBuilder implements ITeamsAppInstallationUpgradeRequestBuilder {
     ...
     */
    public TeamsAppInstallationUpgradeRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ITeamsAppInstallationUpgradeRequest buildRequest() {
     ...
     * @return the ITeamsAppInstallationUpgradeRequest instance
     */
    public ITeamsAppInstallationUpgradeRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
