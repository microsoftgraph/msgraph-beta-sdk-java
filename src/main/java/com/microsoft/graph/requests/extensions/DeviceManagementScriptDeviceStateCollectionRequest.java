...
public class DeviceManagementScriptDeviceStateCollectionRequest extends BaseCollectionRequest<DeviceManagementScriptDeviceStateCollectionResponse, IDeviceManagementScriptDeviceStateCollectionPage> implements IDeviceManagementScriptDeviceStateCollectionRequest {
    ...
    public void get(final ICallback<? super IDeviceManagementScriptDeviceStateCollectionPage> callback) {
    ...
    public void post(final DeviceManagementScriptDeviceState newDeviceManagementScriptDeviceState, final ICallback<? super DeviceManagementScriptDeviceState> callback) {
     ...
     * @return the updated request
     */
    public IDeviceManagementScriptDeviceStateCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementScriptDeviceStateCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementScriptDeviceStateCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementScriptDeviceStateCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IDeviceManagementScriptDeviceStateCollectionRequest)this;
    }
