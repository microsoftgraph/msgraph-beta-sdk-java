 ...
 */
public class CompanyInformationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CompanyInformation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CompanyInformation> value;
