...
public class MacOSTrustedRootCertificateReferenceRequest extends BaseRequest implements IMacOSTrustedRootCertificateReferenceRequest {
     ...
     */
    public MacOSTrustedRootCertificateReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
