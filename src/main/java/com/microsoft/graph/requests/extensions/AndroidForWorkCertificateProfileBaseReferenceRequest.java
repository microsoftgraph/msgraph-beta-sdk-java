...
public class AndroidForWorkCertificateProfileBaseReferenceRequest extends BaseRequest implements IAndroidForWorkCertificateProfileBaseReferenceRequest {
     ...
     */
    public AndroidForWorkCertificateProfileBaseReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
