...
/**
 * The class for the Planner Roster Member Collection Response.
 */
public class PlannerRosterMemberCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PlannerRosterMember within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PlannerRosterMember> value;
