...
/**
 * The class for the Item Patent Collection Response.
 */
public class ItemPatentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ItemPatent within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ItemPatent> value;
