...
public class ItemActivityCollectionRequestBuilder extends BaseRequestBuilder implements IItemActivityCollectionRequestBuilder {
     ...
     */
    public ItemActivityCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IItemActivityCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IItemActivityCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
