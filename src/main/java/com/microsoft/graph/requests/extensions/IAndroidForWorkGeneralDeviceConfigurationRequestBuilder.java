...
import com.microsoft.graph.requests.extensions.IAndroidForWorkGeneralDeviceConfigurationRequest;
...
/**
 * The interface for the Android For Work General Device Configuration Request Builder.
 */
public interface IAndroidForWorkGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IAndroidForWorkGeneralDeviceConfigurationRequest instance
     */
    IAndroidForWorkGeneralDeviceConfigurationRequest buildRequest();
     ...
     * @return the IAndroidForWorkGeneralDeviceConfigurationRequest instance
     */
    IAndroidForWorkGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions);
