...
public interface IAndroidForWorkGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkGeneralDeviceConfigurationRequest instance
     */
    IAndroidForWorkGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
