...
/**
 * The class for the Restricted Apps Violation Collection Response.
 */
public class RestrictedAppsViolationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RestrictedAppsViolation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<RestrictedAppsViolation> value;
