...
public interface IIosVpnConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosVpnConfigurationRequest instance
     */
    IIosVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
