...
/**
 * The class for the On Premises Publishing Profile Collection Response.
 */
public class OnPremisesPublishingProfileCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OnPremisesPublishingProfile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OnPremisesPublishingProfile> value;
