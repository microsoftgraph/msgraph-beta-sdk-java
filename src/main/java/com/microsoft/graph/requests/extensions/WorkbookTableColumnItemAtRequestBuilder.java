...
public class WorkbookTableColumnItemAtRequestBuilder extends BaseFunctionRequestBuilder<WorkbookTableColumn> {
     ...
     */
    public WorkbookTableColumnItemAtRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookTableColumnItemAtParameterSet parameters) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnItemAtRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WorkbookTableColumnItemAtRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
