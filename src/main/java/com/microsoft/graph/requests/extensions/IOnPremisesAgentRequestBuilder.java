...
public interface IOnPremisesAgentRequestBuilder extends IRequestBuilder {
     ...
     */
    IOnPremisesAgentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOnPremisesAgentRequest instance
     */
    IOnPremisesAgentRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
