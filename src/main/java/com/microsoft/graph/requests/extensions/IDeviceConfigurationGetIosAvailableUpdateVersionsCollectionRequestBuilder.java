...
public interface IDeviceConfigurationGetIosAvailableUpdateVersionsCollectionRequestBuilder extends IRequestBuilder {
    ...
    IDeviceConfigurationGetIosAvailableUpdateVersionsCollectionRequest buildRequest();

    IDeviceConfigurationGetIosAvailableUpdateVersionsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
