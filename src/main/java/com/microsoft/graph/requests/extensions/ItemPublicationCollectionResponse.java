...
/**
 * The class for the Item Publication Collection Response.
 */
public class ItemPublicationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ItemPublication within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ItemPublication> value;
