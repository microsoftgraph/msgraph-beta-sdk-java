 ...
 */
public class EducationAssignmentPublishRequest extends BaseRequest implements IEducationAssignmentPublishRequest {
     ...
     */
    public EducationAssignmentPublishRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IEducationAssignmentPublishRequest select(final String value) {
