 ...
 */
public class NetworkManagementConditionRequestBuilder extends BaseRequestBuilder implements INetworkManagementConditionRequestBuilder {
     ...
     */
    public NetworkManagementConditionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the INetworkManagementConditionRequest instance
     */
    public INetworkManagementConditionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.NetworkManagementConditionRequest(getRequestUrl(), getClient(), requestOptions);
    }
