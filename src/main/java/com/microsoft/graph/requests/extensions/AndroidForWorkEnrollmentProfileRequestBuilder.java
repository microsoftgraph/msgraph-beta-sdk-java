...
import com.microsoft.graph.requests.extensions.AndroidForWorkEnrollmentProfileCreateTokenRequestBuilder;
...
public class AndroidForWorkEnrollmentProfileRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkEnrollmentProfileRequestBuilder {
     ...
     */
    public AndroidForWorkEnrollmentProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
