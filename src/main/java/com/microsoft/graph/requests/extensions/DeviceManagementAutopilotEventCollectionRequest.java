...
import com.microsoft.graph.requests.extensions.IDeviceManagementAutopilotEventCollectionPage;
 ...
 */
public class DeviceManagementAutopilotEventCollectionRequest extends BaseCollectionRequest<DeviceManagementAutopilotEventCollectionResponse, IDeviceManagementAutopilotEventCollectionPage> implements IDeviceManagementAutopilotEventCollectionRequest {
     ...
     */
    public DeviceManagementAutopilotEventCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceManagementAutopilotEventCollectionPage get() throws ClientException {
        final DeviceManagementAutopilotEventCollectionResponse response = send();
     ...
     */
    public IDeviceManagementAutopilotEventCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementAutopilotEventCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementAutopilotEventCollectionRequest top(final int value) {
    ...
    public IDeviceManagementAutopilotEventCollectionPage buildFromResponse(final DeviceManagementAutopilotEventCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DeviceManagementAutopilotEventCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DeviceManagementAutopilotEventCollectionPage page = new DeviceManagementAutopilotEventCollectionPage(response, builder);
