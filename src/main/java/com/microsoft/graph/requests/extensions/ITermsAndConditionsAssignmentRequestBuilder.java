...
/**
 * The interface for the Terms And Conditions Assignment Request Builder.
 */
public interface ITermsAndConditionsAssignmentRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
