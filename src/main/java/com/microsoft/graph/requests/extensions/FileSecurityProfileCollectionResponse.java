...
/**
 * The class for the File Security Profile Collection Response.
 */
public class FileSecurityProfileCollectionResponse implements IJsonBackedObject {

    /**
     * The list of FileSecurityProfile within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<FileSecurityProfile> value;
