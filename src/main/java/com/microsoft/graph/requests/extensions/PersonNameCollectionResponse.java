 ...
 */
public class PersonNameCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PersonName within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PersonName> value;
