...
public class WindowsAutopilotDeviceIdentityAssignResourceAccountToDeviceRequest extends BaseRequest implements IWindowsAutopilotDeviceIdentityAssignResourceAccountToDeviceRequest {
     ...
     */
    public WindowsAutopilotDeviceIdentityAssignResourceAccountToDeviceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IWindowsAutopilotDeviceIdentityAssignResourceAccountToDeviceRequest filter(final String value) {
