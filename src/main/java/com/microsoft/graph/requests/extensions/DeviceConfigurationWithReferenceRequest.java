 ...
 */
public class DeviceConfigurationWithReferenceRequest extends BaseWithReferenceRequest<DeviceConfiguration> {
     ...
     */
    public DeviceConfigurationWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DeviceConfigurationWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceConfigurationWithReferenceRequest expand(@Nonnull final String value) {
