 ...
 */
public class LongRunningOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of LongRunningOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<LongRunningOperation> value;
