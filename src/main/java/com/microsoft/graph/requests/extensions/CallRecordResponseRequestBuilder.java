...
public class CallRecordResponseRequestBuilder extends BaseActionRequestBuilder implements ICallRecordResponseRequestBuilder {
     ...
     * @param streamWhileRecording the streamWhileRecording
     * @param stopTones the stopTones
     * @param clientContext the clientContext
     */
    public CallRecordResponseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final java.util.List<Prompt> prompts, final Boolean bargeInAllowed, final Integer initialSilenceTimeoutInSeconds, final Integer maxSilenceTimeoutInSeconds, final Integer maxRecordDurationInSeconds, final Boolean playBeep, final Boolean streamWhileRecording, final java.util.List<String> stopTones, final String clientContext) {
        ...
        bodyParams.put("streamWhileRecording", streamWhileRecording);
    ...
    public ICallRecordResponseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        ...
        if (hasParameter("streamWhileRecording")) {
            request.body.streamWhileRecording = getParameter("streamWhileRecording");
        }
