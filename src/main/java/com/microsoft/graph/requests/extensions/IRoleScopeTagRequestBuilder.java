...
/**
 * The interface for the Role Scope Tag Request Builder.
 */
public interface IRoleScopeTagRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IRoleScopeTagRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
    ...
    IRoleScopeTagAutoAssignmentRequestBuilder assignments(final String id);

    IRoleScopeTagAssignCollectionRequestBuilder assign(final java.util.List<RoleScopeTagAutoAssignment> assignments);
