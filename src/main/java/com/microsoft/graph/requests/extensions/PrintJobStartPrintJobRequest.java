 ...
 */
public class PrintJobStartPrintJobRequest extends BaseRequest implements IPrintJobStartPrintJobRequest {
     ...
     */
    public PrintJobStartPrintJobRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IPrintJobStartPrintJobRequest select(final String value) {
