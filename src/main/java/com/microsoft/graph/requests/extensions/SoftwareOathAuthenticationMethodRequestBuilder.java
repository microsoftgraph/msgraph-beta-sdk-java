...
public class SoftwareOathAuthenticationMethodRequestBuilder extends BaseRequestBuilder implements ISoftwareOathAuthenticationMethodRequestBuilder {
     ...
     */
    public SoftwareOathAuthenticationMethodRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
