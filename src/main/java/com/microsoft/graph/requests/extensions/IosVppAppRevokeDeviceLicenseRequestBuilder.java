...
public class IosVppAppRevokeDeviceLicenseRequestBuilder extends BaseActionRequestBuilder implements IIosVppAppRevokeDeviceLicenseRequestBuilder {
     ...
     */
    public IosVppAppRevokeDeviceLicenseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String managedDeviceId, final Boolean notifyManagedDevices) {
     ...
     * @return the IIosVppAppRevokeDeviceLicenseRequest instance
     */
    public IIosVppAppRevokeDeviceLicenseRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
