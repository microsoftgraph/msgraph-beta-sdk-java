...
import com.microsoft.graph.requests.extensions.ISecurityBaselineStateSummaryRequest;
import com.microsoft.graph.requests.extensions.SecurityBaselineStateSummaryRequest;
...
public class SecurityBaselineStateSummaryRequest extends BaseRequest implements ISecurityBaselineStateSummaryRequest {
     ...
     * @param requestOptions the options for this request
     */
    public SecurityBaselineStateSummaryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
