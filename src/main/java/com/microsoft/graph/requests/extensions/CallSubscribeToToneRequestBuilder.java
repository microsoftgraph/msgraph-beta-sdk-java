...
public class CallSubscribeToToneRequestBuilder extends BaseActionRequestBuilder implements ICallSubscribeToToneRequestBuilder {
     ...
     */
    public CallSubscribeToToneRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String clientContext) {
     ...
     * @return the ICallSubscribeToToneRequest instance
     */
    public ICallSubscribeToToneRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
