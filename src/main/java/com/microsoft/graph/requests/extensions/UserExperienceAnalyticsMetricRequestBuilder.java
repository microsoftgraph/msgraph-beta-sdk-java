...
public class UserExperienceAnalyticsMetricRequestBuilder extends BaseRequestBuilder implements IUserExperienceAnalyticsMetricRequestBuilder {
     ...
     */
    public UserExperienceAnalyticsMetricRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
