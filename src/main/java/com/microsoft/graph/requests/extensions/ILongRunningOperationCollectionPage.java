...
/**
 * The interface for the Long Running Operation Collection Page.
 */
public interface ILongRunningOperationCollectionPage extends IBaseCollectionPage<LongRunningOperation, ILongRunningOperationCollectionRequestBuilder> {
}
