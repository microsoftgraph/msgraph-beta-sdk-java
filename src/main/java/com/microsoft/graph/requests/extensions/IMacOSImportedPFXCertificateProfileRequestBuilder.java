...
/**
 * The interface for the Mac OSImported PFXCertificate Profile Request Builder.
 */
public interface IMacOSImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IMacOSImportedPFXCertificateProfileRequest instance
     */
    IMacOSImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
