...
/**
 * The interface for the Device App Management Task Collection Page.
 */
public interface IDeviceAppManagementTaskCollectionPage extends IBaseCollectionPage<DeviceAppManagementTask, IDeviceAppManagementTaskCollectionRequestBuilder> {
}
