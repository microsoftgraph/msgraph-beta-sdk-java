 ...
 */
public class ReportRootGetOffice365GroupsActivityStorageCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<Office365GroupsActivityStorage> value;
