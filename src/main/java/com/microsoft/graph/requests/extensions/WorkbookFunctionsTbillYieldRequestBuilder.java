...
public class WorkbookFunctionsTbillYieldRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    /**
     * Creates the WorkbookFunctionsTbillYieldRequest
     *
     * @param requestOptions the options for the request
     * @return the WorkbookFunctionsTbillYieldRequest instance
     */
    @Nonnull
    public WorkbookFunctionsTbillYieldRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the WorkbookFunctionsTbillYieldRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the WorkbookFunctionsTbillYieldRequest instance
     */
    @Nonnull
    public WorkbookFunctionsTbillYieldRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
