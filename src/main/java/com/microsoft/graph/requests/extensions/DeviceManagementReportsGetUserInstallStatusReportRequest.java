...
public class DeviceManagementReportsGetUserInstallStatusReportRequest extends BaseRequest<java.io.InputStream> {
    ...
    @Nullable
    protected DeviceManagementReportsGetUserInstallStatusReportParameterSet body;
    /**
