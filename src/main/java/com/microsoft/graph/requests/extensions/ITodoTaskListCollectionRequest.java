 ...
 */
public interface ITodoTaskListCollectionRequest {

    void get(final ICallback<ITodoTaskListCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	ITodoTaskListCollectionRequest skipToken(String skipToken);
}
