...
/**
 * The interface for the Embedded SIMDevice State Collection Request Builder.
 */
public interface IEmbeddedSIMDeviceStateCollectionRequestBuilder extends IRequestBuilder {
    ...
    IEmbeddedSIMDeviceStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
