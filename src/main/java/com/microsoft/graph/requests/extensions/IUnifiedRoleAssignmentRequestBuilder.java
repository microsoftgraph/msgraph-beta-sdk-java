...
public interface IUnifiedRoleAssignmentRequestBuilder extends IRequestBuilder {
     ...
     */
    IUnifiedRoleAssignmentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUnifiedRoleAssignmentRequest instance
     */
    IUnifiedRoleAssignmentRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
