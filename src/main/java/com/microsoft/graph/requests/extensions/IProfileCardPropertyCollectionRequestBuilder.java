...
public interface IProfileCardPropertyCollectionRequestBuilder extends IRequestBuilder {
    ...
    IProfileCardPropertyCollectionRequest buildRequest();

    IProfileCardPropertyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
