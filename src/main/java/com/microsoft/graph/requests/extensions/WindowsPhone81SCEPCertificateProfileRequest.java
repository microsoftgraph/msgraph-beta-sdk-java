...
public class WindowsPhone81SCEPCertificateProfileRequest extends BaseRequest<WindowsPhone81SCEPCertificateProfile> {
     ...
     */
    public void get(@Nonnull final ICallback<? super WindowsPhone81SCEPCertificateProfile> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super WindowsPhone81SCEPCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final WindowsPhone81SCEPCertificateProfile sourceWindowsPhone81SCEPCertificateProfile, @Nonnull final ICallback<? super WindowsPhone81SCEPCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final WindowsPhone81SCEPCertificateProfile newWindowsPhone81SCEPCertificateProfile, @Nonnull final ICallback<? super WindowsPhone81SCEPCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final WindowsPhone81SCEPCertificateProfile newWindowsPhone81SCEPCertificateProfile, @Nonnull final ICallback<? super WindowsPhone81SCEPCertificateProfile> callback) {
