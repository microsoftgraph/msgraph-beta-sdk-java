...
/**
 * The interface for the Sales Quote Line Collection Page.
 */
public interface ISalesQuoteLineCollectionPage extends IBaseCollectionPage<SalesQuoteLine, ISalesQuoteLineCollectionRequestBuilder> {
}
