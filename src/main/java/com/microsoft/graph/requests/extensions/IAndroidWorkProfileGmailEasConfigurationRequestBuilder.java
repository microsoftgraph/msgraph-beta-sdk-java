...
/**
 * The interface for the Android Work Profile Gmail Eas Configuration Request Builder.
 */
public interface IAndroidWorkProfileGmailEasConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidWorkProfileGmailEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
