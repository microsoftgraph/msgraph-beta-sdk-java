...
public class DeviceCompliancePolicyScheduleActionsForRulesRequestBuilder extends BaseActionRequestBuilder implements IDeviceCompliancePolicyScheduleActionsForRulesRequestBuilder {
     ...
     */
    public DeviceCompliancePolicyScheduleActionsForRulesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<DeviceComplianceScheduledActionForRule> deviceComplianceScheduledActionForRules) {
