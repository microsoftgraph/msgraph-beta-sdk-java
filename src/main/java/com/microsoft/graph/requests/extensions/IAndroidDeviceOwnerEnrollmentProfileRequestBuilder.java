...
/**
 * The interface for the Android Device Owner Enrollment Profile Request Builder.
 */
public interface IAndroidDeviceOwnerEnrollmentProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidDeviceOwnerEnrollmentProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
