 ...
 */
public class EducationSynchronizationProfileResumeRequest extends BaseRequest<Void> {
    /**
     ...
     */
    public EducationSynchronizationProfileResumeRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
