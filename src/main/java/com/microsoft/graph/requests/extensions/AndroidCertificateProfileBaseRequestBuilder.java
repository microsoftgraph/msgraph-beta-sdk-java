...
public class AndroidCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IAndroidCertificateProfileBaseRequestBuilder {
     ...
     */
    public AndroidCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidCertificateProfileBaseRequest instance
     */
    public IAndroidCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
