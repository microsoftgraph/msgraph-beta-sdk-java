 ...
 */
public class LicenseDetailsCollectionResponse implements IJsonBackedObject {

    /**
     * The list of LicenseDetails within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<LicenseDetails> value;
