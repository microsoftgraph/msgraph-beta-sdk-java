...
public class GroupPolicyPresentationDropdownListRequest extends BaseRequest implements IGroupPolicyPresentationDropdownListRequest {
     ...
     */
    public GroupPolicyPresentationDropdownListRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
