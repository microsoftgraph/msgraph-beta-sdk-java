 ...
 */
public class DeviceShellScriptRequestBuilder extends BaseRequestBuilder implements IDeviceShellScriptRequestBuilder {
     ...
     * @return the IDeviceShellScriptRequest instance
     */
    public IDeviceShellScriptRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceShellScriptAssignRequestBuilder assign(final java.util.List<DeviceManagementScriptGroupAssignment> deviceManagementScriptGroupAssignments, final java.util.List<DeviceManagementScriptAssignment> deviceManagementScriptAssignments) {
