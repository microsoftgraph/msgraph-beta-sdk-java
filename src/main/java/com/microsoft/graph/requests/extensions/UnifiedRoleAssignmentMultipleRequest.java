...
public class UnifiedRoleAssignmentMultipleRequest extends BaseRequest implements IUnifiedRoleAssignmentMultipleRequest {
     ...
     */
    public UnifiedRoleAssignmentMultipleRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<UnifiedRoleAssignmentMultiple> callback) {
     ...
     */
    public void delete(final ICallback<UnifiedRoleAssignmentMultiple> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final UnifiedRoleAssignmentMultiple sourceUnifiedRoleAssignmentMultiple, final ICallback<UnifiedRoleAssignmentMultiple> callback) {
