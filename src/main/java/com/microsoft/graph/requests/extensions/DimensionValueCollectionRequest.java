...
import com.microsoft.graph.requests.extensions.IDimensionValueCollectionPage;
 ...
 */
public class DimensionValueCollectionRequest extends BaseCollectionRequest<DimensionValueCollectionResponse, IDimensionValueCollectionPage> implements IDimensionValueCollectionRequest {
     ...
     */
    public DimensionValueCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDimensionValueCollectionPage get() throws ClientException {
        final DimensionValueCollectionResponse response = send();
     ...
     */
    public IDimensionValueCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDimensionValueCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDimensionValueCollectionRequest top(final int value) {
    ...
    public IDimensionValueCollectionPage buildFromResponse(final DimensionValueCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DimensionValueCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DimensionValueCollectionPage page = new DimensionValueCollectionPage(response, builder);
