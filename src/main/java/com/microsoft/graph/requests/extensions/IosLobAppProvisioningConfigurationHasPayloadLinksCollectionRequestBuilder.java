...
public class IosLobAppProvisioningConfigurationHasPayloadLinksCollectionRequestBuilder extends BaseActionRequestBuilder implements IIosLobAppProvisioningConfigurationHasPayloadLinksCollectionRequestBuilder {
     ...
     */
    public IosLobAppProvisioningConfigurationHasPayloadLinksCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<String> payloadIds) {
    ...
    public IIosLobAppProvisioningConfigurationHasPayloadLinksCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
