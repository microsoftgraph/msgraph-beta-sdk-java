 ...
 */
public class EducationSubmissionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EducationSubmission within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationSubmission> value;
