 ...
 */
public class SmsAuthenticationMethodTargetCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SmsAuthenticationMethodTarget within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SmsAuthenticationMethodTarget> value;
