...
/**
 * The interface for the Connection Operation Collection Page.
 */
public interface IConnectionOperationCollectionPage extends IBaseCollectionPage<ConnectionOperation, IConnectionOperationCollectionRequestBuilder> {
}
