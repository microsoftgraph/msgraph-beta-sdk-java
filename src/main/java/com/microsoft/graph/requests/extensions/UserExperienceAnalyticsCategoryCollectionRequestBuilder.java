...
public class UserExperienceAnalyticsCategoryCollectionRequestBuilder extends BaseRequestBuilder implements IUserExperienceAnalyticsCategoryCollectionRequestBuilder {
     ...
     */
    public UserExperienceAnalyticsCategoryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsCategoryCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
