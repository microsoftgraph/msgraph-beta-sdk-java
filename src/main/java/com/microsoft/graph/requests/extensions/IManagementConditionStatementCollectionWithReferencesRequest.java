 ...
 */
public interface IManagementConditionStatementCollectionWithReferencesRequest {

    void get(final ICallback<IManagementConditionStatementCollectionWithReferencesPage> callback);
