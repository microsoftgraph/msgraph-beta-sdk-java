...
/**
 * The interface for the Online Meeting Collection Request.
 */
public interface IOnlineMeetingCollectionRequest extends IHttpRequest {

    void get(final ICallback<? super IOnlineMeetingCollectionPage> callback);
     ...
     * @return the updated request
     */
    IOnlineMeetingCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOnlineMeetingCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOnlineMeetingCollectionRequest skip(final int value);
