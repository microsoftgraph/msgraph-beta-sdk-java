 ...
 */
public class OutlookTaskGroupCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OutlookTaskGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OutlookTaskGroup> value;
