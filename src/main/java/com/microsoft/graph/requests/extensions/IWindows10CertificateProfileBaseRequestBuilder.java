...
/**
 * The interface for the Windows10Certificate Profile Base Request Builder.
 */
public interface IWindows10CertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows10CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
