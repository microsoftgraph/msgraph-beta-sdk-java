...
import com.microsoft.graph.requests.extensions.IEducationSynchronizationProfileCollectionPage;
 ...
 */
public class EducationSynchronizationProfileCollectionRequest extends BaseCollectionRequest<EducationSynchronizationProfileCollectionResponse, IEducationSynchronizationProfileCollectionPage> implements IEducationSynchronizationProfileCollectionRequest {
     ...
     */
    public EducationSynchronizationProfileCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IEducationSynchronizationProfileCollectionPage get() throws ClientException {
        final EducationSynchronizationProfileCollectionResponse response = send();
     ...
     */
    public IEducationSynchronizationProfileCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IEducationSynchronizationProfileCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IEducationSynchronizationProfileCollectionRequest top(final int value) {
    ...
    public IEducationSynchronizationProfileCollectionPage buildFromResponse(final EducationSynchronizationProfileCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new EducationSynchronizationProfileCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final EducationSynchronizationProfileCollectionPage page = new EducationSynchronizationProfileCollectionPage(response, builder);
