...
public class Office365GroupsActivityStorageRequest extends BaseRequest implements IOffice365GroupsActivityStorageRequest {
     ...
     */
    public Office365GroupsActivityStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Office365GroupsActivityStorage> callback) {
     ...
     */
    public void delete(final ICallback<Office365GroupsActivityStorage> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Office365GroupsActivityStorage sourceOffice365GroupsActivityStorage, final ICallback<Office365GroupsActivityStorage> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Office365GroupsActivityStorage newOffice365GroupsActivityStorage, final ICallback<Office365GroupsActivityStorage> callback) {
