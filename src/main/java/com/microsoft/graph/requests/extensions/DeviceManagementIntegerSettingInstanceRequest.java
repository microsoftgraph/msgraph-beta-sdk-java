...
public class DeviceManagementIntegerSettingInstanceRequest extends BaseRequest implements IDeviceManagementIntegerSettingInstanceRequest {
     ...
     */
    public void get(final ICallback<DeviceManagementIntegerSettingInstance> callback) {
     ...
     */
    public void delete(final ICallback<DeviceManagementIntegerSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final DeviceManagementIntegerSettingInstance sourceDeviceManagementIntegerSettingInstance, final ICallback<DeviceManagementIntegerSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final DeviceManagementIntegerSettingInstance newDeviceManagementIntegerSettingInstance, final ICallback<DeviceManagementIntegerSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final DeviceManagementIntegerSettingInstance newDeviceManagementIntegerSettingInstance, final ICallback<DeviceManagementIntegerSettingInstance> callback) {
     ...
     * @return the updated request
     */
     public IDeviceManagementIntegerSettingInstanceRequest filter(final String value) {
