...
public interface IWindows81WifiImportConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindows81WifiImportConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows81WifiImportConfigurationRequest instance
     */
    IWindows81WifiImportConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
