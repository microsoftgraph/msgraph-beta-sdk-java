...
/**
 * The interface for the Windows Phone81Trusted Root Certificate Request Builder.
 */
public interface IWindowsPhone81TrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81TrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81TrustedRootCertificateRequest instance
     */
    IWindowsPhone81TrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
