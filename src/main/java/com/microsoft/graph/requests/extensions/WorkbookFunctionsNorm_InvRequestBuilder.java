...
public class WorkbookFunctionsNorm_InvRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {
    ...
    /**
     * Creates the WorkbookFunctionsNorm_InvRequest
     *
     * @param requestOptions the options for the request
     * @return the WorkbookFunctionsNorm_InvRequest instance
     */
    @Nonnull
    public WorkbookFunctionsNorm_InvRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the WorkbookFunctionsNorm_InvRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the WorkbookFunctionsNorm_InvRequest instance
     */
