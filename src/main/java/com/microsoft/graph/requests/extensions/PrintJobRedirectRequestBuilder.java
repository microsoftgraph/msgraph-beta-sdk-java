...
public class PrintJobRedirectRequestBuilder extends BaseActionRequestBuilder implements IPrintJobRedirectRequestBuilder {
     ...
     */
    public PrintJobRedirectRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String destinationPrinterId) {
     ...
     * @return the IPrintJobRedirectRequest instance
     */
    public IPrintJobRedirectRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
