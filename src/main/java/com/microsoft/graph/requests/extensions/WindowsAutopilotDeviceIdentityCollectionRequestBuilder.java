...
public class WindowsAutopilotDeviceIdentityCollectionRequestBuilder extends BaseRequestBuilder implements IWindowsAutopilotDeviceIdentityCollectionRequestBuilder {
     ...
     */
    public WindowsAutopilotDeviceIdentityCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IWindowsAutopilotDeviceIdentityCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IWindowsAutopilotDeviceIdentityCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
