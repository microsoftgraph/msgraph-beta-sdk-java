...
public class SchedulingGroupCollectionRequestBuilder extends BaseRequestBuilder implements ISchedulingGroupCollectionRequestBuilder {
     ...
     */
    public SchedulingGroupCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ISchedulingGroupCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ISchedulingGroupCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
