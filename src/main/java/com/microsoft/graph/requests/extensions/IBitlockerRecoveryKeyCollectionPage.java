...
/**
 * The interface for the Bitlocker Recovery Key Collection Page.
 */
public interface IBitlockerRecoveryKeyCollectionPage extends IBaseCollectionPage<BitlockerRecoveryKey, IBitlockerRecoveryKeyCollectionRequestBuilder> {
}
