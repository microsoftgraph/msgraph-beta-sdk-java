...
/**
 * The interface for the Mac OSWi Fi Configuration Request Builder.
 */
public interface IMacOSWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSWiFiConfigurationRequest instance
     */
    IMacOSWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
