...
public class TeamsTemplateCollectionRequestBuilder extends BaseRequestBuilder implements ITeamsTemplateCollectionRequestBuilder {
     ...
     */
    public TeamsTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITeamsTemplateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
