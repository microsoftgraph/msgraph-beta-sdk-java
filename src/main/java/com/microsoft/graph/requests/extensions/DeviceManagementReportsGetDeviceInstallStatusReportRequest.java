 ...
 */
public class DeviceManagementReportsGetDeviceInstallStatusReportRequest extends BaseRequest<java.io.InputStream> {
    /**
    ...
    @Nullable
    protected DeviceManagementReportsGetDeviceInstallStatusReportParameterSet body;
    /**
     ...
     */
    @Nonnull
    public DeviceManagementReportsGetDeviceInstallStatusReportRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceManagementReportsGetDeviceInstallStatusReportRequest expand(@Nonnull final String value) {
