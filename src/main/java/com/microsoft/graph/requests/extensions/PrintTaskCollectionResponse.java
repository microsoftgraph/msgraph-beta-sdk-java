 ...
 */
public class PrintTaskCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrintTask within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrintTask> value;
