...
public class DeviceCompliancePolicyWithReferenceRequest extends BaseRequest implements IDeviceCompliancePolicyWithReferenceRequest {
     ...
     */
    public DeviceCompliancePolicyWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, DeviceCompliancePolicy.class);
    }

    public void post(final DeviceCompliancePolicy newDeviceCompliancePolicy, final IJsonBackedObject payload, final ICallback<DeviceCompliancePolicy> callback) {
