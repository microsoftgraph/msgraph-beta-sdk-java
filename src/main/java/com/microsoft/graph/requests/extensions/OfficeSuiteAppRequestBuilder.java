 ...
 */
public class OfficeSuiteAppRequestBuilder extends BaseRequestBuilder implements IOfficeSuiteAppRequestBuilder {
     ...
     */
    public OfficeSuiteAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IOfficeSuiteAppRequest instance
     */
    public IOfficeSuiteAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
