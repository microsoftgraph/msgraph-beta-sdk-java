...
/**
 * The class for the Office Suite App Request Builder.
 */
public class OfficeSuiteAppRequestBuilder extends BaseRequestBuilder<OfficeSuiteApp> {

    /**
     * The request builder for the OfficeSuiteApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public OfficeSuiteAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the OfficeSuiteAppRequest instance
     */
    @Nonnull
    public OfficeSuiteAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public OfficeSuiteAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.OfficeSuiteAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
