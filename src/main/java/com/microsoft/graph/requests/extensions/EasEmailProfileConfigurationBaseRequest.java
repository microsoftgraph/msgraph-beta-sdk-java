...
import com.microsoft.graph.requests.extensions.IEasEmailProfileConfigurationBaseRequest;
import com.microsoft.graph.requests.extensions.EasEmailProfileConfigurationBaseRequest;
...
public class EasEmailProfileConfigurationBaseRequest extends BaseRequest implements IEasEmailProfileConfigurationBaseRequest {
     ...
     * @param requestOptions the options for this request
     */
    public EasEmailProfileConfigurationBaseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
