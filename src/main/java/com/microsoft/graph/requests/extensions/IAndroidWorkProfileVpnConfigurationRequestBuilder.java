...
public interface IAndroidWorkProfileVpnConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidWorkProfileVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileVpnConfigurationRequest instance
     */
    IAndroidWorkProfileVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
