...
public class PrivilegedRoleRequest extends BaseRequest implements IPrivilegedRoleRequest {
     ...
     */
    public PrivilegedRoleRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void delete(final ICallback<PrivilegedRole> callback) {
