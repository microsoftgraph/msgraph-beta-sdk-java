...
public class TodoRequest extends BaseRequest implements ITodoRequest {
     ...
     */
    public void get(final ICallback<Todo> callback) {
     ...
     */
    public void delete(final ICallback<Todo> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Todo sourceTodo, final ICallback<Todo> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Todo newTodo, final ICallback<Todo> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final Todo newTodo, final ICallback<Todo> callback) {
     ...
     * @return the updated request
     */
     public ITodoRequest filter(final String value) {
