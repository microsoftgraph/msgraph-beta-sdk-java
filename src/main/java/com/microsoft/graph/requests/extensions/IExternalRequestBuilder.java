...
/**
 * The interface for the External Request Builder.
 */
public interface IExternalRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IExternalRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IExternalRequest instance
     */
    IExternalRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
