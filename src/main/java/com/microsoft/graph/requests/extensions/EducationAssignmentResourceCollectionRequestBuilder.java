...
public class EducationAssignmentResourceCollectionRequestBuilder extends BaseRequestBuilder implements IEducationAssignmentResourceCollectionRequestBuilder {
     ...
     */
    public EducationAssignmentResourceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IEducationAssignmentResourceCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IEducationAssignmentResourceCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
