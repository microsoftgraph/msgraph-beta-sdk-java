...
public interface IIosExpeditedCheckinConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IIosExpeditedCheckinConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosExpeditedCheckinConfigurationRequest instance
     */
    IIosExpeditedCheckinConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
