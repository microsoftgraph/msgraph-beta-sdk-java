 ...
 */
public class MacOSTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IMacOSTrustedRootCertificateRequestBuilder {
     ...
     */
    public MacOSTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSTrustedRootCertificateRequest instance
     */
    public IMacOSTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
