...
/**
 * The class for the Mac OSTrusted Root Certificate Request Builder.
 */
public class MacOSTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<MacOSTrustedRootCertificate> {
     ...
     */
    public MacOSTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSTrustedRootCertificateRequest instance
     */
    @Nonnull
    public MacOSTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
