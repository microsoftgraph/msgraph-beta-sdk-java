...
import com.microsoft.graph.requests.extensions.AndroidTrustedRootCertificateRequest;
...
public class AndroidTrustedRootCertificateRequest extends BaseRequest implements IAndroidTrustedRootCertificateRequest {
     ...
     */
    public AndroidTrustedRootCertificateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
