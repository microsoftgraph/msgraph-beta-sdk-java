 ...
 */
public class AndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerGeneralDeviceConfiguration> {
     ...
     */
    public AndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerGeneralDeviceConfigurationRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidDeviceOwnerGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
