...
public class AndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerGeneralDeviceConfigurationRequest instance
     */
    public IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
