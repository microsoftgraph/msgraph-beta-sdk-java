 ...
 */
public class AccessReviewScheduleDefinitionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AccessReviewScheduleDefinition within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AccessReviewScheduleDefinition> value;
