...
/**
 * The class for the Picture Collection Response.
 */
public class PictureCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Picture within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Picture> value;
