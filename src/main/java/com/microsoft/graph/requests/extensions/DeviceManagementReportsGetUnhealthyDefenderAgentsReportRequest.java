 ...
 */
public class DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest extends BaseRequest<java.io.InputStream> {
    /**
    ...
    @Nullable
    protected DeviceManagementReportsGetUnhealthyDefenderAgentsReportParameterSet body;
    /**
     ...
     */
    @Nonnull
    public DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest expand(@Nonnull final String value) {
