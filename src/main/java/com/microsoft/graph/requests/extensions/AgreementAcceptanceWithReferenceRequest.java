...
public class AgreementAcceptanceWithReferenceRequest extends BaseRequest implements IAgreementAcceptanceWithReferenceRequest {
     ...
     */
    public AgreementAcceptanceWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, AgreementAcceptance.class);
    }

    public void post(final AgreementAcceptance newAgreementAcceptance, final IJsonBackedObject payload, final ICallback<AgreementAcceptance> callback) {
