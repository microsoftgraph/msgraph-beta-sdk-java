...
public class Office365ActivationCountsRequest extends BaseRequest implements IOffice365ActivationCountsRequest {
     ...
     */
    public Office365ActivationCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Office365ActivationCounts> callback) {
     ...
     */
    public void delete(final ICallback<Office365ActivationCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Office365ActivationCounts sourceOffice365ActivationCounts, final ICallback<Office365ActivationCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Office365ActivationCounts newOffice365ActivationCounts, final ICallback<Office365ActivationCounts> callback) {
