 ...
 */
public class UserFlowLanguageConfigurationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserFlowLanguageConfiguration within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserFlowLanguageConfiguration> value;
