...
public interface IAndroidForWorkVpnConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkVpnConfigurationRequest instance
     */
    IAndroidForWorkVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
