...
/**
 * The class for the User Flow Language Page Collection Response.
 */
public class UserFlowLanguagePageCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserFlowLanguagePage within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserFlowLanguagePage> value;
