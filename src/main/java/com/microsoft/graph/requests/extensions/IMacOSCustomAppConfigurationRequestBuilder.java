...
/**
 * The interface for the Mac OSCustom App Configuration Request Builder.
 */
public interface IMacOSCustomAppConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSCustomAppConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSCustomAppConfigurationRequest instance
     */
    IMacOSCustomAppConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
