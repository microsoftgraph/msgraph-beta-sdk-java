 ...
 */
public class AccessReviewInstanceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AccessReviewInstance within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AccessReviewInstance> value;
