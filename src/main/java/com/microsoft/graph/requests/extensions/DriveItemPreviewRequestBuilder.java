...
public class DriveItemPreviewRequestBuilder extends BaseActionRequestBuilder implements IDriveItemPreviewRequestBuilder {
     ...
     * @param chromeless the chromeless
     * @param allowEdit the allowEdit
     * @param page the page
     * @param zoom the zoom
     */
    public DriveItemPreviewRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String viewer, final Boolean chromeless, final Boolean allowEdit, final String page, final Double zoom) {
        ...
        bodyParams.put("allowEdit", allowEdit);
    ...
    public IDriveItemPreviewRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        ...
        if (hasParameter("viewer")) {
            request.body.viewer = getParameter("viewer");
        }

        if (hasParameter("chromeless")) {
            request.body.chromeless = getParameter("chromeless");
        }

        if (hasParameter("allowEdit")) {
            request.body.allowEdit = getParameter("allowEdit");
        }
