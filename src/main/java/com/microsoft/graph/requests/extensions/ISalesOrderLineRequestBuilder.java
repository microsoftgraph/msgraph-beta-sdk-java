...
/**
 * The interface for the Sales Order Line Request Builder.
 */
public interface ISalesOrderLineRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ISalesOrderLineRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISalesOrderLineRequest instance
     */
    ISalesOrderLineRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
