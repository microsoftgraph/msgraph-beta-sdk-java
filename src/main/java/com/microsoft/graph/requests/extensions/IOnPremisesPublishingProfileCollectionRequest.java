...
/**
 * The interface for the On Premises Publishing Profile Collection Request.
 */
public interface IOnPremisesPublishingProfileCollectionRequest {
     ...
     */
    IOnPremisesPublishingProfileCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOnPremisesPublishingProfileCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOnPremisesPublishingProfileCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOnPremisesPublishingProfileCollectionRequest skip(final int value);
