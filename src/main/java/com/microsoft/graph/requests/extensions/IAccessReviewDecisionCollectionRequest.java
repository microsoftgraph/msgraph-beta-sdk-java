...
/**
 * The interface for the Access Review Decision Collection Request.
 */
public interface IAccessReviewDecisionCollectionRequest {
     ...
     */
    IAccessReviewDecisionCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IAccessReviewDecisionCollectionRequest select(final String value);
