 ...
 */
public class WorkbookFunctionsRadiansRequestBuilder extends BaseActionRequestBuilder<WorkbookFunctionResult> {

    private WorkbookFunctionsRadiansParameterSet body;
    /**
     ...
     */
    public WorkbookFunctionsRadiansRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final WorkbookFunctionsRadiansParameterSet parameters) {
     ...
     */
    @Nonnull
    public WorkbookFunctionsRadiansRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
