...
public class InformationProtectionRequestBuilder extends BaseRequestBuilder<InformationProtection> {
     ...
     */
    @Nonnull
    public InformationProtectionEvaluateLabelsAndPoliciesRequestBuilder evaluateLabelsAndPolicies(@Nonnull final InformationProtectionEvaluateLabelsAndPoliciesParameterSet parameters) {
        return new InformationProtectionEvaluateLabelsAndPoliciesRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.evaluateLabelsAndPolicies"), getClient(), null, parameters);
    }
}
