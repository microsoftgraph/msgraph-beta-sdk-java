...
public interface ISalesCreditMemoLineRequestBuilder extends IRequestBuilder {
     ...
     */
    ISalesCreditMemoLineRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ISalesCreditMemoLineRequest instance
     */
    ISalesCreditMemoLineRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
