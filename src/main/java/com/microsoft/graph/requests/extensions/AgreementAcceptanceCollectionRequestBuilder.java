...
public class AgreementAcceptanceCollectionRequestBuilder extends BaseRequestBuilder implements IAgreementAcceptanceCollectionRequestBuilder {
     ...
     */
    public AgreementAcceptanceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
