 ...
 */
public class AppConsentRequestCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AppConsentRequest within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AppConsentRequest> value;
