...
public class AppleUserInitiatedEnrollmentProfileCollectionRequestBuilder extends BaseRequestBuilder implements IAppleUserInitiatedEnrollmentProfileCollectionRequestBuilder {
     ...
     */
    public AppleUserInitiatedEnrollmentProfileCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IAppleUserInitiatedEnrollmentProfileCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IAppleUserInitiatedEnrollmentProfileCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
