 ...
 */
public class PasswordAuthenticationMethodCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PasswordAuthenticationMethod within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PasswordAuthenticationMethod> value;
