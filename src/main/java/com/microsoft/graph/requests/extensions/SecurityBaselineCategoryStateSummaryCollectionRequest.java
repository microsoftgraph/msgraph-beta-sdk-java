...
import com.microsoft.graph.requests.extensions.ISecurityBaselineCategoryStateSummaryCollectionPage;
 ...
 */
public class SecurityBaselineCategoryStateSummaryCollectionRequest extends BaseCollectionRequest<SecurityBaselineCategoryStateSummaryCollectionResponse, ISecurityBaselineCategoryStateSummaryCollectionPage> implements ISecurityBaselineCategoryStateSummaryCollectionRequest {
     ...
     */
    public SecurityBaselineCategoryStateSummaryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ISecurityBaselineCategoryStateSummaryCollectionPage get() throws ClientException {
        final SecurityBaselineCategoryStateSummaryCollectionResponse response = send();
     ...
     */
    public ISecurityBaselineCategoryStateSummaryCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ISecurityBaselineCategoryStateSummaryCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ISecurityBaselineCategoryStateSummaryCollectionRequest top(final int value) {
    ...
    public ISecurityBaselineCategoryStateSummaryCollectionPage buildFromResponse(final SecurityBaselineCategoryStateSummaryCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new SecurityBaselineCategoryStateSummaryCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final SecurityBaselineCategoryStateSummaryCollectionPage page = new SecurityBaselineCategoryStateSummaryCollectionPage(response, builder);
