...
public interface IGroupPolicyPresentationCollectionRequestBuilder extends IRequestBuilder {
    ...
    IGroupPolicyPresentationCollectionRequest buildRequest();

    IGroupPolicyPresentationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
