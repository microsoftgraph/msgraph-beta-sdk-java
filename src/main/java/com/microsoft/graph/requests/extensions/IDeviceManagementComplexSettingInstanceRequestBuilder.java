...
/**
 * The interface for the Device Management Complex Setting Instance Request Builder.
 */
public interface IDeviceManagementComplexSettingInstanceRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceManagementComplexSettingInstanceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
