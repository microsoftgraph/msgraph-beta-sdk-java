...
/**
 * The interface for the Ios Trusted Root Certificate Request Builder.
 */
public interface IIosTrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosTrustedRootCertificateRequest instance
     */
    IIosTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
