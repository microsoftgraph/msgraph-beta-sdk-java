...
import com.microsoft.graph.requests.extensions.IPolicySetCollectionPage;
 ...
 */
public class PolicySetCollectionRequest extends BaseCollectionRequest<PolicySetCollectionResponse, IPolicySetCollectionPage> implements IPolicySetCollectionRequest {
     ...
     */
    public PolicySetCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IPolicySetCollectionPage get() throws ClientException {
        final PolicySetCollectionResponse response = send();
     ...
     */
    public IPolicySetCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPolicySetCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPolicySetCollectionRequest top(final int value) {
    ...
    public IPolicySetCollectionPage buildFromResponse(final PolicySetCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new PolicySetCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PolicySetCollectionPage page = new PolicySetCollectionPage(response, builder);
