...
public class EmbeddedSIMActivationCodePoolAssignmentRequest extends BaseRequest implements IEmbeddedSIMActivationCodePoolAssignmentRequest {
     ...
     */
    public EmbeddedSIMActivationCodePoolAssignmentRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
