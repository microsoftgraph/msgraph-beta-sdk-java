 ...
 */
public class OrganizationalBrandingPropertiesBannerLogoStreamRequest extends BaseStreamRequest<OrganizationalBrandingProperties> {
     ...
     */
    public OrganizationalBrandingPropertiesBannerLogoStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
