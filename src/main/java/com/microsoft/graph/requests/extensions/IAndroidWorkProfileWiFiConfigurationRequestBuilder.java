...
/**
 * The interface for the Android Work Profile Wi Fi Configuration Request Builder.
 */
public interface IAndroidWorkProfileWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidWorkProfileWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileWiFiConfigurationRequest instance
     */
    IAndroidWorkProfileWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
