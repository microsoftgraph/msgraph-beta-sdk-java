...
public class PrintConnectorCollectionRequest extends BaseCollectionRequest<PrintConnectorCollectionResponse, IPrintConnectorCollectionPage> implements IPrintConnectorCollectionRequest {
     ...
     */
    public PrintConnectorCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IPrintConnectorCollectionRequest filter(final String value) {
