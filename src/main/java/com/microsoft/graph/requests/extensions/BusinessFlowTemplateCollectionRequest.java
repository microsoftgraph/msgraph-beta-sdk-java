...
public class BusinessFlowTemplateCollectionRequest extends BaseCollectionRequest<BusinessFlowTemplateCollectionResponse, IBusinessFlowTemplateCollectionPage> implements IBusinessFlowTemplateCollectionRequest {
    ...
    public void get(final ICallback<? super IBusinessFlowTemplateCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IBusinessFlowTemplateCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IBusinessFlowTemplateCollectionRequest orderBy(final String value) {
