...
import com.microsoft.graph.requests.extensions.IAppleExpeditedCheckinConfigurationBaseRequest;
import com.microsoft.graph.requests.extensions.AppleExpeditedCheckinConfigurationBaseRequest;
...
public class AppleExpeditedCheckinConfigurationBaseRequest extends BaseRequest implements IAppleExpeditedCheckinConfigurationBaseRequest {
     ...
     * @param requestOptions the options for this request
     */
    public AppleExpeditedCheckinConfigurationBaseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<AppleExpeditedCheckinConfigurationBase> callback) {
     ...
     */
    public void delete(final ICallback<AppleExpeditedCheckinConfigurationBase> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AppleExpeditedCheckinConfigurationBase sourceAppleExpeditedCheckinConfigurationBase, final ICallback<AppleExpeditedCheckinConfigurationBase> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final AppleExpeditedCheckinConfigurationBase newAppleExpeditedCheckinConfigurationBase, final ICallback<AppleExpeditedCheckinConfigurationBase> callback) {
