...
public class AppleExpeditedCheckinConfigurationBaseRequest extends BaseRequest implements IAppleExpeditedCheckinConfigurationBaseRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final AppleExpeditedCheckinConfigurationBase newAppleExpeditedCheckinConfigurationBase, final ICallback<AppleExpeditedCheckinConfigurationBase> callback) {
     ...
     * @return the updated request
     */
     public IAppleExpeditedCheckinConfigurationBaseRequest filter(final String value) {
