...
public class EducationAssignmentCollectionRequest extends BaseCollectionRequest<EducationAssignmentCollectionResponse, IEducationAssignmentCollectionPage> implements IEducationAssignmentCollectionRequest {
     ...
     */
    public EducationAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public void get(final ICallback<? super IEducationAssignmentCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IEducationAssignmentCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IEducationAssignmentCollectionRequest orderBy(final String value) {
