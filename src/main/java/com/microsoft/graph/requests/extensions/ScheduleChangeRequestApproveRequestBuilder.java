...
public class ScheduleChangeRequestApproveRequestBuilder extends BaseActionRequestBuilder implements IScheduleChangeRequestApproveRequestBuilder {
     ...
     */
    public ScheduleChangeRequestApproveRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String message) {
     ...
     */
    public IScheduleChangeRequestApproveRequest buildRequest() {
     ...
     * @return the IScheduleChangeRequestApproveRequest instance
     */
    public IScheduleChangeRequestApproveRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
