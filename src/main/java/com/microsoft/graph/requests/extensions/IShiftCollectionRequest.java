...
/**
 * The interface for the Shift Collection Request.
 */
public interface IShiftCollectionRequest {
     ...
     */
    IShiftCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IShiftCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IShiftCollectionRequest top(final int value);
