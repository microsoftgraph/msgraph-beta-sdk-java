...
public class EditionUpgradeConfigurationRequestBuilder extends BaseRequestBuilder implements IEditionUpgradeConfigurationRequestBuilder {
     ...
     */
    public IEditionUpgradeConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IEditionUpgradeConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.EditionUpgradeConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
