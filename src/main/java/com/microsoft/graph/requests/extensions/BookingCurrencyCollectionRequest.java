 ...
 */
public class BookingCurrencyCollectionRequest extends BaseCollectionRequest<BookingCurrencyCollectionResponse, IBookingCurrencyCollectionPage> implements IBookingCurrencyCollectionRequest {
    ...
    public void get(final ICallback<? super IBookingCurrencyCollectionPage> callback) {
    ...
    public IBookingCurrencyCollectionPage get() throws ClientException {
        final BookingCurrencyCollectionResponse response = send();
        return buildFromResponse(response);
    }

    public void post(final BookingCurrency newBookingCurrency, final ICallback<? super BookingCurrency> callback) {
     ...
     * @return the updated request
     */
    public IBookingCurrencyCollectionRequest orderBy(final String value) {
    ...
    public IBookingCurrencyCollectionPage buildFromResponse(final BookingCurrencyCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new BookingCurrencyCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final BookingCurrencyCollectionPage page = new BookingCurrencyCollectionPage(response, builder);
