 ...
 */
public class MacOSPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IMacOSPkcsCertificateProfileRequestBuilder {
     ...
     */
    public MacOSPkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSPkcsCertificateProfileRequest instance
     */
    public IMacOSPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
