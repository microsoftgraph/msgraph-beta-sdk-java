...
/**
 * The class for the Group Policy Operation Collection Response.
 */
public class GroupPolicyOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of GroupPolicyOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GroupPolicyOperation> value;
