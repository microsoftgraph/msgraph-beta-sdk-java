...
/**
 * The interface for the Education Outcome Collection Page.
 */
public interface IEducationOutcomeCollectionPage extends IBaseCollectionPage<EducationOutcome, IEducationOutcomeCollectionRequestBuilder> {
}
