 ...
 */
public class MacOSGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSGeneralDeviceConfigurationRequestBuilder {
     ...
     */
    public MacOSGeneralDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IMacOSGeneralDeviceConfigurationRequest instance
     */
    public IMacOSGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
