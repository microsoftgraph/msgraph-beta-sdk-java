...
public class AndroidDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerEnterpriseWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerEnterpriseWiFiConfigurationRequest instance
     */
    public IAndroidDeviceOwnerEnterpriseWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
