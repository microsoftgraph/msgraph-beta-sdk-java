...
/**
 * The interface for the Apple Vpn Configuration Request Builder.
 */
public interface IAppleVpnConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAppleVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAppleVpnConfigurationRequest instance
     */
    IAppleVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
