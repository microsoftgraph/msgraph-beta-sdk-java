 ...
 */
public class UnifiedRoleEligibilityScheduleInstanceFilterByCurrentUserCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleEligibilityScheduleInstance> value;
