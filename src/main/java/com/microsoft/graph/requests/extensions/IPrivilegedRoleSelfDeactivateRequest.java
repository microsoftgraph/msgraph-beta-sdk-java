...
/**
 * The interface for the Privileged Role Self Deactivate Request.
 */
public interface IPrivilegedRoleSelfDeactivateRequest extends IHttpRequest {
     ...
     */
    IPrivilegedRoleSelfDeactivateRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrivilegedRoleSelfDeactivateRequest expand(final String value);
