...
public class TargetedManagedAppConfigurationCollectionRequestBuilder extends BaseRequestBuilder implements ITargetedManagedAppConfigurationCollectionRequestBuilder {
    ...
    public ITargetedManagedAppConfigurationHasPayloadLinksCollectionRequestBuilder hasPayloadLinks(final java.util.List<String> payloadIds) {
        return new TargetedManagedAppConfigurationHasPayloadLinksCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.hasPayloadLinks"), getClient(), null, payloadIds);
    }
}
