 ...
 */
public class IosWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IIosWiFiConfigurationRequestBuilder {
     ...
     */
    public IosWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIosWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosWiFiConfigurationRequest instance
     */
    public IIosWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
