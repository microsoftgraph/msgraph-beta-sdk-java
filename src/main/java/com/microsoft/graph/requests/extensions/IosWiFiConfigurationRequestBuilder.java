...
/**
 * The class for the Ios Wi Fi Configuration Request Builder.
 */
public class IosWiFiConfigurationRequestBuilder extends BaseRequestBuilder<IosWiFiConfiguration> {

    /**
     * The request builder for the IosWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public IosWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosWiFiConfigurationRequest instance
     */
    @Nonnull
    public IosWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
