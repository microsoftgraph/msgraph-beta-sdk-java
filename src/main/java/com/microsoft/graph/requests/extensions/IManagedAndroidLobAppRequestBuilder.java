 ...
 */
public interface IManagedAndroidLobAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagedAndroidLobAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
