...
/**
 * The class for the Exact Match Data Store Collection Response.
 */
public class ExactMatchDataStoreCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ExactMatchDataStore within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ExactMatchDataStore> value;
