...
/**
 * The class for the Allowed Data Location Collection Response.
 */
public class AllowedDataLocationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AllowedDataLocation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AllowedDataLocation> value;
