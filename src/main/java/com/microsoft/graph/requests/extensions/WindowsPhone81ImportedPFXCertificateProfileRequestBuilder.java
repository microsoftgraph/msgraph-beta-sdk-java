...
public class WindowsPhone81ImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81ImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public WindowsPhone81ImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsPhone81ImportedPFXCertificateProfileRequest instance
     */
    public IWindowsPhone81ImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
