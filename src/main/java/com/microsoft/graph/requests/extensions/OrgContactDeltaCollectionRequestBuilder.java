...
public class OrgContactDeltaCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IOrgContactDeltaCollectionRequestBuilder {
     ...
     */
    public OrgContactDeltaCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IOrgContactDeltaCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
