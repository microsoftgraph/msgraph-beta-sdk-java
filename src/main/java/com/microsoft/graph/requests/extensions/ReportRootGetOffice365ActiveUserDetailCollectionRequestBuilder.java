...
public class ReportRootGetOffice365ActiveUserDetailCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetOffice365ActiveUserDetailCollectionRequestBuilder {
     ...
     * @param date the date
     */
    public ReportRootGetOffice365ActiveUserDetailCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.microsoft.graph.models.extensions.DateOnly date) {
     ...
     */
    public ReportRootGetOffice365ActiveUserDetailCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     	 if(period!=null){
    ...
    public IReportRootGetOffice365ActiveUserDetailCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
