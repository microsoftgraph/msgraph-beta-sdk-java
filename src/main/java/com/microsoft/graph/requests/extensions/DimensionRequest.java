...
public class DimensionRequest extends BaseRequest implements IDimensionRequest {
     ...
     */
    public DimensionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Dimension> callback) {
     ...
     */
    public void delete(final ICallback<Dimension> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Dimension sourceDimension, final ICallback<Dimension> callback) {
