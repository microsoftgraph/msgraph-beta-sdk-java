...
public class WindowsPhone81TrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81TrustedRootCertificateRequestBuilder {
     ...
     */
    public WindowsPhone81TrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsPhone81TrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsPhone81TrustedRootCertificateRequest instance
     */
    public IWindowsPhone81TrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
