 ...
 */
public class WindowsPhone81TrustedRootCertificateRequestBuilder extends BaseRequestBuilder<WindowsPhone81TrustedRootCertificate> {
     ...
     */
    public WindowsPhone81TrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81TrustedRootCertificateRequest instance
     */
    @Nonnull
    public WindowsPhone81TrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81TrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsPhone81TrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
