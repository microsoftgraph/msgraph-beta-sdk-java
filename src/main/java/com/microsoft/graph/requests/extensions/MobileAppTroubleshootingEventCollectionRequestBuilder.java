...
public class MobileAppTroubleshootingEventCollectionRequestBuilder extends BaseRequestBuilder implements IMobileAppTroubleshootingEventCollectionRequestBuilder {
     ...
     */
    public MobileAppTroubleshootingEventCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMobileAppTroubleshootingEventCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
