...
/**
 * The interface for the Windows Information Protection Device Registration Reference Request.
 */
public interface IWindowsInformationProtectionDeviceRegistrationReferenceRequest extends IHttpRequest {
     ...
     */
    IWindowsInformationProtectionDeviceRegistrationReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IWindowsInformationProtectionDeviceRegistrationReferenceRequest expand(final String value);
     ...
     */
    WindowsInformationProtectionDeviceRegistration put(WindowsInformationProtectionDeviceRegistration srcWindowsInformationProtectionDeviceRegistration) throws ClientException;
}
