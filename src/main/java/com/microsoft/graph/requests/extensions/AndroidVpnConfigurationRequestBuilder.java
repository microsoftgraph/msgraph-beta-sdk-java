 ...
 */
public class AndroidVpnConfigurationRequestBuilder extends BaseRequestBuilder<AndroidVpnConfiguration> {
     ...
     */
    public AndroidVpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidVpnConfigurationRequest instance
     */
    @Nonnull
    public AndroidVpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidVpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
