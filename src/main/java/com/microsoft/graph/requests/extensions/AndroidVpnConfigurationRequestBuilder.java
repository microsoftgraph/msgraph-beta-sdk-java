...
public class AndroidVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidVpnConfigurationRequestBuilder {
     ...
     */
    public AndroidVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidVpnConfigurationRequest instance
     */
    public IAndroidVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
