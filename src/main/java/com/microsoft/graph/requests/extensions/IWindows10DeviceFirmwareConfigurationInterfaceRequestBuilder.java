...
/**
 * The interface for the Windows10Device Firmware Configuration Interface Request Builder.
 */
public interface IWindows10DeviceFirmwareConfigurationInterfaceRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IWindows10DeviceFirmwareConfigurationInterfaceRequest instance
     */
    IWindows10DeviceFirmwareConfigurationInterfaceRequest buildRequest();
     ...
     * @return the IWindows10DeviceFirmwareConfigurationInterfaceRequest instance
     */
    IWindows10DeviceFirmwareConfigurationInterfaceRequest buildRequest(final java.util.List<? extends Option> requestOptions);
