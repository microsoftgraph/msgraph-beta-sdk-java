...
public interface IWindows10DeviceFirmwareConfigurationInterfaceRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindows10DeviceFirmwareConfigurationInterfaceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows10DeviceFirmwareConfigurationInterfaceRequest instance
     */
    IWindows10DeviceFirmwareConfigurationInterfaceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
