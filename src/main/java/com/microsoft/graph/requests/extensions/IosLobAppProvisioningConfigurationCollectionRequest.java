...
public class IosLobAppProvisioningConfigurationCollectionRequest extends BaseCollectionRequest<IosLobAppProvisioningConfigurationCollectionResponse, IIosLobAppProvisioningConfigurationCollectionPage> implements IIosLobAppProvisioningConfigurationCollectionRequest {
     ...
     * @return the updated request
     */
    public IIosLobAppProvisioningConfigurationCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IIosLobAppProvisioningConfigurationCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IIosLobAppProvisioningConfigurationCollectionRequest)this;
    }
