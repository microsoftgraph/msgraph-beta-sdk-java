 ...
 */
public class ReportRootGetYammerDeviceUsageDistributionUserCountsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<YammerDeviceUsageDistributionUserCounts> value;
