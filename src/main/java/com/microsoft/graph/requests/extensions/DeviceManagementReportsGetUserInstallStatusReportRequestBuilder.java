 ...
 */
public class DeviceManagementReportsGetUserInstallStatusReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetUserInstallStatusReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetUserInstallStatusReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetUserInstallStatusReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetUserInstallStatusReportRequest instance
     */
    public IDeviceManagementReportsGetUserInstallStatusReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
