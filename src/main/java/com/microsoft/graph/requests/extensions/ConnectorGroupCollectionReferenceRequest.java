...
public class ConnectorGroupCollectionReferenceRequest extends BaseCollectionRequest<ConnectorGroupCollectionResponse, IConnectorGroupCollectionPage> implements IConnectorGroupCollectionReferenceRequest {
     ...
     */
    public ConnectorGroupCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
