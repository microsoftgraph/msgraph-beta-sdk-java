...
/**
 * The class for the Android Work Profile Scep Certificate Profile Request Builder.
 */
public class AndroidWorkProfileScepCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileScepCertificateProfile> {

    /**
     * The request builder for the AndroidWorkProfileScepCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidWorkProfileScepCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileScepCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidWorkProfileScepCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileScepCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
