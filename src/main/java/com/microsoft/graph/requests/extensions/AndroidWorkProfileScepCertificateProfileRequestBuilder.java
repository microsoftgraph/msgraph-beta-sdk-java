 ...
 */
public class AndroidWorkProfileScepCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileScepCertificateProfileRequestBuilder {
     ...
     */
    public AndroidWorkProfileScepCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidWorkProfileScepCertificateProfileRequest instance
     */
    public IAndroidWorkProfileScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
