...
public class EdiscoveryCaseReopenRequestBuilder extends BaseActionRequestBuilder implements IEdiscoveryCaseReopenRequestBuilder {
     ...
     */
    public EdiscoveryCaseReopenRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IEdiscoveryCaseReopenRequest instance
     */
    public IEdiscoveryCaseReopenRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
