 ...
 */
public class DeviceConfigurationStateCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceConfigurationStateCollectionRequestBuilder {
     ...
     */
    public DeviceConfigurationStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
