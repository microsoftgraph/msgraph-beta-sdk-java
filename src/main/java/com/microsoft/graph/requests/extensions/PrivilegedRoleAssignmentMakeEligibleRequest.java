...
public class PrivilegedRoleAssignmentMakeEligibleRequest extends BaseRequest implements IPrivilegedRoleAssignmentMakeEligibleRequest {
     ...
     */
    public PrivilegedRoleAssignmentMakeEligibleRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
