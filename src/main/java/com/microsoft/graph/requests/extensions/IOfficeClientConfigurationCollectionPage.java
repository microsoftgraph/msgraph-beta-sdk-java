...
/**
 * The interface for the Office Client Configuration Collection Page.
 */
public interface IOfficeClientConfigurationCollectionPage extends IBaseCollectionPage<OfficeClientConfiguration, IOfficeClientConfigurationCollectionRequestBuilder> {
}
