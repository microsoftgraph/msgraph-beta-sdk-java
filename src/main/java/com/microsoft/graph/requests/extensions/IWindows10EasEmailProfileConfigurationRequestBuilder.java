...
/**
 * The interface for the Windows10Eas Email Profile Configuration Request Builder.
 */
public interface IWindows10EasEmailProfileConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows10EasEmailProfileConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
