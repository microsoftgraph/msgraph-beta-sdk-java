...
public class ClaimsMappingPolicyWithReferenceRequestBuilder extends BaseRequestBuilder implements IClaimsMappingPolicyWithReferenceRequestBuilder {
     ...
     */
    public ClaimsMappingPolicyWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IClaimsMappingPolicyWithReferenceRequest buildRequest() {
     ...
     * @return the IClaimsMappingPolicyWithReferenceRequest instance
     */
    public IClaimsMappingPolicyWithReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
