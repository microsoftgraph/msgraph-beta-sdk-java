...
/**
 * The interface for the Item Activity OLDRequest Builder.
 */
public interface IItemActivityOLDRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IItemActivityOLDRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IItemActivityOLDRequest instance
     */
    IItemActivityOLDRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
