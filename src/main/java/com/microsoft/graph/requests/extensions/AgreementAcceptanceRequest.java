...
import com.microsoft.graph.requests.extensions.IAgreementAcceptanceRequest;
import com.microsoft.graph.requests.extensions.AgreementAcceptanceRequest;
...
public class AgreementAcceptanceRequest extends BaseRequest implements IAgreementAcceptanceRequest {
     ...
     */
    public AgreementAcceptanceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
