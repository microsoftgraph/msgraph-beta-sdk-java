...
public interface IWindows10GeneralConfigurationRequestBuilder extends IRequestBuilder {
    ...
    IWindowsPrivacyDataAccessControlItemCollectionRequestBuilder privacyAccessControls();

    IWindowsPrivacyDataAccessControlItemRequestBuilder privacyAccessControls(final String id);
