...
/**
 * The class for the Site Page Collection Response.
 */
public class SitePageCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SitePage within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SitePage> value;
