...
public class WindowsKioskConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsKioskConfigurationRequestBuilder {
     ...
     */
    public WindowsKioskConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsKioskConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsKioskConfigurationRequest instance
     */
    public IWindowsKioskConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsKioskConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
