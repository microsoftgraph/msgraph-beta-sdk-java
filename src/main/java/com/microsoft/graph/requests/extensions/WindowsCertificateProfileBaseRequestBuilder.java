...
public class WindowsCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IWindowsCertificateProfileBaseRequestBuilder {
     ...
     */
    public WindowsCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsCertificateProfileBaseRequest instance
     */
    public IWindowsCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
