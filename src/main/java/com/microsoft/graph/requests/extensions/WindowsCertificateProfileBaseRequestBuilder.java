...
/**
 * The class for the Windows Certificate Profile Base Request Builder.
 */
public class WindowsCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<WindowsCertificateProfileBase> {
     ...
     */
    public WindowsCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsCertificateProfileBaseRequest instance
     */
    @Nonnull
    public WindowsCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
