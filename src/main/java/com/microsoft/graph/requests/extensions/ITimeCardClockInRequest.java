...
/**
 * The interface for the Time Card Clock In Request.
 */
public interface ITimeCardClockInRequest extends IHttpRequest {
     ...
     */
    ITimeCardClockInRequest select(final String value) ;
     ...
     * @return the updated request
     */
    ITimeCardClockInRequest top(final int value);
     ...
     * @return the updated request
     */
    ITimeCardClockInRequest expand(final String value);
