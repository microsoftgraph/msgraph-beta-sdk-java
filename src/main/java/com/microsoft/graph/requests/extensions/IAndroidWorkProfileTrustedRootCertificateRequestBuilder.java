...
/**
 * The interface for the Android Work Profile Trusted Root Certificate Request Builder.
 */
public interface IAndroidWorkProfileTrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidWorkProfileTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileTrustedRootCertificateRequest instance
     */
    IAndroidWorkProfileTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
