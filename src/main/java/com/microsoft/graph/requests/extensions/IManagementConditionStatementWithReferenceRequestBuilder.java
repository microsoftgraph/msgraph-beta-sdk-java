...
/**
 * The interface for the Management Condition Statement With Reference Request Builder.
 */
public interface IManagementConditionStatementWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IManagementConditionStatementWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IManagementConditionStatementWithReferenceRequest instance
     */
    IManagementConditionStatementWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IManagementConditionStatementReferenceRequestBuilder reference();
