...
import com.microsoft.graph.requests.extensions.WorkbookTableColumnDataBodyRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.IWorkbookTableColumnHeaderRowRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.WorkbookTableColumnHeaderRowRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.IWorkbookTableColumnRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.WorkbookTableColumnRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.IWorkbookTableColumnTotalRowRangeRequestBuilder;
import com.microsoft.graph.requests.extensions.WorkbookTableColumnTotalRowRangeRequestBuilder;
...
public class WorkbookTableColumnRequestBuilder extends BaseRequestBuilder implements IWorkbookTableColumnRequestBuilder {
     ...
     */
    public WorkbookTableColumnRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
