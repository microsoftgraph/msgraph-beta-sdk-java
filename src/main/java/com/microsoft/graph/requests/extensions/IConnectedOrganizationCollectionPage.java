...
/**
 * The interface for the Connected Organization Collection Page.
 */
public interface IConnectedOrganizationCollectionPage extends IBaseCollectionPage<ConnectedOrganization, IConnectedOrganizationCollectionRequestBuilder> {
}
