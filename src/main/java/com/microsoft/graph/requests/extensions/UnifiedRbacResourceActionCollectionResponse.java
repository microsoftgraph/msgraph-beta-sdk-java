...
/**
 * The class for the Unified Rbac Resource Action Collection Response.
 */
public class UnifiedRbacResourceActionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRbacResourceAction within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRbacResourceAction> value;
