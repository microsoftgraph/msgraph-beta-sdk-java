 ...
 */
public class ApplicationTemplateCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ApplicationTemplate within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ApplicationTemplate> value;
