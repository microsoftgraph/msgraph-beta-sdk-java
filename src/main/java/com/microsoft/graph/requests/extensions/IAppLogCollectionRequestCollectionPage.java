...
/**
 * The interface for the App Log Collection Request Collection Page.
 */
public interface IAppLogCollectionRequestCollectionPage extends IBaseCollectionPage<AppLogCollectionRequest, IAppLogCollectionRequestCollectionRequestBuilder> {
}
