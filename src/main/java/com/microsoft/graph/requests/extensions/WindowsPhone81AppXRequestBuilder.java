...
public class WindowsPhone81AppXRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81AppXRequestBuilder {
     ...
     */
    public WindowsPhone81AppXRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsPhone81AppXRequest instance
     */
    public IWindowsPhone81AppXRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
