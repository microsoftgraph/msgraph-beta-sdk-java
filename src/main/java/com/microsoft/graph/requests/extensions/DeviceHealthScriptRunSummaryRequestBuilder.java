...
public class DeviceHealthScriptRunSummaryRequestBuilder extends BaseRequestBuilder implements IDeviceHealthScriptRunSummaryRequestBuilder {
     ...
     */
    public DeviceHealthScriptRunSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IDeviceHealthScriptRunSummaryRequest buildRequest() {
