...
/**
 * The interface for the Device Management Script User State Request Builder.
 */
public interface IDeviceManagementScriptUserStateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceManagementScriptUserStateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
