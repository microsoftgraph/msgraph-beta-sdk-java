 ...
 */
public class OnlineMeetingRecordingStreamRequest extends BaseStreamRequest<OnlineMeeting> implements IOnlineMeetingRecordingStreamRequest {
     ...
     */
    public OnlineMeetingRecordingStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
