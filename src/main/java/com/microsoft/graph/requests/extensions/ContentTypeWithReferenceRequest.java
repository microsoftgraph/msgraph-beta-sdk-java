 ...
 */
public class ContentTypeWithReferenceRequest extends BaseRequest implements IContentTypeWithReferenceRequest {
     ...
     */
    public ContentTypeWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ContentType.class);
    }

    public void post(final ContentType newContentType, final IJsonBackedObject payload, final ICallback<? super ContentType> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public ContentType post(final ContentType newContentType, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IContentTypeWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IContentTypeWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IContentTypeWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (ContentTypeWithReferenceRequest)this;
    }
}
