...
public class OnPremisesAgentGroupCollectionRequest extends BaseCollectionRequest<OnPremisesAgentGroupCollectionResponse, IOnPremisesAgentGroupCollectionPage> implements IOnPremisesAgentGroupCollectionRequest {
     ...
     */
    public OnPremisesAgentGroupCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
