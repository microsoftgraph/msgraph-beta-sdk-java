 ...
 */
public class WorkPositionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WorkPosition within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WorkPosition> value;
