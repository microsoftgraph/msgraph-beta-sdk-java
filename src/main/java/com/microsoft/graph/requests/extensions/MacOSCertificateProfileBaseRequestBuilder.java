...
/**
 * The class for the Mac OSCertificate Profile Base Request Builder.
 */
public class MacOSCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<MacOSCertificateProfileBase> {
     ...
     */
    public MacOSCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSCertificateProfileBaseRequest instance
     */
    @Nonnull
    public MacOSCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
