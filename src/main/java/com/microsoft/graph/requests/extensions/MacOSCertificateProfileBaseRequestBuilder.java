...
public class MacOSCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IMacOSCertificateProfileBaseRequestBuilder {
     ...
     */
    public MacOSCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IMacOSCertificateProfileBaseRequest instance
     */
    public IMacOSCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
