...
/**
 * The class for the Windows Wifi Configuration Request Builder.
 */
public class WindowsWifiConfigurationRequestBuilder extends BaseRequestBuilder<WindowsWifiConfiguration> {

    /**
     * The request builder for the WindowsWifiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsWifiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsWifiConfigurationRequest instance
     */
    @Nonnull
    public WindowsWifiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsWifiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsWifiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
