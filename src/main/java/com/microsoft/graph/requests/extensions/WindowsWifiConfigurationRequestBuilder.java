...
public class WindowsWifiConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsWifiConfigurationRequestBuilder {
     ...
     */
    public WindowsWifiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsWifiConfigurationRequest instance
     */
    public IWindowsWifiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
