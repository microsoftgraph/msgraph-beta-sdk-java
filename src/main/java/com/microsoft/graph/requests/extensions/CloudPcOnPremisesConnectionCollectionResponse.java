...
/**
 * The class for the Cloud Pc On Premises Connection Collection Response.
 */
public class CloudPcOnPremisesConnectionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CloudPcOnPremisesConnection within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CloudPcOnPremisesConnection> value;
