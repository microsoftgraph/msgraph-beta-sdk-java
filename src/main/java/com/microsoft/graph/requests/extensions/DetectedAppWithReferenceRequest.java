...
public class DetectedAppWithReferenceRequest extends BaseRequest implements IDetectedAppWithReferenceRequest {
     ...
     */
    public DetectedAppWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, DetectedApp.class);
    }

    public void post(final DetectedApp newDetectedApp, final IJsonBackedObject payload, final ICallback<DetectedApp> callback) {
