...
public class Windows10ImportedPFXCertificateProfileRequest extends BaseRequest implements IWindows10ImportedPFXCertificateProfileRequest {
     ...
     */
    public Windows10ImportedPFXCertificateProfileRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<Windows10ImportedPFXCertificateProfile> callback) {
     ...
     */
    public void delete(final ICallback<Windows10ImportedPFXCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final Windows10ImportedPFXCertificateProfile sourceWindows10ImportedPFXCertificateProfile, final ICallback<Windows10ImportedPFXCertificateProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final Windows10ImportedPFXCertificateProfile newWindows10ImportedPFXCertificateProfile, final ICallback<Windows10ImportedPFXCertificateProfile> callback) {
