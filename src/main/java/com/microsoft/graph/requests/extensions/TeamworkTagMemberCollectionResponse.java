 ...
 */
public class TeamworkTagMemberCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TeamworkTagMember within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TeamworkTagMember> value;
