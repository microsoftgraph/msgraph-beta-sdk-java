 ...
 */
public class DepOnboardingSettingUnshareForSchoolDataSyncServiceRequest extends BaseRequest<Void> {
    /**
     ...
     */
    public DepOnboardingSettingUnshareForSchoolDataSyncServiceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
