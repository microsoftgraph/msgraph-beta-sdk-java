...
public class ImportedDeviceIdentityResultRequest extends BaseRequest implements IImportedDeviceIdentityResultRequest {
     ...
     */
    public ImportedDeviceIdentityResultRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<ImportedDeviceIdentityResult> callback) {
     ...
     */
    public void delete(final ICallback<ImportedDeviceIdentityResult> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final ImportedDeviceIdentityResult sourceImportedDeviceIdentityResult, final ICallback<ImportedDeviceIdentityResult> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final ImportedDeviceIdentityResult newImportedDeviceIdentityResult, final ICallback<ImportedDeviceIdentityResult> callback) {
