...
public class CallRejectRequestBuilder extends BaseActionRequestBuilder implements ICallRejectRequestBuilder {
     ...
     */
    public CallRejectRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final RejectReason reason, final String callbackUri) {
     ...
     * @return the ICallRejectRequest instance
     */
    public ICallRejectRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
