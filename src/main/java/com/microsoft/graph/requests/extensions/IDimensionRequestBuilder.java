...
/**
 * The interface for the Dimension Request Builder.
 */
public interface IDimensionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDimensionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDimensionRequest instance
     */
    IDimensionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
