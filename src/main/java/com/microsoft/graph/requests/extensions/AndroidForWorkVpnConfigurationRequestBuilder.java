 ...
 */
public class AndroidForWorkVpnConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkVpnConfiguration> {
     ...
     */
    public AndroidForWorkVpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkVpnConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkVpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkVpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
