...
public class AndroidForWorkVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkVpnConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidForWorkVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkVpnConfigurationRequest instance
     */
    public IAndroidForWorkVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
