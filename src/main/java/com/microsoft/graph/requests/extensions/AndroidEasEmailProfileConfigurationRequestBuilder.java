 ...
 */
public class AndroidEasEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder<AndroidEasEmailProfileConfiguration> {
     ...
     */
    public AndroidEasEmailProfileConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidEasEmailProfileConfigurationRequest instance
     */
    @Nonnull
    public AndroidEasEmailProfileConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidEasEmailProfileConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseWithReferenceRequestBuilder smimeSigningCertificate() {
