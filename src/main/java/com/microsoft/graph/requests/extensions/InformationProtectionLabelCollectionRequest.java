...
public class InformationProtectionLabelCollectionRequest extends BaseEntityCollectionRequest<InformationProtectionLabel, InformationProtectionLabelCollectionResponse, InformationProtectionLabelCollectionPage> {
     ...
     */
    public InformationProtectionLabelCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, InformationProtectionLabelCollectionResponse.class, InformationProtectionLabelCollectionPage.class, InformationProtectionLabelCollectionRequestBuilder.class);
    }

    /**
     * Creates a new InformationProtectionLabel
     * @param newInformationProtectionLabel the InformationProtectionLabel to create
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest expand(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest filter(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest orderBy(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest top(final int value) {
        addTopOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
     ...
     */
    @Nonnull
    public InformationProtectionLabelCollectionRequest skipToken(@Nonnull final String skipToken) {
