...
public class DataSharingConsentRequestBuilder extends BaseRequestBuilder implements IDataSharingConsentRequestBuilder {
     ...
     */
    public DataSharingConsentRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IDataSharingConsentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IDataSharingConsentRequest instance
     */
    public IDataSharingConsentRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
