 ...
 */
public class RoleScopeTagCollectionWithReferencesRequest extends BaseCollectionRequest<RoleScopeTagCollectionResponse, IRoleScopeTagCollectionPage> implements IRoleScopeTagCollectionWithReferencesRequest {
    ...
    public IRoleScopeTagCollectionWithReferencesPage get() throws ClientException {
    ...
    public IRoleScopeTagCollectionWithReferencesPage buildFromResponse(final RoleScopeTagCollectionResponse response) {
        final IRoleScopeTagCollectionWithReferencesRequestBuilder builder;
        if (response.nextLink != null) {
            builder = new RoleScopeTagCollectionWithReferencesRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final RoleScopeTagCollectionWithReferencesPage page = new RoleScopeTagCollectionWithReferencesPage(response, builder);
