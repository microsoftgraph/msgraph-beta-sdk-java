...
/**
 * The interface for the Time Card Clock Out Request.
 */
public interface ITimeCardClockOutRequest extends IHttpRequest {
     ...
     */
    ITimeCardClockOutRequest select(final String value) ;
     ...
     * @return the updated request
     */
    ITimeCardClockOutRequest top(final int value);
     ...
     * @return the updated request
     */
    ITimeCardClockOutRequest expand(final String value);
