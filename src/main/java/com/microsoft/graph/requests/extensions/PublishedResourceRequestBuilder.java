 ...
 */
public class PublishedResourceRequestBuilder extends BaseRequestBuilder<PublishedResource> {
     ...
     */
    public PublishedResourceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the PublishedResourceRequest instance
     */
    @Nonnull
    public PublishedResourceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public PublishedResourceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
