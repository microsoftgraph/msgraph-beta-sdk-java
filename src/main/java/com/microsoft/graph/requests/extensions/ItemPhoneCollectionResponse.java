 ...
 */
public class ItemPhoneCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ItemPhone within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ItemPhone> value;
