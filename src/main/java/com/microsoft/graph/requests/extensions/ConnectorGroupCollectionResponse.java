...
/**
 * The class for the Connector Group Collection Response.
 */
public class ConnectorGroupCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ConnectorGroup within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ConnectorGroup> value;
