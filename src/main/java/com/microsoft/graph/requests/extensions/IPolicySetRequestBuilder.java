...
/**
 * The interface for the Policy Set Request Builder.
 */
public interface IPolicySetRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
    ...
    IPolicySetAssignmentRequestBuilder assignments(final String id);

    IPolicySetItemCollectionRequestBuilder items();

    IPolicySetItemRequestBuilder items(final String id);
    IPolicySetUpdateRequestBuilder update(final java.util.List<PolicySetItem> addedPolicySetItems, final java.util.List<PolicySetItem> updatedPolicySetItems, final java.util.List<String> deletedPolicySetItems, final java.util.List<PolicySetAssignment> assignments);
