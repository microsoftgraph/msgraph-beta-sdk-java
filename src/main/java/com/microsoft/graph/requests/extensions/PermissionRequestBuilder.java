...
public class PermissionRequestBuilder extends BaseRequestBuilder<Permission> {
     ...
     */
    @Nonnull
    public PermissionRevokeGrantsRequestBuilder revokeGrants(@Nonnull final PermissionRevokeGrantsParameterSet parameters) {
        return new PermissionRevokeGrantsRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.revokeGrants"), getClient(), null, parameters);
    }
}
