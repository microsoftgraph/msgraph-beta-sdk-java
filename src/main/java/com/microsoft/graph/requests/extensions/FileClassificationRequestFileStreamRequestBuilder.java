...
public class FileClassificationRequestFileStreamRequestBuilder extends BaseRequestBuilder implements IFileClassificationRequestFileStreamRequestBuilder {
     ...
     */
    public FileClassificationRequestFileStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IFileClassificationRequestFileStreamRequest buildRequest() {
     ...
     * @return the IFileClassificationRequestFileStreamRequest instance
     */
    public IFileClassificationRequestFileStreamRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
