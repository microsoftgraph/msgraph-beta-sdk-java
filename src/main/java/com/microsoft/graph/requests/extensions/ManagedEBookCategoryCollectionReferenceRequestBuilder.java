...
public class ManagedEBookCategoryCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IManagedEBookCategoryCollectionReferenceRequestBuilder {
     ...
     */
    public ManagedEBookCategoryCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
