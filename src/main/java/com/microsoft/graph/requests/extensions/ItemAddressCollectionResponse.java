...
/**
 * The class for the Item Address Collection Response.
 */
public class ItemAddressCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ItemAddress within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ItemAddress> value;
