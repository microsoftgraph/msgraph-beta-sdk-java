...
public interface IGroupPolicyDefinitionRequest extends IHttpRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final GroupPolicyDefinition newGroupPolicyDefinition, final ICallback<? super GroupPolicyDefinition> callback);
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    GroupPolicyDefinition put(final GroupPolicyDefinition newGroupPolicyDefinition) throws ClientException;
