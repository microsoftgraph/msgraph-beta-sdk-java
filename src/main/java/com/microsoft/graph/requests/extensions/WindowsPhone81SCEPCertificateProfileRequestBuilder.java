...
public class WindowsPhone81SCEPCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81SCEPCertificateProfileRequestBuilder {
     ...
     */
    public WindowsPhone81SCEPCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
