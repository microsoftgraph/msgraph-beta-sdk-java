 ...
 */
public class WindowsPhone81SCEPCertificateProfileRequestBuilder extends BaseRequestBuilder<WindowsPhone81SCEPCertificateProfile> {
     ...
     */
    public WindowsPhone81SCEPCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81SCEPCertificateProfileRequest instance
     */
    @Nonnull
    public WindowsPhone81SCEPCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81SCEPCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @return the WindowsPhone81TrustedRootCertificateWithReferenceRequestBuilder instance
     */
    @Nonnull
    public WindowsPhone81TrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
