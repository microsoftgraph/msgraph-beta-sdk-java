...
/**
 * The interface for the Purchase Invoice Line Request Builder.
 */
public interface IPurchaseInvoiceLineRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IPurchaseInvoiceLineRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPurchaseInvoiceLineRequest instance
     */
    IPurchaseInvoiceLineRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
