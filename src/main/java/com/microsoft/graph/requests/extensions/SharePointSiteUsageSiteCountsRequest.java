...
import com.microsoft.graph.requests.extensions.SharePointSiteUsageSiteCountsRequest;
...
public class SharePointSiteUsageSiteCountsRequest extends BaseRequest implements ISharePointSiteUsageSiteCountsRequest {
     ...
     */
    public SharePointSiteUsageSiteCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<SharePointSiteUsageSiteCounts> callback) {
     ...
     */
    public void delete(final ICallback<SharePointSiteUsageSiteCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final SharePointSiteUsageSiteCounts sourceSharePointSiteUsageSiteCounts, final ICallback<SharePointSiteUsageSiteCounts> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final SharePointSiteUsageSiteCounts newSharePointSiteUsageSiteCounts, final ICallback<SharePointSiteUsageSiteCounts> callback) {
