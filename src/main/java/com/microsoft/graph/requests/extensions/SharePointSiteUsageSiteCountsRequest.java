...
public class SharePointSiteUsageSiteCountsRequest extends BaseRequest implements ISharePointSiteUsageSiteCountsRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final SharePointSiteUsageSiteCounts newSharePointSiteUsageSiteCounts, final ICallback<SharePointSiteUsageSiteCounts> callback) {
     ...
     * @return the updated request
     */
     public ISharePointSiteUsageSiteCountsRequest filter(final String value) {
