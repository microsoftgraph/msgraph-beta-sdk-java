...
public class PrintDocumentCollectionRequestBuilder extends BaseRequestBuilder implements IPrintDocumentCollectionRequestBuilder {
     ...
     */
    public PrintDocumentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IPrintDocumentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
