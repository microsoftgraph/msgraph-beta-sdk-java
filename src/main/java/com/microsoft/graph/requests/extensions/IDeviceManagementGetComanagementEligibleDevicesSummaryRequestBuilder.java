...
/**
 * The interface for the Device Management Get Comanagement Eligible Devices Summary Request Builder.
 */
public interface IDeviceManagementGetComanagementEligibleDevicesSummaryRequestBuilder extends IRequestBuilder {
     ...
     * @return the IDeviceManagementGetComanagementEligibleDevicesSummaryRequest instance
     */
    IDeviceManagementGetComanagementEligibleDevicesSummaryRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
