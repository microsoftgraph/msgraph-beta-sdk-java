...
public class DeviceManagementIntentDeviceStateCollectionRequest extends BaseCollectionRequest<DeviceManagementIntentDeviceStateCollectionResponse, IDeviceManagementIntentDeviceStateCollectionPage> implements IDeviceManagementIntentDeviceStateCollectionRequest {
    ...
    public void get(final ICallback<? super IDeviceManagementIntentDeviceStateCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentDeviceStateCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentDeviceStateCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentDeviceStateCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentDeviceStateCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IDeviceManagementIntentDeviceStateCollectionRequest)this;
    }
