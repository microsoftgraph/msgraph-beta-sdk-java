...
public class AndroidManagedStoreAppConfigurationSchemaRequestBuilder extends BaseRequestBuilder implements IAndroidManagedStoreAppConfigurationSchemaRequestBuilder {
     ...
     */
    public AndroidManagedStoreAppConfigurationSchemaRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
