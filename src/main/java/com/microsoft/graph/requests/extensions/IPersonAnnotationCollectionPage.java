...
/**
 * The interface for the Person Annotation Collection Page.
 */
public interface IPersonAnnotationCollectionPage extends IBaseCollectionPage<PersonAnnotation, IPersonAnnotationCollectionRequestBuilder> {
}
