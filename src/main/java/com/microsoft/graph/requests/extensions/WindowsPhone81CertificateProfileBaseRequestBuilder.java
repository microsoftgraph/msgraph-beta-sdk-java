 ...
 */
public class WindowsPhone81CertificateProfileBaseRequestBuilder extends BaseRequestBuilder<WindowsPhone81CertificateProfileBase> {
     ...
     */
    public WindowsPhone81CertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81CertificateProfileBaseRequest instance
     */
    @Nonnull
    public WindowsPhone81CertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81CertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsPhone81CertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
