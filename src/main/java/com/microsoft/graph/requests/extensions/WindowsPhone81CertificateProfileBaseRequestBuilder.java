...
public class WindowsPhone81CertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81CertificateProfileBaseRequestBuilder {
     ...
     */
    public WindowsPhone81CertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsPhone81CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsPhone81CertificateProfileBaseRequest instance
     */
    public IWindowsPhone81CertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
