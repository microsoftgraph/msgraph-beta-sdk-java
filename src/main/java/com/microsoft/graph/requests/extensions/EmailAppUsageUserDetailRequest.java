...
import com.microsoft.graph.requests.extensions.IEmailAppUsageUserDetailRequest;
import com.microsoft.graph.requests.extensions.EmailAppUsageUserDetailRequest;
...
public class EmailAppUsageUserDetailRequest extends BaseRequest implements IEmailAppUsageUserDetailRequest {
     ...
     */
    public EmailAppUsageUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
