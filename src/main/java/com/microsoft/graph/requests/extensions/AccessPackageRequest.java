...
import com.microsoft.graph.requests.extensions.AccessPackageRequest;
...
public class AccessPackageRequest extends BaseRequest implements IAccessPackageRequest {
     ...
     */
    public AccessPackageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
