...
/**
 * The class for the Web Account Collection Response.
 */
public class WebAccountCollectionResponse implements IJsonBackedObject {

    /**
     * The list of WebAccount within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<WebAccount> value;
