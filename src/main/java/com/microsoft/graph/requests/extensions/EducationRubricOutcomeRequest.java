...
public class EducationRubricOutcomeRequest extends BaseRequest<EducationRubricOutcome> {
     ...
     */
    public void get(@Nonnull final ICallback<? super EducationRubricOutcome> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super EducationRubricOutcome> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final EducationRubricOutcome sourceEducationRubricOutcome, @Nonnull final ICallback<? super EducationRubricOutcome> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final EducationRubricOutcome newEducationRubricOutcome, @Nonnull final ICallback<? super EducationRubricOutcome> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final EducationRubricOutcome newEducationRubricOutcome, @Nonnull final ICallback<? super EducationRubricOutcome> callback) {
