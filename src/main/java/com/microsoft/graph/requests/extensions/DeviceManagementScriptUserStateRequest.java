...
import com.microsoft.graph.requests.extensions.DeviceManagementScriptUserStateRequest;
...
public class DeviceManagementScriptUserStateRequest extends BaseRequest implements IDeviceManagementScriptUserStateRequest {
     ...
     */
    public DeviceManagementScriptUserStateRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<DeviceManagementScriptUserState> callback) {
     ...
     */
    public void delete(final ICallback<DeviceManagementScriptUserState> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final DeviceManagementScriptUserState sourceDeviceManagementScriptUserState, final ICallback<DeviceManagementScriptUserState> callback) {
