...
public class AndroidForWorkSettingsCompleteSignupRequestBuilder extends BaseActionRequestBuilder implements IAndroidForWorkSettingsCompleteSignupRequestBuilder {
     ...
     */
    public AndroidForWorkSettingsCompleteSignupRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String enterpriseToken) {
     ...
     * @return the IAndroidForWorkSettingsCompleteSignupRequest instance
     */
    public IAndroidForWorkSettingsCompleteSignupRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
