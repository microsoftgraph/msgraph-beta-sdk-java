...
/**
 * The interface for the Mac OSExtensions Configuration Request Builder.
 */
public interface IMacOSExtensionsConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSExtensionsConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSExtensionsConfigurationRequest instance
     */
    IMacOSExtensionsConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
