 ...
 */
public class WindowsDomainJoinConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsDomainJoinConfigurationRequestBuilder {
     ...
     */
    public IWindowsDomainJoinConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsDomainJoinConfigurationRequest instance
     */
    public IWindowsDomainJoinConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceConfigurationCollectionWithReferencesRequestBuilder networkAccessConfigurations() {
    ...
    public IDeviceConfigurationWithReferenceRequestBuilder networkAccessConfigurations(final String id) {
