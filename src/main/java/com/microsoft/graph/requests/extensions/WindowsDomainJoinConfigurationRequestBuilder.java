...
/**
 * The class for the Windows Domain Join Configuration Request Builder.
 */
public class WindowsDomainJoinConfigurationRequestBuilder extends BaseRequestBuilder<WindowsDomainJoinConfiguration> {

    /**
     * The request builder for the WindowsDomainJoinConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsDomainJoinConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsDomainJoinConfigurationRequest instance
     */
    @Nonnull
    public WindowsDomainJoinConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsDomainJoinConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsDomainJoinConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public DeviceConfigurationCollectionWithReferencesRequestBuilder networkAccessConfigurations() {
        return new DeviceConfigurationCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("networkAccessConfigurations"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public DeviceConfigurationWithReferenceRequestBuilder networkAccessConfigurations(@Nonnull final String id) {
