...
public class ComplianceRequest extends BaseRequest<Compliance> {
     ...
     */
    public void get(@Nonnull final ICallback<? super Compliance> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super Compliance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final Compliance sourceCompliance, @Nonnull final ICallback<? super Compliance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final Compliance newCompliance, @Nonnull final ICallback<? super Compliance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final Compliance newCompliance, @Nonnull final ICallback<? super Compliance> callback) {
