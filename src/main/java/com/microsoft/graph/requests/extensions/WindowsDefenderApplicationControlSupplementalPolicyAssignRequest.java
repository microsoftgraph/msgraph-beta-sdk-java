...
public class WindowsDefenderApplicationControlSupplementalPolicyAssignRequest extends BaseRequest<Void> {
    ...
    @Nullable
    protected WindowsDefenderApplicationControlSupplementalPolicyAssignParameterSet body;
    /**
