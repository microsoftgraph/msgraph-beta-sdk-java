...
/**
 * The interface for the Android Device Owner General Device Configuration Request Builder.
 */
public interface IAndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IAndroidDeviceOwnerGeneralDeviceConfigurationRequest instance
     */
    IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest();
     ...
     * @return the IAndroidDeviceOwnerGeneralDeviceConfigurationRequest instance
     */
    IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions);
