...
public interface IAndroidDeviceOwnerGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerGeneralDeviceConfigurationRequest instance
     */
    IAndroidDeviceOwnerGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
