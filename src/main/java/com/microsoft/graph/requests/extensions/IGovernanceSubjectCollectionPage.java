...
/**
 * The interface for the Governance Subject Collection Page.
 */
public interface IGovernanceSubjectCollectionPage extends IBaseCollectionPage<GovernanceSubject, IGovernanceSubjectCollectionRequestBuilder> {
}
