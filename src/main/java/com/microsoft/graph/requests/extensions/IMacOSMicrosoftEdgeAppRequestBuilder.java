...
/**
 * The interface for the Mac OSMicrosoft Edge App Request Builder.
 */
public interface IMacOSMicrosoftEdgeAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSMicrosoftEdgeAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSMicrosoftEdgeAppRequest instance
     */
    IMacOSMicrosoftEdgeAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
