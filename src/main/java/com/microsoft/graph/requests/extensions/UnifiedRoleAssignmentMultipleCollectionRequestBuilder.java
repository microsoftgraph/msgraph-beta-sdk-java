...
public class UnifiedRoleAssignmentMultipleCollectionRequestBuilder extends BaseRequestBuilder implements IUnifiedRoleAssignmentMultipleCollectionRequestBuilder {
     ...
     */
    public UnifiedRoleAssignmentMultipleCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
