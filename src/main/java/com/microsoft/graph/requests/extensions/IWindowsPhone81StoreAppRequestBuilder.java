...
/**
 * The interface for the Windows Phone81Store App Request Builder.
 */
public interface IWindowsPhone81StoreAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81StoreAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81StoreAppRequest instance
     */
    IWindowsPhone81StoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
