...
public class ExtensionPropertyCollectionRequestBuilder extends BaseRequestBuilder implements IExtensionPropertyCollectionRequestBuilder {
     ...
     */
    public ExtensionPropertyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IExtensionPropertyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
