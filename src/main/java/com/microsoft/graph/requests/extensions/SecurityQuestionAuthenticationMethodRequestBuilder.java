...
public class SecurityQuestionAuthenticationMethodRequestBuilder extends BaseRequestBuilder implements ISecurityQuestionAuthenticationMethodRequestBuilder {
     ...
     */
    public SecurityQuestionAuthenticationMethodRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
