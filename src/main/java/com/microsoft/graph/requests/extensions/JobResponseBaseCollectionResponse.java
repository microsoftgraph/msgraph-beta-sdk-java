...
/**
 * The class for the Job Response Base Collection Response.
 */
public class JobResponseBaseCollectionResponse implements IJsonBackedObject {

    /**
     * The list of JobResponseBase within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<JobResponseBase> value;
