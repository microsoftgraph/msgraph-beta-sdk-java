...
import com.microsoft.graph.requests.extensions.IDeviceManagementCollectionSettingDefinitionRequest;
import com.microsoft.graph.requests.extensions.DeviceManagementCollectionSettingDefinitionRequest;
...
public class DeviceManagementCollectionSettingDefinitionRequest extends BaseRequest implements IDeviceManagementCollectionSettingDefinitionRequest {
     ...
     */
    public DeviceManagementCollectionSettingDefinitionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
