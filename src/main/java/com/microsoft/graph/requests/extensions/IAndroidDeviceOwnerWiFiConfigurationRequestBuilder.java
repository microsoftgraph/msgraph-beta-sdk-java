...
/**
 * The interface for the Android Device Owner Wi Fi Configuration Request Builder.
 */
public interface IAndroidDeviceOwnerWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidDeviceOwnerWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidDeviceOwnerWiFiConfigurationRequest instance
     */
    IAndroidDeviceOwnerWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
