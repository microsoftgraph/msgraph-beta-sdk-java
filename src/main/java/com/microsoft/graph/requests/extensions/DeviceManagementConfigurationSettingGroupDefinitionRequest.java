...
public class DeviceManagementConfigurationSettingGroupDefinitionRequest extends BaseRequest<DeviceManagementConfigurationSettingGroupDefinition> {
     ...
     */
    public void get(@Nonnull final ICallback<? super DeviceManagementConfigurationSettingGroupDefinition> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super DeviceManagementConfigurationSettingGroupDefinition> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final DeviceManagementConfigurationSettingGroupDefinition sourceDeviceManagementConfigurationSettingGroupDefinition, @Nonnull final ICallback<? super DeviceManagementConfigurationSettingGroupDefinition> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final DeviceManagementConfigurationSettingGroupDefinition newDeviceManagementConfigurationSettingGroupDefinition, @Nonnull final ICallback<? super DeviceManagementConfigurationSettingGroupDefinition> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final DeviceManagementConfigurationSettingGroupDefinition newDeviceManagementConfigurationSettingGroupDefinition, @Nonnull final ICallback<? super DeviceManagementConfigurationSettingGroupDefinition> callback) {
