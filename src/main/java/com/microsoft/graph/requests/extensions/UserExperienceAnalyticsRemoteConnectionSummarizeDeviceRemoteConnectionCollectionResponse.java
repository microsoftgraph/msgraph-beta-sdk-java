 ...
 */
public class UserExperienceAnalyticsRemoteConnectionSummarizeDeviceRemoteConnectionCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<UserExperienceAnalyticsRemoteConnection> value;
