...
public class DeviceConfigurationHasPayloadLinksCollectionRequestBuilder extends BaseActionRequestBuilder implements IDeviceConfigurationHasPayloadLinksCollectionRequestBuilder {
     ...
     */
    public DeviceConfigurationHasPayloadLinksCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<String> payloadIds) {
    ...
    public IDeviceConfigurationHasPayloadLinksCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IDeviceConfigurationHasPayloadLinksCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
