...
/**
 * The interface for the Information Protection Label Request Builder.
 */
public interface IInformationProtectionLabelRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IInformationProtectionLabelRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IInformationProtectionLabelRequest instance
     */
    IInformationProtectionLabelRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
