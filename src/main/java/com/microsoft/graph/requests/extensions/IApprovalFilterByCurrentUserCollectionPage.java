...
/**
 * The interface for the Approval Filter By Current User Collection Page.
 */
public interface IApprovalFilterByCurrentUserCollectionPage extends IBaseCollectionPage<Approval, IApprovalFilterByCurrentUserCollectionRequestBuilder> {
}
