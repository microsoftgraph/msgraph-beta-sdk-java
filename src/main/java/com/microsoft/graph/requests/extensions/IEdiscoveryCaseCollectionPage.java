...
/**
 * The interface for the Ediscovery Case Collection Page.
 */
public interface IEdiscoveryCaseCollectionPage extends IBaseCollectionPage<EdiscoveryCase, IEdiscoveryCaseCollectionRequestBuilder> {
}
