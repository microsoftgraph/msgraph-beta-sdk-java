...
/**
 * The interface for the Authorization Policy Collection Page.
 */
public interface IAuthorizationPolicyCollectionPage extends IBaseCollectionPage<AuthorizationPolicy, IAuthorizationPolicyCollectionRequestBuilder> {
}
