...
/**
 * The interface for the B2c Identity User Flow Request Builder.
 */
public interface IB2cIdentityUserFlowRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IB2cIdentityUserFlowRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
