...
/**
 * The interface for the Device App Management Task Collection Request Builder.
 */
public interface IDeviceAppManagementTaskCollectionRequestBuilder extends IRequestBuilder {
    ...
    IDeviceAppManagementTaskCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
