 ...
 */
public class GroupPolicyPresentationValueRequestBuilder extends BaseRequestBuilder<GroupPolicyPresentationValue> {
     ...
     */
    public GroupPolicyPresentationValueRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the GroupPolicyPresentationValueRequest instance
     */
    @Nonnull
    public GroupPolicyPresentationValueRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public GroupPolicyPresentationValueRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
