...
public class PrinterShareCollectionRequest extends BaseCollectionRequest<PrinterShareCollectionResponse, IPrinterShareCollectionPage> implements IPrinterShareCollectionRequest {
     ...
     */
    public PrinterShareCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IPrinterShareCollectionPage get() throws ClientException {
        final PrinterShareCollectionResponse response = send();
     ...
     */
    public IPrinterShareCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IPrinterShareCollectionRequest)this;
    }
    public IPrinterShareCollectionPage buildFromResponse(final PrinterShareCollectionResponse response) {
        final IPrinterShareCollectionRequestBuilder builder;
        if (response.nextLink != null) {
            builder = new PrinterShareCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PrinterShareCollectionPage page = new PrinterShareCollectionPage(response, builder);
