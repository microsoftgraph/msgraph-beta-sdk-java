...
/**
 * The interface for the Android Certificate Profile Base Request Builder.
 */
public interface IAndroidCertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidCertificateProfileBaseRequest instance
     */
    IAndroidCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
