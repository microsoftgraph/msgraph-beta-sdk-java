...
public interface IAndroidPkcsCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidPkcsCertificateProfileRequest instance
     */
    IAndroidPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
