...
public class DeviceManagementIntentCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementIntentCollectionRequestBuilder {
     ...
     */
    public DeviceManagementIntentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceManagementIntentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
