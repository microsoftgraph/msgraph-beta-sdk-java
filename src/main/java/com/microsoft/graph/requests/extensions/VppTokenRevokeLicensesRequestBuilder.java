 ...
 */
public class VppTokenRevokeLicensesRequestBuilder extends BaseActionRequestBuilder implements IVppTokenRevokeLicensesRequestBuilder {
    ...
    /**
     * Creates the IVppTokenRevokeLicensesRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IVppTokenRevokeLicensesRequest instance
     */
