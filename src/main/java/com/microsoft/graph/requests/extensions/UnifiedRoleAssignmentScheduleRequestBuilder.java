 ...
 */
public class UnifiedRoleAssignmentScheduleRequestBuilder extends BaseRequestBuilder implements IUnifiedRoleAssignmentScheduleRequestBuilder {
     ...
     */
    public UnifiedRoleAssignmentScheduleRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IUnifiedRoleAssignmentScheduleRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUnifiedRoleAssignmentScheduleRequest instance
     */
    public IUnifiedRoleAssignmentScheduleRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.UnifiedRoleAssignmentScheduleRequest(getRequestUrl(), getClient(), requestOptions);
    }
