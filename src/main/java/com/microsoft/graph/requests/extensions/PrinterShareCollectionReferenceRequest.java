...
public class PrinterShareCollectionReferenceRequest extends BaseCollectionRequest<PrinterShareCollectionResponse, IPrinterShareCollectionPage> implements IPrinterShareCollectionReferenceRequest {
     ...
     */
    public PrinterShareCollectionReferenceRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public void post(final PrinterShare newPrinterShare, final ICallback<? super PrinterShare> callback) {
        ...
        new PrinterShareWithReferenceRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            .buildRequest(getBaseRequest().getHeaders())
            .post(newPrinterShare, body, callback);
    }
     ...
     */
    public IPrinterShareCollectionReferenceRequest expand(final String value) {
        addQueryOption(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (PrinterShareCollectionReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionReferenceRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionReferenceRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionReferenceRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPrinterShareCollectionReferenceRequest top(final int value) {
