...
public class UserGetManagedAppBlockedUsersCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IUserGetManagedAppBlockedUsersCollectionRequestBuilder {
     ...
     */
    public UserGetManagedAppBlockedUsersCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IUserGetManagedAppBlockedUsersCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IUserGetManagedAppBlockedUsersCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
