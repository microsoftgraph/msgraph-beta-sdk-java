...
public class EntitlementManagementSettingsRequestBuilder extends BaseRequestBuilder implements IEntitlementManagementSettingsRequestBuilder {
     ...
     */
    public EntitlementManagementSettingsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
