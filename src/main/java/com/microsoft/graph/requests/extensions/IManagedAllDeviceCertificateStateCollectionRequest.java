 ...
 */
public interface IManagedAllDeviceCertificateStateCollectionRequest extends IHttpRequest {

    void get(final ICallback<? super IManagedAllDeviceCertificateStateCollectionPage> callback);
     ...
     * @return the updated request
     */
    IManagedAllDeviceCertificateStateCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    IManagedAllDeviceCertificateStateCollectionRequest orderBy(final String value);
     ...
     * @return the updated request
     */
    IManagedAllDeviceCertificateStateCollectionRequest skip(final int value);
	 ...
	 * @return the updated request
	 */
	IManagedAllDeviceCertificateStateCollectionRequest skipToken(final String skipToken);
}
