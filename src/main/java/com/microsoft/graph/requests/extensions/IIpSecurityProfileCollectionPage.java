...
/**
 * The interface for the Ip Security Profile Collection Page.
 */
public interface IIpSecurityProfileCollectionPage extends IBaseCollectionPage<IpSecurityProfile, IIpSecurityProfileCollectionRequestBuilder> {
}
