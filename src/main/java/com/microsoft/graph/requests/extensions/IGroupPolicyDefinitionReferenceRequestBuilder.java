...
public interface IGroupPolicyDefinitionReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupPolicyDefinitionReferenceRequest buildRequest();
     ...
     * @return the IGroupPolicyDefinitionReferenceRequest instance
     */
    IGroupPolicyDefinitionReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions);
}
