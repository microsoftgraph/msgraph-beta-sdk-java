...
public class MacOSVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSVpnConfigurationRequestBuilder {
     ...
     */
    public IMacOSVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSVpnConfigurationRequest instance
     */
    public IMacOSVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
