 ...
 */
public interface ITiIndicatorSubmitTiIndicatorsCollectionRequest extends IHttpRequest {

    void post(final ICallback<? super ITiIndicatorSubmitTiIndicatorsCollectionPage> callback);
