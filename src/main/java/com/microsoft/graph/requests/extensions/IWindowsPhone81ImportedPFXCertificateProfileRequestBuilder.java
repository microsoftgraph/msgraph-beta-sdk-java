...
/**
 * The interface for the Windows Phone81Imported PFXCertificate Profile Request Builder.
 */
public interface IWindowsPhone81ImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81ImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81ImportedPFXCertificateProfileRequest instance
     */
    IWindowsPhone81ImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
