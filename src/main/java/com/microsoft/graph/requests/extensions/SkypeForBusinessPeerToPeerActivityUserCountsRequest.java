...
import com.microsoft.graph.requests.extensions.SkypeForBusinessPeerToPeerActivityUserCountsRequest;
...
public class SkypeForBusinessPeerToPeerActivityUserCountsRequest extends BaseRequest implements ISkypeForBusinessPeerToPeerActivityUserCountsRequest {
     ...
     */
    public SkypeForBusinessPeerToPeerActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
