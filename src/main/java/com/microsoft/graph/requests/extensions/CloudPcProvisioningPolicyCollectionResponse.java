...
/**
 * The class for the Cloud Pc Provisioning Policy Collection Response.
 */
public class CloudPcProvisioningPolicyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CloudPcProvisioningPolicy within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CloudPcProvisioningPolicy> value;
