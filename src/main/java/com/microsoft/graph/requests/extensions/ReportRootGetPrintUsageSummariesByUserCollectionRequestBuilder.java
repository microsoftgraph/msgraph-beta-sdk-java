...
public class ReportRootGetPrintUsageSummariesByUserCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetPrintUsageSummariesByUserCollectionRequestBuilder {
     ...
     */
    public ReportRootGetPrintUsageSummariesByUserCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.Calendar periodStart, final java.util.Calendar periodEnd) {
    ...
    public IReportRootGetPrintUsageSummariesByUserCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
