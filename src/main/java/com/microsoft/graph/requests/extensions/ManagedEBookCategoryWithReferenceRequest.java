 ...
 */
public class ManagedEBookCategoryWithReferenceRequest extends BaseRequest implements IManagedEBookCategoryWithReferenceRequest {
    ...
    public ManagedEBookCategory post(final ManagedEBookCategory newManagedEBookCategory, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newManagedEBookCategory;
        }
        return null;
    }
