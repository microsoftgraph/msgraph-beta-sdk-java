 ...
 */
public class UnifiedRoleAssignmentRequestCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRoleAssignmentRequest within this collection page
     */
