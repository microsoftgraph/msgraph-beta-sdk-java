...
/**
 * The interface for the Remote Action Audit Collection Request.
 */
public interface IRemoteActionAuditCollectionRequest {
     ...
     */
    IRemoteActionAuditCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IRemoteActionAuditCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IRemoteActionAuditCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IRemoteActionAuditCollectionRequest skip(final int value);
