...
/**
 * The interface for the Device Compliance Setting State Collection Request Builder.
 */
public interface IDeviceComplianceSettingStateCollectionRequestBuilder extends IRequestBuilder {

    IDeviceComplianceSettingStateCollectionRequest buildRequest();

    IDeviceComplianceSettingStateCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
