 ...
 */
public class AndroidDeviceComplianceLocalActionBaseRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceComplianceLocalActionBaseRequestBuilder {
     ...
     */
    public AndroidDeviceComplianceLocalActionBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidDeviceComplianceLocalActionBaseRequest instance
     */
    public IAndroidDeviceComplianceLocalActionBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
