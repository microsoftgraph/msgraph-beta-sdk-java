 ...
 */
public class DeviceManagementReportsGetUnhealthyFirewallReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetUnhealthyFirewallReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetUnhealthyFirewallReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetUnhealthyFirewallReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetUnhealthyFirewallReportRequest instance
     */
    public IDeviceManagementReportsGetUnhealthyFirewallReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
