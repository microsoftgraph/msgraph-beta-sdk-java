...
public class MobileAppRequestBuilder extends BaseRequestBuilder implements IMobileAppRequestBuilder {
    ...
    public IMobileAppUpdateRelationshipsRequestBuilder updateRelationships(final java.util.List<MobileAppRelationship> relationships) {
        return new MobileAppUpdateRelationshipsRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.updateRelationships"), getClient(), null, relationships);
    }

    public IMobileAppGetRelatedAppStatesCollectionRequestBuilder getRelatedAppStates(final String userPrincipalName, final String deviceId) {
