...
/**
 * The interface for the External Group Collection Page.
 */
public interface IExternalGroupCollectionPage extends IBaseCollectionPage<ExternalGroup, IExternalGroupCollectionRequestBuilder> {
}
