...
/**
 * The interface for the Education Category Collection Page.
 */
public interface IEducationCategoryCollectionPage extends IBaseCollectionPage<EducationCategory, IEducationCategoryCollectionRequestBuilder> {
}
