...
public interface IPublishedResourceRequestBuilder extends IRequestBuilder {
     ...
     */
    IPublishedResourceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPublishedResourceRequest instance
     */
    IPublishedResourceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
