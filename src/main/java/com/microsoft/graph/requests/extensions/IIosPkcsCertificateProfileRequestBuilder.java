...
/**
 * The interface for the Ios Pkcs Certificate Profile Request Builder.
 */
public interface IIosPkcsCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosPkcsCertificateProfileRequest instance
     */
    IIosPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
