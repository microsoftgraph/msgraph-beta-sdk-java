...
public interface IResourceOperationGetScopesForUserCollectionRequest {
     ...
     */
    IResourceOperationGetScopesForUserCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IResourceOperationGetScopesForUserCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IResourceOperationGetScopesForUserCollectionRequest top(final int value);
