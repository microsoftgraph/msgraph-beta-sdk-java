...
/**
 * The interface for the Device Management Setting Category Request Builder.
 */
public interface IDeviceManagementSettingCategoryRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceManagementSettingCategoryRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceManagementSettingCategoryRequest instance
     */
    IDeviceManagementSettingCategoryRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
