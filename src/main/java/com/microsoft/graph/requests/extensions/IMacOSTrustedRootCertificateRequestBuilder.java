...
/**
 * The interface for the Mac OSTrusted Root Certificate Request Builder.
 */
public interface IMacOSTrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IMacOSTrustedRootCertificateRequest instance
     */
    IMacOSTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSTrustedRootCertificateRequest instance
     */
    IMacOSTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
