...
public class ServicePrincipalReferenceRequest extends BaseRequest implements IServicePrincipalReferenceRequest {
     ...
     * @return the updated request
     */
    public IServicePrincipalReferenceRequest filter(final String value) {
     ...
     */
    public void put(ServicePrincipal srcServicePrincipal, final ICallback<ServicePrincipal> callback) {
