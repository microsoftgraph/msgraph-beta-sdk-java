 ...
 */
public class WindowsIdentityProtectionConfigurationRequestBuilder extends BaseRequestBuilder<WindowsIdentityProtectionConfiguration> {
     ...
     */
    public WindowsIdentityProtectionConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsIdentityProtectionConfigurationRequest instance
     */
    @Nonnull
    public WindowsIdentityProtectionConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsIdentityProtectionConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsIdentityProtectionConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
