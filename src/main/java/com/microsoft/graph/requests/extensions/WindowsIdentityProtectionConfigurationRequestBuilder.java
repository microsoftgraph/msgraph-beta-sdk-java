...
public class WindowsIdentityProtectionConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsIdentityProtectionConfigurationRequestBuilder {
     ...
     */
    public WindowsIdentityProtectionConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsIdentityProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsIdentityProtectionConfigurationRequest instance
     */
    public IWindowsIdentityProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
