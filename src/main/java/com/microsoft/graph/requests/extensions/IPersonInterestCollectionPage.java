...
/**
 * The interface for the Person Interest Collection Page.
 */
public interface IPersonInterestCollectionPage extends IBaseCollectionPage<PersonInterest, IPersonInterestCollectionRequestBuilder> {
}
