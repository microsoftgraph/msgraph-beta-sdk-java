...
public class OpenIdConnectProviderRequest extends BaseRequest<OpenIdConnectProvider> {
     ...
     */
    public void get(@Nonnull final ICallback<? super OpenIdConnectProvider> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super OpenIdConnectProvider> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final OpenIdConnectProvider sourceOpenIdConnectProvider, @Nonnull final ICallback<? super OpenIdConnectProvider> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final OpenIdConnectProvider newOpenIdConnectProvider, @Nonnull final ICallback<? super OpenIdConnectProvider> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final OpenIdConnectProvider newOpenIdConnectProvider, @Nonnull final ICallback<? super OpenIdConnectProvider> callback) {
