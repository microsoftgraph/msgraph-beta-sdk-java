...
public class AndroidDeviceOwnerEnrollmentProfileRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerEnrollmentProfileRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerEnrollmentProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerEnrollmentProfileRequest instance
     */
    public IAndroidDeviceOwnerEnrollmentProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
