...
/**
 * The interface for the Site Delta Collection Page.
 */
public interface ISiteDeltaCollectionPage extends IBaseCollectionPage<Site, ISiteDeltaCollectionRequestBuilder> {
    /**
