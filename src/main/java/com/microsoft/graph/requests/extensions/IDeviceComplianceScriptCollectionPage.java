...
/**
 * The interface for the Device Compliance Script Collection Page.
 */
public interface IDeviceComplianceScriptCollectionPage extends IBaseCollectionPage<DeviceComplianceScript, IDeviceComplianceScriptCollectionRequestBuilder> {
}
