 ...
 */
public class WindowsAppXRequestBuilder extends BaseRequestBuilder implements IWindowsAppXRequestBuilder {
     ...
     */
    public WindowsAppXRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsAppXRequest instance
     */
    public IWindowsAppXRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
