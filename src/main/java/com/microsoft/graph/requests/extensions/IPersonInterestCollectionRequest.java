 ...
 */
public interface IPersonInterestCollectionRequest {

    void get(final ICallback<IPersonInterestCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	IPersonInterestCollectionRequest skipToken(String skipToken);
}
