...
/**
 * The interface for the Sales Quote Collection Page.
 */
public interface ISalesQuoteCollectionPage extends IBaseCollectionPage<SalesQuote, ISalesQuoteCollectionRequestBuilder> {
}
