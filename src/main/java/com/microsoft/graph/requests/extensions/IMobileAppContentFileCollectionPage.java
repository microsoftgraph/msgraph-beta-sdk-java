...
/**
 * The interface for the Mobile App Content File Collection Page.
 */
public interface IMobileAppContentFileCollectionPage extends IBaseCollectionPage<MobileAppContentFile, IMobileAppContentFileCollectionRequestBuilder> {
}
