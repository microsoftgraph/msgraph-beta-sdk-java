...
/**
 * The class for the Windows81Vpn Configuration Request Builder.
 */
public class Windows81VpnConfigurationRequestBuilder extends BaseRequestBuilder<Windows81VpnConfiguration> {

    /**
     * The request builder for the Windows81VpnConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public Windows81VpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows81VpnConfigurationRequest instance
     */
    @Nonnull
    public Windows81VpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows81VpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
