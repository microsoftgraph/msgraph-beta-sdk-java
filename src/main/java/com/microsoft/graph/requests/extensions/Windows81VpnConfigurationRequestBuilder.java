 ...
 */
public class Windows81VpnConfigurationRequestBuilder extends BaseRequestBuilder implements IWindows81VpnConfigurationRequestBuilder {
     ...
     */
    public Windows81VpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindows81VpnConfigurationRequest instance
     */
    public IWindows81VpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
