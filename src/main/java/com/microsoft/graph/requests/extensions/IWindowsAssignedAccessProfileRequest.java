...
/**
 * The interface for the Windows Assigned Access Profile Request.
 */
public interface IWindowsAssignedAccessProfileRequest extends IHttpRequest {
     ...
     */
    WindowsAssignedAccessProfile get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    WindowsAssignedAccessProfile patch(final WindowsAssignedAccessProfile sourceWindowsAssignedAccessProfile) throws ClientException;
     ...
     */
    IWindowsAssignedAccessProfileRequest select(final String value);
     ...
     * @return the updated request
     */
    IWindowsAssignedAccessProfileRequest expand(final String value);
