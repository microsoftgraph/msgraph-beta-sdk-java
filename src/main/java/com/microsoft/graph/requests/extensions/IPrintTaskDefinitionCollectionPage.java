...
/**
 * The interface for the Print Task Definition Collection Page.
 */
public interface IPrintTaskDefinitionCollectionPage extends IBaseCollectionPage<PrintTaskDefinition, IPrintTaskDefinitionCollectionRequestBuilder> {
}
