...
public class ServicePrincipalGetPasswordSingleSignOnCredentialsRequest extends BaseRequest<PasswordSingleSignOnCredentialSet> {
    ...
    @Nullable
    protected ServicePrincipalGetPasswordSingleSignOnCredentialsParameterSet body;
    /**
     * Invokes the method and invokes the callback with the result
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final ICallback<? super PasswordSingleSignOnCredentialSet> callback) {
