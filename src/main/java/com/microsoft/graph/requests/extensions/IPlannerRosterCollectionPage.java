...
/**
 * The interface for the Planner Roster Collection Page.
 */
public interface IPlannerRosterCollectionPage extends IBaseCollectionPage<PlannerRoster, IPlannerRosterCollectionRequestBuilder> {
}
