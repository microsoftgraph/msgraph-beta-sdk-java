...
public class SynchronizationTemplateCollectionRequestBuilder extends BaseRequestBuilder implements ISynchronizationTemplateCollectionRequestBuilder {
     ...
     */
    public SynchronizationTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
