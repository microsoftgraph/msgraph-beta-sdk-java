...
/**
 * The class for the Vendor Collection Response.
 */
public class VendorCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Vendor within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Vendor> value;
