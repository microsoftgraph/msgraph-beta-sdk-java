...
public class WindowsStoreAppRequestBuilder extends BaseRequestBuilder implements IWindowsStoreAppRequestBuilder {
     ...
     */
    public WindowsStoreAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsStoreAppRequest instance
     */
    public IWindowsStoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
