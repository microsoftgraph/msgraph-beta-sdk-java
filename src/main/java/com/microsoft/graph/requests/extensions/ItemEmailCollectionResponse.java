...
/**
 * The class for the Item Email Collection Response.
 */
public class ItemEmailCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ItemEmail within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ItemEmail> value;
