...
public class PurchaseInvoicePostRequestBuilder extends BaseActionRequestBuilder implements IPurchaseInvoicePostRequestBuilder {
     ...
     */
    public PurchaseInvoicePostRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IPurchaseInvoicePostRequest instance
     */
    public IPurchaseInvoicePostRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
