...
public class WindowsPhoneEASEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsPhoneEASEmailProfileConfigurationRequestBuilder {
     ...
     */
    public WindowsPhoneEASEmailProfileConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsPhoneEASEmailProfileConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsPhoneEASEmailProfileConfigurationRequest instance
     */
    public IWindowsPhoneEASEmailProfileConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
