...
/**
 * The class for the Windows Phone EASEmail Profile Configuration Request Builder.
 */
public class WindowsPhoneEASEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder<WindowsPhoneEASEmailProfileConfiguration> {

    /**
     * The request builder for the WindowsPhoneEASEmailProfileConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsPhoneEASEmailProfileConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhoneEASEmailProfileConfigurationRequest instance
     */
    @Nonnull
    public WindowsPhoneEASEmailProfileConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhoneEASEmailProfileConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsPhoneEASEmailProfileConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
