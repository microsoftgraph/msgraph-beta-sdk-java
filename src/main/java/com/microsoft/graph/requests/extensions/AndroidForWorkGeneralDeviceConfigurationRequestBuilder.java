 ...
 */
public class AndroidForWorkGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkGeneralDeviceConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkGeneralDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidForWorkGeneralDeviceConfigurationRequest instance
     */
    public IAndroidForWorkGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
