...
/**
 * The class for the Android For Work General Device Configuration Request Builder.
 */
public class AndroidForWorkGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkGeneralDeviceConfiguration> {

    /**
     * The request builder for the AndroidForWorkGeneralDeviceConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkGeneralDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkGeneralDeviceConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkGeneralDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkGeneralDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
