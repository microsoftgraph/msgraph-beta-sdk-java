...
public class GroupPolicyCategoryReferenceRequest extends BaseRequest implements IGroupPolicyCategoryReferenceRequest {
     ...
     */
    public GroupPolicyCategoryReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void put(GroupPolicyCategory srcGroupPolicyCategory, final ICallback<GroupPolicyCategory> callback) {
