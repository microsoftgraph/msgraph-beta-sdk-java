...
import com.microsoft.graph.requests.extensions.IDeviceAndAppManagementDataContentStreamRequestBuilder;
...
public interface IDeviceAndAppManagementDataContentStreamRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceAndAppManagementDataContentStreamRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceAndAppManagementDataContentStreamRequest instance
     */
    IDeviceAndAppManagementDataContentStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
