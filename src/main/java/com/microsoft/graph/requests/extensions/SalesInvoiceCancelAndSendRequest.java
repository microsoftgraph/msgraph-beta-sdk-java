 ...
 */
public class SalesInvoiceCancelAndSendRequest extends BaseRequest implements ISalesInvoiceCancelAndSendRequest {
     ...
     */
    public SalesInvoiceCancelAndSendRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
