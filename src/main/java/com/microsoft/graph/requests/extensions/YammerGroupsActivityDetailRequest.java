...
public class YammerGroupsActivityDetailRequest extends BaseRequest implements IYammerGroupsActivityDetailRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final YammerGroupsActivityDetail newYammerGroupsActivityDetail, final ICallback<YammerGroupsActivityDetail> callback) {
     ...
     * @return the updated request
     */
     public IYammerGroupsActivityDetailRequest filter(final String value) {
