...
public class TokenLifetimePolicyCollectionRequestBuilder extends BaseRequestBuilder implements ITokenLifetimePolicyCollectionRequestBuilder {
     ...
     */
    public TokenLifetimePolicyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ITokenLifetimePolicyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
