...
/**
 * The interface for the Trust Framework Policy Request Builder.
 */
public interface ITrustFrameworkPolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ITrustFrameworkPolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
