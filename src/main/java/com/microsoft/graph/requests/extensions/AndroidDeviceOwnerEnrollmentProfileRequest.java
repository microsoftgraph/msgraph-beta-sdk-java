...
public class AndroidDeviceOwnerEnrollmentProfileRequest extends BaseRequest implements IAndroidDeviceOwnerEnrollmentProfileRequest {
     ...
     */
    public AndroidDeviceOwnerEnrollmentProfileRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<AndroidDeviceOwnerEnrollmentProfile> callback) {
     ...
     */
    public void delete(final ICallback<AndroidDeviceOwnerEnrollmentProfile> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AndroidDeviceOwnerEnrollmentProfile sourceAndroidDeviceOwnerEnrollmentProfile, final ICallback<AndroidDeviceOwnerEnrollmentProfile> callback) {
