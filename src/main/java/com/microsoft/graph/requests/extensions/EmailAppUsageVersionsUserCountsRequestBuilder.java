...
public class EmailAppUsageVersionsUserCountsRequestBuilder extends BaseRequestBuilder implements IEmailAppUsageVersionsUserCountsRequestBuilder {
     ...
     */
    public EmailAppUsageVersionsUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
