...
import com.microsoft.graph.requests.extensions.GroupPolicyDefinitionFileRequest;
...
public class GroupPolicyDefinitionFileRequestBuilder extends BaseRequestBuilder implements IGroupPolicyDefinitionFileRequestBuilder {
     ...
     */
    public GroupPolicyDefinitionFileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IGroupPolicyDefinitionFileRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new GroupPolicyDefinitionFileRequest(getRequestUrl(), getClient(), requestOptions);
    }
