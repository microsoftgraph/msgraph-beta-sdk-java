 ...
 */
public class DeviceHealthScriptRunSummaryRequest extends BaseRequest implements IDeviceHealthScriptRunSummaryRequest {
     ...
     */
    public DeviceHealthScriptRunSummaryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public DeviceHealthScriptRunSummary patch(final DeviceHealthScriptRunSummary sourceDeviceHealthScriptRunSummary) throws ClientException {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public DeviceHealthScriptRunSummary post(final DeviceHealthScriptRunSummary newDeviceHealthScriptRunSummary) throws ClientException {
     ...
     */
     public IDeviceHealthScriptRunSummaryRequest select(final String value) {
