...
/**
 * The class for the Sales Quote Collection Response.
 */
public class SalesQuoteCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SalesQuote within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SalesQuote> value;
