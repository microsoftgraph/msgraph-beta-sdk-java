 ...
 */
public class BookingCustomerCollectionResponse implements IJsonBackedObject {

    /**
     * The list of BookingCustomer within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<BookingCustomer> value;
