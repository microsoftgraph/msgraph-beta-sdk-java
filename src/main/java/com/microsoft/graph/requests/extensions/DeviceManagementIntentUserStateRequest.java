...
public class DeviceManagementIntentUserStateRequest extends BaseRequest implements IDeviceManagementIntentUserStateRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final DeviceManagementIntentUserState newDeviceManagementIntentUserState, final ICallback<DeviceManagementIntentUserState> callback) {
     ...
     * @return the updated request
     */
     public IDeviceManagementIntentUserStateRequest filter(final String value) {
