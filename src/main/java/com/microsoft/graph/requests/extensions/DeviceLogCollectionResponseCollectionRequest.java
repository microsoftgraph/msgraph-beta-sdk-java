...
import com.microsoft.graph.requests.extensions.IDeviceLogCollectionResponseCollectionPage;
...
import com.microsoft.graph.requests.extensions.IDeviceLogCollectionResponseCollectionRequest;
 ...
 */
public class DeviceLogCollectionResponseCollectionRequest extends BaseCollectionRequest<DeviceLogCollectionResponseCollectionResponse, IDeviceLogCollectionResponseCollectionPage> implements IDeviceLogCollectionResponseCollectionRequest {
     ...
     */
    public DeviceLogCollectionResponseCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceLogCollectionResponseCollectionPage get() throws ClientException {
        final DeviceLogCollectionResponseCollectionResponse response = send();
     ...
     */
    public IDeviceLogCollectionResponseCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceLogCollectionResponseCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceLogCollectionResponseCollectionRequest top(final int value) {
    ...
    public IDeviceLogCollectionResponseCollectionPage buildFromResponse(final DeviceLogCollectionResponseCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DeviceLogCollectionResponseCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DeviceLogCollectionResponseCollectionPage page = new DeviceLogCollectionResponseCollectionPage(response, builder);
