...
public class BookingServiceCollectionRequestBuilder extends BaseRequestBuilder implements IBookingServiceCollectionRequestBuilder {
     ...
     */
    public BookingServiceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IBookingServiceCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
