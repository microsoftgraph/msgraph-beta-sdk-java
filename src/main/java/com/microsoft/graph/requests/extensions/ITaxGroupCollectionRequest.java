 ...
 */
public interface ITaxGroupCollectionRequest {

    void get(final ICallback<ITaxGroupCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	ITaxGroupCollectionRequest skipToken(String skipToken);
}
