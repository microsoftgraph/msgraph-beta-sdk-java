...
/**
 * The class for the Education Submission Resource Collection Response.
 */
public class EducationSubmissionResourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EducationSubmissionResource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationSubmissionResource> value;
