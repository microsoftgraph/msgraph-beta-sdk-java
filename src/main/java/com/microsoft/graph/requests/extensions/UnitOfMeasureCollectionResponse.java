 ...
 */
public class UnitOfMeasureCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnitOfMeasure within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnitOfMeasure> value;
