 ...
 */
public class UnifiedRoleScheduleBaseRequestBuilder extends BaseRequestBuilder implements IUnifiedRoleScheduleBaseRequestBuilder {
     ...
     */
    public UnifiedRoleScheduleBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IUnifiedRoleScheduleBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUnifiedRoleScheduleBaseRequest instance
     */
    public IUnifiedRoleScheduleBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.UnifiedRoleScheduleBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
