...
/**
 * The interface for the Ediscovery Case Request Builder.
 */
public interface IEdiscoveryCaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IEdiscoveryCaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
