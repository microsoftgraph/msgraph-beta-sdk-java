...
/**
 * The interface for the Management Condition Request Builder.
 */
public interface IManagementConditionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagementConditionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
