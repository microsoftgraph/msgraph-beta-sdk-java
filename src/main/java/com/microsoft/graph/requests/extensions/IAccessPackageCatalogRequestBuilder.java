...
/**
 * The interface for the Access Package Catalog Request Builder.
 */
public interface IAccessPackageCatalogRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAccessPackageCatalogRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
