...
public class OfficeClientConfigurationAssignCollectionRequest extends BaseCollectionRequest<OfficeClientConfigurationAssignCollectionResponse, IOfficeClientConfigurationAssignCollectionPage> implements IOfficeClientConfigurationAssignCollectionRequest {
    ...
    public void post(final ICallback<? super IOfficeClientConfigurationAssignCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IOfficeClientConfigurationAssignCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IOfficeClientConfigurationAssignCollectionRequest orderBy(final String value) {
