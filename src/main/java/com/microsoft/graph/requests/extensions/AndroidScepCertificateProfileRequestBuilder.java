...
public class AndroidScepCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidScepCertificateProfileRequestBuilder {
     ...
     */
    public IAndroidScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidScepCertificateProfileRequest instance
     */
    public IAndroidScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
