...
public class LanguageProficiencyCollectionRequestBuilder extends BaseRequestBuilder implements ILanguageProficiencyCollectionRequestBuilder {
     ...
     */
    public LanguageProficiencyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ILanguageProficiencyCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ILanguageProficiencyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
