...
public class EventForwardRequestBuilder extends BaseActionRequestBuilder implements IEventForwardRequestBuilder {
     ...
     */
    public EventForwardRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<Recipient> toRecipients, final String comment) {
     ...
     * @return the IEventForwardRequest instance
     */
    public IEventForwardRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
