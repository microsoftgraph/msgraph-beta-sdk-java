...
public class EducationAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IEducationAssignmentCollectionRequestBuilder {
     ...
     */
    public EducationAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IEducationAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
