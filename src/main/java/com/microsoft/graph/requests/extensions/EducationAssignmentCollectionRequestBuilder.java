...
import com.microsoft.graph.requests.extensions.EducationAssignmentCollectionRequest;
...
public class EducationAssignmentCollectionRequestBuilder extends BaseCollectionRequestBuilder<EducationAssignment, EducationAssignmentRequestBuilder, EducationAssignmentCollectionResponse, EducationAssignmentCollectionPage, EducationAssignmentCollectionRequest> {
     ...
     */
    public EducationAssignmentCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, EducationAssignmentRequestBuilder.class, EducationAssignmentCollectionRequest.class);
    }
