...
public class IosManagedAppProtectionCollectionRequestBuilder extends BaseRequestBuilder implements IIosManagedAppProtectionCollectionRequestBuilder {
    ...
    public IIosManagedAppProtectionHasPayloadLinksCollectionRequestBuilder hasPayloadLinks(final java.util.List<String> payloadIds) {
        return new IosManagedAppProtectionHasPayloadLinksCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.hasPayloadLinks"), getClient(), null, payloadIds);
    }
}
