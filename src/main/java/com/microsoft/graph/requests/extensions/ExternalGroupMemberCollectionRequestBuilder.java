...
public class ExternalGroupMemberCollectionRequestBuilder extends BaseRequestBuilder implements IExternalGroupMemberCollectionRequestBuilder {
     ...
     */
    public ExternalGroupMemberCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IExternalGroupMemberCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
