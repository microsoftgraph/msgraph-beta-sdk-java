...
public class VpnConfigurationRequestBuilder extends BaseRequestBuilder implements IVpnConfigurationRequestBuilder {
     ...
     */
    public VpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IVpnConfigurationRequest instance
     */
    public IVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
