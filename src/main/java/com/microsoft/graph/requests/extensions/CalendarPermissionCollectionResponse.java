 ...
 */
public class CalendarPermissionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CalendarPermission within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CalendarPermission> value;
