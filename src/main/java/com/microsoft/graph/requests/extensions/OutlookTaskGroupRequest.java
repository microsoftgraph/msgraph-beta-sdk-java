...
import com.microsoft.graph.requests.extensions.IOutlookTaskGroupRequest;
import com.microsoft.graph.requests.extensions.OutlookTaskGroupRequest;
...
public class OutlookTaskGroupRequest extends BaseRequest implements IOutlookTaskGroupRequest {
     ...
     */
    public OutlookTaskGroupRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
