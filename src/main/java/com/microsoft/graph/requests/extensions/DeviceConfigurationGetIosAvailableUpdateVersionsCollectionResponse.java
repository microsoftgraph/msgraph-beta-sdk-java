 ...
 */
public class DeviceConfigurationGetIosAvailableUpdateVersionsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<IosAvailableUpdateVersion> value;
