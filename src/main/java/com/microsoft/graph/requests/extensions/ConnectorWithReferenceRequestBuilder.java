 ...
 */
public class ConnectorWithReferenceRequestBuilder extends BaseRequestBuilder implements IConnectorWithReferenceRequestBuilder {
     ...
     */
    public IConnectorWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IConnectorReferenceRequestBuilder reference(){
        return new ConnectorReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
