...
import com.microsoft.graph.requests.extensions.ISecurityConfigurationTaskRequest;
import com.microsoft.graph.requests.extensions.SecurityConfigurationTaskRequest;
...
public class SecurityConfigurationTaskRequest extends BaseRequest implements ISecurityConfigurationTaskRequest {
     ...
     */
    public SecurityConfigurationTaskRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
