...
/**
 * The class for the Device Health Script Assignment Collection Response.
 */
public class DeviceHealthScriptAssignmentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DeviceHealthScriptAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DeviceHealthScriptAssignment> value;
