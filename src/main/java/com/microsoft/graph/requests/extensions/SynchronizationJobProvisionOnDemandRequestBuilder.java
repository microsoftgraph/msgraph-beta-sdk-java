 ...
 */
public class SynchronizationJobProvisionOnDemandRequestBuilder extends BaseActionRequestBuilder implements ISynchronizationJobProvisionOnDemandRequestBuilder {
    ...
    /**
     * Creates the ISynchronizationJobProvisionOnDemandRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the ISynchronizationJobProvisionOnDemandRequest instance
     */
    public ISynchronizationJobProvisionOnDemandRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        ...
        if (hasParameter("parameters")) {
            request.body.parameters = getParameter("parameters");
        }
