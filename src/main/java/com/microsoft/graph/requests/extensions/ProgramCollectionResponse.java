...
/**
 * The class for the Program Collection Response.
 */
public class ProgramCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Program within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Program> value;
