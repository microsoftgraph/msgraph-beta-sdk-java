...
public class AndroidWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWiFiConfigurationRequestBuilder {
     ...
     */
    public AndroidWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWiFiConfigurationRequest instance
     */
    public IAndroidWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
