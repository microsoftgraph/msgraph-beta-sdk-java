...
/**
 * The class for the Android Wi Fi Configuration Request Builder.
 */
public class AndroidWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWiFiConfiguration> {

    /**
     * The request builder for the AndroidWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
