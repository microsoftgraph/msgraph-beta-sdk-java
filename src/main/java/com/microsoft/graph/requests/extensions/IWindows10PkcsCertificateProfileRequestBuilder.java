...
public interface IWindows10PkcsCertificateProfileRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindows10PkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindows10PkcsCertificateProfileRequest instance
     */
    IWindows10PkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
