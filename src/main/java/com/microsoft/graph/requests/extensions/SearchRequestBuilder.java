...
public class SearchRequestBuilder extends BaseRequestBuilder implements ISearchRequestBuilder {
     ...
     */
    public SearchRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the ISearchRequest instance
     */
    public ISearchRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
