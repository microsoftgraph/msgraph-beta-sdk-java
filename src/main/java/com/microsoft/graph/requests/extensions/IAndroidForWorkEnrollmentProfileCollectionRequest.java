...
/**
 * The interface for the Android For Work Enrollment Profile Collection Request.
 */
public interface IAndroidForWorkEnrollmentProfileCollectionRequest {
     ...
     */
    IAndroidForWorkEnrollmentProfileCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IAndroidForWorkEnrollmentProfileCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IAndroidForWorkEnrollmentProfileCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IAndroidForWorkEnrollmentProfileCollectionRequest skip(final int value);
