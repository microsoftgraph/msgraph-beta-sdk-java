 ...
 */
public class AccessPackageResourceReferenceRequestBuilder extends BaseReferenceRequestBuilder<AccessPackageResource, AccessPackageResourceReferenceRequest> {
     ...
     */
    public AccessPackageResourceReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AccessPackageResourceReferenceRequest.class);
    }
}
