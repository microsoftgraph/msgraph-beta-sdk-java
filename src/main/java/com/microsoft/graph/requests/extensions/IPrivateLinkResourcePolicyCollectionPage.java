...
/**
 * The interface for the Private Link Resource Policy Collection Page.
 */
public interface IPrivateLinkResourcePolicyCollectionPage extends IBaseCollectionPage<PrivateLinkResourcePolicy, IPrivateLinkResourcePolicyCollectionRequestBuilder> {
}
