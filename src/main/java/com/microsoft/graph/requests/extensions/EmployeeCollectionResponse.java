 ...
 */
public class EmployeeCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Employee within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Employee> value;
