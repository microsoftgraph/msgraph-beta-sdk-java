 ...
 */
public class UserSourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UserSource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UserSource> value;
