...
public class WorkforceIntegrationCollectionRequestBuilder extends BaseRequestBuilder implements IWorkforceIntegrationCollectionRequestBuilder {
     ...
     */
    public WorkforceIntegrationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IWorkforceIntegrationCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IWorkforceIntegrationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
