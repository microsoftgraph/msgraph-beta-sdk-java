 ...
 */
public class AndroidWorkProfileNineWorkEasConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileNineWorkEasConfigurationRequestBuilder {
     ...
     */
    public AndroidWorkProfileNineWorkEasConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IAndroidWorkProfileNineWorkEasConfigurationRequest instance
     */
    public IAndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileNineWorkEasConfigurationRequest instance
     */
    public IAndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
