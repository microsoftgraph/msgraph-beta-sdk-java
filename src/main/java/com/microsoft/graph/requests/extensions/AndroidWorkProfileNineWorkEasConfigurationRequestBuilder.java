...
/**
 * The class for the Android Work Profile Nine Work Eas Configuration Request Builder.
 */
public class AndroidWorkProfileNineWorkEasConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileNineWorkEasConfiguration> {

    /**
     * The request builder for the AndroidWorkProfileNineWorkEasConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidWorkProfileNineWorkEasConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileNineWorkEasConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileNineWorkEasConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileNineWorkEasConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     *
     * @return the AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder instance
     */
    @Nonnull
    public AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
