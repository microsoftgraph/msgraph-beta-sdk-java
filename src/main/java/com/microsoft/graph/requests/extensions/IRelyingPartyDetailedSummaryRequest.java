...
/**
 * The interface for the Relying Party Detailed Summary Request.
 */
public interface IRelyingPartyDetailedSummaryRequest extends IHttpRequest {
     ...
     */
    RelyingPartyDetailedSummary get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    RelyingPartyDetailedSummary patch(final RelyingPartyDetailedSummary sourceRelyingPartyDetailedSummary) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    RelyingPartyDetailedSummary post(final RelyingPartyDetailedSummary newRelyingPartyDetailedSummary) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    RelyingPartyDetailedSummary put(final RelyingPartyDetailedSummary newRelyingPartyDetailedSummary) throws ClientException;
     ...
     */
    IRelyingPartyDetailedSummaryRequest select(final String value);
     ...
     * @return the updated request
     */
    IRelyingPartyDetailedSummaryRequest expand(final String value);
