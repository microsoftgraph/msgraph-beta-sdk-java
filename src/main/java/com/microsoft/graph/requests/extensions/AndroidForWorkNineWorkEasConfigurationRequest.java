...
import com.microsoft.graph.requests.extensions.AndroidForWorkNineWorkEasConfigurationRequest;
...
public class AndroidForWorkNineWorkEasConfigurationRequest extends BaseRequest implements IAndroidForWorkNineWorkEasConfigurationRequest {
     ...
     */
    public AndroidForWorkNineWorkEasConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
