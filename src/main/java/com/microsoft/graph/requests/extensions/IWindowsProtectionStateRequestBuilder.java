...
public interface IWindowsProtectionStateRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindowsProtectionStateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsProtectionStateRequest instance
     */
    IWindowsProtectionStateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
