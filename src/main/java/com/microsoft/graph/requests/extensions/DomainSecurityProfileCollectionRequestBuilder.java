...
public class DomainSecurityProfileCollectionRequestBuilder extends BaseRequestBuilder implements IDomainSecurityProfileCollectionRequestBuilder {
     ...
     */
    public DomainSecurityProfileCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDomainSecurityProfileCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
