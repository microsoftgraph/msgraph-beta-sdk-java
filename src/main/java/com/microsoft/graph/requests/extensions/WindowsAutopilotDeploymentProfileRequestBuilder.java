...
public class WindowsAutopilotDeploymentProfileRequestBuilder extends BaseRequestBuilder implements IWindowsAutopilotDeploymentProfileRequestBuilder {
     ...
     */
    public WindowsAutopilotDeploymentProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindowsAutopilotDeploymentProfileRequest instance
     */
    public IWindowsAutopilotDeploymentProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
