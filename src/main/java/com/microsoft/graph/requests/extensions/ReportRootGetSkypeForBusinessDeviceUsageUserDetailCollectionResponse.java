 ...
 */
public class ReportRootGetSkypeForBusinessDeviceUsageUserDetailCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<SkypeForBusinessDeviceUsageUserDetail> value;
