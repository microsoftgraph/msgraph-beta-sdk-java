 ...
 */
public class ReportRootGetSkypeForBusinessParticipantActivityUserCountsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<SkypeForBusinessParticipantActivityUserCounts> value;
