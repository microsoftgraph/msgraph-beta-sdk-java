 ...
 */
public class GovernanceRoleSettingCollectionResponse implements IJsonBackedObject {

    /**
     * The list of GovernanceRoleSetting within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<GovernanceRoleSetting> value;
