...
public class ReportRootGetOffice365GroupsActivityCountsCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetOffice365GroupsActivityCountsCollectionRequestBuilder {
     ...
     */
    public ReportRootGetOffice365GroupsActivityCountsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
    ...
    public IReportRootGetOffice365GroupsActivityCountsCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IReportRootGetOffice365GroupsActivityCountsCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
