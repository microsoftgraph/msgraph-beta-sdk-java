 ...
 */
public class DirectorySettingCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DirectorySetting within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DirectorySetting> value;
