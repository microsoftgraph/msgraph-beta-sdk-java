...
import com.microsoft.graph.requests.extensions.IPasswordAuthenticationMethodCollectionPage;
 ...
 */
public class PasswordAuthenticationMethodCollectionRequest extends BaseCollectionRequest<PasswordAuthenticationMethodCollectionResponse, IPasswordAuthenticationMethodCollectionPage> implements IPasswordAuthenticationMethodCollectionRequest {
     ...
     */
    public PasswordAuthenticationMethodCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IPasswordAuthenticationMethodCollectionPage get() throws ClientException {
        final PasswordAuthenticationMethodCollectionResponse response = send();
     ...
     */
    public IPasswordAuthenticationMethodCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPasswordAuthenticationMethodCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPasswordAuthenticationMethodCollectionRequest top(final int value) {
    ...
    public IPasswordAuthenticationMethodCollectionPage buildFromResponse(final PasswordAuthenticationMethodCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new PasswordAuthenticationMethodCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PasswordAuthenticationMethodCollectionPage page = new PasswordAuthenticationMethodCollectionPage(response, builder);
