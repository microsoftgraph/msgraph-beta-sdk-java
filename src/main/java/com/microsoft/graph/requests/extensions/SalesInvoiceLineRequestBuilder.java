 ...
 */
public class SalesInvoiceLineRequestBuilder extends BaseRequestBuilder implements ISalesInvoiceLineRequestBuilder {
     ...
     */
    public SalesInvoiceLineRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public ISalesInvoiceLineRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the ISalesInvoiceLineRequest instance
     */
    public ISalesInvoiceLineRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.SalesInvoiceLineRequest(getRequestUrl(), getClient(), requestOptions);
    }
