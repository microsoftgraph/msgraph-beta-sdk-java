...
/**
 * The interface for the Security Action Collection Request.
 */
public interface ISecurityActionCollectionRequest {
     ...
     */
    ISecurityActionCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISecurityActionCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISecurityActionCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISecurityActionCollectionRequest skip(final int value);
