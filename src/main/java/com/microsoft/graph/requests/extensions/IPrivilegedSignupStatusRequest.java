...
/**
 * The interface for the Privileged Signup Status Request.
 */
public interface IPrivilegedSignupStatusRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    PrivilegedSignupStatus put(final PrivilegedSignupStatus newPrivilegedSignupStatus) throws ClientException;
     ...
     */
    IPrivilegedSignupStatusRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrivilegedSignupStatusRequest expand(final String value);
