...
/**
 * The interface for the Enrollment Profile Collection Request.
 */
public interface IEnrollmentProfileCollectionRequest {
     ...
     */
    IEnrollmentProfileCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IEnrollmentProfileCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IEnrollmentProfileCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IEnrollmentProfileCollectionRequest skip(final int value);
