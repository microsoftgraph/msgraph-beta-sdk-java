...
/**
 * The interface for the User Credential Usage Details Collection Request.
 */
public interface IUserCredentialUsageDetailsCollectionRequest {
     ...
     */
    IUserCredentialUsageDetailsCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserCredentialUsageDetailsCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserCredentialUsageDetailsCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserCredentialUsageDetailsCollectionRequest skip(final int value);
