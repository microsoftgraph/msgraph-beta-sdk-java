...
public class WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IWindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionRequestBuilder {
     ...
     */
    public WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IWindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IWindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
