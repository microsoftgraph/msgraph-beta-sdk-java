...
/**
 * The class for the Trust Framework Key Set Collection Response.
 */
public class TrustFrameworkKeySetCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TrustFrameworkKeySet within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TrustFrameworkKeySet> value;
