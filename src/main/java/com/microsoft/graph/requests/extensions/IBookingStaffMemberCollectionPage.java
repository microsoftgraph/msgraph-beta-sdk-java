...
/**
 * The interface for the Booking Staff Member Collection Page.
 */
public interface IBookingStaffMemberCollectionPage extends IBaseCollectionPage<BookingStaffMember, IBookingStaffMemberCollectionRequestBuilder> {
}
