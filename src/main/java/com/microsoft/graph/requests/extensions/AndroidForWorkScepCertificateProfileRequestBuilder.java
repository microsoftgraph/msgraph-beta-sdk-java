...
/**
 * The class for the Android For Work Scep Certificate Profile Request Builder.
 */
public class AndroidForWorkScepCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidForWorkScepCertificateProfile> {

    /**
     * The request builder for the AndroidForWorkScepCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkScepCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkScepCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidForWorkScepCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkScepCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
