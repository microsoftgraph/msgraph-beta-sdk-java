 ...
 */
public class AndroidForWorkScepCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkScepCertificateProfileRequestBuilder {
     ...
     */
    public AndroidForWorkScepCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidForWorkScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkScepCertificateProfileRequest instance
     */
    public IAndroidForWorkScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
