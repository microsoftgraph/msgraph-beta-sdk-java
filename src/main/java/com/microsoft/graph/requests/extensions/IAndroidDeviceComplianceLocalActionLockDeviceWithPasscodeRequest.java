...
/**
 * The interface for the Android Device Compliance Local Action Lock Device With Passcode Request.
 */
public interface IAndroidDeviceComplianceLocalActionLockDeviceWithPasscodeRequest extends IHttpRequest {
     ...
     */
    AndroidDeviceComplianceLocalActionLockDeviceWithPasscode get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    AndroidDeviceComplianceLocalActionLockDeviceWithPasscode patch(final AndroidDeviceComplianceLocalActionLockDeviceWithPasscode sourceAndroidDeviceComplianceLocalActionLockDeviceWithPasscode) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    AndroidDeviceComplianceLocalActionLockDeviceWithPasscode post(final AndroidDeviceComplianceLocalActionLockDeviceWithPasscode newAndroidDeviceComplianceLocalActionLockDeviceWithPasscode) throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    AndroidDeviceComplianceLocalActionLockDeviceWithPasscode put(final AndroidDeviceComplianceLocalActionLockDeviceWithPasscode newAndroidDeviceComplianceLocalActionLockDeviceWithPasscode) throws ClientException;
     ...
     */
    IAndroidDeviceComplianceLocalActionLockDeviceWithPasscodeRequest select(final String value);
     ...
     * @return the updated request
     */
    IAndroidDeviceComplianceLocalActionLockDeviceWithPasscodeRequest expand(final String value);
