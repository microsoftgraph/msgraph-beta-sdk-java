...
public class MobileAppValidateXmlRequestBuilder extends BaseActionRequestBuilder implements IMobileAppValidateXmlRequestBuilder {
     ...
     */
    public MobileAppValidateXmlRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final byte[] officeConfigurationXml) {
     ...
     * @return the IMobileAppValidateXmlRequest instance
     */
    public IMobileAppValidateXmlRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
