 ...
 */
public class UnifiedRoleAssignmentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRoleAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleAssignment> value;
