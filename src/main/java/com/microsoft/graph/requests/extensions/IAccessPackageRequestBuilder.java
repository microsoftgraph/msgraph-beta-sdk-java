...
/**
 * The interface for the Access Package Request Builder.
 */
public interface IAccessPackageRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IAccessPackageRequest instance
     */
    IAccessPackageRequest buildRequest();
     ...
     * @return the IAccessPackageRequest instance
     */
    IAccessPackageRequest buildRequest(final java.util.List<? extends Option> requestOptions);
     ...
     */
    IAccessPackageCatalogWithReferenceRequestBuilder accessPackageCatalog();
