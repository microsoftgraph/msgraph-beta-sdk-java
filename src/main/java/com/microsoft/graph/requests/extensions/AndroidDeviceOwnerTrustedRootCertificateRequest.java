...
public class AndroidDeviceOwnerTrustedRootCertificateRequest extends BaseRequest implements IAndroidDeviceOwnerTrustedRootCertificateRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final AndroidDeviceOwnerTrustedRootCertificate newAndroidDeviceOwnerTrustedRootCertificate, final ICallback<AndroidDeviceOwnerTrustedRootCertificate> callback) {
     ...
     * @return the updated request
     */
     public IAndroidDeviceOwnerTrustedRootCertificateRequest filter(final String value) {
