...
public class AdministrativeUnitWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<AdministrativeUnit, AdministrativeUnitWithReferenceRequest, AdministrativeUnitReferenceRequestBuilder> {
     ...
     */
    public AdministrativeUnitWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AdministrativeUnitWithReferenceRequest.class, AdministrativeUnitReferenceRequestBuilder.class);
    }
}
