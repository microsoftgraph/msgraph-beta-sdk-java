 ...
 */
public class AccessPackageResourceEnvironmentWithReferenceRequest extends BaseRequest implements IAccessPackageResourceEnvironmentWithReferenceRequest {
     ...
     */
    public AccessPackageResourceEnvironmentWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AccessPackageResourceEnvironment.class);
    }

    public void post(final AccessPackageResourceEnvironment newAccessPackageResourceEnvironment, final IJsonBackedObject payload, final ICallback<? super AccessPackageResourceEnvironment> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public AccessPackageResourceEnvironment post(final AccessPackageResourceEnvironment newAccessPackageResourceEnvironment, final IJsonBackedObject payload) throws ClientException {
        IJsonBackedObject response = send(HttpMethod.POST, payload);
        if (response != null){
            return newAccessPackageResourceEnvironment;
        }
        return null;
    }
     ...
     */
    public IAccessPackageResourceEnvironmentWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IAccessPackageResourceEnvironmentWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IAccessPackageResourceEnvironmentWithReferenceRequest expand(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$expand", value));
        return (AccessPackageResourceEnvironmentWithReferenceRequest)this;
    }
}
