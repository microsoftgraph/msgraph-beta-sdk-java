...
/**
 * The interface for the User Experience Analytics App Health Device Performance Collection Request.
 */
public interface IUserExperienceAnalyticsAppHealthDevicePerformanceCollectionRequest extends IHttpRequest {
     ...
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsAppHealthDevicePerformanceCollectionRequest skip(final int value);
