...
public class ChatMessageHostedContentStreamRequestBuilder extends BaseRequestBuilder implements IChatMessageHostedContentStreamRequestBuilder {
     ...
     */
    public ChatMessageHostedContentStreamRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IChatMessageHostedContentStreamRequest buildRequest() {
     ...
     * @return the IChatMessageHostedContentStreamRequest instance
     */
    public IChatMessageHostedContentStreamRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
