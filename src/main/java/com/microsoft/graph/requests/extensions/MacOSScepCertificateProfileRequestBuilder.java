 ...
 */
public class MacOSScepCertificateProfileRequestBuilder extends BaseRequestBuilder implements IMacOSScepCertificateProfileRequestBuilder {
     ...
     */
    public MacOSScepCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSScepCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSScepCertificateProfileRequest instance
     */
    public IMacOSScepCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
