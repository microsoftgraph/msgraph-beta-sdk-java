...
/**
 * The interface for the Mention Request.
 */
public interface IMentionRequest extends IHttpRequest {
     ...
     */
    Mention get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    Mention patch(final Mention sourceMention) throws ClientException;
     ...
     */
    IMentionRequest select(final String value);
     ...
     * @return the updated request
     */
    IMentionRequest expand(final String value);
