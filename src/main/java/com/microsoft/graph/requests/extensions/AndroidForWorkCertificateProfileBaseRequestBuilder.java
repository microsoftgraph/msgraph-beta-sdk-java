...
public class AndroidForWorkCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkCertificateProfileBaseRequestBuilder {
     ...
     */
    public AndroidForWorkCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidForWorkCertificateProfileBaseRequest instance
     */
    public IAndroidForWorkCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
