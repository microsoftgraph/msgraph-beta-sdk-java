 ...
 */
public class AndroidOmaCpConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidOmaCpConfigurationRequestBuilder {
     ...
     */
    public AndroidOmaCpConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IAndroidOmaCpConfigurationRequest instance
     */
    public IAndroidOmaCpConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidOmaCpConfigurationRequest instance
     */
    public IAndroidOmaCpConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidOmaCpConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
