...
import com.microsoft.graph.requests.extensions.UnifiedRbacResourceNamespaceCollectionRequest;
...
public class UnifiedRbacResourceNamespaceCollectionRequestBuilder extends BaseCollectionRequestBuilder<UnifiedRbacResourceNamespace, UnifiedRbacResourceNamespaceRequestBuilder, UnifiedRbacResourceNamespaceCollectionResponse, UnifiedRbacResourceNamespaceCollectionPage, UnifiedRbacResourceNamespaceCollectionRequest> {
     ...
     */
    public UnifiedRbacResourceNamespaceCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, UnifiedRbacResourceNamespaceRequestBuilder.class, UnifiedRbacResourceNamespaceCollectionRequest.class);
    }
