 ...
 */
public class IdentityUserFlowAttributeAssignmentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IdentityUserFlowAttributeAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IdentityUserFlowAttributeAssignment> value;
