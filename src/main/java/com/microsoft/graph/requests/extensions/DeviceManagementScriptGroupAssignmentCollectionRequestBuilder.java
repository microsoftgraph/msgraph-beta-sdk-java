...
public class DeviceManagementScriptGroupAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementScriptGroupAssignmentCollectionRequestBuilder {
     ...
     */
    public DeviceManagementScriptGroupAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
