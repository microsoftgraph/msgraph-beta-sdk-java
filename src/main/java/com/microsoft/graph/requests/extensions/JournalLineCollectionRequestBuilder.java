...
public class JournalLineCollectionRequestBuilder extends BaseRequestBuilder implements IJournalLineCollectionRequestBuilder {
     ...
     */
    public JournalLineCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IJournalLineCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
