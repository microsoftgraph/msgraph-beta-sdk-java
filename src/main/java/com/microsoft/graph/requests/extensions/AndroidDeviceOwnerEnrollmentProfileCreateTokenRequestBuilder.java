...
public class AndroidDeviceOwnerEnrollmentProfileCreateTokenRequestBuilder extends BaseActionRequestBuilder implements IAndroidDeviceOwnerEnrollmentProfileCreateTokenRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerEnrollmentProfileCreateTokenRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Integer tokenValidityInSeconds) {
     ...
     * @return the IAndroidDeviceOwnerEnrollmentProfileCreateTokenRequest instance
     */
    public IAndroidDeviceOwnerEnrollmentProfileCreateTokenRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
