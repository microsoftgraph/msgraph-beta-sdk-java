 ...
 */
public class ApprovalStepCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ApprovalStep within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ApprovalStep> value;
