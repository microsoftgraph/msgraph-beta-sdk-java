...
public class AndroidTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IAndroidTrustedRootCertificateRequestBuilder {
     ...
     */
    public AndroidTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
