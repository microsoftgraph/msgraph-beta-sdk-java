 ...
 */
public class AndroidTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IAndroidTrustedRootCertificateRequestBuilder {
     ...
     */
    public AndroidTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidTrustedRootCertificateRequest instance
     */
    public IAndroidTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
