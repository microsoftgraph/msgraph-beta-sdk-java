...
public class SignInCollectionRequestBuilder extends BaseRequestBuilder implements ISignInCollectionRequestBuilder {
     ...
     */
    public SignInCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ISignInCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
