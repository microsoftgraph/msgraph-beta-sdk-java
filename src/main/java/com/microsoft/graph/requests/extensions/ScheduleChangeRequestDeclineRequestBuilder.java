...
public class ScheduleChangeRequestDeclineRequestBuilder extends BaseActionRequestBuilder implements IScheduleChangeRequestDeclineRequestBuilder {
     ...
     */
    public ScheduleChangeRequestDeclineRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String message) {
     ...
     * @return the IScheduleChangeRequestDeclineRequest instance
     */
    public IScheduleChangeRequestDeclineRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
