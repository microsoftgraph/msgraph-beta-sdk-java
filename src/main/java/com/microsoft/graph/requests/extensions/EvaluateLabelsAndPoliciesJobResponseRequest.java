...
import com.microsoft.graph.requests.extensions.EvaluateLabelsAndPoliciesJobResponseRequest;
...
public class EvaluateLabelsAndPoliciesJobResponseRequest extends BaseRequest implements IEvaluateLabelsAndPoliciesJobResponseRequest {
     ...
     */
    public EvaluateLabelsAndPoliciesJobResponseRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
