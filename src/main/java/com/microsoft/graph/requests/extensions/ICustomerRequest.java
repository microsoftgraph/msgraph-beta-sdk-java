...
/**
 * The interface for the Customer Request.
 */
public interface ICustomerRequest extends IHttpRequest {
     ...
     */
    Customer get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    Customer patch(final Customer sourceCustomer) throws ClientException;
     ...
     */
    ICustomerRequest select(final String value);
     ...
     * @return the updated request
     */
    ICustomerRequest expand(final String value);
