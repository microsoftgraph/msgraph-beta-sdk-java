...
/**
 * The class for the Mac OSCustom App Configuration Request Builder.
 */
public class MacOSCustomAppConfigurationRequestBuilder extends BaseRequestBuilder<MacOSCustomAppConfiguration> {

    /**
     * The request builder for the MacOSCustomAppConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSCustomAppConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSCustomAppConfigurationRequest instance
     */
    @Nonnull
    public MacOSCustomAppConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSCustomAppConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.MacOSCustomAppConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
