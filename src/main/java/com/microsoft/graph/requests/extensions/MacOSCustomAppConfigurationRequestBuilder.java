...
public class MacOSCustomAppConfigurationRequestBuilder extends BaseRequestBuilder implements IMacOSCustomAppConfigurationRequestBuilder {
     ...
     */
    public MacOSCustomAppConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IMacOSCustomAppConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMacOSCustomAppConfigurationRequest instance
     */
    public IMacOSCustomAppConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
