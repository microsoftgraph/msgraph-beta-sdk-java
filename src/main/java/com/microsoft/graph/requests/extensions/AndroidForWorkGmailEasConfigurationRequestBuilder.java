 ...
 */
public class AndroidForWorkGmailEasConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkGmailEasConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkGmailEasConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidForWorkGmailEasConfigurationRequest instance
     */
    public IAndroidForWorkGmailEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
