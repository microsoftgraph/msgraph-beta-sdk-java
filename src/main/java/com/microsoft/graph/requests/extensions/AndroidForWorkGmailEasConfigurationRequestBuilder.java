...
/**
 * The class for the Android For Work Gmail Eas Configuration Request Builder.
 */
public class AndroidForWorkGmailEasConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkGmailEasConfiguration> {

    /**
     * The request builder for the AndroidForWorkGmailEasConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkGmailEasConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkGmailEasConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkGmailEasConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkGmailEasConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkGmailEasConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
