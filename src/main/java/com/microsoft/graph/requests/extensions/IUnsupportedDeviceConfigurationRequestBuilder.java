...
public interface IUnsupportedDeviceConfigurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IUnsupportedDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUnsupportedDeviceConfigurationRequest instance
     */
    IUnsupportedDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
