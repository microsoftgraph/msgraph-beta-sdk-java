 ...
 */
public class PersonAnnualEventCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PersonAnnualEvent within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PersonAnnualEvent> value;
