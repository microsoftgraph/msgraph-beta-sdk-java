...
import com.microsoft.graph.requests.extensions.IAccessReviewScheduleDefinitionCollectionPage;
 ...
 */
public class AccessReviewScheduleDefinitionCollectionRequest extends BaseCollectionRequest<AccessReviewScheduleDefinitionCollectionResponse, IAccessReviewScheduleDefinitionCollectionPage> implements IAccessReviewScheduleDefinitionCollectionRequest {
     ...
     */
    public AccessReviewScheduleDefinitionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AccessReviewScheduleDefinitionCollectionResponse.class, IAccessReviewScheduleDefinitionCollectionPage.class);
    }

    public void get(final ICallback<? super IAccessReviewScheduleDefinitionCollectionPage> callback) {
    ...
    public IAccessReviewScheduleDefinitionCollectionPage get() throws ClientException {
        final AccessReviewScheduleDefinitionCollectionResponse response = send();
     ...
     */
    public IAccessReviewScheduleDefinitionCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IAccessReviewScheduleDefinitionCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IAccessReviewScheduleDefinitionCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IAccessReviewScheduleDefinitionCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IAccessReviewScheduleDefinitionCollectionRequest top(final int value) {
    ...
    public IAccessReviewScheduleDefinitionCollectionPage buildFromResponse(final AccessReviewScheduleDefinitionCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new AccessReviewScheduleDefinitionCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final AccessReviewScheduleDefinitionCollectionPage page = new AccessReviewScheduleDefinitionCollectionPage(response, builder);
