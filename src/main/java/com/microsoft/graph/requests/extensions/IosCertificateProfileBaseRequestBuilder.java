...
/**
 * The class for the Ios Certificate Profile Base Request Builder.
 */
public class IosCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<IosCertificateProfileBase> {
     ...
     */
    public IosCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosCertificateProfileBaseRequest instance
     */
    @Nonnull
    public IosCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
