 ...
 */
public class IosCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IIosCertificateProfileBaseRequestBuilder {
     ...
     */
    public IosCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosCertificateProfileBaseRequest instance
     */
    public IIosCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
