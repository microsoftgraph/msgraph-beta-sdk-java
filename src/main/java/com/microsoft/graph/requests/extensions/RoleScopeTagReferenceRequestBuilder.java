...
public class RoleScopeTagReferenceRequestBuilder extends BaseRequestBuilder implements IRoleScopeTagReferenceRequestBuilder {
     ...
     */
    public RoleScopeTagReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IRoleScopeTagReferenceRequest instance
     */
    public IRoleScopeTagReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
