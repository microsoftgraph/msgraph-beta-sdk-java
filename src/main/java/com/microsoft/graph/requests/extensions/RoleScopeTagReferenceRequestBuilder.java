 ...
 */
public class RoleScopeTagReferenceRequestBuilder extends BaseReferenceRequestBuilder<RoleScopeTag, RoleScopeTagReferenceRequest> {
     ...
     */
    public RoleScopeTagReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, RoleScopeTagReferenceRequest.class);
    }
}
