...
public class AndroidForWorkAppConfigurationSchemaCollectionRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkAppConfigurationSchemaCollectionRequestBuilder {
     ...
     */
    public AndroidForWorkAppConfigurationSchemaCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAndroidForWorkAppConfigurationSchemaCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
