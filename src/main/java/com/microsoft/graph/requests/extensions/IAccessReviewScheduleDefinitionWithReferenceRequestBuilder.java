...
/**
 * The interface for the Access Review Schedule Definition With Reference Request Builder.
 */
public interface IAccessReviewScheduleDefinitionWithReferenceRequestBuilder extends IRequestBuilder {
