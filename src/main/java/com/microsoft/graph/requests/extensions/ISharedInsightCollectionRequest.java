...
/**
 * The interface for the Shared Insight Collection Request.
 */
public interface ISharedInsightCollectionRequest {
     ...
     */
    ISharedInsightCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISharedInsightCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISharedInsightCollectionRequest top(final int value);
