...
/**
 * The interface for the Windows10Imported PFXCertificate Profile Request Builder.
 */
public interface IWindows10ImportedPFXCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IWindows10ImportedPFXCertificateProfileRequest instance
     */
    IWindows10ImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
