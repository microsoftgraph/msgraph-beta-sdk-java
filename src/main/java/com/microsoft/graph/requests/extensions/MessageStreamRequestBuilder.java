...
public class MessageStreamRequestBuilder extends BaseRequestBuilder implements IMessageStreamRequestBuilder {
     ...
     */
    public IMessageStreamRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IMessageStreamRequest instance
     */
    public IMessageStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
