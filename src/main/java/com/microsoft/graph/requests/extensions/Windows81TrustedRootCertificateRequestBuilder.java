...
public class Windows81TrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IWindows81TrustedRootCertificateRequestBuilder {
     ...
     */
    public Windows81TrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
