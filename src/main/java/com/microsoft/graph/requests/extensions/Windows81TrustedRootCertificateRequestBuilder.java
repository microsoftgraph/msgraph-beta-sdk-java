 ...
 */
public class Windows81TrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IWindows81TrustedRootCertificateRequestBuilder {
     ...
     */
    public Windows81TrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindows81TrustedRootCertificateRequest instance
     */
    public IWindows81TrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows81TrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
