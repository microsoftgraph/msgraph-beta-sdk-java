...
/**
 * The interface for the Device Log Collection Response Request Builder.
 */
public interface IDeviceLogCollectionResponseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceLogCollectionResponseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
