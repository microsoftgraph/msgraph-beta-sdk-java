...
public class ParticipantCollectionRequestBuilder extends BaseRequestBuilder implements IParticipantCollectionRequestBuilder {
    ...
    public IParticipantMuteAllRequestBuilder muteAll(final java.util.List<String> participants, final String clientContext) {
        return new ParticipantMuteAllRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.muteAll"), getClient(), null, participants, clientContext);
    }
}
