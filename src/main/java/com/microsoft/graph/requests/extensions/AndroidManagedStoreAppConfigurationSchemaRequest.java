...
public class AndroidManagedStoreAppConfigurationSchemaRequest extends BaseRequest implements IAndroidManagedStoreAppConfigurationSchemaRequest {
     ...
     */
    public void get(final ICallback<AndroidManagedStoreAppConfigurationSchema> callback) {
     ...
     */
    public void delete(final ICallback<AndroidManagedStoreAppConfigurationSchema> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AndroidManagedStoreAppConfigurationSchema sourceAndroidManagedStoreAppConfigurationSchema, final ICallback<AndroidManagedStoreAppConfigurationSchema> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final AndroidManagedStoreAppConfigurationSchema newAndroidManagedStoreAppConfigurationSchema, final ICallback<AndroidManagedStoreAppConfigurationSchema> callback) {
     ...
     * @return the updated request
     */
     public IAndroidManagedStoreAppConfigurationSchemaRequest filter(final String value) {
