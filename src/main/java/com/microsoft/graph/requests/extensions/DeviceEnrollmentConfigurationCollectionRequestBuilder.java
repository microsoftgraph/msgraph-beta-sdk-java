...
public class DeviceEnrollmentConfigurationCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceEnrollmentConfigurationCollectionRequestBuilder {
    ...
    public IDeviceEnrollmentConfigurationHasPayloadLinksCollectionRequestBuilder hasPayloadLinks(final java.util.List<String> payloadIds) {
        return new DeviceEnrollmentConfigurationHasPayloadLinksCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.hasPayloadLinks"), getClient(), null, payloadIds);
    }
}
