 ...
 */
public class EndpointCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Endpoint within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Endpoint> value;
