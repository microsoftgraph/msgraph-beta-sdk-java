...
/**
 * The class for the Office Client Configuration Collection Response.
 */
public class OfficeClientConfigurationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OfficeClientConfiguration within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OfficeClientConfiguration> value;
