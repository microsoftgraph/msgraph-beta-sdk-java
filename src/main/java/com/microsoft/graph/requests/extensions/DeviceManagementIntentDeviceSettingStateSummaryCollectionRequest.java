...
public class DeviceManagementIntentDeviceSettingStateSummaryCollectionRequest extends BaseCollectionRequest<DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse, IDeviceManagementIntentDeviceSettingStateSummaryCollectionPage> implements IDeviceManagementIntentDeviceSettingStateSummaryCollectionRequest {
     ...
     */
    public DeviceManagementIntentDeviceSettingStateSummaryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
