 ...
 */
public class DeviceAppManagementTaskCollectionResponse implements IJsonBackedObject {

    /**
     * The list of DeviceAppManagementTask within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<DeviceAppManagementTask> value;
