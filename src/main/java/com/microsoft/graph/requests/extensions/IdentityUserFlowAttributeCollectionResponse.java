 ...
 */
public class IdentityUserFlowAttributeCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IdentityUserFlowAttribute within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IdentityUserFlowAttribute> value;
