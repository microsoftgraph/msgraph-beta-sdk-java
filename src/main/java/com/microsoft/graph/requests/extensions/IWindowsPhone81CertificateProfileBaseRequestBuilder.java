...
/**
 * The interface for the Windows Phone81Certificate Profile Base Request Builder.
 */
public interface IWindowsPhone81CertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81CertificateProfileBaseRequest instance
     */
    IWindowsPhone81CertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
