...
/**
 * The interface for the Cloud Pc On Premises Connection Request Builder.
 */
public interface ICloudPcOnPremisesConnectionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ICloudPcOnPremisesConnectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
