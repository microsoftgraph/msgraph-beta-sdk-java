...
public class ManagedDeviceSendCustomNotificationToCompanyPortalRequestBuilder extends BaseActionRequestBuilder implements IManagedDeviceSendCustomNotificationToCompanyPortalRequestBuilder {
     ...
     */
    public ManagedDeviceSendCustomNotificationToCompanyPortalRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String notificationTitle, final String notificationBody) {
     ...
     * @return the IManagedDeviceSendCustomNotificationToCompanyPortalRequest instance
     */
    public IManagedDeviceSendCustomNotificationToCompanyPortalRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
