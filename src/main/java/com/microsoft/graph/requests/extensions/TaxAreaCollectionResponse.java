...
/**
 * The class for the Tax Area Collection Response.
 */
public class TaxAreaCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TaxArea within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TaxArea> value;
