 ...
 */
public class GroupPolicyDefinitionValueWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<GroupPolicyDefinitionValue, GroupPolicyDefinitionValueWithReferenceRequest, GroupPolicyDefinitionValueReferenceRequestBuilder> {
     ...
     */
    public GroupPolicyDefinitionValueWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, GroupPolicyDefinitionValueWithReferenceRequest.class, GroupPolicyDefinitionValueReferenceRequestBuilder.class);
    }
}
