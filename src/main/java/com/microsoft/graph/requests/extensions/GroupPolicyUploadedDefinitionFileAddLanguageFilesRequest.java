...
public class GroupPolicyUploadedDefinitionFileAddLanguageFilesRequest extends BaseRequest<Void> {
    ...
    @Nullable
    protected GroupPolicyUploadedDefinitionFileAddLanguageFilesParameterSet body;
    /**
