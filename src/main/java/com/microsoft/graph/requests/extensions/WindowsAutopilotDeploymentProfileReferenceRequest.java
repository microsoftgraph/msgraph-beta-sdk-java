 ...
 */
public class WindowsAutopilotDeploymentProfileReferenceRequest extends BaseReferenceRequest<WindowsAutopilotDeploymentProfile> {
     ...
     */
    public WindowsAutopilotDeploymentProfileReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WindowsAutopilotDeploymentProfileReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WindowsAutopilotDeploymentProfileReferenceRequest expand(@Nonnull final String value) {
