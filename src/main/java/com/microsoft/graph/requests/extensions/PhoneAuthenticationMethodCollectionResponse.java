 ...
 */
public class PhoneAuthenticationMethodCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PhoneAuthenticationMethod within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PhoneAuthenticationMethod> value;
