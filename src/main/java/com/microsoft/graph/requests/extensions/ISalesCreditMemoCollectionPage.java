...
/**
 * The interface for the Sales Credit Memo Collection Page.
 */
public interface ISalesCreditMemoCollectionPage extends IBaseCollectionPage<SalesCreditMemo, ISalesCreditMemoCollectionRequestBuilder> {
}
