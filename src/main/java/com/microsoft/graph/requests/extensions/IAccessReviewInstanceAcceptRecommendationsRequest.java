...
/**
 * The interface for the Access Review Instance Accept Recommendations Request.
 */
public interface IAccessReviewInstanceAcceptRecommendationsRequest extends IHttpRequest {
