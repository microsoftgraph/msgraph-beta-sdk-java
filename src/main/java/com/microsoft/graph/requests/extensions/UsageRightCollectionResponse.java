 ...
 */
public class UsageRightCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UsageRight within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UsageRight> value;
