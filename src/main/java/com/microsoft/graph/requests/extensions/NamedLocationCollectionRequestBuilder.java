...
public class NamedLocationCollectionRequestBuilder extends BaseRequestBuilder implements INamedLocationCollectionRequestBuilder {
     ...
     */
    public NamedLocationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public INamedLocationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
