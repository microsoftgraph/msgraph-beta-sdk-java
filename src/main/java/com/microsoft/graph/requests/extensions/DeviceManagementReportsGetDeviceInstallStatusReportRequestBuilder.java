 ...
 */
public class DeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetDeviceInstallStatusReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetDeviceInstallStatusReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetDeviceInstallStatusReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetDeviceInstallStatusReportRequest instance
     */
    public IDeviceManagementReportsGetDeviceInstallStatusReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
