...
/**
 * The interface for the Windows81Certificate Profile Base Request Builder.
 */
public interface IWindows81CertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows81CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
