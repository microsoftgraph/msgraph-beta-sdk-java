 ...
 */
public class DeviceManagementResourceAccessProfileBaseAssignCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<DeviceManagementResourceAccessProfileAssignment> value;
