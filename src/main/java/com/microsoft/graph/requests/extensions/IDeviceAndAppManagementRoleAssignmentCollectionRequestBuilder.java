...
/**
 * The interface for the Device And App Management Role Assignment Collection Request Builder.
 */
public interface IDeviceAndAppManagementRoleAssignmentCollectionRequestBuilder extends IRequestBuilder {

    IDeviceAndAppManagementRoleAssignmentCollectionRequest buildRequest();

    IDeviceAndAppManagementRoleAssignmentCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
