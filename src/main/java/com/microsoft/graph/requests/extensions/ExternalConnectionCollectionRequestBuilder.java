...
public class ExternalConnectionCollectionRequestBuilder extends BaseRequestBuilder implements IExternalConnectionCollectionRequestBuilder {
     ...
     */
    public ExternalConnectionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IExternalConnectionCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IExternalConnectionCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
