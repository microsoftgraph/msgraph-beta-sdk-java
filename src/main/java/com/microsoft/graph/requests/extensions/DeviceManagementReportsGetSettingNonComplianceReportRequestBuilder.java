 ...
 */
public class DeviceManagementReportsGetSettingNonComplianceReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetSettingNonComplianceReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetSettingNonComplianceReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetSettingNonComplianceReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetSettingNonComplianceReportRequest instance
     */
    public IDeviceManagementReportsGetSettingNonComplianceReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
