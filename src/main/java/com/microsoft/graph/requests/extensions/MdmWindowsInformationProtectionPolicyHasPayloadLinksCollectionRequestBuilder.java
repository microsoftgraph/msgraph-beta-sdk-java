...
public class MdmWindowsInformationProtectionPolicyHasPayloadLinksCollectionRequestBuilder extends BaseActionRequestBuilder implements IMdmWindowsInformationProtectionPolicyHasPayloadLinksCollectionRequestBuilder {
     ...
     */
    public MdmWindowsInformationProtectionPolicyHasPayloadLinksCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final java.util.List<String> payloadIds) {
