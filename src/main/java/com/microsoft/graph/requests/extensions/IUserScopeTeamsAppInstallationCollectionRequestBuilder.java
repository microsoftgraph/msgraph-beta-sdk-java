...
public interface IUserScopeTeamsAppInstallationCollectionRequestBuilder extends IRequestBuilder {
    ...
    IUserScopeTeamsAppInstallationCollectionRequest buildRequest();

    IUserScopeTeamsAppInstallationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
