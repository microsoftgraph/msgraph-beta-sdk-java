...
/**
 * The class for the Legalhold Collection Response.
 */
public class LegalholdCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Legalhold within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Legalhold> value;
