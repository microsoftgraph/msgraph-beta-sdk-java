...
/**
 * The class for the Ios Edu Device Configuration Request Builder.
 */
public class IosEduDeviceConfigurationRequestBuilder extends BaseRequestBuilder<IosEduDeviceConfiguration> {

    /**
     * The request builder for the IosEduDeviceConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public IosEduDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosEduDeviceConfigurationRequest instance
     */
    @Nonnull
    public IosEduDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosEduDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosEduDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
