...
public class IosEduDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IIosEduDeviceConfigurationRequestBuilder {
     ...
     */
    public IosEduDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IIosEduDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IIosEduDeviceConfigurationRequest instance
     */
    public IIosEduDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
