...
public class TrustFrameworkKeySetUploadPkcs12Request extends BaseRequest<TrustFrameworkKey> {
     ...
     */
    public TrustFrameworkKeySetUploadPkcs12Request(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final TrustFrameworkKeySetUploadPkcs12ParameterSet parameters) {
    ...
    @Nullable
    protected TrustFrameworkKeySetUploadPkcs12ParameterSet body;
    /**
