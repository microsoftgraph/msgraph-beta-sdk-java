...
public interface IDeviceManagementIntentDeviceSettingStateSummaryRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    DeviceManagementIntentDeviceSettingStateSummary put(final DeviceManagementIntentDeviceSettingStateSummary newDeviceManagementIntentDeviceSettingStateSummary) throws ClientException;
