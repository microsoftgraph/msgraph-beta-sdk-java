...
public class PrintDocumentRequest extends BaseRequest implements IPrintDocumentRequest {
     ...
     */
    public PrintDocumentRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<PrintDocument> callback) {
     ...
     */
    public void delete(final ICallback<PrintDocument> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final PrintDocument sourcePrintDocument, final ICallback<PrintDocument> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final PrintDocument newPrintDocument, final ICallback<PrintDocument> callback) {
