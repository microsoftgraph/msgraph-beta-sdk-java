...
/**
 * The interface for the Group Policy Definition With Reference Request Builder.
 */
public interface IGroupPolicyDefinitionWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupPolicyDefinitionWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupPolicyDefinitionWithReferenceRequest instance
     */
    IGroupPolicyDefinitionWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IGroupPolicyDefinitionReferenceRequestBuilder reference();
