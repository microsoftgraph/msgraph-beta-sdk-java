...
public interface IDeviceConfigurationConflictSummaryRequestBuilder extends IRequestBuilder {
     ...
     */
    IDeviceConfigurationConflictSummaryRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDeviceConfigurationConflictSummaryRequest instance
     */
    IDeviceConfigurationConflictSummaryRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
