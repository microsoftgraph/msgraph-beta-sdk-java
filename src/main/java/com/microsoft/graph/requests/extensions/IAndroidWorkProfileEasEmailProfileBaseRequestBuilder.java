...
public interface IAndroidWorkProfileEasEmailProfileBaseRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidWorkProfileEasEmailProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidWorkProfileEasEmailProfileBaseRequest instance
     */
    IAndroidWorkProfileEasEmailProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
