 ...
 */
public class ProfileCardPropertyCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ProfileCardProperty within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ProfileCardProperty> value;
