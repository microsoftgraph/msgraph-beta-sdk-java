...
public class AppLogCollectionRequestCollectionRequestBuilder extends BaseRequestBuilder implements IAppLogCollectionRequestCollectionRequestBuilder {
     ...
     */
    public AppLogCollectionRequestCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAppLogCollectionRequestCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
