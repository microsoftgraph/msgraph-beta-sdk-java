...
/**
 * The interface for the Private Link Resource Collection Page.
 */
public interface IPrivateLinkResourceCollectionPage extends IBaseCollectionPage<PrivateLinkResource, IPrivateLinkResourceCollectionRequestBuilder> {
}
