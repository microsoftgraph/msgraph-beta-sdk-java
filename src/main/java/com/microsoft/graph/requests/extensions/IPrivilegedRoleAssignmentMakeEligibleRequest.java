...
/**
 * The interface for the Privileged Role Assignment Make Eligible Request.
 */
public interface IPrivilegedRoleAssignmentMakeEligibleRequest extends IHttpRequest {
     ...
     */
    IPrivilegedRoleAssignmentMakeEligibleRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrivilegedRoleAssignmentMakeEligibleRequest expand(final String value);
