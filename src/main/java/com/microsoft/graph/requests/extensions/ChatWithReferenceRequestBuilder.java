...
public class ChatWithReferenceRequestBuilder extends BaseRequestBuilder implements IChatWithReferenceRequestBuilder {
     ...
     */
    public ChatWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IChatWithReferenceRequest instance
     */
    public IChatWithReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
