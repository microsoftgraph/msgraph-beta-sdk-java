...
public class DocumentCommentCollectionRequest extends BaseCollectionRequest<DocumentCommentCollectionResponse, IDocumentCommentCollectionPage> implements IDocumentCommentCollectionRequest {
     ...
     */
    public DocumentCommentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
