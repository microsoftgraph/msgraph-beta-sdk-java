 ...
 */
public interface IWebAccountCollectionRequest {

    void get(final ICallback<IWebAccountCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	IWebAccountCollectionRequest skipToken(String skipToken);
}
