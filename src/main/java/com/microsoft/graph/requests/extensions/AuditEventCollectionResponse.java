 ...
 */
public class AuditEventCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AuditEvent within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AuditEvent> value;
