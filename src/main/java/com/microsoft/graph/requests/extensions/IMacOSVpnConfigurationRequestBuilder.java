...
/**
 * The interface for the Mac OSVpn Configuration Request Builder.
 */
public interface IMacOSVpnConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSVpnConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSVpnConfigurationRequest instance
     */
    IMacOSVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
     ...
     */
    IMacOSCertificateProfileBaseWithReferenceRequestBuilder identityCertificate();
