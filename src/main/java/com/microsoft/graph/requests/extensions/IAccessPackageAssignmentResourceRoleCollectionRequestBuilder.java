...
public interface IAccessPackageAssignmentResourceRoleCollectionRequestBuilder extends IRequestBuilder {
    ...
    IAccessPackageAssignmentResourceRoleCollectionRequest buildRequest();

    IAccessPackageAssignmentResourceRoleCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
