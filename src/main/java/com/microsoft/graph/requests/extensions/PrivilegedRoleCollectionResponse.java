...
/**
 * The class for the Privileged Role Collection Response.
 */
public class PrivilegedRoleCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PrivilegedRole within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PrivilegedRole> value;
