...
public class WindowsInformationProtectionDeviceRegistrationRequest extends BaseRequest implements IWindowsInformationProtectionDeviceRegistrationRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final WindowsInformationProtectionDeviceRegistration newWindowsInformationProtectionDeviceRegistration, final ICallback<WindowsInformationProtectionDeviceRegistration> callback) {
     ...
     * @return the updated request
     */
     public IWindowsInformationProtectionDeviceRegistrationRequest filter(final String value) {
