...
public class GroupPolicyDefinitionCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IGroupPolicyDefinitionCollectionReferenceRequestBuilder {
     ...
     */
    public GroupPolicyDefinitionCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IGroupPolicyDefinitionCollectionReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public IGroupPolicyDefinitionCollectionReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
