...
public interface IGroupPolicyConfigurationCollectionRequestBuilder extends IRequestBuilder {
    ...
    IGroupPolicyConfigurationCollectionRequest buildRequest();

    IGroupPolicyConfigurationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
