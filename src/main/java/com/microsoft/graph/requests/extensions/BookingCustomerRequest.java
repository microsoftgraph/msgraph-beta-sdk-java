...
import com.microsoft.graph.requests.extensions.IBookingCustomerRequest;
import com.microsoft.graph.requests.extensions.BookingCustomerRequest;
...
public class BookingCustomerRequest extends BaseRequest implements IBookingCustomerRequest {
     ...
     */
    public BookingCustomerRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
