 ...
 */
public class CaseOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CaseOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CaseOperation> value;
