...
/**
 * The interface for the Journal Request Builder.
 */
public interface IJournalRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IJournalRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IJournalRequest instance
     */
    IJournalRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
