 ...
 */
public class AospDeviceOwnerDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IAospDeviceOwnerDeviceConfigurationRequestBuilder {
     ...
     */
    public AospDeviceOwnerDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IAospDeviceOwnerDeviceConfigurationRequest instance
     */
    public IAospDeviceOwnerDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAospDeviceOwnerDeviceConfigurationRequest instance
     */
    public IAospDeviceOwnerDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AospDeviceOwnerDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
