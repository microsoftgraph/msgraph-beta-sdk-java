...
import com.microsoft.graph.requests.extensions.IEmailActivityUserDetailRequest;
import com.microsoft.graph.requests.extensions.EmailActivityUserDetailRequest;
...
public class EmailActivityUserDetailRequest extends BaseRequest implements IEmailActivityUserDetailRequest {
     ...
     */
    public EmailActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
