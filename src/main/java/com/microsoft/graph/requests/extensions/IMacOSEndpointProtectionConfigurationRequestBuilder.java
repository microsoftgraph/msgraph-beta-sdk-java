...
/**
 * The interface for the Mac OSEndpoint Protection Configuration Request Builder.
 */
public interface IMacOSEndpointProtectionConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSEndpointProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSEndpointProtectionConfigurationRequest instance
     */
    IMacOSEndpointProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
