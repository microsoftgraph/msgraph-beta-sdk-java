...
/**
 * The interface for the Unified Role Schedule Instance Base Request Builder.
 */
public interface IUnifiedRoleScheduleInstanceBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IUnifiedRoleScheduleInstanceBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUnifiedRoleScheduleInstanceBaseRequest instance
     */
    IUnifiedRoleScheduleInstanceBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
