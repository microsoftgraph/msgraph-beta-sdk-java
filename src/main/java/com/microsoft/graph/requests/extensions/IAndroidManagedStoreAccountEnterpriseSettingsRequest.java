...
/**
 * The interface for the Android Managed Store Account Enterprise Settings Request.
 */
public interface IAndroidManagedStoreAccountEnterpriseSettingsRequest extends IHttpRequest {
     ...
     */
    AndroidManagedStoreAccountEnterpriseSettings get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    AndroidManagedStoreAccountEnterpriseSettings patch(final AndroidManagedStoreAccountEnterpriseSettings sourceAndroidManagedStoreAccountEnterpriseSettings) throws ClientException;
     ...
     */
    IAndroidManagedStoreAccountEnterpriseSettingsRequest select(final String value);
     ...
     * @return the updated request
     */
    IAndroidManagedStoreAccountEnterpriseSettingsRequest expand(final String value);
