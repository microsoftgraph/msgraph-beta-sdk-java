 ...
 */
public class SiteSourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SiteSource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SiteSource> value;
