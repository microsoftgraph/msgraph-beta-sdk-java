...
/**
 * The interface for the Android For Work Settings Request.
 */
public interface IAndroidForWorkSettingsRequest extends IHttpRequest {
     ...
     */
    AndroidForWorkSettings get() throws ClientException;
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    AndroidForWorkSettings patch(final AndroidForWorkSettings sourceAndroidForWorkSettings) throws ClientException;
     ...
     */
    IAndroidForWorkSettingsRequest select(final String value);
     ...
     * @return the updated request
     */
    IAndroidForWorkSettingsRequest expand(final String value);
