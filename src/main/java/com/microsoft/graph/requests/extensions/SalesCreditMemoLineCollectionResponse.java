 ...
 */
public class SalesCreditMemoLineCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SalesCreditMemoLine within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SalesCreditMemoLine> value;
