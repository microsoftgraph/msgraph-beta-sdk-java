...
public class AccessPackageAssignmentPolicyRequest extends BaseRequest implements IAccessPackageAssignmentPolicyRequest {
     ...
     */
    public AccessPackageAssignmentPolicyRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<AccessPackageAssignmentPolicy> callback) {
     ...
     */
    public void delete(final ICallback<AccessPackageAssignmentPolicy> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AccessPackageAssignmentPolicy sourceAccessPackageAssignmentPolicy, final ICallback<AccessPackageAssignmentPolicy> callback) {
