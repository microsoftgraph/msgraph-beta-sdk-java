...
/**
 * The interface for the App Consent Request Collection Request.
 */
public interface IAppConsentRequestCollectionRequest {
     ...
     */
    IAppConsentRequestCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IAppConsentRequestCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IAppConsentRequestCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IAppConsentRequestCollectionRequest skip(final int value);
