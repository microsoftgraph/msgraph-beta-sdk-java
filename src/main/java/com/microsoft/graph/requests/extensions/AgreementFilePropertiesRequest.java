...
import com.microsoft.graph.requests.extensions.IAgreementFilePropertiesRequest;
import com.microsoft.graph.requests.extensions.AgreementFilePropertiesRequest;
...
public class AgreementFilePropertiesRequest extends BaseRequest implements IAgreementFilePropertiesRequest {
     ...
     * @param requestOptions the options for this request
     */
    public AgreementFilePropertiesRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
