...
public class ReportRootGetOneDriveUsageAccountDetailCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetOneDriveUsageAccountDetailCollectionRequestBuilder {
     ...
     * @param date the date
     */
    public ReportRootGetOneDriveUsageAccountDetailCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.microsoft.graph.models.extensions.DateOnly date) {
     ...
     */
    public ReportRootGetOneDriveUsageAccountDetailCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     	 if(period!=null){
    ...
    public IReportRootGetOneDriveUsageAccountDetailCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
