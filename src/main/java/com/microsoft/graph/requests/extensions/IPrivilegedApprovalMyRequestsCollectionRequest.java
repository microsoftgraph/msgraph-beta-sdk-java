...
public interface IPrivilegedApprovalMyRequestsCollectionRequest {
     ...
     */
    IPrivilegedApprovalMyRequestsCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IPrivilegedApprovalMyRequestsCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IPrivilegedApprovalMyRequestsCollectionRequest top(final int value);
