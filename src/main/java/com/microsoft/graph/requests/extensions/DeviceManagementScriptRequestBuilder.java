...
public class DeviceManagementScriptRequestBuilder extends BaseRequestBuilder implements IDeviceManagementScriptRequestBuilder {
     ...
     */
    public DeviceManagementScriptRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IDeviceManagementScriptRequest instance
     */
    public IDeviceManagementScriptRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
