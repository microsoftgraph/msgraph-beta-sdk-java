...
public class ChatMessageCollectionRequestBuilder extends BaseRequestBuilder implements IChatMessageCollectionRequestBuilder {
     ...
     */
    public ChatMessageCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IChatMessageCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
    ...
    public IChatMessageDeltaCollectionRequestBuilder delta() {
	...
	public IChatMessageDeltaCollectionRequestBuilder delta(final String deltaLink) {
        return new ChatMessageDeltaCollectionRequestBuilder(deltaLink, getClient(), null);
    }
}
