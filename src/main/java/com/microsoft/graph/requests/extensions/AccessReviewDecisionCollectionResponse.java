 ...
 */
public class AccessReviewDecisionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of AccessReviewDecision within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<AccessReviewDecision> value;
