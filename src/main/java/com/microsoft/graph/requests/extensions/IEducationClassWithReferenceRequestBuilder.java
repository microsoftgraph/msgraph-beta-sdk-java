 ...
 */
public interface IEducationClassWithReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IEducationClassWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IEducationClassWithReferenceRequest instance
     */
    IEducationClassWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
