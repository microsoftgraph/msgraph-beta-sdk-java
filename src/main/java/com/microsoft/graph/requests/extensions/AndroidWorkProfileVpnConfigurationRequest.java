...
public class AndroidWorkProfileVpnConfigurationRequest extends BaseRequest implements IAndroidWorkProfileVpnConfigurationRequest {
     ...
     */
    public AndroidWorkProfileVpnConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<AndroidWorkProfileVpnConfiguration> callback) {
     ...
     */
    public void delete(final ICallback<AndroidWorkProfileVpnConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AndroidWorkProfileVpnConfiguration sourceAndroidWorkProfileVpnConfiguration, final ICallback<AndroidWorkProfileVpnConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final AndroidWorkProfileVpnConfiguration newAndroidWorkProfileVpnConfiguration, final ICallback<AndroidWorkProfileVpnConfiguration> callback) {
