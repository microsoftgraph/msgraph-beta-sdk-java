...
/**
 * The interface for the Outlook Task Folder Collection Page.
 */
public interface IOutlookTaskFolderCollectionPage extends IBaseCollectionPage<OutlookTaskFolder, IOutlookTaskFolderCollectionRequestBuilder> {
}
