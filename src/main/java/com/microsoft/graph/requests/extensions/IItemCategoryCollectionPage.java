...
/**
 * The interface for the Item Category Collection Page.
 */
public interface IItemCategoryCollectionPage extends IBaseCollectionPage<ItemCategory, IItemCategoryCollectionRequestBuilder> {
}
