...
/**
 * The interface for the Group Policy Presentation Dropdown List Request Builder.
 */
public interface IGroupPolicyPresentationDropdownListRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IGroupPolicyPresentationDropdownListRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
