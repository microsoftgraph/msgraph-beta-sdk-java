...
/**
 * The interface for the Windows Phone EASEmail Profile Configuration Request Builder.
 */
public interface IWindowsPhoneEASEmailProfileConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IWindowsPhoneEASEmailProfileConfigurationRequest instance
     */
    IWindowsPhoneEASEmailProfileConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
