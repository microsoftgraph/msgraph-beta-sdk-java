 ...
 */
public class ReportRootGetEmailAppUsageAppsUserCountsCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<EmailAppUsageAppsUserCounts> value;
