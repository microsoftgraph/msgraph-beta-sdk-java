 ...
 */
public class AndroidImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidImportedPFXCertificateProfile> {
     ...
     */
    public AndroidImportedPFXCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidImportedPFXCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidImportedPFXCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidImportedPFXCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
