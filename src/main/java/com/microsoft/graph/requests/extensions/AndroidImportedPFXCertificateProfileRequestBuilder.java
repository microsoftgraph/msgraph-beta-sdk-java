...
public class AndroidImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public AndroidImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidImportedPFXCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidImportedPFXCertificateProfileRequest instance
     */
    public IAndroidImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
