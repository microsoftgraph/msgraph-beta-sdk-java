...
public class CertificateBasedAuthConfigurationRequestBuilder extends BaseRequestBuilder implements ICertificateBasedAuthConfigurationRequestBuilder {
     ...
     */
    public CertificateBasedAuthConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the ICertificateBasedAuthConfigurationRequest instance
     */
    public ICertificateBasedAuthConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.CertificateBasedAuthConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
