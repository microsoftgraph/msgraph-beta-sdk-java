...
public class DeviceCompliancePolicyStateCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceCompliancePolicyStateCollectionRequestBuilder {
     ...
     */
    public DeviceCompliancePolicyStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IDeviceCompliancePolicyStateCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IDeviceCompliancePolicyStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
