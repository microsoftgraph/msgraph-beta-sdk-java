...
public class ScheduleShareRequestBuilder extends BaseActionRequestBuilder implements IScheduleShareRequestBuilder {
     ...
     */
    public ScheduleShareRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final Boolean notifyTeam, final java.util.Calendar startDateTime, final java.util.Calendar endDateTime) {
     ...
     * @return the IScheduleShareRequest instance
     */
    public IScheduleShareRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
