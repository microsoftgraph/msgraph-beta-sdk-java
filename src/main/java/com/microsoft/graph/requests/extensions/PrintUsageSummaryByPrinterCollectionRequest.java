 ...
 */
public class PrintUsageSummaryByPrinterCollectionRequest extends BaseCollectionRequest<PrintUsageSummaryByPrinterCollectionResponse, IPrintUsageSummaryByPrinterCollectionPage> implements IPrintUsageSummaryByPrinterCollectionRequest {
     ...
     */
    public PrintUsageSummaryByPrinterCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PrintUsageSummaryByPrinterCollectionResponse.class, IPrintUsageSummaryByPrinterCollectionPage.class);
    }

    public void get(final ICallback<? super IPrintUsageSummaryByPrinterCollectionPage> callback) {
    ...
    public IPrintUsageSummaryByPrinterCollectionPage get() throws ClientException {
        final PrintUsageSummaryByPrinterCollectionResponse response = send();
     ...
     */
    public IPrintUsageSummaryByPrinterCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IPrintUsageSummaryByPrinterCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IPrintUsageSummaryByPrinterCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IPrintUsageSummaryByPrinterCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IPrintUsageSummaryByPrinterCollectionRequest top(final int value) {
    ...
    public IPrintUsageSummaryByPrinterCollectionPage buildFromResponse(final PrintUsageSummaryByPrinterCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new PrintUsageSummaryByPrinterCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final PrintUsageSummaryByPrinterCollectionPage page = new PrintUsageSummaryByPrinterCollectionPage(response, builder);
