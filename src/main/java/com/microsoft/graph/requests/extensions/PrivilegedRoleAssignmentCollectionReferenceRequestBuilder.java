...
public class PrivilegedRoleAssignmentCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IPrivilegedRoleAssignmentCollectionReferenceRequestBuilder {
     ...
     */
    public PrivilegedRoleAssignmentCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
