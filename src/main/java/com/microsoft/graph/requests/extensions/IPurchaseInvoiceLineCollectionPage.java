...
/**
 * The interface for the Purchase Invoice Line Collection Page.
 */
public interface IPurchaseInvoiceLineCollectionPage extends IBaseCollectionPage<PurchaseInvoiceLine, IPurchaseInvoiceLineCollectionRequestBuilder> {
}
