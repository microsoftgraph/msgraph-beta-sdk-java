...
/**
 * The class for the Apple Vpn Configuration Request Builder.
 */
public class AppleVpnConfigurationRequestBuilder extends BaseRequestBuilder<AppleVpnConfiguration> {

    /**
     * The request builder for the AppleVpnConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AppleVpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AppleVpnConfigurationRequest instance
     */
    @Nonnull
    public AppleVpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AppleVpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AppleVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
