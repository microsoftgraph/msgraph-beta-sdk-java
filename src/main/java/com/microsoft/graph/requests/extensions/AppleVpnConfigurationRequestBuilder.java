 ...
 */
public class AppleVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IAppleVpnConfigurationRequestBuilder {
     ...
     */
    public AppleVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAppleVpnConfigurationRequest instance
     */
    public IAppleVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
