...
public class AndroidWorkProfileCertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileCertificateProfileBaseRequestBuilder {
     ...
     */
    public AndroidWorkProfileCertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWorkProfileCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileCertificateProfileBaseRequest instance
     */
    public IAndroidWorkProfileCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
