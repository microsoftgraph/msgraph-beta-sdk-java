 ...
 */
public class NotebookGetRecentNotebooksCollectionRequest extends BaseFunctionCollectionRequest<RecentNotebook, NotebookGetRecentNotebooksCollectionResponse, NotebookGetRecentNotebooksCollectionPage> {
     ...
     */
    @Nonnull
    public NotebookGetRecentNotebooksCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public NotebookGetRecentNotebooksCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public NotebookGetRecentNotebooksCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public NotebookGetRecentNotebooksCollectionRequest skipToken(@Nonnull final String skipToken) {
