...
/**
 * The interface for the Unit Of Measure Collection Page.
 */
public interface IUnitOfMeasureCollectionPage extends IBaseCollectionPage<UnitOfMeasure, IUnitOfMeasureCollectionRequestBuilder> {
}
