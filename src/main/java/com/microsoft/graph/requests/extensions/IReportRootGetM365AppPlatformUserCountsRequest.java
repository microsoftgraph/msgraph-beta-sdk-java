...
/**
 * The interface for the Report Root Get M365App Platform User Counts Request.
 */
public interface IReportRootGetM365AppPlatformUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetM365AppPlatformUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetM365AppPlatformUserCountsRequest expand(final String value);
