...
/**
 * The class for the Approval Workflow Provider Collection Response.
 */
public class ApprovalWorkflowProviderCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ApprovalWorkflowProvider within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ApprovalWorkflowProvider> value;
