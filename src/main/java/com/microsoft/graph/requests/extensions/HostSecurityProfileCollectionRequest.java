...
public class HostSecurityProfileCollectionRequest extends BaseCollectionRequest<HostSecurityProfileCollectionResponse, IHostSecurityProfileCollectionPage> implements IHostSecurityProfileCollectionRequest {
     ...
     */
    public HostSecurityProfileCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public void get(final ICallback<? super IHostSecurityProfileCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IHostSecurityProfileCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IHostSecurityProfileCollectionRequest orderBy(final String value) {
