 ...
 */
public class SharePointActivityUserDetailRequest extends BaseRequest implements ISharePointActivityUserDetailRequest {
     ...
     */
    public SharePointActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public SharePointActivityUserDetail patch(final SharePointActivityUserDetail sourceSharePointActivityUserDetail) throws ClientException {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    public SharePointActivityUserDetail post(final SharePointActivityUserDetail newSharePointActivityUserDetail) throws ClientException {
     ...
     */
     public ISharePointActivityUserDetailRequest select(final String value) {
