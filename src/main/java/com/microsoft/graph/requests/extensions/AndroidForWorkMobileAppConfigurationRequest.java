...
import com.microsoft.graph.requests.extensions.AndroidForWorkMobileAppConfigurationRequest;
...
public class AndroidForWorkMobileAppConfigurationRequest extends BaseRequest implements IAndroidForWorkMobileAppConfigurationRequest {
     ...
     */
    public AndroidForWorkMobileAppConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<AndroidForWorkMobileAppConfiguration> callback) {
     ...
     */
    public void delete(final ICallback<AndroidForWorkMobileAppConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final AndroidForWorkMobileAppConfiguration sourceAndroidForWorkMobileAppConfiguration, final ICallback<AndroidForWorkMobileAppConfiguration> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final AndroidForWorkMobileAppConfiguration newAndroidForWorkMobileAppConfiguration, final ICallback<AndroidForWorkMobileAppConfiguration> callback) {
