 ...
 */
public interface IReportRootGetOffice365GroupsActivityDetailCollectionRequest extends IHttpRequest {

    void get(final ICallback<? super IReportRootGetOffice365GroupsActivityDetailCollectionPage> callback);
