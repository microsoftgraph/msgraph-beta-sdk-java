...
public class DeviceManagementDomainJoinConnectorCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementDomainJoinConnectorCollectionRequestBuilder {
     ...
     */
    public DeviceManagementDomainJoinConnectorCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceManagementDomainJoinConnectorCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
