...
import com.microsoft.graph.requests.extensions.ILookupResultRowCollectionPage;
...
public class LookupResultRowCollectionRequest extends BaseCollectionRequest<LookupResultRowCollectionResponse, ILookupResultRowCollectionPage> implements ILookupResultRowCollectionRequest {
     ...
     */
    public LookupResultRowCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
