...
public class BusinessFlowTemplateCollectionRequestBuilder extends BaseRequestBuilder implements IBusinessFlowTemplateCollectionRequestBuilder {
     ...
     */
    public BusinessFlowTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IBusinessFlowTemplateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
