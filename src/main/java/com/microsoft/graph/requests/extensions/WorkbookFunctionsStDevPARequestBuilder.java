...
public class WorkbookFunctionsStDevPARequestBuilder extends BaseActionRequestBuilder implements IWorkbookFunctionsStDevPARequestBuilder {
     ...
     */
    public WorkbookFunctionsStDevPARequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     */
    public IWorkbookFunctionsStDevPARequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookFunctionsStDevPARequest instance
     */
    public IWorkbookFunctionsStDevPARequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
