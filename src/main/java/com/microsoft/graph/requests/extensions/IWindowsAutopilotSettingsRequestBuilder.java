...
public interface IWindowsAutopilotSettingsRequestBuilder extends IRequestBuilder {
     ...
     */
    IWindowsAutopilotSettingsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsAutopilotSettingsRequest instance
     */
    IWindowsAutopilotSettingsRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
