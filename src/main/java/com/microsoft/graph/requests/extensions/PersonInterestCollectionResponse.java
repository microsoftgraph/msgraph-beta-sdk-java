 ...
 */
public class PersonInterestCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PersonInterest within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PersonInterest> value;
