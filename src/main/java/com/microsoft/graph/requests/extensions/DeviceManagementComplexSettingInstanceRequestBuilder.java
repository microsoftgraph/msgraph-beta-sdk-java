...
import com.microsoft.graph.requests.extensions.DeviceManagementComplexSettingInstanceRequest;
...
public class DeviceManagementComplexSettingInstanceRequestBuilder extends BaseRequestBuilder implements IDeviceManagementComplexSettingInstanceRequestBuilder {
     ...
     */
    public DeviceManagementComplexSettingInstanceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceManagementComplexSettingInstanceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new DeviceManagementComplexSettingInstanceRequest(getRequestUrl(), getClient(), requestOptions);
    }
