 ...
 */
public class UnifiedRoleManagementPolicyRuleCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRoleManagementPolicyRule within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleManagementPolicyRule> value;
