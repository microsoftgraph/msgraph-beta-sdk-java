...
/**
 * The interface for the Enrollment Profile Collection Page.
 */
public interface IEnrollmentProfileCollectionPage extends IBaseCollectionPage<EnrollmentProfile, IEnrollmentProfileCollectionRequestBuilder> {
}
