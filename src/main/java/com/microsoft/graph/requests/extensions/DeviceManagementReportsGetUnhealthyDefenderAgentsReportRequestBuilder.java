 ...
 */
public class DeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequestBuilder {
    ...
    /**
     * Creates the IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest instance
     */
    public IDeviceManagementReportsGetUnhealthyDefenderAgentsReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
