...
public class DeviceComplianceScriptDeviceStateCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceComplianceScriptDeviceStateCollectionRequestBuilder {
     ...
     */
    public DeviceComplianceScriptDeviceStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceComplianceScriptDeviceStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
