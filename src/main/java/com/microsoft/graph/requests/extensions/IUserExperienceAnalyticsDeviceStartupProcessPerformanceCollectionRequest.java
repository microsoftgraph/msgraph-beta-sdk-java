...
/**
 * The interface for the User Experience Analytics Device Startup Process Performance Collection Request.
 */
public interface IUserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionRequest {
     ...
     */
    IUserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IUserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionRequest skip(final int value);
