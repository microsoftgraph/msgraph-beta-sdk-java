...
/**
 * The interface for the Android For Work Pkcs Certificate Profile Request Builder.
 */
public interface IAndroidForWorkPkcsCertificateProfileRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidForWorkPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkPkcsCertificateProfileRequest instance
     */
    IAndroidForWorkPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
