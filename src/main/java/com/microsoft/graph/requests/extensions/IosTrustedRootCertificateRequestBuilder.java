 ...
 */
public class IosTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<IosTrustedRootCertificate> {
     ...
     */
    public IosTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosTrustedRootCertificateRequest instance
     */
    @Nonnull
    public IosTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
