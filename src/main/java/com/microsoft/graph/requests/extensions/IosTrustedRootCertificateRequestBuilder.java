...
public class IosTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IIosTrustedRootCertificateRequestBuilder {
     ...
     */
    public IosTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosTrustedRootCertificateRequest instance
     */
    public IIosTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
