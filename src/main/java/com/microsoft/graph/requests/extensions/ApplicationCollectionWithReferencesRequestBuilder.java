...
public class ApplicationCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IApplicationCollectionWithReferencesRequestBuilder {
     ...
     */
    public ApplicationCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IApplicationCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
