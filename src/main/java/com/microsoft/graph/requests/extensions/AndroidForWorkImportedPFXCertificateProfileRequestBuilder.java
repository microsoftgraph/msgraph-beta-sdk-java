...
public class AndroidForWorkImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public AndroidForWorkImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidForWorkImportedPFXCertificateProfileRequest instance
     */
    public IAndroidForWorkImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
