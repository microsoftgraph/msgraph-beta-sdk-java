...
public class Office365GroupsActivityFileCountsRequestBuilder extends BaseRequestBuilder implements IOffice365GroupsActivityFileCountsRequestBuilder {
     ...
     */
    public Office365GroupsActivityFileCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IOffice365GroupsActivityFileCountsRequest buildRequest() {
