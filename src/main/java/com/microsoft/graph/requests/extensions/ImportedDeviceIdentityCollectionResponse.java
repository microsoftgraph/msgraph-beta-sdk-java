...
/**
 * The class for the Imported Device Identity Collection Response.
 */
public class ImportedDeviceIdentityCollectionResponse implements IJsonBackedObject {

    /**
     * The list of ImportedDeviceIdentity within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<ImportedDeviceIdentity> value;
