...
/**
 * The interface for the Device Compliance Action Item Request Builder.
 */
public interface IDeviceComplianceActionItemRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @return the IDeviceComplianceActionItemRequest instance
     */
    IDeviceComplianceActionItemRequest buildRequest();
