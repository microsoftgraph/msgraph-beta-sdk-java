...
public class UserExperienceAnalyticsAppHealthOSVersionPerformanceRequest extends BaseRequest implements IUserExperienceAnalyticsAppHealthOSVersionPerformanceRequest {
     ...
     */
    public void get(final ICallback<UserExperienceAnalyticsAppHealthOSVersionPerformance> callback) {
     ...
     */
    public void delete(final ICallback<UserExperienceAnalyticsAppHealthOSVersionPerformance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final UserExperienceAnalyticsAppHealthOSVersionPerformance sourceUserExperienceAnalyticsAppHealthOSVersionPerformance, final ICallback<UserExperienceAnalyticsAppHealthOSVersionPerformance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final UserExperienceAnalyticsAppHealthOSVersionPerformance newUserExperienceAnalyticsAppHealthOSVersionPerformance, final ICallback<UserExperienceAnalyticsAppHealthOSVersionPerformance> callback) {
     ...
     * @return the updated request
     */
     public IUserExperienceAnalyticsAppHealthOSVersionPerformanceRequest filter(final String value) {
