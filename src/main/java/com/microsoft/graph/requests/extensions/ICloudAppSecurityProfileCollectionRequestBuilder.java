...
public interface ICloudAppSecurityProfileCollectionRequestBuilder extends IRequestBuilder {
    ...
    ICloudAppSecurityProfileCollectionRequest buildRequest();

    ICloudAppSecurityProfileCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
