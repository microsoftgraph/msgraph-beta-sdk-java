...
public class Windows10PkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IWindows10PkcsCertificateProfileRequestBuilder {
     ...
     */
    public Windows10PkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IWindows10PkcsCertificateProfileRequest instance
     */
    public IWindows10PkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
