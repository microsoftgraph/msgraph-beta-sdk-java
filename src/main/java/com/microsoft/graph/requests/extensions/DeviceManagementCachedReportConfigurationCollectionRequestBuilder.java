...
public class DeviceManagementCachedReportConfigurationCollectionRequestBuilder extends BaseRequestBuilder implements IDeviceManagementCachedReportConfigurationCollectionRequestBuilder {
     ...
     */
    public DeviceManagementCachedReportConfigurationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceManagementCachedReportConfigurationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
