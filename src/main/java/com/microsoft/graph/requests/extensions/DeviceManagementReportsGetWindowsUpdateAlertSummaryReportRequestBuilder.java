 ...
 */
public class DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequestBuilder {
    ...
    /**
     * Creates the IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest instance
     */
    public IDeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest request = new DeviceManagementReportsGetWindowsUpdateAlertSummaryReportRequest(
                getRequestUrl(),
                getClient(),
                requestOptions
        );
