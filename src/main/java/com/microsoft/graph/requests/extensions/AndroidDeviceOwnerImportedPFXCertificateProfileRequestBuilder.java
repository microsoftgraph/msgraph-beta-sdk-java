...
public class AndroidDeviceOwnerImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerImportedPFXCertificateProfileRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerImportedPFXCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerImportedPFXCertificateProfileRequest instance
     */
    public IAndroidDeviceOwnerImportedPFXCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
