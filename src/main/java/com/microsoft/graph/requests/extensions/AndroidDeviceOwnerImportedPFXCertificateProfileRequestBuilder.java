 ...
 */
public class AndroidDeviceOwnerImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerImportedPFXCertificateProfile> {
     ...
     */
    public AndroidDeviceOwnerImportedPFXCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerImportedPFXCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerImportedPFXCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerImportedPFXCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidDeviceOwnerImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
