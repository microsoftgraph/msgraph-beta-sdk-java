 ...
 */
public class AndroidWorkProfileEasEmailProfileBaseRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileEasEmailProfileBase> {
     ...
     */
    public AndroidWorkProfileEasEmailProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileEasEmailProfileBaseRequest instance
     */
    @Nonnull
    public AndroidWorkProfileEasEmailProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileEasEmailProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileEasEmailProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
