...
public class AndroidWorkProfileEasEmailProfileBaseRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileEasEmailProfileBaseRequestBuilder {
     ...
     */
    public AndroidWorkProfileEasEmailProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidWorkProfileEasEmailProfileBaseRequest instance
     */
    public IAndroidWorkProfileEasEmailProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
