...
public class AppScopeRequest extends BaseRequest<AppScope> {
     ...
     */
    public void get(@Nonnull final ICallback<? super AppScope> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super AppScope> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final AppScope sourceAppScope, @Nonnull final ICallback<? super AppScope> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final AppScope newAppScope, @Nonnull final ICallback<? super AppScope> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final AppScope newAppScope, @Nonnull final ICallback<? super AppScope> callback) {
