...
import com.microsoft.graph.requests.extensions.SalesCreditMemoLineRequest;
...
public class SalesCreditMemoLineRequest extends BaseRequest implements ISalesCreditMemoLineRequest {
     ...
     */
    public SalesCreditMemoLineRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
