 ...
 */
public class DeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetConfigurationSettingDetailsReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest instance
     */
    public IDeviceManagementReportsGetConfigurationSettingDetailsReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        DeviceManagementReportsGetConfigurationSettingDetailsReportRequest request = new DeviceManagementReportsGetConfigurationSettingDetailsReportRequest(
                getRequestUrl(),
                getClient(),
                requestOptions
        );
