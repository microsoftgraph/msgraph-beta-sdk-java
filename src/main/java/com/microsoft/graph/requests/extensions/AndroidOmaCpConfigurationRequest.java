...
import com.microsoft.graph.requests.extensions.IAndroidOmaCpConfigurationRequest;
import com.microsoft.graph.requests.extensions.AndroidOmaCpConfigurationRequest;
...
public class AndroidOmaCpConfigurationRequest extends BaseRequest implements IAndroidOmaCpConfigurationRequest {
     ...
     */
    public AndroidOmaCpConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
