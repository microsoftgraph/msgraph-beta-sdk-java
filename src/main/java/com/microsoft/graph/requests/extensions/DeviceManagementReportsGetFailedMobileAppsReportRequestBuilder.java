 ...
 */
public class DeviceManagementReportsGetFailedMobileAppsReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetFailedMobileAppsReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetFailedMobileAppsReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetFailedMobileAppsReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetFailedMobileAppsReportRequest instance
     */
    public IDeviceManagementReportsGetFailedMobileAppsReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        DeviceManagementReportsGetFailedMobileAppsReportRequest request = new DeviceManagementReportsGetFailedMobileAppsReportRequest(
                getRequestUrl(),
                getClient(),
                requestOptions
        );
