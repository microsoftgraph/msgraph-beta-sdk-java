...
public class ConnectorGroupCollectionRequest extends BaseCollectionRequest<ConnectorGroupCollectionResponse, IConnectorGroupCollectionPage> implements IConnectorGroupCollectionRequest {
     ...
     */
    public ConnectorGroupCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ConnectorGroupCollectionResponse.class, IConnectorGroupCollectionPage.class);
    }

    public void get(final ICallback<? super IConnectorGroupCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IConnectorGroupCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IConnectorGroupCollectionRequest orderBy(final String value) {
