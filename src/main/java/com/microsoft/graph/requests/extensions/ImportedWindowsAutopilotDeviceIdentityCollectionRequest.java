...
import com.microsoft.graph.requests.extensions.IImportedWindowsAutopilotDeviceIdentityCollectionPage;
 ...
 */
public class ImportedWindowsAutopilotDeviceIdentityCollectionRequest extends BaseCollectionRequest<ImportedWindowsAutopilotDeviceIdentityCollectionResponse, IImportedWindowsAutopilotDeviceIdentityCollectionPage> implements IImportedWindowsAutopilotDeviceIdentityCollectionRequest {
     ...
     */
    public ImportedWindowsAutopilotDeviceIdentityCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IImportedWindowsAutopilotDeviceIdentityCollectionPage get() throws ClientException {
        final ImportedWindowsAutopilotDeviceIdentityCollectionResponse response = send();
     ...
     */
    public IImportedWindowsAutopilotDeviceIdentityCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IImportedWindowsAutopilotDeviceIdentityCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IImportedWindowsAutopilotDeviceIdentityCollectionRequest top(final int value) {
    ...
    public IImportedWindowsAutopilotDeviceIdentityCollectionPage buildFromResponse(final ImportedWindowsAutopilotDeviceIdentityCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new ImportedWindowsAutopilotDeviceIdentityCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final ImportedWindowsAutopilotDeviceIdentityCollectionPage page = new ImportedWindowsAutopilotDeviceIdentityCollectionPage(response, builder);
