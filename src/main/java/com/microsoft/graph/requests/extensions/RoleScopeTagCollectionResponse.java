...
/**
 * The class for the Role Scope Tag Collection Response.
 */
public class RoleScopeTagCollectionResponse implements IJsonBackedObject {

    /**
     * The list of RoleScopeTag within this collection page
     */
