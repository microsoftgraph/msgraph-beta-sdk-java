...
public class BookingCurrencyRequest extends BaseRequest implements IBookingCurrencyRequest {
     ...
     */
    public void get(final ICallback<? super BookingCurrency> callback) {
     ...
     */
    public void delete(final ICallback<? super BookingCurrency> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final BookingCurrency sourceBookingCurrency, final ICallback<? super BookingCurrency> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(final BookingCurrency newBookingCurrency, final ICallback<? super BookingCurrency> callback) {
