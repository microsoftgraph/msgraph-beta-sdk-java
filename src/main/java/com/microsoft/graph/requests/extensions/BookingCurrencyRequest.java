...
public class BookingCurrencyRequest extends BaseRequest<BookingCurrency> {
     ...
     */
    public void get(@Nonnull final ICallback<? super BookingCurrency> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super BookingCurrency> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final BookingCurrency sourceBookingCurrency, @Nonnull final ICallback<? super BookingCurrency> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final BookingCurrency newBookingCurrency, @Nonnull final ICallback<? super BookingCurrency> callback) {
