 ...
 */
public class DeviceManagementReportsGetReportFiltersRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetReportFiltersRequestBuilder {
    ...
    /**
     * Creates the IDeviceManagementReportsGetReportFiltersRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetReportFiltersRequest instance
     */
    public IDeviceManagementReportsGetReportFiltersRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
