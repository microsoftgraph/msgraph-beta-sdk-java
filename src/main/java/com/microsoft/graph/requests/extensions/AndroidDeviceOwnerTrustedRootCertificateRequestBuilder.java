 ...
 */
public class AndroidDeviceOwnerTrustedRootCertificateRequestBuilder extends BaseRequestBuilder implements IAndroidDeviceOwnerTrustedRootCertificateRequestBuilder {
     ...
     */
    public AndroidDeviceOwnerTrustedRootCertificateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidDeviceOwnerTrustedRootCertificateRequest instance
     */
    public IAndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
