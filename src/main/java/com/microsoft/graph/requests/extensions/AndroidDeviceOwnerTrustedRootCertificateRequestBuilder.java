...
/**
 * The class for the Android Device Owner Trusted Root Certificate Request Builder.
 */
public class AndroidDeviceOwnerTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerTrustedRootCertificate> {
     ...
     */
    public AndroidDeviceOwnerTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerTrustedRootCertificateRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidDeviceOwnerTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
