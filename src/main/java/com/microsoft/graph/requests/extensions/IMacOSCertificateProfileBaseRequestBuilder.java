...
/**
 * The interface for the Mac OSCertificate Profile Base Request Builder.
 */
public interface IMacOSCertificateProfileBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IMacOSCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IMacOSCertificateProfileBaseRequest instance
     */
    IMacOSCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
