...
/**
 * The class for the Unified Role Assignment Request Filter By Current User Collection Response.
 */
public class UnifiedRoleAssignmentRequestFilterByCurrentUserCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleAssignmentRequest> value;
