 ...
 */
public class IdentityUserFlowCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IdentityUserFlow within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IdentityUserFlow> value;
