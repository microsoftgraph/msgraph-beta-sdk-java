 ...
 */
public interface IAgreementCollectionRequest {

    void get(final ICallback<IAgreementCollectionPage> callback);
	 ...
	 * @return the updated request
	 */
	IAgreementCollectionRequest skipToken(String skipToken);
}
