...
/**
 * The class for the Privileged Signup Status Collection Response.
 */
public class PrivilegedSignupStatusCollectionResponse implements IJsonBackedObject {
    ...
    @Expose
    public java.util.List<PrivilegedSignupStatus> value;
