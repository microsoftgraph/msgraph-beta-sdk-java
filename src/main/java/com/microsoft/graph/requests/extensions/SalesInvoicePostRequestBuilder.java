...
public class SalesInvoicePostRequestBuilder extends BaseActionRequestBuilder implements ISalesInvoicePostRequestBuilder {
     ...
     */
    public SalesInvoicePostRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public ISalesInvoicePostRequest buildRequest() {
     ...
     * @return the ISalesInvoicePostRequest instance
     */
    public ISalesInvoicePostRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
