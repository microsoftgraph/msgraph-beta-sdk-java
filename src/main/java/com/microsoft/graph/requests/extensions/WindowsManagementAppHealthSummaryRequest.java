...
import com.microsoft.graph.requests.extensions.WindowsManagementAppHealthSummaryRequest;
...
public class WindowsManagementAppHealthSummaryRequest extends BaseRequest implements IWindowsManagementAppHealthSummaryRequest {
     ...
     */
    public WindowsManagementAppHealthSummaryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
