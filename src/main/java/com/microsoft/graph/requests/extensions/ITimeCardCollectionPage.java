...
/**
 * The interface for the Time Card Collection Page.
 */
public interface ITimeCardCollectionPage extends IBaseCollectionPage<TimeCard, ITimeCardCollectionRequestBuilder> {
}
