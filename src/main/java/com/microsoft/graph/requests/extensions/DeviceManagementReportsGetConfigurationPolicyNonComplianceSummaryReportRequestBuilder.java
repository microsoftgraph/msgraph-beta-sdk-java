...
import com.microsoft.graph.requests.extensions.DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest;
 ...
 */
public class DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder extends BaseActionRequestBuilder implements IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequestBuilder {
     ...
     */
    public IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
        return buildRequest(getOptions(requestOptions));
    }

    /**
     * Creates the IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest with specific requestOptions instead of the existing requestOptions
     *
     * @param requestOptions the options for the request
     * @return the IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest instance
     */
    public IDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest request = new DeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReportRequest(
                getRequestUrl(),
                getClient(),
                requestOptions
        );
