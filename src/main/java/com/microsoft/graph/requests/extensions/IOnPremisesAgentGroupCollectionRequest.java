...
/**
 * The interface for the On Premises Agent Group Collection Request.
 */
public interface IOnPremisesAgentGroupCollectionRequest {
     ...
     */
    IOnPremisesAgentGroupCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IOnPremisesAgentGroupCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IOnPremisesAgentGroupCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IOnPremisesAgentGroupCollectionRequest skip(final int value);
