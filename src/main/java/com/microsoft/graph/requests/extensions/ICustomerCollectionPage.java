...
/**
 * The interface for the Customer Collection Page.
 */
public interface ICustomerCollectionPage extends IBaseCollectionPage<Customer, ICustomerCollectionRequestBuilder> {
}
