...
public class MicrosoftAuthenticatorAuthenticationMethodCollectionRequestBuilder extends BaseRequestBuilder implements IMicrosoftAuthenticatorAuthenticationMethodCollectionRequestBuilder {
     ...
     */
    public MicrosoftAuthenticatorAuthenticationMethodCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMicrosoftAuthenticatorAuthenticationMethodCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
