...
/**
 * The class for the Customer Collection Response.
 */
public class CustomerCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Customer within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Customer> value;
