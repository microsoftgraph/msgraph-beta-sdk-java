...
public class GroupPolicyCategoryRequestBuilder extends BaseRequestBuilder implements IGroupPolicyCategoryRequestBuilder {
     ...
     */
    public GroupPolicyCategoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IGroupPolicyCategoryRequest buildRequest() {
     ...
     * @return the IGroupPolicyCategoryRequest instance
     */
    public IGroupPolicyCategoryRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new GroupPolicyCategoryRequest(getRequestUrl(), getClient(), requestOptions);
    }
