...
/**
 * The interface for the Directory Setting Collection Request Builder.
 */
public interface IDirectorySettingCollectionRequestBuilder extends IRequestBuilder {
    ...
    IDirectorySettingCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
