 ...
 */
public class AndroidWorkProfileWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileWiFiConfiguration> {
     ...
     */
    public AndroidWorkProfileWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
