...
public class AndroidWorkProfileWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileWiFiConfigurationRequestBuilder {
     ...
     */
    public AndroidWorkProfileWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWorkProfileWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileWiFiConfigurationRequest instance
     */
    public IAndroidWorkProfileWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
