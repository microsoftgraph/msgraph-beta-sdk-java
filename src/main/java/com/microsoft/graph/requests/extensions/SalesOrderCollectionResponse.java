 ...
 */
public class SalesOrderCollectionResponse implements IJsonBackedObject {

    /**
     * The list of SalesOrder within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<SalesOrder> value;
