 ...
 */
public class AccessPackageWithReferenceRequestBuilder extends BaseRequestBuilder implements IAccessPackageWithReferenceRequestBuilder {
     ...
     */
    public IAccessPackageWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IAccessPackageReferenceRequestBuilder reference(){
        return new AccessPackageReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
