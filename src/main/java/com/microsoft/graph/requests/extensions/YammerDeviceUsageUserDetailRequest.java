...
import com.microsoft.graph.requests.extensions.IYammerDeviceUsageUserDetailRequest;
import com.microsoft.graph.requests.extensions.YammerDeviceUsageUserDetailRequest;
...
public class YammerDeviceUsageUserDetailRequest extends BaseRequest implements IYammerDeviceUsageUserDetailRequest {
     ...
     */
    public YammerDeviceUsageUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<YammerDeviceUsageUserDetail> callback) {
     ...
     */
    public void delete(final ICallback<YammerDeviceUsageUserDetail> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final YammerDeviceUsageUserDetail sourceYammerDeviceUsageUserDetail, final ICallback<YammerDeviceUsageUserDetail> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(final YammerDeviceUsageUserDetail newYammerDeviceUsageUserDetail, final ICallback<YammerDeviceUsageUserDetail> callback) {
