...
public class AndroidForWorkGeneralDeviceConfigurationRequest extends BaseRequest implements IAndroidForWorkGeneralDeviceConfigurationRequest {
     ...
     */
    public AndroidForWorkGeneralDeviceConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
