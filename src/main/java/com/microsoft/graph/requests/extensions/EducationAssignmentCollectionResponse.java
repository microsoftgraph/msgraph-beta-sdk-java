 ...
 */
public class EducationAssignmentCollectionResponse implements IJsonBackedObject {

    /**
     * The list of EducationAssignment within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EducationAssignment> value;
