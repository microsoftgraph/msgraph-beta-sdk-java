 ...
 */
public class Windows10CertificateProfileBaseRequestBuilder extends BaseRequestBuilder implements IWindows10CertificateProfileBaseRequestBuilder {
     ...
     */
    public Windows10CertificateProfileBaseRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindows10CertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindows10CertificateProfileBaseRequest instance
     */
    public IWindows10CertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
