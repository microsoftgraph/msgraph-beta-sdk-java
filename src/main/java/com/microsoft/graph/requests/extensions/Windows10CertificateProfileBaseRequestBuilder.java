...
/**
 * The class for the Windows10Certificate Profile Base Request Builder.
 */
public class Windows10CertificateProfileBaseRequestBuilder extends BaseRequestBuilder<Windows10CertificateProfileBase> {

    /**
     * The request builder for the Windows10CertificateProfileBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public Windows10CertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10CertificateProfileBaseRequest instance
     */
    @Nonnull
    public Windows10CertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10CertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows10CertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
