...
/**
 * The interface for the Android Trusted Root Certificate Request Builder.
 */
public interface IAndroidTrustedRootCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IAndroidTrustedRootCertificateRequest instance
     */
    IAndroidTrustedRootCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidTrustedRootCertificateRequest instance
     */
    IAndroidTrustedRootCertificateRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
