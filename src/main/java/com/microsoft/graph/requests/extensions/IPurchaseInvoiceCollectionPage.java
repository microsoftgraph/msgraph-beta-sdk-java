...
/**
 * The interface for the Purchase Invoice Collection Page.
 */
public interface IPurchaseInvoiceCollectionPage extends IBaseCollectionPage<PurchaseInvoice, IPurchaseInvoiceCollectionRequestBuilder> {
}
