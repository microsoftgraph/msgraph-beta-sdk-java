 ...
 */
public class ContentTypeWithReferenceRequestBuilder extends BaseRequestBuilder implements IContentTypeWithReferenceRequestBuilder {
     ...
     */
    public ContentTypeWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IContentTypeWithReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IContentTypeWithReferenceRequest instance
     */
    public IContentTypeWithReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new ContentTypeWithReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }

    public IContentTypeReferenceRequestBuilder reference(){
        return new ContentTypeReferenceRequestBuilder(getRequestUrl() + "/$ref", getClient(), getOptions());
    }
