...
/**
 * The interface for the Windows Phone81App XBundle Request Builder.
 */
public interface IWindowsPhone81AppXBundleRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsPhone81AppXBundleRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsPhone81AppXBundleRequest instance
     */
    IWindowsPhone81AppXBundleRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
