...
public class DeviceManagementIntentDeviceSettingStateSummaryRequestBuilder extends BaseRequestBuilder implements IDeviceManagementIntentDeviceSettingStateSummaryRequestBuilder {
     ...
     */
    public DeviceManagementIntentDeviceSettingStateSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IDeviceManagementIntentDeviceSettingStateSummaryRequest instance
     */
    public IDeviceManagementIntentDeviceSettingStateSummaryRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new DeviceManagementIntentDeviceSettingStateSummaryRequest(getRequestUrl(), getClient(), requestOptions);
    }
