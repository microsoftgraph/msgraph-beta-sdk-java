...
/**
 * The interface for the Report Root Get M365App User Counts Request.
 */
public interface IReportRootGetM365AppUserCountsRequest extends IHttpRequest {
     ...
     */
    IReportRootGetM365AppUserCountsRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootGetM365AppUserCountsRequest expand(final String value);
