 ...
 */
public class WindowsPhone81CustomConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsPhone81CustomConfigurationRequestBuilder {
     ...
     */
    public WindowsPhone81CustomConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsPhone81CustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsPhone81CustomConfigurationRequest instance
     */
    public IWindowsPhone81CustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsPhone81CustomConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
