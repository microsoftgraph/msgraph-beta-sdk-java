...
public class DeviceManagementComplexSettingInstanceRequest extends BaseRequest<DeviceManagementComplexSettingInstance> {
     ...
     */
    public void get(@Nonnull final ICallback<? super DeviceManagementComplexSettingInstance> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super DeviceManagementComplexSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final DeviceManagementComplexSettingInstance sourceDeviceManagementComplexSettingInstance, @Nonnull final ICallback<? super DeviceManagementComplexSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void post(@Nonnull final DeviceManagementComplexSettingInstance newDeviceManagementComplexSettingInstance, @Nonnull final ICallback<? super DeviceManagementComplexSettingInstance> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final DeviceManagementComplexSettingInstance newDeviceManagementComplexSettingInstance, @Nonnull final ICallback<? super DeviceManagementComplexSettingInstance> callback) {
