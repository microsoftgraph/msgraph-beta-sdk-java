 ...
 */
public interface IDriveCollectionRequestBuilder extends IRequestBuilder {

    IDriveCollectionRequest buildRequest();

    IDriveCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
