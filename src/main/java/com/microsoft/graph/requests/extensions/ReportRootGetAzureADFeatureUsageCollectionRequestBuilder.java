...
public class ReportRootGetAzureADFeatureUsageCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetAzureADFeatureUsageCollectionRequestBuilder {
     ...
     */
    public ReportRootGetAzureADFeatureUsageCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
    ...
    public IReportRootGetAzureADFeatureUsageCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
