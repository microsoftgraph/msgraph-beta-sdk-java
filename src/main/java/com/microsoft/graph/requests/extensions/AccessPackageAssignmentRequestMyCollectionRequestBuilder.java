...
public class AccessPackageAssignmentRequestMyCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IAccessPackageAssignmentRequestMyCollectionRequestBuilder {
     ...
     */
    public AccessPackageAssignmentRequestMyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IAccessPackageAssignmentRequestMyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
