...
public class AndroidWorkProfileGmailEasConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileGmailEasConfigurationRequestBuilder {
     ...
     */
    public AndroidWorkProfileGmailEasConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWorkProfileGmailEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileGmailEasConfigurationRequest instance
     */
    public IAndroidWorkProfileGmailEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
