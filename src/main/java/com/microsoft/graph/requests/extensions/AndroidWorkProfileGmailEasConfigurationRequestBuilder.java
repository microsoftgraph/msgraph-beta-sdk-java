 ...
 */
public class AndroidWorkProfileGmailEasConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileGmailEasConfiguration> {
     ...
     */
    public AndroidWorkProfileGmailEasConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileGmailEasConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileGmailEasConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileGmailEasConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
