...
/**
 * The interface for the Android Oma Cp Configuration Request Builder.
 */
public interface IAndroidOmaCpConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidOmaCpConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidOmaCpConfigurationRequest instance
     */
    IAndroidOmaCpConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
