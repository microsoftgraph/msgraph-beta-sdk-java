...
/**
 * The interface for the Device Management Export Job Collection Page.
 */
public interface IDeviceManagementExportJobCollectionPage extends IBaseCollectionPage<DeviceManagementExportJob, IDeviceManagementExportJobCollectionRequestBuilder> {
}
