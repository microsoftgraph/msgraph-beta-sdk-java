...
import com.microsoft.graph.requests.extensions.UserExperienceAnalyticsMetricHistoryRequest;
...
public class UserExperienceAnalyticsMetricHistoryRequest extends BaseRequest implements IUserExperienceAnalyticsMetricHistoryRequest {
     ...
     */
    public UserExperienceAnalyticsMetricHistoryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public void get(final ICallback<UserExperienceAnalyticsMetricHistory> callback) {
     ...
     */
    public void delete(final ICallback<UserExperienceAnalyticsMetricHistory> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(final UserExperienceAnalyticsMetricHistory sourceUserExperienceAnalyticsMetricHistory, final ICallback<UserExperienceAnalyticsMetricHistory> callback) {
