...
public class GroupCollectionRequestBuilder extends BaseRequestBuilder implements IGroupCollectionRequestBuilder {
    ...
    public IGroupEvaluateDynamicMembershipRequestBuilder evaluateDynamicMembership(final String memberId, final String membershipRule) {
        return new GroupEvaluateDynamicMembershipRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.evaluateDynamicMembership"), getClient(), null, memberId, membershipRule);
    }
