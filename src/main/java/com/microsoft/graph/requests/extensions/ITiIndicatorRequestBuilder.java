...
/**
 * The interface for the Ti Indicator Request Builder.
 */
public interface ITiIndicatorRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ITiIndicatorRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
