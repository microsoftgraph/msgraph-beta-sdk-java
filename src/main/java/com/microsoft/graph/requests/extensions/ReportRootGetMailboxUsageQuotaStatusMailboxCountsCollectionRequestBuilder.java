...
public class ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionRequestBuilder {
     ...
     */
    public ReportRootGetMailboxUsageQuotaStatusMailboxCountsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, final String period) {
