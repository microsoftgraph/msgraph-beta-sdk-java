...
/**
 * The interface for the Eas Email Profile Configuration Base Request Builder.
 */
public interface IEasEmailProfileConfigurationBaseRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IEasEmailProfileConfigurationBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IEasEmailProfileConfigurationBaseRequest instance
     */
    IEasEmailProfileConfigurationBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
