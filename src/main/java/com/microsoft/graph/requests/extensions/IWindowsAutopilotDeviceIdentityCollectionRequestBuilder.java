...
public interface IWindowsAutopilotDeviceIdentityCollectionRequestBuilder extends IRequestBuilder {
    ...
    IWindowsAutopilotDeviceIdentityCollectionRequest buildRequest();

    IWindowsAutopilotDeviceIdentityCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
