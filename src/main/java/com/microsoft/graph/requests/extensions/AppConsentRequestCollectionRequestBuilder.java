...
public class AppConsentRequestCollectionRequestBuilder extends BaseRequestBuilder implements IAppConsentRequestCollectionRequestBuilder {
     ...
     */
    public AppConsentRequestCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IAppConsentRequestCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IAppConsentRequestCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
