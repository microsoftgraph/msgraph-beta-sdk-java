...
public class ApprovalStepCollectionRequestBuilder extends BaseRequestBuilder implements IApprovalStepCollectionRequestBuilder {
     ...
     */
    public ApprovalStepCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IApprovalStepCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
