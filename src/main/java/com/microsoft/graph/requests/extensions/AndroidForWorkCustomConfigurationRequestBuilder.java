...
/**
 * The class for the Android For Work Custom Configuration Request Builder.
 */
public class AndroidForWorkCustomConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkCustomConfiguration> {

    /**
     * The request builder for the AndroidForWorkCustomConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkCustomConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkCustomConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkCustomConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkCustomConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkCustomConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
