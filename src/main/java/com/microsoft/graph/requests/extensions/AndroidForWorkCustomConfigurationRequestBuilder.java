 ...
 */
public class AndroidForWorkCustomConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkCustomConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkCustomConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IAndroidForWorkCustomConfigurationRequest instance
     */
    public IAndroidForWorkCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkCustomConfigurationRequest instance
     */
    public IAndroidForWorkCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
