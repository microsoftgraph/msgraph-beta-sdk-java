...
public class IosEducationDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IIosEducationDeviceConfigurationRequestBuilder {
     ...
     */
    public IosEducationDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosEducationDeviceConfigurationRequest instance
     */
    public IIosEducationDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
