 ...
 */
public class IosEducationDeviceConfigurationRequestBuilder extends BaseRequestBuilder<IosEducationDeviceConfiguration> {
     ...
     */
    public IosEducationDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosEducationDeviceConfigurationRequest instance
     */
    @Nonnull
    public IosEducationDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosEducationDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosEducationDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
