 ...
 */
public class EndpointCollectionRequest extends BaseEntityCollectionRequest<Endpoint, EndpointCollectionResponse, EndpointCollectionPage> {
     ...
     */
    @Nonnull
    public EndpointCollectionRequest count(final boolean value) {
