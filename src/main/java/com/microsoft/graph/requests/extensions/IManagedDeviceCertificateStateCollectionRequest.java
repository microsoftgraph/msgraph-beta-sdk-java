...
/**
 * The interface for the Managed Device Certificate State Collection Request.
 */
public interface IManagedDeviceCertificateStateCollectionRequest {
     ...
     */
    IManagedDeviceCertificateStateCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IManagedDeviceCertificateStateCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagedDeviceCertificateStateCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IManagedDeviceCertificateStateCollectionRequest skip(final int value);
