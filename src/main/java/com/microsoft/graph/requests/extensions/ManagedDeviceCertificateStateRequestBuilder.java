...
public class ManagedDeviceCertificateStateRequestBuilder extends BaseRequestBuilder implements IManagedDeviceCertificateStateRequestBuilder {
     ...
     */
    public ManagedDeviceCertificateStateRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
