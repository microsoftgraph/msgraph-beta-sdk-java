...
public class AndroidPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidPkcsCertificateProfile> {
    ...
    public AndroidPkcsCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidPkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public AndroidTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
