...
public class AndroidPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidPkcsCertificateProfileRequestBuilder {
     ...
     */
    public AndroidPkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidPkcsCertificateProfileRequest instance
     */
    public IAndroidPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
