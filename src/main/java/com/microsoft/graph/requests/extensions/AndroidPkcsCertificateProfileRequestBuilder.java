...
import com.microsoft.graph.requests.extensions.AndroidPkcsCertificateProfileRequest;
 ...
 */
public class AndroidPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidPkcsCertificateProfileRequestBuilder {
     ...
     */
    public AndroidPkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IAndroidPkcsCertificateProfileRequest instance
     */
    public IAndroidPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
        return new AndroidPkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
