...
/**
 * The interface for the Time Card Collection Request.
 */
public interface ITimeCardCollectionRequest extends IHttpRequest {
     ...
     */
    ITimeCardCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITimeCardCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITimeCardCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ITimeCardCollectionRequest skip(final int value);
