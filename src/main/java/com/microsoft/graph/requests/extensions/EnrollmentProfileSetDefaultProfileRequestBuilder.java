...
public class EnrollmentProfileSetDefaultProfileRequestBuilder extends BaseActionRequestBuilder implements IEnrollmentProfileSetDefaultProfileRequestBuilder {
     ...
     */
    public EnrollmentProfileSetDefaultProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IEnrollmentProfileSetDefaultProfileRequest instance
     */
    public IEnrollmentProfileSetDefaultProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
