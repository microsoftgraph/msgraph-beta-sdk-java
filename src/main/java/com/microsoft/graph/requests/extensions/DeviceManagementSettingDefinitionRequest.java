...
import com.microsoft.graph.requests.extensions.IDeviceManagementSettingDefinitionRequest;
import com.microsoft.graph.requests.extensions.DeviceManagementSettingDefinitionRequest;
...
public class DeviceManagementSettingDefinitionRequest extends BaseRequest implements IDeviceManagementSettingDefinitionRequest {
     ...
     * @param requestOptions the options for this request
     */
    public DeviceManagementSettingDefinitionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
