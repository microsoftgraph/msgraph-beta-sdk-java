...
/**
 * The interface for the Information Protection Policy Request Builder.
 */
public interface IInformationProtectionPolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IInformationProtectionPolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
    ...
    IInformationProtectionLabelRequestBuilder labels(final String id);
