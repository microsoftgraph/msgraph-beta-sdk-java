...
public class ProviderTenantSettingCollectionRequestBuilder extends BaseRequestBuilder implements IProviderTenantSettingCollectionRequestBuilder {
     ...
     */
    public ProviderTenantSettingCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IProviderTenantSettingCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
