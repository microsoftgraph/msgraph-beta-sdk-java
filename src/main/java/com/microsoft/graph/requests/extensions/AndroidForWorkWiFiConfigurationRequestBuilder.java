...
public class AndroidForWorkWiFiConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkWiFiConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkWiFiConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidForWorkWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkWiFiConfigurationRequest instance
     */
    public IAndroidForWorkWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
