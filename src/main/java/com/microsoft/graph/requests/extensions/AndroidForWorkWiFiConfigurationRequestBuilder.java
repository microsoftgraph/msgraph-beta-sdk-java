 ...
 */
public class AndroidForWorkWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkWiFiConfiguration> {
     ...
     */
    public AndroidForWorkWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
