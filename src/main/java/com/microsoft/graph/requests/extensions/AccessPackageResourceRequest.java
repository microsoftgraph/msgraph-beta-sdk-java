...
public class AccessPackageResourceRequest extends BaseRequest<AccessPackageResource> {
     ...
     */
    public void get(@Nonnull final ICallback<? super AccessPackageResource> callback) {
     ...
     */
    public void delete(@Nonnull final ICallback<? super AccessPackageResource> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void patch(@Nonnull final AccessPackageResource sourceAccessPackageResource, @Nonnull final ICallback<? super AccessPackageResource> callback) {
     ...
     * @param callback the callback to be called after success or failure
     */
    public void put(@Nonnull final AccessPackageResource newAccessPackageResource, @Nonnull final ICallback<? super AccessPackageResource> callback) {
