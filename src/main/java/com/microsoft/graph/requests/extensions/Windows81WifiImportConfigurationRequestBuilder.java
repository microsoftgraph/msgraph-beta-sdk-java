 ...
 */
public class Windows81WifiImportConfigurationRequestBuilder extends BaseRequestBuilder<Windows81WifiImportConfiguration> {
     ...
     */
    public Windows81WifiImportConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows81WifiImportConfigurationRequest instance
     */
    @Nonnull
    public Windows81WifiImportConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows81WifiImportConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows81WifiImportConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
