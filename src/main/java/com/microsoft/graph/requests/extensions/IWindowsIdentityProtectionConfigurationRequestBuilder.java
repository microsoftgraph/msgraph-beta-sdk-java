...
/**
 * The interface for the Windows Identity Protection Configuration Request Builder.
 */
public interface IWindowsIdentityProtectionConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsIdentityProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWindowsIdentityProtectionConfigurationRequest instance
     */
    IWindowsIdentityProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
