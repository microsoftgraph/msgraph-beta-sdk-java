 ...
 */
public class PublishedResourceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of PublishedResource within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<PublishedResource> value;
