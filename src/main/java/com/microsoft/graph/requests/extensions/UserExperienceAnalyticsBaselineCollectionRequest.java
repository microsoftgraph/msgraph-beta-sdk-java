...
import com.microsoft.graph.requests.extensions.IUserExperienceAnalyticsBaselineCollectionPage;
 ...
 */
public class UserExperienceAnalyticsBaselineCollectionRequest extends BaseCollectionRequest<UserExperienceAnalyticsBaselineCollectionResponse, IUserExperienceAnalyticsBaselineCollectionPage> implements IUserExperienceAnalyticsBaselineCollectionRequest {
     ...
     */
    public UserExperienceAnalyticsBaselineCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IUserExperienceAnalyticsBaselineCollectionPage get() throws ClientException {
        final UserExperienceAnalyticsBaselineCollectionResponse response = send();
     ...
     */
    public IUserExperienceAnalyticsBaselineCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsBaselineCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IUserExperienceAnalyticsBaselineCollectionRequest top(final int value) {
    ...
    public IUserExperienceAnalyticsBaselineCollectionPage buildFromResponse(final UserExperienceAnalyticsBaselineCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new UserExperienceAnalyticsBaselineCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final UserExperienceAnalyticsBaselineCollectionPage page = new UserExperienceAnalyticsBaselineCollectionPage(response, builder);
