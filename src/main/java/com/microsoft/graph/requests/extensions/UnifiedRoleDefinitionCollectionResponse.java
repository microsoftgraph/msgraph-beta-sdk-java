 ...
 */
public class UnifiedRoleDefinitionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of UnifiedRoleDefinition within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleDefinition> value;
