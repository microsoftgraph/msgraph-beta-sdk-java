...
import com.microsoft.graph.requests.extensions.DepIOSEnrollmentProfileRequest;
...
public class DepIOSEnrollmentProfileRequest extends BaseRequest implements IDepIOSEnrollmentProfileRequest {
     ...
     */
    public DepIOSEnrollmentProfileRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
