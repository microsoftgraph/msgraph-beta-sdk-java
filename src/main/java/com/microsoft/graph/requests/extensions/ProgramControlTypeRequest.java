...
import com.microsoft.graph.requests.extensions.IProgramControlTypeRequest;
import com.microsoft.graph.requests.extensions.ProgramControlTypeRequest;
...
public class ProgramControlTypeRequest extends BaseRequest implements IProgramControlTypeRequest {
     ...
     */
    public ProgramControlTypeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
