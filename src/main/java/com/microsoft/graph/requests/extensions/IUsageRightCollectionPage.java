...
/**
 * The interface for the Usage Right Collection Page.
 */
public interface IUsageRightCollectionPage extends IBaseCollectionPage<UsageRight, IUsageRightCollectionRequestBuilder> {
}
