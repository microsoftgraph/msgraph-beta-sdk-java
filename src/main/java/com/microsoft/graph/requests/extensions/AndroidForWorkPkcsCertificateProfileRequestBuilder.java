...
public class AndroidForWorkPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkPkcsCertificateProfileRequestBuilder {
     ...
     */
    public AndroidForWorkPkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
