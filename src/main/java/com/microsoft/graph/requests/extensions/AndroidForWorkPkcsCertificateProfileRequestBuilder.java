 ...
 */
public class AndroidForWorkPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkPkcsCertificateProfileRequestBuilder {
     ...
     */
    public AndroidForWorkPkcsCertificateProfileRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidForWorkPkcsCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkPkcsCertificateProfileRequest instance
     */
    public IAndroidForWorkPkcsCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
