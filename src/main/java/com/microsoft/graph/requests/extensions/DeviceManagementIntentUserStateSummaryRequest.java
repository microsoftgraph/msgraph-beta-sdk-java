...
import com.microsoft.graph.requests.extensions.IDeviceManagementIntentUserStateSummaryRequest;
import com.microsoft.graph.requests.extensions.DeviceManagementIntentUserStateSummaryRequest;
...
public class DeviceManagementIntentUserStateSummaryRequest extends BaseRequest implements IDeviceManagementIntentUserStateSummaryRequest {
     ...
     */
    public DeviceManagementIntentUserStateSummaryRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
