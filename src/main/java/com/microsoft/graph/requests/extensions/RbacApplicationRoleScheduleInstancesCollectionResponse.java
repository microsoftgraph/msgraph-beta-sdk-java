 ...
 */
public class RbacApplicationRoleScheduleInstancesCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleScheduleInstanceBase> value;
