...
/**
 * The interface for the Android Managed Store App Request Builder.
 */
public interface IAndroidManagedStoreAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAndroidManagedStoreAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidManagedStoreAppRequest instance
     */
    IAndroidManagedStoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
