...
public interface IAndroidForWorkCertificateProfileBaseRequestBuilder extends IRequestBuilder {
     ...
     */
    IAndroidForWorkCertificateProfileBaseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IAndroidForWorkCertificateProfileBaseRequest instance
     */
    IAndroidForWorkCertificateProfileBaseRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
