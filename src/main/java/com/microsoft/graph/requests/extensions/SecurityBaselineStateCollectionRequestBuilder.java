...
public class SecurityBaselineStateCollectionRequestBuilder extends BaseRequestBuilder implements ISecurityBaselineStateCollectionRequestBuilder {
     ...
     */
    public SecurityBaselineStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public ISecurityBaselineStateCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public ISecurityBaselineStateCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
