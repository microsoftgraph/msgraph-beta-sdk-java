...
public class IosDerivedCredentialAuthenticationConfigurationRequestBuilder extends BaseRequestBuilder implements IIosDerivedCredentialAuthenticationConfigurationRequestBuilder {
     ...
     */
    public IosDerivedCredentialAuthenticationConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IIosDerivedCredentialAuthenticationConfigurationRequest instance
     */
    public IIosDerivedCredentialAuthenticationConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
