 ...
 */
public class IosDerivedCredentialAuthenticationConfigurationRequestBuilder extends BaseRequestBuilder<IosDerivedCredentialAuthenticationConfiguration> {
     ...
     */
    public IosDerivedCredentialAuthenticationConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosDerivedCredentialAuthenticationConfigurationRequest instance
     */
    @Nonnull
    public IosDerivedCredentialAuthenticationConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosDerivedCredentialAuthenticationConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosDerivedCredentialAuthenticationConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
