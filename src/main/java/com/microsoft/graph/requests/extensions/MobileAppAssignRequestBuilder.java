...
public class MobileAppAssignRequestBuilder extends BaseActionRequestBuilder implements IMobileAppAssignRequestBuilder {
     ...
     */
    public MobileAppAssignRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final java.util.List<MobileAppAssignment> mobileAppAssignments) {
