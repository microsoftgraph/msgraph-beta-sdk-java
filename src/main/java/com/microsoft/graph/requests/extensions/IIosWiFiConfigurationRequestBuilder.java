...
/**
 * The interface for the Ios Wi Fi Configuration Request Builder.
 */
public interface IIosWiFiConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     * @param requestOptions the options for this request
     * @return the IIosWiFiConfigurationRequest instance
     */
    IIosWiFiConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IIosWiFiConfigurationRequest instance
     */
    IIosWiFiConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
