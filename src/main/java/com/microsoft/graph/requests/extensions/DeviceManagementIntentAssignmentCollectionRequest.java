...
import com.microsoft.graph.requests.extensions.IDeviceManagementIntentAssignmentCollectionPage;
 ...
 */
public class DeviceManagementIntentAssignmentCollectionRequest extends BaseCollectionRequest<DeviceManagementIntentAssignmentCollectionResponse, IDeviceManagementIntentAssignmentCollectionPage> implements IDeviceManagementIntentAssignmentCollectionRequest {
     ...
     */
    public DeviceManagementIntentAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public IDeviceManagementIntentAssignmentCollectionPage get() throws ClientException {
        final DeviceManagementIntentAssignmentCollectionResponse response = send();
     ...
     */
    public IDeviceManagementIntentAssignmentCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentAssignmentCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IDeviceManagementIntentAssignmentCollectionRequest top(final int value) {
    ...
    public IDeviceManagementIntentAssignmentCollectionPage buildFromResponse(final DeviceManagementIntentAssignmentCollectionResponse response) {
        ...
        if (response.nextLink != null) {
            builder = new DeviceManagementIntentAssignmentCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final DeviceManagementIntentAssignmentCollectionPage page = new DeviceManagementIntentAssignmentCollectionPage(response, builder);
