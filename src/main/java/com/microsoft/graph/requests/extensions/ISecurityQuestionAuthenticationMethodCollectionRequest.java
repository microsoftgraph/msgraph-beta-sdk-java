...
/**
 * The interface for the Security Question Authentication Method Collection Request.
 */
public interface ISecurityQuestionAuthenticationMethodCollectionRequest {
     ...
     */
    ISecurityQuestionAuthenticationMethodCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ISecurityQuestionAuthenticationMethodCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ISecurityQuestionAuthenticationMethodCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ISecurityQuestionAuthenticationMethodCollectionRequest skip(final int value);
