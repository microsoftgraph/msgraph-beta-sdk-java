...
public interface IDefaultDeviceCompliancePolicyRequestBuilder extends IRequestBuilder {
     ...
     */
    IDefaultDeviceCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDefaultDeviceCompliancePolicyRequest instance
     */
    IDefaultDeviceCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
