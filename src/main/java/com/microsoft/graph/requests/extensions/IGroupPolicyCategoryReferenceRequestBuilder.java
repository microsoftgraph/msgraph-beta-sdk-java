...
public interface IGroupPolicyCategoryReferenceRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupPolicyCategoryReferenceRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupPolicyCategoryReferenceRequest instance
     */
    IGroupPolicyCategoryReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
