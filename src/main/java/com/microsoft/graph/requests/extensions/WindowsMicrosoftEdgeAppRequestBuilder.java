 ...
 */
public class WindowsMicrosoftEdgeAppRequestBuilder extends BaseRequestBuilder implements IWindowsMicrosoftEdgeAppRequestBuilder {
     ...
     */
    public WindowsMicrosoftEdgeAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IWindowsMicrosoftEdgeAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWindowsMicrosoftEdgeAppRequest instance
     */
    public IWindowsMicrosoftEdgeAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsMicrosoftEdgeAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
