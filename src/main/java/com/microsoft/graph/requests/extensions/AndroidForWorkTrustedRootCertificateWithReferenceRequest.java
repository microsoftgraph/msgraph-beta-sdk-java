...
public class AndroidForWorkTrustedRootCertificateWithReferenceRequest extends BaseRequest implements IAndroidForWorkTrustedRootCertificateWithReferenceRequest {
     ...
     */
    public AndroidForWorkTrustedRootCertificateWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, AndroidForWorkTrustedRootCertificate.class);
    }

    public void post(final AndroidForWorkTrustedRootCertificate newAndroidForWorkTrustedRootCertificate, final IJsonBackedObject payload, final ICallback<AndroidForWorkTrustedRootCertificate> callback) {
