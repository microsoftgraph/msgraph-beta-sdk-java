...
import com.microsoft.graph.requests.extensions.IDeviceSetupConfigurationRequest;
import com.microsoft.graph.requests.extensions.DeviceSetupConfigurationRequest;
...
public class DeviceSetupConfigurationRequest extends BaseRequest implements IDeviceSetupConfigurationRequest {
     ...
     */
    public DeviceSetupConfigurationRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
