 ...
 */
public class UserActivityRecentCollectionRequest extends BaseFunctionCollectionRequest<UserActivity, UserActivityRecentCollectionResponse, UserActivityRecentCollectionPage> {
    ...
    public UserActivityRecentCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, UserActivityRecentCollectionResponse.class, UserActivityRecentCollectionPage.class, UserActivityRecentCollectionRequestBuilder.class);
    }
     ...
     */
    @Nonnull
    public UserActivityRecentCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public UserActivityRecentCollectionRequest count() {
        addCountOption(true);
        return this;
    }
     ...
     */
    @Nonnull
    public UserActivityRecentCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public UserActivityRecentCollectionRequest skipToken(@Nonnull final String skipToken) {
