...
/**
 * The interface for the Connector Collection Page.
 */
public interface IConnectorCollectionPage extends IBaseCollectionPage<Connector, IConnectorCollectionRequestBuilder> {
}
