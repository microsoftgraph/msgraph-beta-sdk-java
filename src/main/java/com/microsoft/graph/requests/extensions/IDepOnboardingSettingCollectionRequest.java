...
/**
 * The interface for the Dep Onboarding Setting Collection Request.
 */
public interface IDepOnboardingSettingCollectionRequest {
     ...
     */
    IDepOnboardingSettingCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IDepOnboardingSettingCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IDepOnboardingSettingCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IDepOnboardingSettingCollectionRequest skip(final int value);
