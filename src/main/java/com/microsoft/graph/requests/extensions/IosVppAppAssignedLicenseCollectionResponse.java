...
/**
 * The class for the Ios Vpp App Assigned License Collection Response.
 */
public class IosVppAppAssignedLicenseCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IosVppAppAssignedLicense within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IosVppAppAssignedLicense> value;
