...
public class ApplicationAddKeyRequestBuilder extends BaseActionRequestBuilder implements IApplicationAddKeyRequestBuilder {
     ...
     */
    public ApplicationAddKeyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final KeyCredential keyCredential, final PasswordCredential passwordCredential, final String proof) {
     ...
     * @return the IApplicationAddKeyRequest instance
     */
    public IApplicationAddKeyRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
