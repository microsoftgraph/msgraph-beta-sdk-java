...
public class AndroidWorkProfileVpnConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileVpnConfigurationRequestBuilder {
     ...
     */
    public AndroidWorkProfileVpnConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the IAndroidWorkProfileVpnConfigurationRequest instance
     */
    public IAndroidWorkProfileVpnConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
