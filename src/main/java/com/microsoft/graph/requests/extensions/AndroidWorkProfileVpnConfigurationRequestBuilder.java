 ...
 */
public class AndroidWorkProfileVpnConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileVpnConfiguration> {
     ...
     */
    public AndroidWorkProfileVpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileVpnConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileVpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileVpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
