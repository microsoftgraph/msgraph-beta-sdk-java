...
/**
 * The interface for the Windows Update State Collection Page.
 */
public interface IWindowsUpdateStateCollectionPage extends IBaseCollectionPage<WindowsUpdateState, IWindowsUpdateStateCollectionRequestBuilder> {
}
