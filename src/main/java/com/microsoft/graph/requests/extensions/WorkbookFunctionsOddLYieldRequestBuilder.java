...
public class WorkbookFunctionsOddLYieldRequestBuilder extends BaseActionRequestBuilder implements IWorkbookFunctionsOddLYieldRequestBuilder {
     ...
     */
    public IWorkbookFunctionsOddLYieldRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookFunctionsOddLYieldRequest instance
     */
    public IWorkbookFunctionsOddLYieldRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
