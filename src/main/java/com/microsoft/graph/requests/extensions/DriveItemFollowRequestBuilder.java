...
public class DriveItemFollowRequestBuilder extends BaseActionRequestBuilder implements IDriveItemFollowRequestBuilder {
     ...
     */
    public DriveItemFollowRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     * @return the IDriveItemFollowRequest instance
     */
    public IDriveItemFollowRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
