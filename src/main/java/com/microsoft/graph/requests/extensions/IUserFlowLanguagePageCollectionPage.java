...
/**
 * The interface for the User Flow Language Page Collection Page.
 */
public interface IUserFlowLanguagePageCollectionPage extends IBaseCollectionPage<UserFlowLanguagePage, IUserFlowLanguagePageCollectionRequestBuilder> {
}
