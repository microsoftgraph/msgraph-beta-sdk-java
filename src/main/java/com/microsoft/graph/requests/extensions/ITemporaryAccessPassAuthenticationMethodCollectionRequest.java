...
/**
 * The interface for the Temporary Access Pass Authentication Method Collection Request.
 */
public interface ITemporaryAccessPassAuthenticationMethodCollectionRequest {
     ...
     */
    ITemporaryAccessPassAuthenticationMethodCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    ITemporaryAccessPassAuthenticationMethodCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    ITemporaryAccessPassAuthenticationMethodCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    ITemporaryAccessPassAuthenticationMethodCollectionRequest skip(final int value);
