...
public class UserCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IUserCollectionReferenceRequestBuilder {
     ...
     */
    public UserCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IUserCollectionReferenceRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IUserCollectionReferenceRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
