 ...
 */
public class AndroidForWorkNineWorkEasConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidForWorkNineWorkEasConfigurationRequestBuilder {
     ...
     */
    public AndroidForWorkNineWorkEasConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidForWorkNineWorkEasConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidForWorkNineWorkEasConfigurationRequest instance
     */
    public IAndroidForWorkNineWorkEasConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidForWorkNineWorkEasConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
