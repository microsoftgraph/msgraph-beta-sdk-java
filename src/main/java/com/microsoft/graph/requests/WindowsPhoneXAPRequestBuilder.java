...
/**
 * The class for the Windows Phone XAPRequest Builder.
 */
public class WindowsPhoneXAPRequestBuilder extends BaseRequestBuilder<WindowsPhoneXAP> {

    /**
     * The request builder for the WindowsPhoneXAP
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsPhoneXAPRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhoneXAPRequest instance
     */
    @Nonnull
    public WindowsPhoneXAPRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhoneXAPRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsPhoneXAPRequest(getRequestUrl(), getClient(), requestOptions);
    }
