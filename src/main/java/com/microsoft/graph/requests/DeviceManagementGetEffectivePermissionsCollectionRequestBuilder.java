...
import com.microsoft.graph.requests.DeviceManagementGetEffectivePermissionsCollectionRequest;
 ...
 */
public class DeviceManagementGetEffectivePermissionsCollectionRequestBuilder extends BaseFunctionCollectionRequestBuilder<String, DeviceManagementGetEffectivePermissionsCollectionRequestBuilder, DeviceManagementGetEffectivePermissionsCollectionResponse, DeviceManagementGetEffectivePermissionsCollectionPage, DeviceManagementGetEffectivePermissionsCollectionRequest> {
     ...
     */
    public DeviceManagementGetEffectivePermissionsCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
