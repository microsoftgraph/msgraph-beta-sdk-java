...
public class OnPremisesAgentRequest extends BaseRequest<OnPremisesAgent> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> patchAsync(@Nonnull final OnPremisesAgent sourceOnPremisesAgent) {
        return sendAsync(HttpMethod.PATCH, sourceOnPremisesAgent);
    }
    ...
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> postAsync(@Nonnull final OnPremisesAgent newOnPremisesAgent) {
        return sendAsync(HttpMethod.POST, newOnPremisesAgent);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OnPremisesAgent> putAsync(@Nonnull final OnPremisesAgent newOnPremisesAgent) {
        return sendAsync(HttpMethod.PUT, newOnPremisesAgent);
    }
