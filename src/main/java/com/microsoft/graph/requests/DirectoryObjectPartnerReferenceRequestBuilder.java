...
public class DirectoryObjectPartnerReferenceRequestBuilder extends BaseRequestBuilder<DirectoryObjectPartnerReference> {
     ...
     */
    public DirectoryObjectPartnerReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public DirectoryObjectPartnerReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DirectoryObjectPartnerReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DirectoryObjectPartnerReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
