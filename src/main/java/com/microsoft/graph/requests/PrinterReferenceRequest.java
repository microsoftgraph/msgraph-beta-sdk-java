 ...
 */
public class PrinterReferenceRequest extends BaseReferenceRequest<Printer> {
     ...
     */
    public PrinterReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public PrinterReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public PrinterReferenceRequest expand(@Nonnull final String value) {
