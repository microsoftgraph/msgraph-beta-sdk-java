...
public class WindowsPhone81VpnConfigurationRequestBuilder extends BaseRequestBuilder<WindowsPhone81VpnConfiguration> {
    ...
    public WindowsPhone81VpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsPhone81VpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.WindowsPhone81CertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
        return new com.microsoft.graph.requests.WindowsPhone81CertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificate"), getClient(), null);
    }
