 ...
 */
public class Windows81TrustedRootCertificateWithReferenceRequest extends BaseWithReferenceRequest<Windows81TrustedRootCertificate> {
     ...
     */
    public Windows81TrustedRootCertificateWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public Windows81TrustedRootCertificateWithReferenceRequest expand(@Nonnull final String value) {
