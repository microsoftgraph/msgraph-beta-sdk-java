 ...
 */
public class AndroidManagedStoreAppRequestBuilder extends BaseRequestBuilder<AndroidManagedStoreApp> {
     ...
     */
    public AndroidManagedStoreAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidManagedStoreAppRequest instance
     */
    @Nonnull
    public AndroidManagedStoreAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidManagedStoreAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidManagedStoreAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
