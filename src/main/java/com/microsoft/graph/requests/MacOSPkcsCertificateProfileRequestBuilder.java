...
/**
 * The class for the Mac OSPkcs Certificate Profile Request Builder.
 */
public class MacOSPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder<MacOSPkcsCertificateProfile> {

    /**
     * The request builder for the MacOSPkcsCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSPkcsCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSPkcsCertificateProfileRequest instance
     */
    @Nonnull
    public MacOSPkcsCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSPkcsCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSPkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
