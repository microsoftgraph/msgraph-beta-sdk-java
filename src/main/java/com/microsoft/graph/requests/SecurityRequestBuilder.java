...
public class SecurityRequestBuilder extends BaseRequestBuilder<Security> {
     ...
     */
    @Nonnull
    public IncidentRequestBuilder incidents(@Nonnull final String id) {
        return new IncidentRequestBuilder(getRequestUrlWithAdditionalSegment("incidents") + "/" + id, getClient(), null);
    }
    ...
    public ThreatSubmissionRootRequestBuilder threatSubmission() {
        return new ThreatSubmissionRootRequestBuilder(getRequestUrlWithAdditionalSegment("threatSubmission"), getClient(), null);
    }
    /**
     *  Gets a request builder for the Alert collection
     *
