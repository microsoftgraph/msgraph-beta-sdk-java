...
/**
 * The class for the Tenant Relationship Access Policy Base Request Builder.
 */
public class TenantRelationshipAccessPolicyBaseRequestBuilder extends BaseRequestBuilder<TenantRelationshipAccessPolicyBase> {

    /**
     * The request builder for the TenantRelationshipAccessPolicyBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public TenantRelationshipAccessPolicyBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the TenantRelationshipAccessPolicyBaseRequest instance
     */
    @Nonnull
    public TenantRelationshipAccessPolicyBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TenantRelationshipAccessPolicyBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.TenantRelationshipAccessPolicyBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
