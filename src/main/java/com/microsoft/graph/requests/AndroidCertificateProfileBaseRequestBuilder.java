 ...
 */
public class AndroidCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<AndroidCertificateProfileBase> {
     ...
     */
    public AndroidCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidCertificateProfileBaseRequest instance
     */
    @Nonnull
    public AndroidCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
