...
/**
 * The class for the Aosp Device Owner Certificate Profile Base Request Builder.
 */
public class AospDeviceOwnerCertificateProfileBaseRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerCertificateProfileBase> {
     ...
     */
    public AospDeviceOwnerCertificateProfileBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerCertificateProfileBaseRequest instance
     */
    @Nonnull
    public AospDeviceOwnerCertificateProfileBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerCertificateProfileBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerCertificateProfileBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
