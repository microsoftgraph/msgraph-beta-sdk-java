...
public class OfficeConfigurationRequest extends BaseRequest<OfficeConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> patchAsync(@Nonnull final OfficeConfiguration sourceOfficeConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceOfficeConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> postAsync(@Nonnull final OfficeConfiguration newOfficeConfiguration) {
        return sendAsync(HttpMethod.POST, newOfficeConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> putAsync(@Nonnull final OfficeConfiguration newOfficeConfiguration) {
        return sendAsync(HttpMethod.PUT, newOfficeConfiguration);
    }
