 ...
 */
public class ContentTypeCopyToDefaultContentLocationRequest extends BaseRequest<ContentType> {
    /**
     ...
     */
    @Nonnull
    public ContentTypeCopyToDefaultContentLocationRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public ContentTypeCopyToDefaultContentLocationRequest expand(@Nonnull final String value) {
