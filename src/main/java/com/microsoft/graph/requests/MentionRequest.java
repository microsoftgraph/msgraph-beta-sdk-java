...
public class MentionRequest extends BaseRequest<Mention> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Mention> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Mention> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Mention> patchAsync(@Nonnull final Mention sourceMention) {
        return sendAsync(HttpMethod.PATCH, sourceMention);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Mention> postAsync(@Nonnull final Mention newMention) {
        return sendAsync(HttpMethod.POST, newMention);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Mention> putAsync(@Nonnull final Mention newMention) {
        return sendAsync(HttpMethod.PUT, newMention);
    }
