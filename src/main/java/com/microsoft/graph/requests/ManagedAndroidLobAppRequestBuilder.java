...
public class ManagedAndroidLobAppRequestBuilder extends BaseRequestBuilder<ManagedAndroidLobApp> {
     ...
     */
    public ManagedAndroidLobAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the ManagedAndroidLobAppRequest instance
     */
    @Nonnull
    public ManagedAndroidLobAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagedAndroidLobAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.ManagedAndroidLobAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
