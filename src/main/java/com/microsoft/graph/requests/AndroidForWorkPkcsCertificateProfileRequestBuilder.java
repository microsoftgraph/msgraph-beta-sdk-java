...
/**
 * The class for the Android For Work Pkcs Certificate Profile Request Builder.
 */
public class AndroidForWorkPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidForWorkPkcsCertificateProfile> {

    /**
     * The request builder for the AndroidForWorkPkcsCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkPkcsCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkPkcsCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidForWorkPkcsCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkPkcsCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkPkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
