...
public class BaseTaskListCollectionRequestBuilder extends BaseCollectionRequestBuilder<BaseTaskList, BaseTaskListRequestBuilder, BaseTaskListCollectionResponse, BaseTaskListCollectionPage, BaseTaskListCollectionRequest> {
    ...
    /**
     * The request builder for this collection of Tasks
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public BaseTaskListCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseTaskListRequestBuilder.class, BaseTaskListCollectionRequest.class);
    }
     ...
     */
    @Nonnull
    public BaseTaskListDeltaCollectionRequestBuilder delta() {
        return new BaseTaskListDeltaCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.delta"), getClient(), null);
    }
