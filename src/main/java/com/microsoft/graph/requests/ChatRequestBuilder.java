...
public class ChatRequestBuilder extends BaseRequestBuilder<Chat> {
     ...
     */
    @Nonnull
    public ChatRemoveAllAccessForUserRequestBuilder removeAllAccessForUser(@Nonnull final ChatRemoveAllAccessForUserParameterSet parameters) {
        return new ChatRemoveAllAccessForUserRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.removeAllAccessForUser"), getClient(), null, parameters);
    }
