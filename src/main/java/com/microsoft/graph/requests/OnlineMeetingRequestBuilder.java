...
public class OnlineMeetingRequestBuilder extends BaseRequestBuilder<OnlineMeeting> {
     ...
     */
    @Nonnull
    public OnlineMeetingSendVirtualAppointmentReminderSmsRequestBuilder sendVirtualAppointmentReminderSms(@Nonnull final OnlineMeetingSendVirtualAppointmentReminderSmsParameterSet parameters) {
        return new OnlineMeetingSendVirtualAppointmentReminderSmsRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.sendVirtualAppointmentReminderSms"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public OnlineMeetingSendVirtualAppointmentSmsRequestBuilder sendVirtualAppointmentSms(@Nonnull final OnlineMeetingSendVirtualAppointmentSmsParameterSet parameters) {
        return new OnlineMeetingSendVirtualAppointmentSmsRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.sendVirtualAppointmentSms"), getClient(), null, parameters);
    }
