 ...
 */
public class IosTrustedRootCertificateWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<IosTrustedRootCertificate, IosTrustedRootCertificateWithReferenceRequest, IosTrustedRootCertificateReferenceRequestBuilder> {
     ...
     */
    public IosTrustedRootCertificateWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, IosTrustedRootCertificateWithReferenceRequest.class, IosTrustedRootCertificateReferenceRequestBuilder.class);
    }
}
