...
public class AccessPackageAssignmentResourceRoleRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentResourceRole> {
    ...
    public AccessPackageAssignmentResourceRoleRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AccessPackageAssignmentResourceRoleRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AccessPackageSubjectRequestBuilder accessPackageSubject() {
        return new com.microsoft.graph.requests.AccessPackageSubjectRequestBuilder(getRequestUrlWithAdditionalSegment("accessPackageSubject"), getClient(), null);
    }
}
