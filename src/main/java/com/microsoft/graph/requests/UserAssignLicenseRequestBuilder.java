...
public class UserAssignLicenseRequestBuilder extends BaseActionRequestBuilder<User> {
     ...
     */
    public UserAssignLicenseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public UserAssignLicenseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final UserAssignLicenseParameterSet parameters) {
        super(requestUrl, client, requestOptions);
     ...
     */
    @Nonnull
    public UserAssignLicenseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
