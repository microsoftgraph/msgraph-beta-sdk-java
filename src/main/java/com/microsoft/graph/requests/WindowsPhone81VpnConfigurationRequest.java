...
import com.microsoft.graph.requests.WindowsPhone81CertificateProfileBaseWithReferenceRequestBuilder;
...
public class WindowsPhone81VpnConfigurationRequest extends BaseRequest<WindowsPhone81VpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPhone81VpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPhone81VpnConfiguration> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPhone81VpnConfiguration> patchAsync(@Nonnull final WindowsPhone81VpnConfiguration sourceWindowsPhone81VpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceWindowsPhone81VpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPhone81VpnConfiguration> postAsync(@Nonnull final WindowsPhone81VpnConfiguration newWindowsPhone81VpnConfiguration) {
        return sendAsync(HttpMethod.POST, newWindowsPhone81VpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<WindowsPhone81VpnConfiguration> putAsync(@Nonnull final WindowsPhone81VpnConfiguration newWindowsPhone81VpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newWindowsPhone81VpnConfiguration);
    }
