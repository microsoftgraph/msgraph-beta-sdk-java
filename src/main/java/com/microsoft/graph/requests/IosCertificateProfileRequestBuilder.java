...
public class IosCertificateProfileRequestBuilder extends BaseRequestBuilder<IosCertificateProfile> {
     ...
     */
    public IosCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosCertificateProfileRequest instance
     */
    @Nonnull
    public IosCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
