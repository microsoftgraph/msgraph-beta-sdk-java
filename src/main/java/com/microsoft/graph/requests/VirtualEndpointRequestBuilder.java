...
public class VirtualEndpointRequestBuilder extends BaseRequestBuilder<VirtualEndpoint> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.CloudPcSharedUseServicePlanCollectionWithReferencesRequestBuilder sharedUseServicePlans() {
        return new com.microsoft.graph.requests.CloudPcSharedUseServicePlanCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("sharedUseServicePlans"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.CloudPcSharedUseServicePlanWithReferenceRequestBuilder sharedUseServicePlans(@Nonnull final String id) {
        return new com.microsoft.graph.requests.CloudPcSharedUseServicePlanWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("sharedUseServicePlans") + "/" + id, getClient(), null);
    }
    /**
