...
/**
 * The class for the Multi Tenant Organization Member Request Builder.
 */
public class MultiTenantOrganizationMemberRequestBuilder extends BaseRequestBuilder<MultiTenantOrganizationMember> {

    /**
     * The request builder for the MultiTenantOrganizationMember
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MultiTenantOrganizationMemberRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MultiTenantOrganizationMemberRequest instance
     */
    @Nonnull
    public MultiTenantOrganizationMemberRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MultiTenantOrganizationMemberRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MultiTenantOrganizationMemberRequest(getRequestUrl(), getClient(), requestOptions);
    }
