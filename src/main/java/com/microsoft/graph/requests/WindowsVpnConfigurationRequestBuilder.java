...
/**
 * The class for the Windows Vpn Configuration Request Builder.
 */
public class WindowsVpnConfigurationRequestBuilder extends BaseRequestBuilder<WindowsVpnConfiguration> {

    /**
     * The request builder for the WindowsVpnConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsVpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsVpnConfigurationRequest instance
     */
    @Nonnull
    public WindowsVpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsVpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsVpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
