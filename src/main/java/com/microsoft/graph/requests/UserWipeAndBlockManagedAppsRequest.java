...
import com.microsoft.graph.requests.UserWipeAndBlockManagedAppsRequest;
...
public class UserWipeAndBlockManagedAppsRequest extends BaseRequest<Void> {
     ...
     */
    public UserWipeAndBlockManagedAppsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the UserWipeAndBlockManagedApps
     *
