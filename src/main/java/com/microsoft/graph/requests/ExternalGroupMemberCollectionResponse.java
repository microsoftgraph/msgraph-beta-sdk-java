...
/**
 * The class for the External Group Member Collection Response.
 ...
 */
@Deprecated
public class ExternalGroupMemberCollectionResponse extends BaseCollectionResponse<ExternalGroupMember> {
