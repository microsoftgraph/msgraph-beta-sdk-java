 ...
 */
public class IosCertificateProfileWithReferenceRequest extends BaseWithReferenceRequest<IosCertificateProfile> {
     ...
     */
    public IosCertificateProfileWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public IosCertificateProfileWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public IosCertificateProfileWithReferenceRequest expand(@Nonnull final String value) {
