...
/**
 * The class for the Windows Wired Network Configuration Request Builder.
 */
public class WindowsWiredNetworkConfigurationRequestBuilder extends BaseRequestBuilder<WindowsWiredNetworkConfiguration> {

    /**
     * The request builder for the WindowsWiredNetworkConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsWiredNetworkConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsWiredNetworkConfigurationRequest instance
     */
    @Nonnull
    public WindowsWiredNetworkConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsWiredNetworkConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsWiredNetworkConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
