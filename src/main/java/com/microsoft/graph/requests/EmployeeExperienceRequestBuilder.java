...
public class EmployeeExperienceRequestBuilder extends BaseRequestBuilder<EmployeeExperience> {
     ...
     */
    @Nonnull
    public LearningProviderCollectionRequestBuilder learningProviders() {
        return new LearningProviderCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("learningProviders"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public LearningProviderRequestBuilder learningProviders(@Nonnull final String id) {
        return new LearningProviderRequestBuilder(getRequestUrlWithAdditionalSegment("learningProviders") + "/" + id, getClient(), null);
    }
}
