...
public class VirtualEventWebinarRequestBuilder extends BaseRequestBuilder<VirtualEventWebinar> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.VirtualEventPresenterCollectionRequestBuilder presenters() {
        return new com.microsoft.graph.requests.VirtualEventPresenterCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("presenters"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.VirtualEventPresenterRequestBuilder presenters(@Nonnull final String id) {
        return new com.microsoft.graph.requests.VirtualEventPresenterRequestBuilder(getRequestUrlWithAdditionalSegment("presenters") + "/" + id, getClient(), null);
    }
    /**
    ...
    /**
     * Gets the request builder for VirtualEventWebinarRegistrationConfiguration
     *
     * @return the VirtualEventWebinarRegistrationConfigurationWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.VirtualEventWebinarRegistrationConfigurationWithReferenceRequestBuilder registrationConfiguration() {
        return new com.microsoft.graph.requests.VirtualEventWebinarRegistrationConfigurationWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("registrationConfiguration"), getClient(), null);
    }
    /**
