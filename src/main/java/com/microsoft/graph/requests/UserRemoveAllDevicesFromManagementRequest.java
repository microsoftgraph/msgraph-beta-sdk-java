...
import com.microsoft.graph.requests.UserRemoveAllDevicesFromManagementRequest;
...
public class UserRemoveAllDevicesFromManagementRequest extends BaseRequest<Void> {
     ...
     */
    public UserRemoveAllDevicesFromManagementRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
