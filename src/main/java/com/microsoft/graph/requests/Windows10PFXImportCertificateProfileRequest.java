...
public class Windows10PFXImportCertificateProfileRequest extends BaseRequest<Windows10PFXImportCertificateProfile> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10PFXImportCertificateProfile> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10PFXImportCertificateProfile> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10PFXImportCertificateProfile> patchAsync(@Nonnull final Windows10PFXImportCertificateProfile sourceWindows10PFXImportCertificateProfile) {
        return sendAsync(HttpMethod.PATCH, sourceWindows10PFXImportCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10PFXImportCertificateProfile> postAsync(@Nonnull final Windows10PFXImportCertificateProfile newWindows10PFXImportCertificateProfile) {
        return sendAsync(HttpMethod.POST, newWindows10PFXImportCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Windows10PFXImportCertificateProfile> putAsync(@Nonnull final Windows10PFXImportCertificateProfile newWindows10PFXImportCertificateProfile) {
        return sendAsync(HttpMethod.PUT, newWindows10PFXImportCertificateProfile);
    }
