 ...
 */
public class GovernanceRoleAssignmentWithReferenceRequest extends BaseWithReferenceRequest<GovernanceRoleAssignment> {
     ...
     */
    public GovernanceRoleAssignmentWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GovernanceRoleAssignmentWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public GovernanceRoleAssignmentWithReferenceRequest expand(@Nonnull final String value) {
