 ...
 */
public class WindowsPhone81CertificateProfileBaseReferenceRequestBuilder extends BaseReferenceRequestBuilder<WindowsPhone81CertificateProfileBase, WindowsPhone81CertificateProfileBaseReferenceRequest> {
     ...
     */
    public WindowsPhone81CertificateProfileBaseReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsPhone81CertificateProfileBaseReferenceRequest.class);
    }
}
