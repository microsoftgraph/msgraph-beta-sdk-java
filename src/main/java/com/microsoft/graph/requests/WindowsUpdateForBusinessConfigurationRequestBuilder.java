...
public class WindowsUpdateForBusinessConfigurationRequestBuilder extends BaseRequestBuilder<WindowsUpdateForBusinessConfiguration> {
     ...
     */
    @Nonnull
    public WindowsUpdateForBusinessConfigurationExtendFeatureUpdatesPauseRequestBuilder extendFeatureUpdatesPause() {
        return new WindowsUpdateForBusinessConfigurationExtendFeatureUpdatesPauseRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.extendFeatureUpdatesPause"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public WindowsUpdateForBusinessConfigurationExtendQualityUpdatesPauseRequestBuilder extendQualityUpdatesPause() {
