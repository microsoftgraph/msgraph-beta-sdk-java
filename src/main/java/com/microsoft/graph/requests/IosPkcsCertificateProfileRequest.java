...
public class IosPkcsCertificateProfileRequest extends BaseRequest<IosPkcsCertificateProfile> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosPkcsCertificateProfile> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosPkcsCertificateProfile> deleteAsync() {
     ...
     */
    @Nullable
    public IosPkcsCertificateProfile delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosPkcsCertificateProfile> patchAsync(@Nonnull final IosPkcsCertificateProfile sourceIosPkcsCertificateProfile) {
        return sendAsync(HttpMethod.PATCH, sourceIosPkcsCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosPkcsCertificateProfile> postAsync(@Nonnull final IosPkcsCertificateProfile newIosPkcsCertificateProfile) {
        return sendAsync(HttpMethod.POST, newIosPkcsCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosPkcsCertificateProfile> putAsync(@Nonnull final IosPkcsCertificateProfile newIosPkcsCertificateProfile) {
        return sendAsync(HttpMethod.PUT, newIosPkcsCertificateProfile);
    }
