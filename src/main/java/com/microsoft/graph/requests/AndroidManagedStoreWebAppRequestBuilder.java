 ...
 */
public class AndroidManagedStoreWebAppRequestBuilder extends BaseRequestBuilder<AndroidManagedStoreWebApp> {
     ...
     */
    public AndroidManagedStoreWebAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidManagedStoreWebAppRequest instance
     */
    @Nonnull
    public AndroidManagedStoreWebAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidManagedStoreWebAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidManagedStoreWebAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
