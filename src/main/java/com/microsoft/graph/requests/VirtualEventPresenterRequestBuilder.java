...
/**
 * The class for the Virtual Event Presenter Request Builder.
 */
public class VirtualEventPresenterRequestBuilder extends BaseRequestBuilder<VirtualEventPresenter> {
     ...
     */
    public VirtualEventPresenterRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the VirtualEventPresenterRequest instance
     */
    @Nonnull
    public VirtualEventPresenterRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public VirtualEventPresenterRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.VirtualEventPresenterRequest(getRequestUrl(), getClient(), requestOptions);
    }
