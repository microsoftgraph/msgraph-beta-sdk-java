...
public class TermsAndConditionsGroupAssignmentRequestBuilder extends BaseRequestBuilder<TermsAndConditionsGroupAssignment> {
    ...
    public TermsAndConditionsGroupAssignmentRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.TermsAndConditionsGroupAssignmentRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.TermsAndConditionsWithReferenceRequestBuilder termsAndConditions() {
        return new com.microsoft.graph.requests.TermsAndConditionsWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("termsAndConditions"), getClient(), null);
    }
}
