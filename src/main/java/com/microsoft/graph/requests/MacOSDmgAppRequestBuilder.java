...
/**
 * The class for the Mac OSDmg App Request Builder.
 */
public class MacOSDmgAppRequestBuilder extends BaseRequestBuilder<MacOSDmgApp> {

    /**
     * The request builder for the MacOSDmgApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSDmgAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSDmgAppRequest instance
     */
    @Nonnull
    public MacOSDmgAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSDmgAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSDmgAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
