 ...
 */
public class AndroidCertificateProfileBaseReferenceRequestBuilder extends BaseReferenceRequestBuilder<AndroidCertificateProfileBase, AndroidCertificateProfileBaseReferenceRequest> {
     ...
     */
    public AndroidCertificateProfileBaseReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AndroidCertificateProfileBaseReferenceRequest.class);
    }
}
