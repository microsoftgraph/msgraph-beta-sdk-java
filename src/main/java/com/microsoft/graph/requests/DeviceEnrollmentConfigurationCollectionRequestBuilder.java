...
import com.microsoft.graph.requests.DeviceEnrollmentConfigurationCreateEnrollmentNotificationConfigurationRequestBuilder;
...
public class DeviceEnrollmentConfigurationCollectionRequestBuilder extends BaseCollectionRequestBuilder<DeviceEnrollmentConfiguration, DeviceEnrollmentConfigurationRequestBuilder, DeviceEnrollmentConfigurationCollectionResponse, DeviceEnrollmentConfigurationCollectionPage, DeviceEnrollmentConfigurationCollectionRequest> {
     ...
     */
    @Nonnull
    public DeviceEnrollmentConfigurationCreateEnrollmentNotificationConfigurationRequestBuilder createEnrollmentNotificationConfiguration(@Nonnull final DeviceEnrollmentConfigurationCreateEnrollmentNotificationConfigurationParameterSet parameters) {
        return new DeviceEnrollmentConfigurationCreateEnrollmentNotificationConfigurationRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.createEnrollmentNotificationConfiguration"), getClient(), null, parameters);
    }
