...
public class MacOSScepCertificateProfileRequestBuilder extends BaseRequestBuilder<MacOSScepCertificateProfile> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
        return new com.microsoft.graph.requests.MacOSTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificate"), getClient(), null);
    }
