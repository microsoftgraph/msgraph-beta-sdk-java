...
import com.microsoft.graph.requests.PrintJobCancelPrintJobRequest;
...
public class PrintJobCancelPrintJobRequest extends BaseRequest<Void> {
     ...
     */
    public PrintJobCancelPrintJobRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the PrintJobCancelPrintJob
     *
