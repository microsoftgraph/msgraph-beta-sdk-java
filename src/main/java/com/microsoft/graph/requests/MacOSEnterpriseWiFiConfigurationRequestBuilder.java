 ...
 */
public class MacOSEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<MacOSEnterpriseWiFiConfiguration> {
     ...
     */
    public MacOSEnterpriseWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSEnterpriseWiFiConfigurationRequest instance
     */
    @Nonnull
    public MacOSEnterpriseWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     *
     * @return the MacOSCertificateProfileBaseWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.MacOSCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }

    /**
     * Gets the request builder for MacOSTrustedRootCertificate
     *
     * @return the MacOSTrustedRootCertificateWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new com.microsoft.graph.requests.MacOSTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
    /**
     *  Gets a request builder for the MacOSTrustedRootCertificate collection
     *
     * @return the collection request builder
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSTrustedRootCertificateCollectionRequestBuilder rootCertificatesForServerValidation() {
        return new com.microsoft.graph.requests.MacOSTrustedRootCertificateCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation"), getClient(), null);
    }

    /**
     * Gets a request builder for the MacOSTrustedRootCertificate item
     *
     * @return the request builder
     * @param id the item identifier
     */
    @Nonnull
    public com.microsoft.graph.requests.MacOSTrustedRootCertificateRequestBuilder rootCertificatesForServerValidation(@Nonnull final String id) {
        return new com.microsoft.graph.requests.MacOSTrustedRootCertificateRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation") + "/" + id, getClient(), null);
    }
