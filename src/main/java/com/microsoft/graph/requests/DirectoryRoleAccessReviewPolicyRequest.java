...
public class DirectoryRoleAccessReviewPolicyRequest extends BaseRequest<DirectoryRoleAccessReviewPolicy> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DirectoryRoleAccessReviewPolicy> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DirectoryRoleAccessReviewPolicy> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DirectoryRoleAccessReviewPolicy> patchAsync(@Nonnull final DirectoryRoleAccessReviewPolicy sourceDirectoryRoleAccessReviewPolicy) {
        return sendAsync(HttpMethod.PATCH, sourceDirectoryRoleAccessReviewPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DirectoryRoleAccessReviewPolicy> postAsync(@Nonnull final DirectoryRoleAccessReviewPolicy newDirectoryRoleAccessReviewPolicy) {
        return sendAsync(HttpMethod.POST, newDirectoryRoleAccessReviewPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DirectoryRoleAccessReviewPolicy> putAsync(@Nonnull final DirectoryRoleAccessReviewPolicy newDirectoryRoleAccessReviewPolicy) {
        return sendAsync(HttpMethod.PUT, newDirectoryRoleAccessReviewPolicy);
    }
