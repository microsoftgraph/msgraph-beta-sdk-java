 ...
 */
public class TrustFrameworkPolicyStreamRequest extends BaseStreamRequest<TrustFrameworkPolicy> {
     ...
     */
    public TrustFrameworkPolicyStreamRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TrustFrameworkPolicy> putAsync(@Nonnull final byte[] fileContents) {
     ...
     */
    @Nullable
    public TrustFrameworkPolicy put(@Nonnull final byte[] fileContents) throws ClientException {
