 ...
 */
public class GroupPolicyDefinitionReferenceRequestBuilder extends BaseReferenceRequestBuilder<GroupPolicyDefinition, GroupPolicyDefinitionReferenceRequest> {
     ...
     */
    public GroupPolicyDefinitionReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, GroupPolicyDefinitionReferenceRequest.class);
    }
}
