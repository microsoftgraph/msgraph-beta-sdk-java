 ...
 */
public class AndroidWorkProfilePkcsCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidWorkProfilePkcsCertificateProfile> {
     ...
     */
    public AndroidWorkProfilePkcsCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfilePkcsCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidWorkProfilePkcsCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfilePkcsCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidWorkProfilePkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.ManagedDeviceCertificateStateCollectionRequestBuilder managedDeviceCertificateStates() {
        return new com.microsoft.graph.requests.ManagedDeviceCertificateStateCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.ManagedDeviceCertificateStateRequestBuilder managedDeviceCertificateStates(@Nonnull final String id) {
        return new com.microsoft.graph.requests.ManagedDeviceCertificateStateRequestBuilder(getRequestUrlWithAdditionalSegment("managedDeviceCertificateStates") + "/" + id, getClient(), null);
    }
