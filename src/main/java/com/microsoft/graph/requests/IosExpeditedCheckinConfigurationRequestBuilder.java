...
/**
 * The class for the Ios Expedited Checkin Configuration Request Builder.
 */
public class IosExpeditedCheckinConfigurationRequestBuilder extends BaseRequestBuilder<IosExpeditedCheckinConfiguration> {

    /**
     * The request builder for the IosExpeditedCheckinConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public IosExpeditedCheckinConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosExpeditedCheckinConfigurationRequest instance
     */
    @Nonnull
    public IosExpeditedCheckinConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosExpeditedCheckinConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosExpeditedCheckinConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
