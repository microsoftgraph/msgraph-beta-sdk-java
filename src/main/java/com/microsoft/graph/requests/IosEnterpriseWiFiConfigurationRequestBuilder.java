...
public class IosEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<IosEnterpriseWiFiConfiguration> {
    ...
    public IosEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
    /**
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosTrustedRootCertificateCollectionRequestBuilder rootCertificatesForServerValidation() {
        return new com.microsoft.graph.requests.IosTrustedRootCertificateCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosTrustedRootCertificateRequestBuilder rootCertificatesForServerValidation(@Nonnull final String id) {
        return new com.microsoft.graph.requests.IosTrustedRootCertificateRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation") + "/" + id, getClient(), null);
    }
