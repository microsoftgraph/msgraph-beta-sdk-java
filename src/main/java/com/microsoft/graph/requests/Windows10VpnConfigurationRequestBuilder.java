...
/**
 * The class for the Windows10Vpn Configuration Request Builder.
 */
public class Windows10VpnConfigurationRequestBuilder extends BaseRequestBuilder<Windows10VpnConfiguration> {

    /**
     * The request builder for the Windows10VpnConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public Windows10VpnConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10VpnConfigurationRequest instance
     */
    @Nonnull
    public Windows10VpnConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10VpnConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows10VpnConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.WindowsCertificateProfileBaseWithReferenceRequestBuilder identityCertificate() {
        return new com.microsoft.graph.requests.WindowsCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificate"), getClient(), null);
    }
