...
import com.microsoft.graph.models.ServicePrincipal;
import com.microsoft.graph.requests.ServicePrincipalWithReferenceRequest;
import com.microsoft.graph.requests.ServicePrincipalReferenceRequestBuilder;
import com.microsoft.graph.requests.ServicePrincipalWithReferenceRequestBuilder;
import com.microsoft.graph.requests.ServicePrincipalCollectionWithReferencesRequest;
import com.microsoft.graph.requests.ServicePrincipalCollectionWithReferencesRequest;
...
public class ServicePrincipalCollectionWithReferencesRequest extends BaseCollectionWithReferencesRequest<ServicePrincipal, ServicePrincipalWithReferenceRequest, ServicePrincipalReferenceRequestBuilder, ServicePrincipalWithReferenceRequestBuilder, ServicePrincipalCollectionResponse, ServicePrincipalCollectionWithReferencesPage, ServicePrincipalCollectionWithReferencesRequest> {
     ...
     */
    @Nonnull
    public ServicePrincipalCollectionWithReferencesRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public ServicePrincipalCollectionWithReferencesRequest count() {
        addCountOption(true);
        return this;
    }
}
