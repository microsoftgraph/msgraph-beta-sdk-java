 ...
 */
public class PlannerPlanCollectionRequestBuilder extends BaseCollectionRequestBuilder<PlannerPlan, PlannerPlanRequestBuilder, PlannerPlanCollectionResponse, PlannerPlanCollectionPage, PlannerPlanCollectionRequest> {
     ...
     */
    public PlannerPlanCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, PlannerPlanRequestBuilder.class, PlannerPlanCollectionRequest.class);
    }
