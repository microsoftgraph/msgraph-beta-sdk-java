 ...
 */
public class MacOSWiredNetworkConfigurationRequestBuilder extends BaseRequestBuilder<MacOSWiredNetworkConfiguration> {
     ...
     */
    public MacOSWiredNetworkConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSWiredNetworkConfigurationRequest instance
     */
    @Nonnull
    public MacOSWiredNetworkConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSWiredNetworkConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSWiredNetworkConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
