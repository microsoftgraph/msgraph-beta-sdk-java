 ...
 */
public class ChatWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<Chat, ChatWithReferenceRequest, ChatReferenceRequestBuilder> {
     ...
     */
    public ChatWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ChatWithReferenceRequest.class, ChatReferenceRequestBuilder.class);
    }
}
