...
import com.microsoft.graph.requests.ManagedDeviceDownloadAppDiagnosticsRequestBuilder;
...
public class ManagedDeviceCollectionRequestBuilder extends BaseCollectionRequestBuilder<ManagedDevice, ManagedDeviceRequestBuilder, ManagedDeviceCollectionResponse, ManagedDeviceCollectionPage, ManagedDeviceCollectionRequest> {
     ...
     */
    @Nonnull
    public ManagedDeviceDownloadAppDiagnosticsRequestBuilder downloadAppDiagnostics(@Nonnull final ManagedDeviceDownloadAppDiagnosticsParameterSet parameters) {
        return new ManagedDeviceDownloadAppDiagnosticsRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.downloadAppDiagnostics"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public ManagedDeviceAppDiagnosticsCollectionRequestBuilder appDiagnostics(@Nonnull final ManagedDeviceAppDiagnosticsParameterSet parameters) {
        return new ManagedDeviceAppDiagnosticsCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.appDiagnostics"), getClient(), null, parameters);
    }
