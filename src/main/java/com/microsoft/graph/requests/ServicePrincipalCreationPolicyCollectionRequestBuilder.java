...
/**
 * The class for the Service Principal Creation Policy Collection Request Builder.
 */
public class ServicePrincipalCreationPolicyCollectionRequestBuilder extends BaseCollectionRequestBuilder<ServicePrincipalCreationPolicy, ServicePrincipalCreationPolicyRequestBuilder, ServicePrincipalCreationPolicyCollectionResponse, ServicePrincipalCreationPolicyCollectionPage, ServicePrincipalCreationPolicyCollectionRequest> {
     ...
     */
    public ServicePrincipalCreationPolicyCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ServicePrincipalCreationPolicyRequestBuilder.class, ServicePrincipalCreationPolicyCollectionRequest.class);
    }
