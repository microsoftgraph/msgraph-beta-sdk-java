...
/**
 * The class for the Aosp Device Owner Pkcs Certificate Profile Request Builder.
 */
public class AospDeviceOwnerPkcsCertificateProfileRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerPkcsCertificateProfile> {

    /**
     * The request builder for the AospDeviceOwnerPkcsCertificateProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerPkcsCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerPkcsCertificateProfileRequest instance
     */
    @Nonnull
    public AospDeviceOwnerPkcsCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerPkcsCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerPkcsCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
