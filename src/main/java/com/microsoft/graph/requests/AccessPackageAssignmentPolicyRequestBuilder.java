...
public class AccessPackageAssignmentPolicyRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentPolicy> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.CustomExtensionStageSettingCollectionWithReferencesRequestBuilder customExtensionStageSettings() {
        return new com.microsoft.graph.requests.CustomExtensionStageSettingCollectionWithReferencesRequestBuilder(getRequestUrlWithAdditionalSegment("customExtensionStageSettings"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.CustomExtensionStageSettingWithReferenceRequestBuilder customExtensionStageSettings(@Nonnull final String id) {
        return new com.microsoft.graph.requests.CustomExtensionStageSettingWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("customExtensionStageSettings") + "/" + id, getClient(), null);
    }
}
