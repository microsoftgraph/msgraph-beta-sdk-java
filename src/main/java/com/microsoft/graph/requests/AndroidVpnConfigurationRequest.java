...
public class AndroidVpnConfigurationRequest extends BaseRequest<AndroidVpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidVpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidVpnConfiguration> deleteAsync() {
     ...
     */
    @Nullable
    public AndroidVpnConfiguration delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidVpnConfiguration> patchAsync(@Nonnull final AndroidVpnConfiguration sourceAndroidVpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidVpnConfiguration> postAsync(@Nonnull final AndroidVpnConfiguration newAndroidVpnConfiguration) {
        return sendAsync(HttpMethod.POST, newAndroidVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidVpnConfiguration> putAsync(@Nonnull final AndroidVpnConfiguration newAndroidVpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newAndroidVpnConfiguration);
    }
