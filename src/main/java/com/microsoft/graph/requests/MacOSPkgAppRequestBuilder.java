...
/**
 * The class for the Mac OSPkg App Request Builder.
 */
public class MacOSPkgAppRequestBuilder extends BaseRequestBuilder<MacOSPkgApp> {

    /**
     * The request builder for the MacOSPkgApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSPkgAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSPkgAppRequest instance
     */
    @Nonnull
    public MacOSPkgAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSPkgAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSPkgAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
