...
/**
 * The class for the Android For Work Nine Work Eas Configuration Request Builder.
 */
public class AndroidForWorkNineWorkEasConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkNineWorkEasConfiguration> {

    /**
     * The request builder for the AndroidForWorkNineWorkEasConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AndroidForWorkNineWorkEasConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkNineWorkEasConfigurationRequest instance
     */
    @Nonnull
    public AndroidForWorkNineWorkEasConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkNineWorkEasConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkNineWorkEasConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
