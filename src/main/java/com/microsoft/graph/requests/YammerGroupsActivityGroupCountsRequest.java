...
public class YammerGroupsActivityGroupCountsRequest extends BaseRequest<YammerGroupsActivityGroupCounts> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<YammerGroupsActivityGroupCounts> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<YammerGroupsActivityGroupCounts> deleteAsync() {
     ...
     */
    @Nullable
    public YammerGroupsActivityGroupCounts delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<YammerGroupsActivityGroupCounts> patchAsync(@Nonnull final YammerGroupsActivityGroupCounts sourceYammerGroupsActivityGroupCounts) {
        return sendAsync(HttpMethod.PATCH, sourceYammerGroupsActivityGroupCounts);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<YammerGroupsActivityGroupCounts> postAsync(@Nonnull final YammerGroupsActivityGroupCounts newYammerGroupsActivityGroupCounts) {
        return sendAsync(HttpMethod.POST, newYammerGroupsActivityGroupCounts);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<YammerGroupsActivityGroupCounts> putAsync(@Nonnull final YammerGroupsActivityGroupCounts newYammerGroupsActivityGroupCounts) {
        return sendAsync(HttpMethod.PUT, newYammerGroupsActivityGroupCounts);
    }
