...
public class MacOSMdatpAppRequest extends BaseRequest<MacOSMdatpApp> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMdatpApp> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMdatpApp> deleteAsync() {
     ...
     */
    @Nullable
    public MacOSMdatpApp delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMdatpApp> patchAsync(@Nonnull final MacOSMdatpApp sourceMacOSMdatpApp) {
        return sendAsync(HttpMethod.PATCH, sourceMacOSMdatpApp);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMdatpApp> postAsync(@Nonnull final MacOSMdatpApp newMacOSMdatpApp) {
        return sendAsync(HttpMethod.POST, newMacOSMdatpApp);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MacOSMdatpApp> putAsync(@Nonnull final MacOSMdatpApp newMacOSMdatpApp) {
        return sendAsync(HttpMethod.PUT, newMacOSMdatpApp);
    }
