 ...
 */
public class AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<AndroidDeviceOwnerTrustedRootCertificate, AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest, AndroidDeviceOwnerTrustedRootCertificateReferenceRequestBuilder> {
     ...
     */
    public AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest.class, AndroidDeviceOwnerTrustedRootCertificateReferenceRequestBuilder.class);
    }
}
