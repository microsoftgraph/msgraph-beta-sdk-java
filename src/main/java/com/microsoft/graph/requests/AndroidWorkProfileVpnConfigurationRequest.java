...
public class AndroidWorkProfileVpnConfigurationRequest extends BaseRequest<AndroidWorkProfileVpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidWorkProfileVpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidWorkProfileVpnConfiguration> deleteAsync() {
     ...
     */
    @Nullable
    public AndroidWorkProfileVpnConfiguration delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidWorkProfileVpnConfiguration> patchAsync(@Nonnull final AndroidWorkProfileVpnConfiguration sourceAndroidWorkProfileVpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidWorkProfileVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidWorkProfileVpnConfiguration> postAsync(@Nonnull final AndroidWorkProfileVpnConfiguration newAndroidWorkProfileVpnConfiguration) {
        return sendAsync(HttpMethod.POST, newAndroidWorkProfileVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidWorkProfileVpnConfiguration> putAsync(@Nonnull final AndroidWorkProfileVpnConfiguration newAndroidWorkProfileVpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newAndroidWorkProfileVpnConfiguration);
    }
