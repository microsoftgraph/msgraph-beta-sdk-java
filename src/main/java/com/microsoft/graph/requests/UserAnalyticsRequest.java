...
public class UserAnalyticsRequest extends BaseRequest<UserAnalytics> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserAnalytics> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserAnalytics> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserAnalytics> patchAsync(@Nonnull final UserAnalytics sourceUserAnalytics) {
        return sendAsync(HttpMethod.PATCH, sourceUserAnalytics);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserAnalytics> postAsync(@Nonnull final UserAnalytics newUserAnalytics) {
        return sendAsync(HttpMethod.POST, newUserAnalytics);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserAnalytics> putAsync(@Nonnull final UserAnalytics newUserAnalytics) {
        return sendAsync(HttpMethod.PUT, newUserAnalytics);
    }
