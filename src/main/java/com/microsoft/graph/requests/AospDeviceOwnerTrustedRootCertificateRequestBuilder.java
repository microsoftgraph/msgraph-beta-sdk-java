...
/**
 * The class for the Aosp Device Owner Trusted Root Certificate Request Builder.
 */
public class AospDeviceOwnerTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerTrustedRootCertificate> {
     ...
     */
    public AospDeviceOwnerTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerTrustedRootCertificateRequest instance
     */
    @Nonnull
    public AospDeviceOwnerTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
