 ...
 */
public class WindowsAutopilotDeploymentProfileWithReferenceRequest extends BaseWithReferenceRequest<WindowsAutopilotDeploymentProfile> {
     ...
     */
    public WindowsAutopilotDeploymentProfileWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WindowsAutopilotDeploymentProfileWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WindowsAutopilotDeploymentProfileWithReferenceRequest expand(@Nonnull final String value) {
