 ...
 */
public class Windows10ImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder<Windows10ImportedPFXCertificateProfile> {
     ...
     */
    public Windows10ImportedPFXCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10ImportedPFXCertificateProfileRequest instance
     */
    @Nonnull
    public Windows10ImportedPFXCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10ImportedPFXCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows10ImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
