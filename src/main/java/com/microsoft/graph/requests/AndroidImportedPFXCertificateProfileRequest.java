...
public class AndroidImportedPFXCertificateProfileRequest extends BaseRequest<AndroidImportedPFXCertificateProfile> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidImportedPFXCertificateProfile> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidImportedPFXCertificateProfile> deleteAsync() {
     ...
     */
    @Nullable
    public AndroidImportedPFXCertificateProfile delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidImportedPFXCertificateProfile> patchAsync(@Nonnull final AndroidImportedPFXCertificateProfile sourceAndroidImportedPFXCertificateProfile) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidImportedPFXCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidImportedPFXCertificateProfile> postAsync(@Nonnull final AndroidImportedPFXCertificateProfile newAndroidImportedPFXCertificateProfile) {
        return sendAsync(HttpMethod.POST, newAndroidImportedPFXCertificateProfile);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidImportedPFXCertificateProfile> putAsync(@Nonnull final AndroidImportedPFXCertificateProfile newAndroidImportedPFXCertificateProfile) {
        return sendAsync(HttpMethod.PUT, newAndroidImportedPFXCertificateProfile);
    }
