...
/**
 * The class for the Authorization Policy Request Builder.
 */
public class AuthorizationPolicyRequestBuilder extends BaseRequestBuilder<AuthorizationPolicy> {

    /**
     * The request builder for the AuthorizationPolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AuthorizationPolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AuthorizationPolicyRequest instance
     */
    @Nonnull
    public AuthorizationPolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AuthorizationPolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AuthorizationPolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
