...
public class AndroidForWorkEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidForWorkEnterpriseWiFiConfiguration> {
    ...
    public AndroidForWorkEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidForWorkCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.AndroidForWorkCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidForWorkTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new com.microsoft.graph.requests.AndroidForWorkTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
