 ...
 */
public class EasEmailProfileConfigurationBaseRequestBuilder extends BaseRequestBuilder<EasEmailProfileConfigurationBase> {
     ...
     */
    public EasEmailProfileConfigurationBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the EasEmailProfileConfigurationBaseRequest instance
     */
    @Nonnull
    public EasEmailProfileConfigurationBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EasEmailProfileConfigurationBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.EasEmailProfileConfigurationBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
