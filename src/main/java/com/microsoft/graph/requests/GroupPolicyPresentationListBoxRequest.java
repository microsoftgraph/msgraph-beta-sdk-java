...
public class GroupPolicyPresentationListBoxRequest extends BaseRequest<GroupPolicyPresentationListBox> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyPresentationListBox> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyPresentationListBox> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyPresentationListBox> patchAsync(@Nonnull final GroupPolicyPresentationListBox sourceGroupPolicyPresentationListBox) {
        return sendAsync(HttpMethod.PATCH, sourceGroupPolicyPresentationListBox);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyPresentationListBox> postAsync(@Nonnull final GroupPolicyPresentationListBox newGroupPolicyPresentationListBox) {
        return sendAsync(HttpMethod.POST, newGroupPolicyPresentationListBox);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<GroupPolicyPresentationListBox> putAsync(@Nonnull final GroupPolicyPresentationListBox newGroupPolicyPresentationListBox) {
        return sendAsync(HttpMethod.PUT, newGroupPolicyPresentationListBox);
    }
