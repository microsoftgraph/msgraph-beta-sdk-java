...
/**
 * The class for the Tenant Reference Collection Request Builder.
 */
public class TenantReferenceCollectionRequestBuilder extends BaseCollectionRequestBuilder<TenantReference, TenantReferenceRequestBuilder, TenantReferenceCollectionResponse, TenantReferenceCollectionPage, TenantReferenceCollectionRequest> {

    /**
     * The request builder for this collection of OutboundSharedUserProfile
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public TenantReferenceCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, TenantReferenceRequestBuilder.class, TenantReferenceCollectionRequest.class);
    }
