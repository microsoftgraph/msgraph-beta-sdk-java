...
/**
 * The class for the Aosp Device Owner Wi Fi Configuration Request Builder.
 */
public class AospDeviceOwnerWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerWiFiConfiguration> {

    /**
     * The request builder for the AospDeviceOwnerWiFiConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerWiFiConfigurationRequest instance
     */
    @Nonnull
    public AospDeviceOwnerWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
