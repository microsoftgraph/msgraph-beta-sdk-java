...
public class AccessPackageAssignmentCollectionRequestBuilder extends BaseCollectionRequestBuilder<AccessPackageAssignment, AccessPackageAssignmentRequestBuilder, AccessPackageAssignmentCollectionResponse, AccessPackageAssignmentCollectionPage, AccessPackageAssignmentCollectionRequest> {
     ...
     */
    @Nonnull
    public AccessPackageAssignmentFilterByCurrentUserCollectionRequestBuilder filterByCurrentUser(@Nonnull final AccessPackageAssignmentFilterByCurrentUserParameterSet parameters) {
        return new AccessPackageAssignmentFilterByCurrentUserCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.filterByCurrentUser"), getClient(), null, parameters);
    }
     ...
     */
    @Nonnull
    public AccessPackageAssignmentAdditionalAccessCollectionRequestBuilder additionalAccess() {
        return new AccessPackageAssignmentAdditionalAccessCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.additionalAccess"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public AccessPackageAssignmentAdditionalAccessCollectionRequestBuilder additionalAccess(@Nonnull final AccessPackageAssignmentAdditionalAccessParameterSet parameters) {
        return new AccessPackageAssignmentAdditionalAccessCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.additionalAccess"), getClient(), null, parameters);
    }
