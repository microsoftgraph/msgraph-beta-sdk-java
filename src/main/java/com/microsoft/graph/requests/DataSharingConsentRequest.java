...
public class DataSharingConsentRequest extends BaseRequest<DataSharingConsent> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DataSharingConsent> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DataSharingConsent> deleteAsync() {
     ...
     */
    @Nullable
    public DataSharingConsent delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DataSharingConsent> patchAsync(@Nonnull final DataSharingConsent sourceDataSharingConsent) {
        return sendAsync(HttpMethod.PATCH, sourceDataSharingConsent);
    }
    ...
    public java.util.concurrent.CompletableFuture<DataSharingConsent> postAsync(@Nonnull final DataSharingConsent newDataSharingConsent) {
        return sendAsync(HttpMethod.POST, newDataSharingConsent);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DataSharingConsent> putAsync(@Nonnull final DataSharingConsent newDataSharingConsent) {
        return sendAsync(HttpMethod.PUT, newDataSharingConsent);
    }
