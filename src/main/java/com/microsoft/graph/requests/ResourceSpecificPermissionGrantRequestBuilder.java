 ...
 */
public class ResourceSpecificPermissionGrantRequestBuilder extends BaseRequestBuilder<ResourceSpecificPermissionGrant> {
     ...
     */
    public ResourceSpecificPermissionGrantRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the ResourceSpecificPermissionGrantRequest instance
     */
    @Nonnull
    public ResourceSpecificPermissionGrantRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ResourceSpecificPermissionGrantRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.ResourceSpecificPermissionGrantRequest(getRequestUrl(), getClient(), requestOptions);
    }
