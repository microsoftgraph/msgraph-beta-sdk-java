 ...
 */
public class AndroidDeviceOwnerScepCertificateProfileRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerScepCertificateProfile> {
     ...
     */
    public AndroidDeviceOwnerScepCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerScepCertificateProfileRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerScepCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerScepCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerScepCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder rootCertificate() {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificate"), getClient(), null);
    }
    /**
