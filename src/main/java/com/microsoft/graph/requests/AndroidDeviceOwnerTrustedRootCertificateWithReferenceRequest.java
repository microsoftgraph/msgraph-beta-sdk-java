 ...
 */
public class AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest extends BaseWithReferenceRequest<AndroidDeviceOwnerTrustedRootCertificate> {
     ...
     */
    public AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerTrustedRootCertificateWithReferenceRequest expand(@Nonnull final String value) {
