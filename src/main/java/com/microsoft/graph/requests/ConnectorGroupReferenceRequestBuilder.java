 ...
 */
public class ConnectorGroupReferenceRequestBuilder extends BaseReferenceRequestBuilder<ConnectorGroup, ConnectorGroupReferenceRequest> {
     ...
     */
    public ConnectorGroupReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, ConnectorGroupReferenceRequest.class);
    }
}
