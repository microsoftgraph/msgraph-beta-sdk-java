...
public class AccessPackageAssignmentRequestRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentRequest> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AccessPackageAssignmentRequestBuilder accessPackageAssignment() {
        return new com.microsoft.graph.requests.AccessPackageAssignmentRequestBuilder(getRequestUrlWithAdditionalSegment("accessPackageAssignment"), getClient(), null);
    }
    ...
    @Deprecated
    @Nonnull
    public AccessPackageAssignmentRequestResumeRequestBuilder resume(@Nonnull final AccessPackageAssignmentRequestResumeParameterSet parameters) {
        return new AccessPackageAssignmentRequestResumeRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.resume"), getClient(), null, parameters);
    }
