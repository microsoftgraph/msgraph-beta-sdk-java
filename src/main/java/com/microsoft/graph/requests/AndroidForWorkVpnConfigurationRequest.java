...
public class AndroidForWorkVpnConfigurationRequest extends BaseRequest<AndroidForWorkVpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkVpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkVpnConfiguration> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkVpnConfiguration> patchAsync(@Nonnull final AndroidForWorkVpnConfiguration sourceAndroidForWorkVpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidForWorkVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkVpnConfiguration> postAsync(@Nonnull final AndroidForWorkVpnConfiguration newAndroidForWorkVpnConfiguration) {
        return sendAsync(HttpMethod.POST, newAndroidForWorkVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkVpnConfiguration> putAsync(@Nonnull final AndroidForWorkVpnConfiguration newAndroidForWorkVpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newAndroidForWorkVpnConfiguration);
    }
