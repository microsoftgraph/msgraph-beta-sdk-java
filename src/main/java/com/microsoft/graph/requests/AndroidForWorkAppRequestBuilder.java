 ...
 */
public class AndroidForWorkAppRequestBuilder extends BaseRequestBuilder<AndroidForWorkApp> {
     ...
     */
    public AndroidForWorkAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidForWorkAppRequest instance
     */
    @Nonnull
    public AndroidForWorkAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidForWorkAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidForWorkAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
