...
/**
 * The class for the Android Trusted Root Certificate Request Builder.
 */
public class AndroidTrustedRootCertificateRequestBuilder extends BaseRequestBuilder<AndroidTrustedRootCertificate> {
     ...
     */
    public AndroidTrustedRootCertificateRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidTrustedRootCertificateRequest instance
     */
    @Nonnull
    public AndroidTrustedRootCertificateRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidTrustedRootCertificateRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidTrustedRootCertificateRequest(getRequestUrl(), getClient(), requestOptions);
    }
