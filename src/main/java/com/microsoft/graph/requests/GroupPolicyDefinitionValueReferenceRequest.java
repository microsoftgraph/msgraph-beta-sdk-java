 ...
 */
public class GroupPolicyDefinitionValueReferenceRequest extends BaseReferenceRequest<GroupPolicyDefinitionValue> {
     ...
     */
    public GroupPolicyDefinitionValueReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public GroupPolicyDefinitionValueReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public GroupPolicyDefinitionValueReferenceRequest expand(@Nonnull final String value) {
