...
public class PlannerPlanRequestBuilder extends BaseRequestBuilder<PlannerPlan> {
     ...
     */
    @Nonnull
    public PlannerPlanMoveToContainerRequestBuilder moveToContainer(@Nonnull final PlannerPlanMoveToContainerParameterSet parameters) {
        return new PlannerPlanMoveToContainerRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.moveToContainer"), getClient(), null, parameters);
    }
}
