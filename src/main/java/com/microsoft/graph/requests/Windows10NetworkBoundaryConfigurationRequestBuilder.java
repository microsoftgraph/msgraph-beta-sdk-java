 ...
 */
public class Windows10NetworkBoundaryConfigurationRequestBuilder extends BaseRequestBuilder<Windows10NetworkBoundaryConfiguration> {
     ...
     */
    public Windows10NetworkBoundaryConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the Windows10NetworkBoundaryConfigurationRequest instance
     */
    @Nonnull
    public Windows10NetworkBoundaryConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public Windows10NetworkBoundaryConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.Windows10NetworkBoundaryConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
