...
import com.microsoft.graph.requests.OrganizationCollectionRequest;
...
public class OrganizationCollectionRequest extends BaseEntityCollectionRequest<Organization, OrganizationCollectionResponse, OrganizationCollectionPage> {
     ...
     */
    @Nonnull
    public OrganizationCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public OrganizationCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
