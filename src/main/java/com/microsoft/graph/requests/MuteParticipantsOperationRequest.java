...
public class MuteParticipantsOperationRequest extends BaseRequest<MuteParticipantsOperation> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> patchAsync(@Nonnull final MuteParticipantsOperation sourceMuteParticipantsOperation) {
        return sendAsync(HttpMethod.PATCH, sourceMuteParticipantsOperation);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> postAsync(@Nonnull final MuteParticipantsOperation newMuteParticipantsOperation) {
        return sendAsync(HttpMethod.POST, newMuteParticipantsOperation);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<MuteParticipantsOperation> putAsync(@Nonnull final MuteParticipantsOperation newMuteParticipantsOperation) {
        return sendAsync(HttpMethod.PUT, newMuteParticipantsOperation);
    }
