...
public class AndroidManagedStoreAppConfigurationSchemaRequest extends BaseRequest<AndroidManagedStoreAppConfigurationSchema> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAppConfigurationSchema> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAppConfigurationSchema> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAppConfigurationSchema> patchAsync(@Nonnull final AndroidManagedStoreAppConfigurationSchema sourceAndroidManagedStoreAppConfigurationSchema) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidManagedStoreAppConfigurationSchema);
    }
    ...
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAppConfigurationSchema> postAsync(@Nonnull final AndroidManagedStoreAppConfigurationSchema newAndroidManagedStoreAppConfigurationSchema) {
        return sendAsync(HttpMethod.POST, newAndroidManagedStoreAppConfigurationSchema);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidManagedStoreAppConfigurationSchema> putAsync(@Nonnull final AndroidManagedStoreAppConfigurationSchema newAndroidManagedStoreAppConfigurationSchema) {
        return sendAsync(HttpMethod.PUT, newAndroidManagedStoreAppConfigurationSchema);
    }
