 ...
 */
public class WindowsHealthMonitoringConfigurationRequestBuilder extends BaseRequestBuilder<WindowsHealthMonitoringConfiguration> {
     ...
     */
    public WindowsHealthMonitoringConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsHealthMonitoringConfigurationRequest instance
     */
    @Nonnull
    public WindowsHealthMonitoringConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsHealthMonitoringConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsHealthMonitoringConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
