...
public class GroupRequestBuilder extends BaseRequestBuilder<Group> {
    ...
    public com.microsoft.graph.requests.DirectorySettingCollectionRequestBuilder settings() {
        return new com.microsoft.graph.requests.DirectorySettingCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("settings"), getClient(), null);
    }
    ...
    public com.microsoft.graph.requests.DirectorySettingRequestBuilder settings(@Nonnull final String id) {
        return new com.microsoft.graph.requests.DirectorySettingRequestBuilder(getRequestUrlWithAdditionalSegment("settings") + "/" + id, getClient(), null);
    }
    /**
     *  Gets a request builder for the DirectoryObject collection
     *
