...
public class TaxAreaRequest extends BaseRequest<TaxArea> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TaxArea> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TaxArea> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TaxArea> patchAsync(@Nonnull final TaxArea sourceTaxArea) {
        return sendAsync(HttpMethod.PATCH, sourceTaxArea);
    }
    ...
    public java.util.concurrent.CompletableFuture<TaxArea> postAsync(@Nonnull final TaxArea newTaxArea) {
        return sendAsync(HttpMethod.POST, newTaxArea);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<TaxArea> putAsync(@Nonnull final TaxArea newTaxArea) {
        return sendAsync(HttpMethod.PUT, newTaxArea);
    }
