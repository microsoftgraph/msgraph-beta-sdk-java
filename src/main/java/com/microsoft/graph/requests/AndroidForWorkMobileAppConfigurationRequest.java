...
public class AndroidForWorkMobileAppConfigurationRequest extends BaseRequest<AndroidForWorkMobileAppConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkMobileAppConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkMobileAppConfiguration> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkMobileAppConfiguration> patchAsync(@Nonnull final AndroidForWorkMobileAppConfiguration sourceAndroidForWorkMobileAppConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceAndroidForWorkMobileAppConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkMobileAppConfiguration> postAsync(@Nonnull final AndroidForWorkMobileAppConfiguration newAndroidForWorkMobileAppConfiguration) {
        return sendAsync(HttpMethod.POST, newAndroidForWorkMobileAppConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<AndroidForWorkMobileAppConfiguration> putAsync(@Nonnull final AndroidForWorkMobileAppConfiguration newAndroidForWorkMobileAppConfiguration) {
        return sendAsync(HttpMethod.PUT, newAndroidForWorkMobileAppConfiguration);
    }
