...
public class IosVpnConfigurationRequest extends BaseRequest<IosVpnConfiguration> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosVpnConfiguration> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosVpnConfiguration> deleteAsync() {
     ...
     */
    @Nullable
    public IosVpnConfiguration delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosVpnConfiguration> patchAsync(@Nonnull final IosVpnConfiguration sourceIosVpnConfiguration) {
        return sendAsync(HttpMethod.PATCH, sourceIosVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosVpnConfiguration> postAsync(@Nonnull final IosVpnConfiguration newIosVpnConfiguration) {
        return sendAsync(HttpMethod.POST, newIosVpnConfiguration);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<IosVpnConfiguration> putAsync(@Nonnull final IosVpnConfiguration newIosVpnConfiguration) {
        return sendAsync(HttpMethod.PUT, newIosVpnConfiguration);
    }
