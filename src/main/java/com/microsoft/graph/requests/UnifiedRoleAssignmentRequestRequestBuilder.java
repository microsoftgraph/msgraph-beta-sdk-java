 ...
 */
public class UnifiedRoleAssignmentRequestRequestBuilder extends BaseRequestBuilder<UnifiedRoleAssignmentRequest> {
     ...
     */
    public UnifiedRoleAssignmentRequestRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the UnifiedRoleAssignmentRequestRequest instance
     */
    @Nonnull
    public UnifiedRoleAssignmentRequestRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public UnifiedRoleAssignmentRequestRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.UnifiedRoleAssignmentRequestRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public UnifiedRoleAssignmentScheduleWithReferenceRequestBuilder targetSchedule() {
     ...
     */
    @Nonnull
    public UnifiedRoleAssignmentRequestCancelRequestBuilder cancel() {
