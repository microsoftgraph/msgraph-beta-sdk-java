...
public class Office365ActiveUserDetailRequest extends BaseRequest<Office365ActiveUserDetail> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Office365ActiveUserDetail> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Office365ActiveUserDetail> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Office365ActiveUserDetail> patchAsync(@Nonnull final Office365ActiveUserDetail sourceOffice365ActiveUserDetail) {
        return sendAsync(HttpMethod.PATCH, sourceOffice365ActiveUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Office365ActiveUserDetail> postAsync(@Nonnull final Office365ActiveUserDetail newOffice365ActiveUserDetail) {
        return sendAsync(HttpMethod.POST, newOffice365ActiveUserDetail);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Office365ActiveUserDetail> putAsync(@Nonnull final Office365ActiveUserDetail newOffice365ActiveUserDetail) {
        return sendAsync(HttpMethod.PUT, newOffice365ActiveUserDetail);
    }
