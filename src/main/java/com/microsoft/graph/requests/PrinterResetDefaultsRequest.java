...
import com.microsoft.graph.requests.PrinterResetDefaultsRequest;
...
public class PrinterResetDefaultsRequest extends BaseRequest<Void> {
     ...
     */
    public PrinterResetDefaultsRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Void.class);
    }

    /**
     * Creates the PrinterResetDefaults
     *
