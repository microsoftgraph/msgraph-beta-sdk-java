...
public class DeviceManagementConfigurationPolicyAssignmentRequest extends BaseRequest<DeviceManagementConfigurationPolicyAssignment> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyAssignment> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyAssignment> deleteAsync() {
     ...
     */
    @Nullable
    public DeviceManagementConfigurationPolicyAssignment delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyAssignment> patchAsync(@Nonnull final DeviceManagementConfigurationPolicyAssignment sourceDeviceManagementConfigurationPolicyAssignment) {
        return sendAsync(HttpMethod.PATCH, sourceDeviceManagementConfigurationPolicyAssignment);
    }
    ...
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyAssignment> postAsync(@Nonnull final DeviceManagementConfigurationPolicyAssignment newDeviceManagementConfigurationPolicyAssignment) {
        return sendAsync(HttpMethod.POST, newDeviceManagementConfigurationPolicyAssignment);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementConfigurationPolicyAssignment> putAsync(@Nonnull final DeviceManagementConfigurationPolicyAssignment newDeviceManagementConfigurationPolicyAssignment) {
        return sendAsync(HttpMethod.PUT, newDeviceManagementConfigurationPolicyAssignment);
    }
