...
public class DeviceCompliancePolicyGroupAssignmentRequestBuilder extends BaseRequestBuilder<DeviceCompliancePolicyGroupAssignment> {
    ...
    public DeviceCompliancePolicyGroupAssignmentRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.DeviceCompliancePolicyGroupAssignmentRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.DeviceCompliancePolicyWithReferenceRequestBuilder deviceCompliancePolicy() {
        return new com.microsoft.graph.requests.DeviceCompliancePolicyWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("deviceCompliancePolicy"), getClient(), null);
    }
}
