...
public class ManagementConditionStatementRequest extends BaseRequest<ManagementConditionStatement> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ManagementConditionStatement> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ManagementConditionStatement> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ManagementConditionStatement> patchAsync(@Nonnull final ManagementConditionStatement sourceManagementConditionStatement) {
        return sendAsync(HttpMethod.PATCH, sourceManagementConditionStatement);
    }
    ...
    public java.util.concurrent.CompletableFuture<ManagementConditionStatement> postAsync(@Nonnull final ManagementConditionStatement newManagementConditionStatement) {
        return sendAsync(HttpMethod.POST, newManagementConditionStatement);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ManagementConditionStatement> putAsync(@Nonnull final ManagementConditionStatement newManagementConditionStatement) {
        return sendAsync(HttpMethod.PUT, newManagementConditionStatement);
    }
