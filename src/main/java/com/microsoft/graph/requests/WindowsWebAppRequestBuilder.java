...
/**
 * The class for the Windows Web App Request Builder.
 */
public class WindowsWebAppRequestBuilder extends BaseRequestBuilder<WindowsWebApp> {

    /**
     * The request builder for the WindowsWebApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsWebAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsWebAppRequest instance
     */
    @Nonnull
    public WindowsWebAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsWebAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsWebAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
