 ...
 */
public class AndroidCertificateProfileBaseReferenceRequest extends BaseReferenceRequest<AndroidCertificateProfileBase> {
     ...
     */
    public AndroidCertificateProfileBaseReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseReferenceRequest expand(@Nonnull final String value) {
