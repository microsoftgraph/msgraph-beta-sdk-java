...
/**
 * The class for the Mac OSWeb Clip Request Builder.
 */
public class MacOSWebClipRequestBuilder extends BaseRequestBuilder<MacOSWebClip> {

    /**
     * The request builder for the MacOSWebClip
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MacOSWebClipRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the MacOSWebClipRequest instance
     */
    @Nonnull
    public MacOSWebClipRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public MacOSWebClipRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.MacOSWebClipRequest(getRequestUrl(), getClient(), requestOptions);
    }
