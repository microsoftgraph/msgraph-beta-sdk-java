...
import com.microsoft.graph.requests.MultiTenantOrganizationMemberRequestBuilder;
...
/**
 * The class for the Multi Tenant Organization Member Collection Request Builder.
 */
public class MultiTenantOrganizationMemberCollectionRequestBuilder extends BaseCollectionRequestBuilder<MultiTenantOrganizationMember, MultiTenantOrganizationMemberRequestBuilder, MultiTenantOrganizationMemberCollectionResponse, MultiTenantOrganizationMemberCollectionPage, MultiTenantOrganizationMemberCollectionRequest> {

    /**
     * The request builder for this collection of MultiTenantOrganization
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public MultiTenantOrganizationMemberCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, MultiTenantOrganizationMemberRequestBuilder.class, MultiTenantOrganizationMemberCollectionRequest.class);
    }
