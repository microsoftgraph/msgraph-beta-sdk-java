 ...
 */
public class AndroidCertificateProfileBaseWithReferenceRequest extends BaseWithReferenceRequest<AndroidCertificateProfileBase> {
     ...
     */
    public AndroidCertificateProfileBaseWithReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseWithReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public AndroidCertificateProfileBaseWithReferenceRequest expand(@Nonnull final String value) {
