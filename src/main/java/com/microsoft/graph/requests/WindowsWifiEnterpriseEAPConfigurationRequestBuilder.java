...
public class WindowsWifiEnterpriseEAPConfigurationRequestBuilder extends BaseRequestBuilder<WindowsWifiEnterpriseEAPConfiguration> {
    ...
    public WindowsWifiEnterpriseEAPConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsWifiEnterpriseEAPConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.Windows81TrustedRootCertificateCollectionRequestBuilder rootCertificatesForServerValidation() {
        return new com.microsoft.graph.requests.Windows81TrustedRootCertificateCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.Windows81TrustedRootCertificateRequestBuilder rootCertificatesForServerValidation(@Nonnull final String id) {
        return new com.microsoft.graph.requests.Windows81TrustedRootCertificateRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificatesForServerValidation") + "/" + id, getClient(), null);
    }
