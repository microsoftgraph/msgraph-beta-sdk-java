...
/**
 * The class for the Outbound Shared User Profile Collection Request Builder.
 */
public class OutboundSharedUserProfileCollectionRequestBuilder extends BaseCollectionRequestBuilder<OutboundSharedUserProfile, OutboundSharedUserProfileRequestBuilder, OutboundSharedUserProfileCollectionResponse, OutboundSharedUserProfileCollectionPage, OutboundSharedUserProfileCollectionRequest> {
     ...
     */
    public OutboundSharedUserProfileCollectionRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, OutboundSharedUserProfileRequestBuilder.class, OutboundSharedUserProfileCollectionRequest.class);
    }
