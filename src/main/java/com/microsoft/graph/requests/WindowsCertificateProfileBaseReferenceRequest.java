 ...
 */
public class WindowsCertificateProfileBaseReferenceRequest extends BaseReferenceRequest<WindowsCertificateProfileBase> {
     ...
     */
    public WindowsCertificateProfileBaseReferenceRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    @Nonnull
    public WindowsCertificateProfileBaseReferenceRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public WindowsCertificateProfileBaseReferenceRequest expand(@Nonnull final String value) {
