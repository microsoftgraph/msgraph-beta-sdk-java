...
public class UserExperienceAnalyticsMetricHistoryRequest extends BaseRequest<UserExperienceAnalyticsMetricHistory> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsMetricHistory> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsMetricHistory> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsMetricHistory> patchAsync(@Nonnull final UserExperienceAnalyticsMetricHistory sourceUserExperienceAnalyticsMetricHistory) {
        return sendAsync(HttpMethod.PATCH, sourceUserExperienceAnalyticsMetricHistory);
    }
    ...
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsMetricHistory> postAsync(@Nonnull final UserExperienceAnalyticsMetricHistory newUserExperienceAnalyticsMetricHistory) {
        return sendAsync(HttpMethod.POST, newUserExperienceAnalyticsMetricHistory);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<UserExperienceAnalyticsMetricHistory> putAsync(@Nonnull final UserExperienceAnalyticsMetricHistory newUserExperienceAnalyticsMetricHistory) {
        return sendAsync(HttpMethod.PUT, newUserExperienceAnalyticsMetricHistory);
    }
