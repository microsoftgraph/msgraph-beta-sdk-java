...
public class CloudPcReportsGetSharedUseLicenseUsageReportRequest extends BaseRequest<java.io.InputStream> {
     ...
     */
    public CloudPcReportsGetSharedUseLicenseUsageReportRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, java.io.InputStream.class);
    }

	/** The body for the method */
    @Nullable
    public CloudPcReportsGetSharedUseLicenseUsageReportParameterSet body;
    /**
     ...
     */
    @Nonnull
    public CloudPcReportsGetSharedUseLicenseUsageReportRequest select(@Nonnull final String value) {
     ...
     */
    @Nonnull
    public CloudPcReportsGetSharedUseLicenseUsageReportRequest expand(@Nonnull final String value) {
