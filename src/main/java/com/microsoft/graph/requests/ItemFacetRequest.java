...
public class ItemFacetRequest extends BaseRequest<ItemFacet> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ItemFacet> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ItemFacet> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ItemFacet> patchAsync(@Nonnull final ItemFacet sourceItemFacet) {
        return sendAsync(HttpMethod.PATCH, sourceItemFacet);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ItemFacet> postAsync(@Nonnull final ItemFacet newItemFacet) {
        return sendAsync(HttpMethod.POST, newItemFacet);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<ItemFacet> putAsync(@Nonnull final ItemFacet newItemFacet) {
        return sendAsync(HttpMethod.PUT, newItemFacet);
    }
