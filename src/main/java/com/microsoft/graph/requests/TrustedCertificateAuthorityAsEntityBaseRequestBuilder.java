...
/**
 * The class for the Trusted Certificate Authority As Entity Base Request Builder.
 */
public class TrustedCertificateAuthorityAsEntityBaseRequestBuilder extends BaseRequestBuilder<TrustedCertificateAuthorityAsEntityBase> {

    /**
     * The request builder for the TrustedCertificateAuthorityAsEntityBase
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public TrustedCertificateAuthorityAsEntityBaseRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the TrustedCertificateAuthorityAsEntityBaseRequest instance
     */
    @Nonnull
    public TrustedCertificateAuthorityAsEntityBaseRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public TrustedCertificateAuthorityAsEntityBaseRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.TrustedCertificateAuthorityAsEntityBaseRequest(getRequestUrl(), getClient(), requestOptions);
    }
