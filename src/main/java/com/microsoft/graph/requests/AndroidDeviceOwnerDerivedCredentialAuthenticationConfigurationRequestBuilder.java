 ...
 */
public class AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequestBuilder extends BaseRequestBuilder<AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration> {
     ...
     */
    public AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequest instance
     */
    @Nonnull
    public AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidDeviceOwnerDerivedCredentialAuthenticationConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
