...
/**
 * The class for the Aosp Device Owner Device Configuration Request Builder.
 */
public class AospDeviceOwnerDeviceConfigurationRequestBuilder extends BaseRequestBuilder<AospDeviceOwnerDeviceConfiguration> {

    /**
     * The request builder for the AospDeviceOwnerDeviceConfiguration
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public AospDeviceOwnerDeviceConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AospDeviceOwnerDeviceConfigurationRequest instance
     */
    @Nonnull
    public AospDeviceOwnerDeviceConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AospDeviceOwnerDeviceConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AospDeviceOwnerDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
