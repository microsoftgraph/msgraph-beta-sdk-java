...
/**
 * The class for the Windows Certificate Profile Base Reference Request Builder.
 */
public class WindowsCertificateProfileBaseReferenceRequestBuilder extends BaseReferenceRequestBuilder<WindowsCertificateProfileBase, WindowsCertificateProfileBaseReferenceRequest> {
     ...
     */
    public WindowsCertificateProfileBaseReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsCertificateProfileBaseReferenceRequest.class);
    }
}
