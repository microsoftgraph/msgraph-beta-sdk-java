...
/**
 * The class for the Federated Token Validation Policy Request Builder.
 */
public class FederatedTokenValidationPolicyRequestBuilder extends BaseRequestBuilder<FederatedTokenValidationPolicy> {

    /**
     * The request builder for the FederatedTokenValidationPolicy
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public FederatedTokenValidationPolicyRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the FederatedTokenValidationPolicyRequest instance
     */
    @Nonnull
    public FederatedTokenValidationPolicyRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public FederatedTokenValidationPolicyRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.FederatedTokenValidationPolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
