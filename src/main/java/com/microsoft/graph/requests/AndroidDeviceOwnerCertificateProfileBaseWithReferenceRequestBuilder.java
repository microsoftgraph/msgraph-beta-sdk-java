 ...
 */
public class AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<AndroidDeviceOwnerCertificateProfileBase, AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequest, AndroidDeviceOwnerCertificateProfileBaseReferenceRequestBuilder> {
     ...
     */
    public AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, AndroidDeviceOwnerCertificateProfileBaseWithReferenceRequest.class, AndroidDeviceOwnerCertificateProfileBaseReferenceRequestBuilder.class);
    }
}
