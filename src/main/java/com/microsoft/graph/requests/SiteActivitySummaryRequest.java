...
public class SiteActivitySummaryRequest extends BaseRequest<SiteActivitySummary> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SiteActivitySummary> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SiteActivitySummary> deleteAsync() {
     ...
     */
    @Nullable
    public SiteActivitySummary delete() throws ClientException {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SiteActivitySummary> patchAsync(@Nonnull final SiteActivitySummary sourceSiteActivitySummary) {
        return sendAsync(HttpMethod.PATCH, sourceSiteActivitySummary);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SiteActivitySummary> postAsync(@Nonnull final SiteActivitySummary newSiteActivitySummary) {
        return sendAsync(HttpMethod.POST, newSiteActivitySummary);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<SiteActivitySummary> putAsync(@Nonnull final SiteActivitySummary newSiteActivitySummary) {
        return sendAsync(HttpMethod.PUT, newSiteActivitySummary);
    }
