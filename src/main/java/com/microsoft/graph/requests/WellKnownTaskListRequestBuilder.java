...
/**
 * The class for the Well Known Task List Request Builder.
 */
public class WellKnownTaskListRequestBuilder extends BaseRequestBuilder<WellKnownTaskList> {

    /**
     * The request builder for the WellKnownTaskList
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WellKnownTaskListRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WellKnownTaskListRequest instance
     */
    @Nonnull
    public WellKnownTaskListRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WellKnownTaskListRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WellKnownTaskListRequest(getRequestUrl(), getClient(), requestOptions);
    }
