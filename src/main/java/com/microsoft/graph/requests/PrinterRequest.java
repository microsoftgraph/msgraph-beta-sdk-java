...
public class PrinterRequest extends BaseRequest<Printer> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Printer> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Printer> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Printer> patchAsync(@Nonnull final Printer sourcePrinter) {
        return sendAsync(HttpMethod.PATCH, sourcePrinter);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Printer> postAsync(@Nonnull final Printer newPrinter) {
        return sendAsync(HttpMethod.POST, newPrinter);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<Printer> putAsync(@Nonnull final Printer newPrinter) {
        return sendAsync(HttpMethod.PUT, newPrinter);
    }
