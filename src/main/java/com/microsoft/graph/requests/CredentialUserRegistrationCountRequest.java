...
public class CredentialUserRegistrationCountRequest extends BaseRequest<CredentialUserRegistrationCount> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<CredentialUserRegistrationCount> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<CredentialUserRegistrationCount> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<CredentialUserRegistrationCount> patchAsync(@Nonnull final CredentialUserRegistrationCount sourceCredentialUserRegistrationCount) {
        return sendAsync(HttpMethod.PATCH, sourceCredentialUserRegistrationCount);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<CredentialUserRegistrationCount> postAsync(@Nonnull final CredentialUserRegistrationCount newCredentialUserRegistrationCount) {
        return sendAsync(HttpMethod.POST, newCredentialUserRegistrationCount);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<CredentialUserRegistrationCount> putAsync(@Nonnull final CredentialUserRegistrationCount newCredentialUserRegistrationCount) {
        return sendAsync(HttpMethod.PUT, newCredentialUserRegistrationCount);
    }
