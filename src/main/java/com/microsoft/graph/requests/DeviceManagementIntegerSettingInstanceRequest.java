...
public class DeviceManagementIntegerSettingInstanceRequest extends BaseRequest<DeviceManagementIntegerSettingInstance> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntegerSettingInstance> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntegerSettingInstance> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntegerSettingInstance> patchAsync(@Nonnull final DeviceManagementIntegerSettingInstance sourceDeviceManagementIntegerSettingInstance) {
        return sendAsync(HttpMethod.PATCH, sourceDeviceManagementIntegerSettingInstance);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntegerSettingInstance> postAsync(@Nonnull final DeviceManagementIntegerSettingInstance newDeviceManagementIntegerSettingInstance) {
        return sendAsync(HttpMethod.POST, newDeviceManagementIntegerSettingInstance);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementIntegerSettingInstance> putAsync(@Nonnull final DeviceManagementIntegerSettingInstance newDeviceManagementIntegerSettingInstance) {
        return sendAsync(HttpMethod.PUT, newDeviceManagementIntegerSettingInstance);
    }
