...
public class IosDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder<IosDeviceFeaturesConfiguration> {
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder singleSignOnExtensionPkinitCertificate() {
        return new com.microsoft.graph.requests.IosCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("singleSignOnExtensionPkinitCertificate"), getClient(), null);
    }
