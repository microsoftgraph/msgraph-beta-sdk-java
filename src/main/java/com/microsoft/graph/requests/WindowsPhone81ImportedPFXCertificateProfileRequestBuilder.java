 ...
 */
public class WindowsPhone81ImportedPFXCertificateProfileRequestBuilder extends BaseRequestBuilder<WindowsPhone81ImportedPFXCertificateProfile> {
     ...
     */
    public WindowsPhone81ImportedPFXCertificateProfileRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsPhone81ImportedPFXCertificateProfileRequest instance
     */
    @Nonnull
    public WindowsPhone81ImportedPFXCertificateProfileRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsPhone81ImportedPFXCertificateProfileRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsPhone81ImportedPFXCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
