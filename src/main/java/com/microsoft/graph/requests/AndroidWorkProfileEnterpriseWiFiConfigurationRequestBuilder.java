 ...
 */
public class AndroidWorkProfileEnterpriseWiFiConfigurationRequestBuilder extends BaseRequestBuilder<AndroidWorkProfileEnterpriseWiFiConfiguration> {
     ...
     */
    public AndroidWorkProfileEnterpriseWiFiConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the AndroidWorkProfileEnterpriseWiFiConfigurationRequest instance
     */
    @Nonnull
    public AndroidWorkProfileEnterpriseWiFiConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public AndroidWorkProfileEnterpriseWiFiConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.AndroidWorkProfileEnterpriseWiFiConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder identityCertificateForClientAuthentication() {
        return new com.microsoft.graph.requests.AndroidWorkProfileCertificateProfileBaseWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("identityCertificateForClientAuthentication"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.AndroidWorkProfileTrustedRootCertificateWithReferenceRequestBuilder rootCertificateForServerValidation() {
        return new com.microsoft.graph.requests.AndroidWorkProfileTrustedRootCertificateWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("rootCertificateForServerValidation"), getClient(), null);
    }
