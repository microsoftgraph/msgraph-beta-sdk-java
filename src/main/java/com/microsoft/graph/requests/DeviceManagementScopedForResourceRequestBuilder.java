...
public class DeviceManagementScopedForResourceRequestBuilder extends BaseFunctionRequestBuilder<Boolean> {
     ...
     */
    public DeviceManagementScopedForResourceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public DeviceManagementScopedForResourceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        final DeviceManagementScopedForResourceRequest request = new DeviceManagementScopedForResourceRequest(
                getRequestUrl(),
                getClient(),
                requestOptions);
