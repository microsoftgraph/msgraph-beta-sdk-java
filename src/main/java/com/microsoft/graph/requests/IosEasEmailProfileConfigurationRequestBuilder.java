 ...
 */
public class IosEasEmailProfileConfigurationRequestBuilder extends BaseRequestBuilder<IosEasEmailProfileConfiguration> {
     ...
     */
    public IosEasEmailProfileConfigurationRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the IosEasEmailProfileConfigurationRequest instance
     */
    @Nonnull
    public IosEasEmailProfileConfigurationRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public IosEasEmailProfileConfigurationRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.IosEasEmailProfileConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     *
     * @return the IosCertificateProfileWithReferenceRequestBuilder instance
     */
    @Nonnull
    public com.microsoft.graph.requests.IosCertificateProfileWithReferenceRequestBuilder smimeEncryptionCertificate() {
        return new com.microsoft.graph.requests.IosCertificateProfileWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("smimeEncryptionCertificate"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph.requests.IosCertificateProfileWithReferenceRequestBuilder smimeSigningCertificate() {
        return new com.microsoft.graph.requests.IosCertificateProfileWithReferenceRequestBuilder(getRequestUrlWithAdditionalSegment("smimeSigningCertificate"), getClient(), null);
    }
