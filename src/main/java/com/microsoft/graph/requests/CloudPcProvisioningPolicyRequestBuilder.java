...
public class CloudPcProvisioningPolicyRequestBuilder extends BaseRequestBuilder<CloudPcProvisioningPolicy> {
    ...
    @Deprecated
    @Nonnull
    public CloudPcProvisioningPolicyApplyRequestBuilder apply(@Nonnull final CloudPcProvisioningPolicyApplyParameterSet parameters) {
        return new CloudPcProvisioningPolicyApplyRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.apply"), getClient(), null, parameters);
    }
