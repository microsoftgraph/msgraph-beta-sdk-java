 ...
 */
public class WindowsCertificateProfileBaseWithReferenceRequestBuilder extends BaseWithReferenceRequestBuilder<WindowsCertificateProfileBase, WindowsCertificateProfileBaseWithReferenceRequest, WindowsCertificateProfileBaseReferenceRequestBuilder> {
     ...
     */
    public WindowsCertificateProfileBaseWithReferenceRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, WindowsCertificateProfileBaseWithReferenceRequest.class, WindowsCertificateProfileBaseReferenceRequestBuilder.class);
    }
}
