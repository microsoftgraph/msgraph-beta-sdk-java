...
public class Windows10GeneralConfigurationRequestBuilder extends BaseRequestBuilder<Windows10GeneralConfiguration> {
    ...
    /**
     *  Gets a request builder for the WindowsPrivacyDataAccessControlItem collection
     *
     * @return the collection request builder
     */
    @Nonnull
    public com.microsoft.graph.requests.WindowsPrivacyDataAccessControlItemCollectionRequestBuilder privacyAccessControls() {
        return new com.microsoft.graph.requests.WindowsPrivacyDataAccessControlItemCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("privacyAccessControls"), getClient(), null);
    }

    /**
     * Gets a request builder for the WindowsPrivacyDataAccessControlItem item
     *
     * @return the request builder
     * @param id the item identifier
     */
    @Nonnull
    public com.microsoft.graph.requests.WindowsPrivacyDataAccessControlItemRequestBuilder privacyAccessControls(@Nonnull final String id) {
        return new com.microsoft.graph.requests.WindowsPrivacyDataAccessControlItemRequestBuilder(getRequestUrlWithAdditionalSegment("privacyAccessControls") + "/" + id, getClient(), null);
    }
