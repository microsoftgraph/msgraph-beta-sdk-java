...
public class InformationProtectionPolicyRequest extends BaseRequest<InformationProtectionPolicy> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> patchAsync(@Nonnull final InformationProtectionPolicy sourceInformationProtectionPolicy) {
        return sendAsync(HttpMethod.PATCH, sourceInformationProtectionPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> postAsync(@Nonnull final InformationProtectionPolicy newInformationProtectionPolicy) {
        return sendAsync(HttpMethod.POST, newInformationProtectionPolicy);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<InformationProtectionPolicy> putAsync(@Nonnull final InformationProtectionPolicy newInformationProtectionPolicy) {
        return sendAsync(HttpMethod.PUT, newInformationProtectionPolicy);
    }
