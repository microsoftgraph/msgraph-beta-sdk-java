...
/**
 * The class for the Windows Store App Request Builder.
 */
public class WindowsStoreAppRequestBuilder extends BaseRequestBuilder<WindowsStoreApp> {

    /**
     * The request builder for the WindowsStoreApp
     *
     * @param requestUrl     the request URL
     * @param client         the service client
     * @param requestOptions the options for this request
     */
    public WindowsStoreAppRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the WindowsStoreAppRequest instance
     */
    @Nonnull
    public WindowsStoreAppRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public WindowsStoreAppRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.WindowsStoreAppRequest(getRequestUrl(), getClient(), requestOptions);
    }
