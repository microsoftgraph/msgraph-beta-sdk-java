...
public class DeviceManagementScriptDeviceStateRequest extends BaseRequest<DeviceManagementScriptDeviceState> {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceState> getAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceState> deleteAsync() {
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceState> patchAsync(@Nonnull final DeviceManagementScriptDeviceState sourceDeviceManagementScriptDeviceState) {
        return sendAsync(HttpMethod.PATCH, sourceDeviceManagementScriptDeviceState);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceState> postAsync(@Nonnull final DeviceManagementScriptDeviceState newDeviceManagementScriptDeviceState) {
        return sendAsync(HttpMethod.POST, newDeviceManagementScriptDeviceState);
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.CompletableFuture<DeviceManagementScriptDeviceState> putAsync(@Nonnull final DeviceManagementScriptDeviceState newDeviceManagementScriptDeviceState) {
        return sendAsync(HttpMethod.PUT, newDeviceManagementScriptDeviceState);
    }
