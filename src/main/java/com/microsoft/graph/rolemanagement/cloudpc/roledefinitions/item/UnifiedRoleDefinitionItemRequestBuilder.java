package microsoft.graph.rolemanagement.cloudpc.roledefinitions.item;
...
import microsoft.graph.rolemanagement.cloudpc.roledefinitions.item.assignedprincipalswithtransitivewithdirectoryscopetypewithdirectoryscopeid.AssignedPrincipalsWithTransitiveWithDirectoryScopeTypeWithDirectoryScopeIdRequestBuilder;
import microsoft.graph.rolemanagement.cloudpc.roledefinitions.item.inheritspermissionsfrom.InheritsPermissionsFromRequestBuilder;
...
public class UnifiedRoleDefinitionItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.roleManagement.cloudPC.roleDefinitions.item.inheritsPermissionsFrom.item collection
