package com.microsoft.graph.rolemanagement.exchange.roleassignments.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRoleAssignment;
import com.microsoft.graph.rolemanagement.exchange.roleassignments.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.roleassignments.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.roleassignments.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.roleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
...
public class UnifiedRoleAssignmentItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UnifiedRoleAssignmentItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UnifiedRoleAssignmentItemRequestBuilder and sets the default values.
    ...
    public UnifiedRoleAssignmentItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
