package com.microsoft.graph.rolemanagement.exchange.resourcenamespaces.item.resourceactions.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRbacResourceAction;
import com.microsoft.graph.rolemanagement.exchange.resourcenamespaces.item.resourceactions.item.authenticationcontext.AuthenticationContextRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.resourcenamespaces.item.resourceactions.item.resourcescope.ResourceScopeRequestBuilder;
...
public class UnifiedRbacResourceActionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public UnifiedRbacResourceActionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new UnifiedRbacResourceActionItemRequestBuilder and sets the default values.
    ...
    public UnifiedRbacResourceActionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
