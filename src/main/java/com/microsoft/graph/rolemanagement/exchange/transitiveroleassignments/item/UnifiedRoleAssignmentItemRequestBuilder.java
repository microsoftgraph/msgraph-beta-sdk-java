package com.microsoft.graph.rolemanagement.exchange.transitiveroleassignments.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRoleAssignment;
import com.microsoft.graph.rolemanagement.exchange.transitiveroleassignments.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.transitiveroleassignments.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.transitiveroleassignments.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.rolemanagement.exchange.transitiveroleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
