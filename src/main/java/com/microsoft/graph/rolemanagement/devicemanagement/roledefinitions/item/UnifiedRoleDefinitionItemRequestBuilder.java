package microsoft.graph.rolemanagement.devicemanagement.roledefinitions.item;
...
import microsoft.graph.rolemanagement.devicemanagement.roledefinitions.item.assignedprincipalswithtransitivewithdirectoryscopetypewithdirectoryscopeid.AssignedPrincipalsWithTransitiveWithDirectoryScopeTypeWithDirectoryScopeIdRequestBuilder;
import microsoft.graph.rolemanagement.devicemanagement.roledefinitions.item.inheritspermissionsfrom.InheritsPermissionsFromRequestBuilder;
...
public class UnifiedRoleDefinitionItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.roleManagement.deviceManagement.roleDefinitions.item.inheritsPermissionsFrom.item collection
