...
public class RoleAssignmentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UnifiedRoleAssignmentMultiple body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultipleCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultipleCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultipleCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultiple> post(@javax.annotation.Nonnull final UnifiedRoleAssignmentMultiple body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultiple> executionException = new java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentMultiple>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
