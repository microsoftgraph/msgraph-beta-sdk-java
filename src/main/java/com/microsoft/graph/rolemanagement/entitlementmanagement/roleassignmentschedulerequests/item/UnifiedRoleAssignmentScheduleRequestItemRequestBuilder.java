...
public class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRoleAssignmentScheduleRequest
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentScheduleRequest> patch(@javax.annotation.Nonnull final UnifiedRoleAssignmentScheduleRequest body) {
        try {
     ...
     * @return a CompletableFuture of unifiedRoleAssignmentScheduleRequest
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleAssignmentScheduleRequest> patch(@javax.annotation.Nonnull final UnifiedRoleAssignmentScheduleRequest body, @javax.annotation.Nullable final java.util.function.Consumer<UnifiedRoleAssignmentScheduleRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
