package microsoft.graph.rolemanagement.entitlementmanagement.roleassignments.item;
...
import microsoft.graph.rolemanagement.entitlementmanagement.roleassignments.item.appscope.AppScopeRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.roleassignments.item.directoryscope.DirectoryScopeRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.roleassignments.item.principal.PrincipalRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.roleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
