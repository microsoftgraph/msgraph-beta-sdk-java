...
public class UnifiedRbacResourceActionItemRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRbacResourceAction
     */
    public java.util.concurrent.CompletableFuture<UnifiedRbacResourceAction> patch(@javax.annotation.Nonnull final UnifiedRbacResourceAction body, @javax.annotation.Nullable final java.util.function.Consumer<UnifiedRbacResourceActionItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
