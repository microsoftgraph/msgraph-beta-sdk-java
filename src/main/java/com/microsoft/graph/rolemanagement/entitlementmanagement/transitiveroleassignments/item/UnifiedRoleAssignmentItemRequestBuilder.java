package microsoft.graph.rolemanagement.entitlementmanagement.transitiveroleassignments.item;
...
import microsoft.graph.rolemanagement.entitlementmanagement.transitiveroleassignments.item.appscope.AppScopeRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.transitiveroleassignments.item.directoryscope.DirectoryScopeRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.transitiveroleassignments.item.principal.PrincipalRequestBuilder;
import microsoft.graph.rolemanagement.entitlementmanagement.transitiveroleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
