package com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRoleAssignmentScheduleInstance;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item.activatedusing.ActivatedUsingRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentscheduleinstances.item.roledefinition.RoleDefinitionRequestBuilder;
