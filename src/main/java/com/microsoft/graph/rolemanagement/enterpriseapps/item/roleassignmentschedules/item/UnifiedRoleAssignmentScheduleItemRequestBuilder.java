package com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRoleAssignmentSchedule;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item.activatedusing.ActivatedUsingRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleassignmentschedules.item.roledefinition.RoleDefinitionRequestBuilder;
