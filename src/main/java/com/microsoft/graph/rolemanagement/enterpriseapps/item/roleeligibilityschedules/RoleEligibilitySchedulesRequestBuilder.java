package com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityschedules;
...
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityschedules.count.CountRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityschedules.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityschedules.item.UnifiedRoleEligibilityScheduleItemRequestBuilder;
...
public class RoleEligibilitySchedulesRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleEligibilitySchedulesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RoleEligibilitySchedulesRequestBuilder and sets the default values.
    ...
    public RoleEligibilitySchedulesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
