package com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityscheduleinstances.item;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.UnifiedRoleEligibilityScheduleInstance;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityscheduleinstances.item.appscope.AppScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityscheduleinstances.item.directoryscope.DirectoryScopeRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityscheduleinstances.item.principal.PrincipalRequestBuilder;
import com.microsoft.graph.rolemanagement.enterpriseapps.item.roleeligibilityscheduleinstances.item.roledefinition.RoleDefinitionRequestBuilder;
