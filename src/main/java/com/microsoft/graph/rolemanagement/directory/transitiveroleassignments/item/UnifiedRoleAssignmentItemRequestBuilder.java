package microsoft.graph.rolemanagement.directory.transitiveroleassignments.item;
...
import microsoft.graph.rolemanagement.directory.transitiveroleassignments.item.appscope.AppScopeRequestBuilder;
import microsoft.graph.rolemanagement.directory.transitiveroleassignments.item.directoryscope.DirectoryScopeRequestBuilder;
import microsoft.graph.rolemanagement.directory.transitiveroleassignments.item.principal.PrincipalRequestBuilder;
import microsoft.graph.rolemanagement.directory.transitiveroleassignments.item.roledefinition.RoleDefinitionRequestBuilder;
