package microsoft.graph.rolemanagement.directory.roleassignmentapprovals.item;
...
import microsoft.graph.rolemanagement.directory.roleassignmentapprovals.item.steps.item.ApprovalStepItemRequestBuilder;
import microsoft.graph.rolemanagement.directory.roleassignmentapprovals.item.steps.StepsRequestBuilder;
...
public class ApprovalItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.roleManagement.directory.roleAssignmentApprovals.item.steps.item collection
