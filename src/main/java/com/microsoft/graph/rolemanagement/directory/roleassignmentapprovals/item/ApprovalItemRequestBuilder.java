...
public class ApprovalItemRequestBuilder {
     ...
     * @return a CompletableFuture of approval
     */
    public java.util.concurrent.CompletableFuture<Approval> patch(@javax.annotation.Nonnull final Approval body, @javax.annotation.Nullable final java.util.function.Consumer<ApprovalItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
