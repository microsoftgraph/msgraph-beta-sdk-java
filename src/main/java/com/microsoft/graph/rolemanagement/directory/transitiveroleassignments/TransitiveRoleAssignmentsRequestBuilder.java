package com.microsoft.graph.rolemanagement.directory.transitiveroleassignments;
...
import com.microsoft.graph.rolemanagement.directory.transitiveroleassignments.count.CountRequestBuilder;
...
public class TransitiveRoleAssignmentsRequestBuilder {
    ...
    public TransitiveRoleAssignmentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
