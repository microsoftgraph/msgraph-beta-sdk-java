...
public class WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBody body) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBody body) {
        try {
