...
public class WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder extends BaseRequestBuilder {
    ...
    public WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/wipeManagedAppRegistrationsByAzureAdDeviceId", pathParameters);
    }
    /**
     * Instantiates a new WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder and sets the default values.
    ...
    public WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/wipeManagedAppRegistrationsByAzureAdDeviceId", rawUrl);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final WipeManagedAppRegistrationsByAzureAdDeviceIdPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WipeManagedAppRegistrationsByAzureAdDeviceIdPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final WipeManagedAppRegistrationsByAzureAdDeviceIdPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
