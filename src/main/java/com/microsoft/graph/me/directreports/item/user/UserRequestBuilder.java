...
import microsoft.graph.me.directreports.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
...
import microsoft.graph.me.directreports.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.me.directreports.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
...
import microsoft.graph.me.directreports.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.me.directreports.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.me.directreports.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.me.directreports.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.me.directreports.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
...
import microsoft.graph.me.directreports.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.me.directreports.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
...
import microsoft.graph.me.directreports.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.me.directreports.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
...
import microsoft.graph.me.directreports.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.me.directreports.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.me.directreports.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.me.directreports.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
