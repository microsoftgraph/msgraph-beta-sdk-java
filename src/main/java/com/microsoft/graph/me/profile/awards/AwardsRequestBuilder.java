package microsoft.graph.me.profile.awards;
...
import microsoft.graph.me.profile.awards.count.CountRequestBuilder;
...
public class AwardsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PersonAwardCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PersonAwardCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of PersonAwardCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PersonAwardCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<AwardsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PersonAwardCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of personAward
     */
    public java.util.concurrent.CompletableFuture<PersonAward> post(@javax.annotation.Nonnull final PersonAward body, @javax.annotation.Nullable final java.util.function.Consumer<AwardsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
