...
public class PatentsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the patents property of the microsoft.graph.profile entity.
     * @param itemPatentId Unique identifier of the item
     * @return a ItemPatentItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public ItemPatentItemRequestBuilder byItemPatentId(@javax.annotation.Nonnull final String itemPatentId) {
    ...
    public PatentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/profile/patents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PatentsRequestBuilder and sets the default values.
    ...
    public PatentsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/profile/patents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ItemPatent> post(@javax.annotation.Nonnull final ItemPatent body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ItemPatent> executionException = new java.util.concurrent.CompletableFuture<ItemPatent>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemPatent body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ItemPatent body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
