...
public class PatentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ItemPatentCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<ItemPatent> post(@javax.annotation.Nonnull final ItemPatent body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<ItemPatent> executionException = new java.util.concurrent.CompletableFuture<ItemPatent>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
