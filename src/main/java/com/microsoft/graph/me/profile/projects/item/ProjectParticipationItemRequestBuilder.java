...
public class ProjectParticipationItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ProjectParticipationItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ProjectParticipationItemRequestBuilder and sets the default values.
    ...
    public ProjectParticipationItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ProjectParticipation body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final ProjectParticipation body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
