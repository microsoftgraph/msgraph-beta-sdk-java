...
public class ExtractContentLabelRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a extractContentLabelRequestBody
     */
    @javax.annotation.Nonnull
    public static ExtractContentLabelRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExtractContentLabelRequestBody currentObject = this;
