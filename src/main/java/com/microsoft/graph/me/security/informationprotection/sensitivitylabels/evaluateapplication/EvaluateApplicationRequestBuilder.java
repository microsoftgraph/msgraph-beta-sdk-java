...
public class EvaluateApplicationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final EvaluateApplicationPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EvaluateApplicationResponse> post(@javax.annotation.Nonnull final EvaluateApplicationPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<EvaluateApplicationResponse> executionException = new java.util.concurrent.CompletableFuture<EvaluateApplicationResponse>();
