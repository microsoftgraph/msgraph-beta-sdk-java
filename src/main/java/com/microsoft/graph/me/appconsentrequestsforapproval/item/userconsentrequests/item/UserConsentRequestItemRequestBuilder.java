...
public class UserConsentRequestItemRequestBuilder {
     ...
     * @return a CompletableFuture of userConsentRequest
     */
    public java.util.concurrent.CompletableFuture<UserConsentRequest> patch(@javax.annotation.Nonnull final UserConsentRequest body, @javax.annotation.Nullable final java.util.function.Consumer<UserConsentRequestItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
