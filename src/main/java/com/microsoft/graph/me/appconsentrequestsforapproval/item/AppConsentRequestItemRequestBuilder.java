package com.microsoft.graph.me.appconsentrequestsforapproval.item;
...
import com.microsoft.graph.me.appconsentrequestsforapproval.item.userconsentrequests.UserConsentRequestsRequestBuilder;
...
public class AppConsentRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AppConsentRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AppConsentRequestItemRequestBuilder and sets the default values.
    ...
    public AppConsentRequestItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
