package com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item;

import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.attachments.item.AttachmentItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.instances.InstancesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendarview.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.attachments.item collection
    ...
    public EventItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
