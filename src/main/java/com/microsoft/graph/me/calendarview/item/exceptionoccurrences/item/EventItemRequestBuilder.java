package microsoft.graph.me.calendarview.item.exceptionoccurrences.item;
...
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.instances.InstancesRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import microsoft.graph.me.calendarview.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.attachments.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.instances.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendarView.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
