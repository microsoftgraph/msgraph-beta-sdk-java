...
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
import microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
