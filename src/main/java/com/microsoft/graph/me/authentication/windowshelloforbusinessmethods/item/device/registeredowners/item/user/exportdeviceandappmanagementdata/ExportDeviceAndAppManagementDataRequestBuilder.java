package microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredowners.item.user.exportdeviceandappmanagementdata;
...
public class ExportDeviceAndAppManagementDataRequestBuilder {
    ...
    public ExportDeviceAndAppManagementDataRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportDeviceAndAppManagementData()";
