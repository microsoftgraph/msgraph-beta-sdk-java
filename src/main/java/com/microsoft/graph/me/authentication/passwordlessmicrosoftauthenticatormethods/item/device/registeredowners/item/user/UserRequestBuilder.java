package microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user;
...
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredowners.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
...
public class UserRequestBuilder {
    ...
    public UserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
