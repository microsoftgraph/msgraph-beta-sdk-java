package microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item;
...
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.device.DeviceRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.group.GroupRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.item.user.UserRequestBuilder;
