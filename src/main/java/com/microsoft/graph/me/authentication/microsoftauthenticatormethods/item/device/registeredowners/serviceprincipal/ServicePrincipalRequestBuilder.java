package com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.serviceprincipal;

import com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.serviceprincipal.count.CountRequestBuilder;
...
public class ServicePrincipalRequestBuilder {
    ...
    public ServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
