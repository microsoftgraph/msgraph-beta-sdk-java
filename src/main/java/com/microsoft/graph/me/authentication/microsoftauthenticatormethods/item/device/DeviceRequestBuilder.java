package microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device;
...
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.commands.CommandsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.commands.item.CommandItemRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.memberof.MemberOfRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.RegisteredOwnersRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredusers.RegisteredUsersRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.restore.RestoreRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.TransitiveMemberOfRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.usagerights.item.UsageRightItemRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.usagerights.UsageRightsRequestBuilder;
...
public class DeviceRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.authentication.microsoftAuthenticatorMethods.item.device.commands.item collection
    ...
    public microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.memberof.item.DirectoryObjectItemRequestBuilder memberOf(@javax.annotation.Nonnull final String id) {
        ...
        return new microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.memberof.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property device in me
     * @param body 
    ...
    public microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.DirectoryObjectItemRequestBuilder registeredOwners(@javax.annotation.Nonnull final String id) {
        ...
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredusers.item.DirectoryObjectItemRequestBuilder registeredUsers(@javax.annotation.Nonnull final String id) {
        ...
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredusers.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.DirectoryObjectItemRequestBuilder transitiveMemberOf(@javax.annotation.Nonnull final String id) {
        ...
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.transitivememberof.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.authentication.microsoftAuthenticatorMethods.item.device.usageRights.item collection
     * @param id Unique identifier of the item
