package com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof;

import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.device.DeviceRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.group.GroupRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.transitivememberof.user.UserRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder {
    ...
    public TransitiveMemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
