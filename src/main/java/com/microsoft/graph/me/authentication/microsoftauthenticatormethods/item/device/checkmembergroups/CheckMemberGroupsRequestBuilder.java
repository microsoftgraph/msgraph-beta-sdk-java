package com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.checkmembergroups;
...
public class CheckMemberGroupsRequestBuilder {
    ...
    public CheckMemberGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/microsoft.graph.checkMemberGroups";
