package com.microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.usagerights;

import com.microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.usagerights.count.CountRequestBuilder;
...
public class UsageRightsRequestBuilder {
    ...
    public UsageRightsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/usageRights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
