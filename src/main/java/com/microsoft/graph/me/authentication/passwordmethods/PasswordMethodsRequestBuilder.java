...
public class PasswordMethodsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final PasswordAuthenticationMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<PasswordAuthenticationMethodCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<PasswordAuthenticationMethodCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PasswordAuthenticationMethodCollectionResponse>();
