package microsoft.graph.me.authentication.passwordmethods;
...
import microsoft.graph.me.authentication.passwordmethods.count.CountRequestBuilder;
import microsoft.graph.models.odataerrors.ODataError;
import microsoft.graph.models.PasswordAuthenticationMethod;
import microsoft.graph.models.PasswordAuthenticationMethodCollectionResponse;
...
public class PasswordMethodsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PasswordAuthenticationMethodCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PasswordAuthenticationMethodCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of PasswordAuthenticationMethodCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<PasswordAuthenticationMethodCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<PasswordMethodsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, PasswordAuthenticationMethodCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
