package microsoft.graph.me.authentication.windowshelloforbusinessmethods.item.device.registeredusers.item.user.ismanagedappuserblocked;
...
public class IsManagedAppUserBlockedRequestBuilder {
    ...
    public IsManagedAppUserBlockedRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.isManagedAppUserBlocked()";
