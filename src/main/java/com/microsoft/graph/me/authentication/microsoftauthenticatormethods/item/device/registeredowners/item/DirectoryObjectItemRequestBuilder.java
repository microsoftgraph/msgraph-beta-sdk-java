package microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.endpoint.EndpointRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.ref.RefRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.user.UserRequestBuilder;
