package com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item;

import com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.endpoint.EndpointRequestBuilder;
import com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.ref.RefRequestBuilder;
import com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.authentication.microsoftauthenticatormethods.item.device.registeredowners.item.user.UserRequestBuilder;
