package microsoft.graph.me.authentication.passwordlessmicrosoftauthenticatormethods.item.device.registeredusers.item.user.findrooms;
...
public class FindRoomsResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a findRoomsResponse
     */
    @javax.annotation.Nonnull
    public static FindRoomsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final FindRoomsResponse currentObject = this;
