 ...
 */
public class WipeAndBlockManagedAppsRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public WipeAndBlockManagedAppsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/wipeAndBlockManagedApps", pathParameters);
    }
    /**
     * Instantiates a new WipeAndBlockManagedAppsRequestBuilder and sets the default values.
    ...
    public WipeAndBlockManagedAppsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/wipeAndBlockManagedApps", rawUrl);
    }
    /**
