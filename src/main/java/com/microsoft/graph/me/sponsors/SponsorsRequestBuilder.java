package com.microsoft.graph.me.sponsors;

import com.microsoft.graph.me.sponsors.count.CountRequestBuilder;
import com.microsoft.graph.me.sponsors.item.DirectoryObjectItemRequestBuilder;
...
public class SponsorsRequestBuilder extends BaseRequestBuilder {
    ...
    public SponsorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/sponsors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SponsorsRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public SponsorsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/sponsors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
