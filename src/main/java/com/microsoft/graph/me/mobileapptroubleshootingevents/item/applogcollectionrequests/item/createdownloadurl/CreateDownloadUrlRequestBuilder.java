...
public class CreateDownloadUrlRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails> post() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails> executionException = new java.util.concurrent.CompletableFuture<AppLogCollectionDownloadDetails>();
