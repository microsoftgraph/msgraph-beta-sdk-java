...
public class AppLogCollectionRequestsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AppLogCollectionRequestCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppLogCollectionRequestCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AppLogCollectionRequestCollectionResponse>();
