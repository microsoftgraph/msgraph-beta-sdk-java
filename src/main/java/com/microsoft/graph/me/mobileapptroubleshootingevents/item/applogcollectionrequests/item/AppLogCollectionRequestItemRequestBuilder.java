package com.microsoft.graph.me.mobileapptroubleshootingevents.item.applogcollectionrequests.item;

import com.microsoft.graph.me.mobileapptroubleshootingevents.item.applogcollectionrequests.item.createdownloadurl.CreateDownloadUrlRequestBuilder;
...
public class AppLogCollectionRequestItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AppLogCollectionRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AppLogCollectionRequestItemRequestBuilder and sets the default values.
    ...
    public AppLogCollectionRequestItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
