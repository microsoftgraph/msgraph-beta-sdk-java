package microsoft.graph.me.devices.item.registeredusers.item.user.getmanagedappdiagnosticstatuses;
...
public class GetManagedAppDiagnosticStatusesRequestBuilder {
    ...
    public GetManagedAppDiagnosticStatusesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getManagedAppDiagnosticStatuses()";
