package com.microsoft.graph.me.devices.item.memberof;

import com.microsoft.graph.me.devices.item.memberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.count.CountRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.device.DeviceRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.group.GroupRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.user.UserRequestBuilder;
...
public class MemberOfRequestBuilder {
    ...
    public MemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
