package microsoft.graph.me.devices.item.memberof;
...
import microsoft.graph.me.devices.item.memberof.application.ApplicationRequestBuilder;
import microsoft.graph.me.devices.item.memberof.count.CountRequestBuilder;
import microsoft.graph.me.devices.item.memberof.device.DeviceRequestBuilder;
import microsoft.graph.me.devices.item.memberof.group.GroupRequestBuilder;
import microsoft.graph.me.devices.item.memberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.me.devices.item.memberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.devices.item.memberof.user.UserRequestBuilder;
