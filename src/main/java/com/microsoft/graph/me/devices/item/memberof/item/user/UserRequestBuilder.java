package microsoft.graph.me.devices.item.memberof.item.user;
...
import microsoft.graph.me.devices.item.memberof.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.assignlicense.AssignLicenseRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.changepassword.ChangePasswordRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.exportpersonaldata.ExportPersonalDataRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.findmeetingtimes.FindMeetingTimesRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmailtips.GetMailTipsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmanagedappdiagnosticstatuses.GetManagedAppDiagnosticStatusesRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmanagedapppolicies.GetManagedAppPoliciesRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.reminderviewwithstartdatetimewithenddatetime.ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.removealldevicesfrommanagement.RemoveAllDevicesFromManagementRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.reprocesslicenseassignment.ReprocessLicenseAssignmentRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.restore.RestoreRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.revokesigninsessions.RevokeSignInSessionsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.sendmail.SendMailRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.translateexchangeids.TranslateExchangeIdsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.wipemanagedappregistrationsbydevicetag.WipeManagedAppRegistrationsByDeviceTagRequestBuilder;
