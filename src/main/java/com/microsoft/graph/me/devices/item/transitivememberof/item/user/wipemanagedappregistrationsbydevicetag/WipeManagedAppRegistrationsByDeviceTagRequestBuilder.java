package microsoft.graph.me.devices.item.transitivememberof.item.user.wipemanagedappregistrationsbydevicetag;
...
public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
    ...
    public WipeManagedAppRegistrationsByDeviceTagRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.wipeManagedAppRegistrationsByDeviceTag";
