package com.microsoft.graph.me.devices;

import com.microsoft.graph.me.devices.count.CountRequestBuilder;
import com.microsoft.graph.me.devices.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.devices.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.me.devices.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.me.devices.item.DeviceItemRequestBuilder;
import com.microsoft.graph.me.devices.validateproperties.ValidatePropertiesRequestBuilder;
...
public class DevicesRequestBuilder extends BaseRequestBuilder {
    ...
    public DevicesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DevicesRequestBuilder and sets the default values.
    ...
    public DevicesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Get devices from me
