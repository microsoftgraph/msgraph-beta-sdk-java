package microsoft.graph.me.devices.item.transitivememberof;
...
import microsoft.graph.me.devices.item.transitivememberof.application.ApplicationRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.count.CountRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.device.DeviceRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.group.GroupRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.devices.item.transitivememberof.user.UserRequestBuilder;
