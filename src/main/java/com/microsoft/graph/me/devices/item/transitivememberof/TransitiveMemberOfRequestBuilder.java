package com.microsoft.graph.me.devices.item.transitivememberof;

import com.microsoft.graph.me.devices.item.transitivememberof.application.ApplicationRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.count.CountRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.device.DeviceRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.group.GroupRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.user.UserRequestBuilder;
...
public class TransitiveMemberOfRequestBuilder {
    ...
    public TransitiveMemberOfRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
