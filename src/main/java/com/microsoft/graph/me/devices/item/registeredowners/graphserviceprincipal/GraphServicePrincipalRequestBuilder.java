package com.microsoft.graph.me.devices.item.registeredowners.graphserviceprincipal;

import com.microsoft.graph.me.devices.item.registeredowners.graphserviceprincipal.count.CountRequestBuilder;
...
public class GraphServicePrincipalRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphServicePrincipalRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphServicePrincipalRequestBuilder and sets the default values.
    ...
    public GraphServicePrincipalRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredOwners/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
