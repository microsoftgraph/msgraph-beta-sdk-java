package com.microsoft.graph.me.devices.item.transitivememberof.item;

import com.microsoft.graph.me.devices.item.transitivememberof.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.device.DeviceRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.group.GroupRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.user.UserRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}";
