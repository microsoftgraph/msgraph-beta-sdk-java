...
import com.microsoft.graph.me.devices.item.transitivememberof.item.graphadministrativeunit.GraphAdministrativeUnitRequestBuilder;
import com.microsoft.graph.me.devices.item.transitivememberof.item.graphgroup.GraphGroupRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DirectoryObjectItemRequestBuilder and sets the default values.
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
