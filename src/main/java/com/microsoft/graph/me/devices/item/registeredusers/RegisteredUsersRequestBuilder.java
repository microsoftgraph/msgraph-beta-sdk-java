package com.microsoft.graph.me.devices.item.registeredusers;

import com.microsoft.graph.me.devices.item.registeredusers.count.CountRequestBuilder;
import com.microsoft.graph.me.devices.item.registeredusers.graphendpoint.GraphEndpointRequestBuilder;
import com.microsoft.graph.me.devices.item.registeredusers.graphserviceprincipal.GraphServicePrincipalRequestBuilder;
import com.microsoft.graph.me.devices.item.registeredusers.graphuser.GraphUserRequestBuilder;
import com.microsoft.graph.me.devices.item.registeredusers.item.DirectoryObjectItemRequestBuilder;
import com.microsoft.graph.me.devices.item.registeredusers.ref.RefRequestBuilder;
...
public class RegisteredUsersRequestBuilder extends BaseRequestBuilder {
    ...
    public RegisteredUsersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RegisteredUsersRequestBuilder and sets the default values.
    ...
    public RegisteredUsersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
