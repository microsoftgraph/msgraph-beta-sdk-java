package microsoft.graph.me.devices.item.registeredowners.item;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.me.devices.item.registeredowners.item.endpoint.EndpointRequestBuilder;
import microsoft.graph.me.devices.item.registeredowners.item.ref.RefRequestBuilder;
import microsoft.graph.me.devices.item.registeredowners.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.devices.item.registeredowners.item.user.UserRequestBuilder;
