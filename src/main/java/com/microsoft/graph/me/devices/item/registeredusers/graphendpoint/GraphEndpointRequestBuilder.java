package com.microsoft.graph.me.devices.item.registeredusers.graphendpoint;

import com.microsoft.graph.me.devices.item.registeredusers.graphendpoint.count.CountRequestBuilder;
...
public class GraphEndpointRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphEndpointRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphEndpointRequestBuilder and sets the default values.
    ...
    public GraphEndpointRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
