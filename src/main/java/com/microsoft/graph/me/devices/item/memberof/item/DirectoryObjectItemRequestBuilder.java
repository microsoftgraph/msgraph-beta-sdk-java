package com.microsoft.graph.me.devices.item.memberof.item;

import com.microsoft.graph.me.devices.item.memberof.item.application.ApplicationRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.item.device.DeviceRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.item.group.GroupRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.item.orgcontact.OrgContactRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import com.microsoft.graph.me.devices.item.memberof.item.user.UserRequestBuilder;
...
public class DirectoryObjectItemRequestBuilder {
    ...
    public DirectoryObjectItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}{?%24select,%24expand}";
