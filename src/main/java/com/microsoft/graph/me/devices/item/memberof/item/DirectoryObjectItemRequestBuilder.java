package microsoft.graph.me.devices.item.memberof.item;
...
import microsoft.graph.me.devices.item.memberof.item.application.ApplicationRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.device.DeviceRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.group.GroupRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.orgcontact.OrgContactRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.serviceprincipal.ServicePrincipalRequestBuilder;
import microsoft.graph.me.devices.item.memberof.item.user.UserRequestBuilder;
