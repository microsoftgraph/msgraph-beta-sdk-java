package com.microsoft.graph.me.devices.delta;
...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
    private java.util.List<Device> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(Device::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<Device> value) {
        this._value = value;
    }
}
