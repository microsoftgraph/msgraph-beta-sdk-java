package com.microsoft.graph.me.devices.item.registeredusers.graphuser;

import com.microsoft.graph.me.devices.item.registeredusers.graphuser.count.CountRequestBuilder;
...
public class GraphUserRequestBuilder extends BaseRequestBuilder {
    ...
    public GraphUserRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GraphUserRequestBuilder and sets the default values.
    ...
    public GraphUserRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/devices/{device%2Did}/registeredUsers/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
