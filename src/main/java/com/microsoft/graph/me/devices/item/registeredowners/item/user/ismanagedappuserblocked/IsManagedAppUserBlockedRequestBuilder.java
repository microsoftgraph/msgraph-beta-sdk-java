package microsoft.graph.me.devices.item.registeredowners.item.user.ismanagedappuserblocked;
...
public class IsManagedAppUserBlockedRequestBuilder {
    ...
    public IsManagedAppUserBlockedRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.isManagedAppUserBlocked()";
