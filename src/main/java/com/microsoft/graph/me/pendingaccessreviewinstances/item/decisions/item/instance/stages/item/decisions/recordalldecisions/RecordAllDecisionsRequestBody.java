...
public class RecordAllDecisionsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a recordAllDecisionsRequestBody
     */
    @javax.annotation.Nonnull
    public static RecordAllDecisionsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RecordAllDecisionsRequestBody currentObject = this;
