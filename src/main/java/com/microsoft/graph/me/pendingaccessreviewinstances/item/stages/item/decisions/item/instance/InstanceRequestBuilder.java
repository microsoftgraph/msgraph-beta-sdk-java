package com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance;

import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.acceptrecommendations.AcceptRecommendationsRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.applydecisions.ApplyDecisionsRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.batchrecorddecisions.BatchRecordDecisionsRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.contactedreviewers.ContactedReviewersRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.decisions.DecisionsRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.definition.DefinitionRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.resetdecisions.ResetDecisionsRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.sendreminder.SendReminderRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.stop.StopRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.instance.stopapplydecisions.StopApplyDecisionsRequestBuilder;
...
public class InstanceRequestBuilder extends BaseRequestBuilder {
    ...
    public InstanceRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new InstanceRequestBuilder and sets the default values.
    ...
    public InstanceRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24select,%24expand}", rawUrl);
    }
    /**
