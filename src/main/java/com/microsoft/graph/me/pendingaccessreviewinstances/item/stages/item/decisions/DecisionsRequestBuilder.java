package com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions;

import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.count.CountRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.filterbycurrentuserwithon.FilterByCurrentUserWithOnRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.item.AccessReviewInstanceDecisionItemItemRequestBuilder;
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.recordalldecisions.RecordAllDecisionsRequestBuilder;
...
public class DecisionsRequestBuilder extends BaseRequestBuilder {
    ...
    public DecisionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DecisionsRequestBuilder and sets the default values.
    ...
    public DecisionsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
