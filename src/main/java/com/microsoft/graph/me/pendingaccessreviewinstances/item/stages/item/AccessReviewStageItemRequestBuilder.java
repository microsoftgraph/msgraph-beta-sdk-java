package com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item;

import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.decisions.DecisionsRequestBuilder;
...
import com.microsoft.graph.me.pendingaccessreviewinstances.item.stages.item.stop.StopRequestBuilder;
...
public class AccessReviewStageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public AccessReviewStageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AccessReviewStageItemRequestBuilder and sets the default values.
    ...
    public AccessReviewStageItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     * Provides operations to manage the decisions property of the microsoft.graph.accessReviewStage entity.
