package com.microsoft.graph.me.tasks.lists.delta;
...
public class DeltaResponse extends BaseDeltaFunctionResponse implements Parsable {
    /** The value property */
    private java.util.List<BaseTaskList> _value;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("value", (n) -> { currentObject.setValue(n.getCollectionOfObjectValues(BaseTaskList::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<BaseTaskList> getValue() {
        return this._value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final java.util.List<BaseTaskList> value) {
        this._value = value;
    }
}
