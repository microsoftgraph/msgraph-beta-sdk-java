...
public class BaseTaskListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.tasks.lists.item.extensions.item collection
     ...
     * @return a CompletableFuture of baseTaskList
     */
    public java.util.concurrent.CompletableFuture<BaseTaskList> patch(@javax.annotation.Nonnull final BaseTaskList body, @javax.annotation.Nullable final java.util.function.Consumer<BaseTaskListItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.tasks.lists.item.tasks.item collection
     * @param id Unique identifier of the item
