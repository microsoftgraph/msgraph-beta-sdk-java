package com.microsoft.graph.me.tasks.lists.item;

import com.microsoft.graph.me.tasks.lists.item.extensions.ExtensionsRequestBuilder;
import com.microsoft.graph.me.tasks.lists.item.extensions.item.ExtensionItemRequestBuilder;
import com.microsoft.graph.me.tasks.lists.item.tasks.item.BaseTaskItemRequestBuilder;
import com.microsoft.graph.me.tasks.lists.item.tasks.TasksRequestBuilder;
...
public class BaseTaskListItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final BaseTaskList body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<BaseTaskList> patch(@javax.annotation.Nonnull final BaseTaskList body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<BaseTaskList> patch(@javax.annotation.Nonnull final BaseTaskList body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
