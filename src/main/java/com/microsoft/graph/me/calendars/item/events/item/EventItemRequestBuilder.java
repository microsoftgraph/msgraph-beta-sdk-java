...
import microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.calendars.item.events.item.exceptionOccurrences.item collection
     * @param id Unique identifier of the item
     * @return a EventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder exceptionOccurrences(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
        return new microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.calendars.item.events.item.instances.item.EventItemRequestBuilder instances(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did1", id);
