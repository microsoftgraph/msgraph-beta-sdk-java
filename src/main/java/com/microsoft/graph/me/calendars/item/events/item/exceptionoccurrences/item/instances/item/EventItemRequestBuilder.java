package com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item;

import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.attachments.AttachmentsRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.attachments.item.AttachmentItemRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.extensions.ExtensionsRequestBuilder;
...
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.forward.ForwardRequestBuilder;
...
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendars.item.events.item.exceptionoccurrences.item.instances.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.events.item.exceptionOccurrences.item.instances.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.events.item.exceptionOccurrences.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.events.item.exceptionOccurrences.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendars.item.events.item.exceptionOccurrences.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
