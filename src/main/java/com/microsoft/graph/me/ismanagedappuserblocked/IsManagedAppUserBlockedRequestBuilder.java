...
public class IsManagedAppUserBlockedRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse> executionException = new java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse>();
