...
public class IsManagedAppUserBlockedRequestBuilder extends BaseRequestBuilder {
    ...
    public IsManagedAppUserBlockedRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/isManagedAppUserBlocked()", pathParameters);
    }
    /**
     * Instantiates a new IsManagedAppUserBlockedRequestBuilder and sets the default values.
    ...
    public IsManagedAppUserBlockedRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/isManagedAppUserBlocked()", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse> executionException = new java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<IsManagedAppUserBlockedResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
