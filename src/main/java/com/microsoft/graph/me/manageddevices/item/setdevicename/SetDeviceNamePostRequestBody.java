package com.microsoft.graph.me.manageddevices.item.setdevicename;
...
public class SetDeviceNamePostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static SetDeviceNamePostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
