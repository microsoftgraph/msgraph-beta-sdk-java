...
import microsoft.graph.me.manageddevices.item.users.item.UserItemRequestBuilder;
...
public class ManagedDeviceItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.managedDevices.item.users.item collection
     * @param id Unique identifier of the item
