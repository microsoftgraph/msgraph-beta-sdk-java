package com.microsoft.graph.me.manageddevices.item.enrollnowaction;
...
public class EnrollNowActionRequestBuilder extends BaseRequestBuilder {
    ...
    public EnrollNowActionRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/enrollNowAction", pathParameters);
    }
    /**
     * Instantiates a new EnrollNowActionRequestBuilder and sets the default values.
    ...
    public EnrollNowActionRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/enrollNowAction", rawUrl);
    }
    /**
