package com.microsoft.graph.me.manageddevices.item.playlostmodesound;
...
public class PlayLostModeSoundPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static PlayLostModeSoundPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("durationInMinutes", (n) -> { currentObject.setDurationInMinutes(n.getStringValue()); });
