package com.microsoft.graph.me.manageddevices.item.reprovisioncloudpc;
...
public class ReprovisionCloudPcRequestBuilder extends BaseRequestBuilder {
    ...
    public ReprovisionCloudPcRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/reprovisionCloudPc", pathParameters);
    }
    /**
     * Instantiates a new ReprovisionCloudPcRequestBuilder and sets the default values.
    ...
    public ReprovisionCloudPcRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/reprovisionCloudPc", rawUrl);
    }
    /**
