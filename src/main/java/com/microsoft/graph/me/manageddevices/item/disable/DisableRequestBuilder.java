...
public class DisableRequestBuilder extends BaseRequestBuilder {
    ...
    public DisableRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/disable", pathParameters);
    }
    /**
     * Instantiates a new DisableRequestBuilder and sets the default values.
    ...
    public DisableRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/disable", rawUrl);
    }
    /**
