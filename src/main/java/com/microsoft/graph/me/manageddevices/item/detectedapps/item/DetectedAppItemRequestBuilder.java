package com.microsoft.graph.me.manageddevices.item.detectedapps.item;
...
public class DetectedAppItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DetectedAppItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DetectedAppItemRequestBuilder and sets the default values.
    ...
    public DetectedAppItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
