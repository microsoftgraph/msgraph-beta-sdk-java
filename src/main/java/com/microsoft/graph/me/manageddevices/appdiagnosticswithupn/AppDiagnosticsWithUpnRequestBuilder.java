...
public class AppDiagnosticsWithUpnRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AppDiagnosticsWithUpnResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppDiagnosticsWithUpnResponse> executionException = new java.util.concurrent.CompletableFuture<AppDiagnosticsWithUpnResponse>();
