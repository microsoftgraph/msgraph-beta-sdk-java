package com.microsoft.graph.me.manageddevices.item.revokeapplevpplicenses;
...
public class RevokeAppleVppLicensesRequestBuilder extends BaseRequestBuilder {
    ...
    public RevokeAppleVppLicensesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/revokeAppleVppLicenses", pathParameters);
    }
    /**
     * Instantiates a new RevokeAppleVppLicensesRequestBuilder and sets the default values.
    ...
    public RevokeAppleVppLicensesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/revokeAppleVppLicenses", rawUrl);
    }
    /**
