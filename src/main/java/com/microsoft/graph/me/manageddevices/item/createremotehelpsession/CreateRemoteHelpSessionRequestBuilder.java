...
public class CreateRemoteHelpSessionRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CreateRemoteHelpSessionResponse> post(@javax.annotation.Nonnull final CreateRemoteHelpSessionPostRequestBody body) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CreateRemoteHelpSessionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of createRemoteHelpSessionResponse
     */
    public java.util.concurrent.CompletableFuture<CreateRemoteHelpSessionResponse> post(@javax.annotation.Nonnull final CreateRemoteHelpSessionPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<CreateRemoteHelpSessionRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
            ...
            return this.requestAdapter.sendAsync(requestInfo, CreateRemoteHelpSessionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
