...
public class GetManagedDevicesWithAppFailuresRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetManagedDevicesWithAppFailuresResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetManagedDevicesWithAppFailuresResponse> executionException = new java.util.concurrent.CompletableFuture<GetManagedDevicesWithAppFailuresResponse>();
