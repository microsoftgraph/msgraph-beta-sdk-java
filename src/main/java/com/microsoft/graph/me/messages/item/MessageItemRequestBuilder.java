...
import microsoft.graph.me.messages.item.eventmessagerequest.EventMessageRequestRequestBuilder;
...
import microsoft.graph.me.messages.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.me.messages.item.mentions.MentionsRequestBuilder;
...
import microsoft.graph.me.messages.item.unsubscribe.UnsubscribeRequestBuilder;
...
public class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.messages.item.mentions.item collection
     * @param id Unique identifier of the item
