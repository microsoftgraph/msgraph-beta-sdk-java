package microsoft.graph.me.messages.item.eventmessagerequest;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.me.messages.item.eventmessagerequest.accept.AcceptRequestBuilder;
import microsoft.graph.me.messages.item.eventmessagerequest.decline.DeclineRequestBuilder;
import microsoft.graph.me.messages.item.eventmessagerequest.tentativelyaccept.TentativelyAcceptRequestBuilder;
/** Builds and executes requests for operations under /me/messages/{message-id}/microsoft.graph.eventMessageRequest  */
public class EventMessageRequestRequestBuilder {
    ...
    public EventMessageRequestRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/messages/{message%2Did}/microsoft.graph.eventMessageRequest";
