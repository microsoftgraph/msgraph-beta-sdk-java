package com.microsoft.graph.me.chats.item.messages.item.undosoftdelete;
...
public class UndoSoftDeleteRequestBuilder extends BaseRequestBuilder {
    ...
    public UndoSoftDeleteRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/undoSoftDelete", pathParameters);
    }
    /**
     * Instantiates a new UndoSoftDeleteRequestBuilder and sets the default values.
    ...
    public UndoSoftDeleteRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/undoSoftDelete", rawUrl);
    }
    /**
