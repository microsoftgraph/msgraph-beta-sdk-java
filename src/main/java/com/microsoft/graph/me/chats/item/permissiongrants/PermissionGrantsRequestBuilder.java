package com.microsoft.graph.me.chats.item.permissiongrants;

import com.microsoft.graph.me.chats.item.permissiongrants.count.CountRequestBuilder;
import com.microsoft.graph.me.chats.item.permissiongrants.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.chats.item.permissiongrants.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.me.chats.item.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.me.chats.item.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
...
public class PermissionGrantsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/chat-list-permissiongrants?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
