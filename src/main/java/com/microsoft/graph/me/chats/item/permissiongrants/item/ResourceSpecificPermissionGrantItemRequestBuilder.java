package microsoft.graph.me.chats.item.permissiongrants.item;
...
import microsoft.graph.me.chats.item.permissiongrants.item.checkmembergroups.CheckMemberGroupsRequestBuilder;
import microsoft.graph.me.chats.item.permissiongrants.item.checkmemberobjects.CheckMemberObjectsRequestBuilder;
import microsoft.graph.me.chats.item.permissiongrants.item.getmembergroups.GetMemberGroupsRequestBuilder;
import microsoft.graph.me.chats.item.permissiongrants.item.getmemberobjects.GetMemberObjectsRequestBuilder;
import microsoft.graph.me.chats.item.permissiongrants.item.restore.RestoreRequestBuilder;
