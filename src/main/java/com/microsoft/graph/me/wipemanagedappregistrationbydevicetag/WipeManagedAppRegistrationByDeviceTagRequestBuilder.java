package microsoft.graph.me.wipemanagedappregistrationbydevicetag;
...
public class WipeManagedAppRegistrationByDeviceTagRequestBuilder {
    ...
    public WipeManagedAppRegistrationByDeviceTagRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/microsoft.graph.wipeManagedAppRegistrationByDeviceTag";
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final WipeManagedAppRegistrationByDeviceTagRequestBody body) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final WipeManagedAppRegistrationByDeviceTagRequestBody body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final WipeManagedAppRegistrationByDeviceTagRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<WipeManagedAppRegistrationByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final WipeManagedAppRegistrationByDeviceTagRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<WipeManagedAppRegistrationByDeviceTagRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
