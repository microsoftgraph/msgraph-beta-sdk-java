...
public class WipeManagedAppRegistrationByDeviceTagRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a wipeManagedAppRegistrationByDeviceTagRequestBody
     */
    @javax.annotation.Nonnull
    public static WipeManagedAppRegistrationByDeviceTagRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final WipeManagedAppRegistrationByDeviceTagRequestBody currentObject = this;
