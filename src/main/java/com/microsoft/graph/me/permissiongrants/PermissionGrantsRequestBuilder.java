package com.microsoft.graph.me.permissiongrants;

import com.microsoft.graph.me.permissiongrants.count.CountRequestBuilder;
import com.microsoft.graph.me.permissiongrants.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.permissiongrants.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.me.permissiongrants.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.me.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import com.microsoft.graph.me.permissiongrants.validateproperties.ValidatePropertiesRequestBuilder;
...
public class PermissionGrantsRequestBuilder extends BaseRequestBuilder {
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
