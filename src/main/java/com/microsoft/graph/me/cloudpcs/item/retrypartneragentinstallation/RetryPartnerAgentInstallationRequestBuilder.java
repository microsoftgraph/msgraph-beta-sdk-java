package com.microsoft.graph.me.cloudpcs.item.retrypartneragentinstallation;
...
public class RetryPartnerAgentInstallationRequestBuilder extends BaseRequestBuilder {
    ...
    public RetryPartnerAgentInstallationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/retryPartnerAgentInstallation", pathParameters);
    }
    /**
     * Instantiates a new RetryPartnerAgentInstallationRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public RetryPartnerAgentInstallationRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/retryPartnerAgentInstallation", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/cloudpc-retrypartneragentinstallation?view=graph-rest-1.0">Find more info here</a>
     */
