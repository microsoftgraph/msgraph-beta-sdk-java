...
public class TroubleshootRequestBuilder extends BaseRequestBuilder {
    ...
    public TroubleshootRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/troubleshoot", pathParameters);
    }
    /**
     * Instantiates a new TroubleshootRequestBuilder and sets the default values.
    ...
    public TroubleshootRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/troubleshoot", rawUrl);
    }
    /**
     * Troubleshoot a specific Cloud PC. Use this API to check the health status of the Cloud PC and the session host.
     * @return a CompletableFuture of void
     * @see <a href="https://docs.microsoft.com/graph/api/cloudpc-troubleshoot?view=graph-rest-1.0">Find more info here</a>
     */
