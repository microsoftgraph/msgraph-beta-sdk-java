package com.microsoft.graph.me.cloudpcs.item.poweron;
...
public class PowerOnRequestBuilder extends BaseRequestBuilder {
    ...
    public PowerOnRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/powerOn", pathParameters);
    }
    /**
     * Instantiates a new PowerOnRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public PowerOnRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/powerOn", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/cloudpc-poweron?view=graph-rest-1.0">Find more info here</a>
     */
