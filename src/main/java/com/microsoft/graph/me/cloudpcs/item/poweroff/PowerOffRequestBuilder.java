package com.microsoft.graph.me.cloudpcs.item.poweroff;
...
public class PowerOffRequestBuilder extends BaseRequestBuilder {
    ...
    public PowerOffRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/powerOff", pathParameters);
    }
    /**
     * Instantiates a new PowerOffRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public PowerOffRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/powerOff", rawUrl);
    }
    /**
