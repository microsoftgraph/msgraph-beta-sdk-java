package microsoft.graph.me.cloudpcs.item.reprovision;
...
public class ReprovisionRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a reprovisionRequestBody
     */
    @javax.annotation.Nonnull
    public static ReprovisionRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ReprovisionRequestBody currentObject = this;
