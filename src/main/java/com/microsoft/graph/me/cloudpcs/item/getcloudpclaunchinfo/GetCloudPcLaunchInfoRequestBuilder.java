package microsoft.graph.me.cloudpcs.item.getcloudpclaunchinfo;
...
import microsoft.graph.models.CloudPcLaunchInfo;
...
public class GetCloudPcLaunchInfoRequestBuilder {
    ...
    public GetCloudPcLaunchInfoRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/microsoft.graph.getCloudPcLaunchInfo()";
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CloudPcLaunchInfo> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CloudPcLaunchInfo::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<CloudPcLaunchInfo> get(@javax.annotation.Nullable final java.util.function.Consumer<GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CloudPcLaunchInfo::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
