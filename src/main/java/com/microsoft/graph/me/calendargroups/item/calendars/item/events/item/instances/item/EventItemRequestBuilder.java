...
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.item.exceptionoccurrences.ExceptionOccurrencesRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendarGroups.item.calendars.item.events.item.instances.item.exceptionOccurrences.item collection
     * @param id Unique identifier of the item
