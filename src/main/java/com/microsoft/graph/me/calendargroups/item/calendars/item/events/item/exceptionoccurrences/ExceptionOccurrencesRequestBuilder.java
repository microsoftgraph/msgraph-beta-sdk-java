package com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.exceptionoccurrences;

import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.exceptionoccurrences.count.CountRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.exceptionoccurrences.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.exceptionoccurrences.item.EventItemRequestBuilder;
...
public class ExceptionOccurrencesRequestBuilder extends BaseRequestBuilder {
    ...
    public ExceptionOccurrencesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ExceptionOccurrencesRequestBuilder and sets the default values.
    ...
    public ExceptionOccurrencesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
