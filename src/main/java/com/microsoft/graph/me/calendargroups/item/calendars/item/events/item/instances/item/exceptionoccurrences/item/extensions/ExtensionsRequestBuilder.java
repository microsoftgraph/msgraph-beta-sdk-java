package com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.item.exceptionoccurrences.item.extensions;

import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
import com.microsoft.graph.me.calendargroups.item.calendars.item.events.item.instances.item.exceptionoccurrences.item.extensions.item.ExtensionItemRequestBuilder;
...
public class ExtensionsRequestBuilder extends BaseRequestBuilder {
    ...
    public ExtensionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ExtensionsRequestBuilder and sets the default values.
    ...
    public ExtensionsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
