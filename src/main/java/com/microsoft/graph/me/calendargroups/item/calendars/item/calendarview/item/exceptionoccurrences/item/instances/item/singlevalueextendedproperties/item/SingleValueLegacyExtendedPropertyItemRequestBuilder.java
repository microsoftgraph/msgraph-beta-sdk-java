package microsoft.graph.me.calendargroups.item.calendars.item.calendarview.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.item;
