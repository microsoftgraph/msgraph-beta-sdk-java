...
public class HasPayloadLinksRequestBuilder extends BaseRequestBuilder {
    ...
    public HasPayloadLinksRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/deviceEnrollmentConfigurations/hasPayloadLinks", pathParameters);
    }
    /**
     * Instantiates a new HasPayloadLinksRequestBuilder and sets the default values.
    ...
    public HasPayloadLinksRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/deviceEnrollmentConfigurations/hasPayloadLinks", rawUrl);
    }
    /**
