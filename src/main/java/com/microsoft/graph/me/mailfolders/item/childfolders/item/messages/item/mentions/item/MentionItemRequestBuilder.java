package com.microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.mentions.item;
...
public class MentionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MentionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/mentions/{mention%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MentionItemRequestBuilder and sets the default values.
    ...
    public MentionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/mentions/{mention%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
