...
import microsoft.graph.me.mailfolders.item.childfolders.item.userconfigurations.item.UserConfigurationItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.userconfigurations.UserConfigurationsRequestBuilder;
...
public class MailFolderItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.userConfigurations.item collection
     * @param id Unique identifier of the item
