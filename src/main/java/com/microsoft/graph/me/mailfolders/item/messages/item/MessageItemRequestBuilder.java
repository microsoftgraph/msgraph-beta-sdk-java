...
import microsoft.graph.me.mailfolders.item.messages.item.calendarsharingmessage.CalendarSharingMessageRequestBuilder;
...
import microsoft.graph.me.mailfolders.item.messages.item.eventmessagerequest.EventMessageRequestRequestBuilder;
...
import microsoft.graph.me.mailfolders.item.messages.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.messages.item.mentions.MentionsRequestBuilder;
...
import microsoft.graph.me.mailfolders.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
...
public class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.messages.item.mentions.item collection
     * @param id Unique identifier of the item
