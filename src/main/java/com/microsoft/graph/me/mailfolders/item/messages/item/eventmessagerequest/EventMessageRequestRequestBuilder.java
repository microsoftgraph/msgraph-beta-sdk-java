package microsoft.graph.me.mailfolders.item.messages.item.eventmessagerequest;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import microsoft.graph.me.mailfolders.item.messages.item.eventmessagerequest.accept.AcceptRequestBuilder;
import microsoft.graph.me.mailfolders.item.messages.item.eventmessagerequest.decline.DeclineRequestBuilder;
import microsoft.graph.me.mailfolders.item.messages.item.eventmessagerequest.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventMessageRequestRequestBuilder {
    ...
    public EventMessageRequestRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.eventMessageRequest";
