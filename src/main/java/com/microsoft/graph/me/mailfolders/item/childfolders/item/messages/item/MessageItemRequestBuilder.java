...
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.eventmessagerequest.EventMessageRequestRequestBuilder;
...
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.mentions.MentionsRequestBuilder;
...
import microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.unsubscribe.UnsubscribeRequestBuilder;
...
public class MessageItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.mentions.item collection
     * @param id Unique identifier of the item
