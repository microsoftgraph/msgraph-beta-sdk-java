package com.microsoft.graph.me.mailfolders.item.childfolders.item.messages.item.unsubscribe;
...
public class UnsubscribeRequestBuilder extends BaseRequestBuilder {
    ...
    public UnsubscribeRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/unsubscribe", pathParameters);
    }
    /**
     * Instantiates a new UnsubscribeRequestBuilder and sets the default values.
    ...
    public UnsubscribeRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/unsubscribe", rawUrl);
    }
    /**
