...
public class OutlookTaskItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.outlook.taskGroups.item.taskFolders.item.tasks.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.outlook.taskGroups.item.taskFolders.item.tasks.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.outlook.taskGroups.item.taskFolders.item.tasks.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
