package com.microsoft.graph.me.drives.item.list.items.item.activities.item.driveitem;

import com.microsoft.graph.me.drives.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
