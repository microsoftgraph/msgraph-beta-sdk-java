package microsoft.graph.me.drives.item.list.items.item.activities.item.driveitem;
...
import microsoft.graph.me.drives.item.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
