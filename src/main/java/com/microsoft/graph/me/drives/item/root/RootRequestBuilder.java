...
import microsoft.graph.me.drives.item.root.activities.ActivitiesRequestBuilder;
import microsoft.graph.me.drives.item.root.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.me.drives.item.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.root.activities.item collection
