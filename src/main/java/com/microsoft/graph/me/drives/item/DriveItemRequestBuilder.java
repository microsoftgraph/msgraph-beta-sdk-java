...
import com.microsoft.graph.me.drives.item.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.me.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
import com.microsoft.graph.me.drives.item.following.item.DriveItemItemRequestBuilder;
...
import com.microsoft.graph.me.drives.item.recent.RecentRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.drives.item.activities.item collection
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.bundles.item.DriveItemItemRequestBuilder bundles(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new com.microsoft.graph.me.drives.item.bundles.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.following.item.DriveItemItemRequestBuilder following(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new com.microsoft.graph.me.drives.item.following.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * A collection of drives available for this user. Read-only.
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.items.item.DriveItemItemRequestBuilder items(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new com.microsoft.graph.me.drives.item.items.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property drives in me
     * @param body 
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.me.drives.item.special.item.DriveItemItemRequestBuilder special(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new com.microsoft.graph.me.drives.item.special.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
