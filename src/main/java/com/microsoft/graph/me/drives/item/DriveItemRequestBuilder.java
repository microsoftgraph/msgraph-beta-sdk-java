package microsoft.graph.me.drives.item;
...
import microsoft.graph.me.drives.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.me.drives.item.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.me.drives.item.bundles.BundlesRequestBuilder;
import microsoft.graph.me.drives.item.following.FollowingRequestBuilder;
import microsoft.graph.me.drives.item.items.ItemsRequestBuilder;
import microsoft.graph.me.drives.item.list.ListRequestBuilder;
import microsoft.graph.me.drives.item.recent.RecentRequestBuilder;
import microsoft.graph.me.drives.item.root.RootRequestBuilder;
import microsoft.graph.me.drives.item.searchwithq.SearchWithQRequestBuilder;
import microsoft.graph.me.drives.item.sharedwithme.SharedWithMeRequestBuilder;
import microsoft.graph.me.drives.item.special.SpecialRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.activities.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.bundles.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.bundles.item.DriveItemItemRequestBuilder bundles(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.me.drives.item.bundles.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.following.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.following.item.DriveItemItemRequestBuilder following(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.me.drives.item.following.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * A collection of drives available for this user. Read-only.
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.items.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.items.item.DriveItemItemRequestBuilder items(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.me.drives.item.items.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property drives in me
     * @param body 
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.drives.item.special.item collection
     * @param id Unique identifier of the item
     * @return a driveItemItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.drives.item.special.item.DriveItemItemRequestBuilder special(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("driveItem%2Did", id);
        return new microsoft.graph.me.drives.item.special.item.DriveItemItemRequestBuilder(urlTplParams, requestAdapter);
    }
