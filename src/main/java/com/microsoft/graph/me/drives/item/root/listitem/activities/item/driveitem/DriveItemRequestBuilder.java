package com.microsoft.graph.me.drives.item.root.listitem.activities.item.driveitem;

import com.microsoft.graph.me.drives.item.root.listitem.activities.item.driveitem.content.ContentRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    public DriveItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
