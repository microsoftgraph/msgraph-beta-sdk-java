package microsoft.graph.me.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.me.events.item.exceptionoccurrences.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
