package com.microsoft.graph.me.calendar.events;

import com.microsoft.graph.me.calendar.events.count.CountRequestBuilder;
import com.microsoft.graph.me.calendar.events.delta.DeltaRequestBuilder;
...
public class EventsRequestBuilder extends BaseRequestBuilder {
    ...
    public EventsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new EventsRequestBuilder and sets the default values.
    ...
    public EventsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
