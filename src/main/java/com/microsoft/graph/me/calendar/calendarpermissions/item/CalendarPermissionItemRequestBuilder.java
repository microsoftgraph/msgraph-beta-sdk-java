package com.microsoft.graph.me.calendar.calendarpermissions.item;
...
public class CalendarPermissionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public CalendarPermissionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/calendarPermissions/{calendarPermission%2Did}{?%24select}", pathParameters);
    }
    /**
     * Instantiates a new CalendarPermissionItemRequestBuilder and sets the default values.
    ...
    public CalendarPermissionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/calendarPermissions/{calendarPermission%2Did}{?%24select}", rawUrl);
    }
    /**
