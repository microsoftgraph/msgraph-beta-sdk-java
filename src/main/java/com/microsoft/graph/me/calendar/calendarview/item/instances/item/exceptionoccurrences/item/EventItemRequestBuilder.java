package com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item;

import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.accept.AcceptRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.attachments.AttachmentsRequestBuilder;
...
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.calendar.CalendarRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.cancel.CancelRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.decline.DeclineRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.dismissreminder.DismissReminderRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.extensions.ExtensionsRequestBuilder;
...
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.forward.ForwardRequestBuilder;
...
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.snoozereminder.SnoozeReminderRequestBuilder;
import com.microsoft.graph.me.calendar.calendarview.item.instances.item.exceptionoccurrences.item.tentativelyaccept.TentativelyAcceptRequestBuilder;
...
public class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.calendarView.item.instances.item.exceptionOccurrences.item.attachments.item collection
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.calendarView.item.instances.item.exceptionOccurrences.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.calendarView.item.instances.item.exceptionOccurrences.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.calendar.calendarView.item.instances.item.exceptionOccurrences.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
