package com.microsoft.graph.me.calendar.events.item.exceptionoccurrences.delta;
...
public class DeltaRequestBuilder extends BaseRequestBuilder {
    ...
    public DeltaRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/delta(){?startDateTime*,endDateTime*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters);
    }
    /**
     * Instantiates a new DeltaRequestBuilder and sets the default values.
    ...
    public DeltaRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/delta(){?startDateTime*,endDateTime*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl);
    }
    /**
