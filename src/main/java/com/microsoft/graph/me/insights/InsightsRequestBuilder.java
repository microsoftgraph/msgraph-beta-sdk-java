...
import microsoft.graph.models.ItemInsights;
...
public class InsightsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ItemInsights body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ItemInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    /**
     * Get insights from me
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ItemInsights::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> get(@javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> get(@javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, ItemInsights::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ItemInsights body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ItemInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final ItemInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
