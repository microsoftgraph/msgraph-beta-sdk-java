...
public class InsightsRequestBuilder {
     ...
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> patch(@javax.annotation.Nonnull final ItemInsights body) {
        try {
     ...
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> patch(@javax.annotation.Nonnull final ItemInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of itemInsights
     */
    public java.util.concurrent.CompletableFuture<ItemInsights> patch(@javax.annotation.Nonnull final ItemInsights body, @javax.annotation.Nullable final java.util.function.Consumer<InsightsRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
