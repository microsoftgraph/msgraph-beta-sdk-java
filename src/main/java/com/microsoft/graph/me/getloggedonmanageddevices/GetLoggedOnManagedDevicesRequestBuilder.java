...
public class GetLoggedOnManagedDevicesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<GetLoggedOnManagedDevicesResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<GetLoggedOnManagedDevicesResponse> executionException = new java.util.concurrent.CompletableFuture<GetLoggedOnManagedDevicesResponse>();
