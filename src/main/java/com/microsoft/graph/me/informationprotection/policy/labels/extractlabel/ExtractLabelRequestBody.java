...
public class ExtractLabelRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a extractLabelRequestBody
     */
    @javax.annotation.Nonnull
    public static ExtractLabelRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ExtractLabelRequestBody currentObject = this;
