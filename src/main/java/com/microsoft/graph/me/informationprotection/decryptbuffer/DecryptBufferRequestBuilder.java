...
public class DecryptBufferRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final DecryptBufferPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BufferDecryptionResult> post(@javax.annotation.Nonnull final DecryptBufferPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<BufferDecryptionResult> executionException = new java.util.concurrent.CompletableFuture<BufferDecryptionResult>();
