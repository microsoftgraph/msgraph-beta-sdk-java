package microsoft.graph.me.informationprotection.threatassessmentrequests.item;
...
import microsoft.graph.me.informationprotection.threatassessmentrequests.item.results.item.ThreatAssessmentResultItemRequestBuilder;
import microsoft.graph.me.informationprotection.threatassessmentrequests.item.results.ResultsRequestBuilder;
...
public class ThreatAssessmentRequestItemRequestBuilder {
    ...
    public ThreatAssessmentRequestItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.informationProtection.threatAssessmentRequests.item.results.item collection
