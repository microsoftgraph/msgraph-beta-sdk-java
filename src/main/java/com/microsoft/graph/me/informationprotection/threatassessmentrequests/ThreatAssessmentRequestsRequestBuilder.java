package com.microsoft.graph.me.informationprotection.threatassessmentrequests;

import com.microsoft.graph.me.informationprotection.threatassessmentrequests.count.CountRequestBuilder;
...
public class ThreatAssessmentRequestsRequestBuilder extends BaseRequestBuilder {
    ...
    public ThreatAssessmentRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/informationProtection/threatAssessmentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ThreatAssessmentRequestsRequestBuilder and sets the default values.
    ...
    public ThreatAssessmentRequestsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/informationProtection/threatAssessmentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
