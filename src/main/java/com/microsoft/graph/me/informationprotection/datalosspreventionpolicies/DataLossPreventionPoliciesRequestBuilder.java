...
public class DataLossPreventionPoliciesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DataLossPreventionPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DataLossPreventionPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<DataLossPreventionPolicyCollectionResponse>();
