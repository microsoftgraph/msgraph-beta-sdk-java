...
public class BitlockerRequestBuilder {
     ...
     * @return a CompletableFuture of bitlocker
     */
    public java.util.concurrent.CompletableFuture<Bitlocker> patch(@javax.annotation.Nonnull final Bitlocker body) {
        try {
     ...
     * @return a CompletableFuture of bitlocker
     */
    public java.util.concurrent.CompletableFuture<Bitlocker> patch(@javax.annotation.Nonnull final Bitlocker body, @javax.annotation.Nullable final java.util.function.Consumer<BitlockerRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of bitlocker
     */
    public java.util.concurrent.CompletableFuture<Bitlocker> patch(@javax.annotation.Nonnull final Bitlocker body, @javax.annotation.Nullable final java.util.function.Consumer<BitlockerRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
