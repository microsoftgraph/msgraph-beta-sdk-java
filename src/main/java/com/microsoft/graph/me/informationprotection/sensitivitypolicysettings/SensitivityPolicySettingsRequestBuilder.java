...
public class SensitivityPolicySettingsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SensitivityPolicySettings body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SensitivityPolicySettings> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SensitivityPolicySettings> executionException = new java.util.concurrent.CompletableFuture<SensitivityPolicySettings>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
