package com.microsoft.graph.me.onenote.pages.item;

import com.microsoft.graph.me.onenote.pages.item.content.ContentRequestBuilder;
import com.microsoft.graph.me.onenote.pages.item.copytosection.CopyToSectionRequestBuilder;
import com.microsoft.graph.me.onenote.pages.item.onenotepatchcontent.OnenotePatchContentRequestBuilder;
import com.microsoft.graph.me.onenote.pages.item.parentnotebook.ParentNotebookRequestBuilder;
import com.microsoft.graph.me.onenote.pages.item.parentsection.ParentSectionRequestBuilder;
import com.microsoft.graph.me.onenote.pages.item.preview.PreviewRequestBuilder;
...
public class OnenotePageItemRequestBuilder extends BaseRequestBuilder {
    ...
    public OnenotePageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/pages/{onenotePage%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new OnenotePageItemRequestBuilder and sets the default values.
    ...
    public OnenotePageItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/pages/{onenotePage%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
