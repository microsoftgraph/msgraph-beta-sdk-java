package com.microsoft.graph.me.onenote.notebooks.item.sections.item.pages;

import com.microsoft.graph.me.onenote.notebooks.item.sections.item.pages.count.CountRequestBuilder;
import com.microsoft.graph.me.onenote.notebooks.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
...
public class PagesRequestBuilder extends BaseRequestBuilder {
    ...
    public PagesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PagesRequestBuilder and sets the default values.
    ...
    public PagesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
