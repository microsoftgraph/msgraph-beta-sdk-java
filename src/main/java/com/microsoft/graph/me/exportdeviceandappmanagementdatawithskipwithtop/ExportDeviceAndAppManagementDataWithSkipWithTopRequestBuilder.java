...
public class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceAndAppManagementData> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceAndAppManagementData> executionException = new java.util.concurrent.CompletableFuture<DeviceAndAppManagementData>();
