package com.microsoft.graph.me.retryserviceprovisioning;
...
public class RetryServiceProvisioningRequestBuilder extends BaseRequestBuilder {
    ...
    public RetryServiceProvisioningRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/retryServiceProvisioning", pathParameters);
    }
    /**
     * Instantiates a new RetryServiceProvisioningRequestBuilder and sets the default values.
     ...
     */
    @javax.annotation.Nullable
    public RetryServiceProvisioningRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/retryServiceProvisioning", rawUrl);
    }
    /**
     * Retry the user service provisioning.
     * @return a CompletableFuture of void
     * @see <a href="https://docs.microsoft.com/graph/api/user-retryserviceprovisioning?view=graph-rest-1.0">Find more info here</a>
     */
