package com.microsoft.graph.me.onlinemeetings.item.transcripts.item.metadatacontent;
...
public class MetadataContentRequestBuilder extends BaseRequestBuilder {
    ...
    public MetadataContentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}/metadataContent", pathParameters);
    }
    /**
     * Instantiates a new MetadataContentRequestBuilder and sets the default values.
    ...
    public MetadataContentRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}/metadataContent", rawUrl);
    }
    /**
