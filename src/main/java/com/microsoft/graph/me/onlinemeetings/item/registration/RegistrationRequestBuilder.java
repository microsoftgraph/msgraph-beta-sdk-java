...
public class RegistrationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final MeetingRegistration body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MeetingRegistration> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MeetingRegistration> executionException = new java.util.concurrent.CompletableFuture<MeetingRegistration>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
