package microsoft.graph.me.onlinemeetings.item.registration;
...
import microsoft.graph.me.onlinemeetings.item.registration.customquestions.CustomQuestionsRequestBuilder;
import microsoft.graph.me.onlinemeetings.item.registration.customquestions.item.MeetingRegistrationQuestionItemRequestBuilder;
...
public class RegistrationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<RegistrationRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final RegistrationRequestBuilderDeleteRequestConfiguration requestConfig = new RegistrationRequestBuilderDeleteRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<RegistrationRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        final RequestInformation requestInfo = new RequestInformation() {{
        ...
        requestInfo.pathParameters = pathParameters;
        if (requestConfiguration != null) {
            final RegistrationRequestBuilderGetRequestConfiguration requestConfig = new RegistrationRequestBuilderGetRequestConfiguration();
            requestConfiguration.accept(requestConfig);
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final MeetingRegistration body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final MeetingRegistration body, @javax.annotation.Nullable final java.util.function.Consumer<RegistrationRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
