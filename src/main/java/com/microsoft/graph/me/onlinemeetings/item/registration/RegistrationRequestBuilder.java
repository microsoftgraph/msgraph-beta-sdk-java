...
public class RegistrationRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.onlineMeetings.item.registration.customQuestions.item collection
    ...
    public java.util.concurrent.CompletableFuture<MeetingRegistration> get() {
        try {
            ...
            return new java.util.concurrent.CompletableFuture<MeetingRegistration>() {{
                this.completeExceptionally(ex);
            }};
        }
    }
