package com.microsoft.graph.me.onlinemeetings.item.alternativerecording;
...
public class AlternativeRecordingRequestBuilder extends BaseRequestBuilder {
    ...
    public AlternativeRecordingRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/alternativeRecording", pathParameters);
    }
    /**
     * Instantiates a new AlternativeRecordingRequestBuilder and sets the default values.
    ...
    public AlternativeRecordingRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/alternativeRecording", rawUrl);
    }
    /**
