package com.microsoft.graph.me.approleassignedresources;

import com.microsoft.graph.me.approleassignedresources.count.CountRequestBuilder;
...
public class AppRoleAssignedResourcesRequestBuilder extends BaseRequestBuilder {
    ...
    public AppRoleAssignedResourcesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/appRoleAssignedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new AppRoleAssignedResourcesRequestBuilder and sets the default values.
    ...
    public AppRoleAssignedResourcesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/appRoleAssignedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
