package com.microsoft.graph.me.planner.tasks;

import com.microsoft.graph.me.planner.tasks.count.CountRequestBuilder;
import com.microsoft.graph.me.planner.tasks.delta.DeltaRequestBuilder;
...
public class TasksRequestBuilder extends BaseRequestBuilder {
    ...
    public TasksRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/planner/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new TasksRequestBuilder and sets the default values.
    ...
    public TasksRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/planner/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     * Retrieve a list of **plannertask** objects assigned to a User.
     * @return a CompletableFuture of PlannerTaskCollectionResponse
     * @see <a href="https://docs.microsoft.com/graph/api/planneruser-list-tasks?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
