...
import com.microsoft.graph.me.planner.recentplans.item.PlannerPlanItemRequestBuilder;
...
public class RecentPlansRequestBuilder extends BaseRequestBuilder {
    ...
    public RecentPlansRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/planner/recentPlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RecentPlansRequestBuilder and sets the default values.
    ...
    public RecentPlansRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/planner/recentPlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/planneruser-list-recentplans?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
