package com.microsoft.graph.me.planner.plans.item;

import com.microsoft.graph.me.planner.plans.item.buckets.BucketsRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.buckets.item.PlannerBucketItemRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.details.DetailsRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.tasks.item.PlannerTaskItemRequestBuilder;
import com.microsoft.graph.me.planner.plans.item.tasks.TasksRequestBuilder;
...
public class PlannerPlanItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.planner.plans.item.buckets.item collection
     ...
     * @return a CompletableFuture of plannerPlan
     */
    public java.util.concurrent.CompletableFuture<PlannerPlan> patch(@javax.annotation.Nonnull final PlannerPlan body, @javax.annotation.Nullable final java.util.function.Consumer<PlannerPlanItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.me.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
