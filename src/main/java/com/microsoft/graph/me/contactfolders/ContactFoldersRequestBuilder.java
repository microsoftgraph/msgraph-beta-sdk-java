...
public class ContactFoldersRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ContactFolderCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ContactFolderCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ContactFolderCollectionResponse>();
