package microsoft.graph.me.joinedgroups.item.drives.item.items.item.subscriptions;
...
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.subscriptions.count.CountRequestBuilder;
...
public class SubscriptionsRequestBuilder {
    ...
    public SubscriptionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
