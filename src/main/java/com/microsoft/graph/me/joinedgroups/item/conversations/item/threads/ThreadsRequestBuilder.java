package microsoft.graph.me.joinedgroups.item.conversations.item.threads;
...
import microsoft.graph.me.joinedgroups.item.conversations.item.threads.count.CountRequestBuilder;
...
public class ThreadsRequestBuilder {
    ...
    public ThreadsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
