package microsoft.graph.me.joinedgroups.item.planner.plans.item;
...
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.BucketsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.PlannerBucketItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.details.DetailsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.tasks.item.PlannerTaskItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.tasks.TasksRequestBuilder;
...
public class PlannerPlanItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.planner.plans.item.buckets.item collection
    ...
    public PlannerPlanItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.planner.plans.item.tasks.item collection
     * @param id Unique identifier of the item
