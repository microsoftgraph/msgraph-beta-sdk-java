package microsoft.graph.me.joinedgroups.item.team.channels.item.filesfolder;
...
import microsoft.graph.me.joinedgroups.item.team.channels.item.filesfolder.content.ContentRequestBuilder;
...
public class FilesFolderRequestBuilder {
    ...
    public FilesFolderRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
