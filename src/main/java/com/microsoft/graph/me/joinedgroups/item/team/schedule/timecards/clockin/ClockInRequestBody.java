package microsoft.graph.me.joinedgroups.item.team.schedule.timecards.clockin;
...
public class ClockInRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a clockInRequestBody
     */
    @javax.annotation.Nonnull
    public static ClockInRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ClockInRequestBody currentObject = this;
