package microsoft.graph.me.joinedgroups.item.drives.item.following.item;
...
import microsoft.graph.me.joinedgroups.item.drives.item.following.item.content.ContentRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/following/{driveItem%2Did}{?%24select,%24expand}";
