package microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.tasks.item;
...
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.tasks.item.assignedtotaskboardformat.AssignedToTaskBoardFormatRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.tasks.item.buckettaskboardformat.BucketTaskBoardFormatRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.tasks.item.details.DetailsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.item.buckets.item.tasks.item.progresstaskboardformat.ProgressTaskBoardFormatRequestBuilder;
...
public class PlannerTaskItemRequestBuilder {
    ...
    public PlannerTaskItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
