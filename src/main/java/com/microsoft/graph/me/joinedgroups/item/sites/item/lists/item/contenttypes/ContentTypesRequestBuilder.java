package microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes;
...
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes.addcopy.AddCopyRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes.addcopyfromcontenttypehub.AddCopyFromContentTypeHubRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes.count.CountRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes.getcompatiblehubcontenttypes.GetCompatibleHubContentTypesRequestBuilder;
...
public class ContentTypesRequestBuilder {
    ...
    public ContentTypesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
