package microsoft.graph.me.joinedgroups.item.team;
...
import microsoft.graph.me.joinedgroups.item.team.allchannels.AllChannelsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.ChannelsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.group.GroupRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.incomingchannels.IncomingChannelsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.installedapps.InstalledAppsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.installedapps.item.TeamsAppInstallationItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.members.item.ConversationMemberItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.members.MembersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.operations.item.TeamsAsyncOperationItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.operations.OperationsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.owners.item.UserItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.owners.OwnersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.permissiongrants.PermissionGrantsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.photo.PhotoRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.primarychannel.PrimaryChannelRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.schedule.ScheduleRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.tags.item.TeamworkTagItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.tags.TagsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.template.TemplateRequestBuilder;
...
public class TeamRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.allChannels.item collection
     * @param id Unique identifier of the item
     * @return a channelItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.team.allchannels.item.ChannelItemRequestBuilder allChannels(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("channel%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.team.allchannels.item.ChannelItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.channels.item collection
     * @param id Unique identifier of the item
     * @return a channelItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.team.channels.item.ChannelItemRequestBuilder channels(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("channel%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.team.channels.item.ChannelItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public TeamRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team{?%24select,%24expand}";
    ...
    /**
     * Delete navigation property team for me
    ...
    /**
     * Update the navigation property team in me
     * @param body 
     * @return a RequestInformation
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.incomingChannels.item collection
     * @param id Unique identifier of the item
     * @return a channelItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.team.incomingchannels.item.ChannelItemRequestBuilder incomingChannels(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("channel%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.team.incomingchannels.item.ChannelItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.installedApps.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.members.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.owners.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.permissionGrants.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.tags.item collection
     * @param id Unique identifier of the item
