package microsoft.graph.me.joinedgroups.item.rejectedsenders;
...
import microsoft.graph.me.joinedgroups.item.rejectedsenders.count.CountRequestBuilder;
...
public class RejectedSendersRequestBuilder {
    ...
    public RejectedSendersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/rejectedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
