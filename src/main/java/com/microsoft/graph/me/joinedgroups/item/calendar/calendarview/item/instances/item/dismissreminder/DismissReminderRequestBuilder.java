package microsoft.graph.me.joinedgroups.item.calendar.calendarview.item.instances.item.dismissreminder;
...
public class DismissReminderRequestBuilder {
    ...
    public DismissReminderRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.dismissReminder";
