package microsoft.graph.me.joinedgroups.item.team.channels.item.tabs.item;
...
import microsoft.graph.me.joinedgroups.item.team.channels.item.tabs.item.teamsapp.TeamsAppRequestBuilder;
...
public class TeamsTabItemRequestBuilder {
    ...
    public TeamsTabItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}";
