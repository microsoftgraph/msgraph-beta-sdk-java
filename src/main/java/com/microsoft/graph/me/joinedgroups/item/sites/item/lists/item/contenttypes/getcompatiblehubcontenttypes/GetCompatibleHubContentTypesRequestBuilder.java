package microsoft.graph.me.joinedgroups.item.sites.item.lists.item.contenttypes.getcompatiblehubcontenttypes;
...
public class GetCompatibleHubContentTypesRequestBuilder {
    ...
    public GetCompatibleHubContentTypesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/microsoft.graph.getCompatibleHubContentTypes()";
