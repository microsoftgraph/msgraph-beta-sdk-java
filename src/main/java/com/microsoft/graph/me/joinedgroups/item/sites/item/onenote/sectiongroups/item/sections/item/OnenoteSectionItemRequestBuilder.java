package microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item;
...
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.copytonotebook.CopyToNotebookRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.copytosectiongroup.CopyToSectionGroupRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.pages.item.OnenotePageItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.pages.PagesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.sectiongroups.item.sections.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
...
public class OnenoteSectionItemRequestBuilder {
    ...
    public OnenoteSectionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.onenote.sectionGroups.item.sections.item.pages.item collection
