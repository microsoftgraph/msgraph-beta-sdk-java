package microsoft.graph.me.joinedgroups.item.team.installedapps.item;
...
import microsoft.graph.me.joinedgroups.item.team.installedapps.item.teamsapp.TeamsAppRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.installedapps.item.teamsappdefinition.TeamsAppDefinitionRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.installedapps.item.upgrade.UpgradeRequestBuilder;
...
public class TeamsAppInstallationItemRequestBuilder {
    ...
    public TeamsAppInstallationItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}";
