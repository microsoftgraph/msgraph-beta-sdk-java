package microsoft.graph.me.joinedgroups.item.team.schedule.offershiftrequests;
...
import microsoft.graph.me.joinedgroups.item.team.schedule.offershiftrequests.count.CountRequestBuilder;
...
public class OfferShiftRequestsRequestBuilder {
    ...
    public OfferShiftRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/offerShiftRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
