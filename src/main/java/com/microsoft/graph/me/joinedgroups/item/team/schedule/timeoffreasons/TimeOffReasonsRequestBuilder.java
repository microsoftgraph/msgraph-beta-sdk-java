package microsoft.graph.me.joinedgroups.item.team.schedule.timeoffreasons;
...
import microsoft.graph.me.joinedgroups.item.team.schedule.timeoffreasons.count.CountRequestBuilder;
...
public class TimeOffReasonsRequestBuilder {
    ...
    public TimeOffReasonsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
