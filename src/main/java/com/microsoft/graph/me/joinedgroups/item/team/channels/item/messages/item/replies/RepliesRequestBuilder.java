package microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.replies;
...
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.replies.count.CountRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.replies.delta.DeltaRequestBuilder;
...
public class RepliesRequestBuilder {
    ...
    public RepliesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
