package microsoft.graph.me.joinedgroups.item.threads.item;
...
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.PostItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.PostsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.reply.ReplyRequestBuilder;
...
public class ConversationThreadItemRequestBuilder {
    ...
    public ConversationThreadItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}{?%24select}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item collection
