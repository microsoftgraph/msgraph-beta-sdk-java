package microsoft.graph.me.joinedgroups.item.calendarview.item.instances.item.singlevalueextendedproperties;
...
import microsoft.graph.me.joinedgroups.item.calendarview.item.instances.item.singlevalueextendedproperties.count.CountRequestBuilder;
...
public class SingleValueExtendedPropertiesRequestBuilder {
    ...
    public SingleValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
