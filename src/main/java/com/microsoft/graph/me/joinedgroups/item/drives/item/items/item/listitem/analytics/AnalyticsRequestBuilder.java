package microsoft.graph.me.joinedgroups.item.drives.item.items.item.listitem.analytics;
...
public class AnalyticsRequestBuilder {
    ...
    public AnalyticsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/analytics{?%24select,%24expand}";
