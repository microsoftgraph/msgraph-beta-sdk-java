package microsoft.graph.me.joinedgroups.item.sites.item.onenote.resources;
...
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.resources.count.CountRequestBuilder;
...
public class ResourcesRequestBuilder {
    ...
    public ResourcesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
