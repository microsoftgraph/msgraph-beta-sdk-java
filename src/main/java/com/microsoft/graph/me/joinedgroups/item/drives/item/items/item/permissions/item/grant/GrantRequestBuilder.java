package microsoft.graph.me.joinedgroups.item.drives.item.items.item.permissions.item.grant;
...
public class GrantRequestBuilder {
    ...
    public GrantRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}/microsoft.graph.grant";
