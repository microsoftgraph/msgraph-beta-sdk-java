package microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item;
...
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.replies.RepliesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
