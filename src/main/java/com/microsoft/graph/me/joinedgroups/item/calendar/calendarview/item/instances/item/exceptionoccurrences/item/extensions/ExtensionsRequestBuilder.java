package microsoft.graph.me.joinedgroups.item.calendar.calendarview.item.instances.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.me.joinedgroups.item.calendar.calendarview.item.instances.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
...
public class ExtensionsRequestBuilder {
    ...
    public ExtensionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
