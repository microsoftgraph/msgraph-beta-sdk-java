package microsoft.graph.me.joinedgroups.item.calendar.calendarview;
...
import microsoft.graph.me.joinedgroups.item.calendar.calendarview.count.CountRequestBuilder;
import microsoft.graph.me.joinedgroups.item.calendar.calendarview.delta.DeltaRequestBuilder;
...
public class CalendarViewRequestBuilder {
    ...
    public CalendarViewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
