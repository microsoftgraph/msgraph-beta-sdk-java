package microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item;
...
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.fromterm.FromTermRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.set.SetRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.item.parentgroup.sets.item.terms.item.children.item.relations.item.toterm.ToTermRequestBuilder;
...
public class RelationItemRequestBuilder {
    ...
    public RelationItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24select,%24expand}";
