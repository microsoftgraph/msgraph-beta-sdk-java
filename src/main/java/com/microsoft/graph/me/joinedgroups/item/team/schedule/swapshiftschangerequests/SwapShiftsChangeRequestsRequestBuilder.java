package microsoft.graph.me.joinedgroups.item.team.schedule.swapshiftschangerequests;
...
import microsoft.graph.me.joinedgroups.item.team.schedule.swapshiftschangerequests.count.CountRequestBuilder;
...
public class SwapShiftsChangeRequestsRequestBuilder {
    ...
    public SwapShiftsChangeRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
