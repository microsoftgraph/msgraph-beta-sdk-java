package microsoft.graph.me.joinedgroups.item.sites.item.termstore;
...
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.groups.GroupsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.groups.item.GroupItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.item.SetItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.sets.SetsRequestBuilder;
...
public class TermStoreRequestBuilder {
    ...
    public TermStoreRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.termStore.groups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.termStore.sets.item collection
     * @param id Unique identifier of the item
