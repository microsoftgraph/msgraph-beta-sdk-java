package microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item;
...
import microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item.hostedcontents.HostedContentsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item.hostedcontents.item.ChatMessageHostedContentItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item.replies.RepliesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item.softdelete.SoftDeleteRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.primarychannel.messages.item.undosoftdelete.UndoSoftDeleteRequestBuilder;
...
public class ChatMessageItemRequestBuilder {
    ...
    public ChatMessageItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.primaryChannel.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.team.primaryChannel.messages.item.replies.item collection
     * @param id Unique identifier of the item
