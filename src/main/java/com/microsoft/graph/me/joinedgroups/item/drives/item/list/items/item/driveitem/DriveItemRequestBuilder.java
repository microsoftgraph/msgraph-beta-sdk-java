package microsoft.graph.me.joinedgroups.item.drives.item.list.items.item.driveitem;
...
import microsoft.graph.me.joinedgroups.item.drives.item.list.items.item.driveitem.content.ContentRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    public DriveItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/driveItem{?%24select,%24expand}";
