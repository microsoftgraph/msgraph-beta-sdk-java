package microsoft.graph.me.joinedgroups.item.team.permissiongrants;
...
import microsoft.graph.me.joinedgroups.item.team.permissiongrants.count.CountRequestBuilder;
...
public class PermissionGrantsRequestBuilder {
    ...
    public PermissionGrantsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
