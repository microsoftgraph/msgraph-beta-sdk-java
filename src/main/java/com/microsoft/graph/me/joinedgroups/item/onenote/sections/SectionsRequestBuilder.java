package microsoft.graph.me.joinedgroups.item.onenote.sections;
...
import microsoft.graph.me.joinedgroups.item.onenote.sections.count.CountRequestBuilder;
...
public class SectionsRequestBuilder {
    ...
    public SectionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
