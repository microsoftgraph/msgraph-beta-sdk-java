package microsoft.graph.me.joinedgroups.item.drives.item.items.item;
...
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.analytics.AnalyticsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.children.ChildrenRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.content.ContentRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.listitem.ListItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.permissions.item.PermissionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.permissions.PermissionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.subscriptions.item.SubscriptionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.subscriptions.SubscriptionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.thumbnails.item.ThumbnailSetItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.thumbnails.ThumbnailsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.versions.item.DriveItemVersionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.versions.VersionsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.activities.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.children.item collection
     * @param id Unique identifier of the item
    ...
    public DriveItemItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item.items.item.versions.item collection
     * @param id Unique identifier of the item
