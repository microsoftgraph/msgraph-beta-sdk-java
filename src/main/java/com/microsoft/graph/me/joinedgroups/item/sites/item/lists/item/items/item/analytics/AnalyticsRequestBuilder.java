package microsoft.graph.me.joinedgroups.item.sites.item.lists.item.items.item.analytics;
...
public class AnalyticsRequestBuilder {
    ...
    public AnalyticsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/analytics{?%24select,%24expand}";
