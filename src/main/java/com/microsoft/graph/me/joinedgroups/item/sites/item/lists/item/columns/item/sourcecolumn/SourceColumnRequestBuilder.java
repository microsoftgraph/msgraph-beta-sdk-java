package microsoft.graph.me.joinedgroups.item.sites.item.lists.item.columns.item.sourcecolumn;
...
public class SourceColumnRequestBuilder {
    ...
    public SourceColumnRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}";
