package microsoft.graph.me.joinedgroups.item.onenote.notebooks.item;
...
import microsoft.graph.me.joinedgroups.item.onenote.notebooks.item.copynotebook.CopyNotebookRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.notebooks.item.sectiongroups.item.SectionGroupItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.notebooks.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.notebooks.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.notebooks.item.sections.SectionsRequestBuilder;
...
public class NotebookItemRequestBuilder {
    ...
    public NotebookItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.onenote.notebooks.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.onenote.notebooks.item.sections.item collection
     * @param id Unique identifier of the item
