package microsoft.graph.me.joinedgroups.item.threads.item.posts.item;
...
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.attachments.AttachmentsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.attachments.item.AttachmentItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.forward.ForwardRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.inreplyto.InReplyToRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.mentions.item.MentionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.mentions.MentionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.multivalueextendedproperties.item.MultiValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.multivalueextendedproperties.MultiValueExtendedPropertiesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.reply.ReplyRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.singlevalueextendedproperties.item.SingleValueLegacyExtendedPropertyItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.posts.item.singlevalueextendedproperties.SingleValueExtendedPropertiesRequestBuilder;
...
public class PostItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item.attachments.item collection
    ...
    public PostItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item.mentions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item.posts.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
