package microsoft.graph.me.joinedgroups.item.drives.item.list.items.item.documentsetversions;
...
import microsoft.graph.me.joinedgroups.item.drives.item.list.items.item.documentsetversions.count.CountRequestBuilder;
...
public class DocumentSetVersionsRequestBuilder {
    ...
    public DocumentSetVersionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
