package microsoft.graph.me.joinedgroups.item.events.item.exceptionoccurrences.item.singlevalueextendedproperties.count;
...
public class CountRequestBuilder {
    ...
    public CountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties/$count";
