package microsoft.graph.me.joinedgroups.item.sites.item;
...
import microsoft.graph.me.joinedgroups.item.sites.item.analytics.AnalyticsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.columns.ColumnsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.ContentTypesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.ContentTypeItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.drive.DriveRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.drives.DrivesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.drives.item.DriveItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.externalcolumns.ExternalColumnsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.items.item.BaseItemItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.items.ItemsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.ListItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.lists.ListsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.onenote.OnenoteRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.operations.item.RichLongRunningOperationItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.operations.OperationsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.pages.item.SitePageItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.pages.PagesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.permissions.item.PermissionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.permissions.PermissionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.sites.SitesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.termstore.TermStoreRequestBuilder;
...
public class SiteItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.sites.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.sites.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public SiteItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.contentTypes.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Delete navigation property sites for me
    ...
    /**
     * Update the navigation property sites in me
     * @param body 
     * @return a RequestInformation
     */
    @javax.annotation.Nonnull
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.drives.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.externalColumns.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.sites.item.externalcolumns.item.ColumnDefinitionItemRequestBuilder externalColumns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.sites.item.externalcolumns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * The list of SharePoint sites in this group. Access the default site with /sites/root.
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.items.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.lists.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.operations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.pages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.sites.item collection
     * @param id Unique identifier of the item
