package com.microsoft.graph.me.joinedgroups;

import com.microsoft.graph.me.joinedgroups.delta.DeltaRequestBuilder;
import com.microsoft.graph.me.joinedgroups.evaluatedynamicmembership.EvaluateDynamicMembershipRequestBuilder;
import com.microsoft.graph.me.joinedgroups.getbyids.GetByIdsRequestBuilder;
import com.microsoft.graph.me.joinedgroups.getuserownedobjects.GetUserOwnedObjectsRequestBuilder;
import com.microsoft.graph.me.joinedgroups.validateproperties.ValidatePropertiesRequestBuilder;
...
public class JoinedGroupsRequestBuilder extends BaseRequestBuilder {
    ...
    public JoinedGroupsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", pathParameters);
    }
    /**
     * Instantiates a new JoinedGroupsRequestBuilder and sets the default values.
    ...
    public JoinedGroupsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/joinedGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", rawUrl);
    }
    /**
