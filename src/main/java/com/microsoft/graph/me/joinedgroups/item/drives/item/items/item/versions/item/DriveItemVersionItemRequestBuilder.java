package microsoft.graph.me.joinedgroups.item.drives.item.items.item.versions.item;
...
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.versions.item.content.ContentRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.items.item.versions.item.restoreversion.RestoreVersionRequestBuilder;
...
public class DriveItemVersionItemRequestBuilder {
    ...
    public DriveItemVersionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
