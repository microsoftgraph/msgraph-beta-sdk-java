package microsoft.graph.me.joinedgroups.item.photo;
...
import microsoft.graph.me.joinedgroups.item.photo.value.ContentRequestBuilder;
...
public class PhotoRequestBuilder {
    ...
    public PhotoRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/photo{?%24select}";
