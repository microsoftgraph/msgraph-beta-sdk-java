package microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item;
...
import microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item.parentnotebook.ParentNotebookRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item.parentsectiongroup.ParentSectionGroupRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item.sectiongroups.SectionGroupsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item.sections.item.OnenoteSectionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.sectiongroups.item.sections.SectionsRequestBuilder;
...
public class SectionGroupItemRequestBuilder {
    ...
    public SectionGroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.onenote.sectionGroups.item.sectionGroups.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.onenote.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
