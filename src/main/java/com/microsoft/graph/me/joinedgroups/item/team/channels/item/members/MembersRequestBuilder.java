package microsoft.graph.me.joinedgroups.item.team.channels.item.members;
...
import microsoft.graph.me.joinedgroups.item.team.channels.item.members.add.AddRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.channels.item.members.count.CountRequestBuilder;
...
public class MembersRequestBuilder {
    ...
    public MembersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
