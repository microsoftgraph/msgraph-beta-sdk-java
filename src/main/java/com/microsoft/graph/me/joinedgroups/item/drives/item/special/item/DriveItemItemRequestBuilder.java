package microsoft.graph.me.joinedgroups.item.drives.item.special.item;
...
import microsoft.graph.me.joinedgroups.item.drives.item.special.item.content.ContentRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    public DriveItemItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/special/{driveItem%2Did}{?%24select,%24expand}";
