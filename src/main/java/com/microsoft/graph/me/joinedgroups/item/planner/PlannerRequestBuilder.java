package microsoft.graph.me.joinedgroups.item.planner;
...
import microsoft.graph.me.joinedgroups.item.planner.plans.item.PlannerPlanItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.plans.PlansRequestBuilder;
...
public class PlannerRequestBuilder {
    ...
    public PlannerRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.planner.plans.item collection
