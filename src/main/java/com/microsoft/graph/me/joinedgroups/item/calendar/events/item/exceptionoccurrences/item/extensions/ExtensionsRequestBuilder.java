package microsoft.graph.me.joinedgroups.item.calendar.events.item.exceptionoccurrences.item.extensions;
...
import microsoft.graph.me.joinedgroups.item.calendar.events.item.exceptionoccurrences.item.extensions.count.CountRequestBuilder;
...
public class ExtensionsRequestBuilder {
    ...
    public ExtensionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
