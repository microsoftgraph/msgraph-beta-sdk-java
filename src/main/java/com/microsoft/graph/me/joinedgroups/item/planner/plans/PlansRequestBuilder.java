package microsoft.graph.me.joinedgroups.item.planner.plans;
...
import microsoft.graph.me.joinedgroups.item.planner.plans.count.CountRequestBuilder;
...
public class PlansRequestBuilder {
    ...
    public PlansRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
