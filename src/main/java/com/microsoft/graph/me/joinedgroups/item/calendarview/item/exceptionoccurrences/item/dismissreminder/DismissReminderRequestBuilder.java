package microsoft.graph.me.joinedgroups.item.calendarview.item.exceptionoccurrences.item.dismissreminder;
...
public class DismissReminderRequestBuilder {
    ...
    public DismissReminderRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.dismissReminder";
