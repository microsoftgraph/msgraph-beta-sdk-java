package microsoft.graph.me.joinedgroups.item.calendarview;
...
import microsoft.graph.me.joinedgroups.item.calendarview.count.CountRequestBuilder;
import microsoft.graph.me.joinedgroups.item.calendarview.delta.DeltaRequestBuilder;
...
public class CalendarViewRequestBuilder {
    ...
    public CalendarViewRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
