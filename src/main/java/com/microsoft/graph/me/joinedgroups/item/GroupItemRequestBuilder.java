package microsoft.graph.me.joinedgroups.item;
...
import microsoft.graph.me.joinedgroups.item.acceptedsenders.AcceptedSendersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.approleassignments.AppRoleAssignmentsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.approleassignments.item.AppRoleAssignmentItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.calendar.CalendarRequestBuilder;
import microsoft.graph.me.joinedgroups.item.calendarview.CalendarViewRequestBuilder;
import microsoft.graph.me.joinedgroups.item.conversations.ConversationsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.conversations.item.ConversationItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.createdonbehalfof.CreatedOnBehalfOfRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drive.DriveRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.DrivesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.drives.item.DriveItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.endpoints.EndpointsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.endpoints.item.EndpointItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.events.EventsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.extensions.ExtensionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.extensions.item.ExtensionItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.grouplifecyclepolicies.GroupLifecyclePoliciesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.grouplifecyclepolicies.item.GroupLifecyclePolicyItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.memberof.MemberOfRequestBuilder;
import microsoft.graph.me.joinedgroups.item.members.MembersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.memberswithlicenseerrors.MembersWithLicenseErrorsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.onenote.OnenoteRequestBuilder;
import microsoft.graph.me.joinedgroups.item.owners.OwnersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.permissiongrants.item.ResourceSpecificPermissionGrantItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.permissiongrants.PermissionGrantsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.photo.PhotoRequestBuilder;
import microsoft.graph.me.joinedgroups.item.photos.item.ProfilePhotoItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.photos.PhotosRequestBuilder;
import microsoft.graph.me.joinedgroups.item.planner.PlannerRequestBuilder;
import microsoft.graph.me.joinedgroups.item.rejectedsenders.RejectedSendersRequestBuilder;
import microsoft.graph.me.joinedgroups.item.settings.item.DirectorySettingItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.settings.SettingsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.SiteItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.SitesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.team.TeamRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.item.ConversationThreadItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.threads.ThreadsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.transitivememberof.TransitiveMemberOfRequestBuilder;
import microsoft.graph.me.joinedgroups.item.transitivemembers.TransitiveMembersRequestBuilder;
...
public class GroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.acceptedSenders.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.acceptedsenders.item.DirectoryObjectItemRequestBuilder acceptedSenders(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.acceptedsenders.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.appRoleAssignments.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.calendarView.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.calendarview.item.EventItemRequestBuilder calendarView(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.calendarview.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public GroupItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}{?%24select}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.conversations.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.drives.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.endpoints.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.events.item collection
     * @param id Unique identifier of the item
     * @return a eventItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.events.item.EventItemRequestBuilder events(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("event%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.events.item.EventItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.groupLifecyclePolicies.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.memberOf.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.memberof.item.DirectoryObjectItemRequestBuilder memberOf(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.memberof.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.members.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.members.item.DirectoryObjectItemRequestBuilder members(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.members.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.membersWithLicenseErrors.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.memberswithlicenseerrors.item.DirectoryObjectItemRequestBuilder membersWithLicenseErrors(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.memberswithlicenseerrors.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.owners.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.owners.item.DirectoryObjectItemRequestBuilder owners(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.owners.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Update the navigation property joinedGroups in me
     * @param body 
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.permissionGrants.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.photos.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.rejectedSenders.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.rejectedsenders.item.DirectoryObjectItemRequestBuilder rejectedSenders(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.rejectedsenders.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.settings.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.threads.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.transitiveMemberOf.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.transitivememberof.item.DirectoryObjectItemRequestBuilder transitiveMemberOf(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.transitivememberof.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.transitiveMembers.item collection
     * @param id Unique identifier of the item
     * @return a directoryObjectItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.transitivemembers.item.DirectoryObjectItemRequestBuilder transitiveMembers(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("directoryObject%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.transitivemembers.item.DirectoryObjectItemRequestBuilder(urlTplParams, requestAdapter);
    }
