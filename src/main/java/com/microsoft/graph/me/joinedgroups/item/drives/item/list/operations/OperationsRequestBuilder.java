package microsoft.graph.me.joinedgroups.item.drives.item.list.operations;
...
import microsoft.graph.me.joinedgroups.item.drives.item.list.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
