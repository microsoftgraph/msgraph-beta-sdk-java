package microsoft.graph.me.joinedgroups.item.team.photo;
...
import microsoft.graph.me.joinedgroups.item.team.photo.value.ContentRequestBuilder;
...
public class PhotoRequestBuilder {
    ...
    public PhotoRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/photo{?%24select,%24expand}";
