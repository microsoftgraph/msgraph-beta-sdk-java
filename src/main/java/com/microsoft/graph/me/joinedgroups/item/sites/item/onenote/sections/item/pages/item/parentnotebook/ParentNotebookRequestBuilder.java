package microsoft.graph.me.joinedgroups.item.sites.item.onenote.sections.item.pages.item.parentnotebook;
...
public class ParentNotebookRequestBuilder {
    ...
    public ParentNotebookRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}";
