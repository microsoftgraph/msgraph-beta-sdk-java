package microsoft.graph.me.joinedgroups.item.team.allchannels;
...
import microsoft.graph.me.joinedgroups.item.team.allchannels.count.CountRequestBuilder;
...
public class AllChannelsRequestBuilder {
    ...
    public AllChannelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
