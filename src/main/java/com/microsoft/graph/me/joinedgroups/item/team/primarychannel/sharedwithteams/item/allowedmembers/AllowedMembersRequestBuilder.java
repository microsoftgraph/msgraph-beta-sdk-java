package microsoft.graph.me.joinedgroups.item.team.primarychannel.sharedwithteams.item.allowedmembers;
...
import microsoft.graph.me.joinedgroups.item.team.primarychannel.sharedwithteams.item.allowedmembers.count.CountRequestBuilder;
...
public class AllowedMembersRequestBuilder {
    ...
    public AllowedMembersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
