package microsoft.graph.me.joinedgroups.item.sites.item.lists.item.operations;
...
import microsoft.graph.me.joinedgroups.item.sites.item.lists.item.operations.count.CountRequestBuilder;
...
public class OperationsRequestBuilder {
    ...
    public OperationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
