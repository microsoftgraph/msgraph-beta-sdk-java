package microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item;
...
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.associatewithhubsites.AssociateWithHubSitesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.base.BaseRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.basetypes.BaseTypesRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columnlinks.ColumnLinksRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columnlinks.item.ColumnLinkItemRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columnpositions.ColumnPositionsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columns.ColumnsRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.copytodefaultcontentlocation.CopyToDefaultContentLocationRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.ispublished.IsPublishedRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.publish.PublishRequestBuilder;
import microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.unpublish.UnpublishRequestBuilder;
...
public class ContentTypeItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.contentTypes.item.baseTypes.item collection
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.contentTypes.item.columnLinks.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.contentTypes.item.columnPositions.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder columnPositions(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columnpositions.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Gets an item from the Microsoft.Graph.me.joinedGroups.item.sites.item.contentTypes.item.columns.item collection
     * @param id Unique identifier of the item
     * @return a columnDefinitionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder columns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        var urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("columnDefinition%2Did", id);
        return new microsoft.graph.me.joinedgroups.item.sites.item.contenttypes.item.columns.item.ColumnDefinitionItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public ContentTypeItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}";
