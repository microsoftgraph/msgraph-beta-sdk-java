package microsoft.graph.me.joinedgroups.item.team.schedule.openshiftchangerequests;
...
import microsoft.graph.me.joinedgroups.item.team.schedule.openshiftchangerequests.count.CountRequestBuilder;
...
public class OpenShiftChangeRequestsRequestBuilder {
    ...
    public OpenShiftChangeRequestsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
