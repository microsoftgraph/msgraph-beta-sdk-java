...
import microsoft.graph.me.transitivememberof.item.user.activateserviceplan.ActivateServicePlanRequestBuilder;
...
import microsoft.graph.me.transitivememberof.item.user.exportdeviceandappmanagementdata.ExportDeviceAndAppManagementDataRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.exportdeviceandappmanagementdatawithskipwithtop.ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder;
...
import microsoft.graph.me.transitivememberof.item.user.findroomlists.FindRoomListsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.findrooms.FindRoomsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.findroomswithroomlist.FindRoomsWithRoomListRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.geteffectivedeviceenrollmentconfigurations.GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getloggedonmanageddevices.GetLoggedOnManagedDevicesRequestBuilder;
...
import microsoft.graph.me.transitivememberof.item.user.getmanageddeviceswithappfailures.GetManagedDevicesWithAppFailuresRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.getmanageddeviceswithfailedorpendingapps.GetManagedDevicesWithFailedOrPendingAppsRequestBuilder;
...
import microsoft.graph.me.transitivememberof.item.user.invalidateallrefreshtokens.InvalidateAllRefreshTokensRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.ismanagedappuserblocked.IsManagedAppUserBlockedRequestBuilder;
...
import microsoft.graph.me.transitivememberof.item.user.unblockmanagedapps.UnblockManagedAppsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.wipeandblockmanagedapps.WipeAndBlockManagedAppsRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.wipemanagedappregistrationbydevicetag.WipeManagedAppRegistrationByDeviceTagRequestBuilder;
import microsoft.graph.me.transitivememberof.item.user.wipemanagedappregistrationsbyazureaddeviceid.WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder;
