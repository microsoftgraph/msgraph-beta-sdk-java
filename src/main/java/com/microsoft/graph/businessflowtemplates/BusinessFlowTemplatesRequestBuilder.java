...
public class BusinessFlowTemplatesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final BusinessFlowTemplate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<BusinessFlowTemplateCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessFlowTemplateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<BusinessFlowTemplateCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<BusinessFlowTemplate> post(@javax.annotation.Nonnull final BusinessFlowTemplate body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<BusinessFlowTemplate> executionException = new java.util.concurrent.CompletableFuture<BusinessFlowTemplate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
