...
public class RenewGroupRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a renewGroupRequestBody
     */
    @javax.annotation.Nonnull
    public static RenewGroupRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final RenewGroupRequestBody currentObject = this;
