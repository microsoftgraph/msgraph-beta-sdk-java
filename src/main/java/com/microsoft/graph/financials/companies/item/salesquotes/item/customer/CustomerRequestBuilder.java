package microsoft.graph.financials.companies.item.salesquotes.item.customer;
...
import microsoft.graph.financials.companies.item.salesquotes.item.customer.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.salesquotes.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import microsoft.graph.financials.companies.item.salesquotes.item.customer.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.salesquotes.item.customer.picture.item.PictureItemRequestBuilder;
import microsoft.graph.financials.companies.item.salesquotes.item.customer.picture.PictureRequestBuilder;
import microsoft.graph.financials.companies.item.salesquotes.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.financials.companies.item.salesQuotes.item.customer.picture.item collection
