package microsoft.graph.financials.companies.item.salesinvoices.item.customer.picture.item;
...
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.picture.item.content.ContentRequestBuilder;
