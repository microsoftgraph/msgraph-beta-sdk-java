...
public class UnitsOfMeasureRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UnitOfMeasure body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UnitOfMeasureCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<UnitOfMeasureCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<UnitOfMeasureCollectionResponse>();
