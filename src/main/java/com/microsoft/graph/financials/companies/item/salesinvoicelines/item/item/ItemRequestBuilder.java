package com.microsoft.graph.financials.companies.item.salesinvoicelines.item.item;

import com.microsoft.graph.financials.companies.item.salesinvoicelines.item.item.itemcategory.ItemCategoryRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesinvoicelines.item.item.picture.PictureRequestBuilder;
