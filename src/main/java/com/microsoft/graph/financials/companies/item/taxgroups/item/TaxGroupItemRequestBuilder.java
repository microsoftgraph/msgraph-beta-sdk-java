...
public class TaxGroupItemRequestBuilder {
     ...
     * @return a CompletableFuture of taxGroup
     */
    public java.util.concurrent.CompletableFuture<TaxGroup> patch(@javax.annotation.Nonnull final TaxGroup body, @javax.annotation.Nullable final java.util.function.Consumer<TaxGroupItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
