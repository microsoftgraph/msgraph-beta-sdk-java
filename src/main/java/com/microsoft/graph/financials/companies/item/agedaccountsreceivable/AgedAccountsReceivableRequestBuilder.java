...
public class AgedAccountsReceivableRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the agedAccountsReceivable property of the microsoft.graph.company entity.
     * @param agedAccountsReceivableId Unique identifier of the item
    ...
    public java.util.concurrent.CompletableFuture<AgedAccountsReceivableCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AgedAccountsReceivableCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AgedAccountsReceivableCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AgedAccountsReceivableCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
