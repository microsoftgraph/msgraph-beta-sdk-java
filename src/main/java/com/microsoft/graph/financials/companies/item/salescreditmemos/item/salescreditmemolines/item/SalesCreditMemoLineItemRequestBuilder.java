package microsoft.graph.financials.companies.item.salescreditmemos.item.salescreditmemolines.item;
...
import microsoft.graph.financials.companies.item.salescreditmemos.item.salescreditmemolines.item.account.AccountRequestBuilder;
import microsoft.graph.financials.companies.item.salescreditmemos.item.salescreditmemolines.item.item.ItemRequestBuilder;
