package com.microsoft.graph.financials.companies.item.salesorders.item.customer;

import com.microsoft.graph.financials.companies.item.salesorders.item.customer.currency.CurrencyRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesorders.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesorders.item.customer.paymentterm.PaymentTermRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesorders.item.customer.picture.item.PictureItemRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesorders.item.customer.picture.PictureRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesorders.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.financials.companies.item.salesOrders.item.customer.picture.item collection
