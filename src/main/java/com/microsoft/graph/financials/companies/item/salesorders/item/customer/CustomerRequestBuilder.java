package microsoft.graph.financials.companies.item.salesorders.item.customer;
...
import microsoft.graph.financials.companies.item.salesorders.item.customer.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.picture.item.PictureItemRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.picture.PictureRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.financials.companies.item.salesOrders.item.customer.picture.item collection
