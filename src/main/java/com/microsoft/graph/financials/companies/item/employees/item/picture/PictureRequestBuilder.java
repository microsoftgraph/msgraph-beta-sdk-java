package com.microsoft.graph.financials.companies.item.employees.item.picture;

import com.microsoft.graph.financials.companies.item.employees.item.picture.count.CountRequestBuilder;
import com.microsoft.graph.financials.companies.item.employees.item.picture.item.PictureItemRequestBuilder;
...
public class PictureRequestBuilder extends BaseRequestBuilder {
    ...
    public PictureRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/employees/{employee%2Did}/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PictureRequestBuilder and sets the default values.
    ...
    public PictureRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/employees/{employee%2Did}/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
