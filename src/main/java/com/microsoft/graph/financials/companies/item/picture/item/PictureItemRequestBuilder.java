package microsoft.graph.financials.companies.item.picture.item;
...
import microsoft.graph.financials.companies.item.picture.item.content.ContentRequestBuilder;
