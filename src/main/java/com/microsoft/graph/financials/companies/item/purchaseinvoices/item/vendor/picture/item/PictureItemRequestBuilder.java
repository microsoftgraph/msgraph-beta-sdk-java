package microsoft.graph.financials.companies.item.purchaseinvoices.item.vendor.picture.item;
...
import microsoft.graph.financials.companies.item.purchaseinvoices.item.vendor.picture.item.content.ContentRequestBuilder;
