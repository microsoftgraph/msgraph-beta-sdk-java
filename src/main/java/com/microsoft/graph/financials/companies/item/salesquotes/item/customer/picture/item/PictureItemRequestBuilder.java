package microsoft.graph.financials.companies.item.salesquotes.item.customer.picture.item;
...
import microsoft.graph.financials.companies.item.salesquotes.item.customer.picture.item.content.ContentRequestBuilder;
