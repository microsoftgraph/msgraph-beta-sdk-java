package microsoft.graph.financials.companies.item.salesinvoices.item.salesinvoicelines.item.item.picture.item;
...
import microsoft.graph.financials.companies.item.salesinvoices.item.salesinvoicelines.item.item.picture.item.content.ContentRequestBuilder;
