package microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments;
...
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.count.CountRequestBuilder;
