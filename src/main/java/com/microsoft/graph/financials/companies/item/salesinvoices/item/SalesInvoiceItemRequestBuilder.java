...
public class SalesInvoiceItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SalesInvoice body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SalesInvoice> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SalesInvoice> executionException = new java.util.concurrent.CompletableFuture<SalesInvoice>();
