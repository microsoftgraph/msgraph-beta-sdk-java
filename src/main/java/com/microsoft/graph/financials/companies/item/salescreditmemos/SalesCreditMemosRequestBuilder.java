...
public class SalesCreditMemosRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse>();
