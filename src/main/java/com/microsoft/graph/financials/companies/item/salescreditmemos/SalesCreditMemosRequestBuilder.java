...
public class SalesCreditMemosRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the salesCreditMemos property of the microsoft.graph.company entity.
     * @param salesCreditMemoId Unique identifier of the item
    ...
    public java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SalesCreditMemoCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<SalesCreditMemoCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
