 ...
 */
public class DimensionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public DimensionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/dimensions/{dimension%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new DimensionItemRequestBuilder and sets the default values.
    ...
    public DimensionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/dimensions/{dimension%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
     * Provides operations to manage the dimensionValues property of the microsoft.graph.dimension entity.
    ...
    public java.util.concurrent.CompletableFuture<Dimension> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, Dimension::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<Dimension> executionException = new java.util.concurrent.CompletableFuture<Dimension>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Dimension> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
