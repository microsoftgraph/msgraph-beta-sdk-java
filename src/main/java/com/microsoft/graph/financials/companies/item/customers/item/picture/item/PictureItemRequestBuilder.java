package microsoft.graph.financials.companies.item.customers.item.picture.item;
...
import microsoft.graph.financials.companies.item.customers.item.picture.item.content.ContentRequestBuilder;
