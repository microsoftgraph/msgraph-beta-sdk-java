package microsoft.graph.financials.companies.item.vendors.item.picture.item;
...
import microsoft.graph.financials.companies.item.vendors.item.picture.item.content.ContentRequestBuilder;
