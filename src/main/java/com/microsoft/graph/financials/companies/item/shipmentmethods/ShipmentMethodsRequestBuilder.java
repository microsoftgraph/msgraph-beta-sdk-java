...
public class ShipmentMethodsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final ShipmentMethod body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ShipmentMethodCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ShipmentMethodCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<ShipmentMethodCollectionResponse>();
