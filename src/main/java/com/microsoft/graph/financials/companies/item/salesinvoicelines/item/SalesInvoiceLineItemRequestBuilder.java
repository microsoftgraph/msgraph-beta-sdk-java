...
public class SalesInvoiceLineItemRequestBuilder {
     ...
     * @return a CompletableFuture of salesInvoiceLine
     */
    public java.util.concurrent.CompletableFuture<SalesInvoiceLine> patch(@javax.annotation.Nonnull final SalesInvoiceLine body, @javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
