package microsoft.graph.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item.picture.item;
...
import microsoft.graph.financials.companies.item.purchaseinvoices.item.purchaseinvoicelines.item.item.picture.item.content.ContentRequestBuilder;
