...
public class PurchaseInvoiceItemRequestBuilder {
     ...
     * @return a CompletableFuture of purchaseInvoice
     */
    public java.util.concurrent.CompletableFuture<PurchaseInvoice> patch(@javax.annotation.Nonnull final PurchaseInvoice body, @javax.annotation.Nullable final java.util.function.Consumer<PurchaseInvoiceItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of purchaseInvoice
     */
    public java.util.concurrent.CompletableFuture<PurchaseInvoice> patch(@javax.annotation.Nonnull final PurchaseInvoice body, @javax.annotation.Nullable final java.util.function.Consumer<PurchaseInvoiceItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
