package com.microsoft.graph.financials.companies.item.salescreditmemolines.item.account;
...
public class AccountRequestBuilder {
    ...
    public AccountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/account{?%24select,%24expand}";
