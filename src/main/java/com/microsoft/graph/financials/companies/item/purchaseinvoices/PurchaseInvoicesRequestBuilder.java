...
public class PurchaseInvoicesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the purchaseInvoices property of the microsoft.graph.company entity.
     * @param purchaseInvoiceId Unique identifier of the item
    ...
    public java.util.concurrent.CompletableFuture<PurchaseInvoiceCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<PurchaseInvoiceCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<PurchaseInvoiceCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PurchaseInvoiceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
