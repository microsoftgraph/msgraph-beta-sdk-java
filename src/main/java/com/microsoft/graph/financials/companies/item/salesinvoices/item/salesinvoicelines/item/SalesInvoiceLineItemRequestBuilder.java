package microsoft.graph.financials.companies.item.salesinvoices.item.salesinvoicelines.item;
...
import microsoft.graph.financials.companies.item.salesinvoices.item.salesinvoicelines.item.account.AccountRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.salesinvoicelines.item.item.ItemRequestBuilder;
...
public class SalesInvoiceLineItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SalesInvoiceLineItemRequestBuilderDeleteRequestConfiguration requestConfig = new SalesInvoiceLineItemRequestBuilderDeleteRequestConfiguration();
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of salesInvoiceLine
     */
    public java.util.concurrent.CompletableFuture<SalesInvoiceLine> get(@javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesInvoiceLine body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesInvoiceLine body, @javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesInvoiceLine body, @javax.annotation.Nullable final java.util.function.Consumer<SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
