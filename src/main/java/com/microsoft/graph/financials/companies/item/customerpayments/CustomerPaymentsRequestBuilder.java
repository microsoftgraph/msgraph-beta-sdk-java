...
public class CustomerPaymentsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final CustomerPayment body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<CustomerPaymentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CustomerPaymentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CustomerPaymentCollectionResponse>();
