package microsoft.graph.financials.companies.item.customerpayments;
...
import microsoft.graph.financials.companies.item.customerpayments.count.CountRequestBuilder;
import microsoft.graph.models.CustomerPayment;
import microsoft.graph.models.CustomerPaymentCollectionResponse;
...
public class CustomerPaymentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CustomerPaymentCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CustomerPaymentCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of CustomerPaymentCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<CustomerPaymentCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<CustomerPaymentsRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, CustomerPaymentCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of customerPayment
     */
    public java.util.concurrent.CompletableFuture<CustomerPayment> post(@javax.annotation.Nonnull final CustomerPayment body, @javax.annotation.Nullable final java.util.function.Consumer<CustomerPaymentsRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
