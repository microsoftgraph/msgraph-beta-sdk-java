package microsoft.graph.financials.companies.item.salesorders.item.customer.picture.item;
...
import microsoft.graph.financials.companies.item.salesorders.item.customer.picture.item.content.ContentRequestBuilder;
