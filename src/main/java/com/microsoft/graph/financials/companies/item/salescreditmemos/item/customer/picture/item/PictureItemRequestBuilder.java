package microsoft.graph.financials.companies.item.salescreditmemos.item.customer.picture.item;
...
import microsoft.graph.financials.companies.item.salescreditmemos.item.customer.picture.item.content.ContentRequestBuilder;
