...
public class PictureItemRequestBuilder {
     ...
     * @return a CompletableFuture of picture
     */
    public java.util.concurrent.CompletableFuture<Picture> patch(@javax.annotation.Nonnull final Picture body, @javax.annotation.Nullable final java.util.function.Consumer<PictureItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of picture
     */
    public java.util.concurrent.CompletableFuture<Picture> patch(@javax.annotation.Nonnull final Picture body, @javax.annotation.Nullable final java.util.function.Consumer<PictureItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
