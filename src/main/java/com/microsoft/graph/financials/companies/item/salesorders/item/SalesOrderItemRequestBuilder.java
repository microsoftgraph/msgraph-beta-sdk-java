package microsoft.graph.financials.companies.item.salesorders.item;
...
import microsoft.graph.financials.companies.item.salesorders.item.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.customer.CustomerRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.salesorderlines.item.SalesOrderLineItemRequestBuilder;
import microsoft.graph.financials.companies.item.salesorders.item.salesorderlines.SalesOrderLinesRequestBuilder;
...
public class SalesOrderItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createDeleteRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SalesOrderItemRequestBuilderDeleteRequestConfiguration requestConfig = new SalesOrderItemRequestBuilderDeleteRequestConfiguration();
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> delete(@javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createDeleteRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
    ...
    public java.util.concurrent.CompletableFuture<SalesOrder> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SalesOrder::createFromDiscriminatorValue, null, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of salesOrder
     */
    public java.util.concurrent.CompletableFuture<SalesOrder> get(@javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, SalesOrder::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesOrder body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesOrder body, @javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesOrder body, @javax.annotation.Nullable final java.util.function.Consumer<SalesOrderItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
