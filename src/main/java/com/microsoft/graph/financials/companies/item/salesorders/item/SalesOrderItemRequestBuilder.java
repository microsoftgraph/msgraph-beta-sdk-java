...
public class SalesOrderItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SalesOrder body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SalesOrder> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SalesOrder> executionException = new java.util.concurrent.CompletableFuture<SalesOrder>();
