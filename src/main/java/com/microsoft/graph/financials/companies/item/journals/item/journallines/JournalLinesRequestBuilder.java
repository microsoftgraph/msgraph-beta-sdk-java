package microsoft.graph.financials.companies.item.journals.item.journallines;
...
import microsoft.graph.financials.companies.item.journals.item.journallines.count.CountRequestBuilder;
import microsoft.graph.models.JournalLine;
import microsoft.graph.models.JournalLineCollectionResponse;
...
public class JournalLinesRequestBuilder {
    ...
    public JournalLinesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
    ...
    public java.util.concurrent.CompletableFuture<JournalLineCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, JournalLineCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
     ...
     * @return a CompletableFuture of JournalLineCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<JournalLineCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<JournalLinesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
            ...
            return this.requestAdapter.sendAsync(requestInfo, JournalLineCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of journalLine
     */
    public java.util.concurrent.CompletableFuture<JournalLine> post(@javax.annotation.Nonnull final JournalLine body, @javax.annotation.Nullable final java.util.function.Consumer<JournalLinesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
