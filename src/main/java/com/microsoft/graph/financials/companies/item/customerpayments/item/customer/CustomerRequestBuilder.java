package microsoft.graph.financials.companies.item.customerpayments.item.customer;
...
import microsoft.graph.financials.companies.item.customerpayments.item.customer.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.customerpayments.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import microsoft.graph.financials.companies.item.customerpayments.item.customer.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.customerpayments.item.customer.picture.item.PictureItemRequestBuilder;
import microsoft.graph.financials.companies.item.customerpayments.item.customer.picture.PictureRequestBuilder;
import microsoft.graph.financials.companies.item.customerpayments.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder {
    ...
    public CustomerRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/financials/companies/{company%2Did}/customerPayments/{customerPayment%2Did}/customer{?%24select,%24expand}";
    ...
    /**
     * Gets an item from the Microsoft.Graph.financials.companies.item.customerPayments.item.customer.picture.item collection
