...
public class SalesQuoteItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SalesQuote> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SalesQuote::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            return new java.util.concurrent.CompletableFuture<SalesQuote>() {{
