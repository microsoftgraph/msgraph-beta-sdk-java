...
public class SalesQuoteItemRequestBuilder {
     ...
     * @return a CompletableFuture of salesQuote
     */
    public java.util.concurrent.CompletableFuture<SalesQuote> patch(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of salesQuote
     */
    public java.util.concurrent.CompletableFuture<SalesQuote> patch(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
