...
public class SalesQuoteItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createGetRequestInformation(@javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderGetRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SalesQuoteItemRequestBuilderGetRequestConfiguration requestConfig = new SalesQuoteItemRequestBuilderGetRequestConfiguration();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SalesQuote body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        ...
        if (requestConfiguration != null) {
            final SalesQuoteItemRequestBuilderPatchRequestConfiguration requestConfig = new SalesQuoteItemRequestBuilderPatchRequestConfiguration();
            requestConfiguration.accept(requestConfig);
            requestInfo.addRequestHeaders(requestConfig.headers);
            requestInfo.addRequestOptions(requestConfig.options);
        }
     ...
     * @return a CompletableFuture of salesQuote
     */
    public java.util.concurrent.CompletableFuture<SalesQuote> get(@javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of salesQuote
     */
    public java.util.concurrent.CompletableFuture<SalesQuote> get(@javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesQuote body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<SalesQuoteItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
