...
public class SalesQuoteItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final SalesQuote body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<SalesQuote> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<SalesQuote> executionException = new java.util.concurrent.CompletableFuture<SalesQuote>();
