package com.microsoft.graph.financials.companies.item.purchaseinvoicelines.item;

import com.microsoft.graph.financials.companies.item.purchaseinvoicelines.item.account.AccountRequestBuilder;
import com.microsoft.graph.financials.companies.item.purchaseinvoicelines.item.item.ItemRequestBuilder;
