package microsoft.graph.financials.companies.item.salesquotelines.item.item.picture.item;
...
import microsoft.graph.financials.companies.item.salesquotelines.item.item.picture.item.content.ContentRequestBuilder;
