...
public class CustomerRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Customer body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Customer> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Customer> executionException = new java.util.concurrent.CompletableFuture<Customer>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
