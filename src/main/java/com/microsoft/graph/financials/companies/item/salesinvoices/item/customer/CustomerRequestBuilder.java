...
public class CustomerRequestBuilder {
     ...
     * @return a CompletableFuture of customer
     */
    public java.util.concurrent.CompletableFuture<Customer> patch(@javax.annotation.Nonnull final Customer body, @javax.annotation.Nullable final java.util.function.Consumer<CustomerRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
