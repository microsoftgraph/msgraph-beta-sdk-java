package microsoft.graph.financials.companies.item.salesinvoices.item.customer;
...
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.picture.item.PictureItemRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.picture.PictureRequestBuilder;
import microsoft.graph.financials.companies.item.salesinvoices.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.financials.companies.item.salesInvoices.item.customer.picture.item collection
