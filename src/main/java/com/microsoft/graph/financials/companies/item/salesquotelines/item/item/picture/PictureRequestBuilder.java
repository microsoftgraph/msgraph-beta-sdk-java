package com.microsoft.graph.financials.companies.item.salesquotelines.item.item.picture;

import com.microsoft.graph.financials.companies.item.salesquotelines.item.item.picture.count.CountRequestBuilder;
import com.microsoft.graph.financials.companies.item.salesquotelines.item.item.picture.item.PictureItemRequestBuilder;
...
public class PictureRequestBuilder extends BaseRequestBuilder {
    ...
    public PictureRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesQuoteLines/{salesQuoteLine%2Did}/item/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new PictureRequestBuilder and sets the default values.
    ...
    public PictureRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesQuoteLines/{salesQuoteLine%2Did}/item/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
