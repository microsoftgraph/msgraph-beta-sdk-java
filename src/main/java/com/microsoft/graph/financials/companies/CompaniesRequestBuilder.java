...
public class CompaniesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CompanyCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
