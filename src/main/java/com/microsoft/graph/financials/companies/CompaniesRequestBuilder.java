...
public class CompaniesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CompanyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<CompanyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CompanyCollectionResponse>();
