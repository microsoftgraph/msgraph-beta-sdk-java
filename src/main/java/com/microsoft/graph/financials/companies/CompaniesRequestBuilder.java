...
public class CompaniesRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<CompanyCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, CompanyCollectionResponse::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<CompanyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<CompanyCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<CompanyCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
