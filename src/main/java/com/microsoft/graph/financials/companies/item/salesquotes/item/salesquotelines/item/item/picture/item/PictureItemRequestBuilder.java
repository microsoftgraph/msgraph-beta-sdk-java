package microsoft.graph.financials.companies.item.salesquotes.item.salesquotelines.item.item.picture.item;
...
import microsoft.graph.financials.companies.item.salesquotes.item.salesquotelines.item.item.picture.item.content.ContentRequestBuilder;
