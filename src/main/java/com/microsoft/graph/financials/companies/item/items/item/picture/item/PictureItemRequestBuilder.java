package microsoft.graph.financials.companies.item.items.item.picture.item;
...
import microsoft.graph.financials.companies.item.items.item.picture.item.content.ContentRequestBuilder;
