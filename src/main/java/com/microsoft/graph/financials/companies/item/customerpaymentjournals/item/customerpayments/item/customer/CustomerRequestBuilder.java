...
public class CustomerRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.financials.companies.item.customerPaymentJournals.item.customerPayments.item.customer.picture.item collection
