package com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer;

import com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.currency.CurrencyRequestBuilder;
import com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.paymentterm.PaymentTermRequestBuilder;
import com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.picture.PictureRequestBuilder;
import com.microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
...
public class CustomerRequestBuilder extends BaseRequestBuilder {
    ...
    public CustomerRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}/customerPayments/{customerPayment%2Did}/customer{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new CustomerRequestBuilder and sets the default values.
    ...
    public CustomerRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}/customerPayments/{customerPayment%2Did}/customer{?%24select,%24expand}", rawUrl);
    }
    /**
