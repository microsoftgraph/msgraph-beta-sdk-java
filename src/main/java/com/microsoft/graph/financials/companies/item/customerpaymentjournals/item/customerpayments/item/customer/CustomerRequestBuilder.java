package microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer;
...
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.currency.CurrencyRequestBuilder;
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.paymentmethod.PaymentMethodRequestBuilder;
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.paymentterm.PaymentTermRequestBuilder;
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.picture.item.PictureItemRequestBuilder;
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.picture.PictureRequestBuilder;
import microsoft.graph.financials.companies.item.customerpaymentjournals.item.customerpayments.item.customer.shipmentmethod.ShipmentMethodRequestBuilder;
