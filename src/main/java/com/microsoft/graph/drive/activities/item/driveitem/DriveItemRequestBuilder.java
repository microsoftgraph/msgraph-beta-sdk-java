package com.microsoft.graph.drive.activities.item.driveitem;

import com.microsoft.graph.drive.activities.item.driveitem.content.ContentRequestBuilder;
...
public class DriveItemRequestBuilder {
    ...
    public DriveItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
