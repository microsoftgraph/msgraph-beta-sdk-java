package microsoft.graph.drive.list.items.item.activities.item.driveitem;
...
import microsoft.graph.drive.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
