package com.microsoft.graph.drive.list.items.item.activities.item.driveitem;

import com.microsoft.graph.drive.list.items.item.activities.item.driveitem.content.ContentRequestBuilder;
