...
import microsoft.graph.drive.activities.ActivitiesRequestBuilder;
import microsoft.graph.drive.activities.item.ItemActivityOLDItemRequestBuilder;
...
public class DriveRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.activities.item collection
