package com.microsoft.graph.drive.items.item.listitem.activities.item.listitem;
...
public class ListItemRequestBuilder {
    ...
    public ListItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
