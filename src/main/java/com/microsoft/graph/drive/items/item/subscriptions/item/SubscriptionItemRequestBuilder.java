package com.microsoft.graph.drive.items.item.subscriptions.item;

import com.microsoft.graph.drive.items.item.subscriptions.item.reauthorize.ReauthorizeRequestBuilder;
