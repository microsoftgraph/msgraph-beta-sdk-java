package microsoft.graph.drive.items.item.listitem.activities.item.driveitem;
...
import microsoft.graph.drive.items.item.listitem.activities.item.driveitem.content.ContentRequestBuilder;
