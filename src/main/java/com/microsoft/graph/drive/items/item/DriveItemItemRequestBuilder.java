...
import microsoft.graph.drive.items.item.activities.ActivitiesRequestBuilder;
import microsoft.graph.drive.items.item.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.drive.items.item.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.items.item.activities.item collection
