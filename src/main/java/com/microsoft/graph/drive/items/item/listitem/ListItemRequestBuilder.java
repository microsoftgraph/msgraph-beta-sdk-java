...
import com.microsoft.graph.drive.items.item.listitem.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drive.items.item.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.items.item.listItem.activities.item collection
