...
import microsoft.graph.drive.items.item.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.drive.items.item.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.drive.items.item.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.drive.items.item.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.items.item.listItem.activities.item collection
