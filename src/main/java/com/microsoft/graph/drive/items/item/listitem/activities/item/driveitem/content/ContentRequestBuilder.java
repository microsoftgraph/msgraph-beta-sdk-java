package com.microsoft.graph.drive.items.item.listitem.activities.item.driveitem.content;
...
public class ContentRequestBuilder {
    ...
    public ContentRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem/content";
