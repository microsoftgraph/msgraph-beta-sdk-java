...
import microsoft.graph.drive.root.listitem.activities.ActivitiesRequestBuilder;
import microsoft.graph.drive.root.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import microsoft.graph.drive.root.listitem.analytics.AnalyticsRequestBuilder;
import microsoft.graph.drive.root.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the Microsoft.Graph.drive.root.listItem.activities.item collection
