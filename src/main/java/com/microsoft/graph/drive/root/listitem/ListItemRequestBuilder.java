...
import com.microsoft.graph.drive.root.listitem.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.drive.root.listitem.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.drive.root.listitem.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drive.root.listitem.createlink.CreateLinkRequestBuilder;
...
public class ListItemRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.root.listItem.activities.item collection
