...
import microsoft.graph.drive.root.activities.ActivitiesRequestBuilder;
import microsoft.graph.drive.root.activities.item.ItemActivityOLDItemRequestBuilder;
...
import microsoft.graph.drive.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
