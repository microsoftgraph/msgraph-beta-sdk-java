...
import com.microsoft.graph.drive.root.activities.ActivitiesRequestBuilder;
import com.microsoft.graph.drive.root.activities.item.ItemActivityOLDItemRequestBuilder;
import com.microsoft.graph.drive.root.analytics.AnalyticsRequestBuilder;
import com.microsoft.graph.drive.root.assignsensitivitylabel.AssignSensitivityLabelRequestBuilder;
...
import com.microsoft.graph.drive.root.extractsensitivitylabels.ExtractSensitivityLabelsRequestBuilder;
...
public class RootRequestBuilder {
    ...
    /**
     * Gets an item from the com.Microsoft.Graph.drive.root.activities.item collection
