...
public class MessageRecipientItemRequestBuilder extends BaseRequestBuilder {
    ...
    public MessageRecipientItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/messageRecipients/{messageRecipient%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MessageRecipientItemRequestBuilder and sets the default values.
    ...
    public MessageRecipientItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/messageRecipients/{messageRecipient%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<MessageRecipient> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<MessageRecipient> executionException = new java.util.concurrent.CompletableFuture<MessageRecipient>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MessageRecipient> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MessageRecipient> patch(@javax.annotation.Nonnull final MessageRecipient body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final MessageRecipient body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final MessageRecipient body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
