...
import com.microsoft.graph.managedtenants.requests.DeviceCompliancePolicySettingStateSummaryCollectionResponse;
import com.microsoft.graph.managedtenants.requests.DeviceCompliancePolicySettingStateSummaryCollectionRequestBuilder;
import com.microsoft.graph.managedtenants.requests.DeviceCompliancePolicySettingStateSummaryCollectionRequest;
...
public class DeviceCompliancePolicySettingStateSummaryCollectionRequest extends BaseEntityCollectionRequest<DeviceCompliancePolicySettingStateSummary, DeviceCompliancePolicySettingStateSummaryCollectionResponse, DeviceCompliancePolicySettingStateSummaryCollectionPage> {
    ...
    public java.util.concurrent.CompletableFuture<DeviceCompliancePolicySettingStateSummary> postAsync(@Nonnull final DeviceCompliancePolicySettingStateSummary newDeviceCompliancePolicySettingStateSummary) {
        ...
        return new DeviceCompliancePolicySettingStateSummaryRequestBuilder(requestUrl, getBaseRequest().getClient(), /* Options */ null)
            ...
            .postAsync(newDeviceCompliancePolicySettingStateSummary);
    }
