...
import com.microsoft.graph.managedtenants.models.RoleDefinition;
 ...
 */
public class RoleAssignment implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<RoleDefinition> roles;
