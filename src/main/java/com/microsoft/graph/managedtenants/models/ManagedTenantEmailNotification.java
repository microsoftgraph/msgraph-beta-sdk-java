...
import com.microsoft.graph.managedtenants.models.Email;
...
/**
 * The class for the Managed Tenant Email Notification.
 */
public class ManagedTenantEmailNotification extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<Email> emailAddresses;

    /**
     * The Email Body.
     * 
     */
    @SerializedName(value = "emailBody", alternate = {"EmailBody"})
    @Expose
	@Nullable
