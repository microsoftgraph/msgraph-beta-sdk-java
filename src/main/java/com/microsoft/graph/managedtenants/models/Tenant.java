...
import com.microsoft.graph.managedtenants.models.TenantContract;
import com.microsoft.graph.managedtenants.models.TenantStatusInformation;
...
/**
 * The class for the Tenant.
 */
public class Tenant extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public TenantStatusInformation tenantStatusInformation;
