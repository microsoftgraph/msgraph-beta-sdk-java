...
/**
 * The class for the Conditional Access Policy Coverage.
 */
public class ConditionalAccessPolicyCoverage extends Entity implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.time.OffsetDateTime latestPolicyModifiedDateTime;
    ...
    @Expose
	@Nullable
    public Boolean requiresDeviceCompliance;
