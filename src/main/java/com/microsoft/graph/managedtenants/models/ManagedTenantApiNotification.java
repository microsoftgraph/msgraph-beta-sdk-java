...
/**
 * The class for the Managed Tenant Api Notification.
 */
public class ManagedTenantApiNotification extends Entity implements IJsonBackedObject {
     ...
     * 
     */
    @SerializedName(value = "isAcknowledged", alternate = {"IsAcknowledged"})
    @Expose
	@Nullable
