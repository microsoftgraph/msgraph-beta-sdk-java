package com.microsoft.graph.officeconfiguration.clientconfigurations.item.assign;
...
public class AssignPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("officeConfigurationAssignments", (n) -> { currentObject.setOfficeConfigurationAssignments(n.getCollectionOfObjectValues(OfficeClientConfigurationAssignment::createFromDiscriminatorValue)); });
