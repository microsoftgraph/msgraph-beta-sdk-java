...
public class OfficeClientConfigurationItemRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OfficeClientConfiguration> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OfficeClientConfiguration> executionException = new java.util.concurrent.CompletableFuture<OfficeClientConfiguration>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
