...
public class OfficeClientConfigurationItemRequestBuilder {
     ...
     * @return a CompletableFuture of officeClientConfiguration
     */
    public java.util.concurrent.CompletableFuture<OfficeClientConfiguration> patch(@javax.annotation.Nonnull final OfficeClientConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<OfficeClientConfigurationItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
