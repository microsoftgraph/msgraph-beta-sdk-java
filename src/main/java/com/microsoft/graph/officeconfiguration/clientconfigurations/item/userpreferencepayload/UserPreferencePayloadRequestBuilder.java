 ...
 */
public class UserPreferencePayloadRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public UserPreferencePayloadRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/userPreferencePayload", pathParameters);
    }
    /**
     * Instantiates a new UserPreferencePayloadRequestBuilder and sets the default values.
    ...
    public UserPreferencePayloadRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/userPreferencePayload", rawUrl);
    }
    /**
