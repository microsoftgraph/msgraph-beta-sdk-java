 ...
 */
public class PolicyPayloadRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public PolicyPayloadRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/policyPayload", pathParameters);
    }
    /**
     * Instantiates a new PolicyPayloadRequestBuilder and sets the default values.
    ...
    public PolicyPayloadRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/policyPayload", rawUrl);
    }
    /**
