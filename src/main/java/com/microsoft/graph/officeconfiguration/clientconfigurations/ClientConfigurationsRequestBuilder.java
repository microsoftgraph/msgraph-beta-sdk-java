 ...
 */
public class ClientConfigurationsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the clientConfigurations property of the microsoft.graph.officeConfiguration entity.
     * @param officeClientConfigurationId Unique identifier of the item
     * @return a OfficeClientConfigurationItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public OfficeClientConfigurationItemRequestBuilder byOfficeClientConfigurationId(@javax.annotation.Nonnull final String officeClientConfigurationId) {
        Objects.requireNonNull(officeClientConfigurationId);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("officeClientConfiguration%2Did", officeClientConfigurationId);
    ...
    public ClientConfigurationsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ClientConfigurationsRequestBuilder and sets the default values.
    ...
    public ClientConfigurationsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/officeConfiguration/clientConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl);
    }
    /**
    ...
    public java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final OfficeClientConfiguration body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final OfficeClientConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
