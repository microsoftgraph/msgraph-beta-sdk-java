...
public class ClientConfigurationsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<OfficeClientConfigurationCollectionResponse>();
