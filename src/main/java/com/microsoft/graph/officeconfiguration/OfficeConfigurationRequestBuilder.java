...
public class OfficeConfigurationRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OfficeConfiguration> patch(@javax.annotation.Nonnull final OfficeConfiguration body, @javax.annotation.Nullable final java.util.function.Consumer<OfficeConfigurationRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        try {
