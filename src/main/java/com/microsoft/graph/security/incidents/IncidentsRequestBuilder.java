...
public class IncidentsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<IncidentCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<IncidentCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<IncidentCollectionResponse>();
