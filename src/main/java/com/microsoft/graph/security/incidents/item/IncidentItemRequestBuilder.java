...
public class IncidentItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final Incident body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<Incident> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<Incident> executionException = new java.util.concurrent.CompletableFuture<Incident>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
