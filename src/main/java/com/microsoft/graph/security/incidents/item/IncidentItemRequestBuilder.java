...
public class IncidentItemRequestBuilder {
     ...
     * @return a CompletableFuture of incident
     */
    public java.util.concurrent.CompletableFuture<Incident> patch(@javax.annotation.Nonnull final Incident body, @javax.annotation.Nullable final java.util.function.Consumer<IncidentItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
