package com.microsoft.graph.security.labels.retentionlabels.item.descriptors.fileplanreferencetemplate;
...
public class FilePlanReferenceTemplateRequestBuilder extends BaseRequestBuilder {
    ...
    public FilePlanReferenceTemplateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public FilePlanReferenceTemplateRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<FilePlanReferenceTemplate> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
