...
public class CategoryTemplateRequestBuilder extends BaseRequestBuilder {
    ...
    public CategoryTemplateRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public CategoryTemplateRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<CategoryTemplate> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<CategoryTemplate> executionException = new java.util.concurrent.CompletableFuture<CategoryTemplate>();
