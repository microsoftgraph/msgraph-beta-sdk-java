...
public class DepartmentsRequestBuilder extends BaseRequestBuilder {
    ...
    public DepartmentTemplateCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DepartmentTemplateCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public DepartmentTemplate post(@jakarta.annotation.Nonnull final DepartmentTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DepartmentTemplate::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Get a list of the departmentTemplate objects and their properties. This API is available in the following national cloud deployments.
