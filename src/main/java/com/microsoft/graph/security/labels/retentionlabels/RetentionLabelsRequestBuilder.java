...
public class RetentionLabelsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<RetentionLabelCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<RetentionLabelCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<RetentionLabelCollectionResponse>();
