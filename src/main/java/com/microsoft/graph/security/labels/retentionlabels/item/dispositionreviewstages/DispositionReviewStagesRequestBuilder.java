...
public class DispositionReviewStagesRequestBuilder extends BaseRequestBuilder {
    ...
    public DispositionReviewStageCollectionResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DispositionReviewStageCollectionResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
    ...
    public DispositionReviewStage post(@jakarta.annotation.Nonnull final DispositionReviewStage body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, DispositionReviewStage::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * When action at the end of retention is chosen as 'dispositionReview', dispositionReviewStages specifies a sequential set of stages with at least one reviewer in each stage.
