...
public class TriggersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TriggersRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TriggersRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TriggersRoot> executionException = new java.util.concurrent.CompletableFuture<TriggersRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
