...
public class DeleteTiIndicatorsRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a DeleteTiIndicatorsPostResponse
    ...
    public DeleteTiIndicatorsPostResponse post(@jakarta.annotation.Nonnull final DeleteTiIndicatorsPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, DeleteTiIndicatorsPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Delete multiple threat intelligence (TI) indicators in one request instead of multiple requests. This API is available in the following national cloud deployments.
     * @param body The request body
