...
public class DeleteTiIndicatorsByExternalIdPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static DeleteTiIndicatorsByExternalIdPostRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
