...
public class TiIndicatorsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final TiIndicator body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TiIndicatorCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TiIndicatorCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TiIndicatorCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<TiIndicator> post(@javax.annotation.Nonnull final TiIndicator body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<TiIndicator> executionException = new java.util.concurrent.CompletableFuture<TiIndicator>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
