...
public class UpdateTiIndicatorsRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final UpdateTiIndicatorsPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<UpdateTiIndicatorsResponse> post(@javax.annotation.Nonnull final UpdateTiIndicatorsPostRequestBody body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<UpdateTiIndicatorsResponse> executionException = new java.util.concurrent.CompletableFuture<UpdateTiIndicatorsResponse>();
