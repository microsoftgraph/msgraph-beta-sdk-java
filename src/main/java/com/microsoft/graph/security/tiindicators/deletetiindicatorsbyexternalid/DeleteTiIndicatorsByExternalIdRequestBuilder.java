...
public class DeleteTiIndicatorsByExternalIdRequestBuilder {
    ...
    public DeleteTiIndicatorsByExternalIdRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/security/tiIndicators/deleteTiIndicatorsByExternalId";
    ...
    public java.util.concurrent.CompletableFuture<DeleteTiIndicatorsByExternalIdResponse> post(@javax.annotation.Nonnull final DeleteTiIndicatorsByExternalIdPostRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<DeleteTiIndicatorsByExternalIdResponse> executionException = new java.util.concurrent.CompletableFuture<DeleteTiIndicatorsByExternalIdResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeleteTiIndicatorsByExternalIdPostRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final DeleteTiIndicatorsByExternalIdPostRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
