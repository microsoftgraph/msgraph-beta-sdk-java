...
public class DeleteTiIndicatorsByExternalIdRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a deleteTiIndicatorsByExternalIdRequestBody
     */
    @javax.annotation.Nonnull
    public static DeleteTiIndicatorsByExternalIdRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeleteTiIndicatorsByExternalIdRequestBody currentObject = this;
