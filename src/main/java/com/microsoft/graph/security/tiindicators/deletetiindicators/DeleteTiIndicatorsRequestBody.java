...
public class DeleteTiIndicatorsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a deleteTiIndicatorsRequestBody
     */
    @javax.annotation.Nonnull
    public static DeleteTiIndicatorsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final DeleteTiIndicatorsRequestBody currentObject = this;
