...
public class SecurityActionsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the securityActions property of the microsoft.graph.security entity.
     * @param securityActionId Unique identifier of the item
     * @return a SecurityActionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public SecurityActionItemRequestBuilder bySecurityActionId(@javax.annotation.Nonnull final String securityActionId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final SecurityAction body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final SecurityAction body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
