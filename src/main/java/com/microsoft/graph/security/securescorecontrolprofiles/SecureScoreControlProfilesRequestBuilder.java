...
public class SecureScoreControlProfilesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfileCollectionResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SecureScoreControlProfileCollectionResponse::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfileCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, SecureScoreControlProfileCollectionResponse::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
     ...
     * @return a CompletableFuture of secureScoreControlProfile
     */
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfile> post(@javax.annotation.Nonnull final SecureScoreControlProfile body, @javax.annotation.Nullable final java.util.function.Consumer<SecureScoreControlProfilesRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
