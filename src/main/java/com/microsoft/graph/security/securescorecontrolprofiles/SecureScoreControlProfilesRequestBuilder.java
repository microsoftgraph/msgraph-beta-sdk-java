...
public class SecureScoreControlProfilesRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<SecureScoreControlProfileCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<SecureScoreControlProfileCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<SecureScoreControlProfileCollectionResponse>();
