...
import com.microsoft.graph.security.threatintelligence.hosts.item.components.item.HostComponentItemRequestBuilder;
import com.microsoft.graph.security.threatintelligence.hosts.item.cookies.CookiesRequestBuilder;
import com.microsoft.graph.security.threatintelligence.hosts.item.cookies.item.HostCookieItemRequestBuilder;
...
public class HostItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public HostComponentItemRequestBuilder components(@javax.annotation.Nonnull final String id) {
     ...
     */
    @javax.annotation.Nonnull
    public HostCookieItemRequestBuilder cookies(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.security.threatintelligence.hosts.item.passivedns.item.PassiveDnsRecordItemRequestBuilder passiveDns(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("passiveDnsRecord%2Did", id);
        return new com.microsoft.graph.security.threatintelligence.hosts.item.passivedns.item.PassiveDnsRecordItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Provides operations to manage the passiveDnsReverse property of the microsoft.graph.security.host entity.
     * @param id Unique identifier of the item
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.security.threatintelligence.hosts.item.passivednsreverse.item.PassiveDnsRecordItemRequestBuilder passiveDnsReverse(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("passiveDnsRecord%2Did", id);
        return new com.microsoft.graph.security.threatintelligence.hosts.item.passivednsreverse.item.PassiveDnsRecordItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public HostTrackerItemRequestBuilder trackers(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
