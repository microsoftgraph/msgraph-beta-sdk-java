...
public class HostSslCertificatesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the hostSslCertificates property of the microsoft.graph.security.threatIntelligence entity.
     * @param hostSslCertificateId Unique identifier of the item
     * @return a HostSslCertificateItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public HostSslCertificateItemRequestBuilder byHostSslCertificateId(@javax.annotation.Nonnull final String hostSslCertificateId) {
    ...
    public HostSslCertificatesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public HostSslCertificatesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<HostSslCertificateCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<HostSslCertificateCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<HostSslCertificateCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostSslCertificateCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostSslCertificate> post(@javax.annotation.Nonnull final HostSslCertificate body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<HostSslCertificate> executionException = new java.util.concurrent.CompletableFuture<HostSslCertificate>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostSslCertificate> post(@javax.annotation.Nonnull final HostSslCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final HostSslCertificate body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final HostSslCertificate body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
