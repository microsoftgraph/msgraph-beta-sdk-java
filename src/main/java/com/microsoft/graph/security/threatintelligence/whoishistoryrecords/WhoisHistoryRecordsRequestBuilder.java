package com.microsoft.graph.security.threatintelligence.whoishistoryrecords;
...
import com.microsoft.graph.security.threatintelligence.whoishistoryrecords.count.CountRequestBuilder;
import com.microsoft.graph.security.threatintelligence.whoishistoryrecords.item.WhoisHistoryRecordItemRequestBuilder;
 ...
 */
public class WhoisHistoryRecordsRequestBuilder extends BaseRequestBuilder {
    /**
    ...
    public WhoisHistoryRecordsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/whoisHistoryRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new WhoisHistoryRecordsRequestBuilder and sets the default values.
     ...
     */
    @jakarta.annotation.Nullable
    public WhoisHistoryRecordsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<WhoisHistoryRecordCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WhoisHistoryRecordCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<WhoisHistoryRecordCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<WhoisHistoryRecord> post(@jakarta.annotation.Nonnull final WhoisHistoryRecord body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<WhoisHistoryRecord> executionException = new java.util.concurrent.CompletableFuture<WhoisHistoryRecord>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WhoisHistoryRecord body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WhoisHistoryRecord body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
