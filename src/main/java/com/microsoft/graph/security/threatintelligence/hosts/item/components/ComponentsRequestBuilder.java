package com.microsoft.graph.security.threatintelligence.hosts.item.components;

import com.microsoft.graph.models.odataerrors.ODataError;
import com.microsoft.graph.models.security.HostComponentCollectionResponse;
import com.microsoft.graph.security.threatintelligence.hosts.item.components.count.CountRequestBuilder;
...
public class ComponentsRequestBuilder extends BaseRequestBuilder {
    ...
    public ComponentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/components{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new ComponentsRequestBuilder and sets the default values.
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-host-list-components?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
