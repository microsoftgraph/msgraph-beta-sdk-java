...
public class HostPairsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the hostPairs property of the microsoft.graph.security.threatIntelligence entity.
     * @param hostPairId Unique identifier of the item
     * @return a HostPairItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public HostPairItemRequestBuilder byHostPairId(@javax.annotation.Nonnull final String hostPairId) {
    ...
    public HostPairsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public HostPairsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<HostPairCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<HostPairCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<HostPairCollectionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostPairCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostPair> post(@javax.annotation.Nonnull final HostPair body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<HostPair> executionException = new java.util.concurrent.CompletableFuture<HostPair>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HostPair> post(@javax.annotation.Nonnull final HostPair body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final HostPair body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final HostPair body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
