...
public class LanguageDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the languageDetails property of the microsoft.graph.training entity.
     * @param trainingLanguageDetailId Unique identifier of the item
     * @return a TrainingLanguageDetailItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public TrainingLanguageDetailItemRequestBuilder byTrainingLanguageDetailId(@javax.annotation.Nonnull final String trainingLanguageDetailId) {
    ...
    public LanguageDetailsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public LanguageDetailsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<TrainingLanguageDetailCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
