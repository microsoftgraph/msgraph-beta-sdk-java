...
public class LanguageDetailsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TrainingLanguageDetailCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TrainingLanguageDetailCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<TrainingLanguageDetailCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TrainingLanguageDetail body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final TrainingLanguageDetail body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
