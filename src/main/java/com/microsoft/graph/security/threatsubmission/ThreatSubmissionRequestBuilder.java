...
public class ThreatSubmissionRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final ThreatSubmissionRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<ThreatSubmissionRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ThreatSubmissionRoot> executionException = new java.util.concurrent.CompletableFuture<ThreatSubmissionRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
