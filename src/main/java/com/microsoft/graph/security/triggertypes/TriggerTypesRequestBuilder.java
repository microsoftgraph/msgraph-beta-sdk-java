...
public class TriggerTypesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TriggerTypesRoot body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TriggerTypesRoot> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TriggerTypesRoot> executionException = new java.util.concurrent.CompletableFuture<TriggerTypesRoot>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
