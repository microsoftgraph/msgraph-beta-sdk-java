package com.microsoft.graph.security.informationprotection.sensitivitylabels;
...
import com.microsoft.graph.security.informationprotection.sensitivitylabels.count.CountRequestBuilder;
import com.microsoft.graph.security.informationprotection.sensitivitylabels.item.SensitivityLabelItemRequestBuilder;
import com.microsoft.graph.security.informationprotection.sensitivitylabels.microsoftgraphsecurityevaluateapplication.MicrosoftGraphSecurityEvaluateApplicationRequestBuilder;
import com.microsoft.graph.security.informationprotection.sensitivitylabels.microsoftgraphsecurityevaluateclassificationresults.MicrosoftGraphSecurityEvaluateClassificationResultsRequestBuilder;
import com.microsoft.graph.security.informationprotection.sensitivitylabels.microsoftgraphsecurityevaluateremoval.MicrosoftGraphSecurityEvaluateRemovalRequestBuilder;
import com.microsoft.graph.security.informationprotection.sensitivitylabels.microsoftgraphsecurityextractcontentlabel.MicrosoftGraphSecurityExtractContentLabelRequestBuilder;
...
public class SensitivityLabelsRequestBuilder extends BaseRequestBuilder {
    ...
    public SensitivityLabelsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/security/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new SensitivityLabelsRequestBuilder and sets the default values.
