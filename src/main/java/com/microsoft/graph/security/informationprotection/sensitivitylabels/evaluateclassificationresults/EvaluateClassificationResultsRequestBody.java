package microsoft.graph.security.informationprotection.sensitivitylabels.evaluateclassificationresults;
...
import microsoft.graph.models.security.ClassificationResult;
import microsoft.graph.models.security.ContentInfo;
/** Provides operations to call the evaluateClassificationResults method.  */
public class EvaluateClassificationResultsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a evaluateClassificationResultsRequestBody
     */
    @javax.annotation.Nonnull
    public static EvaluateClassificationResultsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final EvaluateClassificationResultsRequestBody currentObject = this;
