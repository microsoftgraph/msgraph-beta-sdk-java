...
public class MicrosoftGraphSecurityEvaluateApplicationRequestBuilder extends BaseRequestBuilder {
    ...
    public MicrosoftGraphSecurityEvaluateApplicationRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public MicrosoftGraphSecurityEvaluateApplicationRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
