...
public class MicrosoftGraphSecurityEvaluateApplicationRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of EvaluateApplicationPostResponse
    ...
    public java.util.concurrent.CompletableFuture<EvaluateApplicationPostResponse> post(@jakarta.annotation.Nonnull final EvaluateApplicationPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EvaluateApplicationPostResponse> post(@jakarta.annotation.Nonnull final EvaluateApplicationPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, EvaluateApplicationPostResponse::createFromDiscriminatorValue, errorMapping);
    }
    /**
     * Compute the sensitivity label that should be applied and return the set of actions that must be taken to correctly label the information. This API is useful when a label should be set manually or explicitly by a user or service, rather than automatically based on file contents. Given contentInfo, which includes existing content metadata key-value pairs, and labelingOptions as an input, the API returns an informationProtectionAction object that contains one of more of the following:  This API is available in the following national cloud deployments.
     * @param body The request body
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a MicrosoftGraphSecurityEvaluateApplicationRequestBuilder
     */
    @jakarta.annotation.Nonnull
