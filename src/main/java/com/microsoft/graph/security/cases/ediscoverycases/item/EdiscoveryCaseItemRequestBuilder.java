...
import microsoft.graph.security.cases.ediscoverycases.item.legalholds.item.EdiscoveryHoldPolicyItemRequestBuilder;
import microsoft.graph.security.cases.ediscoverycases.item.legalholds.LegalHoldsRequestBuilder;
