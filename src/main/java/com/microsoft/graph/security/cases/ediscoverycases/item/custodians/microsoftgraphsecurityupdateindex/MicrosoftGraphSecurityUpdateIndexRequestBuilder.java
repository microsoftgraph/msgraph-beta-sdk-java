package com.microsoft.graph.security.cases.ediscoverycases.item.custodians.microsoftgraphsecurityupdateindex;
...
public class MicrosoftGraphSecurityUpdateIndexRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<Void> post(@jakarta.annotation.Nonnull final UpdateIndexPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> post(@jakarta.annotation.Nonnull final UpdateIndexPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
