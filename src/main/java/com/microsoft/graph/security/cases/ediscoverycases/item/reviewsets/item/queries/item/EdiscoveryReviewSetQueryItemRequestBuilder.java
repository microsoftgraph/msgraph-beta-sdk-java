...
import com.microsoft.graph.security.cases.ediscoverycases.item.reviewsets.item.queries.item.securityexport.SecurityExportRequestBuilder;
import com.microsoft.graph.security.cases.ediscoverycases.item.reviewsets.item.queries.item.securityrun.SecurityRunRequestBuilder;
...
public class EdiscoveryReviewSetQueryItemRequestBuilder extends BaseRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public SecurityExportRequestBuilder securityExport() {
        return new SecurityExportRequestBuilder(pathParameters, requestAdapter);
    }
    /** Provides operations to call the run method. */
    @javax.annotation.Nonnull
    public SecurityRunRequestBuilder securityRun() {
        return new SecurityRunRequestBuilder(pathParameters, requestAdapter);
    }
    /**
