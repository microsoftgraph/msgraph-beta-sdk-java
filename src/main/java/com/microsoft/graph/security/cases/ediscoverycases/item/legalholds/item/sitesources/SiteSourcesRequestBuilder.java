package com.microsoft.graph.security.cases.ediscoverycases.item.legalholds.item.sitesources;
...
import com.microsoft.graph.security.cases.ediscoverycases.item.legalholds.item.sitesources.count.CountRequestBuilder;
...
public class SiteSourcesRequestBuilder {
    ...
    public SiteSourcesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/siteSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
     ...
     * @see <a href="https://docs.microsoft.com/graph/api/security-ediscoveryholdpolicy-post-sitesources?view=graph-rest-1.0">Find more info here</a>
     */
    @javax.annotation.Nonnull
