...
public class ApplyTagsRequestBody implements AdditionalDataHolder, Parsable {
     ...
     * @return a applyTagsRequestBody
     */
    @javax.annotation.Nonnull
    public static ApplyTagsRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final ApplyTagsRequestBody currentObject = this;
