...
public class EdiscoveryHoldPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of ediscoveryHoldPolicy
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> patch(@javax.annotation.Nonnull final EdiscoveryHoldPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<EdiscoveryHoldPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of ediscoveryHoldPolicy
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> patch(@javax.annotation.Nonnull final EdiscoveryHoldPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<EdiscoveryHoldPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
