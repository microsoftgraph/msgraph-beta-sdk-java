...
public class EdiscoveryHoldPolicyItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public EdiscoveryHoldPolicyItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public EdiscoveryHoldPolicyItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public EdiscoveryHoldPolicy get() {
        return get(null);
    }
    /**
     * Returns a list of case eDiscoveryHoldPolicy objects for this case.
     ...
     */
    @jakarta.annotation.Nullable
    public EdiscoveryHoldPolicy get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, EdiscoveryHoldPolicy::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public EdiscoveryHoldPolicy patch(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body) {
     ...
     */
    @jakarta.annotation.Nullable
    public EdiscoveryHoldPolicy patch(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
        if (requestConfiguration != null) {
     ...
     */
    @jakarta.annotation.Nonnull
    public EdiscoveryHoldPolicyItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
