...
public class EdiscoveryHoldPolicyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final EdiscoveryHoldPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
