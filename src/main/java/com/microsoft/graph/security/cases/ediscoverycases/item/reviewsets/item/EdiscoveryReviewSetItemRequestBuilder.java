...
import com.microsoft.graph.security.cases.ediscoverycases.item.reviewsets.item.securityexport.SecurityExportRequestBuilder;
...
public class EdiscoveryReviewSetItemRequestBuilder extends BaseRequestBuilder {
    ...
    public EdiscoveryFileItemRequestBuilder files(@javax.annotation.Nonnull final String id) {
        ...
        urlTplParams.put("ediscoveryFile%2Did", id);
