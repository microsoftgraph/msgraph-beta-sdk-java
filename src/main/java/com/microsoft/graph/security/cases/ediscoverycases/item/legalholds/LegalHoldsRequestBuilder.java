...
public class LegalHoldsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse>();
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> post(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicy> post(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final EdiscoveryHoldPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
