...
public class LegalHoldsRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<EdiscoveryHoldPolicyCollectionResponse>();
