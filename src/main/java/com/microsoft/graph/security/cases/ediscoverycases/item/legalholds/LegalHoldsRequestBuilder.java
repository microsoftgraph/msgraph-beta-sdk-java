...
public class LegalHoldsRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Provides operations to manage the legalHolds property of the microsoft.graph.security.ediscoveryCase entity.
     * @param ediscoveryHoldPolicyId Unique identifier of the item
     * @return a EdiscoveryHoldPolicyItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public EdiscoveryHoldPolicyItemRequestBuilder byEdiscoveryHoldPolicyId(@javax.annotation.Nonnull final String ediscoveryHoldPolicyId) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryHoldPolicy body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final EdiscoveryHoldPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
