package microsoft.graph.security.cases.ediscoverycases.item.searches.item.lastestimatestatisticsoperation;
...
import microsoft.graph.models.security.EdiscoveryEstimateOperation;
...
public class LastEstimateStatisticsOperationRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryEstimateOperation> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryEstimateOperation::createFromDiscriminatorValue, null, errorMapping);
    ...
    public java.util.concurrent.CompletableFuture<EdiscoveryEstimateOperation> get(@javax.annotation.Nullable final java.util.function.Consumer<LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, EdiscoveryEstimateOperation::createFromDiscriminatorValue, responseHandler, errorMapping);
        } catch (URISyntaxException ex) {
            return java.util.concurrent.CompletableFuture.failedFuture(ex);
        }
    }
