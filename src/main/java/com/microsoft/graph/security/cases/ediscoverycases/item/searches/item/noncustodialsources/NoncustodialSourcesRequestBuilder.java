package microsoft.graph.security.cases.ediscoverycases.item.searches.item.noncustodialsources;
...
import microsoft.graph.security.cases.ediscoverycases.item.searches.item.noncustodialsources.count.CountRequestBuilder;
...
public class NoncustodialSourcesRequestBuilder {
     ...
     * @return a CompletableFuture of EdiscoveryNoncustodialDataSourceCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSourceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<NoncustodialSourcesRequestBuilderGetRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of EdiscoveryNoncustodialDataSourceCollectionResponse
     */
    public java.util.concurrent.CompletableFuture<EdiscoveryNoncustodialDataSourceCollectionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<NoncustodialSourcesRequestBuilderGetRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInformation requestInfo = createGetRequestInformation(requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<>(2) {{
                put("4XX", ODataError::createFromDiscriminatorValue);
