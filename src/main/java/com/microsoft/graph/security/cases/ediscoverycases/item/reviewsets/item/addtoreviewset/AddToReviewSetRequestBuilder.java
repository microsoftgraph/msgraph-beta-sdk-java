...
public class AddToReviewSetRequestBuilder {
    ...
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AddToReviewSetRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AddToReviewSetRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration) throws URISyntaxException {
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final AddToReviewSetRequestBody body) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final AddToReviewSetRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of void
     */
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final AddToReviewSetRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPostRequestInformation(body, requestConfiguration);
