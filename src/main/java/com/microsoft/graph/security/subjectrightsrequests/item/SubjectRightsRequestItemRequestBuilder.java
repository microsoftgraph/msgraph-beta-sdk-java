...
public class SubjectRightsRequestItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.security.subjectrightsrequests.item.approvers.item.UserItemRequestBuilder approvers(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("user%2Did", id);
        return new com.microsoft.graph.security.subjectrightsrequests.item.approvers.item.UserItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
     * Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
     * @param id Unique identifier of the item
     ...
     */
    @javax.annotation.Nonnull
    public com.microsoft.graph.security.subjectrightsrequests.item.collaborators.item.UserItemRequestBuilder collaborators(@javax.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("user%2Did", id);
        return new com.microsoft.graph.security.subjectrightsrequests.item.collaborators.item.UserItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
