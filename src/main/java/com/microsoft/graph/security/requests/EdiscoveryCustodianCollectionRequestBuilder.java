...
import com.microsoft.graph.security.requests.EdiscoveryCustodianUpdateIndexRequestBuilder;
...
public class EdiscoveryCustodianCollectionRequestBuilder extends BaseCollectionRequestBuilder<EdiscoveryCustodian, EdiscoveryCustodianRequestBuilder, EdiscoveryCustodianCollectionResponse, EdiscoveryCustodianCollectionPage, EdiscoveryCustodianCollectionRequest> {
     ...
     */
    @Nonnull
    public EdiscoveryCustodianUpdateIndexRequestBuilder updateIndex(@Nonnull final EdiscoveryCustodianUpdateIndexParameterSet parameters) {
        return new EdiscoveryCustodianUpdateIndexRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.updateIndex"), getClient(), null, parameters);
    }
