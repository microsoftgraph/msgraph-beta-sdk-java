...
import com.microsoft.graph.security.requests.EdiscoveryNoncustodialDataSourceUpdateIndexRequestBuilder;
...
public class EdiscoveryNoncustodialDataSourceCollectionRequestBuilder extends BaseCollectionRequestBuilder<EdiscoveryNoncustodialDataSource, EdiscoveryNoncustodialDataSourceRequestBuilder, EdiscoveryNoncustodialDataSourceCollectionResponse, EdiscoveryNoncustodialDataSourceCollectionPage, EdiscoveryNoncustodialDataSourceCollectionRequest> {
     ...
     */
    @Nonnull
    public EdiscoveryNoncustodialDataSourceUpdateIndexRequestBuilder updateIndex(@Nonnull final EdiscoveryNoncustodialDataSourceUpdateIndexParameterSet parameters) {
        return new EdiscoveryNoncustodialDataSourceUpdateIndexRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.security.updateIndex"), getClient(), null, parameters);
    }
