...
import com.microsoft.graph.windowsupdates.models.MonitoringRule;
...
/**
 * The class for the Monitoring Settings.
 */
public class MonitoringSettings implements IJsonBackedObject {
    ...
    @Expose
	@Nullable
    public java.util.List<MonitoringRule> monitoringRules;
