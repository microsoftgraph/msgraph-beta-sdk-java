...
/**
 * The class for the Updatable Asset Enroll Assets By Id Parameter Set.
 */
public class UpdatableAssetEnrollAssetsByIdParameterSet {
    ...
    /**
     * Instiaciates a new UpdatableAssetEnrollAssetsByIdParameterSet
     */
     ...
     */
    protected UpdatableAssetEnrollAssetsByIdParameterSet(@Nonnull final UpdatableAssetEnrollAssetsByIdParameterSetBuilder builder) {
    ...
    /**
     * Fluent builder for the UpdatableAssetEnrollAssetsByIdParameterSet
     */
    public static final class UpdatableAssetEnrollAssetsByIdParameterSetBuilder {
         ...
         */
        @Nonnull
        public UpdatableAssetEnrollAssetsByIdParameterSetBuilder withUpdateCategory(@Nullable final UpdateCategory val) {
         ...
         */
        @Nonnull
        public UpdatableAssetEnrollAssetsByIdParameterSetBuilder withMemberEntityType(@Nullable final String val) {
         ...
         */
        @Nonnull
        public UpdatableAssetEnrollAssetsByIdParameterSetBuilder withIds(@Nullable final java.util.List<String> val) {
            this.ids = val;
            return this;
        }
        /**
         * Instanciates a new UpdatableAssetEnrollAssetsByIdParameterSetBuilder
         */
        @Nullable
