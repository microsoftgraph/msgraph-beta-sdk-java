...
public class MobileDeviceManagementPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final MobilityManagementPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<MobilityManagementPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobilityManagementPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<MobilityManagementPolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<MobilityManagementPolicy> post(@javax.annotation.Nonnull final MobilityManagementPolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<MobilityManagementPolicy> executionException = new java.util.concurrent.CompletableFuture<MobilityManagementPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
