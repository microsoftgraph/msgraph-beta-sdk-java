...
public class DeviceRegistrationPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<DeviceRegistrationPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<DeviceRegistrationPolicy> executionException = new java.util.concurrent.CompletableFuture<DeviceRegistrationPolicy>();
