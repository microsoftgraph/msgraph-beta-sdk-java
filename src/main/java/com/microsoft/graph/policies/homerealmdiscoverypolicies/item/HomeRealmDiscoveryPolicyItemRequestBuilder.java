...
public class HomeRealmDiscoveryPolicyItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy> patch(@jakarta.annotation.Nonnull final HomeRealmDiscoveryPolicy body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<HomeRealmDiscoveryPolicy> patch(@jakarta.annotation.Nonnull final HomeRealmDiscoveryPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
