...
public class MultiTenantOrganizationPartnerConfigurationRequestBuilder extends BaseRequestBuilder {
    ...
    public MultiTenantOrganizationPartnerConfigurationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new MultiTenantOrganizationPartnerConfigurationRequestBuilder and sets the default values.
    ...
    public MultiTenantOrganizationPartnerConfigurationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration{?%24select,%24expand}", rawUrl);
    }
    /**
     ...
     * @return a CompletableFuture of MultiTenantOrganizationPartnerConfigurationTemplate
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationPartnerConfigurationTemplate> get() {
        return get(null);
    }
    /**
     * Get the cross-tenant access policy template with inbound and outbound partner configuration settings for a multi-tenant organization.
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationPartnerConfigurationTemplate> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("4XX", ODataError::createFromDiscriminatorValue);
        errorMapping.put("5XX", ODataError::createFromDiscriminatorValue);
        return this.requestAdapter.sendAsync(requestInfo, MultiTenantOrganizationPartnerConfigurationTemplate::createFromDiscriminatorValue, errorMapping);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationPartnerConfigurationTemplate> patch(@jakarta.annotation.Nonnull final MultiTenantOrganizationPartnerConfigurationTemplate body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MultiTenantOrganizationPartnerConfigurationTemplate> patch(@jakarta.annotation.Nonnull final MultiTenantOrganizationPartnerConfigurationTemplate body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
