...
public class FindByMethodModeWithAuthenticationMethodModesRequestBuilder {
    ...
    public FindByMethodModeWithAuthenticationMethodModesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter, @javax.annotation.Nullable final String authenticationMethodModes) {
        ...
        this.urlTemplate = "{+baseurl}/policies/authenticationStrengthPolicies/findByMethodMode(authenticationMethodModes={authenticationMethodModes}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
