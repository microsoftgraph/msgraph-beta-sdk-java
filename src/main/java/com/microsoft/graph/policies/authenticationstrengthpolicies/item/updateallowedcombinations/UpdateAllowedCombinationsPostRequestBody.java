...
public class UpdateAllowedCombinationsPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<String> _allowedCombinations;
    /**
    ...
    public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
        final UpdateAllowedCombinationsPostRequestBody currentObject = this;
        return new HashMap<>(1) {{
            this.put("allowedCombinations", (n) -> { currentObject.setAllowedCombinations(n.getCollectionOfPrimitiveValues(String.class)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setAllowedCombinations(@javax.annotation.Nullable final java.util.List<String> value) {
