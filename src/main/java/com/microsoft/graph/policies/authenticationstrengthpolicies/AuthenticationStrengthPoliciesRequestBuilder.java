...
public class AuthenticationStrengthPoliciesRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPostRequestInformation(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicyCollectionResponse> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicyCollectionResponse> executionException = new java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicyCollectionResponse>();
    ...
    public java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy> post(@javax.annotation.Nonnull final AuthenticationStrengthPolicy body) {
        try {
            ...
            java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy> executionException = new java.util.concurrent.CompletableFuture<AuthenticationStrengthPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
