...
public class AppManagementPolicyItemRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final AppManagementPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<AppManagementPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<AppManagementPolicy> executionException = new java.util.concurrent.CompletableFuture<AppManagementPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
