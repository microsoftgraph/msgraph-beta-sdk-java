...
public class UnifiedRoleManagementPolicyItemRequestBuilder {
     ...
     * @return a CompletableFuture of unifiedRoleManagementPolicy
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicy> patch(@javax.annotation.Nonnull final UnifiedRoleManagementPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<UnifiedRoleManagementPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of unifiedRoleManagementPolicy
     */
    public java.util.concurrent.CompletableFuture<UnifiedRoleManagementPolicy> patch(@javax.annotation.Nonnull final UnifiedRoleManagementPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<UnifiedRoleManagementPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
