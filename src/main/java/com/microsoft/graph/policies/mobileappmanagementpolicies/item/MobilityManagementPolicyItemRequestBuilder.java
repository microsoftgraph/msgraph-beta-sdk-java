package microsoft.graph.policies.mobileappmanagementpolicies.item;
...
import microsoft.graph.policies.mobileappmanagementpolicies.item.includedgroups.IncludedGroupsRequestBuilder;
import microsoft.graph.policies.mobileappmanagementpolicies.item.includedgroups.item.GroupItemRequestBuilder;
...
public class MobilityManagementPolicyItemRequestBuilder {
    ...
    public MobilityManagementPolicyItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}{?%24select,%24expand}";
