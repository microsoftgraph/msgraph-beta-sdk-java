...
public class DefaultAppManagementPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<TenantAppManagementPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<TenantAppManagementPolicy> executionException = new java.util.concurrent.CompletableFuture<TenantAppManagementPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
