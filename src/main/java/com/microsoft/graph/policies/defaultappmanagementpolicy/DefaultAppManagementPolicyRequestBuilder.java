...
public class DefaultAppManagementPolicyRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation createPatchRequestInformation(@javax.annotation.Nonnull final TenantAppManagementPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
    ...
    public java.util.concurrent.CompletableFuture<TenantAppManagementPolicy> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<TenantAppManagementPolicy> executionException = new java.util.concurrent.CompletableFuture<TenantAppManagementPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
