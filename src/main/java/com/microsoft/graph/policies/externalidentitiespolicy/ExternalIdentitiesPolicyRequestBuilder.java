...
public class ExternalIdentitiesPolicyRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> executionException = new java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> patch(@jakarta.annotation.Nonnull final ExternalIdentitiesPolicy body) {
        try {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> patch(@jakarta.annotation.Nonnull final ExternalIdentitiesPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ExternalIdentitiesPolicy body) throws URISyntaxException {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@jakarta.annotation.Nonnull final ExternalIdentitiesPolicy body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
