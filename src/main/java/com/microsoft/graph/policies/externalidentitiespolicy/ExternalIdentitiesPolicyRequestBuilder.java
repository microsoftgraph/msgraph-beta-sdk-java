...
public class ExternalIdentitiesPolicyRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> get() {
        try {
            ...
            java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> executionException = new java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
