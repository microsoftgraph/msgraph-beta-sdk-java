...
public class ExternalIdentitiesPolicyRequestBuilder {
     ...
     * @return a CompletableFuture of externalIdentitiesPolicy
     */
    public java.util.concurrent.CompletableFuture<ExternalIdentitiesPolicy> patch(@javax.annotation.Nonnull final ExternalIdentitiesPolicy body, @javax.annotation.Nullable final java.util.function.Consumer<ExternalIdentitiesPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
