package microsoft.graph.governanceresources.item.roleassignmentrequests.item;
...
import microsoft.graph.governanceresources.item.roleassignmentrequests.item.cancel.CancelRequestBuilder;
import microsoft.graph.governanceresources.item.roleassignmentrequests.item.resource.ResourceRequestBuilder;
import microsoft.graph.governanceresources.item.roleassignmentrequests.item.roledefinition.RoleDefinitionRequestBuilder;
import microsoft.graph.governanceresources.item.roleassignmentrequests.item.subject.SubjectRequestBuilder;
import microsoft.graph.governanceresources.item.roleassignmentrequests.item.updaterequest.UpdateRequestRequestBuilder;
