...
public class GovernanceResourceItemRequestBuilder {
     ...
     * @return a CompletableFuture of governanceResource
     */
    public java.util.concurrent.CompletableFuture<GovernanceResource> patch(@javax.annotation.Nonnull final GovernanceResource body, @javax.annotation.Nullable final java.util.function.Consumer<GovernanceResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration) {
        try {
     ...
     * @return a CompletableFuture of governanceResource
     */
    public java.util.concurrent.CompletableFuture<GovernanceResource> patch(@javax.annotation.Nonnull final GovernanceResource body, @javax.annotation.Nullable final java.util.function.Consumer<GovernanceResourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInformation requestInfo = createPatchRequestInformation(body, requestConfiguration);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>(2) {{
