package com.microsoft.graph.governanceresources.item.roledefinitions;

import com.microsoft.graph.governanceresources.item.roledefinitions.count.CountRequestBuilder;
...
public class RoleDefinitionsRequestBuilder extends BaseRequestBuilder {
    ...
    public RoleDefinitionsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new RoleDefinitionsRequestBuilder and sets the default values.
