package com.microsoft.graph.governanceresources.item.roledefinitions.item;

import com.microsoft.graph.governanceresources.item.roledefinitions.item.resource.ResourceRequestBuilder;
import com.microsoft.graph.governanceresources.item.roledefinitions.item.rolesetting.RoleSettingRequestBuilder;
...
public class GovernanceRoleDefinitionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public GovernanceRoleDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", pathParameters);
    }
    /**
     * Instantiates a new GovernanceRoleDefinitionItemRequestBuilder and sets the default values.
    ...
    public GovernanceRoleDefinitionItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", rawUrl);
    }
    /**
